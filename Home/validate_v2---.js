	   ...
	   {  
	    ...
	    '</TR></table>';
			...
			//	}
			  ...
			  '<TD WIDTH="18%" align="left"><input class="txt_input" type="text" name=TXT_AUDITOR_NAME'+lineno_auditors+'  style=\"width: 150px\" maxlength="200" size="55" ></TD>'+
