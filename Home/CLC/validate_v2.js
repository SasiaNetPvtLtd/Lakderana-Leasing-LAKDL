	...
	//--validate family members--------------------------------------------------------------------------------------------------------------------------------------------------//
	    ...
	    if(oBj.valout[6] != '-') 
		  ...
		  document.Form1.TXT_BUSINESS_CERTIFICATE_NO.value=oBj.valout[16];  //added by nuwan de silva 18-05-07
			...
			m_url=""+servlet_client_url+":"+client_t3_port+"/"+client_name+"AF_MAS_sql_validations1?chksql=m_prime_comfac_client_creation_client_code_validate&client_code="+document.Form1.TXT_CLIENT_CODE.value+"&tmp_help_status="+document.Form1.hid_temp_status.value+"&ac_status=Y";
			}
			else{
			//m_url=""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations1?chksql=m_prime_comfac_client_creation_client_code_validate="+document.Form1.TXT_CLIENT_CODE.value+"&ac_status=N";
			m_url=""+servlet_client_url+":"+client_t3_port+"/"+client_name+"AF_MAS_sql_validations1?chksql=m_prime_comfac_client_creation_client_code_validate&client_code="+document.Form1.TXT_CLIENT_CODE.value+"&tmp_help_status="+document.Form1.hid_temp_status.value+"&ac_status=N";
			}
      ...
      // added by nuwan de silva on  16-10-2008
			...
			m_url=""+servlet_client_url+":"+client_t3_port+"/"+client_name+"AF_MAS_sql_validations2?chksql=m_prime_comfac_count_client_contracts&client_code="+document.Form1.TXT_CLIENT_CODE.value+"";
			load_interface(m_url,'XML'); 
			//window.open(m_url);
			} 
			...
			array_to_date_yy[no]=dval.substring(6,10)
			  ...
			  function validate_NIC_dir(){ 
				...
				//if (document.TXT_CLIENT_TYPE.value=="I"){
