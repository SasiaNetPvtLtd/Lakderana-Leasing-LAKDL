...
function show_client(m_client_data){
	m_url=servlet_client_url+":"+client_t3_port+"/"+client_name+"FA_RE_PRO_drill_downs?chksql=SHOW_CLIENT_INFORMATION&client_code="+m_client_data;
	window.open(m_url,"popupwin1","status=0,menubar=0,scrollbars=1,height=500,width=700");
}
...
function show_invoice_details(m_debtor_code,m_invoice_no,m_batch_no){
	m_url=servlet_client_url+":"+client_t3_port+"/"+client_name+"FA_RE_PRO_drill_downs?chksql=SHOW_INVOICE_DETAIL_DRILL&invoice_no="+m_invoice_no+"&debtor_no="+m_debtor_code+"&batch_no="+m_batch_no;
	window.open(m_url,"popupwin1","status=0,menubar=0,scrollbars=1,height=500,width=700");
}
///--- Add by DSP Chathuranga 2012-12-31 *** For SHOW_INVOICE_DETAIL_DRILL ---///
function show_invoice_details2(m_debtor_code,m_credit_note_code){
	m_url=servlet_client_url+":"+client_t3_port+"/"+client_name+"FA_RE_PRO_drill_downs_2?chksql=SHOW_INVOICE_DETAIL_DRILL_2&credit_note_no="+m_credit_note_code+"&debtor_no="+m_debtor_code;
	window.open(m_url,"popupwin1","status=0,menubar=0,scrollbars=1,height=500,width=700");
}
///--------------------------------END----------------------------------------///
...
function show_pod_cheque_details_for_deposit(m_pod_ref_no){
	m_url=servlet_client_url+":"+client_t3_port+"/"+client_name+"FA_RE_PRO_drill_downs?chksql=SHOW_POD_CHEQUE_DETAIL_DRILL_FOR_DEPOSIT&pod_ref_no="+m_pod_ref_no;
	window.open(m_url,"popupwin1","status=0,menubar=0,scrollbars=1,height=500,width=700");
}
...
function show_receipt_details_display_deposit(m_receipt_no){
	m_url=servlet_client_url+":"+client_t3_port+"/"+client_name+"FA_RE_PRO_drill_downs?chksql=SHOW_RECEIPT_DETAIL_DRILL_FOR_DEPOSIT_DETAILS&receipt_no="+m_receipt_no;
	window.open(m_url,"popupwin1","status=0,menubar=0,scrollbars=1,height=500,width=700");
}
