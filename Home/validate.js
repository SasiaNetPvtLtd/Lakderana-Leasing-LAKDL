...
//============================================Check for new and old NIC formate added by Kanchana on 2015-01-13 for # 19197============================================================
...
function val_nic_for_nicfield(object){ //added by kanchana for seizer screen validation.
m_objval = object.value;
m_length = m_objval.toString().length;
if(m_length>10){
//alert('You are entering new formatted NIC number');
...
//Added by Kanchana to check availability of NIC No * field	  
	function check_availability(obj){
		 m_size=obj.value.length;
		if (obj.value=='')	{
		alert('Plese Enter NIC No field first');	
		document.Form1.TXT_NIC_NO_OLD.value='';
		return false;	
		}
		
		if(m_size==10){
		alert('You have already entered old NIC number ');	
		document.Form1.TXT_NIC_NO_OLD.value='';		
		}
	}  
