...
public class LAKDL_FA_MISF_invoice_portfolio_report extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Invoice Portfolio Report </TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("	if(isNaN(object.value)) {");
			out.println("		alert('Value should be a number.');");
			...
			out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"FA_MISF_reports?chksql=LOAD_INVOICE_PORTFOLIO_REPORT&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&client_code=\"+document.Form1.TXT_CLIENT_CODE.value+\"&facility_no=\"+document.Form1.TXT_FACILITY_NO.value+\"&debtor_code=\"+document.Form1.TXT_DEBTOR_CODE.value+\"&settle_ratio=\"+document.Form1.TXT_SETTLE_RATIO.value;");
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"FA_MISF_invoice_portfolio_report';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("	help_box.innerHTML=\" Invoice Portfolio Report - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\" Invoice Portfolio Report \";"); 
			out.println("}"); 
	  	...
	  	out.println("					}"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Invoice Portfolio Report </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<table class='table' width='100%'  >"); 
			out.println("<tr>"); 
			out.println("<td width='15%' ><DIV id='DIV_TXT_SETTLE_RATIO'  class=div_input><B>Collection Ratio (%)</B></DIV></td>"); 
			// Added By Samitha Kulatilaka On 2009-10-14 (Called An onBlur Function)
			out.println("<td width='17%' ><input class='txt_input' type='text' name='TXT_SETTLE_RATIO' maxlength='5' size='10' style='width:50' value=\"0\" onBlur='isNaN_validate(this);'></td>"); 
			out.println("<td width='*%'><input class='but_input' type='button' name='BUT_VIEW_MAIN' value=\"View\" onClick=\"show_invoice_portfolio_report()\"></td>"); 
			out.println("</tr>");
			out.println("</tr>"); 
			out.println("</table>");  
			out.println("</form>"); 
