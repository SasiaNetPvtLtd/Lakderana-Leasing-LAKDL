...
public class LAKDL_FA_MIS_report_generation extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			if (m_chksql.trim().equals("idle")) {
				...
				out.println("<HTML>"); 
				out.println("<HEAD>"); 
				out.println("<TITLE>Operation Reports - Client Statement </TITLE>"); 
				...
				out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"FA_OP_Current_Account_Statement?chksql=get_report&date_from=\"+m_from_date+\"&date_to=\"+m_to_date+\"&client_code=\"+document.Form1.TXT_CLIENT_CODE.value+\"&facility_no=\"+document.Form1.TXT_FACILITY_NO.value;");
				...
				out.println("function makeRequest_detail_1() {");
				out.println(" 	m_from_dd = document.Form1.TXT_FROM_DATE_DD.value ");
				out.println(" 	m_from_mm = document.Form1.TXT_FROM_DATE_MM.value ");
				out.println("		m_from_yy = document.Form1.TXT_FROM_DATE_YY.value ");
				out.println(" 	m_from_date = m_from_dd+\"-\"+m_from_mm+\"-\"+m_from_yy; ");
				...
				out.println(" 	m_to_date = m_to_dd+\"-\"+m_to_mm+\"-\"+m_to_yy; ");
				out.println("		if(validate_date()) {");
				out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"FA_RE_client_sales_ledger_statement?chksql=get_report&date_from=\"+m_from_date+\"&date_to=\"+m_to_date+\"&client_code=\"+document.Form1.TXT_CLIENT_CODE.value+\"&facility_no=\"+document.Form1.TXT_FACILITY_NO.value;");
				out.println("    popupwin=window.open(m_url,'displayWindow1','left=90,top=110,width=900,height=450,toolbar=0,location=0,center:yes,direction=0,menuBar=1,status=0,scrollbars=1,resizable=1');");
				out.println("   }");
				out.println("}");
				
				out.println("function makeRequest_detail_2() {");
				out.println(" 	m_from_dd = document.Form1.TXT_FROM_DATE_DD.value ");
				out.println(" 	m_from_mm = document.Form1.TXT_FROM_DATE_MM.value ");
				out.println("		m_from_yy = document.Form1.TXT_FROM_DATE_YY.value ");
				out.println(" 	m_from_date = m_from_dd+\"-\"+m_from_mm+\"-\"+m_from_yy; ");
				...
				out.println(" 	m_to_date = m_to_dd+\"-\"+m_to_mm+\"-\"+m_to_yy; ");
				out.println("		if(validate_date()) {");
				out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"FA_RE_client_sales_ledger_statement?chksql=get_report_annex_1&date_from=\"+m_from_date+\"&date_to=\"+m_to_date+\"&client_code=\"+document.Form1.TXT_CLIENT_CODE.value+\"&facility_no=\"+document.Form1.TXT_FACILITY_NO.value;");
				out.println("    popupwin=window.open(m_url,'displayWindow1','left=90,top=110,width=900,height=450,toolbar=0,location=0,center:yes,direction=0,menuBar=1,status=0,scrollbars=1,resizable=1');");
				out.println("   }");
				out.println("}");
				
				out.println("function makeRequest_detail_3() {");
				out.println(" 	m_from_dd = document.Form1.TXT_FROM_DATE_DD.value ");
				out.println(" 	m_from_mm = document.Form1.TXT_FROM_DATE_MM.value ");
				out.println("		m_from_yy = document.Form1.TXT_FROM_DATE_YY.value ");
				out.println(" 	m_from_date = m_from_dd+\"-\"+m_from_mm+\"-\"+m_from_yy; ");
				...
				out.println(" 	m_to_date = m_to_dd+\"-\"+m_to_mm+\"-\"+m_to_yy; ");
				out.println("		if(validate_date()) {");
				out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"FA_RE_client_sales_ledger_statement?chksql=get_report_annex_2&date_from=\"+m_from_date+\"&date_to=\"+m_to_date+\"&client_code=\"+document.Form1.TXT_CLIENT_CODE.value+\"&facility_no=\"+document.Form1.TXT_FACILITY_NO.value;");
				out.println("    popupwin=window.open(m_url,'displayWindow1','left=90,top=110,width=900,height=450,toolbar=0,location=0,center:yes,direction=0,menuBar=1,status=0,scrollbars=1,resizable=1');");
				out.println("   }");
				out.println("}");
				
				out.println("function makeRequest_detail_5() {");
				out.println(" 	m_from_dd = document.Form1.TXT_FROM_DATE_DD.value ");
				out.println(" 	m_from_mm = document.Form1.TXT_FROM_DATE_MM.value ");
				out.println("		m_from_yy = document.Form1.TXT_FROM_DATE_YY.value ");
				out.println(" 	m_from_date = m_from_dd+\"-\"+m_from_mm+\"-\"+m_from_yy; ");
				...
				out.println(" 	m_to_date = m_to_dd+\"-\"+m_to_mm+\"-\"+m_to_yy; ");
				out.println("		if(validate_date()) {");
				out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"FA_RE_client_sales_ledger_statement?chksql=get_report_annex_3&date_from=\"+m_from_date+\"&date_to=\"+m_to_date+\"&client_code=\"+document.Form1.TXT_CLIENT_CODE.value+\"&facility_no=\"+document.Form1.TXT_FACILITY_NO.value;");
				out.println("    popupwin=window.open(m_url,'displayWindow1','left=90,top=110,width=900,height=450,toolbar=0,location=0,center:yes,direction=0,menuBar=1,status=0,scrollbars=1,resizable=1');");
				out.println("   }");
				out.println("}");
				
				out.println("function makeRequest_detail_4() {");
				out.println(" 	m_from_dd = document.Form1.TXT_FROM_DATE_DD.value ");
				out.println(" 	m_from_mm = document.Form1.TXT_FROM_DATE_MM.value ");
				out.println("		m_from_yy = document.Form1.TXT_FROM_DATE_YY.value ");
				out.println(" 	m_from_date = m_from_dd+\"-\"+m_from_mm+\"-\"+m_from_yy; ");
				...
				out.println(" 	m_to_date = m_to_dd+\"-\"+m_to_mm+\"-\"+m_to_yy; ");
				out.println("		if(validate_date()) {");
				out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"FA_RE_client_sales_ledger_statement?chksql=get_report_annex_4&date_from=\"+m_from_date+\"&date_to=\"+m_to_date+\"&client_code=\"+document.Form1.TXT_CLIENT_CODE.value+\"&facility_no=\"+document.Form1.TXT_FACILITY_NO.value;");
				out.println("    popupwin=window.open(m_url,'displayWindow1','left=90,top=110,width=900,height=450,toolbar=0,location=0,center:yes,direction=0,menuBar=1,status=0,scrollbars=1,resizable=1');");
				out.println("   }");
				out.println("}");
				
				out.println("function makeRequest_detail_debtor() {");
				out.println(" 	m_from_dd = document.Form1.TXT_FROM_DATE_DD.value ");
				out.println(" 	m_from_mm = document.Form1.TXT_FROM_DATE_MM.value ");
				out.println("		m_from_yy = document.Form1.TXT_FROM_DATE_YY.value ");
				out.println(" 	m_from_date = m_from_dd+\"-\"+m_from_mm+\"-\"+m_from_yy; ");
				...
				out.println(" 	m_to_date = m_to_dd+\"-\"+m_to_mm+\"-\"+m_to_yy; ");
				out.println("		if(validate_date()) {");
				out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"FA_RE_debtor_sales_ledger_statement?chksql=get_report&date_from=\"+m_from_date+\"&date_to=\"+m_to_date+\"&client_code=\"+document.Form1.TXT_CLIENT_CODE.value+\"&facility_no=\"+document.Form1.TXT_FACILITY_NO.value;");
				out.println("    popupwin=window.open(m_url,'displayWindow1','left=90,top=110,width=900,height=450,toolbar=0,location=0,center:yes,direction=0,menuBar=1,status=0,scrollbars=1,resizable=1');");
				out.println("   }");
				out.println("}");
				
				out.println("function makeRequest_detail_6() {");
				out.println(" 	m_from_dd = document.Form1.TXT_FROM_DATE_DD.value ");
				out.println(" 	m_from_mm = document.Form1.TXT_FROM_DATE_MM.value ");
				out.println("		m_from_yy = document.Form1.TXT_FROM_DATE_YY.value ");
				out.println(" 	m_from_date = m_from_dd+\"-\"+m_from_mm+\"-\"+m_from_yy; ");
				...
				out.println(" 	m_to_date = m_to_dd+\"-\"+m_to_mm+\"-\"+m_to_yy; ");
				out.println("		if(validate_date()) {");
				out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"FA_RE_debtor_sales_ledger_statement?chksql=get_report_bulk&date_from=\"+m_from_date+\"&date_to=\"+m_to_date+\"&client_code=\"+document.Form1.TXT_CLIENT_CODE.value+\"&facility_no=\"+document.Form1.TXT_FACILITY_NO.value;");
				out.println("    popupwin=window.open(m_url,'displayWindow1','left=90,top=110,width=900,height=450,toolbar=0,location=0,center:yes,direction=0,menuBar=1,status=0,scrollbars=1,resizable=1');");
				out.println("   }");
				out.println("}");*/
				...
				out.println("    	m_url = '" + m_class_url + "/" + m_fschema_name + "FA_MIS_report_generation?chksql=CLIENT_STATEMENT' ;"); 
				...
				out.println("			}");
				out.println("			if(validate_data()){"); 
				out.println("				document.Form1.action='"+m_class_url+"/"+m_fschema_name+"FA_MIS_report_generation_save';");  
				...
				out.println("	help_box.innerHTML=\" Operation Reports - Client Statement  - \"+m_val;"); 
				out.println("}"); 
				
				out.println("function load_roll_out_value(){");
				out.println("	help_box.innerHTML=\" Operation Reports - Client Statement  \";"); 
				out.println("}"); 
				...
				out.println("function makeRequest_detail_7() {");
				out.println(" 	m_from_dd = document.Form1.TXT_FROM_DATE_DD.value ");
				out.println(" 	m_from_mm = document.Form1.TXT_FROM_DATE_MM.value ");
				out.println("		m_from_yy = document.Form1.TXT_FROM_DATE_YY.value ");
				out.println(" 	m_from_date = m_from_dd+\"-\"+m_from_mm+\"-\"+m_from_yy; ");
				...
				out.println(" 	m_to_date = m_to_dd+\"-\"+m_to_mm+\"-\"+m_to_yy; ");
				out.println("		if(validate_date()) {");
				out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"FA_OP_Current_Account_Statement?chksql=bulk_print_current_account&date_from=\"+m_from_date+\"&date_to=\"+m_to_date+\"&client_code=\"+document.Form1.TXT_CLIENT_CODE.value+\"&facility_no=\"+document.Form1.TXT_FACILITY_NO.value;");
				out.println("    popupwin=window.open(m_url,'displayWindow1','left=90,top=110,width=900,height=450,toolbar=0,location=0,center:yes,direction=0,menuBar=1,status=0,scrollbars=1,resizable=1');");
				out.println("   }");
				out.println("}");
				...
				out.println("</tr>"); 
				out.println("<tr>"); 
				out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Operation Reports - Client Statement </td>"); 
				out.println("</tr>"); 
				out.println("<tr>"); 
				...
				out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Save\");'  onClick='save_window()' value=\"Generate\"></td>");  
				...
				out.println("<td width='30%' ><input class='txt_input' type='text' name='TXT_FACILITY_NO' maxlength='20' size='10' style='width:100' onblur=\"help_update_facility()\">"); 
				...
				out.println("<td width='30%' ><input class='txt_input' type='text' name='TXT_CLIENT_CODE' maxlength='10' size='50' style='width:100' onblur=\"help_update()\" disabled>"); 
				...
				out.println("</tr>"); 
				out.println("</table>");  
				/*out.println("<table class='table' width='80%'  >"); 
				out.println("<tr>"); 
				out.println("<td width='5%' ></td>"); 
				out.println("<td width='*%' align='left' ><input class='but_input' type='button' name='BUT_DETAILS' style='width:200' value=\"Client Current Account Details\" onClick=\"makeRequest_detail()\"  ></td>");
				out.println("</tr>"); 
				out.println("<tr>"); 
				out.println("<td width='5%' ></td>"); 
				out.println("<td width='*%' align='left' ><input class='but_input' type='button' name='BUT_DETAILS1' style='width:200' value=\"Client Sales Ledger Summary\" onClick=\"makeRequest_detail_1()\"  ></td>");
				out.println("</tr>"); 
				out.println("<tr>"); 
				out.println("<td width='5%' ></td>"); 
				out.println("<td width='*%' align='left' ><input class='but_input' type='button' name='BUT_DETAILS2' style='width:200' value=\"Invoice Batch Details\" onClick=\"makeRequest_detail_2()\"  ></td>");
				out.println("</tr>");
				out.println("<tr>"); 
				out.println("<td width='5%' ></td>"); 
				out.println("<td width='*%' align='left' ><input class='but_input' type='button' name='BUT_DETAILS3' style='width:200' value=\"Invoice Settlement Details\" onClick=\"makeRequest_detail_3()\"  ></td>");
				out.println("</tr>");
				out.println("<tr>"); 
				out.println("<td width='5%' ></td>"); 
				out.println("<td width='*%' align='left' ><input class='but_input' type='button' name='BUT_DETAILS4' style='width:200' value=\"Invoice Reassign Details\" onClick=\"makeRequest_detail_4()\"  ></td>");
				out.println("</tr>");
				out.println("<tr>"); 
				out.println("<td width='5%' ></td>"); 
				out.println("<td width='*%' align='left' ><input class='but_input' type='button' name='BUT_DETAILS4' style='width:200' value=\"Invoice Adjustment Details\" onClick=\"makeRequest_detail_5()\"  ></td>");
				out.println("</tr>");
				out.println("<tr>"); 
				out.println("<td width='5%' ></td>"); 
				out.println("<td width='*%' align='left' ><input class='but_input' type='button' name='BUT_DETAILS5' style='width:200' value=\"Debtor Statements\" onClick=\"makeRequest_detail_debtor()\"  ></td>");
				out.println("</tr>");
				out.println("</table>");
				out.println("<hr>"); 
				out.println("<table class='table' width='100%'  >"); 
				out.println("<tr>"); 
				out.println("<td width='5%' ></td>"); 
				out.println("<td width='*%' align='left' ><input class='but_input' type='button' name='BUT_DETAILS6' style='width:200' value=\"Current Account Statements-Bulk\" onClick=\"makeRequest_detail_7()\"  ></td>");
				out.println("</tr>");
				out.println("<tr>"); 
				out.println("<td width='5%' ></td>"); 
				out.println("<td width='*%' align='left' ><input class='but_input' type='button' name='BUT_DETAILS6' style='width:200' value=\"Debtor Statements-Bulk\" onClick=\"makeRequest_detail_6()\"  ></td>");
				out.println("</tr>");
				out.println("</table>");*/
				out.println("<br>"); 
				...
				m_string=m_string+"<table align='left' width='300px' class='table'>";
				...
				m_string=m_string+"<td width='25%' ><DIV class=div_input>Report Name</DIV></td>";
				m_string=m_string+"<td width='7%' ><DIV class=div_input>Select</DIV></td>"; 
				...
				while(rs.next()){
					...
					m_string=m_string+"<td width='1%'></td>"; 
					//m_string=m_string+"<td width='20%' ><INPUT TYPE='HIDDEN' class='txt_input' NAME='REP_ID_"+chk_nums+"' VALUE=\""+rs.getString(2)+"\">"+rs.getString(2)+"</td>";
					m_string=m_string+"<td width='25%' ><INPUT TYPE='HIDDEN' class='txt_input' NAME='REP_ID_"+chk_nums+"' VALUE=\""+rs.getString(2)+"\">"+rs.getString(3)+"</td>";
