...
public class LAKDL_AF_RE_PRO_Collection_Final_Reminder_front_end extends javax.servlet.http.HttpServlet {
	...
	public /*synchronized*/ void service(HttpServletRequest req, HttpServletResponse res) throws IOException {
		...
		//		out.println("   m_url='" + m_class_url + "/" + m_fschema_name + "AF_RE_PRO_Collection_Final_Reminder?m_finance_no="+req.getParameter("finance_no")+"&application_no=" + req.getParameter("application_no") + "&document_code="+req.getParameter("document_code")+"&print=FALSE&client_code=" + req.getParameter("client_code") + "&client_type=" + req.getParameter("client_type") + "';");
			...
			*/
				...
				out.println("<table border='0' width='90%' class='table'> ");
				out.println("<tr ><td width='*%' class='rep-body' style='{font:13px;text-align:center;}'>");
				out.println("<p>");
				out.println("<font face=\"FMBindumathi\">");
                out.println("<b><u>wjidk isysle|ùuhs'</u></b>"); // mod
				out.println("</p></font>");	
				out.println("</table>");
				...
				out.println("<p>");
				out.println("<font face=\"FMBindumathi\">");
                out.println("fï iïnkaOj wm úiska Tn fj;g tjk ,o mq¾j isysle|ùï iy$fyda ikaksfõokhkg jeäukla f,i");
				out.println("fuh ,shd okajkq ,efí' wm okajd isákafka Tn úiska tlS ±kqï§ï u.ska b,a,d isá mßÈ ksis mßÈ jdßl f.úï");
				out.println("isÿ lsßug ;jÿrg;a wiu;aj we;s nj;a\" th by; .súiqfï yrhd;aul wfmdfydi;a ùula njg m;aj we;s njhs'"); 
				out.println("</p></font>");	
				...
				out.println("<p>");
				out.println("<font face=\"FMBindumathi\">");
                out.println("ta wkqj by; l=,S iskaklalr .súiqfï kshuhka wkqj Tnf.ka wmfj; whúh hq;= ish¨u ys`. l=,S jdßl\" ta");
				out.println("u; jq ys`. fmd&lt;sho iu`. jq iuia: ysÕ uqo, fuu ,smsfha i`oyka Èk isg Èk y; ^07& la bl=;a ùug fmr");
				out.println("f.jk f,ig;a ta olajd jq ish¨u f.ùï isÿlrk f,ig;a Tng okajd isáuq'"); 
				out.println("</p></font>");	
				out.println("</table>"); // mod
				...
				out.println("<p>");
				out.println("<font face=\"FMBindumathi\">");
                out.println("tfia isÿlsßug Tn wiu;a jk wjia:djl § l=,sh wjika lsßug wjYH mshjr .kq ,nk njg;a\" tfia jqjfyd;a");
				out.println("l=,S iskaklalr .súiqfï kshuhkag wkqj wmf.a iud.u fj; Tnf.ka whúh hq;=j mj;sk iuia: uqo,");
				out.println("fmd&lt;sh iy wfkl=;a úhoï o iu`. whlrjd .ekSug;a\" l=,shg fok ,o jdykh$WmlrKh kej; w;am;a");
				out.println("lr .ekSug fyda tys jákdlu\" l=,sh wjika l&lt; Èkfha isg l=,shg ÿka jdykfha$WmlrKfha");
				out.println("ika;lh$N=la;sh Ndr fok f;la fyda kej; ,nd.kakd f;la jq w,dNhkao iu`. whlrjd .ekSu hk");
				out.println("m%;sM,hka w;aú§ug isÿjk njg wms Tng fuu.ska okajd isákafkuq' tfia fyhska tjka ;;a;ajhla");
				out.println("j,lajd,Sug wjYH kï by; b,a,d we;s mßos lghq;= lrk fuka o fuhska okajd isáñ'"); // mod
				out.println("</p></font>");	
				out.println("</table>");
				...
				out.println("<p>");
				out.println("<font face=\"FMBindumathi\">");
                out.println("msgm;a ( wemlrejka jk Tn úiska wod, ld, iSudj ;=&lt; f.ùï isÿjk njg úuid ne,Su iy f.ùï ksis mßos");
				out.println("isÿ lsÍug l=,S .eKqïlrej fm&lt;Uùu Tn i;= j.lSula jk njo fuhska oekqï fouq'"); // mod
				out.println("</p></font>");	
				out.println("</table>");
				...
				out.println("<p>");
				out.println("<font face=\"FMBindumathi\">");
                out.println("by; olajd we;s ysÕ uqo, iïmQ¾K jYfhka f.jd we;akï fuu ,smsh fkdi,ld yßk f,i okajd isáuq'"); // mod
				out.println("</p></font>");	
				out.println("</table>");
