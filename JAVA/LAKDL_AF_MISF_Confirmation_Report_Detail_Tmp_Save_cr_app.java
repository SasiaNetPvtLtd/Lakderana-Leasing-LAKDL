...
public class LAKDL_AF_MISF_Confirmation_Report_Detail_Tmp_Save_cr_app extends HttpServlet {
	...
	public synchronized void  service(HttpServletRequest req, HttpServletResponse res)	throws IOException{
		...
		try {
			...
			String m_row_id=(String)m_sn_methods.met_formdata(reqstr,"hid_row_id");
			...
			m_finance_no = m_sn_methods.met_formdata(reqstr,"hid_finance_no");
				...
				callstmt=conn.prepareCall("BEGIN "+m_schema_name+".AF_SAVE_CONF_RPT_GUAR_TMP_DEL("+
											":1"+													
											"); END;");
				...
				callstmt2=conn.prepareCall("BEGIN "+m_schema_name+".AF_CONF_RPT_GURA_SAVE_TMP("+
											":1,:2,:3,:4,:5,:6,:7,:8"+													
											"); END;");
				...
				for(int i=1; i<=m_guarantor_count; i++){
					...
					callstmt2.setString(3,m_sn_methods.met_formdata(reqstr,"TXT_GUARANTOR_AGREE_"+i)); 
					...
					callstmt2.setString(8,m_sn_methods.met_formdata(reqstr,"TXT_AGREE_ORDER_"+i)); 
					callstmt2.execute();
				}
				...
				callstmt1=conn.prepareCall("BEGIN "+m_schema_name+".AF_SAVE_CONFIRMATION_RPT_TMP("+
				...
				callstmt1.setString(100,m_sn_methods.met_formdata(reqstr,"hid_application_no")); // added by udara 18-07-2017
				
				callstmt1.setString(101,m_sn_methods.met_formdata(reqstr,"m_snap_position")); // added by udara 02-08-2017
				...
				*/
				...
				//out.println("window.location.href='"+m_url+"/LAKDL_AF_MISF_Confirmation_Report_Detail?chksql=main_page&finance_no="+m_finance_no+"';");
				...
				if(m_view_status.equals("view")){
					...
					//out.println("window.location.href='"+m_url+"/LAKDL_AF_MISF_Confirmation_Report_Detail_Snap?chksql=main_page&generate_status=R&finance_no="+m_finance_no+"';");
					out.println("window.location.href='"+m_url+"/LAKDL_AF_MISF_Confirmation_Report_Detail_Snap_cr_app?chksql=main_page&snap_view_status=Y&compare_status=Y&generate_status=R&view_only_status=N&snap_position="+m_snap_position+"&finance_no="+m_finance_no+"&row_id="+m_row_id+"';");
				}
