  ...
  public synchronized void service(HttpServletRequest req, HttpServletResponse res)
      ...
      //conn = DriverManager.getConnection("jdbc:oracle:thin:@147.120.40.1:1521:DN10G", "system", "sys123");
        ...
        out.println("        data_vec = new Array();");
			  ...
			  out.println("           }");
				...
				out.println("            document.Form1.LEAD_SOURCE_NAME.value =data_vec[14]");
       ...
       // out.println(" window.open(url)");
        ...
        out.println(" 	  document.Form1.NET_AMOUNT.disabled=false;");
		    ...
		    out.println(" }");
				...
				out.println("m_url = \"https://dev-lakdl.sasianet.com:/myserver/servlet/LAKDL_AF_MK_Price?chksql=main_page\";"); 
    ...
    //    out.println("   alert(document.Form1.ITEM_SUB_CAT.value);");
        ...
        out.println("                      '<tr class=tr_input><td >Variable Interest Margin</td>'+");
				...
				out.println(" document.Form1.LEAD_SOURCE_NAME.value =data[38]");
        ...
        out.println("<td>&nbsp;</td>");
				...
				*/
				...
				out.println("<td >");
				out.println("<input name=\"RATE\" type=\"text\" maxlength=\6\" class=\"txt_input\" value=18 onchange=format_num(document.Form1.RATE,0);cal_count()>");//format_num(document.Form1.RATE,0);
				out.println("</td>");
				out.println("</tr>");
				...
				out.println("<td>");
				out.println("<input name=\"PERIOD\" type=\"text\" maxlength=\"3\" class=\"txt_input\" value=48 onchange=format_num(document.Form1.PERIOD,0);cal_count()>");
		    ...
		    out.println("<input name=\"FIN_AMOUNT\" type=\"text\" maxlength=\"20\" class=\"txt_input\" STYLE=\"{text-align:right;}\" DISABLED>");
				...
				out.println("<td>");
				out.println("<input name=\"AMI\" type=\"text\" maxlength=\"2\" class=\"txt_input\" value=0 STYLE=\"{text-align:right;}\" onchange=format_num(document.Form1.AMI,0);cal_count()>");
				out.println("</td>");
				out.println("</tr>");
				/*
				out.println("<tr class=tr_input>");
        ...
        */ 
				...
				out.println("<td>");
				out.println("<input name=\"RESIDUAL_VALUE_T1\" type=\"text\" maxlength=\"20\" class=\"txt_input\" value=0 STYLE=\"{text-align:right;}\" onchange=format_num(document.Form1.RESIDUAL_VALUE_T1,0);cal_residual_bal()>");
				out.println("</td>");
				out.println("</tr>");
				//---------------------inditha 3-12-2007
				out.println("<tr class=tr_input>");
				...
				out.println("<td>");
				out.println("<input name=\"RESIDUAL_VALUE\" type=\"text\" maxlength=\"20\" class=\"txt_input\" value=0 STYLE=\"{text-align:right;}\" onchange=format_num(document.Form1.RESIDUAL_VALUE,0);cal_count();cal_residual_bal_rev();>");
				out.println("</td>");
				out.println("</tr>");
				/*
				out.println("<tr class=tr_input>");
