...
public class LAKDL_FA_OP_save_final_chq_return_rem_with_rk_count extends HttpServlet {
  ...
  String reqstr;
	...
	public synchronized void  service(HttpServletRequest req, HttpServletResponse res)	throws IOException{
      ...
      String m_username = m_sn_methods.username;
			...
			int m_num=0;
			int m_tnum=0;
			String m_return_no="",m_client_no="",m_debtor_code="",m_print="",m_receipt_no="",m_remark="",m_facility_no="";
			...
			//------------------------------------------------------------------------------------------
				...
				int tnum=0;
							...
							callstmt1.setString(3,"FINAL_CHEQ_RETURN_RM_WITH_R");
	   	...
	   	out.println("<HTML><HEAD>");
			...
			out.println("	m_url = \""+m_class_url+"/"+m_fschema_name+"FA_OP_Final_Chq_Return_Reminder_Letter_with_rem?chksql=main_page&client_no="+m_client_no+"&debtor_code="+m_debtor_code+"&print=FALSE&receipt_no="+m_receipt_no+"&remark="+m_remark+"&return_no="+m_return_no+"\";"); 
