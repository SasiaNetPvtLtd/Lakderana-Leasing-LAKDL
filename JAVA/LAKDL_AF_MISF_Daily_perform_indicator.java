...
public class LAKDL_AF_MISF_Daily_perform_indicator extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			if(m_chksql.equals("run_report")){ 
				...
				try{
					callstmt1 = conn.prepareCall("BEGIN "+m_schema_name+".AF_MISF_SAVE_DAILY_PERFORM_IND(:1,:2,:3);END;");
			...
			if(m_chksql.equals("main_page")){ 
				...
				out.println("<HTML>"); 
				out.println("<HEAD>"); 
				out.println("<TITLE>Collection - Daily Performance Indicator Dashborad</TITLE>"); 
				out.println("</HEAD>"); 
				...
				out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Daily_perform_indicator?chksql=run_report&date=\"+m_date+\"&location_id=\"+document.Form1.TXT_LOCATION_CODE.value;"); 
				...
				out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Daily_perform_indicator?chksql=print_report_new&location=\"+m_location+\"&date=\"+m_date;");	
				out.println("			window.open(m_url);");
				out.println("	}");
				out.println("}");
				...
				out.println("	m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Daily_perform_indicator?chksql=main_page&generate=drill_down_asset&finance_no=\"+m_finance_no;"); 
				...
				out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MISF_Daily_perform_indicator?chksql=main_page&generate=page';"); 
				out.println("		}"); 
				out.println("}"); 
				...
				out.println("help_box.innerHTML=\" Collection Process - Daily Performance Indicator Dashborad - \"+m_val;"); 
				out.println("}"); 
				out.println(""); 
				
				out.println("function load_roll_out_value(){");
				out.println("help_box.innerHTML=\" Collection Process - Daily Performance Indicator Dashborad - \"+document.Form1.hid_status.value;"); 
				out.println("}"); 
				...
				out.println("if(validate_data()){");
				out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Daily_perform_indicator?chksql=main_page&generate=print_report&location=\"+m_location+\"&officer=\"+m_officer+\"&date=\"+date;");	
				...
				out.println("</tr>"); 
				out.println("<tr>"); 
				out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Collection Process - Daily Performance Indicator Dashborad </td>"); 
				out.println("</tr>"); 
				out.println("<tr>"); 
				...
				*/
				...
				out.println("    m_order_by_type = 'ASC'; ");
				out.println("  }");
				// out.println("	m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Daily_perform_indicator?chksql=print_report_new&location="+m_location+"&officer="+m_officer+"&date="+m_date+"&sort_column=\"+m_sort_col+\"&order_by_type=\"+m_order_by_type;"); 
				out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Daily_perform_indicator?chksql=print_report_new&location="+m_location+"&officer="+m_officer+"&date="+m_date+"&sort_column=\"+m_sort_col+\"&order_by_type=\"+m_order_by_type;");	
				...
				out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Daily_perform_indicator?chksql=print_report_new_drill&location="+m_location+"&officer="+m_officer+"&date="+m_date+"&slab=\"+val;");	
				...
				rs=stmt.executeQuery("SELECT NVL("+m_schema_name+".AF_CO_GET_LOCATION_DESC('"+m_location+"'),'ALL'), "+
					" TO_CHAR(TO_DATE('"+m_date+"','DD-MM-YYYY'),'DD-MON-YYYY') "+
					" FROM DUAL ");
				...
				BigDecimal total_day_due = new BigDecimal(0.00);
				BigDecimal total_progressive_due = new BigDecimal(0.00);
				BigDecimal total_month_due = new BigDecimal(0.00);
				BigDecimal total_day_col = new BigDecimal(0.00);
				BigDecimal total_excess_paid = new BigDecimal(0.00);
				BigDecimal total_progressive_to_date = new BigDecimal(0.00);
				BigDecimal total_todate = new BigDecimal(0.00);
				BigDecimal total_day_col_perform = new BigDecimal(0.00);
				BigDecimal total_month_col_perform = new BigDecimal(0.00);
				BigDecimal total_total_branch_col = new BigDecimal(0.00);
				BigDecimal total_no_of_cases = new BigDecimal(0.00);
				BigDecimal total_new_cases = new BigDecimal(0.00);
				BigDecimal total_month_target = new BigDecimal(0.00);
				...
				if(m_location != null && !m_location.equals("")){
					out.println("<td width=\"100%\"  align='center' colspan='17' ><b>Daily Performance Indicator Dashboard - "+m_start_date+" - "+m_location_desc+"</b></td>"); 
				}else{
					out.println("<td width=\"100%\"  align='center' colspan='17' ><b>Daily Performance Indicator Dashboard - "+m_start_date+"</b></td>"); 
				}
				out.println("</tr>");
				
				out.println("<tr>");
				out.println("<td width=\"5%\"  align='center' rowspan='3' ><b>BRANCH</b></td>"); 
				out.println("<td width=\"100%\"  align='center' colspan='11' ><b>Collection Archievement</b></td>"); 
				out.println("<td width=\"100%\"  align='center' colspan='5' ><b>Lending Archievement</b></td>"); 
				out.println("</tr>");
				
				out.println("<tr>");; 
				out.println("<td width=\"100%\"  align='center' colspan='3' ><b>DUES</b></td>"); 
				out.println("<td width=\"100%\"  align='center' colspan='4' ><b>COLLECTION</b></td>"); 
				out.println("<td width=\"100%\"  align='center' colspan='4' ><b>COLLECTION PERFORMANCE</b></td>"); 
				out.println("<td width=\"100%\"  align='center' rowspan='2' ><b>No of cases(01 "+m_mon+")</b></td>"); 
				out.println("<td width=\"100%\"  align='center' rowspan='2' ><b>New Cases</b></td>"); 
				out.println("<td width=\"100%\"  align='center' rowspan='2' ><b>Month Target</b></td>"); 
				out.println("<td width=\"100%\"  align='center' colspan='2' ><b>Monthly Archievement</b></td>"); 
				
				out.println("</tr>");
				
				
				out.println("<td class='factoring-letter-body' STYLE='text-align:center;' ><b>Day</b></td>"); 
				out.println("<td class='factoring-letter-body' STYLE='text-align:center;'><b>Progressive</b></td>"); 
				out.println("<td class='factoring-letter-body' STYLE='text-align:center;'><b>Month</b></td>"); 
				out.println("<td class='factoring-letter-body' STYLE='text-align:center;'><b>Day</b></td>"); 
				out.println("<td class='factoring-letter-body' STYLE='text-align:center;'><b>Excess paid as at date</b></td>"); 
				out.println("<td class='factoring-letter-body' STYLE='text-align:center;'><b>Progressive todate</b></td>"); 
				out.println("<td class='factoring-letter-body' STYLE='text-align:center;'><b>Total todate</b></td>"); 
				out.println("<td class='factoring-letter-body' STYLE='text-align:center;'><b>Day</b></td>"); 
				out.println("<td class='factoring-letter-body' STYLE='text-align:center;'><b>Progressive</b></td>"); 
				out.println("<td class='factoring-letter-body' STYLE='text-align:center;'><b>Month</b></td>");
				out.println("<td class='factoring-letter-body' STYLE='text-align:center;'><b>Total Branch Collection</b></td>"); 
				out.println("<td class='factoring-letter-body' STYLE='text-align:center;'><b>Amount</b></td>");
				...
				while(more){
					...
					out.println("<td  class=factoring-letter-body   STYLE='{text-align:right;}'  >"+nf.format(rs.getBigDecimal(6).add(rs.getBigDecimal(7)))+"</td>");
					
					if(rs.getBigDecimal(2).signum() !=0){
						out.println("<td  class=factoring-letter-body   STYLE='{text-align:right;}'  >"+nf.format(rs.getBigDecimal(5).multiply(new BigDecimal(100)).divide(rs.getBigDecimal(2),BigDecimal.ROUND_HALF_EVEN))+"%</td>");
					}
					else{
						out.println("<td  class=factoring-letter-body   STYLE='{text-align:right;}'  >"+nf.format(0.00)+"%</td>");
					}
					
					if(rs.getBigDecimal(3).signum() !=0){
						out.println("<td  class=factoring-letter-body   STYLE='{text-align:right;}'  >"+nf.format(rs.getBigDecimal(7).multiply(new BigDecimal(100)).divide(rs.getBigDecimal(3),BigDecimal.ROUND_HALF_EVEN))+"%</td>");
					}
					else{
						out.println("<td  class=factoring-letter-body   STYLE='{text-align:right;}'  >"+nf.format(0.00)+"%</td>");
					}
					...
					if(rs.getBigDecimal(4).signum() !=0){
						out.println("<td  class=factoring-letter-body   STYLE='{text-align:right;}'  >"+nf.format(rs.getBigDecimal(6).multiply(new BigDecimal(100)).divide(rs.getBigDecimal(4),BigDecimal.ROUND_HALF_EVEN))+"%</td>");
					}
					else{
						out.println("<td  class=factoring-letter-body   STYLE='{text-align:right;}'  >"+nf.format(0.00)+"%</td>");
					}
					...
					total_day_due = total_day_due.add(rs.getBigDecimal(2));
					total_progressive_due = total_progressive_due.add(rs.getBigDecimal(3));
					total_month_due = total_month_due.add(rs.getBigDecimal(4));
					total_day_col = total_day_col.add(rs.getBigDecimal(5));
					total_excess_paid = total_excess_paid.add(rs.getBigDecimal(6));
					total_progressive_to_date = total_progressive_to_date.add(rs.getBigDecimal(7));
					total_todate = total_todate.add(rs.getBigDecimal(6).add(rs.getBigDecimal(7)));
					total_total_branch_col = total_total_branch_col.add(rs.getBigDecimal(8));
					total_no_of_cases = total_no_of_cases.add(rs.getBigDecimal(9));
					total_new_cases = total_new_cases.add(rs.getBigDecimal(10));
					total_month_target = new BigDecimal(0.00);
					total_amount = new BigDecimal(0.00);
				...
				if(count>0){
					...
					out.println("<td class=factoring-letter-body  STYLE='{text-align:left;}'   ><b>OVERALL CORPORATE</b></td>"); 
					out.println("<td class=factoring-letter-body STYLE='{text-align:right;}'   ><b>"+nf.format(total_day_due)+"</b></td>"); 
					out.println("<td class=factoring-letter-body STYLE='{text-align:right;}'   ><b>"+nf.format(total_progressive_due)+"</b></td>"); 
					out.println("<td class=factoring-letter-body STYLE='{text-align:right;}'   ><b>"+nf.format(total_month_due)+"</b></td>"); 
					out.println("<td class=factoring-letter-body STYLE='{text-align:right;}'   ><b>"+nf.format(total_day_col)+"</b></td>"); 
					out.println("<td class=factoring-letter-body STYLE='{text-align:right;}'   ><b>"+nf.format(total_excess_paid)+"</b></td>"); 
					out.println("<td class=factoring-letter-body STYLE='{text-align:right;}'   ><b>"+nf.format(total_progressive_to_date)+"</b></td>"); 
					out.println("<td class=factoring-letter-body STYLE='{text-align:right;}'   ><b>"+nf.format(total_todate)+"</b></td>"); 
					
					if(total_day_due.signum() !=0){
						out.println("<td class=factoring-letter-body STYLE='{text-align:right;}'   ><b>"+nf.format(total_day_col.multiply(new BigDecimal(100)).divide(total_day_due,BigDecimal.ROUND_HALF_EVEN))+"%</b></td>"); 
					}
					else{
						out.println("<td  class=factoring-letter-body   STYLE='{text-align:right;}'  >"+nf.format(0.00)+"%</td>");
					}
					
					if(total_progressive_due.signum() !=0){
						out.println("<td class=factoring-letter-body STYLE='{text-align:right;}'   ><b>"+nf.format(total_todate.multiply(new BigDecimal(100)).divide(total_progressive_due,BigDecimal.ROUND_HALF_EVEN))+"%</b></td>"); 
					}
					else{
						out.println("<td  class=factoring-letter-body   STYLE='{text-align:right;}'  >"+nf.format(0.00)+"%</td>");
					}
					...
					if(total_month_due.signum() !=0){
						out.println("<td class=factoring-letter-body STYLE='{text-align:right;}'   ><b>"+nf.format(total_todate.multiply(new BigDecimal(100)).divide(total_month_due,BigDecimal.ROUND_HALF_EVEN))+"%</b></td>"); 
					}
					else{
						out.println("<td  class=factoring-letter-body   STYLE='{text-align:right;}'  >"+nf.format(0.00)+"%</td>");
					}
					...
					out.println("<td class=factoring-letter-body STYLE='{text-align:right;}'   ><b>"+nf.format(total_total_branch_col)+"</b></td>"); 
					out.println("<td class=factoring-letter-body STYLE='{text-align:right;}'   ><b>"+nf1.format(total_no_of_cases)+"</b></td>"); 
					out.println("<td class=factoring-letter-body STYLE='{text-align:right;}'   ><b>"+nf1.format(total_new_cases)+"</b></td>"); 
				...
				Sql_data="   SELECT NVL("+m_schema_name+".AF_CO_GET_LOCATION_DESC(A.LOCATION),'-'), SUM(A.total_rental), A.total_no_of_cases, SUM(A.tot_1_to_10_cases), "+
					...
					"    WHERE A.ENTER_USER ='"+m_username+"' AND A.ENTER_DATE = TO_DATE('"+m_date+"','DD-MM-YYYY') AND A.LOCATION LIKE  '%"+m_location+"%'  "+
