...
public class LAKDL_FA_MISF_factor_debtor_list_report extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Factor Debtor List Report </TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"FA_MISF_reports?chksql=LOAD_FACTOR_DEBTOR_LIST_REPORT&client_type=\"+document.Form1.TXT_CLIENT_TYPE.value+\"&status=\"+document.Form1.TXT_CLIENT_STATUS.value+\"&client_code=\"+document.Form1.TXT_CLIENT_CODE.value;");
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"FA_MISF_factor_debtor_list_report';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("	help_box.innerHTML=\" Factor Debtor List Report - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\" Factor Debtor List Report \";"); 
			out.println("}"); 
	  	...
	  	out.println("					}"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Factor Debtor List Report </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
