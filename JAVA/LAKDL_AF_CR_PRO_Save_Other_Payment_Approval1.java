...
public class LAKDL_AF_CR_PRO_Save_Other_Payment_Approval1 extends HttpServlet {
...
//			PrintStream out = new PrintStream(res.getOutputStream());
	 //   out.println(reqstr);
      ...
      String m_scr_name=(String)m_sn_methods.met_formdata(reqstr,"Hid_scr_name"); 
			...
			callstmt=conn.prepareCall("BEGIN "+m_schema_name+".AF_CR_PRO_SAVE_OTH_PAY_APPRO1(:1,:2,:3,:4); END;");
			for (int j = 0; j < m_maxentries; j++) {
			        ...
			        String m_chk_required =(String)m_sn_methods.met_formdata(reqstr,"CHK_REQUIRED"+(Integer.toString(j)));
							...
							callstmt.setString(2,m_sn_methods.met_formdata(reqstr,"TXT_APPROVE_TYPE"+(Integer.toString(j))));
		...
		//	out.println("else");
			out.println("window.location.href='"+m_url+"/"+m_client_name+"AF_CR_PRO_Other_Payments_Approval1?chksql=main_page';");
