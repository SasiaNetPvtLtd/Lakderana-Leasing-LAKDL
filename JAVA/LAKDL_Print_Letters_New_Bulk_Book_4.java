...
class LAKDL_Print_Letters_New_Bulk_Book_4 implements Printable {
	...
	// public LAKDL_Print_Letters_New_Bulk_Book_4(String m_rec, String m_client_code){ // commented by udara 05-11-2019
	public LAKDL_Print_Letters_New_Bulk_Book_4(String m_rec, String m_client_code, String m_statement_date){ // added by udara 05-11-2019
	...
	public int print (Graphics g,PageFormat pageFormat, int page) {
		...
		//	System.out.println("sql Contract_Client_Data ==> "+Contract_Client_Data);
			...
			String arrearsDetails =" SELECT "+
				...
				" WHERE A.FINANCE_NO='"+m_application_no+"' "+
				" AND A.REMINDER_TYPE = 'NOTTERM' "+ // added by udara 05-11-2019 
	...
	/*		line = new AttributedString(m_contact_full_name + m_print_method.Add_Space(15)+ m_application_no + m_print_method.Add_Space(10) + m_vehicle_no + m_print_method.Add_Space(10) + m_Letter_date +m_print_method.Add_Space(10)+nf.format(arr_amount));
		...
		*/
		...
		//	System.out.println("line_4="+drawPosY);
			...
			//line = new AttributedString("l=,S iskaklalr .súiqfï kshufhka$fldkafoais lv lsÍu fya;=fjka ixfYdaê; 1982 wxl 29 orK mdßfNda.sl Kh mkf;a 18^2& j.ka;sh hgf;a l=,sh wjika lrkq ,nk njg jq ±kaùuhs'");
		...
		/*	data= "wms Tn fj; fuu.ska okajd isákafka Tn úiska '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''' isÿ"+
		 ...
		 */	
		    data= "wms úiska kej; kej; lrk ,o b,a,Sï iy isysle|ùï ms<snoj fkdi,ld yßñka Wla; l=,S "+
					...
					//"wjika lsßug wms úiska mshjr .kq ,nk nj fuu.ska Tn fj; okajd isákafkuq' ta wkqj m%udohlska "+ // commented by udara 12-06-2019
					"wjika lsßug wms úiska mshjr .kq ,nk nj fuu.ska Tn fj; okajd isákafkuq' ta wkqj   m%udohlska "+ // added by udara 12-06-2019
					"f;drj by; lS ys`. uqo, f.jd ksu lsßug läkñka mshjr .kq ,nk fuka wms Tn fj; ldreKslj "+
					//"Wmfoia ,nd fokafkuq'"; // commented by udara 12-06-2019
					"Wmfoia   ,nd fokafkuq'"; // added by udara 12-06-2019
		...
		/*	data1= "ta wkqj\" wm fuu.ska Tn fj; m%ldY lr isákafka fuu ,smsh ,eî Èk 30 la blau ùug fmr by; lreK"+
					...
					" njhs' tneúka\" jeäÿr m%udohlska f;drj tlS lvlsßu h:dj;a lsßu i|yd lghq;= i,ik fuka wms fuu.ska"+
					" Tn fj; oekqï fouq'"; 
		 */
		   data1= "wemlrejka jk Tn úiska tlS ld, iSudj ;=< ksis mßos f.ùï isÿ lsÍug l=,S .eKqïlrej fm<Uùug "+
					//"fyda Tn úiska f.ùï isÿ lsÍug lghq;= lrk f,i fuhska ±kqï fouq' tfia lghq;= fkdlrkafka kï "+ // commented by udara 12-06-2019
					"fyda Tn úiska   f.ùï isÿ lsÍug lghq;= lrk f,i fuhska ±kqï fouq' tfia lghq;= fkdlrkafka kï "+ // added by udara 12-06-2019
