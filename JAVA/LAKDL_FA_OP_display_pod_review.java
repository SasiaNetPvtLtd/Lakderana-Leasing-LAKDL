...
public class LAKDL_FA_OP_display_pod_review extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Operation Process - Post Dated Cheque Review</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"FA_OP_PRO_sql_validations_normal?chksql=LOAD_POD_CHEQUE_REVIEW&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"\";");
			...
			out.println("			}");
			out.println("			if(validate_data()){"); 
			out.println("				document.Form1.action='"+m_class_url+"/"+m_fschema_name+"FA_OP_save_pod_review';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"FA_OP_display_pod_review';"); 
			out.println("		}"); 
			out.println("}"); 
	  	...
	  	out.println("					}"); 
			...
			out.println("<INPUT TYPE='Hidden' NAME='Hid_scr_name' VALUE=\"FA_OP_POD_REVIEW\">"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Operation Process - Post Dated Cheque Review </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
