...
public class LAKDL_AF_MAS_save_group_user extends HttpServlet {
		
	Connection conn;	
	String m_msg,m_url;
	CallableStatement callstmt,callstmt2,callstmt3; // callstmt3 added by udara 18-02-2015
  ...
  String reqstr;
	...
	public synchronized void  service(HttpServletRequest req, HttpServletResponse res)	throws IOException{
      ...
      String m_scr_name=(String)m_sn_methods.met_formdata(reqstr,"Hid_scr_name"); 
			...
			callstmt=conn.prepareCall("BEGIN "+m_schema_name+".AF_MAS_SAVE_GROUP_USER(:1,:2,:3,:4,:5); END;");
			
			callstmt2 = conn.prepareCall( "BEGIN  "+m_schema_name+".AF_MAS_GROUP_MAINTENANCE(?,?,?,?,?,?);END;");
			
			

       String m_user_id = m_sn_methods.met_formdata(reqstr,"TXT_GROUP_ID");
			 String m_name = m_sn_methods.met_formdata(reqstr,"TXT_GROUP_DESC");
          ...
          if(pstmt!=null){try{pstmt.close();}catch(Exception e){}};
				...
				// added by udara 18-02-2015
				callstmt3 = conn.prepareCall( "BEGIN  "+m_schema_name+".AF_MAS_GROUP_MAINTAIN_ALL_USER(?);END;");
				callstmt3.setString(1,m_user_id);
				callstmt3.execute();
				callstmt3.close();
				// end by udara 18-02-2015
	   	...
	   	out.println("<HTML><HEAD>");
			...
			out.println("window.location.href='"+m_url+"/"+m_client_name+"AF_MAS_display_group_user';");   //modified by nwuan de silva 22-11-2007
