...
public class LAKDL_AF_CR_PRO_Enter_Seizer_details extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res) { 
		...
		//	String m_html_client_url = m_sn_methods.html_client_url;
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE> Credit - Enter Seizer Details </TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("}");
				...
				out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_CR_PRO_Enter_Seizer_details?chksql=main_page';"); 
				out.println("		}"); 
				out.println("}"); 
				...
				out.println("help_box.innerHTML=\" Credit - Enter Seizer Details - \"+m_val;"); 
				out.println("}"); 
		
				out.println("function load_roll_out_value(){");
				out.println("help_box.innerHTML=\" Credit - Enter Seizer Details  \";"); 
				out.println("}"); 
			...
			out.println("}"); 
					...
					out.println("    HelpBox('1','10','0',Crit,'m_help_TXT_SIEZER_CODE_LOAD_EDIT','99');");
					out.println("  }");
					out.println("  else{");
					out.println("    document.Form1.hid_help_type.value=\"99\";"); 
					...
					out.println("     return false;"); 
					out.println("  }"); 
					out.println("  else if(document.Form1.TXT_APPLICANT_CODE.value==\"\"){  "); 
					out.println("    DIV_TXT_APPLICANT_CODE.style.color='red';");
					out.println("    return false;"); 
					out.println("  }"); 
					out.println("  else if(document.Form1.TXT_SIEZER_CODE.value==\"\"){  "); 
					out.println("    DIV_TXT_SIEZER_CODE.style.color='red';");
					out.println("    return false;"); 
					out.println("  }"); 
					out.println("  else{"); 
					...
					out.println("		   document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_CR_PRO_Enter_Seizer_details_save';");  
					...
					out.println("</tr>"); 
					out.println("<tr>"); 
					out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Credit - Enter Seizer Details</td>"); 
					out.println("</tr>"); 
					out.println("<tr>"); 
					...
					out.println("<td width='35%' ><input class='txt_input' type='text' name='TXT_APPLICATION_NO' maxlength='15' size='15' onblur=\"help_update('1','10','5','m_help_TXT_SIEZER_CODE_LOAD','99')\">"); 
					out.println("<input class='but_input' type='button' name='BUT_HELP_MAIN' value=\"...\" onClick=\"help_update('1','10','5','m_help_TXT_SIEZER_CODE_LOAD','99')\" ></td>");  // 
					out.println("</tr>"); 
					out.println("<tr >"); 
