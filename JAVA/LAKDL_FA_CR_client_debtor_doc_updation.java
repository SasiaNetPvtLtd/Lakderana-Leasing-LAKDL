...
public class LAKDL_FA_CR_client_debtor_doc_updation extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Credit Process - Client - Debtor Document Updation  </TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("			}");
			out.println("			if(validate_data()){"); 
			out.println("				document.Form1.action='"+m_class_url+"/"+m_fschema_name+"FA_CR_save_client_debtor_doc_updation';");  
			...
			out.println("	help_box.innerHTML=\" Credit Process - Client - Debtor Document Updation - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\" Credit Process - Client - Debtor Document Updation - \";"); 
			out.println("}"); 
			...
			out.println(" 	m_sql = \"m_help_DIV_TXT_CLIENT_DEBTOR_DOC_UPDATE_sql\";"); 
      ...
      out.println(" document.Form1.hid_cal_date.value=num;"); 
  		...
  		out.println("		}");
   		...
   		out.println("}"); 
			...
			out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"FA_CR_PRO_sql_validations_normal?chksql=LOAD_APPLICABLE_DOCS_CLIENT_DEBTOR_LIST&DEBTOR_CODE=\"+document.Form1.TXT_DEBTOR_CODE.value+\"&CLIENT_CODE=\"+document.Form1.TXT_CLIENT_CODE.value+\"&FACILITY_NO=\"+document.Form1.TXT_FACILITY_NO.value;");
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Credit Process - Client - Debtor Document Updation  </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<td width='20%' ><input class='txt_input' type='text' name='TXT_DEBTOR_CODE' maxlength='10' size='10' onblur=\"help_update_client()\">"); 
