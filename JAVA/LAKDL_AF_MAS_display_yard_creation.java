...
//--
//SCREEN NAME:SYSTEM ADMINISTRATION - YARD CREATION
//CREATED BY:
//DATE/TIME:
//NOTES:
...
public class LAKDL_AF_MAS_display_yard_creation extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>System Administration - Creation of Yards</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("else if(data_vec.length==0 && document.Form1.SCREEN_NAME.value!=\"NEW\" && document.Form1.TXT_YARD_CODE.value!='' && document.Form1.hid_val.value=='t1'){");
		/*	out.println("alert('Selected Yard code is incorrect,use help...!')");
			out.println("    document.Form1.TXT_YARD_CODE.value='';"); 
			out.println("    document.Form1.TXT_YARD_CODE.focus();"); 
			...
			out.println("document.Form1.TXT_TEL_NO.value=data_vec[5];"); 
			out.println("document.Form1.TXT_FAX_NO.value=data_vec[6];"); 
			out.println("document.Form1.TXT_DEFAULT_VALUE.value=data_vec[7];");
			//out.println("document.Form1.BUT_CITY_CODE.value=data_vec[8];");
			out.println("}");
		...
		//	out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_yard_creation&data_val=\"+obj.value+\"&ac_status=\"+document.Form1.hid_st.value;");
			//out.println("window.open(m_url)");
			
			
			out.println("    if(document.Form1.SCREEN_NAME.value==\"NEW\" && document.Form1.hid_val.value=='t1' ){");
			out.println("    m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations1?chksql=m_prime_chk_LAKDL_AF_MAS_display_yard_creation_code&data_val=\"+obj.value;");
			out.println("}");
			out.println("    else");
			out.println("    if(document.Form1.SCREEN_NAME.value!=\"NEW\" && document.Form1.hid_val.value=='t1' ){");
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_yard_creation&data_val=\"+obj.value+\"&ac_status=\"+document.Form1.hid_st.value;");
			...
			out.println("if(document.Form1.TXT_YARD_CODE.value==\"\"){  "); 
			...
			out.println("}");
			out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_MAS_save_yard_creation';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MAS_display_yard_creation';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("    m_help_message = \"m_help_msg_LAKDL_AF_MAS_display_yard_creation\";"); 
			...
			out.println("help_box.innerHTML=\" System Administration - Creation of Yards - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" System Administration - Creation of Yards - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
	  	...
	  	out.println("		}"); 
			...
			out.println("    } ");
			out.println("    else{");
			out.println("    m_criteria = document.Form1.TXT_YARD_CODE.value+\"@\"+\"N@\";}"); 
			...
			out.println("    document.Form1.TXT_TEL_NO.value=oBj.valout[7];"); 
			out.println("    document.Form1.TXT_FAX_NO.value=oBj.valout[8];"); 
			...
			out.println("    \"&Sql_in=\"+m_sql+\"&Start_in=\"+Start+"); 
			out.println("    \"&End_in=\"+End+\"&Crit_In=\"+m_criteria+"); 
			out.println("    \"&Hid_No=\"+Hid_No, oBj,\"dialogWidth:44em; dialogHeight:25em; center:yes; status:no\");"); 
			out.println("	"); 
			out.println("	if(oBj.valout[1] !=\" \"){"); 
			out.println("	if(oBj.valout[1] !=\"Close\"){"); 
			out.println("	if(oBj.valout[1]!=\"Prev\"){"); 
	  	...
	  	out.println("		}"); 
			...
			out.println("    m_sql = \"m_view_TXT_YARD_CODE_sql\";");
			out.println("    m_criteria = document.Form1.TXT_YARD_CODE.value+\"@\"+\"Y@\";"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>System Administration - Creation of Yards</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<td width='30%' ><DIV id='DIV_TXT_YARD_CODE'  class=div_input>Yard Code *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_YARD_CODE' maxlength='10' size='10' onblur=\"assig('t1'),makeRequest(document.Form1.TXT_YARD_CODE)\">"); 
			...
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_NAME' maxlength='200' size='200'></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 

			out.println("<td width='30%' ><DIV id='DIV_TXT_ADDRESS1'  class=div_input>Address 1 *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_ADDRESS1' maxlength='100' size='100'></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 

			out.println("<td width='30%' ><DIV id='DIV_TXT_ADDRESS2'  class=div_input>Address 2 *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_ADDRESS2' maxlength='100' size='100'></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_TEL_NO' maxlength='60' size='60'></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 

			out.println("<td width='30%' ><DIV id='DIV_TXT_FAX_NO'  class=div_input>Fax No *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_FAX_NO' maxlength='60' size='60'></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 
