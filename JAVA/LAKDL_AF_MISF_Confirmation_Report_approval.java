...
public class LAKDL_AF_MISF_Confirmation_Report_approval extends javax.servlet.http.HttpServlet { //LAKDL_AF_CR_PRO_Enter_Deletion_letter_details_app
	...
	public void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { // added by udara 18-05-2017
		...
		try { 
			...
			if(m_chksql.equals("main_page")){
				out.println("<HTML>"); 
				out.println("<HEAD>"); 
				out.println("<TITLE>Confirmation Report Approval </TITLE>"); 
				out.println("</HEAD>"); 
				...
				out.println("      m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Confirmation_Report_approval?chksql=details&status=\"+document.Form1.hid_status.value+\"&APPLICATION_NO=\"+document.Form1.TXT_APP_NO.value;"); 
				...
				out.println("			window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MISF_Confirmation_Report_approval?chksql=main_page';"); 
				out.println("		}"); 
				out.println("}"); 
				...
				out.println("   help_box.innerHTML=\" Confirmation Report Approval  - \"+m_val;"); 
				out.println("}"); 
				out.println(""); 
				
				out.println("function load_roll_out_value(){");
				out.println("help_box.innerHTML=\" Confirmation Report Approval  - \"+document.Form1.hid_status.value;"); 
				out.println("}"); 
				...
				//out.println("if(b_flag==0){"); // commented by udara 03-07-2015
				...
				//out.println("		if(validate_data()){");	
				out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_MISF_Confirmation_Report_approval_save';");  
				...
				out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Confirmation_Report_Detail_View_app_1?chksql=main_page&finance_no=\"+val; ");
				...
				// added by udara 07-07-2017
				out.println("function load_details_report_new(val,row){"); 
				out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Confirmation_Report_Detail_Snap?chksql=main_page&snap_view_status=N&compare_status=Y&generate_status=R&view_only_status=N&snap_position=APPROVE1&finance_no=\"+val+\"&row_id=\"+row; ");
				out.println("window.open(m_url,'popupwin_conf_rpt_app_1','left=110,top=110,width=750,height=800,toolbar=0,location=0,directories=0,status=0,menuBar=1,scrollBars=1,resizable=1')");
				out.println("} "); 
				// end by udara 07-07-2017
				...
				out.println("<INPUT TYPE='Hidden' NAME='hid_scr_url'    VALUE=\"LAKDL_AF_MISF_Confirmation_Report_approval\" >"); // added by udara 13-06-2017
				...
				out.println("<INPUT TYPE='Hidden' NAME='hid_stage' VALUE=\"APPROVE_1\" >"); // added by udara 23-06-2017
				...
				out.println("</tr>"); 
				out.println("<tr>"); 
				out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Confirmation Report Approval </td>"); 
				out.println("</tr>"); 
				out.println("<tr>"); 
				...
				//out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Assign\");'  onClick='before_submit_assign_me()' name=\"MAIN_BUT_ASSIGN_ME\" value=\"Save Assign\"></td>"); // commented by udara 19-07-2017 // added by udara 23-06-2017
				...
				rs=stmt.executeQuery(" "+ 								
					...
					//" NVL(CONF_RPT_COMMENT,'-')  "+ // added by udara 30-06-2015 " '-' "+ 
					//" NVL(APP_COMMENT,CONF_RPT_COMMENT)  "+ // added by udara 30-06-2015 " '-' "+ 
				...
				if(more){	
					...
					//out.println("<td  width='5%' > Assign </td>"); // commented by udara 19-07-2017 // added by udara 23-06-2017
					//out.println("<td  width='5%' > Un Assign </td>"); // commented by udara 19-07-2017  // added by udara 23-06-2017
					...
					while(more){
						...
						out.println("<tr style=\"color:'"+rs.getString(12)+"';\" >");
						...
						out.println("<td  width='10%' STYLE='{text-align:left;cursor:pointer;}' onClick=drilldown('"+rs.getString(1)+"')><u>"+rs.getString(6)+" - "+rs.getString(8)+"</u></td>");
						//out.println("<td  width='10' align=center><input type='button' name='DETA_BUTTON_"+j+"' value='View' class='but_input' onClick=load_details_report('"+rs.getString(1)+"') ></td>"); // commented by udara 06-07-2017
						
						// added by udara 06-07-2017
						out.println("<td  width='10' align=center>");
						out.println("<input type='button' name='DETA_BUTTON_"+j+"' value='View' class='but_input' onClick=load_details_report_new('"+rs.getString(1)+"','"+j+"') >");
						//out.println("<input type='button' name='DETA_BUTTON_"+j+"' value='View' class='but_input' onClick=load_details_report('"+rs.getString(1)+"') >");
						//out.println("<input type='button' name='DETA_BUTTON_NEW_"+j+"' value='View-New' class='but_input' onClick=load_details_report_new('"+rs.getString(1)+"') >");
						out.println("</td>");
						// end by udara 06-07-2017
						...
						//out.println("<td  width='10' align=center><input type='button' name='FEASIBILITY_BUTTON_"+j+"' value='View' class='but_input' onClick=show_feasibility_report('"+rs.getString(1)+"') ></td>"); // commented by udara 09-10-2015
						
						// added by udara 09-10-2015
						...
						//out.println("<td  width='5%' align=center><input type='checkbox' name='CHK_ASSIGN_ME_"+j+"'    value ='on' onclick=\"check_assign_me("+j+",'assign');\" ></td>"); // commented by udara 19-07-2017  // added by udara 23-06-2017
						//out.println("<td  width='5%' align=center><input type='checkbox' name='CHK_UN_ASSIGN_ME_"+j+"' value ='on' onclick=\"check_assign_me("+j+",'un_assign');\" ></td>"); // commented by udara 19-07-2017  // added by udara 23-06-2017
						
						
						out.println("<td  width='5%' align=center><input type='checkbox' id='CHK_"+j+"' name='CHK_"+j+"' value ='off' onclick=\"check_status_app("+j+");\" disabled ></td>"); // re-enabled by udara 19-07-2017 // commented by udara 16-06-2017
						
						// commented by udara 19-07-2017
						/*
						// added by udara 13-06-2017
						if (rs.getString(9).equals("READY")){
							out.println("<td  width='5%' align=center><input type='checkbox' name='CHK_"+j+"' value ='off' onclick=\"check_status_app("+j+");\" ></td>"); // commented by udara 16-06-2017	
						}
						else{
							out.println("<td  width='5%' align=center><input type='checkbox' name='CHK_"+j+"' value ='off' onclick=\"check_status_app("+j+");\" disabled ></td>"); // commented by udara 16-06-2017
						}					
						// end by udara 13-06-2017
						*/
