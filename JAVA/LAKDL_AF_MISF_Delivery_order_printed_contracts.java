...
public class LAKDL_AF_MISF_Delivery_order_printed_contracts extends javax.servlet.http.HttpServlet {
	/*
	...
	*/
		...
		try {
			...
			if(m_chksql.equals("main_page")){ 
				...
				out.println("help_box.innerHTML=\"  Delivery order printed contracts - \"+m_val;"); 
				out.println("}"); 
				out.println(""); 
				
				out.println("function load_roll_out_value(){");
				out.println("help_box.innerHTML=\"  Delivery order printed contracts - \"+document.Form1.hid_status.value;"); 
				out.println("}"); 
				...
				out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MISF_Delivery_order_printed_contracts?chksql=main_page';"); 
				out.println("		}"); 
				out.println("}"); 
				...
				out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Delivery_order_printed_contracts?chksql=\"+chkSql+\"&branch_code=\"+m_branch_code+\"&from_date=\"+m_from_date+\"&to_date=\"+m_to_date;");
				...
				out.println("</tr>");
				out.println("<tr>");
				out.println("<td align=\"left\" class=\"pdn_txtpos2\" style=\"height: 18px\" id=help_box> Delivery order printed contracts </td>");
				out.println("</tr>");
				out.println("<tr>");
				...
				*/
				...
				out.println("<TR><TD align='Center' class=factoring-letter-body><B> Delivery order printed contracts</B></TD></TR>");
				out.println("</TABLE>");
				...
				out.println("<td width='10%'    align=center><DIV class=factoring-letter-body><b>DO Issued Date<DIV></td>");
				out.println("<td width='10%'    align=center><DIV class=factoring-letter-body><b>DO No</b></DIV></td>");
				out.println("<td width='10%'    align=center><DIV class=factoring-letter-body><b>Serial No</b></DIV></td>");
				out.println("<td width='10%'    align=center><DIV class=factoring-letter-body><b>Contract No. </b></DIV></td>");
				out.println("<td width='10%'    align=center><DIV class=factoring-letter-body><b>Vendor Name </b></DIV></td>");
				out.println("<td width='10%'    align=center><DIV class=factoring-letter-body><b>Chassis No. </b></DIV></td>");
				out.println("<td width='10%'    align=center><DIV class=factoring-letter-body><b>Issued Person Name </b></DIV></td>");
				out.println("<td width='10%'    align=center><DIV class=factoring-letter-body><b>Print - Copy </b></DIV></td>");
				out.println("</tr>");

				// added by udara 06-05-2015
				rs= stmt.executeQuery(" "+
					" SELECT "+
						" TO_CHAR(PRINT_DATE,'DD-MM-YYYY'), "+
						" DO_CODE, "+
						" FINANCE_NO, "+
						" VENDOR_NAME, "+
						" CHASSIS_NO, "+
						...
						" CLIENT_CODE, "+
						" APPLICATION_NO, "+
						" BRANCH_CODE||' '||SERIAL_NO||' '||NVL(COPY_STATUS,' ') SERIAL_NO "+
							" FROM "+m_schema_name+".AF_CR_PRO_DELIVERY_ORD "+
							" WHERE PRINT_DATE >= TO_DATE('"+m_from_date+"','DD-MM-YYYY') "+
							" AND PRINT_DATE   <= TO_DATE('"+m_to_date+"','DD-MM-YYYY') "+
				...
				try{
					...
					while(rs.next()){
						...
						out.println("<td width='10%' class=factoring-letter-body style=cursor:hand onClick=\"show_transaction_history_new('"+rs.getString(7)+"','"+rs.getString(3)+"')\"><u>"+rs.getString(3)+"</u></td>");
						...
						out.println("<td width='10%' class=factoring-letter-body align='left'> <input class='but_input' type='button' name='BUT_PRINT_DEL_ORDER' id='BUT_PRINT_DEL_ORDER' value='Print' onClick=\"load_documents('"+rs.getString(8)+"','"+rs.getString(7)+"','"+rs.getString(2)+"');\" > </td>");
						out.println("</tr>");
					}
