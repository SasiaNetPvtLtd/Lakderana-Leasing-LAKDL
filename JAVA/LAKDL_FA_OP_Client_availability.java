...
public class LAKDL_FA_OP_Client_availability extends javax.servlet.http.HttpServlet { 

	ServletOutputStream out = null;
	public String m_chksql=""; // Added by Udara Somathilke on 30-03-2010
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			//m_chksql=req.getParameter("chksql"); // Added by Udara Somathilke on 30-03-2010
			
			
			
					m_chksql=req.getParameter("chksql");
				if(m_chksql!=null){
					if (m_chksql.equals("CHK_CLIENT_AVB")) {
			...
			out.println("function on_load_rep() {");
			out.println("   mchksql = '"+m_chksql+"';");
			out.println("   if(mchksql!='null')");
			out.println("	 {");
			//out.println("      alert('"+m_client_code+"'+'   '+'"+m_facility_no+"');");
			out.println("      document.Form1.TXT_CLIENT_CODE.value = '"+m_client_code+"';");
			out.println("      document.Form1.TXT_FACILITY_NO.value = '"+m_facility_no+"';");
		...
		/*	out.println("function get_vector(data_vec) {");
     	...
     	out.println("		document.Form1.TXT_ADJ_DD.value=v_dd;");
   		...
   		out.println("   document.Form1.TXT_ADJ_YY.value=v_yy;");
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"FA_OP_Client_availability';"); 
			out.println("		}"); 
			out.println("}"); 
	  	...
	  	out.println("					}"); 
			...
			out.println("function load_availability_drill_inv_reasign(m_client,m_facility,m_option,date) {");//Added By Sandun on 01-09-2009
			out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"FA_OP_PRO_sql_client_availability_new_scr_drill?chksql=DRILL_DOOWN_INV_REASIGN&CLIENT_CODE=\"+m_client+\"&FACILITY_NO=\"+m_facility+\"&DATE=\"+date+\"&OPTION_NO=\"+m_option;");	
			out.println("		popupwin = window.open(m_url,\"oBj\",\"width=1000,height=450,scrollbars=2\");");
			out.println("}");
			
			out.println("function load_availability_drill_non_sales(m_client,m_facility,m_option,date) {");//Added By Sandun on 01-09-2009
			out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"FA_OP_PRO_sql_client_availability_new_scr_drill?chksql=DRILL_DOOWN_NON_SALES&CLIENT_CODE=\"+m_client+\"&FACILITY_NO=\"+m_facility+\"&DATE=\"+date+\"&OPTION_NO=\"+m_option;");	
			out.println("		popupwin = window.open(m_url,\"oBj\",\"width=700,height=450,scrollbars=2\");");
			out.println("}");
 ...
 //-------END MODIFICATION DONE BY ASHINI------------------------------------------
			...
			out.println("<BODY class='body & txt-body' leftmargin='0' topmargin='0' marginwidth='0' ONLOAD=\"load_lock(),on_load_rep();\">"); 
