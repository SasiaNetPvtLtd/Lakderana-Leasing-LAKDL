//--
//SCREEN NAME: Debtor Balance Report
//CREATED BY : SH
...
public class LAKDL_AF_CR_PRO_Debtor_Bal_Report extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
      ...
      m_chksql=req.getParameter("chksql");
		...
		if(m_chksql.equals("main_page")){
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_client_name+"AF_CR_PRO_Debtor_Bal_Report?chksql=main_page';"); 
			out.println("		}"); 
			out.println("}"); 
     ...
     out.println("function Generate_Report() {");
		 ...
		 //out.println("m_url=\""+m_class_url+"/"+m_client_name+"AF_CR_PRO_Debtor_Bal_Report?chksql=Report&from_date="+m_from_date+"&sort_column=\"+m_sort_col+\"&order_by_type=\"+m_order_by_type;"");			
     out.println("m_url=\""+m_class_url+"/"+m_client_name+"AF_CR_PRO_Debtor_Bal_Report?chksql=Report&from_date=\"+m_from_date+\"&sort_column=APPLICATION_NO&order_by_type=DESC\";");
     ...
     out.println("function get_invoice() {");
		 out.println("m_url=\""+m_class_url+"/"+m_client_name+"AF_CR_PRO_Debtor_Bal_Report?chksql=get_invoice&from_date=&sort_column=APPLICATION_NO&order_by_type=DESC\";");
		 out.println("popupwin=window.open(m_url,'displayWindow1','left=60,top=350,width=900,height=350,toolbar=0,location=0,center:yes,direction=0,menuBar=1,status=0,scrollbars=1,resizable=1');");
     out.println("}");
     
     out.println("function get_receipt() {");
		 out.println("m_url=\""+m_class_url+"/"+m_client_name+"AF_CR_PRO_Debtor_Bal_Report?chksql=get_receipt&from_date=&sort_column=APPLICATION_NO&order_by_type=DESC\";");
		 out.println("popupwin=window.open(m_url,'displayWindow1','left=60,top=350,width=900,height=350,toolbar=0,location=0,center:yes,direction=0,menuBar=1,status=0,scrollbars=1,resizable=1');");
     out.println("}");
     
		 out.println("function get_debtor() {");
		 out.println("m_url=\""+m_class_url+"/"+m_client_name+"AF_CR_PRO_Debtor_Bal_Report?chksql=get_debtor&from_date=&sort_column=APPLICATION_NO&order_by_type=DESC\";");
		 out.println("popupwin=window.open(m_url,'displayWindow1','left=60,top=350,width=900,height=350,toolbar=0,location=0,center:yes,direction=0,menuBar=1,status=0,scrollbars=1,resizable=1');");
     out.println("}");
...
String m_from_date = req.getParameter("from_date");
      ...
      out.println("<table align='center' width='100%' class='table' border=0>"); 
			...
			out.println("<table align='center' width='100%' class='table' border=0>"); 
			out.println("<tr class=pdn_txtpos2>"); 
			out.println("<td width='100%' class='txt_report_column'>Debtor Balance - Invoices </td>"); 
			out.println("</table>");
...
String m_from_date = req.getParameter("from_date");
      ...
      out.println("<table align='center' width='100%' class='table' border=0>"); 
			...
			out.println("<table align='center' width='100%' class='table' border=0>"); 
			out.println("<tr class=pdn_txtpos2>"); 
			out.println("<td width='100%' class='txt_report_column'>Debtor Balance - Debtor </td>"); 
			out.println("</table>");
