...
public class LAKDL_AF_MISF_Recovery_Report_all_slab extends javax.servlet.http.HttpServlet { 
		...
		try { 
			...
			if(m_chksql.equals("run_report")){ 
				...
				try{
					...
					callstmt1 = conn.prepareCall("BEGIN "+m_schema_name+".AF_RE_SAVE_RECOVER_RPT_TEST_2(:1,:2,:3,:4,:5,:6,:7,:8,:9);END;");  
			...
			if(m_chksql.equals("main_page")){ 
				...
				//out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_all_slab?chksql=run_report&finance_no=\"+finance_no+\"&date=\"+m_date+\"&location_id=\"+document.Form1.TXT_LOCATION_CODE.value+\"&user_id=\"+document.Form1.TXT_USER.value;"); //COMMENTED MILINDA 
				//out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_all_slab?chksql=run_report&finance_no=\"+finance_no+\"&date=\"+m_date+\"&location_id=\"+document.Form1.TXT_LOCATION_CODE.value+\"&user_id=\"+document.Form1.TXT_USER.value+\"&cr_officer=\"+m_cr_officer;"); //MOD BY MILINDA // commented by udara 21-11-2013
				
				out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_all_slab?chksql=run_report&finance_no=\"+finance_no+\"&date=\"+m_date+\"&location_id=\"+document.Form1.TXT_LOCATION_CODE.value+\"&user_id=\"+document.Form1.TXT_USER.value+\"&cr_officer=\"+m_cr_officer+\"&active_yard_status=\"+m_active_yard_status+\"&perform_stat=\"+m_perform_stat;"); // added by udara 21-11-2013
				...
				//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_all_slab?chksql=print_report_new&location=\"+m_location+\"&officer=\"+m_officer+\"&date=\"+m_date;");	
				out.println("var perform_status = document.Form1.TXT_PERFORM_STATUS.value;     ");
				out.println(" m_cr_officer=document.Form1.MKT_OFFICER.value;");//added milinda 2013-10-16
				//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_all_slab?chksql=print_report_new&location=\"+m_location+\"&officer=\"+m_officer+\"&date=\"+m_date+\"&perform_status=\"+perform_status;");  // added by udara on 09-05-2013
				out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_all_slab?chksql=print_report_new&location=\"+m_location+\"&officer=\"+m_officer+\"&date=\"+m_date+\"&perform_status=\"+perform_status+\"&cr_officer=\"+m_cr_officer+\"&active_status=\"+document.Form1.TXT_ACTIVE_STATUS.value+\"&region=\"+m_region;");  // added by udara on 09-05-2013 //mod by milinda 2013-10-16
				...
				out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_all_slab?chksql=main_page&generate=page';"); 
				out.println("		}"); 
				out.println("}"); 
				...
				out.println("if(validate_data()){");
				out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_all_slab?chksql=main_page&generate=print_report&location=\"+m_location+\"&officer=\"+m_officer+\"&date=\"+date;");	
				...
				*/
				...
				out.println("    m_order_by_type = 'ASC'; ");
				out.println("  }");
				// out.println("	m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_all_slab?chksql=print_report_new&location="+m_location+"&officer="+m_officer+"&date="+m_date+"&sort_column=\"+m_sort_col+\"&order_by_type=\"+m_order_by_type;"); 
				out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_all_slab?chksql=print_report_new&location="+m_location+"&officer="+m_officer+"&date="+m_date+"&active_status="+m_active_status+"&sort_column=\"+m_sort_col+\"&order_by_type=\"+m_order_by_type;");	
				...
				out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_all_slab?chksql=print_report_new_drill&location="+m_location+"&officer="+m_officer+"&date="+m_date+"&active_status="+m_active_status+"&slab=\"+val+\"&cr_officer="+m_cr_officer+"\";");	
				...
				out.println("function show_drill_2(val){ "); 
				
				out.println("  var m_location = '"+m_location+"';  ");
				out.println("  var m_officer = '"+m_officer+"';  ");
				out.println("  var m_date = '"+m_date+"';  ");
				out.println("  var perform_status = '"+m_perform_status+"';  ");
				out.println("  var m_cr_officer = '"+m_cr_officer+"';  ");
				out.println("  var m_active_status = '"+m_active_status+"';  ");
				out.println("  var m_region = '"+m_region+"';  ");
				
				//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_all_slab?chksql=print_report_new_drill_2&location="+m_location+"&officer="+m_officer+"&date="+m_date+"&active_status="+m_active_status+"&slab=\"+val+\"&cr_officer="+m_cr_officer+"\";");	
				out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_all_slab?chksql=print_report_new_drill_2&location=\"+m_location+\"&officer=\"+m_officer+\"&date=\"+m_date+\"&perform_status=\"+perform_status+\"&cr_officer=\"+m_cr_officer+\"&active_status=\"+m_active_status+\"&region=\"+m_region+\"&slab=\"+val;");
				...
				Sql_data=" SELECT  "+
					...
					" NVL (SUM(DECODE(SIGN(A.TOTAL_AMOUNT),1,A.TOTAL_AMOUNT,0)),0)+ NVL (SUM (a.other_charges_curr_month), 0) - SUM(NVL(A.SETTLED_OTH_FROM_EXCESS,0))  total_arrears, "+ //3 uv test 11-08-2015
					...
					*/
					...
					//" (NVL(A.CLOSING_BALANCE,0) - NVL ( A.FUTURE_RENTAL, 0)  - NVL(A.EARLY_SETT_NEXT,0)) "+ // commented by udara 21-09-2015
					
					// added by udara 21-09-2015
					" CASE WHEN ((NVL(A.CLOSING_BALANCE,0) - NVL ( A.FUTURE_RENTAL, 0)  - NVL(A.EARLY_SETT_NEXT,0))=0) THEN "+
					" NVL(A.CLOSING_BALANCE,0) "+ // " (NVL ( A.FUTURE_RENTAL, 0)  - NVL(A.EARLY_SETT_NEXT,0)) "+
					" ELSE "+
					" (NVL(A.CLOSING_BALANCE,0) - NVL ( A.FUTURE_RENTAL, 0)  - NVL(A.EARLY_SETT_NEXT,0))  "+
					" END "+
					// end by udara 21-09-2015
				...
				*/
					...
					"    NVL(SUM("+m_schema_name+".GET_CR_NOTE_AMNT_RECOV_RPT(A.FINANCE_NO,'"+m_date+"')),0) "+ // 23 added by udara on 05-08-2015
				...
				out.println("<td class='factoring-letter-body' STYLE='text-align:center;'><b>cr f 1</b></td>"); // uv 11-08-2015
				out.println("<td class='factoring-letter-body' STYLE='text-align:center;'><b>cr f 2</b></td>"); // uv 11-08-2015
				out.println("<td class='factoring-letter-body' STYLE='text-align:center;'><b>cr f 1-2</b></td>"); // uv 11-08-2015
				...
				while(more){
					...
					*/
					...
					//BCF = BCF.subtract(rs.getBigDecimal(21)); // uv test 11-08-2015
					...
					*/
					...
					out.println("<td  class=factoring-letter-body   STYLE='{text-align:right;}'  >"+nf.format(rs.getBigDecimal(23))+"</td>"); // uv 11-08-2015
					out.println("<td  class=factoring-letter-body   STYLE='{text-align:right;}'  >"+nf.format(rs.getBigDecimal(22))+"</td>"); // uv 11-08-2015
					out.println("<td  class=factoring-letter-body   STYLE='{text-align:right;}'  >"+nf.format(rs.getBigDecimal(21))+"</td>"); // uv 11-08-2015
				...
				if(total_Cases.signum()<0){
					out.println("<td class=factoring-letter-body STYLE='{text-align:right;cursor:pointer;}' onclick= \"show_drill_2('ALL')\"  ><b><u>("+nf1.format(total_Cases.negate())+")</u></b></td>"); 
					
				}else{
					out.println("<td class=factoring-letter-body STYLE='{text-align:right;cursor:pointer;}' onclick= \"show_drill_2('ALL')\"  ><b><u>"+nf1.format(total_Cases)+"</u></b></td>"); 
				}
				...
				*/
				...
				out.println("</td>");
				out.println("<td style='text-align:right;border-style:none;z-index: 0;border-top-color:black;border-bottom-color:black;border-top-style:solid;border-top-width:2px;border-bottom-style:double;border-bottom-width:6px'>"); 
				//out.println(nf.format(total_bcf.add(total_Future_ren).add(total_Closing).add(total_early_sett_next_month).add(total_early_sett_next_month_new_adjustment))); // commented by udara 16-09-2015 //.add(total_early_sett_next_month_new_adjustment) - Added By: SDF 
				//out.println(nf.format(total_bcf.add(total_Closing).add(total_early_sett_next_month).add(total_early_sett_next_month_new_adjustment))); // added by udara 16-09-2015
				...
				*/
				...
				out.println("  }");
				// out.println("	m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_all_slab?chksql=print_report_new&location="+m_location+"&officer="+m_officer+"&date="+m_date+"&sort_column=\"+m_sort_col+\"&order_by_type=\"+m_order_by_type;"); 
				out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_all_slab?chksql=print_report_new&location="+m_location+"&officer="+m_officer+"&date="+m_date+"&sort_column=\"+m_sort_col+\"&order_by_type=\"+m_order_by_type;"); // commented by udara on 09-05-2013
				out.println(" window.location.href=m_url;"); 
				out.println("}");
				...
				if (m_slab.equals("NEW") ){
					Sql_data=" SELECT  "+
						...
						//" NVL ( DECODE(SIGN(A.TOTAL_AMOUNT),1,A.TOTAL_AMOUNT,0), 0)+ NVL (a.other_charges_curr_month, 0) - NVL(A.SETTLED_OTH_FROM_EXCESS,0) - NVL("+m_schema_name+".GET_CR_NOTE_AMNT_RECOV_RPT_2(A.FINANCE_NO,'"+m_date+"'),0) total_arrears, "+ // commented by udara 17-09-2015 //3 added by udara 05-12-2013
						
						" NVL ( DECODE(SIGN(A.TOTAL_AMOUNT),1,A.TOTAL_AMOUNT,0), 0)+ NVL (a.other_charges_curr_month, 0) - NVL(A.SETTLED_OTH_FROM_EXCESS,0)  total_arrears, "+ // added by udara 17-09-2015
						...
						*/	
						...
						"   NVL("+m_schema_name+".GET_CR_NOTE_AMNT_RECOV_RPT(A.FINANCE_NO,'"+m_date+"'),0) - NVL("+m_schema_name+".GET_CR_NOTE_AMNT_RECOV_RPT_2(A.FINANCE_NO,'"+m_date+"'),0), "+ // 20 21 added by udara on 05-08-2015
						"   NVL("+m_schema_name+".GET_CR_NOTE_AMNT_RECOV_RPT_2(A.FINANCE_NO,'"+m_date+"'),0), "+ // 22 added by udara on 05-08-2015
						"    NVL("+m_schema_name+".GET_CR_NOTE_AMNT_RECOV_RPT(A.FINANCE_NO,'"+m_date+"'),0), "+ // 23 added by udara on 05-08-2015
					...
					Sql_data=" SELECT  "+
						...
						//" NVL ( DECODE(SIGN(A.TOTAL_AMOUNT),1,A.TOTAL_AMOUNT,0), 0)+ NVL (a.other_charges_curr_month, 0) - NVL(A.SETTLED_OTH_FROM_EXCESS,0) - NVL("+m_schema_name+".GET_CR_NOTE_AMNT_RECOV_RPT_2(A.FINANCE_NO,'"+m_date+"'),0) total_arrears, "+ // commented by udara 17-09-2015
						" NVL ( DECODE(SIGN(A.TOTAL_AMOUNT),1,A.TOTAL_AMOUNT,0), 0)+ NVL (a.other_charges_curr_month, 0) - NVL(A.SETTLED_OTH_FROM_EXCESS,0)  total_arrears, "+ // added by udara 17-09-2015
						...
						*/
						...
						"   NVL("+m_schema_name+".GET_CR_NOTE_AMNT_RECOV_RPT(A.FINANCE_NO,'"+m_date+"'),0) - NVL("+m_schema_name+".GET_CR_NOTE_AMNT_RECOV_RPT_2(A.FINANCE_NO,'"+m_date+"'),0), "+ //20  21 added by udara on 05-08-2015
						"   NVL("+m_schema_name+".GET_CR_NOTE_AMNT_RECOV_RPT_2(A.FINANCE_NO,'"+m_date+"'),0), "+ // 21 added by udara on 05-08-2015
						"    NVL("+m_schema_name+".GET_CR_NOTE_AMNT_RECOV_RPT(A.FINANCE_NO,'"+m_date+"'),0), "+ // 22 added by udara on 05-08-2015
				...
				while(more){
					...
					*/
					...
					//futu_rent = futu_rent.add(rs.getBigDecimal(13).subtract(rs.getBigDecimal(17))); // commented by udara 17-09-2015  // added by udara on 03-07-2013
					futu_rent = futu_rent.add(rs.getBigDecimal(23)); // added by udara 17-09-2015 
					...
					Arrea_Collec = Arrea_Collec.subtract(rs.getBigDecimal(20)); // added by udara 17-09-2015
				...
				*/		
			...
			else if(m_chksql.equals("print_report_new_drill_2")){		
				...
				// Sql_data = Sql_data + m_cr_officer_string; // added by milinda
				Sql_data = Sql_data + "    "+m_active_status_string+"   "+
					" GROUP BY A.TOTAL_PERIOD, A.FINANCE_NO  ORDER BY A.TOTAL_PERIOD "; 
				...
				while(more){
					...
					out.println("<td  class=factoring-letter-body   STYLE='{text-align:right;}'  >"+rs.getString(24)+"</td>"); 
				...
				out.println("<td class=factoring-letter-body  STYLE='{text-align:left;}'   ><b>Total</b></td>"); 
				if(total_Cases.signum()<0){
					out.println("<td class=factoring-letter-body STYLE='{text-align:right;cursor:pointer;}'  ><b>("+nf1.format(total_Cases.negate())+")</b></td>"); 
					
				}else{
					out.println("<td class=factoring-letter-body STYLE='{text-align:right;cursor:pointer;}'  ><b>"+nf1.format(total_Cases)+"</b></td>"); 
				}
				
				out.println("<td class=factoring-letter-body STYLE='{text-align:right;}'   ><b> Fin No </b></td>"); 
