...
public class LAKDL_AF_MISF_trail_balance_report extends javax.servlet.http.HttpServlet {
		...
		try {
     	...
     	res.setDateHeader("Expires", 0);
			...
			//--------------------------TRAIL BALANCE REPORT - FIRST LEVEL -------------------------------
			     ...
			     out.println("	 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_trail_balance_report?chksql=LOAD_TRAIL_BAL_REPORT_LEVEL_2&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&div_code=\"+m_div_code+\"&prod_code=\"+m_prod_code+\"&acc_type_code=\"+m_acc_type_code+\"&acc_desc=\"+m_acc_desc;");	
			...
			//--------------------------TRAIL BALANCE REPORT - LEVEL 2 -------------------------------
			     ...
			     out.println("	 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_trail_balance_report?chksql=LOAD_TRAIL_BAL_REPORT_LEVEL_3&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&div_code=\"+m_div_code+\"&prod_code=\"+m_prod_code+\"&acc_type_code=\"+m_acc_type_code+\"&cr_dr_type=\"+m_cr_dr_type+\"&trans_code=\"+m_trans_code+\"&trans_desc=\"+m_trans_desc;");	
					 out.println("   window.open(m_url,'popupwin1','status=0,menubar=0,scrollbars=1,height=450,width=800');	");
					 out.println("	}");	
					 out.println("</SCRIPT>");
			...
			//--------------------------TRAIL BALANCE REPORT - LEVEL 3 -------------------------------
							...
							" WHERE TO_DATE(TO_CHAR(TRNDATE,'DD-MM-YYYY'),'DD-MM-YYYY') >= TO_DATE('"+m_from_date+"','DD-MM-YYYY') AND "+
							" TO_DATE(TO_CHAR(TRNDATE,'DD-MM-YYYY'),'DD-MM-YYYY') <= TO_DATE('"+m_to_date+"','DD-MM-YYYY') "+
