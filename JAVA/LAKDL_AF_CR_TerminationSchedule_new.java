...
public class LAKDL_AF_CR_TerminationSchedule_new extends javax.servlet.http.HttpServlet {
	...
	public /*synchronized*/ void service(HttpServletRequest req, HttpServletResponse res)
	{
		...
		try {
			...
			if (m_chksql.trim().equals("idle")) {
				...
				if(m_term_type.trim().equals("ERL_TER")){
					...
					out.println("</tr>");	
					out.println("<tr><td width='*%'   style='text-align:justify'><B>SMB Leasing PLC</B></BR></BR></BR></td> ");
					out.println("</tr>");	
					...
					out.println("<tr><td width='*%'   style='text-align:justify'>Yours faithfully.</td> ");
					out.println("</tr>");	
					out.println("<tr><td width='*%'   style='text-align:justify'><B>SMB Leasing PLC</></BR></BR></BR></td> ");
					out.println("</tr>");	
					out.println("<tr><td width='*%'   style='text-align:justify'>................................<br><br></td> ");
					out.println("</tr>");	
					out.println("<tr><td width='*%'   style='text-align:justify'>Authorised Signatory.</td> ");
			...
			*/
				...
				out.println("m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_TerminationSchedule_new?chksql=generate_Erl_letter&due_amount="+m_due_amount+"&due_rent="+m_due_rent+"&odi_amount="+m_odi_amount+"&sale_price="+m_sale_price+"&tot_chrg="+m_tot_chrg+"&agreemnt_no="+m_agreemnt_no+"&term_type="+m_term_type+"&client="+m_client+
				...
				*/
				...
				out.println("m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_TerminationSchedule_new?chksql=generate_Erl_Quatation&due_amount="+m_due_amount+"&due_rent="+m_due_rent+"&odi_amount="+m_odi_amount+"&sale_price="+m_sale_price+"&tot_chrg="+m_tot_chrg+"&agreemnt_no="+m_agreemnt_no+"&term_type="+m_term_type+"&client="+m_client+
				...
				// added by udara 11-02-2021
				out.println(" else if(opt==\"78\"){");
				out.println("         document.Form1.TERMINATION_REBATE_TYPE.value = http_request.responseText; ");
				//out.println("         alert(document.Form1.TERMINATION_REBATE_TYPE.value); ");
				out.println(" }");
				// end by udara 11-02-2021
				...
				//out.println("var future_intrst  = document.Form1.h_in.value;");//kanishka // added by udara 26-02-2019
				...
				/*
				//out.println("m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_TerminationSchedule_new?chksql=generate_letter&due_amount=\"+m_due_amount+ ");
				out.println("m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_Termination_Letter?chksql=generate_letter&due_amount=\"+m_due_amount+ ");
				out.println("      \"&due_rent=\"+m_due_rent+\"&odi_amount=\"+m_odi_amount+\"&sale_price=\"+m_sale_price+\"&tot_chrg=\"+m_tot_chrg+\"&agreemnt_no=\"+m_agreemnt_no+");
				out.println("      \"&term_type=\"+m_term_type+\"&client=\"+m_client+\"&print=true&t_date=\"+terDate+\"&capital_outs=\"+capital_outs+ ");
				out.println("      \"&future_intrst=\"+future_intrst+\"&rebate_rate=\"+rebate_rate+\"&rebate_intrst=\"+rebate_intrst+\"&future_min_rebate=\"+future_min_rebate+ ");
				...
				*/
				...
				out.println("m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_TerminationSchedule_new?chksql=generate_Erl_Quatation&due_amount=\"+m_due_amount+ ");
				out.println("      \"&due_rent=\"+m_due_rent+\"&odi_amount=\"+m_odi_amount+\"&sale_price=\"+m_sale_price+\"&tot_chrg=\"+m_tot_chrg+\"&agreemnt_no=\"+m_agreemnt_no+");
				out.println("      \"&term_type=\"+m_term_type+\"&client=\"+m_client+\"&print=true&t_date=\"+terDate+\"&capital_outs=\"+capital_outs+ ");
				out.println("      \"&future_intrst=\"+future_intrst+\"&rebate_rate=\"+rebate_rate+\"&rebate_intrst=\"+rebate_intrst+\"&future_min_rebate=\"+future_min_rebate+ ");
				...
				out.println("m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_TerminationSchedule_new?chksql=generate_Erl_letter&due_amount=\"+m_due_amount+ ");
				out.println("      \"&due_rent=\"+m_due_rent+\"&odi_amount=\"+m_odi_amount+\"&sale_price=\"+m_sale_price+\"&tot_chrg=\"+m_tot_chrg+\"&agreemnt_no=\"+m_agreemnt_no+");
				out.println("      \"&term_type=\"+m_term_type+\"&client=\"+m_client+\"&print=true&t_date=\"+terDate+\"&capital_outs=\"+capital_outs+ ");
				out.println("      \"&future_intrst=\"+future_intrst+\"&rebate_rate=\"+rebate_rate+\"&rebate_intrst=\"+rebate_intrst+\"&future_min_rebate=\"+future_min_rebate+ ");
				...
				//out.println("		M4.innerHTML+='&nbsp;&nbsp;<input type=button name=early_ter_letter Style=\"width:150px;\" value=\"Early Termination Letter\" class=mainbut onclick=Generate_Erl_Letter(\"'+due_amount+'\",\"'+due_rent+'\",\"'+odi_amount+'\",\"'+sale_price+'\",\"'+tot_chrg+'\",\"'+client+'\",\"'+agreemnt_no+'\",\"'+vehicle_no+'\");>';"); // commented by udara 05-11-2018
				...
				out.println("  bal_amount = format_noobject(Math.round(num*100)/100);");  // added by udara 16-10-2018
				out.println(" } ");
				out.println(" else{ ");
				//out.println("	T31.innerHTML=format_noobject(parseFloat(unformat_noobject(document.Form1.ODI_NET.value))+parseFloat(unformat_noobject(document.Form1.TERM_AMOUNT.value))+parseFloat(unformat_noobject(document.Form1.DUE_NET.value))   +parseFloat(unformat_noobject(document.Form1.DUE_RENTALS_NET.value))+parseFloat(unformat_noobject(document.Form1.h_term.value)) +parseFloat(unformat_noobject(document.Form1.h_rpv.value))+ parseFloat(unformat_noobject(document.Form1.hid_sn_val.value))-parseFloat(unformat_noobject(document.Form1.Unallo_Rec.value)));"); 
				//modified by kanishka on 29-01-2014
				...
				out.println("	popupwin = window.open(\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_TerminationSchedule_new?chksql=get_Invoice&client=\"+document.Form1.CLIENT_CODE.value+\"\", \"oBj\",\"left=130,top=200,width=750,height=400\");"); 
				out.println("}");		
				
				
				out.println("function cal_amount(opt,am1,am2,num) {");//
				out.println("   document.Form1.hid_win_opt.value=num;");
				out.println("   m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_TerminationSchedule_new?chksql=Add_Min_Amount&amount1=\"+am1+\"&amount2=\"+am2+\"&type=\"+opt;");
				...
				//out.println("   m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_TerminationSchedule_new?chksql=get_Vehicles&Lease_no=\"+document.Form1.LEASE_NO.value;");
				//comment above and add below by Kanishka On 29-07-2014
				out.println("   m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_TerminationSchedule_new?chksql=get_Vehicles&Lease_no=\"+document.Form1.LEASE_NO.value+\"&Ter_date=\"+document.Form1.TER_DAY.value+\"-\"+document.Form1.TER_MONTH.value+\"-\"+document.Form1.TER_YEAR.value;");
				//out.println("   window.open(m_url);");
				...
				out.println("   m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_TerminationSchedule_new?chksql=get_Receipt&client=\"+document.Form1.CLIENT_CODE.value+\"\";");
        //out.println("   window.open(m_url);");
        ...
        out.println("}");	
				...
				out.println("   m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_TerminationSchedule_new?chksql=get_Receipt_del&rec_no=\"+val+\"\";");
        //out.println("   window.open(m_url);");
        ...
        out.println("}");
				...
				*/
				...
				out.println("   m_url=\"" + m_servlet_client_url + ":" + m_client_t3_port + "/" + m_client_name + "AF_CR_TerminationSchedule_new?chksql=getMoratoriumValues&Lease_no=\"+document.Form1.LEASE_NO.value;");
				out.println("   makeRequest(m_url,'77');");
				out.println("}");
				// end by udara 06-01-2021
				
				// added by udara 11-02-2021
				out.println("function getRebateType() {");
				out.println("   m_url=\"" + m_servlet_client_url + ":" + m_client_t3_port + "/" + m_client_name + "AF_CR_TerminationSchedule_new?chksql=getRebateType&rebate_code=\"+document.Form1.TERM_REBATE_TYPE.value;");
				out.println("   makeRequest(m_url,'78');");
				out.println("}");
				// end by udara 11-02-2021
				
				// added by udara 25-02-2022
				out.println("function changeBalanceTransferType(){");
				out.println("   if(document.Form1.TERM_TYPE.value=='BAL_TRANSF'){");
				out.println("     document.Form1.TERM_REBATE_TYPE.value='BAL_TRAN'; ");
				out.println("     getRebateType(); ");
				out.println("   }");
				out.println("}");
				// end by udara 25-02-2022
				...
				//out.println(" 			obj_PER.value = format_noobject(((Math.round(parseFloat(unformat_noobject(obj_ADJ.value))*100)/100) / (Math.round(parseFloat(unformat_noobject(obj_ODI.value))*100)/100)) *100);"); // commented by udara 17-09-2018 to block the changing the value of the ODI adj percentage // re released 30-10-2018
				...
				out.println("   makeRequest(m_url,'8','TERATESN');"); // added by udara 23-10-2018
				...
				*/
				...
				// added by udara 11-02-2021--[commented by milinda]
				out.println("if(document.Form1.TERM_REBATE_TYPE.value==\"\"){");
				//out.println("    alert('Termination Rebate Type cannot be blank'); "); // commented by udara 16-03-2022
				out.println("    alert('Sub type can not be blank'); "); // added by udara 16-03-2022
				out.println("    document.Form1.TERM_TYPE.focus();");
				out.println("    m_sub = 1;");
				out.println("}");
				out.println("else {");
				
				    out.println(" var ter_rebate_type = document.Form1.TERMINATION_REBATE_TYPE.value; ");
					out.println(" ter_rebate_type = ter_rebate_type.replace(/^\\s+|\\s+$/g,\"\"); ");
					
					out.println(" var sel = document.getElementById('TERM_REBATE_TYPE'); ");
					out.println(" var option_value= sel.options[sel.selectedIndex].text; ");
					
					out.println(" document.Form1.TERMINATION_REBATE_DESC.value = option_value; ");
					out.println(" document.Form1.TERMINATION_REBATE_TYPE.value = ter_rebate_type; ");
				
				    //out.println("alert(document.Form1.TERM_TYPE.value+'    '+ter_rebate_type); ");
					//out.println(" var str = \"       Hello World!        \"; ");
					//out.println(" alert(str.replace(/^\\s+|\\s+$/g,\"\")); ");
					
					/*
					out.println("if(ter_rebate_type!=\"MT\"){");
					out.println("    alert('Not Equal'); "); 
					out.println("    m_sub = 1;");
					out.println("}");
					
					out.println("if(ter_rebate_type==\"MT\"){");
					out.println("    alert('Equal'); "); 
					out.println("    m_sub = 1;");
					out.println("}");
					*/
				
					/*
					out.println("if(document.Form1.TERM_TYPE.value==\"NOR_TER\" && ter_rebate_type!=\"MT\"){");
					out.println("    alert('Termination type should be Mature Termination'); "); 
					out.println("    m_sub = 1;");
					out.println("}");
					
					out.println("if(document.Form1.TERM_TYPE.value==\"ERL_TER\" && ter_rebate_type!=\"ET\"){");
					out.println("    alert('Termination type should be Early Termination'); "); 
					out.println("    m_sub = 1;");
					out.println("}");
					
					out.println("if(document.Form1.TERM_TYPE.value==\"BAL_TRANSF\" && ter_rebate_type!=\"BAL_TRAN\"){");
					out.println("    alert('Termination type should be Balance Transfer'); "); 
					out.println("    m_sub = 1;");
					out.println("}");
					*/
					
					// added by udara 25-02-2022
					out.println("if(document.Form1.TERM_TYPE.value==\"BAL_TRANSF\" && ter_rebate_type!=\"BT\"){");
					//out.println("    alert('Sub Type should be Balance Transfer'); "); 
					out.println("    alert('Please check the sub type'); "); // added by udara 25-02-2022
					out.println("    m_sub = 1;");
					out.println("    return false;");  // added by udara 08-03-2022
					out.println("}");
					// end by udara 25-02-2022
					
					//[commented by milinda]
					out.println("if(ter_rebate_type==\"MT\" && document.Form1.TERM_TYPE.value!=\"NOR_TER\"){");
					//out.println("    alert('Termination type should be Mature Termination for selected rebate type '+ option_value); "); 
					out.println("    alert('Please check the sub type'); "); // added by udara 25-02-2022
					out.println("    m_sub = 1;");
					out.println("    return false;");  // added by udara 08-03-2022
					out.println("}");
					
					out.println("if(ter_rebate_type==\"ET\" && document.Form1.TERM_TYPE.value!=\"ERL_TER\"){");
					//out.println("    alert('Termination type should be Early Termination for selected rebate type '+ option_value); "); 
					out.println("    alert('Please check the sub type'); "); // added by udara 25-02-2022
					out.println("    m_sub = 1;");
					out.println("    return false;");  // added by udara 08-03-2022
					out.println("}");
					
					out.println("if(ter_rebate_type==\"BT\" && document.Form1.TERM_TYPE.value!=\"BAL_TRANSF\"){");
					//out.println("    alert('Termination type should be Balance Transfer for selected rebate type '+ option_value); "); 
					out.println("    alert('Please check the sub type'); "); // added by udara 25-02-2022
					out.println("    m_sub = 1;");
					out.println("    return false;");  // added by udara 08-03-2022
					out.println("}");
					
					// added by udara 08-03-2022
					out.println("if(document.Form1.TERM_TYPE.value==\"NOR_TER\" && document.Form1.HID_RENTAL_PERIOD.value != '0' ){");
					out.println("    alert('This contract cannot be proceed as Normal Termination'); "); 
					out.println("    m_sub = 1;");
					out.println("    return false;");  
					out.println("}");
					// ens by udara 08-03-2022
				...
				*/
				...
				out.println(" m_sub_odi = '';  "); // added by udara 01-02-2019
				out.println(" m_sub_rebate = '';  ");  // added by udara 01-02-2019
				...
				out.println("window.location.href='"+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_TerminationSchedule_new?chksql=main_page'");
				out.println(" }  ");
				out.println("}");
				...
				*/
				...
				out.println(" document.Form1.HID_RENTAL_PERIOD.value =oBj.valout[9]; "); // added by udara 08-03-2022
				...
				out.println(" if(num!=\"\" ){");	
				//out.println("	 popupwin = window.open(\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CO_Documents?chksql=get_documents&deal_no=\"+num+\"&foll_no=\", \"oBj\",\"left=150,top=280,width=620,height=390\");"); 
				out.println("	 popupwin = window.open(\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_TerminationSchedule_new?chksql=SHOW_BALANCES_INFO&url=&client_code=\"+num+\"\", \"oBj\",\"left=150,top=280,width=800,height=600\");"); 
				//0000000123
				//out.println(" load_c_date(document.Form1.hid_cal_date.value);");
				out.println(" }else{");
				out.println("   alert('Please enter Client Code and continue!');");
				...
				out.println("<input type=hidden name=\"HID_RENTAL_PERIOD\" value=\"\">"); // added by udara 08-03-2022
				...
				//String m_ter_type="<SELECT name=\"TERM_TYPE\" class=\"txt_input\" onchange='changeBalanceTransferType();' >"; // temp added by udara 25-02-2022
				...
				out.println("<td><input name=\"TER_RATE\" type=\"text\" maxlength=\"6\" class=\"txt_input\"  onblur=\"check_Rate(document.Form1.TER_RATE.value)\" STYLE=\"{text-align:right;}\" value=\"0\"  onchange=\"check_rebate_change();\" >"); // onchange=check_Rate(document.Form1.TER_RATE.value)
				out.println("</td>");//out.println("<input name=\"CLIENT_TYPE\" type=\"text\" maxlength=\"10\" class=\"txt_input\" ></td>");
				...
				*/
				...
				// added by udara 11-02-2021--[commente by milinda]
				String m_ter_rebate_type="<SELECT name=\"TERM_REBATE_TYPE\" id=\"TERM_REBATE_TYPE\" class=\"txt_input\"  onchange='getRebateType();' >";				
				m_ter_rebate_type=m_ter_rebate_type+"<OPTION value=\"\"> </OPTION>";			
				rs2 = stmt.executeQuery("SELECT CODE, DESCRIPTION "+
					"FROM   "+m_schema_name+".AF_CO_TERMI_REBATE_TYPES ");				
				while(rs2.next()){					
					m_ter_rebate_type=m_ter_rebate_type+"<OPTION value=\""+rs2.getString(1)+"\">"+rs2.getString(2)+"</OPTION>";					
				}
				m_ter_rebate_type=m_ter_rebate_type+"</SELECT>";
				// end by udara 11-02-2021
				
				// added by udara 06-01-2021
				out.println("<tr class=tr_input>");
				//out.println("<td>Rebate Type </td>");
				out.println("<td>Sub Type </td>"); // added by udara 25-02-2022
				//out.println("<td>&nbsp; </td>"); // commented by udara 11-02-2021
				out.println("<td>"+m_ter_rebate_type+"<input type=hidden name=TERMINATION_REBATE_TYPE value=''><input type=hidden name=TERMINATION_REBATE_DESC value=''></TD>"); // added by udara 11-02-2021
		...
		//boolean flag = rs.next();
			...
			out.println("</Root>");
				...
				String		Sql_Unallocated=" SELECT "+ 
					...
					"         AND CLIENT_CODE=UPPER('"+m_client_code+"')  "; // added by udara 11-03-2019
			...
			// added by udara 11-02-2021--[commented by milinda]
			if (m_chksql.trim().equals("getRebateType")){
								String m_rebate_code = req.getParameter("rebate_code");
								
								
					rs = stmt.executeQuery(" SELECT TERMI_TYPE " + 
									" FROM AF_CO_TERMI_REBATE_TYPES A "+
									" WHERE CODE = '"+m_rebate_code+"' ");
