...
public class LAKDL_AF_MK_display_inspection_and_valu_1 extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			String m_valuation = req.getParameter("valuation_no");
...
//###############################################################################################################################################################################
      ...
      //out.println("    asset(document.Form1.TXT_ASSET_ID);");
			...
			//out.println("alert(m_date_diff);");
			/*out.println("if(m_date_diff > 14){ ");
			out.println("  alert('Valuation date should not be less than 2 weeks than the system date.');");
...
//###############################################################################################################################################################################
			...
			//out.println("alert(document.Form1.HID_TXT_VALUATION_DATE.value);");
			out.println("}");
...
//###############################################################################################################################################################################
			...
			//out.println("alert('display_data');");
		  ...
		  out.println("var j=0;");
			...
			/*out.println("'<tr >'+");
			out.println("'<td width=\"10%\" ><B>Product Code*</B></td>'+");
			out.println("'<td width=\"30%\" ><B>Product Description *</B></td>'+"); 
...
//###############################################################################################################################################################################
			...
			//out.println("alert('display_fields');");
			out.println("change1.innerHTML=\"\"");
		  out.println("var j=0;");
			out.println("var i=0;");
			out.println("if(document.Form1.TXT_VALUATION_NO.value!='' && document.Form1.TXT_ITEM_CODE.value!=''){");
...
//###############################################################################################################################################################################
			...
			out.println("return false;"); 
			out.println("}"); 
			//out.println("else if(document.Form1.HID_TXT_REG_DATE.value==\"\"){  "); 
			//out.println("DIV_TXT_DATE_OF_REG.style.color='red';");
			//out.println("return false;"); 
			//out.println("}"); 
			...
			//out.println("check_valuation_date();"); 
			out.println("return false;"); 
			out.println("}"); 
...
//###############################################################################################################################################################################
			...
			out.println("		 document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_MK_save_inspection_and_val_1?number='+ document.Form1.hid_no.value+'';");  
...
//###############################################################################################################################################################################
		...
		//	out.println("document.oncontextmenu=new Function(\"return false\");"); 
			...
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MK_sql_validations?chksql=m_prime_chk_LAKDL_AF_MK_display_inspection_and_valuation_report&data_val=\"+document.Form1.TXT_VALUATION_NO.value+\"&ac_status=\"+document.Form1.hid_act.value;");
			out.println("load_interface(m_url,'XML');");
			out.println("}	"); 
...
//###############################################################################################################################################################################
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MK_display_inspection_and_valu_1?APP_NO="+m_val+"&valuation_no=';");  
			out.println("		}"); 
			out.println("}"); 
...
//###############################################################################################################################################################################
	    ...
	    out.println(" document.Form1.TXT_SUB_MODEL_CODE.value=oBj.valout[4];"); 
			...
			//out.println(" document.Form1.HID_TXT_REG_DATE.value=oBj.valout[4];");
			out.println("}"); 
//###############################################################################################################################################################################
//###############################################################################################################################################################################
...
//###############################################################################################################################################################################
   		...
   		out.println("<td width='10%' align='center'><input type=button name=back value=\"Close\" class=mainbut onclick=close_screen(); onMouseOver='load_roll_value(\"Close\");' onmouseout='load_roll_value(\"Close\");'></td>");
			...
			out.println("</td>"); 
			//out.println("<td width='30%' ><input class='txt_input' type='text' name='TXT_VALUATION_DATE' maxlength='10' size='10' onkeypress='d()' onblur=\"seperate()\"></td>"); 
			...
			out.println("<td width='30%' ><input class='txt_input' type='text' name='TXT_ASSET_ID' maxlength='15' size='15' onkeypress=\"\" onblur=\"assig1('T4'),asset(document.Form1.TXT_ASSET_ID)\" >");
			//out.println("<input class='but_input' type='button' name='BUT_VALUATION_NO' value=\"Help\" onClick=\"help_update()\" disabled></td>"); 
			...
			out.println("<td width='30%' ><input class='txt_input' type='text' name='TXT_ITEM_CODE' maxlength='10' size='10' onblur=\"assig1('T2'),item_val(document.Form1.TXT_ITEM_CODE)\" onkeypress=\"d(),assig1('T2')\" ></td>"); 
			//out.println("<input class='but_input' type='button' name='BUT_ITEM_CODE' value=\"Help\" onClick=\"help_button_7()\">"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			...
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_CHASSIS_NO' maxlength='50' size='20' onkeypress='d()'></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			
			out.println("<tr >"); 
			out.println("<td width='30%' ><DIV id='DIV_TXT_ENGINE_NO'  class=div_input>Engine No *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_ENGINE_NO' maxlength='50' size='20' onkeypress='d()'></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>");
			...
			//out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_DATE_OF_REG' maxlength='10' size='10' onkeypress='d()' onblur=\"seperate1()\" disabled></td>"); 
