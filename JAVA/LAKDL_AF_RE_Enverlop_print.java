...
public class LAKDL_AF_RE_Enverlop_print extends javax.servlet.http.HttpServlet {
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)
	{
		...
		try {
			...
			*/
			...
			out.println("		client_assign3(oBj);"); 
			out.println("		}");
			...
			out.println("Crit=document.Form1.fin_txt.value+\"@\";");
			out.println("HelpBox('1','10','0',Crit,'ClientSqlte1','1');");
			out.println("}");	
		    //CLIENT HELP
		    out.println("function client_help1(){");
			out.println("Crit=document.Form1.CLIENT_CODE.value+\"@\"+document.Form1.fin_txt.value+\"@\";");
			//out.println("Crit=document.Form1.PAY_ACCOUNT.value+\"@\"+document.Form1.CLIENT_CODE.value+\"@\"+\"Y@\";");
			out.println("HelpBox('1','10','0',Crit,'ClientSqlteNEW','2');");//ClientSql
			out.println("}");
			//GUARANTER HELP
			 out.println("function client_help2(){");
			out.println("Crit=document.Form1.Guarantor.value+\"@\"+document.Form1.fin_txt.value+\"@\";");
			out.println("HelpBox('1','10','0',Crit,'ClientSqlte12','4');");
			out.println("}");
		
			out.println("function client_assign(oBj){");
			//out.println(" document.Form1.CLIENT_NAME.value =oBj.valout[3]");
			out.println(" document.Form1.fin_txt.value =oBj.valout[2]");
			...
			out.println("function client_assign3(oBj){");
			//out.println(" document.Form1.CLIENT_NAME.value =oBj.valout[3]");
			out.println(" document.Form1.Guarantor.value =oBj.valout[2]");
			//out.println(" get_Receipt();");
			out.println("}");
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_RE_Enverlop_print';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("help_box.innerHTML=\" Collection Process - Enverlop Print - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 
			
			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" Collection Process - Enverlop Print - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
			...
			out.println("  clie=document.Form1.CLIENT_CODE.value;");
			out.println("  m_finance_no=document.Form1.fin_txt.value;");
			...
			out.println("	m_url = \""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"MK_MAS_Enverlop_print_details?chksql=main_page&client_no=\"+clie+\"&finance_no=\"+m_finance_no; "); 
			...
			out.println("popupwin=window.open(m_url,'displayWindow2','left=110,top=110,width=700,height=300,toolbar=0,location=0,center:yes,direction=0,menuBar=0,status=0,scrollbars=1,resizable=1');");
			out.println("}");
			out.println("}");
			
			out.println("function letter2() {"); 
			out.println("  clie=document.Form1.Guarantor.value;");
			out.println("  m_finance_no=document.Form1.fin_txt.value;");
			out.println("if(document.Form1.Guarantor.value==''){");
			out.println("DIV_TXT_REPOSSESSION_NO2.style.color='red';");
			out.println("alert(\"Please enter all required fields marked with a '*' on screen\");");
			out.println("}");
			out.println("else{");
			out.println("	m_url = \""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"MK_MAS_Enverlop_print_details?chksql=main_page&client_no=\"+clie+\"&finance_no=\"+m_finance_no; "); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Collection Process - Enverlop Print</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
		...
		out.println("<input class='but_input' type='button' name='BUT_TXT_RECEIPT_NO' value=\"Help\" onClick=\"help_receipt_no()\"></td>"); 
			...
			*/
			out.println("<tr >"); 
			out.println("<td width='10%' ><DIV id='DIV_TXT_REPOSSESSION_NO'  class=div_input>Finance No *</DIV></td>"); 
			out.println("<td width='10%' ><input class='txt_input' type='text' name='fin_txt' maxlength='15' size='15'   onchange=\"client_help()\">"); 
			out.println("<input class='but_input' type='button' name='BUT_HELP_MAIN1' value=\"Help\" onClick=\"client_help()\" ></td>");
			//out.println("<td width='*%'></td>"); 
			//out.println("<td width='40%'><input class='but_input' type='button' name='BUT_BCODE' value=\"View\" onClick=\"letter()\" style='{cursor:hand;}'></td>"); 
			out.println("</tr>"); 
			
			out.println("<tr >"); 
			out.println("<td width='10%' ><DIV id='DIV_TXT_REPOSSESSION_NO'  class=div_input>Client No *</DIV></td>"); 
			out.println("<td width='10%' ><input class='txt_input' type='text' name='CLIENT_CODE' maxlength='15' size='15'   onchange=\"client_help1()\">"); 
			out.println("<input class='but_input' type='button' name='BUT_HELP_MAIN' value=\"Help\" onClick=\"client_help1()\" ></td>");
			out.println("<td width='*%'></td>"); 
			out.println("<td width='40%'><input class='but_input' type='button' name='BUT_BCODE' value=\"View\" onClick=\"letter()\" style='{cursor:hand;}'></td>"); 
			out.println("</tr>");
			
			out.println("<tr >"); 
			out.println("<td width='10%' ><DIV id='DIV_TXT_REPOSSESSION_NO2'  class=div_input>Guarantor No *</DIV></td>"); 
			out.println("<td width='10%' ><input class='txt_input' type='text' name='Guarantor' maxlength='15' size='15'   onchange=\"client_help2()\">"); 
			out.println("<input class='but_input' type='button' name='BUT_HELP_MAIN2' value=\"Help\" onClick=\"client_help2()\" ></td>");
			out.println("<td width='*%'></td>"); 
			out.println("<td width='40%'><input class='but_input' type='button' name='BUT_BCODE1' value=\"View\" onClick=\"letter2()\" style='{cursor:hand;}'></td>"); 
			out.println("</tr>");
