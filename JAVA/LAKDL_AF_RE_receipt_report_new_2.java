...
public class LAKDL_AF_RE_receipt_report_new_2 extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			if(m_chksql.equals("main_page")){
				...
				// added by udara on 21-11-2013
				rs= stmt.executeQuery(" SELECT "+
					" "+m_schema_name+".AF_CO_GET_USER_LOCATION('"+m_username+"') "+
					" FROM DUAL ");
				
				while(rs.next()){
					m_branch_id = rs.getString(1);
				}

				// end by udara on 21-11-2013
				
				out.println("<HTML>"); 
				out.println("<HEAD>"); 
				out.println("<TITLE>Collection - Receipt Report New GUI </TITLE>"); 
				out.println("</HEAD>"); 
				...
				out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report_new_gui?chksql=load_receipts&user=\"+m_user+\"&location_code=\"+m_location_code+\"&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=ENT_USER,ENT_DATE&sort_by=ASC&branch_id=\"+branch_id;"); // added by udara on 27-02-2013
				...
				// added by udara 22-11-2013
				out.println("function view_rep_locationwise() {");
				out.println(" 	m_from_dd = document.Form1.TXT_FROM_DATE_DD.value ");
				out.println(" 	m_from_mm = document.Form1.TXT_FROM_DATE_MM.value ");
				out.println("		m_from_yy = document.Form1.TXT_FROM_DATE_YY.value ");
				out.println(" 	m_from_date = m_from_dd+\"-\"+m_from_mm+\"-\"+m_from_yy; ");
				...
				out.println(" 	m_to_date = m_to_dd+\"-\"+m_to_mm+\"-\"+m_to_yy; ");
				out.println(" 	m_user = document.Form1.TXT_USER_ID.value ");
				out.println(" 	m_serchBy = document.Form1.TXT_FILTER_REPORT.value "); //Added By Nishantha on 2015-11-17
				//out.println(" 	m_location_code = document.Form1.LOCATION_CODE.value ");
				//out.println("   branch_id = document.Form1.TXT_BRANCH_ID.value; ");
				
				out.println(" 	m_location_code = '"+m_branch_id+"'; ");
				out.println("   branch_id = '"+m_branch_id+"'; ");
				
				out.println("		if(validate_date()) {");
				//Added By Nishantha on 2015-11-17
				out.println("         if(m_serchBy=='All'){"); 
				//out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report?chksql=load_receipts&user=\"+m_user+\"&location_code=\"+m_location_code+\"&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=ENT_USER,ENT_DATE&sort_by=ASC\";"); // commented by udara on 27-02-2013
				//modified by kanchana on 2016-07-20
				//out.println("			m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report_new_gui_loc?chksql=load_receipts&user=\"+m_user+\"&location_code=\"+m_location_code+\"&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=ENT_USER,ENT_DATE&sort_by=ASC&branch_id=\"+branch_id;"); // added by udara on 27-02-2013
				out.println("			m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report_new_gui_loc?chksql=load_receipts&user=\"+m_user+\"&location_code=\"+m_location_code+\"&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=TO_date(ENT_DATE,'DD-MM-YYYY HH24:MI:SS')&sort_by=ASC&branch_id=\"+branch_id;");
				out.println("    		popupwin=window.open(m_url,'displayWindow1','left=90,top=110,width=900,height=450,toolbar=0,location=0,center:yes,direction=0,menuBar=1,status=0,scrollbars=1,resizable=1,fullscreen=1');");
				out.println("   	   }");
				
				out.println("   	   else if(m_serchBy=='Active'){");
				//modified by kanchana on 2016-07-20
				//out.println("			m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report_new_gui_loc_active?chksql=main_page_active_loc&user=\"+m_user+\"&location_code=\"+m_location_code+\"&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=ENT_USER,ENT_DATE&sort_by=ASC&branch_id=\"+branch_id;"); // added by udara on 27-02-2013
				out.println("			m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report_new_gui_loc_active?chksql=main_page_active_loc&user=\"+m_user+\"&location_code=\"+m_location_code+\"&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=TO_date(ENT_DATE,'DD-MM-YYYY HH24:MI:SS')&sort_by=ASC&branch_id=\"+branch_id;"); // modified by kanchana on 2016-07-20
				out.println("    		popupwin=window.open(m_url,'displayWindow1','left=90,top=110,width=900,height=450,toolbar=0,location=0,center:yes,direction=0,menuBar=1,status=0,scrollbars=1,resizable=1,fullscreen=1');");
				out.println("   		}");
				
				out.println("   	   else if(m_serchBy=='Canceled'){");
				//modified by kanchana on 2016-07-20
				//out.println("			m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report_new_gui_loc_canceled?chksql=main_page_canceled_loc&user=\"+m_user+\"&location_code=\"+m_location_code+\"&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=ENT_USER,ENT_DATE&sort_by=ASC&branch_id=\"+branch_id;"); // added by udara on 27-02-2013
				out.println("			m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report_new_gui_loc_canceled?chksql=main_page_canceled_loc&user=\"+m_user+\"&location_code=\"+m_location_code+\"&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=TO_date(ENT_DATE,'DD-MM-YYYY HH24:MI:SS')&sort_by=ASC&branch_id=\"+branch_id;"); // modified by kanchana on 2016-07-20				
				out.println("    		popupwin=window.open(m_url,'displayWindow1','left=90,top=110,width=900,height=450,toolbar=0,location=0,center:yes,direction=0,menuBar=1,status=0,scrollbars=1,resizable=1,fullscreen=1');");
				out.println("   		}");
				//End Nishantha 
				out.println("   	}");
				...
				out.println("function view_rep_branchwise() {");
				out.println(" 	m_from_dd = document.Form1.TXT_FROM_DATE_DD.value ");
				out.println(" 	m_from_mm = document.Form1.TXT_FROM_DATE_MM.value ");
				out.println("		m_from_yy = document.Form1.TXT_FROM_DATE_YY.value ");
				out.println(" 	m_from_date = m_from_dd+\"-\"+m_from_mm+\"-\"+m_from_yy; ");
				...
				out.println("		if(validate_date()) {");
				out.println("         if(m_serchBy=='All'){"); //Added By Nishantha on 2015-11-17
				//out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report?chksql=load_receipts&user=\"+m_user+\"&location_code=\"+m_location_code+\"&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=ENT_USER,ENT_DATE&sort_by=ASC\";"); // commented by udara on 27-02-2013
				//modified by Kanchana on 2016-07-20
				//out.println("		 	m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report_new_gui_branch?chksql=load_receipts&user=\"+m_user+\"&location_code=\"+m_location_code+\"&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=ENT_USER,ENT_DATE&sort_by=ASC&branch_id=\"+branch_id;"); // added by udara on 27-02-2013
				out.println("		 	m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report_new_gui_branch?chksql=load_receipts&user=\"+m_user+\"&location_code=\"+m_location_code+\"&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=TO_date(ENT_DATE,'DD-MM-YYYY HH24:MI:SS')&sort_by=ASC&branch_id=\"+branch_id;"); // added by udara on 27-02-2013
				out.println("    		popupwin=window.open(m_url,'displayWindow1','left=90,top=110,width=900,height=450,toolbar=0,location=0,center:yes,direction=0,menuBar=1,status=0,scrollbars=1,resizable=1,fullscreen=1');");
				out.println("   		}");
				out.println("   	   else if(m_serchBy=='Active'){");				
				//modified by Kanchana on 2016-07-20
				//out.println("		 	m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report_new_gui_branch_avtived?chksql=main_page_active_branch&user=\"+m_user+\"&location_code=\"+m_location_code+\"&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=ENT_USER,ENT_DATE&sort_by=ASC&branch_id=\"+branch_id;"); // added by udara on 27-02-2013
				out.println("		 	m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report_new_gui_branch_avtived?chksql=main_page_active_branch&user=\"+m_user+\"&location_code=\"+m_location_code+\"&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=TO_date(ENT_DATE,'DD-MM-YYYY HH24:MI:SS')&sort_by=ASC&branch_id=\"+branch_id;"); // added by udara on 27-02-2013
				out.println("    		popupwin=window.open(m_url,'displayWindow1','left=90,top=110,width=900,height=450,toolbar=0,location=0,center:yes,direction=0,menuBar=1,status=0,scrollbars=1,resizable=1,fullscreen=1');");
				out.println("   		}");
				out.println("   	   else if(m_serchBy=='Canceled'){");				
				//modified by Kanchana on 2016-07-20
				//out.println("		 	m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report_new_gui_branch_canceled?chksql=main_page_canceled_branch&user=\"+m_user+\"&location_code=\"+m_location_code+\"&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=ENT_USER,ENT_DATE&sort_by=ASC&branch_id=\"+branch_id;"); // added by udara on 27-02-2013
				out.println("		 	m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report_new_gui_branch_canceled?chksql=main_page_canceled_branch&user=\"+m_user+\"&location_code=\"+m_location_code+\"&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=TO_date(ENT_DATE,'DD-MM-YYYY HH24:MI:SS')&sort_by=ASC&branch_id=\"+branch_id;"); // added by udara on 27-02-2013
				out.println("    		popupwin=window.open(m_url,'displayWindow1','left=90,top=110,width=900,height=450,toolbar=0,location=0,center:yes,direction=0,menuBar=1,status=0,scrollbars=1,resizable=1,fullscreen=1');");
				out.println("   		}");
				//End Nishantha 
				out.println("   	}");
				...
				out.println("		if(validate_date()) {");
				//out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report_new_gui?chksql=load_active_receipts&user=\"+m_user+\"&location_code=\"+m_location_code+\"&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=ENT_USER,ENT_DATE&sort_by=ASC\";"); // commented by udara on 27-02-2013
				out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report_new_gui?chksql=load_active_receipts&user=\"+m_user+\"&location_code=\"+m_location_code+\"&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=ENT_USER,ENT_DATE&sort_by=ASC&branch_id=\"+branch_id;"); // added by udara on 27-02-2013
				out.println("    popupwin=window.open(m_url,'displayWindow1','left=90,top=110,width=900,height=450,toolbar=0,location=0,center:yes,direction=0,menuBar=1,status=0,scrollbars=1,resizable=1,fullscreen=1');");
				out.println("   }");
				out.println("}");
				...
				out.println("   branch_id = document.Form1.TXT_BRANCH_ID.value; "); // added by udara on 27-02-2013
				out.println("		if(validate_date()) {");
				out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report_new_gui?chksql=load_receipts_cancel&user=\"+m_user+\"&location_code=\"+m_location_code+\"&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=ENT_USER,ENT_DATE&sort_by=ASC&branch_id=\"+branch_id;");
				out.println("    popupwin=window.open(m_url,'displayWindow1','left=90,top=110,width=900,height=450,toolbar=0,location=0,center:yes,direction=0,menuBar=1,status=0,scrollbars=1,resizable=1,fullscreen=1');");
				out.println("   }");
				out.println("}");
				...
				out.println("   branch_id = document.Form1.TXT_BRANCH_ID.value; "); // added by udara on 27-02-2013
				out.println("		if(validate_date()) {");
				//out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report_new_gui?chksql=load_receipts_return&user=\"+m_user+\"&location_code=\"+m_location_code+\"&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=ENT_USER,ENT_DATE&sort_by=ASC\";"); // commented by udara on 27-02-2013
				out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report_new_gui?chksql=load_receipts_return&user=\"+m_user+\"&location_code=\"+m_location_code+\"&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=ENT_USER,ENT_DATE&sort_by=ASC&branch_id=\"+branch_id;"); // added by udara on 27-02-2013
				out.println("    popupwin=window.open(m_url,'displayWindow1','left=90,top=110,width=900,height=450,toolbar=0,location=0,center:yes,direction=0,menuBar=1,status=0,scrollbars=1,resizable=1,fullscreen=1');");
				out.println("   }");
				out.println("}");
				...
				out.println("		if(validate_date()) {");
				//out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report_new_gui?chksql=load_receipts_PDC&user=\"+m_user+\"&location_code=\"+m_location_code+\"&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=CHEQUE_DATE&sort_by=ASC\";"); // commented by udara on 27-02-2013
				out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report_new_gui?chksql=load_receipts_PDC&user=\"+m_user+\"&location_code=\"+m_location_code+\"&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=CHEQUE_DATE&sort_by=ASC&branch_id=\"+branch_id;"); // added by udara on 27-02-2013
				out.println("    popupwin=window.open(m_url,'displayWindow1','left=90,top=110,width=900,height=450,toolbar=0,location=0,center:yes,direction=0,menuBar=1,status=0,scrollbars=1,resizable=1,fullscreen=1');");
				out.println("   }");
				out.println("}");
				...
				out.println("   branch_id = document.Form1.TXT_BRANCH_ID.value; "); // added by udara on 27-02-2013
				out.println("		if(validate_date()) {");
				//out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report_new_gui?chksql=load_receipts_stdo&user=\"+m_user+\"&location_code=\"+m_location_code+\"&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=ENT_USER,ENT_DATE&sort_by=ASC\";"); // commented by udara on 27-02-2013
				out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report_new_gui?chksql=load_receipts_stdo&user=\"+m_user+\"&location_code=\"+m_location_code+\"&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=ENT_USER,ENT_DATE&sort_by=ASC&branch_id=\"+branch_id;"); // added by udara on 27-02-2013
				out.println("    popupwin=window.open(m_url,'displayWindow1','left=90,top=110,width=900,height=450,toolbar=0,location=0,center:yes,direction=0,menuBar=1,status=0,scrollbars=1,resizable=1,fullscreen=1');");
				out.println("   }");
				out.println("}");
				...
				out.println("		if(validate_date()) {");
				//out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report_new_gui?chksql=load_receipts_temp&user=\"+m_user+\"&location_code=\"+m_location_code+\"&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=ENT_USER,ENT_DATE&sort_by=ASC\";"); // commented by udara on 27-02-2013
				out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report_new_gui?chksql=load_receipts_temp&user=\"+m_user+\"&location_code=\"+m_location_code+\"&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=ENT_USER,ENT_DATE&sort_by=ASC&branch_id=\"+branch_id;"); // added by udara on 27-02-2013
				out.println("    popupwin=window.open(m_url,'displayWindow1','left=90,top=110,width=900,height=450,toolbar=0,location=0,center:yes,direction=0,menuBar=1,status=0,scrollbars=1,resizable=1,fullscreen=1');");
				out.println("   }");
				out.println("}");
				...
				out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report_new_2?chksql=main_page';"); 
				out.println("		}"); 
				out.println("}"); 
				
				out.println("function new_window(){	"); 
				out.println("	window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report_new_2=main_page';"); 
				out.println("}"); 
				...
				out.println("	help_box.innerHTML=\" Collection - Receipt Report New GUI - \"+m_val;"); 
				out.println("}"); 
				
				out.println("function load_roll_out_value(){");
				out.println("	help_box.innerHTML=\" Collection - Receipt Report New GUI \";"); 
				out.println("}"); 
			...
			//out.println("    \"&End_in=\"+End+\"&Crit_In=\"+m_criteria+"); 
				...
				out.println(" }");
				*/
				//out.println("  sql = 'm_help_TXT_USERS_with_loc_sql'; "); // commeted by udara 27-11-2013
				out.println("  sql = 'm_help_TXT_USERS_with_loc_2_sql'; "); // added by udara 27-11-2013
			  	//out.println(" m_criteria = document.Form1.TXT_USER_ID.value+\"@\"+document.Form1.LOCATION_CODE.value+\"@\";"); // commented by udara 22-11-2013
					
				// added below 2 lines by udara on 22-11-2013	
				out.println(" document.Form1.LOCATION_CODE.value = '"+m_branch_id+"'; ");
			
				// added by udara 26-11-2013
				if(m_branch_id.equals("HO"))
					out.println(" m_criteria = document.Form1.TXT_USER_ID.value+\"@\"+\"\"+\"@\";"); 
				else
				...
				out.println("</tr>"); 
				out.println("<tr>"); 
				out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Collection - Receipt Report New GUI </td>"); 
				out.println("</tr>"); 
				out.println("<tr>"); 
				...
				//Adde By Nishantha on 2015-11-19
				out.println("<table class='table' width='100%'>"); 
				out.println("<tr  >"); // style = '{display: none;}'
				out.println("<td width='10%' ><DIV id='DIV_TXT_USER_ID'  class=div_input>Report Status </DIV></td>"); //Added By Nishanhta on 2015-12-09
				out.println("<td width='*%' ><select  style='{width=150px;font-size=11px;}' name='TXT_FILTER_REPORT'> <option value='All'>All</option>  <option value='Active' >Active</option>  <option value='Canceled'>Canceled</option> </select>"); 
				out.println("</td>");
				out.println("<td width='*%'></td>"); 
				out.println("</tr>"); 
				out.println("</table>");
			//End Nishantha
				...
				//if(m_branch_id.equals("HO")) // commented by udara 22-11-2013
				//	out.println("<tr>");
				//else
					out.println("<tr style = '{display: none;}' >"); 
				...
				out.println("<input class='but_input' type='button' name='BUT_HELP_MAIN_1' style=\"{width:110px;}\" value=\"Location Receipts\"  onClick=\"view_rep_locationwise()\">");        // added  by udara on 22-11-2013
				out.println("<input class='but_input' type='button' name='BUT_HELP_MAIN_7' style=\"{width:110px;}\" value=\"Branch Receipts\"    onClick=\"view_rep_branchwise()\">"); // added  by udara on 22-11-2013
				
				// commented below by udara on 22-11-2013
				/*
				...
				*/
				...
				out.println("<HTML><HEAD><TITLE>Receipt Report New GUI </TITLE></HEAD>");
				out.println("<link REL='STYLESHEET' HREF='"+m_html_client_url+"/css/Asset_Financing_System.css' TYPE=\"text/css\">");
				out.println("<SCRIPT language=\"JavaScript\">"); 
				...
				out.println("<TR><TD align='Center' ><B> Receipt Report New GUI From  "+m_from_date+" To "+m_to_date+" </B></TD></TR>");
				out.println("</TABLE>");
				out.println("<BR>");	
				if(!more){
				...
				out.println("    m_order_by_type = 'ASC'; ");
				out.println("  }");
				out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report_new_gui?chksql=load_receipts_cancel&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=\"+m_sort_col+\"&sort_by=\"+m_order_by_type;");
				//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_display_receipt_deposit_report1?chksql=MAIN&order_by=\"+m_sort_col+\"&sort_by=\"+m_order_by_type+\"&receipt_no="+m_receipt_no+"&deposite_no="+m_deposite_no+"&from_date="+m_from_date+"&to_date="+m_to_date+"\";");		
				out.println(" window.location.href=m_url;"); 
				out.println("}");
			...
			//End by Dineth on 16-06-2009
				...
				out.println("    m_order_by_type = 'ASC'; ");
				out.println("  }");
				out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report_new_gui?chksql=load_receipts_stdo&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=\"+m_sort_col+\"&sort_by=\"+m_order_by_type;");
				//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_display_receipt_deposit_report1?chksql=MAIN&order_by=\"+m_sort_col+\"&sort_by=\"+m_order_by_type+\"&receipt_no="+m_receipt_no+"&deposite_no="+m_deposite_no+"&from_date="+m_from_date+"&to_date="+m_to_date+"\";");		
				out.println(" window.location.href=m_url;"); 
				out.println("}");
