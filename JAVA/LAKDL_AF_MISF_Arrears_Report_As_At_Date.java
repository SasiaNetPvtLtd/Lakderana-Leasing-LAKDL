...
public class LAKDL_AF_MISF_Arrears_Report_As_At_Date extends javax.servlet.http.HttpServlet { 
	...
	public  void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			// commented below by udara 22-08-2017
			/*
			if(m_chksql.equals("run_report")){ 
				...
				try{
					...
					callstmt1 = conn.prepareCall("BEGIN "+m_schema_name+".af_master_arr_final_ns(:1,:2,:3,:4,:5,:6,:7);END;"); // added by udara 06-01-2017
			...
			*/
			...
			if(m_chksql.equals("main_page")){ 
				...
				out.println("<HTML>"); 
				out.println("<HEAD>"); 
				out.println("<TITLE>Collection - Arrears Report-As At Date</TITLE>"); 
				out.println("</HEAD>"); 
				...
				//out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Arrears_Report_As_At_Date?chksql=run_report&finance_no=\"+finance_no+\"&date=\"+m_date+\"&location_id=\"+document.Form1.TXT_LOCATION_CODE.value+\"&user_id=\"+document.Form1.TXT_USER.value+\"&perform_status=\"+m_perform_status;"); 
				out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Arrears_Report_As_At_Date?chksql=run_report&finance_no=\"+finance_no+\"&date=\"+m_date+\"&location_id=\"+document.Form1.TXT_LOCATION_CODE.value+\"&user_id=\"+document.Form1.TXT_USER.value+\"&perform_status=\"+m_perform_status+\"&collector=\"+collector;"); 
			...
			out.println("function set_timer_actions() {");
				...
				out.println("		m_date=document.Form1.VAL_DAY.value+'-'+document.Form1.VAL_MONTH.value+'-'+document.Form1.VAL_YEAR.value;");
				//out.println("finance_no = document.Form1.TXT_FINANCE.value;");
				out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Arrears_Report_As_At_Date?chksql=run_report&date=\"+m_date;"); 
				//out.println("		window.open(m_url)");
				out.println("   set_timer_actions();");
				out.println("		load_interface(m_url,'NORM');");
				out.println("	}");
			...
			//------------------------------------**
				...
				out.println("	}");
				*/
				//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Arrears_Report_As_At_Date?chksql=print_report_new&location=\"+m_location+\"&officer=\"+m_officer+\"&slab=\"+m_slba+\"&rendate=\"+m_rendate+\"&date=\"+m_date;");	
				
				// commented by udara on 06-09-2013
				//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Arrears_Report_As_At_Date?chksql=print_report_new&location=\"+m_location+\"&officer=\"+m_officer+\"&slab=\"+m_slba+\"&rendate=\"+m_rendate+\"&date=\"+m_date+\"&period=\"+m_period+\"&period_2=\"+m_period_2;"); // added by udara on 12-03-2013
				...
				*/
				...
				out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MISF_Arrears_Report_As_At_Date?chksql=main_page&generate=page';"); 
				out.println("		}"); 
				out.println("}"); 
				...
				out.println("help_box.innerHTML=\" Collection Process - Arrears Report As At Date- \"+m_val;"); 
				out.println("}"); 
				out.println(""); 
				
				out.println("function load_roll_out_value(){");
				out.println("help_box.innerHTML=\" Collection Process - Arrears Report As At Date - \"+document.Form1.hid_status.value;"); 
				out.println("}"); 
				...
				out.println("</tr>"); 
				out.println("<tr>"); 
				out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Collection Process - Arrears Report As At Date </td>"); 
				out.println("</tr>"); 
				out.println("<tr>"); 
			...
			//----------Prabash--------------------------
				...
				try{
					callstmt1 = conn.prepareCall("BEGIN "+m_schema_name+".AF_MASTER_ARR_FINAL_AS_AT_DATE(:1,:2);END;");
					callstmt1.setString(1,m_date);
				...
				//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Arrears_Report_As_At_Date?chksql=print_report_new&location="+m_location+"&slba="+m_slba+"&rendate="+m_rendate+"&officer="+m_officer+"&date="+m_date+"&sort_column=\"+m_sort_col+\"&order_by_type=\"+m_order_by_type;");	
				out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Arrears_Report_As_At_Date?chksql=print_report_new_logic&location=\"+m_location+\"&officer=\"+m_officer+\"&slab=\"+m_slba+\"&rendate=\"+m_rendate+\"&date=\"+m_date+\"&period=\"+m_period+\"&period_2=\"+m_period_2+\"&cr_officer=\"+cr_officer+\"&active_status=\"+document.Form1.TXT_ACTIVE_STATUS.value+\"&region=\"+m_region+\"&perform_status=\"+m_perform_status+\"&due_month=\"+due_month+\"&due_year=\"+due_year+\"&ins_level=\"+ins_level;");
				...
				if(m_slba.equals("")){
					...
					if((m_period.equals("")) && (m_period_2.equals(""))){	// added by udara on 21-08-2013
						...
						Sql_data="  WITH T AS(SELECT  "+
							...
							" TOTAL_AMOUNT "+//13
							" FROM "+m_schema_name+".AF_MASTER_ARR_RPT_ASAT_DATE "+
							" WHERE NVL("+m_schema_name+".AF_CO_GET_CR_OFFICER_3(application_no),' ') = '"+cr_officer+"' "+
			...
			// =============== end by udara on 06-09-2013 ====================================================================================
				...
				rs1 = stmt.executeQuery(" "+
					...
					" FROM "+m_schema_name+".ARREARS_RPT_ASAT_DATE_RUN_LOG "+
					" WHERE POINT = 'FINISH' ");
				...
				out.println("<table align=\"center\" width=\"95%\" border=\"0\" class=\"table\">");
				out.println("<tr >");
				out.println("<td width=\"*\" STYLE='{font: bold 10pt arial; text-align:center;}'   ><u>Arrears Report As At Date</u></td>"); 
				out.println("</tr >");
				out.println("</table >");
				out.println("<br>");
				out.println("<br>");
				...
				if((!cr_officer.equals(""))){
					...
					//sql_cr_officer_2 = " AND   COLL_OFFICER LIKE '%"+cr_officer+"%' ";
				...
				if((!m_location.equals("")) && (!m_location.equals(""))){
					//sql_m_location = " AND   LOCATION_CODE LIKE '%"+m_location+"%' ";
					sql_m_location = " AND   LOCATION_CODE = '"+m_location+"' ";
				}
				
				String sql_m_officer = "   ";
				if((!m_officer.equals(""))){
					//sql_m_officer = " AND   COLL_OFICER LIKE '%"+m_officer+"%' "; // marketing executive
				...
				//------------------added by prabash on 19-09-2017------------------------------**
				...
				//sort_string = " ORDER BY  VALUE_DATE "+m_order_by_type+", "+m_sort_column+"  "+m_order_by_type+"  ";
				...
				Sql_data = " "+					
						...
						" FROM "+m_schema_name+".AF_MASTER_ARR_RPT_FINAL "+ 
						//" WHERE ENT_USER = '"+m_username+"' "+
				...
				*/
				...
				/*	" SELECT "+
						    ...
						    " NVL(LAST_PAY_AMT,0) LAST_PAY_AMT, "+ // 18
							" NVL(CURR_COLL_OFFICER,'-') CURR_COLL_OFFICER "+ // 19 
						" FROM "+m_schema_name+".AF_MASTER_ARR_RPT_FINAL_HIS "+ 
						" WHERE   TOTAL_AMOUNT > 0 "+
					...
					*/
						...
						" FROM "+m_schema_name+".AF_MASTER_ARR_RPT_ASAT_DATE "+ 
						" WHERE   TOTAL_AMOUNT > 0 "+
						//"  AND REPORT_DATE >= TRUNC(TO_DATE('"+m_date+"','DD-MM-YYYY'),'MM') "+
						...
						"  "+sql_perform_status+"  "+
					//	" ORDER BY VALUE_DATE,FINANCE_NO,CLIENT_CODE,FULL_NAME,AGE_NEW,CLIENT_TEL_NO,DUE_RENTAL_AMOUNT,FOL_REMARK,CITY_NAME,COLL_OFICER,VEHICLE_NO,TOTAL_PERIOD	 "+					  
					    "  "+sort_string+"  "+  //added by Prabash from arrears report final
					" ";
