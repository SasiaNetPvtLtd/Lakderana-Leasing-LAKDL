//--
//SCREEN NAME	:REFERENCE CONDITIONS
//CREATED BY	:DELANJALI	
//DATE/TIME		:31-01-2007
//NOTES				:
...
public class LAKDL_AF_MAS_display_reference_conditions extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("			if(data_vec.length>0 && document.Form1.SCREEN_NAME.value==\"NEW\" && document.Form1.hid_test.value=='J1' && document.Form1.TXT_CODE.value!=''){");
			out.println("				alert('Record already exsist');");
			out.println("				new_window();");
			out.println("			}");
			out.println("else	if(data_vec.length==0 && document.Form1.SCREEN_NAME.value==\"EDIT\" && document.Form1.hid_test.value=='J1' && document.Form1.TXT_CODE.value!=''){");
			...
			out.println("    document.Form1.TXT_INSERT_SCREEN.value=data_vec[3];"); 
			out.println("			}");
			out.println("}");
			...
			out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_MAS_save_reference_conditions';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MAS_display_reference_conditions';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("help_box.innerHTML=\"System Administration - Conditions - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\"System Administration - Conditions - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
	  	...
	  	out.println("		}"); 
			...
			out.println("    document.Form1.hid_test.value=val;"); 
			out.println("}"); 

			out.println("function help_button_2() {"); 
			out.println("    document.Form1.hid_help_type.value=\"2\";"); 
			out.println("    m_sql = \"m_help_TXT_INSERT_SCREEN_sql\";"); 
			out.println("    m_criteria = document.Form1.TXT_INSERT_SCREEN.value+\"@Y@\";"); 
			out.println("    HelpBox('1','10','0');"); 
			out.println("}"); 
			out.println(""); 

			out.println("function help_value_assign_2() {"); 
			out.println("    document.Form1.TXT_INSERT_SCREEN.value=oBj.valout[2];"); 
			out.println("}"); 

			out.println("function help_update() {"); 
			out.println("    document.Form1.hid_help_type.value=\"99\";"); 
			out.println("    m_sql = \"m_help_TXT_CONDITION_CODE_sql\";"); 
			...
			out.println("    document.Form1.TXT_INSERT_SCREEN.value=oBj.valout[4];"); 
	  	...
	  	out.println("		}"); 
			...
			out.println("<INPUT TYPE='Hidden' NAME='hid_test' VALUE=\"New\">"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>System Administration - Conditions</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
		  ...
		  out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Close\");'  onclick='close_window()' value=\"Close\"></td>"); 
			...
			out.println("<td width='30%' ><DIV id='DIV_TXT_CODE'  class=div_input>Code *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_CODE' maxlength='15' size='15' onblur=\"assig('J1'),makeRequest(document.Form1.TXT_CODE)\">"); 
			...
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_DESCRIPTION' maxlength='100' style={width:250px} size='100'></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 

			out.println("<td width='30%' ><DIV id='DIV_TXT_INSERT_SCREEN'  class=div_input>Insert Screen *</DIV></td>"); 
			out.println("<td width=\"23%\" ><select class=\"txt_input\" type=\"text\" name=TXT_INSERT_SCREEN maxlength=1 style=\"width: 210px\" >");  

		/*	rs = stmt.executeQuery ("SELECT "+
   														 	"INITCAP(DISPLAY_NAME),POSITION,SCREEN_NAME "+
			...
			rs = stmt.executeQuery (" SELECT INITCAP(DISPLAY_NAME),POSITION,SCREEN_NAME, "+
			                        " OPTION_NAME, "+
															" ROW_ID, "+
															" OPTION_ID "+
															" FROM "+m_schema_name+".CO_CO_MAS_USER_SCREEN "+
															" WHERE DIVISION_CODE='AF' "+ // AND DISPLAY_STATUS ='Y'
															" AND SCREEN_URL IS NOT NULL "+
															" ORDER BY OPTION_ID,OPTION_NAME,ROW_ID ");															
			...
			out.println("<option value="+rs.getString(3)+" selected>"+rs.getString(1)+"</option>");
			more=rs.next();
			}
