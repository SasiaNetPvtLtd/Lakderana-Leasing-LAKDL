// DEVELOP BY : MAHELA FOR OFSCL FACTORING    DATE:06-02-2007
...
public class LAKDL_FA_OP_final_invoice_reminder extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Operation Process - Invoice Reminders - Final Reminder  </TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"FA_OP_PRO_rpt_cheque_return_reminder?chksql=LOAD_FINAL_INVOICE_REMINDER\";");
  		...
  		out.println("		}");
   		...
   		out.println("}"); 
			...
			out.println("			}");
			out.println("			if(validate_data()){"); 
			out.println("				document.Form1.action='"+m_class_url+"/"+m_fschema_name+"FA_OP_save_final_invoice_reminder';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"FA_OP_final_invoice_reminder';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("	help_box.innerHTML=\"  Operation Process - Invoice Reminders - Final Reminder  - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\" Operation Process - Invoice Reminders - Final Reminder  \";"); 
			out.println("}"); 
	  	...
	  	out.println("					}"); 
			...
			out.println("function Generate_Letter2(m_client_code,m_facility_no,m_debtor_code,m_batch_no) {");	
			out.println("	m_url = \""+m_class_url+"/"+m_fschema_name+"FA_OP_Invoice_Final_Reminder_Letter?chksql=main_page&client_no=\"+m_client_code+\"&debtor_code=\"+m_debtor_code+\"&print=TRUE&facility_no=\"+m_facility_no+\"&batch_no=\"+m_batch_no;"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Operation Process - Invoice Reminders - Final Reminder </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
