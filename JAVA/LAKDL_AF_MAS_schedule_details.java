...
public class LAKDL_AF_MAS_schedule_details extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>System Administration - Schedule Details</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MAS_schedule_details';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("help_box.innerHTML=\" System Administration - Schedule Details - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" System Administration - Schedule Details - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
			...
			//out.println(" alert(type + ' ::: ' + document.Form1.hid_screen_name.value);  ");
			out.println("   var m_rpt_type    = type; ");
			
			out.println("   if(type=='run'){");
			
			out.println("   	if(document.Form1.hid_screen_name.value=='NEW' || document.Form1.hid_screen_name.value=='EDIT'){");
			
			out.println("       	if(document.Form1.TXT_SCHEDULE_CODE.value==''){ ");
			out.println("         		alert('Scedule number cannot be blank'); ");
			out.println("       	}");
			out.println("   		else if(document.Form1.TXT_SCHEDULE_DESCRIPTION.value==''){ ");
			out.println("     			alert('Scedule details cannot be blank'); ");
			out.println("   		}");
			out.println("   		else if(document.Form1.TXT_ITEM_CAT.value==''){ ");
			out.println("     			alert('Item category cannot be blank'); ");
			out.println("   		}");
			out.println("   		else if(document.Form1.TXT_ITEM_SUB_CAT.value==''){ ");
			out.println("     			alert('Item sub category cannot be blank'); ");
			out.println("   		}");
			out.println("   		else if(document.Form1.datafile.value==''){ ");
			out.println("     			alert('Please attach the excel file'); ");
			out.println("   		}");
			out.println("   		else{");
			...
			out.println("				document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_MAS_schedule_details_upload_excel';");
			
				//out.println("				document.Form1.action='"+m_class_url+"/"+m_fschema_name+"UPLOAD_EXCEL';");
			...
			out.println("   else if(document.Form1.hid_screen_name.value=='DEACT' || document.Form1.hid_screen_name.value=='REACT'){");
			out.println("       var m_path = document.getElementById('datafile').value; ");
			out.println("   	var m_schedule_no = document.Form1.TXT_SCHEDULE_CODE.value; ");
			out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_MAS_schedule_details_upload_excel_3';");
			out.println("		document.Form1.submit();");
			out.println("   }");
			...
			/*
			out.println("	if(document.Form1.hid_screen_name.value==\"RACT\") ");
			out.println("		act_status = 'N'; ");
			out.println("	else ");
			out.println("		act_status = 'Y'; ");
			*/
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>System Administration - Schedule Details</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
