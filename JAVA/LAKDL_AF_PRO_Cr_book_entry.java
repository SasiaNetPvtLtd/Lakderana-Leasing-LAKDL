...
public class LAKDL_AF_PRO_Cr_book_entry extends javax.servlet.http.HttpServlet {
	...
	public void service(HttpServletRequest req, HttpServletResponse res)
	{
		...
		try {
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_PRO_Cr_book_entry?chksql=main_page';"); 
			out.println("		}"); 
			out.println("}"); 
				...
				out.println("<input type=hidden name=\"Hid_scr_name\" value=\"AF_PRO_CR_BOOK_ENTRY\">");
				...
				out.println("</tr>");
				out.println("<tr>");
				out.println("<td align=\"left\" class=\"pdn_txtpos2\" height=\"2%\" id=help_box>CR Book Entry</td>");
				out.println("</tr>");
				...
				out.println("<input name=\"SAVE_BTN\"   value='Print' style=\"width:120px;\" id='enableBtn' onclick='saveBatch()' type=\"button\" class='but_input'></td>"); // value changed as Print from Save udara 21-06-2019
				out.println("</td>");
				out.println("</tr>");
				...
				out.println("       <script type=\"text/javascript\" src='"+m_html_client_url+"/crBook/cr_book_entry.js'></script>");
				...
				out.println("<HTML><HEAD><TITLE>CR Book Received</TITLE></HEAD>"); 
				out.println("<link href=\""+m_html_client_url+"/css/Asset_Financing_System.css\" rel=\"stylesheet\" type=\"text/css\" >");
				...
				out.println("<table width='100%'><tr align='center'><td><b>List of CR Book Received Vehicles</b></td></tr></table>");
				...
				rs = stmt.executeQuery("SELECT FINANCE_NO, " +
										...
										"  VEHICLE_NO " +
										"FROM AF_PRO_CR_BOOK " +
										"WHERE RECEIVED_BATCH='"+m_batch_no+"'");
