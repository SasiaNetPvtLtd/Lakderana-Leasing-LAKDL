...
public class LAKDL_FA_OP_ClientWise_Details extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			String facility_no=req.getParameter("FACILITY_NO");
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
     	...
     	out.println("		document.Form1.TXT_ADJ_DD.value=v_dd;");
	  	...
	  	out.println("					}"); 
			...
			*/
			...
			out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"FA_OP_PRO_sql_client_availability_new_scr?chksql=LOAD_CLIENT_AVAILABILITY&CLIENT_CODE="+client_code+"&FACILITY_NO="+facility_no+"\";");	
