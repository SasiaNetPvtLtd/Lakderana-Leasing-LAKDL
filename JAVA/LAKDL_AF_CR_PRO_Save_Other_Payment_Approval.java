...
public class LAKDL_AF_CR_PRO_Save_Other_Payment_Approval extends HttpServlet {
...
//			PrintStream out = new PrintStream(res.getOutputStream());
	 //   out.println(reqstr);
      ...
      String m_scr_name=(String)m_sn_methods.met_formdata(reqstr,"Hid_scr_name"); 
			...
			callstmt=conn.prepareCall("BEGIN "+m_schema_name+".AF_CR_PRO_SAVE_APR_OTH_PAYMNTS(:1,:2,:3,:4); END;");
		...
		//	out.println("else");
			out.println("window.location.href='"+m_url+"/"+m_client_name+"AF_CR_PRO_Other_Payments_Approval?chksql=main_page';");
