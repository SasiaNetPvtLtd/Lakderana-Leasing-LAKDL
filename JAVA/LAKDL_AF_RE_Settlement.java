...
public class LAKDL_AF_RE_Settlement extends javax.servlet.http.HttpServlet {
	...
	*/
	...
	//public synchronized void service(HttpServletRequest req, HttpServletResponse res) // commented by udara 16-05-2017
	public  void service(HttpServletRequest req, HttpServletResponse res) // added by udara 16-05-2017
	{
		
		Connection conn = null;
		Statement stmt=null,stmt1=null,stmt2=null,stmt12=null,stmt_act=null;
		java.text.NumberFormat nf=null,nf1=null;
		ResultSet rs=null,rs1=null,rs2=null,rs12=null,rs_act=null;
		...
		try {
			...
			if (m_chksql.trim().equals("idle")) {
				...
				//out.println("      client_help();"); // commented by udara 29-02-2016
				out.println("			}");
				out.println("			 if( data_vec.length>0 && document.Form1.hid_help_status.value=='H_client' && document.Form1.CLIENT_CODE.value !='' ){");
				...
				out.println("     else ");
				out.println("     if(data_vec[0]=='REPOSSESS') ");	
				out.println("        alert('This is a repossessed contract and cannot proceed'); ");
				
				// added by udara 26-1-2013
				out.println("     else ");
				out.println("     if(data_vec[0]=='TERMINATED') ");	// BAL_TRANSF
				out.println("        alert('This is a terminated contract and cannot proceed'); ");
				// added by udara 26-1-2013
				
				// added by udara 08-09-2015
				out.println("     else ");
				out.println("     if(data_vec[0]=='CANCEL_PO') ");	
				out.println("        alert('This is an abandoned contract and cannot proceed'); ");
				
				out.println("     else ");
				out.println("     if(data_vec[0]=='REJECT') ");	
				out.println("        alert('This is an abandoned contract and cannot proceed'); ");
				// added by udara 08-09-2015
       ...
       out.println("		 if(data[16] == '' || data[16]== 'null' )");	
			 ...
			 */	
				...
				//out.println("   m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_RE_Settlement?chksql=get_inv_details&Client_Code=\"+document.Form1.CLIENT_CODE.value;"); // commented by udara on 07-05-2013
				out.println("   m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_RE_Settlement?chksql=get_inv_details&finance_no=\"+document.Form1.TXT_CONTRACT_NUMBER.value;"); // added by udara on 07-05-2013
				//out.println(" window.open(m_url);");
				...
				*/
				...
				out.println("if((document.Form1.AMOUNT.value==\"\") || (document.Form1.AMOUNT.value<=\"0\") || (document.Form1.AMOUNT.value==\"0.00\")){  "); // added by udara 03-02-2017
				out.println("  AMOU.style.color='red';");
				out.println("}");
				out.println("else{");
				out.println("   AMOU.style.color='black';");
				...
				out.println("if((document.Form1.AMOUNT.value==\"\") || (document.Form1.AMOUNT.value<=\"0\") || (document.Form1.AMOUNT.value==\"0.00\")){  "); 
				out.println("  AMOU.style.color='red';");
				out.println("  m_sub = 1;;"); 
				out.println("}");
				...
				out.println("if(document.Form1.OTHER_CHARGES.value == 'Y'){");//Added By Kanishka Dilshan On 08-05-2014
				//out.println("  if(document.Form1.amount_after_excess.value > 0 ){  ");
				//out.println(" alert('Total Outstanding Ins = '+parseFloat(document.Form1.Total_Outstanding_Ins.value)); ");
				
				
				//out.println("  alert(document.Form1.hid_contract_status.value);   ");
				
				//out.println("  if( parseFloat(document.Form1.Total_Outstanding_Ins.value) > 0 ){  ");
				// commented by udara 03-06-2014
				/*
				out.println("  if( (parseFloat(document.Form1.Total_Outstanding_Ins.value) > 0) && (document.Form1.hid_contract_status.value=='Activated') ){  ");
				
				out.println("  }else { "); 
				out.println("		alert(\"Insurance payment cannot be saved unless there is an outstanding Insurance Premium.\"); ");
				out.println("       m_sub = 1;");
				
				out.println("  }");
				*/
				
				// added by udara 03-06-2014
				//out.println("  if(document.Form1.hid_contract_status.value=='Activated'){  "); // commented by udara 22-05-2015 for non active validation
				
				out.println("  if((document.Form1.hid_contract_status.value=='Activated')||(document.Form1.hid_contract_status.value!='Activated')){  ");
				...
				out.println("  }"); // commented by udara 22-05-2015 for non active validation
				// end by udara 03-06-2014
				...
				out.println("  m_sub = 1;;"); 
				out.println("}"); 
				//out.println("if(document.Form1.AMOUNT.value==\"\"){  "); // commented by udara 03-02-2017
				out.println("if((document.Form1.AMOUNT.value==\"\") || (document.Form1.AMOUNT.value<=\"0\") || (document.Form1.AMOUNT.value==\"0.00\")){  "); // added by udara 03-02-2017
				out.println("  AMOU.style.color='red';");
				out.println("  m_sub = 1;;"); 
				out.println("}");
				...
				out.println("    m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_RE_sql_validations?chksql=check_app_status&FINANCE_NO=\"+document.Form1.TXT_CONTRACT_NUMBER.value;");
				out.println("	 load_interface(m_url,'XML');");
				out.println("}");
				// added by udara 05-07-2013
				...
				out.println("		document.Form1.action='"+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_RE_Save_Receipt';"); // commented by udara 18-01-2017  //added by nuwan de silva
				//out.println("		document.Form1.action='"+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_RE_Save_Receipt_2';"); // added by udara 18-01-2017
				...
				//out.println("alert(oBj);");
				out.println(" document.Form1.CLIENT_NAME.value =oBj.valout[3]");
				out.println(" document.Form1.CLIENT_CODE.value =oBj.valout[9]");
				out.println(" document.Form1.TXT_CONTRACT_NUMBER.value =oBj.valout[2]");//Added by Prabash on 13-07-2012
				...
				// commented by udara 19-05-2017 because unnecessary
				/*
				...
				*/
				...
				//ADDED MILINDA FOR RESTRICT WHEN INSURANSE TYPE Y 
				out.println("function value_disable(){");
				out.println("if(document.Form1.OTHER_CHARGES.value==\"Y\" ){");
			...
			*/
			...
			out.println("inv_amt1 = parseFloat(unformat_noobject(document.Form1.elements['Text_inv_sett_amount2'+val1].value));");
				...
				// end by udara on 10-07-2013
				
				
				// added by udara 21-02-2014
				out.println("function check_closing(obj){"); 
				
				out.println("     var rental_amount = 0; ");
				
				out.println("	  if(obj.checked==true){");
				out.println("     		if(document.Form1.TXT_FIFO.value=='FIFO_MANU'){ ");
				out.println("     				rental_amount = unformat_noobject(document.Form1.TXT_RENTAL_OTHER_INV.value); "); 
				out.println("     				if(rental_amount >0 ) { ");
				out.println("	     				obj.value='Y'; ");
				out.println("           		}  ");
				out.println("           		else{  ");
				out.println("               		alert('Closing can be applied only with rentals');  ");
				...
				out.println("	     obj.value='Y'; "); // if check box selected the closing status enabled for all
				...
				*/
				...
				//-------------------------------------------------------------------------------------------------------			
				out.println("</script>"); 
				//out.println("<BODY class='body & txt-body' leftmargin='0' topmargin='0' marginwidth='0' ONLOAD=\"load_roll_out_value();load_lock();get_sysdate();disable_help();add_row_cheque();disable_val_date();alloc_other();\">"); commented by udara on 24-09-2012 
				out.println("<BODY class='body & txt-body' leftmargin='0' topmargin='0' marginwidth='0' ONLOAD=\"load_roll_out_value();load_lock();get_sysdate();disable_help();add_row_cheque();disable_val_date();alloc_other();enable_check_date();\">"); // added by udara on 24-09-2012 
				...
				out.println("<td width=10%>&nbsp;</td>");
				out.println("<td ><input type=button name=b_submit value=\"Save\" class=mainbut onclick=check_app_status(); onMouseOver='load_roll_value(\"Save\");' onmouseout='load_roll_out_value();'></td>"); // commented by udara 05-07-2012 // out.println("<td ><input type=button name=b_submit value=\"Save\" class=mainbut onclick=befor_submit(); onMouseOver='load_roll_value(\"Save\");' onmouseout='load_roll_out_value();'></td>");
				out.println("<td>&nbsp;</td>");
				...
				out.println("<OPTION value=\"CASH\" selected >Cash</OPTION>"); // added by udara on 19-09-2012
				out.println("<OPTION value=\"CHEQUE\">Cheque</OPTION>"); // added by udara on 19-09-2012
				...
				out.println("<td width=\"40%\"  ><input name=\"CLIENT_CODE\"   type=\"text\" maxlength=\"20\"  onblur=\"makeRequest5(this.value)\"  class=\"txt_input\" onchange=\"check_client(), inv_details()\"> "); //style=\"{background-color:#CCCCFF}\"
		    ...
		    out.println("</tr>"); 
			  out.println("</table>");	 
				*/
				...
				out.println("<td width=\"30%\"><SELECT  onchange=get_other_charges();value_disable(); name=OTHER_CHARGES class=\"txt_input\" > ");
			...
			*/
				...
				out.println("<table align='center'  width='100%' class='table'>"); 				
				out.println("<tr>"); //  class=tr_input
				out.println("<td width=\"20%\" valign='top'>Closing</td>");
				//out.println("<td width=\"30%\"><input name=\"REMARK\"   type=\"text\" maxlength=\"100\"   style=\"width: 300px\" class=\"txt_input\" > "); //comment by nuwan de silva on 27-08-07
				//out.println("<td width='30%' ><input type=checkbox  name='chk_closing' value = 'N' onclick='check_closing(this);' ></td>"); // class='txt_input' // commented by udara 13-07-2015
				out.println("<td width='30%' ><input type=checkbox  name='chk_closing' value = 'N' onclick='check_chk_boxes(this);' ></td>");  // added by udara 13-07-2015
				out.println("</td>");
				out.println("<td width=\"*%\"></td>");
				out.println("</tr>");
				out.println("</table>");
				
				// end by udar 21-02-2014
				
				
				// added by udara on 13-07-2015
				out.println("<table align='center'  width='100%' class='table'>"); 				
				out.println("<tr>"); 
				out.println("<td width=\"20%\" valign='top'>Documentation Charges</td>"); // out.println("<td width=\"20%\" valign='top'>Initial Charges</td>");
				out.println("<td width='30%' ><input type=checkbox  name='chk_init_charge' value = 'N' onclick='check_chk_boxes(this);' ></td>"); // class='txt_input'
				out.println("</td>");
				out.println("<td width=\"*%\"></td>");
				out.println("</tr>");
				out.println("</table>");
				...
				out.println("<table align='center'  width='100%' class='table'>"); 				
				out.println("<tr>"); 
				out.println("<td width=\"20%\" valign='top'>Stamp Duty</td>");
				out.println("<td width='30%' ><input type=checkbox  name='chk_stamp_duty' value = 'N' onclick='check_chk_boxes(this);' ></td>"); // class='txt_input'
				out.println("</td>");
				out.println("<td width=\"*%\"></td>");
				out.println("</tr>");
				out.println("</table>");
				// end by udara on 13-07-2015
				
				// added by udara 25-08-2016
				out.println("<table align='center'  width='100%' class='table'>"); 				
				out.println("<tr>"); 
				out.println("<td width=\"20%\" valign='top'>Refinance</td>");
				out.println("<td width='30%' ><input type=checkbox  name='chk_refinance' value = 'N' onclick='check_chk_boxes(this);' ></td>"); // class='txt_input'
				out.println("</td>");
				out.println("<td width=\"*%\"></td>");
				out.println("</tr>");
				out.println("</table>");
        ...
        out.println("<td>&nbsp;</td>");
				...
				*/
				...
				out.println("<td width=10%>&nbsp;</td>");
				out.println("<td ><input type=button name=b_submit1 value=\"Save\" class=mainbut onclick=check_app_status(); onMouseOver='load_roll_value(\"Save\");' onmouseout='load_roll_out_value();'></td>"); // added by udara on 05-07-2013 // out.println("<td ><input type=button name=b_submit1 value=\"Save\" class=mainbut onclick=befor_submit(); onMouseOver='load_roll_value(\"Save\");' onmouseout='load_roll_out_value();'></td>"); 
				out.println("<td>&nbsp;</td>");
				out.println("<td>&nbsp;</td>");
				...
				//String m_client    = req.getParameter("Client_Code"); // commented by udara on 07-05-2013
				String m_finance_no    = req.getParameter("finance_no"); // added by udara on 07-05-2013
				...
				*/
				...
				rs1=stmt1.executeQuery(
					...
					"                                                                    WHERE    ACTIVE_STATUS IN ('Y') "+
					" 																	  AND      APPLICATION_NO='"+mm_application_no+"' "+
				...
				*/
				...
				/*Added By Ns on 26-06-2012*/
				out.println("  <tr >");
				out.println("  <td WIDTH=15% bgcolor=\"#FFFF00\" ><b>Excess Receipts (-) </td>");
				out.println("  <td WIDTH=15% bgcolor=\"#CC66FF\" align=right><b>"+nf.format(m_excess_receipt_amount)+"</td>");
				out.println("  <td WIDTH=15% bgcolor=\"#CC99FF\" align=right><b>&nbsp;</td>");
				out.println("  <td WIDTH=15% bgcolor=\"#CCCCFF\" align=right><b>&nbsp;</td>");
				out.println("  </tr>");
				...
				out.println("  <tr >");
				out.println("  <td WIDTH=15% bgcolor=\"#CCCCCC\" ><b>Total Outstanding<input type='hidden' name='amount_after_excess' value = '"+m_amount_after_excess+"'></td>");
				...
				out.println("  <tr >");
				out.println("  <td WIDTH=15% bgcolor=\"#FFFFFF\" >&nbsp;</td>");
				out.println("  <td WIDTH=15% bgcolor=\"#FFFFFF\" >&nbsp;</td>");
				out.println("  <td WIDTH=15% bgcolor=\"#FFFFFF\" >&nbsp;</td>");
				out.println("  <td WIDTH=15% bgcolor=\"#FFFFFF\" >&nbsp;</td>");
				out.println("  </tr>");
				...
				/*Insurance Details*/
				out.println("  <tr >");
				out.println("  <td WIDTH=15% bgcolor=\"#FFFF00\" ><b>Insurance Invoice</td>");
				out.println("  <td WIDTH=15% bgcolor=\"#CC66FF\" align=right><b>"+nf.format(mm_insurance_arrears)+"</td>");
				out.println("  <td WIDTH=15% bgcolor=\"#CC99FF\" align=right><b>"+nf.format(mm_insurance_future)+"</td>");
				out.println("  <td WIDTH=15% bgcolor=\"#CCCCFF\" align=right><b>"+nf.format(mm_insurance_arrears+mm_insurance_future)+"</td>");
				out.println("  </tr>");
				
				out.println("  <tr >");
				out.println("  <td WIDTH=15% bgcolor=\"#FFFF00\" ><b>Excess Receipts Ins (-) </td>");
				out.println("  <td WIDTH=15% bgcolor=\"#CC66FF\" align=right><b>"+nf.format(m_excess_receipt_amount_ins)+"</td>");
				out.println("  <td WIDTH=15% bgcolor=\"#CC99FF\" align=right><b>&nbsp;</td>");
				out.println("  <td WIDTH=15% bgcolor=\"#CCCCFF\" align=right><b>&nbsp;</td>");
				out.println("  </tr>");
				...
				out.println("  <tr >");
				out.println("  <td WIDTH=15% bgcolor=\"#CCCCCC\" ><b>Total Outstanding Ins<input type='hidden' name='Total_Outstanding_Ins' value = '"+(m_total_amt_ins+m_total_amt_future_ins)+"'></td>");
				out.println("  <td WIDTH=15% bgcolor=\"#CCCCCC\" align=right><b>"+nf.format(m_total_amt_ins)+"</td>");
				out.println("  <td WIDTH=15% bgcolor=\"#CCCCCC\" align=right><b>"+nf.format(m_total_amt_future_ins)+"</td>");
				out.println("  <td WIDTH=15% bgcolor=\"#CCCCCC\" align=right><b>"+nf.format(m_total_amt_ins+m_total_amt_future_ins)+"</td>");
				out.println("  </tr>");
				/*Insurance details*/
				...
				out.println("<table border='0' WIDTH=60% class='table' >");
				out.println(" <tr   >"); 
				out.println("<td WIDTH=15% style=\"{font-size: 24px;color: #FF3300;}\" ><b>RENTAL DUE DATE</td>");
				out.println("<td WIDTH=15% style=\"{font-size: 24px;color: #FF3300;}\" ><b>"+mm_RENTAL_DATE+"</td>");
				out.println("  </tr>");
				out.println("</table>");
				...
				if(ins_due_count>0){
					...
					rs1=stmt1.executeQuery(" "+
						" SELECT TO_CHAR(DUE_DATE,'DD-MM-YYYY') FROM (  "+
					...
					if(rs1.next()){
						ins_due_date = rs1.getString(1);
					}
					
					out.println("<table border='0' WIDTH=60% class='table' >");
					
					out.println("  <tr>"); 
					out.println("    <td WIDTH=15%  ><b> Insurance Due Date </b></td>");
					out.println("    <td WIDTH=15%  ><b> "+ins_due_date+"  </b></td>");
					out.println("  </tr>");
				...
				int tot_no_of_rental = 0;
				double tot_rental_amount = 0;
				String rental_date = "";
				String app_status = "";
				...
				rs1=stmt1.executeQuery(" "+
					" SELECT "+
					" NVL("+m_schema_name+".AF_CO_GET_TOT_NO_RENTALS('"+m_finance_no+"',TO_CHAR(SYSDATE,'DD-MM-YYYY')),0), "+
					" NVL("+m_schema_name+".AF_CO_GET_INSTALMENT_AMT("+m_schema_name+".AF_CO_GET_APPLICATION_NO('"+m_finance_no+"')),0), "+ //" NVL("+m_schema_name+".AF_CO_GET_RENTAL_TOTAL('"+mm_application_no+"'),0), "+
					" NVL("+m_schema_name+".AF_CO_GET_RENTAL_DATE("+m_schema_name+".AF_CO_GET_APPLICATION_NO('"+m_finance_no+"')),'-'), "+ // " NVL("+m_schema_name+".AF_CO_GET_RENTAL_DATE('"+mm_application_no+"'),'-'), "+
					//" (SELECT APPLICATION_STATUS FROM "+m_schema_name+".AF_CO_PRO_APPLICATION_DETAILS WHERE APPLICATION_NO = "+m_schema_name+".AF_CO_GET_APPLICATION_NO('"+m_finance_no+"')) APPLICATION_STATUS, "+ // " (SELECT APPLICATION_STATUS FROM "+m_schema_name+".AF_CO_PRO_APPLICATION_DETAILS WHERE APPLICATION_NO = '"+mm_application_no+"') APPLICATION_STATUS, "+
					
					" DECODE("+m_schema_name+".AF_CO_GET_APP_STATUS("+m_schema_name+".AF_CO_GET_APPLICATION_NO('"+m_finance_no+"')),'Normal Termination','Normal Termination Pending',"+m_schema_name+".AF_CO_GET_APP_STATUS("+m_schema_name+".AF_CO_GET_APPLICATION_NO('"+m_finance_no+"'))) APPLICATION_STATUS, "+ // added by udara 26-11-2013
					
					" "+m_schema_name+".AF_CO_GET_CLIENT_CODE("+m_schema_name+".AF_CO_GET_APPLICATION_NO('"+m_finance_no+"')), "+
					//" "+m_schema_name+".AF_GET_PERFORM_STATUS('"+m_finance_no+"',TO_CHAR(SYSDATE,'DD-MM-YYYY'))  "+
					
					" DECODE(NVL("+m_schema_name+".AF_GET_PERFORM_STATUS('"+m_finance_no+"',TO_CHAR(SYSDATE,'DD-MM-YYYY')),'PERFORM'),'PERFORM','Perform','NPERFORM','Non Perform',NVL("+m_schema_name+".AF_GET_PERFORM_STATUS('"+m_finance_no+"',TO_CHAR(SYSDATE,'DD-MM-YYYY')),'PERFORM')) "+ // added by udara 28-07-2015
					
					" FROM DUAL "+
					" ");
				
				if(rs1.next()){
					tot_no_of_rental = rs1.getInt(1);
					tot_rental_amount = rs1.getDouble(2);
					rental_date = rs1.getString(3);
					app_status = rs1.getString(4);
					mmm_client_code = rs1.getString(5);
					m_perform_status = rs1.getString(6); // added by udara 28-07-2015
				}
				
				
				// added by udara 28-10-2014
				String ref_fin_no = "";
				String ref_app_no = "";
				
				rs1=stmt1.executeQuery(" "+
					" SELECT NVL(REF_FINANCE_NO,'-'),  "+
					"  NVL(PRE_APPLICATION_NO,'-') "+
					" FROM "+m_schema_name+".AF_CO_PRO_APPLICATION_DETAILS "+
					" WHERE FINANCE_NO = '"+m_finance_no+"' "+
					" ");
				
				if(rs1.next()){
					ref_fin_no = rs1.getString(1);
					ref_app_no = rs1.getString(2);
				}
				
				double ref_fin_fixed_amount = 0;
				int ref_tot_no_of_rental = 0;
				double ref_fin_fixed_amount_2 = 0;
				
				rs1=stmt1.executeQuery(" "+
					" SELECT   "+
					" 	NVL("+m_schema_name+".AF_CO_GET_INSTALMENT_AMT("+m_schema_name+".AF_CO_GET_APPLICATION_NO('"+ref_fin_no+"')),0), "+ 
					"   NVL("+m_schema_name+".AF_CO_GET_TOT_NO_RENTALS('"+ref_fin_no+"',TO_CHAR(SYSDATE,'DD-MM-YYYY')),0), "+
					" 	NVL("+m_schema_name+".AF_CO_GET_INSTALMENT_AMT('"+ref_app_no+"'),0) "+ 
					" 		FROM DUAL "+
					" ");
				
				if(rs1.next()){
					ref_fin_fixed_amount = rs1.getDouble(1);
					ref_tot_no_of_rental = rs1.getInt(2);
					ref_fin_fixed_amount_2 = rs1.getDouble(3); 
				}
				
				//out.println("ref_fin_no " + ref_fin_no );
				//out.println("ref_fin_fixed_amount " + ref_fin_fixed_amount );
				//out.println("ref_fin_fixed_amount_2 " + ref_fin_fixed_amount_2 );
				
				// commented by udara 21-05-2015
				/*
				if(ref_fin_no.equals("-")){
					tot_rental_amount = ref_fin_fixed_amount;
					tot_no_of_rental = ref_tot_no_of_rental;
				}
				*/
				// end by udara 28-10-2014
				
				// added by udara 21-05-2015
				/*
				if(ref_app_no.equals("-")){
					tot_rental_amount = ref_fin_fixed_amount;
					tot_no_of_rental = ref_tot_no_of_rental;
				}
				else{
					tot_rental_amount = ref_fin_fixed_amount_2;
					tot_no_of_rental = ref_tot_no_of_rental;
				}
				*/
				
				//out.println("test 1 ref_fin_no : - " + ref_fin_no);
				//out.println("test 1");
				...
				out.println("  <tr>"); 
				out.println("    <td WIDTH=15%  ><b> Contract Status </b></td>");
				//out.println("    <td WIDTH=15%  ><b> "+app_status+" </b></td>"); // commented by udara 30-05-2014
				out.println("    <td WIDTH=15%  ><b> "+app_status+" - "+m_perform_status+" </b><INPUT TYPE='Hidden' NAME='hid_contract_status' VALUE=\""+app_status+"\" ></td>"); // added by udara 30-05-2014
				out.println("  </tr>");
				
				out.println("  <tr>"); 
				out.println("    <td WIDTH=15%  ><b> Total No. of Rentals </b></td>");
				out.println("    <td WIDTH=15%  ><b> "+tot_no_of_rental+" </b></td>");
				out.println("  </tr>");
				
				//out.println("  <tr>"); 
				//out.println("    <td WIDTH=15%  ><b> Fixed Rental Date </b></td>");
				//out.println("    <td WIDTH=15%  ><b> "+rental_date+" </b></td>");
				//out.println("  </tr>");
				
				out.println("  <tr>"); 
				out.println("    <td WIDTH=15%  ><b> Fixed Rental Amount </b></td>");
				out.println("    <td WIDTH=15%  ><b> "+nf.format(tot_rental_amount)+" </b></td>");
				out.println("  </tr>");
				
				out.println("  <tr>"); 
				out.println("   <td width='15%' class=div_input style=\"cursor:hand\" onclick=\"show_transaction_info('"+mmm_client_code+"','"+m_finance_no+"')\"><u><b> View Transaction History </b></u></td>"); // &raquo;
