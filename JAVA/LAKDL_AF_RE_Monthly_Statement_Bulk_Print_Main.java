...
public class LAKDL_AF_RE_Monthly_Statement_Bulk_Print_Main extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Invoicing - Monthly Statement Bulk Print </TITLE>"); 
			out.println("</HEAD>"); 
      ...
      out.println("			else {");
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_RE_Monthly_Statement_Bulk_Print_Main?chksql=main_page';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("	help_box.innerHTML=\" Invoicing - Monthly Statement Bulk Print - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\" Invoicing - Monthly Statement Bulk Print \";"); 
			out.println("}"); 
		  ...
		  out.println("if(document.Form1.hid_help_type.value=='1'){"); 
			...
			out.println("}");
					...
					out.println("    Sql  = \"m_help_client_code_help\";"); 
			...
			out.println(" 	m_to_date   = m_to_dd+\"-\"+m_to_mm+\"-\"+m_to_yy; ");
			out.println(" 	m_from_date = m_from_dd+\"-\"+m_from_mm+\"-\"+m_from_yy; ");
			out.println(" 	m_client_num = document.Form1.TXT_CLIENT_CODE.value; ");
			out.println("		if(validate_date()) {");		
		//	m_url=servlet_client_url+":"+client_t3_port+"/"+client_name+"cheq_printing?chksql=PRINT&ref_no="+m_sus_refno;
		  out.println("   m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_Bulk_Print_Main?chksql=MONTHLY_STATEMENT&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&print_type=\"+val+\"&client_num=\"+m_client_num+\"\";");
	...
	//	out.println("document.Form1.action=\""+m_class_url+"/"+m_fschema_name+"AF_RE_Bulk_Print_Main\";");
		...
		out.println("}");
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Invoicing - Monthly Statement Bulk Print </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<tr>"); 
			out.println("<td width='10%' ><DIV id='DIV_TXT_CLIENT_CODE'  class=div_input><b>Client Code </b></DIV></td>"); 
			out.println("<td width='20%' ><input class='txt_input' type='text' name='TXT_CLIENT_CODE' maxlength='15' size='10' onblur=\"assignState('M2'),makeRequest(this)\">"); 
	    out.println("<input class='but_input' type='button' name='BUT_TXT_CLIENT_CODE' value=\"...\" onClick=\"help_client_code()\"></td>"); 
			out.println("<td width='6%'><input class='but_input' type='button' name='BUT_BCODE' value=\"Print\" onClick=\"bulk_print()\" style='{cursor:hand;}'></td>"); 
