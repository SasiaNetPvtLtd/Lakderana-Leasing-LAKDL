...
public class LAKDL_AF_RE_PDC_Bulk_Print_Main extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
      ...
      out.println("			else {");
			...
			out.println("	help_box.innerHTML=\" Invoicing - PDC Bulk Print - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\" Invoicing - PDC Bulk Print \";"); 
			out.println("}"); 
	  	...
	  	out.println("					}"); 
			...
			out.println(" 	m_to_date   = m_to_dd+\"-\"+m_to_mm+\"-\"+m_to_yy; ");
			out.println(" 	m_from_date = m_from_dd+\"-\"+m_from_mm+\"-\"+m_from_yy; ");
			//out.println(" 	m_mode = document.Form1.SETT_MODE.value; "); //thamali 2011.10.13
			out.println(" 	m_branch = document.Form1.BRANCH.value; "); //thamali 2011.10.13

			out.println("		if(validate_date()) {");		
		    //m_url=servlet_client_url+":"+client_t3_port+"/"+client_name+"cheq_printing?chksql=PRINT&ref_no="+m_sus_refno;
		    // commented by thamali 2011.10.13
		    //out.println("   m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_Bulk_Print_Main?chksql=PDC&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&print_type=\"+val+\"\";");
		  	out.println("   m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_Bulk_Print_Main_PDC?chksql=BULK_PRINT_RECEIPT&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&branch=\"+m_branch+\"\";");
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Invoicing - PDC Bulk Print </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<td width=\"10%\" >Branch</td>");
			out.println("<td width=\"20%\"> <SELECT name=\"BRANCH\" class=\"txt_input\" onChange=\"\"> ");
			...
			out.println("<input class=\"txt_input5\" type=\"text\" name=TXT_TO_DATE_YY maxlength=\"4\" size=\"4\" > "+
			            //"<input class='but_input' type='button' name='BUT_VIEW' value=\"Pending\" onClick=\"bulk_print('PEN')\"> "+
									"&nbsp;&nbsp;<input class='but_input' type='button' name='BUT_VIEW' value=\"Print\" onClick=\"bulk_print()\">");//bulk_print('ALL')	
			out.println("</td> ");
			out.println("<td width='*%' ></td>");
			out.println("</table>");  
