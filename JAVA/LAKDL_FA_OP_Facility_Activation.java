...
public class LAKDL_FA_OP_Facility_Activation extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Credit Process - Facility Activation</TITLE>"); 
			out.println("</HEAD>"); 
     	...
     	out.println("		document.Form1.TXT_ADJ_DD.value=v_dd;");
   		...
   		out.println("   document.Form1.TXT_ADJ_YY.value=v_yy;");
			...
			out.println("			}");
			out.println("			if(validate_data()){"); 
			out.println("				document.Form1.action='"+m_class_url+"/"+m_fschema_name+"FA_CR_Save_Facility_Activation';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"FA_OP_Facility_Activation';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("	help_box.innerHTML=\" Credit Process - Facility Activation - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\" Credit Process - Facility Activation - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
	  	...
	  	out.println("					}"); 
			...
			out.println(" 	m_sql = \"m_help_DIV_TXT_FACILITY_ACTIVATION_sql\";"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Credit Process - Facility Activation</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("</tr>");
			out.println("<tr >");
			out.println("<td width=\"15%\"><DIV id=\"DIV_TXT_ADJ_DATE\" class=div_input>Activation Date *</DIV></td>");
			...
			out.println("</tr>");
			out.println("<tr >"); 
			out.println("<td width='15%' ><DIV id='DIV_TXT_ACTIVATION_COMMENTS'  class=div_input>Activation Comments</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_ACTIVATION_COMMENTS' maxlength='500' size='500' style='width:200'></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>");
			out.println("</table>"); 
