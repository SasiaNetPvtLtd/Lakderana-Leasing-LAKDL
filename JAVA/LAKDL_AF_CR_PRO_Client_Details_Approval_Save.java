...
public class LAKDL_AF_CR_PRO_Client_Details_Approval_Save extends javax.servlet.http.HttpServlet {
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)	throws IOException	{
		...
		try {
			...
			*/
			...
			int noofrecodes=0;
			noofrecodes= Integer.parseInt(req.getParameter("noofrecodes"));
			String Client_Code="";
			String Approval="";
		
		   callstmt=conn.prepareCall("BEGIN "+m_schema_name+".AF_CLIENT_CHANGE_APPROVAL(:1,:2); END;");
			for(int k=1;k<=noofrecodes;k++){
				Client_Code="";
				Approval="";
				
				Client_Code=req.getParameter("Client_Code_"+k);
				Approval=req.getParameter("Approve_"+k);
			
					//out.println(Client_Code);
					//out.println(Approval);
					
			callstmt.setString(1,Client_Code);
			callstmt.setString(2,Approval);
			callstmt.execute();
			//callstmt.close();
       ...
       " A.CLIENT_CATEGORY, A.ADDRESS1, A.ADDRESS2, A.CITY_CODE, "+
       " A.REFERENCE, A.TEL_NO, A.FAX_NO, A.EMAIL, A.OFFICE_TEL_NO, "+
       "  A.MOBILE_NO,  A.TEMP_ACTIVE_STATUS, A.ENT_USER, "+
...
//out.println(query);
		...
		if(rs!=null){
			            ...
			            out.println("<td width='20%' align='center'>Client Code</td>");
	                    //out.println("<td width='20%' align='center'>Application No</td>");
			            //out.println("<td width='20%' align='center'>Finance No</td>");
						out.println("<td width='20%' align='center'>Client Type</td>");
						out.println("<td width='20%' align='center'>Full Name</td>");
						out.println("<td width='20%' align='center'>Address1</td>");
		                out.println("<td width='20%' align='center'>Address1<</td>");
			            out.println("<td width='20%' align='center'>City_Code</td>");
						out.println("<td width='20%' align='center'>Telephone No</td>");
						out.println("<td width='20%' align='center'>Fax No</td>");
						out.println("<td width='20%' align='center'>Email</td>");
						out.println("<td width='20%' align='center'>Office Telephone No</td>");
						out.println("<td width='20%' align='center'>Mobile No</td>");
			            //out.println("<td width='20%' align='center'>Active Status </td>");
						out.println("<td width='40%' align='center'>Approve</td>");
              ...
              while(more){
						i=i++;
									...
									out.println("<td width='20%' align='right' style= cursor:hand;cursor-color:blue >"+rs.getString(7)+"</td>"); 
									out.println("<td width='20%' align='right' style= cursor:hand;cursor-color:blue >"+rs.getString(8)+"</td>"); 
									out.println("<td width='20%' align='right' style= cursor:hand;cursor-color:blue >"+rs.getString(9)+"</td>"); 
									
									out.println("<td width='20%' align='right' style= cursor:hand;cursor-color:blue >"+rs.getString(10)+"</td>"); 
									out.println("<td width='20%' align='right' style= cursor:hand;cursor-color:blue >"+rs.getString(11)+"</td>"); 
									out.println("<td width='20%' align='right' style= cursor:hand;cursor-color:blue >"+rs.getString(12)+"</td>"); 
									out.println("<td width='20%' align='right' style= cursor:hand;cursor-color:blue >"+rs.getString(13)+"</td>"); 
									out.println("<td width='20%' align='right' style= cursor:hand;cursor-color:blue >"+rs.getString(14)+"</td>"); 
									...
									out.println("<td width='40%' align='center' style= cursor:hand;cursor-color:blue >"+
										" <select name='Approve_"+i+"' class='but_input' > "+
