...
public class LAKDL_AF_CR_PRO_Enter_Deletion_letter_process_copy_save extends HttpServlet {
	...
	public void service(HttpServletRequest req, HttpServletResponse res)	throws IOException{
		...
		synchronized(this){ 
			...
			try {
				...
				// commented by udara 20-11-2020
				/*
				callstmt=conn.prepareCall("BEGIN "+m_schema_name+".AF_DEL_LETTER_PROCESS_SAVE_CP(:1,:2,:3,:4,:5,:6); END;");
				...
				if(m_del_code_cp.equals("")){
					callstmt.registerOutParameter(6,java.sql.Types.CHAR);
				}else{	
					callstmt.setString(6 ,m_del_code_cp);
				}
				...
				if(m_del_code_cp.equals("")){
					m_del_code_cp = callstmt.getString(6);				 	  
				} 
				...
				*/
				...
				if(m_cr_book_status.equals("SAFE")){//[ADDED BY MILINDA ON 24-07-2020 FOR JB20072020-11237] // temp commented by udara 09-12-2020
					...
					out.println("	m_url = \""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_PRO_Deletion_letter_new_process?chksql=main_page&application_no="+m_app_no+"&client_code="+m_cli_no+"&finance_no="+m_fin_no+"&document_code=DELE_LETT&print=TRUE&del_code="+m_del_code_cp+"\";"); 
					...
					out.println("   window.location.href='"+m_url+"/"+m_client_name+"AF_CR_PRO_Enter_Deletion_letter_process_copy?chksql=main_page';");
				
				} // temp commented by udara 09-12-2020
