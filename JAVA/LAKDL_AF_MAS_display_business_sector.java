...
//--
//SCREEN NAME:SYSTEM ADMINISTRATION BUSINESS SECTOR
//ID:1.15 
//CREATED BY:N.V.P.Chandana
//DATE/TIME:20-07-2006/10.35am
//NOTES:
...
public class LAKDL_AF_MAS_display_business_sector extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>System Administration - Business Sectors</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("			}");
			out.println("    else if(data_vec.length > 0 && document.Form1.SCREEN_NAME.value!=\"NEW\"&& document.Form1.TXT_SECTOR_CODE.value !=''&& document.Form1.hid_help_status.value =='H9' ){");
      ...
      out.println("   }");
		...
		//	out.println("    else if(data_vec.length == 0 && document.Form1.SCREEN_NAME.value==\"NEW\"&& document.Form1.TXT_DESCRIPTION.value !=''&& document.Form1.hid_help_status.value =='H8' ){");
    //	out.println("    document.Form1.TXT_DESCRIPTION.value=data_vec[1]; ");
     // out.println("   }");
			
			out.println("    else if(data_vec.length > 0 && document.Form1.SCREEN_NAME.value==\"NEW\"&& document.Form1.TXT_DESCRIPTION.value !=''&& document.Form1.hid_help_status.value =='H1' ){");
      out.println("				alert('Record already exists');");
      ...
      out.println("   }");
			...
			//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_business_sector&data_val=\"+obj.value;");
			out.println("    if(document.Form1.hid_help_status.value=='H9' && document.Form1.SCREEN_NAME.value==\"NEW\"){");
			out.println("    m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_business_sector1&data_val=\"+obj.value;");
			out.println("}");
			out.println("    else");
      ...
      out.println("    m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_business_sector&data_val=\"+obj.value+\"&ac_status=N\";");
     	...
     	out.println("else");
			...
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations1?chksql=m_prime_chk_LAKDL_AF_MAS_display_business_sector_desc&data_val=\"+obj.value;");
			...
			out.println("if(document.Form1.TXT_SECTOR_CODE.value==\"\"){  "); 
		//	out.println("alert('Business Sector Code Can not Be Blank');"); 
		...
		//	out.println("alert('Description Can not Be Blank');"); 
			...
			out.println("    document.Form1.TXT_SECTOR_CODE.value=data_vec[0]; ");
			out.println("    document.Form1.TXT_DESCRIPTION.value=data_vec[1]; ");
			...
			out.println("}");
			out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_MAS_save_business_sector';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MAS_display_business_sector';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("    m_help_message = \"m_help_msg_LAKDL_AF_MAS_display_business_sector\";"); 
			...
			out.println("help_box.innerHTML=\" System Administration - Business Sectors - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" System Administration - Business Sectors - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
      ...
      out.println("}");
		...
		//	out.println("document.Form1.TXT_DESCRIPTION.value='';"); 
		  ...
		  out.println("if(document.Form1.hid_help_type.value==\"99\"){");
			...
			out.println("    } ");
			out.println("    else{");
			out.println("    m_criteria = document.Form1.TXT_SECTOR_CODE.value+\"@\"+\"N@\";}"); 
			...
			out.println("    m_sql = \"m_help_TXT_SECTOR_DESC_sql\";"); 
	  	...
	  	out.println("		}"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>System Administration - Business Sectors</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_SECTOR_CODE' maxlength='10' size='10' onblur=\"assign_help_status('H9'),makeRequest(document.Form1.TXT_SECTOR_CODE)\">"); 
			out.println("<input class='but_input' type='button' name='BUT_HELP_MAIN' value=\"Help\" onClick=\"help_update()\" disabled></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 

			out.println("<td width='30%' ><DIV id='DIV_TXT_DESCRIPTION'  class=div_input>Business Sector Description *</DIV></td>"); 
