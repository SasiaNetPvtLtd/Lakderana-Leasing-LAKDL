...
public class LAKDL_AF_MAS_display_assign_members extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
	    ...
	    out.println("'<TD><B>Employee ID</B></TD><TD><B>User ID</B></TD><TD><B>Name</B></TD><TD><B>Division Code</B></TD>' +"); //modified nuwan de silva 20-07-07
	    out.println("'</TR>';");
      ...
      out.println("function display_data(data_vec){");
		  ...
		  out.println("m_emp_id='<TD WIDTH=\"30%\">'+data_vec[i+2]+'</TD>';");
			...
			out.println("'<INPUT TYPE=\"Hidden\" NAME=hid_TXT_EMP_ID'+j+'	VALUE='+data_vec[i+2]+'>'+");
      ...
      out.println("			}");
		...
		//	out.println("if(document.Form1.SCREEN_NAME.value!=\"RACT\" && document.Form1.hid_chk_status.value==\"M1\")");
			//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_assign_members&data_val=\"+obj.value+\"&ac_status=Y\";");
		//	out.println("else");
			//out.println("if(document.Form1.SCREEN_NAME.value==\"RACT\" && document.Form1.hid_chk_status.value==\"M1\")");
			//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_assign_members&data_val=\"+obj.value+\"&ac_status=N\";");
		//	out.println("else");
			
			out.println("  if(document.Form1.hid_chk_status.value==\"M2\"){"); 
			out.println("  m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations2?chksql=m_prime_chk_LAKDL_AF_MAS_display_assign_team&data_val=\"+obj.value;");
			out.println("  }");
			out.println("else");
	...
	//		out.println("window.open(m_url);");
			...
			out.println("}"); 
			out.println("if(document.Form1.TXT_USER_ID.value==\"\" && m_table.innerHTML==\"\"){  "); 
			out.println("DIV_TXT_USER_ID.style.color='red';");
			out.println("return false;"); 
			out.println("}"); 
			out.println("if(document.Form1.TXT_USER_ID.value==\"\" && m_table.innerHTML==\"\" && document.Form1.SCREEN_NAME.value==\"NEW\"){  "); 
		...
		//	out.println("alert('linebo' +lineno);");
		//	out.println("alert('obj' +obj.value);");
			out.println("var b_status=1;"); // Variable To Hold The Status
					
			out.println("if(obj.value==\"\"){");
			out.println("alert('Select Employee ID; Use Help');");
			...
			//out.println("m_user=\"hid_TXT_USER_ID\"+i");
			out.println("m_user=\"hid_TXT_EMP_ID\"+i");
			
			//out.println("m_team=\"hid_team_id\"+i")
			//out.println("alert('value -'+document.Form1.elements[m_user].value);");
			//out.println("if(document.Form1.elements[m_user].value=\"N\")");
			//out.println("continue;");
			
			out.println("if(obj.value==document.Form1.elements[m_user].value && document.Form1.elements[m_user].value!=\"N\"){");
			out.println("alert('Employee Id Already Exist');");
			out.println("b_status=0;");
			out.println("break;");
			out.println("}");
			...
			//out.println("m_user_id='<TD WIDTH=\"20%\">'+document.Form1.TXT_USER_ID.value+'</TD>';");		
			out.println("m_user_id='<TD WIDTH=\"20%\">'+array_user[0]+'</TD>';");		
		  out.println("m_name='<TD WIDTH=\"30%\">'+array_user[1]+'</TD>';");
		 // out.println("m_emp_id='<TD WIDTH=\"30%\">'+array_user[2]+'</TD>';");
			out.println("m_emp_id='<TD WIDTH=\"30%\">'+document.Form1.TXT_USER_ID.value+'</TD>';");
			out.println("m_division_code='<TD WIDTH=\"20%\">'+array_user[3]+'</TD>';");
      ...
      out.println("m_hid_input='<INPUT TYPE=\"Hidden\" NAME=hid_TXT_USER_ID'+lineno+'	VALUE='+array_user[0]+'>'+"); //VALUE='+document.Form1.TXT_USER_ID.value+'
			out.println("'<INPUT TYPE=\"Hidden\" NAME=hid_TXT_NAME'+lineno+'	VALUE='+array_user[1]+'>'+");	
			out.println("'<INPUT TYPE=\"Hidden\" NAME=hid_TXT_EMP_ID'+lineno+'	VALUE='+array_user[2]+'>'+");
      ...
      out.println("lineno=lineno+1;");
			...
			//out.println("if(confirm('Delete Record ?')) {"); Are you sure you want to delete the team member
			out.println("if(confirm('Are you sure you want to delete the team member ?')) {");  //added by nuwan de silva 20-07-07
			//out.println("array_team[lineno]='<INPUT TYPE=\"Hidden\" NAME=hid_TXT_USER_ID'+lineno+' VALUE=\"N\">';");
			out.println("array_team[lineno]='<INPUT TYPE=\"Hidden\" NAME=hid_TXT_EMP_ID'+lineno+' VALUE=\"N\">';");
	    ...
	    out.println("array_team.join(\" \")+'</table>';");
			...
			out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_MAS_save_assign_members';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MAS_display_assign_members';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("help_box.innerHTML=\" System Administration - Assign Employees To Teams - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" System Administration - Assign Employees To Teams - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
		...
		//	out.println("if(document.Form1.hid_chk_status.value=='M3' && document.Form1.TXT_USER_ID.value!=\"\"){");
			
		//	out.println("}"); 
		//	out.println("else{"); 
			
			out.println("document.Form1.TXT_USER_ID.value=oBj.valout[2];"); 
			out.println("array_user[0]=oBj.valout[15];"); // user id
			//out.println("array_user[1]=oBj.valout[3];");
			out.println("array_user[1]=oBj.valout[4]+ ' '+oBj.valout[5] ;");//employee name
			out.println("array_user[2]=oBj.valout[2];"); // employee id
			out.println("array_user[3]=oBj.valout[12];"); // division
		//	out.println("}"); 
	  	...
	  	out.println("		}"); 
			*/
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>System Administration - Assign Employees To Teams</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
