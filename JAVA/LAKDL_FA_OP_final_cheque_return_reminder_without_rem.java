...
public class LAKDL_FA_OP_final_cheque_return_reminder_without_rem extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Operation Process - Cheque Return Reminders - Final Cheque Return Reminder - Without Remark  </TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"FA_OP_PRO_rpt_cheque_return_reminder?chksql=LOAD_FINAL_CHEQUE_RETURN_REMINDER_WITHOUT_REM\";");
  		...
  		out.println("		}");
   		...
   		out.println("}"); 
			...
			out.println("			}");
			out.println("			if(validate_data()){"); 
			out.println("				document.Form1.action='"+m_class_url+"/"+m_fschema_name+"FA_OP_save_final_chq_return_rem_without_remark';");  
			...
			out.println("    m_help_message = \"m_help_msg_LAKDL_FA_OP_FINAL_RETURN_REM_WITHOUT_R\";"); 
			...
			out.println("	help_box.innerHTML=\"  Operation Process - Cheque Return Reminders - Final Cheque Return Reminder - Without Remark  - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\" Operation Process - Cheque Return Reminders - Final Cheque Return Reminder - Without Remark  \";"); 
			out.println("}"); 
	  	...
	  	out.println("					}"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Operation Process - Cheque Return Reminders - Final Cheque Return Reminder - Without Remark </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
