...
public class LAKDL_AF_MAS_user_approval2 extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>System Administration - User Approval 2 </TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_rpt_user_approval?chksql=LOAD_USER_APPROVAL_2\";");
  		...
  		out.println("		}");
   		...
   		out.println("}"); 
			...
			//out.println("alert(document.Form1.NUM_CHKS.value)");
			...
			out.println("			}");
			out.println("				document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_MAS_save_user_approval2';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MAS_user_approval2';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("    m_help_message = \"m_help_msg_LAKDL_AF_MAS_user_approval2\";"); 
			...
			out.println("	help_box.innerHTML=\" System Administration - User Approval 2 - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\" System Administration - User Approval 2  \";"); 
			out.println("}"); 
	  	...
	  	out.println("					}"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> System Administration - User Approval 2  </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
