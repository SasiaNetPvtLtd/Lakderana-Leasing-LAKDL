//ID         :
//SCREEN NAME:Document Printing - Lease Schedule
//CREATED BY :Nuwan De Silva	
//DATE/TIME  : 08-02-2006
//NOTES:
import java.io.*;
...
public class LAKDL_AF_CR_PRO_Document_Lease_Schedule extends javax.servlet.http.HttpServlet 
{ 
	
	ServletOutputStream out = null;
	Connection conn;
	Statement stmt,stmt_location,stmt_invoice,stmt_rental,stmt_partner,stmt_rental2,stmt_new_pro_invoice;
	java.text.NumberFormat nf;
	public ResultSet rs,rs_location,rs_invoice,rs_rental,rs_partner,rs_rental2,rs_new_pro_invoice;
	...
	{ 
		...
		{ 
			...
			int m_data_count=0;
			String m_status ="";
			int reshedule_count = 0;
			int m_var_lease_count = 0;
			...
			if(m_chksql.trim().equals("main_page"))
			{
				...
				stmt_new_pro_invoice = conn.createStatement ();
				...
				rs = stmt.executeQuery (" SELECT COUNT(A.APPLICATION_NO) "+
					...
					" WHERE  A.TERMINATION_TYPE = 'RESCHEDULE' "+
					" AND    A.APPLICATION_NO   = '"+m_application_no+"' ");
				
				
				if(rs.next()){
					reshedule_count = rs.getInt(1);
				}
				...
				String Client_Data=" SELECT  "+
					...
					//" NVL(DECODE(CLIENT_TYPE,'I',NIC_NO,  'C',BUSINESS_CERTIFICATE_NO),'-'),   "+ //6 //commented by disnaka on 2011-12-07
					" NVL(DECODE(CLIENT_TYPE,'I',NVL(DECODE(NATIONALITY,'SRILANKAN',NIC_NO,PASSPORT_NO),'-'),  'C',BUSINESS_CERTIFICATE_NO),'-'),   "+ //6 //added by disnaka on 2011-12-07
					" NVL(KEY_DECISION_MAKER,'-') "+//7 //Sandun on 25-06-2009
					...
					" NVL(DECODE(CLIENT_TYPE,'I',NVL(DECODE(NATIONALITY,'SRILANKAN',NIC_NO,PASSPORT_NO),'-'),  'C',BUSINESS_CERTIFICATE_NO),'-'),   "+
					
					" NVL(KEY_DECISION_MAKER,'-') "+//7
					" FROM "+m_schema_name+".AF_CO_MAS_CLIENT  "+
					" WHERE   CLIENT_CODE =  "+
					" (SELECT  "+
					" CO_APPLICANT  "+
				...
				rs_location =stmt_location.executeQuery (" SELECT  "+
					...
					" ACTIVE_STATUS='Y' "+
					" ORDER BY INVOICE_NO ");//Added By Sandun  30-07-2009
				...
				if(more)
				{
					...
					m_term_type = rs.getString(6);
					//m_term_ent_date =rs.getString(7);
				}
				//--Close the Result Set And Stateement--------			
				rs.close();
				stmt.close();
				...
				rs=stmt.executeQuery (" SELECT TO_CHAR(MAX(A.APPLY_DATE),'DD-MM-YYYY') "+
					" FROM LAKDL.AF_CR_PRO_TERMINATION A "+
					" WHERE A.APPLICATION_NO = '"+m_application_no+"' ");
				
				
				if(rs.next()){
					m_term_ent_date =rs.getString(1);
				}
				//--Close the Result Set And Stateement--------			
				rs.close();
				stmt.close();
				...
				else
				{
					rs=stmt.executeQuery (" SELECT "+
						...
						" WHERE A.APPLICATION_NO=B.APPLICATION_NO AND "+
						" A.APPLICATION_NO=UPPER('"+m_application_no+"')"+
						" AND B.ENT_DATE IN (SELECT MAX(ENT_DATE) FROM "+m_schema_name+".AF_CO_PRO_APP_PRICING WHERE APPLICATION_NO=UPPER('"+m_application_no+"') GROUP BY APPLICATION_NO)  "+//Sandun on 14-05-2009
						" GROUP BY B.PERIOD, "+
				...
				rs_invoice=stmt_invoice.executeQuery (" SELECT "+
					...
					"  AND B.ACTIVE_STATUS='Y'  "+ //added by nuwan de silva 09-07-2009
					" ORDER BY B.INVOICE_NO"); //Added By Sandun on 30-07-2009
			...
			"  WHERE  APPLICATION_NO=UPPER('"+m_application_no+"')  "+
				...
				*/
				...
				String sql_rent=" SELECT  "+
					...
					//" AND "+m_schema_name+".AF_CO_GET_RENTAL_STREAM(A.APPLICATION_NO)<2  "+
					" GROUP BY TO_NUMBER(INSTALLMENT_NO),RENTAL_DATE  "+
					" ORDER BY TO_NUMBER(INSTALLMENT_NO) ";
				/*
			...
			" FROM(  "+
				...
				*/
				String Sql_Guarantor=" SELECT "+		
					...
					" ORDER BY B.CLIENT_TYPE, A.GUAR_ID ";
				...
				rs=stmt.executeQuery (" SELECT "+m_schema_name+".AF_CO_GET_RENTAL_STREAM('"+m_application_no+"') "+
					" FROM DUAL ");
				
				if(rs.next()){
					m_var_lease_count = rs.getInt(1);
				}
				...
				if(reshedule_count>0)//Added By Sandun on 24-06-2009
					out.println("<tr><td width='*%' class='rep-body1' align='center' style='{font-size: 10px;}'><B>RE-SCHEDULE</td></tr>");
				else
					out.println("<tr><td width='*%' class='rep-body1' align='center' style='{font-size: 10px;}'><B>SCHEDULE</td></tr>");
				out.println("</table>");
				...
				if(m_asset_type.trim().equals("VEHICLE"))
				{
					...
					if(m_client_type.trim().equals("INDIVIDUAL"))
					{
						...
						if(reshedule_count>0){//Added By Sandun on 24-06-2009
							out.println("   <td width='50%' class='rep-body1' style='{text-align:right;}'><b>Re-Schedule No : "+m_finance_no+"/"+m_term_ent_date+" </b></td></tr>");
						}else{
						...
						out.println("  </tr>");
						if(m_term_type.equals("ENHA_DOWN") || m_term_type.equals("RESCHEDULE")){
							out.println("  <tr>");
							if(reshedule_count>0){//Added By Sandun on 24-06-2009
								out.println("    <td colspan='6' class='rep-body1' style='{font-size: 9px;}'><b>&nbsp;Re-Schedule No :"+m_finance_no+" / "+m_term_ent_date+" </td>");
							}else{
						...
						out.println("  <tr>");
						if(reshedule_count>0){
							out.println("   <td colspan='6' class='rep-body1' style='{font-size: 9px;}'><b>&nbsp;Date of the Re-Schedule : "+m_term_ent_date+" </td>");
						}else{
						...
						out.println("<tr>");
						out.println("<td width='1%' class='rep-body1' valign='top' style='{font-size: 9px;}'>&nbsp;</td> ");
						out.println("<td width='*%' class='rep-body1' valign='top' style='{font-size: 9px;}'>Lease to commence from the date of Acceptance Receipt </td> ");
						out.println("</tr>");
						...
						out.println("    <td width='21%' class='rep-body1' style='{font-size: 9px;}'><strong>&nbsp;"+ m_rental+" RENTAL - given in item No 15 of the schedule</strong></td>");
						out.println("  </tr>");
						out.println("  <tr>");
						out.println("    <td colspan='2' class='rep-body1' style='{font-size: 9px;}'>&nbsp;<b>"+m_period+ " "+ m_no_of+" </td>");
						out.println("   <td>&nbsp;</td>");
						out.println(" </tr>");
						out.println("<tr>");
						...
						data="<strong>STIPULATED LOSS VALUE(For 12 months period calculated from date of commencement of Lease)</strong>";
						out.println("<table width='100%'  border='0' cellspacing='0' > ");
						out.println("<tr>");
						...
						*/
						...
						while(more){
							q++;
							out.println("<tr>");
							out.println("  <td class='rep-body1' valign='top'>("+q+")&nbsp;<B>"+rs_invoice.getString(2)+"");
							out.println("<br>");
							...
							out.println("  <td class='rep-body1' valign='top'>&nbsp;<B>"+rs_invoice.getString(6)+"<br>&nbsp;REG NO : "+rs_invoice.getString(12)+"</td>");
						...
						*/
						...
						if(m_term_type.equals("ENHA_DOWN") || m_term_type.equals("RESCHEDULE")){
							...
							if(reshedule_count>0)//Added By Sandun on 24-06-2009
								...
								out.println("   <td width='50%' class='rep-body1' style='{text-align:right;}'><b>Schedule No : "+m_finance_no+" / "+m_term_ent_date+"</b></td></tr>");
					...
					else if(m_client_type.trim().equals("SOLEPROPRI"))
					{
						...
						if(reshedule_count>0){//Added By Sandun on 24-06-2009
							out.println("    <td colspan='7' class='rep-body1' style='{font-size: 9px;}'><b>&nbsp;Re-Schedule No :"+m_finance_no+" / "+m_term_ent_date+" </td>");
						}else{
							out.println("    <td colspan='7' class='rep-body1' style='{font-size: 9px;}'><b>&nbsp;Schedule No :"+m_finance_no+"</td>");
						}
						...
						if(reshedule_count>0){
							out.println("   <td colspan='7' class='rep-body1' style='{font-size: 9px;}'><b>&nbsp;Date of the Re-Schedule : "+m_term_ent_date+" </td>");
						}else{
							out.println("   <td colspan='7' class='rep-body1' style='{font-size: 9px;}'><b>&nbsp;Date of the Schedule : "+m_agreement_date+" </td>");
						}
						out.println(" </tr>");
						...
						while(rs.next()){
							...
							m_b_cert_no=rs.getString(6);
							m_full_name1=rs.getString(2);	
							m_decision_maker=rs.getString(7);
							...
							if(rs.getString(1).equals("CLIENT")){
								...
								//data="<B> MR. TERREANCE ROHANA DELWITA SOLE PROPRIETOR OF " +m_full_name+m_add1+m_add2+m_city_name+"</B>";//Comment by Sandun on 25-06-2009
								data="<B> "+m_decision_maker.toUpperCase()+" OF " +m_add1+m_add2+m_city_name+" SOLE PROPRIETOR OF " +m_full_name+m_add1+m_add2+m_city_name+"</B>";
								out.println("<tr>");
						...
						if(m_var_lease_count<2){
							rs_rental=stmt_rental.executeQuery(sql_rent_new);//sql_rent
							more=rs_rental.next();
							if(more){
							...
							out.println("<td width='10%' style='text-align:right' class='rep-body1' ></td> ");
							out.println("</tr> ");
							out.println("<tr> ");
							out.println("<td class='rep-body1'></td> ");
							out.println("<td  style='text-align:right' class='rep-body1'></td> ");
							out.println("</tr> ");
							out.println("<tr> "); 
							out.println("<td class='rep-body1'></td> "); 
							out.println("<td  style='text-align:right' class='rep-body1'></td> ");
						...
						data="Payment stream given in item 15 of the schedule will commence from <B>"+m_rental_start_date+"</B> with a <b>"+m_ami+"</b> months grace period.Rental payments will commence on the <B>"+m_rental_start_date+" </B>thereafter <B>"+m_rental_start_day+"</B> Day of each month"; //added by ns on 13-10-2010
						out.println("   <td colspan='3'   valign='top' class='rep-body1'>");
						out.println("<table width='100%'  border='0' cellspacing='0' > ");
						out.println("<tr>");
						...
						*/
						...
						//out.println("   <td width='50%' class='rep-body1' style='{text-align:right;}'><b>Schedule No : "+m_finance_no+"</b></td></tr>");
						if(reshedule_count>0){//Added By Sandun on 24-06-2009
							out.println("   <td width='50%' class='rep-body1' style='{text-align:right;}'><b>Re-Schedule No : "+m_finance_no+"</b></td></tr>");
						}else{
							out.println("   <td width='50%' class='rep-body1' style='{text-align:right;}'><b>Schedule No : "+m_finance_no+"</b></td></tr>");
						}
						out.println("   </table>");			
					...
					else if(m_client_type.trim().equals("CORPORATE") || m_client_type.trim().equals("PARTNERS") ) //MODIFED NUWAN DE SILVA 02-JUL-07
					{
						...
						out.println("  </tr>");
						out.println("  <tr>");
						out.println("    <td colspan='2' class='rep-body1'>&nbsp;<b>"+m_period+ " "+ m_no_of+" </td>");
						out.println("   <td>&nbsp;</td>");
						out.println(" </tr>");
						out.println("<tr>");
						...
						out.println(" <tr>");
						out.println("   <td colspan='6' class='rep-body1'><strong>9. STIPULATED LOSS VALUE(For 12 months period calculated from date of commencement of Lease)</strong></td>");
						out.println(" </tr>");
					...
					else if(m_client_type.trim().equals("LIMITED"))
					{
						...
						while(rs.next()){
							...
							if(rs.getString(1).equals("CLIENT")){	
								...
								//out.println("<td width='*%' class='rep-body1' style='{font-size: 9px;}' ><b>PARTNERSHIP CERTIFICATE NO :"+m_b_cert_no+" </td> "); //comment by ns 14-07-2009
								out.println("</tr>");
								out.println("</table>");
							}
							else if(rs.getString(1).equals("CO-APPLICANT")){
						...
						out.println("<tr>");
						//data="Payment of <b>Rs."+nf.format(rs_rental.getDouble(4))+"</b> covering the first and the last <b>"+m_ami+"</b> month/s rental payable on<B>"+m_rental_start_date+"</B> and thereafter <B>"+m_rental_start_day+"</B> day of each month after the expiry of grace period of <b>"+m_ami+"</b> month/s.";
						data="Payment stream given in item 15 of the schedule will commence from <B>"+m_rental_start_date+"</B> with a <b>"+m_ami+"</b> months grace period.Rental payments will commence on the <B>"+m_rental_start_date+" </B>thereafter <B>"+m_rental_start_day+"</B> day of each month";//Mod by sandun on 14-07-2009
						out.println("   <td colspan='3'   valign='top' class='rep-body1'>");
						out.println("<table width='100%'  border='0' cellspacing='0' > ");
						out.println("<tr>");
						out.println("<td width='1%' class='rep-body1' valign='top'><b>6.</td> ");
				...
				else if(m_asset_type.trim().equals("EQUIPMENT") || m_asset_type.trim().equals("MECHINARY") )
				{
					String data="";
					out.println("<font size=2><p style='text-align:left' class='rep-body1'>");	
					//added by nuwan de silva on 01-09-07
					...
					if(reshedule_count>0){//Added By Sandun on 24-06-2009
						...
						out.println("    <td colspan='6' class='rep-body1' style='{font-size: 9px;}'><b>&nbsp;Schedule No :"+m_finance_no+" / "+m_term_ent_date+" </td>");
					}
					...
					out.println("  </tr>");
					out.println("  <tr>");
					out.println("   <td colspan='3' valign='top' class='rep-body1'><strong>&nbsp;3. ACCEPTANCE RECEIPT TO BE ISSUED WITHIN 7 WORKING DAYS OF DELIVERAY OF "+m_asset_type_desc.toUpperCase()+"  </strong></td>"); //EQUIPMENT
					...
					out.println("  </tr>");
					out.println("  <tr>");
					out.println("   <td colspan='7' class='rep-body1'><strong>8. PURPOSE OF "+m_asset_type_desc.toUpperCase()+" <br>"); //EQUIPMENT //"+m_asset_type_desc.toUpperCase()+"
					out.println("       <br>");
					...
					*/
					...
					out.println("  <tr>");
					out.println("   <td colspan='7' class='rep-body1'><strong>12. DESCRIPTION OF "+m_asset_type_desc.toUpperCase()+" LEASE</strong></td>");//EQUIPMENT
					out.println(" </tr>");
					out.println("<tr> ");
