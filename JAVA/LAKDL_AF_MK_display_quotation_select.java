...
public class LAKDL_AF_MK_display_quotation_select extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Marketing - Quotation Letter</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("	if(data_vec.length==0 && document.Form1.TXT_QUOTATION_NO.value!=''){ ");
			...
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MK_sql_validations?chksql=m_prime_chk_LAKDL_AF_MK_display_indicative_quotation&data_val=\"+obj.value+\"&ac_status=Y\";");
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MK_display_quotation_select';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("function close_quotation(){	"); 
			...
			out.println("alert('Please enter a quotation no to view letter')");
			out.println("}");
			out.println("else{");
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MK_Indicative_Quatation_Letter?chksql=view_letter&data_val=\"+document.Form1.TXT_QUOTATION_NO.value+\"&ac_status=Y\";");
      ...
      out.println(" }");
			...
			out.println("    m_sql = \"m_help_TXT_QUOTATION_NO_sql1\";"); 
			...
			//-------------------------------------------------------------------------------------------------------------------------------------
			out.println("</script>"); 
			out.println("<BODY class='body & txt-body' leftmargin='0' topmargin='0' marginwidth='0' ONLOAD=\"load_roll_value('View Quotation'),load_lock()\">"); 
			out.println("<FORM NAME='Form1' method='post'>"); 
			out.println("<input  type='hidden' value='NEW' name='SCREEN_NAME'> "); 
			out.println("<INPUT TYPE='Hidden' NAME='hid_help_type' VALUE=\"\">"); 
			out.println("<INPUT TYPE='Hidden' NAME='hid_status' VALUE=\"View Quotation\">");
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>System Administration - Quotation Letter</td>"); 
			...
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_QUOTATION_NO' maxlength='15' size='15' onblur=\"assig('QT'),makeRequest(document.Form1.TXT_QUOTATION_NO)\">"); 
			out.println("<input class='but_input' type='button' text-align='center' name='BUT_HELP_MAIN' value=\" Help \" onClick=\"help_update()\"></td>"); 
