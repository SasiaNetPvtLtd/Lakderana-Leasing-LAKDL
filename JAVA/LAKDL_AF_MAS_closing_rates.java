...
// created by udara on 07-09-2012
...
public class LAKDL_AF_MAS_closing_rates extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>System Administration - Closing Rates</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MAS_closing_rates';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("help_box.innerHTML=\" System Administration - Closing Rates - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" System Administration - Closing Rates - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
			...
			*/
			...
			out.println("function generate_from_excel(obj){");
			out.println("   if(obj=='run'){ ");
			out.println("   	if(document.Form1.datafile.value==''){ ");
			out.println("     		alert('Please attach the excel file'); ");
			out.println("   	}");
			out.println("   	else{");
			out.println("       	var m_path = document.getElementById('datafile').value; ");
			//out.println("			m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_closing_rates_excel_view?path=\"+m_path;");
			...
			out.println("			document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_MAS_closing_rates_Save_upload_excel';");
			out.println("			document.Form1.submit();");
			out.println("   	}");
			out.println("   }");
			out.println("   else{");
			out.println("			m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_closing_rates_excel_view\";");
			out.println("   		window.open(m_url,'TheNewpop','fullscreen=no,toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes'); ");
			out.println("   }");
			out.println("}");
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>System Administration - Closing Rates</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			*/
			...
			out.println("<input class='but_input' style='width:100px' type='button' name='BUT_RUN_REPORT'  value=\"View\"  onClick=\"generate_from_excel('view');\" > ");
			out.println("</td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
