...
public class LAKDL_FA_RE_crib_info_updation extends javax.servlet.http.HttpServlet { 
  ...
  public ResultSet rs1,rs2;
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Operation Reports - CRIB Information Updation Report </TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("	help_box.innerHTML=\" Operation Reports - CRIB Information Updation Report  - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\" Operation Reports - CRIB Information Updation Report  \";"); 
			out.println("}"); 
	  	...
	  	out.println("					}"); 
			...
			out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"FA_RE_CRIB_Info_Updation_report?chksql=main_page&mmonth=\"+document.Form1.mmonth.value+\"&print=TRUE\";");
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Operation Reports - CRIB Information Updation Report </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<td class='pdn_txtpos' height='150' valign='top'>");  
			 ...
			 rs1 = stmt1.executeQuery (" SELECT  DISTINCT "+
				     "  TO_CHAR(MONTH_END_DATE,'Month-YYYY') MONTH_END_DATE1,TO_CHAR(MONTH_END_DATE,'MM-YYYY'),MONTH_END_DATE "+
				     "  FROM "+m_schema_name+".FA_OP_CLIENT_LOAN_OP_BAL "+
				     "  UNION "+
				     "  SELECT "+
				     "  DISTINCT "+   
				     "  TO_CHAR(MONTH_END_DATE,'Month-YYYY') MONTH_END_DATE1,TO_CHAR(MONTH_END_DATE,'MM-YYYY'),MONTH_END_DATE "+
				     "  FROM "+m_schema_name+".FA_OP_CLIENT_LOAN_OP_BAL_BK ORDER BY MONTH_END_DATE DESC "); 
			...
			out.println("<tr>");
			out.println("<td width='8%' ><DIV id='DIV_TXT_MONTH'  class=div_input><b>Month</b></DIV></td>"); 
			out.println("<TD WIDTH='8%' align=\"left\">");
			out.println("<select name=\"mmonth\" class=txt_input onChange=\"\" > ");
			while(more){
			...
			out.println("<td width='*%' align='left' ><input class='but_input' type='button' name='BUT_DETAILS3' style='width:200' value=\"CRIB Information Updation Report\" onClick=\"makeRequest_detail_3()\"  ></td>");
			out.println("</tr> ");
			out.println("</table> ");
			out.println("<br>"); 
