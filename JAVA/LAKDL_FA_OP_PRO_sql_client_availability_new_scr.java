...
public class LAKDL_FA_OP_PRO_sql_client_availability_new_scr extends HttpServlet {
        ...
        try {
            ...
            if (m_chksql.trim().equals("idle")) {
                ...
                while(rs1.next()){
                    ...
                    out.println("<td width='10%' bgcolor=\"#CC66FF\" align='right' onClick=\"load_availability_drill_other('"+m_client_code+"','"+m_facility_code+"','OPT24','"+m_month_0+"')\" style='cursor:hand'><DIV class=div_input><b>"+nf.format(rs1.getDouble(2))+"</b></DIV></td>");
                    out.println("<td width='10%' bgcolor=\"#CC99FF\" align='right' onClick=\"load_availability_drill_other('"+m_client_code+"','"+m_facility_code+"','OPT24','"+m_month_1+"')\" style='cursor:hand'><DIV class=div_input><b>"+nf.format(rs1.getDouble(3))+"</b></DIV></td>");
                    out.println("<td width='10%' bgcolor=\"#CCCCFF\" align='right' onClick=\"load_availability_drill_other('"+m_client_code+"','"+m_facility_code+"','OPT24','"+m_month_2+"')\" style='cursor:hand'><DIV class=div_input><b>"+nf.format(rs1.getDouble(4))+"</b></DIV></td>");
                    out.println("<td width='10%' bgcolor=\"#FFCCFF\" align='right' onClick=\"load_availability_drill_other('"+m_client_code+"','"+m_facility_code+"','OPT24','"+m_month_3+"')\" style='cursor:hand'><DIV class=div_input><b>"+nf.format(rs1.getDouble(5))+"</b></DIV></td>");
                    out.println("<td width='10%' bgcolor=\"#FFFF99\" align='right' onClick=\"load_availability_drill_other('"+m_client_code+"','"+m_facility_code+"','OPT24','"+m_month_4+"')\" style='cursor:hand'><DIV class=div_input><b>"+nf.format(rs1.getDouble(6))+"</b></DIV></td>");
                    out.println("<td width='10%' bgcolor=\"#CCFF66\" align='right' onClick=\"load_availability_drill_other('"+m_client_code+"','"+m_facility_code+"','OPT24','"+m_month_5+"')\" style='cursor:hand'><DIV class=div_input><b>"+nf.format(rs1.getDouble(7))+"</b></DIV></td>");
                    out.println("<td width='10%' bgcolor=\"#CCCC66\" align='right' onClick=\"load_availability_drill_other('"+m_client_code+"','"+m_facility_code+"','OPT24','"+m_month_6+"')\" style='cursor:hand'><DIV class=div_input><b>"+nf.format(rs1.getDouble(8))+"</b></DIV></td>");
                    out.println("<td width='*%'><DIV class=div_input></DIV></td>");
                    out.println("</tr>");
                }
                
                double m_client_reasign=0;
                
                rs1= stmt1.executeQuery("SELECT "+m_schema_name+".FA_GET_INVOICE_REASIGN_FUL_AMT('"+m_client_code+"','"+m_facility_code+"',TO_CHAR(SYSDATE,'DD-MM-YYYY')), "+
                    " "+m_schema_name+".FA_GET_INVOICE_REASIGN_AMT('"+m_client_code+"','"+m_facility_code+"','"+m_month_0+"'), "+
                    " "+m_schema_name+".FA_GET_INVOICE_REASIGN_AMT('"+m_client_code+"','"+m_facility_code+"','"+m_month_1+"'), "+
                    " "+m_schema_name+".FA_GET_INVOICE_REASIGN_AMT('"+m_client_code+"','"+m_facility_code+"','"+m_month_2+"'), "+
                    " "+m_schema_name+".FA_GET_INVOICE_REASIGN_AMT('"+m_client_code+"','"+m_facility_code+"','"+m_month_3+"'), "+
                    " "+m_schema_name+".FA_GET_INVOICE_REASIGN_AMT('"+m_client_code+"','"+m_facility_code+"','"+m_month_4+"'), "+
                    " "+m_schema_name+".FA_GET_INVOICE_REASIGN_AMT('"+m_client_code+"','"+m_facility_code+"','"+m_month_5+"'), "+
                    " "+m_schema_name+".FA_GET_INVOICE_REASIGN_AMT('"+m_client_code+"','"+m_facility_code+"','"+m_month_6+"')  "+
                    " FROM DUAL");
                
                while(rs1.next()){
                    m_client_reasign=rs1.getDouble(1);
                    out.println("<tr >");
                    out.println("<td width='20%' bgcolor=\"#FFFF00\" ><DIV class=div_input><b>Invoice Adjustment/Reasign</b></DIV></td>");
                    out.println("<td width='10%' bgcolor=\"#FFFF00\" align='right' onClick=\"load_availability_drill_inv_reasign('"+m_client_code+"','"+m_facility_code+"','TOT','"+m_month_0+"')\" style='cursor:hand'><DIV class=div_input><b>"+nf.format(rs1.getDouble(1))+"</b></DIV></td>");
                    out.println("<td width='10%' bgcolor=\"#CC66FF\" align='right' onClick=\"load_availability_drill_inv_reasign('"+m_client_code+"','"+m_facility_code+"','2','"+m_month_0+"')\" style='cursor:hand'><DIV class=div_input><b>"+nf.format(rs1.getDouble(2))+"</b></DIV></td>");
                    out.println("<td width='10%' bgcolor=\"#CC99FF\" align='right' onClick=\"load_availability_drill_inv_reasign('"+m_client_code+"','"+m_facility_code+"','2','"+m_month_1+"')\" style='cursor:hand'><DIV class=div_input><b>"+nf.format(rs1.getDouble(3))+"</b></DIV></td>");
                    out.println("<td width='10%' bgcolor=\"#CCCCFF\" align='right' onClick=\"load_availability_drill_inv_reasign('"+m_client_code+"','"+m_facility_code+"','2','"+m_month_2+"')\" style='cursor:hand' ><DIV class=div_input><b>"+nf.format(rs1.getDouble(4))+"</b></DIV></td>");
                    out.println("<td width='10%' bgcolor=\"#FFCCFF\" align='right' onClick=\"load_availability_drill_inv_reasign('"+m_client_code+"','"+m_facility_code+"','2','"+m_month_3+"')\" style='cursor:hand' ><DIV class=div_input><b>"+nf.format(rs1.getDouble(5))+"</b></DIV></td>");
                    out.println("<td width='10%' bgcolor=\"#FFFF99\" align='right' onClick=\"load_availability_drill_inv_reasign('"+m_client_code+"','"+m_facility_code+"','2','"+m_month_4+"')\" style='cursor:hand' ><DIV class=div_input><b>"+nf.format(rs1.getDouble(6))+"</b></DIV></td>");
                    out.println("<td width='10%' bgcolor=\"#CCFF66\" align='right' onClick=\"load_availability_drill_inv_reasign('"+m_client_code+"','"+m_facility_code+"','2','"+m_month_5+"')\" style='cursor:hand' ><DIV class=div_input><b>"+nf.format(rs1.getDouble(7))+"</b></DIV></td>");
                    out.println("<td width='10%' bgcolor=\"#CCCC66\" align='right' onClick=\"load_availability_drill_inv_reasign('"+m_client_code+"','"+m_facility_code+"','2','"+m_month_6+"')\" style='cursor:hand' ><DIV class=div_input><b>"+nf.format(rs1.getDouble(8))+"</b></DIV></td>");
                    out.println("<td width='*%'><DIV class=div_input></DIV></td>");
                    out.println("</tr>");
                }		
                ...
                while(rs1.next()){
                    ...
                    out.println("<td width='10%' bgcolor=\"#FFFF00\" align='right' onClick=\"load_availability_drill('"+m_client_code+"','"+m_facility_code+"','OPT25')\" style='cursor:hand' ><DIV class=div_input><b>"+nf.format(rs1.getDouble(1))+"</b></DIV></td>");
                ...
                //***********ADDED BY SANDUN ON 31-08-2009************************************************************************************************************************
                
                
                
                double m_client_non_sales=0;
                
                rs1= stmt1.executeQuery("SELECT "+m_schema_name+".FA_GET_NON_SALES_EXCES_FUL_AMT('"+m_client_code+"','"+m_facility_code+"',TO_CHAR(SYSDATE,'DD-MM-YYYY')), "+
                    " "+m_schema_name+".FA_GET_NON_SALES_EXCES_AMT('"+m_client_code+"','"+m_facility_code+"','"+m_month_0+"'), "+
                    " "+m_schema_name+".FA_GET_NON_SALES_EXCES_AMT('"+m_client_code+"','"+m_facility_code+"','"+m_month_1+"'), "+
                    " "+m_schema_name+".FA_GET_NON_SALES_EXCES_AMT('"+m_client_code+"','"+m_facility_code+"','"+m_month_2+"'), "+
                    " "+m_schema_name+".FA_GET_NON_SALES_EXCES_AMT('"+m_client_code+"','"+m_facility_code+"','"+m_month_3+"'), "+
                    " "+m_schema_name+".FA_GET_NON_SALES_EXCES_AMT('"+m_client_code+"','"+m_facility_code+"','"+m_month_4+"'), "+
                    " "+m_schema_name+".FA_GET_NON_SALES_EXCES_AMT('"+m_client_code+"','"+m_facility_code+"','"+m_month_5+"'), "+
                    " "+m_schema_name+".FA_GET_NON_SALES_EXCES_AMT('"+m_client_code+"','"+m_facility_code+"','"+m_month_6+"')  "+
                    " FROM DUAL");
                
                while(rs1.next()){
                    m_client_non_sales=rs1.getDouble(1);
                    out.println("<tr >");
                    out.println("<td width='20%' bgcolor=\"#FFFF00\" ><DIV class=div_input><b>Non Sales And Excess Funds</b></DIV></td>");
                    out.println("<td width='10%' bgcolor=\"#FFFF00\" align='right' onClick=\"load_availability_drill_non_sales('"+m_client_code+"','"+m_facility_code+"','1','"+m_month_0+"')\" style='cursor:hand'><DIV class=div_input><b>"+nf.format(rs1.getDouble(1))+"</b></DIV></td>");
                    out.println("<td width='10%' bgcolor=\"#CC66FF\" align='right' onClick=\"load_availability_drill_non_sales('"+m_client_code+"','"+m_facility_code+"','O','"+m_month_0+"')\" style='cursor:hand'><DIV class=div_input><b>"+nf.format(rs1.getDouble(2))+"</b></DIV></td>");
                    out.println("<td width='10%' bgcolor=\"#CC99FF\" align='right' onClick=\"load_availability_drill_non_sales('"+m_client_code+"','"+m_facility_code+"','O','"+m_month_1+"')\" style='cursor:hand'><DIV class=div_input><b>"+nf.format(rs1.getDouble(3))+"</b></DIV></td>");
                    out.println("<td width='10%' bgcolor=\"#CCCCFF\" align='right' onClick=\"load_availability_drill_non_sales('"+m_client_code+"','"+m_facility_code+"','O','"+m_month_2+"')\" style='cursor:hand' ><DIV class=div_input><b>"+nf.format(rs1.getDouble(4))+"</b></DIV></td>");
                    out.println("<td width='10%' bgcolor=\"#FFCCFF\" align='right' onClick=\"load_availability_drill_non_sales('"+m_client_code+"','"+m_facility_code+"','O','"+m_month_3+"')\" style='cursor:hand' ><DIV class=div_input><b>"+nf.format(rs1.getDouble(5))+"</b></DIV></td>");
                    out.println("<td width='10%' bgcolor=\"#FFFF99\" align='right' onClick=\"load_availability_drill_non_sales('"+m_client_code+"','"+m_facility_code+"','O','"+m_month_4+"')\" style='cursor:hand' ><DIV class=div_input><b>"+nf.format(rs1.getDouble(6))+"</b></DIV></td>");
                    out.println("<td width='10%' bgcolor=\"#CCFF66\" align='right' onClick=\"load_availability_drill_non_sales('"+m_client_code+"','"+m_facility_code+"','O','"+m_month_5+"')\" style='cursor:hand' ><DIV class=div_input><b>"+nf.format(rs1.getDouble(7))+"</b></DIV></td>");
                    out.println("<td width='10%' bgcolor=\"#CCCC66\" align='right' onClick=\"load_availability_drill_non_sales('"+m_client_code+"','"+m_facility_code+"','O','"+m_month_6+"')\" style='cursor:hand' ><DIV class=div_input><b>"+nf.format(rs1.getDouble(8))+"</b></DIV></td>");
                    out.println("<td width='*%'><DIV class=div_input></DIV></td>");
                    out.println("</tr>");
                }		
                ...
                /* Commented And New Line Added By Samitha Kulatilaka On 2011-08-25 */
                ...
                rs1= stmt1.executeQuery("SELECT "+m_schema_name+".FA_CLIENT_AV_BANK_CHEQUE_TOT_2('"+m_client_code+"','"+m_facility_code+"') FROM DUAL");
                ...
                out.println("<tr >");
                out.println("<td width='20%' bgcolor=\"#FFFF00\" ><DIV class=div_input><b>Total Cancelled Cheques</b></DIV></td>");
                ...
                rs1= stmt1.executeQuery("SELECT "+m_schema_name+".FA_CLIENT_AV_ON_ACC_DEBTOR_2('"+m_client_code+"','"+m_facility_code+"') FROM DUAL");
                ...
                rs1= stmt1.executeQuery(" SELECT A.BATCH_NO,TO_CHAR(A.INVOICE_BATCH_DATE,'DD-MM-YYYY'),SUM(B.NET_INVOICE_AMOUNT),SUM(B.BALANCE_AMOUNT)  "+
                    ...
                    " GROUP BY A.BATCH_NO,A.INVOICE_BATCH_DATE ORDER BY A.INVOICE_BATCH_DATE  ");//order by added by ns 02-07-2009
                ...
                rs1= stmt1.executeQuery(" SELECT A.BATCH_NO,TO_CHAR(A.INVOICE_BATCH_DATE,'DD-MM-YYYY'),SUM(B.NET_INVOICE_AMOUNT),SUM(B.BALANCE_AMOUNT)  "+
                    ...
                    " AND B.INVOICE_STATUS='CONF' "+
                    " AND B.REFACTOR_COUNT>2 "+
                    " GROUP BY A.BATCH_NO,A.INVOICE_BATCH_DATE ORDER BY A.INVOICE_BATCH_DATE ");
