...
public class LAKDL_AF_PRO_CR_save_pay_details2 extends HttpServlet {
	...
	public synchronized void  service(HttpServletRequest req, HttpServletResponse res)	throws IOException{
      ...
      String m_username = m_sn_methods.username;
		  ...
		  int m_maxentries     = Integer.parseInt(m_sn_methods.met_formdata(reqstr,"hid_no_rec"));
			...
			int m_invoice_count=Integer.parseInt(m_sn_methods.met_formdata(reqstr,"hid_invoice_no"));  // added by nuwan de silva on 18-01-2008
...
//---------asset docs---------
			...
			callstmt.setString(5,m_sn_methods.met_formdata(reqstr,"TXT_DOC_CODE_"+b));
		  ...
		  callstmt.execute();	
			...
			callstmt1.setString(7,m_follow_up_no);
			}
			...
			callstmt.setString(5,m_sn_methods.met_formdata(reqstr,"TXT_CLIENT_DOC_CODE_"+a));
			callstmt.setInt(6,sel_stage);
      ...
      callstmt.setString(10,"CREDIT");
	   	...
	   	out.println("<HTML><HEAD>");
			...
			out.println("window.location.href='"+m_url+"/"+m_fschema_name+"AF_PRO_CR_display_main_screen_payment_details1?sql=main_page&status_new=&status_edit=&screen_type=NEW&chksql=R&chksql2=B';");
