...
public class LAKDL_FA_OP_PRO_sql_client_availability_new extends javax.servlet.http.HttpServlet {
		...
		try {
     	...
     	res.setDateHeader("Expires", 0);
			...
			if (m_chksql.trim().equals("idle")) {
				...
				out.println("<tr >");
				out.println("<td width='30%'  bgcolor=\"#FFFF00\"><DIV class=div_input><b>Net-Payable Amount</b></DIV></td>");
				if(m_net_pay_amount<0){
				out.println("<td width='20%'  bgcolor=\"#FFFF00\" align='right'><DIV class=div_input><b>("+nf.format(m_net_pay_amount*-1)+")</b></DIV></td>");
				}
				else{
				out.println("<td width='20%'  bgcolor=\"#FFFF00\" align='right'><DIV class=div_input><b>"+nf.format(m_net_pay_amount)+"</b></DIV></td>");
				}
				out.println("<td width='5%'><DIV class=div_input></DIV></td>");
				out.println("<td width='*%'><DIV class=div_input></DIV></td>");
				out.println("</tr>");
				...
				out.println("<tr >");
				out.println("<td width='30%'  bgcolor=\"#FFFF00\"><DIV class=div_input><b>Minimum Invoice Payable Amount</b></DIV></td>");
				if(m_min_pay_amount<0){
				out.println("<td width='20%'  bgcolor=\"#FFFF00\" align='right'><DIV class=div_input><b>("+nf.format(m_min_pay_amount*-1)+")</b></DIV></td>");
				}
				else{
				out.println("<td width='20%'  bgcolor=\"#FFFF00\" align='right'><DIV class=div_input><b>"+nf.format(m_min_pay_amount)+"</b></DIV></td>");
				}
				out.println("<td width='5%'><DIV class=div_input></DIV></td>");
				out.println("<td width='*%'><DIV class=div_input></DIV></td>");
				out.println("</tr>");
				...
				out.println("</tr>");
				out.println("<tr >");
				out.println("<td width='30%' bgcolor=\"#FFFF00\" ><DIV class=div_input><b>Closing Balance</b></DIV></td>");
				if(m_colse_bal<0){
				out.println("<td width='20%' bgcolor=\"#FFFF00\" align='right'><DIV class=div_input><b>("+nf.format(m_colse_bal*-1)+")</b></DIV></td>");
				}
				else{
				out.println("<td width='20%' bgcolor=\"#FFFF00\" align='right'><DIV class=div_input><b>"+nf.format(m_colse_bal)+"</b></DIV></td>");
				}
				out.println("<td width='5%'><DIV class=div_input></DIV></td>");
				out.println("<td width='*%'><DIV class=div_input></DIV></td>");
				out.println("</tr>");
				...
				out.println("</tr>");
				out.println("<tr >");
				out.println("<td width='30%' bgcolor=\"#FFFF00\" ><DIV class=div_input><b>Net Exposure</b></DIV></td>");
				
				double m_exposure=((m_colse_bal+m_bal_overinterest+m_bal_interest)-(m_bal_bank_cheque));
				
				if(m_exposure<0){
				out.println("<td width='20%' bgcolor=\"#FFFF00\" align='right'><DIV class=div_input><b>("+nf.format(m_exposure*-1)+")</b></DIV></td>");
				}
				else{
				out.println("<td width='20%' bgcolor=\"#FFFF00\" align='right'><DIV class=div_input><b>"+nf.format(m_exposure)+"</b></DIV></td>");
				}
				out.println("<td width='*%'><DIV class=div_input></DIV></td>");
				out.println("</tr>");
				out.println("</table>");
				...
				out.println("<table align='center' width='100%' class='table' >");
				out.println("<tr >");
				out.println("<td width='30%' bgcolor=\"#FFFF00\" ><DIV class=div_input><b>Minimum Payable Amount</b></DIV></td>");
				if(m_minim_pay_amount<0){
				out.println("<td width='20%' bgcolor=\"#FFFF00\" align='right'><DIV class=div_input><b>("+nf.format(m_minim_pay_amount*-1)+")</b></DIV></td>");
				}
				else{
				out.println("<td width='20%' bgcolor=\"#FFFF00\" align='right'><DIV class=div_input><b>"+nf.format(m_minim_pay_amount)+"</b></DIV></td>");
				}
				...
				out.println("<tr >");
				out.println("<td width='30%' bgcolor=\"#FFFF00\" ><DIV class=div_input><b>Maximum Payable Amount</b></DIV></td>");
				if((m_max_pay_amount)<0){
				out.println("<td width='20%' bgcolor=\"#FFFF00\" align='right'><DIV class=div_input><b>("+nf.format((m_max_pay_amount)*-1)+")</b></DIV></td>");
				}
				else{
				out.println("<td width='20%' bgcolor=\"#FFFF00\" align='right'><DIV class=div_input><b>"+nf.format(m_max_pay_amount)+"</b></DIV></td>");
				}
				out.println("<td width='*%'><DIV class=div_input></DIV></td>");
				out.println("</tr>");
				...
				out.println("<HTML><HEAD><TITLE>ACTIVE INVOICE BATCHES TOTAL</TITLE></HEAD>");
				...
				out.println("<HTML><HEAD><TITLE>DISAPPROVAL INVOICES TOTAL</TITLE></HEAD>");
				out.println("<link REL='STYLESHEET' HREF='"+m_html_client_url+"/css/Asset_Financing_System.css' TYPE=\"text/css\">");
				out.println("<BODY   class='body & txt-body' LEFTMARGIN='0' TOPMARGIN='0'>");
				out.println("<FORM NAME='Form1' method='post'>"); 
				out.println("<table align='center' width='100%' class='table' >");
				...
				out.println("<HTML><HEAD><TITLE>DUE DATE EXCEEDED INVOICE TOTAL</TITLE></HEAD>");
				out.println("<link REL='STYLESHEET' HREF='"+m_html_client_url+"/css/Asset_Financing_System.css' TYPE=\"text/css\">");
				out.println("<BODY   class='body & txt-body' LEFTMARGIN='0' TOPMARGIN='0'>");
				out.println("<FORM NAME='Form1' method='post'>"); 
				out.println("<table align='center' width='100%' class='table' >");
				...
				out.println("<HTML><HEAD><TITLE>GROSS-PAYABLE AMOUNT</TITLE></HEAD>");
				out.println("<link REL='STYLESHEET' HREF='"+m_html_client_url+"/css/Asset_Financing_System.css' TYPE=\"text/css\">");
				out.println("<BODY   class='body & txt-body' LEFTMARGIN='0' TOPMARGIN='0'>");
				out.println("<FORM NAME='Form1' method='post'>"); 
				out.println("<table align='center' width='100%' class='table' >");
				...
				while(rs2.next()){
					...
					out.println("<tr bgcolor=\"#CCCCCC\">");
					if(m_temp1>rs2.getDouble(4) && m_temp1>0){
					//out.println("<td width='15%' class=div_input ></td>");
					//out.println("<td width='10%' class=div_input ></td>");
					out.println("<td width='10%' class=div_input ></td>");
					out.println("<td width='15%' class=div_input ></td>");
					...
					else if(m_temp1<=rs2.getDouble(4) && m_temp1>0){
					//out.println("<td width='15%' class=div_input ></td>");
					//out.println("<td width='10%' class=div_input ></td>");
					out.println("<td width='10%' class=div_input ></td>");
					out.println("<td width='15%' class=div_input ></td>");
				...
				if(m_option_no.equals("OPT8")){
					...
					out.println("<HTML><HEAD><TITLE>TOTAL CHARGES</TITLE></HEAD>");
					out.println("<link REL='STYLESHEET' HREF='"+m_html_client_url+"/css/Asset_Financing_System.css' TYPE=\"text/css\">");
					out.println("<BODY   class='body & txt-body' LEFTMARGIN='0' TOPMARGIN='0'>");
					out.println("<FORM NAME='Form1' method='post'>"); 
					out.println("<table align='center' width='100%' class='table' >");
       		...
       		" DECODE(A.DRCR_STATUS,'DR',A.FEE_CHARGE_AMOUNT,A.FEE_CHARGE_AMOUNT*-1) "+
				...
				if(m_option_no.equals("OPT10")){
					...
					out.println("<HTML><HEAD><TITLE>TOTAL PENDING PAYMENTS</TITLE></HEAD>");
					out.println("<link REL='STYLESHEET' HREF='"+m_html_client_url+"/css/Asset_Financing_System.css' TYPE=\"text/css\">");
					out.println("<BODY   class='body & txt-body' LEFTMARGIN='0' TOPMARGIN='0'>");
					out.println("<FORM NAME='Form1' method='post'>"); 
					out.println("<table align='center' width='100%' class='table' >");
				...
				if(m_option_no.equals("OPT11")){
					...
					out.println("<HTML><HEAD><TITLE>TOTAL PAYMENTS</TITLE></HEAD>");
					out.println("<link REL='STYLESHEET' HREF='"+m_html_client_url+"/css/Asset_Financing_System.css' TYPE=\"text/css\">");
					out.println("<BODY   class='body & txt-body' LEFTMARGIN='0' TOPMARGIN='0'>");
					out.println("<FORM NAME='Form1' method='post'>"); 
					out.println("<table align='center' width='100%' class='table' >");
				...
				if(m_option_no.equals("OPT12")){
					...
					out.println("<HTML><HEAD><TITLE>INTEREST NORMAL</TITLE></HEAD>");
					out.println("<link REL='STYLESHEET' HREF='"+m_html_client_url+"/css/Asset_Financing_System.css' TYPE=\"text/css\">");
					out.println("<BODY   class='body & txt-body' LEFTMARGIN='0' TOPMARGIN='0'>");
					out.println("<FORM NAME='Form1' method='post'>"); 
					out.println("<table align='center' width='100%' class='table' >");
				...
				if(m_option_no.equals("OPT13")){
					...
					out.println("<HTML><HEAD><TITLE>RECEIVED FROM ACTIVE INVOICES</TITLE></HEAD>");
					out.println("<link REL='STYLESHEET' HREF='"+m_html_client_url+"/css/Asset_Financing_System.css' TYPE=\"text/css\">");
					out.println("<BODY   class='body & txt-body' LEFTMARGIN='0' TOPMARGIN='0'>");
					out.println("<FORM NAME='Form1' method='post'>"); 
					out.println("<table align='center' width='100%' class='table' >");
				...
				if(m_option_no.equals("OPT14")){
					...
					out.println("<HTML><HEAD><TITLE>RECEIVED FROM INACTIVE INVOICES</TITLE></HEAD>");
					out.println("<link REL='STYLESHEET' HREF='"+m_html_client_url+"/css/Asset_Financing_System.css' TYPE=\"text/css\">");
					out.println("<BODY   class='body & txt-body' LEFTMARGIN='0' TOPMARGIN='0'>");
					out.println("<FORM NAME='Form1' method='post'>"); 
					out.println("<table align='center' width='100%' class='table' >");
				...
				if(m_option_no.equals("OPT15")){
					...
					out.println("<HTML><HEAD><TITLE>UNALLOCATED FUNDS</TITLE></HEAD>");
					out.println("<link REL='STYLESHEET' HREF='"+m_html_client_url+"/css/Asset_Financing_System.css' TYPE=\"text/css\">");
					out.println("<BODY   class='body & txt-body' LEFTMARGIN='0' TOPMARGIN='0'>");
					out.println("<FORM NAME='Form1' method='post'>"); 
					out.println("<table align='center' width='100%' class='table' >");
				...
				if(m_option_no.equals("OPT16")){
					...
					out.println("<HTML><HEAD><TITLE>CHEQUES BANKED PENDING REALISATION</TITLE></HEAD>");
					out.println("<link REL='STYLESHEET' HREF='"+m_html_client_url+"/css/Asset_Financing_System.css' TYPE=\"text/css\">");
					out.println("<BODY   class='body & txt-body' LEFTMARGIN='0' TOPMARGIN='0'>");
					out.println("<FORM NAME='Form1' method='post'>"); 
					out.println("<table align='center' width='100%' class='table' >");
				...
				if(m_option_no.equals("OPT17")){
					...
					out.println("<HTML><HEAD><TITLE>TOTAL UNBANKED POD CHEQUES IN HAND</TITLE></HEAD>");
					out.println("<link REL='STYLESHEET' HREF='"+m_html_client_url+"/css/Asset_Financing_System.css' TYPE=\"text/css\">");
					out.println("<BODY   class='body & txt-body' LEFTMARGIN='0' TOPMARGIN='0'>");
					out.println("<FORM NAME='Form1' method='post'>"); 
					out.println("<table align='center' width='100%' class='table' >");
				...
				out.println("<HTML><HEAD><TITLE>TOTAL INVOICES FALLING DUE WITHIN 7 DAYS</TITLE></HEAD>");
				out.println("<link REL='STYLESHEET' HREF='"+m_html_client_url+"/css/Asset_Financing_System.css' TYPE=\"text/css\">");
				out.println("<BODY   class='body & txt-body' LEFTMARGIN='0' TOPMARGIN='0'>");
				out.println("<FORM NAME='Form1' method='post'>"); 
				out.println("<table align='center' width='100%' class='table' >");
