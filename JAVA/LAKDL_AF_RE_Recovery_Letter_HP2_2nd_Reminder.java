...
public class LAKDL_AF_RE_Recovery_Letter_HP2_2nd_Reminder extends javax.servlet.http.HttpServlet { 
		...
		" WHERE APPLICATION_NO=UPPER('"+m_application_no+"') AND CLIENT_CODE=UPPER('"+m_client_code+"') AND DOCUMENT_CODE=UPPER('"+m_document_code+"') ");
			...
			m_status=req.getParameter("status");
				...
				while(rs.next()){	//Edited by Minal on 13-07-2015 for #17336
					...
					data="We refer to our previous correspondence by which we reminded you of your dues which now amounts to Rs. "+m_due_amount+". ";
					...
					data="We note that we have not received payment of the same as yet.";	
					...
					data=  "We kindly request you to make immediate payment to settle the above amount. This will ensure that you will not be called upon to pay further overdue interest unnecessarily.";
					...
					data=  "In the event you have already settled the above mentioned dues, please disregard this reminder and we apologize for the inconvenience caused and thank you for such payment. If such payment has been made by direct remittance, kindly communicate to us of the same by forwarding documentary proof relating to such remittance, either by handing over / email / fax of same followed by a telephone call.";
