...
public class LAKDL_AF_CR_PRO_Main_Document_Printing extends javax.servlet.http.HttpServlet {
      ...
      String m_username 						= "AA";//m_sn_methods.username;
        ...
        out.println("}");
			  ...
			  out.println("function load_data(m_app_no) {");
				...
				out.println("function load_data_values() {");
	      ...
	      out.println("	m_url = \""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_PRO_Main_Document_Printing?chksql=main_page&sort_column=\"+m_sort_col+\"&order_by_type=\"+m_order_by_type;"); 
			  out.println(" window.location.href=m_url;"); 
				out.println("}");
			
        out.println("</Script>");
				out.println("<body onload=\"load_data_values()\" class=\"body & txt-body\" leftmargin=\"0\" topmargin=\"0\" marginwidth=\"0\" marginheight=\"0\">");
           ...
           int j = 0;   
					 ...
					 rs = stmt.executeQuery (" SELECT "+
							                        " A.APPLICATION_NO,"+ //1
																			...
																			" WHERE A.CLIENT_CODE=X.CLIENT_CODE AND A.APPLICATION_STATUS IN ('VERIFYL','ACTIVATED','RE-APP','APPRO1','APPRO2') "+ //ADDED BY NUWAN DE SILVA 22-05-07 //'VERIFY2',
       ...
       //   out.println("<table class=table border='0' width='100%' >");
          ...
          out.println("</td>");
			...
			else if(m_chksql.trim().equals("load_data")){
			  int j = 0;   
					 rs = stmt.executeQuery (" SELECT "+
							                        " A.APPLICATION_NO,"+ //1
																			" NVL(A.FACILITY_NO,'-'), "+ //2
