...
public class LAKDL_AF_PRO_display_Income_provision_conf_save  extends HttpServlet { // LAKDL_AF_LT_Legal_Termination_save
	...
	public synchronized void  service(HttpServletRequest req, HttpServletResponse res)	throws IOException{
		...
		try {
			...
			callstmt=conn.prepareCall("BEGIN "+m_schema_name+".AF_PRO_PROVISION_ENTRY_GEN(:1,:2,:3); END;");
