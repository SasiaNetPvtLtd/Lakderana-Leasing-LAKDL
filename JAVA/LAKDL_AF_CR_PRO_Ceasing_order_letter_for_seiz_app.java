...
public class LAKDL_AF_CR_PRO_Ceasing_order_letter_for_seiz_app extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		//	String m_sub_model=""; //added by nuwan de silva 04-07-07
		 ...
		 String m_application_no = req.getParameter("application_no");
			String m_button_status = req.getParameter("button_status");
	...
	String sql_install= " SELECT ROWNUM,A.APPLICATION_NO,TO_CHAR(A.RENTAL_DATE,'DD-MM-YYYY'),A.BALANCE_TO_BE_RECEIVED "+
		...
		//	out.println("window.open(m_url);");
		  ...
		  out.println(" window.location.href=m_url;"); 
			...
			//out.println("	m_url = \""+m_class_url+"/"+m_fschema_name+"AF_CR_PRO_Save_Documents_Status?chksql=save_page&scr_name=AF_MK_APP_STATUS_APPROVE_3&application_no="+m_application_no+"&status="+m_status+"&client_code="+m_client_code+"&document_code="+m_document_code+"\";"); 
		  out.println("	m_url = \""+m_class_url+"/"+m_fschema_name+"AF_CR_PRO_Enter_Seizer_details_gen_save?chksql=save_page&scr_name=AF_MK_APP_STATUS_APPROVE_3&application_no="+m_application_no+"&status="+m_status+"&client_code="+m_client_code+"&document_code="+m_document_code+"&button_status=N\";"); 
			out.println(" window.location.href=m_url;"); 
		...
		rs_install2=stmt_make.executeQuery (sql_install)	;
			...
			out.println("<td width='70%' align='left'><font face='times new roman'  size=4>&nbsp</TD></tr>");
			
			out.println("<tr ><td width='60%' align='right'></TD>");
			out.println("<td width='35%' align='right'><font face='times new roman'  size=4>"+m_sysdate+"</TD><td width='5%' align='right'></TD></tr>");
			out.println("</table >");
				out.println("</BR>");
				out.println("</BR>");
				out.println("</BR>");
			...
			out.println("<tr ><td width='25%' align='center'></TD>");
			out.println("<td width='80%' align='left'><font face='times new roman'  size=4>"+m_reg_no+"</TD></tr>");
			out.println("<tr ><td width='25%' align='center'></TD>");
			out.println("<td width='80%' align='left'><font face='times new roman'  size=4>"+m_make+"</TD></tr>");
			out.println("<tr ><td width='25%' align='center'></TD>");
			out.println("<td width='80%' align='left'><font face='times new roman'  size=4>"+m_chassis_no+"</TD></tr>");

			out.println("<tr ><td width='25%' align='center'></TD>");
			out.println("<td width='80%' align='left'><font face='times new roman'  size=4>&nbsp</TD></tr>");
			
			out.println("<tr ><td width='25%' align='center'></TD>");
			out.println("<td width='80%' align='left'><font face='times new roman'  size=4>"+m_engine_no+"</TD></tr>");
			
			out.println("<tr ><td width='25%' align='center'></TD>");
			out.println("<td width='80%' align='left'><font face='times new roman'  size=4>"+m_full_name+"</TD></tr>");

			out.println("<tr ><td width='25%' align='center'></TD>");
			out.println("<td width='80%' align='left'><font face='times new roman'  size=4>"+m_add1+"</TD></tr>");
			
			out.println("<tr ><td width='25%' align='center'></TD>");
			out.println("<td width='80%' align='left'><font face='times new roman'  size=4>"+m_add2+"</TD></tr>");

			
			out.println("<tr ><td width='25%' align='center'></TD>");
			out.println("<td width='80%' align='left'><font face='times new roman'  size=4>"+m_city_name+"</TD></tr>");

			out.println("<tr ><td width='25%' align='center'></TD>");
			out.println("<td width='80%' align='left'><font face='times new roman'  size=4>"+m_finance_no+"</TD></tr>");
