...
//--
//SCREEN NAME:SYSTEM ADMINISTRATION - INITIATION TYPE
//ID:1.44 Initiation Type Creation Process
//CREATED BY:N.V.P.Chandana
//DATE/TIME:25-07-2006
//NOTES:
...
public class LAKDL_AF_MAS_display_initiation_type extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>System Administration - Initiation Types</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("			}");
			out.println("    else if(data_vec.length > 0 && document.Form1.SCREEN_NAME.value!=\"NEW\"&& document.Form1.TXT_INITIATION_CODE.value !=''&& document.Form1.hid_help_status.value =='H9' ){");
      out.println("    assign_data(data_vec);");
      out.println("   }");
      out.println("    else if(data_vec.length == 0 && document.Form1.SCREEN_NAME.value!=\"NEW\"&& document.Form1.TXT_INITIATION_CODE.value !=''&& document.Form1.hid_help_status.value =='H9' ){");
   //  out.println("     alert('Selected Initiation Type code is incorrect,use help...!')");
    ...
    //out.println("    new_window();");
      out.println("   }");
			...
			//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_initiation_type&data_val=\"+obj.value;");
			
			out.println("    if(document.Form1.hid_help_status.value=='H9' && document.Form1.SCREEN_NAME.value==\"NEW\"){");
			out.println("    m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_initiation_type1&data_val=\"+obj.value;");
			out.println("}");
			out.println("    else");
			...
			out.println("    m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_initiation_type&data_val=\"+obj.value+\"&ac_status=Y\";");
			out.println("}");
      out.println("    else");
      out.println("    if(document.Form1.hid_help_status.value=='H9' && document.Form1.SCREEN_NAME.value==\"RACT\")");
      out.println("    m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_initiation_type&data_val=\"+obj.value+\"&ac_status=N\";");
      out.println("    else");
      out.println("    if(document.Form1.hid_help_status.value=='H1')");
      out.println("    m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations1?chksql=m_prime_chk_LAKDL_AF_MAS_display_initiation_type_desc&data_val=\"+obj.value;");
      ...
      out.println("}");
			...
			out.println("    document.Form1.TXT_INITIATION_CODE.value=data_vec[0]; ");
       ...
       out.println("}");
			...
			out.println("if(document.Form1.TXT_INITIATION_CODE.value==\"\"){  "); 
			out.println("DIV_TXT_INITIATION_CODE.style.color='red';");
			...
			out.println("}");
			out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_MAS_save_initiation_type';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MAS_display_initiation_type';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("    m_help_message = \"m_help_msg_LAKDL_AF_MAS_display_initiation_type\";"); 
			...
			out.println("help_box.innerHTML=\" System Administration - Initiation Types - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" System Administration - Initiation Types - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
	  	...
	  	out.println("		}"); 
			...
			out.println("if(document.Form1.hid_help_type.value==\"99\"){");
			out.println("document.Form1.TXT_INITIATION_CODE.value='';"); 
			out.println("document.Form1.TXT_INITIATION_CODE.focus();");
			out.println("}");
			out.println("if(document.Form1.hid_help_type.value==\"1\"){");
			...
			out.println("    m_sql = \"m_help_TXT_INITIATION_CODE_sql\";"); 
			out.println("    if(document.Form1.SCREEN_NAME.value==\"EDIT\" || document.Form1.SCREEN_NAME.value==\"DACT\"){ ");
			out.println("    m_criteria = document.Form1.TXT_INITIATION_CODE.value+\"@\"+\"Y@\";"); 
			out.println("    } ");
			out.println("    else{");
			out.println("    m_criteria = document.Form1.TXT_INITIATION_CODE.value+\"@\"+\"N@\";}"); 
			out.println("    HelpBox('1','10','0');"); 
			out.println("}"); 

			out.println("function help_update_value_assign_99() {"); 
			out.println("    document.Form1.TXT_INITIATION_CODE.value=oBj.valout[2];"); 
	  	...
	  	out.println("		}");
			...
			out.println("    m_sql = \"m_view_TXT_INITIATION_CODE_sql\";");
			out.println("    m_criteria = document.Form1.TXT_INITIATION_CODE.value+\"@\"+\"Y@\";"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>System Administration - Initiation Types</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<td width='30%' ><DIV id='DIV_TXT_INITIATION_CODE'  class=div_input>Initiation Type Code *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_INITIATION_CODE' maxlength='10' size='10' onblur=\"assign_help_status('H9'),makeRequest(document.Form1.TXT_INITIATION_CODE)\">"); 
			out.println("<input class='but_input' type='button' name='BUT_HELP_MAIN' value=\"Help\" onClick=\"help_update()\" disabled></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 

			out.println("<td width='30%' ><DIV id='DIV_TXT_DESCRIPTION'  class=div_input>Initiation Type Description *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_DESCRIPTION' maxlength='50' size='50' onblur=\"assign_help_status('H1'),makeRequest(document.Form1.TXT_DESCRIPTION)\"></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 
