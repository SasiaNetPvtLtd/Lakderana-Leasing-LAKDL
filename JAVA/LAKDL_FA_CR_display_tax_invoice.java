...
public class LAKDL_FA_CR_display_tax_invoice extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Operation Process - TAX Invoice</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("	if(document.Form1.TXT_TAX_INVOICE_NO.value==\"\" ){  "); 
			out.println("		DIV_TXT_TAX_INVOICE_NO.style.color='red';");
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"FA_CR_display_tax_invoice';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("    m_help_message = \"m_help_msg_LAKDL_FA_OP_TAX_INVOICE\";"); 
			...
			out.println("	help_box.innerHTML=\"Operation Process - TAX Invoice - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\"Operation Process - TAX Invoice \";"); 
			out.println("}"); 
	  	...
	  	out.println("					}");  
			...
			out.println(" 	m_sql = \"m_help_DIV_TXT_TAX_INVOICE_sql\";"); 
			out.println("	 	m_criteria = document.Form1.TXT_TAX_INVOICE_NO.value+\"@\"+document.Form1.TXT_CLIENT_CODE.value+\"@\";");
			out.println("		HelpBox('1','10','0');"); 
			out.println("}");
			
			out.println("function help_update_value_1() {"); 
			out.println("		document.Form1.TXT_TAX_INVOICE_NO.value=oBj.valout[2];"); 
			...
			out.println("		document.Form1.TXT_FROM_DATE.value=oBj.valout[6];"); 
			out.println("		document.Form1.TXT_TO_DATE.value=oBj.valout[7];"); 
			out.println("}");
			
			out.println("function Generate_LetterX() {");	
			out.println("	m_url = \""+m_class_url+"/"+m_fschema_name+"FA_OP_Current_Account_Statement?chksql=tax_invoice&INVOICE_NO=\"+document.Form1.TXT_TAX_INVOICE_NO.value;"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Operation Process - TAX Invoice</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<tr>"); 
			out.println("<td width='20%' ><DIV id='DIV_TXT_TAX_NO'  class=div_input>TAX Invoice No *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_TAX_INVOICE_NO' maxlength='13' size='10' onblur=\"help_update_facility()\">"); 
			...
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_FACILITY_NO' maxlength='13' size='10' disabled>"); 
			out.println("</td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>");
			out.println("<tr>"); 
			...
			out.println("</tr>");
			out.println("<tr>"); 
			out.println("<td width='20%' ><DIV class=div_input>From Date</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_FROM_DATE' maxlength='13' size='10' disabled></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>");
			out.println("<tr>"); 
			out.println("<td width='20%' ><DIV class=div_input>To Date</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_TO_DATE' maxlength='13' size='10' disabled></td>"); 
			out.println("<td width='*%'></td>");  
			out.println("</tr>");
			out.println("<tr>"); 
			out.println("<td width='20%' ></td>"); 
			out.println("<td width='40%' ><input class='but_input' type='button' name='BUT_LETTER' value=\"Tax Invoice\" style='width:200' onClick=\"Generate_LetterX()\"></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>");
			out.println("</table>");
			out.println("<br>");
