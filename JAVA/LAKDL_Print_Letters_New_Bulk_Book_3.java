...
class LAKDL_Print_Letters_New_Bulk_Book_3 implements Printable {
	...
	String m_debtor_code="-",m_client_name="-",m_invoice_seq_no="-",m_batch_no="-",m_return_no="-",m_application_no="-",mm_statement_date="-";
	...
	//public LAKDL_Print_Letters_New_Bulk_Book_3(String m_rec, String m_client_code){ // commented by udara 05-11-2019
	public LAKDL_Print_Letters_New_Bulk_Book_3(String m_rec, String m_client_code, String m_statement_date){ // added by udara 05-11-2019
	...
	public int print (Graphics g,PageFormat pageFormat, int page) {
		...
		//	System.out.println("sql Contract_Client_Data ==> "+Contract_Client_Data);
			...
			String arrearsDetails =" SELECT "+
				...
				" WHERE A.FINANCE_NO='"+m_application_no+"' "+
				" AND A.REMINDER_TYPE = 'LETTERM' "+ // added by udara 05-11-2019 
		...
		*/
		...
		//	line.addAttribute(TextAttribute.UNDERLINE, TextAttribute.UNDERLINE_ON);
		   ...
		   // System.out.println("drawPosY1111New111111="+drawPosY);
			...
			// g2d.drawLine(90, 260,  700,  260);//[HR ]	
			   g2d.drawLine(90, valY,  700,  valY);//[HR ]	
			
			drawPosY=drawPosY+10;	
		...
		//	System.out.println("line_1=");
			...
			line = new AttributedString(m_application_no);
			line.addAttribute(TextAttribute.FONT, bodyFont4);
			paragraph      = line.getIterator();
			paragraphStart = paragraph.getBeginIndex();
			paragraphEnd   = paragraph.getEndIndex();
		...
		//	System.out.println("line_4="+drawPosY);
			...
			//line = new AttributedString("l=,S jdßl fkdf.ùu iïnkaOfhka ixfYdaê; 1982 wxl 29 orK mdßfNda.sl Kh mkf;a 18^1& j.ka;sh hgf;a l=,sh wjika lrkq ,nk njg jq ±kaùuhs'");
			//line = new AttributedString("ixfYdaê; 1982 wxl 29 orK mdßfNda.sl Kh mkf;a 18^1&$18^2& j.ka;sh hgf;a jdßl uqo,a fkdf.ùu fyda .súiqï.; kshuhka iy fldkafoais W,a,x>Kh lsÍu fya;=fjka l=,sh wjika lsßuhs'");
			String dataH="ixfYdaê; 1982 wxl 29 orK mdßfNda.sl Kh mkf;a 18^1&$18^2& j.ka;sh hgf;a jdßl uqo,a  "+
				         //"fkdf.ùu fyda .súiqï.; kshuhka iy fldkafoais W,a,x>Kh lsÍu fya;=fjka   "+ // commented by udara 12-06-2019
							"fkdf.ùu fyda .súiqï.; kshuhka iy fldkafoais W,a,x>Kh lsÍu fya;=fjka      "+ // added by udara 12-06-2019
						 "l=,sh wjika lsßuhs'";	
			line = new AttributedString(dataH);
		...
		/*	data= "wms úiska kej; kej; lrk ,o b,a,Sï iy isysle|ùï ms<snoj fkdi,ld yßñka Wla; l=,S "+
					"iskaklalr .súiqu hgf;a Tn úiska f.úh hq;=j mj;sk jdßl uqo,a ysÕj wm fj; whùug we;s w;r\" "+
					"th f.ùug wiu;aj iy$fyda fkdi,ld yer we;s njg fuu.ska ±kqï fokafkuq' fuu ;;a;ajhka "+
					"hgf;a fuls ±kaùu ,eî Èk 14 la we;=<; Tn úiska by; lS ys`. jdßlhka ta u; jq fmd<sh o iu`. "+
					"f.jkq ,eîu Tn úiska meyer yßkafka kï l=,S iskaklalr .súiqfï úêúOdkhkag wkql=,j l=,sh "+
					"wjika lsßug wms úiska mshjr .kq ,nk nj fuu.ska Tn fj; okajd isákafkuq' ta wkqj m%udohlska "+
					"f;drj by; lS ys`. uqo, f.jd ksu lsßug läkñka mshjr .kq ,nk fuka wms Tn fj; ldreKslj "+
					"Wmfoia ,nd fokafkuq'"; 
		*/			
			data="by; wxl orK l=,S iskaklalr .súiqu iy ixfYdaê; 1982 wxl 29 orK mdßfNda.sl Kh mkf;a úêúOdkhkaa  "+
				 "hgf;a Tn fj; tjkakg fhÿKq l=,sh wjika lrkq ,nk njg jq ksfõokh ms<snoj fkdi,ld yßñka tlS ksfõokfha olajd "+
				 //"we;s ysÕ uqo, f.ùug$úfYaIs;j olajd we;s wiu;aùu$lvlsÍu$l%shdj tlS ±kaùfï olajd we;s m%ldYs; ld, iSudj   "+	// commented by udara 12-06-2019
					"we;s ysÕ uqo, f.ùug$úfYaIs;j olajd we;s wiu;aùu$lvlsÍu$l%shdj tlS ±kaùfï olajd we;s m%ldYs; ld, iSudj     "+ // added by udara 12-06-2019
				 ";=< § h:dj;a lsßug Tn úiska fkdi,ld yer ;sfí'";	
		...
		/*	data1= "wemlrejka jk Tn úiska tlS ld, iSudj ;=< ksis mßos f.ùï isÿ lsÍug l=,S .eKqïlrej fm<Uùug "+
					"fyda Tn úiska f.ùï isÿ lsÍug lghq;= lrk f,i fuhska ±kqï fouq' tfia lghq;= fkdlrkafka kï "+
					"l=,S .eKqïlre iuÕ wemlrejl= jk Tngo úreoaOj kS;s u.ska lghq;= lsÍug isÿjk nj fuhska ±kqï "+
					"fouq'"; 
		*/			
		/*	data1="ta wkqj 1982 wxl 29 orK mdßfNda.sl Kh mkf;a 12 jk j.ka;sfha úêúOdkhka Tn úiska W,a,x>kh lr we;s neúka"+
				  "tu mkf;a 18 jk j.ka;sfha úêúOdkhka m%ldrj iy by; lS l=,S iskaklalr .súiqfï kshuhkag wkql+,j jydu l%shd;aul jk"+
				  "mßÈ l=,sh wjika lrk njg fuu.ska m%ldY lrkafkuq' tneúka wms Tn fj; l=,shg fok ,o jdykh$WmlrKh wmf.a"+	
				  "l=,shg fok ,o jdykh$WmlrKh wmf.a wjirh iy wkque;sfhka f;drj ;jÿrg;a Tnf.a ika;lfha"+
				  "fkdmej;sh hq;= jk w;r tu ksid Tn úiska tlS foamf,ys ika;lh ;jÿrg;a ±Íu kS;Hdkql=, fkdjk nj"+	
				  "±kqï fouq'";	*/
		    data1="ta wkqj 1982 wxl 29 orK mdßfNda.sl Kh mkf;a 12 jk j.ka;sfha úêúOdkhka Tn úiska W,a,x>kh lr we;s neúka tu "+
				  "mkf;a 18 jk j.ka;sfha úêúOdkhka m%ldrj iy by; lS l=,S iskaklalr .súiqfï kshuhkag wkql+,j jydu                   "+
				  "l%shd;aul jk mßÈ l=,sh wjika lrk njg fuu.ska m%ldY lrkafkuq' tneúka wms Tn fj; l=,shg fok ,o jdykh$WmlrKh wmf.a "+	
				  "wjirh iy wkque;sfhka f;drj ;jÿrg;a Tnf.a ika;lfha fkdmej;sh hq;= jk w;r tu ksid Tn úiska tlS foamf,ys ika;lh "+
				  ";jÿrg;a ±Íu kS;Hdkql=, fkdjk nj ±kqï fouq'";	
			...
			//data5= "by; olajd we;s ysÕ uqo, iïmQ¾K jYfhka f.jd we;akï fuu ,smsh fkdi,ld yßk f,i okajd isáuq'"; 
			  data5="tneúka tls foam, rdc.sßh nq;a.uqj mdr wxl 100 ys msysá wmf.a m%Odk ld¾hd,h fj; fyda YdLd ld¾hd,hla   "+
					"idudkH jHdmdr lghq;= mj;sk ld,h ;=< § Ndr §u fyda whùug we;s iïmq¾K uqo,a m%udKh tlajr f.ùug "+
					"jydu lghq;= l< hq;= njg wms Tng jeäÿrg;a okajd isákafkuq'";
			...
			//data5= "by; olajd we;s ysÕ uqo, iïmQ¾K jYfhka f.jd we;akï fuu ,smsh fkdi,ld yßk f,i okajd isáuq'"; 
			  data5_1="Tn úiska tfia lsÍug wfmdfydi;a jkafka kï u;= ±kqï§ulska f;drj wmf.a whs;sjdislï n,d;aul lrjd .ekSu i|yd wjYH "+
					  "l%shdud¾. .ekSug isÿjk nj;a Tng iy wemlrejkag tfrysj kvq mjrk f,ig wmf.a kS;s{hka fj; Wmfoia §ug isÿjk nj;a  "+
					  "lreKdfjka i,lkak'";
					
			//data = String.format("%-100s", data);
			
			line = new AttributedString(data5_1);
			line.addAttribute(TextAttribute.FONT, bodyFontSin);
			paragraph      = line.getIterator();
			paragraphStart = paragraph.getBeginIndex();
			paragraphEnd   = paragraph.getEndIndex();
			...
			//data5= "by; olajd we;s ysÕ uqo, iïmQ¾K jYfhka f.jd we;akï fuu ,smsh fkdi,ld yßk f,i okajd isáuq'"; 
			  data5_11="ta wkqj Tn úiska t<fUk ,o l=<s iskaklalr .súiqï fldkafoais j,ska Tn mq¾K jYfhka ;jÿrg;a nef|k njo úfYaIfhka "+
					   "okajd isákafkuq'";
					
			//data = String.format("%-100s", data);
			
			line = new AttributedString(data5_11);
			line.addAttribute(TextAttribute.FONT, bodyFontSin);
			paragraph      = line.getIterator();
			paragraphStart = paragraph.getBeginIndex();
			paragraphEnd   = paragraph.getEndIndex();
		   ...
		   // System.out.println("drawPosX_drawLine111111111111111="+drawPosX);
			...
			drawPosY 		 = 0;
			drawPosY 		 = 736; // footer Details Print Start point is hard code
