...
public class LAKDL_FA_OP_Invoice_First_Reminder_Letter extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
		  ...
		  if (m_chksql.trim().equals("main_page")){
			...
			out.println("<title>1st Reminder</title></head>");
	      ...
	      out.println("<tr><td width='*%' class='factoring-letter-body' >"+rs1.getString(5)+"</td></tr>");
			...
			out.println("<table border='0' width='100%' class='table'> ");	
			out.println("<tr ><td width='*%' class='factoring-letter-body' style='{text-align:center;}'><b><u>1ST REMINDER</u></b></td></tr>");
			...
			out.println("We refer to the factoring agreement we have with your above named supplier under which you "+
			" have been advised to pay all debts due to the said supplier, which have been assigned to us, to the"+
			" credit of Lakderana Investments Limited carrying on factoring business under the name and style of <b>'Orient Factor'</b> at No. 100,   Buthgamuwa Road,  Rajagiriya.");
			...
			" AND (A.DUE_DATE+1)<=TO_DATE(TO_CHAR(SYSDATE,'DD-MM-YYYY'),'DD-MM-YYYY') ");
			...
			out.println("According to our records, your Account is overdue by Rs "+nf.format(m_total_bal)+" as given hereunder.");		
			out.println("</p>");				
			out.println("<p style='text-align:justify' class='factoring-letter-body' >");				
			...
			out.println("<table border='0' width='90%' class='table'> ");	
			out.println("<tr ><td width='*%' class='factoring-letter-body' style='{text-align:justify;}'>");
			out.println(" If you have already made appropriate remittances, please advise us accordingly at your earliest convenience. "+
			" Also if you have any queries concerning this account please do not hesitate to contact the undersigned.");
			out.println("</td></tr></table>");						
			out.println("<br>");						
