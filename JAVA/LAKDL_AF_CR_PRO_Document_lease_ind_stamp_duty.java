...
public class LAKDL_AF_CR_PRO_Document_lease_ind_stamp_duty extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
  	 ...
  	 if(m_chksql.trim().equals("main_page")){
    	...
    	out.println("m_letter+'</table>';");
			...
			out.println("m_letter='<tr><td width=\"*%\" align=\"center\" class=\"rep-body1\" ><b>To be typed on company letter head</b></td></tr>';"); 
	  	out.println("		}else{");
			//out.println("m_letter=\"To be typed on company letter head\" ");
			out.println("m_letter=\"\" ");
			//out.println("m_letter='<tr><td width=\"*%\" align=\"center\" class=\"rep-body1\" ><b>To be typed on company letter head</b></td></tr>';"); 
			out.println("		}");
			out.println("m_table.innerHTML='<table align=\"center\" width=\"100%\" class=\"table\" border=\"0\">'+");
    	out.println("m_writedata+m_letter+'</table>';");
	  	...
	  	out.println("<blockquote><font size=2><p style='text-align:justify' class='rep-body1'>");	
			...
			out.println("<tr><td width='*%' class='rep-body1' ><b>"+m_agree_date+"</b></td></tr>");
			out.println("</table>");
			
			out.println("<br><br>");
			
			out.println("<table border='0' width='90%' class='table'>"); 		
			out.println("<tr><td width='*%' class='rep-body1' ><b><I>THE MANAGER</I></b></td></tr>");
			out.println("<tr><td width='*%' class='rep-body1' ><b><I>"+m_orient_name+"</I></b></td></tr>");
			out.println("<tr><td width='*%' class='rep-body1' ><b><I>"+m_orient_add1+"</I></b></td></tr>");
			out.println("<tr><td width='*%' class='rep-body1' ><b><I>"+m_orient_add2+"</I></b></td></tr>");
			out.println("<tr><td width='*%' class='rep-body1' ><b><I>"+m_orient_city_name+"</I></b></td></tr>");
			out.println("</table>");	
			...
			out.println("<table border='0' width='90%' class='table'>"); 
			//out.println(m_ter_type);
			if(m_ter_type.equals("ENHA_DOWN") || m_ter_type.equals("RESCHEDULE")){
			out.println("<tr><td width='*%' class='rep-body1' ><b>Stamp Duty on Lease Agreement - Agreement No : "+m_finance_no+" / "+m_ter_date+"</b></td></tr>");
			}
			else{
				out.println("<tr><td width='*%' class='rep-body1' ><b>Stamp Duty on Lease Agreement - Agreement No : "+m_finance_no+"</b></td></tr>");
			}
			out.println("</table>");
	    ...
	    out.println("</font></p></blockquote>");
		  ...
		  String data="In the event of the Inland Revenue Department ruling that the above Lease "+
			            "agreement would be liabe for stamp duty I/We agree to pay stamp duty payable on the "+
     	...
     	out.println("<br>");
			...
			out.println("<tr></tr>");
			out.println("<tr></tr>");
			out.println("<tr><td width='*%' class='rep-body1' style='text-align:left'  ><B>NIC No</B>:"+m_nic_no+"</td>");
			out.println("</tr></table>");
			*/
			out.println("<br><br>");
