...
public class LAKDL_FA_OP_cheque_return_legal_letter extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Operation Process - Cheque Return Reminders - Legal Letter  </TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"FA_OP_PRO_rpt_cheque_return_reminder?chksql=LOAD_CHEQUE_RETURN_LEGAL_LETTER\";");
  		...
  		out.println("		}");
   		...
   		out.println("}"); 
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"FA_OP_cheque_return_legal_letter';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("	help_box.innerHTML=\"  Operation Process - Cheque Return Reminders - Legal Letter  - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\" Operation Process - Cheque Return Reminders - Legal Letter \";"); 
			out.println("}"); 
	  	...
	  	out.println("					}"); 
			...
			out.println("function Generate_Letter2(m_return_no,m_debtor_code,m_client_code,m_facility_no) {");	
			out.println("	m_url = \""+m_class_url+"/"+m_fschema_name+"FA_OP_Cheque_Return_Letter?chksql=main_page&client_no=\"+m_client_code+\"&debtor_code=\"+m_debtor_code+\"&print=TRUE&return_no=\"+m_return_no+\"&facility_no=\"+m_facility_no;"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Operation Process - Cheque Return Reminders - Legal Letter </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
