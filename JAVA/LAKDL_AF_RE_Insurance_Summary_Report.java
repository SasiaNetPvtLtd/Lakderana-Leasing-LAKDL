...
public class LAKDL_AF_RE_Insurance_Summary_Report extends javax.servlet.http.HttpServlet {
    ...
    public  void service(HttpServletRequest req, HttpServletResponse res) throws IOException { // synchronized
        ...
        try {
			...
			if(m_chksql.equals("run_report")){ 
				...
				try{
					callstmt1 = conn.prepareCall("BEGIN "+m_schema_name+".AF_SAVE_INSURANCE_SUMMARY_RPT(:1,:2,:3,:4);END;"); 
					callstmt1.setString(1,m_from_date);
					callstmt1.setString(2,m_to_date);
					callstmt1.setString(3,m_username);
					callstmt1.setString(4,m_business_type);
					callstmt1.execute();
					out.print("OK"); 
				}
				catch(Exception ex){
				...
				out.println("help_box.innerHTML=\"  Insurance Summary Report - \"+m_val;"); 
				out.println("}"); 
				out.println(""); 
				
				out.println("function load_roll_out_value(){");
				out.println("help_box.innerHTML=\"  Insurance Summery Report - \"+document.Form1.hid_status.value;"); 
				out.println("}"); 
				...
				out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_RE_Insurance_Summary_Report?chksql=main_page';"); 
				out.println("		}"); 
				out.println("}"); 
				...
				out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_Insurance_Summary_Report?chksql=run_report&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&business_type=\"+m_business_type;"); 
				...
				out.println("       m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_insurance_summery_view?chksql=\"+chkSql+\"&branch_code=\"+m_branch_code+\"&from_date=\"+m_from_date+\"&to_date=\"+m_to_date;");
				...
				out.println("			alert('Insurance Summary Report is generated. Use View Report button to get the view.');"); 
				out.println("		}");
				out.println("		else{");
				...
				out.println("</tr>");
				out.println("<tr>");
				out.println("<td align=\"left\" class=\"pdn_txtpos2\" style=\"height: 18px\" id=help_box>Insurance Summery Report </td>");
				out.println("</tr>");
				out.println("<tr>");
