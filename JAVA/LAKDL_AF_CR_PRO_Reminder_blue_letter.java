...
public class LAKDL_AF_CR_PRO_Reminder_blue_letter extends javax.servlet.http.HttpServlet { 
...
//	CallableStatement callstmt1;
  ...
  public ResultSet rs,rs_doc_charges,rs_make,rs_anx_status,rs_rental,rs_instal1,rs_install2,rs_sysdate;
	...
	String sql_install= " SELECT ROWNUM,A.APPLICATION_NO,TO_CHAR(A.RENTAL_DATE,'DD-MM-YYYY'),A.BALANCE_TO_BE_RECEIVED "+
			...
			out.println("<title>Reminder_Blue_letter </title></head>");
		...
		rs_install2=stmt_make.executeQuery (sql_install)	;
			...
			out.println("<tr ><td width='100%' align='center'>&nbsp</td></tr>");
			out.println("</table>");
			out.println("<table border='0' align='center' width='50%' class='table'>");
			out.println("<tr align='center'><td align='right' ><B><b>&nbsp</td>");
			out.println("<td align='left'><font  size=2px>&nbsp</font></td></tr>");  //pra
			out.println("</table>");
			out.println("<br>");
			out.println("<br>");
			
			out.println("<br>"); // added by udara on 23-10-2012
			
			out.println("<table border='0' align='center' width='100%' class='table'>");
			out.println("<tr ><td>");
			out.println("<table border='0' align='center' width='90%' class='table'>");
			out.println("<tr ><td width='40%' align='left'>&nbsp<br>");
			out.println("<tr ><td width='40%' align='left'>&nbsp<br>");
			out.println("<tr ><td width='40%' align='left'>&nbsp<br>");
			out.println("<tr ><td width='40%' align='left'>&nbsp<br>");
			out.println("<font  size=2px>&nbsp&nbsp </font></td>");
			out.println("<td width='15%'><DIV class='div_input'  ><b>"+m_reg_no+"</b></DIV></td>");
			out.println("<td width='25%' align='left'>&nbsp<br>");
			out.println("<font  size=2px>&nbsp&nbsp</font></td>");
			out.println("<td width='20%'><DIV class='div_input'  ><b>"+m_finance_no+"</b></DIV></td></tr>");
			out.println("</table>");
			out.println("</td></tr>");
			out.println("</table>");
			...
			out.println("<tr ><td width='60%' align='left'>&nbsp<br>");
			out.println("<font  size=2px>&nbsp</font></td>");
			out.println("<td width='40%'  align='right'><DIV class='div_input'  ><b>"+m_Letter_date+"</b></DIV></td></tr>");
			
			
			
			
			out.println("<tr ><td width='60%' align='left'>&nbsp<br></td>");
			out.println("<td width='40%'  align='right'><DIV class='div_input'  ><b>&nbsp</b></DIV></td></tr>");
			out.println("<tr ><td width='60%' align='left'>&nbsp<br></td>");
			
			
			
			out.println("<font  size=2px>&nbsp</font></td>");
			out.println("<td width='40%'  align='right'><DIV class='div_input'  ><b>"+nf.format(m_rental2)+"</b></DIV></td></tr>");

			// added by udara on 23-10-2012
			out.println("<tr ><td width='60%' align='left'>&nbsp<br></td>");
			out.println("<td width='40%'  align='right'><DIV class='div_input'  ><b>&nbsp</b></DIV></td></tr>");
			...
			out.println("<tr ><td width='60%' align='left'>&nbsp<br>");
			out.println("<font  size=2px>&nbsp</font></td>");
			out.println("<td width='40%'  align='right'><DIV class='div_input'  ><b>"+nf.format(m_overdu_amout)+"</b></DIV></td></tr>");
			...
			out.println("<tr ><td width='60%' align='left'>&nbsp<br>");
			out.println("<font  size=2px>&nbsp</font></td>");
			out.println("<td width='40%'  align='right'><DIV class='div_input'  ><b>"+nf.format(m_insu_amout)+"</b></DIV></td></tr>");
			...
			out.println("<tr ><td width='60%' align='center'><b>&nbsp&nbsp&nbsp "+m_sysdate+"</b><br>");
			out.println("<font  size=2px>&nbsp</font></td>");
			out.println("<td width='40%'  align='right'><DIV class='div_input'  ><b>"+nf.format(m_totoverdu_amout)+"</b></DIV></td></tr>");
			
			
			out.println("<tr ><td width='60%' align='left'>&nbsp</td>");
			out.println("<td width='40%'  align='right'><DIV class='div_input'  ><b>&nbsp</b></DIV></td></tr>");
	...
	//	  	out.println("Please note that if you do not settle the above total default amount withing --------------days from the above date we are complled to teminate the above Hire Purchase agreement.");	         
	//	  	out.println("</font></p></blockquote>");	
		
	//		out.println("<table align='center' border='0' width='90%' class='table'>"); 		
	//		out.println("<tr><td><font  size=2px>phw  s>hN °Vämt aq`l ØnyN vlÙ v`Ýk Ëql @gVy ýó vn awr ×m`qvn s$m v`ÝkyK s>h`m 5% amwr @p`ÄyK  @gVmt âÚvn bv slkNn</font></td></tr>");
	//		out.println("</table>");
	//		out.println("<br>");
	...
	//		out.println("<tr><td align='left'><B>Thanking you,</B></td></tr>");
	//		out.println("<tr><td align='lrft'><B>Yours Faithfully,</B></td></tr>");
	//		out.println("<tr><td align='lrft'><B>Lakderana Investments Limited</B></td></tr>");
	//		out.println("</table>");
	...
	//		out.println("<table align='left' border='0' width='30%' class='table'>"); 
	//		out.println("<tr><td align='left'><B>&nbsp</B></td></tr>");
	//		out.println("<tr><td align='left'><B>&nbsp</B></td></tr>");
	//		out.println("<tr><td align='left'><B>&nbsp</B></td></tr>");
	//		out.println("<tr><td align='left'><B>---------------------------</B></td></tr>");
	//		out.println("<tr><td align='lrft'><B>Authorized Officer</B></td></tr>");
