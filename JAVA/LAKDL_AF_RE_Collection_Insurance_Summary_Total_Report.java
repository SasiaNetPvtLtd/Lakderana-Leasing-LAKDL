/*
 * Screen Name      : Insurance Summary Total Report
...
public class LAKDL_AF_RE_Collection_Insurance_Summary_Total_Report extends HttpServlet {
    ...
    public synchronized void service(HttpServletRequest req, HttpServletResponse res) throws IOException {
        ...
        try {
            ...
            if (m_screen_type.trim().equals("main_page")) {
                ...
                out.println("               document.getElementById('help_box').innerHTML = 'Collection Process - Insurance Summary Total - ' + m_val;");
                out.println("           }");
                
                
                out.println("           function load_roll_out_value() {");
                out.println("               document.getElementById('help_box').innerHTML = 'Collection Process - Insurance Summary Total';");
                out.println("           }");
                ...
                out.println("               m_url = '" + m_class_url + "/" + m_fschema_name + "AF_RE_Collection_Insurance_Summary_Total_Report?chksql=view_report&report_date=' + m_report_date;");
                out.println("               window.open(m_url, 'insurance_summary_total_report', 'left=20, top=20, width=900, height=600, toolbar=0, location=0, directories=0, status=0, menuBar=0, scrollBars=1, resizable=1');");
                out.println("           }");
                ...
                out.println("                                       </tr>");
                out.println("                                       <tr>");
                out.println("                                           <td class = \"pdn_txtpos2\" align = \"left\" style = \"height: 18px;\" id = \"help_box\">Collection Process - Insurance Summary Total</td>");
                out.println("                                       </tr>");
                out.println("                                       <tr>");
                ...
                BigDecimal m_motor_basic            = new BigDecimal("0.00");
                BigDecimal m_motor_rcc_tc           = new BigDecimal("0.00");
                BigDecimal m_nonmotor_basic         = new BigDecimal("0.00");
                BigDecimal m_nonmotor_rcc_tc        = new BigDecimal("0.00");
                
                BigDecimal m_motor_basic_total      = new BigDecimal("0.00");
                BigDecimal m_motor_rcc_tc_total     = new BigDecimal("0.00");
                BigDecimal m_nonmotor_basic_total   = new BigDecimal("0.00");
                BigDecimal m_nonmotor_rcc_tc_total  = new BigDecimal("0.00");
                ...
                while (resultSet.next()) {
                    ...
                    if (has_rows == false) {
                        ...
                        out.println("                                                       <td width = \"40%\" align = \"center\" rowspan = \"2\">Insurance Company</td>");
                        out.println("                                                       <td width = \"24%\" align = \"center\" colspan = \"2\">Motor</td>");
                        out.println("                                                       <td width = \"24%\" align = \"center\" colspan = \"2\">Nonmotor</td>");
                        out.println("                                                       <td width = \"12%\" align = \"center\" rowspan = \"2\">Total Commision</td>");
                        out.println("                                                   </tr>");
                        
                        out.println("                                                   <tr style = \"font-weight: bold;\">");
                        out.println("                                                       <td width = \"12%\" align = \"center\">Basic Commision</td>");
                        out.println("                                                       <td width = \"12%\" align = \"center\">RCC & TC Commision</td>");
                        out.println("                                                       <td width = \"12%\" align = \"center\">Basic Commision</td>");
                        out.println("                                                       <td width = \"12%\" align = \"center\">RCC & TC Commision</td>");
                        out.println("                                                   </tr>");
                    ...
                    if ((m_insurance_company != null) && (!m_insurance_company.equals(resultSet.getString("INSUR_COM")))) {
                        ...
                        rowCount = rowCount + 1;
                        m_insurer_total = m_motor_basic.add(m_motor_rcc_tc).add(m_nonmotor_basic).add(m_nonmotor_rcc_tc);
                        m_motor_basic_total = m_motor_basic_total.add(m_motor_basic);
                        m_motor_rcc_tc_total = m_motor_rcc_tc_total.add(m_motor_rcc_tc);
                        m_nonmotor_basic_total = m_nonmotor_basic_total.add(m_nonmotor_basic);
                        m_nonmotor_rcc_tc_total = m_nonmotor_rcc_tc_total.add(m_nonmotor_rcc_tc);
                        m_grand_total = m_grand_total.add(m_insurer_total);
                        
                        out.println("                                                   <tr>");
                        out.println("                                                       <td width = \"40%\" align = \"left\">" + m_insurance_company_name + "</td>");
                        out.println("                                                       <td width = \"12%\" align = \"right\">" + nf.format(m_motor_basic) + "</td>");
                        out.println("                                                       <td width = \"12%\" align = \"right\">" + nf.format(m_motor_rcc_tc) + "</td>");
                        out.println("                                                       <td width = \"12%\" align = \"right\">" + nf.format(m_nonmotor_basic) + "</td>");
                        out.println("                                                       <td width = \"12%\" align = \"right\">" + nf.format(m_nonmotor_rcc_tc) + "</td>");
                        out.println("                                                       <td width = \"12%\" align = \"right\">" + nf.format(m_insurer_total) + "</td>");
                        out.println("                                                   </tr>");
                        
                        m_motor_basic = new BigDecimal("0.00");
                        m_motor_rcc_tc = new BigDecimal("0.00");
                        m_nonmotor_basic = new BigDecimal("0.00");
                        m_nonmotor_rcc_tc = new BigDecimal("0.00");
                    ...
                    if (resultSet.getString("ITEM_CATEGORY_CODE").equals("VEHICLE")) {
                        
                        m_motor_basic = m_motor_basic.add(resultSet.getBigDecimal("BASIC_PREMIUM_COMMISION"));
                        m_motor_rcc_tc = m_motor_rcc_tc.add(resultSet.getBigDecimal("RCC_TC_COMMISION"));
                        
                    }
                    else if (resultSet.getString("ITEM_CATEGORY_CODE").equals("EQUIPMENT")) {
                        
                        m_nonmotor_basic = m_nonmotor_basic.add(resultSet.getBigDecimal("BASIC_PREMIUM_COMMISION"));
                        m_nonmotor_rcc_tc = m_nonmotor_rcc_tc.add(resultSet.getBigDecimal("RCC_TC_COMMISION"));
                ...
                if (has_rows == true) {
                    ...
                    out.println("                                                       <td width = \"12%\" align = \"right\">" + nf.format(m_motor_basic_total) + "</td>");
                    out.println("                                                       <td width = \"12%\" align = \"right\">" + nf.format(m_motor_rcc_tc_total) + "</td>");
                    out.println("                                                       <td width = \"12%\" align = \"right\">" + nf.format(m_nonmotor_basic_total) + "</td>");
                    out.println("                                                       <td width = \"12%\" align = \"right\">" + nf.format(m_nonmotor_rcc_tc_total) + "</td>");
                    ...
                    if (m_reverse_total.compareTo(new BigDecimal("0")) == 1) {
                        out.println("                                                       <td width = \"12%\" align = \"right\">(" + nf.format(m_reverse_total) + ")</td>");
                    }
                    /* m_reverse_total = 0 */
                    ...
                    /* m_reverse_total < 0 */
                        ...
                        out.println("                                                       <td width = \"12%\" align = \"right\">" + nf.format(m_reverse_total.negate()) + "</td>");
                    }
                    out.println("                                                   </tr>");
                    ...
                    if (m_grand_total.compareTo(new BigDecimal("0")) == -1) {
                        out.println("                                                       <td width = \"12%\" align = \"right\">(" + nf.format(m_grand_total.negate()) + ")</td>");
                    }
                    else  {
                        out.println("                                                       <td width = \"12%\" align = \"right\">" + nf.format(m_grand_total) + "</td>");
                    }
                    out.println("                                                   </tr>");
