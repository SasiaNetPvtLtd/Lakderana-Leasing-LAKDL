...
public class LAKDL_FA_OP_Charges_reverse_approval extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Operation Process - Charges Reversal Approval</TITLE>"); 
			out.println("</HEAD>"); 
		  ...
		  out.println("		document.Form1.elements[\"TXT_TRAN_AMOUNT_\"+k].value=0;");
			...
			out.println("			}");
			out.println("				document.Form1.action='"+m_class_url+"/"+m_fschema_name+"FA_OP_Save_Charges_reversal_approval';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"FA_OP_Charges_reverse_approval';"); 
			out.println("		}"); 
			...
			out.println("	help_box.innerHTML=\"  Operation Process -  Charges Reversal Approval - \"+m_val;"); 
  		out.println("		if(m_val==\"New\"){");
			...
			out.println("	help_box.innerHTML=\"  Operation Process -  Charges Reversal Approval - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
		  ...
		  out.println(" 	m_sql = \"m_help_DIV_TXT_FACILITY_NON_SALE_DELE_sql\";"); 
			...
			out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"FA_OP_Charges_addition_approval_sql?chksql=LOAD_DETAILS_CHARGE_REVERSAL\";");
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Operation Process -  Charges Reversal Approval </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
