...
public class LAKDL_FA_CR_display_agreement_printing extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Credit Process - Agreement Printing</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"FA_CR_PRO_sql_validations_normal?chksql=LOAD_AGREEMENT_PRINTING\";");
			...
			out.println("	m_url = \""+m_class_url+"/"+m_fschema_name+"FA_CR_Factoring_Agreement?chksql=main_page&facility_no=\"+m_facility_no+\"&print=TRUE&client_no=\"+m_client_code;"); 
  		...
  		out.println("		}");
   		...
   		out.println("}"); 
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"FA_CR_display_agreement_printing';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("	help_box.innerHTML=\"  Credit Process - Agreement Printing - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\" Credit Process - Agreement Printing  \";"); 
			out.println("}"); 
	  	...
	  	out.println("					}"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Credit Process - Agreement Printing </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
