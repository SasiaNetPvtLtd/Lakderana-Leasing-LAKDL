...
public class LAKDL_FA_CR_display_credit_score_enter extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			*/
			...
			out.println("function makeRequest1(obj1,obj2) {");//obj1,
      ...
      /*
			...
			out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"FA_CR_save_credit_score_enter';");  
			...
			*/
			  ...
			  //Added by Disnaka Jayasuriya on 2009-10-13 to validate credit period
      out.println("function format_num1(obj){  ");
			out.println("format_noobject_nodecimal1(obj)");
   		out.println("obj.value=Math.round(unformat_noobject(obj.value));");
			out.println("}");
      //end
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"FA_CR_display_credit_score_enter';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("help_box.innerHTML=\" Credit Process - Credit Score Entry  - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" Credit Process - Credit Score Entry  - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
     ...
     // out.println("window.close();");
      out.println("}");
			...
			out.println("    m_sql = \"m_help_DIV_TXT_FACILITY_CR_SOCRE_sql_NEW\";"); 
			...
			//out.println("url=\""+m_class_url+"/"+m_fschema_name+"FA_CR_score_validations?chksql=SCORE_DETAILS_VIEW&model=\"+document.Form1.TXT_SCORE_MODEL_CODE.value+\"&facility_no=\"+document.Form1.TXT_APPLICATION_NO.value;");
					out.println("url=\""+m_class_url+"/"+m_fschema_name+"FA_CR_score_validations?chksql=SCORE_DETAILS_VIEW&facility_no=\"+document.Form1.TXT_APPLICATION_NO.value;");
     ...
     // out.println(" alert('wwww'+m_total2);");
			...
			out.println("<INPUT TYPE='Hidden' NAME='USER_SCREEN_NAME' VALUE=\"CREDIT_SCORE_ENTRY\">");
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Credit Process - Credit Score Entry </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_APPLICATION_NO' maxlength='25' size='25' onblur=\"help_update_facility()\">"); //help_update_application()
			out.println("<input class='but_input' type='button' name='BUT_HELP_MAIN' value=\"Help\" onClick=\"help_update_facility()\">"); 
			//out.println("<input class='but_input' type='button' name='BUT_HELP_MAIN1' value=\"Detail\" onClick=\"show_facility(document.Form1.TXT_APPLICATION_NO.value)\"></td>"); 
  		...
  		out.println("</td>");
			...
			//Modified by Disnaka Jayasuriya on 2009-10-19 
			out.println("<td width='10%'><input class='txt_input' type='text' name='TXT_DIRECTOR_VALUE' value ='0'  maxlength='3' size='3' onchange=\"format_num1(this),get_sum1()\" >&nbsp</td>");			
			out.println("</tr>");
			...
			out.println("</SELECT>");
			out.println("</td>"); 
			out.println("<td width='10%'><input class='txt_input' type='text' name='TXT_REPUTATION_VALUE'  value ='0' maxlength='3' size='3' onchange=\"format_num1(this),get_sum1()\">&nbsp</td>");			
			out.println("</tr>");
			...
			out.println("</td>"); 
			out.println("<td width='10%'><input class='txt_input' type='text' name='TXT_REF_BANK_VALUE'  value ='0' maxlength='3' size='3' onchange=\"format_num1(this),get_sum1()\" >&nbsp</td>");			
			out.println("</tr>");
      ...
      ///___________________________ 4			
			...
			out.println("</td>"); 
			out.println("<td width='10%'><input class='txt_input' type='text' name='TXT_REF_TRADE_VALUE'  value ='0' maxlength='3' size='3' onchange=\"format_num1(this),get_sum1()\" >&nbsp</td>");			
			out.println("</tr>");
      ...
      ///___________________________ 5
			...
			out.println("</SELECT>");
  		out.println("</td>"); 
			out.println("<td width='10%'><input class='txt_input' type='text' name='TXT_CAPACITY_VALUE' value ='0' maxlength='3' size='3' onchange=\"format_num1(this),get_sum1()\" ></td>");			
			out.println("</tr>");
			out.println("<tr >");
			out.println("<td width='5%' >&nbsp</td>");
		  ...
		  out.println("</br>");   
			...
			out.println("</SELECT>");
  		out.println("</td>"); 
			out.println("<td width='10%'><input class='txt_input' type='text' name='TXT_PRODUCT_VALUE' maxlength='3' size='3' value='0' onchange=\"format_num1(this),get_sum2()\">&nbsp</td>");			
			out.println("</tr>");
			...
			out.println("</SELECT>");
  		out.println("</td>"); 
			out.println("<td width='10%'><input class='txt_input' type='text' name='TXT_INDUSTRY_VALUE' maxlength='3' size='3' value='0' onchange=\"format_num1(this),get_sum2()\" >&nbsp</td>");			
			out.println("</tr>");
			...
			out.println("</SELECT>");
  		out.println("</td>"); 
			out.println("<td width='10%'><input class='txt_input' type='text' name='TXT_RESONS_VALUE' maxlength='3' size='3' value='0' onchange=\"format_num1(this),get_sum2()\" >&nbsp</td>");			
			out.println("</tr>");
      ...
      ///___________________________ 4			
	    ...
	    out.println("</td>"); 
			...
			out.println("</SELECT>");
  		out.println("</td>"); 
			out.println("<td width='10%'><input class='txt_input' type='text' name='TXT_OPERATION_VALUE1' maxlength='3' size='3' value='0' onchange=\"format_num1(this),get_sum2()\" >&nbsp</td>");			
			out.println("</tr>");
	    ...
	    out.println("</td>"); 
			...
			out.println("</SELECT>");
  		out.println("</td>"); 
			out.println("<td width='10%'><input class='txt_input' type='text' name='TXT_OPERATION_VALUE2' maxlength='3' size='3' value='0' onchange=\"format_num1(this),get_sum2()\">&nbsp</td>");			
			out.println("</tr>");
	    ...
	    out.println("</td>"); 
			...
			out.println("</SELECT>");
  		out.println("</td>"); 
			out.println("<td width='10%'><input class='txt_input' type='text' name='TXT_OPERATION_VALUE3' maxlength='3' size='3' value='0' onchange=\"format_num1(this),get_sum2()\" >&nbsp</td>");			
			out.println("</tr>");
	    ...
	    out.println("</td>"); 
			...
			out.println("</SELECT>");
  		out.println("</td>"); 
			out.println("<td width='10%'><input class='txt_input' type='text' name='TXT_OPERATION_VALUE4' maxlength='3' size='3' value='0' onchange=\"format_num1(this),get_sum2()\">&nbsp</td>");			
			out.println("</tr>");
	    ...
	    out.println("</td>"); 
			...
			out.println("</SELECT>");
  		out.println("</td>"); 
			out.println("<td width='10%'><input class='txt_input' type='text' name='TXT_BANKING_VALUE1' maxlength='3' size='3' value='0' onchange=\"format_num1(this),get_sum2()\" >&nbsp</td>");			
			out.println("</tr>");
	    ...
	    out.println("</td>"); 
			...
			out.println("</SELECT>");
  		out.println("</td>"); 
			out.println("<td width='10%'><input class='txt_input' type='text' name='TXT_BANKING_VALUE2' maxlength='3' size='3' value='0' onchange=\"format_num1(this),get_sum2()\" >&nbsp</td>");			
			out.println("</tr>");
	    ...
	    out.println("</td>"); 
			...
			out.println("</SELECT>");
  		out.println("</td>"); 
			out.println("<td width='10%'><input class='txt_input' type='text' name='TXT_BANKING_VALUE3' maxlength='3' size='3' value='0' onchange=\"format_num1(this),get_sum2()\" >&nbsp</td>");			
			out.println("</tr>");
	    ...
	    out.println("</td>"); 
			...
			out.println("</SELECT>");
  		out.println("</td>"); 
			out.println("<td width='10%'><input class='txt_input' type='text' name='TXT_BANKING_VALUE4' maxlength='3' size='3' value='0' onchange=\"format_num1(this),get_sum2()\" >&nbsp</td>");			
			out.println("</tr>");
			...
			out.println("</td>"); 
			out.println("<td width='10%'><input class='txt_input' type='text' name='TXT_REFERENCE_VALUE' maxlength='3' size='3' value='0' onchange=\"format_num1(this),get_sum2()\" >&nbsp</td>");			
			out.println("</tr>");
			...
			out.println("</SELECT>");
  		out.println("</td>"); 
			out.println("<td width='10%'><input class='txt_input' type='text' name='TXT_FINANCIAL_VALUE' maxlength='3' size='3' value='0' onchange=\"format_num1(this),get_sum2()\" >&nbsp</td>");			
			out.println("</tr>");
		  ...
		  out.println("</td>"); 
			...
			out.println("</SELECT>");
  		out.println("</td>"); 
			out.println("<td width='10%'><input class='txt_input' type='text' name='TXT_DEBTORS_VALUE' maxlength='3' size='3' value='0' onchange=\"format_num1(this),get_sum3()\" >&nbsp</td>");			
			out.println("</tr>");
			...
			out.println("</SELECT>");
  		out.println("</td>"); 
			out.println("<td width='10%'><input class='txt_input' type='text' name='TXT_TOP_DEBTORS_VALUE' maxlength='3' size='3' value='0' onchange=\"format_num1(this),get_sum3()\" >&nbsp</td>");			
			out.println("</tr>");
      ...
      ///_________________________________ 3
			...
			out.println("</td>"); 
			out.println("<td width='10%'><input class='txt_input' type='text' name='TXT_DEBTOR_TRACK_VALUE' maxlength='3' size='3' value='0' onchange=\"format_num1(this),get_sum3()\" >&nbsp</td>");			
			out.println("</tr>");
      ...
      ///_________________________________ 4
			...
			out.println("</td>"); 
			out.println("<td width='10%'><input class='txt_input' type='text' name='TXT_REF_OBTAINED_VALUE' maxlength='3' size='3' value='0' onchange=\"format_num1(this),get_sum3()\" >&nbsp</td>");			
			out.println("</tr>");			
