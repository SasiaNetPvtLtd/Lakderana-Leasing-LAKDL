...
class Print_inovice_book_individual implements Printable {

public String m_group_inv_num,m_from_invoice_date="",m_to_invoice_date="",m_client="";
...
public Print_inovice_book_individual(String m_rec,String m_from_date, String m_to_date,String client_code){
			...
			if(rs.next()){
				    ...
				    m_value_date_2 =rs.getString(7); 
						rs1 = stmt1.executeQuery (	" SELECT "+
																		    ...
																		    " ADDRESS1, "+
																		    " NVL(ADDRESS2,' '), "+
																		    " NVL(LAKDL.AF_CO_GET_CITY_NAME(CITY_CODE),' ') CITY_NAME, "+
