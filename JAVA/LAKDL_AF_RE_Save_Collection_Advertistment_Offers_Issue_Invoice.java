...
public class LAKDL_AF_RE_Save_Collection_Advertistment_Offers_Issue_Invoice extends javax.servlet.http.HttpServlet {
   ...
   //   String m_username 						= "AA";//m_sn_methods.username;
      ...
      String m_inventory_no = req.getParameter("inventory_no");
			...
			String m_offer_no =req.getParameter("offer_no");
	    	  ...
	    	  callstmt=conn.prepareCall("BEGIN "+m_schema_name+".AF_RE_SAVE_ADV_OFF_INV_STATUS(:1,:2,:3,:4); END;");
				
				  callstmt.setString(1,m_inventory_no);
			...
			out.println("window.location.href='"+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_RE_Collection_Offer_Invoice_Letter?chksql=main_page&inventory_no="+m_inventory_no+"&vehicle_no="+m_vehicle_no+"&offer_no="+m_offer_no+"&status=COPY&print=FALSE';");
