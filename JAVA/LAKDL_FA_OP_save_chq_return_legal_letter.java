...
public class LAKDL_FA_OP_save_chq_return_legal_letter extends HttpServlet {
      ...
      String m_username = m_sn_methods.username;
			...
			//------------------------------------------------------------------------------------------
				...
				int tnum=0;
							...
							callstmt1.setString(3,"CHEQ_RETURN_LEGAL_LETTER");
	   	...
	   	out.println("<HTML><HEAD>");
			...
			out.println("	m_url = \""+m_class_url+"/"+m_fschema_name+"FA_OP_Cheque_Return_Letter?chksql=main_page&client_no="+m_client_no+"&debtor_code="+m_debtor_code+"&print=TRUE&receipt_no="+m_receipt_no+"&return_no="+m_return_no+"&facility_no="+m_facility_no+"\";"); 
