		...
		try {
     	...
     	res.setDateHeader("Expires", 0);
			...
			if (m_chksql.trim().equals("idle")) {
				...
				out.println("<tr >");
				out.println("<td width='30%'><DIV class=div_input><b>Net-Payable Amount</b></DIV></td>");
				if(m_net_pay_amount<0){
				out.println("<td width='20%' align='right'><DIV class=div_input><b>("+nf.format(m_net_pay_amount*-1)+")</b></DIV></td>");
				}
				else{
				out.println("<td width='20%' align='right'><DIV class=div_input><b>"+nf.format(m_net_pay_amount)+"</b></DIV></td>");
				}
				out.println("<td width='5%'><DIV class=div_input></DIV></td>");
				out.println("<td width='*%'><DIV class=div_input></DIV></td>");
				out.println("</tr>");
				...
				out.println("<tr >");
				out.println("<td width='30%'><DIV class=div_input><b>Minimum Invoice Payable Amount</b></DIV></td>");
				if(m_min_pay_amount<0){
				out.println("<td width='20%' align='right'><DIV class=div_input><b>("+nf.format(m_min_pay_amount*-1)+")</b></DIV></td>");
				}
				else{
				out.println("<td width='20%' align='right'><DIV class=div_input><b>"+nf.format(m_min_pay_amount)+"</b></DIV></td>");
				}
				out.println("<td width='5%'><DIV class=div_input></DIV></td>");
				out.println("<td width='*%'><DIV class=div_input></DIV></td>");
				out.println("</tr>");
				...
				out.println("<tr >");
				out.println("<td width='30%'><DIV class=div_input><b>Less Receivables from Active Invoices</b></DIV></td>");
				...
				out.println("<tr >");
				out.println("<td width='30%'><DIV class=div_input><b>Less Receivables from Inactive Invoices</b></DIV></td>");
				...
				out.println("</tr>");
				out.println("<tr >");
				out.println("<td width='30%'><DIV class=div_input><b>Closing Balance</b></DIV></td>");
				if(m_colse_bal<0){
				out.println("<td width='20%' align='right'><DIV class=div_input><b>("+nf.format(m_colse_bal*-1)+")</b></DIV></td>");
				}
				else{
				out.println("<td width='20%' align='right'><DIV class=div_input><b>"+nf.format(m_colse_bal)+"</b></DIV></td>");
				}
				out.println("<td width='5%'><DIV class=div_input></DIV></td>");
				out.println("<td width='*%'><DIV class=div_input></DIV></td>");
				out.println("</tr>");
				...
				out.println("</tr>");
				out.println("<tr >");
				out.println("<td width='30%'><DIV class=div_input><b>Net Exposure</b></DIV></td>");
				
				double m_exposure=((m_colse_bal+m_bal_overinterest+m_bal_interest)-(m_bal_bank_cheque));
				
				if(m_exposure<0){
				out.println("<td width='20%' align='right'><DIV class=div_input><b>("+nf.format(m_exposure*-1)+")</b></DIV></td>");
				}
				else{
				out.println("<td width='20%' align='right'><DIV class=div_input><b>"+nf.format(m_exposure)+"</b></DIV></td>");
				}
				out.println("<td width='*%'><DIV class=div_input></DIV></td>");
				out.println("</tr>");
				out.println("</table>");
				...
				out.println("<table align='center' width='100%' class='table' >");
				out.println("<tr >");
				out.println("<td width='30%'><DIV class=div_input><b>Minimum Payable Amount</b></DIV></td>");
				if(m_minim_pay_amount<0){
				out.println("<td width='20%' align='right'><DIV class=div_input><b>("+nf.format(m_minim_pay_amount*-1)+")</b></DIV></td>");
				}
				else{
				out.println("<td width='20%' align='right'><DIV class=div_input><b>"+nf.format(m_minim_pay_amount)+"</b></DIV></td>");
				}
				...
				out.println("<tr >");
				out.println("<td width='30%'><DIV class=div_input><b>Maximum Payable Amount</b></DIV></td>");
				if((m_max_pay_amount)<0){
				out.println("<td width='20%' align='right'><DIV class=div_input><b>("+nf.format((m_max_pay_amount)*-1)+")</b></DIV></td>");
				}
				else{
				out.println("<td width='20%' align='right'><DIV class=div_input><b>"+nf.format(m_max_pay_amount)+"</b></DIV></td>");
				}
				out.println("<td width='*%'><DIV class=div_input></DIV></td>");
				out.println("</tr>");
				...
				out.println("<table align='center' width='100%' class='table' >");
				out.println("<tr >");
				out.println("<td width='30%'><DIV class=div_input><b>Client Credit Limit</b></DIV></td>");
				out.println("<td width='20%' align='right'><DIV class=div_input><b>"+nf.format(m_client_credit)+"</b></DIV></td>");
				out.println("<td width='*%'><DIV class=div_input></DIV></td>");
				out.println("</tr>");
				...
				out.println("<tr >");
				out.println("<td width='30%'><DIV class=div_input><b>Client Maximum Availability</b></DIV></td>");
				out.println("<td width='20%' align='right'><DIV class=div_input><b>"+nf.format(m_client_credit)+"</b></DIV></td>");
				out.println("<td width='*%'><DIV class=div_input></DIV></td>");
				out.println("</tr>");
				}
					...
					out.println("<tr >");
					out.println("<td width='30%'><DIV class=div_input><b>Client Maximum Availability</b></DIV></td>");
					out.println("<td width='20%' align='right'><DIV class=div_input><b>0.00</b></DIV></td>");
					out.println("<td width='*%'><DIV class=div_input></DIV></td>");
					out.println("</tr>");
					}
					else{
					out.println("<tr >");
					out.println("<td width='30%'><DIV class=div_input><b>Client Maximum Availability</b></DIV></td>");
					out.println("<td width='20%' align='right'><DIV class=div_input><b>"+nf.format(m_client_credit-m_client_final_bal)+"</b></DIV></td>");
					out.println("<td width='*%'><DIV class=div_input></DIV></td>");
					out.println("</tr>");
					}
				}
