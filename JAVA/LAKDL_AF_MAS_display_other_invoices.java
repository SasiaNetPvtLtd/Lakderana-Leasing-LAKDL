...
public class LAKDL_AF_MAS_display_other_invoices extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Collection - Other Invoices</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_other_invoices&data_val=\"+obj.value;");
			...
			out.println("return false;"); 
			out.println("}"); 
			out.println("else if(document.Form1.TXT_VALUE_DATE.value==\"\"){  "); 
			...
			out.println("return false;"); 
			out.println("}"); 
			out.println("else if(document.Form1.TXT_DUE_DATE.value==\"\"){  "); 
			out.println("DIV_TXT_DUE_DATE.style.color='red';");
			out.println("return false;"); 
			out.println("}"); 
			out.println("else if(document.Form1.TXT_BALANCE_TO_BE_RECEIVED.value==\"\"){  "); 
			out.println("DIV_TXT_BALANCE_TO_BE_RECEIVED.style.color='red';");
			out.println("return false;"); 
			out.println("}"); 
			...
			out.println("		document.Form1.action='"+m_class_url+"/LAKDL_AF_MAS_save_other_invoices';");  
			...
			out.println("		if(confirm(\"Are You Sure?\")){ "); 
			out.println("		window.location.href='"+m_class_url+"/LAKDL_AF_MAS_display_other_invoices';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("    m_help_message = \"m_help_msg_LAKDL_AF_MAS_display_other_invoices\";"); 
			...
			out.println("help_box.innerHTML=\" Collection - Other Invoices - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" Collection - Other Invoices - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
			...
			out.println("document.Form1.TXT_VALUE_DATE.disabled=true;"); 
			...
			out.println("document.Form1.TXT_DUE_DATE.disabled=true;"); 
			out.println("document.Form1.TXT_BALANCE_TO_BE_RECEIVED.disabled=true;"); 
	  	...
	  	out.println("		}"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Collection - Other Invoices</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<td width='30%' ><DIV id='DIV_TXT_INVOICE_NO'  class=div_input>Invoice No *</DIV></td>"); 
			...
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_VALUE_DATE' maxlength='7' size='7'></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 

			out.println("<td width='30%' ><DIV id='DIV_TXT_NET_AMOUNT'  class=div_input>Net Amount *</DIV></td>"); 
			...
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_TOTAL_AMOUNT' maxlength='22' size='22'></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 

			out.println("<td width='30%' ><DIV id='DIV_TXT_DUE_DATE'  class=div_input>Due Date *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_DUE_DATE' maxlength='7' size='7'></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 

			out.println("<td width='30%' ><DIV id='DIV_TXT_BALANCE_TO_BE_RECEIVED'  class=div_input>Balance To Be Received *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_BALANCE_TO_BE_RECEIVED' maxlength='22' size='22'></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 

			out.println("<td width='30%' >Client Code *</td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_CLIENT_CODE' maxlength='10' size='10'></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 
			...
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_CURRENCY_CODE' maxlength='10' size='10'></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 

			out.println("<td width='30%' ><DIV id='DIV_TXT_EXCHANGE_RATE'  class=div_input>Exchange Rate *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_EXCHANGE_RATE' maxlength='22' size='22'></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 

			out.println("<td width='30%' >INVOICE_TYPE *</td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_INVOICE_TYPE' maxlength='15' size='15'></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("</table>"); 
			out.println("<br>"); 
