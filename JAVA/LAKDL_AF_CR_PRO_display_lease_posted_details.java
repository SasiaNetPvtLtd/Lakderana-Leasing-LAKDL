//--
//SCREEN NAME:LEASE POSTED DETAILS
//CREATED BY :DELANJALI
//DATE/TIME	 :15-FEB-2007
//NOTES			 :
...
public class LAKDL_AF_CR_PRO_display_lease_posted_details extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Lease Posted Details</TITLE>"); 
			out.println("</HEAD>"); 
			out.println("<link REL='STYLESHEET' HREF='"+m_html_client_url+"/css/Asset_Financing_System.css' TYPE=\"text/css\">"); 
			out.println("<SCRIPT language=\"JavaScript\">"); 

			out.println("function get_vector(data_vec) {");
			out.println("			if(data_vec.length>0 && document.Form1.hid_text.value==\"J1\" ){");
			out.println("     document.Form1.TXT_POST_DATE_DD.value=data_vec[0];");
			out.println("     document.Form1.TXT_POST_DATE_MM.value=data_vec[1];");
			out.println("     document.Form1.TXT_POST_DATE_YY.value=data_vec[2];");
			out.println("			}");
			out.println("}");
			out.println("function makeRequest(obj) {");
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_CR_PRO_display_lease_posted_details&data_val=\"+obj.value;");
			...
			out.println("}"); 
			out.println("else if(document.Form1.TXT_POSTED_TO.value==\"\"){  "); 
			out.println("DIV_TXT_POSTED_TO.style.color='red';");
			out.println("return false;"); 
			out.println("}"); 
						out.println("else if(document.Form1.TXT_POST_DATE_DD.value==\"\" || document.Form1.TXT_POST_DATE_MM.value==\"\" || document.Form1.TXT_POST_DATE_YY.value==\"\"){  "); 
			out.println("DIV_TXT_POST_DATE.style.color='red';");
			out.println("return false;"); 
			out.println("}"); 
			...
			out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_CR_PRO_save_lease_posted_details';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_CR_PRO_display_lease_posted_details';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("    m_help_message = \"m_help_msg_LAKDL_AF_CR_PRO_display_lease_posted_details\";"); 
			...
			out.println("help_box.innerHTML=\" Lease Posted Details - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" Lease Posted Details - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
...
/*
			...
			out.println("}"); 
*/
			out.println("function check_date_post(){ ");
			out.println("  checkMonthLength(document.Form1.TXT_POST_DATE_DD,document.Form1.TXT_POST_DATE_MM,document.Form1.TXT_POST_DATE_YY);");
			out.println("}");
	...
	//		out.println("m_row=document.Form1.hid_count.value");
      out.println("  if(document.Form1.hid_cal_date.value=='1'){"); 
			...
			out.println("     document.Form1.TXT_POST_DATE_DD.value=v_dd;");
			out.println("     document.Form1.TXT_POST_DATE_MM.value=v_mm;");
			out.println("     document.Form1.TXT_POST_DATE_YY.value=v_yy;");
			out.println("  }");	
			out.println("}");				
...
/*
			...
			out.println("    document.Form1.TXT_TEL_NO.value=oBj.valout[6];"); 
...
*/
			out.println("function help_update() {"); 
			out.println("    document.Form1.hid_help_type.value=\"99\";"); 
			out.println("    Crit = document.Form1.TXT_LEASE_NO.value+\"@\"+\"VERIFYL@\";"); 
			out.println("    HelpBox('1','10','0',Crit,'FinanceSql','99');");
			out.println("}");
			...
			out.println("document.Form1.hid_text.value=\"J1\"");
...
//-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
			...
			out.println("<INPUT TYPE='Hidden' NAME='hid_status' VALUE=\"New\">"); 
						...
						out.println("<INPUT TYPE='Hidden' NAME='hid_text' VALUE=\"Save\">");
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Lease Posted Details</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<td width='30%' ><DIV id='DIV_TXT_LEASE_NO'  class=div_input>Lease No *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_LEASE_NO' maxlength='10' size='10' onblur=\"makeRequest(document.Form1.TXT_LEASE_NO)\">"); 
			out.println("<input class='but_input' type='button' name='BUT_HELP_MAIN' value=\"Help\" onClick=\"help_update()\" ></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 

			out.println("<td width='30%' ><DIV id='DIV_TXT_POSTED_TO'  class=div_input>Posted To *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_POSTED_TO' maxlength='1' size='1'></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 

			out.println("<td width='30%' ><DIV id='DIV_TXT_POST_DATE'  class=div_input>Posted Date*</DIV></td>"); 
			out.println("<td width=\"20%\"><input class=\"txt_input5\" type=\"text\" name=TXT_POST_DATE_DD maxlength=\"2\" size=\"2\" value=\"\" onblur=\"check_date_post()\">");
			out.println("<input class=\"txt_input5\" type=\"text\" name=TXT_POST_DATE_MM  maxlength=\"2\" size=\"2\" value=\"\" onblur=\"check_date_post()\">");
			out.println("<input class=\"txt_input5\" type=\"text\" name=TXT_POST_DATE_YY maxlength=\"4\" size=\"4\" value=\"\" onblur=\"check_date_post()\"><a href style='{cursor:hand; }' onclick=load_calendar('1')>   Calendar</a> ");	
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			...
			out.println("<td width='30%' >ACTIVE_STATUS *</td>"); 
