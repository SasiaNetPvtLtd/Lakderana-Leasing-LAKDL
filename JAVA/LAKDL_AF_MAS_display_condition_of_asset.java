...
//--
//SCREEN NAME:SYSTEM ADMINISTRATION - CONDITION OF ASSET
//ID:1.19 Condition of Asset Creation Process
//CREATED BY:N.V.P.Chandana
//DATE/TIME:21-07-2006
//NOTES:
...
public class LAKDL_AF_MAS_display_condition_of_asset  extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>System Administration - Condition Of Assets</TITLE>"); 
			out.println("</HEAD>"); 
      ...
      out.println("   }");
      out.println("    else if(data_vec.length == 0 && document.Form1.SCREEN_NAME.value!=\"NEW\"&& document.Form1.TXT_CODE.value !=''&& document.Form1.hid_help_status.value == 'H9' ){");
			//out.println("    alert('Selected Code is incorrect,use help...!')");
			out.println("    document.Form1.TXT_DESCRIPTION.value=\"\" ; ");
			out.println("    help_update();");
			out.println("    document.Form1.TXT_CODE.focus() ; ");
      out.println("   }");
			
      out.println("    else if(data_vec.length > 0 && document.Form1.SCREEN_NAME.value==\"NEW\" && document.Form1.hid_help_status.value == 'H8' ){");
			out.println("				alert('Record already exists.');"); 
      ...
      out.println("   }");
			...
			out.println("    m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_condition_of_asset1&data_val=\"+obj.value;");
			out.println("}");
			out.println("    else");
			...
			out.println("    m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_condition_of_asset&data_val=\"+obj.value+\"&ac_status=Y\";");
			out.println("}");
      out.println("    else");
      out.println("    if(document.Form1.hid_help_status.value=='H9' && document.Form1.SCREEN_NAME.value==\"RACT\")");
      out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_condition_of_asset&data_val=\"+obj.value+\"&ac_status=N\";");
      out.println("    else");
      out.println("    if(document.Form1.hid_help_status.value=='H8')"); //&& document.Form1.SCREEN_NAME.value==\"NEW\" //modified by nuwan de silva 19-07-07
      out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations1?chksql=m_prime_chk_LAKDL_AF_MAS_display_condition_of_asset_desc&data_val=\"+obj.value ;");
      ...
      out.println("    }");
			...
			out.println("}");
			out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_MAS_save_condition_of_asset ';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MAS_display_condition_of_asset ';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("    m_help_message = \"m_help_msg_LAKDL_AF_MAS_display_condition_of_asset \";"); 
			...
			out.println("help_box.innerHTML=\" System Administration - Condition Of Assets - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" System Administration - Condition Of Assets - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
	  	...
	  	out.println("		}"); 
			...
			out.println("    m_sql = \"m_help_TXT_CODE_DESC_sql\";"); 
	  	...
	  	out.println("		}"); 
			...
			out.println("    m_sql = \"m_view_TXT_CODE_sql\";");
			out.println("    m_criteria = document.Form1.TXT_CODE.value+\"@\"+\"Y@\";"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>System Administration - Condition Of Assets</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<td width='30%' ><DIV id='DIV_TXT_CODE'  class=div_input>Condition of Asset Code *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_CODE' maxlength='10' size='10' onblur=\"assign_help_status('H9'),makeRequest(document.Form1.TXT_CODE)\">");  //,show_asset_condition_drill(this.value) --modified by nuwan de silva 19-07-07
			out.println("<input class='but_input' type='button' name='BUT_HELP_MAIN' value=\"Help\" onClick=\"help_update()\" disabled></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 

			out.println("<td width='30%' ><DIV id='DIV_TXT_DESCRIPTION'  class=div_input>Condition of Asset Description *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_DESCRIPTION' maxlength='15' size='15' onblur=\"assign_help_status('H8'),makeRequest(document.Form1.TXT_DESCRIPTION)\"></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >");
