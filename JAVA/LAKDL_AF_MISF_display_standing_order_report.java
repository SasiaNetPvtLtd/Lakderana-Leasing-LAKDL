//--
//SCREEN NAME	:MIS - QUOTATION REPORT
...
public class LAKDL_AF_MISF_display_standing_order_report extends javax.servlet.http.HttpServlet { 
...
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!	
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE> Standing Orders Report Details</TITLE>"); 
			out.println("</HEAD>"); 
			out.println("<link REL='STYLESHEET' HREF='"+m_html_client_url+"/css/Asset_Financing_System.css' TYPE=\"text/css\">"); 
			out.println("<SCRIPT language=\"JavaScript\">"); 
			out.println("var b_flag=0");
			out.println("var m_start=''");
			out.println("var m_end=''");
			out.println("function get_vector(data_vec) {");
			out.println("			if(data_vec.length==0 && document.Form1.SCREEN_NAME.value==\"NEW\" && document.Form1.TXT_SO_NO.value!=\"\" && document.Form1.hid_assig.value==\"G1\"){");
			out.println("help_button_1();");
			out.println("			}");
			out.println("			if(data_vec.length==0 && document.Form1.SCREEN_NAME.value==\"NEW\" &&  document.Form1.TXT_ACC_NO.value!=\"\" && document.Form1.hid_assig.value==\"G2\"){");
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MISF_display_standing_order_report?chksql=main_page';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("    m_help_message = \"m_help_msg_LAKDL_AF_MISF_display_standing_order_report\";"); 
			...
			out.println("help_box.innerHTML=\"  Standing Order Report Details - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\"  Standing Order Report Details \";"); 
			out.println("}"); 
			...
			out.println("if(document.Form1.hid_assig.value==\"G1\"){");//PURCHASE ORDER NO
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_sql_validations?chksql=m_prime_chk_LAKDL_AF_CR_PRO_display_standing_order_so&data_val=\"+obj.value+\"&ac_status=Y\";");
			out.println("}");
			out.println("if(document.Form1.hid_assig.value==\"G2\"){");//APPLICATION NO
		  out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_sql_validations?chksql=m_prime_chk_LAKDL_AF_PRO_CR_display_licencee_settlement&data_val=\"+obj.value+\"&ac_status=Y\";");
			out.println("}");
			out.println("if(document.Form1.hid_assig.value==\"G3\"){");//INVOICE NO
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_sql_validations?chksql=m_prime_chk_LAKDL_AF_CR_PRO_Purchase_Order_val_show_invocie_doc&data_val=\"+obj.value+\"&ac_status=Y\";");
			out.println("}");
	  	...
	  	out.println("		}"); 
			...
			out.println("	}		"); 
			out.println("	else{");
			out.println(" document.Form1.TXT_SO_NO.value=\"\";"); 
		  ...
		  out.println("function view() {"); 
			out.println("m_start=document.Form1.TXT_START_DATE_DD.value+'-'+document.Form1.TXT_START_DATE_MM.value+'-'+document.Form1.TXT_START_DATE_YY.value");
			...
			out.println("m_start=\"\"");
			out.println("}");	
			out.println("m_end=document.Form1.TXT_END_DATE_DD.value+'-'+document.Form1.TXT_END_DATE_MM.value+'-'+document.Form1.TXT_END_DATE_YY.value");
			out.println("if(document.Form1.TXT_END_DATE_DD.value==\"\" || document.Form1.TXT_END_DATE_MM.value==\"\" ||document.Form1.TXT_END_DATE_YY.value==\"\"){");
			out.println("m_end=\"\"");
			out.println("}");
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_display_standing_order_report1?chksql=MAIN&finance_no=\"+document.Form1.TXT_FINANCE_NO.value+\"&acc_no=\"+document.Form1.TXT_ACC_NO.value+\"&so_no=\"+document.Form1.TXT_SO_NO.value+\"&start_date=\"+m_start+\"&end_date=\"+m_end+\"&invoice_no=\"+document.Form1.TXT_INVOICE_NO.value+\"\";");
			...
			out.println("    m_criteria = document.Form1.TXT_SO_NO.value+\"@\"+document.Form1.TXT_FINANCE_NO.value+\"@\"+\"Y@\";"); 
			...
			out.println("    m_criteria = document.Form1.TXT_ACC_NO.value+\"@\"+document.Form1.hid_client.value+\"@\"+\"Y@\";"); 
			out.println("    HelpBox('1','10','0');"); 
			out.println("}"); 
			out.println(""); 
			...
			out.println("    document.Form1.TXT_BANK_CODE.value=oBj.valout[3];"); 
			out.println("}"); 
			...
			out.println("    m_criteria = document.Form1.TXT_INVOICE_NO.value+\"@\"+document.Form1.TXT_FINANCE_NO.value+\"@\"+\"Y@\";"); 
			out.println("    HelpBox('1','10','0');"); 
			out.println("}");
			...
			out.println("if(document.Form1.TXT_END_DATE_DD!=\"\" || document.Form1.TXT_END_DATE_MM!=\"\" ||document.Form1.TXT_END_DATE_YY!=\"\"){");
			...
			out.println("  if(document.Form1.TXT_START_DATE_DD!=\"\" || document.Form1.TXT_START_DATE_MM!=\"\" ||document.Form1.TXT_START_DATE_YY!=\"\"){");
      ...
      out.println("if((parseInt(document.Form1.TXT_START_DATE_DD.value))>=(parseInt(document.Form1.TXT_END_DATE_DD.value))){");
      out.println("if((parseInt(document.Form1.TXT_START_DATE_MM.value))<=(parseInt(document.Form1.TXT_END_DATE_MM.value))){");
      out.println("if((parseInt(document.Form1.TXT_START_DATE_YY.value))<=(parseInt(document.Form1.TXT_END_DATE_YY.value))){");
      out.println(" if(((parseInt(document.Form1.TXT_START_DATE_DD.value))==(parseInt(document.Form1.TXT_END_DATE_DD.value)))&&");
      out.println("((parseInt(document.Form1.TXT_START_DATE_MM.value))==(parseInt(document.Form1.TXT_END_DATE_MM.value)))&&");
      out.println("((parseInt(document.Form1.TXT_START_DATE_YY.value))==(parseInt(document.Form1.TXT_END_DATE_YY.value)))){");
      out.println("}");
      out.println("else if(((parseInt(document.Form1.TXT_START_DATE_DD.value))>(parseInt(document.Form1.TXT_END_DATE_DD.value)))&&");
      out.println("((parseInt(document.Form1.TXT_START_DATE_MM.value))==(parseInt(document.Form1.TXT_END_DATE_MM.value)))&&");
      out.println(" ((parseInt(document.Form1.TXT_START_DATE_YY.value))==(parseInt(document.Form1.TXT_END_DATE_YY.value)))){");
      ...
      out.println("else{");
      out.println(" if((parseInt(document.Form1.TXT_START_DATE_MM.value))<=(parseInt(document.Form1.TXT_END_DATE_MM.value))){");
      out.println("  if((document.Form1.TXT_START_DATE_YY.value)<=(document.Form1.TXT_END_DATE_YY.value)){");
      out.println(" }");
      out.println(" else{");
      out.println("   alert('Start Date should be greater than End Date');");
			out.println("return false;"); 
      ...
      out.println(" }");
      out.println("}");
			out.println("document.Form1.TXT_START_DATE_YY.focus();");
...
//-----------------------------------------------------------------------------------------------------------------------
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Standing Order Report Details</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_FINANCE_NO' maxlength='15' size='15' onblur=\"assig('G6'),makeRequest1(document.Form1.TXT_FINANCE_NO),clear_client()\">"); 
			...
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_SO_NO' maxlength='15' size='15' onblur=\"assig('G1'),makeRequest1(document.Form1.TXT_SO_NO)\" >"); 
			out.println("<input class='but_input' type='button' name='BUT_TXT_SO_NO' value=\"Help\" onClick=\" help_button_1()\"></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>");		
			...
			out.println("<td width='30%' ><input class='txt_input' type='text' name='TXT_ACC_NO' maxlength='20' size='20' onblur=\"assig('G2'),makeRequest1(document.Form1.TXT_ACC_NO)\">"); 
			out.println("<input class='but_input' type='button' name='BUT_TXT_ACC_NO' value=\"Help\" onClick=\"help_button_2()\"></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 

			out.println("<tr>"); 
			out.println("<td width='30%' >Branch Code</td>"); 
			...
			out.println("<tr >"); 
			out.println("<td width=\"20%\"><input class=\"txt_input5\" type=\"hidden\" name=TXT_START_DATE_DD maxlength=\"2\" size=\"2\" value=\"\" onblur=\"check_date_start()\">");
			out.println("<input class=\"txt_input5\" type=\"hidden\" name=TXT_START_DATE_MM  maxlength=\"2\" size=\"2\" value=\"\" onblur=\"check_date_start()\">");
			out.println("<input class=\"txt_input5\" type=\"hidden\" name=TXT_START_DATE_YY maxlength=\"4\" size=\"4\" value=\"\" onblur=\"check_date_start()\"> ");	
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 


			out.println("<tr >"); 
			out.println("<td width=\"20%\"><input class=\"txt_input5\" type=\"hidden\" name=TXT_END_DATE_DD maxlength=\"2\" size=\"2\" value=\"\" onblur=\"check_date_end()\">");
			out.println("<input class=\"txt_input5\" type=\"hidden\" name=TXT_END_DATE_MM  maxlength=\"2\" size=\"2\" value=\"\" onblur=\"check_date_end()\">");
			out.println("<input class=\"txt_input5\" type=\"hidden\" name=TXT_END_DATE_YY maxlength=\"4\" size=\"4\" value=\"\" onblur=\"check_date_end()\"> ");	
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
