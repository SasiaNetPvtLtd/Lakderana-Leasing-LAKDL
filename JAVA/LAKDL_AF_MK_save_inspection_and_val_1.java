...
public class LAKDL_AF_MK_save_inspection_and_val_1 extends HttpServlet {
	...
	public synchronized void  service(HttpServletRequest req, HttpServletResponse res)	throws IOException{
     ...
     if(m_valuation_no.equals("")){
        callstmt.registerOutParameter(1,java.sql.Types.CHAR);	
			...
			/*out.println("m_valuation_no:"+m_valuation_no);
			out.println("m_val_date:"+m_val_date);
			out.println("m_reg_date:"+m_reg_date);*/
	      ...
	      m_valuation_no1 =callstmt.getString(1);
			...
			out.println(m_sn_methods.met_formdata(reqstr,"TXT_STATUS_"+k));*/
	   	...
	   	out.println("<HTML><HEAD>");
			...
			out.println("window.location.href='"+m_url+"/LAKDL_AF_CR_PRO_Credit_Valuation_Veri_1?applicaton_no='+m_app_no;");
		//	out.println("window.location.href='"+m_url+"/LAKDL_AF_MK_display_inspection_and_valu_1?APP_NO='+m_app_no;");
