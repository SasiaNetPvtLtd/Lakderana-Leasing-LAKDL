...
public class LAKDL_AF_MISF_Recovery_Report_automated extends javax.servlet.http.HttpServlet { 
	...
	public  void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { // synchronized
		...
		try { 
			...
			if(m_chksql.equals("main_page")){ 
				...
				out.println("<HTML>"); 
				out.println("<HEAD>"); 
				out.println("<TITLE>Collection - Recovery Report - Automated</TITLE>"); 
				out.println("</HEAD>"); 
				...
				out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_automated?chksql=run_report&finance_no=\"+finance_no+\"&date=\"+m_date+\"&location_id=\"+document.Form1.TXT_LOCATION_CODE.value+\"&user_id=\"+document.Form1.TXT_USER.value+\"&cr_officer=\"+m_cr_officer+\"&active_yard_status=\"+m_active_yard_status+\"&perform_stat=\"+m_perform_stat+\"&region=\"+m_region;"); // added by udara 13-08-2015 
				...
				out.println("			alert('Recovery Report is generated. Use View Report button to get the view.');"); // out.println("			alert('The report is generated. Use View Report button to get the view.');"); // added by udara 25-03-2014
				...
				out.println("   m_user_branch = '"+m_branch_id+"'; ");
				
				out.println("   if(m_user_branch=='HO'){");
				out.println("        print_report2(); ");
				out.println("   }");
				out.println("   else{");
				out.println("        if(document.Form1.TXT_LOCATION_CODE.value==''){   ");
				out.println("           alert('You cannot run the corperate report. Please select a branch'); ");	
				...
				*/
				...
				out.println(" m_cr_officer=document.Form1.MKT_OFFICER.value;");//added milinda 2013-10-16
				out.println("   m_product_name   = document.Form1.TXT_PRODUCT.value; "); // added by udara 15-10-2018
				//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_automated?chksql=print_report_new&location=\"+m_location+\"&officer=\"+m_officer+\"&date=\"+m_date+\"&perform_status=\"+perform_status+\"&cr_officer=\"+m_cr_officer+\"&active_status=\"+document.Form1.TXT_ACTIVE_STATUS.value+\"&region=\"+m_region+\"&finance_no=\"+m_finance_no;");  // added by udara on 09-05-2013 //mod by milinda 2013-10-16
				out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_automated?chksql=print_report_new&location=\"+m_location+\"&officer=\"+m_officer+\"&date=\"+m_date+\"&perform_status=\"+perform_status+\"&cr_officer=\"+m_cr_officer+\"&active_status=\"+document.Form1.TXT_ACTIVE_STATUS.value+\"&region=\"+m_region+\"&finance_no=\"+m_finance_no+\"&product_name=\"+m_product_name;");
				out.println("			window.open(m_url);");
				out.println("	}");
				out.println("}");
				...
				out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_automated?chksql=main_page&generate=page';"); 
				out.println("		}"); 
				out.println("}"); 
				...
				out.println("help_box.innerHTML=\" Collection Process - Recovery Report - Automated - \"+m_val;"); 
				out.println("}"); 
				out.println(""); 
				
				out.println("function load_roll_out_value(){");
				out.println("help_box.innerHTML=\" Collection Process - Recovery Report - Automated - \"+document.Form1.hid_status.value;"); 
				out.println("}"); 
				...
				out.println("if(validate_data()){");
				out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_automated?chksql=main_page&generate=print_report&location=\"+m_location+\"&officer=\"+m_officer+\"&date=\"+date;");	
				...
				out.println("</tr>"); 
				out.println("<tr>"); 
				out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Collection Process - Recovery Report - Automated </td>"); 
				out.println("</tr>"); 
				out.println("<tr>"); 
				...
				//out.println("<input class='but_input' type='button' name='BUT_PRINT' value=\"View Report\" onClick=\"print_report2()\" style=\"{width:110px;}\">");  // commented by udara 19-10-2016
				out.println("<input class='but_input' type='button' name='BUT_PRINT' value=\"View Report\" onClick=\"print_report3()\" style=\"{width:110px;}\">");  // added by udara 19-10-2016
				out.println("<input class='but_input' type='button' name='BUT_PRINT' value=\"Run Report\" onClick=\"run_report()\" style=\"{width:110px;display:none;}\"></td>"); 
				out.println("</tr>");
				
				out.println("<tr >"); // commented by udara 28-09-2016
				...
				*/
				...
				//out.println("<tr>"); // commented by udara 19-10-2016
				...
				rs2= stmt2.executeQuery(" "+
					" SELECT REGIONS_CODE,REGIONS_DESC "+
				...
				*/
				...
				while(rs2.next()){
					out.println("      <OPTION value='"+rs2.getString("REGIONS_CODE")+"' >"+rs2.getString("REGIONS_DESC")+"</OPTION>");
				}
				...
				rs2=stmt2.executeQuery(" SELECT TRAN_CODE,DESCRIPTION,DEFAULT_VALUE "+
				...
				if(!m_active_status.equals("A")){
					...
					m_active_status_string_for_cr_notes = " AND YARD_STATUS = '"+m_active_status+"' ";
					m_active_status_string = " AND A.YARD_STATUS = '"+m_active_status+"' ";
				...
				if(!m_officer.equals("")){
					...
					m_officer_string = " AND A.collection_officer  = UPPER('"+m_officer+"') ";
				}
				
				if(!m_location.equals("")){
					//m_location_string = " AND UPPER(A.LOCATION_CODE)      =  UPPER('"+m_location+"') ";
					m_location_string = " AND A.LOCATION_CODE      =  UPPER('"+m_location+"') ";
				}
				...
				if(!m_cr_officer.equals("")){
					...
					m_cr_officer_string_sql = " AND NVL("+m_schema_name+".AF_CO_GET_CR_OFFICER (B.INQUARY_NO),' ') = UPPER('"+m_cr_officer+"') ";
				}
				...
				out.println("    m_order_by_type = 'ASC'; ");
				out.println("  }");
				out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_automated?chksql=print_report_new&location="+m_location+"&officer="+m_officer+"&date="+m_date+"&active_status="+m_active_status+"&sort_column=\"+m_sort_col+\"&order_by_type=\"+m_order_by_type;");	
				...
				//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_automated?chksql=print_report_new_drill&location="+m_location+"&officer="+m_officer+"&date="+m_date+"&active_status="+m_active_status+"&slab=\"+val+\"&cr_officer="+m_cr_officer+"\";"); // commented by udara 02-08-2018	
				//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_automated?chksql=print_report_new_drill&location="+m_location+"&officer="+m_officer+"&date="+m_date+"&active_status="+m_active_status+"&slab=\"+val+\"&cr_officer="+m_cr_officer+"&perform_status="+m_perform_status+"&region="+m_region+"\";");	// added by udara 02-08-2018
				out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_automated?chksql=print_report_new_drill&location="+m_location+"&officer="+m_officer+"&date="+m_date+"&active_status="+m_active_status+"&slab=\"+val+\"&cr_officer="+m_cr_officer+"&perform_status="+m_perform_status+"&region="+m_region+"&product_name="+m_product_name+"\";");	
				...
				//out.println("   m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_automated?chksql=print_report_new_drill_total&location="+m_location+"&officer="+m_officer+"&date="+m_date+"&active_status="+m_active_status+"&cr_officer="+m_cr_officer+"\";");	// commented by udara 23-08-2017
				out.println("   m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_automated?chksql=print_report_new_drill_total&location="+m_location+"&officer="+m_officer+"&date="+m_date+"&active_status="+m_active_status+"&cr_officer="+m_cr_officer+"&perform_status="+m_perform_status+"&region="+m_region+"&product_name="+m_product_name+"\";"); // added by udara 23-08-2017
				out.println("   window.open(m_url,'slab','left=50,top=60,width=850,height=500,toolbar=0,location=0,directories=0,status=0,menuBar=0,scrollBars=1,resizable=1');"); 
				out.println("}");
				// end by udara 19-10-2016
				...
				// added by udara 06-06-2017
				rs1 = stmt.executeQuery(" "+
					" SELECT TO_CHAR(ENT_DATE,'DD-MM-YYYY HH:MI:SS AM') "+
					" FROM "+m_schema_name+".LAKDL_RECOV_RPT_RUN_LOG_DAY "+
					" WHERE DAY_END_DATE = TO_DATE('"+m_date+"','DD-MM-YYYY') "+
					"  ");
				
				if(rs1.next()){
					m_last_run_date = rs1.getString(1);
				}
				
				// end by udara 06-06-2017
				...
				rs=stmt.executeQuery("SELECT NVL("+m_schema_name+".AF_CO_GET_LOCATION_DESC('"+m_location+"'),'ALL'), "+m_schema_name+".AF_CO_GET_EMP_NAME('"+m_officer+"'), "+
					...
					//" (SELECT TO_CHAR(MAX(ENT_DATE),'DD-MM-YYYY HH:MI:SS') FROM "+m_schema_name+".AF_MIS_RECOVERY_REPORT_DAILY)   "+ // added by udara 19-05-2016
					" FROM DUAL ");
				...
				if(more){
					...
					// m_last_run_date = rs.getString(8); // added by udara 19-05-2016 // commented by udara 06-06-2017
				}
				...
				" SELECT "+
						...
						" FROM ( "+
						      ...
						      " SELECT NVL( A.TOTAL_PERIOD,0) TOTAL_PERIOD, "+
						        ...
						        " FROM "+m_schema_name+".AF_MIS_RECOVERY_REPORT_HIS A, "+m_schema_name+".af_co_pro_application_details B "+
				...
				out.println("<table align=\"center\" width=\"95%\" border=\"0\" class=\"table\">");
				out.println("<tr >");
				out.println("<td width=\"*\" STYLE='{font: bold 9pt arial; text-align:center;}'   ><u>RECOVERY REPORT - AUTOMATED</u></td>"); 
				out.println("</tr >");
			...
			// ============================================== main section end ================================================================
				...
				// added by udara 10-11-2015
				// commented by udara 15-06-2017
				
				
				// end by udara 10-11-2015
				
				
				// added by udara 15-06-2017
				Sql_data = "  "+
							...
							" SELECT   "+
							           " A.FINANCE_NO FINANCE_NO "+
												 ...
												 " AND REPORT_DATE = TO_DATE('"+m_date+"','DD-MM-YYYY') "+
													...
													Sql_data = Sql_data + "    "+m_active_status_string+"   "+ m_finance_string +"  "+m_location_string + "  "+ m_perform_status_string + "  "+ m_officer_string + "  "+ m_cr_officer_string_sql + " group by a.finance_no "+ 
											        
													
							" ) ";
							// end by udara 15-06-2017
				
				
				//out.println(Sql_data); // udara test
				...
				if(count_2>=0){ // added by udara 31-12-2013
					...
					Sql_data = "  "+
						" SELECT "+
							...
							" SUM(SETTL_AMOUNT_CUR_MON_RENTAL_N), "+
							" SUM(SETTLED_OTH_FROM_EXCESS), "+
							" SUM(RENTAL_AMOUNT_NEW) "+ // 17 added by udara 03-01-2018
							" FROM ( "+
							" SELECT   "+
													 ...
													 " FROM "+m_schema_name+".AF_MIS_RECOVERY_REPORT_HIS A, "+m_schema_name+".af_co_pro_application_details B   "+
														...
														Sql_data = Sql_data + "   "+ m_finance_string +"  "+m_location_string + "  "+ m_perform_status_string + "  "+ m_officer_string + "  "+ m_cr_officer_string_sql + "  "+
												        " AND REPORT_DATE = TO_DATE('"+m_date+"','DD-MM-YYYY') "+																					
							" ) "+
				...
				Sql_data="  "+	
					 " SELECT  "+
						 " NVL(SUM(ODI_AMOUNT_COL),0), "+
						 " NVL(SUM(INVOICE),0), "+
						 " NVL(SUM(RENTAL_ARREARS_NEW),0), "+
						 " NVL(SUM(INSURANCE),0), "+
						 " NVL(SUM(BBF),0), "+
						 " NVL(SUM(OPEN_CONTRACT_BAL),0) "+
						 " FROM ( "+
							...
							" SELECT NVL(SUM(A.ODI_AMOUNT_COL),0) ODI_AMOUNT_COL, "+
									...
									" FROM "+m_schema_name+".AF_RECOV_RPT_SUM_HIS_ALL A, "+m_schema_name+".AF_CO_PRO_APPLICATION_DETAILS B"+
												...
												Sql_data = Sql_data + "    "+m_active_status_string+"   "+ m_finance_string + "  "+ m_officer_string + "  "+ m_location_string +"  "+ m_perform_status_string +"  group by report_date "+
				...
				Sql_data=" "+
					...
					// commented by udara 15-06-2017 because daily is not in use for this report now
					...
					" AND    A.FINANCE_NO IN (SELECT FINANCE_NO FROM "+m_schema_name+".AF_MIS_RECOVERY_REPORT_HIS WHERE ENT_USER = 'LAKDLALL' AND REPORT_DATE = TO_DATE('"+m_date+"','DD-MM-YYYY') AND PERFORM_STATUS LIKE '"+m_perform_status+"%' "+ m_active_status_string_for_cr_notes +" ) "+ 
...
//--------------------------------------------------------------------------
				...
				Sql_data=" "+
					" select  "+
					" NVL(GET_DIFF_CR_AMOUNTS_RECOV_AUTO('"+m_date+"','RENTAL','LAKDLALL','"+m_perform_status+"','"+m_active_status+"'),0) CR_NOTES_RENTAL, "+
					" NVL(GET_DIFF_CR_AMOUNTS_RECOV_AUTO('"+m_date+"','ARREARS','LAKDLALL','"+m_perform_status+"','"+m_active_status+"'),0) CR_NOTES_ARREARS, "+
					" NVL(GET_DIFF_CR_AMOUNTS_RECOV_AUTO('"+m_date+"','OTHER_CURR','LAKDLALL','"+m_perform_status+"','"+m_active_status+"'),0) CR_NOTES_OTHER_CURR, "+
					" NVL(GET_DIFF_CR_AMOUNTS_RECOV_AUTO('"+m_date+"','OTHER_PREV','LAKDLALL','"+m_perform_status+"','"+m_active_status+"'),0) CR_NOTES_OTHER_PREV "+
					" from DUAL "+
					" ";
				...
				if(!m_finance_no.equals("")){	
						Sql_data=" "+
							" select  "+
							" NVL(GET_DIFF_CR_AMOU_RECOV_AUTO_2('"+m_date+"','RENTAL','LAKDLALL','"+m_finance_no+"','"+m_perform_status+"','"+m_active_status+"'),0) CR_NOTES_RENTAL, "+
							" NVL(GET_DIFF_CR_AMOU_RECOV_AUTO_2('"+m_date+"','ARREARS','LAKDLALL','"+m_finance_no+"','"+m_perform_status+"','"+m_active_status+"'),0) CR_NOTES_ARREARS, "+
							" NVL(GET_DIFF_CR_AMOU_RECOV_AUTO_2('"+m_date+"','OTHER_CURR','LAKDLALL','"+m_finance_no+"','"+m_perform_status+"','"+m_active_status+"'),0) CR_NOTES_OTHER_CURR, "+
							" NVL(GET_DIFF_CR_AMOU_RECOV_AUTO_2('"+m_date+"','OTHER_PREV','LAKDLALL','"+m_finance_no+"','"+m_perform_status+"','"+m_active_status+"'),0) CR_NOTES_OTHER_PREV "+
							" from DUAL "+
							" ";	
				}
					...
					Sql_data=" "+
							" select  "+
							" NVL(GET_DIFF_CR_AMOU_RECOV_AUTO_3('"+m_date+"','RENTAL','LAKDLALL','"+m_location+"','"+m_perform_status+"','"+m_active_status+"'),0) CR_NOTES_RENTAL, "+
							" NVL(GET_DIFF_CR_AMOU_RECOV_AUTO_3('"+m_date+"','ARREARS','LAKDLALL','"+m_location+"','"+m_perform_status+"','"+m_active_status+"'),0) CR_NOTES_ARREARS, "+
							" NVL(GET_DIFF_CR_AMOU_RECOV_AUTO_3('"+m_date+"','OTHER_CURR','LAKDLALL','"+m_location+"','"+m_perform_status+"','"+m_active_status+"'),0) CR_NOTES_OTHER_CURR, "+
							" NVL(GET_DIFF_CR_AMOU_RECOV_AUTO_3('"+m_date+"','OTHER_PREV','LAKDLALL','"+m_location+"','"+m_perform_status+"','"+m_active_status+"'),0) CR_NOTES_OTHER_PREV "+
							" from DUAL "+
							" ";
				...
				out.println("    m_order_by_type = 'ASC'; ");
				out.println("  }");
				out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_automated?chksql=print_report_new&location="+m_location+"&officer="+m_officer+"&date="+m_date+"&sort_column=\"+m_sort_col+\"&order_by_type=\"+m_order_by_type;"); // commented by udara on 09-05-2013
				out.println(" window.location.href=m_url;"); 
				out.println("}");
				...
				if (m_slab.equals("NEW") ){
					...
					Sql_data=" SELECT  "+
						...
						" FROM "+m_schema_name+".AF_MIS_RECOVERY_REPORT_DAILY A, "+m_schema_name+".af_co_pro_application_details B "+ // mod 22-10-2013
					...
					Sql_data="   "+
						 " SELECT  "+
								...
								// end by udara 28-08-2017	
								 ...
								 " FROM "+m_schema_name+".AF_MIS_RECOVERY_REPORT_HIS A, "+m_schema_name+".af_co_pro_application_details B  "+
								    //" WHERE A.ENT_USER='LAKDLALL' "+
								    //" WHERE TRUNC(A.REPORT_DATE)  = TO_DATE('"+m_date+"','DD-MM-YYYY') "+ // commented by udara 05-10-2018
									" WHERE A.REPORT_DATE = TO_DATE('"+m_date+"','DD-MM-YYYY') "+
								    " AND A.APPLICATION_NO = B.APPLICATION_NO "+ 
									//" AND UPPER(A.collection_officer) like UPPER('%"+m_officer+"%') "+
									//" AND A.collection_officer like UPPER('%"+m_officer+"%') "+ // added by udara 05-10-2018
									" AND A.collection_officer like UPPER('"+m_officer+"%') "+
									//" AND UPPER(A.LOCATION_CODE)      like UPPER('"+m_location+"%') "+ // commented by udara 05-10-2018
									" AND A.LOCATION_CODE  like UPPER('"+m_location+"%') "+ // added by udara 05-10-2018
									" AND A.TOTAL_PERIOD > 0 "+
									//" AND A.TOTAL_PERIOD = '"+m_slab+"'  "+
									" AND A.ACTIVATED_DATE  >= TRUNC(TO_DATE('"+m_date+"','DD-MM-YYYY'),'MM') "+
									" AND A.ACTIVATED_DATE  <= TRUNC(LAST_DAY(TO_DATE('"+m_date+"','DD-MM-YYYY')),'DD') "+
									//" AND UPPER (NVL("+m_schema_name+".AF_CO_GET_CR_OFFICER (B.INQUARY_NO),' ')) LIKE UPPER('"+m_cr_officer+"%') "+ // commented by udara 05-10-2018
									" AND NVL("+m_schema_name+".AF_CO_GET_CR_OFFICER (B.INQUARY_NO),' ') LIKE '"+m_cr_officer+"%' "+ // added by udara 05-10-2018
									m_active_status_string +
									m_perform_status_string; // added by udara 02-08-2018
						 ...
						 " SELECT  "+
								 ...
								 " 1,  "+
								 //" NVL ( DECODE(SIGN(A.TOTAL_AMOUNT),1,A.TOTAL_AMOUNT,0), 0)+ NVL (A.OTHER_CHARGES_CURR_MONTH, 0) - NVL(A.SETTLED_OTH_FROM_EXCESS,0) - NVL("+m_schema_name+".GET_CR_NOTE_AMNT_RECOV_RPT_2(A.FINANCE_NO,'"+m_date+"'),0) TOTAL_ARREARS,  "+
									" NVL (DECODE(SIGN(A.TOTAL_AMOUNT),1,A.TOTAL_AMOUNT,0),0)+ NVL (a.other_charges_curr_month, 0) - NVL(A.SETTLED_OTH_FROM_EXCESS,0) total_arrears, "+ //  adde by udara 28-08-2017
								 " NVL (A.RENTAL_AMOUNT, 0) RENTAL_AMOUNT,  "+
								 " NVL (A.SETTLED_AMOUNT_CUR_MON_RENTAL, 0) SETTLED_AMOUNT_CUR_MON_RENTAL,  "+
								 " NVL (A.SETTLED_AMOUNT_CUR_MON_ARREARS, 0) SETTLED_AMOUNT_CUR_MON_ARREARS,  "+
								 " NVL (A.SETTLED_AMOUNT_CUR_MON, 0) SETTLED_AMOUNT_CUR_MON,  "+
								...
								// end by udara 28-08-2017
								 ...
								 " FROM "+m_schema_name+".AF_MIS_RECOVERY_REPORT_DAILY A, "+m_schema_name+".af_co_pro_application_details B  "+
								    //" WHERE A.ENT_USER='LAKDLALL' "+
								...
								// end by udara 28-08-2017
								 ...
								 " FROM "+m_schema_name+".AF_MIS_RECOVERY_REPORT_HIS A, "+m_schema_name+".af_co_pro_application_details B  "+
									...
									*/
									...
									" AND A.ACTIVATED_DATE  < TRUNC(TO_DATE('"+m_date+"','DD-MM-YYYY'),'MM') "+
									//" AND UPPER (NVL("+m_schema_name+".AF_CO_GET_CR_OFFICER (B.INQUARY_NO),' ')) LIKE UPPER('"+m_cr_officer+"%') "+
									" AND NVL("+m_schema_name+".AF_CO_GET_CR_OFFICER (B.INQUARY_NO),' ') LIKE '"+m_cr_officer+"%' "+
									m_active_status_string +
				...
				while(more){
					...
					closing = new BigDecimal(0.00);
					//closing = closing.add(rs.getBigDecimal(10)); // commented by udara 28-08-2017
					closing = closing.add(rs.getBigDecimal(21)); // added by udara 28-08-2017
					
					Cash_Total = new BigDecimal(0.00);
					
					// commented by udara 28-08-2017
					/*
					if(futu_rent.signum()<0){
						if((futu_rent.signum()<0) && (closing.signum()>0)){
			...
			// added by udara 19-10-2016
				...
				if (m_slab.equals("NEW") ){
					...
					Sql_data="   "+
						 ...
						 //" UNION ALL "+ // commented by udara 23-08-2017
						 Sql_data = Sql_data + " UNION ALL "+ // added by udara 23-08-2017
			...
			// end by udara 19-10-2016
				...
				out.println("<table align=\"center\" width=\"95%\" border=\"0\" class=\"table\">");
				out.println("<tr >");
				out.println("<td width=\"*\" STYLE='{font: bold 10pt arial; text-align:center;}'   ><u>RECOVERY REPORT - AUTOMATED</u></td>"); 
