...
public class MULTI_AF_MAS_Save_Perform_loan extends HttpServlet {
  ...
  String reqstr;
	...
	public synchronized void  service(HttpServletRequest req, HttpServletResponse res)	throws IOException{
      ...
      m_msg = "'Information saved successfully'";
			...
			callstmt=conn.prepareCall("BEGIN "+m_schema_name+".AF_CR_PRO_SAVE_PERFORM_CON(:1,:2,:3,:4,:5); END;");
		  ...
		  //out.println("m_chk_type_n "+m_chk_type_n);
			...
			out.println("window.location.href='"+m_url+"/MULTI_MK_MAS_Performing_Loan_Setup?chksql=main_page';");
