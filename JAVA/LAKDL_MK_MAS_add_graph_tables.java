...
public class LAKDL_MK_MAS_add_graph_tables extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("		}");
			out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"MK_MAS_Add_Graph_Tables_Save';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"MK_MAS_add_graph_tables';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("    m_criteria = document.Form1.TXT_GRAPH_TYPE.value+\"@\";"); 
			...
			//out.println(SUB_SEC_NUM);
			//*************  USE JQUERY GRIDS  ****************//
			//m_url="../../validations/PW_MK_sql_validate_duplication.jsp?chksql=dash_graph_main&sub_sec_id="+document.Form1.SUB_SEC_NUM.value;
			//	out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"PW_MK_sql_validate_duplication?chksql=get_sub_sections\";	");
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"PW_MK_sql_validate_duplication?chksql=dash_graph_main&sub_sec_id=\"+document.Form1.SUB_SEC_NUM.value;");
			//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"FA_CR_xml_validations?chksql=DELETE_DEBTOR_SUP_DOCS&debtor_code=\"+debtor+\"&facility_code=\"+document.Form1.TXT_FACILITY_NO.value;");
			...
			out.println("		colNames:['Dashboard ID','Graph Type','X-Position', 'Y-Position', 'Height', 'Width', 'Edit' , 'Add SQL'],");
			out.println("		colModel:[ ");
			out.println("			{name:'DASH_ID' 			,index:'DASH_ID' 			    , hidden:false	,width:100,align:\"center\" 	,formatter:application_no_fmatter},");
			out.println("			{name:'GRAPH_TYPE_ID' 		,index:'GRAPH_TYPE_ID' 		    , hidden:false	,width:100,align:\"center\" 	,formatter:graph_type_id},");
			out.println("			{name:'DASH_X_POS' 			,index:'DASH_X_POS' 			, hidden:false	,width:100,align:\"center\" 	,formatter:dash_x_position},");
			out.println("			{name:'DASH_Y_POS' 			,index:'DASH_Y_POS' 			, hidden:false	,width:100,align:\"center\" 	,formatter:dash_y_position},");
			out.println("			{name:'GRAPH_HEIGHT' 		,index:'GRAPH_HEIGHT' 			, hidden:false	,width:100,align:\"center\" 	,formatter:graph_height},");
			out.println("			{name:'GRAPH_WIDTH' 		,index:'GRAPH_WIDTH' 			, hidden:false	,width:100,align:\"center\" 	,formatter:graph_width},");
			...
			out.println("		caption:\"Graph Position\",");
			...
			out.println("	document.Form1.TXT_DASHBOARD_ID.value 	= document.Form1.elements[\"HID_APP_NO_\"+row_id].value;");
			out.println("	document.Form1.TXT_GRAPH_TYPE.value		= document.Form1.elements[\"GRAPH_TYPE_ID_\"+row_id].value;");
			out.println("	document.Form1.TXT_X_POSITION.value 	= document.Form1.elements[\"DASH_X_POS_\"+row_id].value;");
			out.println("	document.Form1.TXT_Y_POSITION.value		= document.Form1.elements[\"DASH_Y_POS_\"+row_id].value;");
			out.println("	document.Form1.TXT_HEIGHT.value 	    = document.Form1.elements[\"GRAPH_HEIGHT_\"+row_id].value;");
			out.println("	document.Form1.TXT_WIDTH.value		    = document.Form1.elements[\"GRAPH_WIDTH_\"+row_id].value;");
			...
			out.println("function graph_type_id (cellvalue, options, rowObject)");
			out.println("{");
			out.println("	var rowid = options['rowId'];");
			out.println("	var link ='<input type=\"hidden\" name=\"GRAPH_TYPE_ID_'+rowid+'\" value='+cellvalue+' > '+cellvalue; ");
			out.println("	return link;	");
			out.println("}");
			
			out.println("function dash_x_position (cellvalue, options, rowObject)");
			out.println("{");
			out.println("	var rowid = options['rowId'];");
			out.println("	var link ='<input type=\"hidden\" name=\"DASH_X_POS_'+rowid+'\" value='+cellvalue+' > '+cellvalue; ");
			out.println("	return link;	");
			out.println("}");
			
			
			out.println("function dash_y_position (cellvalue, options, rowObject)");
			out.println("{");
			out.println("	var rowid = options['rowId'];");
			out.println("	var link ='<input type=\"hidden\" name=\"DASH_Y_POS_'+rowid+'\" value='+cellvalue+' > '+cellvalue; ");
			out.println("	return link;	");
			out.println("}");
			
			
			out.println("function graph_height (cellvalue, options, rowObject)");
			out.println("{");
			out.println("	var rowid = options['rowId'];");
			out.println("	var link ='<input type=\"hidden\" name=\"GRAPH_HEIGHT_'+rowid+'\" value='+cellvalue+' > '+cellvalue; ");
			out.println("	return link;");	
			out.println("}");
			
			out.println("function graph_width (cellvalue, options, rowObject)");
			out.println("{");
			out.println("	var rowid = options['rowId'];");
			out.println("	var link ='<input type=\"hidden\" name=\"GRAPH_WIDTH_'+rowid+'\" value='+cellvalue+' > '+cellvalue; ");
			out.println("	return link;	");
			out.println("}");
			
			out.println("function cli_info(row_id){");
			//out.println("	m_url='dashboard_add_sql.jsp?APP_NO='+document.Form1.elements[\"HID_APP_NO_\"+row_id].value;");
			out.println("	m_url=\""+m_class_url+"/"+m_fschema_name+"MK_MAS_dashboard_add_sql?APP_NO=\"+document.Form1.elements[\"HID_APP_NO_\"+row_id].value+\"\";");
			...
			out.println("</script>"); 
			out.println("<BODY class='body & txt-body' leftmargin='0' topmargin='0' marginwidth='0' ONLOAD=\"load_grid_app_details();\">"); 
			...
			out.println("<tr>	");  
			out.println("<td width='10%' ><b>Graph Position</b></td> ");  
			out.println("</tr>	");  											
			
			out.println("<tr > ");  
			
			out.println("<td width='30%' >Dashboard ID *</DIV></td> ");  
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_DASHBOARD_ID' maxlength='100' size='100' onblur=\"\"></td> ");  
			out.println("<td width='*%'></td> ");  
			out.println("</tr> ");  
			
			out.println("<tr > ");  
			
			out.println("<td width='30%' >Graph Type</DIV></td> ");  
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_GRAPH_TYPE' maxlength='100' size='100' onblur=\"\">");  
			out.println("<input class='but_input' type='button' name='BUT_HELP_MAIN' value=\"Help\" onClick=\"help_dash();\" ></td> ");  //graph_type_help(0)
			...
			out.println("<td width='30%' >X-Position</DIV></td> ");  
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_X_POSITION' maxlength='100' size='50'></td> ");  
			out.println("<td width='*%'></td> ");  
			out.println("</tr> ");  
			
			out.println("<tr > ");  
			
			out.println("<td width='30%' >Y-Position</DIV></td> ");  
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_Y_POSITION' maxlength='100' size='50'></td> ");  
			out.println("<td width='*%'></td> ");  
			out.println("</tr> 	");  
			...
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_HEIGHT' maxlength='100' size='50'></td> ");  
			out.println("<td width='*%'></td> ");  
			out.println("</tr> 	");  
			...
			out.println("<td width='30%' >Width</DIV></td> ");  
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_WIDTH' maxlength='100' size='50'></td> ");  
			out.println("<td width='*%'></td> ");  
			out.println("</tr> ");  
			/******************GRID GONE HERE*****************************/
			out.println("<tr>"); 
