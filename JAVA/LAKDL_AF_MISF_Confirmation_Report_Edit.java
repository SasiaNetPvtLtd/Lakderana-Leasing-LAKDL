...
public class LAKDL_AF_MISF_Confirmation_Report_Edit extends javax.servlet.http.HttpServlet { 
...
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!	
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Confirmation Report Edit</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MISF_Confirmation_Report_Edit?chksql=main_page';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("help_box.innerHTML=\"Confirmation Report Edit - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\"Confirmation Report Edit - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
		...
		/*	out.println("else if(m_val!=\"EDIT\"){"); 
		  ...
		  out.println("function view() {");
			...
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Confirmation_Report_Detail_View?chksql=main_page&finance_no=\"+document.Form1.TXT_FINANCE_NO.value+\"\";");
			...
			out.println("    m_sql = \"m_help_TXT_confirmation_rpt_edit_sql\";"); 
			...
			out.println("   document.Form1.hid_finance_status.value=oBj.valout[4]; ");
...
//-----------------------------------------------------------------------------------------------------------------------
			...
			out.println("<INPUT TYPE='Hidden' NAME='hid_finance_status' VALUE=\"\">"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Confirmation Report Edit</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<td width='*%' ><input class='txt_input' type='text' name='TXT_FINANCE_NO' maxlength='200' size='10'  >"); 
