...
public class LAKDL_AF_CR_PRO_Deletion_letter_new extends javax.servlet.http.HttpServlet { 
	
	// commented by udara 03-06-2019
	/*
	...
	Connection conn;
	Statement stmt,stmt_make;
	java.text.NumberFormat nf;
	
    public ResultSet rs,rs_make;
	...
	*/
	...
	//public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { // commented by udara 03-06-2019
	public void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { // added by udara 03-06-2019
		...
		Statement stmt= null,stmt_make= null;
		java.text.NumberFormat nf= null;
		
	    ResultSet rs= null,rs_make= null;
	 	
	
		//String m_html_client_url= null,
		String reqstr = null,m_Letter_date= null,m_c_code= null,m_add1= null,m_add2= null,m_name= null,m_city_desc= null,m_due_date= null,m_no_of_due_date= null,m_finance_no= null,m_print= null,m_termination_no= null;
  	 ...
  	 if(m_chksql.trim().equals("main_page")){
			...
			//--------------------------------------------	
				 ...
				 rs=stmt.executeQuery (" SELECT "+
					...
					//"  NVL("+m_schema_name+".AF_CO_GET_CONTRACT_BAL(FINANCE_NO,CLIENT_CODE,'"+m_sysdate+"','"+m_username+"'),0), "+
					//"  "+m_schema_name+".AF_CO_GET_RENTAL_INSURANCE(FINANCE_NO,'"+m_sysdate+"'), "+
					"  0, "+
					"  0, "+
		...
		*/
		...
		rs_install2=stmt_make.executeQuery (sql_install)	;
			...
			*/
			...
			out.println("<tr ><td width='70%' align='center'></TD>");
			//out.println("<td width='70%' align='left'><b>--</TD><b></tr>"); // commented by udara on 23-10-2012
			out.println("<td width='30%' align='left'><font size='"+font_size+"' >Serial No - "+m_termination_no+" </font></TD></tr>"); // added by udara on 23-10-2012
			...
			out.println("<tr ><td width='10%' align='center'></TD>");
			//out.println("<td width='70%' align='left'><b><font size='"+font_size+"' >LAKDERANA INVESTMENTS LTD</font></TD></b></tr>"); // commented by udara 03-06-2019
			...
			out.println("<table border='0' align='center' width='100%' class='table'>");
			out.println("<tr ><td width='10%' align='center'><b></td>");
			//out.println("<td width='70%' align='left'><font size='"+font_size+"' >--------------</font></td></tr>"); // commented by udara 03-06-2019
			...
			*/
			...
			out.println("<table border='0' align='center' width='100%' class='table'>");
			out.println("<tr ><td width='10%' align='center'></td>");
			//out.println("<td width='70%' align='left'><font size='"+font_size+"' > CC: "+m_insur_company+" </font></td></tr>"); // commented by udara 03-06-2019
			out.println("</table>");
