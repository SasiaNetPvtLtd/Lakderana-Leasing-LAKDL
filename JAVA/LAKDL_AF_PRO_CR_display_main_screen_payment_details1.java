...
public class LAKDL_AF_PRO_CR_display_main_screen_payment_details1 extends javax.servlet.http.HttpServlet { 
	Connection conn;
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			if(m_chksql1.equals("R")){
				m_level="Requisition_Approval";
				m_screen_name1="Requisition-Generation";
				
				m_status_new=null;
				m_status_edit="RE-APP"; 
				if(m_screen_type.equals("EDIT") || m_screen_type.equals("REVERSE")){
					m_status="RE-APP"; 
				}
				...
				m_level="Approval_1";
				m_screen_name1="Approval 1";
				
				//m_status_new="RE_APP"; 
				m_status_new="RE_A_2"; //added nuwan de silva on 08-10-07
				m_status_edit="APPRO1";
				if(m_screen_type.equals("NEW")){
					//m_status="RE-APP"; //added nuwan de silva on 08-10-07
					m_status="RE_A_2";
					m_new_status="Y";
			...
			if (m_chksql.trim().equals("idle")) {
				...
				out.println("	m_url = '"+m_class_url+"/"+m_fschema_name+"AF_PRO_CR_display_pay_req_details?TOT_SET='+document.Form1.elements[\"TXT_TOT_SETTLE_AMT_\"+m_row].value+'&INIT_BAL='+document.Form1.elements[\"TXT_INIT_BAL_AMT_\"+m_row].value+'&CURR_CODE='+document.Form1.elements[\"TXT_CURR_CODE_\"+m_row].value+'&APP_NO='+document.Form1.elements[\"TXT_APP_NO_\"+m_row].value+'&BAL='+document.Form1.elements[\"TXT_BAL_TO_BE_PAID_\"+m_row].value+'&VALUE_DATE='+document.Form1.elements[\"TXT_VALUE_DATE_\"+m_row].value+'&chksql1="+m_chksql1+"';"); 
				...
				out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_PRO_CR_display_main_screen_payment_details1?screen_type="+m_screen_type+"&sql=main_page&status_new="+m_status_new+"&chksql='+st_val+'&chksql2='+st_val1+'';");
				out.println("		}"); 
				out.println("}"); 
				
				out.println("function new_window(){	"); 
				out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_PRO_CR_display_main_screen_payment_details1?screen_type=NEW&sql=main_page&status_new="+m_status_new+"&chksql='+st_val+'&chksql2='+st_val1+'&st_c="+m_sort_column+"&oby="+m_order_by_type+"';");
				
				out.println("}"); 
				
				
				out.println("function edit_window(){	"); 
				out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_PRO_CR_display_main_screen_payment_details1?screen_type=EDIT&sql=main_page&status_edit="+m_status_edit+"&chksql='+st_val+'&chksql2='+st_val1+'&st_c="+m_sort_column+"&oby="+m_order_by_type+"';");
				out.println("}"); 
				
				out.println("function revese_window(){	"); 
				out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_PRO_CR_display_main_screen_payment_details1?screen_type=REVERSE&sql=main_page&status_edit="+m_status_edit+"&chksql='+st_val+'&chksql2='+st_val1+'&st_c="+m_sort_column+"&oby="+m_order_by_type+"';");
				//out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_PRO_CR_display_main_screen_payment_details1?screen_type=REVERSE&sql=main_page&status_edit="+m_status_edit+"&chksql='+st_val+'&chksql2='+st_val1+'&st_c="+m_sort_column+"&oby="+m_order_by_type+"';");
				out.println("}"); 
				...
				out.println("help_box.innerHTML=\" Finance - Payment  "+m_screen_name1+" - \"+m_val;"); 
				out.println("}"); 
				out.println(""); 
				
				out.println("function load_roll_out_value(){");
				out.println("help_box.innerHTML=\" Finance - Payment  "+m_screen_name1+" - \"+document.Form1.hid_status.value;"); 
				out.println("}"); 
				...
				out.println("        	assign_vendor()");
				out.println("		}"); 
				out.println("		if(document.Form1.hid_help_type.value==\"7\"){"); 
				out.println("        	assign_application_no()");
				out.println("		}");
				...
				out.println("function assign_vendor()");
				out.println("{ ");
				...
				out.println("function assign_application_no()");
				out.println("{ ");
				...
				//out.println("               alert('xx-1'); ");
				out.println("               document.Form1.TXT_APPLICATION_NO.value='';");
				//out.println("               alert('xx-2'); ");
				out.println(" 	} ");
				...
				if(m_level.equals("Requisition_Approval")){
					...
					out.println("		if(confirm(\"Are you sure you want to generate Payment Requisition?\")){ "); 
					out.println("	m_url = '"+m_class_url+"/"+m_fschema_name+"AF_PRO_CR_display_pay_req_details?TOT_SET='+document.Form1.elements[\"TXT_TOT_SETTLE_AMT_\"+row].value+'&INIT_BAL='+document.Form1.elements[\"TXT_INIT_BAL_AMT_\"+row].value+'&CURR_CODE='+document.Form1.elements[\"TXT_CURR_CODE_\"+row].value+'&APP_NO='+document.Form1.elements[\"TXT_APP_NO_\"+row].value+'&BAL='+document.Form1.elements[\"TXT_BAL_TO_BE_PAID_\"+row].value+'&VALUE_DATE='+document.Form1.elements[\"TXT_VALUE_DATE_\"+row].value+'&chksql1="+m_chksql1+"';"); 
				...
				if(m_level.equals("Approval_2")){
					...
					//out.println("}"); 		
					out.println("	m_url = '"+m_class_url+"/"+m_fschema_name+"AF_PRO_CR_display_pay_app2_details?TOT_SET='+document.Form1.elements[\"TXT_TOT_SETTLE_AMT_\"+row].value+'&INIT_BAL='+document.Form1.elements[\"TXT_INIT_BAL_AMT_\"+row].value+'&PAID_AMT='+document.Form1.elements[\"TXT_PAID_\"+row].value+'&PAY_NO='+document.Form1.elements[\"TXT_PAYMENT_NO_\"+row].value+'&CURR_CODE='+document.Form1.elements[\"TXT_CURR_CODE_\"+row].value+'&APP_NO='+document.Form1.elements[\"TXT_APP_NO_\"+row].value+'&BAL='+document.Form1.elements[\"TXT_BAL_TO_BE_PAID_\"+row].value+'&VALUE_DATE='+document.Form1.elements[\"TXT_VALUE_DATE_\"+row].value+'&chksql1="+m_chksql1+"';"); 
					out.println(" window.location.href=m_url;"); 
					out.println("}"); 
				}
				out.println("}"); 
				...
				if(m_screen_type.equals("NEW")){
					out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_PRO_CR_display_main_screen_payment_details1?screen_type=NEW&sql=load_data_client&m_client_name=\"+document.Form1.hid_m_client_name.value+\"&chksql="+m_chksql+"&chksql2="+m_chksql1+"&sort_column=\"+m_sort_col+\"&order_by_type=\"+m_order_by_type+\"&APPLICATIO_NO=\"+document.Form1.TXT_APPLICATION_NO.value;");
					
					//out.println(" window.location.href=m_url;"); 
				}
				if(m_screen_type.equals("EDIT")){
					
					out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_PRO_CR_display_main_screen_payment_details1?screen_type=EDIT&status_edit="+m_status_edit+"&sql=load_data_client&m_client_name=\"+document.Form1.hid_m_client_name.value+\"&chksql="+m_chksql+"&chksql2="+m_chksql1+"&sort_column=\"+m_sort_col+\"&order_by_type=\"+m_order_by_type+\"&APPLICATIO_NO=\"+document.Form1.TXT_APPLICATION_NO.value;");
					//out.println(" window.location.href=m_url;"); 
				}
				if(m_screen_type.equals("REVERSE")){
					out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_PRO_CR_display_main_screen_payment_details1?screen_type=REVERSE&status_edit="+m_status_edit+"&sql=load_data_client&m_client_name=\"+document.Form1.hid_m_client_name.value+\"&chksql="+m_chksql+"&chksql2="+m_chksql1+"&sort_column=\"+m_sort_col+\"&order_by_type=\"+m_order_by_type+\"&APPLICATIO_NO=\"+document.Form1.TXT_APPLICATION_NO.value;");
				...
				out.println("	m_url = \""+m_class_url+"/"+m_fschema_name+"AF_PRO_CR_display_main_screen_payment_details1?sql=load_data_client&screen_type="+m_screen_type+"&status_new="+m_status_new+"&m_client_name=\"+m_client_name+\"&chksql=\"+st_val+\"&chksql2=\"+st_val1+\"&APPLICATIO_NO=\"+document.Form1.TXT_APPLICATION_NO.value ;"); 
				//out.println("   window.open(m_url); ");
				//out.println("alert(m_url);");
				//out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_PRO_CR_display_main_screen_payment_details1?screen_type="+m_screen_type+"&sql=main_page&status_new="+m_status_new+"&chksql='+st_val+'&chksql2='+st_val1+'';");
				...
				//out.println("	m_url = \""+m_class_url+"/"+m_fschema_name+"AF_PRO_CR_display_main_screen_payment_details1?chksql=load_data_client&pre=\"+m_prev+\"&appro=\"+m_app+\"&qry=\"+m_app+\"&division_code=\"+m_division_code+\"&m_client_name=\"+m_client_name+\"&option=\"+m_option;"); 
				//out.println("}");
				//out.println("window.open(m_url);");
				out.println("load_interface(m_url,'NORM');");
				out.println("}"); 
				...
				out.println("function vendor_specific_application() ");
				out.println("{  ");
				out.println("    ");
				out.println("    document.Form1.hid_help_type.value=\"7\";"); 
				out.println("    m_sql = \"m_help_VendorsPECIFIC_APPLICATION_sql\";");
				out.println("    m_criteria = document.Form1.TXT_CLIENT_CODE.value+\"@\"+document.Form1.TXT_APPLICATION_NO.value+\"@\";"); 
				out.println("    HelpBox('1','10','0');"); 
				out.println("}  ");
				
				
				
				out.println("function vendor_help() {"); 
				out.println("    document.Form1.hid_help_type.value=\"6\";"); 
				out.println("    m_sql = \"m_help_VendorSql_sql\";"); 
				...
				out.println("</tr>"); 
				out.println("<tr>"); 
				out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Finance - Payment  "+m_screen_name1+"</td>"); 
				out.println("</tr>"); 
				out.println("<tr>"); 
				...
				out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Reverse\");' onClick='load_screen_status(\"REVERSE\")' name=\"bt_reverse\" value=\"Reverse\"></td>");  //Added By Sandun on 19-01-2009
				...
				//}  //Commented by Sandun
				if(m_screen_type.equals("REVERSE")){//m_screen_type.equals("EDIT") || 
				...
				out.println("<tr class=tr_input>"); 
				out.println("<td width='20%' ><DIV id='DIV_TXT_CLIENT_NAME'  class=div_input>Vendor  Name</DIV></td>"); 
				out.println("<td colspan='2' ><input class='txt_input' type='hidden' name='TXT_CLIENT_CODE' value=\"\"><input class='txt_input' type='text' name='TXT_CLIENT_NAME' maxlength='200' onblur=\"vendor_help()\" style=\"{width:250px;}\" size='15' >");  //onblur=\"assignState('M2'),makeRequest(document.Form1.TXT_APPLICATION_NO)\"
				out.println("<input class='but_input' type='button' name='BUT_TXT_CLIENT_NAME_HELP' value=\"...\" onClick=\"vendor_help()\">");
				out.println("</td>"); //m_help_TXT_APPLICATION_NO
				out.println("<td width='*%'></td>");
				out.println("</tr>"); 
				
				out.println("<tr class=tr_input>"); 
				out.println("<td width='20%' ><DIV id='DIV_TXT_CLIENT_NAME'  class=div_input>Application No</DIV></td>"); 
				out.println("<td width='20%' ><input class='txt_input' type='text' name='TXT_APPLICATION_NO' onblur=\"vendor_specific_application()\"  >");  //onblur=\"assignState('M2'),makeRequest(document.Form1.TXT_APPLICATION_NO)\"
				out.println("<input class='but_input' type='button' name='BUT_TXT_FINANCE_HELP' value=\"...\" onClick=\"vendor_specific_application()\"></td>"); //m_help_TXT_APPLICATION_NO
				out.println("<td width='20%'><input class='but_input' type='button' name='BUT_TXT_CLIENT_NAME_SEARCH' value=\"Search\" onClick=\"search_client_details(document.Form1.TXT_CLIENT_NAME.value)\"></td>");
				out.println("<td width='*%'></td>");
				out.println("</tr>");
	...
	//----------------------------------------------------------------------------------------------------------------									
			...
			out.println("</tr></table>");
				...
				*/		
				...
				String m_vendor_specific_application="";
				if(req.getParameter("sort_column")!=null && req.getParameter("order_by_type")!=null)
				{
					m_sort_column = req.getParameter("sort_column");
					m_order_by_type = req.getParameter("order_by_type");
				...
				if(req.getParameter("APPLICATIO_NO")!=null)
				{
					m_vendor_specific_application=req.getParameter("APPLICATIO_NO");
				}	
				...
				if(m_level.equals("Approval_1") || m_level.equals("Approval_2") ) {
					//out.println(m_level);
					out.println("<table width='100%'  border='0' cellspacing='0' cellpadding='0'><tr class=tr_input>");
					out.println("<td colspan=11 align=right></td>");
					out.println("<td align=right colspan=13><input type=button name=top_top     value=\"Go to End\" class=mainbut onclick=befor_end(document.Form1.top_bot);  onMouseOver='load_roll_value(\"Top\");' onmouseout='load_roll_value(document.Form1.hid_status.value);'></td>");
					...
					rs= stmt.executeQuery			
						...
						" AND A.ENTRY_TYPE='V' "+
						//" AND UPPER(PAYEE_NAME) LIKE UPPER('%"+_m_client_name+"%')  "+ // commented by udara on 16-08-2011
						" AND (UPPER(PAYEE_NAME) LIKE UPPER('%"+_m_client_name+"%') OR UPPER(B.FINANCE_NO) LIKE UPPER('%"+_m_client_name+"%')  ) "+ // added by udara on 16-08-2011
					...
					while(more){
						...
						out.println("<td  align=\"right\" >"+nf.format(rs.getDouble(9))+"<input  class=\"txt_input\" type=\"hidden\" name=TXT_PAID_"+j+" value=\""+rs.getString(9)+"\"><input  class=\"txt_input\" type=\"hidden\" name=TXT_BAL_TO_BE_PAID_"+j+" value=\""+rs.getString(12)+"\"><input  class=\"txt_input\" type=\"hidden\" name=TXT_BRANCH_"+j+" value=\"\"></td>"); 
						...
						if(m_screen_type.trim().equals("REVERSE")){//Added By Sandun on 19-01-2009
							out.println("<td align=\"center\"><input type=\"checkbox\" name=\"CHK_APP_"+j+"\" value=\"N\" onclick=\"check_change("+j+")\"  ></td>");			
						}else		{		
							out.println("<td align=\"center\" ><input class=\"but_input\" type=\"button\" style=\"width: 45px\" name=BUT_VIEW_"+j+" value=\"Approve\" onClick=\"help_button("+j+")\"></td>"); 
						}
						out.println("</tr>");
						...
						out.println("<input type=\"hidden\" name=\"HID_STATUS\" value=\""+rs.getString(13)+"\" >"); //Added BY Sandun on 19-01-2009
						more=rs.next();
						j=j+1;
					}
					...
					if(m_level.equals("Requisition_Approval") && m_screen_type.equals("NEW")){
						...
						// COMMENT BY NUWAN DE SILVA ON 23-01-2008 --------------------------------
						/*	rs= stmt.executeQuery
																	("SELECT DISTINCT C.APPLICATION_NO APPLICATION_NO, "+
																	"nvl(C.FINANCE_NO,'-') FINANCE_NO, "+
																	"C.TOTAL_FINANCE_AMOUNT TOTAL_FINANCE_AMOUNT , "+
							...
							*/
						// ADDED BY NUWAN DE SILVA ON 23-01-2008 --------------------------------	
						//out.println
						rs= stmt.executeQuery	 
							(" SELECT DISTINCT C.APPLICATION_NO APPLICATION_NO, "+
							" nvl(C.FINANCE_NO,'-') FINANCE_NO, "+
							...
							" AND B.BAL_TO_BE_PAID >0  "+
							" AND D.ACTIVE_STATUS <> 'C'   "+ //--NOT CANCELLED
							" AND C.APPLICATION_STATUS='ACTIVATED' "+//Added By Sandun on 5-5-2009
							" AND  "+
							" ( "+
							"    UPPER("+m_schema_name+".af_co_get_vendor_name(B.RECEIVER))    LIKE UPPER('%"+_m_client_name+"%')   "+
							"    OR "+
							"    UPPER(C.APPLICATION_NO) LIKE UPPER('%"+_m_client_name+"%') "+
							" ) "+
							" AND UPPER(C.APPLICATION_NO) LIKE UPPER('%"+m_vendor_specific_application+"%')  "+
							//"    OR "+
							// "    UPPER(C.FINANCE_NO) LIKE UPPER('%"+_m_client_name+"%') "+ //commented by madhawa 2012-02-17
							//" )"+
							//" OR  UPPER("+m_schema_name+".af_co_get_client_name(C.CLIENT_CODE)) LIKE UPPER('%"+_m_client_name+"%'))  "+
					...
					else if (m_level.equals("Requisition_Approval") && m_screen_type.equals("REVERSE")){ //m_screen_type.equals("EDIT")
						...
						rs= stmt.executeQuery
							...
							"B.REF_NO REF_NO,  "+//7
							"B.BAL_TO_BE_PAID BAL_TO_BE_PAID, "+//8
							...
							""+m_schema_name+".AF_RE_ACC_SUS_PAYMENT B, "+m_schema_name+".AF_CO_PRO_APP_INVOICE_DETAILS D, "+
							""+m_schema_name+".AF_RE_PRO_SETTLMENT_PAYMENT E , "+
							""+m_schema_name+".AF_CR_PRO_SET_PAY_BREAKDOWN F "+ //Added By Sandun on 20-01-2009
							"WHERE "+
							//"UPPER(C.APPLICATION_STATUS) =UPPER('ACTIVATED') "+
							"B.REF_NO=D.INVOICE_NO "+
							"AND D.APPLICATION_NO = C.APPLICATION_NO "+
							"AND F.PAYMENT_NO     = E.PAYMENT_NO "+
							//"AND B.BAL_TO_BE_PAID >0 "+
							" AND B.SUS_REF_NO=F.SUS_REF_NO "+
							" AND E.PROCESS_STATUS='"+m_status+"' "+ 
							" AND D.ACTIVE_STATUS<>'C' "+ //NOT CANCELLED
							" AND (C.APPLICATION_NO) LIKE ('%"+m_vendor_specific_application+"%') " +//ADDED BY MADHAWA 2012-02-17
							" AND (     UPPER("+m_schema_name+".af_co_get_vendor_name(B.RECEIVER))    LIKE UPPER('%"+_m_client_name+"%')  "+
							"      OR  UPPER("+m_schema_name+".af_co_get_client_name(C.CLIENT_CODE)) LIKE UPPER('%"+_m_client_name+"%')) "+
							"ORDER BY "+m_sort_column+" "+m_order_by_type+" ");
					...
					//out.println
								...
								//---------------------------------------------------------------------------------------------------------------
																	...
																	"to_char(b.value_date,'dd-mm-yyyy') value_date, "+
																	"B.RECEIVER RECEIVER, "+
																	//"B.RECEIVER VENDOR_NAME, "+//to match for above query //COMMENT BY NUWAN DE SILVA
																	"NVL(E.PAYEE_NAME,'-') VENDOR_NAME ,"+
																	//""+m_schema_name+".af_co_get_vendor_name(B.RECEIVER) VENDOR_NAME, "+
																	"E.PAY_AMOUNT PAID_AMT, E.PAYMENT_NO PAYMENT_NO, "+
																	"E.LIC_BRANCH_CODE LIC_BRANCH_CODE, "+
					...
					while(more){
						if(j==0){
							...
							if(!m_level.equals("Requisition_Approval") || m_screen_type.equals("REVERSE") ){//m_screen_type.equals("EDIT")
								out.println("<td width=\"10%\" align=\"left\" style=cursor:hand; title=\"Click here to sort by -  Payment No  \" onclick=sort_data(\"PAYMENT_NO\")>Payment No</td>"); 
							}
					...
					*/
						...
						//comment by nuwan de silva on 18-01-2008
						//out.println("<td  align=\"left\"  style= \"cursor:hand;cursor-color:blue\" onclick=\"show_vendor_drill('"+rs.getString(10)+"')\"><U>"+rs.getString(11)+"<input  class=\"txt_input\" type=\"hidden\" name=TXT_RECEIVER_"+j+" value=\""+rs.getString(10)+"\"></td>"); 
						
						//out.println("<td  align=\"left\"  style= \"cursor:hand;cursor-color:blue\" >"+rs.getString(11)+"<input  class=\"txt_input\" type=\"hidden\" name=TXT_RECEIVER_"+j+" value=\""+rs.getString(10)+"\"></td>"); 
						//}
						...
						if(m_level.equals("Requisition_Approval")&& m_screen_type.equals("NEW")){
							...
							out.println("<input type=\"hidden\" name=TXT_TOT_SETTLE_AMT_"+j+" value=\""+rs.getDouble(17)+"\">"); 
							out.println("<input type=\"hidden\" name=TXT_INIT_BAL_AMT_"+j+" value=\""+rs.getDouble(18)+"\">"); 
							out.println("<input type=\"hidden\" name=\"HID_STATUS\" value=\""+rs.getString(20)+"\" >"); //Added BY Sandun on 19-01-2009
							out.println("<input type=\"hidden\" name=HID_PAY_NO_"+j+" value=\""+rs.getString(13)+"\"></td>");
						}
