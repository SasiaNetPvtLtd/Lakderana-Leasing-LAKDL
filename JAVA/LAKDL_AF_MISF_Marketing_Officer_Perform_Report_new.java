...
public class LAKDL_AF_MISF_Marketing_Officer_Perform_Report_new extends javax.servlet.http.HttpServlet { 
		...
		try { 
			...
			if(m_chksql.equals("run_report")){ 
				...
				try{
					...
					callstmt1 = conn.prepareCall("BEGIN "+m_schema_name+".AF_SAVE_MASTER_ARREARS_RPT_2(:1,:2,:3,:4,:5,:6,:7);END;"); // added by udara 20-05-2017
			...
			if(m_chksql.equals("main_page")){ 
				...
				//out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Perform_Report_new?chksql=run_report&finance_no=\"+finance_no+\"&date=\"+m_date+\"&location_id=\"+document.Form1.TXT_LOCATION_CODE.value+\"&user_id=\"+document.Form1.TXT_USER.value+\"&perform_status=\"+m_perform_status;"); 
				...
				//out.println("			print_report2();"); // commented by udara 09-12-2016
				out.println("			alert('Arrears Report is generated. Use View Report button to get the view.');"); // added by udara 09-12-2016
				out.println("		}");
				out.println("		else{");
				...
				out.println("	}");
				*/
				//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Perform_Report_new?chksql=print_report_new&location=\"+m_location+\"&officer=\"+m_officer+\"&slab=\"+m_slba+\"&rendate=\"+m_rendate+\"&date=\"+m_date;");	
				
				// commented by udara on 06-09-2013
				//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Perform_Report_new?chksql=print_report_new&location=\"+m_location+\"&officer=\"+m_officer+\"&slab=\"+m_slba+\"&rendate=\"+m_rendate+\"&date=\"+m_date+\"&period=\"+m_period+\"&period_2=\"+m_period_2;"); // added by udara on 12-03-2013
				...
				*/
				...
				out.println("           if(due_month==\"\"&& due_year==\"\") ");
				out.println("               m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Perform_Report_new?chksql=print_report_new&location=\"+m_location+\"&officer=\"+m_officer+\"&slab=\"+m_slba+\"&rendate=\"+m_rendate+\"&date=\"+m_date+\"&period=\"+m_period+\"&period_2=\"+m_period_2+\"&cr_officer=\"+cr_officer+\"&active_status=\"+document.Form1.TXT_ACTIVE_STATUS.value+\"&region=\"+m_region+\"&perform_status=\"+m_perform_status;"); // m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Perform_Report_new?chksql=print_report_new&location=\"+m_location+\"&officer=\"+m_officer+\"&slab=\"+m_slba+\"&rendate=\"+m_rendate+\"&date=\"+m_date+\"&period=\"+m_period+\"&period_2=\"+m_period_2;");
				out.println("           else ");
				out.println("           	m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Perform_Report_new?chksql=print_report_new_2&location=\"+m_location+\"&officer=\"+m_officer+\"&slab=\"+m_slba+\"&rendate=\"+m_rendate+\"&date=\"+m_date+\"&period=\"+m_period+\"&period_2=\"+m_period_2+\"&due_month=\"+due_month+\"&due_year=\"+due_year+\"&ins_level=\"+ins_level+\"&cr_officer=\"+cr_officer+\"&active_status=\"+document.Form1.TXT_ACTIVE_STATUS.value+\"&region=\"+m_region+\"&perform_status=\"+m_perform_status;"); // m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Perform_Report_new?chksql=print_report_new_2&location=\"+m_location+\"&officer=\"+m_officer+\"&slab=\"+m_slba+\"&rendate=\"+m_rendate+\"&date=\"+m_date+\"&period=\"+m_period+\"&period_2=\"+m_period_2+\"&due_month=\"+due_month+\"&due_year=\"+due_year+\"&ins_level=\"+ins_level;");
	      ...
	      out.println("	m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_Marketing_Officer_Performance_Report?chksql=main_page&sort_column=\"+m_sort_col+\"&order_by_type=\"+m_order_by_type;"); 
				...
				*/
				...
				out.println("	m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Perform_Report_new?chksql=main_page&generate=drill_down_asset&finance_no=\"+m_finance_no;"); 
				...
				out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Perform_Report_new?chksql=main_page&generate=page';"); 
				out.println("		}"); 
				out.println("}"); 
				...
				out.println("if(validate_data()){");
				out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Perform_Report_new?chksql=main_page&generate=print_report&location=\"+m_location+\"&officer=\"+m_officer+\"&date=\"+date;");	
				...
				//out.println("<input class='but_input' type='button' name='BUT_PRINT' value=\"Run Report\" onClick=\"run_report()\" style=\"{width:110px;}\"></td>"); // commented by udara 17-065-2017
				//out.println("<input class='but_input' type='button' name='BUT_PRINT_RUN' value=\"Run Report\" onClick=\"run_report()\" style=\"{width:110px;}\"></td>");  // added by udara 17-065-2017
				out.println("</td>");
				out.println("</tr>");
