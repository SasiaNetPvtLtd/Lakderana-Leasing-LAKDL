...
public class LAKDL_MK_MAS_Performing_Loan_Setup extends javax.servlet.http.HttpServlet { 
  Connection conn;
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		//	out.println("alert('Description Can not Be Blank');"); 
			...
			out.println("    m_help_message = \"m_help_msg_LAKDL_MK_MAS_Performing_Loan_Setup\";"); 
	  	...
	  	out.println("		}"); 
			...
			out.println("    m_criteria = document.Form1.TXT_FIN_NO.value+\"@\"+document.Form1.TXT_CLIENT_CODE.value+\"@\";");  
	  	...
	  	out.println("		}"); 
   		out.println("	}"); 
			...
			// added by udara 18-02-2014
			out.println("function check_Date(objDD,objMM,objYY,objHid) {");
			out.println("if(objDD.value!=\"\" && objMM.value!=\"\" && objYY.value!=\"\" )");
			out.println("if(checkMonthLength(objDD,objMM,objYY))");
			out.println("     document.Form1.hid_date.value=objDD.value+'-'+objMM.value+'-'+objYY.value;");	
			out.println("     objHid.value = document.Form1.hid_date.value; ");
			//out.println("     alert(objHid.value); ");
			out.println("}");
			// end by udara 18-02-2014
			...
			out.println("<input type=hidden name='hid_date' value=\"\">"); // added by udara 18-02-2014
			...
			String m_non_perform_sql = " SELECT DISTINCT B.APPLICATION_NO,B.FINANCE_NO,B.CLIENT_CODE "+
										   " ,TO_CHAR(SYSDATE,'DD')    "+ // added by udara 18-02-2014
										   " ,TO_CHAR(SYSDATE,'MM')    "+ // added by udara 18-02-2014
										   " ,TO_CHAR(SYSDATE,'YYYY')    "+ // added by udara 18-02-2014
										   " ,TO_CHAR(SYSDATE,'DD-MM-YYYY')    "+ // added by udara 18-02-2014 7
										   " ,'-' "+ // added by udara 11-03-2014
					                       " FROM "+m_schema_name+".AF_CO_PRO_APPLICATION_DETAILS B "+
					                       " WHERE B.APPLICATION_STATUS IN ('ACTIVATED','TERMI','TERMINATED','NORM_TERMI','LEGAL','REPOSSESS') "+
					                       " AND NVL("+m_schema_name+".AF_CO_GET_LEGAL_AGE(B.FINANCE_NO,TO_CHAR(SYSDATE,'DD-MM-YYYY')),0) + NVL("+m_schema_name+".AF_CO_GET_MONTHS_DIFF_LEGAL(B.FINANCE_NO,TO_CHAR(SYSDATE,'DD-MM-YYYY')),0)>=6 "+
																 ...
																 " ,TO_CHAR(NVL(VALUE_DATE,SYSDATE),'DD')    "+ //  added by udara 18-02-2014
																 " ,TO_CHAR(NVL(VALUE_DATE,SYSDATE),'MM')    "+ //  added by udara 18-02-2014
																 " ,TO_CHAR(NVL(VALUE_DATE,SYSDATE),'YYYY')    "+ //  added by udara 18-02-2014
																 " ,TO_CHAR(NVL(VALUE_DATE,SYSDATE),'DD-MM-YYYY')    "+ //  added by udara 18-02-2014
																 " , NVL(REMARKS,'-') "+ // added by udara 11-03-2014
																 " FROM "+m_schema_name+".AF_CO_PERFORMING_CONTACTS "+
			...
			String m_perform_sql   = " SELECT DISTINCT B.APPLICATION_NO,B.FINANCE_NO,B.CLIENT_CODE "+
									   " ,TO_CHAR(SYSDATE,'DD')    "+ // added by udara 18-02-2014
									   " ,TO_CHAR(SYSDATE,'MM')    "+ // added by udara 18-02-2014
									   " ,TO_CHAR(SYSDATE,'YYYY')    "+ // added by udara 18-02-2014 6
									   " ,TO_CHAR(SYSDATE,'DD-MM-YYYY')    "+ // added by udara 18-02-2014 7
									   " ,'-' "+ // added by udara 11-03-2014
				                       " FROM "+m_schema_name+".AF_CO_PRO_APPLICATION_DETAILS B "+
				                       " WHERE B.APPLICATION_STATUS IN ('ACTIVATED','TERMI','TERMINATED','NORM_TERMI','LEGAL','REPOSSESS') "+
			...
			int k=0;
			  ...
			  out.println("<table width='60%' border='0' class='table' >");
				...
				out.println("<td width='10%' align='center'><b>Value Date</b></td>");
				out.println("<td width='25%' align='left'><b>Remarks</b></td>"); // added by udara 11-03-2014
				...
				out.println("<td width='20%' align='left'>"+rs1.getString(2)+"<input type='hidden' name=\"TXT_HID_FIN_"+j+"\" value="+rs1.getString(2)+"></td>");//1
				out.println("<td width='20%' align='left'>"+rs1.getString(1)+"<input type='hidden' name=\"TXT_HID_APP_"+j+"\" value="+rs1.getString(1)+"><input type='hidden' name=\"TXT_HID_CLIENT_"+j+"\" value="+rs1.getString(3)+"></td>");//2
				
				out.println("<td width='20%' > "); 
				out.println("    <input name=\"VAL_DD_"+j+"\" type=\"text\" maxlength=\"2\" class=\"txt_input5\" size=\"2\" onchange=check_Date(document.Form1.VAL_DD_"+j+",document.Form1.VAL_MM_"+j+",document.Form1.VAL_YY_"+j+",document.Form1.TXT_HID_VALUE_DATE_"+j+") value=\""+rs1.getString(4)+"\" > ");
				out.println("    <input name=\"VAL_MM_"+j+"\" type=\"text\" maxlength=\"2\" class=\"txt_input5\" size=\"2\" onchange=check_Date(document.Form1.VAL_DD_"+j+",document.Form1.VAL_MM_"+j+",document.Form1.VAL_YY_"+j+",document.Form1.TXT_HID_VALUE_DATE_"+j+") value=\""+rs1.getString(5)+"\" > ");
				out.println("    <input name=\"VAL_YY_"+j+"\" type=\"text\" maxlength=\"4\" class=\"txt_input5\" size=\"4\" onchange=check_Date(document.Form1.VAL_DD_"+j+",document.Form1.VAL_MM_"+j+",document.Form1.VAL_YY_"+j+",document.Form1.TXT_HID_VALUE_DATE_"+j+") value=\""+rs1.getString(6)+"\" > ");
				out.println("    <input type='hidden' name=\"TXT_HID_VALUE_DATE_"+j+"\" value="+rs1.getString(7)+"> ");
				out.println("</td>");
				
				out.println("<td width='25%' align='left'><input type='text' name=\"TXT_REMARKS_"+j+"\" value=\""+rs1.getString(8)+"\" ></td>");// added by udara 11-03-2014
				
				out.println("<td width='15%' align='center'><input type='checkbox' name=\"TXT_PERF_"+j+"\" value=\"off\" onclick=change_perform_status("+j+")></b></td>");//3
				...
				out.println("<tr height=25>");
				out.println("<td width='20%' align='left'>"+rs2.getString(2)+"<input type='hidden' name=\"TXT_HID_NFIN_"+k+"\" value="+rs2.getString(2)+"></td>");//1
				out.println("<td width='20%' align='left'>"+rs2.getString(1)+"<input type='hidden' name=\"TXT_HID_NAPP_"+k+"\" value="+rs2.getString(1)+"><input type='hidden' name=\"TXT_HID_NCLIENT_"+k+"\" value="+rs2.getString(3)+"></td>");//2
				
				out.println("<td width='20%' > ");
				out.println("    <input name=\"VAL_DD_"+j+"\" type=\"text\" maxlength=\"2\" class=\"txt_input5\" size=\"2\" onchange=check_Date(document.Form1.VAL_DD_"+j+",document.Form1.VAL_MM_"+j+",document.Form1.VAL_YY_"+j+",document.Form1.TXT_HID_VALUE_DATE_"+j+") value=\""+rs2.getString(4)+"\" > ");
				out.println("    <input name=\"VAL_MM_"+j+"\" type=\"text\" maxlength=\"2\" class=\"txt_input5\" size=\"2\" onchange=check_Date(document.Form1.VAL_DD_"+j+",document.Form1.VAL_MM_"+j+",document.Form1.VAL_YY_"+j+",document.Form1.TXT_HID_VALUE_DATE_"+j+") value=\""+rs2.getString(5)+"\" > ");
				out.println("    <input name=\"VAL_YY_"+j+"\" type=\"text\" maxlength=\"4\" class=\"txt_input5\" size=\"4\" onchange=check_Date(document.Form1.VAL_DD_"+j+",document.Form1.VAL_MM_"+j+",document.Form1.VAL_YY_"+j+",document.Form1.TXT_HID_VALUE_DATE_"+j+") value=\""+rs2.getString(6)+"\" > ");
				out.println("    <input type='hidden' name=\"TXT_HID_VALUE_DATE_"+j+"\" value="+rs2.getString(7)+"> ");
				out.println("</td>");
				
				out.println("<td width='25%' align='left'><input type='text' name=\"TXT_REMARKS_"+j+"\" value=\""+rs2.getString(8)+"\" ></td>");// added by udara 11-03-2014
				
				out.println("<td width='15%' align='center'><input type='checkbox' name=\"TXT_NPERF_"+k+"\" value=\"off\" onclick=change_nperform_status("+k+") ></td>");//3
