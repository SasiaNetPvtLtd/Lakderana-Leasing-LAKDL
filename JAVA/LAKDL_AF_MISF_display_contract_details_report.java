...
public class LAKDL_AF_MISF_display_contract_details_report extends javax.servlet.http.HttpServlet { 
...
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!	
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Credit Process -Contract Details Report </TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MISF_display_contract_details_report?chksql=main_page';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("help_box.innerHTML=\"Credit Process -  Contract Details Report - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\"Credit Process -  Contract Details Report - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
		  ...
		  out.println("function view() {");
			...
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Contract_Report?chksql=main_page&print=TRUE&finance_no=\"+document.Form1.TXT_FINANCE_NO.value+\"\";");
...
//-----------------------------------------------------------------------------------------------------------------------
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Credit Process - Contract Details Report</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
