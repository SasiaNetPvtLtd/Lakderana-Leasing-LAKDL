...
public class LAKDL_FA_OP_first_invoice_reminder extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Operation Process - Invoice Reminders - 1st Reminder  </TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"FA_OP_PRO_rpt_cheque_return_reminder?chksql=LOAD_FIRST_INVOICE_REMINDER\";");
  		...
  		out.println("		}");
   		...
   		out.println("}"); 
			...
			out.println("			}");
			out.println("			if(validate_data()){"); 
			out.println("				document.Form1.action='"+m_class_url+"/"+m_fschema_name+"FA_OP_save_first_invoice_reminder';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"FA_OP_first_invoice_reminder';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("	help_box.innerHTML=\"  Operation Process - Invoice Reminders - 1st Reminder  - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\" Operation Process - Invoice Reminders - 1st Reminder  \";"); 
			out.println("}"); 
	  	...
	  	out.println("					}"); 
			...
			out.println("	m_url = \""+m_class_url+"/"+m_fschema_name+"FA_OP_Invoice_First_Reminder_Letter?chksql=main_page&client_no=\"+m_client_code+\"&debtor_code=\"+m_debtor_code+\"&print=TRUE&facility_no=\"+m_facility_no+\"&batch_no=\"+m_batch_no;"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Operation Process - Invoice Reminders - 1st Reminder </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
