...
public class LAKDL_FA_MISF_active_debtor_report extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Factor Active Debtor List Report </TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("function show_active_debtor_report() {");
			out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"FA_MISF_reports?chksql=LOAD_ACTIVE_DEBTOR_REPORT&client_code=\"+document.Form1.TXT_CLIENT_CODE.value+\"&facility_no=\"+document.Form1.TXT_FACILITY_NO.value;");
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"FA_MISF_active_debtor_report';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("	help_box.innerHTML=\" Factor Active Debtor List Report - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\" Factor Active Debtor List Report \";"); 
			out.println("}"); 
	  	...
	  	out.println("					}"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Factor Active Debtor List Report </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<td width='*%' align='left' ><input class='but_input' type='button' name='BUT_VIEW_MAIN' value=\"View\" onClick=\"show_active_debtor_report()\"></td>");
			out.println("</tr>"); 
			out.println("</table>");  
			out.println("</form>"); 
