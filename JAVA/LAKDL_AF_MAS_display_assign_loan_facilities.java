...
public class LAKDL_AF_MAS_display_assign_loan_facilities extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>System Administration - Assign Loan Facilities</TITLE>"); 
			out.println("</HEAD>"); 
	    ...
	    out.println("'<TD><B>Finance No ID</B></TD><TD><B>Client Name</B></TD>' +"); //modified nuwan de silva 20-07-07
	    out.println("'</TR>';");
      ...
      out.println("function display_data(data_vec){");
		  ...
		  out.println("m_but_del='<td><input class=\"but_input\" type=\"button\" name=BUT_TXT_USER_ID_DEL'+j+' value=\"Delete\" onClick=\"del_row('+j+')\"></td>';");
			...
			out.println("m_hid_input='<INPUT TYPE=\"Hidden\" NAME=hid_TXT_FINANCE_NO'+j+'	VALUE='+data_vec[i]+'>'+");
			out.println("'<INPUT TYPE=\"Hidden\" NAME=hid_TXT_NAME'+j+'	VALUE='+data_vec[i+1]+'>';");
	 
		  out.println("m_writedata='<TR>'+m_user_id+m_name+m_but_del+'</TR>'+m_hid_input;");
      ...
      out.println("			}");
			...
			*/
			...
			out.println("}");
			out.println("  if(document.Form1.hid_chk_status.value==\"M2\"){"); 
			out.println("  m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations2?chksql=m_prime_chk_display_loan_facilities&data_val=\"+obj.value;");
			out.println("  }");
			out.println("else");
			...
			out.println("}"); 
			out.println("if(document.Form1.TXT_FINANCE_NO.value==\"\" && m_table.innerHTML==\"\"){  "); 
			out.println("DIV_TXT_FINANCE_NO.style.color='red';");
			out.println("return false;"); 
			out.println("}"); 
			out.println("if(document.Form1.TXT_FINANCE_NO.value==\"\" && m_table.innerHTML==\"\" && document.Form1.SCREEN_NAME.value==\"NEW\"){  "); 
		  ...
		  out.println("var b_status=1;"); // Variable To Hold The Status
			...
			out.println("alert('Select Finance No; Use Help');");
		  ...
		  out.println("m_name='<TD WIDTH=\"30%\">'+array_user[1]+'</TD>';");
			...
			out.println("m_hid_input='<INPUT TYPE=\"Hidden\" NAME=hid_TXT_FINANCE_NO'+lineno+'	VALUE='+array_user[0]+'>'+"); 
      ...
      out.println("lineno=lineno+1;");
			...
			out.println("if(confirm('Are you sure you want to delete the Agreement ?')) {");  
			out.println("array_team[lineno]='<INPUT TYPE=\"Hidden\" NAME=hid_TXT_FINANCE_NO'+lineno+' VALUE=\"N\">';");
			out.println("arr_size=arr_size-1;");
	    out.println("m_table.innerHTML='<table align=\"center\" width=\"100%\" class=\"table\">'+");
	    out.println("array_team.join(\" \")+'</table>';");
			out.println("}"); 
			...
			out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_MAS_save_assign_loan_facilities';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MAS_display_assign_loan_facilities';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("help_box.innerHTML=\" System Administration - Assign Loan Facilities - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" System Administration - Assign Loan Facilities - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
      ...
      out.println("}"); 
	  	...
	  	out.println("		}"); 
			...
			out.println("    m_sql = \"finance_help_loan_facility\";"); 
			...
			out.println("array_user[0]=oBj.valout[2];"); // finance n0
			out.println("array_user[1]=oBj.valout[4];"); // full Name
			out.println("}"); 

			out.println("function help_update() {"); 
			out.println("    document.Form1.hid_help_type.value=\"99\";"); 
			out.println("    if(document.Form1.SCREEN_NAME.value==\"NEW\" ){ ");
			out.println("    m_sql = \"m_help_loan_facilities_assign_sql\";"); 
			out.println("    m_criteria = document.Form1.TXT_REF_NO.value+\"@\"+\"Y@\";"); 
			out.println("}"); 
			out.println("    else{");
			out.println("    m_sql = \"m_help_loan_facilities_assign_edit_sql\";"); 			
			out.println("    m_criteria = document.Form1.TXT_REF_NO.value+\"@\"+\"Y@\";"); 
			out.println("    } ");
			...
			out.println("    if(document.Form1.SCREEN_NAME.value!=\"NEW\" ){ ");
			out.println("    assignState('M2');"); 
			out.println("    makeRequest(document.Form1.TXT_REF_NO)");
			out.println("}");
			...
			out.println("<INPUT TYPE='Hidden' NAME='Hid_scr_name' VALUE=\"AF_AD_LOAN_FACILITIES_ASSIGN\">");
		...
		//	out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Reactivate\");' onClick='load_screen_status(\"RACT\")' value=\"Re-activate\"></td>"); 
		 //out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"View All\");'  onclick='View_all()' value=\"View All\"></td>");
			...
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_REF_NO' maxlength='20' STYLE=\"{WIDTH:150PX;}\" size='20' >"); 
			out.println("<input class='but_input' type='button' name='BUT_HELP_MAIN' value=\"Help\" onClick=\"help_update()\" ></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 

			out.println("<tr >"); 
			out.println("<td width='20%' ><DIV id='DIV_TXT_LOAN_NO'  class=div_input>Loan No\\Reference No *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_LOAN_NO' maxlength='10' size='10' STYLE=\"{WIDTH:150PX;}\" ></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			
			out.println("<tr >"); 
			out.println("<td width='20%' ><DIV id='DIV_TXT_NAME'  class=div_input>Name</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_NAME' maxlength='10' STYLE=\"{WIDTH:250PX;}\" size='10'></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			...
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_FINANCE_NO' maxlength='10' size='10' onblur=\"help_button_3()\">"); 
			out.println("<input class='but_input' type='button' name='BUT_TXT_FINANCE_NO' value=\"Help\" onClick=\"help_button_3()\">"); 
			out.println("<input class='but_input' type='button' name='BUT_ADD' value=\"Add\" onClick=\"add_row(document.Form1.TXT_FINANCE_NO)\"></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("</table>"); 
