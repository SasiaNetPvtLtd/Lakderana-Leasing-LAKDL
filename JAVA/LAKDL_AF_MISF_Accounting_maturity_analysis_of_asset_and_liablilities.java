...
public class LAKDL_AF_MISF_Accounting_maturity_analysis_of_asset_and_liablilities extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			if(m_chksql.equals("run_report")){ 
				...
				try{
				callstmt1 = conn.prepareCall("BEGIN "+m_schema_name+".AF_SAVE_CB_ASSET_LIABILITY_RPT(:1,:2);END;");
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Accounting - Statement Of Maturity Of Asset And Liabilities</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("var m_sav_msg='';");
		  	...
		  	out.println("var b_flag=0;");
				...
				out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Accounting_maturity_analysis_of_asset_and_liablilities?chksql=run_report&date=\"+m_to_date;"); 
				...
				//out.println("		m_from_date=document.Form1.TXT_FROM_DATE_DD.value+'-'+document.Form1.TXT_FROM_DATE_MM.value+'-'+document.Form1.TXT_FROM_DATE_YY.value;");
				out.println("		m_to_date=document.Form1.TXT_TO_DATE_DD.value+'-'+document.Form1.TXT_TO_DATE_MM.value+'-'+document.Form1.TXT_TO_DATE_YY.value;");
				out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Accounting_maturity_analysis_of_asset_and_liablilities?chksql=print_report_new&to_date=\"+m_to_date;");	
      ...
      out.println("			else {");
			...
			out.println("	help_box.innerHTML=\" Accounting - Statement Of Maturity Of Asset And Liabilities - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\" Accounting - Statement Of Maturity Of Asset And Liabilities \";"); 
			out.println("}"); 
	  	...
	  	out.println("					}"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Accounting - Statement Of Maturity Of Asset And Liabilities </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
      ...
      rs1 = stmt1.executeQuery(Comp_Name);
			...
			boolean more1 = rs1.next();			
			  ...
			  out.println("<BODY  class='body & txt-body' leftmargin='0' topmargin='0' marginwidth='0' > ");
				...
				out.println("<tr>");
				out.println("<td align='center' width='*%' ><b>FINANCE LEASING ACT NO 56 OF 2000");
				out.println("<BR><b>STATEMENT OF MATURITY ANALYSIS OF ASSET AND LIABILITIES - SNBFI/ FLA/ 2007/03</td>");
				out.println("</tr>");
				out.println("</table>");
				out.println("<br>");
				out.println("<br>");
				...
				out.println("<td align='left' width='20%'  >Format No</td>");
				out.println("<td align='center' width='5%' >:</td>");
				out.println("<td align='left' width='*%' >SNBFI/FLA/2007/03</b></td>");
				out.println("</tr>");
				out.println("<tr >");
				out.println("<td align='left' width='20%'  >Name of RFLE</td>");
				out.println("<td align='center' width='5%' >:</td>");
			  ...
			  out.println("<br>");
				...
				out.println("<table width=\"100%\"  border=\"1\" cellspacing=\"0\" cellpadding=\"0\" bordercolor=#eeeeee>"); //'black'
				out.println("<tr>");
				out.println("<td rowspan=\"2\" width=\"25%\" align='center' ><b>Asset / Liablities </td>");
				out.println("<td colspan=\"6\" bgcolor=#a5b6c6 align='center' ><B>Maturity Period</td>");
				out.println("</tr>");
				
				out.println("<tr>");
				out.println("<td bgcolor=#a5b6c6  width=\"10%\">Less than 3 Months</td>");
				out.println("<td bgcolor=#a5b6c6  width=\"10%\">3-12 months</td>");
				out.println("<td bgcolor=#a5b6c6  width=\"10%\">12-36 months </td>");
				out.println("<td bgcolor=#a5b6c6  width=\"10%\">36-60 months</td>");
				out.println("<td bgcolor=#a5b6c6  width=\"10%\">More than 60 months</td>");
				out.println("<td bgcolor=#a5b6c6  width=\"10%\">Total</td>");
				out.println("</tr>");
				
				out.println("<tr>");
				out.println("<td  ><b>a.&nbsp;Interest earning asset</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				...
				out.println("</tr>");
				out.println("<tr>");
				out.println("<td  >Investment in Govt securities</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				...
				out.println("</tr>");
				out.println("<tr>");
				out.println("<td  ><p>Fixed deposits and savings deposits with <br> banks & finance companies</p></td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				...
				out.println("<tr>");
				out.println("<td  ><b>b.&nbsp;Loan & Advance net of provisions</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				...
				out.println("<td  >&nbsp;</td>");
				out.println("</tr>");
				String m_transaction_type="",m_transaction_desc="";
				int m_count=0,m_tot_count=0;
								
				String Sql_arrears=" SELECT floor(nvl(a.age,0)), "+ //1
				" nvl(a.total_amount,0) - ( nvl(a.settled_amount,0) + nvl(a.adjusted_amount,0)) , "+ //2
				//"  - (nvl(a.nibsm,0) + nvl(a.ami,0) + nvl(a.interest_suspense,0))  , "+
				" nvl(a.transaction_type,'-'), "+ //3
				" nvl(interest_suspense,0)  ,"+ //4
				" "+m_schema_name+".AF_CO_GET_TRANSACTION_DESC(a.transaction_type) , "+ //5
				" (nvl(a.cap_arr_portion,0) + nvl(a.future_receivable,0)) "+ //6
				" FROM "+m_schema_name+".AF_RE_TBD_CB_ASSET_LIABILITI a "+
				" WHERE  ENT_USER='"+m_username+"' "+
				" ORDER BY  a.transaction_type ";
				
				rs1 = stmt.executeQuery(Sql_arrears);
			  boolean more = rs1.next();
							
				int m_age_1_count=0,m_age_3_count=0,m_age_12_count=0,m_age_36_count=0,m_age_60_count=0;
				double m_age_1_m_amount=0,m_age_3_m_amount=0,m_age_12_m_amount=0,m_age_36_m_amount=0,m_age_60_m_amount=0;
				double m_age_1_m_amount_suspense=0,m_age_3_m_amount_suspense=0,m_age_12_m_amount_suspense=0,m_age_36_m_amount_suspense=0,m_age_60_m_amount_suspense=0;
				double m_amount=0,m_amount_suspense=0;
				double m_age=0;
				double tot_m_age_1_m_amount=0,tot_m_age_3_m_amount=0,tot_m_age_12_m_amount=0,tot_m_age_36_m_amount=0,tot_m_age_60_m_amount=0;

				while(more){
				m_transaction_type=rs1.getString(3);
				m_transaction_desc=rs1.getString(5);
				m_age_1_count=0;
				m_age_1_m_amount=0;
				m_age_3_count=0;
				m_age_3_m_amount=0;
				...
				while(m_transaction_type.equals(rs1.getString(3))) {
				m_age=rs1.getDouble(1);
				m_amount=rs1.getDouble(6);
				m_amount_suspense=rs1.getDouble(4);
				
				/*if ( m_age <= 2 ){
				m_age_1_count+=1;
				m_age_1_m_amount+=m_amount;
				m_age_1_m_amount_suspense+=m_amount_suspense;
				}
				else if ( m_age > 2  &&  m_age <= 11 ){
				m_age_3_count+=1;
				m_age_3_m_amount+=m_amount;
				m_age_3_m_amount_suspense+=m_amount_suspense;
				}
				else if ( m_age > 11  &&  m_age <= 35 ){
				m_age_12_count+=1;
				m_age_12_m_amount+=m_amount;
				m_age_12_m_amount_suspense+=m_amount_suspense;
				}
				else if ( m_age > 35  &&  m_age <= 59 ){
				m_age_36_count+=1;
				m_age_36_m_amount+=m_amount;
				m_age_36_m_amount_suspense+=m_amount_suspense;
				}
				else if ( m_age > 59  ){
				m_age_60_count+=1;
				m_age_60_m_amount+=m_amount;
				m_age_60_m_amount_suspense+=m_amount_suspense;
				}
				*/
				...
				else if ( m_age >= 3  &&  m_age < 12 ){
				m_age_3_count+=1;
				m_age_3_m_amount+=m_amount;
				m_age_3_m_amount_suspense+=m_amount_suspense;
				}
				else if ( m_age >= 12  &&  m_age < 36 ){
				m_age_12_count+=1;
				m_age_12_m_amount+=m_amount;
				m_age_12_m_amount_suspense+=m_amount_suspense;
				}
				else if ( m_age >= 36  &&  m_age < 60 ){
				m_age_36_count+=1;
				m_age_36_m_amount+=m_amount;
				m_age_36_m_amount_suspense+=m_amount_suspense;
				}
				...
				tot_m_age_1_m_amount+=m_age_1_m_amount;
				tot_m_age_3_m_amount+=m_age_3_m_amount;
				tot_m_age_12_m_amount+=m_age_12_m_amount;
				tot_m_age_36_m_amount+=m_age_36_m_amount;
				tot_m_age_60_m_amount+=m_age_60_m_amount;
				
				out.println("<tr>");
				out.println("<td  >"+m_transaction_desc+"</td>");
				out.println("<td  align='right' >"+nf.format(m_age_1_m_amount)+"</td>");
				out.println("<td  align='right' >"+nf.format(m_age_3_m_amount)+"</td>");
				out.println("<td  align='right' >"+nf.format(m_age_12_m_amount)+"</td>");
				out.println("<td  align='right' >"+nf.format(m_age_36_m_amount)+"</td>");
				out.println("<td  align='right' >"+nf.format(m_age_60_m_amount)+"</td>");
				out.println("<td  align='right' >"+nf.format(m_age_1_m_amount+m_age_3_m_amount+m_age_12_m_amount+m_age_36_m_amount+m_age_60_m_amount)+"</td>");
				out.println("</tr>");
				...
				out.println("<tr>");
				out.println("<td  ><b>c.&nbsp;Non-interest earning assets</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				...
				out.println("</tr>");
				out.println("<tr>");
				out.println("<td  >Cash & bank balances</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				...
				//Investment in
				out.println("<tr>");
				out.println("<td  ><b>d.&nbsp;Investment in</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				...
				out.println("</tr>");
				out.println("<tr>");
				out.println("<td  >Subsidary companies</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				...
				out.println("</tr>");
				out.println("<tr>");
				out.println("<td  >Associate companies</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				...
				out.println("</tr>");
				out.println("<tr>");
				out.println("<td  >  Dealing securities</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				...
				out.println("</tr>");
				out.println("<tr>");
				out.println("<td  > Debenture/Commercial papers</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				...
				out.println("</tr>");
				out.println("<tr>");
				out.println("<td  >Stocks (vehicles/real estates/machineries etc)</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				...
				//Fixed Assets
				out.println("<tr>");
				out.println("<td  ><b>e.&nbsp;Fixed Assets</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				...
				//Other Assets
				out.println("<tr>");
				out.println("<td  ><b>f.&nbsp;Other Assets</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
			  ...
			  more = rs1.next();
				...
				/*out.println("<tr>");
				out.println("<td  >Lease Income Suspended</td>");
				out.println("<td  align='right' >("+nf.format(m_age_1_m_amount_suspense)+")</td>");
				out.println("<td  align='right' >("+nf.format(m_age_3_m_amount_suspense)+")</td>");
				out.println("<td  align='right' >("+nf.format(m_age_12_m_amount_suspense)+")</td>");
				out.println("<td  align='right' >("+nf.format(m_age_36_m_amount_suspense)+")</td>");
				out.println("<td  align='right' >("+nf.format(m_age_60_m_amount_suspense)+")</td>");
				out.println("<td  align='right' >("+nf.format(m_age_1_m_amount_suspense+m_age_3_m_amount_suspense+m_age_12_m_amount_suspense+m_age_36_m_amount_suspense+m_age_60_m_amount_suspense)+")</td>");
				out.println("</tr>");
				*/
				out.println("<tr>");
				out.println("<td  >Lease Income Suspended</td>");
				...
				out.println("<tr>");
				out.println("<td  >Imported Assets</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				...
				out.println("<tr>");
				out.println("<td  >Debtor - Sale of lorries</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				...
				out.println("</tr>");
				out.println("<tr>");
				out.println("<td  >Advance Pmts / Receivable</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				...
				out.println("</tr>");
				out.println("<tr>");
				out.println("<td  >VAT receivable</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				...
				out.println("</tr>");
				out.println("<tr>");
				out.println("<td  >Group Co C/A</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				...
				//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				out.println("<tr>");
				out.println("<td  ><b>Total Assets</td>");
				out.println("<td  align='right' ><b>"+nf.format(tot_m_age_1_m_amount)+"</td>");
				...
				out.println("<td  align='right' ><b>"+nf.format(tot_m_age_36_m_amount)+"</td>");
				out.println("<td  align='right' ><b>"+nf.format(tot_m_age_60_m_amount)+"</td>");
				out.println("<td  align='right' ><b>"+nf.format(tot_m_age_1_m_amount+tot_m_age_3_m_amount+tot_m_age_12_m_amount+tot_m_age_36_m_amount+tot_m_age_60_m_amount)+"</td>");
				out.println("</tr>");
				////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				...
				out.println("<tr>");
				out.println("<td  ><b>a.&nbsp;Interest bearing liabilities</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				...
				out.println("<tr>");
				out.println("<td  >Bank overdrafts</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				...
				out.println("<tr>");
				out.println("<td  >Redeemable preference shares</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				...
				out.println("</tr>");
				out.println("<tr>");
				out.println("<td  >Other borrowings</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				...
				//
				out.println("<tr>");
				out.println("<td  ><b>b.&nbsp;Non interest bearing liabilities</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				...
				out.println("<tr>");
				out.println("<td  >Amount due to subsidiaries / associates</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				...
				out.println("<tr>");
				out.println("<td  >Other Liabilities</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				...
				out.println("<tr>");
				out.println("<td  >Lease Creditor</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				...
				out.println("<tr>");
				out.println("<td  >Accurued Expenses</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				...
				out.println("<tr>");
				out.println("<td  >Cost of Equipment Payable</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				...
				out.println("<tr>");
				out.println("<td  >Security Margins</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				...
				out.println("<tr>");
				out.println("<td  >Provision for Gratuity</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				...
				out.println("<tr>");
				out.println("<td  ><b>c.Shareholders funds</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				...
				out.println("<tr>");
				out.println("<td  ><b>Total Liabilities</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
				out.println("<td  >&nbsp;</td>");
