...
public class LAKDL_AF_RE_Recovery_Letter_HP3_notice_of_termi extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		" WHERE APPLICATION_NO=UPPER('"+m_application_no+"') AND CLIENT_CODE=UPPER('"+m_client_code+"') AND DOCUMENT_CODE=UPPER('"+m_document_code+"') ");
			...
			m_status=req.getParameter("status");
				...
				out.println("<title>Notice of termination -HP </title></head>");
				...
				while(rs.next()){	//Edited by Minal on 13-07-2015 for #17336
					...
					out.println("<blockquote><p style='text-align:left' class='txt-body'>");	
					out.println("<table border='0' width='90%' class='table'>"); 		
					out.println("<tr><td width='*%' class='txt-body' ><font size=2.7 ><B>NOTICE OF TERMINATION OF THE HIRE PURCHASE AGREEMENT UNDER SECTION 18 (1) OF THE CONSUMER CREDIT ACT NO: 29 OF 1982 (AS AMENDED) FOR NON PAYMENTS OF HIRE RENTALS.</B></font></td></tr>");
					out.println("</table>");
					out.println("</p></blockquote>");
					...
					data="We hereby give you notice that despite our repeated requests and reminders, you have failed to pay the overdue Hire Purchase rental/s and other charges due on the above agreement which now amounts to a sum of Rs."+m_due_amount+" as at date. ";
					...
					data=     "In the circumstances, we hereby notify you that, unless the total dues are settled in full within 14 days from the date of receipt of this notice, we will be compelled to take steps to terminate the Hire created by the above Agreement, recover possession of the goods and take further action in accordance with the provisions of the said agreement.";
					...
					data= "We therefore advise you to kindly make arrangements to settle the said dues without any further delay.";
					...
					out.println("<td width='*%' class='txt-body' style='text-align:justify' >2. "+m_guranter2+" </td></tr>");
				}if(m_guranter3!=""){
					out.println("<td width='*%' class='txt-body' style='text-align:justify' >2). "+m_guranter3+" </td></tr>");
				}if(m_guranter4!=""){	
					out.println("<td width='*%' class='txt-body' style='text-align:justify' >2). "+m_guranter4+"</td></tr>");
				}*/
