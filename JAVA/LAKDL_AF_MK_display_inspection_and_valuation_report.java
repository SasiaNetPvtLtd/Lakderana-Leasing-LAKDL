//--
//SCREEN NAME:APPLICATION PROCESS -INSPECTION AND VALUATION_REPORT
...
public class LAKDL_AF_MK_display_inspection_and_valuation_report extends javax.servlet.http.HttpServlet { 
	...
	*/
	...
	public  void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		Connection conn = null;
		 String m_val_code = null;
		 ResultSet rs = null;
		 ResultSetMetaData rms = null; 
		Statement stmt = null;
		 String m_val_code1 = null;
		...
		try { 
			...
			if(req.getParameter("row_no")!=null){ //added by nuwan de silva 26-06-07
		  ...
		  out.println("var no=0;");
			...
			out.println("function remove_valuation_no_star() {");
			out.println("	DIV_TXT_VALUATION_NO.innerHTML = 'Valuation No';");
			out.println("}");
			...
			out.println("    document.Form1.TXT_ASSET_DESC.value=data_vec[30]+' '+data_vec[29]+' '+data_vec[31];"); //added by nuwan de silva on 17-12-2007
      ...
      out.println("    else {"); 
		...
		//	out.println("    document.Form1.TXT_CHASSIS_NO.value=data_vec[6];"); 
			...
			out.println("format_noobject_nodecimal1(document.Form1.TXT_METER_READING)"); 
			...
			//modofeid by nuwan de silva 02-07-07----------------------
			out.println("    if(data_vec[14]!= 'null' && data_vec[14]!= ' ' && data_vec[14]!= '-'){ "); 
			out.println("    document.Form1.TXT_COLOUR.value=data_vec[14];"); 
			out.println("    } "); 
      out.println("    else {"); 
			...
			out.println("    document.Form1.TXT_VALUER_NAME.value=data_vec[28];");	
      ...
      out.println("    document.Form1.TXT_YEAR_OF_MANUFACTURE.value='';");
			...
			out.println("document.Form1.TXT_ASSET_DESC.value=data_vec[8]+' '+data_vec[7]+' '+data_vec[9]"); //added by nuwan de silva on 17-12-2007
			...
			out.println("    document.Form1.TXT_MODEL_CODE.value=data_vec[2];");
			out.println("    document.Form1.TXT_SUB_MODEL_CODE.value=data_vec[3];"); 
			out.println("    document.Form1.TXT_ASSET_DESC.value=data_vec[3]+' '+data_vec[2]"); //added by nuwan de silva on 17-12-2007
			out.println("    document.Form1.TXT_REG_NO.value=data_vec[4];"); 
			out.println("    document.Form1.TXT_ENGINE_NO.value=data_vec[5];"); 
			out.println("    document.Form1.TXT_CHASSIS_NO.value=data_vec[6];"); 
			...
			out.println("    document.Form1.TXT_VALUER_NAME.value=data_vec[28];");
			out.println(" if(data_vec[10]=='-'){");
			out.println("data_vec[10]='';");
			out.println(" }");		
			out.println("    document.Form1.TXT_REG_DATE_DD.value=data_vec[10].substring(0,2);"); 
			out.println("    document.Form1.TXT_REG_DATE_MM.value=data_vec[10].substring(3,5);"); 
			out.println("    document.Form1.TXT_REG_DATE_YY.value=data_vec[10].substring(6,10);"); 
			...
			//modified by nuwan de silva 02-07-07-----------------------
			...
			out.println(" else if (data_vec.length >0 && document.Form1.hid_st.value=='M_CHASS' && document.Form1.TXT_CHASSIS_NO.value!=\"\" && data_vec[0]!='-' ){");
			out.println(" val_chassis_no();");
			out.println("}");
			out.println(" else if (data_vec.length >0 && document.Form1.hid_st.value=='M_ENGINE' && document.Form1.TXT_ENGINE_NO.value!=\"\" && data_vec[0]!='-' ){");
			out.println(" val_engine_no();");
			out.println("}");
			//End of Addition by Mahela ------------------------------------------------------------------------------
			
			//added by Prabash on 24-04-2012----------**
			out.println(" else if (data_vec.length >0 && document.Form1.hid_st.value=='M_LICDATE' && document.Form1.TXT_REG_DATE_YY.value!=\"\" && data_vec[0]!='-' ){");
			
			out.println(" Rev_Lic_date();");
			out.println("}");
			//----------------------------------------**
			
			
			//out.println(" else if (data_vec.length ==0 && document.Form1.hid_st.value=='M7' && document.Form1.TXT_CHASSIS_NO.value!=\"\" ){");
			out.println(" else if (data_vec.length ==0 && document.Form1.hid_st.value=='M7' && document.Form1.TXT_CHASSIS_NO.value!=\"\" && data_vec[1] != '"+m_val+"' ){"); // added by udara 24-10-2014
			...
			out.println(" else if (data_vec.length ==0 && document.Form1.hid_st.value=='M8' && document.Form1.TXT_ENGINE_NO.value!=\"\" && data_vec[1] != '"+m_val+"' ){"); // added by udara 24-10-2014
			...
			//out.println(" else if (data_vec.length ==0 && document.Form1.hid_st.value=='M10' && document.Form1.TXT_REG_NO.value!=\"\"){");
			out.println(" else if (data_vec.length ==0 && document.Form1.hid_st.value=='M10' && document.Form1.TXT_REG_NO.value!=\"\" && data_vec[1] != '"+m_val+"' ){"); // added by udara 24-10-2014
			...
			//added by Prabash on 24-04-2012-------------**
			out.println(" else if (data_vec.length ==0 && document.Form1.hid_st.value=='M9' && document.Form1.TXT_REG_DATE_YY.value!=\"\" ){");
			out.println("       alert('Invalid Registration Date.'); "); 
			...
			out.println("       document.Form1.TXT_REG_DATE_DD.focus();  "); 
			out.println("}");
			//-------------------------------------------**
			...
			out.println(" else if (data_vec.length >0 && document.Form1.hid_st.value=='CHECK_VAL' && document.Form1.TXT_VALUE.value!=\"\"){");
			out.println(" alert('Value is less than to financed amount');      "); 
			out.println("}");
			...
			out.println("window.opener.document.Form1.elements[\"CHK_CVV_\"+m_row_no].checked=true; ");
			out.println("window.opener.document.Form1.elements[\"CHK_CVV_\"+m_row_no].value='YES'; ");
			out.println("window.opener.check_change_E(m_row_no);");
			out.println("		}"); 
     ...
     //============================================================================================//
		...
		*/	
			...
			out.println("'<tr >'+");
			out.println("'<td width=\"15%\"  align=\"left\"><B>Product Code</B></td>'+");
			out.println("'<td width=\"30%\"  align=\"left\"><B>Product Description </B></td>'+"); 
		  ...
		  out.println("j=j+1;");	
			...
			out.println("if(parseInt(j)==0){");
			out.println("header()");
			out.println("}");
			out.println("change1.innerHTML+='<table align=\"center\" border=\"0\" width=\"100%\" class=\"table\">'+");
			out.println("'<tr>'+"); 
			out.println("'<td width=\"15%\" align=\"left\" ><input class=\"txt_input\" name=TXT_FILED_CODE_'+j+' value='+data_vec[i]+' maxlength=\"10\" size=\"10\" disabled></td>'+"); 
			out.println("'<td width=\"30%\" align=\"left\" ><input class=\"txt_input\"  name=TXT_FILED_DESC_'+j+' value=\"'+data_vec[i+1]+'\" maxlength=\"50\" style=\"width:200px\" value=\"\" size=\"20\" disabled></td>'+"); 
			out.println("'<td width=\"15%\" align=\"left\" ><input class=\"txt_input\" type=\"text\" name=TXT_STATUS_'+j+' value=\"\" maxlength=\"10\"  size=\"10\"></td>'+"); 
			out.println("'<td width=\"40%\" align=\"left\" ><input class=\"txt_input\" type=\"text\" name=TXT_REMARK_'+j+' value=\"\" maxlength=\"100\" style=\"width:250px\"  size=\"100\"></td>'+"); 
			out.println("'<td width=\"*%\"  align=\"left\"></td>'+"); 
			out.println("'</tr >'+");
			out.println("'</table >';");
			out.println("j=parseInt(j)+1;");
			out.println("i=parseInt(i)+2;");
			out.println("}"); 
			//out.println("}"); 
		//	out.println("document.Form1.hid_no.value=parseInt(j)-1");	
					out.println("document.Form1.hid_no.value=parseInt(j)");	
      ...
      out.println("}"); 
		...
		//	out.println("header()");
			...
			out.println("'</tr >'+");
			out.println("'</table >';");
			out.println("var st='TXT_STATUS_'+parseInt(j);");
			out.println("var rm='TXT_REMARK_'+parseInt(j);");
	    ...
	    out.println("}"); 
			...
			// end by udara 22-05-2014
			
			
			// added by udara 13-11-2014
			out.println("else if(document.Form1.TXT_NOTES.value==\"\"){  "); 
			out.println("DIV_TXT_NOTES.style.color='red';");
			out.println("return false;"); 
			out.println("}");
		...
		//	out.println("}"); 
			...
			out.println("     }");
			out.println("		 document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_MK_save_inspection_and_valuation_report?number='+parseInt(document.Form1.hid_no.value)+'&my_screen_name="+m_my_screen+"';");  
			...
			out.println("m_type='"+m_type+"' ");//-----Added By Sandun on 16-12-2008
			out.println("if(m_type=='PRV'){");
			out.println(" for (var i=0; i < document.Form1.elements.length; i++ ) {");
			...
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MK_sql_validations?chksql=m_prime_chk_LAKDL_AF_MK_display_inspection_and_valuation_report&m_type=\"+m_type+\"&data_val=\"+document.Form1.TXT_VALUATION_NO.value+\"&ac_status=\"+document.Form1.hid_act.value;");
			...
			out.println("help_box.innerHTML=\" Application Process -Inspection and Valuation Report - \"+m_val;"); 
			out.println("}	");
			out.println("if('"+ m_valuation+"'==\"\"){ ");
			...
			out.println("help_box.innerHTML=\" Application Process -Inspection and Valuation Report - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
		...
		/*	out.println("function Prev(Start,End,Hid_No){"); 
			...
			*/
			...
			out.println("    m_criteria = document.Form1.TXT_INVOICE_NO.value+\"@\"+document.Form1.TXT_APP_NO.value+\"@Y@\";"); //MODIFIED NUWAN DE SILVA
	  ...
	  // out.println(" document.Form1.TXT_SUB_MODEL_CODE.value=oBj.valout[4];"); 
		  ...
		  out.println(" document.Form1.TXT_MODEL_CODE.value=oBj.valout[29];"); 
	    out.println(" document.Form1.TXT_SUB_MODEL_CODE.value=oBj.valout[30];"); 
			//out.println("    document.Form1.TXT_ASSET_DESC.value=oBj.valout[30]+' '+oBj.valout[29]"); //added by nuwan de silva on 17-12-2007
		...
		//	out.println(" document.Form1.TXT_SUB_MODEL_DESC.value=oBj.valout[30];"); 
			...
			out.println("    m_sql = \"m_help_TXT_VALUATION_NO_sql_new\";"); 
			out.println("}");
			...
			out.println("    document.Form1.TXT_VALUER_NAME.value=oBj.valout[3];"); 
   		out.println("    document.Form1.hid_valuer_amount.value=oBj.valout[11];");
			...
			out.println("    document.Form1.TXT_ASSET_DESC.value=oBj.valout[32]+' '+oBj.valout[30]+' '+oBj.valout[31]; "); //added by nuwan de silva on 17-12-2007
      ...
      out.println("    else {"); 
	   	...
	   	out.println("format_noobject_nodecimal1(document.Form1.TXT_METER_READING)"); 
			...
			out.println("    document.Form1.TXT_VALUER_NAME.value=oBj.valout[29];");//xxxxxxxxx
      ...
      out.println("    document.Form1.TXT_YEAR_OF_MANUFACTURE.value='';");
		...
		//	out.println("get_engine_chassis_no();");
			...
			//modified by nuwan de silva 02-07-07
			out.println("    if(oBj.valout[8]=='null' ||  oBj.valout[8]=='' || oBj.valout[8]=='-' ){");
			out.println("    document.Form1.TXT_COLOUR.value='';");
			out.println("    }");
			out.println("    else {");
			...
			out.println("    document.Form1.TXT_ASSET_DESC.value=oBj.valout[9]+' '+oBj.valout[4]"); //added by nuwan de silva on 17-12-2007
		...
		//added by prabash---16-05-2012-------**
		out.println("function check_val2(obj1,obj2){");
			out.println("if(obj2.value!=''){"); 
			out.println("if((parseFloat(unformat_noobject(obj1.value))) < (parseFloat(unformat_noobject(obj2.value)))){"); 
			out.println("alert('Forced Sales Value must be less than the Market Value');"); 
			//out.println("alert(format_noobject((unformat_noobject(obj1.value)-unformat_noobject(obj2.value))));"); 
			out.println("obj2.value='';"); 
			out.println("obj2.focus();"); 
			out.println("}"); 
			out.println("}"); 
			out.println("}"); 
      ...
      out.println("    m_decimal='.'+m_decimal;");
	  	...
	  	out.println("    }");
			...
			out.println("if(document.Form1.TXT_METER_READING.value!=\"\"){");
			out.println("format_noobject_nodecimal1(document.Form1.TXT_METER_READING)"); 
			out.println("}");
			out.println("}");
      ...
      out.println(" document.Form1.hid_cal_date.value=num;"); 
		  ...
		  out.println("  else if(document.Form1.hid_cal_date.value=='2'){"); 	
			...
			out.println("assig1('M10'); ");
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MK_sql_validations?chksql=m_LAKDL_AF_MK_display_valuation_report_validate_reg_no&data_val_reg_no=\"+document.Form1.TXT_REG_NO.value+\"&data_val_app_no=\"+document.Form1.TXT_APP_NO.value+\"&data_val_invoice_no=\"+document.Form1.TXT_INVOICE_NO.value+\"&data_val_asset_no=\"+document.Form1.TXT_ASSET_ID.value+\"&data_val_model_no=\"+document.Form1.TXT_MODEL_CODE.value+\"&data_val_sub_model=\"+document.Form1.TXT_SUB_MODEL_CODE.value+\"&ac_status=Y\";");
			...
			//prabash--on 24-04-2012-------**
			out.println("function Rev_Lic_date(){");
		//	out.println(" alert('gggg');");
			out.println("	m_date=document.Form1.TXT_REG_DATE_DD.value+'-'+document.Form1.TXT_REG_DATE_MM.value+'-'+document.Form1.TXT_REG_DATE_YY.value;");
			out.println("assig1('M9'); ");
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MK_sql_validations?chksql=m_LAKDL_AF_MK_display_valuation_report_validate_lic_date&data_val_lic_date=\"+m_date+\"&data_val_app_no=\"+document.Form1.TXT_APP_NO.value+\"&data_val_invoice_no=\"+document.Form1.TXT_INVOICE_NO.value+\"&data_val_asset_no=\"+document.Form1.TXT_ASSET_ID.value+\"&data_val_model_no=\"+document.Form1.TXT_MODEL_CODE.value+\"&data_val_sub_model=\"+document.Form1.TXT_SUB_MODEL_CODE.value+\"&ac_status=Y\";");
			out.println("load_interface(m_url,'XML');");
			out.println("}");	
			//----------------**
			//ADDED By Mahela on 22-05-2007------------------------------------------
			
			out.println("function val_engine_no2(){");
			out.println("assig1('M_ENGINE'); ");
			//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MK_sql_validations?chksql=m_LAKDL_AF_MK_display_valuation_report_validate_engine_no2&data_val_app_no=\"+document.Form1.TXT_APP_NO.value+\"&data_val_invoice_no=\"+document.Form1.TXT_INVOICE_NO.value+\"&data_val_asset_no=\"+document.Form1.TXT_ASSET_ID.value+\"&data_val_model_no=\"+document.Form1.TXT_MODEL_CODE.value+\"&data_val_sub_model=\"+document.Form1.TXT_SUB_MODEL_CODE.value+\"&ac_status=Y\";"); // commented by udara 02-01-2013
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MK_sql_validations?chksql=m_LAKDL_AF_MK_display_performa_invoice_eng_no&data_val=\"+document.Form1.TXT_ENGINE_NO.value+\"&ac_status=Y\";"); // added by udara 02-01-2013
			out.println("load_interface(m_url,'XML');");
			out.println("}");	
			
			out.println("function val_chassis_no2(){");
			out.println("assig1('M_CHASS'); ");
			//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MK_sql_validations?chksql=m_LAKDL_AF_MK_display_valuation_report_validate_chassis_no2&data_val_app_no=\"+document.Form1.TXT_APP_NO.value+\"&data_val_invoice_no=\"+document.Form1.TXT_INVOICE_NO.value+\"&data_val_asset_no=\"+document.Form1.TXT_ASSET_ID.value+\"&data_val_model_no=\"+document.Form1.TXT_MODEL_CODE.value+\"&data_val_sub_model=\"+document.Form1.TXT_SUB_MODEL_CODE.value+\"&ac_status=Y\";"); // commented by udara 02-01-2013
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MK_sql_validations?chksql=m_LAKDL_AF_MK_display_performa_invoice_chassi_no&data_val=\"+document.Form1.TXT_CHASSIS_NO.value+\"&ac_status=Y\";"); // added by udara 02-01-2013
			//out.println("window.open(m_url);");
			out.println("load_interface(m_url,'XML');");
			out.println("}");
			...
			//added by Prabash on 24-04-2012---------**
			out.println("function Rev_Lic_date2(){");
			
			out.println("		m_date=document.Form1.TXT_REG_DATE_DD.value+'-'+document.Form1.TXT_REG_DATE_MM.value+'-'+document.Form1.TXT_REG_DATE_YY.value;");
			out.println("assig1('M_LICDATE'); ");
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MK_sql_validations?chksql=m_LAKDL_AF_MK_display_valuation_report_validate_lic_date2&data_val_lic_date=\"+m_date+\"&data_val_app_no=\"+document.Form1.TXT_APP_NO.value+\"&data_val_invoice_no=\"+document.Form1.TXT_INVOICE_NO.value+\"&data_val_asset_no=\"+document.Form1.TXT_ASSET_ID.value+\"&data_val_model_no=\"+document.Form1.TXT_MODEL_CODE.value+\"&data_val_sub_model=\"+document.Form1.TXT_SUB_MODEL_CODE.value+\"&ac_status=Y\";");
	//		out.println(" alert(m_url);");
			out.println("load_interface(m_url,'XML');");
			out.println("}");
			//---------------------------------------**
			...
			//-----Added by Chandana for Ref No.371 on 27/08/2007 --------
			out.println("function check_val(obj1){ ");
			out.println("if(obj1.value!=\"\" ) {");
			out.println("document.Form1.hid_st.value='CHECK_VAL';");
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MK_sql_validations?chksql=m_LAKDL_AF_MK_display_valuation_check_amount_value&data_val_amt_value=\"+unformat_noobject(obj1.value)+\"&data_val_invoice_no=\"+document.Form1.TXT_INVOICE_NO.value+\"&data_val_asset_no=\"+document.Form1.TXT_ASSET_ID.value;");
			//out.println("window.open(m_url);");
			out.println("load_interface(m_url,'XML');");
			out.println("}");	
			out.println("}");	
			...
			//added by nuwan de silva on 17-12-2007 _____________
			out.println("<INPUT TYPE='Hidden' NAME='TXT_MODEL_CODE'>");
			out.println("<INPUT TYPE='Hidden' NAME='TXT_SUB_MODEL_CODE'>");
			out.println("<INPUT TYPE='Hidden' NAME='TXT_ITEM_CODE'>");
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Application Process -Inspection and Valuation Report</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td  height='10px' class='pdn_txtpos'>"); 
			out.println("<table class='table' cellpadding='2' cellspacing='2' border='0'> "); 
			out.println("<tr><td width='10%' align='center'><input type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"New\");' onclick='load_screen_status(\"NEW\")' value=\"New\"></td>");  
			// Modified By Samitha Kulatilaka On 2009-10-15 (Function Call On onClick() Event)
			out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Edit\");' onClick='load_screen_status(\"EDIT\"),remove_valuation_no_star()' value=\"Edit\"></td>");  
   		...
   		out.println("<td width='10%' align='center'><input type=button name=close value=\"Close\" class=mainbut onclick=close_screen2(); onMouseOver='load_roll_value(\"Close\");' onmouseout='load_roll_value(\"Close\");'></td>");
			...
			out.println("<tr >"); 
			out.println("<td width='25%' ><DIV id='DIV_TXT_APP_NO'  class=div_input>Application No</DIV></td>"); 
			out.println("<td width='25%' ><input class='txt_input' type='text' name='TXT_APP_NO' maxlength='15' size='15' disabled>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>");


			out.println("<tr>"); 
			out.println("<td width='25%' ><DIV id='DIV_TXT_VALUATION_NO'  class=div_input>Valuation No *</DIV></td>"); 
			out.println("<td width='25%' ><input class='txt_input' type='text' name='TXT_VALUATION_NO' maxlength='15' size='15' onkeypress=\"\" onblur=\"assig1('T1'),makeRequest(document.Form1.TXT_VALUATION_NO)\" onchange=\"\" disabled>"); 
			out.println("<input class='but_input' type='button' name='BUT_VALUATION_NO' value=\"Help\" onClick=\"help_update()\" disabled></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>");
			
			out.println("<tr >"); 
			out.println("<td width='25%' ><DIV id='DIV_TXT_VALUER_CODE'  class=div_input>Valuer Code *</DIV></td>"); 
			out.println("<td width='25%' ><input class='txt_input' type='text' name='TXT_VALUER_CODE' maxlength='10' size='10' onblur=\"assig1('VAL'),Valuer(document.Form1.TXT_VALUER_CODE)\">"); 
			out.println("<input class='but_input' type='button' name='BUT_VALUER_CODE' value=\"Help\" onClick=\"help_update_valuer()\" ></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			
			out.println("<tr >");//Added by Chandana on 21/06/2007 
			out.println("<td width='25%' ><DIV id='DIV_TXT_VALUER_NAME' class=div_input>Valuer Name </DIV></td>"); 
			out.println("<td width='25%' ><input class='txt_input' type='text' name='TXT_VALUER_NAME' maxlength='10' size='10' onblur=\"\">"); 
			out.println("</td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			...
			out.println("<tr>"); 
			out.println("<td width='25%' ><DIV id='DIV_TXT_VALUATION_DATE'  class=div_input>Valuation Date [DD-MM-YYYY] *</DIV></td>"); 
			out.println("</td>"); 
			out.println("<td width='25%' ><input class='txt_input5' type='text' name='TXT_VALUATION_DATE_DD' maxlength='2' size='2' >");
			out.println("                 <input class='txt_input5' type='text' name='TXT_VALUATION_DATE_MM' maxlength='2' size='2'>");
			out.println("                 <input class='txt_input5' type='text' name='TXT_VALUATION_DATE_YY' maxlength='4' size='4' onBlur=\"check_valuation_date()\" ><input type='Hidden' name='HID_TXT_VALUATION_DATE' value=\"\"><a href style=\"{cursor:hand; }\" onclick=load_calendar(\"1\")>   Calendar</a></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>");
			...
			out.println("<td width='25%' ><input class='txt_input' type='text' name='TXT_INVOICE_NO' maxlength='15' size='15' onblur=\"assig1('INV'),Invoice(document.Form1.TXT_INVOICE_NO)\">"); 
      ...
      out.println("</table>"); 
		...
		*/	
			...
			out.println("<td width='25%' ><input class='txt_input' type='text' name='TXT_ASSET_ID' maxlength='15' size='15' onkeypress=\"\" onblur=\"assig1('T4'),asset(document.Form1.TXT_ASSET_ID)\" disabled ></TD>");
			out.println("<td width='15%' ><DIV id='DIV_TXT_ASSET_DESC'  class=div_input>Asset Description</DIV></td>"); 
      ...
      out.println("</tr>"); 
			...
			//comment by nuwan de silva on 17-12-2007 ___________________________________
			/*out.println("<tr>");
			...
			*/
			...
			out.println("<tr>"); 
			out.println("<td width='25%' ><DIV id='DIV_TXT_YEAR_OF_MANUFACTURE'  class=div_input>Year Of Manufacture</DIV></td>"); 
			out.println("<td width='25%' ><input class='txt_input' type='text' name='TXT_YEAR_OF_MANUFACTURE' maxlength='4' size='10' onBlur=\"check_number_2(this)\" >");  //disabled comment by nuwan de silva on 18-12-2007
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			
			out.println("<tr >"); 
			out.println("<td width='25%' ><DIV id='DIV_TXT_REG_NO'  class=div_input>Registration No * </DIV></td>"); 
			out.println("<td width='25%' ><input class='txt_input' type='text' name='TXT_REG_NO' maxlength='20' size='20' onkeypress='d()' onBlur=\"val_reg_no()\" ></td>");  
			out.println("<td width='*%'></td>"); 
			
			out.println("<tr >"); 
			out.println("<td width='25%' ><DIV id='DIV_TXT_CHASSIS_NO'  class=div_input>Chassis No / Serial No * </DIV></td>"); // Modified by Mahela  on 18-05-2007 -- val_chassis_no()
			//out.println("<td width='25%' ><input class='txt_input' type='text' name='TXT_CHASSIS_NO' maxlength='50' size='20' onkeypress='d()' onBlur=\"val_chassis_no2()\"></td>"); // commented by udara 03-12-2014
			out.println("<td width='25%' ><input class='txt_input' type='text' name='TXT_CHASSIS_NO' maxlength='50' size='20' onkeypress='d()' onBlur=\"val_chassis_no()\"></td>"); // added by udara 03-12-2014
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			
			out.println("<tr >"); 
			out.println("<td width='25%' ><DIV id='DIV_TXT_ENGINE_NO'  class=div_input>Engine No * </DIV></td>"); // Modified by Mahela on 18-05-2007 -- val_engine_no()
			//out.println("<td width='25%' ><input class='txt_input' type='text' name='TXT_ENGINE_NO' maxlength='50' size='20' onkeypress='d()' onBlur=\"val_engine_no2()\"></td>"); // commented by udara 03-12-2014
			out.println("<td width='25%' ><input class='txt_input' type='text' name='TXT_ENGINE_NO' maxlength='50' size='20' onkeypress='d()' onBlur=\"val_engine_no()\"></td>"); // added by udara 03-12-2014
			out.println("<td width='*%'></td>"); 
			out.println("</tr>");
			...
			out.println("<td width='25%' ><input class='txt_input' type='text' name='TXT_VALUE' maxlength='22' size='22' STYLE='{text-align:right;}' onkeypress='d()' onblur=\"check_number(document.Form1.TXT_VALUE,25),check_val(document.Form1.TXT_VALUE)\"></td>");  //check_value(document.Form1.TXT_VALUE.value),format_number(document.Form1.TXT_VALUE,25)
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			
			out.println("<tr>"); 
			out.println("<td width='25%' ><DIV id='DIV_TXT_FORCED_VALUE'  class=div_input>Forced Sales Value</DIV></td>"); 
			out.println("<td width='25%' ><input class='txt_input' type='text' name='TXT_FORCED_VALUE' maxlength='250' size='25' STYLE=\"{text-align:right}\" onBlur=\"check_number(this,25),check_val2(document.Form1.TXT_VALUE,document.Form1.TXT_FORCED_VALUE)\" >"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 

			out.println("<tr >"); 
			out.println("<td width='25%' >Odometer Reading/Usage in Units  *</td>"); 
			out.println("<td width='25%' ><input class='txt_input' type='text' name='TXT_METER_READING' STYLE=\"{text-align:right}\"  maxlength='22' size='22' onkeypress='d()' onblur=\"check_meter()\"></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>");
			...
			out.println("<tr >"); 
			out.println("<td width='25%' >Condition of Asset</td>"); 
			out.println("<td width='25%' ><select class='txt_input' type='text' name='TXT_CONDITION_OF_ASSET' maxlength='1' size='1' >");  
            ...
            out.println("<table width='100%'  border='0'  class='table' border='0' >");
			out.println("<tr >"); 
			//out.println("<td width='25%' >Notes</td>"); // commented by udara 13-11-2014
			out.println("<td width='25%' ><DIV id='DIV_TXT_NOTES'  class=div_input>No of CR entries *</td>"); // added by udara 13-11-2014
			...
			out.println("<tr >"); 
			out.println("<td width='25%' >Remarks</td>"); 
			...
			out.println("<table width='100%'  border='0' class='table' border='0' >");
			out.println("<tr>"); 
			out.println("<td width='25%' >Type of the Body</td>"); 
			out.println("<td width='25%' ><input class='txt_input' type='text' name='TXT_TYPE_OF_BODY' maxlength='50' size='50' onkeypress=\"d()\"></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 

			out.println("<td width='25%' ><DIV id='DIV_TXT_DATE_OF_REG'  class=div_input>Date of Registration [DD-MM-YYYY] </DIV></td>"); 
			...
			out.println("                 <input class='txt_input5' type='text' name='TXT_REG_DATE_YY' maxlength='4' size='4' onBlur=\"Rev_Lic_date2()\" ><input type='Hidden' name='HID_TXT_REG_DATE' value=\"\"><a href style=\"{cursor:hand; }\" onclick=load_calendar(\"2\")>   Calendar</a></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			
			out.println("<tr >"); 
			out.println("<td width='25%' >General Index (Engineer's Summary)</td>"); 
			out.println("<td width='25%' ><select class='txt_input' type='text' name='TXT_GENERAL_INDEX' maxlength='1' size='1' onchange='d()'>");  
			...
			out.println("<tr>"); 
			out.println("<td width='25%' ><DIV id='DIV_TXT_FORCED_VALUE'  class=div_input>Forced Sales Value</DIV></td>"); 
			out.println("<td width='25%' ><input class='txt_input' type='text' name='TXT_FORCED_VALUE' maxlength='250' size='25' STYLE=\"{text-align:right}\" onBlur=\"check_number(this,25)\" >"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			...
			*/
			...
			out.println("<tr >"); 
			out.println("<td width='25%' >Seating Capacity</td>"); 
			out.println("<td width='25%' ><input class='txt_input' type='text' name='TXT_SEATING_CAPACITY' STYLE=\"{text-align:right}\"  maxlength='2' size='2' onkeypress='d()' onblur=\"check_seat()\"></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			
			out.println("<tr >"); 
			out.println("<td width='25%' >Cubic Capacity</td>"); 
			out.println("<td width='25%' ><input class='txt_input' type='text' name='TXT_NO_OF_CYLINDERS' STYLE=\"{text-align:right}\"  maxlength='5' size='' onkeypress='d()' onblur=\"check_cyl()\"></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 


			out.println("<tr>");
			out.println("<td width='25%' >Fuel Type</td>");
			out.println("<td width='25%' ><select class='txt_input' type='text' name='TXT_FUAL_TYPE' maxlength='10' size='1' onchange='d()' disabled>");  
			...
			out.println("<tr>");
			out.println("<td width='25%' ><DIV id='DIV_TXT_COLOUR'  class=div_input>Colour </DIV></td>"); 
			out.println("<td width='25%' ><input class='txt_input' type='text' name='TXT_COLOUR' maxlength='50' size='50' onkeypress='d()'></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>");
			out.println("</table>");
