...
public class LAKDL_AF_RE_PRO_Collection_First_Reminder_front_end extends javax.servlet.http.HttpServlet {
	...
	public /*synchronized*/ void service(HttpServletRequest req, HttpServletResponse res) throws IOException {
		...
		//		out.println("   m_url='" + m_class_url + "/" + m_fschema_name + "AF_RE_PRO_Collection_Final_Reminder?m_finance_no="+req.getParameter("finance_no")+"&application_no=" + req.getParameter("application_no") + "&document_code="+req.getParameter("document_code")+"&print=FALSE&client_code=" + req.getParameter("client_code") + "&client_type=" + req.getParameter("client_type") + "';");
			...
			*/
				...
				out.println("<p>");
				out.println("<font face=\"FMBindumathi\">");
                out.println("<b><u>m&lt;uq isysle|ùuhs'</u></b>"); // mod
				out.println("</p></font>");	
				out.println("</table>");
				...
				out.println("<p>");
				out.println("<font face=\"FMBindumathi\">");
                out.println("Tn úiska tl`. jq mßÈ by; olajk ,o l=,S iskaklalr .súiqu hgf;a wh úh hq;=j mj;sk udisl");
                out.println("jdßlh$jdßlhka Tn úiska ksis mßÈ f.jd fkdue;s nj wms fuu.ska okajd isákafkuq' tu fya;=fjka Tnf.ka");
                out.println("wm iud.u fj; ys`. Kh jdßl iy ta u; jq fmd&lt;sh jYfhka by; olajd we;s uqo, f.úh hq;=j iy wh úh hq;=j");
                out.println("we;'"); // mod
				out.println("</p></font>");	
				out.println("</table>");
				...
				out.println("<p>");
				out.println("<font face=\"FMBindumathi\">");
                out.println("ta wkqj\" fuu ,smsh ,eì Èk y; ^07& la bl=;a ùug fmr by; lS f.ùï isÿlrk f,i wms fuu.ska Tn fj; ±kqïfouq'"); // mod
				out.println("</p></font>");	
				out.println("</table>");
				...
				out.println("<p>");
				out.println("<font face=\"FMBindumathi\">");
                out.println(";jo\" tfia isÿlsßug Tn wfmdfydi;a jkafka kï by; i|yka lrk ,o .súiqu hgf;a l%shd lsÍug wm yg");
				out.println("isÿjk nj lK.dgqfjka okajd isáuq' tfia fyhska tjka ;;a;ajhla j,lajd,Sug wjYH kï by; b,a,d we;s mßos");
				out.println("lghq;= lrk fuka o fuhska okajd isáuq'"); // mod
				out.println("</p></font>");	
				out.println("</table>");
				...
				out.println("<p>");
				out.println("<font face=\"FMBindumathi\">");
                out.println(";jo\" Tn fj; jeäÿr meyeÈ&lt;s lsÍï wjYH kï fuu ,smsh ,eî Èk 3 la we;=&lt;; fuys my; i|yka wm iud.fïks,OdÍ iïnkaO lr .kak'"); // mod
				out.println("</p></font>");	
				out.println("</table>");
				...
				out.println("<table border='0' width='90%' class='table'> ");
				out.println("<tr ><td width='20%' class='rep-body' style='{font:13px;text-align:justify;}'>");
				out.println("<p>");
				out.println("<font face=\"FMBindumathi\">");
                out.println("ku"); 
				out.println("</p></font></td>");
			    out.println("<td width='70%' class='rep-body' style='{font:13px;text-align:justify;}'> : .............................................................. </td></tr>");
		...
		*/		
			...
			*/
				...
				out.println("<th align='left'><font face=\"Times New Roman\">"+m_vehicle_no+"</font></th>");
				//out.println("<th align='left'><font face=\"Times New Roman\">"+m_ent_date+"</font></th>");
				//out.println("<th align='left'><font face=\"Times New Roman\">"+m_Letter_date+"</font></th>"); // commented by udara 05-11-2019
				out.println("<th align='left'><font face=\"Times New Roman\">"+m_due_date+"</font></th>"); // added by udara 05-11-2019
				//out.println("<th align='left'><font face=\"Times New Roman\">"+nf.format(arr_amount)+"</font></th></tr>");
				//out.println("<th align='left'><font face=\"Times New Roman\">"+nf.format(m_total_arrears)+"</font></th></tr>");
				out.println("<th align='left'><font face=\"Times New Roman\">"+m_total_arrears+"</font></th></tr>");
