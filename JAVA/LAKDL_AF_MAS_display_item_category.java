...
//--
//SCREEN NAME:SYSTEM ADMINISTRATION - ITEM CATEGORY
//CREATED BY:
//DATE/TIME:
//NOTES:
...
public class LAKDL_AF_MAS_display_item_category extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>System Administration - Item Categories</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("else if(data_vec.length==0 && document.Form1.SCREEN_NAME.value!=\"NEW\" && document.Form1.TXT_ITEM_CAT_CODE.value!='' && document.Form1.hid_chk_status.value=='M1'){");
			...
			out.println("    document.Form1.TXT_VAT_APPLICABLE_AMOUNT.value=data_vec[2];"); 
			out.println("    document.Form1.TXT_VAT_AMOUNT.value=data_vec[3];"); 
	...
	//		out.println("load_interface(m_url,'XML');");
			...
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations1?chksql=m_prime_chk_LAKDL_AF_MAS_display_item_category1&data_val=\"+obj.value;");
			
			out.println("else");
			out.println("if(document.Form1.hid_chk_status.value=='M1' && document.Form1.SCREEN_NAME.value==\"RACT\")");
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_item_category&data_val=\"+obj.value+\"&ac_status=N\";");
			...
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations1?chksql=m_prime_chk_LAKDL_AF_MAS_display_item_category_desc&data_val=\"+obj.value;");
			...
			out.println("if(document.Form1.TXT_ITEM_CAT_CODE.value==\"\" && document.Form1.SCREEN_NAME.value!=\"NEW\" ){  "); 
		//	out.println("alert('Item Category Code Can not Be Blank'); "); 
			...
			out.println("		if(validate_data()){"); 
			out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_MAS_save_item_category';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MAS_display_item_category';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("    m_help_message = \"m_help_msg_LAKDL_AF_MAS_display_item_category\";"); 
			...
			out.println("help_box.innerHTML=\" System Administration - Item Categories - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" System Administration - Item Categories - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
	  	...
	  	out.println("		}"); 
			...
			out.println("    } ");
			out.println("    else{");
			out.println("    m_criteria = document.Form1.TXT_ITEM_CAT_CODE.value+\"@\"+\"N@\";}"); 
			out.println("    HelpBox('1','10','0');"); 
			out.println("}"); 
			...
			out.println("    document.Form1.TXT_VAT_APPLICABLE_AMOUNT.value=oBj.valout[4];"); 
			out.println("format_number(document.Form1.TXT_VAT_APPLICABLE_AMOUNT,6);");
			out.println("    document.Form1.TXT_VAT_AMOUNT.value=oBj.valout[5];"); 
			...
			out.println("    document.Form1.TXT_DESCRIPTION.value=\"\";"); 
			out.println("    document.Form1.TXT_DESCRIPTION.value.focus();"); 
			out.println("}"); 
	  	...
	  	out.println("		}"); 
			...
			out.println("    m_sql = \"m_view_TXT_ITEM_CAT_CODE_sql\";");
			out.println("    m_criteria = document.Form1.TXT_ITEM_CAT_CODE.value+\"@\"+\"Y@\";"); 
			...
			out.println("alert('Number should be less than 100');"); 
			...
			out.println("</script>"); 
			out.println("<BODY class='body & txt-body' leftmargin='0' topmargin='0' marginwidth='0' ONLOAD=\"load_lock(),load_roll_out_value('NEW')\">"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>System Administration - Item Categories</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_ITEM_CAT_CODE' maxlength='10' size='10' onblur=\"assignState('M1'), makeRequest(document.Form1.TXT_ITEM_CAT_CODE)\">"); 
			out.println("<input class='but_input' type='button' name='BUT_HELP_MAIN' value=\"Help\" onClick=\"help_update()\" disabled></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 

			out.println("<td width='30%' ><DIV id='DIV_TXT_DESCRIPTION'  class=div_input>Item Category Description *</DIV></td>"); 
			...
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_VAT_APPLICABLE_AMOUNT'   maxlength='6' size='22' onBlur=\"check_number(document.Form1.TXT_VAT_APPLICABLE_AMOUNT,6)\" STYLE='{text-align:right;}'></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			...
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_VAT_AMOUNT'  maxlength='25' size='22'  onBlur=\"check_number(document.Form1.TXT_VAT_AMOUNT,6)\"  STYLE='{text-align:right;}'></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			...
			out.println("<td width='30%' >Defult Value *</td>"); 
