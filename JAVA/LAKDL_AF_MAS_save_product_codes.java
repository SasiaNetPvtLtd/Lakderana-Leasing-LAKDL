...
//--
//SCREEN NAME:SAVE SYSTEM ADMINISTRATION - PRODUCT CODES
//CREATED BY:
//DATE/TIME:
//NOTES:
...
public class LAKDL_AF_MAS_save_product_codes extends HttpServlet {
  ...
  String reqstr;
	...
	public synchronized void  service(HttpServletRequest req, HttpServletResponse res)	throws IOException{
      ...
      String m_scr_name=(String)m_sn_methods.met_formdata(reqstr,"Hid_scr_name"); 
			...
			callstmt=conn.prepareCall("BEGIN "+m_schema_name+".AF_MAS_SAVE_PRODUCT_CODES(:1,:2,:3,:4,:5); END;");
	   	...
	   	out.println("<HTML><HEAD>");
			...
			out.println("window.location.href='"+m_url+"/LAKDL_AF_MAS_display_product_codes';");
