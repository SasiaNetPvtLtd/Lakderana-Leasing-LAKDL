...
public class LAKDL_AF_RE_display_other_invoices extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		//	out.println(" alert(m_date);");
			...
			out.println("'<tr>'+");
			//out.println("'<TD WIDTH=\"20%\"  align=\"left\">Payee Code *</TD>'+"); // <DIV id='DIV_TXT_FINANCE_NO'  class=div_input>Finance No *</DIV>
			...
			//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_sql_validations?chksql=m_prime_chk_LAKDL_AF_RE_get_finance_no&data_val=\"+obj.value;"); // Commented by samith dilshan
			...
			out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_RE_save_other_invoices';");  
			...
			//out.println("      validate_date(document.Form1.TXT_VALUE_DATE_DD,document.Form1.TXT_VALUE_DATE_MM,document.Form1.TXT_VALUE_DATE_YY);"); // commented by udara 15-08-2019
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_RE_display_other_invoices';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("	   "); 
			out.println("    popupwin = window.showModalDialog('"+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CO_Help_Servlet?class_in="+m_client_name+"AF_RE_help_select&Sql_in='+Sql+'&Start_in='+Start+'&End_in='+End+'&Crit_In='+Crit+'&Hid_No='+Hid_No+'&Max_in='+Hid_No+'&Args=', oBj,\"dialogWidth:25em; dialogHeight:26em; center:yes; status:no\");");//m_help_sub_charge_payee_code
	  	...
	  	out.println("		}"); 
			...
			//out.println("    HelpBox('1','10','0',Crit,'FinanceSql','2');"); // Commented by : Samith
			...
			*/
			...
			out.println("</script>"); 
			//out.println("<BODY class='body & txt-body' leftmargin='0' topmargin='0' marginwidth='0' ONLOAD=\"load_sys_date(),load_lock(),get_excharate(),load_roll_value('New'),Onload_payee()\">"); // commented by udara 30-07-2014
			...
			out.println("<td width='10%' align='center'><input type=\"button\" name=\"save_button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Save\");'  onClick='check_app_status()' value=\"Save\"></td>"); // mod by udara added name=\"save_button\" 14-06-2018  // modified by udara 05-07-2013 out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Save\");'  onClick='save_window()' value=\"Save\"></td>");  
			...
			*/
			...
			// commented by udara 15-08-2019
			/*
			out.println("<TD WIDTH=\"30%\"><input class=\"txt_input5\" type=\"text\" name=TXT_VALUE_DATE_DD maxlength=\"2\" size=\"2\" onBlur=check_date_value(document.Form1.TXT_VALUE_DATE_DD,document.Form1.TXT_VALUE_DATE_MM,document.Form1.TXT_VALUE_DATE_YY);validate_date(document.Form1.TXT_VALUE_DATE_DD,document.Form1.TXT_VALUE_DATE_MM,document.Form1.TXT_VALUE_DATE_YY); onChange=\"Change_Type(this); \"  >");//Modified by Dineth on 2008-12-10
			out.println("<input class=\"txt_input5\" type=\"text\" name=TXT_VALUE_DATE_MM  maxlength=\"2\" size=\"2\"  onBlur=check_date_value(document.Form1.TXT_VALUE_DATE_DD,document.Form1.TXT_VALUE_DATE_MM,document.Form1.TXT_VALUE_DATE_YY);validate_date(document.Form1.TXT_VALUE_DATE_DD,document.Form1.TXT_VALUE_DATE_MM,document.Form1.TXT_VALUE_DATE_YY); onChange=\"Check_due_date(document.Form1.TXT_INVOICE_TYPE,document.Form1.TXT_VALUE_DATE_DD,document.Form1.TXT_VALUE_DATE_MM,document.Form1.TXT_VALUE_DATE_YY);\" >");//Modifed by Dineth on 2008-12-10
			out.println("<input class=\"txt_input5\" type=\"text\" name=TXT_VALUE_DATE_YY maxlength=\"4\" size=\"4\"  onBlur=check_date_value(document.Form1.TXT_VALUE_DATE_DD,document.Form1.TXT_VALUE_DATE_MM,document.Form1.TXT_VALUE_DATE_YY);validate_date(document.Form1.TXT_VALUE_DATE_DD,document.Form1.TXT_VALUE_DATE_MM,document.Form1.TXT_VALUE_DATE_YY); onChange=\"Check_due_date(document.Form1.TXT_INVOICE_TYPE,document.Form1.TXT_VALUE_DATE_DD,document.Form1.TXT_VALUE_DATE_MM,document.Form1.TXT_VALUE_DATE_YY);\"  > <a href style='{cursor:hand; }' onclick=load_calendar('2')>   Calendar</a> ");//Modified by Dineth on 2008-12-10 
			out.println("</td> ");
			*/
			
			// added by udara 15-08-2019
			out.println("<TD WIDTH=\"30%\"><input class=\"txt_input5\" type=\"text\" name=TXT_VALUE_DATE_DD maxlength=\"2\" size=\"2\" onBlur=check_date_value(document.Form1.TXT_VALUE_DATE_DD,document.Form1.TXT_VALUE_DATE_MM,document.Form1.TXT_VALUE_DATE_YY); onChange=\"Change_Type(this); \"  >");//Modified by Dineth on 2008-12-10
			out.println("<input class=\"txt_input5\" type=\"text\" name=TXT_VALUE_DATE_MM  maxlength=\"2\" size=\"2\"  onBlur=check_date_value(document.Form1.TXT_VALUE_DATE_DD,document.Form1.TXT_VALUE_DATE_MM,document.Form1.TXT_VALUE_DATE_YY); onChange=\"Check_due_date(document.Form1.TXT_INVOICE_TYPE,document.Form1.TXT_VALUE_DATE_DD,document.Form1.TXT_VALUE_DATE_MM,document.Form1.TXT_VALUE_DATE_YY);\" >");//Modifed by Dineth on 2008-12-10
			out.println("<input class=\"txt_input5\" type=\"text\" name=TXT_VALUE_DATE_YY maxlength=\"4\" size=\"4\"  onBlur=check_date_value(document.Form1.TXT_VALUE_DATE_DD,document.Form1.TXT_VALUE_DATE_MM,document.Form1.TXT_VALUE_DATE_YY); onChange=\"Check_due_date(document.Form1.TXT_INVOICE_TYPE,document.Form1.TXT_VALUE_DATE_DD,document.Form1.TXT_VALUE_DATE_MM,document.Form1.TXT_VALUE_DATE_YY);\"  > <a href style='{cursor:hand; }' onclick=load_calendar('2')>   Calendar</a> ");//Modified by Dineth on 2008-12-10 
			out.println("</td> ");
			...
			out.println("<TD WIDTH=\"30%\"><input class=\"txt_input5\" type=\"text\" name=TXT_DUE_DATE_DD maxlength=\"2\" size=\"2\"  onBlur=\"check_date_value(document.Form1.TXT_DUE_DATE_DD,document.Form1.TXT_DUE_DATE_MM,document.Form1.TXT_DUE_DATE_YY)\" >");//Modified by Dineth on 2008-12-10
			out.println("<input class=\"txt_input5\" type=\"text\" name=TXT_DUE_DATE_MM  maxlength=\"2\" size=\"2\" onBlur=\"check_date_value(document.Form1.TXT_DUE_DATE_DD,document.Form1.TXT_DUE_DATE_MM,document.Form1.TXT_DUE_DATE_YY)\"  >");//Modified by Dineth on 2008-12-10
			out.println("<input class=\"txt_input5\" type=\"text\" name=TXT_DUE_DATE_YY maxlength=\"4\" size=\"4\"  onBlur=\"check_date_value(document.Form1.TXT_DUE_DATE_DD,document.Form1.TXT_DUE_DATE_MM,document.Form1.TXT_DUE_DATE_YY)\"  > <a href style='{cursor:hand; }' onclick=load_calendar('1')>   Calendar</a>  ");//Modified by Dineth on 2008-12-10 // date disabled by kanishka and comment calender on 29-05-2013
			out.println("</td> ");
