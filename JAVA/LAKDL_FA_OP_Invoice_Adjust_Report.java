...
//SCREEN NAME:Invoices Adjustments Report
...
public class LAKDL_FA_OP_Invoice_Adjust_Report extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
		  ...
		  if (m_chksql.trim().equals("main_page")) {
			...
			out.println("<title>Invoices Adjustments Report</title></head>");
			out.println("<link href=\""+m_html_client_url+"/css/Asset_Financing_System.css\" rel=\"stylesheet\" type=\"text/css\" >");	
			out.println("<script>");
			
			out.println("function print_data(){");
			out.println("	 m_url=\""+m_class_url+"/"+m_fschema_name+"FA_OP_save_Invoice_Adjust_Rep?client_no="+m_client_no+"&print="+m_print+"&facility_no="+m_facility_no+"\";");  
      ...
      out.println("<tr><td width='*%' class='rep-body' style='{font:12px;text-align:left;}'>"+m_city_desc+".</td></tr>");
			...
			out.println("<table border='0' width='100%' class='table'> ");	
			out.println("<tr ><td width='*%' class='rep-body' style='{text-align:center;}'><b><u>Invoices Adjustments Report</u></b></td></tr>");
			...
			out.println("We inform to you that the following adjustmensts have been made against your salse ledger. The information as follows </td></tr></table><br>");
			out.println("<table border='0' width='90%' class='table'> ");	
			out.println("<tr ><td width='*%' class='rep-body' style='{text-align:left;}'><b><u>Invoices Adjustments </u></b></td></tr>");
			out.println("</table>");						
			out.println("</font></p></blockquote>");				
			out.println("<blockquote><font size=2><p style='text-align:justify' class='rep-body' >");				
				 ...
				 rs2=stmt2.executeQuery (" SELECT DISTINCT "+   
  				 ...
  				 " NVL(C.ADJUST_AMOUNT,0), "+//9
  				 " NVL(C.ADJUSTMENT_COMMENTS,'-'), "+//10
  				 " C.ADJUST_TYPE "+//11
			...
			out.println("<td width='15%' class='rep-body' style='{text-align:right;}'><b><u>Adjustments Amt(Dr/Cr)</u></b></td> ");
			out.println("<td width='3%' class='rep-body'></td> ");
			out.println("<td width='15%' class='rep-body' style='{text-align:left;}'><b><u>Comments</u></b></td> ");
			out.println("</tr>");
			
			
				while(more){
					out.println("<tr ><td width='10%' class='rep-body' style='{text-align:left;}'>"+rs2.getString(1)+"</td>");
					...
					out.println("<td width='3%' class='rep-body'></td> ");
					if(rs2.getString(11).equals("CR")){
					out.println("<td width='15%' class='rep-body' style='{text-align:right;}'>("+nf.format(rs2.getDouble(9))+")</td> ");
					}
					else {
					out.println("<td width='15%' class='rep-body' style='{text-align:right;}'>"+nf.format(rs2.getDouble(9))+"</td> ");
					}
					out.println("<td width='3%' class='rep-body'></td> ");
					out.println("<td width='15%' class='rep-body' style='{text-align:left;}'>"+rs2.getString(10)+"</td> ");
					//out.println("<td width='3%' class='rep-body'></td> ");
