...
public class LAKDL_AF_MISF_list_of_debit_notes extends javax.servlet.http.HttpServlet {
		...
		try {
			...
			if(m_chksql.equals("main_page")){
				...
				*/
				...
				out.println("	 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_list_of_debit_notes?chksql=view_report_det&from_date=\"+from_date+\"&to_date=\"+to_date+\"&ins_officer=\"+ins_officer+\"&branch_code=\"+branch_code+\"&invoice_type=\"+invoice_type+\"&ins_agent=\"+ins_agent+\"&ins_agent_hid=\"+ins_agent_hid+\"&req_type=\"+req_type ;");
				out.println("    popupwin=window.open(m_url,'displayWindow1','left=70,top=110,width=1000,height=450,toolbar=0,location=0,center:yes,direction=0,menuBar=1,status=0,scrollbars=1,resizable=1');");
				...
				out.println("	 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_list_of_debit_notes?chksql=view_report_det&from_date=\"+from_date+\"&to_date=\"+to_date+\"&ins_officer=\"+ins_officer+\"&branch_code=\"+branch_code+\"&invoice_type=\"+invoice_type+\"&ins_agent_hid=\"+ins_agent_hid+\"&req_type=\"+req_type;");
				out.println("    popupwin=window.open(m_url,'displayWindow1','left=70,top=110,width=1000,height=450,toolbar=0,location=0,center:yes,direction=0,menuBar=1,status=0,scrollbars=1,resizable=1');");
				out.println("}");
				out.println("}");
				...
				//out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MISF_list_of_debit_notes';"); 
				out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MISF_list_of_debit_notes?chksql=main_page';"); 
				out.println("		}"); 
				out.println("}"); 
				...
				out.println("    m_help_message = \"m_help_msg_LAKDL_AF_MISF_list_of_debit_notes\";"); 
				...
				if(!m_ins_officer.equals("")){
					userFilter=""+
						" AND  A.ENT_USER = '"+m_ins_officer+"' ";
				}
				//[ADDED BY MILINDA ON 20-09-2022 JB16092022-18349]
				if(!m_branch_code.equals("")){
					branchFilter=""+
						" AND B.BRANCH_CODE = '"+m_branch_code+"' ";
				...
				rs= stmt.executeQuery(" "+
						" SELECT "+
								...
								" NVL((SELECT REG_NO FROM "+m_schema_name+".AF_CO_PRO_APP_INVOICE_DETAILS WHERE APPLICATION_NO = "+m_schema_name+".AF_CO_GET_APPLICATION_NO(A.FINANCE_NO)),'-') VEHICLE_NO, "+
								...
								" TO_CHAR(A.DUE_DATE,'DD-MM-YYYY') "+ // udara 07-03-2013 // 9
									...
									" AND "+m_schema_name+".AF_CO_GET_APP_LOCATION(A.INVOICE_NO) LIKE '"+m_branch_code+"%' "+
									...
									" AND   LAKDL.AF_GET_COLL_OFFICER(A.FINANCE_NO) LIKE '%"+m_ins_officer+"%' "+
									" ORDER BY A.DUE_DATE "+
									" ");
				*/
				
				// commented by udara on 09-08-2013
				/*
					rs= stmt.executeQuery(" "+
								" SELECT "+
									" A.INVOICE_NO, "+
									...
									" A.ENT_USER "+
										" FROM "+m_schema_name+".AF_CO_PRO_INVOICE A "+
										//" WHERE INVOICE_TYPE LIKE '%"+m_invoice_type+"%' "+ // commented by udara on 29-07-2013
										"  "+m_ins_type_check+" "+ // added by udara on 29-07-2013
										// " AND   TRUNC(A.DUE_DATE) >= TO_DATE('"+m_from_date+"','DD-MM-YYYY') "+ // commented by udara on 30-07-2013
										// " AND   TRUNC(A.DUE_DATE) <= TO_DATE('"+m_to_date+"','DD-MM-YYYY') "+ // commented by udara on 30-07-2013
										
										" AND   TRUNC(A.ENT_DATE) >= TO_DATE('"+m_from_date+"','DD-MM-YYYY') "+ // added by udara on 30-07-2013
										" AND   TRUNC(A.ENT_DATE) <= TO_DATE('"+m_to_date+"','DD-MM-YYYY') "+ // added by udara on 30-07-2013
										
										//" AND   A.ENT_USER LIKE '%"+m_ins_officer+"%' "+
										//" AND   "+m_schema_name+".AF_CO_GET_USER_LOCATION(A.ENT_USER) LIKE '%"+m_branch_code+"%' "+
										" AND   A.ENT_USER LIKE '"+m_ins_officer+"%' "+
										//" AND   "+m_schema_name+".AF_CO_GET_USER_LOCATION(A.ENT_USER) LIKE '"+m_branch_code+"%' "+ // commented by udara on 14-06-2013
										" AND "+m_schema_name+".AF_CO_GET_APP_LOCATION(A.INVOICE_NO) LIKE '"+m_branch_code+"%' "+ // added by udara on 14-06-2013
				...
				if(m_ins_agent_hid.equals("YES")){
					...
					if(!m_ins_agent.equals("")){
						
						if(m_invoice_type.equals("INSINV")){
							rs= stmt.executeQuery(" "+
								//out.println(" "+
								" SELECT "+
								" A.INVOICE_NO, "+
								...
								/*
								" DECODE(A.REMARKS, "+
								" 'CHARGES - SCC1','Province Change Charges - Upfront liability', "+
								" 'CHARGES - SCC2','6 Month Charges - Upfront liability', "+
								" 'CHARGES - SCC3','RMV Transfer Charges - Upfront liability', "+
								" 'CHARGES - SCC4','Initial Charges - Upfront Income', "+
								" A.REMARKS), "+
								*/
								...
								//" AND  A.ENT_USER LIKE '"+m_ins_officer+"%'  "+
								//[COMMENTED ABOVE AND ADED BELOW BY MILINDA ON 20-09-2022 JB16092022-18349]
								" "+userFilter+" "+
								//" AND   TRUNC(A.ENT_DATE) >= TO_DATE('"+m_from_date+"','DD-MM-YYYY') "+ // added by udara on 30-07-2013
								//" AND   TRUNC(A.ENT_DATE) <= TO_DATE('"+m_to_date+"','DD-MM-YYYY') "+ // added by udara on 30-07-2013
								// commented by udara on 23-08-2013	
								//" AND   TRUNC(A.VALUE_DATE) >= TO_DATE('"+m_from_date+"','DD-MM-YYYY') "+ // added by udara on 21-08-2013
								//" AND   TRUNC(A.VALUE_DATE) <= TO_DATE('"+m_to_date+"','DD-MM-YYYY') "+ // added by udara on 21-08-2013
								" " + m_date_range_check + " "+
							...
							rs= stmt.executeQuery(" "+
								...
								*/
								...
								//" A.ENT_USER, "+
								//" A.ENT_USER, "+//[Commented by milinda on 2017-10-10 for JB03102017-01175]
								" NVL((SELECT ENT_USER "+
								" FROM "+m_schema_name+".AF_CO_PRO_APP_PRICING_CHARGES  "+
								" WHERE APPLICATION_NO=B.APPLICATION_NO "+
								" AND   SUB_CHAGE_CODE=SUBSTR(A.REMARKS,11)),A.ENT_USER)ENTUSER, "+
								" A.CLIENT_CODE, "+ // 10 added by udara on 21-08-2013
								" NVL("+m_schema_name+".AF_CO_GET_SUB_CHARG_PAYEE_NAME(C.RECEIVER),'-')"+ //added by ishani 2014-01-08
								...
								" FROM "+m_schema_name+".AF_CO_PRO_INVOICE A, "+m_schema_name+".AF_CO_PRO_APPLICATION_DETAILS B, "+m_schema_name+".AF_RE_ACC_SUS_PAYMENT C  "+
								"  "+m_ins_type_check+" "+ // added by udara on 29-07-2013
								" AND  A.FINANCE_NO = B.FINANCE_NO  AND C.REF_NO=A.INVOICE_NO "+  //AND C.REF_NO=A.INVOICE_NO added by  ishani 2014-01-08
								//" AND  A.ENT_USER LIKE '"+m_ins_officer+"%'  "+
								//[COMMENTED ABOVE AND ADED BELOW BY MILINDA ON 20-09-2022 JB16092022-18349]
								" "+userFilter+" "+
								//" AND   TRUNC(A.ENT_DATE) >= TO_DATE('"+m_from_date+"','DD-MM-YYYY') "+ // added by udara on 30-07-2013
								...
								//" AND   TRUNC(A.VALUE_DATE) <= TO_DATE('"+m_to_date+"','DD-MM-YYYY') "+ // added by udara on 21-08-2013
								" " + m_date_range_check + " "+
								" AND   NVL("+m_schema_name+".AF_CO_GET_SUB_CHARG_PAYEE_NAME(C.RECEIVER),' ') LIKE '"+m_ins_agent+"%' "+ //added by ishani 2014-01-08//" AND "+m_schema_name+".AF_CO_GET_APP_LOCATION(A.INVOICE_NO) LIKE '"+m_branch_code+"%' "+ // added by udara on 14-06-2013
								//" AND B.BRANCH_CODE LIKE '"+m_branch_code+"%' "+
								//[COMMENTED ABOVE AND ADED BELOW BY MILINDA ON 20-09-2022 JB16092022-18349]
								" "+branchFilter+" "+
								" AND A.TOTAL_AMOUNT <> 0 "+
								...
								*/
								...
								"  ORDER BY ENT_DATE "+ // added by udara on 22-08-2013
								" ");
						...
						if(m_invoice_type.equals("INSINV")){
							rs= stmt.executeQuery(" "+
								...
								*/
								...
								//" AND   TRUNC(A.VALUE_DATE) <= TO_DATE('"+m_to_date+"','DD-MM-YYYY') "+ // added by udara on 21-08-2013
								" " + m_date_range_check + " "+
								//	" AND   "+m_schema_name+".AF_CO_GET_SUB_CHARG_PAYEE_NAME(C.RECEIVER) LIKE '"+m_ins_agent+"%' "+ //added by ishani 2014-01-08//" AND "+m_schema_name+".AF_CO_GET_APP_LOCATION(A.INVOICE_NO) LIKE '"+m_branch_code+"%' "+ // added by udara on 14-06-2013
								//" AND B.BRANCH_CODE LIKE '"+m_branch_code+"%' "+
								//[COMMENTED ABOVE AND ADED BELOW BY MILINDA ON 20-09-2022 JB16092022-18349]
								" "+branchFilter+" "+
								" AND A.TOTAL_AMOUNT <> 0 "+
				...
				try{
					...
					while(rs.next()){
						...
						tot_tot_amnt = tot_tot_amnt + rs.getDouble(6); // added by udara on 08-10-2013
						tot_bal_to_be_rec_amnt = tot_bal_to_be_rec_amnt + rs.getDouble(7); // added by udara on 08-10-2013
						...
						out.println("<td width='10%' class=factoring-letter-body align='left' class=div_input style='cursor:hand' onclick=\"show_transaction_info('"+rs.getString(10)+"','"+rs.getString(3)+"')\" ><u>"+rs.getString(3)+"</u></td>");
						...
						if(m_ins_agent_hid.equals("YES")){
							out.println("<td width='10%' class=factoring-letter-body align='left'>"+rs.getString(11)+"</td>");
						}
						
						out.println("<td width='10%' class=factoring-letter-body align='left'>"+rs.getString(12)+"</td>"); // added by udara 26-02-2014
						out.println("<td width='10%' class=factoring-letter-body align='left'>"+rs.getString(13)+"</td>"); // added by udara 26-02-2014
