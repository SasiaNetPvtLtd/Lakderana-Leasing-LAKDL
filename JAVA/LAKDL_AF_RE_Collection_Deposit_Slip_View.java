...
public class LAKDL_AF_RE_Collection_Deposit_Slip_View extends javax.servlet.http.HttpServlet {
  ...
  public synchronized void service(HttpServletRequest req, HttpServletResponse res)
      ...
      out.println("			}");
		...
		//  out.println("m_user_clear=\"TXT_USER\"+document.Form1.hid_row_no.value;");
			...
			out.println("}");
				...
				out.println("function help_deposit_no() {"); 
	...
	//		out.println("window.open(m_url);");
		...
		//--------------------------------------------------------------------------		
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_RE_Collection_Deposit_Slip_View';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("help_box.innerHTML=\" Collection Process - Deposit Slip - \"+m_val;"); 
			...
			out.println("help_box.innerHTML=\" Collection Process - Deposit Slip - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
		...
		//	out.println("document.Form1.BUT_HELP_MAIN.disabled=true;}"); 
			...
			out.println("if(document.Form1.DEPOSIT_CODE.value==''){");
			out.println("DIV_DEPOSIT_CODE.style.color='red';");
      ...
      out.println("</Script>");
			    ...
			    out.println("<INPUT TYPE='Hidden' NAME='hid_no_rec' VALUE=\"\">"); 
					...
					out.println("</tr>"); 
					out.println("<tr>"); 
					out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Collction Process - Deposit Slip</td>"); 
					out.println("</tr>"); 
					out.println("<tr>"); 
			...
			//		out.println("<tr><td width='10%' align='center'><input type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"New\");' onclick='load_screen_status(\"NEW\")' value=\"New\"></td>");  
			  ...
			  //  out.println("<td width='30%' >Purchase Order No</td>"); 
					...
					out.println("<td width='30%' ><DIV id='DIV_DEPOSIT_CODE'  class=div_input>Deposit No *</DIV></td>"); 
					out.println("<td width='30%' ><input class='txt_input' type='text' name='DEPOSIT_CODE' maxlength='20' size='10' onblur=\"val_deposit_code(document.Form1.DEPOSIT_CODE)\">"); 
			    out.println("<input class='but_input' type='button' name='BUT_TXT_DEPOSIT_NO' value=\"Help\" onClick=\"help_deposit_no()\"></td>"); 
