...
public class LAKDL_AF_CR_PRO_Other_Payments_Approval extends javax.servlet.http.HttpServlet {
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)
	{
		...
		try {
			...
			*/
				...
				out.println("<td  width='5%'  >Select <INPUT TYPE=\"checkbox\" NAME=\"CHECK_ALL\" VALUE=\"on\" onclick=\"check_all_chkbox()\"  > </td>"); //change_val_req("+j+")
				out.println("</tr>");
				...
				rs = stmt.executeQuery ("SELECT "+
					...
					" NVL(PAYEE_NAME,'-'),  "+
					" NVL(WHT,0), "+//
					" NVL(NET_AMOUNT,0) "+//Sandun on 24-12-2008
					" FROM "+m_schema_name+".AF_RE_PRO_SETTLMENT_PAYMENT "+
					//" WHERE  PROCESS_STATUS='APPRO1' AND  ENTRY_TYPE<>'V'    ");///*AND UPPER(PAYEE_NAME) LIKE UPPER('"+m_payee_name+"%')*/
					" WHERE  PROCESS_STATUS='Y' AND  ENTRY_TYPE<>'V'  AND UPPER(PAYEE_NAME) LIKE UPPER('%"+m_payee_name+"%')  ");
				...
				out.println("help_box.innerHTML=\"Finance - Other Payment Approval \";"); 
				out.println("}else{");
				out.println("help_box.innerHTML=\"Finance - Other Payment Approval - \"+m_val;"); 
				out.println("}");
				out.println("}");
				...
				out.println("}");
				out.println("		document.Form1.action='"+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_PRO_Save_Other_Payment_Approval';");  
	      ...
	      out.println("	m_url = \""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_MK_Application_Status_Report?chksql=main_page&sort_column=\"+m_sort_col+\"&order_by_type=\"+m_order_by_type;"); 
			  out.println(" window.location.href=m_url;"); 
				...
				*/				
				...
				out.println("m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_PRO_Other_Payments_Approval?chksql=payment_details&payee_name=\"+m_payee_name+\"\";");
				...
				out.println("		window.location.href='"+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_PRO_Other_Payments_Approval?chksql=main_page';"); 
				out.println("		}"); 
				out.println("}"); 
				...
				*/
				...
				out.println("HelpBox('1','10','0',Crit,'PayeeSql','1');");
				out.println("}");
