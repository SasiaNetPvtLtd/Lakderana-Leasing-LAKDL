...
public class LAKDL_AF_CR_PRO_Credit_Verifi_app_1 extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res) { 
		...
		try { 
			...
			if(rs.next()){
				m_count_active=rs.getInt(1);
			}
			
			if (m_count_active >0 ){
				m_active_status="Y";
			}
			/****** end Added by ns on 16-12-20101 **********/		
			...
			if(m_pre_stage.equals("ENT_CON")){
				...
				out.println("<TITLE>Credit Process - Approval 1</TITLE>"); 
			}
			...
			// added by udara on 04-01-2012
			out.println("else if(obj=='Btn_Security_Det') {");
			out.println("document.Form1.hid_chk_status.value='SD'");
			//out.println("		m_url='"+m_class_url+"/"+m_fschema_name+"AF_MK_Asset_Detail_Equipment?row='+row+'&data_val1="+m_pre_stage+"&APP_NO='+document.Form1.TXT_APPLICATION_NO.value+'&screen=G&my_screen_name=CV';"); 
			//out.println("   m_url='"+m_class_url+"/"+m_fschema_name+"AF_MK_Application_Process_Additional_Securities?chksql=main_page&APP_NO='+'"+m_applicaton_no+"';"); 
			...
			out.println("}");
			out.println("if(m_app_status=='V-RECOM'){");
			...
			if(m_pre_stage.equals("ENT_CON")){
				...
				out.println("help_box.innerHTML=\" Credit Process - Approval 1- \"+m_val;"); 
				out.println("enable_butttons()");
			}
			out.println("}"); 
			...
			if(m_pre_stage.equals("ENT_CON")){
				...
				out.println("help_box.innerHTML=\" Credit Process - Approval 1- \"+document.Form1.hid_status.value;"); 
				out.println("enable_butttons()");
			...
			if(m_type.equals("")){
				out.println("window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_CR_PRO_Application_Status_Report_appr1?chksql=main_page&pre="+m_pre_stage+"&appro="+m_app_stage+"&qry="+m_pre_stage1+"';");
			}
			out.println("}");
			out.println("}");
			...
			out.println("m_url='"+m_class_url+"/"+m_fschema_name+"AF_MAS_display_client_creation?m_client_status='+status+'&count_client='+document.Form1.Hid_Count_1.value+'&count_gur="+m_count_gur+"&count_as="+m_count_as+"&count_pr="+m_count_pr+"&count_vl="+m_count_vl+"&count_gur="+m_count_gur+"&active_status="+m_active_status+"&client_type='+ctype+'&inquiry_no='+val+'&screen=G&close_status=Y&client_code='+client_code+'&row=1&fscreen=client_verification'"); //Thamali on 2010.12.27
			...
			//	out.println("		m_url='"+m_class_url+"/"+m_fschema_name+"AF_MK_display_inspection_and_valuation_report?type=CURR&row_no='+row+'&APP_NO='+app_no+'&valuation_no='+prof_inv_no+'&row=1'");     //comment by Prabash on 15-03-2012
			out.println("		m_url='"+m_class_url+"/"+m_fschema_name+"AF_MK_display_inspection_and_valuation_report?type=CURR&row_no='+row+'&APP_NO='+app_no+'&my_screen_name=CV&valuation_no='+prof_inv_no+'&row=1'");     //Added by Prabash on 15-03-2012
			...
			out.println("document.Form1.TXT_CONTRACT_NUMBER.value='"+m_contract+"';"); //pra m_contract_no
			...
			//out.println("window.open('"+m_contract_no+"');"); 
			//}
			//out.println("document.Form1.Btn_Applicant_Det.disabled=false;");  // commented by ashini 
			// added by ashini -------------------------------------------
			out.println("document.Form1.Btn_approve.disabled=true;"); 
			...
			out.println("load_interface(m_url,'XML');");
			//out.println("window.open(m_url);");  //test madhawa 2012-02-27
			out.println("}");		
			...
			out.println("<INPUT TYPE='Hidden' NAME='Hid_scr_name_approv1' VALUE=\"AF_MK_APP_STATUS_APPROVE_2\">"); 
			...
			if(m_pre_stage.equals("V-RECOM")){
				...
				out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Credit Process - Approval 1</td>"); 
			...
			*/
			...
			out.println("<td width='2%' ><input class='txt_input' type='text' name='TXT_TRANSACTION_TYPE' maxlength='15' size='15' disabled ></td>"); 
			...
			out.println("<table width=\"100%\"  border=\"1\" cellspacing=\"0\" bordercolor='lightgrey' cellpadding=\"0\" style='{display:none;}' >"); // mod by udara style='{display:none;}' 17-05-2017
			out.println("<tr>");
			...
			//out.println(Sql_data_exposure_current);
			more=rs.next();
			if(more){
			...
			/***************************OTHERS************************/
			/*out.println("<br>");				
			rs10= stmt10.executeQuery (" SELECT  NVL(A.REG_NO,'N/A'),"+m_schema_name+".GET_OTHER_CONTRCT_FOR_MAIN(A.APPLICATION_NO,A.REG_NO), NVL(A.ENGINE_NO,'N/A'), NVL(A.CHASSIS_NO,'N/A'),NVL(A.COLOUR,'N/A'), NVL(A.VALUE,0) "+
			...
			out.println("<table align='left' width='10%' border=\"0\">");
			out.println("<tr>");
			out.println("<td width='10%' align=\"left\" bgcolor='silver'><B>Other Contract No For Using Same vehicle No<B></td>"); 
			out.println("</tr>");
			//while(rs2.next()){
			while(more11){
				
				out.println("<tr>"); 
				out.println("<td align=\"left\" style= \"cursor:hand;cursor-color:blue\" onclick=\"show_transaction_info('"+rs10.getString(3)+"','"+rs10.getString(4)+"')\" id=\"help_box\"><U>"+rs10.getString(2)+"</td>"); 
			...
			if(m_pre_stage.equals("V-RECOM")){
				rs1=stmt1.executeQuery(
					//out.println(
					"SELECT DISTINCT APPLICATION_NO,A.CLIENT_CODE,REPLACE("+m_schema_name+".AF_CO_GET_CLIENT_NAME(A.CLIENT_CODE),'&','AND') CLIENT_NAME, "+
					"NVL(DECODE(CLIENT_TYPE,'I',ADDRESS1,'C',REGISTERED_ADDRESS1),'-'),NVL(DECODE(CLIENT_TYPE,'I',ADDRESS2,'C',REGISTERED_ADDRESS2),'-'), NVL(DECODE(CLIENT_TYPE,'I',NIC_NO,'C',BUSINESS_CERTIFICATE_NO),'-'), DECODE(NVL(AF_GUARANTORS,'-'),'Y','Gurantor','-') AF_GUARANTORS ,DECODE(NVL(FA_CLIENT,'-'),'Y','Factoring Client','-') FA_CLIENT,DECODE(NVL(FA_DEBTOR,'-'),'Y','Factoring Debtor','-') FA_DEBTOR ,INQUARY_NO,CLIENT_TYPE,TRIM(CO_APPLICANT),"+m_schema_name+".AF_CO_GET_CLIENT_NAME(CO_APPLICANT) CORE_APPLICANT_NAME, "+ //NVL(NIC_NO,'-')
					"(SELECT NVL(DECODE(CLIENT_TYPE,'I',ADDRESS1,'C',REGISTERED_ADDRESS1),'-') FROM "+m_schema_name+".AF_CO_MAS_CLIENT A WHERE  CLIENT_CODE= CO_APPLICANT) ADDRESS1, "+
					"(SELECT NVL(DECODE(CLIENT_TYPE,'I',ADDRESS2,'C',REGISTERED_ADDRESS2),'-') FROM "+m_schema_name+".AF_CO_MAS_CLIENT A WHERE  CLIENT_CODE= CO_APPLICANT) ADDRESS2, "+
					"(SELECT NVL(DECODE(CLIENT_TYPE,'I',NIC_NO,'C',BUSINESS_CERTIFICATE_NO),'-')  FROM   "+m_schema_name+".AF_CO_MAS_CLIENT A WHERE  CLIENT_CODE= CO_APPLICANT) NIC, "+ 
					...
					"WHERE UPPER(APPLICATION_NO) LIKE UPPER('"+m_applicaton_no+"%') "+
					"AND A.CLIENT_CODE=B.CLIENT_CODE "+
					"AND APPLICATION_STATUS=('V-RECOM') ");				
			...
			while(rs1.next()){
				...
				if(q==0){
					out.println("<tr><td width='10%' align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'><b><u>Credit Process  - Applicant Verification </td></tr>"); //test mcp
					out.println("<tr></tr>");
					out.println("<tr></tr>");
					out.println("</table >"); 		
					out.println("<table align='center' width='100%' class='table' border=\"0\">"); 
			...
			rs2= stmt2.executeQuery (" SELECT A.APPLICATION_NO,NVL(A.GUARANTOR_CODE,'N/A'),NVL(B.FULL_NAME,'N/A'), "+
				...
				" ,A.GUAR_ID "+ //MODOFOED BY NS ON 11-08-2010
				" FROM "+
				...
				" AND UPPER(A.APPLICATION_NO)=UPPER(C.APPLICATION_NO) ORDER BY A.GUAR_ID ");
		...
		rs6= stmt6.executeQuery (" SELECT DISTINCT NVL(A.VALUATION_NO,'N/A'), NVL(A.ASSET_ID,'N/A'), NVL(B.DESCRIPTION,'N/A'), '', "+
			...
			*/
			...
			/***The security details section added here ns on 28-09-2012**/
			/*		
				...
				while(more){
						...
						out.println("  <td width=\"10%\"  align='center'><input class=\"but_input\" value=\"Edit\" type=\"button\" name=BUT_EDIT"+line_no+"  onClick=\"vehicle_edit('"+rs.getString(1)+"','"+rs.getString(9)+"')\" ></td>");
						out.println(" </tr>");
						i=i+1;
						line_no=line_no+1;
						more=rs.next();
				...
				while(more1){
						...
						out.println("  <td width=\"10%\"  align='center'><input class=\"but_input\" value=\"Edit\" type=\"button\" type=\"button\" name=BUT_EDIT"+line_no1+"  onClick=\"land_edit('"+rs1.getString(1)+"','"+rs1.getString(9)+"')\" ></td>"); 
						out.println(" </tr>");
						i1=i1+1;
						line_no1=line_no1+1;
						more1=rs1.next();
				...
				while(more2){
						...
						out.println("  <td width=\"10%\"  align='center'><input class=\"but_input\" value=\"Edit\" type=\"button\" name=BUT_EDIT"+line_no2+"  onClick=\"fixed_deposit_edit('"+rs2.getString(1)+"','"+rs2.getString(9)+"')\"></td>"); 
						out.println(" </tr>");
						i2=i2+1;
						line_no2=line_no2+1;
						more2=rs2.next();
			...
			/**end section added for security details***/
