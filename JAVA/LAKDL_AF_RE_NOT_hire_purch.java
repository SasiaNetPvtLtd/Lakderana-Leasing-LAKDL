...
public class LAKDL_AF_RE_NOT_hire_purch extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
	    ...
	    String m_full_name="";
		  ...
		  nf.setMaximumFractionDigits(2);
			...
			//out.print(m_chksql+"@"+m_facility_no+"@"+m_client_no+"@"+m_print);
		  ...
		  if (m_chksql.trim().equals("main_page")) {
			...
			out.println("	 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_Termination_Letter_save?finance_no="+m_facility_no+"&client_code="+m_client_no+"&letter_type=NOT_HP&print="+m_print+"\";");  
      ...
      out.println("<tr><td width='60%' class='rep-body' style='{font:10px;text-align:left;}'>"+m_d_city_desc+".</td><td width='*%' class='rep-body' style='{font:10px;text-align:left;}'></td></tr>");
			...
			//out.println("<tr><td width='*%' class='rep-body' style='{font:10px;text-align:right;}'>"+m_LAKDL_reg_no+"</td></tr>");
			out.println("</TABLE>");		
			out.println("<table border='0' width='100%' class='table'>"); 		
			...
			out.println("<tr ><td width='*%' class='rep-body'  style='{font:10px;text-align:left;}'>Dear Sir</td></tr>");
			out.println("</table><br>");		
			
			/*out.println("<table border='0' width='100%' class='table'> ");	
			out.println("<tr ><td width='*%' class='rep-body'  style='{font:10px;text-align:left;}'><b><u>NOTICE OF TERMINATION OF LEASE PURCHASE NO : "+m_facility_no+"</u></b></td></tr>");
			out.println("</table><br>");		
			*/
			out.println("<table border='0' width='100%' class='table'> ");	
			out.println("<tr ><td width='*%' class='rep-body'  style='{font:10px;text-align:left;}'><b><u>NOTICE OF TERMINATION OF HIRE PURCHASE</u></b></td></tr>");
			out.println("<tr ><td width='*%' class='rep-body'  style='{font:10px;text-align:left;}'><b><u>AGREEMENT NO : "+m_facility_no+"</u></b></td></tr>");
			out.println("</table><br>");		
			//added by nuwan de silva on 09-04-2008
			String data="";
			data="We refer to the Hire Purchase Agreement executed by you.";
			out.println("<table border='0' width='100%' class='table'> ");	
			...
			out.println(" We hereby inform you that despite our repeated requests and reminders, you have failed to pay the arrears of  "+
									" lease rentals due on the above Agreement totaling <b>Rs "+nf.format(m_tot_arrears+m_odi_arrears)+"/= </b> in terms of the conditions in the Agreement. "+
									" ");
			out.println("</td></tr></table>");			
			out.println("<table border='0' width='90%' class='table'> ");	
			out.println("<tr ><td width='*%' class='rep-body' style='{font:10px;text-align:justify;}'>");
			out.println(" In the circumstances, we have to inform you that, unless you settle the above arrears in full within 14 days "+
									" from the date of receipt of this letter, we will be compelled to take steps to terminate the agreement, "+
									" in accordance with the provisions of the Hire Purchase Agreement. "+
									" ");
			out.println("</td></tr></table>");						
			out.println("<table border='0' width='90%' class='table'> ");	
			out.println("<tr ><td width='*%' class='rep-body' style='{font:10px;text-align:justify;}'>");
