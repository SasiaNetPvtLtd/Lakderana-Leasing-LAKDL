...
public class LAKDL_AF_MK_Application_Process_Additional_Securities extends javax.servlet.http.HttpServlet {
	...
	int m_appno_count=0;
      ...
      out.println("}");
		// end by udara 19-02-2014
			...
			//added by kasun on 13-11-2024 for JB16102024-25600
			...
			// added by udara 10-12-2019
			out.println("if(document.Form1.TXT_REMARKS.value==\"\"){  "); 
			out.println("  DIV_TXT_REMARKS.style.color='red';");
			out.println("  return false;"); 
			out.println("}");
			// end by udara 10-12-2019
    	...
    	out.println("return true;"); 
			...
			*/
			...
			out.println("if(document.Form1.TXT_ASSIGN_TYPE.value==\"H\"){"); // added by kasun on 12-11-2024 for JB16102024-25600
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MK_Application_Process_Additional_Securities?chksql=main_page&APP_NO='+app_no;"); 
			out.println("		}"); 
			out.println("}"); 
      ...
      out.println("  if(document.Form1.hid_cal_date.value=='3'){"); 
			...
			out.println("m_hadagasma.innerHTML=\"\" ");
			...
			out.println("        '<td width=\"30%\" ><input class=txt_input type=text name=TXT_VEHICLE maxlength=20 size=20 onBlur=\"makeRequest(document.Form1.TXT_VEHICLE)\">&nbsp;&nbsp;'+"); 
			//out.println("        '<td width=\"30%\" ><input class=txt_input type=text name=TXT_VEHICLE maxlength=20 size=20 onBlur=\"check_vehicle_no2();\">&nbsp;&nbsp;'+"); 
    	...
    	out.println("        '<td width=\"20%\" ><DIV id=DIV_TXT_VEHICLE_MAKE  class=div_input>Make and Model</DIV></td>'+"); 
			...
			out.println("        '<td width=\"30%\" ><input class=txt_input type=text name=TXT_CHASIS maxlength=50 size=50 onblur=\"\" ></td>'+");  //check_vehicle_no();
			out.println("        '<td width=\"*%\">&nbsp;&nbsp;</td>'+"); 
			out.println("        '</tr>'+"); 
			out.println("				 '<tr >'+"); 
    	...
    	out.println("        '<td width=\"20%\" ><DIV id=DIV_TXT_SALES_VALUE  class=div_input>Forsed Slaes Value</DIV></td>'+"); 
			...
			out.println("        '</tr>'+"); 
			out.println("				 '<tr >'+"); 
    	//out.println("        '<td width=\"20%\" ><DIV id=DIV_TXT_REMARKS  class=div_input>Remarks</DIV></td>'+"); // commented by udara 10-12-2019
		out.println("        '<td width=\"20%\" ><DIV id=DIV_TXT_REMARKS  class=div_input>Remarks *</DIV></td>'+"); // commented by udara 10-12-2019
      ...
      out.println("m_write+'</table>';");
			...
			// added by kasun on 12-11-2024 for JB16102024-25600 
			...
			// ended by kasun on 12-11-2024 for JB16102024-25600

			out.println("}");
			
			out.println("function set_details(){");
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MK_Application_Process_Additional_Securities?chksql=details&APP_NO=\"+app_no;");
			...
			out.println("function hadagasma_product_edit(m_applicaton_no,m_sub_cat) {");// added by kasun on 2024.11.18
			...
			// added by udara 03-04-2014
			/*
			out.println("function running_contract_edit(m_applicaton_no) {");
		    out.println("document.Form1.hid_type.value=\"running_contract\"");
			out.println("document.Form1.SCREEN_NAME.value=\"EDIT\"");
			//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MK_sql_validations?chksql=m_prime_chk_LAKDL_AF_MK_Application_Process_running_contract_edit&data_val=\"+m_applicaton_no;");
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MK_sql_validations?chksql=m_prime_chk_LAKDL_AF_MK_Application_Process_running_contract_edit&data_val=\"+m_applicaton_no+\"&run_no=\"+m_run_no;");
      ...
      out.println("</Script>");
					...
					out.println("<INPUT TYPE='Hidden' NAME='hid_type_2' VALUE=\"\">"); // added by udara on 30-07-2013
					...
					out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Save\");'  onClick='save_window()' value=\"Save\"></td>");  //  check_vehicle_no
		      ...
		      out.println("</tr>"); 
			        ...
			        out.println("<option value='R' >Running Contract </option>"); // added by udara 19-02-2014
					out.println("<option value='H' >HADAGASMA </option>"); // added by kasun on 12-11-2024 for JB16102024-25600
					out.println("</select>");
					out.println("</td>");
					out.println("<td width='*%'>&nbsp;</td>"); 
					out.println("</tr>"); 
         	...
         	out.println("<table align='center' width='100%' class='table'>"); 
		      ...
		      out.println("</tr>"); 
			  	out.println("<tr>");  
			    out.println("<td width=\"100%\"><DIV ID='m_hadagasma'></DIV></td>"); // added by kasun on 12-11-2024 for JB16102024-25600
		      	out.println("</tr>"); 	
			    out.println("</table>");
		...
		if(m_chksql.equals("details")){ 
			String m_application_no = req.getParameter("APP_NO");
			  ...
			  if(more){
				...
				//out.println("</table >"); // udara 21-10-2014
				out.println(" </td > ");
				out.println(" </tr > ");
				...
				out.println("  <td width=\"10%\"  align='right'><b>Value of the Land</b></td> ");
				out.println("  <td width=\"1%\"  align='right'> &nbsp; </td> ");
				...
				//out.println("<table width=\"100%\"  align=\"left\" class=\"table\" border=\"0\"  cellpadding=\"2\"> "); // udara 21-10-2014
				...
				out.println("  <td width=\"15%\"  align='right'><b>Amount</b></td> ");
				out.println("  <td width=\"1%\"  align='right'> &nbsp; </td> ");
				...
				// out.println("</table >");			// commented by kasun on 14-11-2024
				out.println(" </td > ");
				out.println(" </tr > ");
				rs3.close();
			...
			//-------------added by kasun on 14-11-2024 for 	JB16102024-25600
			...
			out.println(" </tr > ");
			rs4.close();
			//-------------end by kasun on 14-11-2024 for 	JB16102024-25600
