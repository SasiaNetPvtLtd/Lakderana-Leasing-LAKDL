/*
	* 	created based on LAKDL_AF_MAS_save_client_creation_temp
	* 	2019-03-18
	*	Inesh
	*	JB15032019-07215
*/
...
public class LAKDL_AF_MAS_save_client_creation_temp_cms extends HttpServlet {
      ...
      String m_scr_name=(String)m_sn_methods.met_formdata(reqstr,"Hid_scr_name"); 
		...
		//individual
		  if(client_type.equals("I"))
				...
				for(int i=0;i<icountcredit;i++)
					  {
             				...
             				callstmt3.setString(1,m_client_code.trim());
								...
								{
								//callstmt3.setString(9,m_sn_methods.met_formdata(reqstr,"TXT_MONTHS"+i+""));
								callstmt3.setString(9,m_sn_methods.met_unformat_number(m_sn_methods.met_formdata(reqstr,"TXT_MONTHS"+i+""))); //added by nuwan de silva on 1-10-07
								}
			...
			//out.println("window.location.href='"+m_url+"/LAKDL_AF_MAS_display_client_creation';");
			
			if(m_save_close.equals("N")){
			out.println("window.location.href='"+m_url+"/"+m_client_name+"AF_MAS_display_client_creation_cms';");
			}
			else if(!m_save_close.equals("N")){
			out.println("window.location.href='"+m_url+"/"+m_client_name+"AF_MAS_display_client_creation_cms?close_status=Y';");
			}
