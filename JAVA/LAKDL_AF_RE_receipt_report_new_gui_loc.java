...
public class LAKDL_AF_RE_receipt_report_new_gui_loc extends javax.servlet.http.HttpServlet { 
		...
		try { 
			...
			if(m_chksql.equals("main_page")){
				...
				if(!m_branch_id.equals(""))
					...
					//location_query_part = " AND  "+m_schema_name+".AF_CO_GET_USER_LOCATION_RRN_3(A.ENT_USER,A.REC_NO) = '"+m_branch_id+"' "; // commented by udara 24-07-2018
				...
				if (m_location_code.trim().equals("ALL")) {
					...
					rs1= stmt1.executeQuery(" SELECT "+
						...
						//" ,DECODE(NVL(A.CLOSING_FLAG,'N'),'Y','Closing',DECODE(NVL(A.RENTAL_OTER_INVOICE,0),'0','Insurance','Rental')) N_TYPE "+ //added by udara 27-02-2014
						...
						" ,  NVL("+m_schema_name+".AF_CO_GET_REC_FIN_NO(A.REC_NO),"+m_schema_name+".AF_CO_GET_CLIENT_NIC(A.CLIENT_CODE)) FIN_OR_NIC "+
					...
					rs1= stmt1.executeQuery
						...
						" WHERE  A.REC_NO = B.REC_NO (+) "+//enable client reciepts 2017-09-025
				...
				out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report_new_gui_loc?chksql=load_receipts&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=\"+m_sort_col+\"&sort_by=\"+m_order_by_type+\"&user=&location_code=\"+m_location_code+\"&branch_id=\"+m_branch_id;"); // added by udara on 27-02-2013
				...
				if (m_location_code.trim().equals("ALL")) {
					...
					rs1= stmt1.executeQuery
						...
						" ,NVL(SUB_REC_NO,'-')"+ //added by kanishka on 03-07-2013  //14
						//" ,DECODE(NVL(RENTAL_OTER_INVOICE,0),'0','Insurance','Rental') N_TYPE "+ // 18
						//" ,DECODE(NVL(CLOSING_FLAG,'N'),'Y','Closing',DECODE(NVL(RENTAL_OTER_INVOICE,0),'0','Insurance','Rental')) N_TYPE "+ //added by udara 27-02-2014
						//" ,DECODE(NVL(CLOSING_FLAG,'N'),'Y','Closing','S','Stamp Duty','I','Documentation Charges','R','Refinance',DECODE(NVL(RENTAL_OTER_INVOICE,0),'0','Insurance','Rental')) N_TYPE "+ // added by udara 14-07-2015
				...
				if(more){
					...
					out.println("<td width='10%' style= cursor:hand; onclick=sort_data('FINANCE_NO_SORT') ><b>Finance No/s</b></td>"); // modified by udara on 03-12-2012
					out.println("<td width='6%' style= cursor:hand; onclick=sort_data('REG_NO') ><b>Reg No.</b></td>"); // udara 11-08-2014
					out.println("<td width='8%' style= cursor:hand; onclick=sort_data('REC_AMOUNT')  align='right'><b>Amount</b></td>");
				...
				if(!m_branch_id.equals("")){
					...
					rs1= stmt1.executeQuery(" "+
						...
						//" AND "+m_schema_name+".AF_CO_GET_USER_LOCATION_RRN_3(A.ENT_USER,A.REC_NO) = '"+m_branch_id+"' "+ // commented by udara 24-07-2018  // added by udara 02-12-2013
				...
				out.println("    m_order_by_type = 'ASC'; ");
				out.println("  }");
				//out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report?chksql=load_active_receipts&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=\"+m_sort_col+\"&sort_by=\"+m_order_by_type+\"&user="+m_user+"&location_code="+mm_location_code+"\";"); // commented by udara on 27-02-2013
				out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report?chksql=load_active_receipts&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=\"+m_sort_col+\"&sort_by=\"+m_order_by_type+\"&user="+m_user+"&location_code="+mm_location_code+"&branch_id=\"+m_branch_id;"); // added by udara on 27-02-2013
				//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_display_receipt_deposit_report1?chksql=MAIN&order_by=\"+m_sort_col+\"&sort_by=\"+m_order_by_type+\"&receipt_no="+m_receipt_no+"&deposite_no="+m_deposite_no+"&from_date="+m_from_date+"&to_date="+m_to_date+"\";");		
				out.println(" window.location.href=m_url;"); 
				out.println("}");
				...
				if(!m_branch_id.equals("")){
					...
					*/
					...
					rs1= stmt1.executeQuery(" "+
						...
						//" AND "+m_schema_name+".AF_CO_GET_USER_LOCATION_RRN(B.ENT_USER) = '"+m_branch_id+"' "+ // added by udara on 09-08-2013 // commented by udara 02-12-2013
						//" AND "+m_schema_name+".AF_CO_GET_USER_LOCATION_RRN_3(A.ENT_USER,A.REC_NO) = '"+m_branch_id+"' "+  // added by udara on 02-12-2013
						"   AND  A.REC_LOC = '"+m_branch_id+"' "+ // added by udara 24-07-2018
				...
				*/
				...
				out.println("    m_order_by_type = 'ASC'; ");
				out.println("  }");
				//out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report?chksql=load_receipts_cancel&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=\"+m_sort_col+\"&sort_by=\"+m_order_by_type;"); // commented by udara on 05-12-2012
				//out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report?chksql=load_receipts_cancel&location_code=\"+m_location_code+\"&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=\"+m_sort_col+\"&sort_by=\"+m_order_by_type;"); // added by udara on 05-12-2012
				out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report?chksql=load_receipts_cancel&location_code=\"+m_location_code+\"&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=\"+m_sort_col+\"&sort_by=\"+m_order_by_type+\"&branch_id=\"+m_branch_id;"); // added by udara on 27-02-2013
				//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_display_receipt_deposit_report1?chksql=MAIN&order_by=\"+m_sort_col+\"&sort_by=\"+m_order_by_type+\"&receipt_no="+m_receipt_no+"&deposite_no="+m_deposite_no+"&from_date="+m_from_date+"&to_date="+m_to_date+"\";");		
				out.println(" window.location.href=m_url;"); 
				out.println("}");
			...
			//Added by Dineth on 2008-09-29
				...
				*/
				...
				//out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report?chksql=load_receipts_return&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=\"+m_sort_col+\"&sort_by=\"+m_order_by_type+\"&location_code="+mm_location_code+"&user="+m_user+"\";");
			...
			//Added by Dineth on 16-06-2009
			  ...
			  m_location_code="";
				...
				//out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report?chksql=load_receipts_PDC&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=\"+m_sort_col+\"&sort_by=\"+m_order_by_type+\"&location_code="+mm_location_code+"&user="+m_user+"\";");
			...
			//End by Dineth on 16-06-2009
				...
				out.println("    m_order_by_type = 'ASC'; ");
				out.println("  }");
				//out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report?chksql=load_receipts_stdo&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=\"+m_sort_col+\"&sort_by=\"+m_order_by_type;"); // commented by udara on 03-12-2012
				//out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report?chksql=load_receipts_stdo&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=\"+m_sort_col+\"&sort_by=\"+m_order_by_type+\"&location_code="+mm_location_code+"&user="+m_user+"\";"); // added by udara on 03-12-2012
			...
			try{
				...
				out.println("Error:"+ostr.toString());
			}catch(Exception e){}
		}
		finally{
			if(out!=null){
