...
//--
//SCREEN NAME:SYSTEM ADMINISTRATION - TEAMS
//CREATED BY:
//DATE/TIME:
//NOTES:
...
public class LAKDL_AF_MAS_display_teams extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_teams&data_val=\"+obj.value;");
			...
			out.println("		document.Form1.action='"+m_class_url+"/LAKDL_AF_MAS_save_teams';");  
			...
			out.println("		if(confirm(\"Are You Sure?\")){ "); 
			out.println("		window.location.href='"+m_class_url+"/LAKDL_AF_MAS_display_teams';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("    m_help_message = \"m_help_msg_LAKDL_AF_MAS_display_teams\";"); 
	  	...
	  	out.println("		}"); 
			...
			out.println("<td width='30%' ><DIV id='DIV_TXT_TEAM_ID'  class=div_input>TEAM_ID *</DIV></td>"); 
			...
			out.println("<td width='30%' ><DIV id='DIV_TXT_TEAM_DESC'  class=div_input>TEAM_DESC *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_TEAM_DESC' maxlength='20' size='20'></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 

			out.println("<td width='30%' >TEAM_HEAD *</td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_TEAM_HEAD' maxlength='10' size='10'></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 

			out.println("<td width='30%' ><DIV id='DIV_TXT_DIVISION_CODE'  class=div_input>DIVISION_CODE *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_DIVISION_CODE' maxlength='10' size='10'></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 

			out.println("<td width='30%' >SUB_DIVISION_CODE *</td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_SUB_DIVISION_CODE' maxlength='10' size='10'></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("</table>"); 
			out.println("<br>"); 
