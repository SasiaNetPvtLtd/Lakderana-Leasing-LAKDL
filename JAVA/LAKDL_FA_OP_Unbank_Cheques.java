...
public class LAKDL_FA_OP_Unbank_Cheques extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Operation Process - Return Cheques Send to Client </TITLE>"); 
			out.println("</HEAD>"); 
     	...
     	out.println("		document.Form1.TXT_ADJ_DD.value=v_dd;");
   		...
   		out.println("   document.Form1.TXT_ADJ_YY.value=v_yy;");
			...
			//out.println("	if(validate_data()){"); //edit by malik on 17/2/2009
			out.println("		if(confirm(\"Are you sure you want to \"+m_sav_msg+\" ?\")){ ");
			out.println("			for (var i=0; i < document.Form1.elements.length; i++ ) {");
			out.println("				document.Form1.elements[i].disabled=false;");
			out.println("			}");
			//out.println("			if(validate_data()){"); //edit by malik on 17/2/2009
			out.println("				document.Form1.action='"+m_class_url+"/"+m_fschema_name+"FA_Save_unbank_Cheque';");  
			out.println("				document.Form1.submit();	"); 
			
			
			//out.println("			}"); //edit by malik on 17/2/2009
			//out.println("		}"); //edit by malik on 17/2/2009
			out.println("	}"); 
			out.println("} "); 
			...
			out.println("function check_unbank_cheques(m_num){");
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"FA_OP_Unbank_Cheques';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("	help_box.innerHTML=\" Operation Process - Return Cheques Send to Client - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\" Operation Process - Return Cheques Send to Client - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
      ...
      out.println("}");
			...
			out.println("function get_unbank_chq_details() {");
			out.println("		unbank_cheques_data.innerHTML=\"\";");
			//out.println("		if(validate_data()){");//edit by malik on 17/2/2009
			out.println("				m_url=\""+m_class_url+"/"+m_fschema_name+"FA_OP_Unbank_Cheques_details?chksql=LOAD_UNBANK_CHEQUES&CLIENT_CODE=\"+document.Form1.TXT_CLIENT_CODE.value+\"&FACILITY_NO=\"+document.Form1.TXT_FACILITY_NO.value;");	
			out.println("				load_interface(m_url,'NO');");
			//out.println("		}");//edit by malik on 17/2/2009
			out.println("}");
			
			out.println("function get_vector_normal(m_data){");
			out.println("		unbank_cheques_data.innerHTML=m_data;");
			out.println("}");
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Operation Process - Return Cheques Send to Client </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<input class='but_input' type='button' name='BUT_VIEW_MAIN' value=\"Display\" onClick=\"get_unbank_chq_details()\"></td>");
			out.println("</td>"); 
			out.println("</table>"); 
			out.println("<hr>");
			out.println("<DIV id='unbank_cheques_data'  class=div_input></DIV>");
