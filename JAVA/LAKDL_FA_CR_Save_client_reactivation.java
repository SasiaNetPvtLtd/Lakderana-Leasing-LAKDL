...
public class LAKDL_FA_CR_Save_client_reactivation extends HttpServlet {
  ...
  String reqstr;
	...
	public synchronized void  service(HttpServletRequest req, HttpServletResponse res)	throws IOException{
      ...
      String m_scr_name=(String)m_sn_methods.met_formdata(reqstr,"Hid_scr_name"); 
			...
			callstmt1=conn.prepareCall("BEGIN "+m_schema_name+".FA_CR_SAVE_CLIENT_REACTIVATION(:1,:2,:3,:4); END;");
	   	...
	   	out.println("<HTML><HEAD>");
			...
			out.println("window.location.href='"+m_url+"/"+m_fschema_name+"FA_CR_display_client_reactivation';");
