...
public class LAKDL_AF_MISF_invoice_report extends javax.servlet.http.HttpServlet {
    ...
    public synchronized void service(HttpServletRequest req, HttpServletResponse res) throws IOException {
        ...
        try {
            ...
            out.println("<html>");
            out.println("   <head>");
            out.println("       <title>Finance - Invoice Report</title>");
            out.println("   </head>");
            out.println("   <link REL='STYLESHEET' HREF='" + m_html_client_url + "/css/Asset_Financing_System.css' TYPE=\"text/css\">"); // CHANGE
            out.println("   ");
			...
			//out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_invoice_report_view?from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=ENT_USER,ENT_DATE&sort_by=ASC\";");
			out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_invoice_report_view?from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&branch_code=\"+document.Form1.TXT_LOCATION_CODE.value+\"&order_by=ENT_USER,ENT_DATE&sort_by=ASC\";");
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MISF_invoice_report';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("	help_box.innerHTML=\" Finance - Invoice Report - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\" Finance - Invoice Report \";"); 
			out.println("}"); 
			
            out.println("       function get_system_date() {");
            out.println("           document.Form1.hid_option.value = \"1\";");
            out.println("           m_url=\"" + m_class_url + "/" + m_fschema_name + "FA_CR_sql_validations?chksql=get_sys_date\";"); // CHANGE
			...
			out.println("}"); 
				...
				// ---added by minal on 26-12-2014 by #15198
				out.println("function help_update_brach() {"); 
	  	...
	  	out.println("					}");
            ...
            // out.println("                   </td>");        // Added By Samitha Kulatilaka On 2009-12-17
            // out.println("               </tr>");            // Added By Samitha Kulatilaka On 2009-12-17
            // out.println("           </table>");             // Added By Samitha Kulatilaka On 2009-12-17
            out.println("           ");
            ...
            out.println("</tr>"); 
            out.println("<tr>"); 
            out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Finance - Invoice Report </td>"); 
            out.println("</tr>"); 
            out.println("<tr>"); 
            ...
            out.println("<input class='but_input' type='button' name='BUT_HELP_MAIN_1' style=\"{width:110px;}\" value=\"View All Invoices\" onClick=\"makeRequest_detail()\">");
			...
			out.println("</td> ");
			 out.println("</tr>");
//            out.println("<td width='*%' ></td>");
			out.println("<tr>"); // added by minali on 26-12-2014 for #15198
			out.println("<td width='20%' ><DIV id='DIV_TXT_LOCATION_CODE'  class=div_input><b>Branch</DIV></td>"); 
			out.println("<td width='40%'><input class='txt_input' type='text' name='TXT_LOCATION_CODE' maxlength='10' size='10' style=\"{width:150px}\" >"); 
			out.println("<input class='but_input' type='button' name='BUT_HELP_MAIN' value=\"Help\" onClick=\"help_update_brach()\" ></td>");  
			out.println("</tr>"); 
