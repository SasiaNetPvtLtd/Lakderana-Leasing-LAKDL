...
public class LAKDL_AF_CR_display_credit_score_enter_2 extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			String m_score_mod_cod    = req.getParameter("mm_SCORE_MODEL_CODE");
			String m_final_app        = req.getParameter("mm_FINAL_APP_SCORE");
			String m_model_scr        = req.getParameter("mm_MODEL_SCORE");
			String m_comment          = req.getParameter("mm_COMMENTS");
			String m_score_model   ="SCORE";
			...
			out.println("}else if(obj==\"M2\"){");
	       // out.println("url=\""+m_class_url+"/"+m_fschema_name+"AF_CR_SCORE_validations?chksql=SCORE_DETAILS_EDIT&pre_stage1='ENTER'&model=\"+document.Form1.TXT_SCORE_MODEL_CODE.value+\"&application=\"+document.Form1.TXT_APPLICATION_NO.value;");
			out.println("url=\""+m_class_url+"/"+m_fschema_name+"AF_CR_SCORE_validations?chksql=SCORE_DETAILS_ENTER_EDIT&pre_stage1='ENTER'&model=\"+document.Form1.TXT_SCORE_MODEL_CODE.value+\"&application=\"+document.Form1.TXT_APPLICATION_NO.value;");// Add by Amila
		...
		//	out.println("url=\""+m_class_url+"/"+m_fschema_name+"AF_CR_SCORE_validations?chksql=SCORE_DETAILS_EDIT&pre_stage1='ENTER'&model=\"+document.Form1.TXT_SCORE_MODEL_CODE.value+\"&application=\"+document.Form1.TXT_APPLICATION_NO.value;");
			...
			out.println("document.Form1.BUT_HELP_MAIN_USER.disabled=true");
			
			//out.println("m_score_mod_cod "+m_score_mod_cod);
			out.println("document.Form1.TXT_SCORE_MODEL_CODE.value='"+mm_SCORE_MODEL_CODE+"'"); 
			out.println("document.Form1.TXT_SCORE_MODEL_CODE.disabled=true"); 
			out.println("document.Form1.BUT_HELP_UPDATE.disabled=true");	
			out.println("document.Form1.TXT_TOTAL_SCORE_APP.value='"+mm_FINAL_APP_SCORE+"'");
			out.println("document.Form1.TXT_TOTAL_SCORE.value='"+mm_MODEL_SCORE+"'");
			out.println("document.Form1.TXT_COMMENTS.value='"+mm_COMMENTS+"'");
			...
			//out.println("document.Form1.button_view.disabled=true");
			//out.println("document.Form1.button_save.disabled=true");
			//out.println("document.Form1.button_help.disabled=true");
			//out.println("document.Form1.button_cancel.disabled=true");
			//out.println("document.Form1.button_close.disabled=true");
			
			out.println("document.getElementById('hide_new').style.visibility = 'hidden'");
			out.println("document.getElementById('hide_edit').style.visibility = 'hidden'");
			out.println("document.getElementById('hide_del').style.visibility = 'hidden'");
			out.println("document.getElementById('hide_view').style.visibility = 'hidden'");
			out.println("document.getElementById('hide_save').style.visibility = 'hidden'");
			out.println("document.getElementById('hide_help').style.visibility = 'hidden'");
			out.println("document.getElementById('hide_cancel').style.visibility = 'hidden'");
			out.println("document.getElementById('hide_close').style.visibility = 'hidden'");
			...
			out.println("</script>"); 
			out.println("<BODY class='body & txt-body' leftmargin='1' topmargin='10' marginwidth='0' onload=\"load_lock();makeRequest('M2');\">"); 
			...
			out.println("<tr><td width='10%' align='center'><input name=\"button_new\"  id=\"hide_new\"  type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"New\");' onclick='load_screen_status(\"NEW\")' value=\"New\"></td>");  
			out.println("<td width='10%' align='center'><input name=\"button_edit\" id=\"hide_edit\"  type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Edit\");' onClick='load_screen_status(\"EDIT\")' value=\"Edit\"></td>");  
			out.println("<td width='10%' align='center'><input name=\"button_del\"  id=\"hide_del\"   type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Delete\");' onClick='load_screen_status(\"DELETE\")' value=\"Delete\"></td>");  
			out.println("<td width='10%' align='center'><input name=\"button_view\" id=\"hide_view\"  type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"View\");' onClick='load_view_score();load_screen_status(\"VIEW\")' value=\"View\"></td>");  
			out.println("<td width='10%' align='center'></td>");  
			out.println("<td width='6%'></td>");  
			out.println("<td width='10%' align='center'><input name=\"button_save\"   id=\"hide_save\" type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Save\");'  onClick='save_window()' value=\"Save\"></td>");  
			out.println("<td width='10%' align='center'><input name=\"button_help\"   id=\"hide_help\"  type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Help\");' onClick='load_screen_status(\"HELP\")' value=\"Help\"></td>");  
			out.println("<td width='10%' align='center'><input name=\"button_cancel\" id=\"hide_cancel\" type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Cancel\");'  onclick='clear_window()' value=\"Cancel\"></td>");  
			out.println("<td width='10%' align='center'><input name=\"button_close\"  id=\"hide_close\"  type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Close\");'  onclick='close_window()' value=\"Close\"></td>");  
