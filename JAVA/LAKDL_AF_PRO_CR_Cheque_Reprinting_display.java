/*
 * SCREEN NAME  : Credit Process - Cheque Re-Print
...
public class LAKDL_AF_PRO_CR_Cheque_Reprinting_display extends HttpServlet {
    ...
    public synchronized void service(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) throws IOException {
        ...
        try {
          ...
          //  process_status_get = "APPRO2";
            process_status_get="('DISBRS','PRINT')";
            ...
            if (m_chksql.equals("main_page")) {
                ...
                out.println("<html>");
                out.println("   <head>");
                out.println("       <title>Finance - Cheque Re-Printing</title>");
               ...
               /* out.println("function get_vector(data_vec) {");
                ...
                out.println("               document.getElementById('help_box').innerHTML = 'Finance - Cheque Re-Printing - ' + m_val;");
                out.println("           }");
                
                
                out.println("           function load_roll_out_value() {");
                out.println("               document.getElementById('help_box').innerHTML = 'Finance - Cheque Re-Printing - ' + document.getElementById('hid_status').value;");
                out.println("           }");
                ...
                out.println("               m_url = '" + m_class_url + "/" + m_fschema_name + "AF_PRO_CR_Cheque_Reprinting_display?chksql=load_data&bank_account_no=' + bank_account_no;");
                ...
                out.println("                   document.Form1.action = '" + m_class_url + "/" + m_fschema_name + "AF_PRO_CR_Cheque_RePrinting_save';");
                ...
                out.println("                                       </tr>"); 
                out.println("                                       <tr>"); 
                out.println("                                           <td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Finance - Cheque Re-Printing - New</td>"); 
                out.println("                                       </tr>"); 
                out.println("                                       <tr>"); 
                ...
                */
                ...
                sql = " " +
                    ...
                    "   AND    B.PROCESS_STATUS IN " + process_status_get + " " +
                    "   AND    B.LIC_ACC_NO = '" + bank_account_no + "' " +
                    "   AND    A.ENTRY_TYPE = 'V' " +
                    "   AND    B.GROUP_PAYMENT_NO IS NOT NULL " +
                    "   GROUP BY B.GROUP_PAYMENT_NO, " + // "   GROUP BY B.PAYMENT_NO, " +
                    "            B.PAYEE_NAME, " +
                    "            B.SETTLE_MODE " +
                    ...
                    "   WHERE  A.PROCESS_STATUS IN " + process_status_get + " " +
				...
				*/
                ...
                while (resultSet.next()) {
                    ...
                    if (j == 1) {
						...
						out.println("<td width=\"4%\" style=\"text-align: center;\">A/C Payee Only</td>"); // added by udara 22-07-2015
                    ...
                    out.println("<td style=\"text-align: center;\"><input class=\"txt_input\" type=\"text\" name=\"TXT_CHEQUE_NO_"+j+"\" id=\"TXT_CHEQUE_NO_"+j+"\" /></td>");
					...
					out.println("<td style=\"text-align: center;\"><input type=\"checkbox\" name=\"chkbox_acc_payee"+j+"\" id=\"chkbox_acc_payee"+j+"\"   onclick=\"change_acc_payee(this);\" /></td>"); // added by udara 22-07-2015
