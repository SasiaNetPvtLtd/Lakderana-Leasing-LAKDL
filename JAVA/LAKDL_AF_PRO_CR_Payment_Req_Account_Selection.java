...
public class LAKDL_AF_PRO_CR_Payment_Req_Account_Selection extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
		  ...
		  nf.setMaximumFractionDigits(0);
			...
			//double m_total_settle=0;
			//double m_initial_bal=0;
			//double m_paid_amt=0;
		  ...
		  out.println("load_interface(m_url,'XML');");
			...
			out.println("m_url='"+m_class_url+"/"+m_fschema_name+"AF_CO_Followup?chksql=main_page&scr_name=AF_CR_PRO_PAYMENT_REQ_ACOOUNT_SELECT&status=Y&Followu_no='+document.Form1.elements[m_fol_no].value;"); //modified by nuwan de silva on 17-10-07--------
      ...
      out.println("continue;");
       ...
       out.println("continue;");
    	 ...
    	 out.println("m_writedata+'</table>';");
			...
			out.println("function check_value() {"); //this function addded by ashini on 06.03.208
			out.println("if(parseFloat(unformat_noobject(document.Form1.TXT_GROSS_AMT.value))<parseFloat(unformat_noobject(document.Form1.TXT_WHT_AMT.value))){");
			out.println("alert('Withholding Tax amount cannot be greater than Gross amount');");
			out.println("document.Form1.TXT_WHT_AMT.value=\"0\" ; ");
			out.println("}");
			out.println("else{");
		//	out.println("alert('5623');");
			out.println("document.Form1.TXT_NET_AMT.value=parseFloat(unformat_noobject(document.Form1.TXT_GROSS_AMT.value)) -parseFloat(unformat_noobject(document.Form1.TXT_WHT_AMT.value))  ;");
			//out.println("document.Form1.TXT_NET_AMT.value=format_num(m_gross_payment,4) ;");
			out.println("}");
			out.println("}");
		  ...
		  out.println("	if(m_cond_status==1 && document.Form1.SCREEN_NAME.value==\"NEW\" ){");
			...
			*/
			...
			out.println("alert('Please enter account number')");
		 ...
		 //out.println("else{");
		  ...
		  out.println("	if(m_cond_status==1 && document.Form1.SCREEN_NAME.value==\"NEW\" ){");
			...
			*/
			...
			//out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_PRO_CR_Payment_Req_Account_Selection?PAY_NO="+m_pay_no+"&APP_NO="+m_application_no+"&BAL="+m_balance+"&VALUE_DATE="+m_value_date+"&SUS_REF_NO="+m_sus_ref+"&REF_NO="+m_ref+"&chksql1="+m_status1+"';"); 
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_PRO_CR_Payment_Req_Account_Selection?PAY_NO="+m_pay_no+"&APP_NO="+m_application_no+"&TOT_SET="+m_total_settle+"&INIT_BAL="+m_initial_bal+"&BAL="+m_balance+"&PAID_AMT="+m_paid_amt+"&VALUE_DATE="+m_value_date+"&SUS_REF_NO="+m_sus_ref+"&REF_NO="+m_ref+"&chksql1="+m_status1+"';");  //modified by nwuan de silva on 08-10-07
			out.println("		}"); 
			out.println("}"); 

			out.println("function new_window(){	"); 
			//out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_PRO_CR_Payment_Req_Account_Selection?PAY_NO="+m_pay_no+"&APP_NO="+m_application_no+"&BAL="+m_balance+"&VALUE_DATE="+m_value_date+"&SUS_REF_NO="+m_sus_ref+"&REF_NO="+m_ref+"&chksql1="+m_status1+"';"); 
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_PRO_CR_Payment_Req_Account_Selection?PAY_NO="+m_pay_no+"&APP_NO="+m_application_no+"&TOT_SET="+m_total_settle+"&INIT_BAL="+m_initial_bal+"&PAID_AMT="+m_paid_amt+"&BAL="+m_balance+"&VALUE_DATE="+m_value_date+"&SUS_REF_NO="+m_sus_ref+"&REF_NO="+m_ref+"&chksql1="+m_status1+"';");  //modified by nwuan de silva on 08-10-07
			out.println("}"); 
			out.println(""); 
			out.println(""); 
			...
			out.println("help_box.innerHTML=\" Finance - Payment Requsition Payment Enter - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" Finance - Payment Requsition Payment Enter - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
			...
			*/
			...
			//added by nuwan de silva on 08-10-07------------------------------
      ...
      */
			...
			*/
			...
			/*out.println("function help_button_5(row) {"); 
			out.println("    m_row_no=row;"); 
			out.println("    m_ac_no=\"TXT_ACC_NO_\"+row;"); 
			out.println("    document.Form1.hid_help_type.value=\"5\";"); 
			out.println("    m_sql = \"m_help_TXT_ACCOUNT_2_sql\";"); 
			out.println("    m_criteria = document.Form1.elements[m_ac_no].value+\"@Y@\";"); 
			out.println("    HelpBox('1','10','0');"); 
			out.println("}"); 
			
			out.println("function help_value_assign_5(oBj) {"); 
			out.println("    m_ac_no=\"TXT_ACC_NO_\"+m_row_no;"); 
			out.println("    m_br_name=\"TXT_BRANCH_NAME_\"+m_row_no;"); 
			out.println("    m_br_code=\"hid_TXT_BRANCH_CODE_\"+m_row_no;"); 
			out.println("    document.Form1.elements[m_ac_no].value=oBj.valout[2];"); 
			out.println("    document.Form1.elements[m_br_code].value=oBj.valout[3];");  
			out.println("    document.Form1.elements[m_br_name].value=oBj.valout[4];");
			out.println("}"); 
			*/
      ...
      out.println("  else if(document.Form1.hid_cal_date.value=='6'){"); 
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_PRO_CR_Payment_Req_Main_Screen?screen_type=NEW&sql=main_page&status_new=NEW&chksql=R&chksql2=B&st_c=APPLICATION_NO&oby=ASC';");
			out.println("}");
			out.println("}");
		  ...
		  out.println("if(m_cond_status==1){");
			...
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_CR_PRO_Payment_Requsion_Document_Follow_up?chksql=main_page&client_code="+m_client+"&value_date="+m_value_date+"&application_no="+m_application_no+"&screen_name=account_selection&payment_no="+m_pay_no+"&type=\"+m_type+\"\";");
...
//------------------------------------------------------------------------------------------------------------------------------
			...
			out.println("<INPUT TYPE='Hidden' NAME='Hid_scr_name' VALUE=\"AF_CR_PRO_PAYMENT_REQ_ACOOUNT_SELECT\">");  //AF_CR_PRO_PAYMENT_REQ_ACOOUNT_SELECT //AF_CR_PRO_PAYMENT_REQ_MAIN
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Finance - Payment Requsition Payment Enter</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
		...
		boolean more=rs.next();
			...
			out.println("<input type=hidden name=TXT_FINANCE_NO value="+rs.getString(4)+" >");
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 
			out.println("<td width='30%' ><DIV id='TXT_APP_NAME'  class=div_input>Name of the Applicant</DIV></td>"); 
			out.println("<td width='40%' style= \"cursor:hand;cursor-color:blue\" onclick=\"show_client('"+rs.getString(2)+"')\"><U>"+rs.getString(3)+"<input class='txt_input' type='hidden' value="+rs.getString(2)+"  name='TXT_CLIENT_CODE'></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			}
		 ...
		 " NVL(TAX_INV_NO,'-'), NVL(TO_CHAR(TAX_INV_DATE,'DD-MM-YYYY'),'-') "+	
      ...
      String m_tax_inv_date="";
     	...
     	out.println("<tr class=tr_input1 >");
			...
			out.println("<td align=\"left\"><input class='txt_input' type='text' name='TXT_ACC_NO' style=\"{width:90px;}\" maxlength='20' size='10' onblur=\"check_account(this)\">"); 
		  out.println("<input class='but_input' type='button' name='BUT_TXT_ACC_NO' value=\"Help\" onClick=\"help_button_5()\"></td>"); 
			...
			out.println("<td align=\"right\">"+nf.format(rs2.getDouble(3))+"<input class='txt_input' type='hidden' name='TXT_GROSS_AMT' style=\"{text-align:right; width:75px;}\" maxlength='20' size='10'  VALUE=\""+nf.format(rs2.getDouble(3))+"\"></td>"); //addded by ashini on 06.03.208
		  out.println("<td align=\"right\"><input class='txt_input' type='text' name='TXT_WHT_AMT' style=\"{text-align:right; width:75px;}\" maxlength='20' size='10' value=\""+nf.format(0.00)+"\" onblur=\"format_num(document.Form1.TXT_WHT_AMT,4);check_value()\" >"); //addded by ashini on 06.03.208
		  out.println("<td align=\"right\"><input class='txt_input' type='text' name='TXT_NET_AMT' style=\"{text-align:right; width:75px;}\" maxlength='20' size='10'  VALUE=\""+nf.format(rs2.getDouble(3))+"\" disabled >"); //addded by ashini on 06.03.208
			out.println("</tr >"); 
			a=a+1;
			}
			...
			int f=0;
			int j=0;
      // COMMENT BY NUWAN DE SILVA ON 01-02-2008 -----------------------------------------------------
		 ...
		 "AND UPPER(APPLICATION_NO)=UPPER('"+m_application_no+"') ");
			...
			out.println("<tr></tr>"); 
      out.println("<tr>");  
			out.println("<td  width='20%' align=\"left\" ><b>Tax Invoice No:</td><td width='20%' align=\"left\" style= \"cursor:hand;cursor-color:blue\" ><input value=\""+m_tax_inv_num+"\" class='txt_input'  maxlength='30' type='hidden' name=TXT_TAX_INVOICE_NO disabled ><B>: "+m_tax_inv_num+"</B></td>"); 
			out.println("<td  width='20%' align=\"left\" ><b>Date:</td><td width='20%' align=\"left\" style= \"cursor:hand;cursor-color:blue\" ><input value=\""+m_tax_inv_date+"\" class='txt_input'  maxlength='30' type='hidden' name=TXT_TAX_INV_DATE disabled ><B>: "+m_tax_inv_date+"</B></td>");
			out.println("</tr>"); 
      out.println("<tr></tr>");
			out.println("<tr></tr>"); 
        ...
        "                                 AND (FROM_SCREEN_NO <= (SELECT POSITION FROM "+m_schema_name+".CO_CO_MAS_USER_SCREEN  "+
				"	                                                    WHERE DIVISION_CODE='AF' AND SCREEN_NAME='AF_CR_PRO_PAYMENT_REQ_MAIN' "+
        "                                                         )  "+
        ...
        "                                  ) order by STATUS ");
     	...
     	out.println("<tr class=tr_input1 >");
			...
			"                                      FROM "+m_schema_name+".AF_CO_PRO_APPLICATION_DETAILS "+
			"                                       WHERE APPLICATION_NO=UPPER('"+m_application_no+"') ) "+
			"                  AND  CODE  IN (SELECT DOCUMENT_TYPE "+
			"                                    FROM "+m_schema_name+".AF_CR_PRO_APPLICANT_DOCUMENT "+
			"                                   WHERE APPLICATION_NO=UPPER('"+m_application_no+"') "+
			"                 AND  CLIENT_CODE=UPPER('"+m_client+"') "+
			"                 AND  PRO_INVOICE_NO IS NULL)) NEW_QUERY "+
		...
		//	"AND upper(C.OTHER_NO)=upper('"+m_sus_ref+"')  "+
     	...
     	out.println("<tr class=tr_input1 >");
			...
			out.println("<td align=\"center\" disabled >"+rs5.getString(3)+"</td>"); 
			out.println("<td align=\"center\" disabled >"+rs5.getString(4)+"</td>"); 
			...
			*/
			...
			out.println("<td width='10'><input class='but_input' type='button' name='MORE_BUT' value=\"Add\" onClick=\"add_row()\" disabled ></td>"); 
			out.println("</tr>");  
			out.println("<tr>");  
		  ...
		  out.println("</tr>"); 
			...
			out.println("<td width=\"30%\" style='{text-align:left;}' disabled >"+rs6.getString(7)+"</td>");
			out.println("<td width=\"20%\" style='{text-align:right;}'disabled >"+rs6.getString(2)+"</td>");
			out.println("<td width=\"10%\" style='{text-align:left;}' disabled >"+rs6.getString(3)+"</td>");
			out.println("<td width=\"10%\" style='{text-align:left;}' disabled >"+rs6.getString(4)+"</td>");
			out.println("<td width=\"10%\" style='{text-align:left;}' disabled >"+rs6.getString(5)+"</td></tr>");
