...
public class LAKDL_AF_RE_Insur_Officer_Assign extends javax.servlet.http.HttpServlet {
    ...
    //    out.println("   m_obj.focus();");
        out.println("}");
          ...
          out.println("'<td  width=\"10%\" align=\"left\" style= cursor:hand; title=\"Click here to sort by - Finance No  \"    onclick=sort_data(\"FINANCE_NO\") ><B>Finance No</td>'+");
				...
				//out.println("'<td  width=\"10%\" align=\"left\"><B><u>Facility No</u></td>'+");
					...
					out.println("'<td  width=\"15%\" align=\"left\" style={width:120px;}><B>Insurance Officer</td>'+");
          ...
          out.println("'<td  width=\"10%\" align=\"left\" style= cursor:hand; title=\"Click here to sort by - Finance No  \"    onclick=sort_data(\"FINANCE_NO\") ><B>Finance No</td>'+");
					...
					out.println("'<td  width=\"12%\" align=\"center\" style={width:120px;}><B>Insrance Officer</td>'+");
					//out.println("'<td  width=\"5%\" align=\"center\"></td>'+");
     	...
     	out.println("}");
			...
			out.println("    document.Form1.TXT_PRV_OFFICER.value  = oBj.valout[3] +'.'+ oBj.valout[4] +' '+oBj.valout[5];");
			...
			out.println(" document.Form1.TXT_NEW_OFFICER.value  = oBj.valout[3]+'.'+oBj.valout[4]+' '+ oBj.valout[5] ;");
			...
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_sql_validations?chksql=m_prime_chk_insurance_officer_edit&client_code=\"+document.Form1.TXT_CLIENT_CODE.value+\"&sort_column=\"+m_sort_column+\"&order_by_type=\"+m_order_by_type+\"&ac_status=ACTIVATED\";"); //modified by nuwan de silva 11-03-2009
			out.println("load_interface(m_url,'XML');");
			out.println("}"); 
			...
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_sql_validations?chksql=m_prime_chk_LAKDL_AF_RE_Ins_Officer_Assign_Data&col_officer=\"+document.Form1.TXT_COLL_OFFICER.value+\"&sort_column=\"+m_sort_column+\"&order_by_type=\"+m_order_by_type+\"&ac_status=ACTIVATED\";");
			out.println("load_interface(m_url,'XML');");
			out.println("}"); 
		  ...
		  out.println("}"); 
			...
			*/
			...
			out.println("}");		
					...
					out.println("	else{");
					//      	out.println("<tr class=\"tr_input\" >");
					out.println("m_writedata='<TR class=\"tr_input\">'+m_app_no+m_client_code+m_inq_no+m_fin_no+m_total_finance+m_cur_finance+m_ass_officer+m_officer+m_remark+'</TR>'+m_hid_input;"); 
					out.println("	}");
					//   out.println("m_writedata='<TR>'+m_app_no+m_client_code+m_inq_no+m_fin_no+m_total_finance+m_cur_finance+m_officer+'</TR>'+m_hid_input;"); 
		...
		//--------------------------------------------------------------------------		
		  ...
		  out.println("function assignState(val){");
			...
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_sql_validations?chksql=m_prime_chk_LAKDL_AF_RE_Insu_Officer_Assign_Ind&client_code=\"+document.Form1.TXT_CLIENT_CODE.value+\"&sort_column=\"+m_sort_column+\"&order_by_type=\"+m_order_by_type+\"&ac_status=ACTIVATED\";");
			out.println("load_interface(m_url,'XML');");
			out.println("}");	
			...
			out.println("}");
			out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_RE_Save_Insurance_Officer_Assign';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_RE_Insur_Officer_Assign';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("help_box.innerHTML=\" Collection - Assign Insurance Officer - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" Collection - Assign Insurance Officer - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
		...
		//	out.println("window.open(m_url);");
			...
			*/
			...
			out.println("if(document.Form1.hid_chk_status.value==\"G5\"){");
			out.println(" if (document.Form1.SCREEN_NAME.value=='NEW'){ ");
			...
			out.println("if (document.Form1.SCREEN_NAME.value=='NEW'){ ");
			out.println("get_Application_numbers('APPLICATION_NO','ASC')	");
			out.println("}");
			out.println(" if (document.Form1.SCREEN_NAME.value=='EDIT'){ ");
			out.println("show_data_by_finanace_no('APPLICATION_NO','ASC');"); 
			out.println("}");	
			out.println("}");
			...
			out.println("        '<td width=\"19%\" ><DIV id=DIV_TXT_CLIENT  class=div_input>Client Code</DIV></td>'+"); 
			out.println("        '<td width=\"30%\" ><input class=txt_input type=text name=TXT_CLIENT_CODE maxlength=15 size=15 onblur=assignState(\"G4\"),makeRequest1(this)>&nbsp;&nbsp;'+"); 
			...
			out.println("m_write='<tr >'+"); 
			out.println("        '<td width=\"20%\" ><DIV id=DIV_TXT_COLL_OFFICER  class=div_input>Insurance Officer</DIV></td>'+"); 
			...
			out.println("        '<input class=but_input type=button text-align=center name=BUT_HELP_COLL_OFFICER value=\" Help \" onClick=\"help_button_user_col()\"></td>'+"); 
			out.println("        '<td width=\"*%\"><input type=text class=txt_input style=\"border:none;width=500;font:bold;color:black;\" name=\"TXT_PRV_OFFICER\" value=\"\" ></td>'+"); 
			out.println("        '</tr>';"); 
			
			out.println("m_write1='<tr >'+"); 
			out.println("        '<td width=\"20%\" ><DIV id=DIV_TXT_NEW_COLL_OFFICER  class=div_input>New Insurance Officer</DIV></td>'+"); 
			...
			out.println("        '<input class=but_input type=button text-align=center name=BUT_HELP_NEW_COLL_OFFICER value=\" Help \" onClick=\"help_button_user_col_new()\" disabled></td>'+"); 
			out.println("      '<td width=\"*%\"><input type=text class=txt_input style=\"border:none;width=500;font:bold; color:blue;\" name=\"TXT_NEW_OFFICER\" value=\"\" ></td>'+"); 
			out.println("        '</tr>';"); 
			
			out.println("m_write2='<tr >'+"); 			
			out.println("        '<td width=\"19%\" ><DIV id=DIV_TXT_REMARK_NEW class=div_input>Remark</DIV></td>'+"); 
      ...
      out.println("</Script>");
			    ...
			    out.println("<INPUT TYPE='Hidden' NAME='hid_no_rec' VALUE=\"\">"); 
					out.println("<INPUT TYPE='Hidden' NAME='Hid_scr_name' VALUE=\"AF_RE_INSURANCE_ASSIGN\">"); 
					...
					out.println("</tr>"); 
					out.println("<tr>"); 
					out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Collection - Assign Insurance Officer - New</td>"); 
					out.println("</tr>"); 
					out.println("<tr>"); 
					...
					out.println("<tr >"); 
					out.println("<td width='19%' >Assign Type</td>"); 
					...
					out.println("<table align='center' width='100%' class='table' border=0 cellspacing=0 cellpadding=0 >"); 
					out.println("<tr>");  
			    out.println("<td ><DIV ID='m_table_main'></DIV></td>"); 
		      out.println("</tr>"); 
					out.println("</table>");  
