...
public class LAKDL_AF_MISF_Confirmation_Report_Detail_View extends javax.servlet.http.HttpServlet {
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)	throws IOException	{
		...
		try {
			...
			if (m_chksql.trim().equals("idle")) {
				...
				rs = stmt.executeQuery(" "+
					" SELECT "+
						...
						//" "+m_schema_name+".AF_CO_GET_UPLOAD_FILE_SIZE('"+m_finance_no+"','hirer_1','0') HIRER_1_FILE_ZIZE, "+ // 96 // added by udara 07-07-2015
						//" "+m_schema_name+".AF_CO_GET_UPLOAD_FILE_SIZE('"+m_finance_no+"','hirer_2','0') HIRER_2_FILE_ZIZE, "+ // 97 // added by udara 07-07-2015
						//" "+m_schema_name+".AF_CO_GET_UPLOAD_FILE_SIZE('"+m_finance_no+"','vendor','0') VENDOR_FILE_ZIZE, "+ // 98 // added by udara 07-07-2015
						//" "+m_schema_name+".AF_CO_GET_UPLOAD_FILE_SIZE('"+m_finance_no+"','introducer','0') INTRODUCER_FILE_ZIZE, "+ // 99 // added by udara 07-07-2015
						//" "+m_schema_name+".AF_CO_GET_UPLOAD_FILE_SIZE('"+m_finance_no+"','cr_book','0') CRBOOK_FILE_ZIZE "+ // 100 // added by udara 07-07-2015
				...
				String   m_REPORT_DATE_DD = ""; // added by udara 16-06-2015
				String   m_REPORT_DATE_MM = ""; // added by udara 16-06-2015
				String   m_REPORT_DATE_YY = ""; // added by udara 16-06-2015
				
				String   m_CONF_RPT_COMMENT = ""; // added by udara 30-06-2015
				
				String   m_HIRER_1_FILE_ZIZE = ""; // added by udara 07-07-2015
				String	 m_HIRER_2_FILE_ZIZE = "";  // added by udara 07-07-2015
				String	 m_VENDOR_FILE_ZIZE = "";  // added by udara 07-07-2015
				String	 m_INTRODUCER_FILE_ZIZE = "";  // added by udara 07-07-2015
				String	 m_CRBOOK_FILE_ZIZE = "";  // added by udara 07-07-2015
				String	 m_VALUATION_FILE_ZIZE = ""; // added by udara 11-09-2015
				String   m_ASSIGN_LETTER = ""; // added by udara 11-09-2015
				
				double m_BROKER_COMMISSION = 0; 
				
				String	 m_DELETION_FILE_SIZE = ""; // added by udara 07-10-2015
				
				String	 m_ITEM_CAT_CODE = ""; // added by udara 09-06-2017
				String	 m_ITEM_SUB_CAT  = ""; // added by udara 09-06-2017
				...
				*/
				...
				out.println("	 document.Form1.action=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Confirmation_Report_Detail_Save?view_status=view\";");
				...
				//out.println("	document.Form1.TXT_ENTRY_APPROVAL.value				=	 '"+nf.format(m_ENTRY_APPROVAL)+"';  ");
				...
				*/
				...
				//out.println("    document.Form1.TXT_ENTRY_APPROVAL.disabled = false; "); // commented by udara 24-04-2015
				...
				*/
				...
				//out.println("       document.Form1.TXT_CLOSING_STAT_APPROVALS.disabled = false; "); // added by udara 27-04-2015
				...
				*/
				...
				out.println("    check_nic_div(document.Form1.TXT_HIRER_CLI_TYPE.value, document.Form1.TXT_HIRER_NIC.value, document.Form1.TXT_HIRER_GENDER.value, document.Form1.TXT_HIRER_DOB.value, DIV_TXT_HIRER_NIC); "); // added by udara 24-04-2015
				...
				out.println("     var pattern = new RegExp(/[~`!#$%\\^&*+=\\-\\[\\]\\';,/{}|\\\":<>\\?]/); "); // var pattern = new RegExp(/[~`!#$%\^&*+=\-\[\]\\';,/{}|\\":<>\?]/);
				...
				*/
				...
				out.println("    }"); // added by udara 07-10-2015
				...
				out.println("<BODY   class='body & txt-body' LEFTMARGIN='0' TOPMARGIN='0' onload=\"on_load_data();view_button_enable();\" >"); //onload=\"on_load_data()\"
				out.println("<FORM NAME='Form1' method='post'>"); 
				
				out.println("<INPUT TYPE='Hidden' NAME='hid_finance_no' VALUE='"+m_finance_no+"' >"); // added by udara 06-03-2015
				out.println("<INPUT TYPE='Hidden' NAME='hid_generate_status' VALUE='M' >"); // added by udara 19-05-2015
				...
				out.println(" <input class='txt_input' type='text'   name='TXT_LEAD_SOURCE'      maxlength='200' size='20' style=\"width:250px;\" value='"+m_LEAD_SOURCE+"' >");
				out.println("</td>"); 
				...
				out.println("<td width='4%'>"); 
				//out.println(" <input class='txt_input' type='text'   name='TXT_CONF_RPT_COMMENT'      maxlength='200' size='20' style=\"width:250px;\" value='"+m_CONF_RPT_COMMENT+"' >");
				// added by udara 07-07-2015
				out.println(" <textarea rows=\"2\" cols=\"28\" name=\"TXT_CONF_RPT_COMMENT\" id=\"TXT_CONF_RPT_COMMENT\" wrap=\"hard\" maxlength=\"199\" value=\""+m_CONF_RPT_COMMENT+"\" onblur=\"comment_box_validate();\"  >");
				...
				*/
				...
				out.println("</td>");
				out.println("<td width='20%'></td>");
				//out.println("<td width='20%' ><DIV id='DIV_TXT_CONTRACT_BRANCH' class=div_input><b>IF 'YES' CONTRACT NUMBER</DIV></td>");
				//out.println("<td width='50%' ><input class='txt_input' type='text' name='TXT_CONTRACT_BRANCH' maxlength='200' size='10' ></td>"); 
				...
				out.println("<td width='4%' >");
				out.println("<input class='txt_input' type='hidden' name='TXT_NAME_1_HIRER_CODE' maxlength='200' size='20' style=\"width:200px;\" value='"+hirer_cli_code+"' >");
				out.println("<input class='txt_input' type='text'   name='TXT_NAME_1_HIRER'      maxlength='200' size='20' style=\"width:200px;\" value='"+hirer_cli_name+"' >");
				out.println("</td>"); 
			    ...
			    //out.println("<select class='txt_input' name='TXT_CONTRACT_NO_HIRE' >"); 
				//out.println("<option value='ALL'  > ALL </option>");
				//out.println("</select>");
				
				out.println("<input class='txt_input' type='text' name='TXT_CONTRACT_NO_HIRE' maxlength='200' size='10'  value='"+m_finance_no+"' >");
				...
				out.println("<td width='10%'></td>");
				out.println("<td width='4%' >");
			    out.println("<input class='txt_input' type='hidden' name='TXT_NAME_2_HIRER_CODE' maxlength='200' size='20' style=\"width:200px;\" value='"+hirer_co_app_code+"' >");
			    out.println("<input class='txt_input' type='text'   name='TXT_NAME_2_HIRER'      maxlength='200' size='20' style=\"width:200px;\" value='"+hirer_co_app_name+"' >"); // hirer_co_app_code
				out.println("<td width='21%'></td>");
				...
				out.println("<tr  height='25px'>");
				out.println("<td width='10%'></td>"); 
				out.println("<td width='9.9%' ><b>NIC NO 1</b></td>"); 
				out.println("<td width='10%'></td>");
				...
				out.println("<td width='20%'></td>"); 
				out.println("<td width='20%' ><DIV id='DIV_TXT_CONTACT_NO_HIRER' class=div_input><b>CONTACT NUMBER</b></DIV></td>"); 
				out.println("<td width='4%' ><input class='txt_input' type='text' name='TXT_CONTACT_NUMBER_HIRER' maxlength='200' size='10' value='"+hirer_cus_contact_no+"'  >"); 
				out.println("</tr>");
				...
				out.println("<td width='20%'></td>"); 
				out.println("<td width='20%' ><DIV id='DIV_TXT_ADDRESS_HIRER' class=div_input><b>ADDRESS</b></DIV></td>"); 
				out.println("<td width='4%' ><input class='txt_input' type='text' name='TXT_ADDRESS_HIRER' maxlength='200' size='10' style=\"width:250px;\" value='"+hirer_cus_address+"' >");  
				...
				out.println("<tr  height='25px'>");
				out.println("<td width='10%'></td>"); 
				out.println("<td width='4%'><b>PROVINCE</b></td>"); //(Select Province from drop down list)	
				out.println("<td width='9%'></td>");
				out.println("<td width='4%' >");
				...
				*/
				...
				out.println("<td width='4%' ><input class='txt_input' type='text' name='TXT_ADDRESS_HIRER' maxlength='250' size='10' style=\"width:310px;\" value='"+hirer_cus_address+"' ></td>"); 
				out.println("</tr>");
				...
				*/
				...
				else if(valuation_status.equals("N")){
					out.println("<option value='Y' > Yes </option>");
					out.println("<option value='N' selected > No </option>");
					out.println("<option value='P' > Pending </option>");
				}
				else if(valuation_status.equals("P")){
					out.println("<option value='Y' > Yes </option>");
					out.println("<option value='N' > No </option>");
				...
				rs = stmt.executeQuery(" "+
						" SELECT "+
							...
							" NVL(COLOUR,'-') "+
								...
								" WHERE APPLICATION_NO = '"+m_application_no+"' "+
								//" AND   ACTIVE_STATUS='Y' "+ // commented by udara 12-02-2016
								" AND   ACTIVE_STATUS IN ('Y','T') "+ // added by udara 12-02-2016
								" ");
				...
				*/
				...
				else if(hirer_nic_status.equals("N")){
					out.println("      <option value='Y' > Yes </option>");
					out.println("      <option value='N' selected > No </option>");
					out.println("      <option value='P' > Pending </option>");
				}
				else if(hirer_nic_status.equals("P")){
					out.println("      <option value='Y' > Yes </option>");
					out.println("      <option value='N' > No </option>");
					out.println("      <option value='P' selected > Pending </option>");
				}
				*/
				...
				while(rs.next()){
					...
					*/
					...
					else if(guarantor_nic_status.equals("N")){
						out.println("     <option value='Y' > Yes </option>");
						out.println("     <option value='N' selected > No </option>");
						out.println("     <option value='P' > Pending </option>");
					}
					else if(guarantor_nic_status.equals("P")){
						out.println("     <option value='Y' > Yes </option>");
						out.println("     <option value='N' > No </option>");
						out.println("     <option value='P' selected > Pending </option>");
					}
				...
				*/
				...
				else if(vender_nic_status.equals("N")){					
					out.println("      <option value='Y'  > Yes </option>");
					out.println("      <option value='N' selected > No </option>");
					out.println("      <option value='P' > Pending </option>");	
				}
				...
				// added by udara 18-05-2015
				/*
				out.println(" vender_nic_status : " + vender_nic_status);
				...
				*/	
				...
				//out.println(" <td> m_NIC_COPY_VENDOR : " + m_NIC_COPY_VENDOR + " </td> ");
			...
			//	out.println("<td width='6%'></td>");
				...
				out.println("<td width='4%' ><input class='txt_input' type='text' name='TXT_NIC_NO_1_VENDOR' maxlength='200' size='10' value='"+vendor_nic+"' >");  // added by udara 23-03-2015
				...
				out.println("<input class='but_input' type='button' name='BUT_UPLOAD_NIC_NO_INTRODUCER' value=\"Upload\" onClick=\"upload_nic('introducer','"+m_finance_no+"','"+m_lead_source_name+"',0);\"  >"); // added by udara 07-07-2015
				out.println("<input class='but_input' type='button' name='BUT_VIEW_NIC_NO_INTRODUCER' value=\"View\"   onClick=\"view_nic('introducer','"+m_finance_no+"','"+m_lead_source_name+"',0);\"    >"); // added by udara 07-07-2015
				out.println("</td>");
				
				// added by udara 11-09-2015
				out.println("<td width='1%'></td>");
				out.println("<td width='5%' ><b>BROKER COMMISSION</td>");
				out.println("<td  width='4%'> <input class='txt_input' type='text' name='TXT_BROKER_COMMISSION' maxlength='200' size='10' value='"+nf.format(0)+"' > </td>");
				...
				else if(cr_book_status.equals("N")){					
					out.println("      <option value='Y'  > Yes </option>");
					out.println("      <option value='N' selected > No </option>");
					out.println("      <option value='P' > Pending </option>");	
				}
				*/
				...
				// commented by udara 18-05-2015
				/*
				if(cr_book_status_copy.equals("P")){
					out.println("      <option value='Y' > Yes </option>");
					out.println("      <option value='N' > No </option>");
					out.println("      <option value='P' selected > Pending </option>");				
				}
				...
				else if(cr_book_status_copy.equals("N")){					
					out.println("      <option value='Y'  > Yes </option>");
					out.println("      <option value='N' selected > No </option>");
					out.println("      <option value='P' > Pending </option>");	
				}
				...
				*/
				...
				else if(delete_status.equals("N")){					
					out.println("      <option value='Y'  > Yes </option>");
					out.println("      <option value='N' selected > No </option>");
					out.println("      <option value='P' > Pending </option>");	
				}
				*/
				...
				// commented by udara 18-05-2015
				/*
				if(delete_copy_status.equals("P")){
					out.println("      <option value='Y' > Yes </option>");
					out.println("      <option value='N' > No </option>");
					out.println("      <option value='P' selected > Pending </option>");				
				}
				...
				else if(delete_copy_status.equals("N")){					
					out.println("      <option value='Y'  > Yes </option>");
					out.println("      <option value='N' selected > No </option>");
					out.println("      <option value='P' > Pending </option>");	
				}
				...
				*/
				...
				else if(rev_lic_status.equals("N")){					
					out.println("      <option value='Y'  > Yes </option>");
					out.println("      <option value='N' selected > No </option>");
					out.println("      <option value='P' > Pending </option>");	
				}
				*/
				...
				// commented by udara 18-05-2015
				/*
				if(rev_lic_copy_status.equals("P")){
					out.println("      <option value='Y' > Yes </option>");
					out.println("      <option value='N' > No </option>");
					out.println("      <option value='P' selected > Pending </option>");				
				}
				...
				else if(rev_lic_copy_status.equals("N")){					
					out.println("      <option value='Y'  > Yes </option>");
					out.println("      <option value='N' selected > No </option>");
					out.println("      <option value='P' > Pending </option>");	
				}
				...
				*/
				...
				else if(dup_key_status.equals("N")){					
					out.println("      <option value='Y'  > Yes </option>");
					out.println("      <option value='N' selected > No </option>");
					out.println("      <option value='P' > Pending </option>");	
				}
				*/
				...
				if(rs.next()){
						m_initial_charge_amnt = rs.getDouble(2);
				}
				...
				*/
				...
				//out.println("<td width='5%'> &nbsp; </td>");  
				out.println("<td width='4%'><input class='txt_input' type='text' name='TXT_PAID_1_INSURENCE' maxlength='200' size='10' value='"+nf.format(m_initial_charge_paid)+"' onblur='validate_number_text_boxes(this);set_initial_charges_insurance();set_cash_to_be_paid();' ></td>");
				
				//out.println("</td>");
				
				
				//out.println("<td width='5%'> &nbsp; </td>");  
				out.println("<td width='5%'><input class='txt_input' type='text' name='TXT_BAL_1_INSURENCE' maxlength='200' size='10' value='"+nf.format(m_initial_charge_bal)+"' onblur='validate_number_text_boxes(this);set_initial_charges_insurance();set_cash_to_be_paid();' ></td>");
				...
				//out.println("<td width='5%'> &nbsp; </td>");  
				out.println("<td width='4%'><input class='txt_input' type='text' name='TXT_PAID_2_INSURENCE' maxlength='200' size='10' value='"+nf.format(m_stamp_duty_paid)+"' onblur='validate_number_text_boxes(this);set_stamp_duty_charges();set_cash_to_be_paid();' ></td>");
				...
				//out.println("<td width='5%'> &nbsp; </td>");  
				out.println("<td width='4%'><input class='txt_input' type='text' name='TXT_PAID_3_INSURENCE' maxlength='200' size='10' value='"+nf.format(m_insur_charge_paid)+"' onblur='validate_number_text_boxes(this); set_insurance_charges_balance();set_cash_to_be_paid();' ></td>"); // set_insurance_charges();
				
				//out.println("</td>");
				
				
				//out.println("<td width='5%'> &nbsp; </td>");  
				out.println("<td width='5%'><input class='txt_input' type='text' name='TXT_BAL_3_INSURENCE' maxlength='200' size='10'  onblur='validate_number_text_boxes(this);set_insurance_charges_balance();set_insurance_charges();set_cash_to_be_paid();' ></td>");//(payment to be deducted) // value='"+nf.format(m_insur_charge_bal)+"'
			...
			//	out.println("<td width='5%'><input class='txt_input' type='text' name='TXT_INITAL_CHARGES' maxlength='200' size='10' ></td>");
				...
				out.println("<td width='4%' ><input class='txt_input' type='text' name='TXT_CAPITAL_APPROVALS' maxlength='200' size='10' onblur='validate_number_text_boxes(this);set_capital_values();' value='"+nf.format(m_capital_amount)+"' >"); 
				out.println("<td width='5%'> &nbsp; </td>"); 
				out.println("</tr>");
				...
				out.println("<td width='4%' ><input class='txt_input' type='text' name='TXT_INT_CHARGES_APPROVALS' maxlength='200' size='10' onblur='validate_number_text_boxes(this);set_initial_charges_insurance();' >"); 
				out.println("<td width='5%'> &nbsp; </td>"); 
				out.println("</tr>");
				...
				rs=stmt.executeQuery(" "+
								//" SELECT "+m_schema_name+".AF_CO_GET_CLOSE_REC_AMNT('"+m_re_fin_no+"') "+ // commented by udara 20-02-2017// m_finance_no
				...
				*/
				...
				out.println("<td width='4%' ><input class='txt_input' type='text' name='TXT_LESS_FIRST_RENT_APPROVAL' maxlength='200' size='10' onblur='validate_number_text_boxes(this);set_approval_values();' >"); 
				out.println("<td width='5%'> &nbsp; </td>"); 
				out.println("</tr>");
				...
				//out.println("<td width='2%'></td>");
				out.println("<td width='4%' ><input class='txt_input' type='text' name='TXT_F_RENTAL_APPROVALS' maxlength='200' size='10' onblur='validate_number_text_boxes(this);set_approval_values();set_cash_to_be_paid();' value='"+nf.format(0)+"' ></td>"); 
				out.println("<td width='5%'> &nbsp; </td>"); 
				out.println("<td width='5%'> &nbsp; </td>"); 
				out.println("<td width='5%'> &nbsp; </td>"); 
				out.println("<td width='5%'> &nbsp; </td>"); 
				...
				out.println("<td width='4%' ><input class='txt_input' type='text' name='TXT_CLS_STAT_APPROVAL' maxlength='200' size='10' onblur='validate_number_text_boxes(this);set_approval_values();' >"); 
				out.println("<td width='5%'> &nbsp; </td>"); 
				out.println("</tr>");
				...
				out.println("<td width='4%' ><input class='txt_input' type='text' name='TXT_OTHER_CHARGES_APPROVAL' maxlength='200' size='10' onblur='validate_number_text_boxes(this);set_approval_values();' >"); 
				out.println("<td width='5%'> &nbsp; </td>"); 
				out.println("</tr>");
				...
				out.println("<td width='4%' ><input class='txt_input' type='text' name='TXT_STAMP_DUTY_APPROVAL' maxlength='200' size='10' onblur='validate_number_text_boxes(this);set_stamp_duty_charges();' >"); 
				out.println("<td width='5%'> &nbsp; </td>"); 
				out.println("</tr>");
				//out.println("</table>");
				...
				//out.println("<td width='2%'></td>");
				//out.println("<td width='4%' ><input class='txt_input' type='text' name='TXT_ENTRY_APPROVAL' maxlength='200' size='10' onblur='validate_number_text_boxes(this);' value='"+nf.format(m_valuation_notes)+"' ></td>"); 
				out.println("<td width='4%' ><input class='txt_input' type='text' name='TXT_ENTRY_APPROVAL' maxlength='200' size='10' onblur='validate_number_text_boxes(this);' value='"+m_valuation_notes+"' ></td>"); // udara 24-04-2015
				out.println("<td width='10%'> &nbsp; </td>");
				out.println("<td width='10%' ><DIV id='DIV_TXT_INSU_CHARGES_APPROVALS' class=div_input><b>LESS INSURANCE CHARGES</b></DIV></td>"); 
				out.println("<td width='4%' ><input class='txt_input' type='text' name='TXT_INSU_CHARGES_APPROVALS' maxlength='200' size='10' onblur='validate_number_text_boxes(this);set_insurance_charges();' ></td>"); 
				out.println("<td width='5%'> &nbsp; </td>");
				out.println("</tr>");
				...
				out.println("<td width='10%'> &nbsp; </td>");
				out.println("<td width='9.9%' > &nbsp; </td>"); // <b>CHECKED BY</b>
				...
				*/
				...
				out.println("   <option value='BU'  > Buddhika Udayanga </option>");
				...
				out.println("   <option value='SN'  > Shiiraan Nooramith </option>");
				out.println("   <option value='DW'  > Dhammika Wijerathna </option>");
				...
				*/
											  ...
											  " APP_DATE, "+
												" REPORT_STATUS "+ // 7
													...
													" SELECT "+
															...
															"(SELECT NAME FROM "+m_schema_name+".CO_CO_MAS_USER  WHERE USER_ID=A.ENT_USER) APP_USER, "+ // 2//Added by Jithendra 06-12-2016 for SR#22273
				...
				out.println("<td width='5%'> &nbsp; </td>");  
				out.println("<td width='6%' ><input class='txt_input' type='number' name='TXT_DIRECTOR_NAME_CREDIT_CO' maxlength='200' size='10' value='-' ></td>"); 
				out.println("<td width='5%'> &nbsp; </td>");
				out.println("<td width='6%' ><input class='txt_input' type='number' name='TXT_SIGANTURE_CREDIT_CO' maxlength='200' size='10' value='-' ></td>"); 
				out.println("<td width='5%'> &nbsp; </td>");
				out.println("</tr>");
				
				
				String app_user_code = "";
				String app_user_name = "";
				
				rs = stmt.executeQuery(" "+
					" SELECT "+
						" APP_USER, "+  
						" "+m_schema_name+".AF_CO_GET_USER_NAME(APP_USER) "+ 
							" FROM "+m_schema_name+".AF_CONFIRMATION_REPORT "+
							" WHERE FINANCE_NO = '"+m_finance_no+"' "+
					" ");
				
				if(rs.next()){
					app_user_code = rs.getString(1);
					app_user_name = rs.getString(2);
				}
				...
				if(m_REPORT_STATUS.equals("APPROVED")){
					...
					out.println("<tr height='25px' >");
					out.println("<td width='5%'></td>");  
					out.println("<td width='6%' align='center' > "+app_user_name+" </td>"); 
					out.println("<td width='5%'> &nbsp; </td>");
			...
			System.out.println("Exception - uv - " + e.toString());
