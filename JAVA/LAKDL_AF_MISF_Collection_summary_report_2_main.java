...
public class LAKDL_AF_MISF_Collection_summary_report_2_main extends javax.servlet.http.HttpServlet { 
	...
	public  void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { // synchronized
		...
		try { 
			...
			if(m_chksql.equals("main_page")){ 
				...
				out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Collection_summary_report_2_report?chksql=print_report_new&date=\"+m_date+\"&active_status=\"+document.Form1.TXT_ACTIVE_STATUS.value+\"&region=\"+m_region;");	 // added by udara 07-04-2015
				out.println("			window.open(m_url);");
				out.println("	}");
				out.println("}");
