...
public class LAKDL_AF_MAS_display_vendor_creation_edit extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException {
		...
		//	out.println("m_lname=\"TXT_LAST_NAME_\"+i;"); // commented by ashini
			...
			out.println("m_city=\"TXT_CITY_CODE_\"+i;"); // added by udara 14-12-2016
			out.println("}");
		...
		//	out.println("if(document.Form1.elements[m_branch].value=='' || document.Form1.elements[m_loc_code].value=='' || document.Form1.elements[m_title].value=='' || document.Form1.elements[m_fname].value=='' || document.Form1.elements[m_lname].value=='' || document.Form1.elements[m_addr].value=='' || document.Form1.elements[m_city].value=='' || document.Form1.elements[m_tel].value==''){"); //Added by Chandana on 24/04/2007
			//out.println("if(document.Form1.elements[m_addr].value=='' || document.Form1.elements[m_tel].value==''){"); // commented by udara 14-12-2016 //Added by Chandana on 24/04/2007
			out.println("if(document.Form1.elements[m_addr].value=='' || document.Form1.elements[m_tel].value=='' || document.Form1.elements[m_city].value==''){"); // added by udara 14-12-2016
			...
			*/
			...
			out.println("}");
			out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_MAS_save_vendor_creation_edit?number='+parseInt(document.Form1.hid_no.value)+'';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MAS_display_vendor_creation_edit';"); 
			out.println("		}"); 
			out.println("}"); 
...
//-------------------------------------------------------------------------------------------------
	...
	/*********************************Added by Jithendra 21-10-2016****************************/
		...
		out.println("function makeRequest6(m_client,m_nic) {");
			...
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations4?chksql=m_prime_chk_LAKDL_AF_MAS_display_id_no_duplication_edit&data_val=\"+m_nic+\"&m_client=\"+m_client;");
			out.println("load_interface(m_url,'XML');");
			out.println("}");
			
			
		out.println("function nic_duplication_request(nic_obj) {");
        out.println("makeRequest6(document.Form1.TXT_VENDOR_CODE.value,nic_obj.value);");
      	out.println("}");
...
//		out.println("'<td width=\"40%\" ><input class=txt_input type=text name=TXT_ID_NO_'+j+' maxlength=\"10\" size=\"10\" value=\"+data_vec[i+11]+\" onblur=\"check_nic('+j+'),rem_lead_spaces('+j+'),makeRequest5('+j+'),check_id('+j+')\"></td>'+"); 
	...
	//----------------------------------------------------------------------------------------------------------		
			...
			out.println("</script>"); 
			out.println("<BODY class='body & txt-body' leftmargin='0' topmargin='0' marginwidth='0' ONLOAD=\"init(0),load_lock(),load_roll_value('Edit'),load_screen_status('EDIT')\" >"); // load_roll_value('New')
			...
			out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Edit\");' onClick='load_screen_status(\"EDIT\")' value=\"Edit\"  ></td>");  // added by udara 16-04-2015
			...
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_VAT_REG' maxlength='12' style='width: 200px' size='20' onblur=\"nic_duplication_request(this)\"></td>");  // ONBLUR FUNCTION ADDED BY KANCHANA FOR #19197 ON 2016-01-26
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			//----------------------------------------------------------
			out.println("<tr>"); 
