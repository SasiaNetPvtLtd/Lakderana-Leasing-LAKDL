...
public class LAKDL_AF_RE_Invoice_Print_Main extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
      ...
      out.println("			else {");
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_RE_Invoice_Print_Main?chksql=main_page';"); 
			out.println("		}"); 
			out.println("}"); 
