...
public class LAKDL_AF_RE_Save_Collection_Receipt_Document extends javax.servlet.http.HttpServlet {
   ...
   //   String m_username 						= "AA";//m_sn_methods.username;
      ...
      String m_receipt_no = req.getParameter("receipt_no");
			...
			String m_scr_name = req.getParameter("scr_name");
	    	  ...
	    	  callstmt=conn.prepareCall("BEGIN "+m_schema_name+".AF_RE_SAVE_PRINT_RECEIPT(:1,:2,:3); END;");
				
				  callstmt.setString(1,m_receipt_no);
			...
			out.println("window.location.href='"+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_RE_Receipt_Document?chksql=main_page&receipt_no="+m_receipt_no+"&client_no="+m_client_no+"&print=FALSE';");
