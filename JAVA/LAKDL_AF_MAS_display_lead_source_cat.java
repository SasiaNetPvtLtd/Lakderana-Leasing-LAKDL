...
//SCREEN NAME:SYSTEM ADMINISTRATION - LEAD SOURCE CATEGORY
...
public class LAKDL_AF_MAS_display_lead_source_cat extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>System Administration - Lead Source Categories</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("			}");
			out.println("if(data_vec.length > 0 && document.Form1.SCREEN_NAME.value!=\"NEW\"&& document.Form1.TXT_SOURCE_CODE.value !=''&& document.Form1.hid_help_status.value == 'H1' ){");
			...
			//out.println("				document.Form1.TXT_SOURCE_CODE.value='';");
			//out.println("       document.Form1.TXT_SOURCE_CODE.focus();");
			//out.println("				new_window();");
			out.println("			}");
			out.println("if(data_vec.length > 0 && document.Form1.SCREEN_NAME.value==\"NEW\"&& document.Form1.TXT_NAME.value !=''&& document.Form1.hid_help_status.value == 'H2' ){");
			out.println("				alert('Record already exists');");
			out.println("help_update_desc()");
			
			//out.println("				alert('Invalid Code,Use Help');");
			out.println("				document.Form1.TXT_NAME.value='';");
			out.println("       document.Form1.TXT_NAME.focus();");
			//out.println("				new_window();");
			out.println("			}");
			...
			//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_lead_source_cat&data_val=\"+obj.value+\"&ac_status=Y\";");
			//out.println("else");
			out.println("if(document.Form1.hid_help_status.value == 'H1' && document.Form1.SCREEN_NAME.value!=\"NEW\"){ ");
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_lead_source_cat&data_val=\"+obj.value+\"&ac_status=\"+document.Form1.hid_st.value;");
			out.println("}");
			out.println("if(document.Form1.hid_help_status.value == 'H1' && document.Form1.SCREEN_NAME.value==\"NEW\" ){ ");
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations1?chksql=m_prime_chk_LAKDL_AF_MAS_display_lead_source_cat_r&data_val=\"+obj.value;");
			out.println("}");
			out.println("load_interface(m_url,'XML');");
			out.println("}");
			
			out.println("function makeRequest1(obj) {");
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations1?chksql=m_prime_chk_LAKDL_AF_MAS_display_lead_source_cat_desc&data_val=\"+obj.value;");
			out.println("load_interface(m_url,'XML');");
			out.println("}");

      out.println("function assign_data(data_vec){ ");
			out.println("    document.Form1.TXT_SOURCE_CODE.value=data_vec[0];"); 
			...
			out.println("if(document.Form1.TXT_SOURCE_CODE.value==\"\"){  "); 
			out.println("DIV_TXT_SOURCE_CODE.style.color='red';");
			out.println("document.Form1.TXT_SOURCE_CODE.focus();"); 
			...
			out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_MAS_save_lead_source_cat';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MAS_display_lead_source_cat';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("    m_help_message = \"m_help_msg_LAKDL_AF_MAS_display_lead_source_cat\";"); 
			...
			out.println("help_box.innerHTML=\" System Administration - Lead Source Categories - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" System Administration - Lead Source Categories - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
      ...
      out.println(" }");
			...
			out.println("    m_sql = \"m_help_TXT_SOURCE_CODE_sql\";"); 
			out.println("    if(document.Form1.SCREEN_NAME.value==\"EDIT\" || document.Form1.SCREEN_NAME.value==\"DACT\"){ ");
			out.println("    m_criteria = document.Form1.TXT_SOURCE_CODE.value+\"@\"+\"Y@\";"); 
			out.println("    } ");
			out.println("    else{");
			out.println("    m_criteria = document.Form1.TXT_SOURCE_CODE.value+\"@\"+\"N@\";}"); 
			out.println("    HelpBox('1','10','0');"); 
			out.println("}"); 
      
			out.println("function help_update_desc() {"); 
			out.println("    document.Form1.hid_help_type.value=\"100\";"); 
			out.println("    m_sql = \"m_help_TXT_SOURCE_CODE_sql_desc\";"); 
			...
			out.println("    document.Form1.TXT_SOURCE_CODE.value=oBj.valout[2];"); 
	  	...
	  	out.println("		}"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>System Administration - Lead Source Categories</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<td width='30%' ><DIV id='DIV_TXT_SOURCE_CODE'  class=div_input>Lead Source Category Code *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_SOURCE_CODE' maxlength='10' size='10' onblur=\"assign_help_status('H1'),makeRequest(document.Form1.TXT_SOURCE_CODE)\">"); 
			out.println("<input class='but_input' type='button' name='BUT_HELP_MAIN' value=\"Help\" onClick=\"help_update()\" disabled></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 

			out.println("<td width='30%' ><DIV id='DIV_TXT_NAME'  class=div_input>Lead Source Category Description*</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_NAME' maxlength='50' size='50' onblur=\"assign_help_status('H2'),makeRequest1(document.Form1.TXT_NAME)\"></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 
