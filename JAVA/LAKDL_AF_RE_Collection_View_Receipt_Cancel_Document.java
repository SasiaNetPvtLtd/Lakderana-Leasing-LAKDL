...
public class LAKDL_AF_RE_Collection_View_Receipt_Cancel_Document extends javax.servlet.http.HttpServlet {
	...
	//		m_ac_status = req.getParameter("ac_status");
      ...
      out.println("			}");
	  	...
	  	out.println("		}"); 
			...
			out.println("    HelpBox('1','10','0',Crit,'Receipt_cancel','1');"); //Receipt_cancel
			out.println("}"); 
			out.println(""); 
		...
		//--------------------------------------------------------------------------		
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_RE_Collection_View_Receipt_Cancel_Document';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("help_box.innerHTML=\" Collection Process - Receipt Cancel Document - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" Collection Process - Receipt Cancel Document - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
			...
			out.println("}");
			out.println("else{");
			out.println("	m_url = \""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_RE_Receipt_Cancel_Document?chksql=main_page&receipt_no=\"+document.Form1.TXT_RECEIPT_NO.value+\"&print=TRUE\";"); 
      ...
      out.println("</Script>");
			    ...
			    out.println("<INPUT TYPE='Hidden' NAME='hid_no_rec' VALUE=\"\">"); 
					...
					out.println("</tr>"); 
					out.println("<tr>"); 
					out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Collection Process - Receipt Cancel Document</td>"); 
					out.println("</tr>"); 
					out.println("<tr>"); 
			    ...
			    out.println("<input class='but_input' type='button' name='BUT_TXT_RECEIPT_NO' value=\"Help\" onClick=\"help_receipt_no()\">"); 
					out.println("<input class='but_input' type='button' name='BUT_BCODE' value=\"View Receipt\" onClick=\"letter()\" style='{cursor:hand;}' style='{cursor:hand; width:120px;}'></td>"); 
					out.println("</tr>"); 
          out.println("</table>");          
				out.println("</form>");
				out.println("</body>");
