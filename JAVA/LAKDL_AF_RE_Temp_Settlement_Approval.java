...
public class LAKDL_AF_CR_PRO_Garan_facility_details extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
      ...
      String m_username 				 = m_sn_methods.username;
			...
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_Temp_Settlement_Approval?chksql=view&setle_mode=\"+document.Form1.SETT_MODE.value+\"&user=\"+document.Form1.TXT_USER.value+\" \";");
