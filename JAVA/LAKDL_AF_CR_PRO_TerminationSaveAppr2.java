...
public class LAKDL_AF_CR_PRO_TerminationSaveAppr2 extends HttpServlet {
		Connection conn;	
		String m_msg,m_url;
      	...
      	String m_username = m_sn_methods.username;
			  ...
			  String m_app_remark=m_sn_methods.met_formdata(reqstr,"APP_REMARK_"+j);//Added By SJ on 26-11-2008
				...
				if(m_chk_app.equals("Y")){
					callstmt=conn.prepareCall("BEGIN "+m_schema_name+".AF_CR_PRO_TERM_APPR2(:1,:2,:3,:4,:5,:6); END;");
			...
			out.println("window.location.href='"+m_url+"/"+m_client_name+"AF_CR_TerminationApproval2?chksql=main_page';");
