...
public class LAKDL_FA_OP_initial_cheque_return_reminder extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Operation Process - Cheque Return Reminders - Initial Cheque Return Reminder  </TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"FA_OP_PRO_rpt_cheque_return_reminder?chksql=LOAD_INITIAL_CHEQUE_RETURN_REMINDER\";");
  		...
  		out.println("		}");
   		...
   		out.println("		}");
			//out.println("	 alert(document.Form1.elements[chk].value)	");		
   		out.println("}"); 
			...
			out.println("			}");
			out.println("			if(validate_data()){"); 
			out.println("				document.Form1.action='"+m_class_url+"/"+m_fschema_name+"FA_OP_save_initial_cheque_return_reminder';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"FA_OP_initial_cheque_return_reminder';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("    m_help_message = \"m_help_msg_LAKDL_FA_OP_INITIAL_RETURN_REM\";"); 
			...
			out.println("	help_box.innerHTML=\"  Operation Process - Cheque Return Reminders - Initial Cheque Return Reminder  - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\" Operation Process - Cheque Return Reminders - Initial Cheque Return Reminder  \";"); 
			out.println("}"); 
	  	...
	  	out.println("					}"); 
			...
			out.println("function Generate_Letter2(m_return_no,m_debtor_code,m_client_code,m_receipt_no) {");	
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Operation Process - Cheque Return Reminders - Initial Cheque Return Reminder </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
