...
public class LAKDL_AF_RE_Clear_Credit_Bal_Termi_Contracts extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
		  ...
		  m_inv_type = req.getParameter("inv_type");
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Invoicing - Debit Note For Terminated Contracts </TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("    document.Form1.TXT_NET_AMOUNT.value=data_vec[4]*-1;"); 
			out.println("    document.Form1.HID_NET_AMOUNT.value=data_vec[4];"); 
		  out.println("    cal_tot_amount(document.Form1.TXT_NET_AMOUNT);");				
			out.println("			}");
			out.println("			else if(data_vec.length==0 && document.Form1.hid_help_status.value==\"finance_no\" && document.Form1.TXT_FINANCE_NO.value != \"\" ){");
			out.println("				help_finance(data_vec);"); 	
			out.println("			}");
			...
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_sql_validations?chksql=m_prime_chk_LAKDL_AF_RE_get_term_finance_no&data_val=\"+obj.value;");
      ...
      out.println("  if(document.Form1.hid_cal_date.value=='2'){"); 
		  ...
		  out.println("  else if(document.Form1.hid_cal_date.value=='1'){"); 	
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_RE_Clear_Credit_Bal_Termi_Contracts';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("help_box.innerHTML=\" Invoicing - Debit Note For Terminated Contracts - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 
    
			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" Invoicing - Debit Note For Terminated Contracts - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 			
	  	...
	  	out.println("		}");
			...
			out.println("    HelpBox('1','10','0',Crit,'FinanceSql_Termi','2');");
			//out.println("    HelpBox('1','10','0');"); 
			out.println("}"); 
			...
			out.println("    document.Form1.TXT_NET_AMOUNT.value=oBj.valout[7]*-1;"); 
			out.println("    document.Form1.HID_NET_AMOUNT.value=oBj.valout[7];"); 
		  out.println("cal_tot_amount(document.Form1.TXT_NET_AMOUNT);");
			out.println("}"); 
		  ...
		  out.println("   obj.value=format_noobject(obj.value); ");
			...
			out.println("		}");
			out.println("		m_tot = parseFloat(unformat_noobject(document.Form1.TXT_NET_AMOUNT.value)*-1) + parseFloat(unformat_noobject(document.Form1.TXT_VAT_AMOUNT.value)) ");
			out.println("   if(!isNaN(m_tot)){ ");
			out.println(" 	document.Form1.TXT_TOTAL_AMOUNT.value = m_tot*-1; ");
      ...
      out.println("function Onload_payee(){");//Added By Sandun on 24-12-2008
			...
			out.println("function check_amount(obj){");
			out.println("m_credit_balance = document.Form1.HID_NET_AMOUNT.value;");
			out.println("if( parseFloat(format_noobject(m_credit_balance))*-1 < parseFloat(obj.value) ){");
			out.println("alert('Net Amount should be less than or equal to Rs.'+format_noobject(m_credit_balance*-1));");
			out.println("document.Form1.TXT_NET_AMOUNT.value = m_credit_balance*-1;");
			out.println("cal_tot_amount(document.Form1.TXT_NET_AMOUNT);");
			out.println("}");			
			out.println("}");
			...
			out.println("<INPUT TYPE='Hidden' NAME='Hid_scr_name' VALUE=\"AF_RE_OTHER_INVOICES_TERM_CONTRACTS\">");  
			out.println("<INPUT TYPE='Hidden' NAME='HID_SUS_REF_NO' VALUE=\"\">"); 
			out.println("<INPUT TYPE='Hidden' NAME='hid_cur_yy' VALUE=\"\">");
			out.println("<INPUT TYPE='Hidden' NAME='hid_cur_mm' VALUE=\"\">");
			out.println("<INPUT TYPE='Hidden' NAME='hid_cur_dd' VALUE=\"\">");
			out.println("<INPUT TYPE='Hidden' NAME='HID_NET_AMOUNT' VALUE=\"\">");
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Invoicing - Debit Note For Terminated Contracts </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<TD WIDTH=\"30%\"><input class=\"txt_input5\" type=\"text\" name=TXT_VALUE_DATE_DD maxlength=\"2\" size=\"2\" onBlur=check_date_value(document.Form1.TXT_VALUE_DATE_DD,document.Form1.TXT_VALUE_DATE_MM,document.Form1.TXT_VALUE_DATE_YY);validate_date(document.Form1.TXT_VALUE_DATE_DD,document.Form1.TXT_VALUE_DATE_MM,document.Form1.TXT_VALUE_DATE_YY) >");//Modified by Dineth on 2008-12-10
			out.println("<input class=\"txt_input5\" type=\"text\" name=TXT_VALUE_DATE_MM  maxlength=\"2\" size=\"2\"  onBlur=check_date_value(document.Form1.TXT_VALUE_DATE_DD,document.Form1.TXT_VALUE_DATE_MM,document.Form1.TXT_VALUE_DATE_YY);validate_date(document.Form1.TXT_VALUE_DATE_DD,document.Form1.TXT_VALUE_DATE_MM,document.Form1.TXT_VALUE_DATE_YY)>");//Modifed by Dineth on 2008-12-10
			out.println("<input class=\"txt_input5\" type=\"text\" name=TXT_VALUE_DATE_YY maxlength=\"4\" size=\"4\"  onBlur=check_date_value(document.Form1.TXT_VALUE_DATE_DD,document.Form1.TXT_VALUE_DATE_MM,document.Form1.TXT_VALUE_DATE_YY);validate_date(document.Form1.TXT_VALUE_DATE_DD,document.Form1.TXT_VALUE_DATE_MM,document.Form1.TXT_VALUE_DATE_YY)> <a href style='{cursor:hand; }' onclick=load_calendar('2')>   Calendar</a> ");//Modified by Dineth on 2008-12-10
			out.println("</td> ");
			...
			out.println("<td width='30%' ><input class='txt_input' type='text' name='TXT_NET_AMOUNT' STYLE=\"{text-align:right;}\" onblur=\"cal_tot_amount(this);check_amount(this)\"  maxlength='22' size='22'></td>"); 
			out.println("<td width='10%'></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 
			...
			out.println("<td width='30%' ><input class='txt_input' type='text' name='TXT_VAT_AMOUNT' Value=\"0.00\" STYLE=\"{text-align:right;}\" onblur=\"cal_tot_amount(this)\"  maxlength='22' size='22'></td>"); 
			out.println("<td width='10%'></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 
			...
			out.println("<TD WIDTH=\"30%\"><input class=\"txt_input5\" type=\"text\" name=TXT_DUE_DATE_DD maxlength=\"2\" size=\"2\"  onBlur=check_date_value(document.Form1.TXT_DUE_DATE_DD,document.Form1.TXT_DUE_DATE_MM,document.Form1.TXT_DUE_DATE_YY);validate_date(document.Form1.TXT_DUE_DATE_DD,document.Form1.TXT_DUE_DATE_MM,document.Form1.TXT_DUE_DATE_YY)>");//Modified by Dineth on 2008-12-10
			out.println("<input class=\"txt_input5\" type=\"text\" name=TXT_DUE_DATE_MM  maxlength=\"2\" size=\"2\" onBlur=check_date_value(document.Form1.TXT_DUE_DATE_DD,document.Form1.TXT_DUE_DATE_MM,document.Form1.TXT_DUE_DATE_YY);validate_date(document.Form1.TXT_DUE_DATE_DD,document.Form1.TXT_DUE_DATE_MM,document.Form1.TXT_DUE_DATE_YY) >");//Modified by Dineth on 2008-12-10
			out.println("<input class=\"txt_input5\" type=\"text\" name=TXT_DUE_DATE_YY maxlength=\"4\" size=\"4\"  onBlur=check_date_value(document.Form1.TXT_DUE_DATE_DD,document.Form1.TXT_DUE_DATE_MM,document.Form1.TXT_DUE_DATE_YY);validate_date(document.Form1.TXT_DUE_DATE_DD,document.Form1.TXT_DUE_DATE_MM,document.Form1.TXT_DUE_DATE_YY) > <a href style='{cursor:hand; }' onclick=load_calendar('1')>   Calendar</a>  ");//Modified by Dineth on 2008-12-10
			out.println("</td> ");
			out.println("<td width='10%'></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			...
			out.println("<td width='30%' ><input class='txt_input' type='text' name='TXT_EXCHANGE_RATE' STYLE=\"{text-align:right;}\"  maxlength='22' size='22'></td>"); 
			out.println("<td width='10%'></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
