...
public class LAKDL_AF_PRO_Report_Servlet extends HttpServlet {
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res) throws IOException{
		...
		try {
			...
			// SCREEN_METHODS m_sn_methods = new SCREEN_METHODS(); 2012-02-17 
			...
			if (more) 
			{
				...
				for(int j=1;j<=count-Hidden_Val;j++)
				{
					...
					*/
					...
					/* out.println("</tr>"); commented 2012-02-17 madhawa */ 
				}
				out.println("</TR>");
	...
	&&&&&&&&&&&&&&&&&&&&
				...
				out.println("<INPUT TYPE ='Button' NAME ='Exit'  VALUE ='   Exit   ' class='mainbut' OnClick='Close();'></TD><TD align='right'><TD width='20%'></TD></TD></TR>");
				out.println("</TABLE>");		
			}
			else{
			...
			System.out.println("report_servelet");
			e.printStackTrace();
			try {
				conn.close();
			}	
