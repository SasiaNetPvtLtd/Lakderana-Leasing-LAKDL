...
public class LAKDL_AF_MISF_Confirmation_Report_Detail_Snap extends javax.servlet.http.HttpServlet {
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)	throws IOException	{
		...
		try {
			...
			if (m_chksql.trim().equals("idle")) {
				...
				String m_row_id=req.getParameter("row_id"); // added by udara 24-08-2017
				
				// added by udara 15-02-2018
				int new_contract_count = 0;
				String new_contract_status = "NO";
				...
				if(rs.next()){
					new_contract_count = rs.getInt(1);
				}
				...
				if(new_contract_count>0){
						...
						rs = stmt.executeQuery(" "+
							...
							"  FROM	  "+m_schema_name+".AF_CONFIRMATION_REPORT A "+
							"  WHERE  A.FINANCE_NO = '"+m_finance_no+"' "+
							//"  AND    A.ENT_DATE   >= '14-FEB-2018' ");
							"  AND    A.ENT_DATE   >= "+m_schema_name+".AF_CONFIRM_UPLOAD_START_DATE ");
				...
				// end by udara 15-02-2018
				
				String m_insurance_company = "";
				String mm_application_no = "";
				String mm_application_branch = ""; // added by udara 24-08-2017
				
				// commented by udara 28-08-2018
				/*
				rs = stmt.executeQuery(" "+
					" select INSUR_COM "+
					" from "+m_schema_name+".AF_IS_PRO_ASET_INSUR_DETA "+
					" where FINANCE_NO = '"+m_finance_no+"' "+
					" AND BUSINESS_TYPE = 'NEW' "+ // added by udara 29-01-2018
					" ORDER BY ENT_DATE DESC "+	 
					" ");
				*/
				
				// added by udara 28-08-2018
				rs = stmt.executeQuery(" "+
					
					" SELECT INSUR_COM, ENT_DATE FROM (  "+
					
					" select INSUR_COM INSUR_COM, ENT_DATE ENT_DATE "+
					" from "+m_schema_name+".AF_IS_PRO_ASET_INSUR_DETA "+
					" where FINANCE_NO = '"+m_finance_no+"' "+
					...
					" select INSUR_COM, ENT_DATE ENT_DATE  "+
				...
				rs = stmt.executeQuery(" "+
					" SELECT APPLICATION_NO, BRANCH_CODE "+
					" FROM "+m_schema_name+".AF_CO_PRO_APPLICATION_DETAILS "+
					" WHERE FINANCE_NO = '"+m_finance_no+"' "+
				" ");
				
				if(rs.next()){
					mm_application_no = rs.getString(1);
					mm_application_branch = rs.getString(2); // added by udara 24-08-2017
				}
				...
				int m_GUARANTOR_COUNT = 0; // added by udara 28-07-2017
				...
				// ================== compared values start ==================================================================
				 ...
				 // added by udara 07-02-2018	
				 String mm_FILE_UPLOAD_HIRER_1 = "",  mm_FILE_UPLOAD_HIRER_2 = "", mm_FILE_UPLOAD_VALUATION_DOC = "", mm_FILE_UPLOAD_VENDOR= "";
				 String mm_FILE_UPLOAD_INTRODUCER = "", mm_FILE_UPLOAD_CR_BOOK = "",  mm_FILE_UPLOAD_UP_DELETION = "",  mm_FILE_UPLOAD_ASSIGN_LETTER = "";
				 // end by udara 07-02-2018
				...
				rs = stmt.executeQuery(" "+
					 " SELECT "+
						...
						" FILE_UPLOAD_HIRER_1, FILE_UPLOAD_HIRER_2, FILE_UPLOAD_VALUATION_DOC, FILE_UPLOAD_VENDOR, "+ // added by udara 07-02-2018
						" FILE_UPLOAD_INTRODUCER, FILE_UPLOAD_CR_BOOK, FILE_UPLOAD_UP_DELETION, FILE_UPLOAD_ASSIGN_LETTER "+ // added by udara 07-02-2018
							" FROM "+m_schema_name+".AF_CONFIRMATION_RPT_COMPARE "+
							" WHERE FINANCE_NO = '"+m_finance_no+"' "+
							" AND ENT_USER = '"+m_username+"' "+ // added by udara 03-08-2017
					" ");
				...
				if(rs.next()){
						...
						// added by udara 07-02-2018
						mm_FILE_UPLOAD_HIRER_1 = rs.getString("FILE_UPLOAD_HIRER_1");
						mm_FILE_UPLOAD_HIRER_2 = rs.getString("FILE_UPLOAD_HIRER_2");
						mm_FILE_UPLOAD_VALUATION_DOC = rs.getString("FILE_UPLOAD_VALUATION_DOC");
						mm_FILE_UPLOAD_VENDOR = rs.getString("FILE_UPLOAD_VENDOR");
						mm_FILE_UPLOAD_INTRODUCER = rs.getString("FILE_UPLOAD_INTRODUCER");
						mm_FILE_UPLOAD_CR_BOOK = rs.getString("FILE_UPLOAD_CR_BOOK");
						mm_FILE_UPLOAD_UP_DELETION = rs.getString("FILE_UPLOAD_UP_DELETION");
						mm_FILE_UPLOAD_ASSIGN_LETTER = rs.getString("FILE_UPLOAD_ASSIGN_LETTER");

						// end by udara 07-02-2019
				}
				
				// ================== compared values end ====================================================================
				
				// added by udara 27-02-2018
				// ================== on load file size view start ===========================================================
				String msize_HIRER_1_FILE_ZIZE = ""; String msize_HIRER_2_FILE_ZIZE   = ""; String msize_VENDOR_FILE_ZIZE = ""; String msize_INTRODUCER_FILE_ZIZE = "";
				String msize_CRBOOK_FILE_ZIZE  = ""; String msize_VALUATION_FILE_ZIZE = ""; String msize_ASSIGN_LETTER    = ""; String msize_DELETION_FILE_SIZE   = "";
				
				rs = stmt.executeQuery(" "+
					" SELECT "+
					    " NVL("+m_schema_name+".AF_CO_GET_UPLOAD_FILE_SIZE('"+m_finance_no+"','hirer_1','0'),'View') HIRER_1_FILE_ZIZE, "+ 
						" NVL("+m_schema_name+".AF_CO_GET_UPLOAD_FILE_SIZE('"+m_finance_no+"','hirer_2','0'),'View') HIRER_2_FILE_ZIZE, "+ 
						" NVL("+m_schema_name+".AF_CO_GET_UPLOAD_FILE_SIZE('"+m_finance_no+"','vendor','0'),'View') VENDOR_FILE_ZIZE, "+ 
						" NVL("+m_schema_name+".AF_CO_GET_UPLOAD_FILE_SIZE('"+m_finance_no+"','introducer','0'),'View') INTRODUCER_FILE_ZIZE, "+ 
						" NVL("+m_schema_name+".AF_CO_GET_UPLOAD_FILE_SIZE('"+m_finance_no+"','cr_book','0'),'View') CRBOOK_FILE_ZIZE, "+ 
						" NVL("+m_schema_name+".AF_CO_GET_UPLOAD_FILE_SIZE('"+m_finance_no+"','valuation_doc','0'),'View') VALUATION_FILE_ZIZE, "+ 
						" NVL("+m_schema_name+".AF_CO_GET_UPLOAD_FILE_SIZE('"+m_finance_no+"','upload_assign_let','0'),'View') ASSIGN_LETTER, "+ 
						" NVL("+m_schema_name+".AF_CO_GET_UPLOAD_FILE_SIZE('"+m_finance_no+"','upload_deletion','0'),'View') DELETION_FILE_SIZE "+
						"  	FROM DUAL "+
					" ");
				
				if(rs.next()){
					msize_HIRER_1_FILE_ZIZE        = rs.getString("HIRER_1_FILE_ZIZE");
					msize_HIRER_2_FILE_ZIZE        = rs.getString("HIRER_2_FILE_ZIZE");
					msize_VENDOR_FILE_ZIZE         = rs.getString("VENDOR_FILE_ZIZE");
					msize_INTRODUCER_FILE_ZIZE     = rs.getString("INTRODUCER_FILE_ZIZE");
					msize_CRBOOK_FILE_ZIZE         = rs.getString("CRBOOK_FILE_ZIZE");
					msize_VALUATION_FILE_ZIZE      = rs.getString("VALUATION_FILE_ZIZE");
					msize_ASSIGN_LETTER            = rs.getString("ASSIGN_LETTER");
					msize_DELETION_FILE_SIZE       = rs.getString("DELETION_FILE_SIZE");
				}
				// ================== on load file size view end =============================================================
				// end by udara 27-02-2018
				...
				// added by udara 08-08-2018				
				int m_INIT_INSURANCE_COUNT = 0;
				String m_transaction_type = "";
				
				rs = stmt.executeQuery(" "+
						" SELECT NVL("+m_schema_name+".AF_GET_INIT_INSURANCE_COUNT('"+m_finance_no+"'),0) GET_INIT_INSURANCE_COUNT, "+
						"  	"+m_schema_name+".AF_CO_GET_FIN_TRAN_TYPE('"+m_finance_no+"') TRANSACTION_TYPE "+
						" FROM DUAL "+
					" ");
				
				if(rs.next()){
					m_INIT_INSURANCE_COUNT = rs.getInt("GET_INIT_INSURANCE_COUNT");
					m_transaction_type = rs.getString("TRANSACTION_TYPE");
				}
			    // end by udara 08-08-2018
				...
				*/
				...
				//out.println("           if(m_transaction_type!='LOANS'){ "); // loans if // commented by udara 12-12-2024
				out.println("           if(m_transaction_type!='LOANS' && m_transaction_type!='HADAGASMA'){ "); // loans if // added by udara 12-12-2024
				...
				out.println("			}"); // end LOANS if
				
				
				// added by udara 03-06-2020
				out.println(" var m_TXT_INITAL_CHARGES_INSURENCE = 0; ");
				out.println(" var m_TXT_BAL_1_INSURENCE = 0; ");
				out.println(" var m_TXT_INT_CHARGES_APPROVALS = 0; ");
				
				out.println(" if(document.Form1.TXT_INITAL_CHARGES_INSURENCE.value!=''){ ");
				out.println("   m_TXT_INITAL_CHARGES_INSURENCE = unformat_noobject(document.Form1.TXT_INITAL_CHARGES_INSURENCE.value); ");
				out.println(" }");
				
				out.println(" if(document.Form1.TXT_BAL_1_INSURENCE.value!=''){ ");
				out.println("   m_TXT_BAL_1_INSURENCE = unformat_noobject(document.Form1.TXT_BAL_1_INSURENCE.value); ");
				out.println(" }");
				
				out.println(" if(document.Form1.TXT_INT_CHARGES_APPROVALS.value!=''){ ");
				out.println("   m_TXT_INT_CHARGES_APPROVALS = unformat_noobject(document.Form1.TXT_INT_CHARGES_APPROVALS.value); ");
				out.println(" }");
				
				out.println(" if(count==0){");
				
				out.println(" 		if(m_TXT_INITAL_CHARGES_INSURENCE < 0){");
				out.println("    		count = 1; ");
				out.println(" 		}");
			    out.println(" 		else if(m_TXT_BAL_1_INSURENCE < 0){ ");
				out.println("    		count = 1; ");
				out.println(" 		}");
			    out.println(" 		else if(m_TXT_INT_CHARGES_APPROVALS < 0){ ");
				out.println("    		count = 1; ");
				out.println(" 		}");
			
				out.println(" 		if(count != 0){");
				out.println("    		alert('Cannot save with the minus values');  ");
				out.println(" 		}");
				
				out.println(" }");
				// end by udara 03-06-2020
				...
				out.println("} "); 
				// end by udara 15-11-2018
				
				out.println("function save_report_details(m_finance_no){");

				/*
				out.println("   var m_snap_position = '"+m_snap_position+"'; ");
				out.println("   var m_row_id = '"+m_row_id+"'; "); 
				
				out.println("   if(m_snap_position=='APPROVE1'){  ");
				out.println("      alert(window.opener.document.getElementById('CHK_'+m_row_id).value);   ");
				out.println("   }  ");
				*/
				...
				out.println("   var m_snap_position = '"+m_snap_position+"'; ");
				out.println("   var mm_INIT_INSURANCE_COUNT = '"+m_INIT_INSURANCE_COUNT+"'; "); // added by udara 08-08-2018
				
				out.println("   if(m_snap_position=='APPROVE1'){  ");
				
				out.println("      var m_row_id = '"+m_row_id+"'; "); 
				//out.println("      alert('inside ' + window.opener.document.getElementById('CHK_'+m_row_id).value);   ");
				//out.println("        window.opener.document.getElementById('CHK_'+m_row_id).disabled=false; ");
				
				
				out.println("      if(mm_INIT_INSURANCE_COUNT==0){ "); // added by udara 08-08-2018
				
				out.println("          window.opener.document.Form1.elements[\"CHK_\"+m_row_id].disabled=false;  ");
				
				out.println("      }  "); // added by udara 08-08-2018
				...
				//out.println("    alert(document.Form1.hid_guarantor_count.value);     ");
				...
				out.println("    disable_upload_for_new(); "); // added by udara 15-02-2018
				...
				//out.println("   if( (m_snap_position!='GENERATE') && (m_snap_position!='REGENERATE') ){  ");
				out.println("   if( (m_snap_position!='GENERATE') && (m_snap_position!='REGENERATE') && (m_snap_position!='VIEW') ){  ");
				out.println("      load_guarantor_div(); ");
				out.println("   }");
				...
				// added by udara 07-02-2018
				out.println("onload_div_settings('UPLOAD_NIC_NO_1_HIRER_DIV','"+mm_FILE_UPLOAD_HIRER_1+"');");
				out.println("onload_div_settings('UPLOAD_NIC_NO_2_HIRER_DIV','"+mm_FILE_UPLOAD_HIRER_2+"');");
				out.println("onload_div_settings('UPLOAD_NIC_NO_1_VALUATION_DIV','"+mm_FILE_UPLOAD_VALUATION_DOC+"');");
				out.println("onload_div_settings('UPLOAD_NIC_NO_1_VENDOR_DIV','"+mm_FILE_UPLOAD_VENDOR+"');");
				out.println("onload_div_settings('UPLOAD_NIC_NO_INTRODUCER_DIV','"+mm_FILE_UPLOAD_INTRODUCER+"');");
				out.println("onload_div_settings('UPLOAD_NIC_NO_CR_BOOK_DIV','"+mm_FILE_UPLOAD_CR_BOOK+"');");
				out.println("onload_div_settings('UPLOAD_DELETION_DIV','"+mm_FILE_UPLOAD_UP_DELETION+"');");
				out.println("onload_div_settings('UPLOAD_ASSIGN_LETTER_DIV','"+mm_FILE_UPLOAD_ASSIGN_LETTER+"');");
				// end by udara 07-02-2018
				...
				// added by udara 07-02-2018
				out.println("onload_div_settings('UPLOAD_NIC_NO_1_HIRER_DIV','Y');");
				out.println("onload_div_settings('UPLOAD_NIC_NO_2_HIRER_DIV','Y');");
				out.println("onload_div_settings('UPLOAD_NIC_NO_1_VALUATION_DIV','Y');");
				out.println("onload_div_settings('UPLOAD_NIC_NO_1_VENDOR_DIV','Y');");
				out.println("onload_div_settings('UPLOAD_NIC_NO_INTRODUCER_DIV','Y');");
				out.println("onload_div_settings('UPLOAD_NIC_NO_CR_BOOK_DIV','Y');");
				out.println("onload_div_settings('UPLOAD_DELETION_DIV','Y');");
				out.println("onload_div_settings('UPLOAD_ASSIGN_LETTER_DIV','Y');");
				// end by udara 07-02-2018
				...
				out.println("       view_button_enable(); "); // added by udara 28-07-2017
				...
				// added by udara 28-07-2017
				out.println(" function load_guarantor_div(){ ");

					int div_guarantor_count = 0;
					...
					rs = stmt.executeQuery(" "+
						" SELECT "+
							...
							" NIC_COPY_AGREE, "+
							" NUMBER_AGREE "+
								" FROM "+m_schema_name+".AF_CONF_GUAR_COMPARE "+
								" WHERE FINANCE_NO = '"+m_finance_no+"' "+
					...
					*/
					...
					rs = stmt.executeQuery(" "+
						" SELECT "+
							...
							" NIC_COPY_AGREE, "+
							" NUMBER_AGREE, "+
							" FILE_UPLOAD_GURANTER "+ // added by udara 08-02-2018
								" FROM "+m_schema_name+".AF_CONF_GUAR_COMPARE "+
								" WHERE FINANCE_NO = '"+m_finance_no+"' "+
								" AND ENT_USER = '"+m_username+"' "+
								" AND GUARANTOR_CODE IN (SELECT GUARANTOR_CODE FROM "+m_schema_name+".AF_CO_PRO_APPLI_GUARANTOR WHERE APPLICATION_NO = '"+mm_application_no+"' )   "+
							    " ORDER BY GUAR_ID ");
					...
					while(rs.next()){
						...
						div_guarantor_count = div_guarantor_count + 1;
						out.println("onload_div_settings('TXT_GUARANTOR_AGREE_DIV_"+div_guarantor_count+"','"+rs.getString("GUARANTOR_AGREE")+"');"); 
						out.println("onload_div_settings('TXT_NAME_AGREE_DIV_"+div_guarantor_count+"','"+rs.getString("NAME_AGREE")+"');");
						out.println("onload_div_settings('TXT_NIC_COPY_AGREE_DIV_"+div_guarantor_count+"','"+rs.getString("NIC_COPY_AGREE")+"');");
						out.println("onload_div_settings('TXT_NUMBER_AGREE_DIV_"+div_guarantor_count+"','"+rs.getString("NUMBER_AGREE")+"');");
						out.println("onload_div_settings('UPLOAD_GUAR_DIV_"+div_guarantor_count+"','"+rs.getString("FILE_UPLOAD_GURANTER")+"');"); // added by udara 08-02-2018
				...
				out.println("function view_button_enable(){");
				out.println("       	document.Form1.BUT_VIEW_NIC_NO_1_HIRER.disabled = false; "); // added by udara 26-06-2015
				out.println("       	document.Form1.BUT_VIEW_NIC_NO_2_HIRER.disabled = false; "); // added by udara 26-06-2015 
				out.println("       	document.Form1.BUT_VIEW_NIC_NO_1_VENDOR.disabled = false; "); // added by udara 26-06-2015 
				out.println("       	document.Form1.BUT_VIEW_NIC_NO_INTRODUCER.disabled = false; "); // added by udara 07-07-2015 
				...
				out.println("		    for (var i=1; i <= document.Form1.hid_guarantor_count.value; i++ ) {");
				out.println("		      document.getElementById(\"BUT_VIEW_NIC_NO_AGREE_\"+i).disabled = false;"); 
				out.println("		    }");
				...
				// added by udara 15-02-2018
				out.println("function disable_upload_for_new(){");
				out.println(" 	var new_contract_status = '"+new_contract_status+"' ; ");
				out.println("	if(new_contract_status=='YES'){ ");
				out.println("      document.Form1.BUT_UPLOAD_NIC_NO_1_HIRER.disabled = true; ");
				out.println("      document.Form1.BUT_UPLOAD_NIC_NO_2_HIRER.disabled = true; ");
				out.println("      document.Form1.BUT_UPLOAD_NIC_NO_1_VALUATION.disabled = true; ");
				out.println("      document.Form1.BUT_UPLOAD_NIC_NO_1_VENDOR.disabled = true; ");
				out.println("      document.Form1.BUT_UPLOAD_NIC_NO_INTRODUCER.disabled = true; ");
				out.println("      document.Form1.BUT_UPLOAD_NIC_NO_CR_BOOK.disabled = true; ");
				out.println("      document.Form1.BUT_UPLOAD_DELETION.disabled = true; ");
				out.println("      document.Form1.BUT_UPLOAD_ASSIGN_LETTER.disabled = true; ");

				out.println("		for (var i=1; i <= document.Form1.hid_guarantor_count.value; i++ ) {");
				out.println("		   document.getElementById(\"BUT_UPLOAD_NIC_NO_AGREE_\"+i).disabled = true;"); 
				out.println("		}");

				out.println("   }");
				
				// added by udara 27-02-2018
				out.println("   document.Form1.BUT_VIEW_NIC_NO_1_HIRER.value     = '"+msize_HIRER_1_FILE_ZIZE+"'; ");
				out.println("   document.Form1.BUT_VIEW_NIC_NO_2_HIRER.value     = '"+msize_HIRER_2_FILE_ZIZE+"'; ");
				out.println("   document.Form1.BUT_VIEW_NIC_NO_1_VALUATION.value = '"+msize_VALUATION_FILE_ZIZE+"'; ");
				out.println("   document.Form1.BUT_VIEW_NIC_NO_1_VENDOR.value    = '"+msize_VENDOR_FILE_ZIZE+"'; ");
				out.println("   document.Form1.BUT_VIEW_NIC_NO_INTRODUCER.value  = '"+msize_INTRODUCER_FILE_ZIZE+"'; ");
				out.println("   document.Form1.BUT_VIEW_NIC_NO_CR_BOOK.value     = '"+msize_CRBOOK_FILE_ZIZE+"'; ");
				out.println("   document.Form1.BUT_VIEW_DELETION.value           = '"+msize_DELETION_FILE_SIZE+"'; ");
				out.println("   document.Form1.BUT_VIEW_ASSIGN_LETTER.value      = '"+msize_ASSIGN_LETTER+"'; ");
				// end by udara 27-02-2018
				...
				out.println("<INPUT TYPE='Hidden' NAME='hid_application_no' VALUE='"+mm_application_no+"' >");
				out.println("<INPUT TYPE='Hidden' NAME='hid_row_id' VALUE='"+m_row_id+"' >");
				...
				while(rs.next()){
					...
					if(mm_application_branch.equals(rs.getString(1)))
				...
				rs = stmt.executeQuery(" "+
					" SELECT "+
					" NVL(NIC_NO,'-'), "+  
					//" NVL(MOBILE_NO,'-'), "+ // commented by udara 15-07-2019
					" NVL(NVL(MOBILE_NO,DIRECT_TEL_NO),'-'), "+ // added by udara 15-07-2019
					" CITY_CODE, "+
				...
				if(rs.next()){
					//hirer_cli_id_no = rs.getString(1); // commented by udara 02-07-2019
					hirer_cli_id_no = rs.getString(4); // added by udara 02-07-2019
				...
				if(rs.next()){
					//hirer_co_app_id_no = rs.getString(1); // commented by udara 02-07-2019
					hirer_co_app_id_no = rs.getString(2); // added by udara 02-07-2019
				...
				out.println("<td width='10%'> &nbsp; </td>"); // added by udara 08-09-2017
			    ...
			    out.println("<td width='10%'><DIV id='UPLOAD_NIC_NO_1_HIRER_DIV' class=div_input> [Image] </DIV></td>"); // added by udara 08-09-2017
				...
				out.println("<td width='10%'><DIV id='UPLOAD_NIC_NO_2_HIRER_DIV' class=div_input> [Image] </DIV></td>"); // added by udara 08-09-2017
				...
				try{
					...
					rs = stmt.executeQuery(" "+
						...
						// added by udara 29-01-2018
						" CASE WHEN REGEXP_INSTR(NOTES, '[[:alpha:] -]') > 0 THEN  '0' "+
			            " ELSE NVL(NOTES,0) "+
			            " END "+
						// end by udara 29-01-2018
				...
				try{
					rs = stmt.executeQuery(" "+
						...
						" WHERE APPLICATION_NO = '"+m_application_no+"' "+
						//" AND   ACTIVE_STATUS='Y' "+
						" AND   ACTIVE_STATUS IN ('Y','T') "+ // added by udara 29-01-2018
						" ");
				...
				out.println("<td width='10%'> <DIV id='UPLOAD_NIC_NO_1_VALUATION_DIV' class=div_input> [Image] </DIV> </td>"); // added by udara 08-09-2017
				...
				out.println("<td  width='25%' ><input class='txt_input' type='text' name='TXT_VEHICAL_NO_2_INS_DETAILS' maxlength='200' size='10' value='"+m_reg_no+"' >"); 
				out.println("</td>");
				...
				out.println("<td  width='25%' ><input class='txt_input' type='text' name='TXT_COLOUR_INS_DETAILS' maxlength='200' size='10' value='"+m_colour+"' >"); 
				out.println("</td>");
				...
				rs = stmt.executeQuery(" "+
					...
					" AND   B.ACTIVE_STATUS IN ('Y','T') "+ // added by udara 29-01-2018
				...
				out.println("<td  width='25%' ><input class='txt_input' type='text' name='TXT_ITEM_CATEGORY' maxlength='200' size='10' value='"+m_item_category_desc+"' >"); 
				out.println("</td>");
				...
				//out.println("<td width='4%'> &nbsp; </td>"); // commented by udara 28-07-2017
				out.println("<td width='1%'> &nbsp; </td>"); // added by udara 28-07-2017
				...
				out.println("<td width='2%' > <DIV id='TXT_HIRER_AGREE_DIV' class=div_input> [Changed] </DIV> </td>");
				...
				out.println("<td width='2%' > <DIV id='TXT_NIC_COPY_1_AGREE_DIV' class=div_input> [Changed] </DIV> </td>");
				out.println("<td width='3%' > &nbsp; </td>");
				//out.println("<td width='4%' > <DIV id='TXT_GUARANTOR_STATUS_DIV' class=div_input> [Changed] </DIV> </td>"); // commented by udara 28-07-2017
				out.println("<td width='15%' > <DIV id='TXT_GUARANTOR_STATUS_DIV' class=div_input> [Changed] </DIV> </td>"); // added by udara 28-07-2017
				...
				if(m_generate_status.equals("R")){ // new if block start by udara 14-10-2016
						...
						if(m_view_only_status.equals("N")){
									...
									//if(m_snap_position.equals("GENERATE") || m_snap_position.equals("REGENERATE") || m_snap_position.equals("APPROVE1")){ // commented by udara 27-07-2017
									if(m_snap_position.equals("GENERATE") || m_snap_position.equals("REGENERATE")){ // added by udara 27-07-2017
											...
											rs = stmt.executeQuery(" "+
												...
												" GUAR_ID, "+
												" NVL("+m_schema_name+".AF_CO_GET_UPLOAD_SIZE_GUAR('"+m_finance_no+"','GUARANTER','-',GUAR_ID),'View') "+ // added by udara 27-02-2018
												" FROM "+m_schema_name+".AF_CO_PRO_APPLI_GUARANTOR "+
												" WHERE APPLICATION_NO = '"+m_application_no+"' "+
												" AND ACTIVE_STATUS = 'Y' "+
											...
											while(rs.next()){
												...
												out.println("<input class='but_input' type='button' name='BUT_VIEW_NIC_NO_AGREE_"+guarantor_count+"' value='"+rs.getString(5)+"'   onClick=\"view_nic('GUARANTER','"+m_finance_no+"','"+guarantor_nic_num+"','"+guarantor_count+"');\"    >");
											...
											rs = stmt.executeQuery(" "+
													" SELECT GUARANTOR_CODE, "+
														...
														//" GUAR_NIC_NUM,  "+ // commented by udara 28-07-2017
														" "+m_schema_name+".AF_CO_GET_CLIENT_NIC(GUARANTOR_CODE), "+ // added by udara 28-07-2017
														" AGREEMENT_STATUS, "+
														" GUAR_NIC_STATUS, "+
											...
											while(rs.next()){
												...
												//out.println("<td width='2%'> &nbsp; </td>"); // commented by udara 28-07-2017
												out.println("<td width='2%'> <DIV id='TXT_GUARANTOR_AGREE_DIV_"+guarantor_count+"' class=div_input> [Changed] </DIV> </td>"); // added by udara 28-07-2017
												...
												//out.println("<td width='2%'> &nbsp; </td>"); // commented by udara 28-07-2017
												out.println("<td width='2%'> <DIV id='TXT_NAME_AGREE_DIV_"+guarantor_count+"' class=div_input> [Changed] </DIV> </td>"); // added by udara 28-07-2017
												...
												//out.println("<td width='2%'> &nbsp; </td>"); // commented by udara 28-07-2017
												out.println("<td width='2%'> <DIV id='TXT_NIC_COPY_AGREE_DIV_"+guarantor_count+"' class=div_input> [Changed] </DIV> </td>"); // added by udara 28-07-2017
												
												out.println("<td width='5%' ><DIV id='DIV_TXT_NUMBER_AGREE_"+guarantor_count+"' class=div_input><b>NUMBER</DIV></td>");
												//out.println("<td width='10%' ><input class='txt_input' type='text' name='TXT_NUMBER_AGREE_"+guarantor_count+"' maxlength='200' size='10' value='"+rs.getString(3)+"' >"); // commented by udara 28-07-2017
												out.println("<td width='15%' ><input class='txt_input' type='text' name='TXT_NUMBER_AGREE_"+guarantor_count+"' maxlength='200' size='10' value='"+rs.getString(3)+"' >"); // added by udara 28-07-2017
												...
												out.println("<input class='but_input' type='button' name='BUT_VIEW_NIC_NO_AGREE_"+guarantor_count+"' value=\""+guarantor_pic_view+"\"   onClick=\"view_nic('GUARANTER','"+m_finance_no+"','"+guarantor_nic_num+"','"+guarantor_count+"');\"    >");
											    out.println("<DIV id='TXT_NUMBER_AGREE_DIV_"+guarantor_count+"' class=div_input> [Changed] </DIV> "); // added by udara 28-07-2017
												out.println("<DIV id='UPLOAD_GUAR_DIV_"+guarantor_count+"' class=div_input> [Image] </DIV> "); // aded by udara 07-02-2018
												out.println("</td>"); // added by udara 14-07-2015
												out.println("</tr>");
							...
							if(m_view_only_status.equals("N")){
									...
									while(rs.next()){
										...
										out.println("<input class='but_input' type='button' name='BUT_UPLOAD_NIC_NO_AGREE_"+guarantor_count+"' value=\"Upload\" onClick=\"upload_nic('GUARANTER','"+m_finance_no+"','"+guarantor_nic_num+"','"+guarantor_count+"');\"  >"); // added by udara 26-06-2015
										//out.println("<input class='but_input' type='button' name='BUT_VIEW_NIC_NO_AGREE_"+guarantor_count+"' value=\"View\"   onClick=\"view_nic('GUARANTER','"+m_finance_no+"','"+guarantor_nic_num+"','"+guarantor_count+"');\"    >"); // added by udara 26-06-2015
										out.println("<input class='but_input' type='button' name='BUT_VIEW_NIC_NO_AGREE_"+guarantor_count+"' value='"+rs.getString(5)+"'   onClick=\"view_nic('GUARANTER','"+m_finance_no+"','"+guarantor_nic_num+"','"+guarantor_count+"');\"    >"); // added by udara 27-02-2018
							...
							} // m_view_only_status (not regen (R) end
				...
				out.println("<td width='4%'> &nbsp; </td>"); // added by udara 08-09-2017
				out.println("<td width='5%' ><b>NIC COPY</td>");
				...
				out.println("<td width='4%'> <DIV id='UPLOAD_NIC_NO_1_VENDOR_DIV' class=div_input> [Image] </DIV> </td>"); // added by udara 08-09-2017
				...
				rs = stmt.executeQuery(" "+  
					...
					//" AND C.SUB_TYPE_CODE IN ('BROKERCOMM') "+ // commented by udara 29-08-2017
					" AND C.SUB_TYPE_CODE IN ('BROKERCOMM','N17713_3') "+ // added by udara 29-08-2017
				...
				out.println("<td width='4%'> <DIV id='UPLOAD_NIC_NO_INTRODUCER_DIV' class=div_input> [Image] </DIV> </td>"); // added by udara 08-09-2017
				...
				out.println("<td width='5%'> &nbsp; </td>");
				out.println("<td width='5%'> &nbsp; </td>"); // added by udara 08-09-2017
				...
				out.println("<td width='5%'> <DIV id='UPLOAD_NIC_NO_CR_BOOK_DIV' class=div_input> [Image] </DIV> </td>"); // added by udara 08-09-2017
				...
				out.println("<td width='5%'> <DIV id='UPLOAD_DELETION_DIV' class=div_input> [Image] </DIV> </td>"); // added by udara 08-09-2017
				...
				rs = stmt.executeQuery(" "+  
					...
					//" AND C.SUB_TYPE_CODE NOT IN ('BROKERCOMM','INSURANCE','STDUTY') "+ // commented by udara 29-08-2017 // added by udara 13-10-2015	
					//" AND C.SUB_TYPE_CODE NOT IN ('BROKERCOMM','INSURANCE','STDUTY','N17713_3') "+ // commented by udara 29-01-2018 // added by udara 29-08-2017
					" AND C.SUB_TYPE_CODE NOT IN ('BROKERCOMM','INSURANCE','STDUTY') "+ // added by udara 29-01-2018
					" AND NVL(B.AMOUNT,0) <> 0  "+
					" GROUP BY B.PRICING_NO,B.SUB_CHAGE_CODE,C.DESCRIPTION,B.PRO_INVOICE_NO ORDER BY  C.DESCRIPTION 	"+		 
					" ) "+
					" ORDER BY CHARGES,DESCRIPTION "+
				...
				*/
				...
				// commented by udara 08-08-2018
				/*
				// added by udara 29-01-2018
				rs = stmt.executeQuery(" "+ 
						" SELECT "+  
							 " NVL(SUM(A.TOTAL_AMOUNT),0), "+
							 " NVL(SUM(A.SETTELE_AMOUNT),0), "+
							 " NVL(SUM(A.BALANCE_TO_BE_RECEIVED),0)  "+
							 " FROM "+m_schema_name+".AF_CO_PRO_INVOICE A, "+m_schema_name+".AF_IS_PRO_ASET_INSUR_DETA B "+
						           " WHERE A.INVOICE_NO = B.REF_DEBIT_NOTE_NO "+
						           " AND B.BUSINESS_TYPE = 'NEW' "+
											 " AND     A.ACTIVE_STATUS='Y'  "+ 
											 " AND  A.FINANCE_NO =  '"+m_finance_no+"' "+
											 " AND (A.INVOICE_TYPE = 'INSURANCE' OR A.REMARKS = 'CHARGES - INSURANCE') "+
												" ");
				*/
				
				// commented by udara 04-09-2020
				/*
				// added by udara 08-08-2018
				rs = stmt.executeQuery(" "+ 
						" SELECT "+
							" NVL(SUM(TOTAL_AMOUNT),0), "+
							" NVL(SUM(SETTELE_AMOUNT),0), "+
							" NVL(SUM(BALANCE_TO_BE_RECEIVED),0)  "+              
							" FROM (   "+            
							      " SELECT   "+
							      ...
							      " SELECT  "+ 
														  " A.PREMIUM TOTAL_AMOUNT, "+
														  " 0 SETTELE_AMOUNT, "+
														  " 0 BALANCE_TO_BE_RECEIVED "+
														  " FROM "+m_schema_name+".AF_INIT_INSURANCE_DATA A "+
													            " WHERE A.BUSINESS_TYPE = 'NEW' "+
																//" AND  A.ACTIVE_STATUS='Y'  "+ // commented by udara 23-10-2018
																" AND  A.FINANCE_NO =  '"+m_finance_no+"'   "+  
							//ADDED BY JITHENDRA 28-03-2019 FOR SECURITY INSURANCE			
							 " UNION ALL "+
							 ...
							 " SELECT   "+
														  ...
														  " A.SETTELE_AMOUNT SETTELE_AMOUNT, "+
														  " A.BALANCE_TO_BE_RECEIVED  BALANCE_TO_BE_RECEIVED "+
														  " FROM "+m_schema_name+".AF_CO_PRO_INVOICE A, "+m_schema_name+".AF_IS_PRO_ASET_INSUR_DETA_SEC B "+
													            " WHERE A.INVOICE_NO = B.REF_DEBIT_NOTE_NO "+
													            " AND B.BUSINESS_TYPE = 'NEW' "+
																" AND A.ACTIVE_STATUS='Y'   "+
																" AND A.FINANCE_NO =  '"+m_finance_no+"' "+
				...
				*/
				...
				// added by udara 04-09-2020
				if(m_snap_position.equals("GENERATE") || m_snap_position.equals("REGENERATE") || m_snap_position.equals("APPROVE1")){
					...
					rs = stmt.executeQuery(" "+ 
					"  SELECT NVL(INSURENCE_CHARGES_INSU,0) "+
					"  FROM	  "+m_schema_name+".AF_CONFIRMATION_REPORT A "+
					"  WHERE  A.FINANCE_NO = '"+m_finance_no+"' "+
					" ");
				...
				rs = stmt.executeQuery(" "+  
					...
					" AND D.BUSINESS_TYPE = 'NEW' "+ // added by udara 29-01-2018
					" group by a.REF_NO "+
					" ");
				...
				out.println("<td width='3%' ><b>REFINANCE CASE</td>");
				...
				out.println("<td width='6%'> &nbsp; </td>"); // added by udara 08-09-2017
				...
				out.println("<td width='3%' ><b>BALANCE</td>");
				...
				out.println("<td width='3%'><input class='txt_input' type='text' name='TXT_BAL_4_INSURENCE' maxlength='200' size='10' value='"+nf.format(m_insur_charge_amnt-m_insur_charge_paid-m_insur_charge_bal)+"' onblur='validate_number_text_boxes(this);set_insurance_charges_balance();' ></td>");
				
				//out.println("<td width='5%'> &nbsp; </td>"); // commented by udara 28-07-2017
				out.println("<td width='5%'> <DIV id='TXT_BAL_4_INSURENCE_DIV' class=div_input> [Changed] </DIV> </td>"); // added by udara 28-07-2017
				
				//out.println("<td width='6%'> <DIV id='TXT_BAL_4_INSURENCE_DIV' class=div_input> [Changed] </DIV> </td>"); // commented by udara 28-07-2017
				out.println("<td width='6%'> &nbsp; </td>"); // added by udara 28-07-2017
				...
				rs=stmt.executeQuery(" "+
					...
					*/
					...
					" SELECT  SUM_INSSURED,PAYEE_NAME FROM ( "+  
					    	   " SELECT NVL(E.SUM_INSSURED,0) SUM_INSSURED, "+ 
					           " NVL(E.INSUR_COM,'-') INSUR_COM , "+
					           ...
					           " NVL("+m_schema_name+".AF_CO_GET_SUB_CHARG_PAYEE_NAME(E.INSUR_COM),'-') PAYEE_NAME, "+
					           " E.ENT_DATE ENT_DATE "+
										 " FROM "+m_schema_name+".AF_INIT_INSURANCE_DATA E "+
										 " WHERE E.FINANCE_NO = '"+m_finance_no+"' "+
				...
				out.println("<td width='3%'><b>INSURANCE UPDATE (ASSIGNMENT LETTER RECEIVED)</td>");  
				//	out.println("<td width='5%'><input class='txt_input' type='text' name='TXT_INITAL_CHARGES' maxlength='200' size='10' ></td>");
				out.println("<td width='25%' ><select class='txt_input' name='TXT_INSURANCE_UPDATE_INSU'>"); 
				out.println("<option value=''  ></option>");
				out.println("<option value='Y'  > Yes </option>");
				out.println("<option value='N'  > No </option>");
				out.println("</select>");
				...
				out.println("<td width='6%'> <DIV id='UPLOAD_ASSIGN_LETTER_DIV' class=div_input> [Image] </DIV> </td>"); // added by udara 08-09-2017
				...
				out.println("<td width='3%'><b>RENTAL</td>");  
				...
				out.println("<td width='3%'> <DIV id='DIV_TXT_SLAB_INSURANCE' class=div_input><b>PERIOD(MONTHS)</b></DIV> </td>");
