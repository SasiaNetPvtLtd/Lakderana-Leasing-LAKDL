...
public class LAKDL_AF_CR_PRO_Deletion_letter extends javax.servlet.http.HttpServlet { 
...
//	CallableStatement callstmt1;
  ...
  public ResultSet rs,rs_doc_charges,rs_make,rs_anx_status,rs_rental,rs_instal1,rs_install2,rs_sysdate;
	...
	public String m_html_client_url,reqstr,m_Letter_date,m_c_code,m_add1,m_add2,m_name,m_city_desc,m_due_date,m_no_of_due_date,m_finance_no,m_print,m_termination_no;
	...
	String sql_install= " SELECT ROWNUM,A.APPLICATION_NO,TO_CHAR(A.RENTAL_DATE,'DD-MM-YYYY'),A.BALANCE_TO_BE_RECEIVED "+
		...
		rs_install2=stmt_make.executeQuery (sql_install)	;
			...
			out.println("<td width='70%' align='left'><b>&nbsp</TD><b></tr>");
			...
			out.println("<tr ><td width='10%' align='center'><b></TD>");
			out.println("<td width='70%' align='left'><b>"+m_sysdate+"</TD><b></tr>");
			
			out.println("<tr ><td width='10%' align='center'><b></TD>");
			//out.println("<td width='70%' align='left'><b>--</TD><b></tr>"); // commented by udara on 23-10-2012
			out.println("<td width='70%' align='left'><b> "+m_finance_no+" </TD><b></tr>"); // added by udara on 23-10-2012

			out.println("<tr ><td width='10%' align='center'><b></TD>");
			//out.println("<td width='70%' align='left'><b>--</TD><b></tr>"); // commented by udara on 23-10-2012
			out.println("<td width='70%' align='left'><b> Serial No - "+m_termination_no+" </TD><b></tr>"); // added by udara on 23-10-2012
			...
			out.println("<tr ><td width='10%' align='center'><b></TD>");
			//out.println("<td width='70%' align='left'><b>The Registerar of Motor Vehicles</TD><b></tr>"); // commented by udara on 23-10-2012
			out.println("<td width='70%' align='left'><b>The Registrar of Motor Vehicles</TD><b></tr>"); // added by udara on 23-10-2012
			
			out.println("<tr ><td width='10%' align='center'><b></TD>");
			//out.println("<td width='70%' align='left'><b>R.MV'S Officer</TD><b></tr>"); // commented by udara on 23-10-2012
			out.println("<td width='70%' align='left'><b>R.M.V's Officer</TD><b></tr>"); // added by udara on 23-10-2012 
			
			out.println("<tr ><td width='10%' align='center'><b></TD>");
			out.println("<td width='70%' align='left'><b>Narahenpita Road,</TD><b></tr>");
			
			out.println("<tr ><td width='10%' align='center'><b></TD>");
			out.println("<td width='70%' align='left'><b>Colombo-05.</TD><b></tr>");
			...
			out.println("<tr ><td width='10%' align='center'><b></TD>");
			out.println("<td width='70%' align='left'><b>Dear Sir,</TD><b></tr>");
			...
			out.println("<table border='0' align='center' width='70%' class='table'>");
			...
			out.println("<td width='70%' align='left'><b>Please take notice that the hire purchase agreement in respect of the above vehicle has been<br>completed and that we have no claim on the hirer in respect of this vehicle.</TD><b></tr>");
			out.println("</table>");
			...
			out.println("<table border='0' align='center' width='100%' class='table'>");
			out.println("<tr ><td width='10%' align='center'><b></TD>");
			out.println("<td width='70%' align='left'><b>The registration of the company as 'ABSOLUTE OWNERS' may now be deleted.</TD><b></tr>");
			out.println("</table>");
			...
			out.println("<table border='0' align='center' width='70%' class='table'>");
			out.println("<tr ><td width='70%' align='center'><b>Thank you</TD><b></tr>");
			out.println("</table>");
			...
			out.println("<table border='0' align='center' width='100%' class='table'>");
			out.println("<tr ><td width='10%' align='center'><b></TD>");
			out.println("<td width='70%' align='left'><b>Yours truly,</TD><b></tr>");
			out.println("</table>");
			...
			out.println("<table border='0' align='center' width='100%' class='table'>");
			out.println("<tr ><td width='10%' align='center'><b></TD>");
			out.println("<td width='70%' align='left'><b>--------------</TD><b></tr>");
			out.println("<tr ><td width='10%' align='center'><b></TD>");
			out.println("<td width='70%' align='left'><b>Director</TD><b></tr>");
			out.println("</table>");
