...
public class LAKDL_AF_CR_PRO_Rental_Detail_Report extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
      ...
      m_chksql=req.getParameter("chksql");
		...
		if(m_chksql.equals("main_page")){
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>  Rental Details Report </TITLE>"); 
			out.println("</HEAD>"); 
      ...
      out.println("}"); 
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_CR_PRO_Rental_Detail_Report?chksql=main_page';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("help_box.innerHTML=\" Rental Details Report  \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" Rental Details Report  \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
     ...
     out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_CR_PRO_Rental_Detail_Report?chksql=Report&from_date=\"+m_from_date+\"&sort_column=APPLICATION_NO&order_by_type=DESC\";");
...
//______________________________________________________________________________________________________________________________
      ...
      out.println("<tr>");
			...
			out.println("<td>           <input name=\"VAL_DAY\" type=\"text\" maxlength=\"2\" style=\"width: 25px\" class=\"txt_input\" value='"+m_sys_date_dd+"' onblur=\"checkMonthLength(document.Form1.VAL_DAY,document.Form1.VAL_MONTH,document.Form1.VAL_YEAR)\">");
			out.println("                <input name=\"VAL_MONTH\" type=\"text\" maxlength=\"2\" style=\"width: 25px\" class=\"txt_input\" value='"+m_sys_date_mm+"' onblur=\"checkMonthLength(document.Form1.VAL_DAY,document.Form1.VAL_MONTH,document.Form1.VAL_YEAR)\"> ");
			out.println("                <input name=\"VAL_YEAR\"  type=\"text\" maxlength=\"4\" style=\"width: 45px\" class=\"txt_input\" value='"+m_sys_date_yy+"' onblur=\"checkMonthLength(document.Form1.VAL_DAY,document.Form1.VAL_MONTH,document.Form1.VAL_YEAR)\"> ");
			out.println("</td>");
...
double m_interest_amt=0.00;
 ...
 //Modified by Mahela on 10-05-2007
      ...
      String m_from_date = req.getParameter("from_date");
		  ...
		  out.println("    m_order_by_type = 'ASC'; ");
		  out.println("  }");
			//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RPT_Temprery_Reciept_Details?chksql=MAIN&PURCH_ORD_NO="+m_reciept_no+"&date_from="+m_date_from+"&date_to="+m_date_to+"&sort_column=\"+m_sort_col+\"&order_by_type=\"+m_order_by_type;"); 
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_CR_PRO_Rental_Detail_Report?chksql=Report&from_date="+m_from_date+"&sort_column=\"+m_sort_col+\"&order_by_type=\"+m_order_by_type;");
     ...
     out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_CR_PRO_Rental_Detail_Report?chksql=DRILL_DOWN&from_date="+m_from_date+"&appl_no=\"+app_no+\" \";");
			out.println("popupwin=window.open(m_url,'displayWindow2','left=60,top=350,width=760,height=300,toolbar=0,location=0,center:yes,direction=0,menuBar=0,status=0,scrollbars=1,resizable=1');");
     out.println("}");
			...
			pstmt = conn.prepareStatement("SELECT APPLICATION_NO ,SUM(NET_RENTAL_AMOUNT),SUM(CAPITAL_AMOUNT),SUM(INTEREST_AMOUNT) "+  //GRENTAL_AMOUNT   
			...
			double m_tot_cap=0,m_tot_gross=0,m_tot_interest=0;
			...
			String m_app_no = rs.getString(1);			
						 m_tot_gross = m_tot_gross+rs.getDouble(2);			
			/*		rs1 =	stmt.executeQuery(" SELECT CAPITAL_AMOUNT,INTEREST_AMOUNT "+
					...
					/*		rs1 =	stmt.executeQuery("	SELECT SUM(CAPITAL_AMOUNT),SUM(INTEREST_AMOUNT) "+
							      " FROM "+m_schema_name+".AF_CO_PRO_APP_INSTALLMENT "+
										" WHERE TO_CHAR(RENTAL_DATE,'MON-YY') >= TO_CHAR(TO_DATE('"+m_from_date+"','DD-MM-YYYY'),'MON-YY') AND "+
										" APPLICATION_NO = '"+m_app_no+"' "); */
							/*	
             ...
             m_interest_amt= rs1.getDouble(2);
						 ...
						 m_capital_amt = rs.getDouble(3);
             m_interest_amt= rs.getDouble(4);
							
						 m_tot_cap = m_tot_cap + rs.getDouble(3);
             m_tot_interest = m_tot_interest + rs.getDouble(4);
      ...
      out.println("<tr >"); 
			out.println("<TD width='225' class='txt_report_data' align='center'><b>Total</b></TD>");
			out.println("<TD width='225' class='txt_report_data' align='right'>"+nf.format(m_tot_gross)+"</TD>");
			out.println("<TD width='225' class='txt_report_data' align='right'>"+nf.format(m_tot_cap)+"</TD>");
			out.println("<TD width='225' class='txt_report_data' align='right'>"+nf.format(m_tot_interest)+"</TD>");
			out.println("</tr >"); 
			out.println("</table>");
			out.println("</DIV>");
   		...
   		out.println("<DIV STYLE='position: absolute; top: 0; left: 3; width : 900; height: 15'>");
			...
			out.println("<td width='225' class='txt_report_column' style= cursor:hand; onclick=sort_data('APPLICATION_NO') >APPLICATION NO</td>"); 
			out.println("<td width='225' align='right' class='txt_report_column2' >NET AMOUNT</td>"); 
			out.println("<td width='225' align='right' class='txt_report_column2' >CAPITAL AMOUNT</td>"); 
			out.println("<td width='225' align='right' class='txt_report_column2' >INTEREST AMOUNT</td>"); 
			out.println("</tr >"); 
			out.println("</table>");  
			out.println("</div>"); 
			out.println("<DIV STYLE='position: absolute; top: 0; left: 0; width: 0; height: 0'></DIV>");
	...
	out.println("<HTML>"); 
      ...
      out.println("<table align='center' width='100%' class='table' border=0>"); 
			...
			out.println("<BR>");
										...
										rs =	stmt.executeQuery(" SELECT APPLICATION_NO,PRICING_NO,INSTALLMENT_NO,TO_CHAR(RENTAL_DATE,'DD-MON-YYYY'),NET_RENTAL_AMOUNT,CAPITAL_AMOUNT,INTEREST_AMOUNT,PRO_INVOICE_NO "+  //  GRENTAL_AMOUNT
							                        " FROM "+m_schema_name+".AF_CO_PRO_APP_INSTALLMENT "+
																			" WHERE TO_DATE(TO_CHAR(RENTAL_DATE,'DD-MM-YYYY'),'DD-MM-YYYY') >= TO_DATE('"+m_from_date+"','DD-MM-YYYY') AND "+
			...
			out.println("<tr class=pdn_txtpos2>"); 
			out.println("<td width='15%' class='txt_report_column'>Pricing No</td>"); 
			out.println("<td width='15%' class='txt_report_column'>Proforma Invoice No</td>");
			out.println("<td width='12.5%' class='txt_report_column'>Instalment No</td>");
			out.println("<td width='12.5%' class='txt_report_column'>Rental Date</td>");
			
			out.println("<td width='15%' class='txt_report_column2' >Rental Amount</td>"); 
			...
			out.println("<table align='center' width='100%' class='table' border=1>"); 
			out.println("<tr >"); 
			out.println("<td width='15%' class='txt_report_data' align='center' style= cursor:hand; onClick=show_pricing_drill('"+rs.getString(2)+"')><u>"+rs.getString(2)+"</u></td>"); 
			out.println("<td width='15%' class='txt_report_data' align='center' style= cursor:hand; onClick=show_proforma_invoice_drill('"+rs.getString(8)+"')><U>"+rs.getString(8)+"</U></td>"); 
			out.println("<td width='12.5%' class='txt_report_data' align='center'>"+rs.getString(3)+"</td>");
			out.println("<td width='12.5%' class='txt_report_data' align='center'>"+rs.getString(4)+"</td>");
			out.println("<td width='15%' class='txt_report_data' align='right'>"+nf.format(rs.getDouble(5))+"</td>"); 
			out.println("<td width='15%' class='txt_report_data' align='right'>"+nf.format(rs.getDouble(6))+"</td>"); 
			out.println("<td width='15%' class='txt_report_data' align='right'>"+nf.format(rs.getDouble(7))+"</td>"); 
			out.println("</tr >"); 	
			
			tot_retal=tot_retal + rs.getDouble(5);
			tot_capital=tot_capital + rs.getDouble(6);
			tot_interest=tot_interest + rs.getDouble(7);
			...
			out.println("<tr >"); 
			out.println("<td width='15%' class='txt_report_data' align='center'></td>"); 
			out.println("<td width='15%' class='txt_report_data' align='center'></td>"); 
			out.println("<td width='12.5%' class='txt_report_data' align='center'></td>");
			out.println("<td width='12.5%' class='txt_report_data' align='center'><B>Total</B></td>");
			out.println("<td width='15%' class='txt_report_data' align='right'><B>"+nf.format(tot_retal)+"</B></td>"); 
			out.println("<td width='15%' class='txt_report_data' align='right'><B>"+nf.format(tot_capital)+"</B></td>"); 
			out.println("<td width='15%' class='txt_report_data' align='right'><B>"+nf.format(tot_interest)+"</B></td>"); 
			out.println("</tr >"); 	
			out.println("</table>"); 
...
else if(m_chksql.equals("DRILL_DOWN_CONTRACT")){
	...
	out.println("<HTML>"); 
      ...
      out.println("<table align='center' width='100%' class='table' border=0>"); 
			...
			out.println("<BR>");
						...
						/*				rs =	stmt.executeQuery(" SELECT APPLICATION_NO,PRICING_NO,TO_NUMBER(INSTALLMENT_NO)+1,TO_CHAR(RENTAL_DATE,'DD-MON-YYYY'),NET_RENTAL_AMOUNT,CAPITAL_AMOUNT,INTEREST_AMOUNT,PRO_INVOICE_NO "+  //  GRENTAL_AMOUNT
							                        " FROM "+m_schema_name+".AF_CO_PRO_APP_INSTALLMENT "+
																			//" WHERE TO_DATE(TO_CHAR(RENTAL_DATE,'DD-MM-YYYY'),'DD-MM-YYYY') >= TO_DATE('"+m_from_date+"','DD-MM-YYYY') AND "+
																			" WHERE APPLICATION_NO = '"+m_appl_no+"' "+
																			" ORDER BY  TO_NUMBER(INSTALLMENT_NO),RENTAL_DATE ");
																			
					 */														
				//rs =	stmt.executeQuery("SELECT A.APPLICATION_NO,A.PRICING_NO,TO_NUMBER(INSTALLMENT_NO)+1,TO_CHAR(RENTAL_DATE,'DD-MON-YYYY'),NET_RENTAL_AMOUNT,CAPITAL_AMOUNT,INTEREST_AMOUNT,PRO_INVOICE_NO   "+ // commented by udar on 21-09-2012
				rs =	stmt.executeQuery("SELECT A.APPLICATION_NO,A.PRICING_NO,TO_NUMBER(INSTALLMENT_NO),TO_CHAR(RENTAL_DATE,'DD-MON-YYYY'),NET_RENTAL_AMOUNT,CAPITAL_AMOUNT,INTEREST_AMOUNT,PRO_INVOICE_NO   "+
				" FROM  "+m_schema_name+".AF_CO_PRO_APP_INSTALLMENT A,  "+m_schema_name+".AF_CO_PRO_APP_INVOICE_DETAILS B "+
				" WHERE A.APPLICATION_NO=B.APPLICATION_NO "+
				" AND   A.APPLICATION_NO = '"+m_appl_no+"'  "+
				" AND   B.ACTIVE_STATUS IN ('Y','T')  "+
				" AND   A.PRICING_NO=B.PRICING_NO "+
				" AND  A.PRO_INVOICE_NO=B.INVOICE_NO "+
				//" AND  A.ENT_DATE IN (SELECT MAX(ENT_DATE) FROM "+m_schema_name+".AF_CO_PRO_APP_INSTALLMENT WHERE APPLICATION_NO = '"+m_appl_no+"' GROUP BY APPLICATION_NO)"+  //Added By Sandun on 24-04-2009 
				" ORDER BY  TO_NUMBER(INSTALLMENT_NO),RENTAL_DATE  ");
