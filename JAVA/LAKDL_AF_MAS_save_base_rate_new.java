...
public class LAKDL_AF_MAS_save_base_rate_new extends HttpServlet {
  ...
  String reqstr;
	...
	public synchronized void  service(HttpServletRequest req, HttpServletResponse res)	throws IOException{
      ...
      String m_apply_date="";
		  String m_chk_status="";	
		  callstmt=conn.prepareCall("BEGIN "+m_schema_name+".AF_MAS_SAVE_BASE_RATE_APP(:1,:2,:3,:4,:5); END;");
		  ...
		  m_apply_date =m_sn_methods.met_formdata(reqstr,"hid_val_date_"+(Integer.toString(i)));				
      callstmt.setString(1,m_sn_methods.met_formdata(reqstr,"hid_base_code_"+(Integer.toString(i))));
	    ...
	    callstmt.close();
	   	out.println("<HTML><HEAD>");
			...
			out.println("window.location.href='"+m_url+"/"+m_fschema_name+"AF_MAS_display_var_base_rate_new';");
