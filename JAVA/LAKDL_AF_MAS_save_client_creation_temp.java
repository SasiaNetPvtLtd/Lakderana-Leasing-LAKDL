...
public class LAKDL_AF_MAS_save_client_creation_temp extends HttpServlet {
		...
		//individual
		  if(client_type.equals("I"))
	   	...
	   	out.println("<HTML><HEAD>");
			...
			out.println("window.location.href='"+m_url+"/"+m_client_name+"AF_MAS_display_client_creation';");
			}
			else if(!m_save_close.equals("N")){
			out.println("window.location.href='"+m_url+"/"+m_client_name+"AF_MAS_display_client_creation?close_status=Y';");
			}
