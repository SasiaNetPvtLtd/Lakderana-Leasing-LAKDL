...
public class LAKDL_AF_RE_display_rental_unfreez extends javax.servlet.http.HttpServlet { 
	...
	public  void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			if(m_chksql.equals("main_page")){
				...
				out.println("<HTML>"); 
				out.println("<HEAD>"); 
				out.println("<TITLE>Collection - Repossesion- Rental Un-Freez</TITLE>"); 
				out.println("</HEAD>"); 
				...
				out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_RE_save_rental_unfreez';");  
				...
				out.println("    m_order_by_type = 'ASC'; ");
				out.println("  }");
				out.println("	m_url = \""+m_class_url+"/"+m_fschema_name+"AF_RE_display_rental_unfreez?chksql=main_page&sort_column=\"+m_sort_col+\"&order_by_type=\"+m_order_by_type;"); 
				...
				out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_RE_display_rental_unfreez?chksql=main_page&sort_column="+m_sort_column+"&order_by_type="+m_order_by_type+"';"); 
				out.println("		}"); 
				out.println("}"); 
				...
				out.println("    m_help_message = \"m_help_msg_LAKDL_AF_RE_display_rental_unfreez\";"); 
				...
				out.println("help_box.innerHTML=\" Collection - Repossesion - Rental Un-Freez - \"+m_val;"); 
				out.println("}"); 
				out.println(""); 
				
				out.println("function load_roll_out_value(){");
				out.println("help_box.innerHTML=\" Collection - Repossesion - Rental Un-Freez - \"+document.Form1.hid_status.value;"); 
				out.println("}"); 
				...
				out.println("</tr>"); 
				out.println("<tr>"); 
				out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Collection - Repossesion - Rental Unfreez</td>"); 
				out.println("</tr>"); 
				out.println("<tr>"); 
				...
				rs = stmt.executeQuery ("SELECT A.INVENTORY_NO,A.REPOSSESSION_NO,B.FINANCE_NO,"+
					...
					//" AND "+m_schema_name+".AF_GET_REPO_STATUS_3(A.REPOSSESSION_NO) = 'Vehicle Release' "+
					" AND "+m_schema_name+".AF_GET_REPO_STATUS_3(A.REPOSSESSION_NO,B.FINANCE_NO) = 'Vehicle Release' "+
				...
				out.println("<td  width='40%' style= cursor:hand; title='Click here to sort by - Client Name  '    onclick=sort_data('CLIENT_NAME') >Client Name</td>");
