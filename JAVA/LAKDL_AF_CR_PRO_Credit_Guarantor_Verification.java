...
public class LAKDL_AF_CR_PRO_Credit_Guarantor_Verification extends javax.servlet.http.HttpServlet { 
			...
			LAKDL_AF_CO_conn_methods m_sn_methods = new LAKDL_AF_CO_conn_methods();
		      ...
		      //out.println("window.open(m_url);")	;
				  ...
				  out.println("m_table.innerHTML+='<table align=\"center\" width=\"100%\" ><TR>'+");			
					out.println("'<TD align=\"center\" WIDTH=\"20%\" class=\"pdn_txtpos2\" style=\"height: 16px\" id=\"help_box\"> <input type=\"Hidden\" name=hid_TXT_Guarantor_Code'+j+'	VALUE='+data_vec[i+1]+'> '+data_vec[i+1]+'</td>'+");
					out.println("'<TD align=\"left\"   WIDTH=\"40%\" class=\"pdn_txtpos2\" style=\"height: 16px\" id=\"help_box\">'+data_vec[i+2]+'</td>'+");
					out.println("'<TD align=\"center\"   WIDTH=\"10%\" > <input class=\"mainbut\" style=\"{width:50}\" type=\"button\" name=BUT_VERI'+j+' value=\"Verify\" onClick=load_guarantor(hid_TXT_Guarantor_Code'+j+',hid_View_status'+j+')>'+");
		      ...
		      out.println("}"); 	
					...
					out.println("m_table.innerHTML+='<table align=\"center\" width=\"100%\" ><TR>'+");
					out.println("'<TD WIDTH=\"20%\"     align=\"center\" class=\"pdn_txtpos2\" style=\"height: 20px\" id=\"help_box\"><B>Guarantor Code</B></TD>'+");
					out.println("'<TD WIDTH=\"40%\"     align=\"center\" class=\"pdn_txtpos2\" style=\"height: 20px\" id=\"help_box\"><B>Guarantor Name</B></TD>'+");
					out.println("'<TD WIDTH=\"*%\"     align=\"center\" bgcolor=\"white\" ></TD>'+");
					out.println("'</TR></table>';");
		     	out.println("}");
					
					
					out.println("function load_guarantor(obj,objv){	"); 
					
					out.println("		if(obj.value !=''){ "); 
					out.println("		m_url='"+m_class_url+"/"+m_fschema_name+"AF_MAS_display_client_creation?guarantor_code='+obj.value+'';"); 
			    out.println("window.open(m_url,'displayWindow3','left=0,top=133,width=800,height=700,toolbar=0,location=0,directories=0,status=0,menuBar=1,scrollBars=1,resizable=1');"); 
					...
					out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_CR_PRO_Credit_Guarantor_Verification?applicaton_no='+m_applicaton_no+'';"); 
					out.println("		}"); 
					out.println("}"); 
