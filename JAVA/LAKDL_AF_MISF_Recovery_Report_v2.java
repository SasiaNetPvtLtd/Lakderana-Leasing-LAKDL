...
public class LAKDL_AF_MISF_Recovery_Report_v2 extends javax.servlet.http.HttpServlet { 
	...
	public  void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { // synchronized
		...
		try { 
			...
			if(m_chksql.equals("main_page")){ 
				...
				out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_v2?chksql=run_report&finance_no=\"+finance_no+\"&date=\"+m_date+\"&location_id=\"+document.Form1.TXT_LOCATION_CODE.value+\"&user_id=\"+document.Form1.TXT_USER.value+\"&cr_officer=\"+m_cr_officer+\"&active_yard_status=\"+m_active_yard_status+\"&perform_stat=\"+m_perform_stat+\"&region=\"+m_region;"); // added by udara 13-08-2015 
				...
				// added by udara 28-06-2017
				out.println("function print_report4(){");
				
				out.println("   m_user_branch = '"+m_branch_id+"'; ");
				
				out.println("   if(m_user_branch=='HO'){");
				out.println("        print_report5(); ");
				out.println("   }");
				out.println("   else{");
				out.println("        if(document.Form1.TXT_LOCATION_CODE.value==''){   ");
				out.println("           alert('You cannot run the corperate report. Please select a branch'); ");	
				...
				out.println("function print_report5(){");
				...
				*/
				...
				out.println(" m_cr_officer=document.Form1.MKT_OFFICER.value;");//added milinda 2013-10-16
				out.println("   m_product_name   = document.Form1.TXT_PRODUCT.value; "); // added by udara 12-10-2018
				//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_v2?chksql=print_report_new&location=\"+m_location+\"&officer=\"+m_officer+\"&date=\"+m_date+\"&perform_status=\"+perform_status+\"&cr_officer=\"+m_cr_officer+\"&active_status=\"+document.Form1.TXT_ACTIVE_STATUS.value+\"&region=\"+m_region+\"&finance_no=\"+m_finance_no;");  // added by udara on 09-05-2013 //mod by milinda 2013-10-16
				out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_v2?chksql=print_report_new&location=\"+m_location+\"&officer=\"+m_officer+\"&date=\"+m_date+\"&perform_status=\"+perform_status+\"&cr_officer=\"+m_cr_officer+\"&active_status=\"+document.Form1.TXT_ACTIVE_STATUS.value+\"&region=\"+m_region+\"&finance_no=\"+m_finance_no+\"&product_name=\"+m_product_name;");  
				out.println("			window.open(m_url);");
				out.println("	}");
				out.println("}");
				...
				out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_v2?chksql=main_page&generate=page';"); 
				out.println("		}"); 
				out.println("}"); 
				...
				out.println("help_box.innerHTML=\" Collection Process - Recovery Report - Automated - Daily\"+m_val;"); 
				out.println("}"); 
				out.println(""); 
				
				out.println("function load_roll_out_value(){");
				out.println("help_box.innerHTML=\" Collection Process - Recovery Report - Automated - Daily \"+document.Form1.hid_status.value;"); 
				out.println("}"); 
				...
				out.println("if(validate_data()){");
				out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_v2?chksql=main_page&generate=print_report&location=\"+m_location+\"&officer=\"+m_officer+\"&date=\"+date;");	
				...
				out.println("</tr>"); 
				out.println("<tr>"); 
				out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Collection Process - Recovery Report - Automated - Daily </td>"); 
				out.println("</tr>"); 
				out.println("<tr>"); 
				...
				out.println("<input class='but_input' type='button' name='BUT_PRINT' value=\"View Report - Month End\" onClick=\"print_report4()\" style=\"{width:150px;}\">"); // released by udara 03-07-2018 // added by udara 28-06-2017
				...
				*/
				...
				if(!m_active_status.equals("A")){
					//m_active_status_string = " AND "+m_schema_name+".AF_RE_IS_VEHICLE_IN_YARD2(A.FINANCE_NO,'"+m_date+"') = '"+m_active_status+"' "; // added by udara 23-03-2015 // commented by udara 31-07-2018
					//m_active_status_string_for_cr_notes = " AND "+m_schema_name+".AF_RE_IS_VEHICLE_IN_YARD2(FINANCE_NO,'"+m_date+"') = '"+m_active_status+"' "; // added by udara 18-02-2016 // commented by udara 31-07-2018
				...
				//	m_product_string = " AND B.TRANSACTION_TYPE = '"+m_product_name+"' ";
				//}
				...
				out.println("    m_order_by_type = 'ASC'; ");
				out.println("  }");
				out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_v2?chksql=print_report_new&location="+m_location+"&officer="+m_officer+"&date="+m_date+"&active_status="+m_active_status+"&sort_column=\"+m_sort_col+\"&order_by_type=\"+m_order_by_type;");	
				...
				//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_v2?chksql=print_report_new_drill&location="+m_location+"&officer="+m_officer+"&date="+m_date+"&active_status="+m_active_status+"&slab=\"+val+\"&cr_officer="+m_cr_officer+"\";");	
				//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_v2?chksql=print_report_new_drill&location="+m_location+"&officer="+m_officer+"&date="+m_date+"&active_status="+m_active_status+"&slab=\"+val+\"&cr_officer="+m_cr_officer+"&perform_status="+m_perform_status+"&region="+m_region+"\";");
				out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_v2?chksql=print_report_new_drill&location="+m_location+"&officer="+m_officer+"&date="+m_date+"&active_status="+m_active_status+"&slab=\"+val+\"&cr_officer="+m_cr_officer+"&perform_status="+m_perform_status+"&region="+m_region+"&product_name="+m_product_name+"\";");
				...
				//out.println("   m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_v2?chksql=print_report_new_drill_total&location="+m_location+"&officer="+m_officer+"&date="+m_date+"&active_status="+m_active_status+"&cr_officer="+m_cr_officer+"\";");	// commented by udara 23-08-2017
				//out.println("   m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_v2?chksql=print_report_new_drill_total&location="+m_location+"&officer="+m_officer+"&date="+m_date+"&active_status="+m_active_status+"&cr_officer="+m_cr_officer+"&perform_status="+m_perform_status+"&region="+m_region+"\";"); // added by udara 23-08-2017
				out.println("   m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_v2?chksql=print_report_new_drill_total&location="+m_location+"&officer="+m_officer+"&date="+m_date+"&active_status="+m_active_status+"&cr_officer="+m_cr_officer+"&perform_status="+m_perform_status+"&region="+m_region+"&product_name="+m_product_name+"\";"); 
				out.println("   window.open(m_url,'slab','left=50,top=60,width=850,height=500,toolbar=0,location=0,directories=0,status=0,menuBar=0,scrollBars=1,resizable=1');"); 
				out.println("}");
				// end by udara 19-10-2016
				...
				rs=stmt.executeQuery("SELECT NVL("+m_schema_name+".AF_CO_GET_LOCATION_DESC('"+m_location+"'),'ALL'), "+m_schema_name+".AF_CO_GET_EMP_NAME('"+m_officer+"'), "+
					...
					" (SELECT TO_CHAR(MAX(ENT_DATE),'DD-MM-YYYY HH:MI:SS AM') FROM "+m_schema_name+".AF_MIS_RECOVERY_REPORT_DAILY)   "+ // added by udara 19-05-2016
					" FROM DUAL ");
		...
		" A.FINANCE_NO FINANCE_NO "+
				...
				Sql_data="  "+	
					...
					" SELECT NVL(SUM(A.ODI_AMOUNT_COL),0) ODI_AMOUNT_COL, "+
							...
							" FROM "+m_schema_name+".AF_RECOV_RPT_SUM_HIS_ALL A "+
					...
					*/
					...
					" NVL(SUM(A.PRE_BALANCE),0)+NVL(SUM(A.OTHER_CHARGES_CURR_MONTH),0) BBF, "+ // bbf
					" NVL(SUM(A.OPEN_CONTRACT_BAL),0) OPEN_CONTRACT_BAL "+
					" FROM "+m_schema_name+".AF_RECOV_RPT_SUM_DAILY_ALL A, "+m_schema_name+".AF_CO_PRO_APPLICATION_DETAILS B "+
					//" WHERE ENT_USER='"+m_username+"' "+
					//" WHERE ENT_USER='LAKDLALL' "+
					" WHERE A.FINANCE_NO = B.FINANCE_NO "+ // added by udara 15-10-2018
				...
				Sql_data=" "+
					...
					" AND    A.FINANCE_NO IN (SELECT FINANCE_NO FROM "+m_schema_name+".AF_MIS_RECOVERY_REPORT_DAILY WHERE ENT_USER = 'LAKDLALL' AND REPORT_DATE = TO_DATE('"+m_date+"','DD-MM-YYYY') AND PERFORM_STATUS LIKE '"+m_perform_status+"%' "+ m_active_status_string_for_cr_notes +" ) "+  
				...
				out.println("    m_order_by_type = 'ASC'; ");
				out.println("  }");
				out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_v2?chksql=print_report_new&location="+m_location+"&officer="+m_officer+"&date="+m_date+"&sort_column=\"+m_sort_col+\"&order_by_type=\"+m_order_by_type;"); // commented by udara on 09-05-2013
				out.println(" window.location.href=m_url;"); 
				out.println("}");
				...
				if (m_slab.equals("NEW") ){
					...
					Sql_data="   "+
						...
						" AND A.APPLICATION_NO = B.APPLICATION_NO "+ 
						//" AND UPPER(A.collection_officer) like UPPER('%"+m_officer+"%') "+
						" AND UPPER(A.collection_officer) like UPPER('"+m_officer+"%') "+ // 29-01-2020
						" AND UPPER(A.LOCATION_CODE)      like UPPER('"+m_location+"%') "+
						" AND A.TOTAL_PERIOD > 0 "+
						//" AND A.TOTAL_PERIOD = '"+m_slab+"'  "+
						" AND A.ACTIVATED_DATE  >= TRUNC(TO_DATE('"+m_date+"','DD-MM-YYYY'),'MM') "+
			...
			// end by udara 19-10-2016
				...
				out.println("<table align=\"center\" width=\"95%\" border=\"0\" class=\"table\">");
				out.println("<tr >");
				out.println("<td width=\"*\" STYLE='{font: bold 10pt arial; text-align:center;}'   ><u>RECOVERY REPORT - AUTOMATED - DAILY</u></td>"); 
