...
public class LAKDL_FA_OP_save_Invoice_Settle_Rep extends HttpServlet {
      ...
      String m_username = m_sn_methods.username;
			...
			//------------------------------------------------------------------------------------------
				...
				int tnum=0;
							...
							callstmt1.setString(3,"INVOICE_SETTLEMENT_REPORT");
							callstmt1.setString(4,"FA_OP_INVOICE_SETTLE_REPORT");
	   	...
	   	out.println("<HTML><HEAD>");
			...
			out.println("	m_url = \""+m_class_url+"/"+m_fschema_name+"FA_OP_Invoice_Settle_Report?chksql=main_page&facility_no="+m_facility_no+"&print=FALSE&client_no="+m_client_no+"\";"); 
