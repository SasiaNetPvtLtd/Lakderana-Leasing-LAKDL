...
public class LAKDL_AF_RE_return_receipts extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
   		...
   		nf1 = java.text.NumberFormat.getInstance(Locale.US);
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Collection - Return Receipts Report </TITLE>"); 
			out.println("</HEAD>"); 
			...
			//Added by Dineth on 2009-07-24
			out.println("function set_timer_actions() {");
			out.println("   durationID=durationID+1;");
			out.println("		timerID = setTimeout(\"set_timer_actions()\",1000);");
			out.println("		return_receipts_data.innerHTML=\"<p><b>Please Wait...\"+durationID+\" s</b></P>\";");
			out.println("}");
			
			out.println("function get_vector_normal(m_data){");
			out.println("		clearTimeout(timerID);");
			out.println("		return_receipts_data.innerHTML=m_data;");
			out.println("}");
			...
			out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_return_receipts?chksql=load_receipts_return&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=RETURN_ENTRY_DATE&sort_by=ASC\";");
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_RE_return_receipts?chksql=main_page';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("	help_box.innerHTML=\" Collection - Return Receipts Report - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\" Collection - Return Receipts Report \";"); 
			out.println("}"); 
	  	...
	  	out.println("					}"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Collection - Return Receipts Report </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
...
//			out.println("<td width='*%' ></td>");
			...
			out.println("<DIV id='return_receipts_data'  class=div_input></DIV>");
			out.println("</form>"); 
				...
				String m_rec_no="";
					...
					*/
					rs1= stmt1.executeQuery(" SELECT "+ 
                                  ...
                                  " NVL(TO_CHAR(B.ENT_DATE,'DD-MM-YYYY'),'-'), "+
                                  " NVL(B.ENT_USER,'-') RETURN_USER, "+
                                  " NVL(C.FINANCE_NO,'-') FINANCE_NO, "+
																	" NVL("+m_schema_name+".AF_CO_GET_AGE_END_AGR_NO_NEW(C.FINANCE_NO,TO_CHAR(SYSDATE,'DD-MM-YYYY'),A.CLIENT_CODE),0) AGE, "+
                                  " NVL("+m_schema_name+".AF_CO_GET_EMP_NAME("+m_schema_name+".AF_GET_COLL_OFFICER(C.finance_no)),'-') COLLECTION_OFFICER, "+
																	" A.ENT_DATE RECEIPT_DATE, "+
																	" A.CHEQUE_DATE CHEQUE_DATE, "+
																	" A.REALISED_DATE EFF_RET_DATE, "+
																	" B.ENT_DATE RETURN_ENTRY_DATE "+
                                  " FROM "+
                                  " "+m_schema_name+".AF_CO_PRO_SETTL_RECEIPT A, "+
                                  " "+m_schema_name+".AF_CO_PRO_RETURN_DETAILS B,"+m_schema_name+".AF_CO_PRO_SETTL_REC_APP_BAL C "+
					...
					boolean more = rs1.next();
					 ...
					 out.println("<HTML><HEAD><TITLE>Return Receipts Report </TITLE></HEAD>");
					 out.println("<link REL='STYLESHEET' HREF='"+m_html_client_url+"/css/Asset_Financing_System.css' TYPE=\"text/css\">");
					 out.println("<SCRIPT language=\"JavaScript\">"); 
		  		 ...
		  		 out.println("	 m_order_by_type = 'ASC'; ");  
					 ...
					 out.println("    m_order_by_type = 'ASC'; ");
					 out.println("  }");
					 out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_return_receipts?chksql=load_receipts_return&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=\"+m_sort_col+\"&sort_by=\"+m_order_by_type;");
					 ...
					 out.println("function show_transaction_history_new(val,val2){ "); //Added By Sandun on 03-08-2009
			     ...
			     out.println("}");
					 ...
					 out.println("<TR><TD align='Center' ><B> Return Receipts Report From  "+m_from_date+" To "+m_to_date+" </B></TD></TR>");
					 out.println("</TABLE>");
					 out.println("<BR>");	
					if(!more){
				  ...
				  if(more){
						...
						out.println("<td width='1%'></td>"); 
						//out.println("<td width='12%' style= cursor:hand; title='Click here to sort by - Finance No'    onclick=sort_data('SUS_REF_NO') ><DIV class=div_input ><b>Finance No</b></DIV></td>"); 
						out.println("<td width='12%' style= cursor:hand; title='Click here to sort by - Receipt No'    onclick=sort_data('RECEIPTS_NO') ><DIV class=div_input ><b>Receipt No</b></DIV></td>"); 
						out.println("<td width='12%' style= cursor:hand; title='Click here to sort by - Receipt Date'    onclick=sort_data('RECEIPT_DATE') ><DIV class=div_input ><b>Receipt Date</b></DIV></td>"); 
						out.println("<td width='12%' style= cursor:hand; title='Click here to sort by - Cheque Date'    onclick=sort_data('CHEQUE_DATE') ><DIV class=div_input ><b>Cheque Date</b></DIV></td>"); 
						out.println("<td width='12%' style= cursor:hand; title='Click here to sort by - Client Name'    onclick=sort_data('CLIENT_NAME') ><DIV class=div_input ><b>Client Name</b></DIV></td>"); 
						out.println("<td width='12%' style= cursor:hand; title='Click here to sort by - Cheque No'    onclick=sort_data('CHEQUE_NO') ><DIV class=div_input ><b>Cheque No</b></DIV></td>"); 
						out.println("<td width='12%' style= cursor:hand; title='Click here to sort by - Bank'    onclick=sort_data('BRANCH_CODE') ><DIV class=div_input ><b>Bank</b></DIV></td>"); 
						out.println("<td width='12%' style= cursor:hand; title='Click here to sort by - Amount'    onclick=sort_data('AMOUNT') ><DIV class=div_input ><b>Amount</b></DIV></td>"); 
						out.println("<td width='12%' style= cursor:hand; title='Click here to sort by - Return Remark'    onclick=sort_data('COMMENTS') ><DIV class=div_input ><b>Return Remarks</b></DIV></td>"); 
						out.println("<td width='12%' style= cursor:hand; title='Click here to sort by - Eff Ret Date'    onclick=sort_data('EFF_RET_DATE') ><DIV class=div_input ><b>Effective Return Date</b></DIV></td>"); 
						out.println("<td width='12%' style= cursor:hand; title='Click here to sort by - Return Entry Date'    onclick=sort_data('RETURN_ENTRY_DATE') ><DIV class=div_input ><b>Return Entry Date</b></DIV></td>"); 
						out.println("<td width='12%' style= cursor:hand; title='Click here to sort by - Return User'    onclick=sort_data('RETURN_USER') ><DIV class=div_input ><b>Return User</b></DIV></td>"); 
						out.println("<td width='12%' style= cursor:hand; title='Click here to sort by - Finance No'    onclick=sort_data('RECEIPTS_NO,FINANCE_NO') ><DIV class=div_input ><b>Finance No/s</b></DIV></td>"); 
					  out.println("<td width='12%' style= cursor:hand; title='Click here to sort by - Age'    onclick=sort_data('RECEIPTS_NO,AGE') ><DIV class=div_input ><b>Age</b></DIV></td>"); 
						out.println("<td width='12%' style= cursor:hand; title='Click here to sort by - Collection Officer'    onclick=sort_data('RECEIPTS_NO,COLLECTION_OFFICER') ><DIV class=div_input ><b>Collection Officer</b></DIV></td>"); 
            //out.println("<td width='12%' ><DIV class=div_input ><b>Age</b></DIV></td>");
					...
					while(more){
            m_count=0;
						m_rec_no=rs1.getString(1);
            while(m_rec_no.equals(rs1.getString(1))){
						if(m_count==0){
						if(mflag){
							...
							out.println("<td width='20%' class=div_input onClick=\"show_client('"+rs1.getString(4)+"')\" style='cursor:hand'><u>"+rs1.getString(5)+"</u></td>");
							out.println("<td width='12%' class=div_input >"+rs1.getString(6)+"</td>");
              out.println("<td width='12%' class=div_input >"+rs1.getString(7)+"</td>");
							out.println("<td width='12%' class=div_input align='right' >"+nf.format(rs1.getDouble(8))+"</td>");
              ...
              out.println("<td width='12%' class=div_input style='cursor:hand' onClick=\"show_transaction_history_new('"+rs1.getString(4)+"','"+rs1.getString(13)+"')\" ><u>"+rs1.getString(13)+"</u></td>");
							out.println("<td width='12%' class=div_input align='right' >"+nf.format(rs1.getDouble(14))+"</td>");
							out.println("<td width='12%' class=div_input >"+rs1.getString(15)+"</td>");
              m_tot_rec=m_tot_rec+rs1.getDouble(8);
							i++;
						...
						out.println("<td width='12%' class=div_input ></td>");
						out.println("<td width='12%' class=div_input ></td>");
						out.println("<td width='12%' class=div_input onClick=\"show_transaction_history_new('"+rs1.getString(4)+"','"+rs1.getString(13)+"')\" style='cursor:hand'><u>"+rs1.getString(13)+"</u></td>");
						out.println("<td width='12%' class=div_input align='right' >"+nf.format(rs1.getDouble(14))+"</td>");
						out.println("<td width='12%' class=div_input >"+rs1.getString(15)+"</td>");
