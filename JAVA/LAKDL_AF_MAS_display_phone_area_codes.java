...
//--
//SCREEN NAME:SYSTEM ADMINISTRATION - PHONE AREA CODES
//CREATED BY:
//DATE/TIME:
//NOTES:
...
public class LAKDL_AF_MAS_display_phone_area_codes extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>System Administration - Phone Area Codes</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("else if(data_vec.length==0 && document.Form1.SCREEN_NAME.value!=\"NEW\" && document.Form1.TXT_PHONE_AREA_CODE.value!='' && document.Form1.hid_val.value=='t1'){");
			//out.println("alert('Selected vendor code is incorrect,use help...!')");
			//out.println("    document.Form1.TXT_PHONE_AREA_CODE.value='';"); 
			//out.println("    document.Form1.TXT_PHONE_AREA_CODE.focus();"); 
			...
			out.println("else if(data_vec.length>0 && document.Form1.SCREEN_NAME.value!=\"NEW\" && document.Form1.TXT_PHONE_AREA_CODE.value!='' && document.Form1.hid_val.value=='t1'){");
			out.println("    document.Form1.TXT_PHONE_AREA_CODE.value=data_vec[0];");
			//out.println("    document.Form1.TXT_PHONE_AREA_CODE.focus();"); 
			out.println("document.Form1.TXT_CITY_CODE.value=data_vec[1];"); 
			out.println("    document.Form1.TXT_DEFAULT_VALUE.value=data_vec[2];"); 
			out.println("document.Form1.TXT_CITY_DESC.value=data_vec[3];"); 
			out.println("}");
			...
			//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_phone_area_codes&data_val=\"+obj.value+\"&ac_status=\"+document.Form1.hid_st.value;");
			
			
			out.println("    if(document.Form1.SCREEN_NAME.value==\"NEW\" && document.Form1.hid_val.value=='t1' ){");
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations1?chksql=m_prime_chk_LAKDL_AF_MAS_display_phone_area_codes_code&data_val=\"+obj.value;");
			out.println("}");
      ...
      out.println("    if(document.Form1.SCREEN_NAME.value!=\"NEW\" && document.Form1.hid_val.value=='t1' ){"); 
		  ...
		  out.println("}");	
			...
			out.println("if(document.Form1.TXT_PHONE_AREA_CODE.value==\"\"){  "); 
			out.println("DIV_TXT_PHONE_AREA_CODE.style.color='red';");
			...
			// Modified by Thamali Jayatunga on 2009.10.15, Modified function
			out.println("function before_submit(){ "); 
			out.println("		if(validate_data()){");
			out.println("		if(validate_phone_code()){"); 
			out.println("		if(confirm(\"Are you sure you want to \"+document.Form1.hid_save_status.value+\"?\")){ "); 
			out.println("		if(validate_data()){"); 
			out.println("for (var i=0; i < document.Form1.elements.length; i++ ) {");
			out.println("document.Form1.elements[i].disabled=false;");
			out.println("}");
			out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_MAS_save_phone_area_codes';"); 
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MAS_display_phone_area_codes';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("    m_help_message = \"m_help_msg_LAKDL_AF_MAS_display_phone_area_codes\";"); 
			...
			out.println("help_box.innerHTML=\" System Administration - Phone Area Codes - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" System Administration - Phone Area Codes - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
			...
			//out.println("document.Form1.TXT_PHONE_AREA_CODE.disabled=true;");
	  	...
	  	out.println("		}"); 
			...
			out.println("    m_sql = \"m_help_TXT_PHONE_AREA_CODE_sql\";"); 
			out.println("    m_criteria = document.Form1.TXT_PHONE_AREA_CODE.value+\"@Y@\";"); 
			out.println("    HelpBox('1','10','0');"); 
			out.println("}"); 
			out.println(""); 

			out.println("function help_value_assign_1() {"); 
			out.println("    document.Form1.TXT_PHONE_AREA_CODE.value=oBj.valout[2];"); 
			out.println("}"); 
		...
		//	out.println("alert('help');");
			...
			out.println("    } ");
			out.println("    else{");
			out.println("    m_criteria = document.Form1.TXT_PHONE_AREA_CODE.value+\"@\"+\"N@\";}"); 
			out.println("    HelpBox('1','10','0');"); 
			out.println("}"); 

			out.println("function help_update_value_assign_99() {"); 
			out.println("    document.Form1.TXT_PHONE_AREA_CODE.value=oBj.valout[2];"); 
			out.println("    document.Form1.TXT_CITY_CODE.value=oBj.valout[3];"); 
			out.println("    document.Form1.TXT_DEFAULT_VALUE.value=oBj.valout[4];"); 
			out.println("    assig('t1');makeRequest(document.Form1.TXT_PHONE_AREA_CODE);");
			out.println("}"); 
	  	...
	  	out.println("		}"); 
			...
			out.println("    m_sql = \"m_view_TXT_PHONE_AREA_CODE_sql\";");
			out.println("    m_criteria = document.Form1.TXT_PHONE_AREA_CODE.value+\"@\"+\"Y@\";"); 
			out.println("    HelpView('1',50,'0');"); 
			out.println("}"); 
			
			// Modified by Thamali Jayatunga on 2009.10.15, Added function validate_phone_code
			out.println("function validate_phone_code(){");	
			out.println(" if(isNaN(document.Form1.TXT_PHONE_AREA_CODE.value)) { ");
			out.println("  alert('Phone Area Code should contain Numbers');  "); 
			out.println(" document.Form1.TXT_PHONE_AREA_CODE.value=\"\" ; ");
			out.println(" document.Form1.TXT_PHONE_AREA_CODE.focus();");
			out.println("}");
			out.println(" else if (document.Form1.TXT_PHONE_AREA_CODE.value.charAt(0) != '0') {");
			out.println("alert('1st Number of Phone are code should be 0');");
			out.println(" document.Form1.TXT_PHONE_AREA_CODE.value=\"\" ; ");
			out.println(" document.Form1.TXT_PHONE_AREA_CODE.focus();");
			out.println(" return false;");
			out.println("}"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>System Administration - Phone Area Codes</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<td width='30%' ><DIV id='DIV_TXT_PHONE_AREA_CODE'  class=div_input>Phone Area Code *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_PHONE_AREA_CODE' maxlength='3' size='3' onblur=\"assig('t1'),makeRequest(document.Form1.TXT_PHONE_AREA_CODE)\">"); 
			...
			out.println("<td width='30%' ><input class='txt_input' type='text' name='TXT_CITY_CODE' maxlength='10' size='10' onblur=\"assig('t2'),makeRequest(document.Form1.TXT_CITY_CODE)\">"); 
