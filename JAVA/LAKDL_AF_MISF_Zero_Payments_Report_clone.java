...
public class LAKDL_AF_MISF_Zero_Payments_Report_clone extends javax.servlet.http.HttpServlet { 
	...
	public  void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			if(m_chksql.equals("run_report")){ 
				...
				String m_rendate=req.getParameter("rendate").trim(); // added by udara 25-01-2016
				...
				try{
					...
					callstmt1 = conn.prepareCall("BEGIN "+m_schema_name+".AF_RE_SAVE_ZERO_PAYMENTS(:1,:2,:3,:4,:5,:6);END;"); // added by udara 10-01-2014
					callstmt1.setString(1,m_rendate); // mod by udara 25-01-2016 // callstmt1.setString(1,m_date);
					...
					callstmt1.setString(7,m_date); // added by udara 25-01-2016
					callstmt1.execute();
					out.print("OK"); 
				}
				catch(Exception ex){
			...
			if(m_chksql.equals("main_page")){ 
				...
				out.println("<HTML>"); 
				out.println("<HEAD>"); 
				out.println("<TITLE>Zero Payments Report Clone</TITLE>"); 
				out.println("</HEAD>"); 
				...
				out.println("           m_rendate  = document.Form1.AT_DAY.value+'-'+document.Form1.AT_MONTH.value+'-'+document.Form1.AT_YEAR.value;  "); // added by udara 25-01-2016
				...
				//out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Zero_Payments_Report_clone?chksql=run_report&finance_no=\"+finance_no+\"&date=\"+m_date+\"&location_id=\"+document.Form1.TXT_LOCATION_CODE.value+\"&user_id=\"+document.Form1.TXT_USER.value+\"&perform_status=\"+m_perform_status;"); 
				//out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Zero_Payments_Report_clone?chksql=run_report&finance_no=\"+finance_no+\"&date=\"+m_date+\"&location_id=\"+document.Form1.TXT_LOCATION_CODE.value+\"&user_id=\"+\"\"+\"&perform_status=\"+m_perform_status;"); 
				
				// out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Zero_Payments_Report?chksql=run_report&finance_no=\"+finance_no+\"&date=\"+m_date+\"&location_id=\"+document.Form1.TXT_LOCATION_CODE.value+\"&user_id=\"+\"\"+\"&perform_status=\"+m_perform_status+\"&n_perform_status=\"+mm_perform_status;"); // commented by udara 25-01-2016 // added by udara 14-08-2015
				out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Zero_Payments_Report?chksql=run_report&finance_no=\"+finance_no+\"&date=\"+m_date+\"&location_id=\"+document.Form1.TXT_LOCATION_CODE.value+\"&user_id=\"+\"\"+\"&perform_status=\"+m_perform_status+\"&n_perform_status=\"+mm_perform_status+\"&rendate=\"+m_rendate;"); // added by udara 25-01-2016 
				...
				//out.println("               m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Zero_Payments_Report_clone?chksql=print_report_new&location=\"+m_location+\"&officer=\"+m_officer+\"&slab=\"+m_slba+\"&rendate=\"+m_rendate+\"&date=\"+m_date+\"&period=\"+m_period+\"&period_2=\"+m_period_2+\"&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&possitive_status=\"+m_possitive_status;");
				out.println("               m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Zero_Payments_Report_clone?chksql=print_report_new&location=\"+m_location+\"&officer=\"+m_officer+\"&slab=\"+m_slba+\"&rendate=\"+m_rendate+\"&date=\"+m_date+\"&period=\"+m_period+\"&period_2=\"+m_period_2+\"&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&possitive_status=\"+m_possitive_status+\"&active_status=\"+document.Form1.TXT_ACTIVE_STATUS.value+\"&region=\"+m_region;");
				out.println("           else ");
				//out.println("           	m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Zero_Payments_Report_clone?chksql=print_report_new_2&location=\"+m_location+\"&officer=\"+m_officer+\"&slab=\"+m_slba+\"&rendate=\"+m_rendate+\"&date=\"+m_date+\"&period=\"+m_period+\"&period_2=\"+m_period_2+\"&due_month=\"+due_month+\"&due_year=\"+due_year+\"&ins_level=\"+ins_level+\"&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&possitive_status=\"+m_possitive_status;");
				out.println("           	m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Zero_Payments_Report_clone?chksql=print_report_new_2&location=\"+m_location+\"&officer=\"+m_officer+\"&slab=\"+m_slba+\"&rendate=\"+m_rendate+\"&date=\"+m_date+\"&period=\"+m_period+\"&period_2=\"+m_period_2+\"&due_month=\"+due_month+\"&due_year=\"+due_year+\"&ins_level=\"+ins_level+\"&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&possitive_status=\"+m_possitive_status+\"&active_status=\"+document.Form1.TXT_ACTIVE_STATUS.value;"); // added by udara 12-05-2015
				*/
				...
				out.println("           else ");
				//out.println("           	m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Zero_Payments_Report_clone?chksql=print_report_new_2&location=\"+m_location+\"&officer=\"+m_officer+\"&slab=\"+m_slba+\"&rendate=\"+m_rendate+\"&date=\"+m_date+\"&period=\"+m_period+\"&period_2=\"+m_period_2+\"&due_month=\"+due_month+\"&due_year=\"+due_year+\"&ins_level=\"+ins_level+\"&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&possitive_status=\"+m_possitive_status;");
				out.println("           	m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Zero_Payments_Report_clone?chksql=print_report_new_2&location=\"+m_location+\"&officer=\"+m_officer+\"&slab=\"+m_slba+\"&rendate=\"+m_rendate+\"&date=\"+m_date+\"&period=\"+m_period+\"&period_2=\"+m_period_2+\"&due_month=\"+due_month+\"&due_year=\"+due_year+\"&ins_level=\"+ins_level+\"&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&possitive_status=\"+m_possitive_status+\"&active_status=\"+document.Form1.TXT_ACTIVE_STATUS.value+\"&perform_status=\"+m_perform_status;"); // added by udara 12-05-2015
				...
				out.println("	m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Zero_Payments_Report_clone?chksql=main_page&generate=drill_down_asset&finance_no=\"+m_finance_no;"); 
				...
				out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MISF_Zero_Payments_Report_clone?chksql=main_page&generate=page';"); 
				out.println("		}"); 
				out.println("}"); 
				...
				out.println("help_box.innerHTML=\" Zero Payments Report Clone - \"+m_val;"); 
				out.println("}"); 
				out.println(""); 
				
				out.println("function load_roll_out_value(){");
				out.println("help_box.innerHTML=\" Zero Payments Report Clone - \"+document.Form1.hid_status.value;"); 
				out.println("}"); 
				...
				out.println("if(validate_data()){");
				out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Zero_Payments_Report_clone?chksql=main_page&generate=print_report&location=\"+m_location+\"&officer=\"+m_officer+\"&date=\"+date;");	
				...
				out.println("</tr>"); 
				out.println("<tr>"); 
				out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Zero Payments Report Clone </td>"); 
				out.println("</tr>"); 
				out.println("<tr>"); 
				...
				String Sql_data="";
						...
						Sql_data="  WITH T AS(SELECT  "+
							...
							//" AND VALUE_DATE      			like UPPER('%"+m_rendate+"%') "; // commented by udara 25-01-2016 //added by prabah on 09-05-2012
				...
				out.println("<td width=\"150\" STYLE='{font: bold 8pt arial; text-align:left;}'   >"+m_rendate+"</td>"); // mod by udara 25-01-2016 out.println("<td width=\"150\" STYLE='{font: bold 8pt arial; text-align:left;}'   >"+m_date+"</td>"); 
