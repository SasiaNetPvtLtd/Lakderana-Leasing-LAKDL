...
public class LAKDL_AF_PRO_CR_display_payment_details_1 extends javax.servlet.http.HttpServlet { 

	ServletOutputStream out = null;
	Connection conn;
	Statement stmt2,stmt1;
	java.text.NumberFormat nf,nf1;
	public ResultSet rs2,rs1;
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
      ...
      out.println("continue;");
		  ...
		  out.println("}");		
			...
			out.println("help_button_5('0','10','0','m_help_TXT_ACCOUNT_sql','5')");
			out.println("			}");
			...
			out.println("function check_purchase_order() {");//FOR APPROVAL 2
			out.println("assig('T2')");
			if(m_st_val.equals("VERIFY")){
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_PRO_CR_sql_validations?chksql=m_prime_chk_LAKDL_AF_PRO_CR_display_main_screen_payment_details&data_val="+m_val+"&ac_status="+m_st_val+"\";");
			}
			...
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_PRO_CR_sql_validations?chksql=m_prime_chk_LAKDL_AF_CR_PRO_Asset_details&inv=&data_val=\"+obj.value+\"&ac_status=Y\";");
			out.println("load_interface(m_url,'XML');");
			out.println("}");
   		...
   		out.println("else if (document.Form1.elements[ch].value==''){");
			...
			out.println("}");
			out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_PRO_CR_save_payment_details?form_name=AF_CR_PRO_PAYMENT_MAIN_1&number='+document.Form1.hid_cnt_doc.value+'&number1='+document.Form1.hid_cnt_cr.value+'&number2='+document.Form1.hid_oth_doc.value+'&closest='+st_1+'&approval=VERIFY&approval1=R';");  
	    ...
	    out.println("else{");
		  ...
		  out.println("}");
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_PRO_CR_display_payment_details_1?PO_NO="+m_val+"&CLSTATUS=A&st_val="+m_st_val+"&st_val1="+m_st_val1+"';");
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("help_box.innerHTML=\" Credit Process - Payment Approval 2 - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" Credit Process - Payment Approval 2 - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
      ...
      out.println(" }");
			...
			out.println("    m_sql = \"m_help_TXT_ACCOUNT_sql\";"); 
			...
			out.println("    document.Form1.TXT_USER.value=data_vec[12];");
			out.println("}"); 
			...
			out.println("if(data_vec[10]=='null' || data_vec[10]==\"\"){");
			out.println("    document.Form1.TXT_USER.value=\"\";");
			out.println("}"); 		
			out.println("else{");
			out.println("    document.Form1.TXT_USER.value=data_vec[10];");
			out.println("}"); 
			...
			out.println("document.Form1.TXT_PARTY.value=1");
			...
			out.println("    document.Form1.TXT_PAYER.value=data_vec[13];");
		  ...
		  out.println("}");	
			...
			out.println("function check_insu_dd(ln){ ");
			out.println("ind='TXT_INSURANCE_DATE'+ln;");
			out.println("ind_dd='TXT_INSURANCE_DATE_DD'+ln;");
			out.println("ind_mm='TXT_INSURANCE_DATE_MM'+ln;");
			out.println("ind_yy='TXT_INSURANCE_DATE_YY'+ln;");
			...
			out.println("function check_insu_mm(ln){ ");
			out.println("ind='TXT_INSURANCE_DATE'+ln;");
			out.println("ind_dd='TXT_INSURANCE_DATE_DD'+ln;");
			out.println("ind_mm='TXT_INSURANCE_DATE_MM'+ln;");
			out.println("ind_yy='TXT_INSURANCE_DATE_YY'+ln;");
			...
			out.println("function check_rev_mm(ln){ ");
			...
			out.println(" }");
			out.println("}");
			out.println("function check_rev_dd(ln){ ");
			out.println("ind='TXT_REVENUE_LICENSE_DATE'+ln;");
			out.println("ind_dd='TXT_REVENUE_LICENSE_DATE_DD'+ln;");
			out.println("ind_mm='TXT_REVENUE_LICENSE_DATE_MM'+ln;");
			out.println("ind_yy='TXT_REVENUE_LICENSE_DATE_YY'+ln;");
			...
			out.println("function check_tax_dd(ln){ ");
			...
			out.println("function check_tax_mm(ln){ ");
			out.println("ind='TXT_LUXURY_TAX_DATE'+ln;");
			out.println("ind_dd='TXT_LUXURY_TAX_DATE_DD'+ln;");
			out.println("ind_mm='TXT_LUXURY_TAX_DATE_MM'+ln;");
			out.println("ind_yy='TXT_LUXURY_TAX_DATE_YY'+ln;");
			...
			out.println("function check_dri_dd(ln){ ");
			...
			out.println("function check_dri_mm(ln){ ");
			out.println("ind='TXT_DRIVING_LICENSE_DATE'+ln;");
			out.println("ind_dd='TXT_DRIVING_LICENSE_DATE_DD'+ln;");
			out.println("ind_mm='TXT_DRIVING_LICENSE_DATE_MM'+ln;");
			out.println("ind_yy='TXT_DRIVING_LICENSE_DATE_YY'+ln;");
			...
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_PRO_CR_sql_validations?chksql=m_prime_chk_LAKDL_AF_CR_PRO_Doc_details_test&m_app_no=\"+document.Form1.TXT_APPLICATION_NO.value+\"&screen=AF_CR_PRO_PAYMENT_MAIN_1&data_val=\"+document.Form1.TXT_PURCHASE_ORDER_NO.value+\"&data_val2=\"+array_asst[doc_row]+\"&ac_status=Y\";");
			out.println("load_interface(m_url,'XML');");
			...
			out.println("change1.innerHTML+='<HR><table align=\"center\" width=\"100%\" border=\"01\" class=\"table\">'+");									
			out.println("'<tr><td width=\"10%\" class=\"pdn_txtpos1\" style=\"{font:bold;}\" align=\"left\"><b><u>Invoice No :- '+asst_vec[row_val]+'<input type=\"hidden\" class=\"txt_input\" name=TXT_INVOICE_CODE'+ln+' maxlength=\"50\" size=\"50\" value=\"'+asst_vec[row_val]+'\"></td></tr>'+");
			out.println("'</table>'+");
			...
			out.println("'<td width=\"20%\" style=\"{font:bold;text-align:left;}\">CR Printed Date</td>'+"); 
			out.println("'</tr>'+");
			out.println("'<tr><td width=\"20%\"><input type=\"text\" style=\"{text-align:right;}\" class=\"txt_input5\" name=TXT_VEHICLE_NO'+ln+' value=\"'+asst_vec[row_val+5]+'\" maxlength=\"7\" size=\"20\"></td>'+");		
			out.println("'<td width=\"20%\"><input type=\"text\" style=\"{text-align:right;}\" class=\"txt_input5\" name=TXT_ENGIN_DOCS'+ln+' value=\"'+asst_vec[row_val+3]+'\" maxlength=\"20\" size=\"20\"></td>'+");		
			out.println("'<td width=\"20%\"><input type=\"text\" style=\"{text-align:right;}\" class=\"txt_input5\" name=TXT_CHASI_DOCS'+ln+' value=\"'+asst_vec[row_val+4]+'\" maxlength=\"20\" size=\"21\"></td>'+");		
			out.println("'<td width=\"20%\"><input type=\"text\" style=\"{text-align:right;}\" class=\"txt_input5\" name=TXT_CR_BOOK'+ln+' value=\"'+asst_vec[12]+'\" maxlength=\"20\" size=\"20\"></td>'+");		
			...
			out.println("'<tr>'+");
			out.println("'<td width=\"20%\"><input type=\"text\" style=\"{text-align:right;}\" class=\"txt_input5\" name=TXT_INSURANCE_DATE_DD'+ln+' value=\"'+dd+'\" maxlength=2 size=\"2\" onblur=\"check_insu_dd('+ln+')\">'+");		
			out.println("'<input type=\"text\" style=\"{text-align:right;}\" class=\"txt_input5\" name=TXT_INSURANCE_DATE_MM'+ln+' value=\"'+mm+'\" maxlength=2 size=\"2\" onblur=\"check_insu_mm('+ln+')\">'+");		
			...
			out.println("'<td width=\"20%\"><input type=\"text\" style=\"{text-align:right;}\" class=\"txt_input5\" name=TXT_REVENUE_LICENSE_DATE_DD'+ln+' value=\"'+revdd+'\" maxlength=\"2\" size=\"2\" onblur=\"check_rev_dd('+ln+')\">'+");		
			out.println("'<input type=\"text\" style=\"{text-align:right;}\" class=\"txt_input5\" name=TXT_REVENUE_LICENSE_DATE_MM'+ln+' value=\"'+revmm+'\" maxlength=\"2\" size=\"2\" onblur=\"check_rev_mm('+ln+')\">'+");		
			...
			out.println("'<input type=\"hidden\" style=\"{text-align:right;}\" class=\"txt_input5\" name=TXT_REVENUE_LICENSE_DATE'+ln+' value=\"'+asst_vec[row_val+7]+'\" maxlength=\"10\" size=\"10\"></td>'+");		
			out.println("'<td width=\"20%\"><input type=\"text\" style=\"{text-align:right;}\" class=\"txt_input5\" name=TXT_LUXURY_TAX_DATE_DD'+ln+' value=\"'+taxdd+'\" maxlength=\"2\" size=\"2\" onblur=\"check_tax_dd('+ln+')\">'+");		
			out.println("'<input type=\"text\" style=\"{text-align:right;}\" class=\"txt_input5\" name=TXT_LUXURY_TAX_DATE_MM'+ln+' value=\"'+taxmm+'\" maxlength=\"2\" size=\"2\" onblur=\"check_tax_mm('+ln+')\">'+");		
			...
			out.println("'<input type=\"hidden\" style=\"{text-align:right;}\" class=\"txt_input5\" name=TXT_LUXURY_TAX_DATE'+ln+' value=\"'+asst_vec[row_val+8]+'\" maxlength=\"10\" size=\"10\"></td>'+");		
			out.println("'<input type=\"text\" style=\"{text-align:right;}\" class=\"txt_input5\" name=TXT_DRIVING_LICENSE_DATE_MM'+ln+' value=\"'+drimm+'\" maxlength=\"2\" size=\"2\" onblur=\"check_dri_mm('+ln+')\">'+");		
			...
			out.println("'<input type=\"hidden\" style=\"{text-align:right;}\" class=\"txt_input5\" name=TXT_DRIVING_LICENSE_DATE'+ln+' value=\"'+asst_vec[row_val+10]+'\" maxlength=\"10\" size=\"10\"></td>'+");		
			out.println("'<td width=\"20%\"><input type=\"text\" style=\"{text-align:right;}\" class=\"txt_input5\" name=TXT_DRIVING_LICENSE_DATE_DD'+ln+' value=\"'+dridd+'\" maxlength=\"2\" size=\"2\" onblur=\"check_dri_dd('+ln+')\">'+");		
		  ...
		  out.println("}");
	   	...
	   	out.println("else");
			...
			out.println("'<td width=\"10%\" class=\"pdn_txtpos1\" style=\"{font:bold;}\" align=\"left\"><b><u>Invoice No :- '+asst_vec[row_val]+'<input class=\"txt_input\" type=\"hidden\" name=TXT_INVOICE_CODE'+ln+' maxlength=\"50\" size=\"50\" value=\"'+asst_vec[row_val]+'\"></td></tr>'+");
			out.println("'</table>'+");
			out.println("'<table align=\"center\" width=\"100%\" border=\"0\" class=\"table\">'+");	
			out.println("'<tr><td width=\"20%\" style=\"{font:bold;text-align:left;}\">Vehicle No</td>'+"); 
			out.println("'<td width=\"20%\" style=\"{font:bold;text-align:left;}\">Engine No </td>'+"); 
   		...
   		out.println("if (document.Form1.elements[dr].value=='##'){");
			...
			out.println("document.Form1.clear.disabled=false;");
			out.println("}");
			out.println("}"); 
		  ...
		  out.println("'<td width=\"12%\" align=\"center\" style=\"{font:bold;}\">Followup</td>'+"); 
			...
			out.println("if(doc_vec[i+4]=='Y' || doc_vec[i+4]=='N' || doc_vec[i+4]=='null' || doc_vec[i+4]=='-'){");
			...
			out.println("m_row3='<br><tr style=\"{color:red}\" border=1px;#D5D0C6;inset class=tr_input1>'+m_desc+m_status_pre+m_remark_pre+m_status_f+m_napp_f+m_remark+m_follup+m_fol_remark+'</tr><tr></tr><tr></tr>'+m_hid_input;");
			out.println("}");
			out.println("else{");
			out.println("m_row3='<tr>'+m_desc+m_status_pre+m_remark_pre+m_status_f+m_napp_f+m_remark+m_follup+m_fol_remark+'</tr><tr></tr><tr></tr>'+m_hid_input;");
			out.println("}");
	    ...
	    out.println("array_docu.join(\" \")+'</table>'+'<table align=\"center\" border\"4\" width=\"100%\" class=\"table\">'+");
	   	out.println("'</table>';");
			...
			out.println("'<td width=\"20%\" class=\"pdn_txtpos1\" style=\"{font:bold;}\" align=\"left\"><u>Invoice No</b></td>'+");
     	...
     	out.println("}");
		  ...
		  out.println("'<input type=\"Hidden\" name=hid_TXT_FROM_OTH_SCREEN'+ln_row_othr+' VALUE='+doc_vec_othr[i+5]+'>'+");
			...
			out.println("if(doc_vec_othr[i+4]=='A'){");
			out.println("m_system_1='<br><tr class=\"tr_input1\"><td><DIV id=DIV_TXT_SYSTEM_1  class=div_input style=color:red><b><u>System Exception</div></td></tr>';");
	    ...
	    out.println("othr_docu.join(\" \")+'</table>';");
		  ...
		  out.println("document.Form1.clear.disabled=false;");
			...
			if(m_type.equals("H")){
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_CR_PRO_Autherization_higher_Pay_1?chksql="+m_st_val+"&chksql2="+m_st_val1+"&st_c=APPLICATION_NO&oby=ASC';");
			}
			}
			out.println("}");
...
//------------------------------------------------------------------------------------------------------------------------------
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Credit Process - Payment Approval 2 </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' name=\"save\" onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Save\");'  onClick='save_window()' value=\"Save\" disabled></td>");  
			out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' name=\"help\" onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Help\");' onClick='load_screen_status(\"HELP\")' value=\"Help\"></td>");  
			out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' name=\"clear\" onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Cancel\");'  onclick='clear_window()' value=\"Cancel\"></td>");  
			out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' name=\"close\" onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Close\");'  onclick='close_screen()' value=\"Close\"></td>"); 
			...
			out.println("<input class='but_input' type='button' name='BUT_TXT_ACC_NO' value=\"Help\" onClick=\"help_button_5('0','10','0','m_help_TXT_ACCOUNT_sql','5')\"></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			...
			out.println("<tr>"); 
			out.println("<td width='30%' ><DIV id='DIV_TXT_USER'  class=div_input>Approved User </DIV></td>"); 
			out.println("<td width='30%' ><input class='txt_input' type='text' name='TXT_USER' maxlength='10' size='10'  disabled></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>");


			out.println("<tr>"); 
			out.println("<td width='30%' ><DIV id='DIV_TXT_PAYER'  class=div_input>Payer Name *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_PAYER' maxlength='200' size='200' disabled></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>");
			...
			out.println("<tr>"); 
			out.println("<td width=\"30%\" align=\"left\" >Letter Date</td>"); 
			...
			out.println("<input class=\"txt_input5\" type=\"text\" name=TXT_FROM_DATE_YY maxlength=\"4\" size=\"4\" value=\"\" onblur=\"check_date_from()\"><a href style='{cursor:hand; }'  disabled>   Calendar</a></td> ");	
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
		  ...
		  out.println("<HR>");
			...
			rs1=stmt1.executeQuery("select requ_no,trim(nvl(TO_CHAR(SETTLE_AMT,'999,999,999,999,999,999,999,999.99'),0)) from "+m_schema_name+".AF_CR_PRO_PURCHASE_ORDER_SETT  where upper(purchase_order_no)=upper('"+m_val+"') and upper(requ_no)=upper('"+m_requ+"') ");
			...
			out.println("<td width='30%' align=\"right\">Settle Amount</td>"); 
      ...
      out.println("<tr class=tr_input1 >");
			...
			out.println("<tr >"); 
			out.println("<td width='30%' align=\"left\">"+rs1.getString(1)+"</td>"); 
			out.println("<td width='30%'  align=\"right\">"+rs1.getString(2)+"</td>"); 
			out.println("<td width='*%'>&nbsp</td>"); 	
			out.println("</tr>");
		  ...
		  out.println("</tr>"); 
			out.println("</table>");
				...
				rs2= stmt2.executeQuery ("SELECT DISTINCT ISSUER_CODE,TO_CHAR(AMOUNT,'999,999,999,999,999.99'),TO_CHAR(A.ISSUED_DATE,'DD-MM-YYYY'),TO_CHAR(START_DATE,'DD-MM-YYYY'), "+
