...
public class LAKDL_FA_OP_Charges_addition extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Operation Process - Charges Addition</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("		return false;"); 
			out.println("	}");
			out.println("	else if(document.Form1.TXT_FEE_AMOUNT.value==\"\"){  "); 
			out.println("		DIV_TXT_FEE_AMOUNT.style.color='red';");
			out.println("		return false;"); 
			out.println("	}");
			out.println("	else if(document.Form1.TXT_FEE_COMMENT.value==\"\"){  "); 
			out.println("		DIV_TXT_FEE_COMMENT.style.color='red';");
			out.println("		return false;"); 
			out.println("	}");
			out.println("	else{"); 
     	...
     	out.println("		document.Form1.TXT_ADJ_DD.value=v_dd;");
   		...
   		out.println("   document.Form1.TXT_ADJ_YY.value=v_yy;");
			...
			out.println("			}");
			out.println("			if(validate_data()){"); 
			out.println("				document.Form1.action='"+m_class_url+"/"+m_fschema_name+"FA_OP_Save_charges_addition';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"FA_OP_Charges_addition';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("    m_help_message = \"m_help_msg_LAKDL_FA_CR_CHARGES_ADDITION\";"); 
			...
			out.println("	help_box.innerHTML=\" Operation Process - Charges Addition - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\" Operation Process - Charges Addition - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
	  	...
	  	out.println("					}"); 
			...
			out.println("function help_facility_fee() {"); 
			out.println(" 	document.Form1.hid_help_type.value=\"1\";"); 
			out.println(" 	m_sql = \"m_help_DIV_TXT_FACILITY_CLIENT_CHARGE_ADDITION_sql\";"); 
			...
			out.println("		document.Form1.TXT_FEE_NAME.value=oBj.valout[3];"); 
			out.println("		document.Form1.TXT_FEE_AMOUNT.value=oBj.valout[4];"); 
			out.println("		format_num(document.Form1.TXT_FEE_AMOUNT,4);"); 
			out.println("}");
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Operation Process - Charges Addition</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("</tr>");
			out.println("<tr >");
			out.println("<td width=\"15%\"><DIV id=\"DIV_TXT_ADJ_DATE\" class=div_input>Effective Date *</DIV></td>");
			...
			out.println("</tr>");
			out.println("<tr>"); 
			out.println("<td width='15%' ><DIV id='DIV_TXT_FEE_CODE'  class=div_input>Fee Code * </DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_FEE_CODE' maxlength='25' size='25' onblur=\"help_facility_fee()\"  >"); 
			out.println("<input class='but_input' type='button' name='BUT_HELP_MAIN_11' value=\"Help\" onClick=\"help_facility_fee()\"></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>");
			out.println("<tr >"); 
			out.println("<td width='15%' ><DIV id='DIV_TXT_FEE_NAME'  class=div_input>Fee Name</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_FEE_NAME' maxlength='50' size='50'  style='width:200' disabled></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>");
			out.println("<tr >"); 
			out.println("<td width='15%' ><DIV id='DIV_TXT_FEE_AMOUNT'  class=div_input>Charge Amount *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_FEE_AMOUNT' maxlength='50' size='50' onchange=\"format_num(document.Form1.TXT_FEE_AMOUNT,4)\"></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>");
			out.println("<tr >"); 
			out.println("<td width='15%' ><DIV id='DIV_TXT_FEE_COMMENT'  class=div_input>Comments *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_FEE_COMMENT' maxlength='50' size='50'  style='width:200'></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>");
			out.println("</table>"); 
