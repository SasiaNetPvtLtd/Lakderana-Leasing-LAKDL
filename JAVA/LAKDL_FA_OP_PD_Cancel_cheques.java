...
public class LAKDL_FA_OP_PD_Cancel_cheques extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Operation Process - Cancel PD Cheques Send to Client </TITLE>"); 
			out.println("</HEAD>"); 
		...
		//	out.println("	if(validate_data()){");  //comment by malik on 16/2/2009
			out.println("		if(confirm(\"Are you sure you want to \"+m_sav_msg+\" ?\")){ ");
			out.println("			for (var i=0; i < document.Form1.elements.length; i++ ) {");
			out.println("				document.Form1.elements[i].disabled=false;");
			out.println("			}");
		//	out.println("			if(validate_data()){"); //comment by malik on 16/2/2009
			out.println("				document.Form1.action='"+m_class_url+"/"+m_fschema_name+"FA_PD_Save_Cancel_Cheque';");  
			out.println("				document.Form1.submit();	"); 
			
			
		//	out.println("			}"); //comment by malik on 16/2/2009
		//	out.println("		}"); //comment by malik on 16/2/2009
			out.println("	}"); 
			out.println("} "); 
			...
			out.println("function check_cancel_pod(m_num){");
			out.println(" if(document.Form1.elements[\"CANCEL_CHK_\"+m_num].checked==true){");
			out.println("		document.Form1.elements[\"CANCEL_CHK_\"+m_num].value='on';");
			out.println("		}");
			out.println("	else{");
			out.println("		document.Form1.elements[\"CANCEL_CHK_\"+m_num].value='off';");
			out.println("}");
			out.println("}");

			out.println("function clear_window(){	"); 
			out.println("		if(confirm(\"Are you sure you want to clear the screen ?\")){ "); 
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"FA_OP_PD_Cancel_cheques';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("	help_box.innerHTML=\" Operation Process - Cancel PD Cheques Send to Client - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\" Operation Process - Cancel PD Cheques Send to Client - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
			...
			out.println("function get_pd_cancel_chq_details() {");
			out.println("		pd_cancell_cheques_data.innerHTML=\"\";");
			//out.println("		if(validate_data()){");
			out.println("				m_url=\""+m_class_url+"/"+m_fschema_name+"FA_OP_PD_Cancel_cheque_detail?chksql=LOAD_POD_CANCEL_CHEQUES&CLIENT_CODE=\"+document.Form1.TXT_CLIENT_CODE.value+\"&FACILITY_NO=\"+document.Form1.TXT_FACILITY_NO.value;");	
			out.println("				load_interface(m_url,'NO');");
		//	out.println("		}");
			out.println("}");

			out.println("function get_vector_normal(m_data){");
			out.println("		pd_cancell_cheques_data.innerHTML=m_data;");
			out.println("}");
			out.println("</script>"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Operation Process - Cancel PD Cheques Send to Client </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			//out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"View\");'  onclick='view_window()' value=\"View\"></td>"); 
			...
			out.println("<input class='but_input' type='button' name='BUT_VIEW_MAIN' value=\"Display\" onClick=\"get_pd_cancel_chq_details()\"></td>");
			out.println("</td>"); 
			out.println("</table>"); 
			out.println("<hr>");
			out.println("<DIV id='pd_cancell_cheques_data'  class=div_input></DIV>");
