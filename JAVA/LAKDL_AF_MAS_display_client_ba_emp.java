...
//--
//SCREEN NAME:SYSTEM ADMIN - EMPLOYER / BUSINESS ACTIVITIES
//CREATED BY:
//DATE/TIME:
//NOTES:
...
public class LAKDL_AF_MAS_display_client_ba_emp extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>system admin - employer / business activities</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_client_ba_emp&data_val=\"+obj.value;");
			...
			out.println("if(document.Form1.TXT_BA_NATURE_OF_BUSINESS.value==\"\"){  "); 
			out.println("DIV_TXT_BA_NATURE_OF_BUSINESS.style.color='red';");
			...
			out.println("		document.Form1.action='"+m_class_url+"/LAKDL_AF_MAS_save_client_ba_emp';");  
			...
			out.println("		if(confirm(\"Are You Sure?\")){ "); 
			out.println("		window.location.href='"+m_class_url+"/LAKDL_AF_MAS_display_client_ba_emp';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("    m_help_message = \"m_help_msg_LAKDL_AF_MAS_display_client_ba_emp\";"); 
			...
			out.println("help_box.innerHTML=\" system admin - employer / business activities - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" system admin - employer / business activities - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
	  	...
	  	out.println("		}"); 
			...
			out.println("    m_sql = \"m_help_TXT_BA_NATURE_OF_BUSINESS_sql\";"); 
			out.println("    if(document.Form1.SCREEN_NAME.value==\"EDIT\" || document.Form1.SCREEN_NAME.value==\"DACT\"){ ");
			out.println("    m_criteria = document.Form1.TXT_BA_NATURE_OF_BUSINESS.value+\"@\"+\"Y@\";"); 
			out.println("    } ");
			out.println("    else{");
			out.println("    m_criteria = document.Form1.TXT_BA_NATURE_OF_BUSINESS.value+\"@\"+\"N@\";}"); 
			out.println("    HelpBox('1','10','0');"); 
			out.println("}"); 

			out.println("function help_update_value_assign_99() {"); 
			out.println("    document.Form1.TXT_BA_NATURE_OF_BUSINESS.value=oBj.valout[2];"); 
			out.println("    document.Form1.TXT_BA_PROFESSION.value=oBj.valout[3];"); 
			out.println("    document.Form1.TXT_BA_QUALIFICATIONS.value=oBj.valout[4];"); 
			out.println("    document.Form1.TXT_BA_DESIGNATION.value=oBj.valout[5];"); 
			out.println("    document.Form1.TXT_EMP_NAME.value=oBj.valout[6];"); 
			out.println("    document.Form1.TXT_EMP_ADDRESS1.value=oBj.valout[7];"); 
			out.println("    document.Form1.TXT_EMP_ADDRESS2.value=oBj.valout[8];"); 
			out.println("    document.Form1.TXT_EMP_REFERENCE.value=oBj.valout[9];"); 
			out.println("    document.Form1.TXT_EMP_RDESIGNATION.value=oBj.valout[10];"); 
			out.println("    document.Form1.TXT_EMP_TEL_NO.value=oBj.valout[11];"); 
			out.println("    document.Form1.TXT_EMP_FAX_NO.value=oBj.valout[12];"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>system admin - employer / business activities</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_BA_NATURE_OF_BUSINESS' maxlength='100' size='100' onblur=\"makeRequest(document.Form1.TXT_BA_NATURE_OF_BUSINESS)\">"); 
