...
public class LAKDL_AF_RE_Refund_of_initial_receipt extends javax.servlet.http.HttpServlet {
  ...
  public synchronized void service(HttpServletRequest req, HttpServletResponse res)
	{
      ...
      out.println(" var m_amount_entered=0;");
       ...
       out.println("}");
        ...
        out.println("   makeRequest(m_url,'12','retandrealiz_details');");
			...
			out.println("		document.Form1.action='"+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_RE_refund_of_initial_Save';");  
      ...
      out.println("function befor_reset(){");
		  ...
		  out.println("window.location.href='"+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_RE_Refund_of_initial_receipt?chksql=main_page'");
		  out.println(" }  ");
			out.println("}");
			...
			out.println("    m_help_message = \"m_help_msg_UBFL_AF_RE_Settlement\";"); 
			...
			out.println("help_box.innerHTML=\" Collection - Refund of Initial Receipt - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" Collection - Refund of Initial Recepts - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
      ...
      out.println("}"); 
			...
			out.println("	"); 
			out.println("popupwin = window.showModalDialog('"+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_PRO_CR_Help_Servlet?class_in="+m_client_name+"AF_RE_cancelation_help_select&Sql_in='+Sql+'&Start_in='+Start+'&End_in='+End+'&Crit_In='+Crit+'&Hid_No='+Hid_No+'&Max_in='+Hid_No+'&Args=', oBj,\"dialogWidth:25em; dialogHeight:26em; center:yes; status:no\");"); //NewReceiptSql_refund
			...
			out.println(""); 
				...
				out.println("HelpBox('1','10','0',Crit,'NewReceiptSql_refund','2');"); 
				out.println("}");
      ...
      out.println("}");
		  ...
		  out.println("<BODY class='body & txt-body' leftmargin='0' topmargin='0' marginwidth='0' ONLOAD=\"load_roll_out_value(),get_sysdate()\">"); 
			...
			out.println("<input type='hidden' name='Hid_scr_name' value='AF_RE_FEFUND_RECIPT' > ");
