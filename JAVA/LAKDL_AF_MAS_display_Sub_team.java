...
public class LAKDL_AF_MAS_display_Sub_team extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>System Administration - Sub Teams</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations2?chksql=m_prime_chk_LAKDL_AF_MAS_display_sub_team&data_val=\"+obj.value+\"&ac_status=Y\";");
			out.println("else");
			
			out.println("if(document.Form1.hid_chk_status.value=='M1' && document.Form1.SCREEN_NAME.value ==\"NEW\")");
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations2?chksql=m_prime_chk_LAKDL_AF_MAS_display_sub_team&data_val=\"+obj.value;");
			out.println("else");
			...
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations2?chksql=m_prime_chk_LAKDL_AF_MAS_display_sub_team_desc&data_val=\"+obj.value ;");
      ...
      out.println("else if(document.Form1.TXT_SUB_DIVISION_CODE.value==\"\"){  "); 
			...
			out.println("     }");
			out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_MAS_save_sub_team';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MAS_display_Sub_team';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("help_box.innerHTML=\" System Administration - Sub Teams - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" System Administration - Sub Teams - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
      ...
      //Modified by Disnaka Jayasuriya on 2009-10-16 
			...
			//out.println("    document.Form1.TXT_TEAM_HEAD.value=oBj.valout[2];");  // comment by nuwan de silva on 06-02-2008
			out.println("    document.Form1.TXT_TEAM_HEAD.value=oBj.valout[2];");  // modified by nuwan de silva on 06-02-2008
			out.println("}"); 
      ...
      out.println(" }");
	  	...
	  	out.println("		}"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>System Administration - Sub Teams</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<td width='30%' ><DIV id='DIV_TXT_TEAM_ID'  class=div_input>Sub Team ID *</DIV></td>"); 
			...
			out.println("<td width='30%' ><DIV id='DIV_TXT_TEAM_DESC'  class=div_input>Sub Team Description *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_TEAM_DESC' maxlength='50' size='20' ></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 

			//out.println("<td width='30%' >Team Head </td>"); 
			out.println("<td width='30%' ><DIV id='DIV_TXT_TEAM_HEAD'  class=div_input>Sub Team Head *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_TEAM_HEAD' maxlength='10' size='10' onClick=\"help_button_3()\" >"); 
