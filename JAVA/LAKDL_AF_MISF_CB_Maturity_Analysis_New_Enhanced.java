...
// Addedby ishani jayasundara 2013.08.08
				...
				public class LAKDL_AF_MISF_CB_Maturity_Analysis_New_Enhanced extends javax.servlet.http.HttpServlet { 
				...
				callstmt1 = conn.prepareCall("BEGIN "+m_schema_name+".AF_TBD_AUTO_MATURITY_RPT(:1,:2,:3);END;"); // added by udara 19-04-2017
				...
				else if(m_chksql.equals("check_report")){ 
				...
				//callstmt1 = conn.prepareCall("BEGIN "+m_schema_name+".AF_MISF_SAVE_MAT_ANALYSIS(:1,:2);END;");
				//callstmt1 = conn.prepareCall("BEGIN "+m_schema_name+".AF_TBD_MATURITY_RPT(:1,:2);END;"); // commented by udara 19-04-2017
				rs = stmt.executeQuery("SELECT COUNT(*) FROM "+m_schema_name+".AF_TBD_AUTO_MATURITY_DET WHERE ENT_USER='"+m_user_id+"'");
				...
				out.println("		}");
				out.println("		else if(m_data==\"NO_RUN\"){");
				out.println("			alert('You have already run this Report Today,Proceed to View');");
				out.println("			print_report2();"); 
				out.println("		}");
				out.println("		else if(m_data==\"CAN_RUN\"){");
				...
				out.println("	if(document.Form1.TXT_TO_DATE_DD.value!=\"\" && document.Form1.TXT_TO_DATE_MM.value!=\"\" && document.Form1.TXT_TO_DATE_YY.value!=\"\"){");
				out.println("		m_date=document.Form1.TXT_TO_DATE_DD.value+'-'+document.Form1.TXT_TO_DATE_MM.value+'-'+document.Form1.TXT_TO_DATE_YY.value;");
				//out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_CB_Maturity_Analysis_New_Enhanced?chksql=run_report&user_id="+m_username+"&date=\"+m_date;"); // commented by udara 19-04-2017
				out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_CB_Maturity_Analysis_New_Enhanced?chksql=run_report&user_id="+m_username+"&date=\"+m_date+\"&branch=\"+m_branch;"); // added by udara 19-04-2017
				...
				out.println("function check_report() {");
				...
				out.println("		m_date=document.Form1.TXT_TO_DATE_DD.value+'-'+document.Form1.TXT_TO_DATE_MM.value+'-'+document.Form1.TXT_TO_DATE_YY.value;");
				//out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_CB_Maturity_Analysis_New_Enhanced?chksql=run_report&user_id="+m_username+"&date=\"+m_date;"); // commented by udara 19-04-2017
				out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_CB_Maturity_Analysis_New_Enhanced?chksql=check_report&user_id="+m_username+"&date=\"+m_date+\"&branch=\"+m_branch;"); // added by udara 19-04-2017
				...
				out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_CB_Maturity_Analysis_New_Enhanced?chksql=load_details&m_branch=\"+m_branch+\"&m_to_date=\"+m_to_date+\"&order_by=ENT_DATE&sort_by=ASC\";");
				...
				//added by Jithendra 11-06-2018
				out.println("function view_month_end() {");
				out.println(" 	m_to_dd = document.Form1.TXT_TO_DATE_DD.value ");
				out.println(" 	m_to_mm = document.Form1.TXT_TO_DATE_MM.value ");
				out.println(" 	m_to_yy = document.Form1.TXT_TO_DATE_YY.value ");
				...
				//out.println("		if(validate_date()) {");
				out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_CB_Maturity_Analysis_New_Auto?chksql=load_details&m_branch=\"+m_branch+\"&m_to_date=\"+m_to_date+\"&order_by=ENT_DATE&sort_by=ASC\";");
				out.println("    popupwin=window.open(m_url,'displayWindow1','left=40,top=200,width=1000,height=400,toolbar=0,location=0,center:yes,direction=0,menuBar=1,status=0,scrollbars=1,resizable=1');");
				//out.println("   }");
				out.println("}");
				//end by Jithendra 11-06-2018
				...
				out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MISF_CB_Maturity_Analysis_New_Enhanced?chksql=main_page';"); 
				out.println("		}"); 
				out.println("}"); 
	      ...
	      out.println(" document.Form1.hid_cal_date.value=num;"); 
			  ...
			  out.println("<INPUT TYPE='Hidden' NAME='hid_to_date' VALUE=\"\">");
				...
				out.println("<input class='but_input' type='button' name='BUT_PRINT' value=\"Run Report\" onClick=\"check_report()\" style=\"{width:110px;}\">"); 
				out.println("<input class='but_input' type='button' name='BUT_VIEW' value=\"Month End Report\" style=\"{width:110px;}\" onClick=\"view_month_end()\"></td>");//Added by Jithendra 11-06-2018
				out.println("<td width='*%' ></td>");
				out.println("</table>");  
    		...
    		out.println("<HTML><HEAD><TITLE>Maturity Analysis Enhanced</TITLE></HEAD>");
				out.println("<link REL='STYLESHEET' HREF='"+m_html_client_url+"/css/Asset_Financing_System.css' TYPE=\"text/css\">");
				out.println("<SCRIPT language=\"JavaScript\">"); 
  ...
  */
								...
								*/
								...
								m_sql_query =  m_sql_query + " SELECT DISTINCT A.FINANCE_NO, "+//1
										...
										" TO_CHAR(LAST_PAYMNT_DATE,'DD-MM-YYYY') ,  "+ //6
										" NVL(ARREARS_AMOUNT,0) -NVL(INS_SUSPENSE,0) "+ //7
										" FROM "+m_schema_name+".AF_TBD_AUTO_MATURITY A,"+m_schema_name+".AF_TBD_AUTO_MATURITY_DET B "+
										" WHERE A.APPLICATION_NO = B.APPLICATION_NO "+
										" AND  A.ENT_USER = '"+m_username+"' "+
										" AND  B.ENT_USER = '"+m_username+"' "+
										" AND  STATUS IN ('1','2') ";
								...
								m_sql_query =  m_sql_query + " SELECT DISTINCT A.FINANCE_NO, "+//1
										...
										" FROM "+m_schema_name+".AF_TBD_AUTO_MATURITY A "+
			...
			while(more){	
				...
				rs2 = stmt2.executeQuery(" SELECT  SUM(A.CAPITAL_AMOUNT), "+
																 ...
																 " FROM "+m_schema_name+".AF_TBD_AUTO_MATURITY_DET A "+
