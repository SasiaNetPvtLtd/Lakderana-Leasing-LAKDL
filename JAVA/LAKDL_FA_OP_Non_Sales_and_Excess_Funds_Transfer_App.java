...
public class LAKDL_FA_OP_Non_Sales_and_Excess_Funds_Transfer_App extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Operation Process - Non Sales and Excess Funds Transfer</TITLE>"); 
			out.println("</HEAD>"); 
		  ...
		  out.println("		document.Form1.elements[\"TXT_TRAN_AMOUNT_\"+k].value=0;");
			...
			out.println("			}");
			out.println("				document.Form1.action='"+m_class_url+"/"+m_fschema_name+"FA_OP_Save_Non_Sales_and_Excess_Funds_Transfer_App';");  
			...
			out.println("	help_box.innerHTML=\"  Operation Process -  Non Sales and Excess Funds Transfer - \"+m_val;"); 
  		out.println("		if(m_val==\"New\"){");
			...
			out.println("	help_box.innerHTML=\"  Operation Process -  Non Sales and Excess Funds Transfer - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
		  ...
		  out.println(" 	m_sql = \"m_help_DIV_TXT_FACILITY_NON_SALE_DELE_sql\";"); 
			...
			out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"FA_OP_Non_Sales_and_Excess_Funds_Transfer_Data?chksql=SALES_AND_EXCESS_FUNDS_TRANSFER_DATA\";");
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Operation Process -  Non Sales and Excess Funds Transfer </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
