	...
	*/
	...
	public  void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			if(m_chksql.equals("run_report")){ 
				...
				*/
				...
				rs1= stmt1.executeQuery(" SELECT APPLICATION_NO,  "+//1
					...
					" WHERE ENT_USER=UPPER('"+m_username+"') "+
					" ORDER BY CLIENT_CODE,FINANCE_NO ");
				
				
				
				
				rs2=stmt2.executeQuery("SELECT AGREEMENT_NO FROM "+m_schema_name+".af_co_mas_master_agreement_det a where ENT_USER=UPPER('"+m_username+"')");
				int cnt = 0;
				int j=1;
				String vehicle_no = "";
				String m_con_status = "";
				...
				String mm_structured_status = ""; // added by udara 05-07-2018
				int mm_security_info_count = 0; // added by udara 23-08-2018
				String mm_pledge_status = "";
				String m_reminder_letter_status = ""; // added by udara 22-04-2019
				
				String m_moratorium_flag = ""; // added by udara 12-08-2020
				
				double m_future_debits=0;// added by udara 31-12-2020
				
				
				rs1=stmt1.executeQuery(
					//out.println(
					//" SELECT DISTINCT A.CLIENT_CODE, "+//1 // commented by udara 11-03-2019
					" SELECT  A.CLIENT_CODE, "+//1 // added by udara 11-03-2019
					...
					" NVL("+m_schema_name+".AF_GET_SECURITY_INFO_COUNT(A.APPLICATION_NO),0), "+ // 12 added by udara 23-08-2018
					//" "+m_schema_name+".AF_CO_GET_PLEDGE_STATUS(A.FINANCE_NO) "+ // commented by udara 03-12-2018 // 13 added by udara 10-10-2018
					" "+m_schema_name+".AF_CO_GET_PLEDGE_STATUS_R(A.FINANCE_NO), "+ // 13 added by udara 10-10-2018
					" "+m_schema_name+".AF_CO_REM_LETTER_STATUS(A.FINANCE_NO), "+ // 14 added by udara 22-04-2019
					" NVL("+m_schema_name+".AF_CO_GET_MORA_FLAG_STATUS(A.FINANCE_NO),'-'),  "+ // 15 added by udara 12-08-2020
					" NVL("+m_schema_name+".AF_CO_GET_MORA_FUTURE_DEBITS(A.FINANCE_NO,TO_CHAR(SYSDATE,'DD-MM-YYYY')),0) "+ //  16 added by udara 31-12-2020
				...
				if(rs1.next()){					
					...
					mm_security_info_count = rs1.getInt(12); // added by udara 23-08-2018
					mm_pledge_status = rs1.getString(13); // added by udara 10-10-2018
					m_reminder_letter_status = rs1.getString(14); // added by udara 22-04-2019
					m_moratorium_flag = rs1.getString(15); // added by udara 12-08-2020
					m_future_debits = rs1.getDouble(16); // added by udara 31-12-2020
					//out.println("m_cli_add ="+m_cli_add);
				}
				
				// added by udara 22-10-2018
				/*
				if(m_trn_type.equals("LOANS")){
					mm_pledge_status = "YES";
				}
				*/
				...
				rs2=stmt2.executeQuery(
					...
					"WHERE FINANCE_NO="+m_schema_name+".AF_CO_GET_FINANCE_NO('"+m_app_no+"')");		
				
				
				if(rs2.next()){
					m_ins_company = rs2.getString(1);
					m_premium     = rs2.getDouble(2);
				}
				...
				*/
				...
				if(app_count>0){
					...
					*/
					...
					rs2=stmt2.executeQuery(
						...
						" AND RENTAL_DATE >= TRUNC(SYSDATE,'MONTH') "+ 
             			" AND RENTAL_DATE <= LAST_DAY(SYSDATE) "+ 
						" GROUP BY A.APPLICATION_NO,RENTAL_DATE,VEHICLE_NO,REG_NO "+
				...
				// added by udara 21-02-2019
				if(mm_NET_RENTAL_AMOUNT==0){
				...
				*/
				...
				//out.println("<td class=div_input ><b>:&nbsp;&nbsp;"+m_app_status+" - "+m_perform_status+"</td>"); // commented by udara 22-04-2019
				out.println("<td class=div_input ><b>:&nbsp;&nbsp;"+m_app_status+" - "+m_perform_status+" - "+m_reminder_letter_status+"</td>"); // added by udara 22-04-2019 
				...
				if(mm_security_info_count>0)
					out.println("<td class=div_input style={cursor:hand;} onClick=\"show_run_con_det('"+m_app_no+"');\" >:&nbsp;&nbsp;<u>Yes</u></td>"); //comment AS
				else
				...
				out.println("<tr>");
				out.println("<td class=div_input ><b>Structured Status</td>");
				out.println("<td class=div_input style={cursor:hand;} onClick=\"show_rental_schedule('"+m_app_no+"');\" >:&nbsp;&nbsp;<u>"+mm_structured_status+"</u></td>"); //comment AS
				out.println("<td class=div_input ><b> Pledge Status </b></td>"); // mod by udara 21-08-2015
				out.println("<td class=div_input style={cursor:hand;} onClick=\"show_pledge_details('"+m_finance_no+"');\" >:&nbsp;&nbsp;<u>"+mm_pledge_status+"</u> </td>"); // added by udara 21-08-2015 // out.println("<td class=div_input > &nbsp; </td>"); ,'"+mm_SCORE_MODEL_CODE+"','"+mm_FINAL_APP_SCORE+"','"+mm_MODEL_SCORE+"','"+mm_COMMENTS+"'
				out.println("</tr>");
				// end by udara 05-07-2018
				
				if(!m_ins_company.equals("")){
				out.println("<tr>");
				out.println("<td class=div_input ><b>Security Insurance Company</td>");
				out.println("<td class=div_input style={cursor:hand;}  >:&nbsp;&nbsp;"+m_ins_company+"</td>"); //comment AS
				out.println("<td class=div_input ><b> Security Insurance Premium </b></td>"); // mod by udara 21-08-2015
				out.println("<td class=div_input style={cursor:hand;}  >:&nbsp;&nbsp;"+nf.format(m_premium)+" </td>"); // added by udara 21-08-2015 // out.println("<td class=div_input > &nbsp; </td>"); ,'"+mm_SCORE_MODEL_CODE+"','"+mm_FINAL_APP_SCORE+"','"+mm_MODEL_SCORE+"','"+mm_COMMENTS+"'
				out.println("</tr>");
			   }
				
				// added by udara 23-01-2019
				out.println("<tr>");
				out.println("<td class=div_input ><b>Letter Print History</td>");
				out.println("<td class=div_input style={cursor:hand;} onClick=\"reminder_letter_contracts('"+m_finance_no+"');\" >:&nbsp;&nbsp;<u>view</u></td>"); //comment AS
				
				//out.println("<td class=div_input >&nbsp; </td>"); // commented by udara 12-08-2020
				//out.println("<td class=div_input onClick=\"\" >&nbsp;</td>"); // commented by udara 12-08-2020
				out.println("<td class=div_input ><b>Moratorium Flag</b> </td>"); // added by udara 12-08-2020
				//out.println("<td class=div_input onClick=\"\" > :&nbsp;&nbsp;"+m_moratorium_flag+" </td>"); // added by udara 12-08-2020
				out.println("<td class=div_input style={cursor:hand;} onClick=\"moratorium_debit_note_drill('"+m_finance_no+"');\" > :&nbsp;&nbsp; <u>"+m_moratorium_flag+" / "+nf.format(m_future_debits)+"</u> </td>"); // added by udara 06-01-2021
				...
				String		Sql_invoice=" SELECT REF_NO,TO_CHAR(DUE_DATE,'DD-MM-YYYY'),AMOUNT,TYP,NVL(CHEQUE_NO,'-') CHEQUE_NO,DESCRIPTION,STATUS,NO,ORDER_NO "+
					...
					*/
					...
					" WHEN (INVOICE_TYPE <> 'INSURANCE' AND REMARKS <> 'CHARGES - INSURANCE' AND INVOICE_TYPE<>'INV_OTHER' AND NVL("+m_schema_name+".AF_CO_GET_INST_NO_TRAN_LEDGER('"+m_application_no+"',INVOICE_NO),1)<> 0)  THEN NVL((SELECT INVOICE_DESC FROM "+m_schema_name+".AF_CO_MAS_INVOICE_RECEIPT_ORD WHERE INVOICE_TYPE_CODE=INVOICE_TYPE),"+m_schema_name+".AF_CO_GET_SUB_CHARG_DESC(INVOICE_TYPE)) "+ //[Added by milinda for  #JB16082017-00437 on 09-10-2017 ]
					...
					*/
					...
					" WHEN B.RENTAL_OTER_INVOICE >0 AND NVL(CLOSING_FLAG,'N')  ='I' AND  B.RENTAL_OTER_INVOICE >0 AND B.INSURANCE >0 THEN 'Document / Insurance Payment - Cancelation' "+ // added on 13-11-2017
				...
				while(more_inv){
					...
					// added by udara 11-06-2018
					else if(rs.getString("DESCRIPTION").equals("Credit Note - Insurance Refund Back")){
						mm_flag_insurance  =  true;
						m_cummulative_ins  =  m_cummulative_ins - rs.getDouble("AMOUNT");	
					}
					// end by udara 11-06-2018
					...
					// changed on 13-11-2017
					else if(rs.getString("DESCRIPTION").equals("Document / Insurance Payment - Cancelation")){ //#23772 Inesh 2017-08-01
						mm_flag_insurance  =  false;
						mm_flag_ins_rental_cancel = true;
						mm_row_color ="style='color:#A020F0'";
					...
					if(rs.getString(4).equals("INVOICE")){
						...
						*/
						...
						if(mm_flag_ins_rental_cancel){//#23772 Inesh 2017-08-01
							//out.println("<td width='10%' class=div_input align='right'><span "+mm_row_color+">"+nf1.format(a.abs(m_cum_value))+"</span></td>");//2017-10-24						
							out.println("<td width='10%' class=div_input align='right'><span "+mm_row_color+">"+nf1.format(a.abs(m_cum_value-m_cummulative_ins+mm_rec_insurence))+"</span></td>");
							...
							m_cum_value=m_cum_value+mm_rec_insurence;//xxxx 2017-10-24
						}else{
				...
				*/
				...
				// 	"  ORDER BY ENT_DATE ASC ";
					...
					Sql_Unallocated = " SELECT " +
											"   NVL(A.COMMENTS,'-'), " +               // 1
											"   NVL(A.ENT_USER,'-'), " +               // 2
											"   NVL(A.ASSIGN_PERSON,'-'), " +          // 3
											"   NVL(TO_CHAR(A.ENT_DATE,'DD-MM-YYYY'),'-'), " + // 4
											"   NVL(TO_CHAR(A.FOLLOWUP_DATE,'DD-MM-YYYY'),'-'), " + // 5
											// "   NVL(DECODE(A.ACTION, '001', 'New', '002', 'Pending', '003', 'In Progress','004','Hold','005','Completed', A.ACTION), '-'), " + // 6
											"   NVL((SELECT ACTION_DESC FROM " + m_schema_name + ".AF_CO_FOLLOWUP_COM_ACTION WHERE ACTION_CODE = A.ACTION), '-'), " + // 6
											"   NVL(TO_CHAR(A.FINISH_DATE,'DD-MM-YYYY'),'-'), " + // 7
											"   A.ENT_DATE, " + 
											// "   NVL((SELECT COLOUR_CODE FROM " + m_schema_name + ".AF_CO_FOLLOWUP_COM_ACTION WHERE ACTION_CODE = A.ACTION),'#000000') COLOUR_CODE" + // 9
											"   CASE " +
											"     WHEN A.ACTION = '005' THEN '#0000ff' " + //If completed, make it blue
											"     WHEN TRUNC(A.FOLLOWUP_DATE) <= TRUNC(SYSDATE) THEN '#FF0000' " + //If overdue/due today, make it red
											"     ELSE NVL((SELECT COLOUR_CODE FROM " + m_schema_name + ".AF_CO_FOLLOWUP_COM_ACTION WHERE ACTION_CODE = A.ACTION), '#000000') " + // Otherwise use standard color
											"   END AS COLOUR_CODE " + //9
											" FROM " + m_schema_name + ".AF_CO_FOLLOWUP_COMMENTS A" +
											...
											"   NVL(A.ENT_USER,'-'), " +
											"   NVL(A.ASSIGN_PERSON,'-'), " +
											"   NVL(TO_CHAR(A.ENT_DATE,'DD-MM-YYYY'),'-'), " +
											"   NVL(TO_CHAR(A.FOLLOWUP_DATE,'DD-MM-YYYY'),'-'), " +
											// "   NVL(DECODE(A.ACTION, '001', 'New', '002', 'Pending', '003', 'In Progress','004','Hold','005','Completed', A.ACTION), '-'), " +
											"   NVL((SELECT ACTION_DESC FROM " + m_schema_name + ".AF_CO_FOLLOWUP_COM_ACTION WHERE ACTION_CODE = A.ACTION), '-'), " + // 6
											"   NVL(TO_CHAR(A.FINISH_DATE,'DD-MM-YYYY'),'-'), " +
											"   A.ENT_DATE, " + 
											// "   NVL((SELECT COLOUR_CODE FROM " + m_schema_name + ".AF_CO_FOLLOWUP_COM_ACTION WHERE ACTION_CODE = A.ACTION),'#000000') COLOUR_CODE" + // 9
											"   CASE " +
											"     WHEN A.ACTION = '005' THEN '#0000ff' " + //If completed, make it blue
											...
											"     ELSE NVL((SELECT COLOUR_CODE FROM " + m_schema_name + ".AF_CO_FOLLOWUP_COM_ACTION WHERE ACTION_CODE = A.ACTION), '#000000') " + // Otherwise use standard color
											"   END AS COLOUR_CODE " + //9
											" FROM " + m_schema_name + ".AF_CO_FOLLOWUP_COMMENTS_BK A" +
											" WHERE A.FINANCE_NO = '" + m_finance_no + "' " +
											
											" ORDER BY 8 DESC "; // Sorts by the ENT_DATE column (the 8th column)
				...
				// if (true) {
					...
					out.println("<tr>");
					out.println("<td width='1%'></td>"); 
					out.println("<td width='80%' class=div_input><u><b>Follow up comment history</b></u></td>");
					out.println("<td width='*%'></td>");
					out.println("</tr>");
					out.println("</table>");
					...
					out.println("<table id='commentsTable' align='center' width='100%' class='table' >");
					out.println("<tr>");
					out.println("<td width='1%'></td>"); 
					out.println("<td width='15%' class=div_input ><b>Comment</b></td>");
					out.println("<td width='15%' class=div_input ><b>Created by</b></td>");
					out.println("<td width='15%' class=div_input ><b>Assign for</b></td>");
					out.println("<td width='15%' class=div_input ><b>Created date</b></td>");
					out.println("<td width='15%' class=div_input ><b>Follow up date</b></td>");
					out.println("<td width='15%' class=div_input ><b>Status</b></td>");
					out.println("<td width='15%' class=div_input ><b>Finish date</b></td>");
					out.println("</tr>");
					out.println("</table>");
					out.println("<br>");
					...
					while(more){
						...
						out.println("<tr>");
						out.println("<td width='1%'></td>"); 
						out.println("<td width='15%' class=div_input style='color: " + rs.getString(9) + ";'>"+rs.getString(1)+"</td>");
						out.println("<td width='15%' class=div_input style='color: " + rs.getString(9) + ";'>"+rs.getString(2)+"</td>");
						out.println("<td width='15%' class=div_input style='color: " + rs.getString(9) + ";'>"+rs.getString(3)+"</td>");
						out.println("<td width='15%' class=div_input style='color: " + rs.getString(9) + ";'>"+rs.getString(4)+"</td>");
						out.println("<td width='15%' class=div_input style='color: " + rs.getString(9) + ";'>"+rs.getString(5)+"</td>");
						// out.println("<td width='15%' class=div_input >"+rs.getString(6)+"</td>");
						out.println("<td width='15%' class=div_input style='color: " + rs.getString(9) + ";'>" + rs.getString(6) + "</td>");
						out.println("<td width='15%' class=div_input style='color: " + rs.getString(9) + ";'>"+rs.getString(7)+"</td>");
						out.println("</tr>");
					...
					//Add button for add follow up comment history
					out.println("<table align='center' width='100%' class='table' >");
					out.println("<tr>");
					out.println("<td width='1%'></td>");
					out.println("<td width='10%' class=div_input><input type='button' value='Follow-Up Comment' name='ADD_FOLLOW_UP_COMMENT' class='but_input' style='width:150px' onclick=\"add_follow_up_comment('"+m_finance_no+"')\"> </td>");
					out.println("<td width='10%' class=div_input><input type='button' value='Normal Comment' name='ADD_COMMENT' class='but_input' style='width:150px' onclick=\"add_comment('"+m_finance_no+"')\"> </td>");
					out.println("<td width='*%'></td>");
					out.println("</tr>");
					out.println("</table>");
				...
				out.println("function add_follow_up_comment(app_no){");
				out.println("    var m_url = '"+m_class_url+"/"+m_fschema_name+"AF_RE_Follow_Up_Comment?chksql=main_page&finance_no=' + app_no;");
				// out.println("    var m_url = '"+m_class_url+"/"+m_fschema_name+"AF_RE_Collection_Report_With_Age?chksql=add_follow_up_comment_ui&finance_no=' + app_no;");
				out.println("    window.open(m_url, 'FollowUpWindow', 'left=300,top=200,width=500,height=450,toolbar=0,location=0,directories=0,status=0,menuBar=0,scrollBars=1,resizable=1');");
				out.println("}");	
				out.println("function add_comment(app_no){");
				out.println("    var m_url = '"+m_class_url+"/"+m_fschema_name+"AF_RE_Follow_Up_Comment?chksql=normal_comment_page&finance_no=' + app_no;");
				// out.println("    var m_url = '"+m_class_url+"/"+m_fschema_name+"AF_RE_Collection_Report_With_Age?chksql=add_follow_up_comment_ui&finance_no=' + app_no;");
				out.println("    window.open(m_url, 'FollowUpWindow', 'left=300,top=200,width=500,height=450,toolbar=0,location=0,directories=0,status=0,menuBar=0,scrollBars=1,resizable=1');");
				out.println("}");	
				out.println("</SCRIPT>");	
				...
				*/
			...
			else if(m_chksql.equals("add_follow_up_comment_ui")) {
				String m_finance_no = req.getParameter("finance_no");
				...
				rs1= stmt1.executeQuery(" SELECT TO_CHAR(SYSDATE,'DD'),TO_CHAR(SYSDATE,'MM'),TO_CHAR(SYSDATE,'YYYY') FROM DUAL ");
				if(rs1.next()){
					out.println("document.frmComment.FOLLOW_DAY.value='"+rs1.getString(1)+"';");
					out.println("document.frmComment.FOLLOW_MONTH.value='"+rs1.getString(2)+"';");
					out.println("document.frmComment.FOLLOW_YEAR.value='"+rs1.getString(3)+"';");
				}
				out.println("}"); 

				out.println("function load_calendar(num) {");
				out.println(" document.frmComment.hid_cal_date.value=num;"); 
				out.println("	popupwin = window.open('"+m_class_url+"/"+m_fschema_name+"CO_Calendar_Window', \"oBj\",\"left=190,top=380,width=320,height=230\");"); 
				out.println(" load_c_date(document.frmComment.hid_cal_date.value);");
				out.println("}");

				out.println("function load_c_date(val) {");
				out.println("var date1='' ");
				out.println("var date2='' ");
				out.println("  if(document.frmComment.hid_cal_date.value=='2'){"); 
				...
				out.println("val=val.substr(val.indexOf('-')+1,val.length);");
				out.println("     document.frmComment.FOLLOW_DAY.value=v_date;");
				out.println("     document.frmComment.FOLLOW_MONTH.value=v_month;");
				out.println("     document.frmComment.FOLLOW_YEAR.value=val;");
				out.println("date1=v_date+'-'+v_month+'-'+val;");
				out.println("document.frmComment.hid_as_at_date.value=date1");
				//	out.println("alert(document.frmComment.hid_as_at_date.value);");
				out.println("}");
				
				out.println("}");

				out.println("function help_button_assign_per() {"); 
				out.println("    document.frmComment.hid_help_type.value=\"1\";"); 
				out.println("    m_sql = \"m_help_TXT_USERS_sql\";"); 
				out.println("    m_criteria = document.frmComment.TXT_ASSIGN_PER.value+\"@\";"); 
				...
				out.println("	if(oBj.valout[1]!=\"Prev\"){"); 
				out.println("	if(oBj.valout[1]!=\"Next\"){"); 
				out.println("		if(document.frmComment.hid_help_type.value==\"1\"){"); 
				...
				out.println("	}		"); 
				out.println("	else{");
				out.println(" document.frmComment.TXT_ASSIGN_PER.value=\"\";"); 
				...
				out.println("   document.frmComment.TXT_ASSIGN_PER.value=oBj.valout[2];");
				out.println("}");

				out.println("function get_vector(data_vec) {");
				out.println("			if(data_vec.length==0 && document.frmComment.SCREEN_NAME.value==\"NEW\" &&  document.frmComment.TXT_ASSIGN_PER.value!=\"\"){");
				...
				out.println("    document.frmComment.action = '"+m_class_url+"/"+m_fschema_name+"AF_RE_Save_Follow_Up_Comment';");
				out.println("    document.frmComment.submit();");
				out.println("}");
				...
				out.println("<form name='frmComment' method='POST'>");
				out.println("<input  type='hidden' value='NEW' name='SCREEN_NAME'> "); 
				...
				out.println("<tr><td width='30%'><b>Comment Option</b></td></tr>");
				out.println("<tr><td><b>Action</b></td><td><select name='action' class='txt_input'><option value='-' selected>-</option>");
				while(rs.next()){
					out.println("<option value='"+rs.getString(1)+"'>"+rs.getString(2)+"</option>");
				};		
				out.println("</select></td></tr>");
				out.println("<tr><td><b>Follow Up Date</b></td>");
				out.println("<td width='15%'><input name=\"FOLLOW_DAY\"   type=\"text\" maxlength=\"2\" style=\"width: 25px\" class=\"txt_input\" onchange=check_Date(document.frmComment.FOLLOW_DAY,document.frmComment.FOLLOW_MONTH,document.frmComment.FOLLOW_YEAR)>");
				out.println("<input name=\"FOLLOW_MONTH\" type=\"text\" maxlength=\"2\" style=\"width: 25px\" class=\"txt_input\" onchange=check_Date(document.frmComment.FOLLOW_DAY,document.frmComment.FOLLOW_MONTH,document.frmComment.FOLLOW_YEAR)>");
				out.println("<input name=\"FOLLOW_YEAR\"  type=\"text\" maxlength=\"4\" style=\"width: 45px\" class=\"txt_input\" onchange=check_Date(document.frmComment.FOLLOW_DAY,document.frmComment.FOLLOW_MONTH,document.frmComment.FOLLOW_YEAR)><a href style='{cursor:hand; }' onclick=load_calendar('2')>  Calendar</a></td>");
				out.println("</tr>");
				out.println("<tr><td><b>Assign Person</b></td>");
				out.println("<td width='*%' ><input class='txt_input' type='text' name='TXT_ASSIGN_PER' maxlength='200' size='10' onblur=\"makeRequest1(document.frmComment.TXT_ASSIGN_PER)\" >"); 
				...
				out.println("<input type='button' value='Save' class='mainbut'  onclick='saveComment()'> ");
				out.println("</td>");
				out.println("<td  width='30%'>");
				out.println("<input type='button' value='Cancel' class='mainbut' onclick='closePopup()'>");
				out.println("</td><td width='*%'></td></tr>");
				out.println("</table>");
