...
public class LAKDL_FA_RPT_display_accounts_interest_report extends javax.servlet.http.HttpServlet { 
...
public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
				...
				out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"FA_RPT_display_accounts_interest_report?chksql=DRILL_1&date=\"+m_from_date;");	
				...
				out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"FA_RPT_display_accounts_interest_report?chksql=DRILL_2&date=\"+m_from_date;");	
				out.println("		window.open(m_url,'popupwin3','status=0,menubar=0,scrollbars=1,height=500,width=700');");
				out.println("}");
				...
				rs=stmt.executeQuery("SELECT "+m_schema_name+".FA_FACTORING_FIN_AMT_OP('"+m_from_date+"') FROM DUAL ");
				while(rs.next()){
