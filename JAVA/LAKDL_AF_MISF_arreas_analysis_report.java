...
public class LAKDL_AF_MISF_arreas_analysis_report extends javax.servlet.http.HttpServlet { 
		...
		try { 
			...
			if(m_chksql.equals("main_page")){ 
				...
				*/
				...
				//out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_arreas_analysis_report?chksql=run_report&date=\"+m_date+\"&location_id=\"+document.Form1.TXT_LOCATION_CODE.value+\"&perform_status=\"+m_perform_status;"); // commented by udara 13-01-2015
				//out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_arreas_analysis_report?chksql=run_report&date=\"+m_date+\"&location_id=\"+document.Form1.TXT_LOCATION_CODE.value+\"&perform_status=\"+m_perform_status+\"&coll_officer\"+m_coll_officer+\"&active_status=\"+document.Form1.TXT_ACTIVE_STATUS.value;"); // added by udara 13-01-2015
				out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_arreas_analysis_report?chksql=run_report&date=\"+m_date+\"&location_id=\"+document.Form1.TXT_LOCATION_CODE.value+\"&perform_status=\"+m_perform_status+\"&coll_officer=\"+m_coll_officer+\"&active_status=\"+document.Form1.TXT_ACTIVE_STATUS.value+\"&one_year_below=\"+document.Form1.TXT_ONE_YEAR_BELOW.value;"); 
				...
				//out.println("       m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_arreas_analysis_report?chksql=print_report_new_1&location=\"+m_location+\"&date=\"+m_date+\"&active_status=\"+document.Form1.TXT_ACTIVE_STATUS.value+\"&region=\"+m_region;");  // added by udara on 09-05-2013
				out.println("       m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_arreas_analysis_report?chksql=print_report_new_1&location=\"+m_location+\"&date=\"+m_date+\"&active_status=\"+document.Form1.TXT_ACTIVE_STATUS.value+\"&region=\"+m_region+\"&perform_status=\"+m_perform_status;"); 
				...
				out.println("	m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_arreas_analysis_report?chksql=main_page&generate=drill_down_asset&finance_no=\"+m_finance_no;"); 
				...
				out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MISF_arreas_analysis_report?chksql=main_page&generate=page';"); 
				out.println("		}"); 
				out.println("}"); 
				...
				out.println("if(validate_data()){");
				out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_arreas_analysis_report?chksql=main_page&generate=print_report&location=\"+m_location+\"&officer=\"+m_officer+\"&date=\"+date;");	
			...
			//ADDED BY KANISHAK DILSHAN ON 15-05-2013
				...
				out.println("    m_order_by_type = 'ASC'; ");
				out.println("  }");
				// out.println("	m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_arreas_analysis_report?chksql=print_report_new&location="+m_location+"&officer="+m_officer+"&date="+m_date+"&sort_column=\"+m_sort_col+\"&order_by_type=\"+m_order_by_type;"); 
				out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_arreas_analysis_report?chksql=print_report_new&location="+m_location+"&officer="+m_officer+"&date="+m_date+"&sort_column=\"+m_sort_col+\"&order_by_type=\"+m_order_by_type;");	
				...
				out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_arreas_analysis_report?chksql=print_report_new_1_drill&branch=\"+val1+\"&val=\"+val2;");
