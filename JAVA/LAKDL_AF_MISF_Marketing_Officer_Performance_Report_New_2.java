...
public class LAKDL_AF_MISF_Marketing_Officer_Performance_Report_New_2 extends HttpServlet {
    ...
    public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
        ...
        try { 
            ...
            if(m_chksql.equals("run_report")){ 
                ...
                String m_user_id_coll=req.getParameter("user_id_coll");
                String m_finance_no = req.getParameter("finance_no");
                
                try{
                    callableStatement = conn.prepareCall("BEGIN "+m_schema_name+".AF_RE_SAVE_BRANCH_RPT_NEW(:1, :2, :3, :4, :5, :6); END;");
                    callableStatement.setString(1,m_date);
                    callableStatement.setString(2,m_location_id);
                    callableStatement.setString(3,m_user_id);
                    callableStatement.setString(4,m_user_id_coll);
                    callableStatement.setString(5,m_username);
                    callableStatement.setString(6,m_finance_no);
            ...
            if(m_chksql.equals("main_page")){ 
                ...
                out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Performance_Report_New_2?chksql=run_report&finance_no=\"+finance_no+\"&date=\"+m_date+\"&location_id=\"+document.Form1.TXT_LOCATION_CODE.value+\"&user_id=\"+document.Form1.TXT_USER.value+\"&user_id_coll=\"+document.Form1.TXT_USER_COLL.value;");
                ...
                out.println("	}");
                */
                out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Performance_Report_New_2?chksql=print_report_new&rpt_type=\"+m_rpt_type+\"&location=\"+m_location+\"&officer=\"+m_officer+\"&date=\"+m_date;");	
          ...
          out.println("	m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_Marketing_Officer_Performance_Report?chksql=main_page&sort_column=\"+m_sort_col+\"&order_by_type=\"+m_order_by_type;"); 
                ...
                */
                ...
                out.println("	m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Performance_Report_New_2?chksql=main_page&generate=drill_down_asset&finance_no=\"+m_finance_no;"); 
                ...
                // out.println("else if(document.Form1.hid_chk_status.value=='M_USER_COLL' && document.Form1.SCREEN_NAME.value==\"NEW\")");
                // out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_sql_validations?chksql=m_prime_chk_LAKDL_AF_Re_marketing_offcer&data_val=\"+obj.value+\"&data_val2=\"+document.Form1.TXT_LOCATION_CODE.value+\"&ac_status=Y\";");	
                ...
                // out.println(" if (Sql != 'm_help_Assign_Mkt_Col_Collection_Officer_Edit_sql') {");
                out.println("popupwin = window.showModalDialog('"+m_class_url+"/"+m_fschema_name+"AF_RE_Help_Servlet?class_in="+m_fschema_name+"AF_RE_help_select1&Sql_in='+Sql+'&Start_in='+Start+'&End_in='+End+'&Crit_In='+Crit+'&Hid_No='+Hid_No+'&Max_in='+Hid_No+'&Args=', oBj,\"dialogWidth:25em; dialogHeight:26em; center:yes; status:no\");");
                // out.println(" }");
                // out.println(" else {");
                // out.println("               popupwin = window.showModalDialog(servlet_client_url + ':' + client_t3_port + '/' + client_name + 'AF_MAS_Help_Servlet?class_in=' + client_name + 'AF_MAS_help_select' +");
                // out.println("                       '&Sql_in=' + Sql +");
                // out.println("                       '&Start_in=' + Start +");
                // out.println("                       '&End_in=' + End +");
                // out.println("                       '&Crit_In=' + Crit +");
                ...
                out.println("		help_value_assign_user_coll(oBj);"); 
                out.println("		}"); 
                ...
                out.println("function help_button_user_coll() {"); 
                out.println(" document.Form1.hid_help_type.value='5' ");
                // out.println("    Crit = document.Form1.TXT_USER_COLL.value+\"@\"+document.Form1.TXT_LOCATION_CODE.value+\"@Y@\";"); 
                // out.println("    Crit = document.Form1.TXT_USER_COLL.value + \"@Y@\";");
                out.println("    Crit = document.Form1.TXT_USER_COLL.value;");
                // out.println("    HelpBox('1', '10', '0', Crit, 'm_help_Assign_Mkt_Col_Collection_Officer_Edit_sql', '5');"); 
                out.println("    HelpBox('1', '10', '0', Crit, 'm_help_coll_officer_list_sql', '5');"); 
                out.println("}"); 
                ...
                out.println("    document.Form1.TXT_LOCATION_CODE.value=oBj.valout[7];"); 
                out.println("}"); 
                out.println("function help_value_assign_user_coll(oBj) {"); 
                out.println("    document.Form1.TXT_USER_COLL.value=oBj.valout[2];"); 
                out.println("}"); 
                ...
                out.println("if(validate_data()){");
                out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Performance_Report_New_2?chksql=main_page&generate=print_report&location=\"+m_location+\"&officer=\"+m_officer+\"&date=\"+date;");	
                ...
                out.println("<tr >"); 
                out.println("<td width='20%' ><DIV id='DIV_TXT_USER_COLL'  class=div_input>Collection Officer </DIV></td>"); 
                // out.println("<td width='*%' ><input class='txt_input' type='text' name='TXT_USER_COLL' maxlength='10' style='{width=150px}' size='10' onblur=\"assignState('M_USER_COLL'),makeRequest(document.Form1.TXT_USER_COLL)\">"); 
                out.println("<td width='*%' ><input class='txt_input' type='text' name='TXT_USER_COLL' maxlength='10' style='{width=150px}' size='10' onblur=\"\">"); 
                out.println("<input class='but_input' type='button' name='BUT_HELP_MAIN' value=\"Help\" onClick=\"help_button_user_coll()\">"); 
                out.println("</td>");
                out.println("</tr>"); 
                ...
                out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Performance_Report_New_2?chksql=print_report_new&rpt_type="+m_rpt_type+"&location="+m_location+"&officer="+m_officer+"&date="+m_date+"&sort_column=\"+m_sort_col+\"&order_by_type=\"+m_order_by_type;");	
                ...
                if (m_rpt_type.equals("ALL")) {
                    ...
                    " AND A.TARGET_MONTH = TO_CHAR(TO_DATE('"+m_date+"','DD-MM-YYYY'),'Mon-YYYY'))  , "+//17
                        */
                        " NVL("+m_schema_name+".AF_CO_GET_TARGET_AMOUNT(FINANCE_NO,TO_CHAR(TO_DATE('"+m_date+"','DD-MM-YYYY'),'Mon-YYYY')),0) ,"+ //added by nuwan de silva on 14-07-2010
                        ...
                        " NVL("+m_schema_name+".AF_CO_GET_EMP_NAME(COLLECTION_OFFICER),'-') "+//NVL("+m_schema_name+".AF_CO_GET_PRV_COLL_OFICER(application_no),'-') "+//18 Added By Lalanka on 15-07-2009
                        " ,DECODE(STATUS,'1',NVL("+m_schema_name+".AF_CO_GET_MONTHS_DIFF(APPLICATION_NO,'"+m_date+"'),0),'2', NVL("+m_schema_name+".AF_CO_GET_MONTHS_DIFF_LEGAL(FINANCE_NO,'"+m_date+"'),0) )  "+ 
                        " , "+m_schema_name+".AF_CO_GET_COLLECTION_OFFICER(COLLECTION_OFFICER) COLLECTION_OFFICER_2 " +
                    ...
                    Sql_data=" SELECT  "+
                        ...
                        " ,NVL("+m_schema_name+".AF_CO_GET_MONTHS_DIFF(APPLICATION_NO,'"+m_date+"'),0) "+
                        " , "+m_schema_name+".AF_CO_GET_COLLECTION_OFFICER(COLLECTION_OFFICER) COLLECTION_OFFICER_2 " +
                        " FROM "+m_schema_name+".AF_RE_TBD_BRANCH_REPORT B"+
                        " WHERE ENT_USER='"+m_username+"' "+
                        " AND UPPER(COLLECTION_OFFICER) LIKE UPPER('%"+m_officer+"%') "+
                    ...
                    Sql_data=" SELECT  "+
                        ...
                        " NVL("+m_schema_name+".AF_CO_GET_EMP_NAME(COLLECTION_OFFICER),'-') "+//NVL("+m_schema_name+".AF_CO_GET_PRV_COLL_OFICER(application_no),'-') "+//18 Added By Lalanka on 15-07-2009
                        //" NVL("+m_schema_name+".AF_CO_GET_PRV_COLL_OFICER(application_no),'-') "+//18 Added By Lalanka on 15-07-2009
                        " ,NVL("+m_schema_name+".AF_CO_GET_MONTHS_DIFF_LEGAL(FINANCE_NO,'"+m_date+"'),0) "+
                        " , "+m_schema_name+".AF_CO_GET_COLLECTION_OFFICER(COLLECTION_OFFICER) COLLECTION_OFFICER_2 " +
                        " FROM "+m_schema_name+".AF_RE_TBD_BRANCH_REPORT B"+
                        " WHERE ENT_USER='"+m_username+"' "+
                        " AND UPPER(COLLECTION_OFFICER) LIKE UPPER('%"+m_officer+"%') "+
                ...
                double odi_open_bal=0;
                double total_odi_target=0;
                double odi_achievement =0;
                double total_odi_achievement=0;
                double total_odi_collection=0;
                double odi_closing_bal=0;
                double total_odi_closing_bal=0;
                
                
                out.println("<table  width=\"95%\" border=\"0\" class=\"table\">");
                out.println("<tr >");
                out.println("<td width=\"*\" STYLE='{font: bold 8pt arial; text-align:center;}'   ><u>Weekly Report on Outstanding & Remittance</u></td>"); 
                out.println("</tr >");
                out.println("</table >");
                out.println("<br>");
                out.println("<br>");
                ...
                out.println("<td width=\"50\" STYLE='{font: bold 8pt arial; text-align:left;}'   >To</td>"); 
                ...
                if(!more){
                    ...
                    out.println("<tr >");
                    out.println("<td width=\"*\" STYLE='{font: bold 10pt arial; text-align:center;}'><font color='red'>No Records To Display</font></td>"); 
                    out.println("</tr >");
                    out.println("</table >");
                }
                if(more){
                    ...
                    out.println("<tr id=tr_id_header class=factoring-letter-body bgcolor=\"#C0C0C0\" style='height:25'>");
                    out.println("<td width=\"42%\" colspan=8 align='center' ><b>Contarct Detail</td>");
                    out.println("<td width=\"42%\" colspan=10 align='center' ><b>Monthly Rental Collection</td>");
                    out.println("<td width=\"42%\" colspan=9 align='center' ><b>Overdue Collection</td>");
                    out.println("</tr >");
                    /*
                    ...
                    out.println("<td width=\"7%\"  align='center' >U</td>");
                    out.println("<td width=\"7%\"  align='center' >V</td>");
                    out.println("<td width=\"7%\"  align='center' >W</td>");
                    out.println("</tr >");
                    */
                    ...
                    out.println("<td class=factoring-letter-body ><b>No</b></td>"); //1			
                    out.println("<td class=factoring-letter-body title='Click here to sort by - Agreement No  '       onclick=sort_data('FINANCE_NO') STYLE='{text-align:center; cursor:hand; }'        		 ><b>Agreement No</b></td>"); //2
                    
                    //out.println("<td class=factoring-letter-body title='Click here to sort by - Application Status  ' onclick=sort_data('FINANCE_NO') STYLE='{text-align:center; cursor:hand; }'        		 ><b>Application Status</b></td>"); //21
                    //out.println("<td class=factoring-letter-body title='Click here to sort by - Termination Date  '   onclick=sort_data('FINANCE_NO') STYLE='{text-align:center; cursor:hand; }'        		 ><b>Termination Date</b></td>"); //22
                    
                    out.println("<td class=factoring-letter-body title='Click here to sort by - Client  '             onclick=sort_data('FULL_NAME') STYLE='{text-align:center; cursor:hand; }'              ><b>Client</b></td>");  //3
                    out.println("<td class=factoring-letter-body title='Click here to sort by - Tel  '                onclick=sort_data('CLIENT_TEL_NO') STYLE='{text-align:center; cursor:hand; }'          ><b>Tel</b></td>"); //4
                    out.println("<td class=factoring-letter-body title='Click here to sort by - Due Date  '           onclick=sort_data('VALUE_DATE') STYLE='{text-align:center; cursor:hand; }'             ><b><p>Due<br>Date</p></b></td>");  //5
                    out.println("<td class=factoring-letter-body title='Click here to sort by - Monthly Rental  '     onclick=sort_data('RENTAL_AMOUNT') STYLE='{text-align:center; cursor:hand; }'          ><b><p>Monthly<br>Rental</p></b></td>");  //6
                    
                    //Monthly Rental Collection
                    out.println("<td class=factoring-letter-body title='Click here to sort by - Opening Age  '        onclick=sort_data('AGE_OLD') STYLE='{text-align:center; cursor:hand; }'                ><b><p>Opening<br>Age</p></b></td>"); //7
                    out.println("<td class=factoring-letter-body title='Click here to sort by - Opening balance  '    onclick=sort_data('OPEN_BAL') STYLE='{ text-align:center; cursor:hand; }'      			   ><b><p>Opening<br>Balance</p></b></td>");//8 
                    out.println("<td class=factoring-letter-body title='Click here to sort by - Current Month Due  '  onclick=sort_data('DUE_RENTAL_AMOUNT') STYLE='{ text-align:center; cursor:hand; }'     ><b>Current<br>Month Due</p></b></td>");//9
                    out.println("<td class=factoring-letter-body title='Click here to sort by - Current Month Due  '  onclick=sort_data('DUE_RENTAL_AMOUNT') STYLE='{ text-align:center; cursor:hand; }'     ><b>Target</p></b></td>");//10
                    out.println("<td class=factoring-letter-body title='Click here to sort by - Collections  '        onclick=sort_data('SETTLED_AMOUNT_CUR_MON') STYLE='{ text-align:center; cursor:hand; }'><b>Collections</b></td>"); //11
                    out.println("<td class=factoring-letter-body title='Click here to sort by - Achivement  '         STYLE='{ text-align:center; cursor:hand; }'                                            ><b>Achivement</b></td>");//12
                    out.println("<td class=factoring-letter-body                                                      STYLE='{ text-align:center; cursor:hand; }'                                            ><b><p>Closing<br>Balance</p></b></td>"); //13
                    out.println("<td class=factoring-letter-body title='Click here to sort by - Closing Age  '        onclick=sort_data('AGE_NEW') STYLE='{ text-align:center; cursor:hand; }'               ><b><p>Closing<br>Age</p></b></td>"); //14
                    
                    //added by ns on 08-06-2010 aggregate
                    out.println("<td class=factoring-letter-body                                                      STYLE='{ text-align:center; cursor:hand; }'               ><b><p>Aggregate<br>Age</p></b></td>"); //14
                    
                    out.println("<td class=factoring-letter-body                                                      STYLE='{text-align:center; cursor:hand; }'  																					 ><b>Remarks</b></td>");//15
                    out.println("<td class=factoring-letter-body                                                      STYLE='{text-align:center; cursor:hand; }'  																					 ><b>Follow Up</b></td>");//16
                    
                    //Overdue Collection
                    out.println("<td class=factoring-letter-body title='Click here to sort by - Opening balance  '    onclick=sort_data('OPEN_BAL') STYLE='{ text-align:center; cursor:hand; }'      			   ><b><p>Opening<br>Balance</p></b></td>");//17
                    out.println("<td class=factoring-letter-body title='Click here to sort by - Current Month Due  '  onclick=sort_data('DUE_RENTAL_AMOUNT') STYLE='{ text-align:center; cursor:hand; }'     ><b>Target</p></b></td>");//18
                    out.println("<td class=factoring-letter-body title='Click here to sort by - Collections  '        onclick=sort_data('SETTLED_AMOUNT_CUR_MON') STYLE='{ text-align:center; cursor:hand; }'><b>Collections</b></td>"); //19
                    out.println("<td class=factoring-letter-body title='Click here to sort by - Achivement  '         STYLE='{ text-align:center; cursor:hand; }'                                            ><b>Achivement</b></td>");//20
                    out.println("<td class=factoring-letter-body                                                      STYLE='{ text-align:center; cursor:hand; }'                                            ><b><p>Closing<br>Balance</p></b></td>"); //21
                    out.println("<td class=factoring-letter-body title='Click here to sort by - Opening Receivables'  STYLE='{text-align:center; cursor:hand; }'                                             ><b><p>Opening<br>Receivables</p></b></td>"); //22 
                    out.println("<td class=factoring-letter-body title='Click here to sort by - Closing Receivables'  STYLE='{ text-align:center; cursor:hand; }'                                            ><b><p>Closing<br>Receivables</p></b></td>");  //23
                    
                    out.println("<td class=factoring-letter-body STYLE='{text-align:center; cursor:hand; }'  																																															><b>City</b></td>");
                    out.println("<td class=factoring-letter-body STYLE='{text-align:center; cursor:hand; }'  																																															><b>Marketing officer</b></td>");
                    out.println("<td class=factoring-letter-body STYLE='{text-align:center; cursor:hand; }'  																																															><b>Collection officer</b></td>");
                    ...
                    while(more){
                        ...
                        out.println("<td  class=factoring-letter-body  bgcolor='lightblue' >"+j+"</td>"); //1
                        out.println("<td  class=factoring-letter-body  bgcolor='lightblue' onClick=\"show_transaction_history_new('"+rs.getString(2)+"','"+rs.getString(1)+"')\" STYLE='{text-align:left;cursor:hand; }'   ><u>"+rs.getString(1)+"</u></td>"); //2
                        
                        //out.println("<td  class=factoring-letter-body  bgcolor='lightblue' STYLE='{text-align:left;cursor:hand; }'   >"+rs.getString(21)+"</td>"); //2
                        //out.println("<td  class=factoring-letter-body  bgcolor='lightblue' STYLE='{text-align:left;cursor:hand; }'   >"+rs.getString(22)+"</td>"); //2
                        
                        
                        out.println("<td  class=factoring-letter-body  bgcolor='lightblue' onClick=\"show_client('"+rs.getString(2)+"')\" class=factoring-letter-body STYLE='{text-align:left;cursor:hand; }' ><u>"+rs.getString(3)+"</u></td>"); //3
                        out.println("<td  class=factoring-letter-body  bgcolor='lightblue' STYLE='{text-align:left;cursor:hand}' onClick=\"update_contract_detail('"+rs.getString(2)+"')\"   >"+rs.getString(10)+"</td>"); //4
                        out.println("<td  class=factoring-letter-body  bgcolor='lightblue' STYLE='{text-align:center;}'   >"+rs.getString(5)+"</td>"); //5
                        out.println("<td  class=factoring-letter-body  bgcolor='lightblue' STYLE='{text-align:right;}'   >"+nf1.format(rs.getDouble(4))+"</td>");  //6
                        
                        //Monthly Rental Collection			
                        if(rs.getDouble(6) < 0 ){
                            out.println("<td  class=factoring-letter-body  STYLE='{text-align:right; color=green; }'  ><b>"+nf.format(rs.getDouble(6))+"</td>"); //7
                        }
                        else if(rs.getDouble(6) >= 0 && rs.getDouble(6) < 2 ){
                            out.println("<td  class=factoring-letter-body  STYLE='{text-align:right; color=green; }'  ><b>"+nf.format(rs.getDouble(6))+"</td>"); //7
                        }
                        else if(rs.getDouble(6) >= 2 && rs.getDouble(6) < 3 ){
                            out.println("<td  class=factoring-letter-body  STYLE='{text-align:right; color=orange;}'  ><b>"+nf.format(rs.getDouble(6))+"</td>"); //7
                        }
                        else if(rs.getDouble(6) >= 3 ){
                            out.println("<td  class=factoring-letter-body  STYLE='{text-align:right; color=red; }'   ><b>"+nf.format(rs.getDouble(6))+"</td>"); //7
                        }
                        
                        out.println("<td  class=factoring-letter-body   STYLE='{text-align:right;}'  >"+nf1.format(rs.getDouble(7))+"</td>"); //8
                        out.println("<td  class=factoring-letter-body   STYLE='{text-align:right;}'  >"+nf1.format(rs.getDouble(11))+"</td>"); //9
                        out.println("<td  class=factoring-letter-body   STYLE='{text-align:right;}'  >"+nf1.format(rs.getDouble(17))+"</td>");//10
                        out.println("<td  class=factoring-letter-body   STYLE='{text-align:right;}'  >"+nf1.format(rs.getDouble(8))+"</td>"); //11
                        
                        
                        achievement=(rs.getDouble(8)/rs.getDouble(17))*100;
                        try {		
                            out.println("<td  class=factoring-letter-body STYLE='{text-align:right;}'  >"+nf1.format(achievement)+"%</td>"); //12
                        }
                        catch(Exception e) {
                            out.println(nf1.format(0.00)+"%</td>"); //12
                        }
                        
                        
                        closing_bal=(rs.getDouble(11)+rs.getDouble(7) ) - rs.getDouble(8);
                        
                        out.println("<td class=factoring-letter-body    STYLE='{text-align:right;}'  >"+nf1.format(closing_bal)+"</td>"); //13
                        
                        if(rs.getDouble(6) < 0 ){
                            out.println("<td  class=factoring-letter-body  STYLE='{text-align:right; color=green; }'  ><b>"+nf.format(rs.getDouble(6))+"</td>"); //14
                        }
                        else if(rs.getDouble(9) >= 0 && rs.getDouble(9) < 2 ){
                            out.println("<td  class=factoring-letter-body  STYLE='{text-align:right; color=green; }'  ><b>"+nf.format(rs.getDouble(9))+"</td>"); //14
                        }
                        else if(rs.getDouble(9) >= 2 && rs.getDouble(9) < 3 ){
                            out.println("<td  class=factoring-letter-body  STYLE='{text-align:right; color=orange;}'  ><b>"+nf.format(rs.getDouble(9))+"</td>"); //14
                        }
                        else if(rs.getDouble(9) >= 3 ){
                            out.println("<td  class=factoring-letter-body  STYLE='{text-align:right; color=red; }'  ><b>"+nf.format(rs.getDouble(9))+"</td>"); //4
                        }
                        //aggregate age added by ns on 08-06-2010
                        out.println("<td  class=factoring-letter-body  STYLE='{text-align:right; color=red; }'  ><b>"+nf.format(rs.getDouble(9)+rs.getDouble(23))+"</td>"); //4
                        
                        out.println("<td  class=factoring-letter-body   bgcolor='lightblue' style=cursor:hand onClick=\"add_client_comments('"+rs.getString(2)+"','"+rs.getString(1)+"')\"><u>Remarks</u></td>");//15
                        out.println("<td  class=factoring-letter-body   bgcolor='lightblue' style=cursor:hand onClick=\"show_followup('"+rs.getString(1)+"')\"><u>"+rs.getString(16)+"</u></td>");//16
                        
                        //Overdue Collection
                        out.println("<td  class=factoring-letter-body   STYLE='{text-align:right;}'  >"+nf1.format(rs.getDouble(18))+"</td>");//17
                        out.println("<td  class=factoring-letter-body   STYLE='{text-align:right;}'  >"+nf1.format(rs.getDouble(19))+"</td>");//18
                        out.println("<td  class=factoring-letter-body   STYLE='{text-align:right;}'  >"+nf1.format(rs.getDouble(20))+"</td>"); //19
                        odi_achievement=(rs.getDouble(20)/rs.getDouble(19))*100;
                        
                        
                        try {		
                            out.println("<td  class=factoring-letter-body   STYLE='{text-align:right;}'  >"+nf1.format(odi_achievement)+"%</td>"); //20
                        }
                        catch(Exception e) {
                            out.println(nf1.format(0.00)+"%</td>"); //20
                        }
                        
                        
                        odi_closing_bal=rs.getDouble(18)-rs.getDouble(20);
                        out.println("<td class=factoring-letter-body    STYLE='{text-align:right;}'  >"+nf1.format(odi_closing_bal)+"</td>");//21
                        out.println("<td  class=factoring-letter-body   bgcolor='lightblue' STYLE='{text-align:right;}'  >"+nf1.format(rs.getDouble(7)+rs.getDouble(14))+"</td>");  //tot.op 22
                        out.println("<td  class=factoring-letter-body   bgcolor='lightblue' STYLE='{text-align:right;}'  >"+nf1.format(closing_bal+rs.getDouble(15))+"</td>"); //tot.col  23
                        ...
                        out.println("<td  class=factoring-letter-body   STYLE='{text-align:center;}'   >"+rs.getString("COLLECTION_OFFICER_2")+"</td>"); 
                        ...
                        odi_open_bal+=rs.getDouble(18);
                        total_odi_target+=rs.getDouble(19);
                        total_odi_achievement+=odi_achievement;
                        total_odi_collection+=rs.getDouble(20);
                        total_odi_closing_bal +=odi_closing_bal; 
                        more=rs.next();
                        count+=1;
                        j+=1;
                    ...
                    if(count>0){
                        ...
                        //out.println("<td STYLE='{font:  8pt arial; text-align:left;cursor:hand; }'   >&nbsp;</td>");  //added by nuwan de silva
                        //out.println("<td STYLE='{font:  8pt arial; text-align:left;cursor:hand; }'   >&nbsp;</td>");  //added by nuwan de silva
                        ...
                        out.println("<td class=factoring-letter-body STYLE='{text-align:right;}'  ><b>"+nf1.format(total_target)+"</td>"); 
                        out.println("<td class=factoring-letter-body STYLE='{text-align:right;}'  ><b>"+nf1.format(total_collection)+"</td>"); 
                        
                        
                        
                        try {		
                            out.println("<td STYLE='{font:  bold 8pt  arial; text-align:right;}'  >"+nf1.format((total_collection/total_target)*100)+"%</td>");
                        }
                        catch(Exception e) {
                            out.println(nf1.format(0.00)+"%</td>");
                        }
                        ...
                        out.println("<td STYLE='{font:  bold 8pt  arial; text-align:right;}'  >&nbsp;</td>"); 
                        out.println("<td STYLE='{font:  bold 8pt  arial; text-align:right;}' >&nbsp;</td>"); 
                        out.println("<td STYLE='{font:  bold 8pt  arial; text-align:right;}' >&nbsp;</td>"); //aggregate age
                        
                        //Overdue Collection
                        out.println("<td class=factoring-letter-body STYLE='{text-align:right;}'  ><b>"+nf1.format(odi_open_bal)+"</td>");
                        out.println("<td class=factoring-letter-body STYLE='{text-align:right;}'  ><b>"+nf1.format(total_odi_target)+"</td>");
                        
                        out.println("<td STYLE='{font:  bold 8pt  arial; text-align:right;}'  >"+nf1.format(total_odi_collection)+"</td>"); 
                        
                        
                        
                        try {		
                            out.println("<td STYLE='{font:  bold 8pt  arial; text-align:right;}'  >"+nf1.format((total_odi_collection/total_odi_target)*100)+"%</td>"); 
                        }
                        catch(Exception e) {
                            out.println(nf1.format(0.00)+"%</td>"); 
                        }
                        
                        out.println("<td class=factoring-letter-body STYLE='{text-align:right;}'  ><b>"+nf1.format(total_odi_closing_bal)+"</td>"); 
                        ...
                        out.println("<td  class=factoring-letter-body   STYLE='{text-align:center;}'   >&nbsp;</td>"); 
                        out.println("<td  class=factoring-letter-body   STYLE='{text-align:center;}'   >&nbsp;</td>"); 
