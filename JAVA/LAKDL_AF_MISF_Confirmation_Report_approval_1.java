...
public class LAKDL_AF_MISF_Confirmation_Report_approval_1 extends javax.servlet.http.HttpServlet { //LAKDL_AF_CR_PRO_Enter_Deletion_letter_details_app
	...
	public void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { // added by udara 18-05-2017
		...
		try { 
			...
			if(m_chksql.equals("main_page")){
					out.println("<HTML>"); 
					out.println("<HEAD>"); 
					out.println("<TITLE>Confirmation Report Approval Level 2</TITLE>"); 
					out.println("</HEAD>"); 
					...
					*/
					...
					out.println("      m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Confirmation_Report_approval_1?chksql=details&status=\"+document.Form1.hid_status.value+\"&APPLICATION_NO=\"+document.Form1.TXT_APP_NO.value;"); 
					...
					out.println("			window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MISF_Confirmation_Report_approval_1?chksql=main_page';"); 
					out.println("		}"); 
					out.println("}"); 
					...
					out.println("   help_box.innerHTML=\" Confirmation Report Approval Level 2 - \"+m_val;"); 
					out.println("}"); 
					out.println(""); 

					out.println("function load_roll_out_value(){");
					out.println("help_box.innerHTML=\" Confirmation Report Approval Level 2 - \"+document.Form1.hid_status.value;"); 
					out.println("}"); 
				  ...
				  out.println("document.Form1.TXT_VALUE_DATE_YY.disabled=true;");
					...
					//out.println("alert('No invoice selected...!');"); // commented by udara 16-06-2017
					...
					//out.println("		if(validate_data()){");	
					out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_MISF_Confirmation_Report_approval_save_1';");  
				...
				*/
				...
				out.println("function load_details_report(val){"); 
				out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Confirmation_Report_Detail_View?chksql=main_page&finance_no=\"+val; ");
				out.println("window.open(m_url,'popupwin_conf_rpt_app_2','left=110,top=110,width=750,height=800,toolbar=0,location=0,directories=0,status=0,menuBar=1,scrollBars=1,resizable=1')");
				out.println("} "); 
				...
				out.println("m_url='"+m_class_url+"/"+m_fschema_name+"AF_MISF_Confirmation_Report_approval_1?chksql=drill_down&finance_no='+val;"); 
				out.println("window.open(m_url,'displayWindow3','left=50,top=60,width=850,height=500,toolbar=0,location=0,directories=0,status=0,menuBar=0,scrollBars=1,resizable=1');"); 
				out.println("}");
				...
				// end by udara 24-07-2018
					...
					out.println("<INPUT TYPE='Hidden' NAME='hid_scr_url'    VALUE=\"LAKDL_AF_MISF_Confirmation_Report_approval_1\" >"); // added by udara 13-06-2017
					...
					out.println("<INPUT TYPE='Hidden' NAME='hid_stage' VALUE=\"APPROVE_2\" >"); // added by udara 23-06-2017
					...
					out.println("</tr>"); 
					out.println("<tr>"); 
					out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Confirmation Report Approval Level 2</td>"); 
					out.println("</tr>"); 
					out.println("<tr>"); 
					...
					rs=stmt.executeQuery(" "+ 								
									" SELECT "+
										...
										//" NVL(APP_COMMENT,'-') "+ 
										//" NVL(APP_COMMENT,CONF_RPT_COMMENT)  "+ 
										...
										" DECODE(B.APPLICATION_STATUS,'ACTIVATED', "+
										  ...
										  " ,"+m_schema_name+".AF_GET_CONF_ASSIGN_ME_STATUS_2(A.FINANCE_NO,'"+m_username+"') "+ // 11 added by udara 19-07-2017
										  " ,B.APPLICATION_NO "+ // 12 added by udara 15-08-2017
										  " ,DECODE(B.PRIORITY,'A','red','black') "+// 13 // added by udara 26-03-2018
										  " ,"+m_schema_name+".AF_GET_INIT_INSURANCE_COUNT(A.FINANCE_NO)  "+ // 14 added by udara 08-08-2018
										  " ,NVL("+m_schema_name+".AF_GET_INIT_INSURANCE_COUNT_2(A.FINANCE_NO),0)  "+ // 15 added by udara 23-08-2018
				...
				out.println("<table align=\"center\" width=\"100%\" border=\"0\" class=\"table\">");
	      		out.println("<tr class=pdn_txtpos2 align='left'>");
					...
					out.println("<td  width='5%' > Details </td>");
					out.println("<td  width='5%' > Documents </td>");
					...
					out.println("<td  width='5%' > Approve </td>");
			...
			out.println("<tr style=\"color:'"+rs.getString(13)+"';\" >"); // added by udara 26-03-2018
			...
			out.println("<td  width='1%' >"+counts+"</td>"); // added by udara 15-10-2015
				...
				//out.println("<td  width='5' align=center><input type='button' name='DETA_BUTTON_"+j+"' value='View' class='but_input' onClick=load_details_report('"+rs.getString(1)+"') ></td>"); // commented by udara 14-07-2017
				out.println("<td  width='5' align=center><input type='button' name='DETA_BUTTON_"+j+"' value='View' class='but_input' onClick=load_details_report_new('"+rs.getString(1)+"') ></td>"); // added by udara 14-07-2017
				...
				//out.println("<td  width='10' align=center><input type='button' name='FEASIBILITY_BUTTON_"+j+"' value='View' class='but_input' onClick=show_feasibility_report('"+rs.getString(1)+"') ></td>"); // commented by udara 07-10-2015
				...
				*/
				...
				out.println("<td  width='10' align=center><input type='button' name='SANCTION_BUTTON_"+j+"' value='View' class='but_input' onClick=show_sanction_letter('"+rs.getString(12)+"') ></td>"); // added by udara 15-08-2017
				...
				// added by udara 13-06-2017
				//if (rs.getString(9).equals("READY")){ // commented by udara 08-08-2018
				if (rs.getString(9).equals("READY") && rs.getInt(14)==0){ // added by udara 08-08-2018
					...
					if (rs.getString(11).equals("READY")){
						out.println("<td  width='10%' align=center><input type='checkbox' name='CHK_DIS_"+j+"' value ='off' onclick=\"check_status_app("+j+");\"  ></td>"); // out.println("<td  width='5%' align=center> Not Ready </td>");
					}
					else{
