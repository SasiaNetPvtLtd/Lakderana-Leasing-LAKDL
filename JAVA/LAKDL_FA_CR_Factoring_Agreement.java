	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
    	...
    	out.println("m_writedata+'</table>';");
		  ...
		  out.println("</tr>"); 
			...
			out.println("<td width='*%' class='factoring-letter-body' style='{text-align:justify;}'>	This Recourse Factoring Agreement entered on the date given in the schedule and at the place mentioned therein between <b><i>Orient Financial Services Corporation Limited </i></b> having its registered office at No. 100, Hyde Park Corner, Colombo 02 and the principle place of business at No. 525, Union Place, Colombo 02 carrying on business under the trade name '<b><i>Orient Factor</i></b>' to factor the debts </td>");
			out.println("</tr>");
			...
			out.println("<td width='*%' class='factoring-letter-body' style='{text-align:justify;}'>	Means and includes Orient Financial Services Corporation Limited</td>");
			out.println("</tr>");
			out.println("</table><br>");
			out.println("<table border='0' width='90%' class='table'> ");	
          ...
          "winding up; and in relation to a natural person or partnership the issue of a petition for bankruptcy ; or (ii) the making of any proposal or order for or in relation to and voluntary agreement under part XXXVIIIA of the Civil Procedure Code or under the insolvency Ordinance  No.7 of 1853 ( or any statutory  modification or reenactment thereof) or (iii) sequestration.");
			...
			if(m_client_cat.trim().equals("PARTNERS")){
			rs1=stmt1.executeQuery(" SELECT A.CLIENT_CODE, A.DIR_NAME, A.DIR_NIC_NO "+
                             " FROM "+m_schema_name+".FA_CO_MAS_CLIENT_COMP_DIR A "+
                             " WHERE A.CLIENT_CODE='"+m_c_code+"'");
			String m_partner_names = "";
			String m_partner_nics = "";
			while(rs1.next()){
			m_partner_names=m_partner_names+" "+rs1.getString(2);
			m_partner_nics=m_partner_nics+" "+rs1.getString(3);
			}
			...
			out.println("<td width='50%' height='40' class='factoring-letter-body' style='{text-align:left;}' valign='top'>	");
			out.println("<br>"+m_name+" Partnership of "+m_partner_names+"<br>"+m_cli_nic+","+m_partner_nics+"<br>"+m_add1+","+m_add2+"<br>"+m_bus_nature+" ");
			out.println("</td>");
			}
			out.println("</tr>");		
			}
			else if(m_client_cat.trim().equals("SOLEPROPRI")){
			rs1=stmt1.executeQuery(" SELECT A.CLIENT_CODE, A.DIR_NAME, A.DIR_NIC_NO "+
                             " FROM "+m_schema_name+".FA_CO_MAS_CLIENT_COMP_DIR A "+
                             " WHERE A.CLIENT_CODE='"+m_c_code+"'");
			String m_propreitor_names = "";
			String m_propreitor_nics = "";
			while(rs1.next()){
			m_propreitor_names=m_propreitor_names+" "+rs1.getString(2);
			m_propreitor_nics=m_propreitor_nics+" "+rs1.getString(3);
			}
			...
			out.println(" 1A  <br>Name<br>NIC No./BRC No./PVS No.<br> Address<br>Nature of Business of Seller");
			out.println("</td>");
			if(m_propreitor_names.equals("")){
			out.println("<td width='50%' height='40' class='factoring-letter-body' style='{text-align:left;}' valign='top'>	");
			out.println("<br>"+m_name+"<br>"+m_cli_nic+"<br>"+m_add1+","+m_add2+"<br>"+m_bus_nature+" ");
			out.println("</td>");
			}else{
			out.println("<td width='50%' height='40' class='factoring-letter-body' style='{text-align:left;}' valign='top'>	");
			out.println("<br>"+m_propreitor_names+" Proprietor of "+m_name+"<br>"+m_propreitor_nics+","+m_cli_nic+"<br>"+m_add1+","+m_add2+"<br>"+m_bus_nature+" ");
			out.println("</td>");
			}
			out.println("</tr>");		
		  ...
		  String m_int_pay = nf.format(m_initial_pay);
		   ...
		   String m_cents3=m_val3.substring(m_dot3+1,m_length3);	
			...
			//Commented by Dineth on 04-05-2009
			/*
			out.println("<tr >");
			out.println("<td width='*%' height='20' class='factoring-letter-body' style='{text-align:left;}' valign='top'>	");
			...
			*/
			...
			String m_guar_data1="";
			boolean m_flag11=false;
			boolean m_flag12=false;
			...
			while(more1){
			m_guar_data1+="<tr >";
			m_guar_data1+="<td width='100%' height='20' class='factoring-letter-body' style='{text-align:left;}' valign='top'>	";
			m_guar_data1+="<br><br><br> ................................ ";
			m_guar_data1+="</td>";
			m_guar_data1+="</tr>";
			m_guar_data1+="<tr >";
			m_guar_data1+="<td width='100%' height='20' class='rep-body' style='{text-align:left;}' valign='top'>	";
			m_guar_data1+="Name: "+ rs1.getString(2)+" ";
			m_guar_data1+="</td>";
			m_guar_data1+="</tr>";
			
			m_guar_data1+="<tr >";
			m_guar_data1+="<td width='100%' height='20' class='rep-body' style='{text-align:left;}' valign='top'>	";
			m_guar_data1+="NIC: "+ rs1.getString(3)+" ";
			m_guar_data1+="</td>";
			m_guar_data1+="</tr>";
			...
			out.println("<table width='90%' border='0' cellspacing='0'> ");
			if(m_flag11==true || m_flag12==true){
			out.println("<tr >");
			out.println("<td width='100%' height='20' class='factoring-letter-body' style='{text-align:left;}' valign='top'>	");
			out.println(" Guarantors ");
			out.println("</td>");
			out.println("</tr>");
			out.println(m_guar_data1);
			out.println("</TABLE>");
			out.println("<br>");
