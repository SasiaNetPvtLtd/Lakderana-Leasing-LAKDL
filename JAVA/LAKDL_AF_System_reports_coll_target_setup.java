...
public class LAKDL_AF_System_reports_coll_target_setup extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			if(m_chksql.equals("main_page")){
					...
					out.println("<HTML>"); 
					out.println("<HEAD>"); 
					out.println("<TITLE>System Administration - Collection Target Setup</TITLE>"); 
					out.println("</HEAD>"); 
					...
					out.println("   DIV_TXT_TYPE.style.color='red';");
					out.println("   document.Form1.TXT_TYPE.focus()");
					...
					out.println("       m_target=\"CHK_REG\"+i"); 
					
					out.println("       if(document.Form1.elements[m_item_sub_cat].value==''){");
					out.println("           m_found = m_found + 1;"); 
					out.println("       }"); 
					
					out.println("       if(document.Form1.elements[m_item_cat].value==''){");
					out.println("           m_found = m_found + 1;"); 
					out.println("       }");
					
					out.println("       if(document.Form1.elements[m_target].value==''){");
					out.println("           m_found = m_found + 1;"); 
					out.println("       }");
					...
					out.println("		document.Form1.action='"+m_class_url+"/LAKDL_AF_Save_System_reports_coll_target_setup';");  
					...
					out.println("window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_System_reports_coll_target_setup?chksql=main_page';"); 
					out.println("}else {"); 			
					out.println("window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_System_reports_coll_target_setup?chksql=main_page';"); 
					out.println("}"); 
					
					//out.println("		window.location.href='"+m_class_url+"/LAKDL_AF_System_reports_coll_target_setup';"); 
					out.println("		}"); 
					out.println("}"); 
					...
					out.println("    m_help_message = \"m_help_msg_LAKDL_AF_System_reports_coll_target_setup\";"); 
					...
					out.println("help_box.innerHTML=\" System Administration - Collection Target Setup - \"+m_val;"); 
					out.println("}"); 
					out.println(""); 
		
					out.println("function load_roll_out_value(){");
					out.println("help_box.innerHTML=\" System Administration - Collection Target Setup - \"+document.Form1.hid_status.value;"); 
					out.println("}"); 
					...
					//out.println("                                 '<TD WIDTH=\"10%\" align=\"left\"> &nbsp; </TD>'+");
					out.println("                                 '<TD WIDTH=\"10%\" align=\"left\">To</TD>'+");
					//out.println("                                 '<TD WIDTH=\"10%\" align=\"left\"> &nbsp; </TD>'+");
					//out.println("                                 '<TD WIDTH=\"10%\" align=\"left\"> &nbsp; </TD>'+");
					out.println("                                 '<TD WIDTH=\"10%\" align=\"left\"> Target </TD>'+");
					out.println("                                 '<TD WIDTH=\"10%\" align=\"left\"> &nbsp; </TD>'+");
					...
					out.println("  '<TD WIDTH=\"10%\" ><input class=\"txt_input3\" type=\"text\"     name=TXT_ITEM_SUB_CAT'+lineno_bank+'      value=\"\" onblur=\"check_for_number(this);\" ></TD>'+");
					...
					out.println("  '<TD WIDTH=\"10%\" ><input class=\"txt_input3\" type=\"text\"     name=TXT_ITEM_CAT_CODE'+lineno_bank+'     value=\"\" onblur=\"check_for_number(this);\" ></TD>'+"); 	
				    //out.println("  '<TD WIDTH=\"10%\" align=\"left\"> <DIV id=DIV_TXT_ITEM_CAT_CODE'+lineno_bank+'  class=div_input>  </DIV> </TD>'+");
					//out.println("  '<TD WIDTH=\"10%\" align=\"left\"> &nbsp; </TD>'+");
					out.println("  '<TD WIDTH=\"10%\" ><input class=\"txt_input3\" type=\"text\" name=CHK_REG'+lineno_bank+' onblur=\"check_for_percentage(this);\" ></td>'+");
					...
					out.println("'<TD WIDTH=\"10%\"><input class=\"txt_input3\" type=\"text\"   name=TXT_ITEM_SUB_CAT'+j+'     value=\"\"    onblur=\"check_for_number(this);\" ></TD>'+");
					...
					out.println("'<TD WIDTH=\"10%\"><input class=\"txt_input3\" type=\"text\"   name=TXT_ITEM_CAT_CODE'+j+'    value=\"\" onblur=\"check_for_number(this);\" ></TD>'+"); 
					//out.println("'<TD WIDTH=\"10%\" align=\"left\"> <DIV id=DIV_TXT_ITEM_CAT_CODE'+j+'  class=div_input> '+array_item_cat_desc[j]+' </DIV> </TD>'+");
					//out.println("'<TD WIDTH=\"10%\" align=\"left\"> &nbsp; </TD>'+");
					out.println("'<TD WIDTH=\"10%\" ><input   class=\"txt_input3\" type=\"text\"  name=CHK_REG'+j+' value=\"\" onblur=\"check_for_percentage(this);\" ></td>'+");
					...
					out.println("e_txt_bank.innerHTML +='<table align=\"center\" width=\"100%\" class=\"table\"><tr>'+");									
					out.println("'<TD WIDTH=\"10%\"><input class=\"txt_input3\" type=\"text\"   name=TXT_ITEM_SUB_CAT'+j+'      value=\"'+array_banker[j]+'\"  onblur=\"check_for_number(this);\" ></TD>'+");
					//out.println("'<TD WIDTH=\"10%\"><input class=\"but_input\"  type=\"button\" name=BUT_TXT_ITEM_SUB_CAT'+j+'  value=\"...\" onClick=\"help_update('+j+')\" style=\"width: 30px\" ></td>'+");
					//out.println("'<TD WIDTH=\"10%\" align=\"left\"> <DIV id=DIV_TXT_ITEM_SUB_CAT'+j+'  class=div_input> '+array_item_sub_cat_desc[j]+' </DIV> </TD>'+");
					out.println("'<TD WIDTH=\"10%\"><input class=\"txt_input3\" type=\"text\"   name=TXT_ITEM_CAT_CODE'+j+'     value=\"'+array_banker_name[j]+'\" onblur=\"check_for_number(this);\" ></TD>'+");
					//out.println("'<TD WIDTH=\"10%\" align=\"left\"> <DIV id=DIV_TXT_ITEM_CAT_CODE'+j+'  class=div_input> '+array_item_cat_desc[j]+' </DIV> </TD>'+");
					//out.println("'<TD WIDTH=\"10%\" align=\"left\"> &nbsp; </TD>'+");
					out.println("'<TD WIDTH=\"10%\" ><input   class=\"txt_input3\" type=\"text\"  name=CHK_REG'+j+'  value=\"'+array_chk_reg[j]+'\" onblur=\"check_for_percentage(this);\" ></td>'+");
					out.println("'<TD WIDTH=\"10%\"><input class=\"but_input\"  type=\"button\" name=BUT_SUB_CAT_DEL'+j+'       value=\"Delete\" onClick=del_row_bank(\"'+j+'\",\"'+type+'\")></td>'+");
					out.println("'<TD WIDTH=\"20%\" align=\"left\"> &nbsp; </TD>'+");
					out.println("'</tr></table>';");
					...
					out.println("      m_url=\""+m_class_url+"/"+m_fschema_name+"AF_System_reports_coll_target_setup?chksql=load_dynamic&coll_type=\"+document.Form1.TXT_TYPE.value;"); 
					out.println("      load_interface(m_url,'NORM');");
					out.println("}");
					
					out.println("function load_dynamic_count() {");
					out.println("      document.Form1.hid_val.value='t2'; ");
					out.println("      m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=load_dynamic_count_coll_target&coll_type=\"+document.Form1.TXT_TYPE.value;");
					out.println("      load_interface(m_url,'XML');");
					out.println("}");
					...
					out.println("function check_for_number(obj) {");
					out.println("  if(isNaN(obj.value)){");
					out.println("     alert('Please enter a number'); ");
					out.println("     obj.value = ''; ");
					out.println("  }");
					out.println("  else{");
					//out.println("     format_number(obj); ");
					out.println("  }");
					out.println("}");
					
					out.println("function check_for_percentage(obj) {");
					out.println("  if(isNaN(obj.value)){");
					out.println("     alert('Please enter a number'); ");
					out.println("     obj.value = ''; ");
					out.println("  }");
					out.println("  else if(obj.value > 100 || obj.value < 0){ ");
					out.println("     alert('Please enter a number bettween 0 - 100'); ");
					out.println("     obj.value = ''; ");
					out.println("  }");
					out.println("  else{");
					//out.println("     format_number(obj); ");
					...
					out.println("</tr>"); 
					out.println("<tr>"); 
					out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>System Administration - Collection Target Setup</td>"); 
					out.println("</tr>"); 
					out.println("<tr>"); 
					...
					out.println("<tr >");
					out.println("<td width=\"20%\"><DIV id=\"DIV_TXT_EFFECTIVE_DATE\" class=div_input>Date *</DIV></td>");
					...
					out.println("<tr >"); 
					out.println("<td width='20%' ><DIV id='DIV_TXT_VEHICLE_CATEGORY'  class=div_input>Collection Target Setup *</DIV></td>"); 
					...
					out.println("<tr >"); 
					out.println("<td width='20%' ><DIV id='DIV_TXT_VEHICLE_CATEGORY_DESCRIPTION'  class=div_input>Collection Target Setup Description *</DIV></td>"); 
					...
					*/
					...
					out.println("<tr >"); 
					out.println("<td width='20%' ><DIV id='DIV_TXT_TYPE'  class=div_input>Report Type</DIV></td>"); 
					out.println("<td width='40%' >"); 
					out.println("<select class='txt_input' name='TXT_TYPE' onchange='load_dynamic_count();' >");  
					out.println("      <OPTION value='' ></OPTION>");
					out.println("      <OPTION value='RENTAL_BELOW'  >Rental Below</OPTION>");
					out.println("      <OPTION value='RENTAL_ABOVE'  >Rental Above</OPTION>");
					out.println("</select>");
					out.println("<td width='*%'></td>"); 
					out.println("</tr>"); 
					out.println("<tr>"); 
					...
					String	m_coll_type  = req.getParameter("coll_type");
					int j = 0;
					...
					while(rs.next()){
							...
							out.println("  <TD WIDTH=\"10%\" ><input class=\"txt_input3\" type=\"text\"     name='TXT_ITEM_SUB_CAT"+j+"'       value='"+nf.format(rs.getDouble("FROM_AMOUNT"))+"'   onblur=\"\" ></TD>");
							//out.println("  <TD WIDTH=\"10%\" > <DIV  id='DIV_TXT_ITEM_SUB_CAT"+j+"'    class=div_input> "+rs.getString("ITEM_SUB_CAT_DESC")+" </DIV> </TD>");
							//out.println("  <TD WIDTH=\"10%\" ><input class=\"but_input\"  type=\"button\"   name='BUT_TXT_ITEM_SUB_CAT"+j+"'   value=\"...\" onClick=\"help_update('"+j+"')\" style=\"width: 30px\"  ></td>");
							out.println("  <TD WIDTH=\"10%\" ><input class=\"txt_input3\" type=\"text\"     name='TXT_ITEM_CAT_CODE"+j+"'      value='"+nf.format(rs.getDouble("TO_AMOUNT"))+"'   > </TD>"); 
					        //out.println("  <TD WIDTH=\"10%\" > <DIV  id='DIV_TXT_ITEM_CAT_CODE"+j+"'    class=div_input> "+rs.getString("ITEM_CAT_DESC")+" </DIV> </TD>");
						    //out.println("  <TD WIDTH=\"10%\" > &nbsp; </TD>");
							
							out.println("  <TD WIDTH=\"10%\" ><input   type=\"text\"  class=\"txt_input3\"  name='CHK_REG"+j+"'  value='"+nf.format(rs.getDouble("TARGET"))+"'  >");
