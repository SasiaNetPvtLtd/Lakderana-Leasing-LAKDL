...
public class LAKDL_AF_MISF_Recovery_Report extends javax.servlet.http.HttpServlet { 
		...
		try { 
			...
			if(m_chksql.equals("run_report")){ 
				...
				try{
					...
					callstmt1 = conn.prepareCall("BEGIN "+m_schema_name+".AF_RE_SAVE_RECOVER_RPT_CHECK(:1,:2,:3,:4,:5,:6,:7,:8,:9);END;"); // added by udara 28-06-2016
			...
			if(m_chksql.equals("main_page")){ 
				...
				//out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report?chksql=run_report&finance_no=\"+finance_no+\"&date=\"+m_date+\"&location_id=\"+document.Form1.TXT_LOCATION_CODE.value+\"&user_id=\"+document.Form1.TXT_USER.value;"); //COMMENTED MILINDA 
				//out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report?chksql=run_report&finance_no=\"+finance_no+\"&date=\"+m_date+\"&location_id=\"+document.Form1.TXT_LOCATION_CODE.value+\"&user_id=\"+document.Form1.TXT_USER.value+\"&cr_officer=\"+m_cr_officer;"); //MOD BY MILINDA // commented by udara 21-11-2013
				...
				//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report?chksql=print_report_new&location=\"+m_location+\"&officer=\"+m_officer+\"&date=\"+m_date;");	
				...
				out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report?chksql=print_report_new&location=\"+m_location+\"&officer=\"+m_officer+\"&date=\"+m_date+\"&perform_status=\"+perform_status+\"&cr_officer=\"+m_cr_officer+\"&active_status=\"+document.Form1.TXT_ACTIVE_STATUS.value+\"&region=\"+m_region;");  // added by udara on 09-05-2013 //mod by milinda 2013-10-16
				...
				out.println("	m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report?chksql=main_page&generate=drill_down_asset&finance_no=\"+m_finance_no;"); 
				...
				out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report?chksql=main_page&generate=page';"); 
				out.println("		}"); 
				out.println("}"); 
				...
				out.println("if(validate_data()){");
				out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report?chksql=main_page&generate=print_report&location=\"+m_location+\"&officer=\"+m_officer+\"&date=\"+date;");	
				...
				// added by udara 19-08-2016
				out.println("function run_report_thread(){"); 
				
				out.println("   if(confirm(\"Are you sure you want to run the recovery report thread?\")){  ");
				out.println("      document.Form1.action=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_MISF_Recovery_Report_thread_save\";");
				out.println("      document.Form1.submit();");
				//out.println("      alert('Ready');");
				out.println("   }");
				
				out.println("}");
				// end by udara 19-08-2016
				...
				out.println("<input class='but_input' type='button' name='BUT_PRINT_THREAD' value=\"Run Report Test\" onClick=\"run_report_thread()\" style=\"{width:110px;}\">"); // out.println("<input class='but_input' type='button' name='BUT_PRINT_THREAD' value=\"Run Report Thread\" onClick=\"run_report_thread()\" style=\"{width:110px;}\">"); // added by udara 19-08-2016
				out.println("</td>"); 
				out.println("</tr>");
