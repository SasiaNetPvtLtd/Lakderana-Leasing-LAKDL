//--
//SCREEN NAME	:MIS - RECEIPT DEPOSITE REPORT
...
public class LAKDL_AF_MISF_display_receipt_deposit_report extends javax.servlet.http.HttpServlet { 
...
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!	
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE> Recipt Deposit Report Details</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("			if(data_vec.length==0 && document.Form1.SCREEN_NAME.value==\"NEW\" && document.Form1.TXT_PURCHASE_ORDER_NO.value!=\"\" && document.Form1.hid_assig.value==\"G1\"){");
			...
			out.println("			}");
			out.println("			if(data_vec.length==0 && document.Form1.SCREEN_NAME.value==\"NEW\" &&  document.Form1.TXT_INQUIRY_NO.value!=\"\" && document.Form1.hid_assig.value==\"G5\"){");
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MISF_display_receipt_deposit_report?chksql=main_page';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("    m_help_message = \"m_help_msg_LAKDL_LAKDL_AF_MISF_display_receipt_deposit_report\";"); 
			...
			out.println("help_box.innerHTML=\"  Recipt Deposit Report Details - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\"  Recipt Deposit Report Details - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
			...
			out.println("function makeRequest1(obj) {");//not used
			out.println("if(document.Form1.hid_assig.value==\"G1\"){");//PURCHASE ORDER NO
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_sql_validations?chksql=m_prime_chk_LAKDL_AF_MK_display_purchase_order&data_val=\"+obj.value+\"&ac_status=Y\";");
			out.println("}");
		  ...
		  out.println("function view() {"); 
			...
			//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_display_receipt_deposit_report1?chksql=MAIN&receipt_no=\"+document.Form1.RECEIPT_NO.value+\"&deposite_no=\"+document.Form1.DEPOSIT_CODE.value+\"\";");    //Commmented by Chandana on 08/05/2007
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_display_receipt_deposit_report1?chksql=MAIN&deposite_no=\"+document.Form1.DEPOSIT_CODE.value+\"&from_date=\"+from_date+\"&to_date=\"+to_date+\" \";"); //-- Added by chandana on 08/05/2007 --//
			...
			out.println("    m_sql = \"ReceiptSql1\";"); 
			out.println("    m_criteria = document.Form1.RECEIPT_NO.value+\"@\";");
			...
			out.println("    m_sql = \"m_help_Collection_process_Deposit_code\";"); 
			out.println("    m_criteria = document.Form1.DEPOSIT_CODE.value+\"@Y@\";"); 
			out.println("    HelpBox('1','10','0');"); 
			out.println("}"); 
...
//-----------------------------------------------------------------------------------------------------------------------
			...
			out.println("</script>"); 
			out.println("<BODY class='body & txt-body' leftmargin='0' topmargin='0' marginwidth='0' ONLOAD=\"load_lock();get_sys_date();\">"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Recipt Deposit Report Details</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
      ...
      //Commented by Dineth on 2009-01-19
			/*out.println("<tr class=tr_input>");
			out.println("<td width=\"20%\"><DIV id='DIV_TXT_rec_CODE'  class=div_input>Receipt No</td>");
			out.println("<td width=\"30%\"><input name=\"RECEIPT_NO\" type=\"text\" maxlength=\"15\" class=\"txt_input\" > ");
			out.println("<input type=button name=rec_help value=Help class=\"but_input\" onclick=\"help_button_1()\"  ></td>");
			out.println("</td>");*/
			//Commented by Dineth on 2009-01-19
			//---- Added by Chandana on 08/05/2007 Modified by Dineth on 2009-01-19-----//
			out.println("<tr class=tr_input>");
			out.println("<td width='12%' ID=VDATE>Deposit Date</td>");
			...
			// Added by Udara Somathilake on 14/9/2009
      ...
      //----- End Chandana on 08/05/2007  --------------//
			...
			out.println("<td width='40%' ><input class='txt_input' type='text' name='DEPOSIT_CODE' maxlength='15' size='10' >"); 
			out.println("<input class='but_input' type='button' name='BUT_HELP_MAIN' value=\"Help\" onClick=\"help_button_2()\" ></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("<td width='10%'><input class='mainbut' type='button' name='BUT_VIEW' value=\"View\" onClick=\"view();\";></td>"); 
			out.println("</tr>"); 
