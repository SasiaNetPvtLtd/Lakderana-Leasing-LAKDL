...
public class LAKDL_AF_CR_Legal_TerminationCheck extends javax.servlet.http.HttpServlet {
  ...
  public synchronized void service(HttpServletRequest req, HttpServletResponse res)
	{
      ...
      //conn = DriverManager.getConnection("jdbc:oracle:thin:@147.120.40.1:1521:DN10G", "system", "sys123");
       ...
       out.println("}");
			  ...
			  out.println("}");		
				...
				out.println(" document.Form1.hid_opt_val.value=num;"); 
			  out.println("	popupwin = window.open(\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_Legal_TerminationCheck?chksql=get_Invoice&client=\"+document.Form1.CLIENT_CODE.value+\"\", \"oBj\",\"left=130,top=200,width=750,height=400\");"); 
			  out.println("}");	
        ...
        out.println("   if(parseFloat(m_inv_allo)>0){"); 
				...
				out.println("       m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_Legal_TerminationCheck?chksql=Add_Min_Amount&amount1=\"+am1+\"&amount2=\"+am2+\"&type=\"+opt;");
        ...
        out.println("}");	
			  ...
			  out.println("function get_Receipt(m_stat,opt) {");
				out.println("   m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_Legal_TerminationCheck?chksql=get_Receipt&termino=\"+document.Form1.TXT_PAYMENT_NO.value+\"&client=\"+document.Form1.CLIENT_CODE.value+\"&Status="+m_Status+"\";");
        //out.println("   window.open(m_url);");
        ...
        out.println("}");	
	      ...
	      out.println("	  popupwin = window.open(\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CO_Ter_ReceiptAllocation?chksql=main_page&Ter_no=\"+num+\"&Cli_no=\"+code, \"oBj\",\"left=30,top=50,width=900,height=600\");"); 
				...
				out.println("   m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_Legal_TerminationCheck?chksql=get_Receipt_del&rec_no=\"+val+\"\";");
        //out.println("   window.open(m_url);");
        ...
        //out.println("   window.open(m_url);");
			...
			out.println("}");
		//	out.println("		if(validate_data()){");  //coment by Prabash on 15-02-2012 
		...
		//	out.println("		}"); //coment by Prabash on 15-02-2012 
			out.println("		}"); 
			out.println("} "); 
		  ...
		  out.println("window.location.href='"+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_Legal_TerminationCheck?chksql=main_page&Status="+m_Status+"'");
		  out.println(" }  ");
			out.println("}");
      ...
      //out.println("  popupwin = window.showModalDialog('"+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_Legal_TerminationCheck?chksql=RUN_AUTO_ALLO&client='+document.Form1.CLIENT_CODE.value+'&screen='+document.Form1.Hid_scr_name.value+'', oBj,\"dialogWidth:25em; dialogHeight:26em; center:yes; status:no\");");
			//out.println("  get_Receipt();"); 
      out.println("  get_Receipt();"); 
      out.println("}"); 
      ...
      out.println("       document.Form1.elements['TERM_TYPE_'+num1].value=='RENT_REVIS' ){ ");
			...
			*/
			...
			//=====Added by Prabash on 15-02-2012 ==========================================
				...
				out.println("Crit=document.Form1.TXT_PAYMENT_NO.value+\"@\"+document.Form1.hid_opt_status.value+\"@\"+document.Form1.CLIENT_CODE.value+\"@\";");
				out.println("HelpBox('1','10','0',Crit,'Termination1','1');");
				out.println("}");
				out.println("function client_assign(oBj){");
        ...
        out.println("<td>&nbsp;</td>");
			  ...
			  out.println("<td>&nbsp;</td>");
				...
				out.println("&nbsp;</tr>"); 
				out.println("<tr class=tr_input>"); 
				out.println("<td width='10%' ><DIV id='DIV_TXT_PAYMENT_NO'  class=div_input>Termination No </DIV></td>"); 
				...
				out.println("<input class='but_input' type='button' name='BUT_TXT_PAYMENT_NO_SEARCH' value=\"Search\" onClick=\"get_Receipt();\"></td>");
				out.println("</tr>"); 
				out.println("</table>"); 
				//=========================================================
        ...
        */
        ...
        out.println("<td>&nbsp;</td>");
			...
			out.println("</html>"); 
			    ...
			    String m_ter_type="";
				 String m_termino      = req.getParameter("termino"); //Added by Prabash on 15-02-2012
          ...
          out.println("</tr>");
			...
			rs = stmt.executeQuery (" SELECT TERMINATION_NO,FINANCE_NO,APPLICATION_NO, "+
					                        "        "+m_schema_name+".AF_CO_GET_CLIENT_NAME(CLIENT_CODE), "+
																	...
																	"        NVL("+m_schema_name+".AF_CO_RET_REMARK(TERMINATION_NO,'"+m_Status+"'),'-'), "+
																	"        DECODE(ACTIVE_STATUS,'ENT',"+m_schema_name+".AF_CO_GET_USER_NAME(ENT_USER),'APPRO1',"+m_schema_name+".AF_CO_GET_USER_NAME(FIRST_APPR_BY),'APPRO2',"+m_schema_name+".AF_CO_GET_USER_NAME(SECOND_APPR_BY)) "+
																	" FROM   "+m_schema_name+".AF_CR_PRO_LEGAL_TERMINATION "+
																	" WHERE  ACTIVE_STATUS =UPPER('"+m_Status+"') AND  CLIENT_CODE LIKE '"+m_client+"%' "+
																	"    	 AND    TERMINATION_NO LIKE '%"+m_termino+"%' ");// Added by Prabash on 15-02-2012
          ...
          out.println("<td  width='12%' >Client Name</td>");
					...
					//out.println("<td  width='8%' align=right>Interest Outstanding</td>");//Commented by Dineth on 17-03-2009
					out.println("<td  width='10%' align=right>Legal Due(Without ODI)</td>");
					out.println("<td  width='8%' align=right>ODI Amount</td>");
					out.println("<td  width='10%' align=right>Legal Due(With ODI)</td>");
					out.println("<td  width='18%' >Remarks</td>");
					out.println("<td  width='10%' >New Remark</td>");
					out.println("<td  width='10%'>User</td>");
					out.println("<td  width='10%'>Action</td>");
           ...
           int j = 0; 
              ...
              while(rs.next()){
                  ...
                  out.println("<td class=hs onclick=\"show_client('"+rs.getString(4)+"')\">"+rs.getString(4)+"<input type=hidden name=\"CLI_NO_"+j+"\" value=\""+rs.getString(7)+"\"></td>");
                  ...
                  out.println("<td align=right>"+nf.format(rs.getDouble(10))+"<input type=hidden name=\"CAP_OUT_"+j+"\" value=\""+rs.getString(10)+"\"><input type=hidden name=\"INT_OUT_"+j+"\" value=\""+(rs.getString(11))+"\"><input type=hidden name=\"T_V_COUNT_"+j+"\" value=\""+rs.getString(15)+"\"></td>");
                  //out.println("<td align=right>"+nf.format(rs.getDouble(11))+"</td>");//Commented by Dineth on 17-03-2009
									out.println("<td align=right>"+nf.format(rs.getDouble(9)+rs.getDouble(10))+"</td>");
									...
									out.println("<td align=right>"+nf.format(rs.getDouble(9)+rs.getDouble(10)+rs.getDouble(12))+"</td>");
									out.println("<td align=left>"+rs.getString(18) +"</td>");//onclick=check_type(\""+j+"\")
									
								  out.println("<td align=center><input type='text' name='NEW_REMARK_"+j+"' class=\"txt_input\" style=width:200 maxlength='200'></td>");
									out.println("<td align=left>"+rs.getString(19)+"</td>");//Added by Dineth on 18-03-2009
