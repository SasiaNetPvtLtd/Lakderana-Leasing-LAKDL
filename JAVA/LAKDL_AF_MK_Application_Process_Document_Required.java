...
public class LAKDL_AF_MK_Application_Process_Document_Required extends javax.servlet.http.HttpServlet 
{ 
	/*
	Connection conn;
	...
	*/
	...
	//	out.println("alert('value'+document.Form1.hid_scr_approv.value);");
		 ...
		 // out.println("window.open(m_url);");
			...
			out.println("function check_more_than_20(){");
			out.println("   assignState('M20');");
			out.println("   m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MK_sql_validations?chksql=m_check_more_than_20&data_val_app_no="+m_app_no+"\";");
			out.println("   load_interface(m_url,'XML');");
			out.println("}");
      ...
      out.println("	if(m_close_status==\"Y\"){");
     	...
     	out.println("}");
    	  ...
    	  out.println("m_writedata+'</table>';");
			  ...
			  out.println("while(i<data_vec.length){");
				...
				out.println("					{ ");
				out.println("m_chk_status='<TD WIDTH=\"10%\" align=\"left\"><input  type=\"checkbox\" name=CHK_STATUS_GUR'+lineno+' value=\"off\" onClick=\"Val_Change_Gur('+lineno+')\"  ></TD>';");
			//	out.println("m_chk_status_not_app='<TD WIDTH=\"10%\" align=\"left\"><input  type=\"checkbox\" name=CHK_STATUS_GUR_NOT_APP'+lineno+' value=\"off\" onClick=\"Val_Change_Gur_Not_app('+lineno+')\"   ></TD>';"); //comment by Prabash on 07-09-2017
				out.println("m_chk_status_not_app='<TD WIDTH=\"10%\" align=\"left\"><input  type=\"checkbox\" name=CHK_STATUS_GUR_NOT_APP'+lineno+' value=\"on\" onClick=\"Val_Change_Gur_Not_app('+lineno+')\" checked  ></TD>';");
				out.println("					} ");
    	  ...
    	  out.println("m_writedata+'</table>';");
			  ...
			  out.println("while(i<data_vec.length){");
				...
				out.println("					{ ");
				out.println("m_chk_status='<TD WIDTH=\"10%\" align=\"left\"><input  type=\"checkbox\" name=CHK_STATUS_INV_DOC'+lineno_inv_doc+' value=\"off\" onClick=\"Val_Change_Inv_Doc('+lineno_inv_doc+')\"  ></TD>';");
			  //out.println("m_chk_status_not_app='<TD WIDTH=\"10%\" align=\"left\"><input  type=\"checkbox\" name=CHK_STATUS_INV_DOC_NOT_APP'+lineno_inv_doc+' value=\"off\" onClick=\"Val_Inv_Doc_Not_App('+lineno_inv_doc+')\" ></TD>';");//comment by Prabash on 07-09-2017
				out.println("m_chk_status_not_app='<TD WIDTH=\"10%\" align=\"left\"><input  type=\"checkbox\" name=CHK_STATUS_INV_DOC_NOT_APP'+lineno_inv_doc+' value=\"on\" onClick=\"Val_Inv_Doc_Not_App('+lineno_inv_doc+')\" checked ></TD>';");
				out.println("					} ");
       ...
       // out.println("alert('row asset no'+row_asset_no);");
		...
		out.println(" document.Form1.hid_no_of_asset_doc.value = count; "); // added by udara 17-07-2015
		...
		//	out.println("alert('test val'+b_flag_on);");
			...
			/*out.println("			else if(data_vec.length==0 && document.Form1.hid_chk_status.value=='M5'){");
      ...
      out.println("        }"); 
			...
			*/
			...
			// added by udara 05-11-2014
			out.println("			else if(data_vec.length>0 && document.Form1.hid_chk_status.value=='M20'){");
			//out.println("     			alert(data_vec[0]);");
			//out.println("                alert(document.Form1.hid_no_of_clinet_doc.value); ");
			
			out.println("                 var no_of_years  = data_vec[0];     ");
			out.println("                 var check_status = '';     ");
			
			//out.println("                 for (var i=0; i < document.Form1.hid_no_of_clinet_doc.value; i++ ) {");
			out.println("                 for (var i=0; i < document.Form1.hid_no_of_asset_doc.value; i++ ) {");
			//out.println("                       if(document.Form1.elements['hid_TXT_CODE'+i].value=='OVER20'){ ");
			//out.println("                            if(document.Form1.elements['CHK_STATUS'+i].checked==true){ ");
			
			out.println("                       if(document.Form1.elements['hid_TXT_CODE_INV_DOC'+i].value=='OVER20'){ ");
			out.println("                            if(document.Form1.elements['CHK_STATUS_INV_DOC'+i].checked==true){ ");
			
			out.println("                            	check_status = 'YES';	");
			out.println("                            }");
			out.println("                            else{");
			out.println("                            	check_status = 'NO';	");
			out.println("                            }");
			out.println("                       }");
			out.println("                 }");
			
			//out.println("			      alert(check_status); ");
			out.println("                 if((no_of_years > 20) && (check_status=='NO')){ "); 
			//out.println("			      		alert('cannot save  ' + check_status + '  ' + no_of_years); ");
			out.println("			      		alert('Cannot Save - Make sure the Over 20 Inspection Form is selected'); "); //Over 20 Inspection Form
			out.println("                 }");
			out.println("                 else{");
			//out.println("			      		alert('can save'); ");
		...
		//	out.println("alert('test length'+array_gur_code.length);");
		  ...
		  //out.println("window.open(m_url);");
			...
			//out.println("window.open(m_url);"); // udara 11-03-2015
			out.println("load_interface(m_url,'XML');");
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MK_Application_Process_Document_Required?chksql=main_page&APP_NO="+m_app_no+"&Hid_scr_name="+m_Hid_scr_name+"&TXT_TYPE="+m_txt_type+"&CLIENT_CODE="+m_client_code+"&ac_status=Y&scr_approv="+m_scr_approv+"&hid_records="+m_hid_records+"&CORE_APP_CODE="+m_core_app_code+"';"); //&hid_records=A&scr_approv=Y'
		//	out.println("m_url='"+m_class_url+"/"+m_fschema_name+"AF_MK_Application_Process_Document_Required?chksql=main_page&Hid_scr_name='+document.Form1.Hid_scr_name.value+'&APP_NO='+document.Form1.TXT_APPLICATION_NO.value+'&TXT_TYPE='+document.Form1.TXT_TR_TYPE.value+'&CLIENT_CODE='+document.Form1.TXT_APPLICANT_CODE.value+'&CORE_APP_CODE='+document.Form1.TXT_CORE_APPLICANT_CODE.value+'&ac_status=Y&hid_records='+document.Form1.hid_no_rec.value;"); 
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MK_Application_Process_Document_Required?chksql=main_page&APP_NO="+m_app_no+"&TXT_TYPE="+m_txt_type+"&CLIENT_CODE="+m_client_code+"&ac_status=Y&CORE_APP_CODE="+m_core_app_code+"';"); 
			out.println("}"); 
			out.println(""); 
			out.println(""); 
			...
			// commented by udara 05-11-2014
			/*
			out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_MK_Save_Application_Process_Document_Required';");  
			out.println("		document.Form1.submit();	"); 
			*/
			
			//out.println("		   alert('ready now'); ");
			out.println("          check_more_than_20(); ");
	...
	/*		out.println("function Val_Change(row){");
			
		//	out.println("alert('val'+row)")	;
			out.println("m_chk_status=\"CHK_STATUS\"+row");
			out.println("m_chk_fol_status=\"CHK_STATUS_FOLLOWUP\"+row");
			
			out.println("if(document.Form1.elements[m_chk_fol_status].checked==true && document.Form1.elements[m_chk_status].checked==true){");
			out.println("document.Form1.elements[m_chk_fol_status].value='on'");
			out.println("document.Form1.elements[m_chk_fol_status].checked=true");
		//	out.println("obj2.checked=false");
		//	out.println("obj2.value='off'");
			out.println("}else if(document.Form1.elements[m_chk_fol_status].checked==true && document.Form1.elements[m_chk_status].checked==false){");
			//out.println("alert('val'+row)")	;	
			out.println("document.Form1.elements[m_chk_fol_status].value='on'");
			out.println("document.Form1.elements[m_chk_fol_status].checked=true");
			out.println("}");	
			out.println("else if(document.Form1.elements[m_chk_fol_status].checked=false && document.Form1.elements[m_chk_status].checked==false)");
			out.println("{");	
		// 	out.println("alert('val'+row)")	;	
			out.println("document.Form1.elements[m_chk_fol_status].value='on'");
			out.println("document.Form1.elements[m_chk_fol_status].checked=true");
     ...
     //============================================================================================//
			  ...
			  //  out.println("<INPUT TYPE='Hidden' NAME='hid_no_of_clinet_doc' VALUE=\"\">"); 
				  //out.println("<INPUT TYPE='Hidden' NAME='hid_no_of_core_doc' VALUE=\"\">"); 
					...
					//out.println("<INPUT TYPE='Hidden' NAME='hid_no_of_asset_doc' VALUE=\"0\">"); // added by udara 17-07-2015
          ...
          out.println("<td  width='15%' ><b>Remarks</td>");
						...
						while(rs.next())
				{
                  ...
                  out.println("<tr class=tr_input STYLE=\"{color:red;}\"   >");
									...
									/*if(j==0){
									out.println("<tr><td width='15%' id=\"MK_NAME\" ></td>"); 
									out.println("</tr>");
									}*/
									out.println("<td width='15%' align='left' style= cursor:hand; onClick=\"show_document_drill('"+rs.getString(1)+"')\" ><u>"+rs.getString(1) +"</u></td>");
									out.println("<INPUT TYPE=\"Hidden\" NAME=hid_TXT_CODE"+j+"	VALUE='"+rs.getString(1) +"'>");
								  ...
								  //out.println("status"+m_chk_status);
									...
									{
									out.println("<td width='10%' align='left'><input  type='checkbox' name=CHK_STATUS"+j+" value='off'  onclick=\"Val_Change_Check("+j+")\"></td>");
								//	out.println("<td width='10%' align='left'><input  type='checkbox' name=CHK_STATUS_NOT_APP"+j+" value='off'  onclick=\"Val_Not_Applicable("+j+")\"></td>"); //commend by prabash on 07-09-2017
									out.println("<td width='10%' align='left'><input  type='checkbox' name=CHK_STATUS_NOT_APP"+j+" value='on' checked onclick=\"Val_Not_Applicable("+j+")\" ></td>");
									}
	     ...
	     out.println("</tr>"); 	
		   out.println("</table>");
				...
				/*out.println("<table align='center' width='100%' class='table'>"); 
			  out.println("<tr>" );
			  out.println("<td width=\"100%\"><DIV ID=e_label_ba1_footer> </DIV></td>");				
				out.println("</tr>" );
	      out.println("</table>");*/
