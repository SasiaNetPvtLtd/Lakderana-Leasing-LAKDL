...
public class LAKDL_AF_CR_delete_guarantor extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res) { 
      ...
      String m_username = m_sn_methods.username;
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE> Credit - Delete Guarantor </TITLE>"); 
			out.println("</HEAD>"); 
      ...
      out.println("      display_data(data_vec);"); 		
			...
			out.println("function load_guarantors(m_app_no){");
			out.println("m_url='"+m_class_url+"/"+m_fschema_name+"AF_MAS_rpt_user_approval?chksql=LOAD_GUARANTOR_DETAILS&app_no='+m_app_no;"); 
  		...
  		out.println("		}");
   		...
   		out.println("}"); 
				  ...
				  out.println("}"); 
					...
					out.println("						document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_CR_save_delete_guarantor';");  
				...
				out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_CR_delete_guarantor?chksql=main_page';"); 
				out.println("		}"); 
				out.println("}"); 
				...
				out.println("    m_help_message = \"m_help_msg_LAKDL_AF_CR_delete_guarantor\";"); 
				...
				out.println("help_box.innerHTML=\" Credit - Delete Guarantor - \"+m_val;"); 
				out.println("}"); 
		
				out.println("function load_roll_out_value(){");
				out.println("help_box.innerHTML=\" Credit - Delete Guarantor  \";"); 
				out.println("}"); 
          ...
          out.println("   document.Form1.elements[m_tel_no].value=oBj.valout[4];"); 
					...
					out.println("    load_guarantors(oBj.valout[2]);"); 
					out.println("}"); 
					...
					out.println("   document.Form1.TXT_APPLICANT_CODE.value=oBj.valout[4];"); 
					out.println("   document.Form1.TXT_APPLICANT_NAME.value=oBj.valout[5];"); 
					out.println("   load_guarantors(oBj.valout[3]);"); 
					out.println("}");
			    ...
			    out.println("<INPUT TYPE='Hidden' NAME='hid_close_sts' VALUE=\"N\">"); 
					...
					out.println("</tr>"); 
					out.println("<tr>"); 
					out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Credit - Delete Guarantor</td>"); 
					out.println("</tr>"); 
					out.println("<tr>"); 
