// DEVELOP BY : NUWAN DE SILVA FOR OFSCL FACTORING    DATE:23-12-2010
...
public class LAKDL_FA_OP_display_suspense_receipt extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Operation Process - Suspense Receipt</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"FA_OP_suspense_receipt_sql?chksql=LOAD_SETTLEMENT_APPROVAL\";");
			...
			out.println("			}");
			out.println("			if(validate_data()){"); 
			out.println("				document.Form1.action='"+m_class_url+"/"+m_fschema_name+"FA_OP_Save_suspense_receipt';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"FA_OP_display_suspense_receipt';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("	help_box.innerHTML=\" Operation Process - Suspense Receipt - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\" Operation Process - Suspense Receipt- \";"); 
			out.println("}"); 
	  	...
	  	out.println("					}"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Operation Process - Suspense Receipt</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
