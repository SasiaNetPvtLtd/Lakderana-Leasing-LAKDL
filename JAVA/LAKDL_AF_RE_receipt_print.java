...
public class LAKDL_AF_RE_receipt_print extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			if(m_chksql.equals("main_page")){
				...
				out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_print?chksql=main_page';"); 
				out.println("		}"); 
				out.println("}"); 
				...
				out.println("	help_box.innerHTML=\" Receipts - Print - \"+m_val;"); 
				out.println("}"); 
				...
				out.println(" 	m_from_date = m_from_dd+\"-\"+m_from_mm+\"-\"+m_from_yy; ");
				out.println("   if(validate_date()) {");	
				out.println("       m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_print_normal?chksql=get_receipt_details&user=\"+val+\"&from_date=\"+m_from_date+\"&to_date=\"+m_to_date;");	
