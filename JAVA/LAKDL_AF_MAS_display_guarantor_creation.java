//SCREEN NAME:SYSTEM ADMINISTRATION - GUARANTOR
...
public class LAKDL_AF_MAS_display_guarantor_creation extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			String m_save_close="";
			String m_row_no="";
			String m_client_status=""; //added by nuwan de silva on 22-10-07
			String m_gur_row_no="";    //added by nuwan de silva on 22-10-07
			int m_count =0;
			...
			if(req.getParameter("save_close")==null)
			{
				m_save_close="N";
			}
			else
			...
			if(req.getParameter("row_no")==null)
			{
				m_row_no="N";
			}
			else
			{
				m_row_no  = req.getParameter("row_no");
			}
			
			if(req.getParameter("m_client_status")!=null){
				m_client_status=req.getParameter("m_client_status").trim();
			}
			if(req.getParameter("gur_row_no")!=null){
				m_gur_row_no=req.getParameter("gur_row_no").trim();
			}
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>System Administration - Creation Of Guarantor </TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("m_close_status='"+m_close_status+"';");
			out.println(" var m_client_status ='"+m_client_status+"'; ");  //added by nwuan de silva on 22-10-07
			out.println(" var m_gur_row_no ='"+m_gur_row_no+"'; ");        //added by nwuan de silva on 22-10-07
			/*
			//Individual
			...
			out.println("var lineno_property=0;");
			
			out.println("var arr_size=0;");
			out.println("var arr_size_family=0;");
			out.println("var arr_size_property=0;");
			...
			//	out.println("   	 data_vec='';	");
			out.println("     }");
			out.println("		 else if(data_vec.length >=0 && document.Form1.SCREEN_NAME.value!=\"NEW\" && document.Form1.hid_help_status.value =='H_prop_fill'){");
			out.println("      assign_data_property(data_vec); ");
			//out.println("   	 data_vec='';	");
			out.println("     }");
			...
			//	out.println("   	 data_vec='';	");
			out.println("     }");
			out.println("		 else if(data_vec.length==0 && document.Form1.hid_help_status.value == 'H_bank' && document.Form1.hid_bank_status.value=='NEW' && document.Form1.elements[m_bank].value!=\"\" ){");
			//out.println("				alert('Record already exists');");
			out.println("				help_button_bank(count);");
			out.println("			}");
			//added by nuwan de silva 06-07-07
			...
			out.println("				document.Form1.TXT_POSTAL_DESC.value=data_vec[1];");
			out.println("			}");
			...
			out.println("				fill_rest_get_vector(data_vec,'G');"); //added by nuwan de silva 07-08-07
			out.println("			}");
			out.println("		 else if( data_vec.length==0 && document.Form1.SCREEN_NAME.value!=\"NEW\" && document.Form1.hid_help_status.value == 'Client_Code' && document.Form1.TXT_CLIENT_CODE.value!=\"\" ){");
			//out.println("				help_client_code_validate();"); //added by nuwan de silva 07-08-07
			
			out.println("	     if(document.Form1.hid_temp_status.value == \"Y\" ){ ");  //added by nuwan de silva 1-10-07
			...
			//To fill owned Property
			out.println("   makeRequest_prop(document.Form1.TXT_CLIENT_CODE); ");
			out.println(" }");
			out.println(" else {");
			out.println(" while(vec_pos<m_size){ "); 
			...
			//out.println("   makeRequest(document.Form1.TXT_CLIENT_CODE); ");
			out.println("   assign_help_status('H_aud'); "); //added by nuwan de silva 06-07-07
			out.println("   makeRequest(document.Form1.TXT_CLIENT_CODE); ");
			...
			out.println("function assign_data_property(data_vec){ ");
			out.println(" vec_pos=0; ");
			out.println(" i=0; ");
			out.println(" m_size=0; ");
			out.println(" m_size=data_vec.length; ");
			out.println(" if(m_size==0) { ");
			out.println("  array_name_p[i] = 'VEHICLE';");
			out.println("  array_loc_p[i] = '-';");
			out.println("  array_make_p[i] = '-';");
			out.println("  array_model_p[i] = '-';");
			out.println("  array_company_p[i] = '-';");
			out.println("  array_val_p[i] = '0';");
			out.println("  array_reg_no[i] = '';");
			out.println("  arr_size_property=i+1;");
			out.println("  write_data_property(i+1); ");	
			out.println(" if(document.Form1.SCREEN_NAME.value =='DACT' || document.Form1.SCREEN_NAME.value =='RACT' ){"); 
			out.println("   disable_rows_property(i+1);");
			out.println("   }");			
			...
			out.println(" }");
			out.println(" else {");
			out.println("  array_name_p[i] = data_vec[vec_pos];");
			out.println(" }");
			...
			out.println(" }");
			out.println(" else {");
			out.println("  array_loc_p[i] = data_vec[vec_pos+1];");
			out.println(" }");
			...
			out.println(" }");
			out.println(" else {");
			out.println("  array_make_p[i] = data_vec[vec_pos+2];");
			out.println(" }");
			...
			out.println(" }");
			out.println(" else {");
			out.println("  array_model_p[i] = data_vec[vec_pos+3];");
			out.println(" }");
			...
			out.println(" }");
			out.println(" else {");
			out.println("  array_company_p[i] = data_vec[vec_pos+4];");
			out.println(" }");
			
			out.println(" if(data_vec[vec_pos+5]=='null' || data_vec[vec_pos+5]==''){ ");
			out.println("  array_val_p[i] = '';");
			out.println(" }");
			out.println(" else {");
			out.println("  array_val_p[i] = data_vec[vec_pos+5];");
			out.println(" }");
			...
			out.println(" }");
			out.println(" else {");
			out.println("  array_reg_no[i] = data_vec[vec_pos+6];");
			out.println(" }");
			...
			//out.println(" ");
			out.println(" }");
			out.println(" arr_size_property=i;");
			out.println(" write_data_property(i); ");		
			out.println(" if(document.Form1.SCREEN_NAME.value =='DACT' || document.Form1.SCREEN_NAME.value =='RACT' ){"); 
			out.println("   disable_rows_property(i);");
			out.println("   }");
			...
			//out.println("  vec_pos=vec_pos+6;	 ");
			out.println("  vec_pos=vec_pos+7;	 "); //added by nuwan de silva on 07-09-07
			out.println("  i=i+1; ");
			out.println(" ");
			out.println(" }");
			...
			out.println(" check_number_decimal(document.Form1.TXT_TOT_EXPENSE,20)");
			out.println(" document.Form1.TXT_TOT_INCOME.value = sum_in;   ");
			out.println(" check_number_decimal(document.Form1.TXT_TOT_INCOME,20)");
	...
	*/
			...
			*/
			...
			out.println(" '<td width=\"40%\"><input name=TXT_INCOME'+x+' class=\"txt_input\"  value=\"0\" maxlength=\"20\" size=\"10\" onblur=\"check_number(this,20),cal_tot()\" STYLE=\"{text-align:right;}\" ></td>'+"); 
			out.println(" '</tr ></table>'");
			out.println("  }");
			...
			out.println(" '<tr >'+");
			out.println(" '<td width=\"30%\">'+data_vec[i]+'<input type=hidden name=hid_iecode'+x+' value=\"'+data_vec[i+2]+'\" ><input type=hidden name=hid_type'+x+' value=\"'+data_vec[i+1]+'\" ></td>'+");
			out.println(" '<td width=\"40%\"><input name=TXT_INCOME'+x+' class=\"txt_input\"  value=\"\" maxlength=\"20\" size=\"10\" onblur=\"check_number(this,20),cal_tot()\" STYLE=\"{text-align:right;}\" ></td>'+"); 
			out.println(" '</tr ></table>'");
			out.println("  }");
			out.println("  else {");
			out.println("  e_data_income.innerHTML+='<table align=\"center\" border=\"0\" width=\"100%\" class=\"table\">'+");
			out.println("  '<tr >'+");
			out.println("  '<td width=\"30%\">'+data_vec[i]+'<input type=hidden name=hid_iecode'+x+' value=\"'+data_vec[i+2]+'\" ><input type=hidden name=hid_type'+x+' value=\"'+data_vec[i+1]+'\" ></td>'+");
			out.println("  '<td width=\"40%\"><input name=TXT_INCOME'+x+' class=\"txt_input\"  value=\"'+data_vec[i+3]+'\" maxlength=\"20\" size=\"10\" onblur=\"check_number(this,20),cal_tot()\" STYLE=\"{text-align:right;}\" ></td>'+"); 
			out.println("  '</tr ></table>'");
			out.println("  }");
			out.println("  }");
			out.println(" else if(data_vec[i+1] == 'EX'){ ");
			...
			//To fill owned Propeties
			out.println("function makeRequest_prop(obj) {");
			out.println("document.Form1.hid_help_status.value='H_prop_fill';");
			out.println("if(document.Form1.SCREEN_NAME.value!=\"RACT\"  ) {");
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations1?chksql=m_prime_chk_LAKDL_AF_MAS_display_property&client_code=\"+obj.value+\"&ac_status=Y&tmp_help_status=\"+document.Form1.hid_temp_status.value;");
			out.println("load_interface(m_url,'XML'); ");
			out.println("}");
			out.println("else if(document.Form1.SCREEN_NAME.value==\"RACT\"  ) {");
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations1?chksql=m_prime_chk_LAKDL_AF_MAS_display_property&client_code=\"+obj.value+\"&ac_status=N&tmp_help_status=\"+document.Form1.hid_temp_status.value;");
			out.println("load_interface(m_url,'XML'); ");
			out.println("}");
			//out.println("window.open(m_url);");
			out.println("}");
			...
			out.println(" '<tr >'+");
			out.println(" '<td width=\"15%\" align=\"left\" > No of Children  </td>'+");
			out.println(" '<td width=\"20%\"><input name=TXT_NO_CHILD class=\"txt_input\" onblur=\"check_number(this)\" STYLE=\"{text-align:right;}\"  value=\"0\" maxlength=\"1\" size=\"10\"></td>'+"); 
			out.println(" '<td width=\"*%\" ></td>'+");
			out.println(" '</tr >'+");
			out.println(" '<tr >'+");
			out.println(" '<td width=\"15%\" align=\"left\" > Total Dependents  </td>'+");
			out.println(" '<td width=\"20%\"><input name=TXT_TOT_DEP class=\"txt_input\" onblur=\"check_number(this)\" STYLE=\"{text-align:right;}\"  value=\"0\" maxlength=\"2\" size=\"10\"></td>'+"); 
			out.println(" '<td width=\"*%\" ></td>'+");
			out.println(" '</tr ></table>'");	
			out.println("}");
			...
			out.println(" '<td width=\"40%\" ><input name=TXT_TOT_INCOME class=\"txt_input\"  value=\"0\" maxlength=\"10\" size=\"10\" STYLE=\"{text-align:right;}\" disabled  ></td>'+"); 
			out.println(" '</tr ></table>'");
			...
			out.println(" '<td width=\"40%\" ><input name=TXT_TOT_EXPENSE class=\"txt_input\"  value=\"0\" maxlength=\"10\" size=\"10\" STYLE=\"{text-align:right;}\" disabled  ></td>'+"); 
			out.println(" '</tr ></table>'");
			...
			out.println(" '<td width=\"40%\" ><input name=TXT_NET_INCOME class=\"txt_input\"  value=\"0\" maxlength=\"10\" size=\"10\" STYLE=\"{text-align:right;}\" disabled  ></td>'+"); 
			out.println(" '</tr ></table>'");
			...
			out.println("'<input class=\"but_input\" type=\"button\" name=\"BUT_TXT_BUS_SECT_MAIN\" value=\"Help\" onClick=\"help_button_bus_sec()\"></td>'+"); 
			...
			out.println("'<input class=\"but_input\" type=\"button\" name=\"BUT_TXT_BUS_SUB\" value=\"Help\" onClick=\"help_button_sub_sec()\"></td>'+"); 
			...
			out.println("'<TD WIDTH=\"15%\" align=\"left\"> Category </TD>'+");
			//out.println("e_header_ba.innerHTML +='<table align=\"center\" width=\"100%\" class=\"table\"><TR><TD WIDTH=\"15%\" align=\"left\"> Category </TD>'+");
	    ...
	    out.println(" '</TR></table>';");
			out.println(" }");
			out.println(" else {");
			out.println(" e_header_bank_c.innerHTML +='<table  border=\"0\" align=\"center\" width=\"100%\" class=\"table\"><TR><TD WIDTH=\"13%\" align=\"left\">Banker </TD>'+");
			out.println(" '<TD WIDTH=\"10%\" align=\"left\">Bank Name </TD>'+");
			out.println(" '<TD WIDTH=\"10%\" align=\"left\">Branch </TD>'+");
			out.println(" '<TD WIDTH=\"10%\" align=\"left\">Branch Name</TD>'+");
	...
	*/
			...
			out.println("function header_property(type){");
			out.println(" lineno_property=0; ");
			out.println("  m_write_data_prop ='<table border=\"0\" align=\"center\" width=\"100%\" class=\"table\"><TR>'+");
			out.println("  '<TD WIDTH=\"11%\" align=\"left\">Name</TD>' +");
			out.println("  '<TD WIDTH=\"15%\" align=\"left\">Location </TD>' +");
			out.println("  '<TD WIDTH=\"10%\" align=\"left\">Make </TD>' +");
			out.println("  '<TD WIDTH=\"9%\" align=\"left\">Model </TD>' +");
			out.println("  '<TD WIDTH=\"10%\" align=\"left\">Engine No  </TD>' +"); //Added by Prabash on 21-03-2012
			out.println("  '<TD WIDTH=\"10%\" align=\"left\">Chassis No </TD>' +"); //Added by Prabash on 21-03-2012
			out.println("  '<TD WIDTH=\"11%\" align=\"left\">Company </TD>' +");
			out.println("  '<TD WIDTH=\"10%\" align=\"left\">Value (Rs.)</TD>' +");
			out.println("  '<TD WIDTH=\"10%\" align=\"left\">Deed No. / Reg No. </TD>' +");
			out.println("  '<TD WIDTH=\"*%\" align=\"left\">&nbsp </TD>' +"); //added by Prabash on 21-03-2012
			out.println("  '</TR></table>';");
			//out.println(" if(document.Form1.TXT_CLIENT_TYPE.value == \"I\") { ");
			out.println(" if(type == \"I\") { ");
			out.println("	e_header_property.innerHTML += m_write_data_prop ");
			out.println(" }");	
			out.println(" else{ ");
			out.println("	e_header_property_c.innerHTML += m_write_data_prop ");
			out.println(" }");	
			out.println("}");	
			...
			out.println("e_header_company_directors.innerHTML +='<table  align=\"center\" border=\"0\" width=\"100%\" class=\"table\"><TR><TD WIDTH=\"25%\" align=\"left\">Name </TD>'+");
	    ...
	    out.println("'</TR></table>';");
     	out.println("}");
			*/
			...
			out.println("function add_button_property(type){");
			//out.println(" if(document.Form1.TXT_CLIENT_TYPE.value == \"I\") { "); //modiifed by nuwan de silva 10-07-07
			out.println(" if(type == \"I\") { ");
			out.println("		e_add_but_property.innerHTML='<table align=\"center\" width=\"100%\" class=\"table\"><TR>'+");
			out.println("		'<td width=\"20%\"><input class=\"but_input\" type=\"button\" name=\"BUT_ADD_PRO\" value=\"Add\" onClick=add_row_property(\"'+type+'\")></td>'+");  //\"'+type+'\"
			out.println("		'<td width=\"*%\"></td>'+"); 
			out.println("		'</TR></table>';");
			out.println("	}");
			out.println("	else {");
			out.println("		e_add_but_property_c.innerHTML='<table align=\"center\" width=\"100%\" class=\"table\"><TR>'+");
			out.println("		'<td width=\"20%\"><input class=\"but_input\" type=\"button\" name=\"BUT_ADD_PRO\" value=\"Add\" onClick=add_row_property(\"'+type+'\")></td>'+");  //\"'+type+'\"
			out.println("		'<td width=\"*%\"></td>'+"); 
			out.println("		'</TR></table>';");
			out.println("	}");
			...
			out.println("'<tr>'+");
			out.println("'<td width=\"80%\" ><B><u> D.Details Of Family Members </B></td>'+"); 
			out.println("'</tr>'+");
			out.println("'</TR></table>';");
			out.println("}");
			
			out.println("function add_label_property(type){"); //modiifed by nuwan de silva 10-07-07
			//out.println("alert('type'+document.Form1.TXT_CLIENT_TYPE.value)");
			//out.println(" if(document.Form1.TXT_CLIENT_TYPE.value == \"I\") { ");
			out.println(" if(type == \"I\") { ");
			out.println("  e_label_property.innerHTML='<table align=\"center\" width=\"100%\" class=\"table\"><TR>'+");
			out.println("  '<tr>'+");
			out.println("  '<td width=\"80%\" ><B><u> E.Particulars Of Immovable & Moveable Property Owned </u> </B></td>'+"); 
			out.println("  '</tr>'+");
			out.println("  '</TR></table>';");
			out.println(" }");
			out.println("	else {");
			out.println("  e_label_property_c.innerHTML='<table align=\"center\" width=\"100%\" class=\"table\"><TR>'+");
			out.println("  '<tr>'+");
			out.println("  '<td width=\"80%\" ><B><u> D.Particulars Of Immovable & Moveable Property Owned </u> </B></td>'+"); 
			out.println("  '</tr>'+");
			out.println("  '</TR></table>';");
			out.println(" }");
			out.println("}");
			...
			out.println("'<tr>'+");
			out.println("'<td width=\"80%\" ><B><DIV id=\"DIV_TXT_TOT_INCOME\"  class=\"div_input\"><u> C.Details Of Present Monthly Income/Expenses (*) </u> </div> </B></td>'+"); 
			out.println("'</tr>'+");
			out.println("'</TR></table>';");
			out.println("}");
			...
			out.println("'<tr>'+");
			out.println("'<td width=\"80%\" ><b><DIV id=\"DIV_TXT_BA\" class=\"div_input\"> Business Activities (*)</div></b></td>'+"); 
			out.println("'</tr>'+");
			out.println("'</TR></table>';");
			out.println("}");
			...
			out.println("'<tr>'+");
			out.println("'<td width=\"80%\" ><b><DIV id=\"DIV_TXT_BANK\"  class=\"div_input\"> Bankers & Auditors (*)</DIV> </b></td>'+"); 
			out.println("'</tr>'+");
			out.println("'</TR></table>';");
			out.println("}");
			...
			out.println("'<TD WIDTH=\"9%\"><input class=\"txt_input3\" type=\"text\" name=TXT_BANK_CODE'+j+' value=\"\" onblur=\"makeRequest8(this)\"  maxlength=\"10\" size=\"12\" style=\"width: 70px\" ></TD>'+");
			...
			out.println("  '<TD WIDTH=\"10%\"><input class=\"txt_input3\" type=\"text\" name=TXT_BANK_NAME'+j+' value=\"\"></TD>'+");
			
			out.println("'<TD WIDTH=\"6%\"><input class=\"txt_input3\" type=\"text\" name=TXT_BRANCH_CODE'+j+' value=\"\" onblur=\"makeRequest9(this)\"   maxlength=\"10\" size=\"12\" style=\"width: 80px\" ></TD>'+");
			...
			out.println("'<TD WIDTH=\"9%\"><input class=\"txt_input3\" type=\"text\" name=TXT_BANK_CODE'+j+'  onblur=\"makeRequest8(this)\"  value=\"\" maxlength=\"10\" size=\"12\" style=\"width: 70px\"></TD>'+");
			out.println("'<TD WIDTH=\"4%\"><input class=\"but_input\" type=\"button\" name=BUT_TXT_BANK_CODE'+j+' value=\"?\" onClick=\"help_button_bank('+j+')\"  style=\"width: 30px\" ></td>'+");
			out.println("  '<TD WIDTH=\"10%\"><input class=\"txt_input3\" type=\"text\" name=TXT_BANK_NAME'+j+' value=\"\"></TD>'+");
			
			out.println("'<TD WIDTH=\"6%\"><input class=\"txt_input3\" type=\"text\" name=TXT_BRANCH_CODE'+j+' onblur=\"makeRequest9(this)\"  value=\"\" maxlength=\"10\" size=\"12\" style=\"width: 80px\" ></TD>'+");
			out.println("'<TD WIDTH=\"4%\"><input class=\"but_input\" type=\"button\" name=BUT_TXT_BRANCH_CODE'+j+' value=\"?\" onClick=\"help_button_branch('+j+')\" style=\"width: 30px\"  ></td>'+");
			out.println("'<TD WIDTH=\"10%\"><input class=\"txt_input3\" type=\"text\" name=TXT_BRANCH_NAME'+j+' value=\"\" ></TD>'+");
			...
			out.println("'<TD WIDTH=\"9%\"><input class=\"txt_input3\" type=\"text\" name=TXT_BANK_CODE'+j+' value=\"'+array_banker[j]+'\"   maxlength=\"10\" size=\"12\" style=\"width: 70px\"></TD>'+");
			out.println("'<TD WIDTH=\"4%\"><input class=\"but_input\" type=\"button\" name=BUT_TXT_BANK_CODE'+j+' value=\"?\" onClick=\"help_button_bank('+j+')\" style=\"width: 30px\"  ></td>'+");
			out.println("'<TD WIDTH=\"9%\"><input class=\"txt_input3\" type=\"text\" name=TXT_BANK_NAME'+j+' value=\"'+array_banker_name[j]+'\"></TD>'+");
			
			out.println("'<TD WIDTH=\"6%\"><input class=\"txt_input3\" type=\"text\" name=TXT_BRANCH_CODE'+j+'  value=\"'+array_branch[j]+'\"   maxlength=\"10\" size=\"12\" style=\"width: 80px\" ></TD>'+");
			out.println("'<TD WIDTH=\"4%\"><input class=\"but_input\" type=\"button\" name=BUT_TXT_BRANCH_CODE'+j+' value=\"?\" onClick=\"help_button_branch('+j+')\" style=\"width: 30px\"  ></td>'+");
			out.println("'<TD WIDTH=\"10%\"><input class=\"txt_input3\" type=\"text\" name=TXT_BRANCH_NAME'+j+'  value=\"'+array_branch_name[j]+'\"    ></TD>'+"); //maxlength=\"10\" size=\"12\" style=\"width: 80px\" //comment by nuwan de silva on 01-10-07
			...
			out.println("'<TD WIDTH=\"12%\"><input class=\"txt_input5\" type=\"text\" name=TXT_APPROVED_AMOUNT'+j+' onblur=\"check_number(this)\" value=\"\" maxlength=\"25\" style=\"width: 100px\"></TD>'+");
			...
			out.println("  '<TD WIDTH=\"12%\"><input class=\"txt_input5\" type=\"text\" name=TXT_APPROVED_AMOUNT'+j+' value=\"'+array_app_amount[j]+'\" onblur=\"check_number(this)\" maxlength=\"25\" style=\"width: 100px\"></TD>'+");
			...
			out.println("  '<TD WIDTH=\"12%\"><input class=\"txt_input3\" type=\"text\" name=TXT_SECURITY'+j+' value=\"'+array_security[j]+'\"  maxlength=\"100\" size=\"14\" style=\"width: 100px\" ></TD>'+");
			out.println("  '<TD WIDTH=\"12%\"><input class=\"txt_input5\" type=\"text\" name=TXT_APPROVED_AMOUNT'+j+' value=\"'+array_app_amount[j]+'\" onblur=\"check_number(this)\" maxlength=\"25\" style=\"width: 100px\"></TD>'+");
			out.println("  '<TD WIDTH=\"12%\"><input class=\"txt_input5\" type=\"text\" name=TXT_BALANCE_AMOUNT'+j+' value=\"'+array_bal_amount[j]+'\" onblur=\"check_number_decimal(this,22)\" maxlength=\"22\" style=\"width: 100px\"></TD>'+");
			out.println("  '<TD WIDTH=\"7%\"><input class=\"txt_input5\" type=\"text\" name=TXT_MONTHS'+j+' value=\"'+array_months[j]+'\"  onblur=\"check_number(this)\" maxlength=\"4\" size=\"5\" style=\"width: 55px\" ></TD>'+");
			out.println("  '<TD WIDTH=\"6%\"><input class=\"but_input\" type=\"button\" name=BUT_CREDIT_DEL'+j+' value=\"Delete\" onClick=\"del_row_credit('+j+')\">'+");
			out.println("  '</td></tr></table>';");
			out.println(" }");
			...
			//comment by nuwan de silva on 07-09-07 for ref no 501
        ...
        out.println("continue;");
			...
			out.println(" '<TD WIDTH=\"15%\"><input class=\"txt_input5\" type=\"text\" name=TXT_APPROVED_AMOUNT'+j+' value=\"\" onblur=\"check_number(this)\" maxlength=\"25\" size=\"20\" style=\"width: 120px\" ></TD>'+");
			...
			out.println("'<TD WIDTH=\"15%\"><input class=\"txt_input5\" type=\"text\" name=TXT_APPROVED_AMOUNT'+j+' value=\"'+array_app_amount_c[j]+'\"  onblur=\"check_number(this)\"  maxlength=\"25\" size=\"20\" style=\"width: 120px\" ></TD>'+");
			...
			out.println("m_bank_name=\"TXT_BANK_NAME\"+no");
			
			out.println("m_branch=\"TXT_BRANCH_CODE\"+no");
			out.println("m_branch_name=\"TXT_BRANCH_NAME\"+no");
			...
			out.println("m_bank_name=\"TXT_BANK_NAME\"+count");
			
			out.println("m_branch=\"TXT_BRANCH_CODE\"+count");
			out.println("m_branch_name=\"TXT_BRANCH_NAME\"+count");
			...
			out.println("  '<TD WIDTH=\"9%\"><input class=\"txt_input3\" type=\"text\" name=TXT_BANK_CODE'+lineno_bank+' maxlength=\"10\" onblur=\"makeRequest8(this)\"  size=\"12\"  style=\"width: 70px\" ></TD>'+");
			...
			out.println("  '<TD WIDTH=\"10%\"><input class=\"txt_input3\" type=\"text\" name=TXT_BANK_NAME'+lineno_bank+' value=\"\"></TD>'+");
			...
			out.println("  '<TD WIDTH=\"10%\"><input class=\"txt_input\" type=\"text\" name=TXT_ACCOUNT_NO'+lineno_bank+' maxlength=\"20\" size=\"20\" style=\"width: 125px\"></TD>'+");
			out.println("  '<TD WIDTH=\"15%\"><input class=\"txt_input\" type=\"text\" name=TXT_REFERENCE'+lineno_bank+' maxlength=\"20\" size=\"20\" style=\"width: 125px\"></TD>'+");
			out.println("  '<TD WIDTH=\"10%\"><input class=\"txt_input3\" type=\"text\" name=TXT_TEL_NO2'+lineno_bank+' onBlur=\"Validate_Telephone_Number(this,1)\" maxlength=\"60\" size=\"22\" style=\"width: 125px\"></TD>'+");
			out.println("  '<TD WIDTH=\"10%\"><input class=\"txt_input3\" type=\"text\" name=TXT_FAX_NO'+lineno_bank+' onBlur=\"Validate_Telephone_Number(this,2)\" maxlength=\"60\" size=\"22\" style=\"width: 125px\"></TD>'+");
			out.println("  '<TD WIDTH=\"7%\"><input class=\"txt_input5\" type=\"text\" name=TXT_RELATIONSHIP2'+lineno_bank+' onblur=\"check_number(this)\"  maxlength=\"4\" size=\"6\" style=\"width: 55px\" ></TD>'+");
			...
			out.println("  '<TD WIDTH=\"9%\"><input class=\"txt_input3\" type=\"text\" name=TXT_BANK_CODE'+lineno_bank+' onblur=\"makeRequest8(this)\"  maxlength=\"10\" size=\"12\" style=\"width: 70px\"></TD>'+");
			out.println("  '<TD WIDTH=\"4%\"><input class=\"but_input\" type=\"button\" name=BUT_TXT_BANK_CODE'+lineno_bank+' value=\"?\" onClick=\"help_button_bank('+lineno_bank+')\"  style=\"width: 30px\" ></td>'+");
			out.println("  '<TD WIDTH=\"10%\"><input class=\"txt_input3\" type=\"text\" name=TXT_BANK_NAME'+lineno_bank+' value=\"\"></TD>'+");
			...
			out.println("  '<TD WIDTH=\"10%\"><input class=\"txt_input3\" type=\"text\" name=TXT_TEL_NO2'+lineno_bank+' onBlur=\"Validate_Telephone_Number(this,1)\" maxlength=\"60\" size=\"22\" style=\"width: 125px\"></TD>'+");
			out.println("  '<TD WIDTH=\"10%\"><input class=\"txt_input3\" type=\"text\" name=TXT_FAX_NO'+lineno_bank+' onBlur=\"Validate_Telephone_Number(this,2)\" maxlength=\"60\" size=\"22\"  style=\"width: 125px\"></TD>'+");
			out.println("  '<TD WIDTH=\"7%\"><input class=\"txt_input5\" type=\"text\" name=TXT_RELATIONSHIP2'+lineno_bank+' onblur=\"check_number(this)\" style=\"width: 55px\"  maxlength=\"4\" size=\"6\"></TD>'+");
			out.println("  '<TD WIDTH=\"6%\"><input class=\"but_input\" type=\"button\" name=BUT_BANK_DEL'+lineno_bank+' value=\"Delete\" onClick=del_row_bank(\"'+lineno_bank+'\",\"'+type+'\")>'+");
			out.println("  '</td></tr></table>';");
			...
			out.println("'</SELECT></td>'+");
			//out.println("'<TD WIDTH=\"15%\"><input class=\"txt_input3\" type=\"text\" name=TXT_TYPE_OF_FACILITY'+lineno_credit+' maxlength=\"50\"></TD>'+");
			out.println("'<TD WIDTH=\"15%\"><input class=\"txt_input\" type=\"text\" name=TXT_INSTITUTION'+lineno_credit+' maxlength=\"100\" style=\"width: 130px\"></TD>'+");
			out.println("'<TD WIDTH=\"12%\"><input class=\"txt_input\" type=\"text\" name=TXT_CONTACT_PERSON'+lineno_credit+' maxlength=\"100\" style=\"width: 100px\"></TD>'+");
			out.println("'<TD WIDTH=\"12%\"><input class=\"txt_input3\" type=\"text\" name=TXT_CONTRACT_NO'+lineno_credit+' maxlength=\"60\"  size=\"13\" style=\"width: 100px\"></TD>'+");
			out.println("'<TD WIDTH=\"12%\"><input class=\"txt_input3\" type=\"text\" name=TXT_SECURITY'+lineno_credit+' maxlength=\"100\" size=\"14\" style=\"width: 100px\"></TD>'+");
			out.println("'<TD WIDTH=\"12%\"><input class=\"txt_input5\" type=\"text\" name=TXT_APPROVED_AMOUNT'+lineno_credit+' onblur=\"check_number(this)\" maxlength=\"25\" style=\"width: 100px\"></TD>'+");
			out.println("'<TD WIDTH=\"12%\"><input class=\"txt_input5\" type=\"text\" name=TXT_BALANCE_AMOUNT'+lineno_credit+' onblur=\"check_number_decimal(this,21)\" maxlength=\"21\" style=\"width: 100px\"></TD>'+");
			out.println("'<TD WIDTH=\"7%\"><input class=\"txt_input5\" type=\"text\" name=TXT_MONTHS'+lineno_credit+' onblur=\"check_number(this)\" maxlength=\"4\" size=\"5\" style=\"width: 55px\" ></TD>'+");
			...
			out.println("if(b_flag==0){");
				out.println("e_txt_company_directors.innerHTML +='<table  border=\"0\"  align=\"center\" width=\"100%\" class=\"table\"><tr>'+");									
		...
		out.println("}");
			*/
			...
			out.println("function add_row_property(type){");  //modiifed by nuwan de silva 10-07-07
			//out.println("alert('type'+type)");
			
			out.println("var b_flag=0;");
			out.println("if(lineno_property!=0){ "); 
			out.println("  count=lineno_property-1;");
			out.println("  m_name=\"TXT_NAME\"+count");
			out.println("  m_loc=\"TXT_LOC\"+count");
			out.println("  m_make=\"TXT_MAKE\"+count");
			out.println("  m_model=\"TXT_MODEL\"+count");
			out.println("  m_engine_no=\"TXT_ENGINE_NO\"+count");//Added by Prabash on 21-03-2012
			out.println("  m_chassis_no=\"TXT_CHASSIS_NO\"+count");//Added by Prabash on 21-03-2012
			out.println("  m_company=\"TXT_COMPANY\"+count");
			out.println("  m_val=\"TXT_VALUE_P\"+count");
			out.println("  m_reg=\"TXT_REG_NO\"+count");
			
			out.println(" if(document.Form1.elements[m_name].value==\"\") {");
			out.println("  alert('Property name cannot be null');");
			out.println("  b_flag=1;");
			out.println(" }");
			out.println(" else if(document.Form1.elements[m_loc].value==\"\") {");
			out.println("  alert('Loaction cannot be null');");
			out.println("  b_flag=1;");
			out.println(" }");
			out.println(" else if(document.Form1.elements[m_make].value==\"\") {");
			...
			out.println("  b_flag=1;");
			out.println(" }");
			//--added by Prabash on 21-03-2012---------**
			out.println(" else if(document.Form1.elements[m_engine_no].value==\"\") {");
			out.println("  alert('Engine no cannot be null');");
			out.println("  b_flag=1;");
			out.println(" }");
			out.println(" else if(document.Form1.elements[m_chassis_no].value==\"\") {");
			out.println("  alert('Chassis_no cannot be null');");
			out.println("  b_flag=1;");
			out.println(" }");	
			//-----------------------------------------**
			out.println(" else if(document.Form1.elements[m_company].value==\"\") {");
			out.println("  alert('Company  cannot be null');");
			out.println("  b_flag=1;");
			out.println(" }");
			out.println(" else if(document.Form1.elements[m_val].value==\"\") {");
			out.println("  alert(' Value cannot be null');");
			out.println("  b_flag=1;");
			out.println(" }");
			out.println(" else{");
			...
			out.println("		'<select name=TXT_NAME'+lineno_property+' class=\"txt_input\" >'+");
			out.println("		'<OPTION value=\"LAND_BUILD\" >Land & Building</option>'+");
			out.println("		'<OPTION value=\"VEHICLE\" SELECTED>Vehicles</option>'+");
			out.println("		'<OPTION value=\"LIFE_INS\" >Life Insurance </option>'+");
			out.println("		'<OPTION value=\"SHARES\" >Shares In Companies </option>'+");
			out.println("		'</SELECT></td>'+");
			out.println("		    '<TD WIDTH=\"15%\"><input class=\"txt_input\" type=\"text\" name=TXT_LOC'+lineno_property+' value=\"\"  maxlength=\"200\"  style=\"width: 180px\" size=\"40\"></TD>'+");
			out.println("		'<TD WIDTH=\"10%\"><input class=\"txt_input\" type=\"text\" name=TXT_MAKE'+lineno_property+' value=\"-\"  maxlength=\"50\"  style=\"width: 80px\" size=\"40\"></TD>'+");
			out.println("		'<TD WIDTH=\"10%\"><input class=\"txt_input\" type=\"text\" name=TXT_MODEL'+lineno_property+' value=\"-\"  maxlength=\"50\"  style=\"width: 80px\" size=\"40\"></TD>'+");
			out.println("		'<TD WIDTH=\"10%\"><input class=\"txt_input\" type=\"text\" name=TXT_ENGINE_NO'+lineno_property+' value=\"-\"  maxlength=\"50\"  style=\"width: 80px\" size=\"40\"></TD>'+"); //Added by Prabash on 23-03-2012
			out.println("		'<TD WIDTH=\"10%\"><input class=\"txt_input\" type=\"text\" name=TXT_CHASSIS_NO'+lineno_property+' value=\"-\"  maxlength=\"50\"  style=\"width: 80px\" size=\"40\"></TD>'+"); //Added by Prabash on 23-03-2012
			out.println("		'<TD WIDTH=\"10%\"><input class=\"txt_input\" type=\"text\" name=TXT_COMPANY'+lineno_property+' value=\"\"  maxlength=\"100\"  style=\"width: 130px\" size=\"40\"></TD>'+");
			out.println("		    '<TD WIDTH=\"10%\"><input class=\"txt_input\" type=\"text\" name=TXT_VALUE_P'+lineno_property+' value=\"\" onblur=\"check_number(this)\" STYLE=\"{text-align:right;width: 100px}\" maxlength=\"20\" size=\"20\"></TD>'+");
			out.println("		'<TD WIDTH=\"10%\"><input class=\"txt_input\" type=\"text\" name=TXT_REG_NO'+lineno_property+' style=\"width: 95px\" maxlength=\"10\" size=\"20\"></TD>'+");
			out.println("		'<TD WIDTH=\"5%\"><input class=\"but_input\" type=\"button\" name=BUT_PRO_DEL'+lineno_property+' value=\"Delete\" onClick=\"del_row_property('+lineno_property+')\">'+");
			out.println("		'</td></tr></table>';");
			//out.println(" if(document.Form1.TXT_CLIENT_TYPE.value == \"I\") { "); //modiifed by nuwan de silva 10-07-07
			out.println(" if(type==\"I\") { ");
			out.println("	e_txt_property.innerHTML += m_write_data_prop ");
			out.println(" }");
			out.println("	else {");
			out.println("	e_txt_property_c.innerHTML += m_write_data_prop ");
			out.println(" }");
			out.println("lineno_property = lineno_property+1;");
			out.println("arr_size_property = lineno_property;");
			out.println("}");
			out.println("add_button_property(type);"); //modiifed by nuwan de silva 10-07-07
			out.println("}");
			
			out.println("function disable_rows_property(no)");
			out.println("{");
			out.println("for(var i=0;i<no;i++)");
			out.println("{	");
			
			out.println("  m_name=\"TXT_NAME\"+i");
			out.println("  m_loc=\"TXT_LOC\"+i");
			out.println("  m_make=\"TXT_MAKE\"+i");
			out.println("  m_model=\"TXT_MODEL\"+i");
			out.println("  m_company=\"TXT_COMPANY\"+i");
			out.println("  m_val=\"TXT_VALUE_P\"+i");
			out.println("  m_reg=\"TXT_REG_NO\"+i");
			out.println("  m_del=\"BUT_PRO_DEL\"+i");	
			
			
			out.println("   document.Form1.elements[m_name].disabled=true;");                           
			out.println("   document.Form1.elements[m_loc].disabled=true;");	
			out.println("   document.Form1.elements[m_make].disabled=true;");
			out.println("   document.Form1.elements[m_model].disabled=true;");	
			out.println("   document.Form1.elements[m_company].disabled=true;");
			out.println("   document.Form1.elements[m_val].disabled=true;");
			out.println("   document.Form1.elements[m_reg].disabled=true;");
			out.println("   document.Form1.elements[m_del].disabled=true;");
			
			out.println("}	");
			out.println("   document.Form1.BUT_ADD_PRO.disabled=true;");	
			out.println("} ");
			
			
			out.println("function del_row_property(rowNo){"); 
			//out.println("alert(' row No prp =' +rowNo)");
			out.println("var j=0;");
			out.println("for(var i=0;i<arr_size_property;i++){");
			...
			//out.println("alert('Value ew - :  ' +document.Form1.elements[\"TXT_VALUE\"+i].value)");	
			out.println("array_name_p[j]=document.Form1.elements[m_name].value;");
			out.println("array_loc_p[j]=document.Form1.elements[m_loc].value;");
			out.println("array_make_p[j]=document.Form1.elements[m_make].value;");
			out.println("array_model_p[j]=document.Form1.elements[m_model].value;");
			out.println("array_company_p[j]=document.Form1.elements[m_company].value;");
			out.println("array_val_p[j]=document.Form1.elements[m_val].value;");
			out.println("array_reg_no[j]=document.Form1.elements[m_reg].value;");
			
			out.println("j=j+1;");
			out.println("}");
			
			out.println("m_name=\"TXT_NAME\"+rowNo");
			out.println("m_loc=\"TXT_LOC\"+rowNo");
			out.println("m_make=\"TXT_MAKE\"+rowNo");
			out.println("m_model=\"TXT_MODEL\"+rowNo");
			out.println("m_company=\"TXT_COMPANY\"+rowNo");
			out.println("m_val=\"TXT_VALUE_P\"+rowNo");
			out.println("m_reg=\"TXT_REG_NO\"+rowNo");
			
			out.println("if( document.Form1.elements[m_loc].value != '' || document.Form1.elements[m_make].value != '' || document.Form1.elements[m_model].value != '' || document.Form1.elements[m_val].value != '' || document.Form1.elements[m_reg].value != '' ) { ");
			out.println(" if(confirm('Are you sure you want to delete ?')){ "); 
			out.println("		lineno_property = lineno_property-1;");
			out.println("		arr_size_property = lineno_property;");
			out.println("		write_data_property(arr_size_property);");
			out.println("	}");
			out.println("}");
			out.println(" else { ");
			out.println("		lineno_property = lineno_property-1;");
			...
			out.println("function write_data_property(size){");
			//out.println("alert('arr_size_guarantor '+size);");
			out.println("e_txt_property.innerHTML=\"\";");
			out.println("e_txt_property_c.innerHTML=\"\";");
			out.println("m_write_data1 ='';");
			out.println("m_write_data2 ='';");
			
			out.println(" for(var j=0;j<size;j++){");
			out.println("if(array_make_p[j]==\"\" && array_loc_p[j]==\"\" && array_model_p[j]==\"\" && array_company_p[j]==\"\"  && array_val_p[j]==\"\" && array_reg_no[j]==\"\"){");
			
			out.println("m_write_data1  +='<table  align=\"center\" width=\"100%\" class=\"table\"><tr>'+");									
			out.println("'<td WIDTH=\"14%\">'+ ");
			out.println("'<select name=TXT_NAME'+j+' class=\"txt_input\" >'+");
			out.println("'<OPTION value=\"LAND_BUILD\" >Land & Building</option>'+");
			out.println("'<OPTION value=\"VEHICLE\" SELECTED>Vehicles</option>'+");
			out.println("'<OPTION value=\"LIFE_INS\" >Life Insurance </option>'+");
			out.println("'<OPTION value=\"SHARES\" >Shares In Companies </option>'+");
			out.println("'</SELECT></td>'+");
			out.println("'<TD WIDTH=\"21%\"><input class=\"txt_input\" type=\"text\" name=TXT_LOC'+j+' maxlength=\"200\"  style=\"width: 180px\" size=\"40\"></TD>'+");
			out.println("'<TD WIDTH=\"10%\"><input class=\"txt_input\" type=\"text\" name=TXT_MAKE'+j+' maxlength=\"50\"  style=\"width: 80px\" size=\"40\"></TD>'+");
			out.println("'<TD WIDTH=\"10%\"><input class=\"txt_input\" type=\"text\" name=TXT_MODEL'+j+' maxlength=\"50\"  style=\"width: 80px\" size=\"40\"></TD>'+");
			out.println("'<TD WIDTH=\"15%\"><input class=\"txt_input\" type=\"text\" name=TXT_COMPANY'+j+' maxlength=\"100\"  style=\"width: 130px\" size=\"40\"></TD>'+");
			out.println("'<TD WIDTH=\"12%\"><input class=\"txt_input\" type=\"text\" name=TXT_VALUE_P'+j+' onblur=\"check_number(this)\" STYLE=\"{text-align:right;width: 100px}\" maxlength=\"20\" size=\"20\"></TD>'+");
			out.println("'<TD WIDTH=\"12%\"><input class=\"txt_input\" type=\"text\" name=TXT_REG_NO'+j+' style=\"width: 95px\" maxlength=\"10\" size=\"20\"></TD>'+");
			out.println("'<TD WIDTH=\"6%\"><input class=\"but_input\" type=\"button\" name=BUT_PRO_DEL'+j+' value=\"Delete\" onClick=\"del_row_property('+j+')\">'+");
			out.println("'</td></tr></table>';");
			out.println("continue;");
			out.println("}");
			
			out.println("m_write_data1  +='<table  align=\"center\" width=\"100%\" class=\"table\"><tr>'");									
			//out.println("'<TD WIDTH=\"15%\"><input class=\"txt_input\" type=\"text\" name=TXT_NAME'+lineno_property+' maxlength=\"100\"  style=\"width: 220px\"  size=\"50\"></TD>'+");
			out.println(" if(array_name_p[j]==\"VEHICLE\") { ");
			out.println("m_write_data2  ='<td WIDTH=\"14%\">'+ ");
			out.println("'<select name=TXT_NAME'+j+' class=\"txt_input\" >'+");
			out.println("'<OPTION value=\"LAND_BUILD\" >Land & Building</option>'+");
			out.println("'<OPTION value=\"VEHICLE\" SELECTED>Vehicles</option>'+");
			out.println("'<OPTION value=\"LIFE_INS\" >Life Insurance </option>'+");
			...
			out.println("'</SELECT></td>'");
			out.println("}");
			out.println(" else if(array_name_p[j]==\"LAND_BUILD\") { ");
			out.println("m_write_data2  ='<td WIDTH=\"14%\">'+ ");
			out.println("'<select name=TXT_NAME'+j+' class=\"txt_input\" >'+");
			out.println("'<OPTION value=\"LAND_BUILD\" SELECTED >Land & Building</option>'+");
			out.println("'<OPTION value=\"VEHICLE\">Vehicles</option>'+");
			out.println("'<OPTION value=\"LIFE_INS\" >Life Insurance </option>'+");
			out.println("'<OPTION value=\"SHARES\" >Shares In Companies </option>'+");
			out.println("'</SELECT></td>'");
			out.println("}");
			out.println(" else if(array_name_p[j]==\"LIFE_INS\") { ");
			out.println("m_write_data2  ='<td WIDTH=\"14%\">'+ ");
			out.println("'<select name=TXT_NAME'+j+' class=\"txt_input\" >'+");
			out.println("'<OPTION value=\"LAND_BUILD\"  >Land & Building</option>'+");
			out.println("'<OPTION value=\"VEHICLE\">Vehicles</option>'+");
			out.println("'<OPTION value=\"LIFE_INS\" SELECTED >Life Insurance </option>'+");
			out.println("'<OPTION value=\"SHARES\" >Shares In Companies </option>'+");
			out.println("'</SELECT></td>'");
			out.println("}");
			out.println(" else if(array_name_p[j]==\"SHARES\") { ");
			out.println("m_write_data2 ='<td WIDTH=\"14%\"> '+ ");
			out.println("'<select name=TXT_NAME'+j+' class=\"txt_input\" >'+");
			out.println("'<OPTION value=\"LAND_BUILD\"  >Land & Building</option>'+");
			out.println("'<OPTION value=\"VEHICLE\">Vehicles</option>'+");
			out.println("'<OPTION value=\"LIFE_INS\"  >Life Insurance </option>'+");
			out.println("'<OPTION value=\"SHARES\" SELECTED >Shares In Companies </option>'+");
			out.println("'</SELECT></td>'");
			out.println("}");
			//out.println(" alert(m_write_data2); ");
			out.println("m_write_data1  += m_write_data2 + '<TD WIDTH=\"21%\"><input class=\"txt_input\" type=\"text\" name=TXT_LOC'+j+' value=\"'+array_loc_p[j]+'\"  maxlength=\"200\"  style=\"width: 180px\" size=\"40\"></TD>'");
			out.println("m_write_data1  +='<TD WIDTH=\"10%\"><input class=\"txt_input\" type=\"text\" name=TXT_MAKE'+j+' value=\"'+array_make_p[j]+'\"  maxlength=\"50\"  style=\"width: 80px\" size=\"40\"></TD>'");
			out.println("m_write_data1  +='<TD WIDTH=\"10%\"><input class=\"txt_input\" type=\"text\" name=TXT_MODEL'+j+' value=\"'+array_model_p[j]+'\"  maxlength=\"50\"  style=\"width: 80px\" size=\"40\"></TD>'");
			out.println("m_write_data1  +='<TD WIDTH=\"15%\"><input class=\"txt_input\" type=\"text\" name=TXT_COMPANY'+j+' value=\"'+array_company_p[j]+'\"  maxlength=\"100\"  style=\"width: 130px\" size=\"40\"></TD>'");
			out.println("m_write_data1  +='<TD WIDTH=\"12%\"><input class=\"txt_input\" type=\"text\" name=TXT_VALUE_P'+j+' value=\"'+array_val_p[j]+'\"  onblur=\"check_number(this)\" STYLE=\"{text-align:right;width: 100px}\" maxlength=\"20\" size=\"20\"></TD>'");
			out.println("m_write_data1  +='<TD WIDTH=\"12%\"><input class=\"txt_input\" type=\"text\" name=TXT_REG_NO'+j+' value=\"'+array_reg_no[j]+'\" style=\"width: 95px\" maxlength=\"10\" size=\"20\"></TD>'");
			out.println("m_write_data1  +='<TD WIDTH=\"6%\"><input class=\"but_input\" type=\"button\" name=BUT_PRO_DEL'+j+' value=\"Delete\" onClick=\"del_row_property('+j+')\">'");
			out.println("m_write_data1  +='</td></tr></table>';");
			out.println("}");
			//out.println(" alert('type'+document.Form1.TXT_CLIENT_TYPE.value); ");
			//out.println(" alert(m_write_data1); ");
			out.println(" if(document.Form1.TXT_CLIENT_TYPE.value == \"I\")");
			out.println("  e_txt_property.innerHTML += m_write_data1; ");
			out.println(" else ");
			out.println("  e_txt_property_c.innerHTML += m_write_data1; ");	
			out.println("lineno_property = j;");
			out.println("}");
			...
			out.println("'<TD WIDTH=\"15%\"><input class=\"txt_input5\" type=\"text\" name=TXT_APPROVED_AMOUNT'+lineno_credit_c+' onblur=\"check_number(this)\" maxlength=\"25\" size=\"20\" style=\"width: 120px\" ></TD>'+");
			...
			*/
			...
			out.println("else if(document.Form1.TXT_OTHER_NAME.value==\"\"){  "); 
			...
			*/
			...
			//out.println("else if(document.Form1.TXT_NIC_NO.value==\"\" ){  "); // commented by udara on 14-11-2013
			out.println("else if ( (document.Form1.TXT_NIC_NO.value==\"\") && (document.Form1.TXT_PASSPORT_NO.value==\"\") ) {  ");  // added by udara on 14-11-2013
			...
			*/
			...
			out.println(" if(m_status==\"Deactivate\" || m_status==\"Reactivate\" ){"); 
			out.println("		if(document.Form1.hid_client_type.value == 'I'){"); 
			...
			out.println("   }");
			out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_MAS_save_guarantor_creation?countemp='+lineno+'"+
				...
				"&countcreditc='+lineno_credit_c+'&countcus='+lineno_customer+'&countaudit='+lineno_auditors+'&countnonc='+lineno_nonrelated+'&m_screen="+m_screen+"&save_close="+m_save_close+"&row_no="+m_row_no+"&arr_size_in_ex='+arr_size_income+'&countprop='+lineno_property;");  
			out.println("		document.Form1.submit();	");
			out.println("		}"); 
			out.println(" }"); 
			
			out.println("		else if(document.Form1.hid_client_type.value == 'C'){"); 
			out.println("		if(confirm(m_save_msg)){ "); 
			out.println("   for (var i=0; i < document.Form1.elements.length; i++ ) {");
			out.println("    document.Form1.elements[i].disabled=false;");
			out.println("   }");
			...
			out.println("		if(validate_NIC(document.Form1.TXT_NIC_NO)){"); 	
			out.println("		if(double_check('I'))"); 
			out.println("		if(confirm(m_save_msg)){ "); 
			out.println("   for (var i=0; i < document.Form1.elements.length; i++ ) {");
			out.println("    document.Form1.elements[i].disabled=false;");
			out.println("   }");
			...
			out.println("		if(document.Form1.hid_client_type.value == 'I'){"); 
			out.println("		if(check_dates()){"); 
			out.println("		if(confirm(\"Are you sure you want to perform a temporary save ?\")){ "); 
			out.println("		for (var i=0; i < document.Form1.elements.length; i++ ) {");
			out.println("		document.Form1.elements[i].disabled=false;");
			out.println("		}");
			out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_MAS_save_guarantor_creation_temp?countemp='+lineno+'"+
				"&countbank='+lineno_bank+'&countcredit='+lineno_credit+'&countfamily='+lineno_family+'"+
				"&countcomp='+lineno_company_dir+'&countba='+lineno_ba+'&countsub='+lineno_subsidiaries+'&countbankc='+lineno_bank+'"+
				"&countcreditc='+lineno_credit_c+'&countcus='+lineno_customer+'&countaudit='+lineno_auditors+'&countnonc='+lineno_nonrelated+'&m_screen="+m_screen+"&save_close="+m_save_close+"&row_no="+m_row_no+"&arr_size_in_ex='+arr_size_income+'&countprop='+lineno_property;");  
			out.println("		document.Form1.submit();	"); 
			out.println("		}"); 
			...
			out.println("document.Form1.hid_screen.value=m_screen;   ");
			...
			out.println(" if(document.Form1.hid_app_screen.value=='Y'){ "); 			
			...
			//out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MAS_display_guarantor_creation';"); // commented by udara 18-09-2014
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MAS_display_guarantor_creation'+'?app_screen="+m_app_screen+"';"); // added by udara 18-09-2014
			out.println("		}}"); 
			//out.println("}"); 
			...
			out.println("help_box.innerHTML=\" System Administration  - Creation Of Guarantor - \"+m_val;"); 
			out.println("help_box1.innerHTML=\" System Administration - Creation Of Guarantor - \"+m_val;"); 
			//out.println("    select_content(m_client_type);");
			
			out.println("}"); 
			
			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" System Administration  - Creation Of Guarantor - \"+document.Form1.hid_status.value;"); 
			out.println("help_box1.innerHTML=\" System Administration - Creation Of Guarantor - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
			...
			out.println("document.Form1.temp_save2.disabled=true;");//Added By Nuwan De Silva
			out.println("document.Form1.temp.disabled=true;"); //Added by Kanchana on 2016-09-09
			
			out.println("if(document.Form1.hid_client_type.value=='I'){");
			//out.println("  document.Form1.TXT_TOT_EXPENSE.disabled=true;"); //added by nwuan de silva on 01-10-07
			...
			out.println(" }else if(m_app_screen=='APP_N' || m_screen=='G'){ "); //[Application Entry level and creation of client level ]
			...
			out.println("}");
			//out.println("   ocument.Form1.TXT_NIC_NO.disabled =true;");
			...
			*/
			...
			out.println("function load_screen_status(m_val){"); 
			out.println("  load_screen_status_reduce_guar(m_val,'"+m_screen+"','"+m_app_screen+"'); ");
			out.println("}");
			...
			*/
			...
			out.println("		help_value_assign_client_code_creation(\"G\");"); 
			out.println("		}"); 
			...
			//-------COMMENTED BY CHANDANA ON 07/03/2007---------------//
			...
			out.println("  	 if(document.Form1.elements[m_bank].value != '' && document.Form1.elements[m_branch].value == '' ) ");
			out.println("    m_criteria = document.Form1.elements[m_bank].value+\"@Y@\";"); 
			out.println("  	 else  ");
			out.println("    m_criteria = document.Form1.elements[m_branch].value+\"@Y@\";"); 
			//out.println("  	 else if(document.Form1.elements[m_bank].value != '' && document.Form1.elements[m_branch].value != '' && ( m_bank_val+\"-\"+m_branch_val) != document.Form1.elements[m_branch].value   )  ");
			//out.println("    m_criteria = document.Form1.elements[m_bank].value+\"-\"+document.Form1.elements[m_branch].value+\"@Y@\";"); 
			...
			*/
			...
			//-----------ADDED BY CHANDANA  ON 07/03/2007---------------//
			/*out.println("function help_button_branch(lineno) {"); 
			out.println("    m_bank=\"TXT_BANK_CODE\"+lineno");
			out.println("    m_branch=\"TXT_BRANCH_CODE\"+lineno");
			out.println("    m_bank_val = document.Form1.elements[m_bank].value");
		  ...
		  out.println("    m_criteria =document.Form1.elements[m_branch].value+\"@\"+document.Form1.elements[m_bank].value+\"@Y@\";"); 
			...
			*/
			...
			out.println("  var from_screen = '"+m_chksql+"';"); //Added by Kanchana on 2016-09-09
			...
			out.println("  }");
			out.println("  else {");
			out.println("    document.Form1.TXT_EMP_NAME.value=data_vec[18];");
			out.println("  }");
			//#####################	
			...
			out.println("  }");
			out.println(" set_client_help_disable_guarantor() "); //Added by kanchana on 2016-09-02
			...
			//out.println("    document.Form1.TXT_CORRESPONDENCE_OFF.value=data_vec[9];"); 
			out.println(" if(data_vec[7]==''||data_vec[7]=='null'){");
			...
			//out.println("    document.Form1.TXT_DESIGNATION2.value=data_vec[10];"); 
			out.println(" if(data_vec[8]==''||data_vec[8]=='null'){");
			...
			//out.println("    document.Form1.TXT_BUSINESS_CERTIFICATE_NO.value=data_vec[21];"); 
			out.println(" if(data_vec[19]==''||data_vec[19]=='null'){");
			out.println("    document.Form1.TXT_BUSINESS_CERTIFICATE_NO.value='';"); 
			out.println(" }");
			out.println(" else {");
			...
			//out.println("    document.Form1.TXT_DATE_OF_INCORPORATION.value=data_vec[22];"); 
			out.println(" if(data_vec[20]==''||data_vec[20]=='null'){");
			...
			//out.println("    document.Form1.TXT_VAT_REG_NO.value=data_vec[23];"); 
			out.println(" if(data_vec[21]==''||data_vec[21]=='null'){");
			out.println("    document.Form1.TXT_VAT_REG_NO.value='';"); 
			out.println(" }");
			out.println(" else {");
			...
			//out.println("    document.Form1.TXT_VAT_REG_DATE.value=data_vec[24];"); 
			out.println(" if(data_vec[22]==''||data_vec[22]=='null'){");
			...
			out.println(" }");
			//out.println("    document.Form1.TXT_REG_OFFICE.value=oBj.valout[4];"); 
			//out.println("    document.Form1.TXT_KEY_DECISION_MAKER.value=oBj.valout[5];"); 
			out.println(" if(oBj.valout[6]==''||oBj.valout[6]=='null'){");
			out.println("    document.Form1.TXT_KEY_DECISION_MAKER.value='';"); 
			out.println(" }");
			out.println(" else {");
			...
			//out.println("    document.Form1.TXT_DESIGNATION1.value=oBj.valout[6];"); 
			//out.println("    document.Form1.TXT_DIRECT_TEL_NO.value=oBj.valout[7];"); 
			out.println(" if(oBj.valout[8]==''||oBj.valout[8]=='null'){");
			out.println("    document.Form1.TXT_DIRECT_TEL_NO.value='';"); 
			out.println(" }");
			out.println(" else {");
			...
			//out.println("    document.Form1.TXT_CONTACT_FOR_PAYMENT.value=oBj.valout[8];"); 
			out.println(" if(oBj.valout[9]==''||oBj.valout[9]=='null'){");
			out.println("    document.Form1.TXT_CONTACT_FOR_PAYMENT.value='';"); 
			out.println(" }");
			out.println(" else {");
			...
			out.println(" m_client_code_value='';"); //added by nuwan de silva on 01-10-07
			out.println("   if(obj=='I'){");
			out.println("  document.Form1.hid_client_type.value=obj;");
			out.println("  m_client_type_value=obj;"); //added by nuwan de silva on 01-10-07
			out.println("  document.Form1.TXT_CLIENT_CODE.value='';");
			//out.println(" if(m_close_status!='Y'){"); //comment by nuwan de silva on 01-10-07
			out.println("	 add_individual();");
			//out.println(" }"); 
			/*out.println("  if(document.Form1.SCREEN_NAME.value =='NEW')"); 
			...
			//out.println("'<tr >'+");
			out.println("'<tr>'+");
			out.println("'<td colspan=4 ><B><u> A.Details 0f Applicant </u></B></td>'+"); 
			out.println("'</tr>'+");
			out.println("'<tr >'+"); 
			...
			out.println("'<td ><input class=\"txt_input\" type=\"text\" name=\"TXT_DIRECT_TEL_NO\" onBlur=\"Validate_Telephone_Number(this,1)\" maxlength=\"60\" size=\"10\"></td>'+"); 
			out.println("'</tr>'+"); 
			...
			out.println("'<input class=\"but_input\" type=\"button\" name=\"BUT_HELP_CITY\" value=\"Help\" onClick=\"help_button_city()\">    </td>'+"); 
			//-----------added by :delanjali------------------------------------------------------------------------------------------------------------------------------------------------
			//-----------date     :2007-06-20-----------------------------------------------------------------------------------------------------------------------------------------------
			out.println("'<tr >'+"); 
			out.println("'<td ><DIV id=\"DIV_TXT_CITY_CODE\"  class=\"div_input\">City Description </div></td>'+"); 
			...
			out.println("'<input class=\"but_input\" type=\"button\" name=\"BUT_HELP_POSTAL_CODE\" value=\"Help\" onClick=\"help_button_postal_code()\" >  </td>'+"); 
			out.println("'</tr>'+"); 
			//----modified by : delanjali-------------------------------------------------------------------------------------------------------------------------------------------------------------
			//----date : 2007-06-20-------------------------------------------------------------------------------------------------------------------------------------------------------------
			...
			out.println("'<td ><input class=\"txt_input\" type=\"text\" name=\"TXT_GEN_TEL_NO\" onBlur=\"Validate_Telephone_Number(this,1)\" maxlength=\"60\" size=\"50\"></td>'+"); 
			out.println("'</tr>'+"); 
			...
			out.println("'<td ><input class=\"txt_input\" type=\"text\" name=\"TXT_GEN_FAX\" onBlur=\"Validate_Telephone_Number(this,2)\" maxlength=\"60\" size=\"10\"></td>'+"); 
			out.println("'</tr>'+"); 
			...
			out.println("'<td ><input class=\"txt_input\" type=\"text\" name=\"TXT_F_TEL_NO\" onBlur=\"Validate_Telephone_Number(this,1)\" maxlength=\"60\" size=\"50\"></td>'+"); 
			out.println("'</tr>'+"); 
			...
			out.println("'<td ><input class=\"txt_input\" type=\"text\" name=\"TXT_F_FAX_NO\" onBlur=\"Validate_Telephone_Number(this,2)\" maxlength=\"60\" size=\"10\"></td>'+"); 
			out.println("'</tr>'+"); 
			...
			rs=stmt.executeQuery(" SELECT ENTITY_CODE,DESCRIPTION "+
				...
				" WHERE  ENTITY_CODE NOT IN ('INDIVIDUAL') AND ACTIVE_STATUS='Y'  "); //modofied by nuwan de silva 03-07-07
			...
			out.println("add_label_property('C');"); //modiifed by nuwan de silva 10-07-07
			out.println("header_property('C');");
			out.println("add_row_property('C');");
			
			out.println("view_client_status()"); //added by nuwan de silva 08-08-07
			
			out.println("}");
			
			//Added by Kanchana to check availability of NIC No * field	  
			out.println(" function check_availability(obj){ ");
			out.println(" m_size=obj.value.length; ");
			out.println(" if (obj.value=='')	{ ");
			out.println(" alert('Plese Enter NIC No * field first'); ");	
			out.println(" document.Form1.TXT_NIC_NO_OLD.value=''; ");
			out.println("return false;	 ");
			out.println(" } ");
			
			out.println(" if(m_size==10){ ");
			out.println(" alert('You have already entered old NIC number ');	 ");
			out.println(" document.Form1.TXT_NIC_NO_OLD.value=''; ");		
			out.println(" } }");
			//out.println(" } ");  
			//Endded by kanchana 	
			...
			out.println(" lineno_property=0;");
			out.println(" arr_size_property=0;");
			out.println("e_label_property.innerHTML='';  ");
			out.println("e_header_property.innerHTML='';  ");
			out.println("e_txt_property.innerHTML='';  ");
			out.println("e_add_but_property.innerHTML='';  ");
			...
			//out.println("'<tr >'+");
			out.println("'<tr>'+");
			out.println("'<td colspan=4 ><B><u> A.Detials Of Applicant </U></B></td>'+"); 
			out.println("'</tr>'+");
			...
			out.println("'<td  ><input class=\"txt_input\" type=\"text\" name=\"TXT_FIRST_NAME\" style=\"width:250px;\" maxlength=\"200\"></td>'+"); 
			out.println("'<td ></td>'+"); 
			out.println("'</tr>'+"); 
			out.println("'<tr >'+"); 
			...
			out.println("'<tr >'+");
			out.println("'<td  ><DIV id=\"DIV_TXT_ADDRESS1_HOME\" class=\"div_input\">Home Address *</DIV> </td>'+"); 
			out.println("'<td  ><input class=\"txt_input3\" type=\"text\" name=\"TXT_ADDRESS1_HOME\" maxlength=\"100\" size=\"45\"></td>'+"); 
			out.println("'<td  >Telephone Office </td>'+"); 
			out.println("'<td  ><input class=\"txt_input\" type=\"text\" name=\"TXT_OFFICE_TEL_NO\" onBlur=\"Validate_Telephone_Number(this,1)\" maxlength=\"60\" size=\"10\"></td>'+"); 
			out.println("'</tr>'+"); 
			
			out.println("'<tr >'+"); 
			out.println("'<td ></td>'+"); 
			out.println("'<td ><input class=\"txt_input3\" type=\"text\" name=\"TXT_ADDRESS2_HOME\" maxlength=\"100\" size=\"45\"></td>'+"); 
			out.println("'<td >Fax  </td>'+"); 
			out.println("'<td ><input class=\"txt_input\" type=\"text\" name=\"TXT_FAX_NO\" onBlur=\"Validate_Telephone_Number(this,2)\" maxlength=\"60\" size=\"10\"></td>'+"); 
			out.println("'</tr>'+"); 
			...
			//out.println("'<td >Mobile  </td>'+"); // commented by udara 06-12-2023
			out.println("'<td ><DIV id=\"DIV_TXT_MOBILE_NO\"  class=\"div_input\">Mobile * </div></td>'+"); // commented by udara 06-12-2023
			out.println("'<td ><input class=\"txt_input\" type=\"text\" name=\"TXT_MOBILE_NO\" onBlur=\"Validate_Telephone_Number(this,3)\" maxlength=\"30\" size=\"10\"></td>'+"); 
			out.println("'</tr>'+");
			...
			out.println("'<td ><input class=\"txt_input\" type=\"text\" name=\"TXT_DURATION_AT_YEARS\"  STYLE=\"{text-align:right;}\" onblur=\"check_number(this)\" maxlength=\"3\"   size=\"22\"></td>'+"); //check_number_decimal MODIFIED BY CHANDANA FOR REF NO.778 ON 07/08/2007
			out.println("'<td ></td>'+"); 
			out.println("'<td ></td>'+"); 
			out.println("'</tr>'+"); 
			...
			out.println("'<td ><input class=\"txt_input\" type=\"text\" name=\"TXT_DURATION_AT_MONTHS\" STYLE=\"{text-align:right;}\" onblur=\"check_number(this)\" maxlength=\"2\" size=\"2\"></td>'+"); //check_number_decimal MODIFIED BY CHANDANA FOR REF NO.778 ON 07/08/2007
			out.println("'<td ></td>'+"); 
			out.println("'<td ></td>'+"); 
			out.println("'</tr>'+");
			out.println("'<tr ></tr>'+"); 
			...
			out.println("'<td ><input class=\"txt_input3\" type=\"text\" name=\"TXT_EMP_NAME\" value=\"-\" maxlength=\"100\" size=\"45\"></td>'+");  //add  value by Prabash on 23-03-2012
			...
			out.println("'<td >Telephone </td>'+"); 
			out.println("'<td ><input class=\"txt_input\" type=\"text\" name=\"TXT_EMP_TEL_NO\" onBlur=\"Validate_Telephone_Number(this,1)\" maxlength=\"60\" size=\"10\"></td>'+"); 
			out.println("'</tr>'+"); 
			...
			out.println("'<td > </td>'+"); 
			out.println("'<td >Fax </td>'+"); 
			out.println("'<td ><input class=\"txt_input\" type=\"text\" name=\"TXT_EMP_FAX_NO\" onBlur=\"Validate_Telephone_Number(this,2)\" maxlength=\"60\" size=\"10\"></td>'+"); 
			out.println("'</tr>'+"); 
			out.println("'<tr ></tr>'+"); 
			out.println("'<tr ></tr>'+"); 
			out.println("'<tr ></tr>'+");
			...
			out.println("'<td ><input class=\"txt_input3\" type=\"text\" name=\"TXT_NAME_REL\" maxlength=\"100\" size=\"45\"></td>'+"); 
			...
			out.println("'<td ><DIV id=\"DIV_TXT_ADDRESS1_REL\"  class=\"div_input\">Address </DIV></td>'+"); 
			out.println("'<td ><input class=\"txt_input3\" type=\"text\" name=\"TXT_ADDRESS1_REL\" maxlength=\"100\" size=\"45\"></td>'+"); 
			out.println("'<td ><DIV id=\"DIV_TXT_HOME_TEL_NO\"  class=\"div_input\">Telephone - Home  </DIV></td>'+"); 
			out.println("'<td ><input class=\"txt_input\" type=\"text\" name=\"TXT_HOME_TEL_NO\" onBlur=\"Validate_Telephone_Number(this,1)\" maxlength=\"60\" size=\"10\"></td>'+");
			out.println("'</tr>'+"); 
			
			out.println("'<tr >'+"); 
			out.println("'<td > </td>'+"); 
			out.println("'<td ><input class=\"txt_input3\" type=\"text\" name=\"TXT_ADDRESS2_REL\" maxlength=\"100\" size=\"45\"></td>'+"); 
			out.println("'<td >Telephone - Office </td>'+"); 
			out.println("'<td ><input class=\"txt_input\" type=\"text\" name=\"TXT_OFFICE_TEL_NO_REL\" onBlur=\"Validate_Telephone_Number(this,1)\" maxlength=\"60\" size=\"10\"></td>'+"); 
			out.println("'</tr>'+"); 
			...
			out.println("'<td ><input class=\"txt_input\" type=\"text\" name=\"TXT_MOBILE_NO_REL\" onBlur=\"Validate_Telephone_Number(this,3)\" maxlength=\"30\" size=\"10\"></td>'+"); 
			out.println("'</tr>'+"); 
			...
			out.println("'<td ><input class=\"txt_input\" type=\"text\" name=\"TXT_NIC_NO\" onblur=\"makeRequest2(document.Form1.TXT_NIC_NO),validate_NIC(this)\"  maxlength=\"12\"  size=\"10\" ></td>'+"); 
			...
			out.println("'<TD ><input class=\"txt_input5\" type=\"text\" name=\"TXT_DATE_OF_BIRTH_DD\" onBlur=validate_client_dob(document.Form1.TXT_DATE_OF_BIRTH_DD,document.Form1.TXT_DATE_OF_BIRTH_MM,document.Form1.TXT_DATE_OF_BIRTH_YY)  maxlength=\"2\" size=\"2\">'+"); //added by nuwan de silva 06-08-07
			...
			//Added by Kanchana on 2016-08-22
			out.println("'<tr >'+");
			...
			out.println("'<td >'+");
			out.println("'<select name=\"TXT_NATIONALITY\" class=\"txt_input\" >'+");
			
			rs=stmt.executeQuery(" SELECT NATIONALITY_CODE,DESCRIPTION "+
				" FROM   LAKDL.AF_CO_MAS_NATIONALITY WHERE  ACTIVE_STATUS='Y'  ");
			...
			out.println("'<td >Business Sector  </td>'+"); 
			out.println("'<td ><input class=\"txt_input\" type=\"text\" name=\"TXT_BUS_SECT_MAIN\" maxlength=\"10\" size=\"10\">'+"); 
			out.println("'<input class=\"but_input\" type=\"button\" name=\"BUT_TXT_BUS_SUB_MAIN\" value=\"Help\" onClick=\"help_button_bus_sec()\"></td>'+");
			...
			//Property owned
			out.println("add_label_property('I');"); //modiifed by nuwan de silva 10-07-07
			out.println("header_property('I');");
			out.println("add_row_property('I');");
			...
			/*	out.println(" function clear_corporate(){");
				...
				out.println(" lineno_property=0;");
				out.println(" arr_size_property=0;");
				out.println("e_label_property_c.innerHTML='';  ");
				out.println("e_header_property_c.innerHTML='';  ");
				out.println("e_txt_property_c.innerHTML='';  ");
				out.println("e_add_but_property_c.innerHTML='';  ");
				...
				//out.println(" e_app_doc_c.innerHTML='';");
				//out.println(" e_app_doc_header_c.innerHTML='';");
	...
	*/
			...
			out.println(" if(data_vec[9]=='INDIVIDUAL'  && document.Form1.SCREEN_NAME.value ==\"NEW\" && document.Form1.hid_client_type.value==\"I\"  ){ ");
			
			out.println("  if(data_vec[1] != '-') ");
			//out.println("    document.Form1.TXT_FULL_NAME_I.value=data_vec[1];"); 
			out.println("    document.Form1.TXT_OTHER_NAME.value=data_vec[1];");  //Modified Nuwan De Silva--14-05-07--------------
			...
			/*out.println("function help_button_inq() {");
			out.println("    document.Form1.hid_help_type.value=\"77\";"); 
			out.println("    m_sql = \"m_help_TXT_INQUARY_NO\";"); 
			out.println("    m_criteria = document.Form1.TXT_INQUARY_NO.value+\"@\"+\"Y@\";"); 
			out.println("    HelpBox('1','10','2');"); 
			out.println("}"); 
			
			out.println("function help_value_assign_inq() {"); 
			out.println("    document.Form1.TXT_INQUARY_NO.value=oBj.valout[2];"); 
			out.println(" if(oBj.valout[9]=='INDIVIDUAL'   && document.Form1.SCREEN_NAME.value ==\"NEW\" && document.Form1.hid_client_type.value==\"I\"  ){ ");  //Modified Nuwan De Silva 15-05-07
			out.println("  if(oBj.valout[3] != '-') ");
//			out.println("    document.Form1.TXT_FULL_NAME_I.value=oBj.valout[3];"); 
			out.println("    document.Form1.TXT_OTHER_NAME.value=oBj.valout[3];");  //Modified Nuwan De Silva 15-05-07

			out.println("  if(oBj.valout[4] != '-') ");
			out.println("    document.Form1.TXT_TEL_NO.value=oBj.valout[4];"); 
			out.println("  if(oBj.valout[5] != '-') ");
			out.println("    document.Form1.TXT_MOBILE_NO.value=oBj.valout[5];"); 
			out.println("  if(oBj.valout[6] != '-') ");
			out.println("    document.Form1.TXT_FAX_NO.value=oBj.valout[6];"); 
			out.println("  if(oBj.valout[7] != '-') ");
			out.println("    document.Form1.TXT_ADDRESS1_HOME.value=oBj.valout[7];"); 
			out.println("  if(oBj.valout[8] != '-') ");
			out.println("    document.Form1.TXT_CITY_CODE.value=oBj.valout[8];"); 
			out.println("  if(oBj.valout[19] != '-') ");
			out.println("    document.Form1.TXT_ADDRESS2_HOME.value=oBj.valout[19];"); 
			
			out.println("  if(data_vec[27] != '-') ");
		  out.println("    document.Form1.TXT_SURNAME.value=oBj.valout[27];");//Added Nuwan De Silva 15-05-07


			out.println("  if(oBj.valout[16] != '-') ");
			
			out.println("    document.Form1.TXT_NIC_NO.value=oBj.valout[16];"); 
			out.println("    document.Form1.TXT_NIC_NO.focus(); ");
			out.println(" }"); 
			out.println(" else if( oBj.valout[9]!='INDIVIDUAL' && document.Form1.SCREEN_NAME.value ==\"NEW\" && document.Form1.hid_client_type.value!=\"I\") { ");
			out.println("  if(oBj.valout[3] != '-') ");
			out.println("    document.Form1.TXT_FULL_NAME_C.value=oBj.valout[3];"); 
			out.println("  if(oBj.valout[4] != '-') ");
			out.println("    document.Form1.TXT_DIRECT_TEL_NO.value=oBj.valout[4];"); 
			out.println("  if(oBj.valout[7] != '-') ");
			out.println("    document.Form1.TXT_ADDRESS1_REG.value=oBj.valout[7];"); 
			out.println("  if(oBj.valout[8] != '-') ");
			out.println("    document.Form1.TXT_CITY_CODE.value=oBj.valout[8];"); 
			out.println("  if(oBj.valout[9] != '-') ");
			out.println("    document.Form1.TXT_LEGAL_STATUS.value=oBj.valout[9];"); 
			out.println("  if(oBj.valout[19] != '-') ");
			out.println("    document.Form1.TXT_ADDRESS2_REG.value=oBj.valout[19];"); 
			
			out.println("  if(oBj.valout[16] != '-') ");
			out.println("    document.Form1.TXT_BUSINESS_CERTIFICATE_NO.value=oBj.valout[16];");  //added by nuwan de silva 18-05-07
...
*/
			...
			/*		out.println("function set_client_help_disable_guarantor(){ ");
					//if(fscreen != null)	{
					//if(fscreen.equalsIgnoreCase("client_verification")){
					//out.println("alert('kkkk');	");
					out.println("   assign_help_status('H_active_cont'); ");
					out.println("   makeRequest(document.Form1.TXT_CLIENT_CODE); ");			
					//				}	
					//}
					out.println("}"); */  
			...
			out.println("}");
			//out.println("alert('!!'+window.opener.document.Form1.elements[hidchk].value)");
			out.println("}");
			*/
			...
			out.println("check_number_decimal(obj,size)"); 
			out.println("}"); 
			out.println("else{");
			out.println("alert('please enter a number');"); 
			...
			*/
			...
			out.println("<INPUT TYPE='Hidden' NAME='hid_screen' VALUE=\"\">");
			...
			out.println("<INPUT TYPE='Hidden' NAME='hid_count_aud' VALUE=\"1\">");  //added by nuwan de silva 05-07-07
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>System Administration - Creation Of Guarantor </td>"); 
			out.println("</tr>"); 
			...
			//out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Edit\");' name=\"edit\"  onClick='load_screen_status(\"EDIT\")' value=\"Edit\"></td>");  // commented by udara 15-09-2014
			...
			out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Deactivate\");' name=\"dact\" onClick='load_screen_status(\"DACT\")' value=\"De-activate\" Disabled ></td>"); // Disabled by udara 15-09-2014 
			out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Reactivate\");' name=\"ract\" onClick='load_screen_status(\"RACT\")' value=\"Re-activate\" Disabled ></td>"); // Disabled by udara 15-09-2014 
			...
			out.println("<td width='29%' ><input class='txt_input' type='text' name='TXT_CLIENT_CODE' maxlength='10' size='10' onblur=\"validate_client_code()\" disabled >");  //assign_data_values()
			out.println("<input class='but_input' type='button' name='BUT_HELP_MAIN' value=\"Help\" onClick=\"help_client_code_validate()\" disabled>");  //help_update()
			out.println("<input class='but_input1' type='button' name='BUT_HELP_TEMP' value=\"Temp Help\" onClick=\"help_client_code_validate_temp()\" size='10' disabled></td>");  //help_update_temp()
			...
			out.println("<input class='but_input' type='button' name='BUT_TXT_INQUARY_NO' value=\"Help\" onClick=\"help_button_inq()\">"); 
			...
			//Immovable, Movable Property divs
			out.println("<table align='center' width='100%' class='table'>"); 
			out.println("<tr>" );
			out.println("<td width=\"100%\"><DIV ID=e_label_property>  </DIV></td>");				
			out.println("</tr>" );
			out.println("</table>");
			out.println("<table align='center' width='100%' class='table'>"); 
			out.println("<tr>" );
			out.println("<td width=\"100%\"><DIV ID=e_header_property></DIV></td>");				
			out.println("</tr>" );
			out.println("</table>");
			
			out.println("<table align='center' width='100%' class='table'>"); 
			out.println("<tr>" );
			out.println("<td width=\"100%\"><DIV ID=e_txt_property></DIV></td>");				
			out.println("</tr></table>" );
			//out.println("</table>");
			
			out.println("<table align='center' width='100%' class='table'>"); 
			out.println("<tr>" );
			out.println("<td width=\"100%\"><DIV ID=e_add_but_property></DIV></td>");				
			out.println("</tr></table>" );
			//out.println("</table>");
			...
			//Owned property <div>s Corporate
			out.println("<table align='center' width='100%' class='table'>"); 
			//out.println("<tr>" );
			out.println("<tr><td width=\"100%\"><DIV ID=e_label_property_c>  </DIV></td></tr></table>");				
			//out.println("</tr></table>" );
			//out.println("</table>");
			
			out.println("<table align='center' width='100%' class='table'>"); 
			//out.println("<tr>" );
			out.println("<tr><td width=\"100%\"><DIV ID=e_header_property_c></DIV></td></tr></table>");				
			//out.println("</tr></table>" );
			//out.println("</table>");
			
			out.println("<table align='center' width='100%' class='table'>"); 
			//out.println("<tr>" );
			out.println("<tr><td width=\"100%\"><DIV ID=e_txt_property_c></DIV></td></tr></table>");				
			//out.println("</tr></table>" );
			//out.println("</table>");
			
			out.println("<table align='center' width='100%' class='table'>"); 
			out.println("<tr>" );
			out.println("<td width=\"100%\"><DIV ID=e_add_but_property_c>  </DIV></td>");				
			out.println("</tr></table>" );
			//out.println("</table>");
			...
			if  (m_screen.equals("G")){
				...
				out.println("<tr><td width='10%' align='center' ><input type=\"button\" style=\"width:140px\" class='mainbut' name=\"close2\" onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Next\");'  onclick='close_screen()' value=\"Proceed to Next Level\"></td></tr>");  
			...
			*/
			...
			out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' name=\"edit2\"  onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Edit\");'  onClick='load_screen_status(\"EDIT\")' value=\"Edit\"></td>");  
			out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' name=\"dact2\" onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Deactivate\");'  onClick='load_screen_status(\"DACT\")' value=\"De-activate\"></td>");  
			out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' name=\"ract2\" onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Reactivate\");'  onClick='load_screen_status(\"RACT\")' value=\"Re-activate\"></td>");  
			out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' name=\"temp2\"  onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Temporary\");' onClick='load_screen_status(\"TEMP\")' value=\"Temp\"></td>");  
			out.println("<td width='6%'></td>");  
			out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' name=\"save2\" onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Save\");'  onClick='save_window()' value=\"Save\"></td>");  
			out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' name=\"temp_save2\" onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Temporary Save\");'   onClick='save_window_temp()' value=\"Temp Save\"></td>");  
			...
			*/
			...
			/*out.println("<tr><td width='10%' align='center'><input type=\"button\" class='mainbut' name=\"but_new2\" onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"New\");'  onclick='load_screen_status(\"NEW\")' value=\"New\"></td>");  
			//out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Edit\");' name=\"edit2\"  onClick='load_screen_status(\"EDIT\")' value=\"Edit\"></td>");  // commented by udara 15-09-2014 
			...
			out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Deactivate\");' name=\"dact2\" onClick='load_screen_status(\"DACT\")' value=\"De-activate\" Disabled ></td>");  // Disabled by udara 15-09-2014
			out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Reactivate\");' name=\"ract2\" onClick='load_screen_status(\"RACT\")' value=\"Re-activate\" Disabled ></td>");  // Disabled by udara 15-09-2014 
			out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' name=\"temp2\"  onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Temporary\");' onClick='load_screen_status(\"TEMP\")' value=\"Temp\"></td>");  
			out.println("<td width='6%'></td>");  
			out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Save\");' name=\"save2\"  onClick='save_window()' value=\"Save\"></td>");  
			out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Temporary Save\");' name=\"temp_save2\"  onClick='save_window_temp()' value=\"Temp Save\"></td>");  
			out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Help\");' name=\"help2\" onClick='load_screen_status(\"HELP\")' value=\"Help\"></td>");  
			out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Cancel\");' name=\"cancel2\" onclick='clear_window()' value=\"Cancel\"></td>");  
			//out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Close\");' name=\"close3\" onclick='close_screen()' value=\"Close\"></td>");  
			out.println("<td width='*%' align='right' class='div_input'></td></tr>");  
			...
			//}
			if (!m_screen.equals("G")){
				out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' name=\"close2\" onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Close\");'  onclick='close_screen()' value=\"Close\"></td>");  
			}
			...
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box1'>System Administration - Creation Of Guarantor</td>"); 
			out.println("</tr></table>");
			//out.println("</table>");*/
