...
public class LAKDL_FA_OP_Save_invoice_adjust_approval extends HttpServlet {
  ...
  String reqstr;
	...
	public synchronized void  service(HttpServletRequest req, HttpServletResponse res)	throws IOException{
      ...
      String m_scr_name=(String)m_sn_methods.met_formdata(reqstr,"Hid_scr_name"); 
			...
			callstmt1=conn.prepareCall("BEGIN "+m_schema_name+".FA_CR_SAVE_INVO_ADJ_APPROVAL(:1,:2,:3,:4,:5); END;");
			...
			for(int i=0;i<m_num1;i++){
				...
				if(!m_action.equals("O")){
					callstmt1.setString(1,(String)m_sn_methods.met_formdata(reqstr,"TXT_ADJUSTMENT_NO_"+i+""));
					...
					callstmt1.setString(5,(String)m_sn_methods.met_formdata(reqstr,"TXT_ADJUST_TYPE"));
	   	...
	   	out.println("<HTML><HEAD>");
			...
			out.println("window.location.href='"+m_url+"/"+m_fschema_name+"FA_OP_display_invoice_adjust_approval';");
