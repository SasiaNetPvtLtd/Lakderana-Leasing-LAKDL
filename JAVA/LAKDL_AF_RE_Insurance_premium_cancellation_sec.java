...
public class LAKDL_AF_RE_Insurance_premium_cancellation_sec extends javax.servlet.http.HttpServlet { 
	...
	public void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			if(m_chksql.equals("main_page")){
					out.println("<HTML>"); 
					out.println("<HEAD>"); 
					out.println("<TITLE>Insurance Premium Cancellation-Security </TITLE>"); 
					out.println("</HEAD>"); 
					...
					out.println("      m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_Insurance_premium_cancellation_sec?chksql=details&status=\"+document.Form1.hid_status.value+\"&FINANCE_NO=\"+document.Form1.TXT_FIN_NO.value+\"&from_date=\"+m_from_date+\"&to_date=\"+m_to_date;"); 
					...
					out.println("			window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_RE_Insurance_premium_cancellation_sec?chksql=main_page';"); 
					out.println("		}"); 
					out.println("}"); 
					...
					out.println("   help_box.innerHTML=\" Insurance Premium Cancellation-Security  - \"+m_val;"); 
					out.println("}"); 
					out.println(""); 

					out.println("function load_roll_out_value(){");
					out.println("help_box.innerHTML=\" Insurance Premium Cancellation-Security  - \"+document.Form1.hid_status.value;"); 
					out.println("}"); 
				  ...
				  out.println("count=count+1;");
					...
					//out.println("		if(validate_data()){");	
					out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_RE_Insurance_premium_cancellation_save_sec';");  
				...
				out.println("}");	
					...
					out.println("</tr>"); 
					out.println("<tr>"); 
					out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Insurance Premium Cancellation-Security </td>"); 
					out.println("</tr>"); 
					out.println("<tr>"); 
					...
					rs=stmt.executeQuery(" "+ 								
									...
									" A.POLICY_NO,  "+ // 6
									" A.DEBIT_NOTE_NO "+ // 7
									" from "+m_schema_name+".AF_IS_PRO_ASET_INSUR_DETA_SEC a, "+m_schema_name+".AF_CO_PRO_INVOICE B "+
