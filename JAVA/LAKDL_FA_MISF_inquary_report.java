...
public class LAKDL_FA_MISF_inquary_report extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Inquary Report </TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"FA_MISF_inquary_report';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("	help_box.innerHTML=\"Inquary Report \";"); 
			out.println("}"); 
			...
			out.println(" m_sql = \"m_help_DIV_TXT_FACTOR_INQ_NO_sql\";"); 
			out.println(" m_criteria = document.Form1.TXT_INQ_CODE.value+\"@\";"); 
			...
			out.println("		document.Form1.TXT_INQ_CODE.value=oBj.valout[2];"); 
			out.println("}");
	  	...
	  	out.println("					}"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Inquary Report </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<table class='table' width='100%'  >"); 
			out.println("<tr>"); 
			out.println("<td width='15%' ><DIV id='DIV_TXT_INQ_CODE'  class=div_input><b>Inquiry No</b></DIV></td>"); 
			out.println("<td width='20%' ><input class='txt_input' type='text' name='TXT_INQ_CODE' maxlength='10' size='50' style='width:100' onblur=\"help_update()\" >"); 
