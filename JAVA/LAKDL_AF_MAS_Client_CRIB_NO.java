...
public class LAKDL_AF_MAS_Client_CRIB_NO extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>System Administration - CRIB No </TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("function show_realise_settle_report() {");
			out.println(" 	m_from_dd = document.Form1.TXT_FROM_DATE_DD.value ");
			out.println(" 	m_from_mm = document.Form1.TXT_FROM_DATE_MM.value ");
			out.println("		m_from_yy = document.Form1.TXT_FROM_DATE_YY.value ");
			...
			out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"FA_MISF_reports?chksql=LOAD_REALISE_SETTLE_REPORT&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&client_code=\"+document.Form1.TXT_CLIENT_CODE.value+\"&facility_no=\"+document.Form1.TXT_FACILITY_NO.value+\"&debtor_code=\"+document.Form1.TXT_DEBTOR_CODE.value+\"&branch_code=\"+document.Form1.TXT_BRANCH_CODE.value+\"&settle_mode=\"+document.Form1.TXT_SETTLEMENT_MODE.value;");
      ...
      out.println("function validate_data(){"); 
			...
			out.println("if(document.Form1.TXT_CRIB_NO.value==\"\"){  "); 
			out.println("DIV_TXT_CRIB_NO.style.color='red';");
			out.println("return false;"); 
			out.println("}"); 
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MAS_Client_CRIB_NO';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_MAS_Save_Client_CRIB_NO';");  
			...
			out.println("	help_box.innerHTML=\" System Administration - CRIB No \";"); 
			out.println("}"); 
	  	...
	  	out.println("					}"); 
			...
			out.println("<td width='*%' ><input class='txt_input' type='text' name='TXT_CLIENT_CODE' maxlength='10' size='50' style='width:100px' onblur=\"help_update()\" >"); 
			...
			//out.println("<table class='table' width='100%'  >"); 
			out.println("<tr>"); 
			out.println("<td width='15%' ><DIV id='DIV_TXT_CLIENT_NAME'  class=div_input>Client Name</DIV></td>"); 
			out.println("<td width='*%' ><input class='txt_input' type='text' name='TXT_CLIENT_NAME' maxlength='20' size='10' style='width:250px' disabled=true onblur=\"\">"); 
			out.println("</td>"); 
			//out.println("<td width='*%' align='left' ></td>");
			out.println("</tr>"); 
			//out.println("</table>");  
			//out.println("<table class='table' width='100%'  >"); 
			out.println("<tr>"); 
			out.println("<td width='15%' ><DIV id='DIV_TXT_CRIB_NO'  class=div_input>CRIB No *</DIV></td>"); 
			out.println("<td width='*%' ><input class='txt_input' type='text' name='TXT_CRIB_NO' maxlength='20' size='10' style='width:100px' onblur=\"\">"); 
			out.println("</td>"); 
			//out.println("<td width='*%' align='left' ></td>");
			out.println("</tr>"); 
			out.println("</table>");  
