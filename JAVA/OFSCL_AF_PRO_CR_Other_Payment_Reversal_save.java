...
public class OFSCL_AF_PRO_CR_Other_Payment_Reversal_save extends HttpServlet {
	...
	OFSCL_AF_CO_conn_methods m_sn_methods;
	...
	ServletOutputStream out;
		...
		try {
			...
			m_sn_methods = new OFSCL_AF_CO_conn_methods();
