...
//DEVELOPED BY UDARA SOMATHILAKE ON 13-05-2010 FOR OFSCL NOT SINHALA
...
public class LAKDL_AF_RE_NOT_fin_lease_sinhala extends javax.servlet.http.HttpServlet { 
...
*/
       ...
       */
				...
				// added by nuwan de silva on 01-09-2008---------------
					...
					//" AND  TO_DATE(A.ODI_DATE)<=TO_DATE(TO_CHAR(SYSDATE,'DD-MM-YYYY'),'DD-MM-YYYY') ");// this part comment by ns on 12-09-2011 NOT not picking the toal odi
					"");
      ...
      out.println("<tr><td width='60%' class='rep-body' style='{font:10px;text-align:left;}'>"+m_d_city_desc+".</td><td width='*%' class='rep-body' style='{font:10px;text-align:left;}'></td></tr>");
		  ...
		  out.println("<tr ><td width='70%' class='rep-body'  style='{font:10px;text-align:left;}'></td><td width='30%' class='rep-body'  style='{font:10px;text-align:left;}' ><b></td></tr>");//"+m_LAKDL_reg_no+"
			...
			out.println("<table border='0' width='100%' class='table'> ");	
			// Sinhala Letter font face-> aKandyNew
			out.println("<tr ><td width='*%' class='rep-body'  style='{font:10px;text-align:left;}'><b><font size=\"2\" face=\"aKandyNew\"><u>Äy`pØA§ w#p$@lÎ</u></font></b></td> <td width='*%' class='rep-body'  style='{font:10px;text-align:left;}'><b><font size=\"2\" face=\"aKandyNew\">bQq avsN ¿ÞM q#Ním</font></b></td> </tr>"); // Registered Post
			out.println("</table>");		
			out.println("<table border='0' width='100%' class='table'>"); 		
			out.println("<tr><td width='*%' class='rep-body' style='{font:10px;text-align:left;}'><font face=\"aKandyNew\">Øny - </font>"+m_Letter_date+"</td></tr>"); // date
			out.println("</table><br>");	
			out.println("<table border='0' width='100%' class='table'>"); 		
			...
			out.println("<table border='0' width='100%' class='table'> ");	
			out.println("<tr ><td width='*%' class='rep-body'  style='{font:10px;text-align:left;}'><br><font face=\"aKandyNew\">mhWmy`@zÎ,</font></td></tr>"); // Dear/Mr
			out.println("</table><br>");		
			...
			out.println("<tr ><td width='*%' class='rep-body'  style='{font:10px;text-align:left;}'><b><u><font face=\"aKandyNew\">up@L?z aAk      </font> "+m_facility_no+"  &nbsp;&nbsp; <font face=\"aKandyNew\">Øny - </font> :"+m_lease_date+" </u></b></td></tr>");
			out.println("</table><br>");		
			...
			*/
			...
			out.println("<p>");
			out.println(" ihñN sqhN ob ìâN aWsN ¿Ýmt @yÚÐ kL bÚ °ìä@mö µ< v`Ýk @gìM "+
