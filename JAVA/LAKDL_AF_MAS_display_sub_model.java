...
//SCREEN NAME:SYSTEM ADMINISTRATION - SUB MODEL
...
public class LAKDL_AF_MAS_display_sub_model extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>System Administration - Sub Models</TITLE>"); 
			out.println("</HEAD>"); 
			...
			//out.println("				new_window();");
			out.println("			}");
			out.println("		  else	if(data_vec.length > 0 && document.Form1.SCREEN_NAME.value!=\"NEW\"&& document.Form1.TXT_SUB_CODE.value !=''&& document.Form1.hid_help_status.value == 'H1' ){");
			...
			out.println("			}");
			out.println("		  else	if(data_vec.length == 0 && document.Form1.hid_help_status.value == 'H2' && document.Form1.TXT_MODEL_CODE.value !='' && document.Form1.SCREEN_NAME.value!=\"NEW\"  ){");
			//out.println("				alert('Invalid Code');");
			out.println("				help_button_1();");
			out.println("			}");
			out.println("		  else	if(data_vec.length == 0 && document.Form1.hid_help_status.value == 'H3' && document.Form1.TXT_COUNTRY_CODE.value !='' && document.Form1.SCREEN_NAME.value!=\"NEW\"  ){");
			...
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations1?chksql=m_prime_chk_LAKDL_AF_MAS_display_sub_model1&data_val=\"+obj.value;");
			out.println("else");
			...
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations1?chksql=m_prime_chk_LAKDL_AF_MAS_display_sub_model_desc&data_val=\"+obj.value;");
			out.println("else");
			out.println("if(document.Form1.hid_help_status.value == 'H2' && document.Form1.SCREEN_NAME.value!=\"RACT\") ");
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_model_creation&data_val=\"+obj.value+\"&ac_status=Y\";");
			out.println("else");
			out.println("if(document.Form1.hid_help_status.value == 'H2' && document.Form1.SCREEN_NAME.value==\"RACT\") ");
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_model_creation&data_val=\"+obj.value+\"&ac_status=N\";");
			out.println("else");
			...
			out.println("    document.Form1.TXT_SUB_CODE.value=data_vec[0];"); 
			...
			out.println("    document.Form1.TXT_OPTION_TYPE.value=data_vec[4];"); 
			out.println("    document.Form1.TXT_COUNTRY_CODE.value=data_vec[5];"); 
			...
			out.println("    document.Form1.TXT_MODEL_DESCRIPTION.value=data_vec[9];");
			out.println("}");
			...
			out.println("   document.Form1.TXT_ENGINE_CAPACITY.value='';");
			out.println("   document.Form1.TXT_ENGINE_CAPACITY.focus();");
			out.println("   }");
			out.println("}");
			...
			out.println("if(document.Form1.TXT_SUB_CODE.value==\"\"){  "); 
			out.println("DIV_TXT_SUB_CODE.style.color='red';");
			...
			out.println("   }");
			out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_MAS_save_sub_model';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MAS_display_sub_model';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("    m_help_message = \"m_help_msg_LAKDL_AF_MAS_display_sub_model\";"); 
			...
			out.println("help_box.innerHTML=\" System Administration - Sub Models - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" System Administration - Sub Models - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
			...
			out.println("document.Form1.TXT_MODEL_DESCRIPTION.disabled=true;"); 
			out.println("document.Form1.TXT_DESCRIPTION.disabled=true;"); 
			out.println("document.Form1.TXT_ENGINE_CAPACITY.disabled=true;"); 
			out.println("document.Form1.TXT_OPTION_TYPE.disabled=true;"); 
	  	...
	  	out.println("		}"); 
			...
			out.println("		if(document.Form1.hid_help_type.value==\"99\" ) {" ); 
			out.println("    document.Form1.TXT_SUB_CODE.value =''; ");
			out.println("    document.Form1.TXT_SUB_CODE.focus(); ");
			out.println("   }		"); 
			...
			out.println("    document.Form1.TXT_MODEL_DESCRIPTION.value=oBj.valout[3];"); 
			out.println("}"); 
			...
			out.println("    m_criteria = document.Form1.TXT_SUB_CODE.value+\"@\"+\"Y@\";"); 
			out.println("    } ");
			out.println("    else{");
			out.println("    m_criteria = document.Form1.TXT_SUB_CODE.value+\"@\"+\"N@\";}"); 
			out.println("    HelpBox('1','10','5');"); 
			out.println("}"); 
			...
			out.println("    m_sql = \"m_help_TXT_SUB_M_CODE_DESC_sql\";"); 
			...
			out.println("    document.Form1.TXT_SUB_CODE.value=oBj.valout[2];"); 
			out.println("    document.Form1.TXT_DESCRIPTION.value=oBj.valout[3];"); 
			out.println("    document.Form1.TXT_MODEL_CODE.value=oBj.valout[4];"); 
			out.println("    document.Form1.TXT_ENGINE_CAPACITY.value=oBj.valout[5];"); 
			out.println("    document.Form1.TXT_OPTION_TYPE.value=oBj.valout[6];"); 
			out.println("    document.Form1.TXT_COUNTRY_CODE.value=oBj.valout[7];"); 
			out.println("    document.Form1.TXT_YEAR_OF_MANUFACTURE.value=oBj.valout[8];"); 
			out.println("    document.Form1.TXT_DEFAULT_VALUE.value=oBj.valout[9];"); 
      out.println("    document.Form1.TXT_MODEL_DESCRIPTION.value=oBj.valout[10];"); 
			out.println("}"); 
			...
			out.println("    \"&Sql_in=\"+m_sql+\"&Start_in=\"+Start+"); 
			out.println("    \"&End_in=\"+End+\"&Crit_In=\"+m_criteria+"); 
			out.println("    \"&Hid_No=\"+Hid_No, oBj,\"dialogWidth:48em; dialogHeight:25em; center:yes; status:no\");"); 
			out.println("	"); 
			out.println("	if(oBj.valout[1] !=\" \"){"); 
			out.println("	if(oBj.valout[1] !=\"Close\"){"); 
			out.println("	if(oBj.valout[1]!=\"Prev\"){"); 
	  	...
	  	out.println("		}"); 
			...
			out.println("    m_sql = \"m_view_TXT_SUB_M_CODE_sql\";");
			out.println("    m_criteria = document.Form1.TXT_SUB_CODE.value+\"@\"+\"Y@\";"); 
			out.println("    HelpView('1',50,'0');"); 
			out.println("}"); 
			
			out.println("function load_model(val){");	//Added by Chandana on 15/11/2007
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_display_model_creation?CLSTATUS=B&code=\"+document.Form1.TXT_MODEL_CODE.value+\"\";"); 
			out.println("window.open(m_url,'displayWindow32','left=50,top=60,width=950,height=590,toolbar=0,location=0,directories=0,status=0,menuBar=0,scrollBars=1,resizable=1,fullscreen=0');"); 
		 	out.println("}");
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>System Administration - Sub Models </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<td width='30%' ><DIV id='DIV_TXT_SUB_CODE'  class=div_input>Sub Model Code *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_SUB_CODE' maxlength='20' size='20' onblur=\"assign_help_status('H1'),makeRequest(document.Form1.TXT_SUB_CODE)\">"); 
			...
			out.println("<td width='30%' ><DIV id='DIV_TXT_DESCRIPTION'  class=div_input>Sub Model Description *</DIV></td>");//assign_help_status('H_desc'),makeRequest(document.Form1.TXT_DESCRIPTION) 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_DESCRIPTION' maxlength='100' onblur=\"\"  size='60'></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 


			out.println("<td width='30%' ><DIV id='DIV_TXT_MODEL_CODE'  class=div_input>Model Code *</DIV></td>"); 
			out.println("<td width='30%' ><input class='txt_input' type='text' name='TXT_MODEL_CODE' maxlength='10' size='10' onblur=\"assign_help_status('H2'),makeRequest(document.Form1.TXT_MODEL_CODE)\" >"); 
			out.println("<input class='but_input' type='button' name='BUT_TXT_MODEL_CODE' value=\"Help\" onClick=\"help_button_1()\">"); 
			out.println("<input class='but_input' style='width:70' type='button' name='MODEL_LINK_BUT' value=\"Create New\" onClick=\"load_model('A')\"></td>"); /*Added by Chandana on 15/11/2007*/
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 

      out.println("<td width='30%' ><DIV id='DIV_TXT_MODEL_DESCRIPTION'  class=div_input>Model Description</DIV></td>"); 
			out.println("<td width='30%' ><input class='txt_input' type='text' name='TXT_MODEL_DESCRIPTION' maxlength='100' size='60' onblur=\"\"></td>"); /*Added by Chandana on 15/11/2007*/
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 
			...
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_ENGINE_CAPACITY' maxlength='5' size='6' onblur='format_noobject_nodecimal1(this)' value='0'></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 

			out.println("<td width='30%' ><DIV id='DIV_TXT_OPTION_TYPE'  class=div_input>Option Type *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_OPTION_TYPE' maxlength='10' size='10'></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 

			out.println("<td width='30%' ><DIV id='DIV_TXT_COUNTRY_CODE'  class=div_input>Country Code *</DIV></td>"); 
			out.println("<td width='30%' ><input class='txt_input' type='text' name='TXT_COUNTRY_CODE' maxlength='10' size='10'onblur=\"assign_help_status('H3'),makeRequest(document.Form1.TXT_COUNTRY_CODE)\" >"); 
