...
public class LAKDL_AF_CR_PRO_Enter_Deletion_letter_process extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res) { 
		...
		//	String m_html_client_url = m_sn_methods.html_client_url;
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE> Deletion Letter Process </TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("}");
				...
				out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_CR_PRO_Enter_Deletion_letter_process?chksql=main_page';"); 
				out.println("		}"); 
				out.println("}"); 
				...
				out.println("help_box.innerHTML=\" Deletion Letter Process - \"+m_val;"); 
				out.println("}"); 
		
				out.println("function load_roll_out_value(){");
				out.println("help_box.innerHTML=\" Deletion Letter Process  \";"); 
				out.println("}"); 
			...
			out.println("}"); 
					...
					*/
					...
					out.println("    HelpBox('1','10','0',Crit,'m_help_ClientSql_Receipt','2');");
					out.println("}");
					...
					*/
					...
					out.println("		   document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_CR_PRO_Enter_Deletion_letter_process_save';");  
					...
					out.println("</tr>"); 
					out.println("<tr>"); 
					out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Deletion Letter Process</td>"); 
					out.println("</tr>"); 
					out.println("<tr>"); 
