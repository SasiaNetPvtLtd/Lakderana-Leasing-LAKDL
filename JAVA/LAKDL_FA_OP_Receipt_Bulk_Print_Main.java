...
public class LAKDL_FA_OP_Receipt_Bulk_Print_Main extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Receipt Bulk Print </TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("function validate_date(){");  // Modified by Chatura Jayawardena
			out.println(" 	m_to_dd = document.Form1.TXT_TO_DATE_DD; ");
			out.println(" 	m_to_mm = document.Form1.TXT_TO_DATE_MM; ");
			out.println(" 	m_to_yy = document.Form1.TXT_TO_DATE_YY; ");
			out.println(" 	m_from_dd = document.Form1.TXT_FROM_DATE_DD; ");
			out.println(" 	m_from_mm = document.Form1.TXT_FROM_DATE_MM;");
			out.println(" 	m_from_yy = document.Form1.TXT_FROM_DATE_YY; ");
      out.println(" 	  if(m_from_dd.value  != '' && m_from_mm.value  !='' && m_from_yy.value  !=''  ) { ");
			out.println(" 	  if(m_to_dd.value  != '' && m_to_mm.value  !='' && m_to_yy.value  !=''  ) { ");
			out.println("  	     if(checkMonthLength(m_from_dd,m_from_mm,m_from_yy) && checkMonthLength(m_to_dd,m_to_mm,m_to_yy)){  "); 
      ...
      out.println("			else {");
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"FA_OP_Receipt_Bulk_Print_Main?chksql=main_page';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("	help_box.innerHTML=\" Receipt Bulk Print - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\" Receipt Bulk Print \";"); 
			out.println("}"); 
	  	...
	  	out.println("					}"); 
			...
			out.println(" 	m_from_date = m_from_dd+\"-\"+m_from_mm+\"-\"+m_from_yy; ");
			out.println("		if(validate_date()) {");		
		  out.println("   m_url=\""+m_class_url+"/"+m_fschema_name+"FA_OP_Bulk_Print_Main?chksql=RECEIPT&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&print_type=\"+val+\"\";");
		  ...
		  out.println("}");
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Receipt Bulk Print </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<input class=\"txt_input5\" type=\"text\" name=TXT_TO_DATE_YY maxlength=\"4\" size=\"4\" >&nbsp;&nbsp;&nbsp;&nbsp; <input class='but_input' type='button' name='BUT_VIEW' value=\"Pending\" onClick=\"bulk_print('Pending')\">");	
			//out.println("<input class=\"txt_input5\" type=\"text\" name=TXT_TO_DATE_YY maxlength=\"4\" size=\"4\" >&nbsp;&nbsp;&nbsp;&nbsp; <input class='but_input' type='button' name='BUT_VIEW' value=\"Pending\" onClick=\"bulk_print('PEN')\">&nbsp;&nbsp;<input class='but_input' type='button' name='BUT_VIEW' value=\" All \" onClick=\"bulk_print('ALL')\">");	
			out.println("</td> ");
