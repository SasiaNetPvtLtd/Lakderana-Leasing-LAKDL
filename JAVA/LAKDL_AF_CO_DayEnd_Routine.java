...
public class LAKDL_AF_CO_DayEnd_Routine extends javax.servlet.http.HttpServlet {
  ...
  public synchronized void service(HttpServletRequest req, HttpServletResponse res)
	{
      ...
      //conn = DriverManager.getConnection("jdbc:oracle:thin:@147.120.40.1:1521:DN10G", "system", "sys123");
        ...
        out.println("}");
				...
				out.println(" document.Form1.LFROM_DAY.value   =data[0]");
				out.println(" document.Form1.LFROM_MONTH.value =data[1]");
				out.println(" document.Form1.LFROM_YEAR.value  =data[2]");
				out.println(" document.Form1.LAST_USER.value   =data[3]");
				out.println(" document.Form1.FROM_DAY.value  =data[4]");
				out.println(" document.Form1.FROM_MONTH.value=data[5]");
				out.println(" document.Form1.FROM_YEAR.value =data[6]");
				out.println(" document.Form1.LOG_USER.value    =data[7]");
				out.println("}");	
        ...
        out.println(" }");
	      out.println("}");
				...
				*/
				...
				//out.println("  Form1.reset()   ");
			  out.println("window.location.href='"+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CO_DayEnd_Routine?chksql=main_page'");
			  out.println(" }  ");
				out.println("}");
			  ...
			  out.println("help_box.innerHTML=\"Administration - Day End Routine - \"+m_val;"); 
			  out.println("}");
				//end of MM
        ...
        out.println(" url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CO_XMLFile?chksql=get_dayend_date\";");
        ...
        out.println(" }");
	      out.println("}");
				...
				out.println("<input type=hidden name=\"Hid_scr_name\" value=\"AF_CO_DAYEND\">");
        ...
        //out.println("<td>&nbsp;</td>");
			  ...
			  out.println("<tr class=tr_input>");
				out.println("<td >Last Day End Date</td>");
				out.println("<td><input name=\"LFROM_DAY\"   type=\"text\" maxlength=\"2\" class=\"txt_input\" style=\"width:25px;\" onchange=chkstartdate(document.Form1.LFROM_DAY,document.Form1.FROM_MONTH,document.Form1.LFROM_YEAR) disabled> ");
				...
				out.println("<td >Last Day End User</td>");
				out.println("<td><input name=\"LAST_USER\"   type=\"text\" maxlength=\"10\" class=\"txt_input\" onchange=chkstartdate(document.Form1.LTO_DAY,document.Form1.LTO_MONTH,document.Form1.LTO_YEAR) disabled> ");
				out.println("</td>");
				out.println("<td ></td>");
				...
				out.println("<tr class=tr_input>");
				out.println("<td id=fod>Day End Date</td>");
				out.println("<td><input name=\"FROM_DAY\"   type=\"text\" maxlength=\"2\" class=\"txt_input\" style=\"width:25px;\" onchange=chkstartdate(document.Form1.FROM_DAY,document.Form1.FROM_MONTH,document.Form1.FROM_YEAR) disabled> ");
				out.println("    <input name=\"FROM_MONTH\" type=\"text\" maxlength=\"2\" class=\"txt_input\" style=\"width:25px;\" onchange=chkstartdate(document.Form1.FROM_DAY,document.Form1.FROM_MONTH,document.Form1.FROM_YEAR) disabled> ");
				out.println("    <input name=\"FROM_YEAR\"  type=\"text\" maxlength=\"4\" class=\"txt_input\" style=\"width:40px;\" onchange=chkstartdate(document.Form1.FROM_DAY,document.Form1.FROM_MONTH,document.Form1.FROM_YEAR) disabled> ");
				out.println("</td>");//out.println("<input name=\"CLIENT_TYPE\" type=\"text\" maxlength=\"10\" class=\"txt_input\" ></td>");
				out.println("<td id=tod>Login User</td>");
				out.println("<td><input name=\"LOG_USER\"   type=\"text\" maxlength=\"10\" class=\"txt_input\" onchange=chkstartdate(document.Form1.TO_DAY,document.Form1.TO_MONTH,document.Form1.TO_YEAR) disabled> ");
				out.println("</td>");
				out.println("<td ><input type=button name=b_submit value=\"Run\" class=mainbut onclick=befor_submit();></td>");//onMouseOver='load_roll_value(\"Save\");' onmouseout='load_roll_value(document.Form1.OPTION_DESC.value);'
        //out.println("<input name=\"LEAD_SOURCE_CATEGORY\" type=\"text\" maxlength=\"10\" id=\"txtAddress1\" class=\"txt_input\" style=\"width:150px;\" >");
				out.println("</tr>");
				
				//out.println("<tr class=tr_input>");
				//out.println("<td >Exceptions</td>");
				//out.println("<td colspan=3 id=exc></td>");
			  //out.println("</tr>");
