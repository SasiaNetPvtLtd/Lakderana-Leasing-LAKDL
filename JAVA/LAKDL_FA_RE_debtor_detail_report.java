...
public class LAKDL_FA_RE_debtor_detail_report extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Operation Reports - Debtor Statement </TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"FA_RE_PRO_rpt_debtor_statement?chksql=LOAD_DEBTOR_STATEMENT_REPORT&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&client_code=\"+document.Form1.TXT_CLIENT_CODE.value+\"&facility_no=\"+document.Form1.TXT_FACILITY_NO.value+\"&debtor_code=\"+document.Form1.TXT_DEBTOR_CODE.value;");
			...
			out.println("    m_help_message = \"m_help_msg_LAKDL_FA_OP_DEBTOR_STATEMENT_REPORT\";"); 
			...
			out.println("	help_box.innerHTML=\" Operation Reports - Debtor Statement  - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\" Operation Reports - Debtor Statement  \";"); 
			out.println("}"); 
	  	...
	  	out.println("					}"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Operation Reports - Debtor Statement </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<td width='17%' ><input class='txt_input' type='text' name='TXT_DEBTOR_CODE' maxlength='10' size='10' style='width:100' onblur=\"help_update_debtor()\" tabindex=\"1\">"); 
			out.println("<input class='but_input' type='button' name='BUT_DEBTOR_MAIN' value=\"Help\" onClick=\"help_update_debtor()\"></td>");
			out.println("<td width='*%' align='left' ><input class='but_input' type='button' name='BUT_DETAILS' value=\"Show\" onClick=\"makeRequest_detail()\"  ></td>");
			out.println("</tr>"); 
			out.println("</table>");
			out.println("<br>"); 
