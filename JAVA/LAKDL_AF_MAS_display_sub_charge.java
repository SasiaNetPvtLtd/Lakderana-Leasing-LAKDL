...
//--
//SCREEN NAME:SYSTEM ADMINISTRATION - SUB CHARGE
//CREATED BY:
//DATE/TIME:
//NOTES:
...
public class LAKDL_AF_MAS_display_sub_charge extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			//String m_type_code =(String) m_sn_methods.met_formdata(reqstr,"txt_type_code"); 
		
				
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>System Administration - Sub Charges</TITLE>"); 
			out.println("</HEAD>"); 
			...
			//out.println("alert('Selected Sub Type code is incorrect,use help...!')");
			...
			//out.println("alert('Entered Type Code is Wrong.....!');"); 
			//out.println("document.Form1.TXT_TYPE_CODE.value='';");
			out.println("	}");
			out.println("}");
		  ...
		  out.println("		}"); 
			...
			out.println("		}");
			out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_MAS_save_sub_charge';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MAS_display_sub_charge';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("help_box.innerHTML=\" System Administration - Sub Charges - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" System Administration - Sub Charges - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
			...
			out.println("document.Form1.TXT_MAINTENANCE_STATUS.disabled=true;"); 
			out.println("document.Form1.BUT_TYPE_CODE.disabled=true;"); 
			out.println("document.Form1.TXT_CHARGE_TYPE.disabled=true;"); 
			out.println("document.Form1.TXT_ACC_TYPE.disabled=true;");
	  	...
	  	out.println("		}"); 
			...
			out.println("    } ");
			out.println("    else{");
			out.println("    m_criteria = document.Form1.TXT_SUB_TYPE_CODE.value+\"@\"+\"N@\";}"); 
			out.println("    HelpBox('1','10','0');"); 
			out.println("}"); 

			out.println("function help_update_value_assign_99() {"); 
			out.println("    document.Form1.TXT_SUB_TYPE_CODE.value=oBj.valout[2];"); 
			out.println("    document.Form1.TXT_TYPE_CODE.value=oBj.valout[3];"); 
			...
			out.println("    document.Form1.TXT_MAINTENANCE_STATUS.value=oBj.valout[6];"); 
			out.println("    document.Form1.TXT_CHARGE_TYPE.value=oBj.valout[7];"); 
			out.println("    document.Form1.TXT_ACC_TYPE.value=oBj.valout[8];");
			out.println("}"); 
	  	...
	  	out.println("		}"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>System Administration - Sub Charges</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<tr >"); 
			out.println("<td width='30%' ><DIV id='DIV_TXT_SUB_TYPE_CODE'  class=div_input>Sub Type Code *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_SUB_TYPE_CODE' maxlength='10' size='10' onblur=\"assig('t1'),makeRequest(document.Form1.TXT_SUB_TYPE_CODE)\">"); 
			out.println("<input class='but_input' type='button' name='BUT_HELP_MAIN' value=\"Help\" onClick=\"help_update()\" disabled></td>"); 
			//out.println("<td input type='hidden' name='hid_1' value='1'></TD>"); 
			out.println("<td width='*%'></td>"); 
  		out.println("</tr>"); 
			
			out.println("<tr>"); 
			out.println("<td width='30%' ><DIV id='DIV_TXT_TYPE_CODE'  class=div_input>Type Code *</DIV></td>"); 
			out.println("<td width='30%' ><input class='txt_input' type='text' name='TXT_TYPE_CODE' maxlength='10' size='10' onblur=\"assig('t2'),makeRequest1(document.Form1.TXT_TYPE_CODE)\">"); 
			out.println("<input class='but_input' type='button' name='BUT_TYPE_CODE' value=\"Help\" onClick=\"help_button_2()\"></td>"); 
			//out.println("<td input type='hidden' name='hid_2' value='2'></TD>"); 
			out.println("<td width='*%'></td>"); 
			...
			out.println("<td width='30%' ><DIV id='DIV_TXT_DESCRIPTION'  class=div_input>Description *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_DESCRIPTION' maxlength='50' size='20'></td>");  //modified the maxlength20 to 50 nuwan de silva 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			...
			out.println("<tr >"); 
			out.println("<td width='30%' >Maintenance Status</td>"); 
			out.println("<td width='40%' ><select class='txt_input' type='text' name='TXT_MAINTENANCE_STATUS' maxlength='1' size='1'>");  
			out.println("<option value='N' selected>No</option>");			
			out.println("<option value='Y'>Yes</option>");		
			out.println("</select>");
			out.println("</td>");
			...
			//____ added by nuwan de silva on 04-12-2007_______________________________________________________________________
			out.println("<tr >"); 
			out.println("<td width='30%' >Charge Type</td>"); 
			out.println("<td width='40%' ><select class='txt_input' type='text' name='TXT_CHARGE_TYPE' maxlength='1' size='1'>");  
			out.println("<option value='AMO'         >Amortised</option>");			
			out.println("<option value='INV' selected >Upfront</option>");	
		    out.println("<option value='DIO'  >Display Only</option>"); // added by udara on 15-03-2012
			out.println("<option value='EXO'  >Expense Only</option>"); // added by udara on 15-03-2012
			out.println("</select>");
			out.println("</td>");
			out.println("<td width='*%'></td>"); 
			out.println("</tr>");
			...
			//____ added by Chandana on 08-01-2008_______________________________________________________________________
			out.println("<tr >"); 
			out.println("<td width='30%' >Account Type</td>"); 
			out.println("<td width='40%' ><select class='txt_input' type='text' name='TXT_ACC_TYPE' maxlength='1' size='1'>");  
			out.println("<option value='I'         >Income</option>");			
			out.println("<option value='L' selected >Liability</option>");	
			out.println("<option value='D'  >Display Only</option>"); // added by udara on 15-03-2012
			out.println("<option value='E'  >Expense Only</option>"); // added by udara on 15-03-2012
			out.println("</select>");
			out.println("</td>");
			out.println("<td width='*%'></td>"); 
			out.println("</tr>");
