...
public class LAKDL_AF_MISF_display_application_process_report extends javax.servlet.http.HttpServlet { 
...
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!	
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MISF_display_application_process_report?chksql=main_page';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("help_box.innerHTML=\"  Application Process Report - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
		  ...
		  out.println("function view() {"); 
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_display_application_process_report1?chksql=MAIN&client_code=\"+document.Form1.TXT_CLIENT_CODE.value+\"&application_no=\"+document.Form1.TXT_APPLICATION_NO.value+\"\";");
			...
			out.println("    m_criteria = document.Form1.TXT_APPLICATION_NO.value+\"@\"+document.Form1.TXT_CLIENT_CODE.value+\"@\"+\"ACTIVATED@\";"); 
			out.println("    HelpBox('1','10','0');"); 
			out.println("}");
...
//-----------------------------------------------------------------------------------------------------------------------
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Application Process Report</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
