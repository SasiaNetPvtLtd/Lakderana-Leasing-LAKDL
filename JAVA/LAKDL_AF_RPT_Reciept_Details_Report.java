...
//NOTES:
//URL:https://dev-lakdl.sasianet.com:/myserver/servlet/LAKDL_AF_RPT_Reciept_Details_Report?chksql=MAIN&
...
public class LAKDL_AF_RPT_Reciept_Details_Report extends javax.servlet.http.HttpServlet { 
...
public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
      ...
      if(m_screen_type.trim().equals("main_page1")){	
	  	...
	  	out.println("		}"); 
			...
			out.println("	 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RPT_Reciept_Details_Report?chksql=MAIN&PURCH_ORD_NO=\"+document.Form1.TXT_RECIEPT_NO.value+\"&from_date=\"+document.Form1.hid_from_date.value+\"&to_date=\"+document.Form1.hid_to_date.value+\" \";");
      ...
      out.println("</table>");
  		...
  		out.println("<tr>"); 
			out.println("<td width='20%' ><DIV id='DIV_TXT_RECIEPT_NO'  class=div_input>Reciept No </DIV></td>"); 
			...
			out.println("<tr><td align='left' class='pdn_txtpos2' style='height: 18px'>Reciept Details Report</td></tr>"); 
			out.println("</table>");  
			out.println("</table>");  
			out.println("</BR>");
			out.println("</BR>");
			...
			out.println("<td width='12%' class='txt_report_column'>RECIEPT NO</td>"); 
			out.println("<td width='10%' class='txt_report_column'>EFF VAL DATE</td>"); 
			...
			out.println("<td width='10%' class='txt_report_column'>RECIEPT AMOUNT</td>"); 
			out.println("<td width='10%' class='txt_report_column'>EXCHANGE RATE</td>"); 
			out.println("<td width='10%' class='txt_report_column'>REP CURR AMOUNT</td>"); 
			out.println("<td width='10%' class='txt_report_column'>SETTLE MODE</td>"); 
			...
			out.println("<td width='10%' class='txt_report_column'>BRANCH_CODE</td>"); 
			out.println("<td width='10%' class='txt_report_column'>ACCOUNT NO</td>"); 
