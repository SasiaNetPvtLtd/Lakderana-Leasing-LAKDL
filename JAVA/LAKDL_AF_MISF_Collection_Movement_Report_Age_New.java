...
public class LAKDL_AF_MISF_Collection_Movement_Report_Age_New extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
      ...
      out.println("</body>"); 
		...
		else if(m_chksql.equals("print_report_user_new")){		
	  ...
	  String m_prev_month="",m_curr_month="",m_curr_date="",m_Letter_date="",m_prev_date="",m_termi_status="";
		...
		//out.println(
		  ...
		  boolean more2=rs.next();
			...
			m_age_old=rs.getInt(14);
			m_amount_old=rs.getDouble(12);
			m_amount_cap_old=rs.getDouble(13);
			
			
			m_agr_status=rs.getString(16); //added by ns 30-09-2009
			m_termi_status = rs.getString(17);
			
		if(!m_termi_status.equals("1")){
			if ( m_age <=0 ){
		  ...
		  m_age_6_count=m_age_6_count+1;
			...
			if(m_agr_status.equals("OLD") && !m_termi_status.equals("2")){
			if ( m_age_old <=0 ){
		  ...
		  out.println("<HTML>"); 
			...
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Collection_Movement_Report_Age_New?chksql=drill_down_details&age=\"+m_age+\"&user_id=\"+m_user_id;"); 
			out.println("window.open(m_url);");	
			out.println("}");	
      ...
      out.println("</tr>");
			...
			int m_total_count=m_age_1_count+m_age_2_count+m_age_3_count+m_age_4_5_count+m_age_6_count;
			double m_age_tot_amount=m_age_1_m_amount+m_age_2_m_amount+m_age_3_m_amount+m_age_4_5_m_amount+m_age_6_m_amount;
			//Current Month -------------------------------------------------------------------------------
			out.println("<tr>");
		  ...
		  out.println("</tr>");
			...
			int m_total_count_old=m_age_1_count_old+m_age_2_count_old+m_age_3_count_old+m_age_4_5_count_old+m_age_6_count_old;
			double m_age_tot_amount_old=m_age_1_m_amount_old+m_age_2_m_amount_old+m_age_3_m_amount_old+m_age_4_5_m_amount_old+m_age_6_m_amount_old;
		  ...
		  double m_tot_age_m_amount_cap=m_age_1_m_amount_cap+m_age_2_m_amount_cap+m_age_3_m_amount_cap+m_age_4_5_m_amount_cap+m_age_6_m_amount_cap;
      //double m_tot_age_m_amount_cap=m_age_0_m_amount_cap+m_age_1_m_amount_cap+m_age_2_m_amount_cap+m_age_3_m_amount_cap+m_age_4_5_m_amount_cap+m_age_6_m_amount_cap;
		  ...
		  out.println("</tr>");
			...
			out.println("<td bgcolor='lightgrey' width='10%' STYLE='{font:  8pt  arial; text-align:right;}' class='rep-body' align='center'>&nbsp;</td>");
		  out.println("</tr>");			
		 double m_tot_age_m_amount_cap_old=m_age_1_m_amount_cap_old+m_age_2_m_amount_cap_old+m_age_3_m_amount_cap_old+m_age_4_5_m_amount_cap_old+m_age_6_m_amount_cap_old;
    ...
    out.println("</table >"); 
	  ...
	  String m_officer="";
		String m_sub_team_id="";
	  String m_prev_month="",m_curr_month="",m_curr_date="",m_Letter_date="",m_prev_date="",m_agr_status="",m_termi_status="";
    ...
    out.println("</table >"); 
	  ...
	  String m_prev_month="",m_curr_month="",m_curr_date="",m_Letter_date="",m_prev_date="",m_termi_status="";
  	  ...
  	  out.println("<HTML>"); 
		  ...
		  boolean more2=rs.next();
			...
			double m_grand_amount_total=0,m_grand_amount_total_month_0=0,m_grand_amount_total_month_1=0,m_grand_amount_total_month_2=0,m_grand_amount_total_month_3=0,m_grand_amount_total_month_4_5=0,m_grand_amount_total_month_6=0;
			double m_grand_amount_total_old=0,m_grand_amount_total_old_month_0=0,m_grand_amount_total_old_month_1=0,m_grand_amount_total_old_month_2=0,m_grand_amount_total_old_month_3=0,m_grand_amount_total_old_month_4_5=0,m_grand_amount_total_old_month_6=0;
			int m_grand_count_total_old=0,m_grand_count_total_month_0_old=0,m_grand_count_total_month_1_old=0,m_grand_count_total_month_2_old=0,m_grand_count_total_month_3_old=0,m_grand_count_total_month_4_5_old=0,m_grand_count_total_month_6_old=0;
			double m_grand_count_total_rate=0,m_grand_amont_total_rate=0;
			double m_tot_age_grand_m_amount_cap=0,m_age_0_grand_m_amount_cap=0,m_age_1_grand_m_amount_cap=0,m_age_2_grand_m_amount_cap=0,m_age_3_grand_m_amount_cap=0,m_age_4_5_grand_m_amount_cap=0,m_age_6_grand_m_amount_cap=0;
			double m_grand_amount_tot_rate=0,m_tot_age_grand_m_amount_cap_old=0,m_age_0_grand_m_amount_cap_old=0,m_age_1_grand_m_amount_cap_old=0,m_age_2_grand_m_amount_cap_old=0,m_age_3_grand_m_amount_cap_old=0,m_age_4_5_grand_m_amount_cap_old=0,m_age_6_grand_m_amount_cap_old=0;
			String m_agr_status="";
      ...
      out.println("</tr>");
			*/
			...
			int m_total_count=m_age_0_count+m_age_1_count+m_age_2_count+m_age_3_count+m_age_4_5_count+m_age_6_count;
			double m_age_tot_amount=m_age_0_m_amount+m_age_1_m_amount+m_age_2_m_amount+m_age_3_m_amount+m_age_4_5_m_amount+m_age_6_m_amount;
			...
			out.println("<td width='90%' STYLE='{font:  8pt bold arial; text-align:center;}' class='rep-body' align='center' colspan=9 bgcolor='#FFFFCC' ><b>Rental Movement</td>");
			out.println("</tr>");
		  ...
		  out.println("<td width='10%' STYLE='{font:  8pt  arial; text-align:right;}' class='rep-body' bgcolor='#90EE90' >"+m_total_count+"</td>");
			...
			out.println("<td width='20%' STYLE='{font:  8pt bold arial; text-align:center;}' class='rep-body' align='center'>&nbsp;</td>");
			out.println("<td width='10%' STYLE='{font:  8pt bold arial; text-align:center;}' class='rep-body' align='center'>&nbsp;</td>");
			out.println("<td width='10%' STYLE='{font:  8pt  arial; text-align:right;}' class='rep-body' >"+nf.format(m_age_0_m_amount)+"</td>");
		  ...
		  out.println("</tr>");			
			...
			*/
			...
			out.println("<td width='90%' STYLE='{font:  8pt bold arial; text-align:center;}' class='rep-body' align='center' colspan=9 bgcolor='#FFFFCC' ><b>Capital Movement</td>");
			out.println("</tr>");
     ...
     //---28-04-2009
		  ...
		  out.println("<td  bgcolor='lightgrey' width='10%' STYLE='{font:  8pt  arial; text-align:right;}' class='rep-body' align='center'>&nbsp;</td>");			
			...
			m_grand_count_total     = m_grand_count_total_month_0+m_grand_count_total_month_1+m_grand_count_total_month_2+m_grand_count_total_month_3+m_grand_count_total_month_4_5+m_grand_count_total_month_6;
			m_grand_count_total_old = m_grand_count_total_month_0_old + m_grand_count_total_month_1_old + m_grand_count_total_month_2_old+ m_grand_count_total_month_3_old + m_grand_count_total_month_4_5_old+m_grand_count_total_month_6_old;
			...
			m_grand_amount_total_old = m_grand_amount_total_old_month_0+m_grand_amount_total_old_month_1+m_grand_amount_total_old_month_2+m_grand_amount_total_old_month_3+m_grand_amount_total_old_month_4_5+m_grand_amount_total_old_month_6;
			m_grand_amount_total     = m_grand_amount_total_month_0+m_grand_amount_total_month_1+m_grand_amount_total_month_2+m_grand_amount_total_month_3+m_grand_amount_total_month_4_5+m_grand_amount_total_month_6;
			...
			m_tot_age_grand_m_amount_cap     = m_age_0_grand_m_amount_cap+m_age_1_grand_m_amount_cap+m_age_2_grand_m_amount_cap+m_age_3_grand_m_amount_cap+m_age_4_5_grand_m_amount_cap+m_age_6_grand_m_amount_cap;
			m_tot_age_grand_m_amount_cap_old = m_age_0_grand_m_amount_cap_old+m_age_1_grand_m_amount_cap_old+m_age_2_grand_m_amount_cap_old+m_age_3_grand_m_amount_cap_old+m_age_4_5_grand_m_amount_cap_old+m_age_6_grand_m_amount_cap_old;
        ...
        out.println("<table border='1' width='100%' class='table' cellspacing='0' >"); 	
			  ...
			  out.println("<td width='90%' STYLE='{font:  8pt bold arial; text-align:center;}' class='rep-body' align='center' colspan=10 bgcolor='#FFFFCC' ><b>Rental Movement</td>");
			  out.println("</tr>");	
			  ...
			  out.println("<td width='10%' STYLE='{font:  8pt  arial; text-align:right;}' class='rep-body'  align='center'>&nbsp;</td>");
				...
				out.println("<tr >");
				out.println("<td bgcolor='lightgrey' colspan=10 width='20%' STYLE='{font:  8pt bold arial; text-align:center;}' class='rep-body' align='center'>&nbsp;</td>");
			  out.println("</tr>");		
    ...
    out.println("</table >"); 
	  ...
	  String m_prev_month="",m_curr_month="",m_curr_date="",m_Letter_date="",m_prev_date="",m_termi_status="";
  	  ...
  	  out.println("<HTML>"); 
			...
			out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Collection_Movement_Report_Age_New?chksql=print_report_sub_team&date=\"+m_date+\"&sub_team_id=\"+m_sub_team;"); 
			out.println("window.open(m_url);");	
			out.println("}");	
...
//			" FROM "+m_schema_name+".af_re_tbd_col_movement_rpt_age a "+
      ...
      //t.println("</tr>");
			...
			m_total_count=m_age_0_count+m_age_1_count+m_age_2_count+m_age_3_count+m_age_4_5_count+m_age_6_count;
			m_age_tot_amount=m_age_0_m_amount+m_age_1_m_amount+m_age_2_m_amount+m_age_3_m_amount+m_age_4_5_m_amount+m_age_6_m_amount;
    ...
    out.println("</table >"); 
	  ...
	  String m_officer="";
		String m_sub_team_id="";
	  String m_prev_month="",m_curr_month="",m_curr_date="",m_Letter_date="",m_prev_date="";
  	  ...
  	  out.println("<HTML>"); 
			...
			out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Collection_Movement_Report_Age_New?chksql=print_report_team&date=\"+m_date+\"&team_id=\"+m_team_id;"); 
			out.println("window.open(m_url);");	
			out.println("}");	
			...
			" AND a.ent_user='"+m_username+"' ORDER BY a.team_id,a.sub_team_id,A.collection_officer ");
    ...
    out.println("</table >"); 
   ...
   else if(m_chksql.equals("print_report_all_new")){		
	  ...
	  String m_prev_month="",m_curr_month="",m_curr_date="",m_Letter_date="",m_prev_date="",m_termi_status="";
  	  ...
  	  out.println("<HTML>"); 
		  ...
		  boolean more2=rs.next();
			...
			double m_age_4_5_m_amount=0,m_age_4_5_m_amount_cap=0;
			double m_age_4_5_m_amount_old=0,m_age_4_5_m_amount_cap_old=0;
			String m_collector="",m_collector_name="",m_agr_status="";
			int m_total_count=0;
			int m_total_count_old=0;
			double m_age_tot_amount=0;
			double m_age_tot_amount_old=0;
      ...
      m_amount=0;
			...
			m_amount=rs.getDouble(9);
			m_amount_cap=rs.getDouble(10);
			m_agr_status=rs.getString(17); //added by ns 30-09-2009
			m_termi_status=rs.getString(18); 
			m_age_old=rs.getInt(14);
			m_amount_old=rs.getDouble(12);
			m_amount_cap_old=rs.getDouble(13);
