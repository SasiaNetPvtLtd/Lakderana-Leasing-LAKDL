...
//SCREEN NAME:CLIENT DEBTOR APPROVAL LETTER 2
...
public class LAKDL_FA_CR_Client_Debtor_Approval_Letter2 extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
		  ...
		  if (m_chksql.trim().equals("main_page")) {
			...
			out.println("	m_url = \""+m_class_url+"/"+m_fschema_name+"FA_CR_client_debtor_doc_issue_updation?doc_code=D002&client_code="+m_client_no+"&facility_no="+m_facility_no+"&debtor_code="+m_debtor_code+"\";"); 
    	...
    	out.println("m_writedata+'</table>';");
		  ...
		  out.println("</tr>"); 
			...
			out.println("<tr><td width='*%' class='factoring-letter-body'><input class='txt_input6' type='text' name='TXT_DATE' maxlength='100' value='"+m_Letter_date+"' size='100' style='width:100'></td>");
		  ...
		  out.println("<tr><td width='50%'></td><td width='20%' class='factoring-letter-body'  >Supplier     	 </td><td width='2%' class='factoring-letter-body'  > : </td><td width='*%' class='factoring-letter-body'  align='left' > "+m_client_name+"</td></tr>");
			...
			out.println("We are pleased to inform you that we are providing factoring services to  "+
									" the above named supplier whereby the amount payable on invoices are assigned "+
									" to us. Accordingly all payments on the invoices are to be made to our company. "+
									" <i>We hereby enlighten you as to the nature and procedure of factoring which is a sale of debt; </i> ");						
			out.println("</td></tr>");									
			out.println("</table>");
			out.println("</p></blockquote>");				
			out.println("<blockquote><p style='text-align:justify' class='factoring-letter-body' >");			
			out.println("<table border='0' width='80%' class='table'>"); 		
			out.println("<tr><td width='*%' class='factoring-letter-body'  style='text-align:justify'>");
			out.println("<li style='text-align:justify' class='factoring-letter-body' > Factoring is the purchase of debt portfolios at a discount from other "+
									" 	establishments with the view to recover same, Act as managing agents for Companies "+
									" 	or other such institutions whether incorporated or otherwise engaged in finance or "+
									" 	finance related business. <br>");
      out.println("</td></tr>");									
			out.println("</table>");									
			out.println("</p></blockquote>");				
			out.println("<blockquote><p style='text-align:justify' class='factoring-letter-body'  >");				
			out.println("<table border='0' width='80%' class='table'>"); 		
			out.println("<tr><td width='*%' class='factoring-letter-body'  style='text-align:justify'>");
			out.println("<b>Your obligations and duties</b>");
			out.println("<li style='text-align:justify' class='factoring-letter-body' > All your remittances on invoices should be sent in favour of "+
									" 	<b><i>'Orient Factor'</i></b>.<br><br> "+
									"<li style='text-align:justify' class='factoring-letter-body' > Any questions pertaining to invoices, credit notes, statement of "+
									" 	accounts, payments and on the actual goods and services must be referred to the supplier.<br><br>"+
									"<li style='text-align:justify' class='factoring-letter-body' > You are advised as benefits of all the  supplier invoices are being "+
									" assigned to <b><i>'Orient Factor'</i></b>  any existing arrangement for settlement of reduction of any account due to the "+
									" supplier by contra assignment should be discounted. If you have counter claim on the supplier that should be invoiced "+
									" by you in the normal manner and the payment be directly collected from the supplier.<br><br> "+
									"<li style='text-align:justify' class='factoring-letter-body' > If there are any discrepancies or incorrect statements on any of "+
									" the invoices assigned to <b><i>'Orient Factor'</i></b>  it is your duty to notify <b><i>'Orient Factor'</i></b>  forthwith.<br><br>"+
									"<li style='text-align:justify' class='factoring-letter-body' > Please ensure that all dues of invoices assigned to <b><i>Orient Factor</i></b>  to "+
									" be paid to the payee <b>Lakderana Investments Limited</b> from now on at No. 100, Buthgamuwa Road, Rajagiriya."+
									"Your debts will be discharged only on payment made directly to <b>Lakderana Investments Limited.</b><br><br> "+
									"<li style='text-align:justify' class='factoring-letter-body' >If the payment are made by cheques and if such cheques are "+
									" dishonored all signatories to the  cheques shall be call upon to honoring such payments.<br><br> "+
									"<li style='text-align:justify' class='factoring-letter-body' > The responsibility of the supplier/you (debtor) shall be joint and several and we retain the right to proceed against one or both at our discretion.<br><br> "+
									"You are required to sign and return the duplicate of this letter within "+
									" 10 days from date of receipt.Even if you do not return the duplicate within 10 days you will of course be bound and obliged by the above terms.");
			out.println("</td></tr>");									
			out.println("</table>");																		
			out.println("</p></blockquote>");
			out.println("<blockquote><p style='text-align:justify' class='factoring-letter-body' >");	
			...
			out.println("<table border='0' width='80%' class='table'>"); 		
			out.println("<tr><td width='*%' class='factoring-letter-body'  style='text-align:justify'>");
			out.println(" I/We hereby agree to be bound by the terms and conditions set out above "+
									" and all other terms contained in the factoring agreement entered by and between "+
									" you and the supplier to which we are a privy and further confirm that our debts owing "+
									" to the supplier has not been assigned to any third party.");
 			out.println("</td></tr>");									
			out.println("</table>");																					
			out.println("</p><p style='text-align:justify' class='factoring-letter-body'><br><br>");										
			out.println("<table border='0' width='80%' class='table'>"); 		
