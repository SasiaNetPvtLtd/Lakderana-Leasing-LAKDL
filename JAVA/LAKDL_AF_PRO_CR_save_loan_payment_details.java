...
public class LAKDL_AF_PRO_CR_save_loan_payment_details extends HttpServlet {
	...
	public synchronized void  service(HttpServletRequest req, HttpServletResponse res)	throws IOException{
      ...
      String m_scr_name=(String)m_sn_methods.met_formdata(reqstr,"Hid_scr_name"); 
	   	...
	   	out.println("<HTML><HEAD>");
			...
			out.println("window.location.href='"+m_url+"/"+m_fschema_name+"AF_PRO_CR_display_loan_payment_details?sql=main_page&status_new=&status_edit=&screen_type=EDIT&chksql="+m_status+"&chksql2="+m_chksql1+"';");
			out.println("}");
			out.println("else {");
			out.println("window.location.href='"+m_url+"/"+m_fschema_name+"AF_PRO_CR_display_loan_payment_details?sql=main_page&status_new=&status_edit=&screen_type=EDIT&chksql="+m_status+"&chksql2="+m_chksql1+"';");
			out.println("}");
