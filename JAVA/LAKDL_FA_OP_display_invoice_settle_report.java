...
public class LAKDL_FA_OP_display_invoice_settle_report extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Operation Process - Invoices Settlement Report</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("	help_box.innerHTML=\"Operation Process - Invoices Settlement Report - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\"Operation Process - Invoices Settlement Report \";"); 
			out.println("}"); 
	  	...
	  	out.println("					}");  
			...
			out.println(" 	m_sql = \"m_help_DIV_TXT_INVOICE_SETTLE_REPORT_sql\";"); 
			...
			out.println("	m_url = \""+m_class_url+"/"+m_fschema_name+"FA_OP_Invoice_Settle_Report?chksql=main_page&client_no=\"+document.Form1.TXT_CLIENT_CODE.value+\"&print=TRUE&facility_no=\"+document.Form1.TXT_FACILITY_NO.value;"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Operation Process - Invoices Settlement Report </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
