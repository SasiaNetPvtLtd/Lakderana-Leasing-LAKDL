...
//Deposit Slip Printing 30-03-2007
...
public class LAKDL_AF_RE_Collection_POD_ACK_View extends javax.servlet.http.HttpServlet {
  ...
  public synchronized void service(HttpServletRequest req, HttpServletResponse res)
	...
	//		out.println("m_branch_code=data_vec[4];");
      ...
      out.println("			}");
			...
			out.println("		help_deposit_no_assign();"); 
	  	out.println("		}"); 
		  out.println("		if(IfCount==\"1\"){"); 
			out.println("		pod_no_assign();"); 
	  	out.println("		}"); 
		...
		//  out.println("m_user_clear=\"TXT_USER\"+document.Form1.hid_row_no.value;");
			...
			/*
				...
				out.println("    HelpBox('1','10','0',Crit,'m_help_finance_no_post_dated_sql','99');"); 
				...
				*/
				...
				out.println("    Crit = document.Form1.TXT_FINANCE_NO.value+\"@ACTIVATED@\";"); 
				out.println("    HelpBox('1','10','0',Crit,'ClientSql_Client_add','99');"); 
				out.println("}"); 
					
					
			out.println(""); 

			out.println("function help_deposit_no_assign() {"); 
			//out.println("m_user_assign=\"TXT_USER\"+row_No");
			out.println("    document.Form1.TXT_FINANCE_NO.value=oBj.valout[2];"); 
			out.println("    document.Form1.hid_CLIENT_CODE.value=oBj.valout[2];"); //MOd By Sandun on 14-07-2009
		...
		//	out.println("m_branch_code=oBj.valout[6];");
			...
			out.println("function val_deposit_code(obj){");
	...
	//		out.println("window.open(m_url);");
		...
		//--------------------------------------------------------------------------		
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_RE_Collection_POD_ACK_View';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("help_box.innerHTML=\" Collection Process - POD Slip - \"+m_val;"); 
			...
			out.println("help_box.innerHTML=\" Collection Process - POD Slip - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
		...
		//	out.println("document.Form1.BUT_HELP_MAIN.disabled=true;}"); 
			...
			out.println("if(document.Form1.TXT_POD_NO.value==''){");
			out.println("DIV_TXT_POD_NO.style.color='red';");
			out.println("alert(\"Please enter all required fields marked with a '*' on screen\");");
			out.println("}");
			out.println("else{");
			//out.println("	m_url = \""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_RE_Receipt_Deposit_Slip?chksql=print_deposit_slip&deposit_no=\"+document.Form1.DEPOSIT_CODE.value;"); 
			out.println("popupwin = window.open('"+m_class_url+"/"+m_fschema_name+"AF_RE_Post_Dated_Acknowledgement?chksql=print_ack&batch_no='+document.Form1.HID_BATCH_NO.value+'&pod_no='+document.Form1.TXT_POD_NO.value+'&finance_no='+document.Form1.TXT_FINANCE_NO.value+'&client_code='+document.Form1.hid_CLIENT_CODE.value+'&ack=all','displayWindow1','left=110,top=110,width=650,height=400,toolbar=0,location=0,directories=0,status=0,menuBar=1,scrollBars=1,resizable=1');	");				
		//	out.println("popupwin =window.open(m_url,'displayWindow3','left=110,top=110,width=660,height=700,toolbar=0,location=0,direction=0,menuBar=0,status=0,scrollbars=1,resizable=0');");
			...
			out.println("function help_pod() {"); 				
			out.println("    Crit = document.Form1.TXT_POD_NO.value+\"@\"+document.Form1.TXT_FINANCE_NO.value+\"@\";"); 
			out.println("    HelpBox('1','10','0',Crit,'pod_ack_sql','1');"); 
			out.println("}"); 
			
			out.println("function pod_no_assign() {"); 
			...
			out.println("    document.Form1.TXT_POD_NO.value=oBj.valout[2];"); 
			out.println("    document.Form1.HID_BATCH_NO.value=oBj.valout[10];"); 
			//out.println("alert(document.Form1.HID_BATCH_NO.value);");
			out.println("}");
      out.println("</Script>");
          ...
          out.println("<INPUT TYPE='Hidden' NAME='HID_BATCH_NO' VALUE=\"\">");
					...
					out.println("</tr>"); 
					out.println("<tr>"); 
					out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Collction Process - POD Slip</td>"); 
					out.println("</tr>"); 
					out.println("<tr>"); 
			...
			//		out.println("<tr><td width='10%' align='center'><input type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"New\");' onclick='load_screen_status(\"NEW\")' value=\"New\"></td>");  
			  ...
			  //  out.println("<td width='30%' >Purchase Order No</td>"); 
					...
					out.println("<td width='30%' ><input class='txt_input' type='text' name='TXT_FINANCE_NO' maxlength='20' size='10' onblur=\"help_finance_no()\">"); 
			    out.println("<input class='but_input' type='button' name='BUT_POD_CODE' value=\"Help\" onClick=\"help_finance_no()\"></td>"); 
					out.println("<td width='6%'><input class='but_input' type='button' name='BUT_BCODE' value=\"View\" onClick=\"letter()\" style='{cursor:hand;}'></td>"); 
					out.println("</tr>"); 
          out.println("</table>");          
				*/		
					out.println("<td width='30%' ><DIV id='DIV_TXT_FINANCE_NO'  class=div_input>Client Code</DIV></td>"); 
					out.println("<td width='30%' ><input class='txt_input' type='text' name='TXT_FINANCE_NO' maxlength='20' size='10' onblur=\"help_client()\">"); 
			    out.println("<input class='but_input' type='button' name='BUT_POD_CODE' value=\"Help\" onClick=\"help_client()\"></td>"); 
					out.println("</tr>"); 
					out.println("<tr>"); 
					out.println("<td width='30%' ><DIV id='DIV_TXT_POD_NO'  class=div_input>PDC No *</DIV></td>"); 
					out.println("<td width='30%' ><input class='txt_input' type='text' name='TXT_POD_NO' maxlength='20' size='10' onblur=\"help_pod()\">"); 
			    out.println("<input class='but_input' type='button' name='BUT_POD_CODE_1' value=\"Help\" onClick=\"help_pod()\"></td>"); 
					out.println("<td width='6%'><input class='but_input' type='button' name='BUT_BCODE' value=\"View\" onClick=\"letter()\" style='{cursor:hand;}'></td>"); 
					out.println("</tr>"); 
          out.println("</table>");          
