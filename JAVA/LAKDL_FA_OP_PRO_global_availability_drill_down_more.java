...
// DEVELOP BY : DINETH FOR OFSCL FACTORING    DATE:2008-09-11
  
public class LAKDL_FA_OP_PRO_global_availability_drill_down_more extends javax.servlet.http.HttpServlet {
     	...
     	res.setDateHeader("Expires", 0);
			...
			else if(m_chksql.trim().equals("LOAD_GLOBAL_AVAILABILITY_DRILL"))
			{
				...
				if(m_option_no.equals("OPT30")){
					...
					rs1= stmt1.executeQuery(" SELECT A.CLIENT_CODE, "+
																	...
																	" A.FACILITY_NO, "+
																	" "+m_schema_name+".FA_CLIENT_AV_UNALLOFUND_TRAN(A.CLIENT_CODE,A.FACILITY_NO,TO_CHAR(SYSDATE,'DD-MM-YYYY')) "+
																	"	FROM "+m_schema_name+".FA_CR_PRO_INVOICE A "+
																	" WHERE "+m_schema_name+".FA_CLIENT_AV_UNALLOFUND_TRAN(A.CLIENT_CODE,A.FACILITY_NO,TO_CHAR(SYSDATE,'DD-MM-YYYY'))>0 "+
					...
					out.println("<p class=pdn_txtpos2><center><u><B>UNALLOCATED FUND TRANSFER</B></center></u></p>");
					out.println("<br>");
				...
				if(m_option_no.equals("OPT31")){
					...
					rs1= stmt1.executeQuery(" SELECT A.CLIENT_CODE, "+
																	"	"+m_schema_name+".FA_GET_CLIENT_FULL_NAME(A.CLIENT_CODE), "+
																	" A.FACILITY_NO, "+
																	" "+m_schema_name+".FA_CLIENT_AV_RETURNED_FUNDS(A.CLIENT_CODE,A.FACILITY_NO,TO_CHAR(SYSDATE,'DD-MM-YYYY')) "+
																	"	FROM "+m_schema_name+".FA_CR_PRO_INVOICE A "+
																	" WHERE "+m_schema_name+".FA_CLIENT_AV_RETURNED_FUNDS(A.CLIENT_CODE,A.FACILITY_NO,TO_CHAR(SYSDATE,'DD-MM-YYYY'))>0 "+
																	" GROUP BY A.CLIENT_CODE,A.FACILITY_NO ");
				...
				if(m_option_no.equals("OPT32")){
					...
					rs1= stmt1.executeQuery(" SELECT A.CLIENT_CODE, "+
																	"	"+m_schema_name+".FA_GET_CLIENT_FULL_NAME(A.CLIENT_CODE), "+
																	" A.FACILITY_NO, "+
																	" "+m_schema_name+".FA_CLIENT_AV_REFUNDED_FUNDS(A.CLIENT_CODE,A.FACILITY_NO,TO_CHAR(SYSDATE,'DD-MM-YYYY')) "+
																	"	FROM "+m_schema_name+".FA_CR_PRO_INVOICE A "+
																	" WHERE "+m_schema_name+".FA_CLIENT_AV_REFUNDED_FUNDS(A.CLIENT_CODE,A.FACILITY_NO,TO_CHAR(SYSDATE,'DD-MM-YYYY'))>0 "+
																	" GROUP BY A.CLIENT_CODE,A.FACILITY_NO ");
					...
					out.println("<BODY   class='body & txt-body' LEFTMARGIN='0' TOPMARGIN='0'>");
					out.println("<FORM NAME='Form1' method='post'>"); 
					out.println("<p class=pdn_txtpos2><center><u><B>REFUNDED FUNDS</B></center></u></p>");
					out.println("<br>");
					out.println("<table align='center' width='100%' class='table' >");
					out.println("<tr class=pdn_txtpos2>");
					out.println("<td width='10%' ><DIV class=div_input><b>Client Code</b></DIV></td>");
			...
			if(m_option_no.equals("OPT30")){
					...
					rs1= stmt1.executeQuery(" SELECT A.CLIENT_CODE, "+
																	"	"+m_schema_name+".FA_GET_CLIENT_FULL_NAME(A.CLIENT_CODE), "+
																	" A.FACILITY_NO, "+
																	" "+m_schema_name+".FA_CLIENT_AV_UNALLOFUND_TRAN_M(A.CLIENT_CODE,A.FACILITY_NO,'"+m_date+"') "+
																	"	FROM "+m_schema_name+".FA_CR_PRO_INVOICE A "+
																	" WHERE "+m_schema_name+".FA_CLIENT_AV_UNALLOFUND_TRAN_M(A.CLIENT_CODE,A.FACILITY_NO,'"+m_date+"')>0 "+
																	" GROUP BY A.CLIENT_CODE,A.FACILITY_NO ");
				...
				if(m_option_no.equals("OPT31")){
					...
					rs1= stmt1.executeQuery(" SELECT A.CLIENT_CODE, "+
																	"	"+m_schema_name+".FA_GET_CLIENT_FULL_NAME(A.CLIENT_CODE), "+
																	" A.FACILITY_NO, "+
																	" "+m_schema_name+".FA_CLIENT_AV_RETURNED_FUNDS_M(A.CLIENT_CODE,A.FACILITY_NO,'"+m_date+"') "+
																	"	FROM "+m_schema_name+".FA_CR_PRO_INVOICE A "+
																	" WHERE "+m_schema_name+".FA_CLIENT_AV_RETURNED_FUNDS_M(A.CLIENT_CODE,A.FACILITY_NO,'"+m_date+"')>0 "+
																	" GROUP BY A.CLIENT_CODE,A.FACILITY_NO ");
				...
				if(m_option_no.equals("OPT32")){
					...
					rs1= stmt1.executeQuery(" SELECT A.CLIENT_CODE, "+
																	"	"+m_schema_name+".FA_GET_CLIENT_FULL_NAME(A.CLIENT_CODE), "+
																	" A.FACILITY_NO, "+
																	" "+m_schema_name+".FA_CLIENT_AV_REFUNDED_FUNDS_M(A.CLIENT_CODE,A.FACILITY_NO,'"+m_date+"') "+
																	"	FROM "+m_schema_name+".FA_CR_PRO_INVOICE A "+
																	" WHERE "+m_schema_name+".FA_CLIENT_AV_REFUNDED_FUNDS_M(A.CLIENT_CODE,A.FACILITY_NO,'"+m_date+"')>0 "+
																	" GROUP BY A.CLIENT_CODE,A.FACILITY_NO ");
