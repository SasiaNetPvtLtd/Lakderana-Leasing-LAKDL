...
//--
//SCREEN NAME:SYSTEM ADMINISTRATION -  FOLLOW UP ACTION CATEGORY 
//CREATED BY:
//DATE/TIME:
//NOTES:
...
public class LAKDL_AF_MAS_display_follow_up_action_category extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>System Administration -  Follow Up Action Categories</TITLE>"); 
			out.println("</HEAD>"); 
			out.println("<link REL='STYLESHEET' HREF='"+m_html_client_url+"/css/Asset_Financing_System.css' TYPE=\"text/css\">"); 
			out.println("<SCRIPT language=\"JavaScript\">"); 

			out.println("function get_vector(data_vec) {");
			out.println("			if(data_vec.length>0 && document.Form1.SCREEN_NAME.value==\"NEW\" && document.Form1.hid_val.value!='t2'){");
			out.println("				alert('Record already exists');");
			out.println("				new_window();");
			out.println("			}");
			
			out.println("else if(data_vec.length==0 && document.Form1.SCREEN_NAME.value!=\"NEW\" && document.Form1.TXT_CATEGORY_CODE.value!='' && document.Form1.hid_val.value=='t1'){");
			out.println("help_update()");
			
			out.println("}");

			out.println("else if(data_vec.length>0 && document.Form1.SCREEN_NAME.value!=\"NEW\" && document.Form1.TXT_CATEGORY_CODE.value!='' && document.Form1.hid_val.value=='t1'){");
			out.println("document.Form1.TXT_CATEGORY_CODE.value=data_vec[0];"); 
			out.println("document.Form1.TXT_CATEGORY_NAME.value=data_vec[1];"); 
			...
			out.println("			if(data_vec.length>0 && document.Form1.SCREEN_NAME.value==\"NEW\" && document.Form1.TXT_CATEGORY_NAME.value!='' && document.Form1.hid_val.value=='t2'){");
			out.println("				alert('Record already exists');");
			out.println("help_update_desc()");
			out.println("document.Form1.TXT_CATEGORY_NAME.value='';"); 
			out.println("document.Form1.TXT_CATEGORY_NAME.focus();"); 
			...
			out.println(" if ((document.Form1.SCREEN_NAME.value==\"RACT\")||(document.Form1.SCREEN_NAME.value==\"EDIT\")||(document.Form1.SCREEN_NAME.value==\"DACT\")){");
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_follow_up_action_category&data_val=\"+obj.value+\"&ac_status=\"+document.Form1.hid_st.value;");
			out.println("}");
			out.println(" if(document.Form1.SCREEN_NAME.value==\"NEW\"){");
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations1?chksql=m_prime_chk_LAKDL_AF_MAS_display_follow_up_action_category_r&data_val=\"+obj.value;");
			out.println("}");
			...
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations1?chksql=m_prime_chk_LAKDL_AF_MAS_display_follow_up_action_category_desc&data_val=\"+obj.value+\"&ac_status=\"+document.Form1.hid_st.value;");
			//out.println("window.open(m_url)");
			out.println("load_interface(m_url,'XML');");
			out.println("}");
			...
			out.println("if(document.Form1.TXT_CATEGORY_CODE.value==\"\"){  "); 
			out.println("DIV_TXT_CATEGORY_CODE.style.color='red';");
			out.println("return false;"); 
			out.println("}"); 
			out.println("else if(document.Form1.TXT_CATEGORY_NAME.value==\"\"){  "); 
			out.println("DIV_TXT_CATEGORY_NAME.style.color='red';");
			out.println("return false;"); 
			out.println("}"); 
			...
			out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_MAS_save_follow_up_action_category';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MAS_display_follow_up_action_category';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("    m_help_message = \"m_help_msg_LAKDL_AF_MAS_display_follow_up_action_category\";"); 
			...
			out.println("help_box.innerHTML=\" System Administration -  Follow Up Action Categories - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" System Administration -  Follow Up Action Categories  - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
			...
			out.println("document.Form1.TXT_CATEGORY_NAME.disabled=true;"); 
      ...
      out.println(" }");
			...
			out.println("    document.Form1.TXT_CATEGORY_CODE.focus();"); 
			out.println("document.Form1.TXT_CATEGORY_NAME.value='';"); 
			...
			out.println("    } ");
			out.println("    else{");
			out.println("    m_criteria = document.Form1.TXT_CATEGORY_CODE.value+\"@\"+\"N@\";}"); 
			out.println("    HelpBox('1','10','0');"); 
			out.println("}"); 

			out.println("function help_update_desc() {"); 
			out.println("    document.Form1.hid_help_type.value=\"100\";"); 
			out.println("    m_sql = \"m_help_TXT_CATEGORY_CODE_desc_sql\";"); 
			//out.println("    if(document.Form1.SCREEN_NAME.value==\"NEW\" || document.Form1.SCREEN_NAME.value==\"EDIT\" || document.Form1.SCREEN_NAME.value==\"DACT\"){ ");
			out.println("    m_criteria = document.Form1.TXT_CATEGORY_NAME.value+\"@\";"); 
			//out.println("    } ");
			//out.println("    else{");
			//out.println("    m_criteria = document.Form1.TXT_CATEGORY_CODE.value+\"@\"+\"N@\";}"); 
			out.println("    HelpBox('1','10','0');"); 
			...
			out.println("    document.Form1.TXT_CATEGORY_CODE.value=oBj.valout[2];"); 
			out.println("    document.Form1.TXT_CATEGORY_NAME.value=oBj.valout[3];"); 
	  	...
	  	out.println("		}"); 
			...
			out.println("    m_sql = \"m_view_TXT_CATEGORY_CODE_sql\";");
			out.println("    m_criteria = document.Form1.TXT_CATEGORY_CODE.value+\"@\"+\"Y@\";"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>System Administration -  Follow Up Action Categories </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_CATEGORY_CODE' maxlength='10' size='10' onblur=\"assig('t1'),makeRequest(document.Form1.TXT_CATEGORY_CODE)\">"); 
			out.println("<input class='but_input' type='button' name='BUT_HELP_MAIN' value=\"Help\" onClick=\"help_update()\" disabled></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 

			out.println("<td width='30%' ><DIV id='DIV_TXT_CATEGORY_NAME'  class=div_input>Category Name *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_CATEGORY_NAME' maxlength='50' size='25' onblur=\"assig('t2'),makeRequest1(document.Form1.TXT_CATEGORY_NAME)\"></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 
