...
public class LAKDL_AF_RE_Invoice_Bulk_Print_Main extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
      ...
      out.println(" 	  if(m_from_dd != '' && m_from_mm !='' && m_from_yy !=''  ) { ");
			out.println("  	     if(checkMonthLength(document.Form1.TXT_FROM_DATE_DD,document.Form1.TXT_FROM_DATE_MM,document.Form1.TXT_FROM_DATE_YY)&&checkMonthLength(document.Form1.TXT_TO_DATE_DD,document.Form1.TXT_TO_DATE_MM,document.Form1.TXT_TO_DATE_YY)){  "); 
      ...
      out.println("			else {");
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_RE_Invoice_Bulk_Print_Main?chksql=main_page';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("	help_box.innerHTML=\" Invoicing - Invoice Bulk Print - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\" Invoicing - Invoice Bulk Print \";"); 
			out.println("}"); 
		...
		//m_url=servlet_client_url+":"+client_t3_port+"/"+client_name+"cheq_printing?chksql=PRINT&ref_no="+m_sus_refno;
		  out.println("   m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_Bulk_Print_Main?chksql=PRINT&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&print_type=\"+val+\"\";");
		  out.println("document.Form1.submit();");	
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Invoicing - Invoice Bulk Print </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
