...
public class LAKDL_AF_RE_PRO_Collection_NOT_Letter_Reminder_front_end extends javax.servlet.http.HttpServlet {
	...
	public /*synchronized*/ void service(HttpServletRequest req, HttpServletResponse res) throws IOException {
		...
		//		out.println("   m_url='" + m_class_url + "/" + m_fschema_name + "AF_RE_PRO_Collection_Final_Reminder?m_finance_no="+req.getParameter("finance_no")+"&application_no=" + req.getParameter("application_no") + "&document_code="+req.getParameter("document_code")+"&print=FALSE&client_code=" + req.getParameter("client_code") + "&client_type=" + req.getParameter("client_type") + "';");
			...
			*/
				...
				out.println("<p>");
				out.println("<font face=\"FMBindumathi\">");
                out.println("<b><u>l=,S jdßl fkdf.ùu iïnkaOfhka ixfYdaê; 1982 wxl 29 orK mdßfNda.sl Kh mkf;a 18^1&");
				out.println("j.ka;sh hgf;a l=,sh wjika lrkq ,nk njg jq ±kaùuhs'</u></b>"); // mod
				out.println("</p></font>");	
				out.println("</table>");
				...
				out.println("<p>");
				out.println("<font face=\"FMBindumathi\">");
                out.println("wms úiska kej; kej; lrk ,o b,a,Sï iy isysle|ùï ms&lt;snoj fkdi,ld yßñka Wla; l=,S");
				out.println("iskaklalr .súiqu hgf;a Tn úiska f.úh hq;=j mj;sk jdßl uqo,a ysÕj wm fj; whùug we;s w;r\"");
				out.println("th f.ùug wiu;aj iy$fyda fkdi,ld yer we;s njg fuu.ska ±kqï fokafkuq' fuu ;;a;ajhka");
				out.println("hgf;a fuls ±kaùu ,eî Èk 14 la we;=&lt;; Tn úiska by; lS ys`. jdßlhka ta u; jq fmd&lt;sh o iu`.");
				out.println("f.jkq ,eîu Tn úiska meyer yßkafka kï l=,S iskaklalr .súiqfï úêúOdkhkag wkql=,j l=,sh");
				out.println("wjika lsßug wms úiska mshjr .kq ,nk nj fuu.ska Tn fj; okajd isákafkuq' ta wkqj m%udohlska");
				out.println("f;drj by; lS ys`. uqo, f.jd ksu lsßug läkñka mshjr .kq ,nk fuka wms Tn fj; ldreKslj");
				out.println("Wmfoia ,nd fokafkuq'"); 
				out.println("</p></font>");	
				...
				out.println("<p>");
				out.println("<font face=\"FMBindumathi\">");
                out.println("wemlrejka jk Tn úiska tlS ld, iSudj ;=&lt; ksis mßos f.ùï isÿ lsÍug l=,S .eKqïlrej fm&lt;Uùug");
				out.println("fyda Tn úiska f.ùï isÿ lsÍug lghq;= lrk f,i fuhska ±kqï fouq' tfia lghq;= fkdlrkafka kï");
				out.println("l=,S .eKqïlre iuÕ wemlrejl= jk Tngo úreoaOj kS;s u.ska lghq;= lsÍug isÿjk nj fuhska ±kqï");
				out.println("fouq'"); 
				out.println("</p></font>");	
				out.println("</table>"); // mod
