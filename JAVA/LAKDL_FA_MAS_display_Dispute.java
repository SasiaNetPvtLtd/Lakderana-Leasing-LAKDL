...
public class LAKDL_FA_MAS_display_Dispute extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			*/
			...
			out.println("			}");
			out.println("		  else	if(data_vec.length > 0 && document.Form1.SCREEN_NAME.value!=\"NEW\"&& document.Form1.TXT_DISPUTE_CODE.value !='' && document.Form1.hid_help_status.value == 'H1' ){");
			...
			out.println("		  else	if(data_vec.length>0 && document.Form1.SCREEN_NAME.value==\"NEW\"&& document.Form1.TXT_DISPUTE_DESC.value !='' && document.Form1.hid_help_status.value == 'H2' ){");
			out.println("				alert('Record already exists');");
			out.println("help_update_desc()");
			out.println("	document.Form1.TXT_DISPUTE_DESC.value =''");
			out.println("	document.Form1.TXT_DISPUTE_DESC.focus()");
			out.println("			}");
			out.println("}");
			...
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_nationality&data_val=\"+obj.value+\"&ac_status=\"+document.Form1.hid_st.value;");
			out.println("}");
			//out.println("else{");
			out.println("if(document.Form1.hid_help_status.value == 'H1' && document.Form1.SCREEN_NAME.value==\"NEW\" ) {");
			...
			out.println("help_box.innerHTML=\" System Administration - Disputes - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" System Administration - Disputes - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
      ...
      out.println(" }");
			...
			out.println("    document.Form1.TXT_DISPUTE_DESC.value='';"); 
			//out.println("    document.Form1.TXT_ACT_POINT.value=;");
			out.println("}");
			out.println("}");
			...
			//out.println("    m_criteria = document.Form1.TXT_DISPUTE_CODE.value+\"@\"+\"Y@\";"); 
			...
			out.println("    document.Form1.TXT_DISPUTE_CODE.value=oBj.valout[2];"); 
			out.println("    document.Form1.TXT_DISPUTE_DESC.value=oBj.valout[3];");
		    out.println("    document.Form1.TXT_ACT_POINT.value=oBj.valout[4];");
			//TXT_ACT_POINT
			out.println("}"); 
	  	...
	  	out.println("		}"); 
			...
			out.println("<td class='pdn_txtpos' height='150' valign='top'>");  
	         ...
	         out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_DISPUTE_CODE' maxlength='3' size='10' onblur=\"assign_help_status('H1'),makeRequest(document.Form1.TXT_DISPUTE_CODE);\">");
