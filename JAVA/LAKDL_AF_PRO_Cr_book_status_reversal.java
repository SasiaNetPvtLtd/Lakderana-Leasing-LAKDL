...
public class LAKDL_AF_PRO_Cr_book_status_reversal extends javax.servlet.http.HttpServlet {
	...
	public void service(HttpServletRequest req, HttpServletResponse res)
	{
		...
		try {
			...
			if (m_chksql.trim().equals("idle")) {
				...
				out.println(" 	HelpBox('1','10','0',Crit,'m_help_TXT_finance_no_sql','4');");
				out.println("}");
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_PRO_Cr_book_status_reversal?chksql=main_page';"); 
			out.println("		}"); 
			out.println("}"); 
				...
				out.println("</tr>");
				out.println("<tr>");
				out.println("<td align=\"left\" class=\"pdn_txtpos2\" height=\"2%\" id=help_box>CR Book Status Reversal</td>");
				out.println("</tr>");
				...
				out.println("       <script type=\"text/javascript\" src='"+m_html_client_url+"/crBook/cr_book_status_reversal.js'></script>");
