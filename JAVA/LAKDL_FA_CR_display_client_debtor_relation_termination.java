...
public class LAKDL_FA_CR_display_client_debtor_relation_termination extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Credit Process - Client Maintenance - Client-Debtor Relationship Maintenance</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"FA_CR_display_client_debtor_relation_termination';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("	help_box.innerHTML=\"Credit Process - Client Maintenance - Client-Debtor Relationship Maintenance- \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\"Credit Process - Client Maintenance - Client-Debtor Relationship Maintenance \";"); 
			out.println("}"); 
	  	...
	  	out.println("					}");  
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Credit Process - Client Maintenance - Client-Debtor Relationship Maintenance</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
