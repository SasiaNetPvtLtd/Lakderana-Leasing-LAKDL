...
public class LAKDL_FA_OP_Receipt_Cancellation extends javax.servlet.http.HttpServlet {
  ...
  public synchronized void service(HttpServletRequest req, HttpServletResponse res)
	{
      ...
      out.println(" var m_amount_entered=0;");
       ...
       out.println("}");
        ...
        //out.println("   window.open(m_url);");
			  ...
			  out.println("   m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"FA_OP_Receipt_Cancellation?chksql=get_return_receipt&m_receipt_no=\"+document.Form1.RECEIPT_NO.value+\"\";");
				out.println("  }");
        out.println("   makeRequest(m_url,'10','invoice_details');");
				...
				out.println("if(document.Form1.RECEIPT_NO.value!=\"\" ){");
			  out.println("   m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"FA_OP_Receipt_Cancellation?chksql=get_deposite_details&m_receipt_no=\"+document.Form1.RECEIPT_NO.value+\"\";");
				out.println("  }");
        out.println("   makeRequest(m_url,'11','deposite_details');");
				...
				out.println("if(document.Form1.RECEIPT_NO.value!=\"\" ){");
			  out.println("   m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"FA_OP_Receipt_Cancellation?chksql=get_retrealiz_details&m_receipt_no=\"+document.Form1.RECEIPT_NO.value+\"\";");
				out.println("  }");
        out.println("   makeRequest(m_url,'12','retandrealiz_details');");
			...
			out.println("		document.Form1.action='"+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"FA_OP_Receipt_Cancellation_Save?chksql=main_page';");  
      ...
      out.println("function befor_reset(){");
		  ...
		  out.println("window.location.href='"+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"FA_OP_Receipt_Cancellation?chksql=main_page'");
		  out.println(" }  ");
			out.println("}");
      ...
      out.println("}"); 
			...
			out.println(""); 
			  ...
			  out.println("function receipt_help(){");
				...
				out.println("HelpBox('1','10','0',Crit,'m_help_DIV_TXT_RECEIPT_CANCEL_sql','2');");
				out.println("}");	
      ...
      out.println("}");
	   ...
	   out.println(" function remv_inv_det(){ ");
	    ...
	    out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"FA_OP_Receipt_Cancellation?chksql=main_page';"); 
			out.println("}");
      ...
      out.println("}");
		  ...
		  out.println("<BODY class='body & txt-body' leftmargin='0' topmargin='0' marginwidth='0' ONLOAD=\"load_roll_out_value(),get_sysdate()\">"); 
			...
			out.println("<input type='hidden' name='Hid_scr_name' value='FA_OP_Receipt_Cancellation' > ");
