...
public class LAKDL_AF_CR_PRO_Enter_Deletion_letter_details_app extends javax.servlet.http.HttpServlet { //LAKDL_AF_CR_PRO_Enter_Deletion_letter_details_app
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			if(m_chksql.equals("main_page")){
					...
					out.println("      m_url=\""+m_class_url+"/"+m_fschema_name+"AF_CR_PRO_Enter_Deletion_letter_details_app?chksql=details&status=\"+document.Form1.hid_status.value+\"&APPLICATION_NO=\"+document.Form1.TXT_APP_NO.value;"); 
					...
					out.println("			window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_CR_PRO_Enter_Deletion_letter_details_app?chksql=main_page';"); 
					out.println("		}"); 
					out.println("}"); 
				  ...
				  out.println("count=count+1;");
					...
					//out.println("		if(validate_data()){");	
					out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_CR_PRO_Enter_Deletion_letter_details_app_save';");  
					...
					rs=stmt.executeQuery(" "+ 								
									" SELECT "+
										...
										" '-' "+ // 6
										  ...
										  " WHERE A.APPLICATION_NO LIKE '%"+m_app_no+"%'   "+
