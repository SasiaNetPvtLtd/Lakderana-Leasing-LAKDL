...
public class LAKDL_FA_OP_Non_Sales_and_Excess_Funds_Transfer_Main extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Non Sales and Excess Funds Transfer Report </TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("function show_transfer_report() {");
			out.println(" 	m_from_dd = document.Form1.TXT_FROM_DATE_DD.value ");
			out.println(" 	m_from_mm = document.Form1.TXT_FROM_DATE_MM.value ");
			out.println("		m_from_yy = document.Form1.TXT_FROM_DATE_YY.value ");
			...
			out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"FA_OP_Non_Sales_and_Excess_Funds_Transfer_Report?chksql=LOAD_TRANSFER_REPORT&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&client_code=\"+document.Form1.TXT_CLIENT_CODE.value+\"&facility_no=\"+document.Form1.TXT_FACILITY_NO.value;");
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"FA_OP_transfer_report';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("	help_box.innerHTML=\" Non Sales and Excess Funds Transfer Report - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\" Non Sales and Excess Funds Transfer Report \";"); 
			out.println("}"); 
			...
			out.println("	"); 
		 /* out.println(" window.open(servlet_client_url+\":\"+client_t3_port+\"/\"+client_name+\"FA_MAS_Help_Servlet?class_in=\"+client_name+\"FA_OP_help_select_2\"+"); 
			out.println("    \"&Sql_in=\"+m_sql+\"&Start_in=\"+Start+"); 
			out.println("    \"&End_in=\"+End+\"&Crit_In=\"+m_criteria+"); 
	  	...
	  	out.println("					}"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Non Sales and Excess Funds Transfer Report </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<td width='20%' ><input class='txt_input' type='text' name='TXT_CLIENT_CODE' maxlength='10' size='50' style='width:100' disabled> </td>"); 
			out.println("<td width='*%' align='left' ></td>");
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td width='*%'><input class='but_input' type='button' name='BUT_VIEW_MAIN' value=\"View\" onClick=\"show_transfer_report()\"></td>"); 
			out.println("</tr>");
			out.println("</table>");  
			out.println("</form>"); 
