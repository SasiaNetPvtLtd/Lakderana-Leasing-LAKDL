...
public class LAKDL_FA_MISF_deposit_settle_report extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Settlement Receipt Deposit</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("function show_deposit_settle_report() {");
			out.println(" 	m_from_dd = document.Form1.TXT_FROM_DATE_DD.value ");
			out.println(" 	m_from_mm = document.Form1.TXT_FROM_DATE_MM.value ");
			out.println("		m_from_yy = document.Form1.TXT_FROM_DATE_YY.value ");
			...
			out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"FA_MISF_reports?chksql=LOAD_DEPOSIT_SETTLE_REPORT&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&client_code=\"+document.Form1.TXT_CLIENT_CODE.value+\"&facility_no=\"+document.Form1.TXT_FACILITY_NO.value+\"&debtor_code=\"+document.Form1.TXT_DEBTOR_CODE.value+\"&branch_code=\"+document.Form1.TXT_BRANCH_CODE.value+\"&settle_mode=\"+document.Form1.TXT_SETTLEMENT_MODE.value;");
	  	...
	  	out.println("					}"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Settlement Receipt Deposit Report </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("</td>");
			out.println("<td width='*%'><input class='but_input' type='button' name='BUT_VIEW_MAIN' value=\"View\" onClick=\"show_deposit_settle_report()\"></td>"); 
			out.println("</tr>");
			out.println("</table>");  
			out.println("</form>"); 
