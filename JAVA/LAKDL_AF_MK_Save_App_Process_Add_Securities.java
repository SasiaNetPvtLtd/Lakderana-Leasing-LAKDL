...
public class LAKDL_AF_MK_Save_App_Process_Add_Securities extends HttpServlet {
	 ...
	 //   out.println(reqstr);
      ...
      String m_scr_name=(String)m_sn_methods.met_formdata(reqstr,"SCREEN_NAME"); 
			...
			if(m_chksql.equals("product_hadagasma")){
				...
				callstmt=conn.prepareCall("BEGIN "+m_schema_name+".SAVE_AF_ASSET_PRO_HADAGASMA(:1,:2,:3,:4,:5); END;");
				
				callstmt.setString(1,m_app_no);
				callstmt.setString(2,m_sn_methods.met_formdata(reqstr,"TXT_ITEM_SUB_CAT"));
				callstmt.setString(3,m_sn_methods.met_formdata(reqstr,"TXT_REMARKS"));
				callstmt.setString(4,m_username);
