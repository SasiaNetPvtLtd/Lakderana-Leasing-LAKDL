// DEVELOP BY : NUWAN FOR OFSCL FACTORING    DATE:04-06-2010
...
public class LAKDL_FA_OP_display_pod_approval extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Operation Process - Post Dated Cheque Receipt Generation</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"FA_OP_PRO_sql_validations_normal?chksql=LOAD_POD_CHEQUE_APPROVAL&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"\";");
			...
			out.println("				if(obj3==\"C\"){");
			out.println("					obj1=document.Form1.elements[\"TXT_APPROVE_COMMENT_\"+k].value;");
			out.println("						if(obj1==\"\"){");
			out.println("							alert('For the cancel entries, system needs to enter comments related to the pd cheques');");
			...
			out.println("			}");
			out.println("			if(validate_data()){"); 
			out.println("				document.Form1.action='"+m_class_url+"/"+m_fschema_name+"FA_OP_save_pod_approval';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"FA_OP_display_pod_approval';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("	help_box.innerHTML=\" Operation Process - Post Dated Cheque Approval - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\" Operation Process - Post Dated Cheque Approval \";"); 
			out.println("}"); 
	  	...
	  	out.println("					}"); 
			...
			out.println("<INPUT TYPE='Hidden' NAME='Hid_scr_name' VALUE=\"FA_OP_POD_APPROVAL\">"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Operation Process - Post Dated Cheque Approval </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<TD WIDTH=\"50%\"><input class=\"txt_input5\" type=\"text\" name=TXT_FROM_DATE_DD maxlength=\"2\" size=\"2\" >");
