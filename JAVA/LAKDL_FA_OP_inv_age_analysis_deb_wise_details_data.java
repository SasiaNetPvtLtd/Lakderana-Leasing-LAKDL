...
public class LAKDL_FA_OP_inv_age_analysis_deb_wise_details_data extends javax.servlet.http.HttpServlet {
  ...
  public ResultSet rs1,rs2;
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)	throws IOException	{
		...
		/*---------THIS PART IS MODIFIED BY ASHINI ON 10-10-2007-----------*/
			...
			String mm_debtor_code=req.getParameter("debtor_code");
			...
			out.println(" function show_invoice_details_99m(m_client_code,m_facility_no,m_date,m_range,m_date_cat,m_debtor_code){ ");
			out.println("  m_url=\""+m_class_url+"/"+m_fschema_name+"FA_OP_inv_age_analysis_deb_wise_detail?chksql=LOAD_INVOICE_DETAILS&client_code=\"+m_client_code+\"&facility_no=\"+m_facility_no+\"&eff_date=\"+m_date+\"&date_range=\"+m_range+\"&date_category=\"+m_date_cat+\"&debtor_code=\"+m_debtor_code;");
			out.println("  window.open(m_url,'popupwin1','status=0,menubar=0,scrollbars=1,height=500,width=700');");
			out.println(" }");
			
			out.println(" function show_invoice_details_7m(m_client_code,m_facility_no,m_date,m_range,m_date_cat,m_debtor_code){ ");
			out.println("  m_url=\""+m_class_url+"/"+m_fschema_name+"FA_OP_inv_age_analysis_deb_wise_detail?chksql=LOAD_INVOICE_DETAILS&client_code=\"+m_client_code+\"&facility_no=\"+m_facility_no+\"&eff_date=\"+m_date+\"&date_range=\"+m_range+\"&date_category=\"+m_date_cat+\"&debtor_code=\"+m_debtor_code;");
			out.println("  window.open(m_url,'popupwin1','status=0,menubar=0,scrollbars=1,height=500,width=700');");
			out.println(" }");
			
			out.println(" function show_invoice_details_7(m_client_code,m_facility_no,m_date,m_range,m_date_cat,m_debtor_code){ ");
			out.println("  m_url=\""+m_class_url+"/"+m_fschema_name+"FA_OP_inv_age_analysis_deb_wise_detail?chksql=LOAD_INVOICE_DETAILS&client_code=\"+m_client_code+\"&facility_no=\"+m_facility_no+\"&eff_date=\"+m_date+\"&date_range=\"+m_range+\"&date_category=\"+m_date_cat+\"&debtor_code=\"+m_debtor_code;");
		//	out.println(" alert(m_url);");
			out.println("  window.open(m_url,'popupwin1','status=0,menubar=0,scrollbars=1,height=500,width=700');");
			out.println(" }");
			
			out.println(" function show_invoice_details_30(m_client_code,m_facility_no,m_date,m_range,m_date_cat,m_debtor_code){ ");
			out.println("  m_url=\""+m_class_url+"/"+m_fschema_name+"FA_OP_inv_age_analysis_deb_wise_detail?chksql=LOAD_INVOICE_DETAILS&client_code=\"+m_client_code+\"&facility_no=\"+m_facility_no+\"&eff_date=\"+m_date+\"&date_range=\"+m_range+\"&date_category=\"+m_date_cat+\"&debtor_code=\"+m_debtor_code;");
			out.println("  window.open(m_url,'popupwin1','status=0,menubar=0,scrollbars=1,height=500,width=700');");
			out.println(" }");
			
			out.println(" function show_invoice_details_60(m_client_code,m_facility_no,m_date,m_range,m_date_cat,m_debtor_code){ ");
			out.println("  m_url=\""+m_class_url+"/"+m_fschema_name+"FA_OP_inv_age_analysis_deb_wise_detail?chksql=LOAD_INVOICE_DETAILS&client_code=\"+m_client_code+\"&facility_no=\"+m_facility_no+\"&eff_date=\"+m_date+\"&date_range=\"+m_range+\"&date_category=\"+m_date_cat+\"&debtor_code=\"+m_debtor_code;");
			out.println("	 window.open(m_url,'popupwin1','status=0,menubar=0,scrollbars=1,height=500,width=700');");
			out.println(" }");

			out.println(" function show_invoice_details_90(m_client_code,m_facility_no,m_date,m_range,m_date_cat,m_debtor_code){");
			out.println("	 m_url=\""+m_class_url+"/"+m_fschema_name+"FA_OP_inv_age_analysis_deb_wise_detail?chksql=LOAD_INVOICE_DETAILS&client_code=\"+m_client_code+\"&facility_no=\"+m_facility_no+\"&eff_date=\"+m_date+\"&date_range=\"+m_range+\"&date_category=\"+m_date_cat+\"&debtor_code=\"+m_debtor_code;");
			out.println("	 window.open(m_url,'popupwin1','status=0,menubar=0,scrollbars=1,height=500,width=700');");
			out.println(" }");

			out.println(" function show_invoice_details_99(m_client_code,m_facility_no,m_date,m_range,m_date_cat,m_debtor_code){ ");
			out.println(" m_url=\""+m_class_url+"/"+m_fschema_name+"FA_OP_inv_age_analysis_deb_wise_detail?chksql=LOAD_INVOICE_DETAILS&client_code=\"+m_client_code+\"&facility_no=\"+m_facility_no+\"&eff_date=\"+m_date+\"&date_range=\"+m_range+\"&date_category=\"+m_date_cat+\"&debtor_code=\"+m_debtor_code;");
			out.println(" window.open(m_url,'popupwin1','status=0,menubar=0,scrollbars=1,height=500,width=700');");
			out.println(" }");
			...
			" AND DEBTOR_CODE LIKE '"+mm_debtor_code+"%' "+
		  ...
		  " AND A.FACILITY_NO LIKE '"+mm_facility_no+"%' "+
			...
			if(more1){
				...
				out.println("<TABLE width='100%' ><TR class=pdn_txtpos2 ><TD  width='100%' STYLE='{font: 10pt arial; text-align:center;}'><B><U>Not yet due</U><B></TD></TR></TABLE>");
				}
  			...
  			out.println("<TD STYLE='{font: 7pt arial; text-align:center;}' width='18%'></TD>");
				if(m_date_category.equals("1")){
				out.println("<TD STYLE='{font: 7pt arial; text-align:center;}' width='6%'>Not yet due NO</TD>");
				out.println("<TD STYLE='{font: 7pt arial; text-align:center;}' width='6%'>Not yet due SUM</TD>");
				}
				/*if(m_date_category.equals("2")){
				...
				out.println("<TD STYLE='{font: 7pt arial; text-align:center;}' width='6%'>Due Today NO</TD>");
				out.println("<TD STYLE='{font: 7pt arial; text-align:center;}' width='6%'>Due Today SUM</TD>");*/
				out.println("<TD STYLE='{font: 7pt arial; text-align:center;}' width='6%'>Not yet due days NO</TD>");
				out.println("<TD STYLE='{font: 7pt arial; text-align:center;}' width='6%'>Not yet due days SUM</TD>");
				out.println("<TD STYLE='{font: 7pt arial; text-align:center;}' width='6%'>Due in 30 days NO</TD>");
				out.println("<TD STYLE='{font: 7pt arial; text-align:center;}' width='6%'>Due in 30 days SUM</TD>");
				out.println("<TD STYLE='{font: 7pt arial; text-align:center;}' width='6%'>Due in 60 days NO</TD>");
				out.println("<TD STYLE='{font: 7pt arial; text-align:center;}' width='6%'>Due in 60 days SUM</TD>");
				...
				while(more1){
					...
					if(m_port_name_temp.equals(m_port_name) && m_facility_no_temp.equals(m_facility_no) ){
						...
						else if(m_num_days>0 && m_num_days<=30){
				   ...
				   if(m_date_category.equals("1")){
						out.println("<TD STYLE='{font: 7pt arial; text-align:right; cursor: hand;}' onClick=\"show_invoice_details_7('"+m_port_name_temp+"','"+m_facility_no_temp+"','"+m_eff_date+"','0','"+m_date_category+"','"+mm_debtor_code+"')\"  width='6%'><u>"+nf1.format(m_p7)+"</u></TD>");
						out.println("<TD STYLE='{font: 7pt arial; text-align:right; cursor: hand;}' onClick=\"show_invoice_details_7('"+m_port_name_temp+"','"+m_facility_no_temp+"','"+m_eff_date+"','0','"+m_date_category+"','"+mm_debtor_code+"')\"  width='6%'><u>"+nf.format(m_r7)+"</u></TD>");
						}
				   if(m_date_category.equals("2")){
						out.println("<TD STYLE='{font: 7pt arial; text-align:right; cursor: hand;}' onClick=\"show_invoice_details_30('"+m_port_name_temp+"','"+m_facility_no_temp+"','"+m_eff_date+"','30','"+m_date_category+"','"+mm_debtor_code+"')\"  width='6%'><u>"+nf1.format(m_p30)+"</u></TD>");
						out.println("<TD STYLE='{font: 7pt arial; text-align:right; cursor: hand;}' onClick=\"show_invoice_details_30('"+m_port_name_temp+"','"+m_facility_no_temp+"','"+m_eff_date+"','30','"+m_date_category+"','"+mm_debtor_code+"')\" width='6%'><u>"+nf.format(m_r30)+"</u></TD>");
						}
				   if(m_date_category.equals("3")){
						out.println("<TD STYLE='{font: 7pt arial; text-align:right; cursor: hand;}' onClick=\"show_invoice_details_60('"+m_port_name_temp+"','"+m_facility_no_temp+"','"+m_eff_date+"','60','"+m_date_category+"','"+mm_debtor_code+"')\" width='6%'><u>"+nf1.format(m_p60)+"</u></TD>");
						out.println("<TD STYLE='{font: 7pt arial; text-align:right; cursor: hand;}' onClick=\"show_invoice_details_60('"+m_port_name_temp+"','"+m_facility_no_temp+"','"+m_eff_date+"','60','"+m_date_category+"','"+mm_debtor_code+"')\" width='6%'><u>"+nf.format(m_r60)+"</u></TD>");
						}
				   if(m_date_category.equals("4")){
						out.println("<TD STYLE='{font: 7pt arial; text-align:right; cursor: hand;}' onClick=\"show_invoice_details_90('"+m_port_name_temp+"','"+m_facility_no_temp+"','"+m_eff_date+"','90','"+m_date_category+"','"+mm_debtor_code+"')\" width='6%'><u>"+nf1.format(m_p90)+"</u></TD>");
						out.println("<TD STYLE='{font: 7pt arial; text-align:right; cursor: hand;}' onClick=\"show_invoice_details_90('"+m_port_name_temp+"','"+m_facility_no_temp+"','"+m_eff_date+"','90','"+m_date_category+"','"+mm_debtor_code+"')\" width='6%'><u>"+nf.format(m_r90)+"</u></TD>");
						}
				   if(m_date_category.equals("5")){
						out.println("<TD STYLE='{font: 7pt arial; text-align:right; cursor: hand;}' onClick=\"show_invoice_details_99('"+m_port_name_temp+"','"+m_facility_no_temp+"','"+m_eff_date+"','99','"+m_date_category+"','"+mm_debtor_code+"')\" width='6%'><u>"+nf1.format(m_p90m)+"</u></TD>");
						out.println("<TD STYLE='{font: 7pt arial; text-align:right; cursor: hand;}' onClick=\"show_invoice_details_99('"+m_port_name_temp+"','"+m_facility_no_temp+"','"+m_eff_date+"','99','"+m_date_category+"','"+mm_debtor_code+"')\" width='6%'><u>"+nf.format(m_r90m)+"</u></TD>");
						}
				   if(m_date_category.equals("6")){
						/*out.println("<TD STYLE='{font: 7pt arial; text-align:right; cursor: hand;}' onClick=\"show_invoice_details_99m('"+m_port_name_temp+"','"+m_facility_no_temp+"','"+m_eff_date+"','99m','"+m_date_category+"')\"  width='6%'><u>"+nf1.format(m_pd7m)+"</u></TD>");
						out.println("<TD STYLE='{font: 7pt arial; text-align:right; cursor: hand;}' onClick=\"show_invoice_details_99m('"+m_port_name_temp+"','"+m_facility_no_temp+"','"+m_eff_date+"','99m','"+m_date_category+"')\" width='6%'><u>"+nf.format(m_rd7m)+"</u></TD>");
	  		    ...
	  		    if(m_date_category.equals("1")){
						out.println("<TD STYLE='{font: 7pt arial; text-align:right; cursor: hand;}' onClick=\"show_invoice_details_7('"+m_port_name_temp+"','"+m_facility_no+"','"+m_eff_date+"','0','"+m_date_category+"','"+mm_debtor_code+"')\"  width='6%'><u>"+nf1.format(m_p7)+"</u></TD>");
						out.println("<TD STYLE='{font: 7pt arial; text-align:right;}' width='6%'>"+nf.format(m_r7)+"</TD>");
					  }
				    if(m_date_category.equals("2")){
						out.println("<TD STYLE='{font: 7pt arial; text-align:right; cursor: hand;}' onClick=\"show_invoice_details_30('"+m_port_name_temp+"','"+m_facility_no+"','"+m_eff_date+"','30','"+m_date_category+"','"+mm_debtor_code+"')\"  width='6%'><u>"+nf1.format(m_p30)+"</u></TD>");
						out.println("<TD STYLE='{font: 7pt arial; text-align:right;}' width='6%'>"+nf.format(m_r30)+"</TD>");
						}
				    if(m_date_category.equals("3")){
						out.println("<TD STYLE='{font: 7pt arial; text-align:right; cursor: hand;}' onClick=\"show_invoice_details_60('"+m_port_name_temp+"','"+m_facility_no+"','"+m_eff_date+"','60','"+m_date_category+"','"+mm_debtor_code+"')\" width='6%'><u>"+nf1.format(m_p60)+"</u></TD>");
						out.println("<TD STYLE='{font: 7pt arial; text-align:right;}' width='6%'>"+nf.format(m_r60)+"</TD>");
						}
				    if(m_date_category.equals("4")){
						out.println("<TD STYLE='{font: 7pt arial; text-align:right; cursor: hand;}' onClick=\"show_invoice_details_90('"+m_port_name_temp+"','"+m_facility_no+"','"+m_eff_date+"','90','"+m_date_category+"','"+mm_debtor_code+"')\" width='6%'><u>"+nf1.format(m_p90)+"</u></TD>");
						out.println("<TD STYLE='{font: 7pt arial; text-align:right;}' width='6%'>"+nf.format(m_r90)+"</TD>");
						}
				    if(m_date_category.equals("5")){
						out.println("<TD STYLE='{font: 7pt arial; text-align:right; cursor: hand;}' onClick=\"show_invoice_details_99('"+m_port_name_temp+"','"+m_facility_no+"','"+m_eff_date+"','99','"+m_date_category+"','"+mm_debtor_code+"')\" width='6%'><u>"+nf1.format(m_p90m)+"</u></TD>");
