...
public class LAKDL_AF_MISF_Confirmation_Report_Detail_Snap_cr_app extends javax.servlet.http.HttpServlet {
		...
		try {
			...
			if (m_chksql.trim().equals("idle")) {
				...
				rs = stmt.executeQuery(" "+
					...
					" AND BUSINESS_TYPE = 'NEW' "+ // added by udara 22-09-2017
				...
				*/
				...
				out.println("	 document.Form1.action=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Confirmation_Report_Detail_Snap_Save_cr_app?view_status=new\";"); 
				...
				out.println("	 document.Form1.action=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Confirmation_Report_Detail_Tmp_Save_cr_app?view_status=new\";"); 
				out.println("	 document.Form1.submit();	"); 
				out.println("}");
				...
				rs = stmt.executeQuery(" "+
					...
					//" AND APPLICATION_STATUS NOT IN ('TERMI','TERMINATED','NORM_TERMI')  "+ // added by udara 09-11-2017
					" ");
				...
				rs = stmt.executeQuery(" "+
					...
					" WHERE CLIENT_CODE = '"+mmm_client_code+"' "+
					" AND FINANCE_NO IS NOT NULL  "+
					//" AND APPLICATION_STATUS NOT IN ('TERMI','TERMINATED','NORM_TERMI')  "+ // added by udara 08-11-2017
					" ");
				...
				try{
					rs = stmt.executeQuery(" "+
						...
						" WHERE APPLICATION_NO = '"+m_application_no+"' "+
						//" AND   ACTIVE_STATUS='Y' "+
						" AND   ACTIVE_STATUS IN ('Y','T') "+ // added by udara 08-11-2017
						" ");
				...
				rs = stmt.executeQuery(" "+
					...
					" AND   B.ACTIVE_STATUS IN ('Y','T') "+ // added by udara 08-11-2017
				...
				rs = stmt.executeQuery(" "+  
					...
					//" AND C.SUB_TYPE_CODE IN ('BROKERCOMM') "+ // added by udara 12-09-2017
				...
				rs = stmt.executeQuery(" "+  
					...
					" AND C.SUB_TYPE_CODE NOT IN ('BROKERCOMM','INSURANCE','STDUTY') "+ // added by udara 12-09-2017
					" AND NVL(B.AMOUNT,0) <> 0  "+
					" GROUP BY B.PRICING_NO,B.SUB_CHAGE_CODE,C.DESCRIPTION,B.PRO_INVOICE_NO ORDER BY  C.DESCRIPTION 	"+		 
					" ) "+
					" ORDER BY CHARGES,DESCRIPTION "+
				...
				*/
				...
				rs = stmt.executeQuery(" "+  
					...
					" AND D.BUSINESS_TYPE = 'NEW' "+ // added by udara 22-09-2017
					" group by a.REF_NO "+
					" ");
