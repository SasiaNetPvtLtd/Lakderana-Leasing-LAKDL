...
public class LAKDL_FA_RPT_Accounts_Main_Interest extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Operation Process - Factoring Finance Interest</TITLE>"); 
			out.println("</HEAD>"); 
			...
			//out.println("		document.DIV_TXT_INVOICE_START.style.color='red';"); commented by Chatura Jayawardena
		...
		//	out.println("		document.DIV_TXT_INVOICE_START.style.color='red';"); commented by Chatura Jayawardena
			...
			//out.println("		document.DIV_TXT_INVOICE_END.style.color='red';");  commented by Chatura Jayawardena
			out.println("		return false;"); 
			out.println("	}");
			...
			out.println("	if(checkMonthLength(document.Form1.TXT_ST_DD,document.Form1.TXT_ST_MM,document.Form1.TXT_ST_YY) && checkMonthLength(document.Form1.TXT_END_DD,document.Form1.TXT_END_MM,document.Form1.TXT_END_YY)){");  //added by Chatura Jayawardena
			out.println("	if(document.Form1.TXT_INTEREST_AMT.disabled ==false){");  //added by Chatura Jayawardena
			out.println("	if(isnumberok(document.Form1.TXT_INTEREST_AMT,8)){");  //added by Chatura Jayawardena
			...
			out.println("	}");
			out.println("}else{");
			out.println("alert(\"Enter a valid Interest Rate\");");
			out.println("document.Form1.TXT_INTEREST_AMT.value =0;");
			out.println("document.Form1.TXT_INTEREST_AMT.focus();");
			out.println("}");
			out.println("}else{");
			out.println("	if(validate_data() ){");
			out.println("		m_rpt_st_date=document.Form1.TXT_ST_DD.value+'-'+document.Form1.TXT_ST_MM.value+'-'+document.Form1.TXT_ST_YY.value;");
			...
			out.println("		m_rpt_st_date=document.Form1.TXT_ST_DD.value+'-'+document.Form1.TXT_ST_MM.value+'-'+document.Form1.TXT_ST_YY.value;");
			out.println("		m_rpt_end_date=document.Form1.TXT_END_DD.value+'-'+document.Form1.TXT_END_MM.value+'-'+document.Form1.TXT_END_YY.value;");
			out.println("		window.open(servlet_client_url+\":\"+client_t3_port+\"/\"+client_name+\"FA_RPT_display_accounts_interest_report2?chksql=MAIN&start_date=\"+m_rpt_st_date+\"&end_date=\"+m_rpt_end_date+\"&int_rate=\"+document.Form1.TXT_INTEREST_AMT.value,'popupwin1','status=0,menubar=0,scrollbars=1,height=500,width=700');");
			out.println("	}");
			out.println("}else{");
			out.println("alert(\"Enter a valid Interest Rate\");");
			out.println("document.Form1.TXT_INTEREST_AMT.value =0;");
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"FA_RPT_Accounts_Main_Interest';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("	help_box.innerHTML=\" Operation Process - Factoring Finance Interest - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\" Operation Process - Factoring Finance Interest - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
		...
		//	out.println(" alert('vec_len' +vec_len)");
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Operation Process - Factoring Finance Interest</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("</tr>");
			out.println("<tr >");
			out.println("<td width=\"15%\"><DIV id=\"DIV_TXT_INVOICE_START\" class=div_input>Interest Rate (%)</DIV></td>");
			out.println("<td width=\"40%\"><input class=\"txt_input5\" type=\"text\" name=\"TXT_INTEREST_AMT\" maxlength=\"8\" size=\"8\"  value=\"0.00\"></td>");
			...
			out.println("<input class='but_input' type='button' name='BUT_HELP_MAIN_RPT2' value=\"View Report 2\" onClick=\"view_report2()\" style='width:100'>");
			out.println("</td>");
			out.println("</tr>");
			out.println("</table>"); 
			out.println("<hr>");
