...
public class LAKDL_AF_CR_display_application_guarantors extends javax.servlet.http.HttpServlet { 
  ...
  public ResultSet rs,rs1;
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
	    ...
	    String m_schema_name = m_sn_methods.schema_name.trim();
			...
			out.println("}");
			out.println("url=\""+m_class_url+"/"+m_schema_name+"_AF_CR_display_application_guarantors?chksql=pop_guarantors&APP_NO=\"+m_app_no;");
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_schema_name+"_AF_CR_display_application_guarantors?chksql=main_page&APP_NO='+m_app_no ;"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("function load_new_guarantor(){");
	    out.println("m_url=\""+m_class_url+"/"+m_schema_name+"_AF_MAS_display_client_creation\" ;");
	    out.println("window.open(m_url,'displayWindow4','left=0,top=0,width=950,height=550,toolbar=0,location=0,directories=0,status=0,menuBar=1,scrollBars=1,resizable=1');"); 
 			out.println("}");
	    ...
	    out.println("m_url=\""+m_class_url+"/"+m_schema_name+"_AF_MAS_display_client_creation?client_code=\"+m_guarantor_code+\"&client_type=\"+guarantor_type+\"&inquiry_no=\" ;");
			...
			out.println("<td width='10%' align='center'></td>");  
			out.println("<td width='10%' align='center'></td>");  
			out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' style='{width:120};' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Create Guarantors\");' onClick='load_new_guarantor()' value=\"Create Guarantors\"></td>");  
