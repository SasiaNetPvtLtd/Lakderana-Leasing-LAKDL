...
public class LAKDL_AF_MAS_display_broker extends javax.servlet.http.HttpServlet { 
...
*/
      ...
      out.println(" function assign_help_status(obj){");
	  	...
	  	out.println("		}"); 
			...
			out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Deactivate\");' onClick='load_screen_status(\"DACT\")' value=\"De-activate\" disabled ></td>"); // disabled by udara 28-09-2018 
			out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Reactivate\");' onClick='load_screen_status(\"RACT\")' value=\"Re-activate\" disabled ></td>"); // disabled by udara 28-09-2018
			out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Blacklist\");' onClick='load_screen_status(\"BLAK\")' value=\"Black-list\" disabled ></td>"); // disabled by udara 28-09-2018
			...
			*/
			...
			//out.println("<td width='20%' >Fax No </td>"); // commented by udara 28-03-2022
			out.println("<td width='20%' >Account Number </td>"); // added by udara 28-03-2022
