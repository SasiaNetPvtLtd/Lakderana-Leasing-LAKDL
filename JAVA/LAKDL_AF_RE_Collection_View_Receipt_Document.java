...
public class LAKDL_AF_RE_Collection_View_Receipt_Document extends javax.servlet.http.HttpServlet {
   ...
   //   String m_username 						= "AA";//m_sn_methods.username;
	...
	//		m_ac_status = req.getParameter("ac_status");
        ...
        out.println("<html>");
			...
			out.println("m_client_code=data_vec[5];");
      ...
      out.println("			}");
			...
			out.println("popupwin = window.showModalDialog('"+m_class_url+"/"+m_fschema_name+"AF_RE_Help_Servlet?class_in="+m_fschema_name+"AF_RE_help_select&Sql_in='+Sql+'&Start_in='+Start+'&End_in='+End+'&Crit_In='+Crit+'&Hid_No='+Hid_No+'&Max_in='+Hid_No+'&Args=', oBj,\"dialogWidth:35em; dialogHeight:26em; center:yes; status:no\");");
			...
			out.println("		help_receipt_no_assign(oBj);"); 
	  	out.println("		}"); 
		...
		//  out.println("m_user_clear=\"TXT_USER\"+document.Form1.hid_row_no.value;");
			...
			out.println("function help_receipt_no() {"); 
			
			out.println("Crit=document.Form1.TXT_RECEIPT_NO.value+\"@\";");

			out.println("    HelpBox('1','10','0',Crit,'ReceiptSql','1');"); 
			out.println("}"); 
			out.println(""); 

			out.println("function help_receipt_no_assign(oBj) {"); 
			out.println("    document.Form1.TXT_RECEIPT_NO.value=oBj.valout[2];"); 
			
	
			
			out.println("m_client_code=oBj.valout[6]"); 
			...
			*/
			...
			out.println("function val_receipt_no(obj){");
				
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_sql_validations?chksql=m_prime_chk_LAKDL_AF_RE_get_receipt_no&data_val=\"+obj.value;");
		...
		//--------------------------------------------------------------------------		
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_RE_Collection_View_Receipt_Document';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("help_box.innerHTML=\" Collection Process - Receipt Document - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" Collection Process - Receipt Document - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
			...
			out.println("}");
			out.println("else{");
			out.println("	m_url = \""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_RE_Receipt_Document?chksql=main_page&receipt_no=\"+document.Form1.TXT_RECEIPT_NO.value+\"&client_no=\"+m_client_code+\"&print=TRUE\";"); 
			out.println("popupwin=window.open(m_url,'displayWindow2','left=110,top=110,width=620,height=800,toolbar=0,location=0,center:yes,direction=0,menuBar=1,status=0,scrollbars=1,resizable=1');");
			out.println("}");
			out.println("}");
			*/
			...
			out.println("}");
			out.println("else{");
			out.println("	m_url = \""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_RE_Receipt_Document_New?chksql=main_page&receipt_no=\"+document.Form1.TXT_RECEIPT_NO.value+\"&client_no=\"+m_client_code+\"&print=TRUE\";"); 
			//out.println("	m_url = \""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_RE_Receipt_Document_temp?chksql=main_page&receipt_no=\"+document.Form1.TXT_RECEIPT_NO.value+\"&client_no=\"+m_client_code+\"&print=TRUE\";"); 	
			...
			out.println("function letter_inital() {"); 
			out.println("if(document.Form1.TXT_RECEIPT_NO.value==''){");
			out.println("DIV_TXT_RECEIPT_NO.style.color='red';");
			out.println("alert(\"Please enter all required fields marked with a '*' on screen\");");
			out.println("}");
			out.println("else{");
			out.println("	m_url = \""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_RE_Receipt_Initail_Payment_BreakDown?chksql=LOAD_CHARGES_DETAILS&receipt_no=\"+document.Form1.TXT_RECEIPT_NO.value+\"&client_no=\"+m_client_code+\"&print=TRUE\";"); 
			out.println("popupwin=window.open(m_url,'displayWindow2','left=110,top=110,width=620,height=800,toolbar=0,location=0,center:yes,direction=0,menuBar=0,status=0,scrollbars=1,resizable=1');");
			out.println("}");
			out.println("}");
      ...
      out.println("</Script>");
			    ...
			    out.println("<INPUT TYPE='Hidden' NAME='hid_no_rec' VALUE=\"\">"); 
					...
					out.println("</tr>"); 
					out.println("<tr>"); 
					out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Collection Process - Receipt Document</td>"); 
					out.println("</tr>"); 
					out.println("<tr>"); 
			...
			//		out.println("<tr><td width='10%' align='center'><input type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"New\");' onclick='load_screen_status(\"NEW\")' value=\"New\"></td>");  
				...
				//	out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Help\");' onClick='load_screen_status(\"HELP\")' value=\"Help\"></td>");  
					...
					out.println("<tr>"); 
					out.println("<td width='30%' ><DIV id='DIV_TXT_RECEIPT_NO'  class=div_input>Receipt No *</DIV></td>"); 
					out.println("<td width='30%' ><input class='txt_input' type='text' name='TXT_RECEIPT_NO' maxlength='30' size='30' onblur=\"help_receipt_no()\">"); 
			    out.println("<input class='but_input' type='button' name='BUT_TXT_RECEIPT_NO' value=\"Help\" onClick=\"help_receipt_no()\"></td>"); 
					...
					out.println("<td width='10%'><input class='but_input' type='button' name='BUT_BCODE' value=\"View Receipt\" onClick=\"letter()\" style='{cursor:hand;}' style='{cursor:hand; width:120px;}'></td>"); 
					out.println("<td width='10%'><input class='but_input' type='button' name='BUT_BCODE' value=\"Inital Break Down\" onClick=\"letter_inital()\" style='{cursor:hand; width:120px;}'></td>"); 
					out.println("</tr>"); 
