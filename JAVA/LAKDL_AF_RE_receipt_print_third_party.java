...
public class LAKDL_AF_RE_receipt_print_third_party extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			if(m_chksql.equals("main_page")){
				...
				out.println("<HTML>"); 
				out.println("<HEAD>"); 
				out.println("<TITLE>Receipts - Print </TITLE>"); 
				out.println("</HEAD>"); 
				...
				out.println("		m_receipt_details.innerHTML=m_data;");
				out.println("}");
				...
				out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_print_third_party?chksql=main_page';"); 
				out.println("		}"); 
				out.println("}"); 
				...
				out.println("	help_box.innerHTML=\" Receipts - Print - Third Party \"+m_val;"); 
				out.println("}"); 
				
				out.println("function load_roll_out_value(){");
				out.println("	help_box.innerHTML=\" Receipts - Print \";"); 
				out.println("}"); 
				...
				out.println("function bulk_print_text_print(val){"); 
				//out.println("alert('val--'+val);		"); 
				out.println(" 	m_to_dd = document.Form1.TXT_TO_DATE_DD.value ");
				out.println(" 	m_to_mm = document.Form1.TXT_TO_DATE_MM.value ");
				out.println(" 	m_to_yy = document.Form1.TXT_TO_DATE_YY.value ");
				...
				out.println("		if(validate_date()) {");		
				//m_url=servlet_client_url+":"+client_t3_port+"/"+client_name+"cheq_printing?chksql=PRINT&ref_no="+m_sus_refno;
				out.println("   m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_Bulk_Print_Main_SO?chksql=STANDING_ORDER_BULK_TEST_PRINT&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&print_type=\"+val+\"\";");
				out.println("document.Form1.submit();");	
				...
				out.println("function bulk_print_text(val){"); 
				//out.println("alert('val--'+val);		"); 
				out.println(" 	m_to_dd = document.Form1.TXT_TO_DATE_DD.value ");
				out.println(" 	m_to_mm = document.Form1.TXT_TO_DATE_MM.value ");
				out.println(" 	m_to_yy = document.Form1.TXT_TO_DATE_YY.value ");
				...
				out.println("		if(validate_date()) {");		
				//m_url=servlet_client_url+":"+client_t3_port+"/"+client_name+"cheq_printing?chksql=PRINT&ref_no="+m_sus_refno;
				out.println("   m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_Bulk_Print_Main_SO?chksql=STANDING_ORDER_BULK_TEST&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&print_type=\"+val+\"\";");
				out.println("document.Form1.submit();");	
				...
				out.println("function get_receipt_det(val){"); 
				...
				out.println(" 	m_from_date = m_from_dd+\"-\"+m_from_mm+\"-\"+m_from_yy; ");
				out.println("   if(validate_date()) {");	
				out.println("       m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_print_normal?chksql=get_receipt_details_third&user=\"+val+\"&from_date=\"+m_from_date+\"&to_date=\"+m_to_date;");	
				...
				out.println("function print_receipt(val1,val2) {"); 
				//out.println("m_url = \""+m_class_url+"/"+m_fschema_name+"AF_RE_Receipt_Document?chksql=main_page&receipt_no=\"+val1+\"&client_no=\"+val2+\"&print=TRUE\";"); 
				out.println("  m_url = \""+m_class_url+"/"+m_fschema_name+"AF_RE_Receipt_Document_New?chksql=main_page&receipt_no=\"+val1+\"&client_no=\"+val2+\"&print=TRUE\";"); //added by kanishka on 19-07-2013
				...
				out.println("</tr>"); 
				out.println("<tr>"); 
				out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Receipts - Print </td>"); 
				out.println("</tr>"); 
				out.println("<tr>"); 
				...
				out.println("<td width='20%' ><input class='but_input' style = 'width:150px' type='button' name='BUT_VIEW_SO' value=\"View Receipts\" onClick=\"get_receipt_det(document.Form1.USER.value)\"></td>");	//bulk_print('ALL')
				...
				//out.println("<td width='10%' ><input class='but_input' style = 'width:60px' type='button' name='BUT_PRINT_TEXT' value=\"Text\" onClick=\"bulk_print_text(document.Form1.USER.value)\"></td>");	
				
				//out.println("<td width='10%' ><input class='but_input' style = 'width:60px' type='button' name='BUT_PRINT_TEXT' value=\"Print\" onClick=\"bulk_print_text_print(document.Form1.USER.value)\"></td>");	
				...
				out.println("<tr>"); 
				out.println("<td width='100%' class='note'><DIV ID=m_receipt_details></DIV></td>"); 
				out.println("</tr>"); 
				out.println("</table>"); 
