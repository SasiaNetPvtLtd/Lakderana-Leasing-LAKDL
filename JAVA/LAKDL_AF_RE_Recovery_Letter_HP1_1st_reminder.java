...
public class LAKDL_AF_RE_Recovery_Letter_HP1_1st_reminder extends javax.servlet.http.HttpServlet { 
		...
		" WHERE APPLICATION_NO=UPPER('"+m_application_no+"') AND CLIENT_CODE=UPPER('"+m_client_code+"') AND DOCUMENT_CODE=UPPER('"+m_document_code+"') ");
			...
			m_status=req.getParameter("status");
				...
				while(rs.next()){	//Edited by Minal on 13-07-2015 for #17336
					...
					out.println("<tr><td width=\"100%\" class='txt-body'><font size=2.7 >"+m_add2+", "+m_city_name+"</font></td></tr>");
					out.println("</table>");
					out.println("</p></blockquote>");	
					...
					out.println("<tr><td width='*%' class='txt-body' style='text-align:right'><font size=2.7 ><b><i></i></b></font></td></tr>");//Without prejudice
					out.println("</table>");
					out.println("</p></blockquote>");
					...
					data="Please treat this information as a helpful reminder on your above Hire Purchase Agreement.";
					...
					//data="We presume that due to your busy work schedule, you may have missed your payment which was due on "+m_date+", which now amounts to Rs. "+m_due_amount+".";	
					data="We presume that due to your busy work schedule, you may have missed your payment which was in arrears amounting to Rs."+m_due_amount+" as at date.";// "+m_date+".";//Changed by Minal on 04-06-2015 for #16321 //Changed by Minal on 06-06-2015 for #16321
					...
					data=  "If you have not settled this payment, please be good enough to arrange for same at your earliest.";
					...
					data= "If you wish to inquire about this payment, please call us on "+m_orient_tel_no+".";
					...
					data= "Thanking You,";
					//String  data1= "<b>MELSTA REGAL FINANCE LIMITED</b>";
					...
					*/
					...
					data= "This is an auto generated reminder and requires no signature.";
					
					
					out.println("<blockquote><p style='text-align:left'>");	
					out.println("<table border='0' width='90%' class='table'>"); 		
					out.println("<td width='*%' class='txt-body' style='text-align:justify' ><font size=1.9 >"+data+"</font></td>");
					out.println("</tr></table>");
					out.println("</p></blockquote>");
					...
					//data= " Please obtain an official receipt upon your payment from Melsta Regal Finance Ltd.";
