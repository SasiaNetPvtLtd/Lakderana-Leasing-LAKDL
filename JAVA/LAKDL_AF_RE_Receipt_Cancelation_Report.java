...
public class LAKDL_AF_RE_Receipt_Cancelation_Report extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
   		...
   		nf1 = java.text.NumberFormat.getInstance(Locale.US);
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Collection - Receipt Cancellation Report </TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("	help_box.innerHTML=\" Collection - Receipt Cancellation Report - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\" Collection - Receipt Cancellation Report \";"); 
			out.println("}"); 
	  	...
	  	out.println("					}"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Collection - Receipt Cancellation Report </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<input class=\"txt_input5\" type=\"text\" name=TXT_TO_DATE_YY maxlength=\"4\" size=\"4\" >&nbsp;&nbsp;&nbsp;&nbsp; <input class='but_input' type='button' name='BUT_HELP_MAIN_1' value=\"View\" onClick=\"makeRequest_detail()\">");	
			out.println("</td> ");
