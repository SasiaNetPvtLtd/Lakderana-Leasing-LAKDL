...
public class LAKDL_FA_MISF_factor_client_list_report extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Factor Client List Report </TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("function show_factor_client_list_report() {");
			out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"FA_MISF_reports?chksql=LOAD_FACTOR_CLIENT_LIST_REPORT&client_type=\"+document.Form1.TXT_CLIENT_TYPE.value+\"&factoring_type=\"+document.Form1.TXT_CLIENT_RELATIONSHIP.value+\"&status=\"+document.Form1.TXT_CLIENT_STATUS.value;");
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"FA_MISF_factor_client_list_report';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("	help_box.innerHTML=\" Factor Client List Report - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\" Factor Client List Report \";"); 
			out.println("}"); 
	  	...
	  	out.println("					}"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Factor Client List Report </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<table class='table' width='100%'  >"); 
			out.println("<tr >"); 
			out.println("<td width='15%' ><b>Client Type </b></td>"); 
			out.println("<td width='20%' ><select name='TXT_CLIENT_TYPE' style='width:100' class='txt_input'>");
			...
			out.println("<table class='table' width='100%'  >"); 
			out.println("<tr >"); 
			out.println("<td width='15%' ><b>Factoring Relationship </b></td>"); 
			out.println("<td width='20%' ><select name='TXT_CLIENT_RELATIONSHIP' style='width:130' class='txt_input'>");
			out.println("<option value=\"C\">As a Client</option>");
			...
			out.println("<table class='table' width='100%'  >"); 
			out.println("<tr >"); 
			out.println("<td width='15%' ><b>Client Status </b></td>"); 
			out.println("<td width='20%' ><select name='TXT_CLIENT_STATUS' style='width:130' class='txt_input'>");
			out.println("<option value=\"E\">Client Creation</option>");
			out.println("<option value=\"I\">Approved Initial</option>");
			out.println("<option value=\"Y\">Approved Credit</option>");
			out.println("<option value=\"N\">Disapproved Client</option>");
			out.println("<option value=\"T\">Terminated</option>");
			out.println("<option value=\"\" SELECTED>All</option>");
			out.println("</select></td>");
			out.println("<td width='*%'><input class='but_input' type='button' name='BUT_VIEW_MAIN' value=\"View\" onClick=\"show_factor_client_list_report()\"></td>"); 
			out.println("</tr>");
			out.println("</table>");  
			out.println("</form>"); 
