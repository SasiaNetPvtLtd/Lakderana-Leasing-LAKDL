...
//--
//SCREEN NAME:SYSTEM ADMINISTRATION - LEGAL ENTITY
//CREATED BY:
//DATE/TIME:
//NOTES:
...
public class LAKDL_AF_MAS_display_legal_entity extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>System Administration - Legal Entities</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("			}");
			out.println("else if(data_vec.length==0 && document.Form1.SCREEN_NAME.value!=\"NEW\" && document.Form1.TXT_ENTITY_CODE.value!='' && document.Form1.hid_val.value=='t1'){");
		///	out.println("alert('Selected Entity code is incorrect,use help...!')");
			//out.println("document.Form1.TXT_ENTITY_CODE.value='';"); 
			//out.println("document.Form1.TXT_ENTITY_CODE.focus();"); 
			...
			out.println("else if(data_vec.length>0 && document.Form1.SCREEN_NAME.value!=\"NEW\" && document.Form1.TXT_ENTITY_CODE.value!='' && document.Form1.hid_val.value=='t1'){");
			out.println("document.Form1.TXT_ENTITY_CODE.value=data_vec[0];"); 
			...
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_legal_entity_code&data_val=\"+obj.value;");
			out.println("}");
			out.println("    else");
			out.println("    if(document.Form1.hid_val.value=='t2'){");
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations1?chksql=m_prime_chk_LAKDL_AF_MAS_display_legal_entity_desc&data_val=\"+obj.value;");
			out.println("}");
			out.println("    else");
   // 	out.println("    if(document.Form1.SCREEN_NAME.value==\"RACT\" && document.Form1.hid_chk_status.value=='M1' )");
      out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_legal_entity&data_val=\"+obj.value+\"&ac_status=\"+document.Form1.hid_st.value;");
	//		out.println("else");
		//	out.println("if(document.Form1.hid_chk_status.value=='M2')");
		//	out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_division_desc&data_val=\"+obj.value;");
			...
			out.println("if(document.Form1.TXT_ENTITY_CODE.value==\"\"){  "); 
			out.println("DIV_TXT_ENTITY_CODE.style.color='red';");
			...
			out.println("}");
			out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_MAS_save_legal_entity';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MAS_display_legal_entity';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("    m_help_message = \"m_help_msg_LAKDL_AF_MAS_display_legal_entity\";"); 
			...
			out.println("help_box.innerHTML=\" System Administration - Legal Entities - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" System Administration - Legal Entities - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
			...
			//out.println("document.Form1.TXT_ENTITY_CODE.disabled=true;"); 
		  ...
		  out.println("    document.Form1.TXT_ENTITY_CODE.focus();"); 
			...
			out.println("    m_sql = \"m_help_TXT_ENTITY_CODE_sql\";"); 
			out.println("    m_criteria = document.Form1.TXT_ENTITY_CODE.value+\"@Y@\";"); 
			out.println("    HelpBox('1','10','0');"); 
			out.println("}"); 
			out.println(""); 

			out.println("function help_value_assign_1() {"); 
			out.println("    document.Form1.TXT_ENTITY_CODE.value=oBj.valout[2];"); 
			out.println("}"); 
			...
			out.println("    } ");
			out.println("    else{");
			out.println("    m_criteria = document.Form1.TXT_ENTITY_CODE.value+\"@\"+\"N@\";}"); 
			out.println("    HelpBox('1','10','0');"); 
			out.println("}"); 
			...
			out.println("    m_sql = \"m_help_TXT_ENTITY_DESC_sql\";"); 
	  	...
	  	out.println("		}"); 
			...
			out.println("    m_sql = \"m_view_TXT_ENTITY_CODE_sql\";");
			out.println("    m_criteria = document.Form1.TXT_ENTITY_CODE.value+\"@\"+\"Y@\";"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>System Administration - Legal Entities</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<td width='30%' ><DIV id='DIV_TXT_ENTITY_CODE'  class=div_input>Legal Entity Code *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_ENTITY_CODE' maxlength='10' size='10' onblur=\"assig('t1'),makeRequest(document.Form1.TXT_ENTITY_CODE)\">"); 
			out.println("<input class='but_input' type='button' name='BUT_HELP_MAIN' value=\"Help\" onClick=\"help_update()\" disabled></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 

			out.println("<td width='30%' ><DIV id='DIV_TXT_DESCRIPTION'  class=div_input> Legal Entity Description *</DIV></td>"); 
