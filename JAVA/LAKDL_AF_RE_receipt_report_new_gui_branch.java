...
public class LAKDL_AF_RE_receipt_report_new_gui_branch extends javax.servlet.http.HttpServlet { 
			...
			if(m_chksql.equals("main_page")){
				...
				if (m_location_code.trim().equals("ALL")) {
					...
					rs1= stmt1.executeQuery(" SELECT "+
						...
						" WHERE  A.REC_NO = B.REC_NO (+) "+//enable client reciepts 2017-09-25
				...
				out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report_new_gui_branch?chksql=load_receipts&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=\"+m_sort_col+\"&sort_by=\"+m_order_by_type+\"&user=&location_code=\"+m_location_code+\"&branch_id=\"+m_branch_id;"); 
				...
				while(more){
					...
					out.println("<td  class=div_input ><p>"+rs1.getString(19)+"</p></td>"); // udara 11-08-2014
