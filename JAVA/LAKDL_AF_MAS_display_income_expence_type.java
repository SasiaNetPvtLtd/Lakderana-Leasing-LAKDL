...
//SCREEN NAME:SYSTEM ADMINISTRATION - INCOME EXPENCE TYPE
...
public class LAKDL_AF_MAS_display_income_expence_type extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>System Administration - Income Expence Types</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("			}");
			out.println("		  else	if(data_vec.length > 0 && document.Form1.SCREEN_NAME.value!=\"NEW\"&& document.Form1.TXT_I_E_CODE.value !='' && document.Form1.hid_help_status.value == 'H1' ){");
			out.println("				assign_data(data_vec);");
			out.println("			}");
			out.println("		  else	if(data_vec.length == 0 && document.Form1.SCREEN_NAME.value!=\"NEW\"&& document.Form1.TXT_I_E_CODE.value !=''&& document.Form1.hid_help_status.value == 'H1' ){");
			out.println("         help_update(); ");
			//out.println("				alert('Invalid Code,Use Help');");
			//out.println("				document.Form1.TXT_I_E_CODE.value='';");
			//out.println("       document.Form1.TXT_I_E_CODE.focus();");
			//out.println("				new_window();");
			out.println("			}");
		  ...
		  out.println("			  document.Form1.TXT_DESCRIPTION.value=\"\" ");
			...
			out.println("if(document.Form1.hid_help_status.value == 'H1' && document.Form1.SCREEN_NAME.value!=\"RACT\" && document.Form1.SCREEN_NAME.value==\"NEW\" ) ");
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations1?chksql=m_prime_chk_LAKDL_AF_MAS_display_income_expence_type&data_val=\"+obj.value;");
			out.println("else");
			out.println("if(document.Form1.hid_help_status.value == 'H1' && document.Form1.SCREEN_NAME.value!=\"RACT\" ) ");
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_income_expence_type&data_val=\"+obj.value+\"&ac_status=Y\";");
			out.println("else");
			out.println("if(document.Form1.hid_help_status.value == 'H1' && document.Form1.SCREEN_NAME.value==\"RACT\" ) ");
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_income_expence_type&data_val=\"+obj.value+\"&ac_status=N\";");
			out.println("else");
			out.println("if(document.Form1.hid_help_status.value == 'H2'  ) "); //&& document.Form1.SCREEN_NAME.value==\"NEW\" modifed nuwan de silva 28-06-07
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations1?chksql=m_prime_chk_LAKDL_AF_MAS_display_income_expence_type_desc&data_val=\"+obj.value ;");
     // out.println("window.open(m_url);");
		  ...
		  out.println("    document.Form1.TXT_I_E_CODE.value=data_vec[0];"); 
			...
			out.println("if(document.Form1.TXT_I_E_CODE.value==\"\"){  "); 
			out.println("DIV_TXT_I_E_CODE.style.color='red';");
      ...
      out.println("		if(validate_data()){"); 
			...
			out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_MAS_save_income_expence_type';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MAS_display_income_expence_type';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("    m_help_message = \"m_help_msg_LAKDL_AF_MAS_display_income_expence_type\";"); 
			...
			out.println("help_box.innerHTML=\" System Administration - Income Expense Types - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" System Administration - Income Expense Types - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
	  	...
	  	out.println("		}"); 
			...
			out.println("    m_sql = \"m_help_TXT_I_E_CODE_sql_desc\";"); 
			...
			out.println("    m_sql = \"m_help_TXT_I_E_CODE_sql\";"); 
			out.println("    if(document.Form1.SCREEN_NAME.value==\"EDIT\" || document.Form1.SCREEN_NAME.value==\"DACT\"){ ");
			out.println("    m_criteria = document.Form1.TXT_I_E_CODE.value+\"@\"+\"Y@\";"); 
			out.println("    } ");
			out.println("    else{");
			out.println("    m_criteria = document.Form1.TXT_I_E_CODE.value+\"@\"+\"N@\";}"); 
			out.println("    HelpBox('1','10','0');"); 
			out.println("}"); 
			...
			out.println("    document.Form1.TXT_I_E_CODE.value=oBj.valout[2];"); 
      ...
      out.println(" }");
	  	...
	  	out.println("		}"); 
			...
			out.println("    m_sql = \"m_view_TXT_I_E_CODE_sql\";");
			out.println("    m_criteria = document.Form1.TXT_I_E_CODE.value+\"@\"+\"Y@\";"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>System Administration - Income Expence Types</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<td width='30%' ><DIV id='DIV_TXT_I_E_CODE'  class=div_input>Income Expense Code *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_I_E_CODE' maxlength='10' size='10' onblur=\"assign_help_status('H1'),makeRequest(document.Form1.TXT_I_E_CODE)\">"); 
			...
			out.println("<tr >"); 
			out.println("<td width='30%' >Income Expense Type </td>"); 
			out.println("<td>");
			out.println("<select name='TXT_TYPE' class=\"txt_input\" >");
			out.println("<OPTION value=\"IN\" SELECTED >Income </option>");
			out.println("<OPTION value=\"EX\" >Expense </option>");
			...
			out.println("<td width='30%' ><DIV id='DIV_TXT_DESCRIPTION'  class=div_input>Income Expense Description *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_DESCRIPTION' maxlength='50' style={width:250px} size='20' onblur=\"assign_help_status('H2'),makeRequest(document.Form1.TXT_DESCRIPTION)\"></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 
