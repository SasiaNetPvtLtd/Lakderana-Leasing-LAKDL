...
public class LAKDL_FA_OP_cheque_return_reminder extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Operation Process - Cheque Return Reminders </TITLE>"); 
			out.println("</HEAD>"); 
  		...
  		out.println("		}");
   		...
   		out.println("}"); 
			...
			out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"FA_OP_PRO_rpt_cheque_return_reminder?chksql=LOAD_FINAL_CHEQUE_RETURN_REMINDER_PERIOD&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"\";");
			...
			out.println("function Generate_Letter1(m_return_no,m_client_code,m_debtor_code,m_receipt_no) {");	
			out.println("	m_url = \""+m_class_url+"/"+m_fschema_name+"FA_OP_Initial_Cheque_Return_Reminder_Letter?chksql=main_page&client_no=\"+m_client_code+\"&debtor_code=\"+m_debtor_code+\"&print=TRUE&receipt_no=\"+m_receipt_no+\"&return_no=\"+m_return_no;"); 
			...
			out.println("function Generate_Letter2(m_return_no,m_client_code,m_debtor_code,m_receipt_no) {");	
			out.println("	m_url = \""+m_class_url+"/"+m_fschema_name+"FA_OP_Final_Chq_Return_Reminder_Letter_without_rem?chksql=main_page&client_no=\"+m_client_code+\"&debtor_code=\"+m_debtor_code+\"&print=TRUE&receipt_no=\"+m_receipt_no+\"&return_no=\"+m_return_no;"); 
			out.println(" popupwin=window.open(m_url,'displayWindow2','left=110,top=110,width=750,height=300,toolbar=0,location=0,center:yes,direction=0,menuBar=1,status=0,scrollbars=1,resizable=1');");
			out.println("}");	
			
			out.println("function Generate_Letter3(m_return_no,m_client_code,m_debtor_code,m_receipt_no,m_remark) {");	
			out.println("	m_url = \""+m_class_url+"/"+m_fschema_name+"FA_OP_Final_Chq_Return_Reminder_Letter_with_rem?chksql=main_page&client_no=\"+m_client_code+\"&debtor_code=\"+m_debtor_code+\"&print=TRUE&receipt_no=\"+m_receipt_no+\"&remark=\"+m_remark+\"&return_no=\"+m_return_no;"); 
			out.println(" popupwin=window.open(m_url,'displayWindow2','left=110,top=110,width=750,height=300,toolbar=0,location=0,center:yes,direction=0,menuBar=1,status=0,scrollbars=1,resizable=1');");
			out.println("}");	
			...
			out.println("			}");
			out.println("			if(validate_data()){"); 
			out.println("				document.Form1.action='"+m_class_url+"/"+m_fschema_name+"FA_OP_save_cheque_return_reminder';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"FA_OP_cheque_return_reminder';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("	help_box.innerHTML=\" Operation Process - Cheque Return Reminders - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\" Operation Process - Cheque Return Reminders \";"); 
			out.println("}"); 
	  	...
	  	out.println("					}"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Operation Process - Cheque Return Reminders </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println(" <TD WIDTH=\"15%\"><input class=\"txt_input5\" type=\"text\" name=TXT_TO_DATE_DD maxlength=\"2\" size=\"2\" >");
