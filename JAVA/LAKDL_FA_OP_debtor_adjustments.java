...
public class LAKDL_FA_OP_debtor_adjustments extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Operation Process - Debtor Adjustments </TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("			}");
			out.println("			if(validate_data()){"); 
			out.println("				document.Form1.action='"+m_class_url+"/"+m_fschema_name+"FA_OP_Save_debtor_adjust';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"FA_OP_debtor_adjustments';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("    m_help_message = \"m_help_msg_LAKDL_FA_CR_DEBTOR_ADJUSTMENTS\";"); 
			...
			out.println("	help_box.innerHTML=\"  Operation Process - Debtor Adjustments - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\"  Operation Process - Debtor Adjustments - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
	  	...
	  	out.println("					}");  
			...
			out.println(" 	m_sql = \"m_help_DIV_TXT_FACILITY_ADJUST_ENTER_sql\";"); 
			...
			out.println(" 	m_sql = \"m_help_DIV_TXT_DEBTOR_ADJUEST_sql\";"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Operation Process - Debtor Adjustments </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<input class='but_input' type='button' name='BUT_HELP_MAIN_1' value=\"Help\" onClick=\"help_update_debtor()\">");
			...
			out.println("<input class=\"txt_input5\" type=\"text\" name=\"TXT_ADJ_YY\" maxlength=\"4\" size=\"4\"  onblur=\"checkMonthLength(document.Form1.TXT_ADJ_DD,document.Form1.TXT_ADJ_MM,document.Form1.TXT_ADJ_YY)\">[DD-MM-YYYY]</td>");
			out.println("<td width='*%'></td>"); 
			out.println("</tr>");
			out.println("<tr >"); 
			...
			out.println("<td width='40%' ><select name=\"TXT_ADJ_TYPE\" class='txt_input'><OPTION value=\"CR\" SELECTED>CR</option><OPTION value=\"DR\">DR</option></SELECT></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>");
			out.println("</table>"); 
