...
public class LAKDL_AF_MISF_Total_Unsettle_Report extends javax.servlet.http.HttpServlet { 
	...
	public  void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { // synchronized
		...
		try { 
			...
			if(m_chksql.equals("main_page")){ 
				...
				out.println("<HTML>"); 
				out.println("<HEAD>"); 
				out.println("<TITLE>Collection - Total Unsettle Report</TITLE>"); 
				out.println("</HEAD>"); 
				...
				out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Total_Unsettle_Report?chksql=print_report_new&location=\"+m_location+\"&officer=\"+m_officer+\"&date=\"+m_date+\"&perform_status=\"+perform_status+\"&cr_officer=\"+m_cr_officer+\"&active_status=\"+document.Form1.TXT_ACTIVE_STATUS.value+\"&region=\"+m_region;");  // added by udara on 09-05-2013 //mod by milinda 2013-10-16
				...
				out.println("help_box.innerHTML=\" Collection Process - Total Unsettle Report- \"+m_val;"); 
				out.println("}"); 
				out.println(""); 
				
				out.println("function load_roll_out_value(){");
				out.println("help_box.innerHTML=\" Collection Process - Total Unsettle Report- \"+document.Form1.hid_status.value;"); 
				out.println("}"); 
				...
				out.println("</tr>"); 
				out.println("<tr>"); 
				out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Collection Process - Total Unsettle Report</td>"); 
				out.println("</tr>"); 
				out.println("<tr>"); 
				...
				Sql_data=" SELECT  "+
					...
					" FROM "+m_schema_name+".AF_RE_TOTAL_UNSETTLE_REPORT A, "+m_schema_name+".af_co_pro_application_details B "+ //ADDED MILINDA
					...
					//" AND A.PERFORM_STATUS LIKE '"+m_perform_status+"%' "+ // commented by udara 07-10-2014 // added by udara on 09-05-2013
