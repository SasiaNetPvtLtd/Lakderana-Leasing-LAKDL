...
public class LAKDL_AF_RE_receipt_report_new_gui_loc_canceled extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			String m_username 	= m_sn_methods.username;
			 ...
			 if(m_chksql.equals("main_page_canceled_loc"))
			 {
				...
				out.println("    m_order_by_type = 'ASC'; ");
				out.println("  }");				
				out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report_new_gui_loc_canceled?chksql=main_page_canceled_loc&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=\"+m_sort_col+\"&sort_by=\"+m_order_by_type+\"&user=&location_code=\"+m_location_code+\"&branch_id=\"+m_branch_id;"); // added by udara on 27-02-2013				
