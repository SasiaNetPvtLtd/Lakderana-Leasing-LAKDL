...
public class LAKDL_FA_CR_Client_Debtor_Approval_Letter4 extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
		  ...
		  if (m_chksql.trim().equals("main_page")) {
			...
			out.println("<title>To be sent on the letter head of  Lakderana Factor </title></head>");
			...
			out.println(" div_plus_button.innerHTML=\"\" ");
    	...
    	out.println("m_writedata+'</table>';");
    	   ...
    	   //out.println("m_writedata+'</table>';");
			...
			// Added by Udara Somathilake on 18-10-2010 for Dynamic block
			/*
			out.println("function add_manual_data(){");
			out.println("			<tr> <td width=100px ><b>Inv Date</b></td>   <td width=100px><b>Inv No</b></td>   <td width=100px><b>Inv Amount(Rs)</b></td>  </tr>  "); 
			out.println("}");
			*/
			out.println("function add_manual_data(){");
			/*
         out.println("		 tax_content ='';");
         out.println("		 m_dir_count=parseInt(document.Form1.hid_manual_data_count.value);");
         out.println("		 m_dir_count++;");
         out.println("		 tax_content=tax_content+'<table class=\"table\" width=\"100%\">'+"); 
         out.println("      '<tr> '+");
         out.println("      '<td width=\"30%\"><b>'+m_dir_count+'.</b>&nbsp; Tax Type</td>'+ ");
         out.println("      '<td width=\"40%\"><input class = \"txt_input\" type = \"text\" name = \"TXT_TAXD_'+m_dir_count+'\" maxlength = \"30\" style = \"{width: 175px;}\"  ><input class=\\'but_input\\' type=\\'button\\' name=\\'BUT_HELP_MAIN_D\\' value=\"...\" onClick=\" \" /> <input class=\"but_input\" type=\"button\" name=\"BUT_DELETE_TAX_'+m_dir_count+'\" value=\" - \" onClick=\" \"></td>'+ "); 
         out.println("		 '<td width=\"*%\"></td></tr>'+"); 
         out.println("		 '</table>';");
         out.println("		 document.Form1.hid_manual_data_count.value=m_dir_count;");
         out.println("   	 document.getElementById('div_manual_data').innerHTML = document.getElementById('div_manual_data').innerHTML + tax_content ; ");
         out.println("		 alert(document.getElementById('div_manual_data').innerHTML);"); 
			*/
			
			out.println("		 tax_content ='';");
         out.println("		 m_dir_count=parseInt(document.Form1.hid_manual_data_count.value);");
         out.println("		 m_dir_count++;");
			out.println("		 tax_content = tax_content+'<table class=\"table\" width=\"100%\" cellspacing=0 >'+"); 
			out.println("		 '<tr>'+"); 
			out.println("		 '<td  width=100px ><input class=\"factoring-letter-body\" type = \"text\" name = \"TXT_TAXD_'+m_dir_count+'\" maxlength = \"30\" style = \"{width: 150px; height: 15px; border:none;  cursor:default;color: #1E1E1E; text-decoration: none; valign:top;}\"  ></td>'+");//class = \"txt_input\"
			out.println("		 '<td  width=100px ><input class=\"factoring-letter-body\" type = \"text\" name = \"TXT_TAXD_'+m_dir_count+'\" maxlength = \"30\" style = \"{width: 150px; height: 15px; border:none;  cursor:default;color: #1E1E1E; text-decoration: none; valign:top;}\"  ></td>'+"); 
			out.println("		 '<td  width=100px ><input class=\"factoring-letter-body\" type = \"text\" name = \"TXT_TAXD_'+m_dir_count+'\" maxlength = \"30\" style = \"{width: 150px; height: 15px; border:none;  cursor:default;color: #1E1E1E; text-decoration: none; valign:top;}\"  ></td>'+");
			out.println("		 '<tr>'+"); 
			out.println("		 '</table>';");
			out.println("   	 document.getElementById('div_manual_data').innerHTML = document.getElementById('div_manual_data').innerHTML + tax_content ; ");
			...
			out.println("</script>");				
			out.println("<body leftmargin='0' topmargin='0' class=body onLoad=\"add_button(); add_manual_data();\">");	
			//out.println("<body bgcolor='white'><br>");
			out.println("<form name='Form1'>");	
			out.println("<INPUT TYPE='Hidden' NAME='hid_manual_data_count' VALUE=\"\">"); 
		  ...
		  out.println("</TABLE>");
			...
			" We the <b>Lakderana Investments Limited </b> having its registered office at "+
			" No. 100, Buthgamuwa Road, Rajagiriya and the principle place of business at No. 100, Buthgamuwa Road, Rajagiriya "+
			" carrying on Factoring business under the name and style of <b>'Lakderana Factor'</b> "+
			" (referred to as <b>'Lakderana Factor'</b> herein and in all other documents as per the terms of 'Factoring Agreement' entered into with 'Lakderana Factor'.) "+
			" now provide a factoring service for your above named supplier, the benefit of whose <b>existing under mentioned and future invoices</b> "+
			" have been assigned to <b>'Lakderana Factor'</b> and therefore to whom payments should be made. "+
			
			
			
			// Commented below line by Udara Somathilake on 13-10-2010
			// " your above named supplier, the benefit of whose invoices have been assigned to <b><i>'Orient Factor'</i></b> and therefore to whom payments should be made. "+
			
			// Added below line by Udara Somathilke on 13-10-2010
			//" your above named supplier, the benefit of whose <b>existing under mentioned and future invoices</b> have been assigned to <b><i>'Orient Factor'</i></b> and therefore to whom payments should be made. "+
			" </p>"+
			
			" <p>"+
			/*
			" 		<table border=0 >"+
			" 				<tr> <td width=100px ><b>Inv Date</b></td>   <td width=100px><b>Inv No</b></td>   <td width=100px><b>Inv Amount(Rs)</b></td>  </tr>"+
			" 				<tr> <td height=40px ></td> </tr> "+
			" 		</table>"+
			*/
			
			" 		<table border=0 >"+
			" 				<tr> <td width=150px class='factoring-letter-body' ><b>Inv Date</b></td>   <td width=150px class='factoring-letter-body' ><b>Inv No</b></td>   <td width=150px class='factoring-letter-body' ><b>Inv Amount(Rs)</b></td> <td width=150px class='factoring-letter-body' ><div id = div_plus_button> <input class=\"but_input\" type=\"button\" name=\"BUT_ADD_DATA\" value=\" + \" onClick=\" add_manual_data(); \"></div> </td> </tr>"+
			" 		</table>"+
			
			" 		<table>"+
			" 			 <td height=12px class='factoring-letter-body' ><div id='div_manual_data'> </div> </td>	"+
			" 		</table>"+
			...
			out.println("<table border='0' width='80%' class='table'>"); 		
			out.println("<tr><td width='*%' class='factoring-letter-body'  style='text-align:justify'>");
			out.println("     <li style='text-align:justify' class='factoring-letter-body' > Please send your remittances drawn in favour of <b>Lakderana Investments Limited</b> together with your payment advice to us at No. 100, Buthgamuwa Road, Rajagiriya. Your debts will be discharged only on payment made directly to us.  "+
									" <br><br> "+
									"<li style='text-align:justify' class='factoring-letter-body' > Queries relating to invoices, credit notes, statements, and the actual goods or services should be directed to the supplier (and copied to <b>Lakderana Factor</b> for information purposes only). "+
									"<br><br>"+
									"<li style='text-align:justify' class='factoring-letter-body' > In view of the benefit of all supplier's invoices having been assigned to <b>Lakderana Factor</b>; it is stressed that any existing arrangement for settlement or reduction of an account due to the supplier by contra assignments should be discounted. Should you have a counter claim on the supplier for goods supplied or work done, the relative cost should be invoiced by you in the usual manner and they should then pay you directly. "+
									"<br><br> "+
									"<li style='text-align:justify' class='factoring-letter-body' > If any invoice assigned to <b>Lakderana Factor</b> is found to be incorrect in any respect, such discrepancies must be notified to Lakderana Factor immediately. "+
									"<br> ");
			out.println("</td></tr>");								
			...
			out.println("Lakderana Factor,<br><br> ");	
			out.println(" -----------------------<br>");
