...
public class LAKDL_FA_OP_Unbank_cheque_letter extends javax.servlet.http.HttpServlet { 
  ...
  public ResultSet rs1,rs2;
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
      ...
      String m_debtor_code ="";
				...
				out.println("<title>Unbank Cheque Letter</title></head>");
		...
		*/
		//Commented by Dineth on 2009-02-19
				...
				" A.FACILITY_NO='"+m_facility_no+"' AND "+
				" A.CLIENT_CODE='"+m_client_no+"' "+
				" AND TO_DATE(TO_CHAR(B.ENT_DATE,'DD-MM-YYYY'),'DD-MM-YYYY') =TO_DATE('"+m_date+"','DD-MM-YYYY') "+
				" ");*/
