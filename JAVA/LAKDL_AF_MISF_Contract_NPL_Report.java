...
public class LAKDL_AF_MISF_Contract_NPL_Report extends javax.servlet.http.HttpServlet { 
	...
	CallableStatement callstmt1 =null;
	 ResultSet rs1= null;
		...
		try { 			 
			...
			double tot_arr_cap = 0.0;
			double tot_arr_int = 0.0;
			double tot_arr_oth = 0.0;
			double tot_acc_odi = 0.0;
			double tot_exp = 0.0;
			...
			String m_branch_code=req.getParameter("branch_code"); //  Added by: Samith dilshan on 2015-05-05 , To get brach code for 'NPL Report'
			String m_ndia=req.getParameter("ndia");
			...
			if(m_chksql.equals("run_report")){ 				
				try{	
					callstmt1 = conn.prepareCall("BEGIN "+m_schema_name+".AF_CO_TBD_CONTRACT_STATUS(:1,:2,:3,:4);END;");
				...
				if(m_chksql.equals("main_page")){ 
					...
					out.println("<HTML>"); 
					out.println("<HEAD>"); 
					out.println("<TITLE>NPL Report</TITLE>"); 
					out.println("</HEAD>"); 
					...
					out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MISF_Contract_NPL_Report?chksql=main_page';"); 
					out.println("		}"); 
					out.println("}"); 
					...
					out.println("		help_box.innerHTML=\" Credit Process -NPL Report - \"+m_val;"); 
					out.println("}"); 
					...
					out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Contract_NPL_Report?chksql=run_report&date=\"+m_date+\"&client_code=\"+document.Form1.CLIENT_CODE.value+\"&branch_code=\"+document.Form1.TXT_LOCATION_CODE.value;");  // Samith :  brach:TXT_LOCATION_CODE
					...
					out.println("   m_ndia   = document.Form1.TXT_NDIA.value; "); 
					out.println("		m_date=document.Form1.VAL_DAY.value+'-'+document.Form1.VAL_MONTH.value+'-'+document.Form1.VAL_YEAR.value;");
					out.println("	if(document.Form1.VAL_DAY.value!=\"\" && document.Form1.VAL_MONTH.value!=\"\" && document.Form1.VAL_YEAR.value!=\"\"){");
					//out.println("			m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Contract_NPL_Report?chksql=print_report&date=\"+m_date+\"&client_code=\"+document.Form1.CLIENT_CODE.value+\"&branch_code=\"+document.Form1.TXT_LOCATION_CODE.value;");   // Samith :  brach:TXT_LOCATION_CODE
					out.println("			m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Contract_NPL_Report?chksql=print_report&date=\"+m_date+\"&client_code=\"+document.Form1.CLIENT_CODE.value+\"&branch_code=\"+document.Form1.TXT_LOCATION_CODE.value+\"&product_name=\"+m_product_name+\"&ndia=\"+m_ndia;"); 
					out.println("			window.open(m_url);");
					out.println("	}");
					out.println("}");
					
					
					out.println("function print_report_export(){");
					out.println("		clearTimeout(timerID);");
					out.println("		m_table.innerHTML=\"\";");
					out.println("   m_product_name   = document.Form1.TXT_PRODUCT.value; "); // added by udara 11-10-2018
					out.println("   m_ndia   = document.Form1.TXT_NDIA.value; "); 
					...
					out.println("	if(document.Form1.VAL_DAY.value!=\"\" && document.Form1.VAL_MONTH.value!=\"\" && document.Form1.VAL_YEAR.value!=\"\"){");
					//out.println("			m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Contract_NPL_Report?chksql=print_report&date=\"+m_date+\"&client_code=\"+document.Form1.CLIENT_CODE.value+\"&branch_code=\"+document.Form1.TXT_LOCATION_CODE.value;");   // Samith :  brach:TXT_LOCATION_CODE
					out.println("			m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Contract_NPL_Report?chksql=print_report_export&date=\"+m_date+\"&client_code=\"+document.Form1.CLIENT_CODE.value+\"&branch_code=\"+document.Form1.TXT_LOCATION_CODE.value+\"&product_name=\"+m_product_name+\"&ndia=\"+m_ndia;"); 
					out.println("			window.open(m_url);");
					out.println("	}");
					out.println("}");
					...
					out.println("</tr>"); 
					out.println("<tr>"); 
					out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Credit Process - NPL Report</td>"); 
					out.println("</tr>"); 
					out.println("<tr>"); 
					...
					out.println("<input class='but_input' type='button' name='BUT_PRINT' value=\"Export Excel\" onClick=\"print_report_export()\" style='{width=150px}'>");
				...
				out.println("<tr>"); 
				out.println("<td width='20%' ><DIV id='DIV_TXT_NDIA'  class=div_input> NDIA (No. Of Days In Arrears) </DIV></td>"); 
			    out.println("<td width='*%' ><select class='txt_input' name='TXT_NDIA'>");  
	            out.println("      <OPTION value='0' > All </OPTION>");
				out.println("      <OPTION value='31' > 31 Days and Above </OPTION>");
				out.println("      <OPTION value='61' > 61 Days and Above </OPTION>");
				out.println("      <OPTION value='91' > 91 Days and Above </OPTION>");
				out.println("      <OPTION value='121' > 120 Days and Above </OPTION>");
				out.println("      <OPTION value='181' > 181 Days and Above </OPTION>");
				out.println("      <OPTION value='366' > 366 Days and Above </OPTION>");
				out.println(" 	   </select>");
				out.println(" </td>"); 
				out.println("</tr>");
					...
					if(m_chksql.equals("print_report")){		
						...
						out.println("<HTML><HEAD><TITLE>NPL Report</TITLE></HEAD>");
						...
						out.println("   m_url=servlet_client_url+\":\"+client_t3_port+\"/\"+client_name+\"AF_MISF_Contract_NPL_Report?chksql=SHOW_MAINTENANCE_DRILL&date=\"+m_date+\"&app_no=\"+m_app_no;");
						...
						out.println("<TR><TD align='Center' class=factoring-letter-body><B>NPL Report As At "+m_date+"</B></TD></TR>");
						out.println("</TABLE>");
						...
						out.println("<td width='10%' align=right><DIV class=factoring-letter-body><b>Item Sub Category</b></DIV>");
						out.println("<td width='10%' align=right><DIV class=factoring-letter-body><b>Moratorium</b></DIV>"); // added by udara 13-08-2020
						out.println("<td width='10%' align=right><DIV class=factoring-letter-body><b>Future Debits</b></DIV>"); // added by udara 07-01-2021
						
						out.println("<td width='10%' align=right><DIV class=factoring-letter-body><b>Arrears Capital</b></DIV>");
						out.println("<td width='10%' align=right><DIV class=factoring-letter-body><b>Arrears Interest</b></DIV>");
						out.println("<td width='10%' align=right><DIV class=factoring-letter-body><b>Charges In Arrears</b></DIV>");
						out.println("<td width='10%' align=right><DIV class=factoring-letter-body><b>Accumilated ODI</b></DIV>");
						out.println("<td width='10%' align=right><DIV class=factoring-letter-body><b>Total Exposure</b></DIV>");
						out.println("<td width='10%' align=right><DIV class=factoring-letter-body><b>Arrears Status</b></DIV>");
						out.println("<td width='10%' align=right><DIV class=factoring-letter-body><b>NDIA</b></DIV>");
						
						out.println("</td>"); // added by udara 10-07-2017
						...
						if (m_client_code.equals("")){
							...
							m_sql_string = m_sql_string + " SELECT X.CLIENT_CODE,"+
								...
								//" NVL("+m_schema_name+".CO_GET_RENTAL_CONTRACT(X.APPLICATION_NO),0) "+//ADDED MIILNDA 2014-07-18 //COMMENTED BY  UDARA 10-07-2018 FOR BALANCE TRANSFER CONTRACT ISSUE
								...
								" ,NVL(ARREARS_CAPITAL,0) ARREARS_CAPITAL "+
								" ,NVL(ARREARS_INTEREST,0) ARREARS_INTEREST "+
								" ,NVL(OTHER_CHARGES_OUTSTANDING,0) OTHER_CHARGES_OUTSTANDING "+
								" ,NVL(ACC_ODI_INTEREST,0) ACC_ODI_INTEREST "+
								" ,NVL(TOT_EXPOSURE,0) TOT_EXPOSURE "+
								" ,NVL(ARR_STATUS,0) ARR_STATUS "+
								" ,NVL(DPD,0) DPD "+
								
								" FROM "+m_schema_name+".AF_CO_TBD_CONTRACT_NPL X , "+m_schema_name+".AF_CO_PRO_APPLICATION_DETAILS Y "+
								" WHERE X.FINANCE_NO=Y.FINANCE_NO "+
								//" AND   USER_NAME='"+m_username+"' "
								" AND   X.DPD >= '"+m_ndia+"' "+
								" AND   X.REPORT_DATE =  TO_DATE('"+m_date+"','DD-MM-YYYY')   ";
						...
						while(rs1.next()){
							...
							tot_arr_cap += rs1.getDouble("ARREARS_CAPITAL");
							tot_arr_int += rs1.getDouble("ARREARS_INTEREST");
							tot_arr_oth += rs1.getDouble("OTHER_CHARGES_OUTSTANDING");
							tot_acc_odi += rs1.getDouble("ACC_ODI_INTEREST");
							tot_exp += rs1.getDouble("TOT_EXPOSURE");
							...
							out.println("<td width='10%' class=factoring-letter-body align=right>"+rs1.getString(21)+"</td>"); // added by udara 13-08-2020
							...
							out.println("<td width='10%' class=factoring-letter-body align=right> "+nf1.format(rs1.getDouble("ARREARS_CAPITAL"))+" </td>");
							out.println("<td width='10%' class=factoring-letter-body align=right> "+nf1.format(rs1.getDouble("ARREARS_INTEREST"))+" </td>");
							out.println("<td width='10%' class=factoring-letter-body align=right> "+nf1.format(rs1.getDouble("OTHER_CHARGES_OUTSTANDING"))+" </td>");
							out.println("<td width='10%' class=factoring-letter-body align=right> "+nf1.format(rs1.getDouble("ACC_ODI_INTEREST"))+" </td>");
							out.println("<td width='10%' class=factoring-letter-body align=right> "+nf1.format(rs1.getDouble("TOT_EXPOSURE"))+" </td>");
							out.println("<td width='10%' class=factoring-letter-body align=right> "+nf1.format(rs1.getDouble("ARR_STATUS"))+" </td>");
							out.println("<td width='10%' class=factoring-letter-body align=right> "+rs1.getString("DPD")+" </td>");
						...
						out.println("<td width='20%' align=center colspan=5> &nbsp; </td>"); // added by udara 10-07-2017 // colspan changed from 2 to 3 by udara 13-08-2020
						out.println("<td width='20%' align=center ><b> "+nf1.format(tot_future_debits)+" </b></td>"); // added by udara 07-01-2021 tot_future_debits
						
						out.println("<td width='20%' align=center ><b> "+nf1.format(tot_arr_cap)+" </b></td>");
						out.println("<td width='20%' align=center ><b> "+nf1.format(tot_arr_int)+" </b></td>");
						out.println("<td width='20%' align=center ><b> "+nf1.format(tot_arr_oth)+" </b></td>");
						out.println("<td width='20%' align=center ><b> "+nf1.format(tot_acc_odi)+" </b></td>");
						out.println("<td width='20%' align=center ><b> "+nf1.format(tot_exp)+" </b></td>");
				...
				if (m_chksql.equals("print_report_export")) {
					...
					if(more){
					    ...
					    res.setHeader("Content-disposition","attachment; filename=NPL Report Export.csv" );
						
						out.print("NPL Report As At ,"); 
					    out.print(""+m_date+"\n"); 	
						...
						out.print("Application No,");
						out.print("Activation Date,");
						out.print("Termination Date,");
						out.print("Balance Outstanding,");
						out.print("Future Receivable,");
						out.print("Unearned Income,");
						out.print("NIBSM,");
						out.print("AMI,");
						out.print("Maintance,");
						out.print("Rental Amount,");
						out.print("IRR,");
						out.print("Branch,");
						out.print("Item Category,");
						out.print("Item Sub Category,");
						out.print("Moratorium,");
						out.print("Future Debits,");
						out.print("Arrears Capital,");
						out.print("Arrears Interest,");
						out.print("Charges In ARrears,");
						out.print("Accumilated ODI,");
						out.print("Total Exposure,");
						out.print("Arrears Status,");
						out.print("NDIA,");
						...
						while(more){
							...
							out.print(""+rs1.getString("ACTIVATION_DATE")+",");
							out.print(""+rs1.getString(13)+",");
							out.print(""+rs1.getDouble(6)+",");
							out.print(""+rs1.getDouble(5)+",");
							out.print(""+rs1.getDouble(7)+",");
							out.print(""+rs1.getDouble(9)+",");
							out.print(""+rs1.getDouble(10)+",");
							out.print(""+rs1.getDouble(11)+",");
							out.print(""+rs1.getDouble(15)+",");
							out.print(""+rs1.getDouble(16)+",");
							out.print(""+rs1.getString(17)+",");
							out.print(""+rs1.getString(19)+",");
							out.print(""+rs1.getString(20)+",");
							out.print(""+rs1.getString(21)+",");
							out.print(""+rs1.getDouble("FUTURE_DEBITS")+",");
							out.print(""+rs1.getDouble("ARREARS_CAPITAL")+",");
							out.print(""+rs1.getDouble("ARREARS_INTEREST")+",");
							out.print(""+rs1.getDouble("OTHER_CHARGES_OUTSTANDING")+",");
							out.print(""+rs1.getDouble("ACC_ODI_INTEREST")+",");
							out.print(""+rs1.getDouble("TOT_EXPOSURE")+",");
							out.print(""+rs1.getDouble("ARR_STATUS")+",");
							out.print(""+rs1.getString("DPD")+",");
							out.print("\n");
						...
						if(count>0){
							out.print(",,,,,,,");
							out.print(""+tot_oustanding_bal+","); 
						    out.print(""+tot_future_receivble+","); 
							out.print(""+tot_unearned_income+","); 
							out.print(""+tot_nibsm+","); 
							out.print(""+tot_ami+",");
							out.print(""+tot_maintaince+",");
							out.print(""+tot_RENTAL+",");
							out.print(",,,,,");
							out.print(""+tot_future_debits+",");
							out.print(""+tot_arr_cap+",");
							out.print(""+tot_arr_int+",");
							out.print(""+tot_arr_oth+",");
							out.print(""+tot_acc_odi+",");
							out.print(""+tot_exp+",");
							out.print(",");
							out.print("\n");
						}
