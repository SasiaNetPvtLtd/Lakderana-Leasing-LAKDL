...
public class LAKDL_AF_MISF_Confirmation_Report_Detail_View_app_1 extends javax.servlet.http.HttpServlet {
	
	Connection conn;
	Statement stmt_2,stmt; // stmt_charges , stmt_pricing, stmt_rental, stmt_invoice
	...
	public  void service(HttpServletRequest req, HttpServletResponse res)	throws IOException	{ // synchronized
		...
		try {
			...
			if (m_chksql.trim().equals("idle")) {
				...
				//out.println("<BODY   class='body & txt-body' LEFTMARGIN='0' TOPMARGIN='0' onload=\"alert('test');\" >"); // udara test
				out.println("<BODY   class='body & txt-body' LEFTMARGIN='0' TOPMARGIN='0' onload=\"on_load_data()\" >"); //onload=\"on_load_data()\"
				//out.println("<BODY   class='body & txt-body' LEFTMARGIN='0' TOPMARGIN='0' onload=\"\" >"); // 05-11-2015 on_load_data()
				...
				*/
				...
				out.println("<td width='4%' ><input class='txt_input' type='text' name='TXT_ADDRESS_HIRER' maxlength='200' size='10' style=\"width:310px;\" value='"+hirer_cus_address+"' ></td>"); 
				out.println("</tr>");
				...
				*/
				...
				//onkeydown="if (event.keyCode == 13) document.getElementById('clickit').click()"
				out.println(" <textarea rows=\"2\" cols=\"28\" name=\"TXT_CONF_RPT_COMMENT\" id=\"TXT_CONF_RPT_COMMENT\" wrap=\"hard\" maxlength=\"199\" value=\"\" onblur=\"comment_box_validate();\" onkeydown=\" if(event.keyCode == 13){return false;}\" >");
				out.println(" </textarea> ");
				out.println("</td>");
