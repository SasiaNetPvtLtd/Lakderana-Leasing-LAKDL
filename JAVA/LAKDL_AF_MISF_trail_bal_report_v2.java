...
public class LAKDL_AF_MISF_trail_bal_report_v2 extends javax.servlet.http.HttpServlet { 
		...
		try { 
			...
			String m_username = m_sn_methods.username;
				...
				if(m_chksql.equals("run_report")){ 
					...
					try{
						...
						callstmt1 = conn.prepareCall("BEGIN "+m_schema_name+".AF_MIS_LEA_TRIAL_BAL_V2(:1,:2,:3,:4,:5);END;"); 
						callstmt1.setString(1,m_from_date);
						callstmt1.setString(2,m_to_date);
						callstmt1.setString(3,m_username); 
						callstmt1.setString(4,m_acc_type_code); 
						callstmt1.setString(5,m_product_code);
						callstmt1.execute();
						out.print("OK"); 
					}
					catch(Exception ex){
				...
				out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_trail_balance_report_v2?chksql=LOAD_TRAIL_BAL_REPORT_LEVEL_1&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&div_code=\"+document.Form1.TXT_DIVISION_CODE.value+\"&prod_code=\"+document.Form1.TXT_PRODUCT_CODE.value+\"&acc_type_code=\"+document.Form1.TXT_ACC_CODE.value;");
	      ...
	      out.println(" document.Form1.hid_cal_date.value=num;"); 
			  ...
			  out.println("  if(document.Form1.hid_cal_date.value=='1'){"); 
				...
				out.println("	help_box.innerHTML=\" Trial Balance Report - \"+m_val;"); 
				out.println("}"); 
	
				out.println("function load_roll_out_value(){");
				out.println("	help_box.innerHTML=\" Trial Balance Report \";"); 
				out.println("}"); 
		  	...
		  	out.println("					}"); 
				...
				out.println("		m_acc_type_code  = document.Form1.TXT_ACC_CODE.value; ");
				out.println("		m_product_code   = document.Form1.TXT_PRODUCT_CODE.value; ");
				
				out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_trail_bal_report_v2?chksql=run_report&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&acc_type_code=\"+m_acc_type_code+\"&product_code=\"+m_product_code;"); 
				...
				out.println("			alert('Report is generated. Use View Report button to get the view.');"); 
				out.println("		}");
				out.println("		else{");
				...
				out.println("</tr>"); 
				out.println("<tr>"); 
				out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Trial Balance Report </td>"); 
				out.println("</tr>"); 
				out.println("<tr>"); 
				...
				out.println("<table class='table' width='100%'  >"); 
				out.println("<tr>"); 
				out.println("<td width='15%' ><DIV id='DIV_TXT_PRODUCT_CODE'  class=div_input><B>Product Code</B></DIV></td>"); 
				out.println("<td width='17%' ><input class='txt_input' type='text' name='TXT_PRODUCT_CODE' maxlength='20' size='10' style='width:100' onblur=\"help_update_product()\">"); 
			    ...
			    out.println("<input class='but_input' type='button' name='BUT_VIEW_MAIN' value=\"View\" onClick=\"show_trail_balance_report()\">");
				out.println("<input class='but_input' type='button' name='BUT_RUN_MAIN' value=\"Run\"   onClick=\"run_report()\">");
				out.println("</td>"); 
				out.println("</tr>");
				out.println("</table>");  
