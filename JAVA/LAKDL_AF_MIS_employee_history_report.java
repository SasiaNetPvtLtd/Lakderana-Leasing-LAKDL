...
//SCREEN NAME:EMPLOYEE HISTORY REPORT
//CREATED BY:PRABASH
//DATE/TIME:22/08/2011
//SUPPORT #2973
...
public class LAKDL_AF_MIS_employee_history_report extends javax.servlet.http.HttpServlet { 
...
public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<html>");
			out.println("<head>");
			out.println("<title>Asset Financing System -Employee History report</title>");
			out.println("<link href=\""+m_html_client_url+"/css/Asset_Financing_System.css\" rel=\"stylesheet\" type=\"text/css\" >");
			out.println("</head>");
			out.println("<Script>");			
			
			out.println("function load_roll_value(m_val){"); 
			out.println("help_box.innerHTML=\" Employee History report - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" Employee History report - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MIS_employee_history_report?chksql=main_page';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("function load_employee_history(){ ");	
			...
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MIS_employee_history_report?chksql=MAIN&from_date=\"+from_date+\"&to_date=\"+to_date+\" \";");
      ...
      out.println("}");
			...
			out.println("</tr>");
			out.println("<tr>");
			out.println("<td align=\"left\" class=\"pdn_txtpos2\" style=\"height: 18px\" id=help_box>Employee History report</td>");
			out.println("</tr>");
			out.println("<tr>");
      ...
      out.println("</table>");
			...
			out.println("<td width='10%' align=\"left\"><input class='mainbut' type='button' name='BUT_VIEW' value=\"View\" onClick=\"load_employee_history()\"></td>"); 
		  out.println("<td width='*%'></td>");
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Employee History report</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("<tr><td align='center'  style='height: 18px'><b>Employee History report- From "+m_from_date+" To "+m_to_date+"</td></tr>"); 
			out.println("</table>");  
			out.println("</table>");  
			out.println("</BR>");
			out.println("</BR>");
			...
			int j = 0;			
		  pstmt = conn.prepareStatement( " SELECT  A.EMP_CODE,"+
        								" A.TITLE,"+
       									" A.FIRST_NAME, "+
        								" A.LAST_NAME, "+
        								" A.ADDRESS,"+
        								...
        								" A.ID_NO,"+
        								" A.ACTIVE_STATUS,"+
        								" TO_CHAR(A.EMP_DOB,'DD-MM-YYYY'),"+
        								" TO_CHAR(A.EMP_DO_JOIN,'DD-MM-YYYY'),"+
        								" TO_CHAR(A.EMP_DO_RESIGN,'DD-MM-YYYY') "+
  										" FROM LAKDL.CO_CO_MAS_EMPLOYEE A"+
										" WHERE "+
										" TO_DATE(TO_CHAR(A.EMP_DO_JOIN,'DD-MM-YYYY'),'DD-MM-YYYY') <= TO_DATE('"+m_to_date+"','DD-MM-YYYY') "+
                        				" AND TO_DATE(TO_CHAR(A.EMP_DO_JOIN,'DD-MM-YYYY'),'DD-MM-YYYY') >= TO_DATE('"+m_from_date+"','DD-MM-YYYY')");
		 ...
		 rs=pstmt.executeQuery(); 			
			...
			if(more){
			out.println("<table align='center'  width='150%' class='table' border=0>"); 
			out.println("<tr class=pdn_txtpos2>");
			out.println("<td width='6%' align='left'>Employee Code </td>");
			out.println("<td width='3%' align='left'>Title</td>"); 			 
			out.println("<td width='8%' align='left'>First Name</td>"); 
			out.println("<td width='8%' align='left'>Last Name</td>"); 
			out.println("<td width='10%' align='left'>Address </td>"); 
			out.println("<td width='5%' align='lrft'>Location Code</td>"); 
			out.println("<td width='5%'  align='left'>Area Code</td>"); 
			out.println("<td width='5%'  align='left'>City Code</td>"); 
			out.println("<td width='5%' align='left'>Contact No</td>"); 
			out.println("<td width='5%' align='left'>Designation Code</td>");
			out.println("<td width='5%' align='left'>Division Code </td>");
			out.println("<td width='5%' align='lrft'>EPF No</td>"); 
			out.println("<td width='5%'  align='left'>ID No </td>"); 
			out.println("<td width='2%'  align='left'>Active Status</td>"); 
			out.println("<td width='7%' align='left'>Date Of Birth</td>"); 
			out.println("<td width='7%' align='left'>Date Of Joined</td>");
			out.println("<td width='7%' align='left'>Date Of Resign</td>");
			out.println("</tr >");
      	...
      	out.println("<tr class=tr_input >");
			...
			out.println("<td width='6%' align='left'>"+rs.getString(1)+"</td>");
			out.println("<td width='3%' align='left'>"+rs.getString(2)+"</td>"); 			 
			...
			out.println("<td width='5%' align='left'>"+rs.getString(10)+"</td>");
			out.println("<td width='5%' align='left'>"+rs.getString(11)+"</td>"); 
			out.println("<td width='5%' align='left'>"+rs.getString(12)+"</td>");
			out.println("<td width='5%' align='left'>"+rs.getString(13)+"</td>"); 			 
			out.println("<td width='2%' align='left'>"+rs.getString(14)+"</td>");
			...
			if (rs.getString(15)==null){
				...
				{	
				out.println("<td width='7%' align='left'>"+rs.getString(15)+"</td>");
				}
			
			out.println("<td width='7%' align='left'>"+rs.getString(16)+"</td>"); 
			...
			if (rs.getString(17)==null){
				...
				{	
				out.println("<td width='7%' align='left'>"+rs.getString(17)+"</td>");
			}
			out.println("</tr >");
