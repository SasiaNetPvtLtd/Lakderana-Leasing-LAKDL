...
public class LAKDL_AF_CR_save_pricing_approval extends HttpServlet {
	...
	synchronized(this){ 
      ...
      String m_scr_name=(String)m_sn_methods.met_formdata(reqstr,"Hid_scr_name"); 
	   	...
	   	out.println("<HTML><HEAD>");
			...
			out.println(" window.location.href='"+m_url+"/"+m_schema_name+"_AF_CR_display_pricing_approval?chksql=main_page&APP_NO='+m_app_no+'&INQ_NO='+m_inq_no+'';");
