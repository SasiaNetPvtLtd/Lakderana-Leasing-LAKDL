...
public class LAKDL_AF_RE_PRO_Collection_LOT_Letter_Reminder_front_end extends javax.servlet.http.HttpServlet {
	...
	public /*synchronized*/ void service(HttpServletRequest req, HttpServletResponse res) throws IOException {
		...
		try {
			...
			if (m_chksql.trim().equals("print_not_final_letter")) {
				...
				String m_due_date=req.getParameter("due_date"); // added by udara 05-11-2019
		...
		//		out.println("   m_url='" + m_class_url + "/" + m_fschema_name + "AF_RE_PRO_Collection_Final_Reminder?m_finance_no="+req.getParameter("finance_no")+"&application_no=" + req.getParameter("application_no") + "&document_code="+req.getParameter("document_code")+"&print=FALSE&client_code=" + req.getParameter("client_code") + "&client_type=" + req.getParameter("client_type") + "';");
			...
			*/
				...
				out.println("<th align='left'><font face=\"Times New Roman\">"+m_due_date+"</font></th>"); // added by udara 05-11-2019
				...
				out.println("<p>");
				out.println("<font face=\"FMBindumathi\">");
                out.println("<b><u>ixfYdaê; 1982 wxl 29 orK mdßfNda.sl Kh mkf;a 18^1&$18^2& j.ka;sh hgf;a jdßl uqo,a fkdf.ùu fyda .súiqï.;");
				out.println("kshuhka iy fldkafoais W,a,x&gt;Kh lsÍu fya;=fjka l=,sh wjika lsßuhs'</u></b>"); // mod
				out.println("</p></font>");	
				out.println("</table>");
				...
				out.println("<p>");
				out.println("<font face=\"FMBindumathi\">");
                out.println("by; wxl orK l=,S iskaklalr .súiqu iy ixfYdaê; 1982 wxl 29 orK mdßfNda.sl Kh mkf;a úêúOdkhka hgf;a");
				out.println("Tn fj; tjkakg fhÿKq l=,sh wjika lrkq ,nk njg jq ksfõokh ms&lt;snoj fkdi,ld yßñka tlS ksfõokfha");
				out.println("olajd we;s ysÕ uqo, f.ùug$úfYaIs;j olajd we;s wiu;aùu$lvlsÍu$l%shdj tlS ±kaùfï olajd we;s m%ldYs; ld,");
				out.println("iSudj ;=&lt; § h:dj;a lsßug Tn úiska fkdi,ld yer ;sfí'"); 
				out.println("</p></font>");	
				out.println("</table>"); // mod
				...
				out.println("<p>");
				out.println("<font face=\"FMBindumathi\">");
                out.println("ta wkqj\" 1982 wxl 29 orK mdßfNda.sl Kh mkf;a 12 jk j.ka;sfha úêúOdkhka Tn úiska W,a,x>kh lr we;s");
				out.println("neúka\" tu mkf;a 18 jk j.ka;sfha úêúOdkhka m%ldrj iy by; lS l=,S iskaklalr .súiqfï kshuhkag wkql+,j");
				out.println("jydu l%shd;aul jk mßÈ l=,sh wjika lrk njg fuu.ska m%ldY lrkafkuq' tneúka\" wms Tn fj; l=,shg fok ,o");
				out.println("jdykh$WmlrKh wmf.a wjirh iy wkque;sfhka f;drj ;jÿrg;a Tnf.a ika;lfha fkdmej;sh hq;= jk w;r\"");
				out.println("tu ksid Tn úiska tlS foamf,ys ika;lh ;jÿrg;a ±Íu kS;Hdkql=, fkdjk nj ±kqï fouq'"); 
				out.println("</p></font>");	
				out.println("</table>"); // mod
				...
				out.println("<p>");
				out.println("<font face=\"FMBindumathi\">");
                out.println("tneúka\" tls foam, rdc.sßh\" nq;a.uqj mdr\" wxl 100 ys msysá wmf.a m%Odk ld¾hd,h fj; fyda YdLd ld¾hd,hla fj;");
				out.println("idudkH jHdmdr lghq;= mj;sk ld,h ;=&lt; § Ndr §u fyda whùug we;s iïmq¾K uqo,a m%udKh tlajr f.ùug jydu");
				out.println("lghq;= l&lt; hq;= njg wms Tng jeäÿrg;a okajd isákafkuq'"); // mod
				out.println("</p></font>");	
				out.println("</table>");
				...
				out.println("<p>");
				out.println("<font face=\"FMBindumathi\">");
                out.println("Tn úiska tfia lsÍug wfmdfydi;a jkafka kï u;= ±kqï§ulska f;drj wmf.a whs;sjdislï n,d;aul lrjd .ekSu");
				out.println("i|yd wjYH l%shdud¾. .ekSug isÿjk nj;a\" Tng iy wemlrejkag tfrysj kvq mjrk f,ig wmf.a kS;s{hka fj;");
				out.println("Wmfoia §ug isÿjk nj;a lreKdfjka i,lkak'"); // mod
				out.println("</p></font>");	
				out.println("</table>");
				...
				out.println("<p>");
				out.println("<font face=\"FMBindumathi\">");
                out.println("ta wkqj\" Tn úiska t&lt;fUk ,o l=&lt;s iskaklalr .súiqï fldkafoais j,ska Tn mq¾K jYfhka ;jÿrg;a nef|k njo");
				out.println("úfYaIfhka okajd isákafkuq'"); // mod
				out.println("</p></font>");	
				out.println("</table>");
