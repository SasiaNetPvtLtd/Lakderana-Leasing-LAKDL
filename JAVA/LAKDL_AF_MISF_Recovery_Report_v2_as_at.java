...
public class LAKDL_AF_MISF_Recovery_Report_v2_as_at extends javax.servlet.http.HttpServlet { 
		...
		try { 
			...
			if(m_chksql.equals("run_report")){ 
				...
				*/
				...
				try{
					callstmt1 = conn.prepareCall("BEGIN "+m_schema_name+".AF_RECOVER_RPT_V2_AS_AT_DATE(:1,:2);END;"); 
					callstmt1.setString(1,m_date);
					callstmt1.setString(2,"LAKDLALL");
					callstmt1.execute();
					out.print("OK"); 
				}
				catch(Exception ex){
			...
			if(m_chksql.equals("main_page")){ 
				...
				//out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_v2_as_at?chksql=run_report&finance_no=\"+finance_no+\"&date=\"+m_date+\"&location_id=\"+document.Form1.TXT_LOCATION_CODE.value+\"&user_id=\"+document.Form1.TXT_USER.value+\"&cr_officer=\"+m_cr_officer+\"&active_yard_status=\"+m_active_yard_status+\"&perform_stat=\"+m_perform_stat+\"&region=\"+m_region;"); // added by udara 13-08-2015 
				out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_v2_as_at?chksql=run_report&date=\"+m_date;"); 
				...
				*/
				...
				//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_v2_as_at?chksql=print_report_new&location=\"+m_location+\"&officer=\"+m_officer+\"&date=\"+m_date+\"&perform_status=\"+perform_status+\"&cr_officer=\"+m_cr_officer+\"&active_status=\"+document.Form1.TXT_ACTIVE_STATUS.value+\"&region=\"+m_region+\"&finance_no=\"+m_finance_no;");  // added by udara on 09-05-2013 //mod by milinda 2013-10-16
				...
				out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_v2_as_at?chksql=main_page&generate=page';"); 
				out.println("		}"); 
				out.println("}"); 
				...
				out.println("if(validate_data()){");
				out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_v2_as_at?chksql=main_page&generate=print_report&location=\"+m_location+\"&officer=\"+m_officer+\"&date=\"+date;");	
				...
				//out.println("<input class='but_input' type='button' name='BUT_PRINT' value=\"View Report - Monthly\" onClick=\"print_report4()\" style=\"{width:150px;}\">"); // added by udara 28-06-2017
				...
				*/
				...
				out.println("    m_order_by_type = 'ASC'; ");
				out.println("  }");
				out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_v2_as_at?chksql=print_report_new&location="+m_location+"&officer="+m_officer+"&date="+m_date+"&active_status="+m_active_status+"&sort_column=\"+m_sort_col+\"&order_by_type=\"+m_order_by_type;");	
				...
				//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_v2_as_at?chksql=print_report_new_drill&location="+m_location+"&officer="+m_officer+"&date="+m_date+"&active_status="+m_active_status+"&slab=\"+val+\"&cr_officer="+m_cr_officer+"&perform_status="+m_perform_status+"&region="+m_region+"\";");	
				out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_v2_as_at?chksql=print_report_new_drill&location="+m_location+"&officer="+m_officer+"&date="+m_date+"&active_status="+m_active_status+"&slab=\"+val+\"&cr_officer="+m_cr_officer+"&perform_status="+m_perform_status+"&region="+m_region+"&product_name="+m_product_name+"\";");	
				...
				//out.println("   m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_v2_as_at?chksql=print_report_new_drill_total&location="+m_location+"&officer="+m_officer+"&date="+m_date+"&active_status="+m_active_status+"&cr_officer="+m_cr_officer+"\";");	// commented by udara 23-08-2017
				//out.println("   window.open(m_url,'slab','left=50,top=60,width=850,height=500,toolbar=0,location=0,directories=0,status=0,menuBar=0,scrollBars=1,resizable=1');"); 
				//out.println("   m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_v2_as_at?chksql=print_report_new_drill_total&location="+m_location+"&officer="+m_officer+"&date="+m_date+"&active_status="+m_active_status+"&cr_officer="+m_cr_officer+"&perform_status="+m_perform_status+"&region="+m_region+"\";"); // added by udara 23-08-2017
				out.println("   m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_v2_as_at?chksql=print_report_new_drill_total&location="+m_location+"&officer="+m_officer+"&date="+m_date+"&active_status="+m_active_status+"&cr_officer="+m_cr_officer+"&perform_status="+m_perform_status+"&region="+m_region+"&product_name="+m_product_name+"\";");
				out.println("}");
				// end by udara 19-10-2016
				...
				rs=stmt.executeQuery("SELECT NVL("+m_schema_name+".AF_CO_GET_LOCATION_DESC('"+m_location+"'),'ALL'), "+m_schema_name+".AF_CO_GET_EMP_NAME('"+m_officer+"'), "+
					...
					" (SELECT TO_CHAR(MAX(ENT_DATE),'DD-MM-YYYY HH:MI:SS AM') FROM "+m_schema_name+".AF_MIS_RECOVERY_REPORT_AS_AT)   "+ // added by udara 19-05-2016
					" FROM DUAL ");
				...
				Sql_data="  "+
					...
					" FROM "+m_schema_name+".AF_MIS_RECOVERY_REPORT_AS_AT A, "+m_schema_name+".AF_CO_PRO_APPLICATION_DETAILS B "+
				...
				Sql_data=" "+
					...
					" AND    A.FINANCE_NO IN (SELECT FINANCE_NO FROM "+m_schema_name+".AF_MIS_RECOVERY_REPORT_AS_AT WHERE ENT_USER = 'LAKDLALL' AND REPORT_DATE = TO_DATE('"+m_date+"','DD-MM-YYYY') AND PERFORM_STATUS LIKE '"+m_perform_status+"%' "+ m_active_status_string_for_cr_notes +" ) "+  
				...
				out.println("    m_order_by_type = 'ASC'; ");
				out.println("  }");
				out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_v2_as_at?chksql=print_report_new&location="+m_location+"&officer="+m_officer+"&date="+m_date+"&sort_column=\"+m_sort_col+\"&order_by_type=\"+m_order_by_type;"); // commented by udara on 09-05-2013
				out.println(" window.location.href=m_url;"); 
				out.println("}");
				...
				if (m_slab.equals("NEW") ){
					...
					Sql_data="   "+
						...
						" NVL("+m_schema_name+".GET_CR_NOTE_AMNT_RECOV_RPT(A.FINANCE_NO,'"+m_date+"'),0) - NVL("+m_schema_name+".GET_CR_NOTE_AMNT_RECOV_RPT_2(A.FINANCE_NO,'"+m_date+"'),0)  CR_NOTE, "+
