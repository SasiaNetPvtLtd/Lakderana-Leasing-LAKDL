...
public class LAKDL_AF_MISF_due_days_change extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			if(m_chksql.equals("main_page")){ 
				...
				rs2= stmt2.executeQuery(" SELECT CURRENT_PERIOD FROM "+m_schema_name+".AF_CO_MAS_GRACE_PERIOD ");
				
				
				out.println("<HTML>"); 
				out.println("<HEAD>"); 
				out.println("<TITLE>System Administration - Due Days Change</TITLE>"); 
				out.println("</HEAD>"); 
				...
				out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_due_days_change?chksql=run_report&date=\"+m_date+\"&location_id=\"+document.Form1.TXT_LOCATION_CODE.value+\"&finance_no=\"+finance_no;"); 
				...
				out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_due_days_change?chksql=print_report_new&location=\"+m_location+\"&date=\"+m_date+\"&finance_no=\"+finance_no;");	
				out.println("			window.open(m_url);");
				out.println("	}");
				out.println("}");
				...
				out.println("	m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_due_days_change?chksql=main_page&generate=drill_down_asset&finance_no=\"+m_finance_no;"); 
				...
				out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MISF_due_days_change?chksql=main_page&generate=page';"); 
				out.println("		}"); 
				out.println("}"); 
				...
				out.println("help_box.innerHTML=\" System Administration - Due Days Change - \"+m_val;"); 
				out.println("}"); 
				out.println(""); 
				
				out.println("function load_roll_out_value(){");
				out.println("help_box.innerHTML=\" System Administration - Due Days Change - \"+document.Form1.hid_status.value;"); 
				out.println("}"); 
			...
			out.println("}"); 
				...
				out.println("if(validate_data()){");
				out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_due_days_change?chksql=main_page&generate=print_report&location=\"+m_location+\"&officer=\"+m_officer+\"&date=\"+date;");	
				...
				if(rs2.next()){
					out.println("document.Form1.TXT_NO_OF_DAYS.value='"+rs2.getInt(1)+"';");			
				}
				out.println("}"); 
				...
				out.println("     document.Form1.TXT_NO_OF_DAYS.focus(); ");
				out.println("   }"); 
				
				out.println("   else if (isNaN(document.Form1.TXT_NO_OF_DAYS.value)){ ");
				out.println("     alert('No. of days field should be a number'); ");
				out.println("     document.Form1.TXT_NO_OF_DAYS.value = ''; ");
				out.println("     document.Form1.TXT_NO_OF_DAYS.focus(); ");
				out.println("   }"); 
				...
				out.println("	if(confirm(\"Are you sure you want to change No. of due days\")){ "); 
				out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_MISF_due_days_change_save';");  
				...
				out.println("</tr>"); 
				out.println("<tr>"); 
				out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>System Administration - Due Days Change </td>"); 
				out.println("</tr>"); 
				out.println("<tr>"); 
				...
				out.println("<tr >"); 
				out.println("<td width='20%' ><DIV id='DIV_TXT_NO_OF_DAYS'  class=div_input>No. of Days </DIV></td>");  
				out.println("<td width='*%' ><input class='txt_input' type='text' name='TXT_NO_OF_DAYS' maxlength='10' size='10' style=\"{width:150px; text-align:right; }\" onblur='check_value();'  >"); 
				out.println("</td>"); 
				out.println("</tr>"); 
