...
public class LAKDL_AF_RE_receipt_report extends javax.servlet.http.HttpServlet { 
	...
	public  void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			if(m_chksql.equals("main_page")){
				...
				if(m_active_status!=null && !m_active_status.equals("A")){
					m_active_status_string = " AND "+m_schema_name+".AF_RE_IS_VEHICLE_IN_YARD2(C.FINANCE_NO,'"+m_to_date+"') = '"+m_active_status+"' "; // added by udara 23-03-2015
				}
				...
				if(m_branch_id!=null && !m_branch_id.equals(""))
				...
				if (m_location_code!=null && m_location_code.trim().equals("ALL")) {
					m_location_code="";
					...
					String sql1 = " SELECT "+
						...
						" NVL(B.FINANCE_NO,'-')  FIN_NO, "+ // " NVL("+m_schema_name+".AF_CO_GET_REC_FIN_NO(A.REC_NO),'-') FIN_NO, "+ //11
						...
						" A.BRANCH_CODE,"+
						" NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') REGION "+ //-------Added by Samith Dilshan on 15-06-2015
						" ,  NVL(B.FINANCE_NO,"+m_schema_name+".AF_CO_GET_CLIENT_NIC(A.CLIENT_CODE)) FIN_OR_NIC "+
						...
						//" WHERE  A.REC_NO = B.REC_NO AND B.FINANCE_NO = C.FINANCE_NO  AND "+ //COMMENTED ON 2017-09-20
						" WHERE  A.REC_NO = B.REC_NO (+) "+ 	//inesh 2017-09-20 to enable client reciepts
						" AND B.FINANCE_NO = C.FINANCE_NO (+) "+ //inesh 2017-09-20 to enable clietn reciepts
						" AND "+
					...
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						//sql1 = sql1 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(A.BRANCH_CODE),'-') = '"+m_region+"' ";   
						sql1 = sql1 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 07-08-2015
					}
					
						//sql1 = sql1 + " AND A.EFF_VALDATE<=TO_DATE('"+m_to_date+"','DD-MM-YYYY') "+
						sql1 = sql1 + " AND A.EFF_VALDATE <= TO_DATE('"+m_to_date+"','DD-MM-YYYY') "+
						"  "+ m_user_query + 
						" "+ location_query_part + " "+ 
						
						"  "+m_active_status_string+" "+ // added by udara 18-08-2015
					...
					String sql1 = " SELECT "+
						...
						" WHERE  A.REC_NO = B.REC_NO (+) "+ 	//inesh 2017-09-20 to enable client reciepts
						" AND B.FINANCE_NO = C.FINANCE_NO (+) "+//inesh 2017-09-20 to enable client reciepts
						" AND "+
						//" A.EFF_VALDATE>=TO_DATE('"+m_from_date+"','DD-MM-YYYY') ";
						" A.EFF_VALDATE >= TO_DATE('"+m_from_date+"','DD-MM-YYYY') ";
					
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						sql1 = sql1 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 13-08-2015
					}
				...
				//out.println("<HTML><HEAD><TITLE>Receipt Report </TITLE></HEAD>"); // commented by udara 09-05-2014
				...
				out.println(" m_region='"+m_region+"';"); // added by udara 10-07-2015
				out.println(" m_active_yard_status='"+m_active_status+"';"); // added by udara 26-08-2015
				...
				out.println(" else if(m_sort_col=='EFF_VALDATE'){"); //added by kanchana on 2016-07-28
				out.println(" m_sort_col=\"TO_date(EFF_VALDATE,'DD-MM-YYYY')\"; ");
				out.println("    }");//endded by kanchana on 2016-07-28
				
				//out.println("alert(m_sort_col+\""+m_order_by+"\"+'"+m_sort_by+"');");				  
				...
				out.println("    m_order_by_type = 'ASC'; ");
				out.println("  }");
				//out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report?chksql=load_receipts&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=\"+m_sort_col+\"&sort_by=\"+m_order_by_type+\"&user=&location_code=\"+m_location_code;");// commented by udara on 27-02-2013
				out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report?chksql=load_receipts&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=\"+m_sort_col+\"&sort_by=\"+m_order_by_type+\"&user=&location_code=\"+m_location_code+\"&branch_id=\"+m_branch_id;"); // added by udara on 27-02-2013
				out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report?chksql=load_receipts&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=\"+m_sort_col+\"&sort_by=\"+m_order_by_type+\"&user=&location_code=\"+m_location_code+\"&branch_id=\"+m_branch_id+\"&region=\"+m_region+\"&active_yard_status=\"+m_active_yard_status;"); 
				...
				out.println("</SCRIPT>");
				out.println("<BODY   class='body & txt-body' LEFTMARGIN='0' TOPMARGIN='0'>"); // commented by udara 09-05-2014
				...
				if(!(m_region.equals("NOT_SELECT"))){ 					
					...
					if(more_1){
						out.println("<TR><TD align='left' ><B>Region : "+rs3.getString(1)+" </B></TD>");
						out.println("<TD align='right' ><B> &nbsp; </B></TD></TR>");
					}
				}
				...
				if(more){
					...
					out.println("<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\" width='100%' background=\""+m_html_client_url+"/vehicle_inspection/5.jpg\"  >"); // added by udara 12-05-2014
					//out.println("<tr class=pdn_txtpos2>");
					out.println("<tr class=pdn_txtpos3>"); // udara 12-08-2014
					//out.println("<tr>");
					out.println("<td width='1%'></td>"); 
					out.println("<td width='10%' ><b>Receipt No</b></td>"); 
					out.println("<td width='9%'  style= cursor:hand; onclick=sort_data('SUB_REC_SORT') ><b>Sub Receipt No</b></td>");  // SUB_REC_SORT // SUB_REC_NO
					...
					out.println("<td width='1%'> &nbsp; </td>"); // udara 19-08-2014
					...
					out.println("<td width='10%' ><b>Remarks</b></td>"); // added by udara 15-05-2024
					out.println("</tr>"); 
				...
				while(more){
					...
					out.println("<td  class=div_input ><p>"+rs1.getString("FIN_OR_NIC")+"</p></td>"); //width='15%'
					...
					out.println("<td class=div_input >"+rs1.getString(18)+"</td>"); // added by udara 25-02-2014
					...
					out.println("<td class=div_input >"+rs1.getString(10)+"</td>"); // added by udara 15-05-2024
					out.println("</tr>");
				...
				out.println("<td  class=div_input ></td>"); // added by udara 11-08-2014
				...
				out.println("<td  class=div_input ></td>"); // added by udara 27-05-2024
				out.println("<td  class=div_input ></td>"); // added by udara 15-05-2024
				out.println("</tr>");
				out.println("<tr>");
				out.println("<td ></td>"); 
				out.println("<td  class=div_input ></td>");
				...
				if (m_location_code.trim().equals("ALL")) {
					...
					String sql2= " SELECT "+
						...
						" WHERE  A.REC_NO = B.REC_NO (+) AND B.FINANCE_NO = C.FINANCE_NO (+)  AND "+
						" A.REC_CANCEL_DATE>=TO_DATE('"+m_from_date+"','DD-MM-YYYY') "+//ADDED BY KANISHKA ON 03-09-2013
						" AND A.REC_CANCEL_DATE<=TO_DATE('"+m_to_date+"','DD-MM-YYYY') ";//ADDED BY KANISHKA ON 03-09-2013
					
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						//sql2 = sql2 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(A.BRANCH_CODE),'-') = '"+m_region+"' ";  
						sql2 = sql2 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 07-08-2015
					}
					
					
						sql2 = sql2 + "  "+ m_user_query + 
					...
					String sql2= " SELECT "+
						...
						" ,  NVL(B.FINANCE_NO,"+m_schema_name+".AF_CO_GET_CLIENT_NIC(A.CLIENT_CODE)) FIN_OR_NIC "+
						" FROM "+m_schema_name+".AF_CO_PRO_SETTL_RECEIPT  A , "+m_schema_name+".AF_CO_PRO_SETTL_REC_APP_BAL B, "+m_schema_name+".AF_CO_PRO_APPLICATION_DETAILS C  "+
						" WHERE  A.REC_NO = B.REC_NO (+) AND B.FINANCE_NO = C.FINANCE_NO (+)  AND "+//enable client reciepts 2017-09-25
						" A.REC_CANCEL_DATE>=TO_DATE('"+m_from_date+"','DD-MM-YYYY') "+//ADDED BY KANISHKA ON 03-09-2013
						" AND A.REC_CANCEL_DATE<=TO_DATE('"+m_to_date+"','DD-MM-YYYY') ";//ADDED BY KANISHKA ON 03-09-2013
					
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						sql2 = sql2 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 13-08-2015
					}
					
					
						sql2 = sql2 + " AND C.BRANCH_CODE = '"+m_location_code+"'  "+ m_user_query + 
				...
				while(more){
					...
					//out.println("<td  class=div_input ><p>"+rs1.getString(11)+"</p></td>"); //width='15%'
					out.println("<td  class=div_input ><p>"+rs1.getString("FIN_OR_NIC")+"</p></td>"); //width='15%'
					out.println("<td  class=div_input ><p>"+rs1.getString(19)+"</p></td>");
					out.println("<td  class=div_input align='right' >"+nf.format(rs1.getDouble(2))+"</td>"); //width='10%'
					out.println("<td  class=div_input > &nbsp; </td>"); // udara 19-08-2014
					out.println("<td  class=div_input >&nbsp;"+rs1.getString(3)+"</td>"); //width='14%'
				...
				if(mm_location_code.trim().equals("ALL")){  // added by udara on 07-12-2012
					...
					String sql3 = " SELECT TYPE,SUM(TOTAL),COUNT(COUNT),DUMMY FROM ( "+
					...
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
							//sql3 = sql3 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(A.BRANCH_CODE),'-') = '"+m_region+"' ";
							sql3 = sql3 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 07-08-2015
					}
					
						//sql3 = sql3 + " AND A.EFF_VALDATE<=TO_DATE('"+m_to_date+"','DD-MM-YYYY') "+
						sql3 = sql3 + " AND A.EFF_VALDATE <= TO_DATE('"+m_to_date+"','DD-MM-YYYY') "+
						...
						" "+  m_user_query + //" AND "+m_schema_name+".AF_CO_GET_APP_LOCATION("+m_schema_name+".AF_CO_GET_APPLICATION_NO(NVL("+m_schema_name+".AF_CO_GET_REC_FIN_NO(REC_NO),'-'))) = '"+m_location_code+"'  "+m_user_query +
					...
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
							//sql3 = sql3 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(A.BRANCH_CODE),'-') = '"+m_region+"' ";
							//sql3 = sql3 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION("+m_schema_name+".AF_CO_GET_USER_LOCATION_RRN_3(A.ENT_USER,A.REC_NO)),'-') = '"+m_region+"' "; // added by udara 07-08-2015
							sql3 = sql3 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 13-08-2015
						}
				...
				out.println("<table align='center' cellspacing=\"0\" cellpadding=\"0\" border=\"1\" width='50%' background=\""+m_html_client_url+"/vehicle_inspection/5.jpg\"  >"); // added by udara 12-05-2014
				out.println("<tr class=pdn_txtpos2>");
				...
				if(mm_location_code.trim().equals("ALL")){  // added by udara on 07-12-2012
					...
					// added by udara 13-08-2015
					String sql4= " SELECT A.SETTLE_MODE ,SUM(A.REC_AMOUNT) ,COUNT(A.REC_AMOUNT)  "+
						" FROM "+m_schema_name+".AF_CO_PRO_SETTL_RECEIPT  A , "+m_schema_name+".AF_CO_PRO_SETTL_REC_APP_BAL B, "+m_schema_name+".AF_CO_PRO_APPLICATION_DETAILS C"+ 
						" WHERE  A.REC_NO = B.REC_NO(+) AND B.FINANCE_NO = C.FINANCE_NO(+)  AND  "+
						" A.EFF_VALDATE>=TO_DATE('"+m_from_date+"','DD-MM-YYYY') "+ 
					...
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						//sql4 = sql4 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(A.BRANCH_CODE),'-') = '"+m_region+"' "; 
						sql4 = sql4 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 07-08-2015
					}
					
						sql4 = sql4 + " AND A.ACC_NO = 'TRANSFERAC' "+
						" "+ location_query_part + " "+ // " AND  "+m_schema_name+".AF_CO_GET_USER_LOCATION_RRN(ENT_USER) LIKE '"+m_branch_id+"%'  "+ // added by udara on 27-02-2013 // mod by udara on 25-07-2013
					...
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						//sql4 = sql4 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(A.BRANCH_CODE),'-') = '"+m_region+"' "; 
						//sql4 = sql4 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION("+m_schema_name+".AF_CO_GET_USER_LOCATION_RRN_3(A.ENT_USER,A.REC_NO)),'-') = '"+m_region+"' "; // added by udara 07-08-2015
						sql4 = sql4 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 13-08-2015
					}
				...
				if(mm_location_code.trim().equals("ALL")){  // added by udara on 07-12-2012
					...
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						//sql5 = sql5 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(A.BRANCH_CODE),'-') = '"+m_region+"' ";
						sql5 = sql5 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 07-08-2015
					}
					
						//sql5 = sql5 +  " AND A.EFF_VALDATE<=TO_DATE('"+m_to_date+"','DD-MM-YYYY') "+
						sql5 = sql5 +  " AND A.EFF_VALDATE <= TO_DATE('"+m_to_date+"','DD-MM-YYYY') "+
					...
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						...
						sql5 = sql5 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 13-08-2015
					}
				...
				if(mm_location_code.trim().equals("ALL")){
					...
					String sql6= " SELECT A.ENT_USER ,A.SETTLE_MODE ,SUM(A.REC_AMOUNT) ,COUNT(A.REC_AMOUNT)  "+
						" FROM "+m_schema_name+".AF_CO_PRO_SETTL_RECEIPT  A , "+m_schema_name+".AF_CO_PRO_SETTL_REC_APP_BAL B, "+m_schema_name+".AF_CO_PRO_APPLICATION_DETAILS C "+
						" WHERE  A.REC_NO = B.REC_NO(+) AND B.FINANCE_NO = C.FINANCE_NO(+)  AND  "+
						//" A.EFF_VALDATE>=TO_DATE('"+m_from_date+"','DD-MM-YYYY') ";
						" A.EFF_VALDATE >= TO_DATE('"+m_from_date+"','DD-MM-YYYY') ";
					...
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						//sql6 = sql6 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(A.BRANCH_CODE),'-') = '"+m_region+"' ";  
						sql6 = sql6 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 07-08-2015
					}
					
						//sql6 = sql6 + " AND A.EFF_VALDATE<=TO_DATE('"+m_to_date+"','DD-MM-YYYY') "+
						sql6 = sql6 + " AND A.EFF_VALDATE <= TO_DATE('"+m_to_date+"','DD-MM-YYYY') "+
					...
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						...
						sql6 = sql6 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 13-08-2015
					}
				...
				if(mm_location_code.trim().equals("ALL")){  // added by udara on 07-12-2012
					...
					String sql7= " SELECT TYPE,SUM(TOTAL),COUNT(COUNT),DUMMY FROM ( "+
						" SELECT A.SETTLE_MODE TYPE ,A.REC_AMOUNT TOTAL,A.REC_AMOUNT COUNT, 1 DUMMY "+
						" FROM "+m_schema_name+".AF_CO_PRO_SETTL_RECEIPT  A , "+m_schema_name+".AF_CO_PRO_SETTL_REC_APP_BAL B, "+m_schema_name+".AF_CO_PRO_APPLICATION_DETAILS C"+ 
						" WHERE  A.REC_NO = B.REC_NO(+) AND B.FINANCE_NO = C.FINANCE_NO(+)  AND ";
					
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						//sql7 = sql7 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(A.BRANCH_CODE),'-') = '"+m_region+"' "; 
						sql7 = sql7 +"  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' AND "; // added by udara 07-08-2015
					}
					
						//sql7 = sql7 + " A.EFF_VALDATE>=TO_DATE('"+m_from_date+"','DD-MM-YYYY') "+ 
						//" AND A.EFF_VALDATE<=TO_DATE('"+m_to_date+"','DD-MM-YYYY') "+
					...
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						...
						sql7 = sql7 +"   NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' AND "; // added by udara 13-08-2015
					}
				...
				if(mm_location_code.trim().equals("ALL")){  
					...
					m_bbf_sql = " "+
						...
						if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						  m_bbf_sql = m_bbf_sql +"   AND NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"'  "; // added by udara 13-08-2015
					    }
			...
			//out.println("Testing SasiaNet ==> <BR>"+m_bbf_sql);
			rs1= stmt1.executeQuery(m_bbf_sql);
				...
				if(mm_location_code.trim().equals("ALL")){  
					...
					/*************Below query added by Jithendra 23-01-2017 for active status*********/
					 
					rs1= stmt1.executeQuery(" SELECT TYPE,SUM(TOTAL),COUNT(COUNT),DUMMY FROM ( "+
						" SELECT A.SETTLE_MODE TYPE ,A.REC_AMOUNT TOTAL,A.REC_AMOUNT COUNT, 1 DUMMY "+
						//" FROM "+m_schema_name+".AF_CO_PRO_SETTL_RECEIPT A "+ // mod by udara 09-08-2013//Comment by Jithendra 23-01-2017
						" FROM "+m_schema_name+".AF_CO_PRO_SETTL_RECEIPT  A , "+m_schema_name+".AF_CO_PRO_SETTL_REC_APP_BAL B, "+m_schema_name+".AF_CO_PRO_APPLICATION_DETAILS C"+//Added by Jithendra 23-01-2017 
						" WHERE  A.REC_NO = B.REC_NO(+) AND B.FINANCE_NO = C.FINANCE_NO(+)   "+
						//" AND  A.EFF_VALDATE>=TO_DATE('"+m_from_date+"','DD-MM-YYYY') "+
						//" AND  A.EFF_VALDATE<=TO_DATE('"+m_to_date+"','DD-MM-YYYY') "+
						" AND  A.EFF_VALDATE>=TO_DATE('"+m_from_date+"','DD-MM-YYYY') "+
						...
						"  "+m_active_status_string+" "+ // added by udara 18-08-2015//Uncommented by Jithendra 23-01-2017
				...
				if(mm_location_code.trim().equals("ALL")){  
					...
					rs1= stmt1.executeQuery(" "+
						...
						" FROM "+m_schema_name+".AF_CO_PRO_SETTL_RECEIPT A  "+
						" WHERE  "+
						//" TO_DATE(TO_CHAR(EFF_VALDATE,'DD-MM-YYYY'),'DD-MM-YYYY')>=TO_DATE('"+m_from_date+"','DD-MM-YYYY') "+	//COMMENTED BY KANISHKA ON 03-09-2013
						...
						" AND REC_CANCEL_DATE>=TO_DATE('"+m_from_date+"','DD-MM-YYYY') "+//ADDED BY KANISHKA ON 03-09-2013
						" AND REC_CANCEL_DATE<=TO_DATE('"+m_to_date+"','DD-MM-YYYY') "+//ADDED BY KANISHKA ON 03-09-2013
					...
					rs1= stmt1.executeQuery(" "+
						...
						//" AND A.REC_CANCEL_DATE>=TO_DATE('"+m_from_date+"','DD-MM-YYYY') "+//ADDED BY KANISHKA ON 03-09-2013
						//" AND A.REC_CANCEL_DATE<=TO_DATE('"+m_to_date+"','DD-MM-YYYY') "+//ADDED BY KANISHKA ON 03-09-2013
				...
				/****end****/	
					...
					//out.println(" "+
						...
						"  "+m_active_status_string+" "+ // added by Jithendra 23-01-2017//
				...
				if(!m_branch_id.equals("")){
					...
					out.println("<table align='center' cellspacing=\"0\" cellpadding=\"0\" border=\"0\" width='50%' background=\""+m_html_client_url+"/vehicle_inspection/5.jpg\"  >"); // added by udara 12-05-2014
				...
				if (m_location_code.trim().equals("ALL")) {
					...
					String sql10 = " SELECT "+
						...
						" ,  NVL(B.FINANCE_NO,"+m_schema_name+".AF_CO_GET_CLIENT_NIC(A.CLIENT_CODE)) FIN_OR_NIC "+
						" FROM "+m_schema_name+".AF_CO_PRO_SETTL_RECEIPT  A , "+m_schema_name+".AF_CO_PRO_SETTL_REC_APP_BAL B, "+m_schema_name+".AF_CO_PRO_APPLICATION_DETAILS C  "+
						" WHERE A.REC_NO = B.REC_NO (+) "+  //2017-09-25 ENABLE FOR CLIENT RECIEPT
						" AND B.FINANCE_NO = C.FINANCE_NO (+) AND ";
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						sql10 = sql10 +"    NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' AND "; // added by udara 07-08-2015
					}
					
						//sql10 = sql10 +" A.EFF_VALDATE>=TO_DATE('"+m_from_date+"','DD-MM-YYYY') "+
						//" AND A.EFF_VALDATE<=TO_DATE('"+m_to_date+"','DD-MM-YYYY') "+
						...
						"  "+m_active_status_string+" "+ // added by udara 19-08-2015

						" ORDER BY "+m_order_by+" "+m_sort_by+" ";
						// end by udara 13-08-2015
					
					rs1= stmt1.executeQuery(sql10);
					...
					String sql10 = " SELECT "+
						...
						" AND B.FINANCE_NO = C.FINANCE_NO (+) AND ";
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						sql10 = sql10 +"    NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' AND "; // added by udara 13-08-2015
					}
				...
				out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report?chksql=load_active_receipts&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=\"+m_sort_col+\"&sort_by=\"+m_order_by_type+\"&user="+m_user+"&location_code="+mm_location_code+"&branch_id=\"+m_branch_id+\"&region=\"+m_region+\"&active_yard_status=\"+m_active_yard_status;"); // added by udara on 12-08-2015
				...
				if(more){
					...
					out.println("<td width='1%'></td>"); 
					out.println("<td width='10%'><b>Receipt No</b></td>"); 
					out.println("<td width='9%'  style= cursor:hand; onclick=sort_data('SUB_REC_SORT') ><b>Sub Receipt No</b></td>"); // mod by udara 24-02-2015 SUB_REC_SORT // SUB_REC_NO
					out.println("<td width='5%'  style= cursor:hand; onclick=sort_data('SETTLE_MODE') ><b>Settle Mode</b></td>"); // mod by udara on 29-08-2013
					out.println("<td width='10%' style= cursor:hand; onclick=sort_data('FINANCE_NO_SORT') ><b>Finance No/s</b></td>"); 
					out.println("<td width='6%' style= cursor:hand; onclick=sort_data('REG_NO') ><b>Reg No.</b></td>"); // added by udara 11-08-2014
					out.println("<td width='8%' style= cursor:hand; onclick=sort_data('REC_AMOUNT') align='right'><b>Amount</b></td>");
					out.println("<td width='1%'> &nbsp; </td>"); 
					out.println("<td width='8%' style= cursor:hand; onclick=sort_data('EFF_VALDATE') ><b>&nbsp;Value Date</b></td>");
					...
					out.println("<td width='3%'  style= cursor:hand; onclick=sort_data('A.STATUS') ><b>Status</b></td>");
					//out.println("<td width='10%' ><b>Account</b></td>");
					out.println("<td width='1%' >&nbsp;</td>"); // added by udara 27-05-2024
					out.println("<td width='10%' ><b>Remarks</b></td>");  // added by udara 15-05-2024
					out.println("</tr>"); 
				...
				if (m_location_code.trim().equals("ALL")) {
					...
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						//sql11 = sql11 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(A.BRANCH_CODE),'-') = '"+m_region+"' "; 
						sql11 = sql11 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 07-08-2015
					}
					
						//sql11 = sql11 + " AND A.EFF_VALDATE<=TO_DATE('"+m_to_date+"','DD-MM-YYYY') "+
						sql11 = sql11 + " AND A.EFF_VALDATE<=TO_DATE('"+m_to_date+"','DD-MM-YYYY') "+
						" AND A.STATUS  IN ('C','CAD') "+ // added by udara on 28-08-2013
						" "+ location_query_part + " "+ // " AND  "+m_schema_name+".AF_CO_GET_USER_LOCATION_RRN(ENT_USER) LIKE '"+m_branch_id+"%'  "+ // added by udara on 27-02-2013 // mod by udara on 25-07-2013 for performance
					...
					String sql11 = " SELECT "+
						...
						" FROM "+m_schema_name+".AF_CO_PRO_SETTL_RECEIPT  A , "+m_schema_name+".AF_CO_PRO_SETTL_REC_APP_BAL B, "+m_schema_name+".AF_CO_PRO_APPLICATION_DETAILS C  "+
						//" WHERE  A.REC_NO = B.REC_NO AND B.FINANCE_NO = C.FINANCE_NO  AND "+
						" WHERE  A.REC_NO = B.REC_NO (+) AND B.FINANCE_NO = C.FINANCE_NO (+)  AND "+//ENABLE CLIENT RECIEPTS
						//" A.EFF_VALDATE>=TO_DATE('"+m_from_date+"','DD-MM-YYYY') ";
						" A.EFF_VALDATE>=TO_DATE('"+m_from_date+"','DD-MM-YYYY') ";
					
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						sql11 = sql11 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 13-08-2015
					}
				...
				out.println("<td  class=div_input ></td>");
				out.println("<td  class=div_input ></td>"); // added by udara on 31-07-2013
				out.println("<td  class=div_input ></td>"); // added by udara on 11-08-2014
				out.println("<td  class=div_input align='right' >___________</b></td>");
				out.println("<td  class=div_input >&nbsp;</td>"); // udara 19-08-2014
				out.println("<td  class=div_input >&nbsp;</td>");
				out.println("<td  class=div_input ></td>");
				...
				if (mm_location_code.trim().equals("ALL")) { // added by udara on 07-12-2012
					...
					String sql12 =  " SELECT TYPE,SUM(TOTAL),COUNT(COUNT),DUMMY FROM ( "+
						" SELECT A.SETTLE_MODE TYPE ,A.REC_AMOUNT TOTAL,A.REC_AMOUNT COUNT, 1 DUMMY "+
						" FROM "+m_schema_name+".AF_CO_PRO_SETTL_RECEIPT  A , "+m_schema_name+".AF_CO_PRO_SETTL_REC_APP_BAL B, "+m_schema_name+".AF_CO_PRO_APPLICATION_DETAILS C "+ 
						" WHERE  A.REC_NO = B.REC_NO(+) AND B.FINANCE_NO = C.FINANCE_NO(+)  AND  "+
						//" A.EFF_VALDATE>=TO_DATE('"+m_from_date+"','DD-MM-YYYY') ";
					...
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code   
						sql12 = sql12 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 07-08-2015
					}
					
						//sql12 = sql12 + " AND A.EFF_VALDATE<=TO_DATE('"+m_to_date+"','DD-MM-YYYY') "+
						sql12 = sql12 + " AND A.EFF_VALDATE<=TO_DATE('"+m_to_date+"','DD-MM-YYYY') "+
						" AND A.STATUS NOT IN ('C','CAD')"+
					...
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						sql12 = sql12 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 13-08-2015
					}
				...
				if(mm_location_code.trim().equals("ALL")){  // added by udara on 07-12-2012
					...
					// added by udara 13-08-2015
					String sql13 = " SELECT A.SETTLE_MODE ,SUM(A.REC_AMOUNT) ,COUNT(A.REC_AMOUNT)  "+
						" FROM "+m_schema_name+".AF_CO_PRO_SETTL_RECEIPT  A , "+m_schema_name+".AF_CO_PRO_SETTL_REC_APP_BAL B, "+m_schema_name+".AF_CO_PRO_APPLICATION_DETAILS C "+ 
						//" WHERE  A.EFF_VALDATE>=TO_DATE('"+m_from_date+"','DD-MM-YYYY') "+ 
						//" AND A.EFF_VALDATE<=TO_DATE('"+m_to_date+"','DD-MM-YYYY') "+
						" WHERE  A.EFF_VALDATE>=TO_DATE('"+m_from_date+"','DD-MM-YYYY') "+ 
					...
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						sql13 = sql13 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 07-08-2015
					}
					
						sql13 = sql13 + " AND A.SETTLE_MODE = 'STD_ORD' "+
					...
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						sql13 = sql13 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' ";  // added by udara 13-08-2015
					}
				...
				if(mm_location_code.trim().equals("ALL")){  // added by udara on 07-12-2012
					...
					String sql14 = " SELECT ENT_USER,TYPE,SUM(TOTAL),COUNT(COUNT), DUMMY FROM( "+
						" SELECT A.ENT_USER ENT_USER,A.SETTLE_MODE TYPE,A.REC_AMOUNT TOTAL,A.REC_AMOUNT COUNT, 1 DUMMY "+
						" FROM "+m_schema_name+".AF_CO_PRO_SETTL_RECEIPT  A , "+m_schema_name+".AF_CO_PRO_SETTL_REC_APP_BAL B, "+m_schema_name+".AF_CO_PRO_APPLICATION_DETAILS C  "+
						" WHERE  A.REC_NO = B.REC_NO(+) AND B.FINANCE_NO = C.FINANCE_NO(+)  AND  "+
						//" A.EFF_VALDATE>=TO_DATE('"+m_from_date+"','DD-MM-YYYY') ";
					...
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						sql14 = sql14 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 07-08-2015
					}
					
						sql14 = sql14 + " AND A.EFF_VALDATE<=TO_DATE('"+m_to_date+"','DD-MM-YYYY') "+
					...
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						sql14 = sql14 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 13-08-2015
					}
				...
				if(mm_location_code.trim().equals("ALL")){  // added by udara on 07-12-2012
					...
					// added by udara 13-08-2015
					String sql15 = " SELECT A.ENT_USER ,A.SETTLE_MODE ,SUM(A.REC_AMOUNT) ,COUNT(A.REC_AMOUNT)  "+
						" FROM "+m_schema_name+".AF_CO_PRO_SETTL_RECEIPT  A , "+m_schema_name+".AF_CO_PRO_SETTL_REC_APP_BAL B, "+m_schema_name+".AF_CO_PRO_APPLICATION_DETAILS C  "+
						" WHERE  A.REC_NO = B.REC_NO(+) AND B.FINANCE_NO = C.FINANCE_NO(+)  AND  "+
						" A.EFF_VALDATE>=TO_DATE('"+m_from_date+"','DD-MM-YYYY') "+
						" AND A.EFF_VALDATE<=TO_DATE('"+m_to_date+"','DD-MM-YYYY') "+
					...
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						sql15 = sql15 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 07-08-2015
					}
					
						sql15 = sql15 + " AND A.SETTLE_MODE = 'STD_ORD' "+
						" AND A.ACC_NO = 'TRANSFERAC' "+m_user_query +
						//" AND C.BRANCH_CODE = '"+m_location_code+"'  "+ //" AND "+m_schema_name+".AF_CO_GET_APP_LOCATION("+m_schema_name+".AF_CO_GET_APPLICATION_NO(NVL("+m_schema_name+".AF_CO_GET_REC_FIN_NO(REC_NO),'-'))) = '"+m_location_code+"' "+
						" "+location_query_part+"  "+  //" AND  "+m_schema_name+".AF_CO_GET_USER_LOCATION_RRN(ENT_USER) LIKE '"+m_branch_id+"%'  "+ // added by udara on 27-02-2013
					...
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						//sql15 = sql15 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(A.BRANCH_CODE),'-') = '"+m_region+"' ";
						//sql15 = sql15 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION("+m_schema_name+".AF_CO_GET_USER_LOCATION_RRN_3(A.ENT_USER,A.REC_NO)),'-') = '"+m_region+"' "; // added by udara 07-08-2015
						sql15 = sql15 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 13-08-2015
					}
				...
				// added by udara 13-08-2015
					String sql16 = " "+
						...
						if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						  sql16 = sql16 +"   AND NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"'  "; // added by udara 13-08-2015
					    }
						...
						//WEB ACCOUNT LINK PART REMOVED BY KANISHKA ON 01-07-2014  [REQUESTED BY CLIENT]		 
				...
				if(mm_location_code.trim().equals("ALL")){  
					...
					String sql17 = " SELECT TYPE,SUM(TOTAL),COUNT(COUNT),DUMMY FROM ( "+
						" SELECT A.SETTLE_MODE TYPE ,A.REC_AMOUNT TOTAL,A.REC_AMOUNT COUNT, 1 DUMMY "+
						" FROM "+m_schema_name+".AF_CO_PRO_SETTL_RECEIPT  A , "+m_schema_name+".AF_CO_PRO_SETTL_REC_APP_BAL B, "+m_schema_name+".AF_CO_PRO_APPLICATION_DETAILS C "+ 
						" WHERE  A.REC_NO = B.REC_NO(+) AND B.FINANCE_NO = C.FINANCE_NO(+)  AND "+
						" A.EFF_VALDATE>=TO_DATE('"+m_from_date+"','DD-MM-YYYY') ";
					...
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						//sql17 = sql17 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(A.BRANCH_CODE),'-') = '"+m_region+"' "; 
						sql17 = sql17 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 07-08-2015
					}
					
						sql17 = sql17 + " AND A.EFF_VALDATE<=TO_DATE('"+m_to_date+"','DD-MM-YYYY') "+ 
					...
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						sql17 = sql17 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 13-08-2015
					}
				...
				if(mm_location_code.trim().equals("ALL")){  // added by udara on 07-12-2012
					...
					String sql18 = " "+
						...
						rs1= stmt1.executeQuery(sql18);	
						
						
				} else{
					
					
					String sql18 = " SELECT TYPE,SUM(TOTAL),COUNT(COUNT),DUMMY FROM ( "+
						...
						" AND  TO_DATE(TO_CHAR(D.ENT_DATE,'DD-MM-YYYY'),'DD-MM-YYYY')>=TO_DATE('"+m_from_date+"','DD-MM-YYYY') "+  // added by udara on 13-08-2013
						" AND TO_DATE(TO_CHAR(D.ENT_DATE,'DD-MM-YYYY'),'DD-MM-YYYY')<=TO_DATE('"+m_to_date+"','DD-MM-YYYY') ";
					
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code

						sql18 = sql18 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 13-08-2015
					}
					
						sql18 = sql18 + " AND D.STATUS = 'Y' "+ 
				...
				if(!m_branch_id.equals("")){
					...
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						sql19 = sql19 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION("+m_schema_name+".AF_CO_GET_APP_LOCATION(SUS_REF_NO)),'-') = '"+m_region+"' "; // added by udara 13-08-2015
					}
					
					
						sql19 = sql19 + " AND A.STATUS = 'B' "+
						" AND A.REC_LOC = '"+m_branch_id+"' "+ // added by udara 24-07-2018
						" AND B.STATUS = 'Y' "+ // added by udara on 18-09-2013
						" AND TO_DATE(TO_CHAR(B.ENT_DATE,'DD-MM-YYYY'),'DD-MM-YYYY')>=TO_DATE('"+m_from_date+"','DD-MM-YYYY') "+  // added by udara on 18-09-2013
						" AND TO_DATE(TO_CHAR(B.ENT_DATE,'DD-MM-YYYY'),'DD-MM-YYYY')<=TO_DATE('"+m_to_date+"','DD-MM-YYYY')  "+ // added by udara on 18-09-2013
				...
				if(!m_branch_id.equals("")){
					...
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						sql20 = sql20 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 13-08-2015
					}
					
						sql20 = sql20 + " AND A.EFF_VALDATE <= TO_DATE('"+m_to_date+"','DD-MM-YYYY') "+
						" AND C.BRANCH_CODE = '"+m_branch_id+"' "+
						//" AND A.STATUS NOT IN ('C','CAD')  "+
						" AND  "+m_schema_name+".AF_CO_GET_USER_LOCATION_RRN(A.ENT_USER) <> '"+m_branch_id+"' "+
						" ORDER BY "+m_order_by+" "+m_sort_by+" "+
				...
				if(m_user!= null && !m_user.equals("")){
					...
					m_user_query = "AND A.ENT_USER = UPPER('"+m_user+"') ";
					m_user_query2 = "AND A.REC_ENT_BY = UPPER('"+m_user+"') ";
				}
				...
				if (m_location_code.trim().equals("ALL")) {
					...
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						//sql20 = sql20 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(A.BRANCH_CODE),'-') = '"+m_region+"' "; 
						sql20 = sql20 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(D.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 07-08-2015
					}
					
						//sql20 = sql20 + " AND  B.REC_NO = C.REC_NO AND C.FINANCE_NO = D.FINANCE_NO   "+
						sql20 = sql20 + " AND  B.REC_NO = C.REC_NO (+) AND C.FINANCE_NO = D.FINANCE_NO (+)   "+ //2017-09-25 FOR ENABLE CLIENT RECIEPTS
							
						" AND A.EFF_VALDATE>=TO_DATE('"+m_from_date+"','DD-MM-YYYY') "+
						" AND A.EFF_VALDATE<=TO_DATE('"+m_to_date+"','DD-MM-YYYY') "+m_user_query+
					...
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						...
						sql20 = sql20 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(D.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 13-08-2015
					}
				...
				out.println("<HTML><HEAD><TITLE>Receipt Cancelation Report </TITLE>");
			...
			// added by udara 09-05-2014
				...
				out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report?chksql=load_receipts_cancel&location_code=\"+m_location_code+\"&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=\"+m_sort_col+\"&sort_by=\"+m_order_by_type+\"&branch_id=\"+m_branch_id+\"&region=\"+m_region+\"&active_yard_status=\"+m_active_yard_status;"); // added by udara 12-08-2015
				...
				if(more){
					...
					out.println("<table align='center' cellspacing=\"0\" cellpadding=\"0\" border=\"0\" width='100%' background=\""+m_html_client_url+"/vehicle_inspection/5.jpg\"  >");
					...
					out.println("<td width='10%' style= cursor:hand; title='Click here to sort by - Sub Receipt No'  onclick=sort_data('SUB_REC_SORT') ><b>Sub Receipt No</b></td>"); 
					...
					out.println("<td width='10%' style= cursor:hand; title='Click here to sort by - Modified Date'    onclick=sort_data('ENT_DATE') ><DIV class=div_input ><b>Modified Date</b></DIV></td>"); 
					out.println("</tr>"); 
				...
				while(more){
					...
					out.println("<td width='6%' class=div_input >"+rs1.getString(15)+"</td>"); // added by udara 25-02-2014
			...
			//Added by Dineth on 2008-09-29
				...
				if (m_location_code.trim().equals("ALL")) {
					...
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						//sql21 = sql21 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(A.BRANCH_CODE),'-') = '"+m_region+"' "; 
						sql21 = sql21 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 07-08-2015
					}
					
						sql21 = sql21 + " AND TO_DATE(TO_CHAR(A.REALISED_DATE,'DD-MM-YYYY'),'DD-MM-YYYY')<=TO_DATE('"+m_to_date+"','DD-MM-YYYY') "+m_user_query+
					...
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						...
						sql21 = sql21 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 13-08-2015
					}
				...
				out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report?chksql=load_receipts_return&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=\"+m_sort_col+\"&sort_by=\"+m_order_by_type+\"&location_code="+mm_location_code+"&user="+m_user+"&branch_id=\"+m_branch_id;");
				//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_display_receipt_deposit_report1?chksql=MAIN&order_by=\"+m_sort_col+\"&sort_by=\"+m_order_by_type+\"&receipt_no="+m_receipt_no+"&deposite_no="+m_deposite_no+"&from_date="+m_from_date+"&to_date="+m_to_date+"\";");		
				out.println(" window.location.href=m_url;"); 
				out.println("}");
				...
				if(more){
					...
					//out.println("<td width='12%' style= cursor:hand; title='Click here to sort by - Finance No'    onclick=sort_data('SUS_REF_NO') ><DIV class=div_input ><b>Finance No</b></DIV></td>"); 
					out.println("<td width='10%' style= cursor:hand; title='Click here to sort by - Receipt No'    onclick=sort_data('REC_NO') ><DIV class=div_input ><b>Receipt No</b></DIV></td>"); 
					out.println("<td width='10%' style= cursor:hand; title='Click here to sort by - Sub Receipt No'    onclick=sort_data('SUB_REC_SORT') ><DIV class=div_input ><b>Sub Receipt No</b></DIV></td>"); // SUB_REC_NO
				...
				if(mm_location_code.trim().equals("ALL")){  // added by udara on 07-12-2012
					...
					// added by udara 13-08-2015
					String sql22 = " SELECT A.SETTLE_MODE,SUM(A.REC_AMOUNT),COUNT(A.REC_AMOUNT) "+
						" FROM "+m_schema_name+".AF_CO_PRO_SETTL_RECEIPT  A , "+m_schema_name+".AF_CO_PRO_SETTL_REC_APP_BAL B, "+m_schema_name+".AF_CO_PRO_APPLICATION_DETAILS C  "+
						" WHERE  A.REC_NO = B.REC_NO(+) AND B.FINANCE_NO = C.FINANCE_NO(+)  AND  "+
						" TO_DATE(TO_CHAR(A.REALISED_DATE,'DD-MM-YYYY'),'DD-MM-YYYY')>=TO_DATE('"+m_from_date+"','DD-MM-YYYY') ";
					
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						//sql22 = sql22 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(A.BRANCH_CODE),'-') = '"+m_region+"' "; 
						sql22 = sql22 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 07-08-2015
					}
					
						sql22 = sql22 + " AND TO_DATE(TO_CHAR(A.REALISED_DATE,'DD-MM-YYYY'),'DD-MM-YYYY')<=TO_DATE('"+m_to_date+"','DD-MM-YYYY') "+
						" AND A.STATUS ='RET'"+ //ADDED BY NUWAN ON 01-04-08
						" "+location_query_part+" "+  // " AND  "+m_schema_name+".AF_CO_GET_USER_LOCATION_RRN(ENT_USER) LIKE '"+m_branch_id+"%'  "+ // added by udara on 27-02-2013
						//" AND C.BRANCH_CODE = '"+m_location_code+"'  "+ //" AND "+m_schema_name+".AF_CO_GET_APP_LOCATION("+m_schema_name+".AF_CO_GET_APPLICATION_NO(NVL("+m_schema_name+".AF_CO_GET_REC_FIN_NO(REC_NO),'-'))) = '"+m_location_code+"' "+
					...
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						sql22 = sql22 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 13-08-2015
					}
				...
				if(mm_location_code.trim().equals("ALL")){  // added by udara on 07-12-2012
					...
					String sql23 = " SELECT A.ENT_USER,A.SETTLE_MODE,SUM(A.REC_AMOUNT),COUNT(A.REC_AMOUNT) "+
						" FROM "+m_schema_name+".AF_CO_PRO_SETTL_RECEIPT  A , "+m_schema_name+".AF_CO_PRO_SETTL_REC_APP_BAL B, "+m_schema_name+".AF_CO_PRO_APPLICATION_DETAILS C  "+
						" WHERE  A.REC_NO = B.REC_NO(+) AND B.FINANCE_NO = C.FINANCE_NO(+)  AND  "+
						" TO_DATE(TO_CHAR(A.REALISED_DATE,'DD-MM-YYYY'),'DD-MM-YYYY')>=TO_DATE('"+m_from_date+"','DD-MM-YYYY') ";
					
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						//sql23 = sql23 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(A.BRANCH_CODE),'-') = '"+m_region+"' "; 
						sql23 = sql23 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 07-08-2015
					}
					
						sql23 = sql23 + " AND TO_DATE(TO_CHAR(A.REALISED_DATE,'DD-MM-YYYY'),'DD-MM-YYYY')<=TO_DATE('"+m_to_date+"','DD-MM-YYYY') "+
						" AND A.STATUS ='RET'"+ //ADDED BY NUWAN ON 01-04-08
						" "+location_query_part+" "+  // " AND  "+m_schema_name+".AF_CO_GET_USER_LOCATION_RRN(ENT_USER) LIKE '"+m_branch_id+"%'  "+ // added by udara on 27-02-2013
					...
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						sql23 = sql23 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 13-08-2015
					}
			...
			//Added by Dineth on 16-06-2009
				...
				if (m_location_code.trim().equals("ALL")) {
					...
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						//sql30 = sql30 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(A.BRANCH_CODE),'-') = '"+m_region+"' ";   
						sql30 = sql30 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 07-08-2015
					}
					
						sql30 = sql30 + "  "+ // " AND "+m_schema_name+".AF_CO_GET_APP_LOCATION("+m_schema_name+".AF_CO_GET_APPLICATION_NO(NVL("+m_schema_name+".AF_CO_GET_REC_FIN_NO(REC_NO),'-'))) = '"+m_location_code+"' "+ //ADDED BY NS ON 28-03-2011
						" "+location_query_part+" "+ //" AND  "+m_schema_name+".AF_CO_GET_USER_LOCATION_RRN(ENT_USER) LIKE '"+m_branch_id+"%'  "+ // added by udara on 27-02-2013
						"  "+m_active_status_string+" "+ // added by udara 19-08-2015
						" AND A.REC_TYPE ='POD' "+ 
						" ORDER BY "+m_order_by+" "+m_sort_by+" ";
						
						rs1= stmt1.executeQuery(sql30);	
					...
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						sql30 = sql30 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 13-08-2015
					}
					
						sql30 = sql30 + " AND C.BRANCH_CODE = '"+m_location_code+"'  "+ // " AND "+m_schema_name+".AF_CO_GET_APP_LOCATION("+m_schema_name+".AF_CO_GET_APPLICATION_NO(NVL("+m_schema_name+".AF_CO_GET_REC_FIN_NO(REC_NO),'-'))) = '"+m_location_code+"' "+ //ADDED BY NS ON 28-03-2011
						" "+location_query_part+" "+ //" AND  "+m_schema_name+".AF_CO_GET_USER_LOCATION_RRN(ENT_USER) LIKE '"+m_branch_id+"%'  "+ // added by udara on 27-02-2013
						"  "+m_active_status_string+" "+ // added by udara 19-08-2015
						" AND A.REC_TYPE ='POD' "+ 
						" ORDER BY "+m_order_by+" "+m_sort_by+" ";
				...
				out.println(" if(m_sort_col=='CHEQUE_DATE'){"); //added by kanchana on 2016-07-28
				out.println(" m_sort_col=\"TO_date(CHEQUE_DATE,'DD-MM-YYYY')\"; ");
				out.println("    }");//endded by kanchana on 2016-07-28
				...
				out.println("    m_order_by_type = 'ASC'; ");
				out.println("  }");
				out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report?chksql=load_receipts_PDC&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=\"+m_sort_col+\"&sort_by=\"+m_order_by_type+\"&location_code="+mm_location_code+"&user="+m_user+"&branch_id=\"+m_branch_id;");
				//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_display_receipt_deposit_report1?chksql=MAIN&order_by=\"+m_sort_col+\"&sort_by=\"+m_order_by_type+\"&receipt_no="+m_receipt_no+"&deposite_no="+m_deposite_no+"&from_date="+m_from_date+"&to_date="+m_to_date+"\";");		
				out.println(" window.location.href=m_url;"); 
				out.println("}");
				...
				if(more){
					...
					out.println("<table align='center' cellspacing=\"0\" cellpadding=\"0\" border=\"0\" width='120%' background=\""+m_html_client_url+"/vehicle_inspection/5.jpg\"  >");
					out.println("<tr class=pdn_txtpos2>");
					out.println("<td width='1%'></td>"); 
					//out.println("<td width='12%' style= cursor:hand; title='Click here to sort by - Finance No'    onclick=sort_data('SUS_REF_NO') ><DIV class=div_input ><b>Finance No</b></DIV></td>"); 
					out.println("<td width='10%' style= cursor:hand; title='Click here to sort by - Receipt No'    onclick=sort_data('REC_NO') ><DIV class=div_input ><b>Receipt No</b></DIV></td>"); 
				...
				if(mm_location_code.trim().equals("ALL")){  // added by udara on 07-12-2012
					...
					String sql31 = " SELECT A.SETTLE_MODE,SUM(A.REC_AMOUNT),COUNT(A.REC_AMOUNT) "+
						" FROM "+m_schema_name+".AF_CO_PRO_SETTL_RECEIPT  A , "+m_schema_name+".AF_CO_PRO_SETTL_REC_APP_BAL B, "+m_schema_name+".AF_CO_PRO_APPLICATION_DETAILS C  "+
						" WHERE  A.REC_NO = B.REC_NO(+) AND B.FINANCE_NO = C.FINANCE_NO(+)    ";
					
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						sql31 = sql31 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 07-08-2015
					}
					
						sql31 = sql31 + " AND TO_DATE(TO_CHAR(A.ENT_DATE,'DD-MM-YYYY'),'DD-MM-YYYY')>=TO_DATE('"+m_from_date+"','DD-MM-YYYY') "+
					...
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						sql31 = sql31 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' ";  // added by udara 13-08-2015
					}
				...
				if(mm_location_code.trim().equals("ALL")){  // added by udara on 07-12-2012
					...
					// added by udara 13-08-2015
					String sql32 = " SELECT A.ENT_USER,A.SETTLE_MODE,SUM(A.REC_AMOUNT),COUNT(A.REC_AMOUNT) "+
						" FROM "+m_schema_name+".AF_CO_PRO_SETTL_RECEIPT  A , "+m_schema_name+".AF_CO_PRO_SETTL_REC_APP_BAL B, "+m_schema_name+".AF_CO_PRO_APPLICATION_DETAILS C "+
						" WHERE  A.REC_NO = B.REC_NO(+) AND B.FINANCE_NO = C.FINANCE_NO(+)  AND  "+
						" TO_DATE(TO_CHAR(A.ENT_DATE,'DD-MM-YYYY'),'DD-MM-YYYY')>=TO_DATE('"+m_from_date+"','DD-MM-YYYY') ";
					
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						sql32 = sql32 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 07-08-2015
					}
					
						sql32 = sql32 +" AND TO_DATE(TO_CHAR(A.ENT_DATE,'DD-MM-YYYY'),'DD-MM-YYYY')<=TO_DATE('"+m_to_date+"','DD-MM-YYYY') "+m_user_query+
						" AND A.REC_TYPE='POD' "+ //Added by Dineth on 16-06-2009
						" "+location_query_part+" "+ // " AND  "+m_schema_name+".AF_CO_GET_USER_LOCATION_RRN(ENT_USER) LIKE '"+m_branch_id+"%'  "+ // added by udara on 27-02-2013
						" GROUP BY A.ENT_USER,A.SETTLE_MODE "+
						" ORDER BY A.ENT_USER,A.SETTLE_MODE ";
					...
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						sql32 = sql32 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 13-08-2015
					}
			...
			//End by Dineth on 16-06-2009
				...
				if (m_location_code.trim().equals("ALL")) {
					...
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						//sql46 = sql46 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(A.BRANCH_CODE),'-') = '"+m_region+"' ";  
						sql46 = sql46 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 07-08-2015
					}
					
						sql46 = sql46 +" AND TO_DATE(TO_CHAR(A.ENT_DATE,'DD-MM-YYYY'),'DD-MM-YYYY')<=TO_DATE('"+m_to_date+"','DD-MM-YYYY') "+m_user_query+
						//" AND C.BRANCH_CODE = '"+m_location_code+"'  "+ // " AND "+m_schema_name+".AF_CO_GET_APP_LOCATION("+m_schema_name+".AF_CO_GET_APPLICATION_NO(NVL("+m_schema_name+".AF_CO_GET_REC_FIN_NO(REC_NO),'-'))) = '"+m_location_code+"' "+
						" AND A.REC_TYPE='TMP' "+ 
						//" AND "+m_schema_name+".AF_CO_GET_APP_LOCATION("+m_schema_name+".AF_CO_GET_APPLICATION_NO(NVL("+m_schema_name+".AF_CO_GET_REC_FIN_NO(REC_NO),'-'))) = '"+m_location_code+"' "+ //ADDED BY NS ON 28-03-2011
						"  "+location_query_part+" "+ // " AND  "+m_schema_name+".AF_CO_GET_USER_LOCATION_RRN(ENT_USER) LIKE '"+m_branch_id+"%'  "+ // added by udara on 27-02-2013
					...
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						sql46 = sql46 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 13-08-2015
					}
				...
				out.println("    m_order_by_type = 'ASC'; ");
				out.println("  }");
				//out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report?chksql=load_receipts&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=\"+m_sort_col+\"&sort_by=\"+m_order_by_type;"); // commented by udara on 03-12-2012
				//out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report?chksql=load_receipts_temp&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=\"+m_sort_col+\"&sort_by=\"+m_order_by_type+\"&location_code="+mm_location_code+"&user="+m_user+"\";"); // added by udara on 03-12-2012
				out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report?chksql=load_receipts_temp&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=\"+m_sort_col+\"&sort_by=\"+m_order_by_type+\"&location_code="+mm_location_code+"&user="+m_user+"&branch_id=\"+m_branch_id;");
				//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_display_receipt_deposit_report1?chksql=MAIN&order_by=\"+m_sort_col+\"&sort_by=\"+m_order_by_type+\"&receipt_no="+m_receipt_no+"&deposite_no="+m_deposite_no+"&from_date="+m_from_date+"&to_date="+m_to_date+"\";");		
				out.println(" window.location.href=m_url;"); 
				out.println("}");
				...
				if(more){
					...
					out.println("<td width='12%' style= cursor:hand; title='Click here to sort by - Sub Receipt No'    onclick=sort_data('SUB_REC_SORT') ><DIV class=div_input ><b>Sub Receipt No</b></DIV></td>"); // SUB_REC_NO
				...
				if(mm_location_code.trim().equals("ALL")){  // added by udara on 07-12-2012
					...
					// added by udara 13-08-2015
					String sql47 = " SELECT A.SETTLE_MODE,SUM(A.REC_AMOUNT),COUNT(A.REC_AMOUNT) "+
						" FROM "+m_schema_name+".AF_CO_PRO_SETTL_RECEIPT  A , "+m_schema_name+".AF_CO_PRO_SETTL_REC_APP_BAL B, "+m_schema_name+".AF_CO_PRO_APPLICATION_DETAILS C  "+
						" WHERE  A.REC_NO = B.REC_NO(+) AND B.FINANCE_NO = C.FINANCE_NO(+)  AND  "+
						" TO_DATE(TO_CHAR(A.ENT_DATE,'DD-MM-YYYY'),'DD-MM-YYYY')>=TO_DATE('"+m_from_date+"','DD-MM-YYYY') ";
					
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						//sql47 = sql47 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(A.BRANCH_CODE),'-') = '"+m_region+"' ";   
						sql47 = sql47 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 07-08-2015
					}
					
						sql47 = sql47 +" AND TO_DATE(TO_CHAR(A.ENT_DATE,'DD-MM-YYYY'),'DD-MM-YYYY')<=TO_DATE('"+m_to_date+"','DD-MM-YYYY') "+
					...
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						sql47 = sql47 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 13-08-2015
					}
				...
				if(mm_location_code.trim().equals("ALL")){  // added by udara on 07-12-2012
					...
					// added by udara 13-08-2015
					String sql48 = " SELECT A.ENT_USER,A.SETTLE_MODE,SUM(A.REC_AMOUNT),COUNT(A.REC_AMOUNT) "+
						" FROM "+m_schema_name+".AF_CO_PRO_SETTL_RECEIPT  A , "+m_schema_name+".AF_CO_PRO_SETTL_REC_APP_BAL B, "+m_schema_name+".AF_CO_PRO_APPLICATION_DETAILS C  "+
						" WHERE  A.REC_NO = B.REC_NO(+) AND B.FINANCE_NO = C.FINANCE_NO(+)  AND  "+
						" TO_DATE(TO_CHAR(A.ENT_DATE,'DD-MM-YYYY'),'DD-MM-YYYY')>=TO_DATE('"+m_from_date+"','DD-MM-YYYY') ";
					
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						//sql48 = sql48 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(A.BRANCH_CODE),'-') = '"+m_region+"' "; 
						sql48 = sql48 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 07-08-2015
					}
					
						sql48 = sql48 +" AND TO_DATE(TO_CHAR(A.ENT_DATE,'DD-MM-YYYY'),'DD-MM-YYYY')<=TO_DATE('"+m_to_date+"','DD-MM-YYYY') "+
						" AND A.REC_TYPE='TMP'  "+ m_user_query+
						//" AND C.BRANCH_CODE = '"+m_location_code+"'  "+ // " AND "+m_schema_name+".AF_CO_GET_APP_LOCATION("+m_schema_name+".AF_CO_GET_APPLICATION_NO(NVL("+m_schema_name+".AF_CO_GET_REC_FIN_NO(REC_NO),'-'))) = '"+m_location_code+"' "+ //ADDED BY NS ON 28-03-2011
						" "+location_query_part+" "+ // " AND  "+m_schema_name+".AF_CO_GET_USER_LOCATION_RRN(ENT_USER) LIKE '"+m_branch_id+"%'  "+ // added by udara on 27-02-2013
						" GROUP BY A.ENT_USER,A.SETTLE_MODE "+
					...
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						...
						sql48 = sql48 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 13-08-2015
					}
				...
				if (m_location_code.trim().equals("ALL")) {
					...
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						//sql40 = sql40 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(A.BRANCH_CODE),'-') = '"+m_region+"' ";
						sql40 = sql40 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 07-08-2015
					}
					
						sql40 = sql40 +" AND TO_DATE(TO_CHAR(A.ENT_DATE,'DD-MM-YYYY'),'DD-MM-YYYY')<=TO_DATE('"+m_to_date+"','DD-MM-YYYY') "+m_user_query+
						" AND A.SETTLE_MODE ='STD_ORD' "+
						" AND C.BRANCH_CODE = '"+m_location_code+"'  "+ // " AND "+m_schema_name+".AF_CO_GET_APP_LOCATION("+m_schema_name+".AF_CO_GET_APPLICATION_NO(NVL("+m_schema_name+".AF_CO_GET_REC_FIN_NO(REC_NO),'-'))) = '"+m_location_code+"' "+ //ADDED BY NS ON 28-03-2011
						" "+location_query_part+" "+ //" AND  "+m_schema_name+".AF_CO_GET_USER_LOCATION_RRN(ENT_USER) LIKE '"+m_branch_id+"%'  "+ // added by udara on 27-02-2013
						"  "+m_active_status_string+" "+ // added by udara 19-08-2015
					...
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						sql40 = sql40 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 13-08-2015
					}
				...
				out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_receipt_report?chksql=load_receipts_stdo&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&order_by=\"+m_sort_col+\"&sort_by=\"+m_order_by_type+\"&location_code="+mm_location_code+"&user="+m_user+"&branch_id=\"+m_branch_id;"); // added by udara on 03-12-2012
				//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_display_receipt_deposit_report1?chksql=MAIN&order_by=\"+m_sort_col+\"&sort_by=\"+m_order_by_type+\"&receipt_no="+m_receipt_no+"&deposite_no="+m_deposite_no+"&from_date="+m_from_date+"&to_date="+m_to_date+"\";");		
				out.println(" window.location.href=m_url;"); 
				out.println("}");
				...
				if(mm_location_code.trim().equals("ALL")){  // added by udara on 07-12-2012
					...
					// added by udara 13-08-2015
					String sql41 = " SELECT A.SETTLE_MODE,SUM(A.REC_AMOUNT),COUNT(A.REC_AMOUNT) "+
						" FROM "+m_schema_name+".AF_CO_PRO_SETTL_RECEIPT  A , "+m_schema_name+".AF_CO_PRO_SETTL_REC_APP_BAL B, "+m_schema_name+".AF_CO_PRO_APPLICATION_DETAILS C  "+
						" WHERE  A.REC_NO = B.REC_NO(+) AND B.FINANCE_NO = C.FINANCE_NO(+)  AND "+
						" TO_DATE(TO_CHAR(A.ENT_DATE,'DD-MM-YYYY'),'DD-MM-YYYY')>=TO_DATE('"+m_from_date+"','DD-MM-YYYY') "+
						" AND TO_DATE(TO_CHAR(A.ENT_DATE,'DD-MM-YYYY'),'DD-MM-YYYY')<=TO_DATE('"+m_to_date+"','DD-MM-YYYY') "+
					...
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						sql41 = sql41 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 07-08-2015
					}
					
						sql41 = sql41 +"   "+ // " AND "+m_schema_name+".AF_CO_GET_APP_LOCATION("+m_schema_name+".AF_CO_GET_APPLICATION_NO(NVL("+m_schema_name+".AF_CO_GET_REC_FIN_NO(REC_NO),'-'))) = '"+m_location_code+"' "+ //ADDED BY NS ON 28-03-2011
						" "+location_query_part+" "+ // " AND  "+m_schema_name+".AF_CO_GET_USER_LOCATION_RRN(ENT_USER) LIKE '"+m_branch_id+"%'  "+ // added by udara on 27-02-2013
						" GROUP BY A.SETTLE_MODE ";
					// end by udara 13-08-2015
					
					rs1= stmt1.executeQuery(sql41);		
					...
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						sql41 = sql41 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 13-08-2015
					}
					
						sql41 = sql41 +" AND C.BRANCH_CODE = '"+m_location_code+"'  "+ // " AND "+m_schema_name+".AF_CO_GET_APP_LOCATION("+m_schema_name+".AF_CO_GET_APPLICATION_NO(NVL("+m_schema_name+".AF_CO_GET_REC_FIN_NO(REC_NO),'-'))) = '"+m_location_code+"' "+ //ADDED BY NS ON 28-03-2011
						" "+location_query_part+" "+ // " AND  "+m_schema_name+".AF_CO_GET_USER_LOCATION_RRN(ENT_USER) LIKE '"+m_branch_id+"%'  "+ // added by udara on 27-02-2013
						" GROUP BY A.SETTLE_MODE ";
				...
				if(mm_location_code.trim().equals("ALL")){  // added by udara on 07-12-2012
					...
					String sql42 = " SELECT A.ENT_USER,A.SETTLE_MODE,SUM(A.REC_AMOUNT),COUNT(A.REC_AMOUNT) "+
						" FROM "+m_schema_name+".AF_CO_PRO_SETTL_RECEIPT  A , "+m_schema_name+".AF_CO_PRO_SETTL_REC_APP_BAL B, "+m_schema_name+".AF_CO_PRO_APPLICATION_DETAILS C  "+
						" WHERE  A.REC_NO = B.REC_NO(+) AND B.FINANCE_NO = C.FINANCE_NO(+)  AND  "+
						" TO_DATE(TO_CHAR(A.ENT_DATE,'DD-MM-YYYY'),'DD-MM-YYYY')>=TO_DATE('"+m_from_date+"','DD-MM-YYYY') "+
						" AND TO_DATE(TO_CHAR(A.ENT_DATE,'DD-MM-YYYY'),'DD-MM-YYYY')<=TO_DATE('"+m_to_date+"','DD-MM-YYYY') ";
					...
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						//sql42 = sql42 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(A.BRANCH_CODE),'-') = '"+m_region+"' "; 
						sql42 = sql42 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 07-08-2015
					}
					
						sql42 = sql42 +" AND A.SETTLE_MODE ='STD_ORD' "+ m_user_query+
						" AND A.STATUS IN ('E','B') "+
						" "+location_query_part+" "+  //" AND  "+m_schema_name+".AF_CO_GET_USER_LOCATION_RRN(ENT_USER) LIKE '"+m_branch_id+"%'  "+ // added by udara on 27-02-2013
						" GROUP BY A.ENT_USER,A.SETTLE_MODE "+
						" ORDER BY A.ENT_USER,A.SETTLE_MODE ";
					...
					if(!(m_region.equals("NOT_SELECT"))){    // Added By: Samith Dilshan on 2015-06-15 for Region Code
						sql42 = sql42 +"  AND  NVL("+m_schema_name+".AF_CO_GET_USER_REGION(C.BRANCH_CODE),'-') = '"+m_region+"' "; // added by udara 13-08-2015
					}
