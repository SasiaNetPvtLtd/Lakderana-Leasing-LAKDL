...
//--
//SCREEN NAME:SYSTEM ADMINISTRATION - PRODUCT CODES
//CREATED BY:
//DATE/TIME:
//NOTES:
...
public class LAKDL_AF_MAS_display_product_codes extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>System Administration - Product Codes</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("			}");
			out.println("else if(data_vec.length==0 && document.Form1.SCREEN_NAME.value!=\"NEW\" && document.Form1.TXT_PRODUCT_CODE.value!='' && document.Form1.hid_val.value=='t1'){");
			out.println("alert('Selected Product code is incorrect,use help...!')");
			...
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_leasing_product_id&data_val=\"+obj.value+\"&ac_status=\"+document.Form1.hid_st.value;");
			...
			out.println("		if(validate_data()){"); 
			out.println("		document.Form1.action='"+m_class_url+"/LAKDL_AF_MAS_save_product_codes';");  
			...
			out.println("		if(confirm(\"Are You Sure?\")){ "); 
			out.println("		window.location.href='"+m_class_url+"/LAKDL_AF_MAS_display_product_codes';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("    m_help_message = \"m_help_msg_LAKDL_AF_MAS_display_product_codes\";"); 
			...
			out.println("help_box.innerHTML=\" System Administration - Product Codes - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" System Administration - Product Codes - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
	  	...
	  	out.println("		}"); 
			...
			out.println("    m_sql = \"m_help_TXT_PRODUCT_ID_sql\";"); 
			...
			out.println("    } ");
			out.println("    else{");
			out.println("    m_criteria = document.Form1.TXT_PRODUCT_CODE.value+\"@\"+\"N@\";}"); 
			out.println("    HelpBox('1','10','0');"); 
			out.println("}"); 
	  	...
	  	out.println("		}"); 
			...
			out.println("    m_sql = \"m_view_TXT_PRODUCT_CODE_sql\";");
			out.println("    m_criteria = document.Form1.TXT_PRODUCT_CODE.value+\"@\"+\"Y@\";"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>System Administration - Product Codes</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_PRODUCT_CODE' maxlength='10' size='10' onblur=\"assig('t1'),makeRequest(document.Form1.TXT_PRODUCT_CODE)\">"); 
