...
public class LAKDL_AF_MAS_display_user_login_report extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>User Login Details </TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_user_login_detail_report?chksql=LOGIN_DETAILS&from_date=\"+m_from_date+\"&to_date=\"+m_to_date;");
      ...
      out.println(" document.Form1.hid_cal_date.value=num;"); 
		  ...
		  out.println("  if(document.Form1.hid_cal_date.value=='1'){"); 
			...
			out.println("	help_box.innerHTML=\" User Login Details- \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\" User Login Details \";"); 
			out.println("}"); 
	  	...
	  	out.println("					}"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> User Login Details </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
