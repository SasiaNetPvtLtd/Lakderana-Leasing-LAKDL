...
public class LAKDL_AF_UG_Administration_followup extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out = res.getOutputStream(); 
						...
						out.println("<p class=ug_headin><a NAME='Follow_Up'></a><u>Follow Up</u> ");
						
						Geographic_Areas_header="<p align='justify' class=rep-body>Through Follow Up section you can predefine activities that are expected to be done when following up. Examples for such activities can be Send documents, Call and Collect document.";
						...
						out.println("<p class=ug_headin><a NAME='Follow _Up_Action_Categories'>");
						out.println("</a><u>Follow Up Action Categories</u>");
						out.println(" ");
						out.println("<p class=rep-body>Follow up action categories are the action types that the users have to select when entering or modifying follow up actions. You can predefine such actions here so that the user will have to select the action from a list.");
					...
					out.println("<p align='justify' class=rep-body>As Overdraft interest rate at your company is not fixed, you will need to update the interest rate occasionally. This screen helps you to change the ODI rate after the effective date you specify.");
					*/
					/*	//------------Variable base rates
