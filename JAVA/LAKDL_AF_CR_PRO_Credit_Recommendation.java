...
public class LAKDL_AF_CR_PRO_Credit_Recommendation extends javax.servlet.http.HttpServlet {
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)
	{
		...
		try {
			...
			if (m_chksql.trim().equals("idle")) {
				...
				out.println("<html>");
				out.println("<head>");
				out.println("<title>Asset Financing System 1</title>    ");
				...
				out.println("}");
				out.println("else if('"+m_pre_stage+"'=='V-APP'){");
				out.println("help_box.innerHTML=\" Credit  - Credit Recommendation - \"+document.Form1.hid_status.value;"); 
				out.println("}");
				out.println("else if('"+m_pre_stage+"'=='VERIFY-M'){");
				...
				//out.println("		document.Form1.action=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_PRO_save_application_approval_details?scr=\"+document.Form1.hid_scr.value+\"&number=\"+document.Form1.hid_no.value+\"&actst1=\"+m_prev+\"&actst2=\"+m_app;");   
				out.println("		document.Form1.action=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_PRO_Save_Credit_Recomendation?scr=\"+document.Form1.hid_scr.value+\"&number=\"+document.Form1.hid_no.value+\"&actst1=\"+m_prev+\"&actst2=\"+m_app;");   
			...
			*/
			...
			//  out.println(" window.location.href=m_url;"); 
				...
				*/
				...
				// 		out.println("	m_url = \""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_PRO_Application_Status_Report_appr?chksql=main_page&pre=\"+m_app+\"&appro=\"+m_prev;"); 
				out.println("	m_url = \""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_PRO_Credit_Recommendation?chksql=main_page&pre=\"+m_app+\"&appro=\"+m_prev;"); 
				...
				if(m_pre_stage.equals("ENT_CON")){
					...
					out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Credit - Credit Recommendation</td>"); 
				}
				...
				//*** Credit Recommendation ****
					...
					rs = stmt.executeQuery (" SELECT  "+ //added by udara 07-03-2019
						...
						"	FROM "+m_schema_name+".AF_CO_PRO_APPLICATION_DETAILS A "+ 
						" WHERE APPLICATION_STATUS IN ('"+m_pre_stage1+"') "+ 
						" AND DECODE("+m_schema_name+".AF_CO_GET_USER_LOCATION('"+m_username+"'),'HO','-',"+m_schema_name+".AF_CO_GET_USER_LOCATION('"+m_username+"')) LIKE  DECODE("+m_schema_name+".AF_CO_GET_USER_LOCATION('"+m_username+"'),'HO','-',A.BRANCH_CODE)||'%' "+ // added by udara on 18-06-2013//temp commented by milinda 2014-05-19
						" ORDER BY "+m_sort_column+" "+m_order_by_type+"");
		...
		out.println("<td width=\"5%\" align=center><input type=\"checkbox\" name=chk_reject_"+j+" value=\"N\" unchecked onclick=\"change_reject('"+j+"')\" ></td>");
			...
			//added by nuwan de silva on 23-11-2007------
				...
				out.println("}");
				//out.println("		document.Form1.action=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_PRO_save_application_approval_details?scr=\"+document.Form1.hid_scr.value+\"&number=\"+document.Form1.hid_no.value+\"&actst1=\"+m_prev+\"&actst2=\"+m_app;");   
				//out.println("alert('m_prev'+m_prev);");
				//out.println("alert('m_app'+m_app);");
				...
				out.println("	m_url = \""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_PRO_Credit_Recommendation?chksql=main_page&pre=\"+m_prev+\"&appro=\"+m_app+\"&qry=\"+m_prev+\"&option=\"+val;"); 
				out.println(" window.location.href=m_url;");
				
				out.println("}");
				out.println("else	if(val==2){");
				
				out.println("	m_url = \""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_PRO_Credit_Recommendation?chksql=main_page&pre=\"+m_prev+\"&appro=\"+m_app+\"&qry=\"+m_app+\"&option=\"+val;"); 
				out.println(" window.location.href=m_url;"); 
				...
				//out.println(" alert('app no'+val3);");
				////out.println("	m_url = \""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_PRO_Credit_Verifi_app_1?pre="+m_pre_stage+"&appro="+m_app_stage+"&qry="+m_pre_stage1+"&applicaton_no=\"+val+\"&insurance_done=\"+val2+\"&close=1\";"); 
				out.println("	m_url = \""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_PRO_Credit_Recommend_app?pre="+m_pre_stage+"&appro="+m_app_stage+"&qry="+m_pre_stage1+"&applicaton_no=\"+val+\"&insurance_done=\"+val2+\"&contract_no=\"+document.Form1.TXT_CONTRACT_NUMBER.value+\"&clientcode=\"+val3+\"&close=1\";"); 
				out.println(" window.location.href=m_url;"); 
				//out.println("popupwin=window.open(m_url,'displayWindow2','left=60,top=10,width=800,height=650,toolbar=0,location=0,directories=0,status=0,menuBar=0,scrollBars=1,resizable=1,fullscreen=yes');"); 
				...
				out.println("m_option=1");
				//out.println("	m_url = \""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_PRO_Application_Status_Report_appr?chksql=load_data_client&pre=\"+m_prev+\"&appro=\"+m_app+\"&qry=\"+m_prev+\"&division_code=\"+m_division_code+\"&m_client_name=\"+m_client_name+\"&option=\"+m_option;"); 
				out.println("	m_url = \""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_PRO_Credit_Recommendation?chksql=load_data_client&pre=\"+m_prev+\"&appro=\"+m_app+\"&qry=\"+m_prev+\"&division_code=\"+m_division_code+\"&m_client_name=\"+m_client_name+\"&option=\"+m_option;"); 
				...
				//out.println("	m_url = \""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_PRO_Application_Status_Report_appr?chksql=load_data_client&pre=\"+m_prev+\"&appro=\"+m_app+\"&qry=\"+m_app+\"&division_code=\"+m_division_code+\"&m_client_name=\"+m_client_name+\"&option=\"+m_option;"); 
				out.println("	m_url = \""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_PRO_Credit_Recommendation?chksql=load_data_client&pre=\"+m_prev+\"&appro=\"+m_app+\"&qry=\"+m_app+\"&division_code=\"+m_division_code+\"&m_client_name=\"+m_client_name+\"&option=\"+m_option;"); 
				...
				out.println("<input type=hidden name=\"ROW_ID\" ></td>");
				out.println("<input type=hidden name=\"hid_save\" value=\"Save\" ></td>");
				out.println("<INPUT TYPE='Hidden' NAME='Hid_scr_name_verification' VALUE=\"AF_CR_CREDIT_RECOMMENDATION\">");  // added by nuwan de silva on 17-12-2007
				...
				out.println("<input class='but_input' type='button' text-align='center' name='BUT_HELP_CLIENT' value=\" ... \" onClick=\"help_button_2()\">"); // prabash 0n 22-03-2012 -help_update()
			...
			//__________________________________________added by nuwan de silva on 23-11-2007 _____________________________________________
				...
				if(req.getParameter("sort_column")!=null && req.getParameter("order_by_type")!=null){
					...
					out.println("m_pre_stage1"+m_pre_stage1);
					*/
				}
				String  m_opt=req.getParameter("option");
				if	(req.getParameter("option")==null){
				...
				//out.println("<td  width='10%' style= cursor:hand; title='Click here to sort by - Facility No  '       onclick=sort_data('FACILITY_NO') >Facility No</td>");
				out.println("<td  width='10%' style= cursor:hand; title='Click here to sort by - Facility No  '       onclick=sort_data('FACILITY_NO') >Contact No</td>");
				out.println("<td  width='5%'  style= cursor:hand; title='Click here to sort by - Period  '            onclick=sort_data('PERIOD') >Period(Days)</td>");
		...
		out.println("<td width=\"5%\" align=center><input type=\"checkbox\" name=chk_reject_"+j+" value=\"N\" unchecked onclick=\"change_reject('"+j+"')\" ></td>");
					...
					*/
					...
					if(((m_pre_stage.equals("V-APP") || m_pre_stage.equals("VERIFY-M")) && (m_limit < m_total))){
						...
						if (m_opt.equals("2")){
							out.println("<td width=\"5%\" align=center><input type=\"checkbox\" name=chk_quot_"+j+" value=\"N\" unchecked onclick=\"change('"+j+"')\" ></td>");//disabled
							out.println("<td width=\"5%\" align=center><input type=\"checkbox\" name=chk_reject_"+j+" value=\"N\" unchecked onclick=\"change_reject('"+j+"')\" ></td>");//disabled
