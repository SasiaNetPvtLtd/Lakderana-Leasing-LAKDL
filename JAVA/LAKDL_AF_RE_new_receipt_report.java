		...
		try { 
			...
			if(m_chksql.equals("main_page")){
				...
				try{
					...
					callstmt1=conn.prepareCall("BEGIN "+m_schema_name+".NEW_RECIEPT_REPORT(?,?,?,?,?,?,?,?,?,?,?,?); END;");
					callstmt1.setString(1,m_username);
					callstmt1.setString(2,m_mdatefrom);
					callstmt1.setString(3,m_mdate);
					callstmt1.setString(4,m_agent);
					callstmt1.setString(5,m_cor);
					callstmt1.setString(6,m_port);
					callstmt1.setString(7,m_username);
					callstmt1.setString(8,m_mdatefrom);
					callstmt1.setString(9,m_mdate);
					callstmt1.setString(10,m_agent);
					callstmt1.setString(11,m_cor);
					callstmt1.setString(12,m_port);
					callstmt1.execute();	
					callstmt1.close();	
					out.println("ok");
				...
				{
					out.println("error "+errrr.toString());
				}
