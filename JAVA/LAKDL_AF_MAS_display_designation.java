...
public class LAKDL_AF_MAS_display_designation extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>System Administration - Designations</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("			}");
			out.println("		  else	if(data_vec.length > 0 && document.Form1.SCREEN_NAME.value!=\"NEW\"&& document.Form1.TXT_DESIGNATION_CODE.value !=''&& document.Form1.hid_help_status.value == 'H1' ){");
			...
			out.println("		  else	if( document.Form1.hid_help_status.value == 'H2' && document.Form1.TXT_DIVISION.value !=''  ){");
			out.println(" help_button_1();"); 
			out.println("			}");
			
			out.println("		  else	if(data_vec.length > 0 && document.Form1.hid_help_status.value == 'H4' && document.Form1.TXT_DIVISION.value !=''  ){");
			out.println("				document.Form1.TXT_DESCRIPTION.value=data_vec[1];");
			out.println("			}");
			out.println("			else");
			out.println("			if(data_vec.length>0  && document.Form1.TXT_DESIGNATION_NAME.value!=\"\" && document.Form1.hid_help_status.value=='H5' &&document.Form1.SCREEN_NAME.value==\"NEW\" ){");
			out.println("alert('Record already exists');");
			...
			out.println("    m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations1?chksql=m_prime_chk_LAKDL_AF_MAS_display_designation_code&data_val=\"+obj.value;");
			out.println("}");
			out.println("    else");
      ...
      out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_designation&data_val=\"+obj.value+\"&ac_status=N\";");
			...
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations1?chksql=m_prime_chk_LAKDL_AF_MAS_display_designation_desc&data_val=\"+obj.value;");
			...
			out.println("    m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_division1&data_val=\"+obj.value;");
			...
			out.println("    document.Form1.TXT_DESIGNATION_CODE.value=data_vec[0];"); 
			out.println("    document.Form1.TXT_DESIGNATION_NAME.value=data_vec[1];"); 
			out.println("    document.Form1.TXT_DESIGNATION_LEVEL.value=data_vec[2];"); 
			out.println("    document.Form1.TXT_DIVISION.value=data_vec[3];"); 
			out.println("assign_help_status('H4');");
			out.println("makeRequest(document.Form1.TXT_DIVISION);");
			
			out.println("}");

			out.println("function validate_data(){"); 
			out.println("//validations goes here"); 
			out.println("if(document.Form1.TXT_DESIGNATION_CODE.value==\"\"){  "); 
			out.println("DIV_TXT_DESIGNATION_CODE.style.color='red';");
			out.println("return false;"); 
			out.println("}"); 
			out.println("else if(document.Form1.TXT_DESIGNATION_NAME.value==\"\"){  "); 
			out.println("DIV_TXT_DESIGNATION_NAME.style.color='red';");
			out.println("return false;"); 
			out.println("}"); 
			out.println("else if(document.Form1.TXT_DIVISION.value==\"\"){  "); 
			...
			out.println("   document.Form1.TXT_DESIGNATION_LEVEL.value='';");
			out.println("   document.Form1.TXT_DESIGNATION_LEVEL.focus();");
			out.println("   }");
			out.println("}");
			...
			out.println("}");
			out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_MAS_save_designation';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MAS_display_designation';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("    m_help_message = \"m_help_msg_LAKDL_AF_MAS_display_designation\";"); 
			...
			out.println("help_box.innerHTML=\" System Administration - Designations - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" System Administration - Designations - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
			...
			out.println("document.Form1.TXT_DESIGNATION_NAME.disabled=true;"); 
			out.println("document.Form1.TXT_DESIGNATION_LEVEL.disabled=true;"); 
      ...
      out.println("document.Form1.TXT_DESCRIPTION.disabled=true;"); 
	  	...
	  	out.println("}");
			out.println("if(document.Form1.hid_help_type.value==\"2\"){");
			out.println("document.Form1.TXT_DESIGNATION_NAME.value='';");
			out.println("document.Form1.TXT_DESIGNATION_NAME.focus();");
			out.println("}");
			...
			out.println("    } ");
			out.println("    else{");
			out.println("    m_criteria = document.Form1.TXT_DESIGNATION_CODE.value+\"@\"+\"N@\";}"); 
			out.println("    HelpBox('1','10','0');"); 
			out.println("}"); 

			out.println("function help_update_value_assign_99() {"); 
			out.println("    document.Form1.TXT_DESIGNATION_CODE.value=oBj.valout[2];"); 
			out.println("    document.Form1.TXT_DESIGNATION_NAME.value=oBj.valout[3];"); 
			out.println("    document.Form1.TXT_DESIGNATION_LEVEL.value=oBj.valout[4];"); 
			out.println("    document.Form1.TXT_DIVISION.value=oBj.valout[5];"); 
			...
			out.println("    m_sql = \"m_help_TXT_DESIGNATION_DESC_sql\";"); 
			out.println("    m_criteria = document.Form1.TXT_DESIGNATION_NAME.value+\"@\"+\"Y@\";"); 
			out.println("    HelpBox('1','10','0');"); 
			out.println("}"); 
	  	...
	  	out.println("		}"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>System Administration - Designations</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_DESIGNATION_CODE' maxlength='10' size='10' onblur=\"assign_help_status('H1'),makeRequest(document.Form1.TXT_DESIGNATION_CODE)\">"); 
			out.println("<input class='but_input' type='button' name='BUT_HELP_MAIN' value=\"Help\" onClick=\"help_update()\" disabled></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 

			out.println("<td width='30%' ><DIV id='DIV_TXT_DESIGNATION_NAME'  class=div_input>Designation Name *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_DESIGNATION_NAME' maxlength='50' size='50' onblur=\"assign_help_status('H5'),makeRequest(document.Form1.TXT_DESIGNATION_NAME)\"></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 

			out.println("<td width='30%' >Designation Level </td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_DESIGNATION_LEVEL' maxlength='2' size='2' onblur='val_number(this.value)'></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			
			out.println("<tr>"); 
			out.println("<td width='30%' ><DIV id='DIV_TXT_DIVISION'  class=div_input>Division Code *</DIV></td>"); 
			out.println("<td width='30%' ><input class='txt_input' type='text' name='TXT_DIVISION' maxlength='10' size='10'onblur=\"assign_help_status('H2'),makeRequest(document.Form1.TXT_DIVISION)\" >"); 
			out.println("<input class='but_input' type='button' name='BUT_TXT_DIVISION' value=\"Help\" onClick=\"help_button_1()\"></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			
			out.println("<tr >"); 
			out.println("<td width='30%' >Division Description *</td>"); 
			out.println("<td width='40%' ><input class='txt_input' style=\"{width:200px}\" type='text' name='TXT_DESCRIPTION' maxlength='50' size='200' disabled></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
