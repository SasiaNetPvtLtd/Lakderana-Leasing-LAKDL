...
public class LAKDL_AF_MISF_Marketing_Officer_Perform_Report_final_clone extends javax.servlet.http.HttpServlet { 
	...
	public  void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			if(m_chksql.equals("main_page")){ 
				...
				//out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Perform_Report_final_clone?chksql=run_report&finance_no=\"+finance_no+\"&date=\"+m_date+\"&location_id=\"+document.Form1.TXT_LOCATION_CODE.value+\"&user_id=\"+document.Form1.TXT_USER.value+\"&perform_status=\"+m_perform_status;"); 
				out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Perform_Report_final_clone?chksql=run_report&finance_no=\"+finance_no+\"&date=\"+m_date+\"&location_id=\"+document.Form1.TXT_LOCATION_CODE.value+\"&user_id=\"+document.Form1.TXT_USER.value+\"&perform_status=\"+m_perform_status+\"&collector=\"+collector;"); 
				...
				out.println("	}");
				*/
				//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Perform_Report_final_clone?chksql=print_report_new&location=\"+m_location+\"&officer=\"+m_officer+\"&slab=\"+m_slba+\"&rendate=\"+m_rendate+\"&date=\"+m_date;");	
				
				// commented by udara on 06-09-2013
				//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Perform_Report_final_clone?chksql=print_report_new&location=\"+m_location+\"&officer=\"+m_officer+\"&slab=\"+m_slba+\"&rendate=\"+m_rendate+\"&date=\"+m_date+\"&period=\"+m_period+\"&period_2=\"+m_period_2;"); // added by udara on 12-03-2013
				...
				//out.println("               m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Perform_Report_final_clone?chksql=print_report_new&location=\"+m_location+\"&officer=\"+m_officer+\"&slab=\"+m_slba+\"&rendate=\"+m_rendate+\"&date=\"+m_date+\"&period=\"+m_period+\"&period_2=\"+m_period_2+\"&cr_officer=\"+cr_officer+\"&active_status=\"+document.Form1.TXT_ACTIVE_STATUS.value+\"&region=\"+m_region+\"&perform_status=\"+m_perform_status;"); // m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Perform_Report_final_clone?chksql=print_report_new&location=\"+m_location+\"&officer=\"+m_officer+\"&slab=\"+m_slba+\"&rendate=\"+m_rendate+\"&date=\"+m_date+\"&period=\"+m_period+\"&period_2=\"+m_period_2;");
				out.println("               m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Perform_Report_final_clone?chksql=print_report_new_logic&location=\"+m_location+\"&officer=\"+m_officer+\"&slab=\"+m_slba+\"&rendate=\"+m_rendate+\"&date=\"+m_date+\"&period=\"+m_period+\"&period_2=\"+m_period_2+\"&cr_officer=\"+cr_officer+\"&active_status=\"+document.Form1.TXT_ACTIVE_STATUS.value+\"&region=\"+m_region+\"&perform_status=\"+m_perform_status;"); // udara 08-12-2016
				out.println("           else ");
				out.println("           	m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Perform_Report_final_clone?chksql=print_report_new_2&location=\"+m_location+\"&officer=\"+m_officer+\"&slab=\"+m_slba+\"&rendate=\"+m_rendate+\"&date=\"+m_date+\"&period=\"+m_period+\"&period_2=\"+m_period_2+\"&due_month=\"+due_month+\"&due_year=\"+due_year+\"&ins_level=\"+ins_level+\"&cr_officer=\"+cr_officer+\"&active_status=\"+document.Form1.TXT_ACTIVE_STATUS.value+\"&region=\"+m_region+\"&perform_status=\"+m_perform_status;"); // m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Perform_Report_final_clone?chksql=print_report_new_2&location=\"+m_location+\"&officer=\"+m_officer+\"&slab=\"+m_slba+\"&rendate=\"+m_rendate+\"&date=\"+m_date+\"&period=\"+m_period+\"&period_2=\"+m_period_2+\"&due_month=\"+due_month+\"&due_year=\"+due_year+\"&ins_level=\"+ins_level;");
				*/
				...
				out.println("               m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Perform_Report_final_clone?chksql=print_report_new_logic&location=\"+m_location+\"&officer=\"+m_officer+\"&slab=\"+m_slba+\"&rendate=\"+m_rendate+\"&date=\"+m_date+\"&period=\"+m_period+\"&period_2=\"+m_period_2+\"&cr_officer=\"+cr_officer+\"&active_status=\"+document.Form1.TXT_ACTIVE_STATUS.value+\"&region=\"+m_region+\"&perform_status=\"+m_perform_status+\"&due_month=\"+due_month+\"&due_year=\"+due_year+\"&ins_level=\"+ins_level+\"&product_name=\"+m_product_name;"); // added by udara 04-03-2019
				...
				out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Perform_Report_final_clone?chksql=main_page&generate=page';"); 
				out.println("		}"); 
				out.println("}"); 
			...
			// =============== end by udara on 06-09-2013 ====================================================================================
				...
				out.println("<td width=\"7%\"  align='center' > &nbsp; </td>"); // added by udara 22-04-2019
				out.println("<td width=\"7%\"  align='center' > &nbsp; </td>"); // added by udara 13-08-2020
				out.println("</tr >");
				...
				out.println("<td class=factoring-letter-body  ><b>Remark</b></td>"); // added by udara 22-04-2019
				out.println("<td class=factoring-letter-body  ><b>Moratorium</b></td>"); // added by udara 13-08-2020
				out.println("</tr >");
				...
				if((!m_rendate.equals("")) && (!m_rendate.equals(""))){
					...
					sql_m_rendate = 	" AND   NVL(VALUE_DATE,' ') = '"+m_rendate+"' ";
				}
				...
				if((!cr_officer.equals("")) ){
					...
					//sql_cr_officer_2 = " AND   CURR_COLL_OFFICER LIKE '%"+cr_officer+"%' ";
				...
				if((!m_officer.equals("")) ){
					//sql_m_officer = " AND   COLLECTION_OFFICER LIKE '%"+m_officer+"%' ";
					//sql_m_officer = " AND   COLL_OFICER LIKE '%"+m_officer+"%' "; // marketing executive
					sql_m_officer = " AND   COLL_OFICER = '"+m_officer+"' ";
				}
				...
				Sql_data = " "+		
					...
					" SELECT "+
							...
							" "+m_schema_name+".AF_CO_REM_LETTER_STATUS(FINANCE_NO) LETTER_STATUS, "+ // added by udara 22-04-2019
							" NVL("+m_schema_name+".AF_CO_GET_MORA_FLAG_STATUS(FINANCE_NO),'-') MORATORIUM_STATUS "+ // added by udara 13-08-2020
						...
						"  "+sql_m_region+" "+ 
						"  "+sql_m_region_product+" "+  // added by udara 04-03-2019
						"  "+sql_m_ins_level+" "+
						"  "+sql_due_month_year+" "+
						"  "+sql_perform_status+"  "+
						...
						"  "+sort_string+"  "+ // added by udara 15-09-2017
						" ";
				...
				while(rs.next()){
							...
							if(!rs.getString("VALUE_DATE").equals(rental_date)){
								...
								if(j!=1)	{
									...
									out.println("<td  class=factoring-letter-body   STYLE='{text-align:right;}'  > </td>"); 
									out.println("<td  class=factoring-letter-body   STYLE='{text-align:right;}'  > </td>");  
									out.println("<td  class=factoring-letter-body   STYLE='{text-align:right;}'  > </td>"); // added by udara 22-04-2019
									out.println("<td  class=factoring-letter-body   STYLE='{text-align:right;}'  > </td>"); // added by udara 13-08-2020
									out.println("</tr>");
							...
							out.println("<td  class=factoring-letter-body   bgcolor='"+row_colour+"'  > "+rs.getString("LETTER_STATUS")+" </td>"); // added by udara 22-04-2019
							out.println("<td  class=factoring-letter-body   bgcolor='"+row_colour+"'  > "+rs.getString("MORATORIUM_STATUS")+" </td>"); // added by udara 13-08-2020
