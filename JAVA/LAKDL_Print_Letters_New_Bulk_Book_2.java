...
class LAKDL_Print_Letters_New_Bulk_Book_2 implements Printable {
	...
	//public LAKDL_Print_Letters_New_Bulk_Book_2(String m_rec, String m_client_code){ // commented by udara 05-11-2019
	public LAKDL_Print_Letters_New_Bulk_Book_2(String m_rec, String m_client_code, String m_statement_date){ // added by udara 05-11-2019
	...
	public int print (Graphics g,PageFormat pageFormat, int page) {
		...
		//	System.out.println("sql Contract_Client_Data ==> "+Contract_Client_Data);
			...
			String arrearsDetails =" SELECT "+
				...
				" WHERE A.FINANCE_NO='"+m_application_no+"' "+
				" AND A.REMINDER_TYPE = 'FINREIM' "+ // added by udara 05-11-2019
			...
			Font bodyFont_3  	= new Font ("Times New Roman",Font.PLAIN,12);
	...
	/*		line = new AttributedString(m_contact_full_name + m_print_method.Add_Space(15)+ m_application_no + m_print_method.Add_Space(10) + m_vehicle_no + m_print_method.Add_Space(10) + m_Letter_date +m_print_method.Add_Space(10)+nf.format(arr_amount));
		...
		*/
		...
		//	System.out.println("line_4="+drawPosY);
			...
			line = new AttributedString("wjidk isysle|ùuhs'");
			...
			//data= "fï iïnkaOj wm úiska Tn fj;g tjk ,o mq¾j isysle|ùï iy$fyda ikaksfõokhkg jeäukla f,i fuh ,shd okajkq ,efí' wm okajd isákafka Tn úiska tlS ±kqï§ï u.ska b,a,d isá mßÈ ksis mßÈ jdßl f.úï isÿ lsßug ;jÿrg;a wiu;aj we;s nj;a\" th by; .súiqfï yrhd;aul wfmdfydi;a ùula njg m;aj we;s njhs'"; 
			//data= "fï iïnkaOj wm úiska Tn fj;g tjk ,o mq¾j isysle|ùï iy$fyda ikaksfõokhkg jeäukla f,i fuh ,shd okajkq ,efí' wm okajd isákafka Tn úiska tlS ±kqï§ï u.ska b,a,d isá mßÈ ksis mßÈ jdßl f.úï isÿ lsßug   ;jÿrg;a wiu;aj we;s nj;a\" th by; .súiqfï yrhd;aul wfmdfydi;a ùula njg m;aj we;s njhs'"; 
			  data="fï iïnkaOj wm úiska Tn fj;g tjk ,o mq¾j isysle|ùï iy$fyda ikaksfõokhkg "+
				   "jeäukla f,i fuh ,shd okajkq ,efí' wm okajd isákafka Tn úiska tlS ±kqï§ï"+
				   //"u.ska b,a,d isá mßÈ ksis mßÈ jdßl f.úï isÿ lsßug             ;jÿrg;a wiu;aj we;s nj;a\" "+ // commented by udara 12-06-2019
					"u.ska b,a,d isá mßÈ ksis mßÈ jdßl f.úï isÿ lsßug ;jÿrg;a       wiu;aj we;s nj;a\" "+ // added by udara 12-06-2019
				   "th by; .súiqfï yrhd;aul wfmdfydi;a ùula njg m;aj we;s njhs'";
			...
			data1= "ta wkqj by; l=,S iskaklalr .súiqfï kshuhka wkqj Tnf.ka wmfj; whúh hq;= ish¨u ys`. l=,S jdßl\" ta u; jq ys`. fmd<sho iu`. jq iuia: ysÕ uqo, fuu ,smsfha i`oyka Èk isg Èk y; ^07& la bl=;a ùug fmr f.jk f,ig;a ta olajd jq ish¨u f.ùï isÿlrk f,ig;a Tng okajd isáuq'"; 
			...
			data2= "tfia isÿlsßug Tn wiu;a jk wjia:djl § l=,sh wjika lsßug wjYH mshjr .kq ,nk njg;a\" tfia jqjfyd;a l=,S iskaklalr .súiqfï kshuhkag wkqj wmf.a iud.u fj; Tnf.ka whúh hq;=j mj;sk iuia: uqo, fmd<sh iy wfkl=;a úhoï o iu`. whlrjd .ekSug;a\" l=,shg fok ,o jdykh$WmlrKh kej; w;am;a lr .ekSug fyda tys jákdlu\" l=,sh wjika l< Èkfha isg l=,shg ÿka jdykfha$WmlrKfha"+
                   " ika;lh$N=la;sh Ndr fok f;la fyda kej; ,nd.kakd f;la jq w,dNhkao iu`. whlrjd .ekSu hk"+
                   " m%;sM,hka w;aú§ug isÿjk njg wms Tng fuu.ska okajd isákafkuq' tfia fyhska tjka ;;a;ajhla"+
                   " j,lajd,Sug wjYH kï by; b,a,d we;s mßos lghq;= lrk fuka o fuhska okajd isáñ'"; 
			...
			data3= "msgm;a ( wemlrejka jk Tn úiska wod, ld, iSudj ;=< f.ùï isÿjk njg úuid ne,Su iy f.ùï ksis mßos "+
					" isÿ lsÍug l=,S .eKqïlrej fm<Uùu Tn i;= j.lSula jk njo fuhska oekqï fouq'"; 
