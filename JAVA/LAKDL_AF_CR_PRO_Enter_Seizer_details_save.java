...
public class LAKDL_AF_CR_PRO_Enter_Seizer_details_save extends HttpServlet {
	...
	synchronized(this){ 
		...
		try {
			...
			m_url = m_class_url;				
     	    ...
     	    callstmt=conn.prepareCall("BEGIN "+m_schema_name+".AF_CO_MAS_SEIZER_DETAILS_SAVE(:1,:2,:3,:4); END;");
			...
			callstmt.setString(4,(String)m_sn_methods.met_formdata(reqstr,"SCREEN_NAME")); 
			callstmt.execute();			
		  	callstmt.close();
			...
			out.println("window.location.href='"+m_url+"/"+m_client_name+"AF_CR_PRO_Enter_Seizer_details?chksql=main_page';");
