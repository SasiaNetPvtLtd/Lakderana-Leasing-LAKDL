...
public class LAKDL_FA_OP_Cheque_Return_Transfer extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Operation Process - Cheque Return Transfer</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("			}");
			out.println("			if(validate_data()){"); 
			out.println("				document.Form1.action='"+m_class_url+"/"+m_fschema_name+"FA_OP_Save_Cheques_Return_Transfer?chksql=RECEIPT_DETAILS';");  
			...
			out.println("	help_box.innerHTML=\" Operation Process - Cheque Return Transfer - \"+m_val;"); 
  		out.println("		if(m_val==\"New\"){");
			...
			out.println("	help_box.innerHTML=\"  Operation Process - Cheque Return Transfer - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
	  	...
	  	out.println("					}"); 
			...
			out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"FA_OP_Non_Sales_and_Excess_Funds_Transfer_Data?chksql=CHEQUE_RETURN&facility_no=\"+document.Form1.TXT_FACILITY_NO.value+\"&client_code=\"+document.Form1.TXT_CLIENT_CODE.value+\"&cheque_no=\"+document.Form1.TXT_CHEQUE_NO.value;");
		  ...
		  out.println(" 	m_sql = \"m_help_DIV_TXT_FACILITY_NON_SALE_DELE_sql\";"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Operation Process - Cheque Return Transfer</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_CHEQUE_NO' maxlength='10' size='50' style='width:150'>"); 
			out.println("<input class='but_input' type='button' name='BUT_RECE_DETAILS' value=\"Display\" onClick=\"makeRequest_get_receipt_detail()\"></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>");
			out.println("</table>");
			out.println("<hr>");
