...
public class LAKDL_AF_CR_PRO_Enter_Deletion_letter_details_app_save extends HttpServlet {
	...
	public synchronized void  service(HttpServletRequest req, HttpServletResponse res)	throws IOException{
		...
		try {
			...
			out.println("window.location.href='"+m_url+"/LAKDL_AF_CR_PRO_Enter_Deletion_letter_details_app?chksql=main_page';");
