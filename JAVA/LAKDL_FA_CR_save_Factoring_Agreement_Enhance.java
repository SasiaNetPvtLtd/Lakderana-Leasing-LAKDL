...
public class LAKDL_FA_CR_save_Factoring_Agreement_Enhance extends HttpServlet {
  ...
  String reqstr;
	...
	public synchronized void  service(HttpServletRequest req, HttpServletResponse res)	throws IOException{
      ...
      String m_username = m_sn_methods.username;
			...
			//------------------------------------------------------------------------------------------
				callstmt1=conn.prepareCall("BEGIN "+m_schema_name+".FA_CR_SAVE_AGREEMENT_ENHANCE(:1,:2,:3,:4,:5); END;");
				
				int tnum=0;
				
							callstmt1.setString(1,m_facility_no);
							callstmt1.setString(2,m_client_no);
							callstmt1.setString(3,"AGREEMENT_ENHANCEMENT");
	   	...
	   	out.println("<HTML><HEAD>");
			...
			out.println("	m_url = \""+m_class_url+"/"+m_fschema_name+"FA_CR_Factoring_Agreement_Enhance?chksql=main_page&facility_no="+m_facility_no+"&print=FALSE&client_no="+m_client_no+"\";"); 
