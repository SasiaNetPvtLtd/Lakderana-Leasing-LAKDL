...
public class LAKDL_FA_OP_client_charges_report extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Operation Reports - Client Charges Report</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"FA_OP_PRO_rpt_client_charges?chksql=LOAD_CLIENT_CHARGES_REPORT&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&fee_code=\"+document.Form1.TXT_FEES.value+\"&facility_no=\"+document.Form1.TXT_FACILITY_NO.value;");
			...
			out.println("    m_help_message = \"m_help_msg_LAKDL_FA_OP_CLIENT_CHARGES_REPORT\";"); 
			...
			out.println("	help_box.innerHTML=\" Operation Reports - Client Charges Report - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\" Operation Reports - Client Charges Report \";"); 
			out.println("}"); 
	  	...
	  	out.println("					}"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Operation Reports - Client Charges Report </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<tr >"); 
			out.println("<td width='8%' ><DIV id='DIV_TXT_REAL_DATE'  class=div_input><b>From Date</b></DIV></td>"); 
			...
			out.println("</td> ");
			out.println("<td width='6%' ><DIV id='DIV_TXT_REAL_DATE'  class=div_input><b>To Date</b></DIV></td>"); 
			...
			out.println("<table class='table' width='100%'  >"); 
			out.println("<tr >"); 
			rs= stmt.executeQuery("SELECT FEE_CODE,FEE_DESC FROM "+m_schema_name+".FA_CO_MAS_FEES WHERE ACTIVE_STATUS='Y' ");

			out.println("<td width='10%' ><b>Charges Description</b></td>"); 
			out.println("<td width='20%' ><select name='TXT_FEES' class='txt_input'   style='width:300' >");
			...
			out.println("<td width='10%' ><DIV id='DIV_TXT_FACILITY_NO'  class=div_input><B>Facility No</B></DIV></td>"); 
			...
			out.println("<input class='but_input' type='button' name='BUT_DETAILS' value=\"Show\" onClick=\"makeRequest_detail()\"  ></td>");
			out.println("</tr>"); 
			out.println("</table>");
			out.println("<br>"); 
