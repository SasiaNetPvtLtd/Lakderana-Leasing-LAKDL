...
public class LAKDL_AF_CR_PRO_Credit_Approval_Saction_Letter_view2 extends javax.servlet.http.HttpServlet { 
...
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!	
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE> Sanction Letter-2</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_CR_PRO_Credit_Approval_Saction_Letter_view2?chksql=main_page';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("help_box.innerHTML=\"  Sanction Letter-2 - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\"  Sanction Letter-2 - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
	...
	//	out.println("window.open(m_url)");		
 	    ...
 	    out.println("    m_sql = \"m_help_TXT_FinanceSql_sql\";"); 
		  ...
		  //out.println("    m_sql = \"m_help_TXT_FinanceSql_new2\";");
		    ...
		    out.println("    } else { ");
			out.println("    m_sql = \"m_help_TXT_FinanceSql_sanction_sql2\";"); // mod by udara 31-10-2014 out.println("    m_sql = \"m_help_TXT_FinanceSql_sql2\";");
			out.println("    }  ");
		  //out.println("    m_criteria = document.Form1.TXT_FINANCE_NO.value+\"@\"+document.Form1.TXT_APPLICATION_NO.value+\"@\"+\"ACTIVATED@\";"); 
			out.println("    m_criteria = document.Form1.TXT_FINANCE_NO.value+\"@\"+document.Form1.TXT_CLIENT_CODE.value+\"@\"+\"ACTIVATED@\";"); 
			out.println("    HelpBox('1','10','0');"); 
			...
			//out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"LAKDL_AF_CR_PRO_Credit_Approval_Saction_Letter_view2?chksql=LOAD_TERMINATION_LETTER&finance_no=\"+document.Form1.TXT_FINANCE_NO.value;");
			out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_CR_PRO_Credit_Approval_Saction_Letter?chksql=Report&print=TRUE&letter=second&applicaton_no=\"+document.Form1.HID_APPLICATION_NO.value;");
			out.println("		window.open(m_url);");
...
//-----------------------------------------------------------------------------------------------------------------------
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Sanction Letter-2</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
