...
public class LAKDL_AF_RE_Ins_Bulk_Print_Main extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Invoicing - Insuarance Bulk Print </TITLE>"); 
			out.println("</HEAD>"); 
      ...
      out.println(" 	  if(m_to_dd != '' && m_to_mm !='' && m_to_yy !=''  ) { ");
			out.println("  	     if(checkMonthLength(document.Form1.TXT_TO_DATE_DD,document.Form1.TXT_TO_DATE_MM,document.Form1.TXT_TO_DATE_YY) && checkMonthLength(document.Form1.TXT_FROM_DATE_DD,document.Form1.TXT_FROM_DATE_MM,document.Form1.TXT_FROM_DATE_YY)){  "); // Modified by Udara on 12/10/2009 by adding validations to From Date side
      ...
      out.println("			else {");
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_RE_Ins_Bulk_Print_Main?chksql=main_page';"); 
			out.println("		}"); 
			out.println("}"); 
	  	...
	  	out.println("					}"); 
			...
			//out.println("   m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_Bulk_Print_Main?chksql=BULK_PRINT_INS&mode=\"+document.Form1.SETT_MODE.value+\"&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&print_type=\"+val+\"\";");
			out.println("   m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_Bulk_Print_Main?chksql=BULK_PRINT_INSUARANCE&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&print_type=\"+val+\"\";");
			//out.println("window.open(m_url);");
		  out.println("document.Form1.submit();");	
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Invoicing - Insuarance Bulk Print </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<OPTION value=\"PDC\" >PDC</OPTION>");
	...
	*/
			out.println("<table class='table' width='100%'  >"); 
			out.println("<tr >"); 
			out.println("<td width='20%' ><DIV id='DIV_TXT_FROM_DATE'  class=div_input>From Date</b></DIV></td>"); 
			...
			out.println("<input class=\"txt_input5\" type=\"text\" name=TXT_TO_DATE_YY maxlength=\"4\" size=\"4\" > "+
			            //"<input class='but_input' type='button' name='BUT_VIEW' value=\"Pending\" onClick=\"bulk_print('PEN')\"> "+
									"&nbsp;&nbsp;<input class='but_input' type='button' name='BUT_VIEW' Style=\"{width:110px;}\" value=\" Bulk Print \" onClick=\"bulk_print('ALL')\">");	
			out.println("</td> ");
