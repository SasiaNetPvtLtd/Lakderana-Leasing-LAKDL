...
public class LAKDL_FA_OP_Charges_Hold extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
      ...
      ResultSet rs1;
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Operation Process - Charges Hold </TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("		charges_hold.innerHTML=\"<p><b>Please Wait...\"+durationID+\" s</b></P>\";");
			out.println("}");
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"FA_OP_Charges_Hold?chksql=main_page';"); 
			out.println("		}"); 
			out.println("}"); 
...
/*
			...
			*/
			...
			out.println("	help_box.innerHTML=\"  Operation Process - Charges Hold - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\"  Operation Process - Charges Hold - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
	  	...
	  	out.println("					}"); 
			...
			out.println("		charges_hold.innerHTML=\"\";");
			out.println("   set_timer_actions();");
			out.println("		if(validate_data()){");			
			out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"FA_OP_PRO_sql_validations_normal?chksql=LOAD_FEE_PACKAGE_DETAILS&CLIENT_CODE=\"+document.Form1.TXT_CLIENT_CODE.value+\"&FACILITY_NO=\"+document.Form1.TXT_FACILITY_NO.value;");	
			...
			out.println("		charges_hold.innerHTML=m_data;");
			out.println("}");
		...
		out.println("function before_submit(){ "); 
			...
			out.println("			}");
			out.println("			if(validate_data()){"); 
			out.println("				document.Form1.action='"+m_class_url+"/"+m_fschema_name+"FA_CR_Save_Changes_Hold';");  
			...
			out.println("function chk_status(obj){");
			//out.println("alert('before'+obj.value);");
			out.println("if(obj.checked==true){");
			out.println("obj.value='on';");
			out.println("}else if(obj.checked==false){");
			out.println("obj.value='off';");
			out.println("}");
			//out.println("alert('after'+obj.value);");
			out.println("} ");
			
			out.println("function get_Status(){");
			//out.println("alert('sdf'+document.Form1.hid_line_count.value);");
			out.println("for (var i=0; i < parseFloat(document.Form1.hid_line_count.value); i++ ) {");
			out.println("m_chk=\"chkbox_fee_\"+i;");
			out.println("if(document.Form1.elements[m_chk].checked==true){");
			out.println("document.Form1.elements[m_chk].value='on'");
			//out.println("document.Form1.elements[m_chk].checked=true;");
			out.println("}else if(document.Form1.elements[m_chk].checked==false){");
			out.println("document.Form1.elements[m_chk].value='off';");
			//out.println("document.Form1.elements[m_chk].checked=false;");
			out.println("}");
			//out.println("alert('value is'+document.Form1.elements[m_chk].value);");
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Operation Process - Charges Hold</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<hr>");
			out.println("<DIV id='charges_hold'  class=div_input></DIV>");
