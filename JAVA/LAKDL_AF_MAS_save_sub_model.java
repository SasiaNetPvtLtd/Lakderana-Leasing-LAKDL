...
//SCREEN NAME: SAVE SYSTEM ADMINISTRATION - SUB MODEL
...
public class LAKDL_AF_MAS_save_sub_model extends HttpServlet {
  ...
  String reqstr;
	...
	public synchronized void  service(HttpServletRequest req, HttpServletResponse res)	throws IOException{
      ...
      String m_scr_name=(String)m_sn_methods.met_formdata(reqstr,"Hid_scr_name"); 
			...
			callstmt.setString(5,m_sn_methods.met_formdata(reqstr,"TXT_OPTION_TYPE"));
	   	...
	   	out.println("<HTML><HEAD>");
			...
			out.println("window.location.href='"+m_url+"/LAKDL_AF_MAS_display_sub_model';");
