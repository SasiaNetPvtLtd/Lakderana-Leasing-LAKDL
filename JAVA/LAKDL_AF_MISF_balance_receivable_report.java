...
public class LAKDL_AF_MISF_balance_receivable_report extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			String m_date_dd="",m_date_mm="",m_date_yy=""; //added by nuwan de silva on 2007-10-07
      ...
      m_chksql=req.getParameter("chksql");
			...
			stmt = conn.createStatement ();  //added by nuwan de silva on 2007-10-07
...
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!	
		...
		//added by nuwan de silva on 22-10-07--------------------------	
		out.println("function assign_system_date(){	"); 
		out.println("document.Form1.TXT_FROM_DATE_DD.value='"+m_date_dd+"'");
		out.println("document.Form1.TXT_FROM_DATE_MM.value='"+m_date_mm+"'");
		out.println("document.Form1.TXT_FROM_DATE_YY.value='"+m_date_yy+"'");
	 ...
	 // out.println("document.Form1.hid_bank_date.value='"+m_val_date+"'");
		out.println("}	"); 
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MISF_balance_receivable_report?chksql=main_page';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			//out.println("window.open('"+m_class_url+"/"+m_fschema_name+"AF_MK_Help_Servlet?class_in="+m_fschema_name+"AF_MISF_help_select&Sql_in='+m_sql+'&Start_in='+Start+'&End_in='+End+'&Crit_In='+m_criteria+'&Hid_No='+Hid_No+'&Max_in='+Hid_No+'&Args=')");
	  	...
	  	out.println("		}"); 
			...
			out.println("}");
			   ...
			   //added by nuwan de silva on 17-10-07
					...
					out.println("DIV_TXT_FROM.style.color='red';");
					out.println("return false;"); 
					out.println("}"); 
					out.println("else{"); 
		  ...
		  out.println("function view() {"); 
			out.println("if(validate_data()){"); //added by nuwan de silva on 17-10-07
			...
			out.println("m_date=\"\"");
			out.println("}");
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_balance_receivable_report1?chksql=MAIN&client_name=\"+document.Form1.hid_client_name.value+\"&finance_no=\"+document.Form1.TXT_FINANCE_NO.value+\"&client_code=\"+document.Form1.TXT_CLIENT_CODE.value+\"&allocation_date=\"+m_date+\"\";");
			out.println("popupwin=window.open(m_url,'displayWindow1','left=10,top=60,width=1000,height=550,toolbar=0,location=0,center:yes,direction=0,menuBar=0,status=0,scrollbars=1,resizable=1');");
			out.println("}");
      out.println("}");
			...
			out.println("   document.Form1.hid_client_name.value=oBj.valout[3];"); 
      ...
      out.println(" document.Form1.hid_cal_date.value=num;"); 
			...
			//------------------------------------------------------------	
			//out.println("    m_sql = \"m_help_TXT_FinanceSql_new3\";"); 
			//out.println("    m_criteria = document.Form1.TXT_FINANCE_NO.value+\"@\"+document.Form1.TXT_CLIENT_CODE.value+\"@\"+\"ACTIVATED@\";"); 
			out.println("    m_sql = \"m_help_TXT_FinanceSql_BalReceive\";"); //Mod By Sandun on 30-10-2009
...
//-----------------------------------------------------------------------------------------------------------------------
			...
			out.println("</script>"); 
			out.println("<BODY class='body & txt-body' leftmargin='0' topmargin='0' marginwidth='0' ONLOAD=\"load_lock(),assign_system_date()\">"); 
			...
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_FINANCE_NO' maxlength='15' size='15' onblur=\"help_button_6()\">"); 
			...
			out.println("<td width=\"30%\" ><DIV id='DIV_TXT_FROM' class=div_input>Date as at *</DIV></td>");  //From Date
