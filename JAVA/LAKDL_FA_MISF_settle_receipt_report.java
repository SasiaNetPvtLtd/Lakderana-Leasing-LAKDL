...
public class LAKDL_FA_MISF_settle_receipt_report extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Settlement Receipt Report </TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("function show_settle_receipt_report() {");
			out.println(" 	m_from_dd = document.Form1.TXT_FROM_DATE_DD.value ");
			out.println(" 	m_from_mm = document.Form1.TXT_FROM_DATE_MM.value ");
			out.println("		m_from_yy = document.Form1.TXT_FROM_DATE_YY.value ");
			...
			out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"FA_MISF_reports?chksql=LOAD_SETTLE_RECEIPT_REPORT&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&client_code=\"+document.Form1.TXT_CLIENT_CODE.value+\"&facility_no=\"+document.Form1.TXT_FACILITY_NO.value+\"&debtor_code=\"+document.Form1.TXT_DEBTOR_CODE.value+\"&coll_officer=\"+document.Form1.TXT_COLL_OFFICER.value+\"&settle_type=\"+document.Form1.TXT_SETTLEMENT_TYPE.value+\"&settle_mode=\"+document.Form1.TXT_SETTLEMENT_MODE.value;");
			...
			out.println("function show_settle_receipt_letter() {");
			out.println(" 	m_from_dd = document.Form1.TXT_FROM_DATE_DD.value ");
			out.println(" 	m_from_mm = document.Form1.TXT_FROM_DATE_MM.value ");
			out.println("		m_from_yy = document.Form1.TXT_FROM_DATE_YY.value ");
			out.println(" 	m_from_date = m_from_dd+\"-\"+m_from_mm+\"-\"+m_from_yy; ");
			...
			out.println(" 	m_to_date = m_to_dd+\"-\"+m_to_mm+\"-\"+m_to_yy; ");
			out.println("		if(validate_date()) {");
			out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"FA_MISF_reports?chksql=LOAD_SETTLE_RECEIPT_LETTER&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&client_code=\"+document.Form1.TXT_CLIENT_CODE.value+\"&facility_no=\"+document.Form1.TXT_FACILITY_NO.value+\"&debtor_code=\"+document.Form1.TXT_DEBTOR_CODE.value+\"&coll_officer=\"+document.Form1.TXT_COLL_OFFICER.value+\"&settle_type=\"+document.Form1.TXT_SETTLEMENT_TYPE.value+\"&settle_mode=\"+document.Form1.TXT_SETTLEMENT_MODE.value;");
			out.println("    popupwin=window.open(m_url,'displayWindow1','left=70,top=110,width=1000,height=450,toolbar=0,location=0,center:yes,direction=0,menuBar=1,status=0,scrollbars=1,resizable=1');");
			out.println("   }");
			out.println("}");
			...
			out.println("	help_box.innerHTML=\" Settlement Receipt Report - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\" Settlement Receipt Report \";"); 
			out.println("}"); 
			...
			out.println("function help_update_value_assign_4() {"); 
	  	...
	  	out.println("					}"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Settlement Receipt Report </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<table class='table' width='100%'  >"); 
			out.println("<tr>"); 
			out.println("<td width='15%' ><DIV id='DIV_TXT_COLL_OFFICER'  class=div_input><B>Collection Officer </B></DIV></td>"); 
			out.println("<td width='20%' ><input class='txt_input' type='text' name='TXT_COLL_OFFICER' style='width:100' maxlength='10' size='10' value=\"\">"); 
			...
			out.println("<table class='table' width='100%'  >"); 
			out.println("<tr >");
			out.println("<td width='15%' ><DIV id='DIV_TXT_SETTLEMENT_TYPE'  class=div_input><B>Settlement Type</B></DIV></td>");
			out.println("<td width='20%' ><SELECT name=\"TXT_SETTLEMENT_TYPE\" class=\"txt_input\" style='width:150' >");
			out.println("<OPTION value=\"VD\">Value Date</OPTION>");
			out.println("<OPTION value=\"CD\">Cheque Date</OPTION>");
			out.println("<OPTION value=\"RD\" selected>Realise Date</OPTION>");
			out.println("<OPTION value=\"BD\">Bank Date</OPTION>");
			out.println("</td>");
			out.println("<td width='*%'></td>"); 
			out.println("</tr>");
			out.println("</table>");  
			out.println("<table class='table' width='100%'  >"); 
			out.println("<tr >");
			out.println("<td width='15%' ><DIV id='DIV_TXT_SETTLEMENT_MODE'  class=div_input><B>Settle Mode </B></DIV></td>");
			out.println("<td width='20%' ><SELECT name=\"TXT_SETTLEMENT_MODE\" class=\"txt_input\" > ");
			...
			out.println("</td>");
			out.println("<td width='*%'><input class='but_input' type='button' name='BUT_VIEW_MAIN' value=\"View\" onClick=\"show_settle_receipt_report()\"> ");
			out.println("<input class='but_input' type='button' name='BUT_VIEW_MAIN1' value=\"Letter\" onClick=\"show_settle_receipt_letter()\">");
			out.println("</td>"); 
			out.println("</tr>");
			out.println("</table>");  
			out.println("</form>"); 
