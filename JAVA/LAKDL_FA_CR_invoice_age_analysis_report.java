...
public class LAKDL_FA_CR_invoice_age_analysis_report extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Operation Process - Client Charges Report</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"FA_CR_PRO_rpt_age_analysis?chksql=LOAD_INVOICE_AGE_ANALYSIS_REPORT&eff_date=\"+m_eff_date+\"\";");
			...
			out.println("			}");
			out.println("			if(validate_data()){"); 
			//out.println("				document.Form1.action='"+m_class_url+"/"+m_fschema_name+"FA_OP_save_pod_realization';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"FA_OP_client_charges_report';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("    m_help_message = \"m_help_msg_LAKDL_FA_OP_POD_CHEQUE_REALISATION\";"); 
			...
			out.println("	help_box.innerHTML=\" Operation Process - Client Charges Report - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\" Operation Process - Client Charges Report \";"); 
			out.println("}"); 
	  	...
	  	out.println("					}"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Operation Process - Invoice Age Analysis Report </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
