...
public class LAKDL_AF_CR_PRO_Doc_require_drill extends javax.servlet.http.HttpServlet 
{ 
	Connection conn;
...
public class LAKDL_AF_CR_PRO_Doc_require_drill extends javax.servlet.http.HttpServlet { 
	...
	public  void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			if(m_chksql.equals("Report")){	
				
				String m_applicaton_no = "";
				
				if(req.getParameter("applicaton_no")!=null ){
					m_applicaton_no=req.getParameter("applicaton_no").trim();
				}				
				
				out.println("<HTML>"); 
				out.println("<HEAD>"); 
				out.println("<TITLE>Documents Required</TITLE>"); 
				out.println("</HEAD>"); 
				out.println("<link REL='STYLESHEET' HREF='"+m_html_client_url+"/css/Asset_Financing_System.css' TYPE=\"text/css\">"); 
				out.println("<SCRIPT language=\"JavaScript\">"); 
				...
				out.println("   <tr>");
				out.println("      <td><b> Documents Required </b></td>");
				out.println("   </tr>");
				out.println("</table>");
				...
				out.println("   <tr>");
				out.println("      <td width='10%' ><b> Document Code </b></td>");
				out.println("      <td width='40%' ><b> Document Description </b></td>");
				out.println("   </tr>");
				...
				while(rs.next()){
					...
					out.println("      <td width='40%' > "+rs.getString(2)+" </td>");
					out.println("   </tr>");
