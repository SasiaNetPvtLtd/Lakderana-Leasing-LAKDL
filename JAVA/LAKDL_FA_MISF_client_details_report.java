// DEVELOP BY : CHANDANA FOR OFSCL FACTORING    DATE:10-05-2007
...
public class LAKDL_FA_MISF_client_details_report extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Client Details Report </TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"FA_MISF_client_details_report';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("	help_box.innerHTML=\" Client Details Report - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\"Client Details Report \";"); 
			out.println("}"); 
			...
			out.println(" m_sql = \"m_help_DIV_TXT_FACTOR_CLIENT_NO_sql\";"); 
		...
		//	out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"FA_MK_Inquiry?chksql=Inquiry_Followup_All&INQ_NO=\"+document.Form1.TXT_INQ_CODE.value+\"&FROM_DATE=\"+m_from_date+\"&TO_DATE=\"+m_to_date+\"&order_by=INQUIRY_CODE&order_by_type=ASC \";");
			...
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"FA_OP_PRO_rpt_exception_detail?chksql=LOAD_CLIENT_DETAIL_REPORT_ALL&CLIENT_NO=\"+document.Form1.TXT_CLIENT_NO.value+\"&FROM_DATE=\"+m_from_date+\"&TO_DATE=\"+m_to_date+\" \";");
			...
			out.println("<table class='table' width='100%'  >"); 
			out.println("<tr>"); 
			out.println("<td width='15%' ><DIV id='DIV_TXT_CLIENT_NO'  class=div_input><b>Client No</b></DIV></td>"); 
			out.println("<td width='20%' ><input class='txt_input' type='text' name='TXT_CLIENT_NO' maxlength='10' size='50' style='width:100' onblur=\"help_update()\" >"); 
