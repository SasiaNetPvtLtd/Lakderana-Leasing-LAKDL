...
//--
//SCREEN NAME:COLLECTION - RETURN & REALIZATION
...
public class LAKDL_AF_CO_PRO_return_realization_display extends javax.servlet.http.HttpServlet { 
      ...
      out.println("}");
		...
		//	out.println("document.Form1.TXT_DESCRIPTION.value='';"); 
	  	...
	  	out.println("		}");
			...
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_ACC_NO' maxlength='10' size='10' onblur=\"\">"); 
			...
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_BRANCH_NAME' maxlength='100' size='100' onblur=\"\" ></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			
			out.println("<tr >"); 
			out.println("<td width='30%' ><DIV id='DIV_TXT_BANK_NAME'  class=div_input> Bank Name </DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_BANK_NAME' maxlength='100' size='100' onblur=\"\" ></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
