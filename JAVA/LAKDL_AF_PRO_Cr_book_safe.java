...
public class LAKDL_AF_PRO_Cr_book_safe extends javax.servlet.http.HttpServlet {
	...
	public void service(HttpServletRequest req, HttpServletResponse res)
	{
		...
		try {
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_PRO_Cr_book_safe?chksql=main_page';"); 
			out.println("		}"); 
			out.println("}"); 
				...
				out.println("<input type=hidden name=\"Hid_scr_name\" value=\"AF_PRO_CR_BOOK_SAFE\">");
				...
				out.println("</tr>");
				out.println("<tr>");
				out.println("<td align=\"left\" class=\"pdn_txtpos2\" height=\"2%\" id=help_box>Add CR Book to Safe</td>");
				out.println("</tr>");
				out.println("<tr>");
				...
				out.println("<input name=\"SAVE_BTN\"   value='Print' style=\"width:120px;\" id='enableBtn' onclick='saveBatch()' type=\"button\" class='but_input'></td>"); // Save // modified by udara 18-07-2019
				out.println("</td>");
				out.println("</tr>");
				...
				out.println("       <script type=\"text/javascript\" src='"+m_html_client_url+"/crBook/cr_book_safe.js'></script>");
				...
				out.println("<table width='100%'><tr align='center'><td><b>List of CR Books added to Safe</b></td></tr></table>");
