// DEVELOP BY : CHANDANA FOR OFSCL FACTORING    DATE:09-05-2007
// QUATATION REPORT            
...
public class LAKDL_FA_MISF_quatation_report extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Quatation Report </TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"FA_MISF_quatation_report';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("	help_box.innerHTML=\" Quatation Report - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\"Quatation Report \";"); 
			out.println("}"); 
			...
			out.println(" m_sql = \"m_help_DIV_TXT_FACTOR_QUOTATION_NO_sql\";"); 
	  	...
	  	out.println("					}"); 
			...
			out.println(" 	m_to_date = m_to_dd+\"-\"+m_to_mm+\"-\"+m_to_yy; ");
			out.println("		if(validate_date()) {");
		//	out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"FA_MK_Inquiry?chksql=Inquiry_Followup_All&INQ_NO=\"+document.Form1.TXT_INQ_CODE.value+\"&FROM_DATE=\"+m_from_date+\"&TO_DATE=\"+m_to_date+\"&order_by=INQUIRY_CODE&order_by_type=ASC \";");
			
			
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"FA_OP_PRO_rpt_exception_detail?chksql=LOAD_QUOTATION_DETAIL_ALL&QUOTATION_NO=\"+document.Form1.TXT_QUOTATION_NO.value+\"&FROM_DATE=\"+m_from_date+\"&TO_DATE=\"+m_to_date+\" \";");
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Quatation Report </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<table class='table' width='100%'  >"); 
			out.println("<tr>"); 
			out.println("<td width='15%' ><DIV id='DIV_TXT_QUOTATION_NO'  class=div_input><b>Quotation No</b></DIV></td>"); 
			out.println("<td width='20%' ><input class='txt_input' type='text' name='TXT_QUOTATION_NO' maxlength='10' size='50' style='width:100' onblur=\"help_update()\" >"); 
