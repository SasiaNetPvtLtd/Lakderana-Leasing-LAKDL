...
public class LAKDL_AF_MISF_Recovery_Report_reconciliation extends javax.servlet.http.HttpServlet {
	/*
	...
	*/
		...
		try {
			...
			if(m_chksql.equals("main_page")){ 
				...
				out.println("help_box.innerHTML=\"  Recovery Report - Reconciliation \";"); 
				out.println("}"); 
				out.println(""); 
				...
				out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_reconciliation?chksql=main_page';"); 
				out.println("		}"); 
				out.println("}"); 
				...
				*/
				...
				out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Recovery_Report_reconciliation?chksql=\"+chkSql+\"&to_date=\"+m_to_date;");
				...
				out.println("</tr>");
				out.println("<tr>");
				out.println("<td align=\"left\" class=\"pdn_txtpos2\" style=\"height: 18px\" id=help_box> Recovery Report - Reconciliation </td>");
				out.println("</tr>");
				out.println("<tr>");
				...
				*/
				...
				out.println("<tr class=tr_input>");
				out.println("<td width='7%' ID=VDATE>Date As At</td>");
				out.println("<td width='40%' ><input name=\"VAL_DAY2\"   type=\"text\" maxlength=\"2\" style=\"width: 25px\" class=\"txt_input\" onchange=check_date(document.Form1.VAL_DAY2,document.Form1.VAL_MONTH2,document.Form1.VAL_YEAR2) value='"+rs1.getString(1)+"' > ");
				out.println("<input name=\"VAL_MONTH2\" type=\"text\" maxlength=\"2\" style=\"width: 25px\" class=\"txt_input\" onchange=check_date(document.Form1.VAL_DAY2,document.Form1.VAL_MONTH2,document.Form1.VAL_YEAR2) value='"+rs1.getString(2)+"' >   ");
				out.println("<input name=\"VAL_YEAR2\"  type=\"text\" maxlength=\"4\" style=\"width: 45px\" class=\"txt_input\" onchange=check_date(document.Form1.VAL_DAY2,document.Form1.VAL_MONTH2,document.Form1.VAL_YEAR2) value='"+rs1.getString(3)+"' ><a href style='{cursor:hand; }' onclick=load_calendar('3')>   Calendar</a> ");
				...
				*/
				...
				out.println("<HTML><HEAD><TITLE>Recovery Report - Reconciliation </TITLE></HEAD>");
				...
				out.println("<TR><TD align='Center' class=factoring-letter-body><B> Recovery Report - Reconciliation - Rental Differences</B></TD></TR>");
				out.println("</TABLE>");
				
				out.println("<br>");
				out.println("<table width='50%' class='table' border='1'  cellspacing='0' cellspacing='1' >");
				
				out.println("<tr class=factoring-letter-body bgcolor=\"#C0C0C0\">");
				out.println("<td width='1%'   align=center><DIV class=factoring-letter-body><b> Finance No <DIV></td>");
				out.println("<td width='10%' align=center><DIV class=factoring-letter-body><b> Recovery Report </b></DIV></td>");
				out.println("<td width='10%' align=center><DIV class=factoring-letter-body><b> Collection Summary Report </b></DIV></td>");
				out.println("<td width='10%' align=center><DIV class=factoring-letter-body><b> Difference Amount </b></DIV></td>");
				out.println("</tr>");
					...
					rs= stmt.executeQuery(" "+
						" SELECT "+
							...
							" RECOVERY_RENTAL, "+
							" COLL_RENTAL,"+
						    " (RECOVERY_RENTAL - COLL_RENTAL) "+
						" FROM "+m_schema_name+".AF_MIS_RECOV_COLL_COMPARE "+
						" WHERE REPORT_DATE = TO_DATE('"+m_to_date+"','DD-MM-YYYY') "+
						" AND (RECOVERY_RENTAL - COLL_RENTAL) <> 0 "+
					" ");
				...
				double total_recovery_rental = 0;
				double total_coll_rental = 0;
				double total_rental_diff = 0;
				
				try{
				
					while(rs.next()){
						
						total_recovery_rental =  total_recovery_rental + rs.getDouble(2);
						total_coll_rental     =  total_coll_rental     + rs.getDouble(3);
						total_rental_diff     =  total_rental_diff     + rs.getDouble(4);
						...
						out.println("<td width='10%' class=factoring-letter-body align='left' STYLE='text-align:left; cursor:hand;' onclick=\"show_transaction_history_new('','"+rs.getString(1)+"');\" ><u>"+rs.getString(1)+"</u></td>");
						out.println("<td width='10%' class=factoring-letter-body align='right'>"+nf.format(rs.getDouble(2))+"</td>");
					...
					out.println("<tr>");
					out.println("<td width='10%' class=factoring-letter-body align='right'><b> Total </b></td>");
					out.println("<td width='10%' class=factoring-letter-body align='right'><b> "+nf.format(total_recovery_rental)+" </b></td>");
					out.println("<td width='10%' class=factoring-letter-body align='right'><b> "+nf.format(total_coll_rental)+" </b></td>");
					out.println("<td width='10%' class=factoring-letter-body align='right'><b> "+nf.format(total_rental_diff)+" </b></td>");
					out.println("</tr>");
				...
				out.println("<TABLE  WIDTH='50%' class='factoring-letter-body'>");
				out.println("<TR><TD align='Center' class=factoring-letter-body><B> Recovery Report - Reconciliation - Arrears Differences</B></TD></TR>");
				out.println("</TABLE>");
				...
				out.println("</tr>");
					...
					rs= stmt.executeQuery(" "+
						" SELECT "+
							...
							" RECOVERY_ARREARS, "+
							" COLL_ARREARS,"+
						    " (RECOVERY_ARREARS - COLL_ARREARS) "+
						" FROM "+m_schema_name+".AF_MIS_RECOV_COLL_COMPARE "+
						" WHERE REPORT_DATE = TO_DATE('"+m_to_date+"','DD-MM-YYYY') "+
						" AND (RECOVERY_ARREARS - COLL_ARREARS) <> 0 "+
					" ");
				...
				double total_recovery_arrears = 0;
				double total_coll_arrears = 0;
				double total_arrears_diff = 0;
				
				try{
				
					while(rs.next()){
						
						total_recovery_arrears =  total_recovery_arrears + rs.getDouble(2);
						total_coll_arrears     =  total_coll_arrears     + rs.getDouble(3);
						total_arrears_diff     =  total_arrears_diff     + rs.getDouble(4);
					...
					out.println("<tr>");
					out.println("<td width='10%' class=factoring-letter-body align='right'><b> Total </b></td>");
					out.println("<td width='10%' class=factoring-letter-body align='right'><b> "+nf.format(total_recovery_arrears)+" </b></td>");
					out.println("<td width='10%' class=factoring-letter-body align='right'><b> "+nf.format(total_coll_arrears)+" </b></td>");
					out.println("<td width='10%' class=factoring-letter-body align='right'><b> "+nf.format(total_arrears_diff)+" </b></td>");
					out.println("</tr>");
