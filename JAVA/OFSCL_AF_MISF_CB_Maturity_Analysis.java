        import java.io.*; 
				...
				public class OFSCL_AF_MISF_CB_Maturity_Analysis extends javax.servlet.http.HttpServlet { 
				...
				callstmt1 = conn.prepareCall("BEGIN "+m_schema_name+".AF_TBD_MATURITY_RPT(:1,:2);END;");
				...
				out.println("	if(document.Form1.TXT_TO_DATE_DD.value!=\"\" && document.Form1.TXT_TO_DATE_MM.value!=\"\" && document.Form1.TXT_TO_DATE_YY.value!=\"\"){");
				out.println("		m_date=document.Form1.TXT_TO_DATE_DD.value+'-'+document.Form1.TXT_TO_DATE_MM.value+'-'+document.Form1.TXT_TO_DATE_YY.value;");
				out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_CB_Maturity_Analysis?chksql=run_report&user_id="+m_username+"&date=\"+m_date;"); 
				...
				out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_CB_Maturity_Analysis?chksql=load_details&m_to_date=\"+m_to_date+\"&order_by=ENT_DATE&sort_by=ASC\";");
				...
				out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MISF_CB_Maturity_Analysis?chksql=main_page';"); 
				out.println("		}"); 
				out.println("}"); 
				...
				out.println("    m_help_message = \"m_help_msg_OFSCL_FA_OP_CLIENT_STATEMENT_REPORT\";"); 
				...
				out.println("	help_box.innerHTML=\" Accounting - Maturity Analysis - \"+m_val;"); 
				out.println("}"); 
				
				out.println("function load_roll_out_value(){");
				out.println("	help_box.innerHTML=\" Accounting - Maturity Analysis\";"); 
				out.println("}"); 
	      ...
	      out.println(" document.Form1.hid_cal_date.value=num;"); 
			  ...
			  out.println("<INPUT TYPE='Hidden' NAME='hid_to_date' VALUE=\"\">");
				...
				out.println("</tr>"); 
				out.println("<tr>"); 
				out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Accounting - Maturity Analysis</td>"); 
				out.println("</tr>"); 
				out.println("<tr>"); 
    		...
    		out.println("<HTML><HEAD><TITLE>Maturity Analysis</TITLE></HEAD>");
				...
				out.println("<td width='1850' colspan='37' align='center'><b>ANALYSIS OF FUTURE CASH OUTFLOWS</b></td>");
				out.println("</tr>");
				out.println("<tr BGCOLOR=#a5b6c6 height=10>");
				out.println("<td width='200' colspan='4' align='center'><b>0-7 Days</b></td>");
				out.println("<td width='150' colspan='3' align='center'><b>8-14 Days</b></td>");
				out.println("<td width='150' colspan='3' align='center'><b>15-21 Days</b></td>");
				out.println("<td width='150' colspan='3' align='center'><b>22-31 Days</b></td>");
				out.println("<td width='150' colspan='3' align='center'><b>1-2 Months</b></td>");
				out.println("<td width='150' colspan='3' align='center'><b>2-3 Months</b></td>");
				out.println("<td width='150' colspan='3' align='center'><b>3-12 Months</b></td>");
				out.println("<td width='150' colspan='3' align='center'><b>12-24 Months</b></td>");
				out.println("<td width='150' colspan='3' align='center'><b>24-36 Months</b></td>");
				out.println("<td width='150' colspan='3' align='center'><b>36-48 Months</b></td>");
				out.println("<td width='150' colspan='3' align='center'><b>48-60 Months</b></td>");
				out.println("<td width='150' colspan='3' align='center'><b>Above 60 Months</b></td>");
				out.println("</tr>");
				out.println("<tr BGCOLOR=#a5b6c6 height=10>");
				out.println("<td width='50' align='right'><b>Capital</b></td>");//7
				out.println("<td width='50' align='right'><b>Interest</b></td>");//8
				out.println("<td width='50' align='right'><b>Other</b></td>");//9
  ...
  */
				...
				double m_cap_0_7=0,m_int_0_7=0,m_oth_0_7=0,m_cap_8_14=0,m_int_8_14=0,m_cap_15_21=0,m_int_15_21=0,m_cap_22_31=0,m_int_22_31=0,
				m_cap_1_2=0,m_int_1_2=0,m_cap_2_3=0,m_int_2_3=0,m_cap_3_12=0,m_int_3_12=0,m_cap_12_24=0,m_int_12_24=0,
				m_cap_24_36=0,m_int_24_36=0,m_cap_36_48=0,m_int_36_48=0,m_cap_48_60=0,m_int_48_60=0,m_cap_60=0,m_int_60=0,m_cap_tot=0,m_int_tot=0;
			  String m_activate_date="", m_last_date="";
				...
				double m_sub_cap_8_14=0;
				double m_sub_int_8_14=0;
				
				double m_sub_cap_15_21=0;
				double m_sub_int_15_21=0;
				
				double m_sub_cap_22_31=0;
				double m_sub_int_22_31=0;
				...
				double m_sub_cap_3_12=0;
				double m_sub_int_3_12=0;
			...
			while(more){	
				...
				rs2 = stmt2.executeQuery(" SELECT  SUM(A.CAPITAL_AMOUNT), "+
																 ...
																 " FROM "+m_schema_name+".AF_TBD_MATURITY_DET A "+
																 " WHERE A.APPLICATION_NO = '"+m_app_no+"' "+
																 " AND A.RENTAL_DATE <= TO_DATE('"+m_to_date+"','DD-MM-YYYY')+7 "+
																 " AND A.ENT_USER = '"+m_username+"' ") ;
				...
				rs2 = stmt2.executeQuery(" SELECT  SUM(A.CAPITAL_AMOUNT), "+
																 ...
																 " FROM "+m_schema_name+".AF_TBD_MATURITY_DET A "+
																 " WHERE A.APPLICATION_NO = '"+m_app_no+"' "+
																 " AND A.RENTAL_DATE >= TO_DATE('"+m_to_date+"','DD-MM-YYYY')+8 "+
																 " AND A.RENTAL_DATE <= TO_DATE('"+m_to_date+"','DD-MM-YYYY')+14 "+
																 " AND A.ENT_USER = '"+m_username+"' ") ;
				
				if(rs2.next()){
				m_cap_8_14 = rs2.getDouble(1);
				m_int_8_14 = rs2.getDouble(2);
				}
					...
					rs2 = stmt2.executeQuery(" SELECT  SUM(A.CAPITAL_AMOUNT), "+
																 ...
																 " FROM "+m_schema_name+".AF_TBD_MATURITY_DET A "+
																 " WHERE A.APPLICATION_NO = '"+m_app_no+"' "+
																 " AND A.RENTAL_DATE >= TO_DATE('"+m_to_date+"','DD-MM-YYYY')+15 "+
																 " AND A.RENTAL_DATE <= TO_DATE('"+m_to_date+"','DD-MM-YYYY')+21 "+
																 " AND A.ENT_USER = '"+m_username+"' ") ;
				
				if(rs2.next()){
				m_cap_15_21 = rs2.getDouble(1);
				m_int_15_21 = rs2.getDouble(2);
				}
				...
				rs2 = stmt2.executeQuery(" SELECT  SUM(A.CAPITAL_AMOUNT), "+
																 ...
																 " FROM "+m_schema_name+".AF_TBD_MATURITY_DET A "+
																 " WHERE A.APPLICATION_NO = '"+m_app_no+"' "+
																 " AND A.RENTAL_DATE >= TO_DATE('"+m_to_date+"','DD-MM-YYYY')+22 "+
																 //" AND A.RENTAL_DATE <= TO_DATE('"+m_to_date+"','DD-MM-YYYY')+30 "+
																 " AND A.RENTAL_DATE < ADD_MONTHS(TO_DATE('"+m_to_date+"','DD-MM-YYYY'),1) "+
																 " AND A.ENT_USER = '"+m_username+"' ") ;
				
				if(rs2.next()){
				m_cap_22_31 = rs2.getDouble(1);
				m_int_22_31 = rs2.getDouble(2);
				}
				...
				if(rs2.next()){
				m_cap_3_12 = rs2.getDouble(1);
				m_int_3_12 = rs2.getDouble(2);
				}
				...
				**/
				...
				out.println("<td width='100' align='right'>"+nf.format(m_oth_0_7)+"</td>");//9
				out.println("<td width='100' align='right'>"+nf.format(m_cap_0_7+m_int_0_7+m_oth_0_7)+"</td>");//10
				//8-14
				...
				//3-12
				out.println("<td width='100' align='right'>"+nf.format(m_cap_3_12)+"</td>");//7
				out.println("<td width='100' align='right'>"+nf.format(m_int_3_12)+"</td>");//8
				out.println("<td width='100' align='right'>"+nf.format(m_cap_3_12+m_int_3_12)+"</td>");//10
				//12-24
				...
				m_sub_cap_8_14=m_sub_cap_8_14+m_cap_8_14;
				m_sub_int_8_14=m_sub_int_8_14+m_int_8_14;
				
				m_sub_cap_15_21=m_sub_cap_15_21+m_cap_15_21;
				m_sub_int_15_21=m_sub_int_15_21+m_int_15_21;
				
				m_sub_cap_22_31=m_sub_cap_22_31+m_cap_22_31;
				m_sub_int_22_31=m_sub_int_22_31+m_int_22_31;
				...
				m_sub_cap_3_12=m_sub_cap_3_12+m_cap_3_12;
				m_sub_int_3_12=m_sub_int_3_12+m_int_3_12;
				...
				out.println("<td width='100' align='right'><b>"+nf.format(m_sub_oth_0_7)+"</td>");//9
				out.println("<td width='100' align='right'><b>"+nf.format(m_sub_cap_0_7+m_sub_int_0_7+m_sub_oth_0_7)+"</td>");//10
				//8-14
				...
				//3-12
				out.println("<td width='100' align='right'><b>"+nf.format(m_sub_cap_3_12)+"</td>");//7
				out.println("<td width='100' align='right'><b>"+nf.format(m_sub_int_3_12)+"</td>");//8
				out.println("<td width='100' align='right'><b>"+nf.format(m_sub_cap_3_12+m_sub_int_3_12)+"</td>");//10
				//12-24
