...
public class LAKDL_AF_RE_save_rental_freez extends HttpServlet {
  ...
  String reqstr;
	...
	public synchronized void  service(HttpServletRequest req, HttpServletResponse res)	throws IOException{
      ...
      String m_scr_name=(String)m_sn_methods.met_formdata(reqstr,"Hid_scr_name"); 
			...
			callstmt=conn.prepareCall("BEGIN "+m_schema_name+".AF_RE_SAVE_RENTAL_FREEZ(:1,:2,:3,:4,:5); END;");
			...
			if(m_chk.equals("Y")){			
				...
				callstmt.setString(5,"AF_RE_RENTAL_FREEZ");
				callstmt.execute();
			...
			out.println("window.location.href='"+m_url+"/"+m_fschema_name+"AF_RE_rental_freeze?chksql=main_page';");
