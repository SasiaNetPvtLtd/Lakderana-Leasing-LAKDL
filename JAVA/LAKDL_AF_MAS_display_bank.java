...
public class LAKDL_AF_MAS_display_bank extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>System Administration - Banks</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("			}");
			out.println("		  else	if(data_vec.length > 0 && document.Form1.SCREEN_NAME.value!=\"NEW\"&& document.Form1.TXT_BANK_CODE.value !=''&& document.Form1.hid_help_status.value == 'H1' ){");
			out.println("				assign_data(data_vec);");
			out.println("			}");
			out.println("		  else	if(data_vec.length == 0 && document.Form1.SCREEN_NAME.value!=\"NEW\"&& document.Form1.TXT_BANK_CODE.value !=''&& document.Form1.hid_help_status.value == 'H1' ){");
			//out.println("				alert('Invalid Code,Use Help');");
			//out.println("if(bttn_press!=1){");
			out.println("help_update()");
			//out.println("			}");
			out.println("bank_arry=data_vec");
			out.println("			}");
			out.println("		  else	if(data_vec.length > 0 && document.Form1.SCREEN_NAME.value==\"NEW\"&& document.Form1.TXT_NAME.value !='' && document.Form1.hid_help_status.value == 'H2' ){");
			out.println("				alert('Record already exists');");
			...
			*/
			...
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations1?chksql=m_prime_chk_LAKDL_AF_MAS_display_bank1&data_val=\"+obj.value;");
  		out.println("else");
			out.println("if(document.Form1.hid_help_status.value == 'H1' && document.Form1.SCREEN_NAME.value==\"RACT\" )");
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_bank&data_val=\"+obj.value+\"&ac_status=N\";");
			out.println("load_interface(m_url,'XML');");
			...
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_bank_name&data_val=\"+obj.value;");
			out.println("load_interface(m_url,'XML');");
			out.println("}");
			...
			out.println("if(document.Form1.TXT_BANK_CODE.value==\"\"){  "); 
			...
			//out.println("alert('Enter Bank Name..!')");
			out.println("document.Form1.TXT_NAME.focus()");
			...
			out.println("		if(validate_data()){"); 
			out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_MAS_save_bank';");  
			...
			out.println("    document.Form1.TXT_BANK_CODE.value=data_vec[0];"); 
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MAS_display_bank';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("help_box.innerHTML=\" System Administration - Banks - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" System Administration - Banks - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
      ...
      out.println(" }");
			...
			//out.println("if(bank_arry.length==0 && document.Form1.hid_help_status.value == 'H1') {");//**
		...
		//	out.println("bttn_press=1");
			...
			out.println("    } ");
			out.println("    else{");
			out.println("    m_criteria = document.Form1.TXT_BANK_CODE.value+\"@\"+\"N@\";}"); 
			/*out.println("}");
  		...
  		out.println("	}"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>System Administration - Banks</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_BANK_CODE' maxlength='5' size='5' onblur=\"assign_help_status('H1'),makeRequest(document.Form1.TXT_BANK_CODE)\" onkeypress=\"check_bank()\">"); 
			...
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_NAME' maxlength='50' size='30' onblur=\"assign_help_status('H2'),makeRequest1(document.Form1.TXT_NAME)\"></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 
