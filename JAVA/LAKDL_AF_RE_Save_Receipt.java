...
public class LAKDL_AF_RE_Save_Receipt extends HttpServlet {
	
	// commented below by udara 16-05-2017
	/*
	...
	*/
	...
	//public void service(HttpServletRequest req, HttpServletResponse res)throws IOException // commentex by udara 16-05-2017
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)throws IOException // added by udara 16-05-2017
	{
		
		// added by udara 16-05-2017
		...
		// end by udara 16-05-2017
		
		
		
		try {
			
			//synchronized (this){ // commented by udara 16-05-2017
				...
				if (m_scr_name.trim().equals("AF_RE_INVOICE_GEN")){
					...
					synchronized (this){
						...
						m_url = "AF_RE_Repossession?chksql=main_page";
						callstmt1 = conn.prepareCall( "BEGIN "+m_schema_name+"."+ 
					...
					try{ // added try block by udara 14-07-2016
							...
							*/
							...
							try {			
									...
									//LAKDL_Generate_receipts_sms_thread th = new LAKDL_Generate_receipts_sms_thread(client_code,finance_code,mm_rec_no,m_amount,m_type,m_username,m_schema_name,conn);
									LAKDL_Generate_receipts_sms_thread th = new LAKDL_Generate_receipts_sms_thread(client_code,finance_code,mm_rec_no,m_amount,m_type,m_username,m_schema_name);
									th.start();
	...
	//}
			...
			//} //end syncronized	// commented by udara 16-05-2017
		}
		catch (Exception E) {
