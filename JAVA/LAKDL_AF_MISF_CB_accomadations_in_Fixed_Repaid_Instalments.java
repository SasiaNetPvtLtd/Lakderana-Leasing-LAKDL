import java.io.*; 
				...
				public class LAKDL_AF_MISF_CB_accomadations_in_Fixed_Repaid_Instalments extends javax.servlet.http.HttpServlet { 
				...
				public String m_chksql,m_transation_type="";
				...
				try{
				callstmt1 = conn.prepareCall("BEGIN "+m_schema_name+".AF_MISF_SAVE_REP_IN_FIXED_RPT(:1,:2);END;");
				...
				out.println("	if(document.Form1.TXT_TO_DATE_DD.value!=\"\" && document.Form1.TXT_TO_DATE_MM.value!=\"\" && document.Form1.TXT_TO_DATE_YY.value!=\"\"){");
				out.println("		m_date=document.Form1.TXT_TO_DATE_DD.value+'-'+document.Form1.TXT_TO_DATE_MM.value+'-'+document.Form1.TXT_TO_DATE_YY.value;");
				out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_CB_accomadations_in_Fixed_Repaid_Instalments?chksql=run_report&user_id="+m_username+"&date=\"+m_date;"); 
								
				//out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_CB_accomadations_in_Fixed_Repaid_Instalments?chksql=please_wait;\""); 
		    ...
		    out.println("</tr>"); 
			  out.println("</table>"); 
				...
				out.println("<HTML><HEAD><TITLE>Arrears repaid in fixed installments Report </TITLE></HEAD>");
				out.println("<link REL='STYLESHEET' HREF='"+m_html_client_url+"/css/Asset_Financing_System.css' TYPE=\"text/css\">");
				out.println("<SCRIPT language=\"JavaScript\">"); 
				...
				out.println("<table width='2000'  border='1' cellspacing='0' cellpadding='0' bordercolor=#eeeeee >");
				...
				rs2 = stmt2.executeQuery(" SELECT A.FINANCE_NO,"+ //1
                                ...
                                " NVL(TO_CHAR(A.LAST_PAYMNT_DATE,'DD/MM/YYYY'),'-'), "+ //5
																...
																" FROM "+m_schema_name+".AF_MISF_TEMP_IN_FIXED_INSTAL A , "+m_schema_name+".AF_CO_PRO_APPLICATION_DETAILS B "+
				...
				out.println("<td align='left'>"+rs2.getString(20)+"</td>");
				...
				out.println("</tr>");
                                ...
                                " NVL(TO_CHAR(A.LAST_PAYMNT_DATE,'DD/MM/YYYY'),'-'), "+ //5
																...
																//" (NVL(NIBSM,0) + NVL(AMI,0)) /*A.DEPOSITS*/,  "+ //12
																//" NVL("+m_schema_name+".AF_CO_GET_DEPOSITS(A.APPLICATION_NO),0) DEPOSITS , "+ //12
																//" "+m_schema_name+".AF_CO_GET_APP_NIBSM(A.APPLICATION_NO) NIBSM, "+//12
																" 0 NIBSM,"+
																" NVL(TO_CHAR(A.LAST_PAID_DATE,'DD/MM/YYYY'),'-') , "+ //13
																" A.LAST_PAID_AMOUNT,  "+ //14
																" A.SECURITY_DETAILS, "+ //15
				...
				out.println("<td align='right'>"+nf.format(rs2.getDouble(9))+"</td>");
				out.println("<td align='right'>"+nf.format(0.00)+"</td>");//stock legal 
				//out.println("<td align='right'>"+nf.format(rs2.getDouble(10))+"</td>");
				out.println("<td align='right'>"+nf.format(rs2.getDouble(11))+"</td>");
				out.println("<td align='right'>"+nf.format(rs2.getDouble(12))+"</td>");
				out.println("<td align='right'>"+nf.format(m_net_exp)+"</td>");
