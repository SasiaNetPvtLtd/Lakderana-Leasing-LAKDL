...
//SCREEN NAME:SYSTEM ADMINISTRATION - AREA
//CREATED BY :NUWAN DE SILVA
//DATE/TIME  :19-07-2006 
//NOTES:
...
public class LAKDL_AF_MAS_display_area extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>System Administration - Areas</TITLE>"); 
			out.println("</HEAD>"); 
      ...
      out.println("var b_staus=0;"); 
			...
			out.println("			}");
			out.println("			else");
			out.println("			if(data_vec.length==0 && document.Form1.SCREEN_NAME.value!=\"NEW\" && document.Form1.TXT_AREA_CODE.value!=\"\" && document.Form1.hid_chk_status.value=='M1' ){");
	    ...
	    out.println("			else");
			...
			out.println("			else");
			out.println("			if(data_vec.length>0 && document.Form1.hid_chk_status.value=='M4' && document.Form1.TXT_CITY_CODE.value!=\"\"){");
			out.println("    document.Form1.TXT_CITY_DESC.value=data_vec[1];"); 
			out.println("			}");

  		out.println("			else");
			out.println("			if(data_vec.length==0 && document.Form1.hid_chk_status.value=='M2' && document.Form1.TXT_CITY_CODE.value!=\"\"){");
			//out.println("alert('assin value 0'+document.Form1.hid_chk_status.value);");
      ...
      out.println("			}");
			...
			out.println("			else");
			out.println("			if(data_vec.length>0 && document.Form1.SCREEN_NAME.value!=\"NEW\" && document.Form1.TXT_AREA_CODE.value!=\"\" && document.Form1.hid_chk_status.value=='M1' ){");
			out.println("    document.Form1.TXT_AREA_CODE.value=data_vec[0];"); 
			out.println("    document.Form1.TXT_AREA_DESC.value=data_vec[1];;"); 
			out.println("    document.Form1.TXT_CITY_CODE.value=data_vec[2];;"); 
		 	out.println("assignState('M4');");
			out.println("makeRequest(document.Form1.TXT_CITY_CODE);");
			
			out.println("    document.Form1.TXT_DEFAULT_VALUE.value=data_vec[3];;"); 
      out.println("			}");
			
			out.println("			else");
			out.println("			if(data_vec.length>0 && document.Form1.SCREEN_NAME.value==\"NEW\" && document.Form1.TXT_AREA_DESC.value!=\"\" && document.Form1.hid_chk_status.value=='M3' ){");
			out.println("				alert('Record already exists');");
			...
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_area1&data_val=\"+obj.value;");
			...
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_area_desc&data_val=\"+obj.value;");
			
			out.println("else");
			out.println("if(document.Form1.hid_chk_status.value=='M4')");
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_city_code&data_val=\"+obj.value;");
		...
		/*	out.println("function makeRequest(obj) {");
			...
			//out.println("    else");
			//out.println("    if((document.Form1.hid_chk_status.value=='M1' && document.Form1.SCREEN_NAME.value!=\"RACT\")&&(document.Form1.hid_help_status.value=='H9' && document.Form1.SCREEN_NAME.value!=\"NEW\")){");
			//out.println("    m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_area&data_val=\"+obj.value+\"&ac_status=Y\";");
			//out.println("}");
    	out.println("    if(document.Form1.hid_chk_status.value=='M1' && document.Form1.SCREEN_NAME.value==\"RACT\")");
      out.println("    m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_area&data_val=\"+obj.value+\"&ac_status=N\";");
			
			out.println("    if(document.Form1.hid_chk_status.value == 'M2' && document.Form1.SCREEN_NAME.value==\"EDIT\") {");
			out.println("    m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_area&data_val=\"+obj.value;");
			out.println("}");			
			out.println("load_interface(m_url,'XML');");
			out.println("}");*/
			...
			out.println("if(document.Form1.TXT_AREA_CODE.value==\"\"){  "); 
		//	out.println("alert('Area Code Can not Be Blank');"); 
			out.println("DIV_TXT_AREA_CODE.style.color='red';");
			out.println("return false;"); 
			out.println("}"); 
			out.println("else if(document.Form1.TXT_AREA_DESC.value==\"\"){  "); 
		//	out.println("alert('Area Description Can not Be Blank');"); 
			out.println("DIV_TXT_AREA_DESC.style.color='red';");
			out.println("return false;"); 
			out.println("}"); 
		...
		//	out.println("alert('City Code Can not Be Blank');"); 
			...
			out.println("}");
			out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_MAS_save_area';");  
			...
			out.println("		window.location.href='"+m_class_url+"/LAKDL_AF_MAS_display_area';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MAS_display_area';"); 
			out.println("}"); 
			out.println(""); 
			out.println(""); 
			...
			out.println("    m_help_message = \"m_help_msg_LAKDL_AF_MAS_display_area\";"); 
			...
			out.println("help_box.innerHTML=\" System Administration - Areas - \"+m_val;"); 
			...
			out.println("help_box.innerHTML=\" System Administration - Areas - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
			...
			out.println("document.Form1.TXT_AREA_DESC.disabled=true;"); 
	  	...
	  	out.println("		}"); 
			...
			out.println("if(document.Form1.hid_help_type.value==\"2\"){");
			out.println("document.Form1.TXT_AREA_DESC.value='';"); 
			out.println("document.Form1.TXT_AREA_DESC.focus();"); 
			out.println("	}");
			...
			out.println("    } ");
			out.println("    else{");
			out.println("    m_criteria = document.Form1.TXT_AREA_CODE.value+\"@\"+\"N@\";}"); 
			out.println("    HelpBox('1','10','2');"); 
			out.println("}"); 
			
			out.println("function help_update_desc() {"); 
			out.println("    document.Form1.hid_help_type.value=\"2\";"); 
			out.println("    m_sql = \"m_help_TXT_AREA_DESC_sql\";"); 
			out.println("    m_criteria = document.Form1.TXT_AREA_DESC.value+\"@\"+\"Y@\";"); 
			out.println("    HelpBox('1','10','2');"); 
			out.println("}"); 
	  	...
	  	out.println("		}"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>System Administration - Areas</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<tr >"); 
			out.println("<td width='30%' ><DIV id='DIV_TXT_AREA_DESC'  class=div_input>Area Description *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_AREA_DESC' maxlength='50' size='50' onblur=\"assignState('M3'), makeRequest(document.Form1.TXT_AREA_DESC)\"></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
