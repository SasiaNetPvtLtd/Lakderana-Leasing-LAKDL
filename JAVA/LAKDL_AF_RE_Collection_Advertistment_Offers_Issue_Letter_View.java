...
//Adveristment Offer Issue Letter
...
public class LAKDL_AF_RE_Collection_Advertistment_Offers_Issue_Letter_View extends javax.servlet.http.HttpServlet {
	...
	//		m_ac_status = req.getParameter("ac_status");
        ...
        out.println("<html>");
			  ...
			  out.println("var arr_size=0;");
				out.println("var m_inventory_no=\"\";");
				out.println("var m_vehicle_no=\"\";");
				out.println("var m_offer_no=\"\";");
				
			out.println("function get_vector(data_vec) {");
			//out.println("m_user_val=\"TXT_USER\"+document.Form1.hid_row_no.value;");
		
			out.println("			if(data_vec.length>0 ){");
			out.println("    document.Form1.TXT_ADVETIST_NO.value=data_vec[0];"); 
			
			out.println("			}");
			
			out.println("			else{");
			
			out.println("     help_advertistment_no();");
      out.println("			}");
			...
			*/
			...
			out.println("		help_advertistment_no_assign();"); 
	  	out.println("		}"); 
		...
		//  out.println("m_user_clear=\"TXT_USER\"+document.Form1.hid_row_no.value;");
			out.println("document.Form1.TXT_ADVETIST_NO.value='';");
			...
			out.println("function help_advertistment_no() {"); 
			out.println("    Crit =document.Form1.TXT_ADVETIST_NO.value+\"@\"+\"LEASE@\"+\"Y@\";"); 
			out.println("    HelpBox('1','10','0',Crit,'m_help_TXT_ADVETST_NO_VIEW_LETTER_sql','1');"); 
			out.println("}"); 
			out.println(""); 

			out.println("function help_advertistment_no_assign() {"); 
		
			out.println("    document.Form1.TXT_ADVETIST_NO.value=oBj.valout[2];"); 
			out.println("m_inventory_no=oBj.valout[3];");
			out.println("m_vehicle_no=oBj.valout[4];");
			out.println("m_offer_no=oBj.valout[5];");
			out.println("}"); 
			
			
			out.println("function val_advertist_no(obj){");
		
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_sql_validations?chksql=m_prime_chk_LAKDL_AF_RE_Collection_Offer_Invoice_View_Letter&data_val=\"+obj.value+\"&data_val2=LEASE&ac_status=Y\";");
		...
		//--------------------------------------------------------------------------		
			...
			*/
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_RE_Collection_Advertistment_Offers_Issue_Letter_View';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			*/
			...
			out.println("help_box.innerHTML=\" Collection - Offer Invoice Letter - \"+m_val;"); 
			...
			out.println("help_box.innerHTML=\" Collection - Offer Invoice Letter - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
		...
		//	out.println("document.Form1.BUT_HELP_MAIN.disabled=true;}"); 
			...
			out.println("if(document.Form1.TXT_ADVETIST_NO.value==''){");
			out.println("DIV_TXT_ADVETIST_NO.style.color='red';");
			//out.println("alert('Please enter a purchase order no to view letter')");
			out.println("alert(\"Please enter all required fields marked with a '*' on screen\");");
			out.println("}");
			out.println("else{");
			
			out.println("	m_url = \""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_RE_Collection_Offer_Invoice_Letter?chksql=main_page&inventory_no=\"+m_inventory_no+\"&offer_no=\"+m_offer_no+\"&status=COPY&print=TRUE&vehicle_no=\"+m_vehicle_no;"); 
			...
			out.println("popupwin =window.open(m_url,'displayWindow3','left=110,top=110,width=700,height=700,toolbar=0,location=0,direction=0,menuBar=0,status=0,scrollbars=1,resizable=1');");
      ...
      out.println("</Script>");
			    ...
			    out.println("<INPUT TYPE='Hidden' NAME='hid_no_rec' VALUE=\"\">"); 
					...
					out.println("</tr>"); 
					out.println("<tr>"); 
					out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Collection - Offer Invoice Letter</td>"); 
					out.println("</tr>"); 
					out.println("<tr>"); 
			...
			//		out.println("<tr><td width='10%' align='center'><input type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"New\");' onclick='load_screen_status(\"NEW\")' value=\"New\"></td>");  
			  ...
			  //  out.println("<td width='30%' >Purchase Order No</td>"); 
					...
					out.println("<td width='30%' ><DIV id='DIV_TXT_ADVETIST_NO'  class=div_input>Advertisement No *</DIV></td>"); 
					out.println("<td width='30%' ><input class='txt_input' type='text' name='TXT_ADVETIST_NO' maxlength='10' size='10' onblur=\"val_advertist_no(document.Form1.TXT_ADVETIST_NO)\">"); 
			    out.println("<input class='but_input' type='button' name='BUT_TXT_ADVETIST_NO' value=\"Help\" onClick=\"help_advertistment_no()\"></td>"); 
