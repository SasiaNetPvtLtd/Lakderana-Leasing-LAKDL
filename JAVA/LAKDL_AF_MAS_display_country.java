...
//SCREEN NAME:SYSTEM ADMINISTRATION - COUNTRY
...
public class LAKDL_AF_MAS_display_country extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>System Administration - Countries</TITLE>"); 
			out.println("</HEAD>"); 
			out.println("<link REL='STYLESHEET' HREF='"+m_html_client_url+"/css/Asset_Financing_System.css' TYPE=\"text/css\">"); 
			out.println("<SCRIPT language=\"JavaScript\">"); 
			out.println("var b_chk_val=0;"); 
			...
			out.println("			}");
			out.println("			else");
			out.println("			if(data_vec.length==0 && document.Form1.SCREEN_NAME.value!=\"NEW\" && document.Form1.TXT_COUNTRY_CODE.value!=\"\" ){");
			...
			//out.println("			else");
			out.println("			if(data_vec.length>0 && document.Form1.SCREEN_NAME.value!=\"NEW\" && document.Form1.TXT_COUNTRY_CODE.value!=\"\" && document.Form1.hid_help_status.value=='H1'){");
			out.println("    document.Form1.TXT_COUNTRY_CODE.value=data_vec[0];"); 
			out.println("    document.Form1.TXT_COUNTRY_DESC.value=data_vec[1];"); 
			out.println("    document.Form1.TXT_DEFAULT_VALUE.value=data_vec[2];"); 
			out.println("			}");
			
			out.println("			else");

			out.println("			if(data_vec.length>0 && document.Form1.SCREEN_NAME.value==\"NEW\" && document.Form1.TXT_COUNTRY_DESC.value!=\"\" && document.Form1.hid_help_status.value=='H2'){");
			out.println("				alert('Record already exists');");
			out.println("help_update_desc();");
			out.println("document.Form1.TXT_COUNTRY_DESC.value='';"); 
			out.println("document.Form1.TXT_COUNTRY_DESC.focus();"); 
		...
		/*	out.println("function makeRequest(obj) {");
			...
			out.println("function makeRequest(obj) {");
			out.println("    if(document.Form1.SCREEN_NAME.value!=\"RACT\"){");
			out.println("    m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_country2&data_val=\"+obj.value;");
			out.println("}");
			out.println("    else");
      ...
      out.println("    m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_country&data_val=\"+obj.value+\"&ac_status=N\";");
			...
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_country_desc&data_val=\"+obj.value;");
			out.println("load_interface(m_url,'XML');");
			out.println("}");
			...
			//out.println("makeRequest(document.Form1.TXT_COUNTRY_CODE);");
			out.println("//validations goes here"); 
			out.println("if(document.Form1.TXT_COUNTRY_CODE.value==\"\" ){  "); 
			...
			out.println("}"); 
			out.println("else if(document.Form1.TXT_COUNTRY_DESC.value==\"\"){  "); 
			out.println("DIV_TXT_COUNTRY_DESC.style.color='red';");
			//out.println("alert('Enter Country Description..!')");
			out.println("document.Form1.TXT_COUNTRY_DESC.focus()");
			out.println("return false;"); 
			out.println("}"); 
      ...
      out.println("}");
			...
			//out.println("		if(confirm(\"Are You Sure?You want to Save records?\")){ "); //**
			...
			out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_MAS_save_country';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MAS_display_country';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("    m_help_message = \"m_help_msg_LAKDL_AF_MAS_display_country\";"); 
			...
			out.println("help_box.innerHTML=\" System Administration - Countries - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" System Administration - Countries - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
			...
			out.println("document.Form1.TXT_COUNTRY_DESC.disabled=true;"); 
	  	...
	  	out.println("		}"); 
			...
			//out.println("		help_update_value_assign_desc();"); 
	  	out.println("		}"); 
			out.println("	}"); 
			out.println("	else{"); 
      ...
      out.println(" }");
			...
			///out.println("makeRequest(document.Form1.TXT_COUNTRY_CODE)");
			//out.println("alert('country_arry.length'+country_arry.length)");
			//out.println("if(country_arry.length==0) {");//**
			...
			//out.println("var y_st=\"Y\"");//**
			//out.println("var n_st=\"N\"");//**
			//out.println("    } ");	
			
			//out.println("if(document.Form1.hid_help_status.value=='H2'){");
			//out.println("var cntry=''");//**
			
			//out.println("var cntry=document.Form1.TXT_COUNTRY_DESC.value.substring(0,1)");//**
			...
			out.println("    } ");
			out.println("    else{");
			out.println("    m_criteria = document.Form1.TXT_COUNTRY_CODE.value+\"@\"+\"N@\";"); 
			//out.println("    } ");
			out.println("    } ");	
		...
		/*	out.println("else if(enter_text==1){");
			...
			out.println("    } ");
			out.println("    else{");
			out.println("    m_criteria = cntry+\"@\"+\"N@\";"); 
			out.println("    } ");		
			out.println("    } ");	*/
			...
			out.println("    m_sql = \"m_help_TXT_COUNTRY_DESC_sql\";"); 
			out.println("    m_criteria = document.Form1.TXT_COUNTRY_DESC.value+\"@\";");
			out.println("    HelpBox('1','10','0');"); 
			out.println("}"); 	
			...
			out.println("    document.Form1.TXT_COUNTRY_DESC.value=oBj.valout[3];"); 
			...
			out.println("function help_update_value_assign_desc() {"); 
			out.println("    document.Form1.TXT_COUNTRY_CODE.value=oBj.valout[2];"); 
			out.println("    document.Form1.TXT_COUNTRY_DESC.value=oBj.valout[3];"); 
			out.println("    document.Form1.TXT_DEFAULT_VALUE.value=oBj.valout[4];"); 
	  	...
	  	out.println("		}"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>System Administration - Countries</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td  height='10px' class='pdn_txtpos'>"); 
			out.println("<table class='table' cellpadding='2' cellspacing='2' border='0'> "); 
			out.println("<tr><td width='10%' align='center'><input type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"New\");' onclick='load_screen_status(\"NEW\"),msg(\"NEW\")' value=\"New\"></td>");  
			out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Edit\");' onClick='load_screen_status(\"EDIT\"),msg(\"EDIT\")' value=\"Edit\"></td>");  
			out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Deactivate\");' onClick='load_screen_status(\"DACT\"),msg(\"DACT\")' value=\"De-activate\"></td>");  
			out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Reactivate\");' onClick='load_screen_status(\"RACT\"),msg(\"RACT\")' value=\"Re-activate\"></td>");
			...
			*/
			...
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_COUNTRY_CODE' maxlength='10' size='10' onblur=\"assign_help_status('H1'),makeRequest(document.Form1.TXT_COUNTRY_CODE)\" onkeypress=\"check_country()\">"); 
			...
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_COUNTRY_DESC' maxlength='50' size='20' onblur=\"assign_help_status('H2'),makeRequest1(document.Form1.TXT_COUNTRY_DESC)\"></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
