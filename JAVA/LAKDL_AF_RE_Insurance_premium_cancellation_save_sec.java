...
public class LAKDL_AF_RE_Insurance_premium_cancellation_save_sec extends HttpServlet {
	...
	public synchronized void  service(HttpServletRequest req, HttpServletResponse res)	throws IOException{
		...
		try {
			...
			String m_chk_type = "off"; 
				...
				callstmt=conn.prepareCall("BEGIN "+m_schema_name+".AF_CO_INS_PREMIUM_CAN_SEC(:1,:2,:3,:4,:5,:6,:7); END;");
			...
			out.println("window.location.href='"+m_url+"/LAKDL_AF_RE_Insurance_premium_cancellation_sec?chksql=main_page';");
