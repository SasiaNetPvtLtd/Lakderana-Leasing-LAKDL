...
//--
//SCREEN NAME:SYSTEM ADMINISTRATION - CLIENT BANK
//CREATED BY:
//DATE/TIME:
//NOTES:
...
public class LAKDL_AF_MAS_display_client_bank extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>System administration - client Bank</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_client_bank&data_val=\"+obj.value;");
			...
			out.println("return false;"); 
			out.println("}"); 
			out.println("else if(document.Form1.TXT_ACCOUNT_NO.value==\"\"){  "); 
			out.println("DIV_TXT_ACCOUNT_NO.style.color='red';");
			out.println("return false;"); 
			out.println("}"); 
			out.println("else if(document.Form1.TXT_REFERENCE.value==\"\"){  "); 
			out.println("DIV_TXT_REFERENCE.style.color='red';");
			out.println("return false;"); 
			out.println("}"); 
			...
			out.println("		document.Form1.action='"+m_class_url+"/LAKDL_AF_MAS_save_client_bank';");  
			...
			out.println("		if(confirm(\"Are You Sure?\")){ "); 
			out.println("		window.location.href='"+m_class_url+"/LAKDL_AF_MAS_display_client_bank';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("    m_help_message = \"m_help_msg_LAKDL_AF_MAS_display_client_bank\";"); 
			...
			out.println("help_box.innerHTML=\" System administration - client Bank - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" System administration - client Bank - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
	  	...
	  	out.println("		}"); 
			...
			out.println("    document.Form1.TXT_BRANCH_CODE.value=oBj.valout[4];"); 
			out.println("    document.Form1.TXT_ACCOUNT_NO.value=oBj.valout[5];"); 
			out.println("    document.Form1.TXT_REFERENCE.value=oBj.valout[6];"); 
			out.println("    document.Form1.TXT_TEL_NO.value=oBj.valout[7];"); 
			out.println("    document.Form1.TXT_FAX_NO.value=oBj.valout[8];"); 
			out.println("    document.Form1.TXT_RELATIONSHIP.value=oBj.valout[9];"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>System administration - client Bank</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<td width='30%' ><DIV id='DIV_TXT_BANK_CODE'  class=div_input>BANK_CODE *</DIV></td>"); 
			out.println("<td width='30%' ><input class='txt_input' type='text' name='TXT_BANK_CODE' maxlength='10' size='10'>"); 
			...
			out.println("<input class='but_input' type='button' name='BUT_TXT_BRANCH_CODE' value=\"Help\" onClick=\"help_button_2()\"></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 

			out.println("<td width='30%' ><DIV id='DIV_TXT_ACCOUNT_NO'  class=div_input>ACCOUNT_NO *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_ACCOUNT_NO' maxlength='20' size='20'></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 

			out.println("<td width='30%' ><DIV id='DIV_TXT_REFERENCE'  class=div_input>REFERENCE *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_REFERENCE' maxlength='20' size='20'></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 
			...
			out.println("<td width='30%' ><DIV id='DIV_TXT_FAX_NO'  class=div_input>FAX_NO *</DIV></td>"); 
