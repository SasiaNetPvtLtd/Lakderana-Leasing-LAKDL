...
//SCREEN NAME:SYSTEM ADMINISTRATION - INQUIRY STATUS
...
public class LAKDL_AF_MAS_display_inquiry_status extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>System Administration - Inquiry Stages</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("	if(data_vec.length > 0 && document.Form1.SCREEN_NAME.value!=\"NEW\"&& document.Form1.TXT_CODE.value !=''&& document.Form1.hid_help_status.value == 'H1' ){");
			...
			out.println("if(data_vec.length > 0 && document.Form1.SCREEN_NAME.value==\"NEW\"&& document.Form1.TXT_DESCRIPTION.value !='' && document.Form1.hid_help_status.value == 'H2' ){");
			out.println("				alert('Record already exists');");
			...
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_inquiry_status&data_val=\"+obj.value+\"&ac_status=\"+document.Form1.hid_st.value;");
			out.println("}");
			//out.println("else");
			out.println("if(document.Form1.SCREEN_NAME.value==\"NEW\" ){ ");
			//out.println("if(document.Form1.hid_help_status.value == 'H1' && document.Form1.SCREEN_NAME.value==\"NEW\" ) {");
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_inquiry_status_r&data_val=\"+obj.value;");
			out.println("}");
			out.println("load_interface(m_url,'XML');");
			out.println("}");
			
			out.println("function makeRequest1(obj) {");
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations1?chksql=m_prime_chk_LAKDL_AF_MAS_display_inquiry_status_desc&data_val=\"+obj.value;");
			out.println("load_interface(m_url,'XML');");
			out.println("}");
		  ...
		  out.println("    document.Form1.TXT_CODE.value=data_vec[0];"); 
			...
			out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_MAS_save_inquiry_status';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MAS_display_inquiry_status';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("    m_help_message = \"m_help_msg_LAKDL_AF_MAS_display_inquiry_status\";"); 
			...
			out.println("help_box.innerHTML=\" System Administration - Inquiry Stages - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" System Administration - Inquiry Stages - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
      ...
      out.println(" }");
		  ...
		  out.println("    document.Form1.TXT_CODE.value='';"); 
			...
			out.println("    m_sql = \"m_help_TXT_INQ_CODE_sql\";"); 
			...
			out.println("    m_sql = \"m_help_TXT_INQ_CODE_sql_desc\";"); 
	  	...
	  	out.println("		}"); 
			...
			out.println("    m_sql = \"m_view_TXT_INQ_CODE_sql\";");
			out.println("    m_criteria = document.Form1.TXT_CODE.value+\"@\"+\"Y@\";"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>System Administration - Inquiry Stages</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<td width='30%' ><DIV id='DIV_TXT_CODE'  class=div_input>Inquiry Status Code *</DIV></td>"); 
			...
			out.println("<td width='30%' ><DIV id='DIV_TXT_DESCRIPTION'  class=div_input>Inquiry Status Description *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_DESCRIPTION' maxlength='50' size='20' onblur=\"assign_help_status('H2'),makeRequest1(document.Form1.TXT_DESCRIPTION)\">");  
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 
