...
class LAKDL_Print_Letters_New_Bulk_Book implements Printable {
	...
	// public LAKDL_Print_Letters_New_Bulk_Book(String m_rec, String m_client_code){ // commented by udara 05-11-2019
	public LAKDL_Print_Letters_New_Bulk_Book(String m_rec, String m_client_code, String m_statement_date){ // added by udara 05-11-2019
			...
			FontRenderContext frc = g2d.getFontRenderContext();
			   ...
			   // DocPrintJob job = ps.createPrintJob();
				 ...
				 String LAKDL_IMAGE="LAKDL";
					try{
					// image1 = ImageIO.read(new File("D:\\SasiaNet_Products\\NetAsset\\LAKDL\\Home\\images\\" + LAKDL_IMAGE + ".gif")); // Develop ment
	...
	/*		line = new AttributedString(m_contact_full_name + m_print_method.Add_Space(15)+ m_application_no + m_print_method.Add_Space(10) + m_vehicle_no + m_print_method.Add_Space(10) + m_Letter_date +m_print_method.Add_Space(10)+nf.format(arr_amount));
		...
		*/
		...
		//	line.addAttribute(TextAttribute.UNDERLINE, TextAttribute.UNDERLINE_ON);
			...
			//System.out.println("drawPosYClient=");
		...
		*/
		...
		//	System.out.println("m_company_name position="+drawPosY);
			...
			//System.out.println("m_reg_no position="+drawPosY);
			...
			//System.out.println("m_company_det position="+drawPosY);
			...
			//System.out.println("m_com_contact position="+drawPosY);
