...
public class LAKDL_AF_MAS_display_client extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_client&data_val=\"+obj.value;");
			...
			out.println("		document.Form1.action='"+m_class_url+"/LAKDL_AF_MAS_save_client';");  
			...
			out.println("		if(confirm(\"Are You Sure?\")){ "); 
			out.println("		window.location.href='"+m_class_url+"/LAKDL_AF_MAS_display_client';"); 
			out.println("		}"); 
			out.println("}"); 
	  	...
	  	out.println("		}"); 
			...
			out.println("<td>");
			out.println("<select name='TXT_CLIENT_TYPE' class=\"txt_input\" >");
			...
			out.println("<tr >");
			out.println("<td width='30%' ><DIV id='DIV_TXT_CLIENT_CODE'  class=div_input><B> A.DETAILS OF APPLICANT </B></DIV></td>"); 
			out.println("</tr>");
						out.println("<tr >"); 
			...
			out.println("<td width='30%' >Business Sub Sector</td>"); 
			...
			out.println("<td width='30%' >Office Tel No *</td>"); 
			...
			out.println("<td width='30%' ><input class='txt_input' type='text' name='TXT_CAT_TYPE_CODE' maxlength='10' size='10'>"); 
			out.println("<input class='but_input' type='button' name='BUT_TXT_CAT_TYPE_CODE' value=\"Help\" onClick=\"help_button_3()\"></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 
			...
			out.println("<td width='30%' >Direct Tel No *</td>"); 
			...
			out.println("<input class='but_input' type='button' name='BUT_TXT_REGISTERED_CITY_CODE' value=\"Help\" onClick=\"help_button_4()\"></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 
			...
			out.println("<td width='30%' >Factory Tel No *</td>"); 
