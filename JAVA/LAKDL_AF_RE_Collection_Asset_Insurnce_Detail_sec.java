...
/*
	* 	Inesh Gunasekara
	*	2018-10-11
	* 	Insurance Asset Details - Security
	* 	JB21082018-04816
*/
import java.io.*; 
...
public class LAKDL_AF_RE_Collection_Asset_Insurnce_Detail_sec extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			if(m_screen_type.trim().equals("main_page")){	
				...
				out.println("help_box.innerHTML=\"  Collection Prossess - Insurance Asset Details - Security - \"+m_val;"); 
				out.println("}"); 
				out.println(""); 
				
				out.println("function load_roll_out_value(){");
				out.println("help_box.innerHTML=\"  Collection Prossess - Insurance Asset Details - Security - \"+document.Form1.hid_status.value;"); 
				out.println("}"); 
		...
		//		out.println(" load_c_date(document.Form1.hid_cal_date.value);");
				...
				out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_Collection_Asset_Insurnce_Detail_sec?chksql=load_details&sr_name=\"+m_scr_name+\"&finance_no=\"+finance_no+\"&devision_type=\"+m_opt+\"&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&status=\"+m_status;");
				...
				out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_Collection_Asset_Insurnce_Detail_sec?chksql=load_details_btt&sr_name=\"+m_scr_name+\"&invo_no=\"+invoice_no+\"&finance_no=\"+val1+\"&clint_name=\"+val2+\"&asst_deta=\"+description+\"&business_type=\"+m_business_type+\"&policy_no=\"+val4+\"&debit_note_no=\"+val5+\"&price_no=\"+m_price_no+\"&app_no=\"+m_app_no;");
			...
			//	out.println("window.open(m_url);");
				...
				out.println("</tr>");
				out.println("<tr>");
				out.println("<td align=\"left\" class=\"pdn_txtpos2\" style=\"height: 18px\" id=help_box>Collection Prossess - Insurance Asset Details - Security </td>");
				out.println("</tr>");
				out.println("<tr>");
				...
				if(m_scr_name.equals("New")){
					...
					if(m_finance_no.equals("")||m_finance_no.equals(null)||m_finance_no.equals(" ")){												
						rs=stmt.executeQuery("  "+
							...
							" AND (A.FINANCE_NO,B.SECURITY_ID) NOT IN( "+ // added by udara 10-07-2018
				...
				*/
				...
				out.println("		if(confirm(\"Are you sure you want to clear the screen?\")){ "); 
				out.println("          m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_Collection_Asset_Insurnce_Detail_sec?chksql=load_details_btt&sr_name=\"+m_sr_name+\"&invo_no=\"+m_invoice_no+\"&finance_no=\"+m_finance_no+\"&clint_name=\"+m_clint_name+\"&asst_deta=\"+m_asst_deta+\"&business_type=\"+m_business_type+\"&policy_no=\"+m_policy_no+\"&debit_note_no=\"+m_debit_note_no+\"&price_no=\"+m_price_no+\"&app_no=\"+m_app_no;");
		       ...
		       out.println("        if(unformat_noobject(document.Form2.txt_premium.value)>0){ "); // released by udara 03-09-2015	//--Comment by Prabash on 22-01-2015-15405
				...
				out.println("				document.Form2.action='"+m_class_url+"/"+m_fschema_name+"AF_MISF_Save_Asset_Insurance_Detail_sec';");  
				out.println("				document.Form2.submit();	");
				out.println("   		}");
			...
			//	out.println("					alert(document.Form2.hid_start_date_diff.value);");
				...
				*/
				...
				//out.println("<td width='30%' align ='left'><select  class=\"txt_input\" name='hid_ins_done_by'><option value='LICENCEE'> Company</option><option value='CLIENT'> Client</option></select> </td>");
				out.println("<td width='30%' align ='left'><select  class=\"txt_input\" name='hid_ins_done_by'><option value='LICENSEE'> Company</option><option value='CLIENT'> Client</option></select> </td>");
