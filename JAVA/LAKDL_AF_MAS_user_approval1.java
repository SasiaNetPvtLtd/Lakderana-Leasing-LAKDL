// DEVELOP BY : MAHELA FOR OFSCL LEASING    DATE:19-02-2007
...
public class LAKDL_AF_MAS_user_approval1 extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>System Administration - User Approval 1 </TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_rpt_user_approval?chksql=LOAD_USER_APPROVAL_1\";");
  		...
  		out.println("		}");
   		...
   		out.println("}"); 
			...
			out.println("function edit_user(m_user_id){	"); 
			out.println("		window.open(\""+m_class_url+"/"+m_fschema_name+"AF_MAS_display_user?user_id=\"+m_user_id+\"&close_status=Y\",\"popupwin1\",\"status=0,menubar=0,scrollbars=1,height=500,width=700\");");
			out.println("}"); 

      out.println("function get_user_right(m_user_id){	"); 
			out.println("		window.open(\""+m_class_url+"/"+m_fschema_name+"AF_CR_PRO_User_rights_details?chksql=main_page&emp_code=\"+m_user_id+\"&close_status=Y\",\"popupwin1\",\"status=0,menubar=0,scrollbars=1,height=500,width=700\");");
			out.println("}"); 
			...
			out.println("			}");
			out.println("			if(validate_data()){"); 
			out.println("				document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_MAS_save_user_approval1';");  
			...
			*/
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MAS_user_approval1';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("    m_help_message = \"m_help_msg_LAKDL_AF_MAS_user_approval1\";"); 
			...
			out.println("	help_box.innerHTML=\" System Administration - User Approval 1 - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\" System Administration - User Approval 1  \";"); 
			out.println("}"); 
	  	...
	  	out.println("					}"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> System Administration - User Approval 1  </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
