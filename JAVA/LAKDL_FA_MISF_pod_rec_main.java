...
public class LAKDL_FA_MISF_pod_rec_main extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>PD Cheque and Settlement Receipt Report</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"FA_MISF_unbank_cheques_main';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("	help_box.innerHTML=\"PD Cheque and Settlement Receipt Report- \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\"PD Cheque and Settlement Receipt Report\";"); 
			out.println("}"); 
	  	...
	  	out.println("					}"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>PD Cheque and Settlement Receipt Report</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<table class='table' width='100%'  >"); 
			out.println("<tr >");
			out.println("<td width='10%'><input class='but_input' type='button' name='BUT_VIEW_MAIN' value=\"View P D Cheques\" onClick=\"show_pd_cheque_report()\" style='width:150' >"); 
			out.println("<td width='*%'><input class='but_input' type='button' name='BUT_VIEW_MAIN' value=\"View Settlement Receipt\" onClick=\"show_receipt_report()\" style='width:150'>"); 
			out.println("</td>"); 
			out.println("</tr>");
			out.println("</table>");  
			out.println("</form>"); 
