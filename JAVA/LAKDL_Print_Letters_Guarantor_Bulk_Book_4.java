...
class LAKDL_Print_Letters_Guarantor_Bulk_Book_4 implements Printable {
	...
	//public LAKDL_Print_Letters_Guarantor_Bulk_Book_4(String finance_no, String guarantor_code){ // commented by udara 05-11-2019
	public LAKDL_Print_Letters_Guarantor_Bulk_Book_4(String finance_no, String guarantor_code, String m_statement_date){ // added by udara 05-11-2019
	...
	public int print (Graphics g,PageFormat pageFormat, int page) {
		...
		//	System.out.println("sql Contract_Client_Data ==> "+Contract_Client_Data);
			...
			line = new AttributedString("BY REGISTERED POST");
