...
public class LAKDL_AF_MISF_Marketing_Officer_Perform_Report_final extends javax.servlet.http.HttpServlet { 
	...
	public  void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			if(m_chksql.equals("main_page")){ 
				...
				//out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Perform_Report_final?chksql=run_report&finance_no=\"+finance_no+\"&date=\"+m_date+\"&location_id=\"+document.Form1.TXT_LOCATION_CODE.value+\"&user_id=\"+document.Form1.TXT_USER.value+\"&perform_status=\"+m_perform_status;"); 
				out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Perform_Report_final?chksql=run_report&finance_no=\"+finance_no+\"&date=\"+m_date+\"&location_id=\"+document.Form1.TXT_LOCATION_CODE.value+\"&user_id=\"+document.Form1.TXT_USER.value+\"&perform_status=\"+m_perform_status+\"&collector=\"+collector;"); 
				...
				out.println("	}");
				*/
				//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Perform_Report_final?chksql=print_report_new&location=\"+m_location+\"&officer=\"+m_officer+\"&slab=\"+m_slba+\"&rendate=\"+m_rendate+\"&date=\"+m_date;");	
				
				// commented by udara on 06-09-2013
				//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Perform_Report_final?chksql=print_report_new&location=\"+m_location+\"&officer=\"+m_officer+\"&slab=\"+m_slba+\"&rendate=\"+m_rendate+\"&date=\"+m_date+\"&period=\"+m_period+\"&period_2=\"+m_period_2;"); // added by udara on 12-03-2013
				...
				//out.println("               m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Perform_Report_final?chksql=print_report_new&location=\"+m_location+\"&officer=\"+m_officer+\"&slab=\"+m_slba+\"&rendate=\"+m_rendate+\"&date=\"+m_date+\"&period=\"+m_period+\"&period_2=\"+m_period_2+\"&cr_officer=\"+cr_officer+\"&active_status=\"+document.Form1.TXT_ACTIVE_STATUS.value+\"&region=\"+m_region+\"&perform_status=\"+m_perform_status;"); // m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Perform_Report_final?chksql=print_report_new&location=\"+m_location+\"&officer=\"+m_officer+\"&slab=\"+m_slba+\"&rendate=\"+m_rendate+\"&date=\"+m_date+\"&period=\"+m_period+\"&period_2=\"+m_period_2;");
				out.println("               m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Perform_Report_final?chksql=print_report_new_logic&location=\"+m_location+\"&officer=\"+m_officer+\"&slab=\"+m_slba+\"&rendate=\"+m_rendate+\"&date=\"+m_date+\"&period=\"+m_period+\"&period_2=\"+m_period_2+\"&cr_officer=\"+cr_officer+\"&active_status=\"+document.Form1.TXT_ACTIVE_STATUS.value+\"&region=\"+m_region+\"&perform_status=\"+m_perform_status;"); // udara 08-12-2016
				out.println("           else ");
				out.println("           	m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Perform_Report_final?chksql=print_report_new_2&location=\"+m_location+\"&officer=\"+m_officer+\"&slab=\"+m_slba+\"&rendate=\"+m_rendate+\"&date=\"+m_date+\"&period=\"+m_period+\"&period_2=\"+m_period_2+\"&due_month=\"+due_month+\"&due_year=\"+due_year+\"&ins_level=\"+ins_level+\"&cr_officer=\"+cr_officer+\"&active_status=\"+document.Form1.TXT_ACTIVE_STATUS.value+\"&region=\"+m_region+\"&perform_status=\"+m_perform_status;"); // m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Perform_Report_final?chksql=print_report_new_2&location=\"+m_location+\"&officer=\"+m_officer+\"&slab=\"+m_slba+\"&rendate=\"+m_rendate+\"&date=\"+m_date+\"&period=\"+m_period+\"&period_2=\"+m_period_2+\"&due_month=\"+due_month+\"&due_year=\"+due_year+\"&ins_level=\"+ins_level;");
				*/
				...
				out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Perform_Report_final?chksql=main_page&generate=page';"); 
				out.println("		}"); 
				out.println("}"); 
