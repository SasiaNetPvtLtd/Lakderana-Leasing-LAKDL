...
public class LAKDL_AF_RE_Save_Lease_Assign extends HttpServlet {
	...
	synchronized(this){ 
	 ...
	 //   out.println(reqstr);
      ...
      String m_scr_name=(String)m_sn_methods.met_formdata(reqstr,"Hid_scr_name"); 
			...
			callstmt=conn.prepareCall("BEGIN "+m_schema_name+".AF_RE_SAVE_LEASE_ASSIGN(:1,:2,:3,:4,:5); END;");
			for (int j = 0; j < m_maxentries; j++) {
			
							String m_req =(String)m_sn_methods.met_formdata(reqstr,"CHK_REQUIRED"+(Integer.toString(j)));
							//out.println("m_req"+m_req);
							if(m_req.equals("on")){ // 26-02-2015//Uncommented by Jithendra 16-01-2017
										...
										String m_user =(String)m_sn_methods.met_formdata(reqstr,"TXT_USER"+(Integer.toString(j)));
									    ...
									    callstmt.setString(5,m_sn_methods.met_formdata(reqstr,"TXT_REMARK"+(Integer.toString(j))));  //added by Sandun on 28/07/2008
										callstmt.execute();
									} // 26-02-2015//Uncommented by Jithendra 16-01-2017
				}
		  ...
		  callstmt.close();
	   	...
	   	out.println("<HTML><HEAD>");
			...
			out.println("window.location.href='"+m_url+"/"+m_client_name+"AF_RE_Lease_Assign';");
