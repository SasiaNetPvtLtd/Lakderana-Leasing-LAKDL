...
public class LAKDL_AF_CR_PRO_Activate_Application extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res) { 
      ...
      String m_username = m_sn_methods.username;
			...
			out.println("	}");
				...
				out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_CR_PRO_Activate_Application?chksql=main_page';"); 
				out.println("		}"); 
				out.println("}"); 
				...
				out.println("    m_help_message = \"m_help_msg_application_activation\";"); 
				...
				out.println("help_box.innerHTML=\" Credit - Application Activation - \"+m_val;"); 
				out.println("}"); 
		
				out.println("function load_roll_out_value(){");
				out.println("help_box.innerHTML=\" Credit - Application Activation  \";"); 
				out.println("}"); 
			...
			out.println("    m_sql = \"m_help_TXT_APPLICATION_NO_activated\";"); 
			...
			out.println("    m_sql = \"m_help_FINANCE_NO_activated\";"); 
			out.println("    m_criteria = document.Form1.TXT_APPLICATION_NO.value+\"@\"+document.Form1.TXT_APPLICANT_CODE.value+\"@\"+document.Form1.TXT_FINANCE_NO.value+\"@\";");
			out.println("    HelpBox('1','10','0');"); 
			out.println("}"); 
			...
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_PRO_CR_sql_validations?chksql=m_prime_chk_LAKDL_AF_CR_PRO_display_activated_app_appnum&data_val1=\"+document.Form1.TXT_APPLICATION_NO.value+\"&ac_status=Y\";");
			out.println("load_interface(m_url,'XML');");
			out.println("}");
			
			out.println("function check_finnum() {");
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_PRO_CR_sql_validations?chksql=m_prime_chk_LAKDL_AF_CR_PRO_display_activated_app_finnum&data_val1=\"+document.Form1.TXT_FINANCE_NO.value+\"&ac_status=Y\";");
			out.println("load_interface(m_url,'XML');");
			out.println("}");
		  ...
		  out.println("		if(validate_data()){"); 
			...
			out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_CR_PRO_Save_Activate_Application';");  
			...
			out.println("} "); 
			    ...
			    out.println("<INPUT TYPE='Hidden' NAME='hid_close_sts' VALUE=\"N\">"); 
					...
					out.println("</tr>"); 
					out.println("<tr>"); 
					out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Credit - Application Activation</td>"); 
					out.println("</tr>"); 
					out.println("<tr>"); 
