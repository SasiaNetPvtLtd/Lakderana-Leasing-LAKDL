...
//--
//SCREEN NAME:SYSTEM ADMINISTRATION - BROKER DETAILS
//CREATED BY:CHANDANA
...
public class LAKDL_AF_MAS_brokers_details extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>System Administration - Broker Comments</TITLE>"); 
			out.println("</HEAD>"); 
		...
		//	out.println("				new_window();");
		  out.println("				assign_data(data_vec);");
			...
			out.println("if(document.Form1.hid_help_status.value == 'H1' && document.Form1.SCREEN_NAME.value==\"EDIT\" ) {");
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations1?chksql=m_prime_chk_LAKDL_AF_MAS_display_broker_details&data_val=\"+obj.value+\"&ac_status=Y\";");
			out.println(" }");
			out.println("else");
			out.println("if(document.Form1.hid_help_status.value == 'H1' && document.Form1.SCREEN_NAME.value==\"NEW\" ) {");
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations1?chksql=m_prime_chk_LAKDL_AF_MAS_display_broker_details&data_val=\"+obj.value+\"&ac_status=N\";");
			out.println(" }");
			...
			out.println("    document.Form1.TXT_COMMENTS.value=data_vec[16];");
			...
			out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_MAS_save_broker_details';");  
			...
			out.println("if(object.value!=''){"); //added by nuwan de silva 20-07-07
			out.println(" m_objval = object.toString(); ");
...
*/
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MAS_brokers_details';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("help_box.innerHTML=\" System Administration - Broker Comments - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" System Administration - Broker Comments - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
     ...
     // out.println("window.close();");
      out.println(" }");
			...
			out.println("document.Form1.TXT_BROKER_CODE.value='';"); 
			out.println("document.Form1.TXT_BROKER_CODE.focus();"); 
			//out.println("document.Form1.TXT_TITLE.value='';");  //modified by nuwan de silva 20-07-07
			...
			out.println("document.Form1.TXT_COMMISSION_RATE.value='';"); 
			out.println("document.Form1.TXT_COMMISSION_AMOUNT.value='';"); 
			out.println("document.Form1.TXT_COMMENTS.value='';");  //added by nuwan de silva 20-07-07---------
			...
			out.println("    m_sql = \"m_help_TXT_BROKER_DETAILS_sql\";"); 
      ...
      out.println(" function assign_help_status(obj){");
			...
			out.println("    document.Form1.TXT_COMMENTS.value=oBj.valout[18];");
	  	...
	  	out.println("		}"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>System Administration - Broker Comments</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
		...
		//	out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Reactivate\");' onClick='load_screen_status(\"RACT\")' value=\"Re-activate\"></td>"); 
			...
			out.println("<td width='30%' ><DIV id='DIV_TXT_BROKER_CODE'  class=div_input>Broker Code *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_BROKER_CODE' maxlength='10' size='10' onblur=\"assign_help_status('H1'),makeRequest(document.Form1.TXT_BROKER_CODE)\">"); 
			...
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_FIRST_NAME' maxlength='200' size='50'></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 

			out.println("<td width='30%' ><DIV id='DIV_TXT_LAST_NAME'  class=div_input>Last Name *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_LAST_NAME' maxlength='50' size='50'></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 

			out.println("<td width='30%' ><DIV id='DIV_TXT_ID_NO'  class=div_input>ID No *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_ID_NO' maxlength='10' size='10'onblur=\"val_nic(this),assign_help_status('H6'),makeRequest(document.Form1.TXT_ID_NO)\" ></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 
			...
			out.println("<td width='30%' ><input class='txt_input' type='text' name='TXT_LOCATION_CODE' maxlength='10' size='10' onblur=\"assign_help_status('H2'),makeRequest1(document.Form1.TXT_LOCATION_CODE)\">"); 
			...
			*/
			...
			out.println("<td width='30%' ><input class='txt_input' type='text' name='TXT_CITY_CODE' maxlength='10' size='10' onblur=\"assign_help_status('H3'),makeRequest(document.Form1.TXT_CITY_CODE)\" disabled></td>"); 
			//out.println("<input class='but_input' type='button' name='BUT_TXT_CITY_CODE' value=\"Help\" onClick=\"help_button_2()\" disabled></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 

			out.println("<td width='30%' >Postal Code</td>"); 
			out.println("<td width='30%' ><input class='txt_input' type='text' name='TXT_POSTAL_CODE' maxlength='10' size='10' onblur=\"assign_help_status('H4'),makeRequest(document.Form1.TXT_POSTAL_CODE)\" disabled></td>"); 
			...
			out.println("<td width='30%' >Sector Code</td>"); 
			out.println("<td width='30%' ><input class='txt_input' type='text' name='TXT_SECTOR_CODE' maxlength='10' size='10' onblur=\"assign_help_status('H5'),makeRequest(document.Form1.TXT_SECTOR_CODE)\">"); 
			out.println("<input class='but_input' type='button' name='BUT_TXT_SECTOR_CODE' value=\"Help\" onClick=\"help_button_4()\"></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 

			out.println("<td width='30%' >Commission Rate </td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_COMMISSION_RATE' maxlength='22' size='22' onblur='check_rate(),val_com_rate(this.value)' ></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 

			out.println("<td width='30%' >Commission Amount </td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_COMMISSION_AMOUNT' maxlength='22' size='22' onblur='check_amt(),val_com_amount(this.value)' ></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("</table>"); 
			out.println("<br>"); 
			...
			out.println("<td width=\"25%\"><B>Please tick this box if the broker is complete.</B></td><td width=\"5%\"><input class='' type='checkbox' name='CHK_REQUIRED' onClick='change_val_req()' ></td><td width=\"20%\"></td>");
			out.println("<td width='*%'></td>"); 
			out.println("</tr>");
			out.println("</table>");
