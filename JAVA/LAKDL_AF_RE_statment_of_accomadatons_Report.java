...
public class LAKDL_AF_RE_statment_of_accomadatons_Report extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			if(m_chksql.equals("run_report")){ 
				...
				try{
				callstmt1 = conn.prepareCall("BEGIN "+m_schema_name+".AF_CB_ACC_GRANT_TOT_OS_RPT(:1,:2);END;");
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Accounting - Statement Of Accommodations Granted </TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("var m_sav_msg='';");
		  	...
		  	out.println("var b_flag=0;");
				...
				out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_statment_of_accomadatons_Report?chksql=run_report&date=\"+m_to_date;"); 
				...
				out.println("		m_from_date=document.Form1.TXT_FROM_DATE_DD.value+'-'+document.Form1.TXT_FROM_DATE_MM.value+'-'+document.Form1.TXT_FROM_DATE_YY.value;");
				out.println("		m_to_date=document.Form1.TXT_TO_DATE_DD.value+'-'+document.Form1.TXT_TO_DATE_MM.value+'-'+document.Form1.TXT_TO_DATE_YY.value;");
				out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_statment_of_accomadatons_Report?chksql=print_report_new&from_date=\"+m_from_date+\"&to_date=\"+m_to_date;");	
      ...
      out.println("			else {");
			...
			out.println("	help_box.innerHTML=\" Accounting - Statement Of Accommodations Granted - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\" Accounting - Statement Of Accommodations Granted \";"); 
			out.println("}"); 
	  	...
	  	out.println("					}"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Accounting - Statement Of Accommodations Granted </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
      ...
      rs1 = stmt1.executeQuery(Comp_Name);
			...
			boolean more1 = rs1.next();			
			  ...
			  out.println("<BODY  class='body & txt-body' leftmargin='0' topmargin='0' marginwidth='0' > ");
				...
				*/
				...
				out.println("<td align='left' width='20%'  >Format No</td>");
				out.println("<td align='center' width='5%' >:</td>");
				out.println("<td align='left' width='*%' >SNBFI/FL/02/06</b></td>");
				out.println("</tr>");
				out.println("<tr >");
				out.println("<td align='left' width='20%'  >Name of RFLE</td>");
				out.println("<td align='center' width='5%' >:</td>");
			  ...
			  out.println("<br>");
				...
				" SELECT COUNT(A.finance_no) NO_OF_CONTRACTS,"+ //1
				...
				" nvl(a.transaction_type,'-') TXT_TYPE, "+ //3
				" "+m_schema_name+".AF_CO_GET_TRANSACTION_DESC(a.transaction_type) TXT_TYPE_DESC, "+ //4
				" MIN(A.irr) ,"+ //5
				" MAX(A.irr) "+  //6
				" , sum(a.facility_amount) "+ //7
				" FROM   "+m_schema_name+".AF_RE_TBD_CB_GRANT_TOT_OS a  "+
				...
				" GROUP BY A.transaction_type ORDER BY A.transaction_type ");
        ...
        if(!more){
				...
				out.println("<tr>");
				out.println("<td rowspan=\"2\" width=\"35%\">&nbsp;</td>");
				out.println("<td colspan=\"3\" bgcolor=#a5b6c6  width=\"40%\">Accommodation Granted During the Quarter ended "+m_ended_date+"</td>");
				out.println("<td colspan=\"2\" bgcolor=#a5b6c6  width=\"25%\">Outstanding Accommodation As at "+m_ended_date+"</td>");
				out.println("</tr>");
				
				out.println("<tr>");
				out.println("<td bgcolor=#a5b6c6  width=\"10%\">No of contract  </td>");
				out.println("<td bgcolor=#a5b6c6  width=\"15%\">Total amount granted/financed </td>");
				out.println("<td bgcolor=#a5b6c6  width=\"15%\">Range of rates of interest(%) </td>");
				out.println("<td bgcolor=#a5b6c6  width=\"10%\">No of Contracts </td>");
				out.println("<td bgcolor=#a5b6c6  width=\"15%\">Total Outstanding </td>");
				out.println("</tr>");
				
				String m_transaction_type="";
				int m_count=0,m_tot_count=0;
				double m_amount=0,m_tot_amount=0;
				
				while(more){
				m_transaction_type=rs.getString(3);
				...
				out.println("<td align=\"right\">"+rs.getInt(1)+" &nbsp;</td>");
				out.println("<td align=\"right\">"+nf.format(rs.getDouble(7))+" &nbsp;</td>");
				out.println("<td align=\"right\">"+rs.getDouble(5)+"% - "+rs.getString(6)+"% &nbsp;</td>");
				out.println("<td align=\"right\">"+rs1.getInt(1)+" &nbsp;</td>");
				out.println("<td align=\"right\">"+nf.format(rs1.getDouble(2))+" &nbsp;</td>");
				out.println("</tr>");
				m_count+=rs.getInt(1);
				m_amount+=rs.getDouble(7);
				m_tot_count+=rs1.getInt(1);
				m_tot_amount+=rs1.getDouble(2);
				more=rs.next();
				}
        ...
        m_tot_amnt  = rs.getDouble(6) + rs.getDouble(12) + rs.getDouble(18) + rs.getDouble(24);
				*/
				...
				out.println("<tr height=\"30px\">");
				out.println("<td><B>&nbsp; Total &nbsp;</B></td>");
				out.println("<td align=\"right\"><B>"+m_count+"&nbsp;</td>");
				out.println("<td align=\"right\"><B>"+nf.format(m_amount)+"&nbsp;</td>");
				out.println("<td align=\"right\"><B>&nbsp;</td>");
				out.println("<td align=\"right\"><B>"+m_tot_count+"&nbsp;</td>");
				out.println("<td align=\"right\"><B>"+nf.format(m_tot_amount)+"&nbsp;</td>");
				out.println("</tr>");
