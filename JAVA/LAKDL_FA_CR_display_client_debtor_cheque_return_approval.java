...
public class LAKDL_FA_CR_display_client_debtor_cheque_return_approval extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Credit Process - Client Debtor Cheque Return Approval </TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"FA_CR_PRO_sql_validations_normal?chksql=LOAD_CLIENTS_DEBTOR_CHEQUE_APPROVAL\";");
			...
			out.println("			}");
			out.println("			if(validate_data()){"); 
			out.println("				document.Form1.action='"+m_class_url+"/"+m_fschema_name+"FA_CR_Save_client_debtor_cheque_return_approval';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"FA_CR_display_client_debtor_cheque_return_approval';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("	help_box.innerHTML=\" Credit Process - Client Debtor Cheque Return Approval  - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\" Credit Process - Client Debtor Cheque Return Approval  \";"); 
			out.println("}"); 
	  	...
	  	out.println("					}"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Credit Process - Client Debtor Cheque Return Approval </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
