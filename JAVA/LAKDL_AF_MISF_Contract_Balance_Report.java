...
public class LAKDL_AF_MISF_Contract_Balance_Report extends javax.servlet.http.HttpServlet { 
		...
		try { 			 
			...
			if(m_chksql.equals("run_report")){ 				
				...
				if(m_chksql.equals("main_page")){ 
					...
					out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MISF_Contract_Balance_Report?chksql=main_page';"); 
					out.println("		}"); 
					out.println("}"); 
					...
					out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Contract_Balance_Report?chksql=run_report&date=\"+m_date+\"&client_code=\"+document.Form1.CLIENT_CODE.value+\"&branch_code=\"+document.Form1.TXT_LOCATION_CODE.value;");  // Samith :  brach:TXT_LOCATION_CODE
					...
					out.println("		m_date=document.Form1.VAL_DAY.value+'-'+document.Form1.VAL_MONTH.value+'-'+document.Form1.VAL_YEAR.value;");
					out.println("	if(document.Form1.VAL_DAY.value!=\"\" && document.Form1.VAL_MONTH.value!=\"\" && document.Form1.VAL_YEAR.value!=\"\"){");
					//out.println("			m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Contract_Balance_Report?chksql=print_report&date=\"+m_date+\"&client_code=\"+document.Form1.CLIENT_CODE.value+\"&branch_code=\"+document.Form1.TXT_LOCATION_CODE.value;");   // Samith :  brach:TXT_LOCATION_CODE
					out.println("			m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Contract_Balance_Report?chksql=print_report&date=\"+m_date+\"&client_code=\"+document.Form1.CLIENT_CODE.value+\"&branch_code=\"+document.Form1.TXT_LOCATION_CODE.value+\"&product_name=\"+m_product_name;"); 
					...
					if(m_chksql.equals("print_report")){		
						...
						if (m_client_code.equals("")){
							...
							rs1= stmt1.executeQuery(" SELECT X.CLIENT_CODE,"+
								...
								" FROM "+m_schema_name+".AF_CO_TBD_CONTRACT_BAL X , "+m_schema_name+".AF_CO_PRO_APPLICATION_DETAILS Y "+
