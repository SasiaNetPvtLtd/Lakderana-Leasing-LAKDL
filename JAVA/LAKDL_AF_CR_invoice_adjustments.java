...
public class LAKDL_AF_CR_invoice_adjustments extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			stmt2=conn.createStatement(); // added by udara 08-06-2015
			...
			rs2 = stmt2.executeQuery ("SELECT TO_CHAR(SYSDATE,'DD-MM-YYYY') "+
				"FROM  DUAL ");
		
			while(rs2.next()){
				out.println(" m_sysdate = '"+rs2.getString(1)+"'");			
			}
			out.println(" document.Form1.TXT_ADUSTED_DATE_DD.value = m_sysdate.substring(0,2)");
			out.println(" document.Form1.TXT_ADUSTED_DATE_MM.value = m_sysdate.substring(3,5)");
			out.println(" document.Form1.TXT_ADUSTED_DATE_YY.value = m_sysdate.substring(6,10)");
			...
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_PRO_CR_sql_validations?chksql=m_prime_chk_LAKDL_AF_CR_invoice_adjustments_credit_no&data_val=\"+obj.value+\"&ac_status=Y\";");
			...
			out.println("	else if(document.Form1.TXT_AMOUNT_ADJUST.value==\"\"){  "); 
			out.println("		DIV_TXT_INVOICE_AMOUNT_ADJUST.style.color='red';");
			out.println("		return false;"); 
			out.println("	}");
			...
			out.println("			}");
			out.println("			if(validate_data()){"); 
			out.println("				document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_CR_Save_invoice_adjustments';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_CR_invoice_adjustments';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("	help_box.innerHTML=\"  Finance - Invoice Adjustments - \"+m_val;"); 
			out.println("}"); 
			
			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\"  Finance - Invoice Adjustments - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
			...
			out.println("		document.Form1.TXT_FINANCE_NO.disabled=true;"); 
			out.println("		document.Form1.TXT_INVOICE_NO.disabled=true;"); 
			out.println("		document.Form1.TXT_AMOUNT_ADJUST.disabled=true;"); 
			out.println("		document.Form1.TXT_CREDIT_TYPE.disabled=true;"); 
			out.println("		document.Form1.BUT_HELP_FINANCE.disabled=true;"); 
			out.println("		document.Form1.BUT_HELP_INVOICE.disabled=true;"); 
			...
			out.println("if(IfCount=='99'){"); 
			out.println("document.Form1.TXT_CREDIT_NO.value=\"\";"); 
			out.println("}");			
			out.println("else if(IfCount=='100'){"); 
			...
			//out.println("    HelpBox('1','10','0',Crit,'m_help_CR_DR_NOTES_CREDIT_NO','99');"); 		
			
			out.println("    HelpBox('1','10','0',Crit,'m_help_CR_DR_NOTES_CREDIT_NO1','99');"); 		
			...
			out.println("		document.Form1.TXT_INVOICE_NO.value=oBj.valout[6];"); 
			...
			out.println("		document.Form1.TXT_BAL_TO_BE_RECEVIED.value=oBj.valout[8];"); 
			out.println("		format_number(document.Form1.TXT_BAL_TO_BE_RECEVIED,25);");
			out.println("		document.Form1.TXT_AMOUNT_ADJUST.value=oBj.valout[9];"); 
			out.println("		format_number(document.Form1.TXT_AMOUNT_ADJUST,25);");
			out.println("		getDateValues(oBj.valout[10]);");
			out.println("		document.Form1.TXT_CREDIT_TYPE.value=oBj.valout[11];"); 
			out.println("		getDateValues_Adusted(oBj.valout[12]);");
			out.println("		document.Form1.TXT_REMARKS.value=oBj.valout[13];"); 
			out.println("		document.Form1.TXT_DOC_REF_NO.value=oBj.valout[14];"); 
			out.println("		document.Form1.TXT_ADJUSTED_TYPE.value=oBj.valout[15];"); 
			out.println("		document.Form1.TXT_NARRATIONS_CODE.value=oBj.valout[16];"); 
			out.println("}");
			...
			//Modified by Dineth on 2008-09-15
			...
			out.println("    HelpBox('1','10','0',Crit,'m_help_CR_DR_NOTES_INVOICE_NO_ADJ','2');"); 		
			out.println("    } ");		
			...
			//---------Sandun on 22-01-2009----------------------
			
			out.println("function copy_doc(){");
			out.println("m_url = \""+m_class_url+"/"+m_fschema_name+"AF_CR_display_adjustment_doc\" ;");
			...
			out.println("<BODY class='body & txt-body' leftmargin='0' topmargin='0' marginwidth='0' ONLOAD=\"load_lock(),Fill_Finance_no(),load_sys_date()\">"); 
			...
			out.println("<INPUT TYPE='Hidden' NAME='Hid_scr_name' VALUE=\"AF_CR_INVOICE_ADJUSTMENTS\">");
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Finance - Invoice Adjustments </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			//out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Delete\");'  onClick='load_screen_status(\"DEL\")' value=\"Delete\"></td>");  // Modified By Sandun on 10-11-2008
			...
			//-(2007-03-22)----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
			out.println("<td width='6%'></td>");  
			out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Copy\");'  onclick='copy_doc()' value=\"Copy\"></td>"); //Added By Sandun on 22-01-2009
			...
			out.println("<tr>"); 
			out.println("<td width='15%' ><DIV id='DIV_TXT_CREDIT_NO'  class=div_input>Credit No *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_CREDIT_NO' maxlength='15' size='15' onblur=\"assignState('M3'),makeRequest(document.Form1.TXT_CREDIT_NO)\" disabled>"); 
			...
			//out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_FINANCE_NO' maxlength='15' size='15' onblur=\"assignState('M1'),makeRequest(document.Form1.TXT_FINANCE_NO)\">"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_FINANCE_NO' maxlength='20' size='15' onblur=\"assignState('M1'),makeRequest(document.Form1.TXT_FINANCE_NO)\">"); 
			...
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_CLIENT_CODE' maxlength='10' size='10' disabled></TD>"); 
			...
			out.println("<input class='but_input' type='button' name='BUT_HELP_INVOICE' value=\"...\" onClick=\"help_invoice_number()\"></td>");
			...
			out.println("<tr >"); 
			out.println("<td width='15%' ><DIV id='DIV_TXT_INVOICE_AMOUNT'  class=div_input>Total Amount Rs.</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_TOTAL_AMOUNT' maxlength='25' size='50' style='width:118;text-align:right;'  disabled></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>");
			
			out.println("<tr >"); 
			out.println("<td width='15%' ><DIV id='DIV_TXT_INVOICE_BAL'  class=div_input>Balance To Be Received</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_BAL_TO_BE_RECEVIED' maxlength='25' size='50' style='width:118;text-align:right;'  disabled></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>");	
			
			
			out.println("<tr >"); 
			out.println("<td width='15%' ><DIV id='DIV_TXT_INVOICE_AMOUNT_ADJUST'  class=div_input>Adjusted Amount Rs.</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_AMOUNT_ADJUST' maxlength='25' size='50' style='width:118;text-align:right;' onBlur=\"check_number(document.Form1.TXT_AMOUNT_ADJUST,25)\" ></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>");	
			
			
			out.println("<tr >");
			out.println("<td width=\"15%\"><DIV id=\"DIV_TXT_INVOICE_BATCH_DATE\" class=div_input>Invoice Date </DIV></td>");
			out.println("<td width=\"40%\"><input class=\"txt_input5\" type=\"text\" name=\"TXT_INVOICE_DATE_DD\" maxlength=\"2\" size=\"2\" onblur=\"checkMonthLength(document.Form1.TXT_INVOICE_DATE_DD,document.Form1.TXT_INVOICE_DATE_MM,document.Form1.TXT_INVOICE_DATE_YY)\" >");
			out.println("<input class=\"txt_input5\" type=\"text\" name=\"TXT_INVOICE_DATE_MM\" maxlength=\"2\" size=\"2\" onblur=\"checkMonthLength(document.Form1.TXT_INVOICE_DATE_DD,document.Form1.TXT_INVOICE_DATE_MM,document.Form1.TXT_INVOICE_DATE_YY)\">");
			out.println("<input class=\"txt_input5\" type=\"text\" name=\"TXT_INVOICE_DATE_YY\" maxlength=\"4\" size=\"4\" onblur=\"checkMonthLength(document.Form1.TXT_INVOICE_DATE_DD,document.Form1.TXT_INVOICE_DATE_MM,document.Form1.TXT_INVOICE_DATE_YY)\" ><a href style='{cursor:hand; }' onclick=load_calendar('1')>   Calendar</a></td>");
			out.println("<td width='*%'></td>"); 
			out.println("</tr>");
			
			out.println("<tr >"); 
			out.println("<td width='30%' >Credit/Debit Type</td>"); 
			out.println("<td width='40%' ><select name='TXT_CREDIT_TYPE' class='txt_input' disabled>");
			out.println("<option value=\"CR\"      SELECTED>Credit</option>");
			out.println("<option value=\"DB\" 			>Debit </option>");
			out.println("</select>");
			out.println("</tr>"); 
			
			out.println("<tr >"); 
			out.println("<td width='30%' >Credit Debit Narrations</td>"); 
			
			out.println("<td width=\"40%\" ><select class=\"txt_input\" type=\"text\" name=TXT_NARRATIONS_CODE maxlength=15  >");  //style=\"width:145px\" 
			...
			out.println("<tr >");
			out.println("<td width=\"15%\"><DIV id=\"DIV_TXT_ADUSTED_DATE\" class=div_input>Adjusted Date *</DIV></td>"); //modified by nuwan de silva 26-06-07
			//modified by madhawa add function call checkMonthLength for onblur event 
			out.println("<td width=\"40%\"><input class=\"txt_input5\" type=\"text\" name=\"TXT_ADUSTED_DATE_DD\" maxlength=\"2\" size=\"2\" onblur=\"checkMonthLength(document.Form1.TXT_ADUSTED_DATE_DD,document.Form1.TXT_ADUSTED_DATE_MM,document.Form1.TXT_ADUSTED_DATE_YY)\" >");
			//modified by madhawa add function call checkMonthLength for onblur event
			out.println("<input class=\"txt_input5\" type=\"text\" name=\"TXT_ADUSTED_DATE_MM\" maxlength=\"2\" size=\"2\" onblur=\"checkMonthLength(document.Form1.TXT_ADUSTED_DATE_DD,document.Form1.TXT_ADUSTED_DATE_MM,document.Form1.TXT_ADUSTED_DATE_YY)\" >");
			...
			out.println("<tr >"); 
			out.println("<td width='15%' ><DIV id='DIV_TXT_REMARKS'  class=div_input>Remarks</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_REMARKS' maxlength='1000' size='50' style='width:400;' onBlur=\"\" ></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>");	
			//ADDED MILINDA 2014-01-07
			out.println("<tr >"); 
			out.println("<td width='15%' ><DIV id='DIV_TXT_REMARKS_1'  class=div_input>Remarks</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_REMARKS_2' maxlength='1000' size='50' style='width:400;' onBlur=\"\" ></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>");	
			
			out.println("<tr >"); 
			out.println("<td width='15%' ><DIV id='DIV_TXT_DOC_REF_NO'  class=div_input>Document Reference Number</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_DOC_REF_NO' maxlength='25' size='50'  onBlur=\"\" ></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>");	
			
			
			out.println("<tr >"); 
			out.println("<td width='30%' >Adjusted Type</td>"); 
			out.println("<td width='40%' ><select name='TXT_ADJUSTED_TYPE' class='txt_input'>");
