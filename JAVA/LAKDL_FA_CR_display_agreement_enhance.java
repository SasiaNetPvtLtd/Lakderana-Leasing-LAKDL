// DEVELOP BY : MAHELA FOR OFSCL FACTORING    DATE:27-02-2007
...
public class LAKDL_FA_CR_display_agreement_enhance extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Credit Process - Agreement (Enhancement/Variation) </TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"FA_CR_PRO_sql_validations_normal?chksql=LOAD_AGREEMENT_ENHANCEMENT\";");
			...
			out.println("function Generate_agreement(m_facility_no,m_client_code) {");	
			out.println("	m_url = \""+m_class_url+"/"+m_fschema_name+"FA_CR_Factoring_Agreement_Enhance?chksql=main_page&facility_no=\"+m_facility_no+\"&print=TRUE&client_no=\"+m_client_code;"); 
  		...
  		out.println("		}");
   		...
   		out.println("}"); 
			...
			out.println("			}");
			out.println("			if(validate_data()){"); 
			out.println("				document.Form1.action='"+m_class_url+"/"+m_fschema_name+"FA_CR_Save_client_facility_approval';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"FA_CR_display_agreement_enhance';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("    m_help_message = \"m_help_msg_LAKDL_FA_CR_FACT_AGREEMENT\";"); 
			...
			out.println("	help_box.innerHTML=\"  Credit Process - Agreement (Enhancement/Variation)  - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\" Credit Process - Agreement (Enhancement/Variation)   \";"); 
			out.println("}"); 
	  	...
	  	out.println("					}"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Credit Process - Agreement (Enhancement/Variation) </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
