...
//SCREEN NAME:SYSTEM ADMINISTRATION - VALUER
...
public class LAKDL_AF_MAS_display_valuer extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>System Administration - Creation of Valuers</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("			}");
			out.println("			else if(data_vec.length>0 && document.Form1.SCREEN_NAME.value==\"NEW\" && document.Form1.hid_help_status.value == 'H_val'){");
			out.println("				alert('Record already Exists.');");
			out.println("   		help_update_name();"); 
			//out.println("    document.Form1.TXT_LAST_NAME.focus();"); 
			out.println("			}");
			out.println("		  else	if(data_vec.length > 0 && document.Form1.SCREEN_NAME.value!=\"NEW\"&& document.Form1.TXT_VALUER_CODE.value !=''&& document.Form1.hid_help_status.value == 'H1' ){");
			...
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations1?chksql=m_prime_chk_LAKDL_AF_MAS_display_valuer2&data_val=\"+obj.value;");
			out.println("else");
			out.println("if(document.Form1.hid_help_status.value == 'H1' && document.Form1.SCREEN_NAME.value!=\"RACT\" ) ");
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_valuer&data_val=\"+obj.value+\"&ac_status=Y\";");
			out.println("else");
			out.println("if(document.Form1.hid_help_status.value == 'H1' && document.Form1.SCREEN_NAME.value==\"RACT\" ) ");
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_valuer&data_val=\"+obj.value+\"&ac_status=N\";");
			out.println("else");
			...
			out.println("if(document.Form1.hid_help_status.value == 'H_val' && document.Form1.SCREEN_NAME.value!=\"RACT\" ) ");
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations1?chksql=m_prime_chk_LAKDL_AF_MAS_display_valuer1&data_val=\"+obj.value+\"&data_val2=\"+obj2.value;");
			...
			out.println("    document.Form1.TXT_ADDRESS.value=data_vec[3];"); 
			...
			out.println("    document.Form1.TXT_MOBILE_NO.value=data_vec[7];"); 
			out.println("    document.Form1.TXT_DEFAULT_VALUE.value=data_vec[8];"); 
			...
			out.println("    document.Form1.TXT_VALUER_CODE.focus(); ");
			out.println("   }		"); 
			...
			out.println("   }");
			out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_MAS_save_valuer';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MAS_display_valuer';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("    m_help_message = \"m_help_msg_LAKDL_AF_MAS_display_valuer\";"); 
			...
			out.println("help_box.innerHTML=\" System Administration - Creation of Valuers - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" System Administration - Creation of Valuers - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
	  	...
	  	out.println("		}"); 
			...
			out.println("    m_sql = \"m_help_TXT_VALUER_NAME_sql\";"); 
			...
			out.println("    document.Form1.TXT_ADDRESS.value=oBj.valout[5];"); 
			...
			out.println("    document.Form1.TXT_DEFAULT_VALUE.value=oBj.valout[10];"); 
	  	...
	  	out.println("		}"); 
			...
			out.println("    m_sql = \"m_view_TXT_VALUER_CODE_sql\";");
			out.println("    m_criteria = document.Form1.TXT_VALUER_CODE.value+\"@\"+\"Y@\";"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>System Administration - Creation of Valuers</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_VALUER_CODE' maxlength='10' size='10' onblur=\"assign_help_status('H1'),makeRequest(document.Form1.TXT_VALUER_CODE)\">"); 
			...
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_LAST_NAME' onblur=\"assign_help_status('H_val'),makeRequest1(document.Form1.TXT_FIRST_NAME,this)\"  maxlength='50' size='20'></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 

			out.println("<td width='30%' ><DIV id='DIV_TXT_ADDRESS'  class=div_input>Address 1 *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_ADDRESS' maxlength='100' size='20'></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 
			...
			out.println("<td width='30%' ><input class='txt_input' type='text' name='TXT_CITY_CODE' maxlength='10' size='10' onblur=\"assign_help_status('H2'),makeRequest(document.Form1.TXT_CITY_CODE)\" >"); 
			out.println("<input class='but_input' type='button' name='BUT_TXT_CITY_CODE' value=\"Help\" onClick=\"help_button_1()\"></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 

			out.println("<td width='30%' ><DIV id='DIV_TXT_TEL_NO'  class=div_input>Tel No *</DIV></td>"); 
	...
	//---(2007-02-28)-------------------------------------------------------------------------------------------------------------		
			out.println("<tr >"); 
			out.println("<td width='30%' ><DIV id='DIV_TXT_AMOUNT'  class=div_input>Valuer Amount</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' style='text-align:right' type='text' name='TXT_AMOUNT' maxlength='25' size='27' onblur=\"check()\" ></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
	//----------------------------------------------------------------------------------------------------------------------------		
