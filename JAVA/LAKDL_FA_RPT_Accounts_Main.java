...
public class LAKDL_FA_RPT_Accounts_Main extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("		window.open(servlet_client_url+\":\"+client_t3_port+\"/\"+client_name+\"FA_RPT_display_accounts_report_new?chksql=MAIN&start_date=\"+m_rpt_st_date+\"&end_date=\"+m_rpt_end_date,'popupwin1','status=0,menubar=0,scrollbars=1,height=500,width=700');");
			out.println("	}");
			out.println("}");
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"FA_RPT_Accounts_Main';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("	help_box.innerHTML=\" Operation Process - Accounts Information - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\" Operation Process - Accounts Information - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
	  	...
	  	out.println("					}"); 
			...
			//modified by madhawa 2009-10-14 add call to "checkMonthLength" on onblur event
			out.println("<td width=\"40%\"><input class=\"txt_input5\" type=\"text\" name=\"TXT_ST_DD\" maxlength=\"2\" size=\"2\" onblur=\"checkMonthLength(document.Form1.TXT_ST_DD,document.Form1.TXT_ST_MM,document.Form1.TXT_ST_YY)\"  value=\""+m_dd+"\" tabindex=\"1\">");
			//modified by madhawa 2009-10-14 add call to "checkMonthLength" on onblur event
