...
public class LAKDL_AF_CR_PRO_Payment_Voucher_Generation extends javax.servlet.http.HttpServlet {
   ...
   //   String m_username 						= "AA";//m_sn_methods.username;
      ...
      out.println("			}");
	  	...
	  	out.println("		}"); 
			...
			out.println("    HelpBox('1','10','0',Crit,'m_help_payment_no_other_payment','1');"); 
			out.println("}");
			out.println(""); 
			

			out.println("function assign_payment_no() {"); 
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_CR_PRO_Payment_Voucher_Generation';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("help_box.innerHTML=\" Finance Process - Payment Voucher Copy - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" Finance Process - Payment Voucher Copy - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
			...
			out.println("}");
			out.println("else{");
			out.println(" m_url = \""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_PRO_Document_Payment_Voucher?chksql=main_page&payment_no=\"+document.Form1.TXT_PAYMENT_NO.value+\"&print=TRUE\";	");				
      ...
      out.println("</Script>");
			    ...
			    out.println("<INPUT TYPE='Hidden' NAME='hid_no_rec' VALUE=\"\">"); 
					...
					out.println("</tr>"); 
					out.println("<tr>"); 
					out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Finance Process - Payment Voucher Copy</td>"); 
					out.println("</tr>"); 
					out.println("<tr>"); 
			...
			//		out.println("<tr><td width='10%' align='center'><input type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"New\");' onclick='load_screen_status(\"NEW\")' value=\"New\"></td>");  
				...
				//	out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Help\");' onClick='load_screen_status(\"HELP\")' value=\"Help\"></td>");  
					...
					out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_PAYMENT_NO' maxlength='15' size='15'>"); 
			    out.println("<input class='but_input' type='button' name='BUT_TXT_PAYMENT_NO' value=\"Help\" onClick=\"help_payment_no()\">"); 
					out.println("<input class='but_input' type='button' name='BUT_BCODE' value=\"View Voucher\" onClick=\"letter()\" style=\"{width:110px;}\" style='{cursor:hand;}'></td>"); 
					out.println("</tr>"); 
          out.println("</table>");   
