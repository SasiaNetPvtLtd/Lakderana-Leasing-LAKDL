...
public class LAKDL_AF_RE_Crib_Letter_Main extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res) { 
      ...
      String m_username = m_sn_methods.username;
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE> CRIB Letter </TITLE>"); 
			out.println("</HEAD>"); 
      ...
      out.println("      display_data(data_vec);"); 		
			...
			out.println("}");
				...
				out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_RE_Crib_Letter_Main?chksql=main_page';"); 
				out.println("		}"); 
				out.println("}"); 
				...
				out.println("help_box.innerHTML=\" CRIB Letter - \"+m_val;"); 
				out.println("}"); 
		
				out.println("function load_roll_out_value(){");
				out.println("help_box.innerHTML=\" CRIB Letter  \";"); 
				out.println("}"); 
			...
			out.println("}"); 
					...
					out.println("    Crit = document.Form1.TXT_APPLICATION_NO.value+\"@\"+document.Form1.TXT_FINANCE_NO.value+\"@\"+document.Form1.TXT_APPLICANT_CODE.value+\"@\";"); 
					out.println("    HelpBox(Start,End,Hid_No,Crit,Sql,IfCount);"); 
					out.println("}"); 
					...
					out.println("    Crit = document.Form1.TXT_FINANCE_NO.value+\"@\"+document.Form1.TXT_APPLICATION_NO.value+\"@\"+document.Form1.TXT_APPLICANT_CODE.value+\"@\";"); 
					out.println("    HelpBox('1','10','0',Crit,'m_help_TXT_FINANCE_NO_6','2');");
					out.println("}");
          ...
          out.println("function validate_app_no(){");
		   	  ...
		   	  out.println("			 alert('Application No Cannot Be Null ');	");
				  ...
				  out.println("}");
					...
					//modified by Disnaka Jayasuriya on 2009-10-15
					out.println("function but_view(){");  //AF_CR_Preliminary_Information_Letter?chksql=letter&app_no=AP20070702-0851
					out.println("	if (validate_app_no()){");
					out.println("  m_url='"+m_class_url+"/"+m_fschema_name+"AF_CR_Preliminary_Information_Letter?chksql=letter&app_no='+document.Form1.TXT_APPLICATION_NO.value;");  
          ...
          out.println("	}");
			    ...
			    out.println("<INPUT TYPE='Hidden' NAME='hid_close_sts' VALUE=\"N\">"); 
					...
					out.println("</tr>"); 
					out.println("<tr>"); 
					out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>CRIB Letter</td>"); 
					out.println("</tr>"); 
					out.println("<tr>"); 
	    		...
	    		out.println("<td width='10%' align='center'><input type=button name=back value=\"Close\" class=mainbut onclick=close_screen(); onMouseOver='load_roll_value(\"Close\");' onmouseout='load_roll_out_value();'></td>");
			   	...
			   	out.println("<td width='100%'>");	
					...
					out.println("<td width='35%' ><input class='txt_input' type='text' name='TXT_APPLICATION_NO' maxlength='15' size='15' onblur=\"help_update('1','10','5','m_help_TXT_APPLICATION_NO_6','99')\">"); 
					out.println("<input class='but_input' type='button' name='BUT_HELP_MAIN' value=\"...\" onClick=\"help_update('1','10','5','m_help_TXT_APPLICATION_NO_6','99')\" ></td>"); //M_APPLICATION_PROCESS_APPLICATION_HELP m_help_TXT_APPLICATION_NO
					out.println("</tr>"); 
					out.println("<tr >"); 
					...
					out.println("<td width='35%' ><input class='txt_input' type='text' name='TXT_APPLICANT_CODE' maxlength='10' size='10' onblur=\"help_button_2('1','10','0','m_help_TXT_CLIENT_NO_6','3')\">"); 
					out.println("<input class='but_input' type='button' name='BUT_TXT_APPLICANT_CODE' value=\"...\" onClick=\"help_button_2('1','10','0','m_help_TXT_CLIENT_NO_6','3')\">&nbsp&nbsp<input class='but_input' type='button' name='BUT_VIEW' value=\" View \" onClick=\"but_view()\"></td>"); 
