...
public class LAKDL_FA_CR_display_legal_letter_to_debtor extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Operation Process - Legal Letter to Debtor</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("			}");
			out.println("			if(validate_data()){"); 
			out.println("	      m_url=\""+m_class_url+"/"+m_fschema_name+"FA_OP_save_Legal_Letter_to_debtor?client_no=\"+document.Form1.TXT_CLIENT_CODE.value+\"&facility_no=\"+document.Form1.TXT_FACILITY_NO.value+\"&debtor_code=\"+document.Form1.TXT_DEBTOR_CODE.value+\"&type=LEGAL_LETTER_TO_DEBTOR\";");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"FA_CR_display_legal_letter_to_debtor';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("	help_box.innerHTML=\"Operation Process - Legal Letter to Debtor - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\"Operation Process - Legal Letter to Debtor \";"); 
			out.println("}"); 
	  	...
	  	out.println("					}");  
			...
			out.println(" 	m_sql = \"m_help_DIV_TXT_DEBTOR_LEGAL_LETTER_sql\";"); 
			...
			out.println(" 	m_sql = \"m_help_DIV_TXT_DEBTOR_CODE_LEGAL_LETTER_sql\";"); 
			...
			out.println("	m_url = \""+m_class_url+"/"+m_fschema_name+"FA_OP_Legal_Letter_to_debtor?chksql=main_page&client_no=\"+document.Form1.TXT_CLIENT_CODE.value+\"&print=TRUE&facility_no=\"+document.Form1.TXT_FACILITY_NO.value+\"&debtor_code=\"+document.Form1.TXT_DEBTOR_CODE.value;"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Operation Process - Legal Letter to Debtor </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
