/*
	* 	created based on LAKDL_AF_MAS_display_client_creation
	* 	2019-03-18
	*	Inesh
	*	JB15032019-07215
*/
...
public class LAKDL_AF_MAS_display_client_creation_cms extends HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
            ...
            */
			...
			out.println("			    disable_client_save_buttons(); "); // added by udara 11-06-2024
			out.println("			}");
    ...
    out.println("'</TR></table>';");
      ...
      */
			...
			out.println(submit.before_submit(m_class_url,m_fschema_name,m_screen,m_save_close,m_APP_NO,m_no_of_rec,"CMS"));
			out.println(" ");
			...
			out.println("		}");
			out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_MAS_save_client_creation_temp_cms?countemp='+lineno+'"+
			...
			//out.println("window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MAS_display_client_creation?save_close="+m_save_close+"';"); // commented by udara 18-09-2014
			out.println("window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MAS_display_client_creation_cms?save_close="+m_save_close+"'+'&app_screen="+m_app_screen+"';"); // added by udara 18-09-2014
	...
	*/
		...
		*/
			...
			if(m_app_screen.equals("Y")){
				out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' style='display:none;' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Edit\");' name=\"edit\"  onClick='load_screen_status(\"EDIT\")' value=\"Edit\" Disabled ></td>"); 
			}
			else{
				out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' style='display:none;' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Edit\");' name=\"edit\"  onClick='load_screen_status(\"EDIT\")' value=\"Edit\"></td>"); 
			}
			// end by udara 27-08-2014
			...
			out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' style='display:none;' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Deactivate\");' name=\"dact\" onClick='load_screen_status(\"DACT\")' value=\"De-activate\" Disabled ></td>"); // added Disabled by udara 15-09-2014 
			out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' style='display:none;' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Reactivate\");' name=\"ract\" onClick='load_screen_status(\"RACT\")' value=\"Re-activate\" Disabled ></td>"); // added Disabled by udara 15-09-2014 
			out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' style='display:none;' name=\"temp\"  onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Temporary\");' onClick='load_screen_status(\"TEMP\")' value=\"Temp\"></td>");  
			out.println("<td width='6%'></td>");  
			
			out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' style='display:none;' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Temporary Save\");' name=\"temp_save\"  onClick='save_window_temp()' value=\"Temp Save\"></td>");  
			out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' style='display:none;' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Help\");' name=\"help\" onClick='load_screen_status(\"HELP\")' value=\"Help\"></td>");  
			...
			out.println("<input  class='but_input' style='display:none;' type='button' name='BUT_HELP_MAIN' value=\"...\" onClick=\"help_client_code_validate()\" disabled>");  //help_update()
			out.println("<input  class='but_input1' style='display:none;' type='button' name='BUT_HELP_TEMP' value=\"Temp Help\" onClick=\"help_client_code_validate_temp()\" size='10' disabled></td>");  //help_update_temp() comment by nuwan de silva 08-08-07
			...
			// added by udara 27-08-2014
			if(m_app_screen.equals("Y")){
				out.println("<td width='10%' align='center'><input type=\"button\" style='display:none;' class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Edit\");' name=\"edit2\"  onClick='load_screen_status(\"EDIT\")' value=\"Edit\" Disabled ></td>"); 
			}
			else{
				out.println("<td width='10%' align='center'><input type=\"button\" style='display:none;' class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Edit\");' name=\"edit2\"  onClick='load_screen_status(\"EDIT\")' value=\"Edit\"></td>"); 
			}
			// end by udara 27-08-2014
			...
			out.println("<td width='10%' align='center'><input type=\"button\" style='display:none;' class='mainbut' name=\"dact2\" onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Deactivate\");'  onClick='load_screen_status(\"DACT\")' value=\"De-activate\" Disabled ></td>"); // added Disabled by udara 15-09-2014
			out.println("<td width='10%' align='center'><input type=\"button\" style='display:none;' class='mainbut' name=\"ract2\" onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Reactivate\");'  onClick='load_screen_status(\"RACT\")' value=\"Re-activate\" Disabled ></td>"); // added Disabled by udara 15-09-2014  
			out.println("<td width='10%' align='center'><input type=\"button\" style='display:none;' class='mainbut' name=\"temp2\"  onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Temporary\");' onClick='load_screen_status(\"TEMP\")' value=\"Temp\" disabled ></td>");  // added Disabled by udara 01-02-2018
			out.println("<td width='6%'></td>");  
			
			out.println("<td width='10%' align='center'><input type=\"button\" style='display:none;' class='mainbut' name=\"temp_save2\" onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Temporary Save\");'   onClick='save_window_temp()' value=\"Temp Save\" disabled ></td>");  // added Disabled by udara 01-02-2018
			out.println("<td width='10%' align='center'><input type=\"button\" style='display:none;' class='mainbut' name=\"help2\" onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Help\");'  onClick='load_screen_status(\"HELP\")' value=\"Help\"></td>");  
