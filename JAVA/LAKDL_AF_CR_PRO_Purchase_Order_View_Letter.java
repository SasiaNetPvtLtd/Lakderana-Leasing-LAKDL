...
public class LAKDL_AF_CR_PRO_Purchase_Order_View_Letter extends javax.servlet.http.HttpServlet {
   ...
   //   String m_username 						= "AA";//m_sn_methods.username;
      ...
      out.println("			}");
		...
		//	out.println("m_user=\"TXT_USER\"+row_No");
			...
			out.println("    HelpBox('1','10','0',Crit,'m_help_TXT_PURCHASE_ORDER_NO','1');"); 
			out.println("}"); 
			out.println(""); 
		...
		//--------------------------------------------------------------------------		
			...
			*/
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_CR_PRO_Purchase_Order_View_Letter';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("help_box.innerHTML=\" Credit Process - Purchase Order Copy - \"+m_val;"); 
			...
			out.println("help_box.innerHTML=\" Credit Process - Purchase Order Copy - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
		...
		//	out.println("document.Form1.BUT_HELP_MAIN.disabled=true;}"); 
			...
			out.println(" m_url = \""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_PRO_Delivery_Order?chksql=main_page&pur_ord_no=\"+document.Form1.TXT_PUR_ORD_NO.value+\"&application_no=\"+m_app_no+\"&document_code=HP_DELOD&print=TRUE&client_code=\"+m_client_code+\"&vendor_code=\"+m_ven_code+\"&branch_code=\"+m_branch_code;	");				
			out.println("}else{");
      ...
      out.println("</Script>");
			    ...
			    out.println("<INPUT TYPE='Hidden' NAME='hid_no_rec' VALUE=\"\">"); 
					...
					out.println("</tr>"); 
					out.println("<tr>"); 
					out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Credit Process - Purchase Order Copy</td>"); 
					out.println("</tr>"); 
					out.println("<tr>"); 
			...
			//		out.println("<tr><td width='10%' align='center'><input type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"New\");' onclick='load_screen_status(\"NEW\")' value=\"New\"></td>");  
			  ...
			  //  out.println("<td width='30%' >Purchase Order No</td>"); 
					...
					out.println("<td width='*%' ><input class='txt_input' type='text' name='TXT_PUR_ORD_NO' maxlength='15' size='15'>"); 
			    out.println("<input class='but_input' type='button' name='BUT_TXT_PUR_ORD_NO' value=\"Help\" onClick=\"help_pur_no()\">"); 
					out.println("<input class='but_input' type='button' name='BUT_BCODE' value=\"View Purchase/Delivery Order\" onClick=\"letter()\" style='{cursor:hand;width:150px;}'></td>"); 
					out.println("</tr>"); 
          out.println("</table>");          
