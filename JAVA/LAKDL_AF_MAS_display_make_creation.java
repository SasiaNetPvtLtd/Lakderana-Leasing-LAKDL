//--
//SCREEN NAME	:SYSTEM ADMINISTRATION - MAKE 
//ID					:1.40 Make Creation Process 
//CREATED BY	:N.V.P.Chandana
//DATE/TIME		:24-07-2006/3.13pm
//NOTES				:
...
public class LAKDL_AF_MAS_display_make_creation extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>System Administration - Make Creation</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("			}");
			out.println("    else if(data_vec.length > 0 && document.Form1.SCREEN_NAME.value!=\"NEW\"&& document.Form1.TXT_MAKE_CODE.value !=''&& document.Form1.hid_help_status.value =='H9' ){");
      out.println("    assign_data(data_vec);");
      out.println("   }");
			out.println("    else if(data_vec.length > 0 && document.Form1.SCREEN_NAME.value==\"EDIT\"&& document.Form1.TXT_MAKE_CODE.value !=''&& document.Form1.hid_help_status.value =='D1' ){");
      out.println("    assign_data(data_vec);");
      out.println("   }");
      out.println("    else if(data_vec.length == 0 && document.Form1.SCREEN_NAME.value!=\"NEW\"&& document.Form1.TXT_MAKE_CODE.value !=''&& document.Form1.hid_help_status.value =='H9' ){");
			out.println("   help_update();");
		  out.println("   }");
			out.println("    else if(data_vec.length == 0 && document.Form1.hid_help_status.value =='H1'&& document.Form1.TXT_SUB_CAT_CODE.value !='' ){");
			out.println("   help_button_1();");
		  out.println("   }");		
			out.println("			else");
			out.println("			if(data_vec.length>0  && document.Form1.TXT_MAKE_DESC.value!=\"\" && document.Form1.hid_help_status.value=='H2' && document.Form1.SCREEN_NAME.value==\"NEW\" ){");
			out.println("				alert('Record already exists');");
			...
			out.println("    m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_make_creation_code&data_val=\"+obj.value;");
			out.println("}");
			out.println("    else");
      ...
      out.println("    m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_make_creation&data_val=\"+obj.value+\"&ac_status=N\";");
     	out.println("    else");
      ...
      out.println("    m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations1?chksql=m_prime_chk_LAKDL_AF_MAS_display_make_creation_desc&data_val=\"+obj.value;");
		  out.println("    else");
      out.println("    if(document.Form1.hid_help_status.value=='D1')");
      out.println("    m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_make_creation_p&data_val=\"+obj.value+\"&ac_status=P\";");
			...
			out.println("}"); 
			out.println("else if(document.Form1.TXT_MAKE_DESC.value==\"\"){  "); 
			out.println("DIV_TXT_MAKE_DESC.style.color='red';");
			out.println("return false;"); 
			out.println("}"); 
			out.println("else{"); 
			...
			out.println("		}");
			out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_MAS_save_make_creation';");  
			...
			out.println("    document.Form1.TXT_MAKE_CODE.value=data_vec[0]; ");
			out.println("    document.Form1.TXT_MAKE_DESC.value=data_vec[1]; ");
			...
			out.println("document.Form1.TXT_MAKE_CODE.value='"+m_code+"'");

			out.println("document.Form1.SCREEN_NAME.value='EDIT';"); 
			out.println("document.Form1.BUT_HELP_MAIN.disabled=false"); 
			out.println("assign_help_status('D1')");
			out.println("makeRequest(document.Form1.TXT_MAKE_CODE)");
			out.println("}"); 
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MAS_display_make_creation';"); 
			out.println("		}"); 
			out.println("}"); 

			out.println("function new_window(){	"); 
			out.println("if(document.Form1.hid_close_status.value=='Y'){");			
			out.println("window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MAS_display_make_creation?CLSTATUS=B';"); 
			out.println("}else {"); 			
			out.println("window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MAS_display_make_creation';"); 
			out.println("}"); 
			out.println("}"); 
			...
			out.println("    m_help_message = \"m_help_msg_LAKDL_AF_MAS_display_make_creation\";"); 
      ...
      out.println("}");
			...
			out.println("help_box.innerHTML=\" System Administration - Make Creation - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" System Administration - Make Creation - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
			...
			out.println("document.Form1.BUT_HELP_MAIN.disabled=false;"); 
			out.println("document.Form1.TXT_MAKE_DESC.disabled=true;");
	  	...
	  	out.println("		}"); 
			out.println("	}"); 
			/*out.println("	else{"); 
			out.println("		Next(oBj.valout[2],oBj.valout[3],oBj.valout[4],Hid_No);"); 
			out.println("		return false;"); 
			out.println("	} "); 
			out.println("	}"); 
			out.println("	else{	"); 
			out.println("	Prev(oBj.valout[2],oBj.valout[3],oBj.valout[4],Hid_No);"); 
			out.println("	}	"); 
			out.println("	}		"); 
			*/
			//added by nuwan de silva 28-06-07---------------------
			out.println("	else{"); 
	  	...
	  	out.println("		}"); 
			...
			out.println("		if(document.Form1.hid_help_type.value==\"2\"){"); 
			out.println("document.Form1.TXT_MAKE_DESC.value='';"); 
			out.println("document.Form1.TXT_MAKE_DESC.focus();"); 
	  	out.println("		}"); 
      ...
      out.println("function Prev(Start,End,Hid_No){"); 
			...
			out.println("    } ");
			out.println("    else{");
			out.println("    m_criteria = document.Form1.TXT_MAKE_CODE.value+\"@\"+\"N@\";}"); 
			out.println("    HelpBox('1','10','1');"); 
			out.println("}");
			out.println(" if('"+m_close_status+"'=='A'){");
			out.println("    if(document.Form1.SCREEN_NAME.value==\"EDIT\" || document.Form1.SCREEN_NAME.value==\"DACT\"){ ");
			out.println("    m_criteria = document.Form1.TXT_MAKE_CODE.value+\"@\"+\"P@\";"); 
			out.println("    } ");
			out.println("    else{");
			out.println("    m_criteria = document.Form1.TXT_MAKE_CODE.value+\"@\"+\"N@\";}"); 
			out.println("    HelpBox('1','10','1');"); 
			...
			out.println("    m_sql = \"m_help_TXT_MAKE_DESC_sql\";"); 
			
			out.println("    m_criteria = document.Form1.TXT_MAKE_DESC.value+\"@\"+\"Y@\";"); 
			out.println("    HelpBox('1','10','0');"); 
			out.println("}"); 
	  ...
	  //	out.println("		}"); 
			...
			out.println("    m_sql = \"m_view_TXT_MAKE_CODE_sql\";");
			out.println("    m_criteria = document.Form1.TXT_MAKE_CODE.value+\"@\"+\"Y@\";"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>System Administration - Make Creation</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
		...
		//	out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Close\");'  onclick='close_window()' value=\"Close\"></td>");  
			...
			out.println("<td width='30%' ><DIV id='DIV_TXT_MAKE_CODE'  class=div_input>Make Code *</td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_MAKE_CODE' maxlength='10' size='10' onblur=\"assign_help_status('H9'),makeRequest(document.Form1.TXT_MAKE_CODE)\">"); 
			...
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_MAKE_DESC' maxlength='50' size='50' onblur=\"assign_help_status('H2'),makeRequest(document.Form1.TXT_MAKE_DESC)\"></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
