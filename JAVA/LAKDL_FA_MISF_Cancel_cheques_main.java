// DEVELOP BY : ASHINI FOR OFSCL FACTORING    DATE:04-03-2008
// CANCEL PD CHEQUE REPORT            
...
public class LAKDL_FA_MISF_Cancel_cheques_main extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Cancel PD Cheques send to client Report</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("function show_cancel_pd_cheque_report() {");
			out.println(" 	m_from_dd = document.Form1.TXT_FROM_DATE_DD.value ");
			out.println(" 	m_from_mm = document.Form1.TXT_FROM_DATE_MM.value ");
			out.println("		m_from_yy = document.Form1.TXT_FROM_DATE_YY.value ");
			...
			//out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"FA_MISF_cancel_pd_cheque_reports?chksql=LOAD_ALL_POD_REPORT&from_date=\"+m_from_date+\"&to_date=\"+m_to_date;");
			out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"FA_MISF_cancel_pd_cheque_reports?chksql=LOAD_ALL_POD_REPORT&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&facility_no=\"+document.Form1.TXT_FACILITY_NO.value+\"&client_code=\"+document.Form1.TXT_CLIENT_CODE.value;");
			out.println("}");
			out.println("else{");
			out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"FA_MISF_cancel_pd_cheque_reports?chksql=LOAD_POD_REPORT&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&facility_no=\"+document.Form1.TXT_FACILITY_NO.value+\"&client_code=\"+document.Form1.TXT_CLIENT_CODE.value;");
			out.println("   }");
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"FA_MISF_Cancel_cheques_main';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("	help_box.innerHTML=\" Cancel PD Cheques send to client Report - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\" Cancel PD Cheques send to client Report \";"); 
			out.println("}"); 
	  	...
	  	out.println("					}"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Cancel PD Cheques send to client Report</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<table class='table' width='100%'  >"); 
			out.println("<tr >");
			out.println("<td width='*%'><input class='but_input' type='button' name='BUT_VIEW_MAIN' value=\"View\" onClick=\"show_cancel_pd_cheque_report()\">"); 
			out.println("</td>"); 
			out.println("</tr>");
			out.println("</table>");  
			out.println("</form>"); 
