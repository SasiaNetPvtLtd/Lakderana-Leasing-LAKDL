...
public class LAKDL_AF_CR_PRO_Enter_Seizer_details_letter extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			if(m_chksql.equals("main_page")){
					out.println("<HTML>"); 
					out.println("<HEAD>"); 
					out.println("<TITLE>Seizer Letter Approval </TITLE>"); 
					out.println("</HEAD>"); 
					...
					out.println("      m_url=\""+m_class_url+"/"+m_fschema_name+"AF_CR_PRO_Enter_Seizer_details_letter?chksql=details&status=\"+document.Form1.hid_status.value+\"&APPLICATION_NO=\"+document.Form1.TXT_APP_NO.value;"); 
					...
					out.println("			window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_CR_PRO_Enter_Seizer_details_letter?chksql=main_page';"); 
					out.println("		}"); 
					out.println("}"); 
					...
					out.println("   help_box.innerHTML=\" Seizer Letter Approval  - \"+m_val;"); 
					out.println("}"); 
					out.println(""); 

					out.println("function load_roll_out_value(){");
					out.println("help_box.innerHTML=\" Seizer Letter Approval  - \"+document.Form1.hid_status.value;"); 
					out.println("}"); 
				  ...
				  out.println("document.Form1.TXT_VALUE_DATE_YY.disabled=true;");
					...
					out.println("    m_sql = \"m_help_TXT_SIEZER_CODE_LOAD_LETTER\";");
				  ...
				  out.println("count=count+1;");
					...
					//out.println("		if(validate_data()){");	
					out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_CR_PRO_Enter_Seizer_details_letter_save';");  
				...
				out.println("}");	
					...
					out.println("</tr>"); 
					out.println("<tr>"); 
					out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Seizer Letter Approval </td>"); 
					out.println("</tr>"); 
					out.println("<tr>"); 
					...
					rs=stmt.executeQuery(" "+ 								
									" SELECT "+
										...
										" (SELECT ADDRESS1 FROM "+m_schema_name+".AF_CO_MAS_SEIZER WHERE SEIZER_CODE = A.SEIZER_CODE) || ', ' || (SELECT ADDRESS2 FROM "+m_schema_name+".AF_CO_MAS_SEIZER WHERE SEIZER_CODE = A.SEIZER_CODE) ADDRESS, "+ // 6
										" (SELECT TEL_NO FROM "+m_schema_name+".AF_CO_MAS_SEIZER WHERE SEIZER_CODE = A.SEIZER_CODE) TEL_NO, "+      // 7
										" (SELECT MOBILE_NO FROM "+m_schema_name+".AF_CO_MAS_SEIZER WHERE SEIZER_CODE = A.SEIZER_CODE) MOBILE_NO "+ // 8
										  " FROM "+m_schema_name+".AF_CO_MAS_SEIZER_DETAILS A, "+m_schema_name+".AF_CO_PRO_APPLICATION_DETAILS B "+
										  " WHERE  A.APPLICATION_NO = B.APPLICATION_NO "+
										  " AND (A.APPLICATION_NO LIKE '%"+m_app_no+"%' OR A.SEIZER_CODE LIKE '%"+m_app_no+"%' OR UPPER("+m_schema_name+".AF_CO_GET_SEIZER_NAME(A.SEIZER_CODE)) LIKE UPPER('%"+m_app_no+"%'))   "+
				...
				out.println("<td  width='10%' > <input type='hidden' name='HID_APP_NO_"+j+"'    id='HID_APP_NO_"+j+"'    value ='"+rs.getString(1)+"' > "+rs.getString(1)+" </td>"); 
				out.println("<td  width='10%' > <input type='hidden' name='HID_FIN_NO_"+j+"'    id='HID_FIN_NO_"+j+"'    value ='"+rs.getString(2)+"' > "+rs.getString(2)+" </td>");
				out.println("<td  width='10%' > <input type='hidden' name='HID_CLI_NO_"+j+"'    id='HID_CLI_NO_"+j+"'    value ='"+rs.getString(3)+"' > "+rs.getString(3)+" </td>");
