...
public class LAKDL_AF_RE_BULK_sql_validations extends javax.servlet.http.HttpServlet {
	...
	*/
	...
	public  void service(HttpServletRequest req, HttpServletResponse res)	throws IOException	{
		...
		try {
			...
			//added by nuwan de silva on 19-09-07------------------------
			...
			else if(m_chksql.trim().equals("LOAD_TERMINATION_LETTER_BULK")){
				String m_finance_no = req.getParameter("finance_no");
				String m_letter_category = req.getParameter("letter_cat");
				...
				while(rs1.next()) {
					out.print("<row id='"+ i +"'>"); 
					//out.print("<cell><![CDATA["+i+"]]></cell>");//FINANCE_NO
					out.print("<cell><![CDATA["+rs1.getString(1)+"]]></cell>");//FINANCE_NO
					out.print("<cell><![CDATA["+rs1.getString(3)+"]]></cell>");//CLIENT_NAME
					out.print("<cell><![CDATA["+rs1.getString(8)+"]]></cell>");//STATEMENT_DATE
			        out.print("<cell><![CDATA["+rs1.getString(5)+"]]></cell>");//AGE
					out.print("<cell><![CDATA["+nf.format(rs1.getDouble(4))+"]]></cell>");//TOTAL_ARREARS
					out.print("<cell><![CDATA["+nf.format(rs1.getDouble(7))+"]]></cell>");//RENTAL_AMOUNT
					out.print("<cell><![CDATA[]]></cell>");//PRINT
					out.print("<cell><![CDATA[]]></cell>");//CANCEL
					out.print("<cell><![CDATA["+rs1.getString(8)+"]]></cell>");//AGE
					out.print("</row>");
					i++;
				}
				out.print("</rows>");
			...
			else if(m_chksql.trim().equals("LOAD_TERMINATION_LETTER")){
				String m_finance_no = req.getParameter("finance_no");
				String m_letter_category = req.getParameter("letter_cat");
				String m_client_code = req.getParameter("client_code");
				String m_row = req.getParameter("row");
			...
			/*	query = " SELECT A.FINANCE_NO, "+
			  ...
			  query = " SELECT A.FINANCE_NO, "+
				...
				while(rs1.next()) {
					...
					out.print("<cell><![CDATA["+rs1.getString(3)+"]]></cell>");//CLIENT_NAME
					out.print("<cell><![CDATA["+nf.format(rs1.getDouble(4))+"]]></cell>");//TOTAL_ARREARS
					out.print("<cell><![CDATA["+nf.format(rs1.getDouble(5))+"]]></cell>");//AGE
					out.print("<cell><![CDATA["+nf.format(rs1.getDouble(7))+"]]></cell>");//RENTAL_AMOUNT
					out.print("<cell><![CDATA[]]></cell>");//PRINT
					//out.print("<cell><![CDATA[]]></cell>");//CANCEL
					out.print("</row>");
