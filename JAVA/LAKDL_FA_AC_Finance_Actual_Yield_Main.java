// DEVELOP BY : ASHINI FOR OFSCL FACTORING    DATE:01-01-2007
...
public class LAKDL_FA_AC_Finance_Actual_Yield_Main extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Operation Process - Factoring Actual Yield </TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"FA_AC_Finance_Actual_Yield_Main';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("	help_box.innerHTML=\"  Operation Process - Factoring Actual Yield - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\"  Operation Process - Factoring Actual Yield - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
	  	...
	  	out.println("					}"); 
			...
			out.println("function view_report2(){");
			...
			out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"FA_AC_Finance_Actual_Yield_Rpt_New?chksql=LOAD_YIELD_ALL&m_rpt_st_date=\"+m_rpt_st_date+\"&m_rpt_end_date=\"+m_rpt_end_date+\"&CLIENT_CODE=\"+document.Form1.TXT_CLIENT_CODE.value+\"&FACILITY_NO=\"+document.Form1.TXT_FACILITY_NO.value;");	
			...
			out.println("		m_rpt_st_date=document.Form1.TXT_ST_DD.value+'-'+document.Form1.TXT_ST_MM.value+'-'+document.Form1.TXT_ST_YY.value;");
			out.println("		m_rpt_end_date=document.Form1.TXT_END_DD.value+'-'+document.Form1.TXT_END_MM.value+'-'+document.Form1.TXT_END_YY.value;");
			out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"FA_AC_Finance_Actual_Yield_Rpt?chksql=LOAD_YIELD&m_rpt_st_date=\"+m_rpt_st_date+\"&m_rpt_end_date=\"+m_rpt_end_date+\"&CLIENT_CODE=\"+document.Form1.TXT_CLIENT_CODE.value+\"&FACILITY_NO=\"+document.Form1.TXT_FACILITY_NO.value;");	
			//out.println("		window.open(m_url);");
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Operation Process - Factoring Actual Yield </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("</tr>");
			out.println("<tr >");
			//Modified by Disnaka Jayasuriya on 2009-12-14 for date validation
			out.println("<td width=\"15%\"><DIV id=\"DIV_TXT_INVOICE_START\" class=div_input>Start Date *</DIV></td>");
			out.println("<td width=\"40%\"><input class=\"txt_input5\" type=\"text\" name=\"TXT_ST_DD\" maxlength=\"2\" size=\"2\"  value=\""+m_dd+"\" onblur=\"checkMonthLength(document.Form1.TXT_ST_DD,document.Form1.TXT_ST_MM,document.Form1.TXT_ST_YY)\" tabindex=\"1\">");
			out.println("<input class=\"txt_input5\" type=\"text\" name=\"TXT_ST_MM\" maxlength=\"2\" size=\"2\" value=\""+m_mm+"\" onblur=\"checkMonthLength(document.Form1.TXT_ST_DD,document.Form1.TXT_ST_MM,document.Form1.TXT_ST_YY)\" tabindex=\"2\">");
			...
			out.println("<td width=\"40%\"><input class=\"txt_input5\" type=\"text\" name=\"TXT_END_DD\" maxlength=\"2\" size=\"2\"  value=\""+m_dd+"\" onblur=\"checkMonthLength(document.Form1.TXT_END_DD,document.Form1.TXT_END_MM,document.Form1.TXT_END_YY)\" tabindex=\"4\">");
			out.println("<input class=\"txt_input5\" type=\"text\" name=\"TXT_END_MM\" maxlength=\"2\" size=\"2\" value=\""+m_mm+"\" onblur=\"checkMonthLength(document.Form1.TXT_END_DD,document.Form1.TXT_END_MM,document.Form1.TXT_END_YY)\" tabindex=\"5\">");
			...
			out.println("<input class='but_input' type='button' name='BUT_HELP_MAIN_RPT' value=\"View Report All\" onClick=\"view_report2()\" style='width:100'></td>");
			out.println("</tr>");
