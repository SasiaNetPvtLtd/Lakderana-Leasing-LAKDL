	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)	throws IOException	{
        ...
        /*
				...
				*/
				...
				out.println("<td width='10%' ><DIV class=div_input><b>Code</b></DIV></td>");
				out.println("<td width='20%' ><DIV class=div_input><b>Name</b></DIV></td>");
				out.println("<td width='10%' ><DIV class=div_input><b>Client Manager</b></DIV></td>"); 
				out.println("<td width='10%' ><DIV class=div_input><b>Mkt. Executive</b></DIV></td>"); 
				out.println("<td width='10%' ><DIV class=div_input><b>Coll. Officer</b></DIV></td>"); 
				out.println("<td width='10%' ><DIV class=div_input><b>Coll. Route</b></DIV></td>"); 
				out.println("<td width='15%' ><DIV class=div_input><b>Reasons</b></DIV></td>"); 
				out.println("<td width='10%' ><DIV class=div_input><b>Action</b></DIV></td>"); 
				...
				*/
				while(rs1.next()){
					...
					out.println("<td width='10%' class=div_input  onClick=\"show_client('"+rs1.getString(1)+"')\" style='cursor:hand'><INPUT TYPE='HIDDEN' class='txt_input' NAME='TXT_CLIENT_CODE_"+chk_nums+"' VALUE=\""+rs1.getString(1)+"\"><U>"+rs1.getString(1)+"</U></td>");
					out.println("<td width='20%' class=div_input>"+rs1.getString(2)+"</td>");
					out.println("<td width='10%' class=div_input><INPUT TYPE='TEXT' class='txt_input' NAME='TXT_CLIENT_MGR_"+chk_nums+"' VALUE=\""+rs1.getString(5)+"\" maxlength=\"10\" style='width:50'><input class=\"but_input\" type=\"button\" name=\"BUT_CLIENT_DETAIL\" value=\"Help\" onClick=\"HELP_CLIENT_MGR('"+chk_nums+"')\"></td>");
					out.println("<td width='10%' class=div_input><INPUT TYPE='TEXT' class='txt_input' NAME='TXT_CLIENT_MKT_"+chk_nums+"' VALUE=\""+rs1.getString(6)+"\" maxlength=\"10\" style='width:50'><input class=\"but_input\" type=\"button\" name=\"BUT_CLIENT_DETAIL\" value=\"Help\" onClick=\"HELP_CLIENT_MKT('"+chk_nums+"')\"></td>");
					out.println("<td width='10%' class=div_input><INPUT TYPE='TEXT' class='txt_input' NAME='TXT_CLIENT_CMGR_"+chk_nums+"' VALUE=\""+rs1.getString(8)+"\" maxlength=\"10\" style='width:50'><input class=\"but_input\" type=\"button\" name=\"BUT_CLIENT_DETAIL\" value=\"Help\" onClick=\"HELP_CLIENT_COFF('"+chk_nums+"')\"></td>");
					out.println("<td width='10%' class=div_input><INPUT TYPE='TEXT' class='txt_input' NAME='TXT_CLIENT_ROUTE_"+chk_nums+"' VALUE=\""+rs1.getString(9)+"\" maxlength=\"10\" style='width:50'><input class=\"but_input\" type=\"button\" name=\"BUT_CLIENT_DETAIL\" value=\"Help\" onClick=\"HELP_CLIENT_ROUTE('"+chk_nums+"')\"></td>");
					out.println("<td width='15%' class=div_input>"+rs1.getString(7)+"</td>"); 
					out.println("<td width='10%' class=div_input><select name='TXT_APPROVE_TYPE_"+chk_nums+"' class='txt_input'><OPTION value=\"A\">Approve</option><OPTION value=\"D\">Disapprove</option><OPTION value=\"F\">Follow-up</option><OPTION value=\"O\" SELECTED>No Action</option></SELECT></td>");
					out.println("<td width='15%' class=div_input><INPUT TYPE='TEXT' class='txt_input' NAME='TXT_APPROVE_COMMENT_"+chk_nums+"' VALUE=\"\" maxlength=\"200\"></td>"); 
					out.println("</tr>");
					chk_nums++;
				}
				...
				String m_grade="";
					...
					" SELECT DISTINCT A.FACILITY_NO, "+
					" A.CLIENT_CODE,"+
					" "+m_schema_name+".FA_GET_CLIENT_FULL_NAME(A.CLIENT_CODE),"+
					" "+m_schema_name+".FA_GET_CLIENT_MANAGER(A.FACILITY_MGR_CODE,'O','O'),"+
					" "+m_schema_name+".FA_GET_PRODUCT_PACK_NAME(A.FA_PRODUCT_CODE),"+
					" "+m_schema_name+".FA_GET_FEE_PACK_NAME(A.FEE_PACK_CODE), "+
					" CREDIT_LIMIT,"+
					" TO_CHAR(A.FACILITY_START_DATE,'DD-MM-YYYY'),"+
					" TO_CHAR(A.FACILITY_END_DATE,'DD-MM-YYYY')"+
					" FROM "+m_schema_name+".FA_CR_PRO_CLIENT_FACILITY A, "+
					"      "+m_schema_name+".FA_CR_PRO_CRSCORE B "+
					" WHERE A.FACILITY_STATUS='N' "+
					" AND A.CLIENT_CODE = B.CLIENT_CODE "+
					" AND B.APP_STATUS = 'CONF' "+
				...
				m_string=m_string+"<td width='10%' align='right'><b>Score</td>";//Added by SJ on 25-11-2008
				m_string=m_string+"<td width='15%' align='left'><B>Grade</td>";//
				...
				m_string=m_string+"<td width='8%' ><DIV class=div_input><b>Credit Score</b></DIV></td>";				
				m_string=m_string+"</tr>";
				int chk_nums=0;
				...
				while(rs1.next()){
					...
					rs4 = stmt4.executeQuery ("  SELECT "+
												            ...
												            "  FROM "+m_schema_name+".FA_CR_PRO_CRSCORE_DBT_DETAIL A "+
															      " WHERE A.CLIENT_CODE = '"+rs1.getString(2)+"' ");
				  ...
				  rs5 = stmt2.executeQuery (" SELECT "+
					...
					rs6 = stmt3.executeQuery (" SELECT  "+
																		...
																		" WHERE CLIENT_CODE = '"+rs1.getString(2)+"' "); 
					...
					m_string=m_string+"<td width='10%' class=div_input align=\"right\" >"+nf.format(m_tot)+"%</td>";
					m_string=m_string+"<td width='15%' class=div_input align=\"left\" >"+m_grade+"</td>";
					...
					m_string=m_string+"<td width='20%' class=div_input><INPUT TYPE='TEXT' class='txt_input' NAME='TXT_APPROVE_COMMENT_"+chk_nums+"' VALUE=\"\"  style=\"width: 170px\" maxlength=\"200\">"; 
					...
					m_string=m_string+"<td width='8%' class=div_input><input class=\"but_input\" type=\"button\" onclick=\"display_data('"+rs1.getString(2)+"')\" name=\"BUT_CREDIT_SCR\" style=\"width:50\" value=\"View\"></td>"; 
					m_string=m_string+"</tr>";
					chk_nums++;
				}
				m_string=m_string+"<INPUT TYPE='HIDDEN' NAME='NUM_CHKS' VALUE="+chk_nums+">";
				...
				String m_string="";				
				  ...
				  " "+m_schema_name+".FA_DEBTOR_DOCUMENT_STATUS(CLIENT_CODE,FACILITY_NO,DEBTOR_CODE,'D003'),"+//9
					" "+m_schema_name+".FA_DEBTOR_COLLECT_STATUS(CLIENT_CODE,FACILITY_NO,DEBTOR_CODE), "+//10---- Y=coll by orient
					" "+m_schema_name+".FA_DEBTOR_PD_UPFORNT_STATUS(CLIENT_CODE,FACILITY_NO,DEBTOR_CODE) "+//11---Y=pod 100% ok
					" FROM "+m_schema_name+".FA_CR_PRO_CLIENT_DEBTOR "+
				...
				out.println("<td width='15%' ><DIV class=div_input><b>Name</b></DIV></td>");
				out.println("<td width='10%' ><DIV class=div_input><b>Debtor Code</b></DIV></td>"); 
				out.println("<td width='15%' ><DIV class=div_input><b>Name</b></DIV></td>"); 
				out.println("<td width='15%' align='right' ><DIV class=div_input><b>Debtor Credit Limit</b></DIV></td>"); 
				...
				out.println("<td width='10%' ><DIV class=div_input><b>Collect by Company</b></DIV></td>");
				out.println("<td width='10%' ><DIV class=div_input><b>PD upfornt</b></DIV></td>");
				out.println("<td width='10%' ><DIV class=div_input><b>Accepted Assignment Letter Status</b></DIV></td>");
				out.println("<td width='10%' ><DIV class=div_input><b>New Debtor Credit Limit</b></DIV></td>");
				...
				while(rs1.next()){
					...
					//out.println("<td width='1%'></td>"); 
					out.println("<td width='10%' class=div_input   onClick=\"show_facility('"+rs1.getString(1)+"')\"  style='cursor:hand'><INPUT TYPE='HIDDEN' class='txt_input' NAME='TXT_FACILITY_NO_"+chk_nums+"' VALUE=\""+rs1.getString(1)+"\"><u>"+rs1.getString(1)+"</u></td>");
					out.println("<td width='10%' class=div_input  onClick=\"show_client('"+rs1.getString(2)+"')\"  style='cursor:hand'><INPUT TYPE='HIDDEN' class='txt_input' NAME='TXT_CLIENT_CODE_"+chk_nums+"' VALUE=\""+rs1.getString(2)+"\"><u>"+rs1.getString(2)+"</u></td>");
					out.println("<td width='15%' class=div_input>"+rs1.getString(3)+"</td>");
					out.println("<td width='10%' class=div_input  onClick=\"show_client('"+rs1.getString(4)+"')\"  style='cursor:hand'><INPUT TYPE='HIDDEN' class='txt_input' NAME='TXT_DEBTOR_CODE_"+chk_nums+"' VALUE=\""+rs1.getString(4)+"\"><u>"+rs1.getString(4)+"</u></td>");
					...
					out.println("<td width='10%' class=div_input align='center' >"+rs1.getString(7)+"</td>");
					out.println("<td width='10%' class=div_input align='center' >"+rs1.getString(8)+"</td>");
					out.println("<td width='10%' class=div_input align='center' >"+rs1.getString(9)+"</td>");
					out.println("<td width='10%' class=div_input align='center' >"+rs1.getString(10)+"</td>");
					out.println("<td width='10%' class=div_input align='center' >"+rs1.getString(11)+"</td>");
					if(rs1.getString(9).equals("Y")){
						out.println("<td width='10%' class=div_input align='center' ><input type=\"checkbox\" name=\"TXT_STATUS_"+chk_nums+"\" checked disabled></td>");
					} 
					else{
						if(rs1.getString(7).equals("Y") && rs1.getString(8).equals("Y")){
						out.println("<td width='10%' class=div_input align='center' ><input type=\"checkbox\" name=\"TXT_STATUS_"+chk_nums+"\" onclick=\"enable_approval_box("+chk_nums+")\"></td>");
						}
						else{
						out.println("<td width='10%' class=div_input align='center' ><input type=\"checkbox\" name=\"TXT_STATUS_"+chk_nums+"\" onclick=\"enable_approval_box("+chk_nums+")\" disabled></td>");
						}
					}
					if(rs1.getString(7).equals("Y") && rs1.getString(8).equals("Y")){
						out.println("<td width='10%' class=div_input><INPUT TYPE='TEXT' class='txt_input' NAME='TXT_DEBTOR_LIMIT_"+chk_nums+"' VALUE=\""+nf.format(rs1.getDouble(6))+"\" style=\"width:100px\" maxlength=\"20\" onchange='format_number(document.Form1.TXT_DEBTOR_LIMIT_"+chk_nums+",20)'  style='{text-align:right;}'>"); // Modified by Thamali Jayatunga on 2009.10.20
						...
						out.println("<td width='10%' class=div_input><INPUT TYPE='TEXT' class='txt_input' NAME='TXT_DEBTOR_LIMIT_"+chk_nums+"' VALUE=\""+nf.format(rs1.getDouble(6))+"\" style=\"width:100px\" maxlength=\"20\" style='{text-align:right;}' disabled>"); 
						out.println("<td width='11%' class=div_input><select name='TXT_APPROVE_TYPE_"+chk_nums+"' class='txt_input' style=\"width: 90px\"><OPTION value=\"D\">Disapprove</option><OPTION value=\"F\">Follow-up</option><OPTION value=\"O\" SELECTED>No Action</option></SELECT></td>");
						//temp comment by ij 22-10-2007	
				 	}
				...
				m_string=m_string+"<td width='10%' ><DIV class=div_input><b>PD upfornt</b></DIV></td>";
				...
				while(rs1.next()){
					...
					m_string=m_string+"<td width='10%' class=div_input align='center' >"+rs1.getString(11)+"</td>";
					if(rs1.getString(9).equals("Y")){
					...
					if(rs1.getString(7).equals("Y") && rs1.getString(8).equals("Y")){
						...
						//temp comment by ij 22-10-2007	
						/*if(rs1.getString(10).equals("Y") && rs1.getString(11).equals("Y")){
							m_string=m_string+"<td width='10%' class=div_input><INPUT TYPE='TEXT' class='txt_input' NAME='TXT_DEBTOR_LIMIT_"+chk_nums+"' VALUE=\""+nf.format(rs1.getDouble(6))+"\" style=\"width:100px\" maxlength=\"20\" style='{text-align:right;}'>"; 
							m_string=m_string+"<td width='11%' class=div_input><select name='TXT_APPROVE_TYPE_"+chk_nums+"' class='txt_input' style=\"width: 90px\"><OPTION value=\"A\">Approve</option><OPTION value=\"D\">Disapprove</option><OPTION value=\"F\">Follow-up</option><OPTION value=\"O\" SELECTED>No Action</option></SELECT></td>";
						}
						else if(rs1.getString(10).equals("Y") && rs1.getString(11).equals("N")){
							m_string=m_string+"<td width='10%' class=div_input><INPUT TYPE='TEXT' class='txt_input' NAME='TXT_DEBTOR_LIMIT_"+chk_nums+"' VALUE=\""+nf.format(rs1.getDouble(6))+"\" style=\"width:100px\" maxlength=\"20\" style='{text-align:right;}' disabled>"; 
							m_string=m_string+"<td width='11%' class=div_input><select name='TXT_APPROVE_TYPE_"+chk_nums+"' class='txt_input' style=\"width: 90px\"><OPTION value=\"D\">Disapprove</option><OPTION value=\"F\">Follow-up</option><OPTION value=\"O\" SELECTED>No Action</option></SELECT></td>";
						}
						else if(rs1.getString(10).equals("N") && rs1.getString(11).equals("Y")){
							m_string=m_string+"<td width='10%' class=div_input><INPUT TYPE='TEXT' class='txt_input' NAME='TXT_DEBTOR_LIMIT_"+chk_nums+"' VALUE=\""+nf.format(rs1.getDouble(6))+"\" style=\"width:100px\" maxlength=\"20\" style='{text-align:right;}'>"; 
							m_string=m_string+"<td width='11%' class=div_input><select name='TXT_APPROVE_TYPE_"+chk_nums+"' class='txt_input' style=\"width: 90px\"><OPTION value=\"A\">Approve</option><OPTION value=\"D\">Disapprove</option><OPTION value=\"F\">Follow-up</option><OPTION value=\"O\" SELECTED>No Action</option></SELECT></td>";
						}
						else if(rs1.getString(10).equals("N") && rs1.getString(11).equals("N")){
							m_string=m_string+"<td width='10%' class=div_input><INPUT TYPE='TEXT' class='txt_input' NAME='TXT_DEBTOR_LIMIT_"+chk_nums+"' VALUE=\""+nf.format(rs1.getDouble(6))+"\" style=\"width:100px\" maxlength=\"20\" style='{text-align:right;}' disabled>"; 
							m_string=m_string+"<td width='11%' class=div_input><select name='TXT_APPROVE_TYPE_"+chk_nums+"' class='txt_input' style=\"width: 90px\"><OPTION value=\"D\">Disapprove</option><OPTION value=\"F\">Follow-up</option><OPTION value=\"O\" SELECTED>No Action</option></SELECT></td>";
						}* /
					}
				...
				*/
				...
				m_string=m_string+"<td width='10%' ><DIV class=div_input><b>Debtor Code</b></DIV></td>"; 
				m_string=m_string+"<td width='15%' ><DIV class=div_input><b>Name</b></DIV></td>"; 
				//m_string=m_string+"<td width='15%' align='right' ><DIV class=div_input><b>Debtor Credit Limit</b></DIV></td>"; // Commented this line by Udara Somathilake on 18-10-2010
				...
				while(rs1.next()){
					...
					m_string=m_string+"<td width='10%' class=div_input  onClick=\"show_client('"+rs1.getString(4)+"')\"  style='cursor:hand'><INPUT TYPE='HIDDEN' class='txt_input' NAME='TXT_DEBTOR_CODE_"+chk_nums+"' VALUE=\""+rs1.getString(4)+"\"><u>"+rs1.getString(4)+"</u></td>";
					m_string=m_string+"<td width='15%' class=div_input>"+rs1.getString(5)+"</td>";
					//m_string=m_string+"<td width='15%' class=div_input align='right' >"+nf.format(rs1.getDouble(6))+"</td>"; // Commented this line by Udara Somathilake on 18-10-2010
					m_string=m_string+"<td width='10%' class=div_input><select name='TXT_TYPE_"+chk_nums+"' class='txt_input' style=\"width: 90px\" ><OPTION value=\"B\" SELECTED>BLANK</option><OPTION value=\"P\">REGISTERED POST</option><OPTION value=\"H\">BY HAND</option></SELECT></td>";
					m_string=m_string+"<td width='20%' class=div_input>";
					//====Modified by Dineth on 2008-09-19
					//m_string=m_string+"<input class=\"but_input\" type=\"button\" onclick=\"Generate_Letter1('"+rs1.getString(2) +"','"+rs1.getString(4)+"','"+chk_nums+"')\" name=BUT_LETTER1 value=\"Letter 1\" >"; 
					//m_string=m_string+"<input class=\"but_input\" type=\"button\" onclick=\"Generate_Letter2('"+rs1.getString(2) +"','"+rs1.getString(4)+"','"+chk_nums+"')\" name=BUT_LETTER2 value=\"Letter 2\" >";
					//m_string=m_string+"<input class=\"but_input\" type=\"button\" onclick=\"Generate_Letter3('"+rs1.getString(2) +"','"+rs1.getString(4)+"','"+chk_nums+"')\" name=BUT_LETTER3 value=\"Letter 3\" ></td>";
					m_string=m_string+"<input class=\"but_input\" type=\"button\" onclick=\"Generate_Letter1('"+rs1.getString(2) +"','"+rs1.getString(4)+"','"+chk_nums+"','"+rs1.getString(1)+"')\" name=BUT_LETTER1 value=\"Letter 1\" >"; 
					m_string=m_string+"<input class=\"but_input\" type=\"button\" onclick=\"Generate_Letter2('"+rs1.getString(2) +"','"+rs1.getString(4)+"','"+chk_nums+"','"+rs1.getString(1)+"')\" name=BUT_LETTER2 value=\"Letter 2\" >";
					//m_string=m_string+"<input class=\"but_input\" type=\"button\" onclick=\"Generate_Letter3('"+rs1.getString(2) +"','"+rs1.getString(4)+"','"+chk_nums+"','"+rs1.getString(1)+"')\" name=BUT_LETTER3 value=\"Letter 3\" ></td>"; // commented by udara somathilake on 03-11-2010
					m_string=m_string+"<input class=\"but_input\" type=\"button\" onclick=\"Generate_Letter3('"+rs1.getString(2) +"','"+rs1.getString(4)+"','"+chk_nums+"','"+rs1.getString(1)+"')\" name=BUT_LETTER3 value=\"Letter 3\" >"; // Added by udara somathilake on 03-2010
					m_string=m_string+"<input class=\"but_input\" type=\"button\" onclick=\"Generate_Letter4('"+rs1.getString(2) +"','"+rs1.getString(4)+"','"+chk_nums+"','"+rs1.getString(1)+"')\" name=BUT_LETTER4 value=\"Letter 4\" ></td>"; // Added by udara somathilake on 03-11-2010
				...
				m_string=m_string+"<br><br><hr><br>";
				
				m_string=m_string+"<table align='center' width='100%' class='table' >";
				m_string=m_string+"<tr class=pdn_txtpos2><td width='10%' ><DIV class=div_input><b>Pending or Disapproved Facilities</b></DIV></td></TR></table>";
				...
				rs1= stmt1.executeQuery(" SELECT FACILITY_NO, "+//1
					...
					" FACILITY_STATUS "+//11
					" FROM "+m_schema_name+".FA_CR_PRO_CLIENT_FACILITY "+
					" WHERE FACILITY_STATUS NOT IN('Y','T') "+
					" ORDER BY "+m_schema_name+".FA_GET_CLIENT_FULL_NAME(CLIENT_CODE) ");
				...
				while(rs1.next()){
					...
					m_string=m_string+"<td width='10%' align='right' class=div_input>"+nf.format(rs1.getDouble(7))+"</td>";
					m_string=m_string+"<td width='10%' class=div_input>"+rs1.getString(11)+"</td>";
					m_string=m_string+"<td width='12%' class=div_input><select name='TXT_APPROVE_TYPE_"+chk_nums+"' class='txt_input' style=\"width: 100px\" ><OPTION value=\"T\">Termination</option><OPTION value=\"C\">Disapproved</option><OPTION value=\"N\">Review Facility</option><OPTION value=\"F\">Follow-up</option><OPTION value=\"O\" SELECTED>No Action</option></SELECT></td>";
					m_string=m_string+"<td width='25%' class=div_input><INPUT TYPE='TEXT' class='txt_input' NAME='TXT_APPROVE_COMMENT_"+chk_nums+"' VALUE=\"\" style=\"width: 170px\"  maxlength=\"200\"></td>"; 
				...
				String m_string="";				
				  ...
				  " "+m_schema_name+".FA_DEBTOR_DOCUMENT_STATUS(CLIENT_CODE,FACILITY_NO,DEBTOR_CODE,'D003'),"+//7
					" "+m_schema_name+".FA_DEBTOR_COLLECT_STATUS(CLIENT_CODE,FACILITY_NO,DEBTOR_CODE), "+//8---- Y=coll by orient
					" "+m_schema_name+".FA_DEBTOR_PD_UPFORNT_STATUS(CLIENT_CODE,FACILITY_NO,DEBTOR_CODE) "+//9---Y=pod 100% ok
					" FROM "+m_schema_name+".FA_CR_PRO_CLIENT_DEBTOR "+
				...
				m_string=m_string+"<p class=div_input><b>Approved Relations</b></p>";
				...
				while(rs1.next()){
					...
					m_string=m_string+"<td width='10%' class=div_input><select name='TXT_APPROVE_TYPE_"+chk_nums+"' class='txt_input'><OPTION value=\"T\">Terminate</option><OPTION value=\"D\">Deactivate</option><OPTION value=\"D\">Disapproved</option><OPTION value=\"N\">Re-view</option><OPTION value=\"F\">Follow-up</option><OPTION value=\"O\" SELECTED>No Action</option></SELECT></td>";
					m_string=m_string+"<td width='15%' class=div_input><INPUT TYPE='TEXT' class='txt_input' NAME='TXT_APPROVE_COMMENT_"+chk_nums+"' VALUE=\"\" maxlength=\"200\"></td>"; 
					}
					else{
				...
				m_string=m_string+"<p class=div_input><b>Disapproved or Deactivated Relations</b></p><br>";
				m_string=m_string+"<table align='center' width='100%' class='table' >";
				m_string=m_string+"<tr class=pdn_txtpos2>";
				m_string=m_string+"<td width='15%' ><DIV class=div_input><b>Debtor Code</b></DIV></td>"; 
				m_string=m_string+"<td width='20%' ><DIV class=div_input><b>Name</b></DIV></td>"; 
			  ...
			  " "+m_schema_name+".FA_DEBTOR_DOCUMENT_STATUS(CLIENT_CODE,FACILITY_NO,DEBTOR_CODE,'D003'),"+//7
				...
				m_string=m_string+"<td width='10%' class=div_input><b>Reference No</b></td>";//Add by Indika 04/09/08
				//m_string=m_string+"<td width='10%' class=div_input><b>Serial No</b></td>";//Add by Indika 03/09/08
				m_string=m_string+"<td width='15%' class=div_input><b>Amount</b></td>";
				m_string=m_string+"<td width='15%' class=div_input><b>Dispute Code</b></td>";
				m_string=m_string+"<td width='15%' class=div_input><b>Dispute Amount</b></td>";
				...
				while(rs1.next()){
					...
					m_string=m_string+"<td width='1%' class=div_input><b>"+chk_nums+"</b></td>"+
						...
						"<td width=\"10%\" class=div_input><input class=\"txt_input\" type=\"text\" name=\"TXT_REFERENCE_NO_"+chk_nums+"\" disabled value=\""+rs1.getString(3)+"\"></td>"+ //add by indika 04/09/08
						//"<td width=\"10%\" class=div_input><input class=\"txt_input\" type=\"text\" name=\"TXT_SERIAL_NO_"+chk_nums+"\" disabled value=\""+rs1.getString(3)+"\"></td>"+ //add by indika 03/09/08
						...
						"<td width=\"15%\" class=div_input><input class=\"txt_input\" type=\"text\" name=\"TXT_DISPUTE_CODE_"+chk_nums+"\" disabled value=\""+rs1.getString(15)+"\"  style='text-align:right'></td>"+
						"<td width=\"15%\" class=div_input><input class=\"txt_input\" type=\"text\" name=\"TXT_DISPUTE_AMOUNT_"+chk_nums+"\" disabled value=\""+nf.format(rs1.getDouble(14))+"\"  style='text-align:right'></td>"+
       		...
       		" NVL(A.INVOICE_COMMENTS,'-'), "+//8
				...
				String m_batch_no=req.getParameter("batch_no");
				String m_invoice_balance=req.getParameter("invoice_balance");//added 2011-04-19
				
				String m_string="";	
				String query="";

					
					query=query+" SELECT A.DEBTOR_CODE,"+m_schema_name+".FA_GET_CLIENT_FULL_NAME(A.DEBTOR_CODE),"+//2 
					" A.INVOICE_NO, "+//3
					" A.INVOICE_AMOUNT,"+//4
       				" TO_CHAR(A.INVOICE_DATE,'DD'),"+//5
					" TO_CHAR(A.INVOICE_DATE,'MM'),"+//6
					...
					" NVL(A.BALANCE_AMOUNT,0) "+//10
  				    " FROM "+m_schema_name+".FA_CR_PRO_INVOICE_DETAIL A "+
					" WHERE A.BATCH_NO='"+m_batch_no+"' AND A.INVOICE_STATUS='CONF' AND A.BALANCE_AMOUNT>0";
					if(!m_invoice_balance.equals(""))
					{
					query=query+" AND A.BALANCE_AMOUNT = '"+m_invoice_balance+"'";
				    }
			...
			//Added by Mahela on 19-06-2007
				...
				//Modified by Dineth on 2008-11-07
				rs1= stmt1.executeQuery("SELECT  "+
				" DISTINCT A.DOC_CODE CODE, "+ 
				" B.DESCRIPTION, "+
