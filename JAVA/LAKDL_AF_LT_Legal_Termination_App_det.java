...
public class LAKDL_AF_LT_Legal_Termination_App_det extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			String m_termination_no = req.getParameter("legTerminationNo");
			...
			if (m_chksql.trim().equals("idle")) {
				...
				out.println("<HTML>"); 
				out.println("<HEAD>"); 
				out.println("<TITLE>Operation Reports - Legal Termination Settlement Approval Detail</TITLE>"); 
				...
				out.println("var terminationNo= '"+m_termination_no+"' ;");
				...
				out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_LT_Legal_Termination_App_det';"); 
				out.println("		}"); 
				out.println("}"); 
				...
				out.println("	help_box.innerHTML=\" Operation Reports - Legal Termination Settlement Approval Detail - \"+m_val;"); 
				out.println("}"); 
				
				out.println("function load_roll_out_value(){");
				out.println("	help_box.innerHTML=\" Operation Reports - Legal Termination Settlement Approval Detail \";"); 
				out.println("}"); 
				...
				*/
				...
				out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_LT_sql_validations_normal?chksql=LEGAL_INV_DET_APP_DET&terminationNo=\"+terminationNo;");
				...
				out.println("</tr>"); 
				out.println("<tr>"); 
				out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Operation Reports - Legal Termination Settlement Approval Detail</td>"); 
				out.println("</tr>"); 
				out.println("<tr>"); 
