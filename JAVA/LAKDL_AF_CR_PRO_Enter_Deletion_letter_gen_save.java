// created by udara on 31-12-2012
import java.io.*;
import java.util.*;
...
public class LAKDL_AF_CR_PRO_Enter_Deletion_letter_gen_save extends HttpServlet {
		...
		try {
			...
			String m_client_code=req.getParameter("m_client_code");
				...
				//	if(m_chk_type.equals("on")){
						...
						callstmt.setString(1,application_no);
			...
			out.println("window.location.href='"+m_url+"/LAKDL_AF_CR_PRO_Enter_Deletion_letter_details_gen?chksql=main_page&application_no="+application_no+"&client_code="+m_client_code+"&document_code=CEAS_ORDER&button_status=N';"); 
