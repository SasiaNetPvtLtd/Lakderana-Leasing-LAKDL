...
public class LAKDL_FA_CR_display_cancel_assign_letter extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Operation Process - Cancellation of Assigned Letters</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"FA_CR_display_cancel_assign_letter';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("	help_box.innerHTML=\"Operation Process - Cancellation of Assigned Letters - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\"Operation Process - Cancellation of Assigned Letters \";"); 
			out.println("}"); 
	  	...
	  	out.println("					}");  
			...
			out.println(" 	m_sql = \"m_help_DIV_TXT_CANCEL_ASSIGN_LETTER_sql\";"); 
			...
			out.println(" 	m_sql = \"m_help_DIV_TXT_DEBTOR_CODE_CANCEL_ASSIGN_LETTER_sql\";"); 
			...
			out.println("	m_url = \""+m_class_url+"/"+m_fschema_name+"FA_CR_Cancellation_of_assign_let?chksql=main_page&client_no=\"+document.Form1.TXT_CLIENT_CODE.value+\"&print=TRUE&facility_no=\"+document.Form1.TXT_FACILITY_NO.value+\"&debtor_code=\"+document.Form1.TXT_DEBTOR_CODE.value;"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Operation Process - Cancellation of Assigned Letters </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td  height='10px' class='pdn_txtpos'>"); 
			out.println("<table class='table' cellpadding='2' cellspacing='2' border='0'> "); 
			out.println("<tr>");  
			//out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"View - Letter\");'  onClick='save_window()' style='width:90' value=\"View - Letter\"></td>");  
			...
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_DEBTOR_CODE' maxlength='10' size='10' style='width:120' onblur=\"help_update_debtor()\">"); 
			...
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_DEBTOR_NAME' maxlength='10' size='50' style='width:200' disabled>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=\"button\" class='but_input' onClick='Generate_LetterX()' style='width:90' value=\"View - Letter\"></td>"); 
			out.println("<td width='*%'></td>"); //<input class='but_input' type='button' name='BUT_LETTER' value=\"Letter\" onClick=\"Generate_LetterX()\">
			out.println("</tr>");
			out.println("</table>");  
			out.println("<br>");
			out.println("<table>"); 
