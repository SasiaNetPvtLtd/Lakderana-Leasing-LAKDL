...
public class LAKDL_AF_RE_PRO_drill_downs_three extends javax.servlet.http.HttpServlet {
	/*
	Connection conn;
	...
	public void service(HttpServletRequest req, HttpServletResponse res)	throws IOException	{
     	...
     	res.setDateHeader("Expires", 0);
			...
			if (m_chksql.trim().equals("idle")) {
				...
				String		Sql_Contracts=" SELECT "+
									 ...
									 " NVL(DECODE(A.APPLICATION_STATUS,'ENTERED','Entered','ENT_CON','Completed','VERIFY1','Verification','V-APP','Score Approval','VERIFY-M','Approval 1','VERIFY2','Approval 2','VERIFYL','Entered Leasing No','ACTIVATED','Activated','CANCEL','Cancel','REPOSSESS','Repossess','REJECT','Rejected'),'-'), "+
        ...
        if (!more) {
				...
				if (more) {
				  out.println("<table align='center' width='100%' class='table' >");
					...
					out.println("<td width='20%' class=div_input><b>Transaction Type</b></td>");
					out.println("<td width='20%' class=div_input><b>Stage</b></td>");
					out.println("<td width='*%'></td>"); 
					out.println("</tr>");
					out.println("</table>");
					out.println("<br>");
				...
				while(more){
					...
					out.println("<tr>");
					out.println("<td width='1%'></td>"); 
					out.println("<td width='20%' class=div_input style= cursor:hand; onclick=show_application_drill('"+rs.getString(1)+"') ><u>"+rs.getString(1)+"</u></td>");
					out.println("<td width='20%' class=div_input style= cursor:hand; onclick=show_finance_drill('"+rs.getString(2)+"') ><u>"+rs.getString(2)+"</u></td>");
        ...
        if (!more) {
				...
				while(more){
					...
					out.println("<tr>");
					out.println("<td width='1%'></td>"); 
					out.println("<td width='20%' class=div_input style= cursor:hand; onclick=show_asset_drill('"+rs.getString(1)+"') ><u>"+rs.getString(1)+"</u></td>");
        ...
        if (!more) {
				...
				if (more) {
				  out.println("<table align='center' width='100%' class='table' >");
					out.println("<tr>");
					out.println("<td width='1%'></td>"); 
					out.println("<td width='25%' align='left' class=div_input><b>Application No</b></td>");
					out.println("<td width='15%' align='left' class=div_input><b>Finance no</b></td>");
					out.println("<td width='35%' align='left' class=div_input><b>Client Name</b></td>");
				...
				while(more){
					...
					out.println("<tr>");
					out.println("<td width='1%'></td>"); 
					out.println("<td width='25%' align='left' class=div_input style= cursor:hand; onclick=show_application_detail_drill('"+rs.getString(3)+"') ><u>"+rs.getString(3)+"</u></td>");
					out.println("<td width='15%' align='left' class=div_input style= cursor:hand; onclick=show_finance_detail_drill('"+rs.getString(4)+"') ><u>"+rs.getString(4)+"</u></td>");
					out.println("<td width='35%' align='left' class=div_input style= cursor:hand; onclick=show_client('"+rs.getString(1)+"') ><u>"+rs.getString(6)+"</u></td>");
				  ...
				  out.println("<tr>");
					...
					out.println("<td width='35%' class=div_input><b>Total</b></td>");
