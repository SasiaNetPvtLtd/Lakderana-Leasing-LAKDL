...
public class LAKDL_AF_CR_PRO_Other_Payments_Autho_By_Division extends javax.servlet.http.HttpServlet {
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)
	{
		...
		try {
			...
			if (m_chksql.trim().equals("idle")) {
				...
				out.println("<td  width='12%' >Payment No</td>"); 
				out.println("<td  width='5%' >Type</td>"); 
				out.println("<td  width='5%' >Entry Type</td>"); 
				out.println("<td  width='10%' >WHT</td>"); 
				out.println("<td  width='10%' >Amount</td>"); 
				out.println("<td  width='10%' >Payment Amount</td>"); 
				out.println("<td  width='10%' >Effective Date</td>"); 
				out.println("<td  width='10%' >Payee Name</td>"); 
				out.println("<td  width='10%' >Approve</td>"); 	
				out.println("<td  width='5%' >Select<INPUT TYPE=\"checkbox\" NAME=\"CHECK_ALL\" VALUE=\"on\" onclick=\"check_all_chkbox()\"  ></td>"); 
				...
				rs = stmt.executeQuery (" SELECT "+
					...
					" WHERE  PROCESS_STATUS='AUTHO' AND  ENTRY_TYPE <> 'V'  AND UPPER(PAYEE_NAME) LIKE UPPER('"+m_payee_name+"%')  ");
				while(rs.next()){
					if(j>0 && j%2==1){
					...
					out.println("<select NAME=CHK_APP"+j+" class='txt_input'><option value=APP>Approve</option>");
					out.println("<option value=DAPP>DisApprove</option></select></td>");
					...
					out.println("<input type=hidden name=HID_WHT"+j+" value="+rs.getDouble(9)+">");
					out.println("<input type=hidden name=HID_SETTLED_AMT"+j+" value="+rs.getDouble(10)+">");
					out.println("</tr>");
					j=j+1;
				}
				...
				rs = stmt.executeQuery (" SELECT "+
					" COUNT(PAYMENT_NO) "+
					" FROM "+m_schema_name+".AF_RE_PRO_SETTLMENT_PAYMENT "+
					" WHERE  PROCESS_STATUS='AUTHO' AND  ENTRY_TYPE <>'V' ");
				...
				out.println("help_box.innerHTML=\"Finance - Other Payments Authorization \";"); 
				out.println("}else{");
				out.println("help_box.innerHTML=\"Finance - Other Payments Authorization - \"+m_val;"); 
				out.println("}");
				out.println("}");
				...
				out.println("		if(validate_data()){"); 
				out.println("		document.Form1.action='"+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_PRO_Save_Other_Payment_Autho_By_Division';");  
				...
				out.println("m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_PRO_Other_Payments_Autho_By_Division?chksql=payment_details&payee_name=\"+m_payee_name+\"\";");
				...
				out.println("help_box.innerHTML=\" Finance - Other Payments Authorization - \"+document.Form1.hid_status.value;"); 
				out.println("}"); 
				...
				out.println("		window.location.href='"+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_PRO_Other_Payments_Autho_By_Division?chksql=main_page';"); 
				out.println("		}"); 
				out.println("}"); 				
				...
				out.println("Crit=document.Form1.TXT_CLIENT_NAME.value+\"@\";");
				out.println("HelpBox('1','10','0',Crit,'cre_payee','1');");
				out.println("}");
				...
				out.println("<INPUT TYPE='Hidden' NAME='Hid_scr_name' VALUE=\"AF_CR_PRO_OTHER_PAY_AUTHO\">"); 
				...
				out.println("</tr>"); 
				out.println("<tr>"); 
				out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Finance - Other Payments Authorization</td>"); 
				out.println("</tr>"); 
				out.println("<tr>"); 
				...
				out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_CLIENT_NAME' maxlength='15' style=\"{width:250px;}\" size='15'onBlur='payment_no_help()' >");  
				out.println("<input type=button name=cli_help value=... class=\"but_input\" onclick=\"payment_no_help()\">");//Added by prabash on 10-02-2012
				if(m_count_payment_no>0){
					...
					out.println("<input class='but_input' type='button' name='BUT_TXT_CLIENT_NAME_SEARCH' value=\"Search\" ></td>"); 
				}
				out.println("<td width='*%'><b>Pending Payments For Authorization &nbsp;&nbsp;&nbsp; "+m_count_payment_no+"</td>");
				out.println("</tr>"); 
