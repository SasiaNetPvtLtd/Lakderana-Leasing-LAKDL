...
//Created by Dineth Meemanage on 2009-02-11
...
public class LAKDL_AF_CR_ODI_Approve1 extends javax.servlet.http.HttpServlet {
      ...
      String m_username 						= "AA";//m_sn_methods.username;
         ...
         out.println("<td  width='10%' >Invoice</td>");
          ...
          out.println("<td  width='10%' align='left'>Allocated Date</td>");
					...
					out.println("<td  width='20%' align='left'>Remark</td>");		
					out.println("</tr>");
           ...
           int j = 0;   
             ...
             */
							...
							// end by udara 23-12-2013
							 ...
							 " AND B.FINANCE_NO='"+m_finance_no+"' "+  
							 " AND A.STATUS='ENT'  "+
							 " GROUP BY A.INVOICE_NO,A.ODI_NO,A.ALLOCATED_DATE,A.ENT_USER,A.ODI_TYPE,A.ODI_STATUS,A.REMARKS,A.STATUS"+
								" ,A.INC_DEC_STAT ");
                  ...
                  out.println("<td width='10%' align='right'  >"+nf.format(rs.getDouble(7)*-1)+"</td>");
									...
									*/
									...
									out.println("<td width='10%' align='left'   >"+rs.getString(17) +"</td>"); // added by udara 23-12-2013
					        ...
					        out.println("</select></td>");
									...
									out.println("<td width='25%' align='left' >"+rs.getString(15)+"</td>");//Added by Sandun on 01-07-2009
								  ...
								  out.println("<input type=hidden name=ODI_BAL"+j+" value="+rs.getDouble(14)+" >");
									out.println("<input type=hidden name=STATUS_"+j+" value="+rs.getString(16)+" >");
									out.println("</tr>");
                	j=j+1;
              }
          ...
          out.println("</tr></table>");
			...
			out.println("<HTML><HEAD><TITLE>ODI Approve 1</TITLE></HEAD>");
		  ...
		  out.println("}"); 
			...
			out.println("<TR><TD><CENTER><B>ODI Approve 1</B></TD></TR>");
			out.println("</TABLE>");
			out.println("<BR><BR>");
        ...
        out.println("	 popupwin = window.open(\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_RE_PRO_drill_downs_3?chksql=SHOW_FINANCE_DETAIL_DRILL&finance_no=\"+num+\"\", \"oBj\",\"left=150,top=100,width=620,height=390,scrollBars=1\");"); 
			...
			//client Help
				...
				out.println("HelpBox('1','10','0',Crit,'ClientSql_ODI_APP1','1');");//Mod By Sandun on 30-06-2009
				out.println("}");		
			...
			//Lease Help
			  out.println("function lease_help(){");
				...
				out.println("HelpBox('1','10','0',Crit,'LeaseSql_ODI_APP1','3');");//Mod by Sandun on 01-07-2009
				out.println("}");	
        ...
        out.println("}");
				...
				out.println("help_box.innerHTML=\"Finance - O D Interest Adjustments Approval1 \";"); 
			  out.println("}else{");
				out.println("help_box.innerHTML=\"Finance - O D Interest Adjustments Approval1 - \"+m_val;"); 
			  out.println("}");
				out.println("}");
        ...
        out.println("m_chk_required=\"CHK_REQUIRED\"+row_no;");				
				...
				out.println("}");
				out.println("		document.Form1.action='"+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_ODI_Save_Approve1';");  
	      ...
	      out.println("document.Form1.hid_odi_bal.value=data_vec[0]; ");
			...
			out.println("m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_ODI_Approve1?chksql=odi_adjustment_details&finance_no=\"+document.Form1.LEASE_NO.value+\"\";");
			...
			out.println("m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_MAS_sql_validations1?chksql=m_prime_chk_LAKDL_AF_MAS_get_odi_count_app1\";");
			out.println("load_interface(m_url,'XML');");
			out.println("}");
			...
			out.println("}");
				...
				out.println("help_box.innerHTML=\" Finance Process - O D Interest Adjustments Approval1 - \"+document.Form1.hid_status.value;"); 
				out.println("}"); 
			...
			out.println("}"); 
					...
					out.println("		window.location.href='"+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_ODI_Approve1?chksql=main_page';"); 
					out.println("		}"); 
					out.println("}"); 
        	...
        	out.println("</Script>");
			  ...
			  out.println("<INPUT TYPE='Hidden' NAME='hid_no_rec' VALUE=\"0\">"); 
				out.println("<INPUT TYPE='Hidden' NAME='Hid_scr_name' VALUE=\"AF_CR_ODI_ADJUST_APPROVAL1\">"); 
	      ...
	      out.println("<INPUT TYPE='Hidden' NAME='hid_odi_bal' VALUE=0>");
				...
				out.println("<td width='8' valign='top'><img src='spacer.gif' width='8' height='8'></td>"); 
					...
					out.println("</tr>"); 
					out.println("<tr>"); 
					out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Finance - O D Interest Adjustments Approval1</td>"); 
					out.println("</tr>"); 
					out.println("<tr>"); 
