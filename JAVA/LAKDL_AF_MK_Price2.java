...
public class LAKDL_AF_MK_Price2 extends javax.servlet.http.HttpServlet {
  ...
  public synchronized void service(HttpServletRequest req, HttpServletResponse res)
	{
      ...
      //conn = DriverManager.getConnection("jdbc:oracle:thin:@147.120.40.1:1521:DN10G", "system", "sys123");
        ...
        out.println("<td>&nbsp;</td>");
				...
				out.println("<tr class=tr_input>");
				out.println("<td width=10%><div id=prino class=div_input>Pricing No </div></td>");
				out.println("<td width=20%><input name=\"PRICE_NO\" type=\"text\" maxlength=\"15\" class=\"txt_input\" >");
				out.println("<input type=button name=inqu_help value=Help class=\"but_input\" onclick=\"inq_help('1','10','13','InquirySql','7')\"></td>");
				out.println("<td width=10%><div id=inqno class=div_input>Inquiry No </div></td>");
				out.println("<td width=20%><input name=\"INQ_NO\" type=\"text\" maxlength=\"15\" class=\"txt_input\" >");
				out.println("<input type=button name=inq_help value=Help class=\"but_input\" onclick=\"inq_help('1','10','13','InquirySql','7')\"></td>");
				out.println("<td width=10%><div id=trntype class=div_input>Transaction Type *</div></td>");
