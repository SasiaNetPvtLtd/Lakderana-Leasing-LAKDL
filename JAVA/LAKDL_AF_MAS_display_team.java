...
//SCREEN NAME:SYSTEM ADMINISTRATION -TEAM
...
public class LAKDL_AF_MAS_display_team extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>System Administration - Teams</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("			}");
			out.println("			else");
			out.println("			if(data_vec.length==0 && document.Form1.hid_chk_status.value=='M2' && document.Form1.TXT_DIVISION_CODE.value!=\"\"){");
			...
			out.println("			}");
			out.println("			else");
			out.println("			if(data_vec.length==0 && document.Form1.hid_chk_status.value=='M3' && document.Form1.TXT_SUB_DIVISION_CODE.value!=\"\"){");
			...
			out.println("			}");
			out.println("			else");
			out.println("			if(data_vec.length==0 && document.Form1.hid_chk_status.value=='M4' && document.Form1.TXT_TEAM_HEAD.value!=\"\"){");
			out.println("				help_button_3();");
			//out.println("       document.Form1.TXT_TEAM_HEAD.value=\"\" "); 
			//out.println("       document.Form1.TXT_TEAM_HEAD.focus()  "); 
			out.println("			}");
			out.println("			else");
			out.println("			if(document.Form1.SCREEN_NAME.value==\"NEW\"  && data_vec.length > 0 && document.Form1.hid_chk_status.value=='M5' && document.Form1.TXT_TEAM_DESC.value!=\"\"){");
			out.println("				alert('Record already exists.');"); 
			out.println("				help_new_desc();");
			//out.println("       document.Form1.TXT_TEAM_HEAD.value=\"\" "); 
			//out.println("       document.Form1.TXT_TEAM_DESC.focus()  "); 
			out.println("			}");
			...
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_team&data_val=\"+obj.value+\"&ac_status=Y\";");
			out.println("else");
			
			out.println("if(document.Form1.hid_chk_status.value=='M1' && document.Form1.SCREEN_NAME.value ==\"NEW\")");
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations1?chksql=m_prime_chk_LAKDL_AF_MAS_display_team&data_val=\"+obj.value;");
			out.println("else");
			
			out.println("if(document.Form1.hid_chk_status.value=='M1' && document.Form1.SCREEN_NAME.value==\"RACT\")");
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_team&data_val=\"+obj.value+\"&ac_status=N\";");
			//out.println("if(document.Form1.hid_chk_status.value=='M1')");
			//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_team&data_val=\"+obj.value;");
			out.println("else");
			...
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations1?chksql=m_prime_chk_LAKDL_AF_MAS_display_team_desc&data_val=\"+obj.value ;");
	    ...
	    out.println("function assignState(val){");
			...
			out.println("}"); 
			out.println("else if(document.Form1.TXT_TEAM_DESC.value==\"\"){  "); 
			out.println("DIV_TXT_TEAM_DESC.style.color='red';");
			out.println("return false;"); 
			out.println("}"); 
			out.println("else if(document.Form1.TXT_TEAM_HEAD.value==\"\"){  "); 
			out.println("DIV_TXT_TEAM_HEAD.style.color='red';");
			out.println("return false;"); 
			out.println("}"); 
      out.println("else if(document.Form1.TXT_DIVISION_CODE.value==\"\"){  "); 
			...
			out.println("return false;"); 
			out.println("}"); 
      out.println("else if(document.Form1.TXT_SUB_DIVISION_CODE.value==\"\"){  "); 
			out.println("DIV_TXT_SUB_DIVISION_CODE.style.color='red';");
			out.println("return false;"); 
			out.println("}"); 
			...
			out.println("     }");
			out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_MAS_save_team';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MAS_display_team';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("    m_help_message = \"m_help_msg_LAKDL_AF_MAS_display_team\";"); 
			...
			out.println("help_box.innerHTML=\" System Administration - Teams - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" System Administration - Teams - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
      ...
      //Modified by Disnaka Jayasuriya on 2009-10-16 
      ...
      //Modified by Disnaka Jayasuriya on 2009-10-16 for filter sub division codes for to relevant division code 
			out.println("function help_button_2() {"); 
			out.println("    document.Form1.hid_help_type.value=\"2\";"); 
			out.println("    m_sql = \"m_help_TXT_SUB_DIVISION_CODE1_sql\";"); 
			out.println("    		m_criteria = document.Form1.TXT_SUB_DIVISION_CODE.value+\"@Y@\"+document.Form1.TXT_DIVISION_CODE.value+\"@\";"); 
			out.println("    HelpBox('1','10','0');"); 
			out.println("}"); 
			out.println(""); 
       ...
       //Modified by Disnaka Jayasuriya on 2009-10-16 
			...
			out.println("    m_criteria = document.Form1.TXT_TEAM_HEAD.value+\"@Y@\";"); 
			out.println("    HelpBox('1','10','5');"); 
			out.println("}"); 
			out.println(""); 

			out.println("function help_value_assign_3() {"); 
			out.println("    document.Form1.TXT_TEAM_HEAD.value=oBj.valout[2];"); 
			out.println("}"); 

			out.println("function help_new_desc() {"); 
			out.println("    document.Form1.hid_help_type.value=\"33\";"); 
			out.println("    m_sql = \"m_help_TXT_TEAM_ID_DESC_sql\";"); 
			out.println("    m_criteria = document.Form1.TXT_TEAM_DESC.value+\"@\" ;"); 
			...
			out.println("document.Form1.TXT_TEAM_ID.value='';"); 
			out.println("document.Form1.TXT_TEAM_ID.focus() ;"); 
			out.println("document.Form1.TXT_TEAM_DESC.value='';"); 
			out.println("    document.Form1.TXT_TEAM_HEAD.value=\"\""); 
      ...
      out.println(" }");
			...
			out.println("    \"&Sql_in=\"+m_sql+\"&Start_in=\"+Start+"); 
			out.println("    \"&End_in=\"+End+\"&Crit_In=\"+m_criteria+"); 
			out.println("    \"&Hid_No=\"+Hid_No, oBj,\"dialogWidth:34.5em; dialogHeight:25em; center:yes; status:no\");"); 
			out.println("	"); 
			out.println("	if(oBj.valout[1] !=\" \"){"); 
			out.println("	if(oBj.valout[1] !=\"Close\"){"); 
			out.println("	if(oBj.valout[1]!=\"Prev\"){"); 
	  	...
	  	out.println("		}"); 
			...
			out.println("    m_sql = \"m_view_TXT_TEAM_ID_sql\";");
			out.println("    m_criteria = document.Form1.TXT_TEAM_ID.value+\"@\"+\"Y@\";"); 
			out.println("    HelpView('1',50,'0');"); 
			out.println("}"); 
			
			out.println("function veiwHierarchy(){	"); 
			out.println("Width = screen.availWidth;");
			out.println("Height = screen.availHeight;");
			out.println("var Left = (screen.availWidth-352);");
			out.println("		window.open(\""+m_class_url+"/"+m_fschema_name+"FA_Dispaly_Team_hierarchy\",\"popupwin1\",\"status=0,menubar=0,scrollbars=1,top=0,left=\"+Left+\",height=\"+Height+\",width=350\");");
			out.println("}"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>System Administration - Teams</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<td width='30%' ><DIV id='DIV_TXT_TEAM_DESC'  class=div_input>Team Description *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_TEAM_DESC' maxlength='50' size='20' onblur=\"assignState('M5'),makeRequest(document.Form1.TXT_TEAM_DESC)\"></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 

			//out.println("<td width='30%' >Team Head </td>"); 
			out.println("<td width='30%' ><DIV id='DIV_TXT_TEAM_HEAD'  class=div_input>Team Head *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_TEAM_HEAD' maxlength='10' size='10' onblur=\"assignState('M4'),makeRequest(document.Form1.TXT_TEAM_HEAD)\">"); 
			out.println("<input class='but_input' type='button' name='BUT_TXT_TEAM_HEAD' value=\"Help\" onClick=\"help_button_3()\"></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 

			out.println("<td width='30%' ><DIV id='DIV_TXT_DIVISION_CODE'  class=div_input>Division Code *</DIV></td>"); 
			out.println("<td width='30%' ><input class='txt_input' type='text' name='TXT_DIVISION_CODE' maxlength='10' size='10' onblur=\"assignState('M2'),makeRequest(document.Form1.TXT_DIVISION_CODE)\">"); 
			...
			out.println("<td width='30%' ><DIV id='DIV_TXT_SUB_DIVISION_CODE'  class=div_input>Sub Division Code *</DIV></td>"); 
			out.println("<td width='30%' ><input class='txt_input' type='text' name='TXT_SUB_DIVISION_CODE' maxlength='10' size='10' onblur=\"assignState('M3'),makeRequest(document.Form1.TXT_SUB_DIVISION_CODE)\">"); 
			out.println("<input class='but_input' type='button' name='BUT_TXT_SUB_DIVISION_CODE' value=\"Help\" onClick=\"help_button_2()\"></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			
			out.println("<tr>"); 
			out.println("<td width='30%' ><input name='BUT_VIEW_TEAM_HIERARCHY' class='but_input' style='width:120px;' type='button' value='View Team Hierarchy' onclick='veiwHierarchy();'></td>"); 
