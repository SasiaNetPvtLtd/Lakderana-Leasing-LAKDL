...
public class LAKDL_FA_OP_Debtor_Credit_Comments extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Operation Process - Debtor Credit Comments</TITLE>"); 
			out.println("</HEAD>"); 
    	...
    	out.println("}");
			...
			out.println("function dispay_data() {");
   		out.println("   m_url=\""+m_class_url+"/"+m_fschema_name+"FA_OP_PRO_sql_validations_normal?m_facility_code=\"+document.Form1.TXT_FACILITY_NO.value+\"&m_client_code=\"+document.Form1.TXT_CLIENT_CODE.value+\"&m_debtor=\"+document.Form1.TXT_DEBTOR_CODE.value+\"&chksql=LOAD_CLIENT_DEBTOR_DISPUTES\";");
			out.println("		load_interface(m_url,'NO');");
    	out.println("}");
			
			out.println("function before_submit(){ "); 
			out.println("	get_display_msg();");
			out.println("	if((!(document.Form1.TXT_FACILITY_NO.value==\"\"))|| (!(document.Form1.TXT_CLIENT_CODE.value==\"\"))) {  "); 
			out.println("		if(confirm(\"Are You Sure you want to \"+m_sav_msg+\"\")){ ");
			out.println("				document.Form1.TXT_CLIENT_CODE.disabled=false;");
			out.println("				document.Form1.action='"+m_class_url+"/"+m_fschema_name+"FA_CR_Save_Debtor_Credit_Comments';");  
			...
			out.println("	help_box.innerHTML=\"  Operation Process - Debtor Credit Comments\";"); 
			out.println("}"); 
  		...
  		out.println("function help_update_value_6() {"); 
			...
			out.println("<INPUT TYPE='Hidden' NAME='hid_faciliyt' VALUE=\"\">"); 
			out.println("<INPUT TYPE='Hidden' NAME='hid_clent' VALUE=\"\">"); 
			out.println("<INPUT TYPE='Hidden' NAME='hid_debtor' VALUE=\"\">"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Operation Process - Debtor Credit Comments </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<td width='40%' ><TEXTAREA class='txt_input' name='TXT_COMMENTS'  maxlength='1000' style='{width:750px; height:50px;}' size='200'  ></TEXTAREA></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>");
			out.println("</table>");
