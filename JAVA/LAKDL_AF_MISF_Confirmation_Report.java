...
public class LAKDL_AF_MISF_Confirmation_Report extends javax.servlet.http.HttpServlet { 
...
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!	
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Confirmation Report</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MISF_Confirmation_Report?chksql=main_page';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("help_box.innerHTML=\"Confirmation Report - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\"Confirmation Report - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
		...
		/*	out.println("else if(m_val!=\"EDIT\"){"); 
		  ...
		  out.println("function view() {");
			...
			//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Confirmation_Report_Detail?chksql=main_page&finance_no=\"+document.Form1.TXT_FINANCE_NO.value+\"\";"); // commented by udara 19-05-2015
			
			//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Confirmation_Report_Detail?chksql=main_page&finance_no=\"+document.Form1.TXT_FINANCE_NO.value+\"&generate_status=\"+document.Form1.generate_status.value;"); // commented by udara 14-07-2017
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Confirmation_Report_Detail_Snap?chksql=main_page&snap_view_status=Y&compare_status=N&view_only_status=N&snap_position=GENERATE&finance_no=\"+document.Form1.TXT_FINANCE_NO.value+\"&generate_status=\"+document.Form1.generate_status.value;"); // added by udara 14-07-2017
			
			out.println("popupwin=window.open(m_url,'displayWindow1_confirmation_rpt','left=10,top=60,width=1000,height=550,toolbar=0,location=0,center:yes,direction=0,menuBar=1,status=0,scrollbars=1,resizable=1');");
			out.println(" new_window(); ");
			out.println("}");
			out.println("else{");
			...
			out.println("    m_sql = \"m_help_TXT_confirmation_rpt_gen_sql\";");
			out.println(" }");
...
//-----------------------------------------------------------------------------------------------------------------------
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Confirmation Report</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Re-Generate\");'  onclick='re_generate_report(\"re_gen\")' value=\"Re-Generate\" ></td>");  // added by udara 19-05-2015
