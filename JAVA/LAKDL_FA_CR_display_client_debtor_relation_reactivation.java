...
public class LAKDL_FA_CR_display_client_debtor_relation_reactivation extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Credit Process - Client Maintenance - Client-Debtor Relationship Reactivation</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"FA_CR_PRO_sql_validations_normal?chksql=LOAD_CLIENTS_DEBTOR_RELATION_REACTIVATION&facility_no=\"+document.Form1.TXT_FACILITY_NO.value;");
			...
			out.println("			}");
			out.println("			if(validate_data()){"); 
			out.println("				document.Form1.action='"+m_class_url+"/"+m_fschema_name+"FA_CR_Save_client_debtor_relation_reactivation';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"FA_CR_display_client_debtor_relation_reactivation';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("    m_help_message = \"m_help_msg_LAKDL_FA_CR_CLIENT_DEBTOR_RELATION_TERMINATION\";"); 
			...
			out.println("	help_box.innerHTML=\"Credit Process - Client Maintenance - Client-Debtor Relationship Reactivation - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\"Credit Process - Client Maintenance - Client-Debtor Relationship Reactivation \";"); 
			out.println("}"); 
			...
			out.println("		credit_approval_data.innerHTML='';");
			out.println("}");
	  	...
	  	out.println("					}");  
			...
			out.println(" 	m_sql = \"m_help_DIV_TXT_FACILITY_CLIENT_DEBTOR_RELATION_TERMINATION_sql\";"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Credit Process - Client Maintenance - Client-Debtor Relationship Reactivation </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
