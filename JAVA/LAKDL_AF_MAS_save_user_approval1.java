...
public class LAKDL_AF_MAS_save_user_approval1 extends HttpServlet {
	...
	public synchronized void  service(HttpServletRequest req, HttpServletResponse res)	throws IOException{
      ...
      String m_username = m_sn_methods.username;
			...
			if(m_num>0){
				...
				//------------------------------------------------------------------
				callstmt1=conn.prepareCall("BEGIN "+m_schema_name+".AF_MAS_SAVE_USER_APPROVAL(:1,:2,:3,:4); END;");
				...
				if(m_num>0){
					...
					for(int i=1;i<=m_num;i++){
						...
						if(m_status.equals("Y")){
							...
							callstmt1.setString(1,m_sn_methods.met_formdata(reqstr,"TXT_USER_ID_"+i).trim());
							callstmt1.setString(2,"APPR1");
