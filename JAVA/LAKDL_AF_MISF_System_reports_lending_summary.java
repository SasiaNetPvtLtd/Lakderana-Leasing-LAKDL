...
public class LAKDL_AF_MISF_System_reports_lending_summary extends javax.servlet.http.HttpServlet { 
		...
		try { 
			...
			if(m_chksql.equals("run_report")){ 
				...
				try{
					...
					callstmt1 = conn.prepareCall("BEGIN "+m_schema_name+".AF_PRO_SYS_REP_LENDING_SUMMARY(:1,:2,:3,:4,:5,:6,:7);END;");
			...
			if(m_chksql.equals("main_page")){ 
				...
				out.println("<HTML>"); 
				out.println("<HEAD>"); 
				out.println("<TITLE>Lending Performance Summary Report</TITLE>"); 
				out.println("</HEAD>"); 
				...
				out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_System_reports_lending_summary?chksql=run_report&date=\"+m_date+\"&location=\"+m_location+\"&officer=\"+m_officer+\"&active_status=\"+m_active_status+\"&region=\"+m_region+\"&perform_status=\"+m_perform_status;"); 
				...
				out.println("           m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_System_reports_lending_summary?chksql=print_report_system_report_lending&location=\"+m_location+\"&officer=\"+m_officer+\"&date=\"+m_date+\"&active_status=\"+document.Form1.TXT_ACTIVE_STATUS.value+\"&region=\"+m_region+\"&perform_status=\"+m_perform_status;");
				...
				out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MISF_System_reports_lending_summary?chksql=main_page';"); 
				out.println("		}"); 
				out.println("}"); 
				...
				out.println("help_box.innerHTML=\" Lending Performance Summary Report - \"+m_val;"); 
				out.println("}"); 
				out.println(""); 
				
				out.println("function load_roll_out_value(){");
				out.println("help_box.innerHTML=\" Lending Performance Summary Report - \"+document.Form1.hid_status.value;"); 
				out.println("}"); 
				...
				out.println("</tr>"); 
				out.println("<tr>"); 
				out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Lending Performance Summary Report </td>"); 
				out.println("</tr>"); 
				out.println("<tr>"); 
			...
			else if(m_chksql.equals("print_report_system_report_lending")){
				...
				*/
				...
				out.println("<HTML>"); 
				out.println("<HEAD>"); 
				out.println("<TITLE>Collection - Lending Performance Summary Report</TITLE>"); 
				out.println("</HEAD>"); 
				out.println("<link REL='STYLESHEET' HREF='"+m_html_client_url+"/css/Asset_Financing_System.css' TYPE=\"text/css\">"); 
				out.println("<SCRIPT language=\"JavaScript\">"); 
				...
				out.println("  m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_System_reports_lending_summary?chksql=print_report_new_logic&location="+m_location+"&officer="+m_officer+"&date="+m_date+"&active_status="+m_active_status+"&region="+m_region+"&perform_status="+m_perform_status+"&sort_column=\"+m_sort_col+\"&order_by_type=\"+m_order_by_type;");	
				...
				String m_colour_head_three_wheeler = "#99ccff";
				String m_colour_head_other = "#cce6ff";
				String m_colour_head_motorbikes = "#ffbb99";
				String m_colour_cases = "#ffff99";
				String m_colour_region_total = "#b3d1ff";
				String m_colour_total = "#b3d1ff";
				...
				out.println("<tr >");
				out.println("<td width=\"*\" STYLE='{font: bold 10pt arial; text-align:center;}'   ><u>Lending Performance Summary Report</u></td>"); 
				out.println("</tr >");
				out.println("</table >");
				out.println("<br>");
				/*
				...
				out.println("<tr >");
				out.println("<td width=\"150\" STYLE='{font: bold 8pt arial; text-align:left;}'   >Lending Performance Summary Report for the</td>"); 
				...
				*/
				...
				out.println("<tr>");
				out.println("<td width=\"10%\"  align='center' bgcolor='lightgray' colspan=1 > &nbsp; </td>"); 
				out.println("<td width=\"10%\"  align='center' bgcolor='lightgray' colspan=12 > <b> No. of cases <b> </td>"); 
				out.println("<td width=\"10%\"  align='center' bgcolor='lightgray'  > &nbsp; </td>"); 
				out.println("<td width=\"10%\"  align='center' bgcolor='lightgray' colspan=4 > &nbsp; </td>");
				out.println("</tr>");
				
				out.println("<tr>");
				out.println("<td width=\"10%\"  align='center' bgcolor='lightgray' colspan=1 > &nbsp; </td>"); 
				out.println("<td width=\"10%\"  align='center' bgcolor='"+m_colour_head_three_wheeler+"' colspan=4 ><b> Three Wheels </b></td>"); 
				out.println("<td width=\"10%\"  align='center' bgcolor='"+m_colour_head_other+"' colspan=4 ><b> Other Vehicles </b></td>"); 
				out.println("<td width=\"10%\"  align='center' bgcolor='"+m_colour_head_motorbikes+"' colspan=4 ><b> Mortorbikes </b></td>"); 
				out.println("<td width=\"10%\"  align='center' bgcolor='lightgray'  > &nbsp; </td>"); 
				out.println("<td width=\"10%\"  align='center' bgcolor='"+m_colour_total+"' colspan=4 > &nbsp; </td>");
				out.println("</tr>");
				
				out.println("<tr>");
				//out.println("<td width=\"10%\"  align='center' bgcolor='lightgray' ><b> No </b></td>"); 
				out.println("<td width=\"10%\"  align='center' bgcolor='"+m_colour_total+"' ><b> Branch </b></td>"); 
				
				out.println("<td width=\"10%\"  align='center' bgcolor='"+m_colour_head_three_wheeler+"' ><b> Registered </b></td>");
				out.println("<td width=\"10%\"  align='center' bgcolor='"+m_colour_head_three_wheeler+"' ><b> Lending Amount </b></td>");
				out.println("<td width=\"10%\"  align='center' bgcolor='"+m_colour_head_three_wheeler+"' ><b> Unregistered </b></td>");
				out.println("<td width=\"10%\"  align='center' bgcolor='"+m_colour_head_three_wheeler+"' ><b> Lending Amount </b></td>");
				
				out.println("<td width=\"10%\"  align='center' bgcolor='"+m_colour_head_other+"' ><b> Registered </b></td>");
				out.println("<td width=\"10%\"  align='center' bgcolor='"+m_colour_head_other+"' ><b> Lending Amount </b></td>");
				out.println("<td width=\"10%\"  align='center' bgcolor='"+m_colour_head_other+"' ><b> Unregistered </b></td>");
				out.println("<td width=\"10%\"  align='center' bgcolor='"+m_colour_head_other+"' ><b> Lending Amount </b></td>");
				
				out.println("<td width=\"10%\"  align='center' bgcolor='"+m_colour_head_motorbikes+"' ><b> Registered </b></td>");
				out.println("<td width=\"10%\"  align='center' bgcolor='"+m_colour_head_motorbikes+"' ><b> Lending Amount </b></td>");
				out.println("<td width=\"10%\"  align='center' bgcolor='"+m_colour_head_motorbikes+"' ><b> Unregistered </b></td>");
				out.println("<td width=\"10%\"  align='center' bgcolor='"+m_colour_head_motorbikes+"' ><b> Lending Amount </b></td>");
				
				out.println("<td width=\"10%\"  align='center' bgcolor='lightgray' ><b> Total </b></td>"); 
				
				out.println("<td width=\"10%\"  align='center' bgcolor='"+m_colour_total+"' ><b> Lending to previous day </b></td>");
				out.println("<td width=\"10%\"  align='center' bgcolor='"+m_colour_total+"' ><b> Lending amount of as at date </b></td>");
				out.println("<td width=\"10%\"  align='center' bgcolor='"+m_colour_total+"' ><b> Total lending as at date </b></td>");
				out.println("<td width=\"10%\"  align='center' bgcolor='"+m_colour_total+"' ><b> Last month as at date </b></td>");
				...
				Sql_data = " "+
								" SELECT "+
									...
									" NVL("+m_schema_name+".AF_CO_GET_REG_DESC(REGION_CODE),'Z - No Region') REGION_CODE "+
									    " FROM "+m_schema_name+".AF_TBL_LEND_SUM_LOC_BRK_DOWN "+
				...
				double m_REG_3W_COUNT = 0;
			    double m_REG_3W_AMOUNT = 0;
			    double m_UNREG_3W_COUNT = 0;
			    double m_UNREG_3W_AMOUNT = 0;
			    
			    double m_REG_OTHER_COUNT = 0;
			    double m_REG_OTHER_AMOUNT = 0;
			    double m_UNREG_OTHER_COUNT = 0;
			    double m_UNREG_OTHER_AMOUNT = 0;
			    
			    double m_REG_2W_COUNT = 0;
			    double m_REG_2W_AMOUNT = 0;
			    double m_UNREG_2W_COUNT = 0;
			    double m_UNREG_2W_AMOUNT = 0;
			    
			    double m_TOTAL = 0;
			    double m_PREVIOUS_DAY = 0;
			    double m_AS_AT_DAY = 0;
			    double m_TOTAL_LEND = 0;
			    double m_LAST_MONTH = 0;
				
				// ===========================================
				
				double m_sub_REG_3W_COUNT = 0;
			    double m_sub_REG_3W_AMOUNT = 0;
			    double m_sub_UNREG_3W_COUNT = 0;
			    double m_sub_UNREG_3W_AMOUNT = 0;
			    
			    double m_sub_REG_OTHER_COUNT = 0;
			    double m_sub_REG_OTHER_AMOUNT = 0;
			    double m_sub_UNREG_OTHER_COUNT = 0;
			    double m_sub_UNREG_OTHER_AMOUNT = 0;
			    
			    double m_sub_REG_2W_COUNT = 0;
			    double m_sub_REG_2W_AMOUNT = 0;
			    double m_sub_UNREG_2W_COUNT = 0;
			    double m_sub_UNREG_2W_AMOUNT = 0;
			    
			    double m_sub_TOTAL = 0;
			    double m_sub_PREVIOUS_DAY = 0;
			    double m_sub_AS_AT_DAY = 0;
			    double m_sub_TOTAL_LEND = 0;
			    double m_sub_LAST_MONTH = 0;
				...
				while(rs.next()){	
						...
						m_REG_3W_COUNT    = m_REG_3W_COUNT + rs.getDouble("REG_3W_COUNT");
					    m_REG_3W_AMOUNT   = m_REG_3W_AMOUNT + rs.getDouble("REG_3W_AMOUNT");
					    m_UNREG_3W_COUNT  = m_UNREG_3W_COUNT + rs.getDouble("UNREG_3W_COUNT");
					    m_UNREG_3W_AMOUNT = m_UNREG_3W_AMOUNT + rs.getDouble("UNREG_3W_AMOUNT");
					    
					    m_REG_OTHER_COUNT    = m_REG_OTHER_COUNT + rs.getDouble("REG_OTHER_COUNT");
					    m_REG_OTHER_AMOUNT   = m_REG_OTHER_AMOUNT + rs.getDouble("REG_OTHER_AMOUNT");
					    m_UNREG_OTHER_COUNT  = m_UNREG_OTHER_COUNT + rs.getDouble("UNREG_OTHER_COUNT");
					    m_UNREG_OTHER_AMOUNT = m_UNREG_OTHER_AMOUNT + rs.getDouble("UNREG_OTHER_AMOUNT");
					    
					    m_REG_2W_COUNT    = m_REG_2W_COUNT + rs.getDouble("REG_2W_COUNT");
					    m_REG_2W_AMOUNT   = m_REG_2W_AMOUNT + rs.getDouble("REG_2W_AMOUNT");
					    m_UNREG_2W_COUNT  = m_UNREG_2W_COUNT + rs.getDouble("UNREG_2W_COUNT");
					    m_UNREG_2W_AMOUNT = m_UNREG_2W_AMOUNT + rs.getDouble("UNREG_2W_AMOUNT");
					    
					    m_TOTAL        = m_TOTAL + rs.getDouble("TOTAL");
					    m_PREVIOUS_DAY = m_PREVIOUS_DAY + rs.getDouble("PREVIOUS_DAY");
					    m_AS_AT_DAY    = m_AS_AT_DAY + rs.getDouble("AS_AT_DAY");
					    m_TOTAL_LEND   = m_TOTAL_LEND + rs.getDouble("TOTAL_LEND");
					    m_LAST_MONTH   = m_LAST_MONTH + rs.getDouble("LAST_MONTH");
						...
						out.println("<td width=\"10%\"  align='right'  onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','REG_3W_AMOUNT');\" STYLE='{text-align:right;cursor:pointer;}'   ><u> "+nf1.format(rs.getDouble("REG_3W_COUNT"))+" </u></td>");
						out.println("<td width=\"10%\"  align='right'  onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','REG_3W_AMOUNT');\" STYLE='{text-align:right;cursor:pointer;}'   ><u> "+nf1.format(rs.getDouble("REG_3W_AMOUNT"))+" </u></td>");
						out.println("<td width=\"10%\"  align='right'  onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','UNREG_3W_AMOUNT');\" STYLE='{text-align:right;cursor:pointer;}' ><u> "+nf1.format(rs.getDouble("UNREG_3W_COUNT"))+" </u></td>");
						out.println("<td width=\"10%\"  align='right'  onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','UNREG_3W_AMOUNT');\" STYLE='{text-align:right;cursor:pointer;}' ><u> "+nf1.format(rs.getDouble("UNREG_3W_AMOUNT"))+" </u></td>");
						
						out.println("<td width=\"10%\"  align='right'  onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','REG_OTHER_AMOUNT');\" STYLE='{text-align:right;cursor:pointer;}'   ><u> "+nf1.format(rs.getDouble("REG_OTHER_COUNT"))+" </u></td>");
						out.println("<td width=\"10%\"  align='right'  onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','REG_OTHER_AMOUNT');\" STYLE='{text-align:right;cursor:pointer;}'   ><u> "+nf1.format(rs.getDouble("REG_OTHER_AMOUNT"))+" </u></td>");
						out.println("<td width=\"10%\"  align='right'  onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','UNREG_OTHER_AMOUNT');\" STYLE='{text-align:right;cursor:pointer;}' ><u> "+nf1.format(rs.getDouble("UNREG_OTHER_COUNT"))+" </u></td>");
						out.println("<td width=\"10%\"  align='right'  onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','UNREG_OTHER_AMOUNT');\" STYLE='{text-align:right;cursor:pointer;}' ><u> "+nf1.format(rs.getDouble("UNREG_OTHER_AMOUNT"))+" </u></td>");
						
						out.println("<td width=\"10%\"  align='right'  onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','REG_2W_AMOUNT');\" STYLE='{text-align:right;cursor:pointer;}'   ><u> "+nf1.format(rs.getDouble("REG_2W_COUNT"))+" </u></td>");
						out.println("<td width=\"10%\"  align='right'  onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','REG_2W_AMOUNT');\" STYLE='{text-align:right;cursor:pointer;}'   ><u> "+nf1.format(rs.getDouble("REG_2W_AMOUNT"))+" </u></td>");
						out.println("<td width=\"10%\"  align='right'  onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','UNREG_2W_AMOUNT');\" STYLE='{text-align:right;cursor:pointer;}' ><u> "+nf1.format(rs.getDouble("UNREG_2W_COUNT"))+" </u></td>");
						out.println("<td width=\"10%\"  align='right'  onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','UNREG_2W_AMOUNT');\" STYLE='{text-align:right;cursor:pointer;}' ><u> "+nf1.format(rs.getDouble("UNREG_2W_AMOUNT"))+" </u></td>");
						
						out.println("<td width=\"10%\"  align='right'  onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','TOTAL');\" STYLE='{text-align:right;cursor:pointer;}' ><u> "+nf1.format(rs.getDouble("TOTAL"))+"  </u></td>"); 
						
						out.println("<td width=\"10%\"  align='right'  onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','PREVIOUS_DAY');\" STYLE='{text-align:right;cursor:pointer;}' ><u> "+nf1.format(rs.getDouble("PREVIOUS_DAY"))+"  </u></td>");
						out.println("<td width=\"10%\"  align='right'  onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','AS_AT_DAY');\" STYLE='{text-align:right;cursor:pointer;}'    ><u> "+nf1.format(rs.getDouble("AS_AT_DAY"))+"   </u></td>");
						out.println("<td width=\"10%\"  align='right'  onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','TOTAL_LEND');\" STYLE='{text-align:right;cursor:pointer;}'   ><u> "+nf1.format(rs.getDouble("TOTAL_LEND"))+"  </u></td>");
						out.println("<td width=\"10%\"  align='right'  onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','LAST_MONTH');\" STYLE='{text-align:right;cursor:pointer;}'   ><u> "+nf1.format(rs.getDouble("LAST_MONTH"))+"  </u></td>");
						...
						*/
						...
						if(region_code.equals("")){
								...
								m_sub_REG_3W_COUNT    = m_sub_REG_3W_COUNT + rs.getDouble("REG_3W_COUNT");
							    m_sub_REG_3W_AMOUNT   = m_sub_REG_3W_AMOUNT + rs.getDouble("REG_3W_AMOUNT");
							    m_sub_UNREG_3W_COUNT  = m_sub_UNREG_3W_COUNT + rs.getDouble("UNREG_3W_COUNT");
							    m_sub_UNREG_3W_AMOUNT = m_sub_UNREG_3W_AMOUNT + rs.getDouble("UNREG_3W_AMOUNT");
							    
							    m_sub_REG_OTHER_COUNT    = m_sub_REG_OTHER_COUNT + rs.getDouble("REG_OTHER_COUNT");
							    m_sub_REG_OTHER_AMOUNT   = m_sub_REG_OTHER_AMOUNT + rs.getDouble("REG_OTHER_AMOUNT");
							    m_sub_UNREG_OTHER_COUNT  = m_sub_UNREG_OTHER_COUNT + rs.getDouble("UNREG_OTHER_COUNT");
							    m_sub_UNREG_OTHER_AMOUNT = m_sub_UNREG_OTHER_AMOUNT + rs.getDouble("UNREG_OTHER_AMOUNT");
							    
							    m_sub_REG_2W_COUNT    = m_sub_REG_2W_COUNT + rs.getDouble("REG_2W_COUNT");
							    m_sub_REG_2W_AMOUNT   = m_sub_REG_2W_AMOUNT + rs.getDouble("REG_2W_AMOUNT");
							    m_sub_UNREG_2W_COUNT  = m_sub_UNREG_2W_COUNT + rs.getDouble("UNREG_2W_COUNT");
							    m_sub_UNREG_2W_AMOUNT = m_sub_UNREG_2W_AMOUNT + rs.getDouble("UNREG_2W_AMOUNT");
							    
							    m_sub_TOTAL        = m_sub_TOTAL + rs.getDouble("TOTAL");
							    m_sub_PREVIOUS_DAY = m_sub_PREVIOUS_DAY + rs.getDouble("PREVIOUS_DAY");
							    m_sub_AS_AT_DAY    = m_sub_AS_AT_DAY + rs.getDouble("AS_AT_DAY");
							    m_sub_TOTAL_LEND   = m_sub_TOTAL_LEND + rs.getDouble("TOTAL_LEND");
							    m_sub_LAST_MONTH   = m_sub_LAST_MONTH + rs.getDouble("LAST_MONTH");
								...
								out.println("<td width=\"10%\"  align='right'  onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','REG_3W_AMOUNT');\" STYLE='{text-align:right;cursor:pointer;}'   bgcolor="+m_colour_cases+" ><u> "+nf1.format(rs.getDouble("REG_3W_COUNT"))+" </u></td>");
								out.println("<td width=\"10%\"  align='right'  onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','REG_3W_AMOUNT');\" STYLE='{text-align:right;cursor:pointer;}'   ><u> "+nf1.format(rs.getDouble("REG_3W_AMOUNT"))+" </u></td>");
								out.println("<td width=\"10%\"  align='right'  onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','UNREG_3W_AMOUNT');\" STYLE='{text-align:right;cursor:pointer;}' bgcolor="+m_colour_cases+" ><u> "+nf1.format(rs.getDouble("UNREG_3W_COUNT"))+" </u></td>");
								out.println("<td width=\"10%\"  align='right'  onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','UNREG_3W_AMOUNT');\" STYLE='{text-align:right;cursor:pointer;}' ><u> "+nf1.format(rs.getDouble("UNREG_3W_AMOUNT"))+" </u></td>");
								
								out.println("<td width=\"10%\"  align='right'  onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','REG_OTHER_AMOUNT');\" STYLE='{text-align:right;cursor:pointer;}'   bgcolor="+m_colour_cases+" ><u> "+nf1.format(rs.getDouble("REG_OTHER_COUNT"))+" </u></td>");
								out.println("<td width=\"10%\"  align='right'  onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','REG_OTHER_AMOUNT');\" STYLE='{text-align:right;cursor:pointer;}'   ><u> "+nf1.format(rs.getDouble("REG_OTHER_AMOUNT"))+" </u></td>");
								out.println("<td width=\"10%\"  align='right'  onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','UNREG_OTHER_AMOUNT');\" STYLE='{text-align:right;cursor:pointer;}' bgcolor="+m_colour_cases+" ><u> "+nf1.format(rs.getDouble("UNREG_OTHER_COUNT"))+" </u></td>");
								out.println("<td width=\"10%\"  align='right'  onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','UNREG_OTHER_AMOUNT');\" STYLE='{text-align:right;cursor:pointer;}' ><u> "+nf1.format(rs.getDouble("UNREG_OTHER_AMOUNT"))+" </u></td>");
								
								out.println("<td width=\"10%\"  align='right'  onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','REG_2W_AMOUNT');\" STYLE='{text-align:right;cursor:pointer;}'   bgcolor="+m_colour_cases+" ><u> "+nf1.format(rs.getDouble("REG_2W_COUNT"))+" </u></td>");
								out.println("<td width=\"10%\"  align='right'  onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','REG_2W_AMOUNT');\" STYLE='{text-align:right;cursor:pointer;}'   ><u> "+nf1.format(rs.getDouble("REG_2W_AMOUNT"))+" </u></td>");
								out.println("<td width=\"10%\"  align='right'  onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','UNREG_2W_AMOUNT');\" STYLE='{text-align:right;cursor:pointer;}' bgcolor="+m_colour_cases+" ><u> "+nf1.format(rs.getDouble("UNREG_2W_COUNT"))+" </u></td>");
								out.println("<td width=\"10%\"  align='right'  onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','UNREG_2W_AMOUNT');\" STYLE='{text-align:right;cursor:pointer;}' ><u> "+nf1.format(rs.getDouble("UNREG_2W_AMOUNT"))+" </u></td>");
								...
								out.println("<td width=\"10%\"  align='right'  ><b> "+nf1.format(m_sub_REG_3W_COUNT)+" </b></td>");
								out.println("<td width=\"10%\"  align='right'  ><b> "+nf1.format(m_sub_REG_3W_AMOUNT)+" </b></td>");
								out.println("<td width=\"10%\"  align='right'  ><b> "+nf1.format(m_sub_UNREG_3W_COUNT)+" </b></td>");
								out.println("<td width=\"10%\"  align='right'  ><b> "+nf1.format(m_sub_UNREG_3W_AMOUNT)+" </b></td>");
										
								out.println("<td width=\"10%\"  align='right'  ><b> "+nf1.format(m_sub_REG_OTHER_COUNT)+" </b></td>");
								out.println("<td width=\"10%\"  align='right'  ><b> "+nf1.format(m_sub_REG_OTHER_AMOUNT)+" </b></td>");
								out.println("<td width=\"10%\"  align='right'  ><b> "+nf1.format(m_sub_UNREG_OTHER_COUNT)+" </b></td>");
								out.println("<td width=\"10%\"  align='right'  ><b> "+nf1.format(m_sub_UNREG_OTHER_AMOUNT)+" </b></td>");
										
								out.println("<td width=\"10%\"  align='right'  ><b> "+nf1.format(m_sub_REG_2W_COUNT)+" </b></td>");
								out.println("<td width=\"10%\"  align='right'  ><b> "+nf1.format(m_sub_REG_2W_AMOUNT)+" </b></td>");
								out.println("<td width=\"10%\"  align='right'  ><b> "+nf1.format(m_sub_UNREG_2W_COUNT)+" </b></td>");
								out.println("<td width=\"10%\"  align='right'  ><b> "+nf1.format(m_sub_UNREG_2W_AMOUNT)+" </b></td>");
										
								out.println("<td width=\"10%\"  align='right'  ><b> "+nf1.format(m_sub_TOTAL)+"  </b></td>"); 
										
								out.println("<td width=\"10%\"  align='right'  ><b> "+nf1.format(m_sub_PREVIOUS_DAY)+"  </b></td>");
								out.println("<td width=\"10%\"  align='right'  ><b> "+nf1.format(m_sub_AS_AT_DAY)+"  </b></td>");
								out.println("<td width=\"10%\"  align='right'  ><b> "+nf1.format(m_sub_TOTAL_LEND)+"  </b></td>");
								out.println("<td width=\"10%\"  align='right'  ><b> "+nf1.format(m_sub_LAST_MONTH)+"  </b></td>");
										
								out.println("</tr>");
							
								region_code = rs.getString("REGION_CODE");
							
								m_sub_REG_3W_COUNT    = 0;
							    m_sub_REG_3W_AMOUNT   = 0;
							    m_sub_UNREG_3W_COUNT  = 0;
							    m_sub_UNREG_3W_AMOUNT = 0;
							    
							    m_sub_REG_OTHER_COUNT    = 0;
							    m_sub_REG_OTHER_AMOUNT   = 0;
							    m_sub_UNREG_OTHER_COUNT  = 0;
							    m_sub_UNREG_OTHER_AMOUNT = 0;
							    
							    m_sub_REG_2W_COUNT    = 0;
							    m_sub_REG_2W_AMOUNT   = 0;
							    m_sub_UNREG_2W_COUNT  = 0;
							    m_sub_UNREG_2W_AMOUNT = 0;
							    
							    m_sub_TOTAL        = 0;
							    m_sub_PREVIOUS_DAY = 0;
							    m_sub_AS_AT_DAY    = 0;
							    m_sub_TOTAL_LEND   = 0;
							    m_sub_LAST_MONTH   = 0;
				...
				out.println("<td width=\"10%\"  align='right'  ><b> "+nf1.format(m_REG_3W_COUNT)+" </b></td>");
				out.println("<td width=\"10%\"  align='right'  ><b> "+nf1.format(m_REG_3W_AMOUNT)+" </b></td>");
				out.println("<td width=\"10%\"  align='right'  ><b> "+nf1.format(m_UNREG_3W_COUNT)+" </b></td>");
				out.println("<td width=\"10%\"  align='right'  ><b> "+nf1.format(m_UNREG_3W_AMOUNT)+" </b></td>");
						
				out.println("<td width=\"10%\"  align='right'  ><b> "+nf1.format(m_REG_OTHER_COUNT)+" </b></td>");
				out.println("<td width=\"10%\"  align='right'  ><b> "+nf1.format(m_REG_OTHER_AMOUNT)+" </b></td>");
				out.println("<td width=\"10%\"  align='right'  ><b> "+nf1.format(m_UNREG_OTHER_COUNT)+" </b></td>");
				out.println("<td width=\"10%\"  align='right'  ><b> "+nf1.format(m_UNREG_OTHER_AMOUNT)+" </b></td>");
						
				out.println("<td width=\"10%\"  align='right'  ><b> "+nf1.format(m_REG_2W_COUNT)+" </b></td>");
				out.println("<td width=\"10%\"  align='right'  ><b> "+nf1.format(m_REG_2W_AMOUNT)+" </b></td>");
				out.println("<td width=\"10%\"  align='right'  ><b> "+nf1.format(m_UNREG_2W_COUNT)+" </b></td>");
				out.println("<td width=\"10%\"  align='right'  ><b> "+nf1.format(m_UNREG_2W_AMOUNT)+" </b></td>");
						
				out.println("<td width=\"10%\"  align='right'  ><b> "+nf1.format(m_TOTAL)+"  </b></td>"); 
						
				out.println("<td width=\"10%\"  align='right'  ><b> "+nf1.format(m_PREVIOUS_DAY)+"  </b></td>");
				out.println("<td width=\"10%\"  align='right'  ><b> "+nf1.format(m_AS_AT_DAY)+"  </b></td>");
				out.println("<td width=\"10%\"  align='right'  ><b> "+nf1.format(m_TOTAL_LEND)+"  </b></td>");
				out.println("<td width=\"10%\"  align='right'  ><b> "+nf1.format(m_LAST_MONTH)+"  </b></td>");
			...
			else if(m_chksql.equals("print_report_system_report_lending_main_drill")){	
				...
				out.println("<table align=\"center\" width=\"95%\" border=\"0\" class=\"table\">");
				out.println("<tr >");
				out.println("<td width=\"*\" STYLE='{font: bold 9pt arial; text-align:center;}'   ><u>Lending Performance Summary Report</u></td>"); 
				out.println("</tr >");
				out.println("</table >");
				out.println("<br>");
				out.println("<br>");
				...
				if(!m_date.equals(m_cur_date)){
					...
					if(m_report_type.equals("REG_3W_AMOUNT")){
									
									Sql_data="  "+
											" SELECT "+
					                            " FINANCE_NO, "+
					                            " NVL(TOTAL_FINANCE_AMOUNT,0) TOTAL_FINANCE_AMOUNT "+
					                            " FROM "+m_schema_name+".AF_TBL_LENDING_SUMMARY_HIS "+
						                            //" WHERE ENT_USER='"+m_username+"' "+
						                            " WHERE VEHICLE_CAT = '3W' "+
						                            " AND REG_STATUS  = 'Y' "+
						                            " AND ACTIVATED_DATE <= TO_DATE('"+m_date+"','DD-MM-YYYY') "+
								...
								else if(m_report_type.equals("UNREG_3W_AMOUNT")){
								...
								else if(m_report_type.equals("REG_OTHER_AMOUNT")){
								...
								else if(m_report_type.equals("UNREG_OTHER_AMOUNT")){
								...
								else if(m_report_type.equals("REG_2W_AMOUNT")){
								...
								else if(m_report_type.equals("UNREG_2W_AMOUNT")){
								...
								else if(m_report_type.equals("TOTAL")){
									...
									Sql_data="  "+
											" SELECT "+
					                            ...
					                            " FROM "+m_schema_name+".AF_TBL_LENDING_SUMMARY_HIS "+
						                            //" WHERE ENT_USER='"+m_username+"' "+
						                            " WHERE ACTIVATED_DATE <= TO_DATE('"+m_date+"','DD-MM-YYYY') "+
													" AND REPORT_DATE = TO_DATE('"+m_date+"','DD-MM-YYYY') "+
						                            "  "+sql_m_location+" "+
						                            "  "+sql_perform_status+"  "+
						                            "  "+m_active_status_string+" "+
								...
								else if(m_report_type.equals("PREVIOUS_DAY")){
								...
								else if(m_report_type.equals("AS_AT_DAY")){
								...
								else if(m_report_type.equals("TOTAL_LEND")){
								...
								else if(m_report_type.equals("LAST_MONTH")){
									
									Sql_data="  "+
											" SELECT "+
					                            " FINANCE_NO, "+
					                            " NVL(TOTAL_FINANCE_AMOUNT,0) TOTAL_FINANCE_AMOUNT "+
					                            " FROM "+m_schema_name+".AF_TBL_LEND_SUMM_RPT_PREV_HIS "+
						                            //" WHERE ENT_USER='"+m_username+"' "+
													" WHERE ACTIVATED_DATE <= TO_DATE('"+m_date+"','DD-MM-YYYY') "+
				                                    " AND ACTIVATED_DATE >= ADD_MONTHS(TRUNC(TO_DATE('"+m_date+"','DD-MM-YYYY'),'MONTH'),-1) "+
													" AND REPORT_DATE = ADD_MONTHS(TO_DATE('"+m_date+"','DD-MM-YYYY'),-1) "+
						                            "  "+sql_m_location+" "+
						                            "  "+sql_perform_status+"  "+
						                            "  "+m_active_status_string+" "+
						                            "  "+sql_m_region+" "+ 
								...
								if(m_report_type.equals("REG_3W_AMOUNT")){
									...
									Sql_data="  "+
											" SELECT "+
					                            " FINANCE_NO, "+
					                            " NVL(TOTAL_FINANCE_AMOUNT,0) TOTAL_FINANCE_AMOUNT "+
					                            " FROM "+m_schema_name+".AF_TBL_LENDING_SUMMARY_RPT "+
						                            " WHERE ENT_USER='"+m_username+"' "+
						                            " AND VEHICLE_CAT = '3W' "+
						                            " AND REG_STATUS  = 'Y' "+
						                            " AND ACTIVATED_DATE <= TO_DATE('"+m_date+"','DD-MM-YYYY') "+
									...
									Sql_data="  "+
											" SELECT "+
					                            " FINANCE_NO, "+
					                            " NVL(TOTAL_FINANCE_AMOUNT,0) TOTAL_FINANCE_AMOUNT "+
					                            " FROM "+m_schema_name+".AF_TBL_LEND_SUMM_RPT_PREV "+
						                            " WHERE ENT_USER='"+m_username+"' "+
													" AND ACTIVATED_DATE <= TO_DATE('"+m_date+"','DD-MM-YYYY') "+
				                                    " AND ACTIVATED_DATE >= ADD_MONTHS(TRUNC(TO_DATE('"+m_date+"','DD-MM-YYYY'),'MONTH'),-1) "+
						                            "  "+sql_m_location+" "+
