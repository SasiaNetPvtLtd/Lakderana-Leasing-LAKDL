...
public class LAKDL_AF_MISF_System_reports_below_above_coll_perform extends javax.servlet.http.HttpServlet { 
	...
	public  void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			if(m_chksql.equals("run_report")){ 
				...
				String m_report_cat = "";
				if(req.getParameter("report_cat") != null ){
					m_report_cat = req.getParameter("report_cat").trim();
				}

				
				try{

					callstmt1 = conn.prepareCall("BEGIN "+m_schema_name+".AF_PRO_SYS_REP_COLL_PERFORM(:1,:2,:3,:4,:5,:6,:7,:8);END;");
					...
					callstmt1.setString(8,m_report_cat);
					callstmt1.execute();
					out.print("OK");					
			...
			if(m_chksql.equals("main_page")){ 
				...
				out.println("<HTML>"); 
				out.println("<HEAD>"); 
				out.println("<TITLE>Below one year & Above one year Collection performance</TITLE>"); 
				out.println("</HEAD>"); 
				...
				out.println("   if(document.Form1.TXT_ONE_YEAR_BELOW.value=='ALL'){");
				out.println("      alert('Please select Below or Above to generate'); ");
				out.println("   }");
				out.println("   else{");
				...
				out.println("       	var m_report_cat = document.Form1.TXT_ONE_YEAR_BELOW.value; ");

				out.println("			m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_System_reports_below_above_coll_perform?chksql=run_report&date=\"+m_date+\"&location=\"+m_location+\"&officer=\"+m_officer+\"&active_status=\"+m_active_status+\"&region=\"+m_region+\"&perform_status=\"+m_perform_status+\"&report_cat=\"+m_report_cat;"); 
				...
				out.println("   if(document.Form1.TXT_ONE_YEAR_BELOW.value=='ALL'){ ");
				out.println("     alert('Please select Below or Above to view the report'); ");
				out.println("   }");
				...
				out.println("           var m_above_below_status = document.Form1.TXT_ONE_YEAR_BELOW.value;   "); 

				out.println("           m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_System_reports_below_above_coll_perform?chksql=print_report_collection_plan&location=\"+m_location+\"&officer=\"+m_officer+\"&date=\"+m_date+\"&active_status=\"+document.Form1.TXT_ACTIVE_STATUS.value+\"&region=\"+m_region+\"&perform_status=\"+m_perform_status+\"&above_below_status=\"+m_above_below_status;");
				...
				out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MISF_System_reports_below_above_coll_perform?chksql=main_page';"); 
				out.println("		}"); 
				out.println("}"); 
				...
				out.println("help_box.innerHTML=\" Below one year & Above one year Collection performance - \"+m_val;"); 
				out.println("}"); 
				out.println(""); 
				
				out.println("function load_roll_out_value(){");
				out.println("help_box.innerHTML=\" Below one year & Above one year Collection performance - \"+document.Form1.hid_status.value;"); 
				out.println("}"); 
				...
				out.println("</tr>"); 
				out.println("<tr>"); 
				out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Below one year & Above one year Collection performance </td>"); 
				out.println("</tr>"); 
				out.println("<tr>"); 
				...
				if(req.getParameter("above_below_status")!=null ){
					m_above_below_status=req.getParameter("above_below_status").trim();
				}
				...
				*/
				...
				// added by udara 04-09-2018
				
				int m_BELOW_REGION_TARGET = 0;
				int m_BELOW_TOTAL_TARGET  = 0;
				int m_ABOVE_REGION_TARGET = 0;
				int m_ABOVE_TOTAL_TARGET  = 0;
				
				int mm_REGION_TARGET  = 0;
				int mm_TOTAL_TARGET   = 0;
				
				rs1 = stmt.executeQuery(" "+
					" SELECT BELOW_REGION_TARGET, "+
							" BELOW_TOTAL_TARGET, "+
							" ABOVE_REGION_TARGET, "+
							" ABOVE_TOTAL_TARGET "+
								" FROM "+m_schema_name+".TBL_REGION_AND_TOTAL_TARGET "+
					" ");
				
				if(rs1.next()){
					  m_BELOW_REGION_TARGET = rs1.getInt("BELOW_REGION_TARGET");
				      m_BELOW_TOTAL_TARGET  = rs1.getInt("BELOW_TOTAL_TARGET");
				      m_ABOVE_REGION_TARGET = rs1.getInt("ABOVE_REGION_TARGET");
				      m_ABOVE_TOTAL_TARGET  = rs1.getInt("ABOVE_TOTAL_TARGET");
				}
				
				if(m_above_below_status.equals("BELOW")){
					mm_REGION_TARGET = m_BELOW_REGION_TARGET;
					mm_TOTAL_TARGET  = m_BELOW_TOTAL_TARGET;
				}
				else{
					mm_REGION_TARGET = m_ABOVE_REGION_TARGET;
					mm_TOTAL_TARGET  = m_ABOVE_TOTAL_TARGET;
				}
				
				// end by udara 04-09-2018
				...
				out.println("<HTML>"); 
				out.println("<HEAD>"); 
				out.println("<TITLE>Collection - Below one year & Above one year Collection performance</TITLE>"); 
				out.println("</HEAD>"); 
				out.println("<link REL='STYLESHEET' HREF='"+m_html_client_url+"/css/Asset_Financing_System.css' TYPE=\"text/css\">"); 
				out.println("<SCRIPT language=\"JavaScript\">"); 
				...
				out.println("  m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_System_reports_below_above_coll_perform?chksql=print_report_new_logic&location="+m_location+"&officer="+m_officer+"&date="+m_date+"&active_status="+m_active_status+"&region="+m_region+"&perform_status="+m_perform_status+"&sort_column=\"+m_sort_col+\"&order_by_type=\"+m_order_by_type;");	
				...
				out.println("           m_above_below_status = '"+m_above_below_status+"'; ");
				
				out.println("           m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_System_reports_below_above_coll_perform?chksql=print_report_collection_plan_main_drill&location=\"+m_location+\"&officer=\"+m_officer+\"&date=\"+m_date+\"&active_status=\"+m_active_status+\"&region=\"+m_region+\"&perform_status=\"+m_perform_status+\"&report_type=\"+m_report_type+\"&above_below_status=\"+m_above_below_status;"); // added by udara 26-09-2017
				...
				String m_colour_head_rental = "#66b3ff";
				String m_colour_head_arrears = "#66ff66";
				...
				out.println("<tr >");
				out.println("<td width=\"*\" STYLE='{font: bold 10pt arial; text-align:center;}'   ><u>Below one year & Above one year Collection performance</u></td>"); 
				out.println("</tr >");
				out.println("</table >");
				out.println("<br>");
				/*
				...
				out.println("<tr >");
				out.println("<td width=\"150\" STYLE='{font: bold 8pt arial; text-align:left;}'   >Below one year & Above one year Collection performance for the</td>"); 
				...
				*/
				...
				out.println("<td width=\"16%\"  align='center' bgcolor='lightgray' colspan=3 ><b> &nbsp; </b></td>"); 
				
				out.println("<td width=\"10%\"  align='center' bgcolor='"+m_colour_head_rental+"' colspan=5 ><b> RENTAL </b></td>"); 
				
				out.println("<td width=\"32%\"  align='center' bgcolor='"+m_colour_head_arrears+"' colspan=6 ><b> ARREARS </b></td>"); 
				...
				out.println("<td width=\"4%\"  align='center' bgcolor='lightgray' ><b> No. of cases </b></td>"); 
				...
				out.println("<td width=\"4%\"  align='center' bgcolor='lightgray' ><b> Rental Collected As At "+m_date+" </b></td>"); // m_run_date_2
				...
				if(m_run_days<5)
					out.println("<td width=\"4%\"  align='center' bgcolor='lightgray' ><b> Due Arrears (1) </b></td>");
				else if(m_run_days >=5 && m_run_days < 10)
				    out.println("<td width=\"4%\"  align='center' bgcolor='lightgray' ><b> Due Arrears (1,5) </b></td>");
				else if(m_run_days >=10 && m_run_days < 15)
					out.println("<td width=\"4%\"  align='center' bgcolor='lightgray' ><b> Due Arrears (1,5,10) </b></td>");
				else if(m_run_days >=15 && m_run_days < 20)
					out.println("<td width=\"4%\"  align='center' bgcolor='lightgray' ><b> Due Arrears (1,5,10,15) </b></td>");
				else
					out.println("<td width=\"4%\"  align='center' bgcolor='lightgray' ><b> Due Arrears (1,5,10,15,20) </b></td>");
				
				//out.println("<td width=\"4%\"  align='center' bgcolor='lightgray' ><b> Due Arrears (1,5,10,15,20) </b></td>");
				out.println("<td width=\"4%\"  align='center' bgcolor='lightgray' ><b> Arrears Collected As At "+m_date+" </b></td>"); // m_run_date_2
				out.println("<td width=\"4%\"  align='center' bgcolor='lightgray' ><b> % </b></td>");
				out.println("<td width=\"4%\"  align='center' bgcolor='lightgray' ><b> Last Month As At Date</b></td>");
				...
				Sql_data = " "+
						" SELECT "+
							...
							" NVL("+m_schema_name+".AF_CO_GET_REG_DESC(REGION_CODE),'Z - No Region') REGION_CODE "+
								" FROM "+m_schema_name+".AF_TBL_SYS_REP_COLL_PER_SUM "+
				...
				double m_LAST_MONTH_RENTAL = 0;
				double m_RENTAL_TARGET = 0;
				double m_NEED_TO_COLL_RENTAL = 0;
				double m_TOTAL_ARREARS = 0;
				double m_ARR_COLLECTION = 0;
				double m_LAST_MONTH_ARR = 0;
				double m_ARR_TARGET = 0;
				double m_NEED_TO_COLL_ARR = 0;
				int m_NO_OF_CASE = 0;
				...
				double m_sub_LAST_MONTH_RENTAL = 0;
				double m_sub_RENTAL_TARGET = 0;
				double m_sub_NEED_TO_COLL_RENTAL = 0;
				double m_sub_TOTAL_ARREARS = 0;
				double m_sub_ARR_COLLECTION = 0;
				double m_sub_LAST_MONTH_ARR = 0;
				double m_sub_ARR_TARGET = 0;
				double m_sub_NEED_TO_COLL_ARR = 0;
				int m_sub_NO_OF_CASE = 0;
				
				double sub_rental_perc = 0;
				double sub_arr_perc = 0;
				
				int sub_count = 0;
				
				double sub_last_rental_perc = 0;
				double sub_last_arr_perc = 0;
				...
				while(rs.next()){	
						...
						m_LAST_MONTH_RENTAL = m_LAST_MONTH_RENTAL + rs.getDouble("LAST_MONTH_RENTAL");
						m_RENTAL_TARGET = m_RENTAL_TARGET + rs.getDouble("RENTAL_TARGET");
					    m_NEED_TO_COLL_RENTAL = m_NEED_TO_COLL_RENTAL + rs.getDouble("NEED_TO_COLL_RENTAL");
						m_TOTAL_ARREARS = m_TOTAL_ARREARS + rs.getDouble("TOTAL_ARREARS");
						m_ARR_COLLECTION = m_ARR_COLLECTION + rs.getDouble("ARR_COLLECTION");
						m_LAST_MONTH_ARR = m_LAST_MONTH_ARR + rs.getDouble("LAST_MONTH_ARR");
						m_ARR_TARGET = m_ARR_TARGET + rs.getDouble("ARR_TARGET");
						m_NEED_TO_COLL_ARR = m_NEED_TO_COLL_ARR + rs.getDouble("NEED_TO_COLL_ARR");
						m_NO_OF_CASE = m_NO_OF_CASE + rs.getInt("NO_OF_CASE");
						...
						out.println("<td width=\"4%\"  align='left'   STYLE='cursor:hand; text-align:left;' onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','BRANCH_DRILL');\" > "+rs.getString("BRANCH_DESC")+" </td>"); // BRANCH_CODE
						
						out.println("<td width=\"4%\"  align='right'  STYLE='cursor:hand; text-align:right;' onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','BRANCH_DRILL');\" > "+rs.getInt("NO_OF_CASE")+" </td>"); 
						out.println("<td width=\"4%\"  align='right'  STYLE='cursor:hand; text-align:right;' onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','BRANCH_DRILL');\" > "+nf1.format(rs.getDouble("RENTAL_AMOUNT"))+" </td>");
						
						out.println("<td width=\"4%\"  align='right'  STYLE='cursor:hand; text-align:right;' onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','BRANCH_DRILL');\" > "+nf.format(rs.getDouble("RENTAL_AMOUNT_NEW"))+" </td>");
						out.println("<td width=\"4%\"  align='right'  STYLE='cursor:hand; text-align:right;' onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','BRANCH_DRILL');\" > "+nf.format(rs.getDouble("RENTAL_PERCENTAGE"))+" </td>");
						out.println("<td width=\"4%\"  align='right'  STYLE='cursor:hand; text-align:right;' onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','BRANCH_DRILL');\" > "+nf.format(rs.getDouble("LAST_MONTH_RENTAL"))+" </td>");
						out.println("<td width=\"4%\"  align='right'  STYLE='cursor:hand; text-align:right;' onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','BRANCH_DRILL');\" > "+nf1.format(rs.getDouble("RENTAL_TARGET"))+" </td>");
						out.println("<td width=\"4%\"  align='right'  STYLE='cursor:hand; text-align:right;' onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','BRANCH_DRILL');\" > "+nf.format(rs.getDouble("NEED_TO_COLL_RENTAL"))+" </td>");
						
						out.println("<td width=\"4%\"  align='right'  STYLE='cursor:hand; text-align:right;' onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','BRANCH_DRILL');\" > "+nf.format(rs.getDouble("TOTAL_ARREARS"))+" </td>");
						out.println("<td width=\"4%\"  align='right'  STYLE='cursor:hand; text-align:right;' onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','BRANCH_DRILL');\" > "+nf.format(rs.getDouble("ARR_COLLECTION"))+" </td>");
						out.println("<td width=\"4%\"  align='right'  STYLE='cursor:hand; text-align:right;' onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','BRANCH_DRILL');\" > "+nf.format(rs.getDouble("ARR_PERCENTAGE"))+" </td>");
						out.println("<td width=\"4%\"  align='right'  STYLE='cursor:hand; text-align:right;' onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','BRANCH_DRILL');\" > "+nf.format(rs.getDouble("LAST_MONTH_ARR"))+" </td>");
						out.println("<td width=\"4%\"  align='right'  STYLE='cursor:hand; text-align:right;' onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','BRANCH_DRILL');\" > "+nf1.format(rs.getDouble("ARR_TARGET"))+" </td>");
						out.println("<td width=\"4%\"  align='right'  STYLE='cursor:hand; text-align:right;' onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','BRANCH_DRILL');\" > "+nf.format(rs.getDouble("NEED_TO_COLL_ARR"))+" </td>");
						...
						*/
						...
						if(region_code.equals("")){
							...
							m_sub_LAST_MONTH_RENTAL = m_sub_LAST_MONTH_RENTAL + rs.getDouble("LAST_MONTH_RENTAL");
							m_sub_RENTAL_TARGET = m_sub_RENTAL_TARGET + rs.getDouble("RENTAL_TARGET");
						    m_sub_NEED_TO_COLL_RENTAL = m_sub_NEED_TO_COLL_RENTAL + rs.getDouble("NEED_TO_COLL_RENTAL");
							...
							m_sub_LAST_MONTH_ARR = m_sub_LAST_MONTH_ARR + rs.getDouble("LAST_MONTH_ARR");
							m_sub_ARR_TARGET = m_sub_ARR_TARGET + rs.getDouble("ARR_TARGET");
							m_sub_NEED_TO_COLL_ARR = m_sub_NEED_TO_COLL_ARR + rs.getDouble("NEED_TO_COLL_ARR");
							m_sub_NO_OF_CASE = m_sub_NO_OF_CASE + rs.getInt("NO_OF_CASE");
							...
							//out.println("<td width=\"4%\"  align='left'   STYLE='cursor:hand; text-align:left;'  ><b> "+region_code+" </b></td>"); // BRANCH_CODE
							
							out.println("<td width=\"4%\"  align='right'  STYLE='cursor:hand; text-align:right;' > &nbsp; </td>"); 
							out.println("<td width=\"4%\"  align='right'  STYLE='cursor:hand; text-align:right;' > &nbsp; </td>");
							...
							out.println("<td width=\"4%\"  align='right'  STYLE='cursor:hand; text-align:right;' onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','BRANCH_DRILL');\" > "+rs.getInt("NO_OF_CASE")+" </td>"); 
							out.println("<td width=\"4%\"  align='right'  STYLE='cursor:hand; text-align:right;' onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','BRANCH_DRILL');\" bgcolor="+m_colour_col_due+" > "+nf1.format(rs.getDouble("RENTAL_AMOUNT"))+" </td>");
							
							out.println("<td width=\"4%\"  align='right'  STYLE='cursor:hand; text-align:right;' onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','BRANCH_DRILL');\" bgcolor="+m_colour_col_collected+" > "+nf1.format(rs.getDouble("RENTAL_AMOUNT_NEW"))+" </td>");
							out.println("<td width=\"4%\"  align='right'  STYLE='cursor:hand; text-align:right;' onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','BRANCH_DRILL');\" bgcolor="+m_colour_col_cases+" > "+nf1.format(rs.getDouble("RENTAL_PERCENTAGE"))+" </td>");
							out.println("<td width=\"4%\"  align='right'  STYLE='cursor:hand; text-align:right;' onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','BRANCH_DRILL');\" bgcolor="+m_colour_col_cases+" > "+nf1.format(rs.getDouble("LAST_MONTH_RENTAL"))+" </td>");
							out.println("<td width=\"4%\"  align='right'  STYLE='cursor:hand; text-align:right;' onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','BRANCH_DRILL');\" bgcolor="+m_colour_col_due+" > "+nf1.format(rs.getDouble("RENTAL_TARGET"))+" </td>");
							out.println("<td width=\"4%\"  align='right'  STYLE='cursor:hand; text-align:right;' onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','BRANCH_DRILL');\" bgcolor="+m_colour_col_due+" > "+nf1.format(rs.getDouble("NEED_TO_COLL_RENTAL"))+" </td>");
							
							out.println("<td width=\"4%\"  align='right'  STYLE='cursor:hand; text-align:right;' onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','BRANCH_DRILL');\" bgcolor="+m_colour_col_due+" > "+nf1.format(rs.getDouble("TOTAL_ARREARS"))+" </td>");
							out.println("<td width=\"4%\"  align='right'  STYLE='cursor:hand; text-align:right;' onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','BRANCH_DRILL');\" bgcolor="+m_colour_col_collected+" > "+nf1.format(rs.getDouble("ARR_COLLECTION"))+" </td>");
							out.println("<td width=\"4%\"  align='right'  STYLE='cursor:hand; text-align:right;' onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','BRANCH_DRILL');\" bgcolor="+m_colour_col_cases+" > "+nf1.format(rs.getDouble("ARR_PERCENTAGE"))+" </td>");
							out.println("<td width=\"4%\"  align='right'  STYLE='cursor:hand; text-align:right;' onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','BRANCH_DRILL');\" bgcolor="+m_colour_col_cases+" > "+nf1.format(rs.getDouble("LAST_MONTH_ARR"))+" </td>");
							out.println("<td width=\"4%\"  align='right'  STYLE='cursor:hand; text-align:right;' onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','BRANCH_DRILL');\" bgcolor="+m_colour_col_due+" > "+nf1.format(rs.getDouble("ARR_TARGET"))+" </td>");
							out.println("<td width=\"4%\"  align='right'  STYLE='cursor:hand; text-align:right;' onclick=\"show_drill_down('"+rs.getString("BRANCH_CODE")+"','BRANCH_DRILL');\" bgcolor="+m_colour_col_due+" > "+nf1.format(rs.getDouble("NEED_TO_COLL_ARR"))+" </td>");
							...
							if(m_sub_RENTAL_AMOUNT>0){
								sub_rental_perc = (m_sub_RENTAL_AMOUNT_NEW / m_sub_RENTAL_AMOUNT) * 100;
							}
							else{
								sub_rental_perc = 0;
							}
							...
							if(m_sub_TOTAL_ARREARS>0){
								sub_arr_perc = (m_sub_ARR_COLLECTION / m_sub_TOTAL_ARREARS) * 100;
							}
							else{
								sub_arr_perc = 0;
							}
							...
							sub_last_rental_perc = 0;
							sub_last_arr_perc = 0;
							
							if(sub_count>0){
								sub_last_rental_perc = m_sub_LAST_MONTH_RENTAL / sub_count; 
								sub_last_arr_perc = m_sub_LAST_MONTH_ARR / sub_count; 
								m_sub_RENTAL_TARGET = m_sub_RENTAL_TARGET / sub_count;
								m_sub_ARR_TARGET = m_sub_ARR_TARGET / sub_count;
							}
							...
							out.println("<td width=\"4%\"  align='right'  STYLE='cursor:hand; text-align:right;' ><b> "+m_sub_NO_OF_CASE+" </b></td>"); 
							out.println("<td width=\"4%\"  align='right'  STYLE='cursor:hand; text-align:right;' ><b> "+nf1.format(m_sub_RENTAL_AMOUNT)+" </b></td>");
										
							out.println("<td width=\"4%\"  align='right'  STYLE='cursor:hand; text-align:right;' ><b> "+nf1.format(m_sub_RENTAL_AMOUNT_NEW)+" </b></td>");
							out.println("<td width=\"4%\"  align='right'  STYLE='cursor:hand; text-align:right;' ><b> "+nf1.format(sub_rental_perc)+" </b></td>");
							out.println("<td width=\"4%\"  align='right'  STYLE='cursor:hand; text-align:right;' ><b> "+nf1.format(sub_last_rental_perc)+" </b></td>");
							//out.println("<td width=\"4%\"  align='right'  STYLE='cursor:hand; text-align:right;' ><b> "+nf1.format(m_sub_RENTAL_TARGET)+" </b></td>");
							out.println("<td width=\"4%\"  align='right'  STYLE='cursor:hand; text-align:right;' ><b> "+nf1.format(mm_REGION_TARGET)+" </b></td>");
							out.println("<td width=\"4%\"  align='right'  STYLE='cursor:hand; text-align:right;' ><b> "+nf1.format(m_sub_NEED_TO_COLL_RENTAL)+" </b></td>");
										
							out.println("<td width=\"4%\"  align='right'  STYLE='cursor:hand; text-align:right;' ><b> "+nf1.format(m_sub_TOTAL_ARREARS)+" </b></td>");
							out.println("<td width=\"4%\"  align='right'  STYLE='cursor:hand; text-align:right;' ><b> "+nf1.format(m_sub_ARR_COLLECTION)+" </b></td>");
							out.println("<td width=\"4%\"  align='right'  STYLE='cursor:hand; text-align:right;' ><b> "+nf1.format(sub_arr_perc)+" </b></td>");
							out.println("<td width=\"4%\"  align='right'  STYLE='cursor:hand; text-align:right;' ><b> "+nf1.format(sub_last_arr_perc)+" </b></td>");
							out.println("<td width=\"4%\"  align='right'  STYLE='cursor:hand; text-align:right;' ><b> "+nf1.format(m_sub_ARR_TARGET)+" </b></td>");
							out.println("<td width=\"4%\"  align='right'  STYLE='cursor:hand; text-align:right;' ><b> "+nf1.format(m_sub_NEED_TO_COLL_ARR)+" </b></td>");
							...
							m_sub_LAST_MONTH_RENTAL = 0;
							m_sub_RENTAL_TARGET = 0;
						    m_sub_NEED_TO_COLL_RENTAL = 0;
							m_sub_TOTAL_ARREARS = 0;
							m_sub_ARR_COLLECTION = 0;
							m_sub_LAST_MONTH_ARR = 0;
							m_sub_ARR_TARGET = 0;
							m_sub_NEED_TO_COLL_ARR = 0;
							m_sub_NO_OF_CASE = 0;
				...
				double rental_perc = 0;
				double arr_perc = 0;
				
				if(m_RENTAL_AMOUNT>0){
					rental_perc = (m_RENTAL_AMOUNT_NEW / m_RENTAL_AMOUNT) * 100;
				}
				else{
					rental_perc = 0;
				}
				...
				if(m_TOTAL_ARREARS>0){
					arr_perc = (m_ARR_COLLECTION / m_TOTAL_ARREARS) * 100;
				}
				else{
					arr_perc = 0;
				}
				
				double last_rental_perc = 0;
				double last_arr_perc = 0;
				
				if(count>0){
					last_rental_perc = m_LAST_MONTH_RENTAL / count; 
					last_arr_perc = m_LAST_MONTH_ARR / count; 
					m_RENTAL_TARGET = m_RENTAL_TARGET / count;
					m_ARR_TARGET = m_ARR_TARGET / count; 
				}
				...
				out.println("<td width=\"4%\"  align='right'  ><b> "+m_NO_OF_CASE+" </b></td>");
				out.println("<td width=\"4%\"  align='right'  ><b> "+nf1.format(m_RENTAL_AMOUNT)+" </b></td>"); 
				
				out.println("<td width=\"4%\"  align='right'  ><b> "+nf1.format(m_RENTAL_AMOUNT_NEW)+" </b></td>");
				out.println("<td width=\"4%\"  align='right'  ><b> "+nf1.format(rental_perc)+" </b></td>");
				out.println("<td width=\"4%\"  align='right'  ><b> "+nf1.format(last_rental_perc)+" </b></td>"); // "+nf.format(m_LAST_MONTH_RENTAL)+" 
				//out.println("<td width=\"4%\"  align='right'  ><b> "+nf1.format(m_RENTAL_TARGET)+" </b></td>");
				out.println("<td width=\"4%\"  align='right'  ><b> "+nf1.format(mm_TOTAL_TARGET)+" </b></td>");
				out.println("<td width=\"4%\"  align='right'  ><b> "+nf1.format(m_NEED_TO_COLL_RENTAL)+" </b></td>");
				
				out.println("<td width=\"4%\"  align='right'  ><b> "+nf1.format(m_TOTAL_ARREARS)+" </b></td>");		
				out.println("<td width=\"4%\"  align='right'  ><b> "+nf1.format(m_ARR_COLLECTION)+" </b></td>");
				out.println("<td width=\"4%\"  align='right'  ><b> "+nf1.format(arr_perc)+" </b></td>");
				out.println("<td width=\"4%\"  align='right'  ><b> "+nf1.format(last_arr_perc)+" </b></td>"); // "+nf.format(m_LAST_MONTH_ARR)+"
				out.println("<td width=\"4%\"  align='right'  ><b> "+nf1.format(m_ARR_TARGET)+" </b></td>");
				out.println("<td width=\"4%\"  align='right'  ><b> "+nf1.format(m_NEED_TO_COLL_ARR)+" </b></td>");
				...
				*/
				...
				out.println("<td width=\"4%\"  align='center' bgcolor='lightgray' ><b> Due Rental (1,5,10,15,20) </b></td>");				
				out.println("<td width=\"4%\"  align='center' bgcolor='lightgray' ><b> Rental Collected As At "+m_run_date_2+" </b></td>");
				out.println("<td width=\"4%\"  align='center' bgcolor='lightgray' ><b> Due Arrears (1,5,10,15,20) </b></td>");
				out.println("<td width=\"4%\"  align='center' bgcolor='lightgray' ><b> Arrears Collected As At "+m_run_date_2+" </b></td>");
				out.println("</tr>");
				...
				Sql_data = " "+
						" SELECT "+
							...
							" TOTAL_ARREARS, "+
							" ARR_COLLECTION "+
								" FROM "+m_schema_name+".AF_TBL_SYS_REP_COLL_PERFORM "+
								" WHERE ENT_USER = '"+m_username+"' "+ 
								" AND BRANCH_CODE = '"+m_location+"' "+
								" AND REPORT_DATE = TO_DATE('"+m_date+"','DD-MM-YYYY')  "+
								" AND ABOVE_BELOW_STATUS = '"+m_above_below_status+"' "+ 
								" ";
				...
				while(rs.next()){	
						...
						out.println("<tr>");
						out.println("<td width=\"4%\"  align='left'   > "+count+" </td>"); 
						out.println("<td width=\"4%\"  align='left'   STYLE='cursor:hand; text-align:left;'   > "+rs.getString("FINANCE_NO")+" </td>"); 
						out.println("<td width=\"4%\"  align='right'  STYLE='cursor:hand; text-align:right;'  > "+nf1.format(rs.getDouble("RENTAL_AMOUNT"))+" </td>");
						out.println("<td width=\"4%\"  align='right'  STYLE='cursor:hand; text-align:right;'  > "+nf1.format(rs.getDouble("RENTAL_AMOUNT_NEW"))+" </td>");
						out.println("<td width=\"4%\"  align='right'  STYLE='cursor:hand; text-align:right;'  > "+nf1.format(rs.getDouble("TOTAL_ARREARS"))+" </td>");
						out.println("<td width=\"4%\"  align='right'  STYLE='cursor:hand; text-align:right;'  > "+nf1.format(rs.getDouble("ARR_COLLECTION"))+" </td>");
						out.println("</tr>");
				...
				out.println("<tr>");	
				out.println("<td width=\"4%\"  align='left'   ><b> "+count+" </b></td>"); 		
