...
public class LAKDL_AF_CR_change_cap_allow extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res) { 
      ...
      String m_username = m_sn_methods.username;
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE> Finance - Change Capital Allowance Rates</TITLE>"); 
			out.println("</HEAD>"); 
      ...
      out.println("      display_data(data_vec);"); 		
			...
			out.println("function load_invoices(m_app_no){");
			out.println("m_url='"+m_class_url+"/"+m_fschema_name+"AF_MAS_rpt_user_approval?chksql=LOAD_INVOICE_DETAILS&app_no='+m_app_no;"); 
			out.println("load_interface(m_url,'NOR');");
		 	out.println("}");
			...
			out.println("						document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_CR_save_change_cap_allow';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_CR_change_cap_allow?chksql=main_page';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("    m_help_message = \"m_help_msg_LAKDL_AF_CR_change_cap_allow\";"); 
			...
			out.println("help_box.innerHTML=\" Finance - Change Capital Allowance Rates - \"+m_val;"); 
			out.println("}"); 
		
			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" Finance - Change Capital Allowance Rates  \";"); 
			out.println("}"); 
			...
			out.println("		help_value_assign_invoice(document.Form1.hid_row_no.value,oBj);"); 
			out.println("	}");					
			out.println("	}"); 
			out.println("	}"); 
			out.println("	else{"); 
			...
			out.println("    HelpBox('1','10','0',Crit,'FinanceSql_change_cap_allow','2');");
			out.println("}");
			...
			out.println("		load_invoices(oBj.valout[3])");
			out.println("}");
					
			out.println("function help_invoice(rowNo,m_app_no) {");
			out.println("    document.Form1.hid_help_type.value=\"4\";"); 
			out.println("    m_invoice = \"TXT_INVOICE_NO_\"+rowNo;");
			out.println("    document.Form1.hid_row_no.value=rowNo;"); 
			out.println("    Sql  = \"InvoiceSql_change_cap_allow\";"); 
			out.println("    Crit = m_app_no+\"@\"+document.Form1.elements[m_invoice].value+\"@Y@\";"); 
			out.println("    HelpBox('1','10','3',Crit,Sql,'4');"); 
			out.println("}"); 

		
			out.println("function help_value_assign_invoice(rowNo,oBj) {"); 					
			out.println("		m_invoice=\"TXT_INVOICE_NO_\"+rowNo;");
			out.println("		m_vehicle_no=\"TXT_VEHICLE_NO_\"+rowNo;");	
			out.println("		m_engine_no=\"TXT_ENGINE_NO_\"+rowNo;");	
			out.println("		m_chassis_no=\"TXT_CHASSIS_NO_\"+rowNo;");	
			out.println("		m_tot=\"TXT_TOT_AMOUNT_\"+rowNo;");	
			out.println("		m_net=\"TXT_NET_PRICE_\"+rowNo;");	
			out.println("		m_cap=\"TXT_CAPITAL_ALLOW_\"+rowNo;");	
			out.println("   document.Form1.elements[m_invoice].value=oBj.valout[2];"); 
			out.println("   document.Form1.elements[m_vehicle_no].value=oBj.valout[3];"); 
			out.println("   document.Form1.elements[m_engine_no].value=oBj.valout[4];"); 
			out.println("   document.Form1.elements[m_chassis_no].value=oBj.valout[5];"); 
			out.println("   document.Form1.elements[m_tot].value=oBj.valout[6];"); 
			out.println("   format_number(document.Form1.elements[m_tot],20);");
			out.println("   document.Form1.elements[m_net].value=oBj.valout[7];"); 
			out.println("   format_number(document.Form1.elements[m_net],20);");
			out.println("   document.Form1.elements[m_cap].value=oBj.valout[8];"); 
			out.println("   format_number(document.Form1.elements[m_cap],6);");
			out.println("}");

					
			out.println("function help_button_2(Start,End,Hid_No,Sql,IfCount) {"); 
			out.println("    document.Form1.hid_help_type.value=\"3\";"); 
			out.println("    Crit =document.Form1.TXT_APPLICANT_CODE.value+\"@\"+document.Form1.TXT_FINANCE_NO.value+\"@Y@\";"); 
			out.println("    HelpBox(Start,End,Hid_No,Crit,Sql,IfCount);"); 
			out.println("}"); 
			...
			out.println("}		"); 					
			    ...
			    out.println("<INPUT TYPE='Hidden' NAME='hid_close_sts' VALUE=\"N\">"); 
					...
					out.println("</tr>"); 
					out.println("<tr>"); 
					out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Finance - Change Capital Allowance Rates </td>"); 
					out.println("</tr>"); 
					out.println("<tr>"); 
	    		...
	    		out.println("<td width='10%' align='center'><input type=button name=back value=\"Close\" class=mainbut onclick=close_screen(); onMouseOver='load_roll_value(\"Close\");' onmouseout='load_roll_value(\"Close\");'></td>");
			   	...
			   	out.println("<td width='100%'>");	
					...
					out.println("<tr >"); 
					out.println("<td  width='20%' ><DIV id='DIV_TXT_FINANCE_NO'  class=div_input><b>Finance Number *</b></DIV></td>"); 
					...
					out.println("<td width='28%' ><input class='txt_input' type='text' name='TXT_APPLICANT_CODE' maxlength='10' size='10' onblur=\"help_button_2('1','10','0','ClientSql_change_cap_allow','3')\">"); 
					out.println("<input class='but_input' type='button' name='BUT_TXT_APPLICANT_CODE' value=\"...\" onClick=\"help_button_2('1','10','0','ClientSql_change_cap_allow','3')\"></td>"); 
