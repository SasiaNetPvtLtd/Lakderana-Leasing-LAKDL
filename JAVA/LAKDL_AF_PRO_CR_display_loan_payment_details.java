...
public class LAKDL_AF_PRO_CR_display_loan_payment_details extends javax.servlet.http.HttpServlet { 
	Connection conn;
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
		  ...
		  m_order_by_type = "DESC";
			...
			out.println("	m_url = '"+m_class_url+"/"+m_fschema_name+"AF_PRO_CR_display_pay_req_details?TOT_SET='+document.Form1.elements[\"TXT_TOT_SETTLE_AMT_\"+m_row].value+'&INIT_BAL='+document.Form1.elements[\"TXT_INIT_BAL_AMT_\"+m_row].value+'&CURR_CODE='+document.Form1.elements[\"TXT_CURR_CODE_\"+m_row].value+'&APP_NO='+document.Form1.elements[\"TXT_APP_NO_\"+m_row].value+'&BAL='+document.Form1.elements[\"TXT_BAL_TO_BE_PAID_\"+m_row].value+'&VALUE_DATE='+document.Form1.elements[\"TXT_VALUE_DATE_\"+m_row].value+'&screen_type=L&chksql1="+m_chksql1+"';"); 
      ...
      out.println("}");
			...
			out.println("}");
			out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_PRO_CR_save_loan_payment_details?screen_type="+m_screen_type+"&level="+m_level+"&number='+document.Form1.hid_count.value+'&status="+m_status+"&chksql="+m_chksql+"&chksql1="+m_chksql1+"';");   
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_PRO_CR_display_loan_payment_details?screen_type="+m_screen_type+"&sql=main_page&status_new="+m_status_new+"&chksql='+st_val+'&chksql2='+st_val1+'';");
			out.println("		}"); 
			out.println("}"); 

			out.println("function new_window(){	"); 
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_PRO_CR_display_loan_payment_details?screen_type=NEW&sql=main_page&status_new="+m_status_new+"&chksql='+st_val+'&chksql2='+st_val1+'&st_c="+m_sort_column+"&oby="+m_order_by_type+"';");
			out.println("}"); 
			

			out.println("function edit_window(){	"); 
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_PRO_CR_display_loan_payment_details?screen_type=EDIT&sql=main_page&status_edit="+m_status_edit+"&chksql='+st_val+'&chksql2='+st_val1+'&st_c="+m_sort_column+"&oby="+m_order_by_type+"';");
			out.println("}"); 
	  	...
	  	out.println("		}"); 
			...
			out.println("		if(confirm(\"Are you sure you want to generate Payment Requisition?\")){ "); 
			out.println("	m_url = '"+m_class_url+"/"+m_fschema_name+"AF_PRO_CR_display_pay_req_details?TOT_SET='+document.Form1.elements[\"TXT_TOT_SETTLE_AMT_\"+row].value+'&INIT_BAL='+document.Form1.elements[\"TXT_INIT_BAL_AMT_\"+row].value+'&CURR_CODE='+document.Form1.elements[\"TXT_CURR_CODE_\"+row].value+'&APP_NO='+document.Form1.elements[\"TXT_APP_NO_\"+row].value+'&BAL='+document.Form1.elements[\"TXT_BAL_TO_BE_PAID_\"+row].value+'&VALUE_DATE='+document.Form1.elements[\"TXT_VALUE_DATE_\"+row].value+'&screen_type=L&chksql1="+m_chksql1+"';"); 
		  ...
		  //out.println("	m_url = '"+m_class_url+"/"+m_fschema_name+"AF_PRO_CR_display_pay_repos2_details?TOT_SET='+document.Form1.elements[\"TXT_TOT_SETTLE_AMT_\"+row].value+'&INIT_BAL='+document.Form1.elements[\"TXT_INIT_BAL_AMT_\"+row].value+'&PAY_NO='+document.Form1.elements[\"TXT_PAYMENT_NO_\"+row].value+'&APP_NO='+document.Form1.elements[\"TXT_APP_NO_\"+row].value+'&BAL='+document.Form1.elements[\"TXT_BAL_TO_BE_PAID_\"+row].value+'&VALUE_DATE='+document.Form1.elements[\"TXT_VALUE_DATE_\"+row].value+'&SUS_REF_NO='+document.Form1.elements[\"TXT_SUS_REF_NO_\"+row].value+'&PAID_AMT='+document.Form1.elements[\"TXT_PAID_\"+row].value+'&REF_NO='+document.Form1.elements[\"TXT_REF_NO_\"+row].value+'&ENT_TYPE='+(document.Form1.elements[\"TXT_REF_NO_\"+row].value).substring(0,2)+'&chksql1="+m_chksql1+"';"); 
			...
			if(m_screen_type.equals("NEW")){
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_PRO_CR_display_loan_payment_details?screen_type=NEW&sql=load_data_client&m_client_name=\"+document.Form1.hid_m_client_name.value+\"&chksql="+m_chksql+"&chksql2="+m_chksql1+"&sort_column=\"+m_sort_col+\"&order_by_type=\"+m_order_by_type;");
			//out.println(" window.location.href=m_url;"); 
			}
			if(m_screen_type.equals("EDIT")){

			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_PRO_CR_display_loan_payment_details?screen_type=EDIT&status_edit="+m_status_edit+"&sql=load_data_client&m_client_name=\"+document.Form1.hid_m_client_name.value+\"&chksql="+m_chksql+"&chksql2="+m_chksql1+"&sort_column=\"+m_sort_col+\"&order_by_type=\"+m_order_by_type;");
			//out.println(" window.location.href=m_url;"); 
			}
      ...
      out.println("}");
			...
			out.println("	m_url = \""+m_class_url+"/"+m_fschema_name+"AF_PRO_CR_display_loan_payment_details?sql=load_data_client&screen_type="+m_screen_type+"&status_new="+m_status_new+"&m_client_name=\"+m_client_name+\"&chksql=\"+st_val+\"&chksql2=\"+st_val1;"); 
			//out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_PRO_CR_display_loan_payment_details?screen_type="+m_screen_type+"&sql=main_page&status_new="+m_status_new+"&chksql='+st_val+'&chksql2='+st_val1+'';");

			//out.println("}");
			//out.println("else if( m_option==2 ){");
			//out.println("m_option=2");
			//out.println("	m_url = \""+m_class_url+"/"+m_fschema_name+"AF_PRO_CR_display_loan_payment_details?chksql=load_data_client&pre=\"+m_prev+\"&appro=\"+m_app+\"&qry=\"+m_app+\"&division_code=\"+m_division_code+\"&m_client_name=\"+m_client_name+\"&option=\"+m_option;"); 
			//out.println("}");
			//out.println("window.open(m_url);");
			out.println("load_interface(m_url,'NORM');");
			out.println("}"); 
...
//-------------------------------------------------------------------------------------------------------
      ...
      out.println("</tr></table>");
			...
			rs= stmt.executeQuery
														...
														"B.RECEIVER RECEIVER, "+		
														""+m_schema_name+".af_co_get_client_name(B.RECEIVER) VENDOR_NAME, "+
      ...
      // COMMENT BY NUWAN DE SILVA ON 23-01-2008 --------------------------------
		  /*	rs= stmt.executeQuery
												    ...
												    "B.INT_BAL_SETTLE_AMOUNT INT_BAL_SETTLE_AMOUNT "+
														...
														" AND B.BAL_TO_BE_PAID >0 "+
														" AND D.ACTIVE_STATUS<>'C' "+ //NOT CANCELLED
														" AND (     UPPER("+m_schema_name+".af_co_get_client_name(B.RECEIVER))    LIKE UPPER('%"+_m_client_name+"%')  "+
			...
			rs= stmt.executeQuery			
					...
					" NVL("+m_schema_name+".af_co_get_client_name(B.RECEIVER),'-') VENDOR_NAME, "+
					"'',"+
	...
	//	out.println
		...
		//out.println
												    ...
												    "B.INT_BAL_SETTLE_AMOUNT INT_BAL_SETTLE_AMOUNT, "+
													  ...
													  "AND B.SUS_REF_NO=E.SUS_REF_NO "+
														"AND E.PROCESS_STATUS='"+m_status+"' "+ 
														" AND( UPPER(E.PAYEE_NAME) LIKE UPPER('%"+_m_client_name+"%')"+ //"+m_schema_name+".af_co_get_client_name(B.RECEIVER)
														" OR UPPER("+m_schema_name+".af_co_get_client_name(C.CLIENT_CODE)) LIKE UPPER('%"+_m_client_name+"%') ) "+
													  "AND D.ACTIVE_STATUS<>'C' "+ //NOT CANCELLED
