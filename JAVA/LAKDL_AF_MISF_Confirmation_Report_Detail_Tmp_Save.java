...
public class LAKDL_AF_MISF_Confirmation_Report_Detail_Tmp_Save extends HttpServlet {
			...
			m_finance_no = m_sn_methods.met_formdata(reqstr,"hid_finance_no");
				...
				*/
				...
				if(m_view_status.equals("view")){
					...
					out.println("window.location.href='"+m_url+"/LAKDL_AF_MISF_Confirmation_Report_Detail_Snap?chksql=main_page&snap_view_status=Y&compare_status=Y&generate_status=R&view_only_status=N&snap_position="+m_snap_position+"&finance_no="+m_finance_no+"&row_id="+m_row_id+"';");
				}
