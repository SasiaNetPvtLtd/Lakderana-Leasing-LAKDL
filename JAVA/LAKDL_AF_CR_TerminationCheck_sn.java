...
public class LAKDL_AF_CR_TerminationCheck_sn extends javax.servlet.http.HttpServlet {
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)
	{
		...
		try {
			...
			if (m_chksql.trim().equals("idle")) {
				...
				out.println(" document.Form1.hid_opt_val.value=num;"); 
				out.println("	popupwin = window.open(\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_TerminationCheck_sn?chksql=get_Invoice&client=\"+document.Form1.CLIENT_CODE.value+\"\", \"oBj\",\"left=130,top=200,width=750,height=400\");"); 
				out.println("}");	
        ...
        out.println("   if(parseFloat(m_inv_allo)>0){"); 
				...
				out.println("       m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_TerminationCheck_sn?chksql=Add_Min_Amount&amount1=\"+am1+\"&amount2=\"+am2+\"&type=\"+opt;");
        ...
        out.println("}");	
				*/
				...
				out.println("   m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_TerminationCheck_sn?chksql=get_Receipt&client=\"+document.Form1.CLIENT_CODE.value+\"&term_type=\";");
				// out.println("   window.open(m_url);");
				...
				out.println("   m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_TerminationCheck_sn?chksql=get_Receipt_del&rec_no=\"+val+\"\";");
				//out.println("   window.open(m_url);");
				...
				*/
				...
				out.println("window.location.href='"+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_TerminationCheck_sn?chksql=main_page'");
				out.println(" }  ");
				out.println("}");
				...
				//out.println("  popupwin = window.showModalDialog('"+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_TerminationCheck_sn?chksql=RUN_AUTO_ALLO&client='+document.Form1.CLIENT_CODE.value+'&screen='+document.Form1.Hid_scr_name.value+'', oBj,\"dialogWidth:25em; dialogHeight:26em; center:yes; status:no\");");
				//out.println("  get_Receipt();"); 
				out.println("  get_Receipt();"); 
				out.println("}"); 
				...
				*/
				...
				out.println("       if((document.Form1.elements['TERM_TYPE_'+num1].value==\"ERL_TER\") &&  (parseFloat(unformat_noobject(document.Form1.elements['DUE_AM_'+num1].value))) > 0){");//Added By Kanishka On 04-07-2014
				out.println("       	document.Form1.elements['Text_standard'+num1].checked=false;");
				out.println("       	document.Form1.elements['Text_standard'+num1].value =\"NO\";");
				out.println("       } "); 
			...
			out.println("       document.Form1.elements['TERM_TYPE_'+num1].value=='RENT_REVIS' ){ ");
				...
				*/
				...
				out.println("m_url=\""+m_class_url+"/"+m_schema_name+"_AF_CR_TerminationCalculationReport_N?chksql=main_page&FINANCE_NO=\"+finance_no+\"&TERMINATION_TYPE=\"+termination_type+\"&TERMINATION_NO=\"+termination_no+\"\";");  
				...
				out.println("m_url=\""+m_class_url+"/"+m_schema_name+"_AF_CR_TerminationCheck_sn?chksql=print_screen_DEL\";");  
				...
				out.println("m_url=\""+m_class_url+"/"+m_schema_name+"_AF_CR_TerminationCheck_sn?chksql=print_screen_RR\";");  
				out.println("window.open(m_url,'displayWindow4','left=60,top=80,width=650,height=300,toolbar=0,location=0,directories=0,status=0,menuBar=0,scrollBars=1,resizable=1');"); 
				out.println("  }");
				
				// added by udara 30-01-2019
				...
				out.println("<tr>");
				out.println("<td style=\"width: 6px\"></td>");//<!--img src="http://www.LAKDL-leasing.lk/images/btnback.gif" /--></td>
				...
				*/
				...
				out.println("       <script type=\"text/javascript\" src='"+m_html_client_url+"/termination/termination.js'></script>"); // added by udara 14-05-2019
				out.println("</body>"); 
				out.println("</html>"); 
				...
				rs = stmt.executeQuery (" SELECT TERMINATION_NO, FINANCE_NO, "+
					...
					" ,NVL("+m_schema_name+".AF_CO_GET_TERMI_REBATE_REF(FINANCE_NO),'-') REBATE_REF "+ // added by udara 08-03-2021
		...
		out.println("<td  width='10%' >Value Date</td>");
			...
			*/
				...
				out.println("<td  width='8%' >Rebate Ref</td>"); // added by udara 08-03-2021
				//out.println("<td  width='13%' >Amount Allocat</td>");
				//out.println("<td  width='8%' ></td>");
				out.println("</tr>");
				...
				while(rs.next()){
					...
					out.println("<td STYLE='text-align:left; cursor:hand;' onclick=\"show_transaction_history_new('','"+rs.getString(2)+"');\" ><u>"+rs.getString(2) +"</u><input type=hidden name=\"FIN_NO_"+j+"\" value=\""+rs.getString(2)+"\"><input type=hidden name=\"APP_NO_"+j+"\" value=\""+rs.getString(8)+"\"></td>");
					...
					out.println("<td align=right>"+nf.format(rs.getDouble(5))+"<input type=hidden name=\"SETT_A_"+j+"\" value=\""+rs.getString(5)+"\"><input type=hidden name=\"T_V_COUNT_"+j+"\" value=\""+rs.getString(15)+"\"></td>");
					out.println("<td align=right>"+nf.format(rs.getDouble(6))+"<input type=hidden name=\"BAL_AM_"+j+"\" value=\""+(rs.getString(6))+"\"></td>");
					//m_DUE_bal=(rs.getDouble(6)+rs.getDouble(7));//Commented By Kanishka Dilshan On 25-11-2014 [ column 6 (Termination invoice) value contains in column 7(all invoices) ]
					m_DUE_bal=(rs.getDouble(7));//Added By Kanishka Dilshan On 25-11-2014
					out.println("<td align=right>"+nf.format((m_DUE_bal))+"<input type=hidden name=\"DUE_AM_"+j+"\" value=\""+nf.format((m_DUE_bal))+"\"></td>");// +rs.getDouble(13)
					...
					*/
					...
					//out.println(           "type=\"button\" value=\"Allocate\" class=\"but_input\" name=\"btn_al_"+j+"\" onclick=\"allocate_rec('"+rs.getString(2)+"')\"></td>"); // commented by udara 14-05-2019
					out.println(           "type=\"button\" value=\"Allocate\" class=\"but_input\" name=\"btn_al_"+j+"\" onclick=\"saveAllo('"+j+"','"+rs.getString(2)+"')\"></td>"); // added by udara 14-05-2019
					...
					out.println("<td>"+rs.getString("REBATE_REF")+"</td>"); // added by udara 08-03-2021
					//}
					//out.println("     </td>");
					out.println("</tr>");
