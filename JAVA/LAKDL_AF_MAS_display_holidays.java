...
//--
//SCREEN NAME:SYSTEM ADMINISTRATION - HOLIDAYS
//CREATED BY:
//DATE/TIME:
//NOTES:
...
public class LAKDL_AF_MAS_display_holidays extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>System Administration - Holidays</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("else if(data_vec.length==0 && document.Form1.SCREEN_NAME.value!=\"NEW\" && document.Form1.TXT_HOLIDAY_DATE.value!='' && document.Form1.hid_val.value=='t1'){");
			//out.println("alert(data_vec.length)");
			//out.println("alert('Selected Holiday Date is incorrect,use help...!')");
			//out.println("    document.Form1.TXT_HOLIDAY_DATE.value='';"); 
			//out.println("    document.Form1.TXT_HOLIDAY_DATE.focus();"); 
			//out.println("document.Form1.TXT_DESCRIPTION.value='';"); 
			out.println("help_update();;"); 
			out.println("}");

			out.println("else if(data_vec.length>0 && document.Form1.SCREEN_NAME.value!=\"NEW\" && document.Form1.TXT_HOLIDAY_DATE.value!='' && document.Form1.hid_val.value=='t1'){");
			out.println("    document.Form1.TXT_HOLIDAY_DATE.value=data_vec[0];"); 
			...
			//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_holidays&data_val=\"+obj.value+\"&ac_status=\"+document.Form1.hid_st.value;");
			//out.println("window.open(m_url)");
			
			out.println("if(document.Form1.SCREEN_NAME.value==\"NEW\" && document.Form1.hid_val.value=='t1' ){");
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations1?chksql=m_prime_chk_LAKDL_AF_MAS_display_holidays_code&data_val=\"+obj.value;");
			out.println("}");
			out.println("else");
    	out.println("if(document.Form1.SCREEN_NAME.value!=\"NEW\" && document.Form1.hid_val.value=='t1' ){");
      out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_holidays&data_val=\"+obj.value+\"&ac_status=\"+document.Form1.hid_st.value;");
			...
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations1?chksql=m_prime_chk_LAKDL_AF_MAS_display_holidays_desc&data_val=\"+obj.value;");
			...
			out.println("if(document.Form1.TXT_HOLIDAY_DATE.value==\"\"){  "); 
			out.println("DIV_TXT_HOLIDAY_DATE.style.color='red';");
			...
			out.println("}");
			out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_MAS_save_holidays';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MAS_display_holidays';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("    m_help_message = \"m_help_msg_LAKDL_AF_MAS_display_holidays\";"); 
			...
			out.println("help_box.innerHTML=\" System Administration - Holidays - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" System Administration - Holidays - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
			...
			out.println("}else if(m_val==\"EDIT\"){");  
			//out.println("document.Form1.TXT_HOLIDAY_DATE.disabled=true;"); 
	  	...
	  	out.println("		}"); 
			...
			out.println("    m_sql = \"m_help_TXT_HOLIDAY_DATE_sql\";"); 
			out.println("    m_criteria = document.Form1.TXT_HOLIDAY_DATE.value+\"@Y@\";"); 
			out.println("    HelpBox('1','10','0');"); 
			out.println("}"); 
			out.println(""); 

			out.println("function help_value_assign_1() {"); 
			out.println("    document.Form1.TXT_HOLIDAY_DATE.value=oBj.valout[2];"); 
			out.println("}"); 
			...
			out.println("    } ");
			out.println("    else{");
			out.println("    m_criteria = document.Form1.TXT_HOLIDAY_DATE.value+\"@\"+\"N@\";}"); 
			out.println("    HelpBox('1','10','0');"); 
			out.println("}"); 
			...
			out.println("    m_sql = \"m_help_TXT_HOLIDAY_DESC_sql\";"); 
      ...
      out.println("function HelpView(Start,End,Hid_No,Max) {"); 
	  	...
	  	out.println("		}"); 
			...
			out.println("    m_sql = \"m_view_TXT_HOLIDAY_DATE_sql\";");
			out.println("    m_criteria = document.Form1.TXT_HOLIDAY_DATE.value+\"@\"+\"Y@\";"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>System Administration - Holidays</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<td width='30%' ><DIV id='DIV_TXT_HOLIDAY_DATE'  class=div_input>Date Of Holiday(DD-MM-YYYY)*</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_HOLIDAY_DATE' maxlength='10' size='10' onblur=\"assig('t1'),makeRequest(document.Form1.TXT_HOLIDAY_DATE)\">"); 
			out.println("<input class='but_input' type='button' name='BUT_HELP_MAIN' value=\"Help\" onClick=\"help_update()\" disabled></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 

			out.println("<td width='30%' ><DIV id='DIV_TXT_DESCRIPTION'  class=div_input>Holiday Description *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_DESCRIPTION' maxlength='50' size='50' style='width:200'></td>"); //style - Added by Chandana on 24/04/2007 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("</table>"); 
			out.println("<br>"); 
