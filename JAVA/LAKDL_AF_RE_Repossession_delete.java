...
public class LAKDL_AF_RE_Repossession_delete extends javax.servlet.http.HttpServlet {
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)
	{
		...
		try {
			...
			if (m_chksql.trim().equals("idle")) {
				...
				out.println("          }else{");
				out.println("          if(opt==\"REPOSSESS\"){");
				out.println("            Reposses_Help('1','10','0','m_help_Repossseion_Help1','1')");//m_help_Repossseion_Help1  RepossessionNoSql
				out.println("          }else if(opt==\"FINANCE\"){");
			...
			*/
				...
				out.println("</script>"); 
				out.println("<BODY class='body & txt-body' leftmargin='0' topmargin='0' marginwidth='0' ONLOAD=\"change_type(document.Form1.TXT_TYPE);load_screen_status('DELETE')\">"); //load_lock(),
				...
				out.println("<input class='but_input' type='button' name='BUT_HELP_MAIN' value=\"...\" onClick=\"Reposses_Help('1','10','0','m_help_Repossseion_Help1','1')\" disabled></td>");//m_help_Repossseion_Help1  RepossessionNoSql
				out.println("<td width='*%'></td>"); 
				out.println("</tr>"); 
			...
			//added by nuwan de silva on31-10-07---------------------
				...
				String Sql_vehicle="SELECT"+		
					...
					"			B.INVOICE_NO NOT IN ( "+
					"     SELECT  PRO_INVOICE_NO FROM "+m_schema_name+".AF_RE_PRO_REPOSSESSION F  WHERE UPPER(FINANCE_NO) = UPPER('"+_m_finance_no+"') AND ACTIVE_STATUS <> 'C'"+
					"			) "+
