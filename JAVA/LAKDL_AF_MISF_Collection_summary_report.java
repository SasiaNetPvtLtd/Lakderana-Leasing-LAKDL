...
public class LAKDL_AF_MISF_Collection_summary_report extends javax.servlet.http.HttpServlet { 
	...
	public  void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { // synchronized
		...
		try { 
			...
			if(m_chksql.equals("main_page")){ 
				...
				out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Collection_summary_report?chksql=run_report&date=\"+m_date+\"&branch=\"+m_branch+\"&coll_off=\"+m_coll_off+\"&region=\"+m_region;"); 
				//out.println("		window.open(m_url)");
				...
				out.println("			alert('Collection Summary Report is generated. Use View Report button to get the view.');"); 
				out.println("		}");
				out.println("		else{");
				...
				//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Collection_summary_report?chksql=print_report_new&date=\"+m_date;");	 // commented by udara 07-04-2015
				out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Collection_summary_report?chksql=print_report_new&date=\"+m_date+\"&active_status=\"+document.Form1.TXT_ACTIVE_STATUS.value+\"&region=\"+m_region;");	 // added by udara 07-04-2015
				out.println("			window.open(m_url);");
				out.println("	}");
				out.println("}");
	      ...
	      out.println("	m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_Marketing_Officer_Performance_Report?chksql=main_page&sort_column=\"+m_sort_col+\"&order_by_type=\"+m_order_by_type;"); 
				...
				*/
				...
				out.println("	m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Collection_summary_report?chksql=main_page&generate=drill_down_asset&finance_no=\"+m_finance_no;"); 
				...
				out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MISF_Collection_summary_report?chksql=main_page&generate=page';"); 
				out.println("		}"); 
				out.println("}"); 
				...
				//out.println("<input class='but_input' type='button' name='BUT_PRINT' value=\"Run Report\" onClick=\"run_report_validation()\" style=\"{width:110px;}\"></td>");  // run_report // mod by udara 27-01-2016
				out.println("<input class='but_input' type='button' name='BUT_PRINT' value=\"Run Report\" onClick=\"run_report()\" style=\"{width:110px;}\"></td>"); // mod by udara 08-04-2016
				out.println("</tr>");
				...
				*/
				...
				Sql_data = "  SELECT    NVL("+m_schema_name+".AF_CO_GET_LOCATION_DESC(A.LOCATION),'-'),"+
					...
					"            SUM(NVL(A.DOWN_PAYMENT_TO_DATE,0)), "+ // added by udara 04-05-2017 // "            SUM(NVL(A.DOWN_PAYMENT,0)) "+ // added by udara 25-04-2017 (24)
					"            SUM(NVL(A.DOWN_PAYMENT,0)) "+ // added by udara 04-05-2017 // added by udara 25-04-2017 (25)
				...
				if(!more){
					...
					out.println("<td class=factoring-letter-body COLSPAN='2' STYLE='{ text-align:center; }' ><b>DOWN PAYMENT</b></td>"); // mod by udara 04-05-2017 // added by udara 25-04-2017
					...
					out.println("<td class=factoring-letter-body  STYLE='{text-align:center; }' ><b> Total to-date </b></td>"); // added by udara 04-05-2017
					out.println("<td class=factoring-letter-body  STYLE='{text-align:center; }' ><b> "+m_date+" </b></td>");  // mod by udara 04-05-2017 // added by udara 25-04-2017 
					...
					BigDecimal m_total_penalty,m_total_invoice,m_total_ins_invoice,m_total_ren_invoice,m_total_insurence,m_total_arrears,m_total_closing,m_total_rental,m_total_excess,m_total,m_total_down_payment; // m_total_down_payment added by udara 25-04-2017
					BigDecimal m_total_penalty_to_date,m_total_invoice_to_date,m_total_ins_invoice_to_date,m_total_ren_invoice_to_date,m_total_insurence_to_date,m_total_arrears_to_date,m_total_closing_to_date,m_total_rental_to_date,m_total_excess_to_date,m_total_to_date, m_total_down_payment_to_date; // m_total_down_payment_to_date added by udara 04-05-2017
					...
					m_total_penalty_to_date = m_total_invoice_to_date = m_total_ins_invoice_to_date = m_total_ren_invoice_to_date = m_total_insurence_to_date = m_total_arrears_to_date = m_total_closing_to_date = m_total_rental_to_date = m_total_excess_to_date = m_total_to_date = m_total_down_payment = m_total_down_payment_to_date = new BigDecimal(0.00); // added m_total_down_payment_to_date by udara 04-05-2017// m_total_down_payment added by udara 25-04-2017 
					...
					while(more){
						...
						m_total_down_payment_to_date = m_total_down_payment_to_date.add(rs.getBigDecimal(24)); // mod by udara 04-05-2017  // added by udara 25-04-2017
						m_total_down_payment = m_total_down_payment.add(rs.getBigDecimal(25)); // added by udara 04-05-2017
						
						out.println("<td class=factoring-letter-body  STYLE='{text-align:right; }' >"+nf.format(rs.getBigDecimal(24))+"</td>"); // added by udara 25-04-2017
					...
					//m_total_to_date_new = m_total_to_date_new.add(m_total_penalty_to_date).add(m_total_invoice_to_date).add(m_total_ins_invoice_to_date).add(m_total_ren_invoice_to_date).add(m_total_insurence_to_date).add(m_total_arrears_to_date).add(m_total_closing_to_date).add(m_total_rental_to_date).add(m_total_excess_to_date); // commented by udara 12-05-2017
					m_total_to_date_new = m_total_to_date_new.add(m_total_penalty_to_date).add(m_total_invoice_to_date).add(m_total_ins_invoice_to_date).add(m_total_ren_invoice_to_date).add(m_total_insurence_to_date).add(m_total_arrears_to_date).add(m_total_closing_to_date).add(m_total_rental_to_date).add(m_total_excess_to_date).add(m_total_down_payment_to_date); // added by udara 12-05-2017
					m_total = m_total.add(m_total_down_payment); // added by udara 12-05-2017
					...
					out.println("<td class=factoring-letter-body  STYLE='{ text-align:right; }' > <b>"+nf.format(m_total_down_payment_to_date)+"</b> </td>"); // added by udara 04-05-2017
					out.println("<td class=factoring-letter-body  STYLE='{ text-align:right; }' > <b>"+nf.format(m_total_down_payment)+"</b> </td>");  // added by udara 25-04-2017
				...
				*/
				...
				Sql_data="  SELECT    NVL("+m_schema_name+".AF_CO_GET_LOCATION_DESC(A.LOCATION),'-'),"+
					...
					"         SUM ( NVL(A.TOTAL_TO_DATE,0) ),"+
					"            SUM ( NVL(A.TOTAL,0) ), "+
					"            SUM(NVL(A.DOWN_PAYMENT_TO_DATE,0)), "+ // added by udara 04-05-2017 "            SUM(NVL(A.DOWN_PAYMENT,0)) "+ // added by udara 26-04-2017 (24)
					"            SUM(NVL(A.DOWN_PAYMENT,0)) "+ // added by udara 04-05-2017
					"     FROM   "+m_schema_name+".AF_RE_COL_SUM_BRANCH_REPORT A"+
					"    WHERE   A.ENT_USER = '"+m_username+"'  "+
				...
				if(!more){
					...
					out.println("<td class=factoring-letter-body COLSPAN='2' STYLE='{ text-align:center; }' ><b>DOWN PAYMENT</b></td>"); // mod by udara 04-05-2017 // added by udara 26-04-2017
					...
					out.println("<td class=factoring-letter-body  STYLE='{text-align:center; }' ><b> Total to-date </b></td>");  // added by udara 26-04-2017 
					out.println("<td class=factoring-letter-body  STYLE='{text-align:center; }' ><b> "+m_date+" </b></td>");  // added by udara 04-05-2017
					...
					m_total_penalty_to_date = m_total_invoice_to_date = m_total_ins_invoice_to_date = m_total_ren_invoice_to_date = m_total_insurence_to_date = m_total_arrears_to_date = m_total_closing_to_date = m_total_rental_to_date = m_total_excess_to_date = m_total_to_date = m_total_down_payment_to_date = new BigDecimal(0.00); // m_total_down_payment_to_date added by udara 04-05-2017
					...
					while(more){
						...
						m_total_down_payment_to_date = m_total_down_payment_to_date.add(rs.getBigDecimal(24)); // added by udara 04-05-2017
						m_total_down_payment = m_total_down_payment.add(rs.getBigDecimal(25)); // mod by udara 04-05-2017 // added by udara 26-04-2017
