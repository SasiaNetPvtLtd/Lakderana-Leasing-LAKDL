...
public class LAKDL_FA_OP_Receipt_Cancellation_Save extends HttpServlet {
      ...
      m_username 						= m_sn_methods.username;
       ...
       //if (m_scr_name.trim().equals("AF_RE_CANCELLATION")){
				...
				synchronized (this){
					  ...
					  "FA_CR_SAVE_RECEIPT_CANCELATION(:1,:2,:3);END;");
	 				  ...
	 				  callstmt1.execute();
						...
						m_msg = "'"+m_rec_no+" Receipt Cancelled Successfully'";
					
					
				   m_url = "FA_OP_Receipt_Cancellation?chksql=main_page";
		 ...
		 //}				
			...
			//out.println("window.location.href='"+m_url+"/"+m_client_name+"FA_OP_Receipt_Cancellation?chksql=main_page';");
