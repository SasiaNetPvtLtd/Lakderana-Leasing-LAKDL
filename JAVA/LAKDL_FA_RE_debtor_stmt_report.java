...
public class LAKDL_FA_RE_debtor_stmt_report extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
	  	...
	  	out.println("					}"); 
			...
			out.println("<td width='*%' align='left' ><input class='but_input' type='button' name='BUT_DETAILS' style='width:200' value=\"Debtor Statement\" onClick=\"makeRequest_detail()\"  ></td>");
			out.println("</tr>"); 
			out.println("</table>");
			out.println("<br>"); 
