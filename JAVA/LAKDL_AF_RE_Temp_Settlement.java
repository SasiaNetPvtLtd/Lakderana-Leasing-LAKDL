...
public class LAKDL_AF_RE_Temp_Settlement extends javax.servlet.http.HttpServlet {
  ...
  public synchronized void service(HttpServletRequest req, HttpServletResponse res)
	{
      ...
      out.println(" var m_amount_entered=0;");
	    ...
	    out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_RE_Temp_Settlement?chksql=main_page';"); 
        ...
        out.println("}");
			...
			out.println("   m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_RE_Temp_Settlement?chksql=get_return_receipt&client=\"+obj+\"\";");
			//out.println(" window.open(m_url);");
			out.println("	load_interface(m_url,'NORM');");
			out.println("}");
			
			out.println("function makeRequest3(obj) {");
			out.println("   m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_RE_Temp_Settlement?chksql=get_return_receipt2&client=\"+obj+\"&rec_no=\"+document.Form1.RECEIPT_NO.value;");
   ...
   //   out.println("account_help();");
		  ...
		  out.println("      document.Form1.BRANCH_NAME.value =data_vec[2]");
			...
			out.println("  m_url='"+m_class_url+"/"+m_fschema_name+"AF_RE_Temp_Settlement?chksql=view_cheques&cheque_no='+document.Form1.CHEQUE_NO.value+'&branch_code='+document.Form1.PAY_BRANCH.value;");
       ...
       out.println("		 if(data[16] == '' || data[16]== 'null' )");	
		   ...
		   out.println("}");
			...
			out.println("'<TD WIDTH=\"30%\"  align=\"left\"><input class=\"txt_input\" type=\"text\" name=TEN_AMOUNT style=\"{text-align:right;}\" maxlength=\"25\" value=\"'+data[17]+'\"  size=\"25\" onchange =\"calculate_balance(this)\" onblur=\"get_returned_value(this,25)\" disabled></TD>'+");
			out.println("'<td></td>'+");
			out.println("'<td></td></tr>'+");
			out.println("'<TD WIDTH=\"20%\"  align=\"left\">Returned Amount</TD>'+");
			out.println("'<TD WIDTH=\"30%\"  align=\"left\"><input class=\"txt_input\" type=\"text\" name=RET_AMOUNT style=\"{text-align:right;}\" maxlength=\"25\" value=\"'+data[18]+'\"   size=\"10\" onblur=\"cal_retamt(this)\" disabled ></TD>'+");
			out.println("'<td></td>'+");
			out.println("'<td></td></tr>'+");
			out.println("'</table>';");
      out.println("}");
       ...
       out.println("}");
        ...
        //out.println("   window.open(m_url);");
			  ...
			  out.println("	popupwin = window.open(\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_RE_Temp_Settlement?chksql=get_Invoice&client=\"+document.Form1.CLIENT_CODE.value+\"\", \"oBj\",\"left=130,top=200,width=750,height=400\");"); 
			  out.println("}");		
				
				out.println("function cal_amount(opt,am1,am2,num) {");//
				out.println("   document.Form1.hid_win_opt.value=num;");
				out.println("   m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_RE_Temp_Settlement?chksql=Add_Min_Amount&amount1=\"+am1+\"&amount2=\"+am2+\"&type=\"+opt;");
        //out.println("   window.open(m_url);");
        ...
        //out.println("   window.open(m_url);");
				...
				//t.println("   m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_RE_Temp_Settlement?chksql=get_invoice&Client_Code=\"+document.Form1.CLIENT_CODE.value+\"&Amount=\"+unformat_noobject(document.Form1.AMOUNT.value)+\"&Type=\"+document.Form1.hid_option.value+\"&Rec_No=\"+document.Form1.RECEIPT_NO.value;");				
				...
				out.println("   m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_RE_Temp_Settlement?chksql=get_contract&Client_Code=\"+document.Form1.CLIENT_CODE.value+\"&Amount=\"+unformat_noobject(document.Form1.TXT_RENTAL_OTHER_INV.value)+\"&Other_Amount=\"+unformat_noobject(document.Form1.TXT_OTHER_INV.value)+\"&Type=\"+document.Form1.hid_option.value+\"&Rec_No=\"+document.Form1.RECEIPT_NO.value;");
				out.println("  }");
				out.println("else if(document.Form1.OTHER_CHARGES.value==\"N\" ){");
				//out.println("   m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_RE_Temp_Settlement?chksql=get_invoice&Client_Code=\"+document.Form1.CLIENT_CODE.value+\"&Amount=\"+unformat_noobject(document.Form1.AMOUNT.value)+\"&Type=\"+document.Form1.hid_option.value+\"&Rec_No=\"+document.Form1.RECEIPT_NO.value;");
        ...
        //out.println("   window.open(m_url);");
			...
			out.println("}");
			  ...
			  out.println("function inv_details() {");
				...
				out.println("   m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_RE_Temp_Settlement?chksql=get_inv_details&Client_Code=\"+document.Form1.CLIENT_CODE.value;");
				//out.println(" window.open(m_url);");
				...
				out.println("if(document.Form1.OTHER_CHARGES.value==\"Y\" && document.Form1.TXT_RENTAL_OTHER_INV.value!=\"\" ){");
    		//out.println("   m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_RE_Temp_Settlement?chksql=get_contract_det&Client_Code=\"+document.Form1.CLIENT_CODE.value+\"&Amount=\"+unformat_noobject(document.Form1.TXT_RENTAL_OTHER_INV.value)+\"&Other_Amount=\"+unformat_noobject(document.Form1.TXT_OTHER_INV.value)+\"&Type=\"+document.Form1.hid_option.value+\"&Rec_No=\"+document.Form1.RECEIPT_NO.value;");
				out.println("   m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_RE_Temp_Settlement?chksql=get_contract_det&Client_Code=\"+document.Form1.CLIENT_CODE.value+\"&Amount=\"+unformat_noobject(document.Form1.AMOUNT.value)+\"&Other_Amount=\"+unformat_noobject(document.Form1.TXT_OTHER_INV.value)+\"&Type=\"+document.Form1.hid_option.value+\"&Rec_No=\"+document.Form1.RECEIPT_NO.value;");
				out.println("  }");
				out.println("else if(document.Form1.OTHER_CHARGES.value==\"N\" ){");
				out.println("   m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_RE_Temp_Settlement?chksql=get_contract_det&Client_Code=\"+document.Form1.CLIENT_CODE.value+\"&Amount=\"+unformat_noobject(document.Form1.AMOUNT.value)+\"&Other_Amount=\"+unformat_noobject(0.00)+\"&Type=\"+document.Form1.hid_option.value+\"&Rec_No=\"+document.Form1.RECEIPT_NO.value;");
				//out.println("   m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_RE_Temp_Settlement?chksql=get_contract&Client_Code=\"+document.Form1.CLIENT_CODE.value+\"&Amount=\"+unformat_noobject(document.Form1.AMOUNT.value)+\"&Type=\"+document.Form1.hid_option.value+\"&Rec_No=\"+document.Form1.RECEIPT_NO.value;");
				out.println("  }");
        ...
        //out.println("   window.open(m_url);");
				...
				out.println("   m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_RE_Temp_Settlement?chksql=get_return_receipt&client=\"+document.Form1.CLIENT_CODE.value+\"\";");
        //out.println("   window.open(m_url);");
				out.println("   makeRequest(m_url,'4','Receipt');");
				out.println("}");
      ...
      out.println("}else{");
			...
			out.println("   DIV_AUTO_ALLO_RIGHTS.style.color='red';");
			out.println("		if(confirm('Are you sure,invoice auto allocation mode is correct?')){");
			out.println("   DIV_AUTO_ALLO_RIGHTS.style.color='black';");
			...
			out.println("		document.Form1.action='"+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_RE_Save_Temp_Settlement';");  
			out.println("		document.Form1.submit();	"); 
			out.println("		}"); 
			
			out.println("		}"); 
			out.println("		document.Form1.b_submit.disabled=false"); 
			out.println("		document.Form1.b_submit1.disabled=false"); 
      ...
      out.println("function befor_reset(){");
		  ...
		  out.println("window.location.href='"+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_RE_Temp_Settlement?chksql=main_page'");
		  out.println(" }  ");
			out.println("}");
			...
			out.println("    m_help_message = \"m_help_msg_LAKDL_AF_RE_Temp_Settlement\";"); 
      ...
      out.println("  if(document.Form1.hid_cal_date.value=='2'){"); 
			...
			out.println(" function check_settled_mode(){");	
			out.println(" if(document.Form1.SETT_MODE.value==\"CHEQUE\" || document.Form1.SETT_MODE.value==\"CASH\"){");
			out.println(" m_value_date.innerHTML='<table align=\"center\" border=\"0\"  width=\"100%\" class=table>'+");
			out.println("                        '<tr class=tr_input>'+");
			out.println("                        '<td ID=VDATE width=\"20%\">Value Date *</td>'+");
			out.println("                        '<td width=\"30%\"><input name=\"VAL_DAY\"   type=\"text\" maxlength=\"2\" style=\"width: 25px\" class=\"txt_input\" onBlur=validate_date_future_date(document.Form1.VAL_DAY,document.Form1.VAL_MONTH,document.Form1.VAL_YEAR)  disabled>'+ ");
			out.println("                        '<input name=\"VAL_MONTH\" type=\"text\" maxlength=\"2\" style=\"width: 25px\" class=\"txt_input\" onBlur=validate_date_future_date(document.Form1.VAL_DAY,document.Form1.VAL_MONTH,document.Form1.VAL_YEAR)  disabled> '+");
			out.println("                        '<input name=\"VAL_YEAR\"  type=\"text\" maxlength=\"4\" style=\"width: 45px\" class=\"txt_input\" onBlur=validate_date_future_date(document.Form1.VAL_DAY,document.Form1.VAL_MONTH,document.Form1.VAL_YEAR)  disabled> '+");
			out.println("                        '</td>'+");
			out.println("                        '<td >&nbsp;</td>'+");
			out.println("                        '<td>&nbsp;</td>'+");
			out.println("                        '</tr>'+");				
			...
			out.println("'<TD WIDTH=\"30%\"  align=\"left\"><input class=\"txt_input\" type=\"text\" name=TXT_RENTAL_OTHER_INV maxlength=\"25\"  style=\"{text-align:right;}\" size=\"10\" value=\"'+data_vec[19]+'\" onblur=\"calculate_balance(this),check_number(this,25)\" disabled></TD>'+"); // length validated by udara on 13/10/2009
			...
			out.println("'</tr>'+");
  		out.println("'<TD WIDTH=\"20%\"  align=\"left\">Other Invoices</TD>'+");
	...
	//		out.println("   document.Form1.TXT_TOT_ENTERED.value=format_noobject(document.Form1.AMOUNT.value);");
			...
			out.println("m_table_other_charges.innerHTML+='<table align=\"center\" width=\"100%\" class=\"table\" border=\"0\"><tr ID=T_ID class=tr_input>'+");		
			out.println("'<TD WIDTH=\"20%\"  align=\"left\">Rental Invoices</TD>'+");
			out.println("'<TD WIDTH=\"30%\"  align=\"left\"><input class=\"txt_input\" type=\"text\" name=TXT_RENTAL_OTHER_INV maxlength=\"23\"  style=\"{text-align:right;}\" size=\"10\" value=\"0\" onBlur=\"calculate_balance(this) ,check_number(this,25)\" ></TD>'+");
			out.println("'<TD WIDTH=\"20%\"  align=\"left\">Total Amount entered</TD>'+");
	...
	*/		
		...
		/*	out.println("else if(document.Form1.PAY_TYPE.value==\"THIRD\" && document.Form1.hid_option.value==\"NEW\"){");
			...
			*/	
			...
			out.println("m_table_tendered.innerHTML+='<table align=\"center\" width=\"100%\" class=\"table\" border=\"0\"><tr ID=T_ID class=tr_input>'+");		
			out.println("'<TD WIDTH=\"20%\"  align=\"left\">Tendered Amount</TD>'+");
			out.println("'<TD WIDTH=\"30%\"  align=\"left\"><input class=\"txt_input\" type=\"text\" name=TEN_AMOUNT style=\"{text-align:right;}\"  maxlength=\"25\"  size=\"25\" onchange =\"calculate_balance(this)\" onblur=\"get_returned_value(this,25)\" ></TD>'+");
			out.println("'<td></td>'+");
			out.println("'<td></td></tr>'+");
			out.println("'<TD WIDTH=\"20%\"  align=\"left\">Returned Amount</TD>'+");
			out.println("'<TD WIDTH=\"30%\"  align=\"left\"><input class=\"txt_input\" type=\"text\" name=RET_AMOUNT style=\"{text-align:right;}\" maxlength=\"25\"   size=\"10\" onblur=\"cal_retamt(this)\" disabled ></TD>'+");
			out.println("'<td></td>'+");
			out.println("'<td></td></tr>'+");
			out.println("'</table>';");
			out.println("}");	
      ...
      out.println("m_table_cheque.innerHTML+='<table align=\"center\" width=\"100%\" class=\"table\" border=\"0\"><tr class=tr_input>'+");		
			...
			out.println("'<td width=\"30%\"><input name=CHEQUE_DATE_DD   type=\"text\" maxlength=\"2\" class=\"txt_input\" style=\"width:25px\" onBlur=\"checkMonthLength(document.Form1.CHEQUE_DATE_DD,document.Form1.CHEQUE_DATE_MM,document.Form1.CHEQUE_DATE_YY);date_compaire()\" value=\"\"	>'+ ");
			out.println("'<input name=CHEQUE_DATE_MM   type=\"text\" maxlength=\"2\" class=\"txt_input\" style=\"width:25px\" onBlur=\"checkMonthLength(document.Form1.CHEQUE_DATE_DD,document.Form1.CHEQUE_DATE_MM,document.Form1.CHEQUE_DATE_YY);date_compaire()\" value=\"\">'+ ");
			out.println("'<input name=CHEQUE_DATE_YY   type=\"text\" maxlength=\"4\" class=\"txt_input\" style=\"width:45px\" onBlur=\"checkMonthLength(document.Form1.CHEQUE_DATE_DD,document.Form1.CHEQUE_DATE_MM,document.Form1.CHEQUE_DATE_YY);date_compaire()\"  value=\"\"  >'+ "); //<a href style=\"{cursor:hand; }\" onclick=load_calendar(\"3\")>Calendar</a>
			...
			out.println("'<input name=CHEQUE_DATE_YY   type=\"text\" maxlength=\"4\" class=\"txt_input\" style=\"width:45px\" onBlur=\"check_date_value()\" value=\"'+data_vec[16]+'\" disabled>'+ "); //<a href style=\"{cursor:hand; }\" onclick=load_calendar(\"3\")>Calendar</a>
			out.println("'<a href style=\"{cursor:hand; }\" onclick=load_calendar(\"3\")>   Calendar</a></td>'+");
			out.println("'<td></td>'+");
			out.println("'<td></td></tr>'+");
      ...
      //out.println("   window.open(m_url);");
        ...
        out.println("      calcualte_values(num2,num1);");	//Added By Nuwan De Silva
			...
			out.println("   m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_RE_sql_validations?chksql=m_prime_chk_LAKDL_AF_RE_Temp_Settlement_tendered_amount&data_val1=\"+unformat_noobject(document.Form1.AMOUNT.value)+\"&data_val2=\"+unformat_noobject(document.Form1.TEN_AMOUNT.value);");
			out.println("	 load_interface(m_url,'XML');");
			out.println("format_number(obj,size)");
			out.println("}");			
...
*/ //sandun  -------------------p
      ...
      out.println("document.Form1.AMOUNT.disabled=true;	"); 
			...
			out.println("if(document.Form1.OTHER_CHARGES.value==\"Y\" && document.Form1.TXT_RENTAL_OTHER_INV.value!=\"\" ){");
  		//out.println("   m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_RE_Temp_Settlement?chksql=get_invoice&Client_Code=\"+document.Form1.CLIENT_CODE.value+\"&Amount=\"+unformat_noobject(document.Form1.TXT_RENTAL_OTHER_INV.value)+\"&Type=\"+document.Form1.hid_option.value+\"&Rec_No=\"+document.Form1.RECEIPT_NO.value;");
			out.println("   m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_RE_Temp_Settlement?chksql=get_invoice&Client_Code=\"+document.Form1.CLIENT_CODE.value+\"&Amount=\"+unformat_noobject(document.Form1.AMOUNT.value)+\"&Type=\"+document.Form1.hid_option.value+\"&Rec_No=\"+document.Form1.RECEIPT_NO.value;");
			out.println("  }");
			out.println("else if(document.Form1.OTHER_CHARGES.value==\"N\" ){");
			out.println("   m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_RE_Temp_Settlement?chksql=get_invoice&Client_Code=\"+document.Form1.CLIENT_CODE.value+\"&Amount=\"+unformat_noobject(document.Form1.AMOUNT.value)+\"&Type=\"+document.Form1.hid_option.value+\"&Rec_No=\"+document.Form1.RECEIPT_NO.value;");
      ...
      out.println("   makeRequest(m_url,'11','Manual');");
	    ...
	    //out.println("  alert('sett_amt'+sett_amt);");
			...
			out.println("}else{");			
			out.println(" document.Form1.OTHER_CHARGES.value = 'N';");
			out.println(" get_other_charges();");
			out.println("}");
			out.println("}");			
      ...
      out.println("}");
			...
			out.println("function allocate_amounts(k){");
			out.println("var m_allo_amount=0;");
			out.println("var m_allo_amount_1=0;");
			out.println("var count= document.Form1.hid_activate_cntract_cnt.value;");
			out.println("for(j=0;j<count;j++){");
			out.println("m_allo_amount=m_allo_amount+parseFloat(unformat_noobject(document.Form1.elements['activate_Text_balance_amount'+j].value));");
			out.println("}");
			out.println("document.Form1.rec_bal_amount.value = parseFloat(m_allo_amount);");
			out.println("format_num(document.Form1.rec_bal_amount,0)");
			out.println("if(parseFloat(unformat_noobject(document.Form1.AMOUNT.value)) < parseFloat(m_allo_amount)){");
			out.println("alert('Allocated amounts cannot be exceeded receipt amount..!');");
			out.println("document.Form1.elements['activate_Text_balance_amount'+k].value=0.00;");
			out.println("for(j=0;j<count;j++){");
			out.println("m_allo_amount_1=m_allo_amount_1+parseFloat(unformat_noobject(document.Form1.elements['activate_Text_balance_amount'+j].value));");
			out.println("}");
			out.println("document.Form1.rec_bal_amount.value = parseFloat(m_allo_amount_1);");
			out.println("format_num(document.Form1.rec_bal_amount,0)");
			out.println("}");
			out.println("if(parseFloat(unformat_noobject(document.Form1.elements['activate_Text_balance_amount'+k].value))>parseFloat(0.00)){");
			out.println("document.Form1.elements['activate_Text_standard_chk'+k].checked=true;");
			out.println("document.Form1.elements['activate_Text_standard_chk'+k].value=\"YES\";");
			out.println("}else{");
			out.println("document.Form1.elements['activate_Text_standard_chk'+k].checked=false;");
			out.println("document.Form1.elements['activate_Text_standard_chk'+k].value=\"NO\";");
			out.println("}");
			out.println("}");
			
			out.println("function aloc_status(x){");
			out.println("var count_1= document.Form1.hid_activate_cntract_cnt.value;");
			out.println("var m_allo_amount_2=0;");
			out.println("if(document.Form1.elements['activate_Text_standard_chk'+x].checked==true){;");
			out.println("document.Form1.elements['activate_Text_standard_chk'+x].value=\"YES\";");
			out.println("}else{");
			out.println("document.Form1.elements['activate_Text_standard_chk'+x].value=\"NO\";");
			out.println("document.Form1.elements['activate_Text_balance_amount'+x].value=0.00;");
			out.println("format_num(document.Form1.elements['activate_Text_balance_amount'+x],0);");
			out.println("for(j=0;j<count_1;j++){");
			out.println("m_allo_amount_2=m_allo_amount_2+parseFloat(unformat_noobject(document.Form1.elements['activate_Text_balance_amount'+j].value));");
			out.println("}");
			out.println("document.Form1.rec_bal_amount.value = parseFloat(m_allo_amount_2);");
			out.println("format_num(document.Form1.rec_bal_amount,0)");
			out.println("}");
			out.println("}");
		  ...
		  out.println("   }");
			...
			out.println("function onload_curr_code(){");
			out.println("document.Form1.CURR_CODE.value=\"SLR\";");
			out.println("}");
			
			out.println("function date_compaire(){");			
			out.println("if(document.Form1.SETT_MODE.value==\"CHEQUE\"){");
			out.println(" var m_cheque_date = new Date(parseInt(document.Form1.CHEQUE_DATE_YY.value),(parseInt(document.Form1.CHEQUE_DATE_MM.value)-1),parseInt(document.Form1.CHEQUE_DATE_DD.value));");
			out.println(" var m_value_date = new Date(parseInt(document.Form1.VAL_YEAR.value),(parseInt(document.Form1.VAL_MONTH.value)-1),parseInt(document.Form1.VAL_DAY.value));");
			out.println("if(m_value_date<m_cheque_date){");
			out.println("alert('Cheque date should not be greater than the value date...!');");
			out.println("document.Form1.CHEQUE_DATE_YY.value=document.Form1.VAL_YEAR.value;");
			out.println("document.Form1.CHEQUE_DATE_DD.value=document.Form1.VAL_DAY.value;");
			out.println("document.Form1.CHEQUE_DATE_MM.value=document.Form1.VAL_MONTH.value;");
			out.println("return false;");
			out.println("}else{");
			out.println("return true;");
			out.println("}");
			...
			//-------------------------------------------------------------------------------------------------------			
			out.println("</script>"); 
			out.println("<BODY class='body & txt-body' leftmargin='0' topmargin='0' marginwidth='0' ONLOAD=\"load_roll_out_value();load_lock();disable_help();add_row_cheque();alloc_other();onload_curr_code();check_settled_mode();\">"); //disable_val_date();
			out.println("<FORM NAME='Form1' method='post'>"); 
			out.println("<input type='hidden' name='Hid_scr_name' value='AF_RE_TEMP_SETTELMENT' > ");
			...
			out.println("<input type=hidden name=\"HID_SYS_VAL_YEAR\" value=\"\">");
			  ...
			  out.println("<td>&nbsp;</td>");
				out.println("<td>&nbsp;</td>");
				out.println("<td><input type='button' name=help class=mainbut value=\"Help\" onclick=load_screen_status(\"HELP\"); onMouseOver='load_roll_value(\"Help\");' onmouseout='load_roll_out_value();'>  </td>");  //Added By Nuwan De Silv 17-05-05
				
				out.println("<td>&nbsp;</td>");
				out.println("<td><input type=button name=reset value=\"Cancel\" class=mainbut onclick=befor_reset(); onMouseOver='load_roll_value(\"Cancel\");' onmouseout='load_roll_out_value();'></td>");
        out.println("<td>&nbsp;</td>");
				...
				out.println("<td width=\"30%\"> <SELECT name=\"SETT_MODE\" class=\"txt_input\" onChange=\"enable_check_date();check_settled_mode()\"> ");
				...
				out.println("<div id=\"m_value_date\"></div>");
		    ...
		    out.println("</tr>"); 
			  ...
			  out.println("<tr class=tr_input>");
				...
				out.println("<tr class=tr_input>");
				out.println("<td width=\"20%\" id='DIV_AUTO_ALLO_RIGHTS' >Invoice Auto Allocation</td>");
				out.println("<td width='30%' ><SELECT name=\"TXT_AUTO_ALLO_RIGHTS\" class=\"txt_input\" >"); 
				out.println("<OPTION value=\"Y\" >Yes</OPTION>");
				out.println("<OPTION value=\"N\"  SELECTED >No</OPTION>");
				...
				out.println("<table align='center'  width='100%' class='table'>"); 
			  out.println("<tr class=tr_input>");
				out.println("<td width=\"20%\" >Allocation Method</td>");
				out.println("<td width='30%' ><SELECT name=\"TXT_FIFO\" class=\"txt_input\" onChange=\"alloc_other()\">"); 
				out.println("<OPTION value=\"FIFO_MANU\" SELECTED>Manual Allocation</OPTION>");
				out.println("<OPTION value=\"NO_ALLO\"  >No Allocation</OPTION>");
		    ...
		    out.println("</tr>"); 
			  out.println("</table>");
				...
				out.println("<table align='center'  width='100%' class='table'>"); 				
				out.println("<tr>");
				out.println("<td class=\"pdn_txtpos\" height=\"0\" valign=\"top\">");
		...
		out.println("</table>");							
			...
			*/
								...
								" WHERE "+m_schema_name+".AF_CO_GET_APP_TER_STATUS(APPLICATION_NO) IN ('LEGAL','ACTIVATED')  "+
							  ...
							  " 	) "+
								...
								*/
								...
								if(more_rs_act) {	
								  out.println("<table border='0' width='60%' ><tr class=tr_input1 WIDTH=100%>");
									out.println("  <td WIDTH=15%>Finance No</td>");
									out.println("  <td WIDTH=20%>Vehicle Reg. No</td>");
									//out.println("  <td WIDTH=12% align=right>ODI Balance Amount</td>");
									//out.println("  <td WIDTH=12% align=right>Invoice Balance Amount</td>");
									//out.println("  <td WIDTH=12% align=right>ODI Allocated Amount</td>");
									//out.println("  <td WIDTH=12% align=right>Invoice Allocated Amount</td>");
									...
									out.println("  <td WIDTH=5% align=center>Status</td></tr>");
									}
								while(more_rs_act){
								...
								out.println("  <td align=left  onClick=\"\" style= 'WORD-BREAK:BREAK-ALL' >"+rs_act.getString(6)+"</td>");
								...
								out.println("<td align=right><input type=text style='width:150px' name=\"activate_Text_balance_amount"+act+"\"    value=\""+nf.format(0.00)+"\" class=\"txt_input2\" onclick='this.select()' onchange='allocate_amounts(\""+act+"\")' onblur='format_num(this,25)'></td>");								
								out.println("<td align=center><INPUT TYPE=\"checkbox\" name=\"activate_Text_standard_chk"+act+"\"    onclick=aloc_status(\""+act+"\") value=\"NO\" ></td></tr>");  //onclick=check_aloc_status_new_activated(\""+act+"\")
								act=act+1;
								...
								out.println("<tr>"); 
								out.println("<td colspan ='2'  align='right' width='35%' ><b>Rceipt Amount</td>"); 
								out.println("<td align=right width='20%' ><input class=\"txt_input2\" type='text' style='border:none;width=150px' readonly value=\""+nf.format(0)+"\" name='rec_bal_amount'  onchange='format_num(this,25);'></td>"); 
