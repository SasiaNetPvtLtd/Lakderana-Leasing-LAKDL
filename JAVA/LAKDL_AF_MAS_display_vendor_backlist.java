...
//--
//SCREEN NAME:SYSTEM ADMINISTRATION - VENDOR BLACKLIST
//CREATED BY:
//DATE/TIME:
//NOTES:
...
public class LAKDL_AF_MAS_display_vendor_backlist extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>System Administration - Vendor Blacklisting </TITLE>"); 
			out.println("</HEAD>"); 
			out.println("<link REL='STYLESHEET' HREF='"+m_html_client_url+"/css/Asset_Financing_System.css' TYPE=\"text/css\">"); 
			out.println("<SCRIPT language=\"JavaScript\">"); 

			out.println("function get_vector(data_vec) {");
			out.println("			if(data_vec.length>0 && document.Form1.SCREEN_NAME.value==\"BALCKLIST\" && document.Form1.hid_val.value=='t1'){");
			out.println("				alert('Record already exsist');");
			out.println("				new_window();");
			out.println("			}");
				out.println("else if(data_vec.length==0 && document.Form1.SCREEN_NAME.value!=\"BALCKLIST\" && document.Form1.TXT_VENDOR_CODE.value!='' && document.Form1.hid_val.value=='t1'){");
			...
			out.println("document.Form1.TXT_ACTIVE_STATUS.value=data_vec[4];"); 
			...
			out.println(" if ((document.Form1.SCREEN_NAME.value==\"BALCKLIST\")||(document.Form1.SCREEN_NAME.value==\"EDIT\")||(document.Form1.SCREEN_NAME.value==\"DACT\")){");
			...
			//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_vendor_backlist&data_val=\"+obj.value;");
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_vendor_creation1&data_val=\"+obj.value+\"&ac_status=\"+document.Form1.hid_st.value;");
			...
			out.println("   if(m_status == \"Blacklist\"){ ");
			out.println("   m_save_msg = 'Are you sure you want to Blacklist the Vendor ? '");
			out.println("   }"); 
			out.println("   else if(m_status == \"Activate\"){ ");
			out.println("   m_save_msg = 'Are you sure you want to Activate the Vendor ? '");
			out.println("   }"); 
			...
			out.println("		}");
			//out.println("		if(validate_data()){"); 
			out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_MAS_save_vendor_backlist';");  
			...
			out.println("		if(confirm(\"Are you want to clear the screen ?\")){ "); 
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MAS_display_vendor_backlist';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("    m_help_message = \"m_help_msg_LAKDL_AF_MAS_display_vendor_backlist\";"); 
			...
			out.println("help_box.innerHTML=\" System Administration - Vendor Blacklisting - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" System Administration - Vendor Blacklisting - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 

			out.println("function load_screen_status(m_val){"); 
			out.println("if(m_val==\"BALCKLIST\"){"); 
			out.println("new_window();"); 
			...
			out.println("document.Form1.hid_status.value=\"Activate\";"); 
			//out.println("}else if(m_val==\"TEMPB\"){");  
			//out.println("document.Form1.hid_status.value=\"TempBacklist\";"); 
			out.println("}else{");  
	  	...
	  	out.println("		}"); 
			...
			out.println("    m_sql = \"m_help_TXT_VENDOR_BCODE_sql\";"); 
			out.println("    if(document.Form1.SCREEN_NAME.value==\"EDIT\" || document.Form1.SCREEN_NAME.value==\"DACT\" ){ ");
			out.println("    m_criteria = document.Form1.TXT_VENDOR_CODE.value+\"@\"+\"B@\";"); 
			out.println("    } ");
			out.println("    else{");
			out.println("    m_criteria = document.Form1.TXT_VENDOR_CODE.value+\"@\"+\"Y@\";}"); 
			out.println("    HelpBox('1','10','0');"); 
			...
			out.println("    document.Form1.TXT_ACTIVE_STATUS.value=oBj.valout[6];"); 
      ...
      out.println("function HelpView(Start,End,Hid_No,Max) {"); 
	  	...
	  	out.println("		}"); 
			...
			out.println("    m_sql = \"m_view_TXT_VENDOR_BCODE_sql\";");
			out.println("    m_criteria = document.Form1.TXT_VENDOR_CODE.value+\"@\"+\"Y@\";"); 
			...
			out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_rpt_blacklists?chksql=LOAD_VENDOR_BLACKLIST_REPORT\";");
			...
			out.println("</script>"); 
			out.println("<BODY class='body & txt-body' leftmargin='0' topmargin='0' marginwidth='0' ONLOAD=\"load_lock(),load_roll_value('Blacklist')\">"); 
			out.println("<FORM NAME='Form1' method='post'>"); 
			out.println("<input  type='hidden' value='Blacklist' name='SCREEN_NAME'> "); 
			out.println("<INPUT TYPE='Hidden' NAME='hid_help_type' VALUE=\"\">"); 
			out.println("<INPUT TYPE='Hidden' NAME='hid_val' VALUE=\"Blacklist\">");
			out.println("<INPUT TYPE='Hidden' NAME='hid_st' VALUE=\"Blacklist\">");
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>System Administration - Vendor Blacklisting</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			//out.println("<td width='10%' align='center'><input type=\"button\" class='mainbut' onMouseout='load_roll_out_value();' onMouseOver='load_roll_value(\"Edit\");' onClick='load_screen_status(\"TEMPB\")' value=\"T-Backlist\"></td>");  
			...
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_VENDOR_CODE' maxlength='10' size='10' onblur=\"assig('t1'),makeRequest(document.Form1.TXT_VENDOR_CODE)\">"); 
			...
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_NAME' maxlength='20' size='20' disabled></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 

			out.println("<td width='30%' >Item Category</td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_CATEGORY' maxlength='10' size='10' disabled></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 

			out.println("<td width='30%' >Vendor Type</td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_TYPE' maxlength='10' size='10' disabled></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 

			out.println("<td width='30%' >Active Status*</td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_ACTIVE_STATUS' maxlength='1' size='1' disabled></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr >"); 

			//out.println("<td width='30%' >Default Value</td>"); 
			//out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_DEFAULT_VALUE' maxlength='1' size='1' disabled></td>"); 
			out.println("<td width='30%' >Default Value</td>"); 
			out.println("<td width='40%' ><select class='txt_input' type='text' name='TXT_DEFAULT_VALUE' maxlength='1' size='1' disabled>");  
