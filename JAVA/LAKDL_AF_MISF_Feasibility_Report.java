...
public class LAKDL_AF_MISF_Feasibility_Report extends javax.servlet.http.HttpServlet { 
...
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!	
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Credit Process -Offer Letter </TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MISF_Feasibility_Report?chksql=main_page';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("help_box.innerHTML=\"Credit Process -  Offer Letter - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\"Credit Process -  Offer Letter - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
		  ...
		  out.println("function view() {");
			...
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Feasibility_Report_Detail?chksql=main_page&print=TRUE&finance_no=\"+document.Form1.TXT_FINANCE_NO.value+\"\";");
...
//-----------------------------------------------------------------------------------------------------------------------
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Credit Process - Offer Letter</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			//out.println("<td width='*%' ><input class='txt_input' type='text' name='TXT_FINANCE_NO' maxlength='200' size='10' onblur=\"makeRequest1(document.Form1.TXT_FINANCE_NO)\" >");  // commented by udara 13-05-2015
			out.println("<td width='*%' ><input class='txt_input' type='text' name='TXT_FINANCE_NO' maxlength='200' size='10' onblur=\"help_button_finance()\" >"); // added by udara 13-05-2015
