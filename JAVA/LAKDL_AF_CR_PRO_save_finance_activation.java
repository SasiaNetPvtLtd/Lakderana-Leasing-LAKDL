...
public class LAKDL_AF_CR_PRO_save_finance_activation extends HttpServlet {
  ...
  String reqstr;
	...
	public synchronized void  service(HttpServletRequest req, HttpServletResponse res)	throws IOException{
      ...
      String m_scr_name=(String)m_sn_methods.met_formdata(reqstr,"Hid_scr_name"); 
			...
			callstmt=conn.prepareCall("BEGIN "+m_schema_name+".AF_CR_SAVE_FINANCE_ACTIVATION(:1,:2,:3); END;");
