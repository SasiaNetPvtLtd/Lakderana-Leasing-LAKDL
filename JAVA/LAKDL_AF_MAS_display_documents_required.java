...
//--
//SCREEN NAME:SYSTEM ADMINISTRATION - DOCUMENTS REQUIRED
//ID:1.50 Document Required Creation Process
//CREATED BY:N.V.P.Chandana
//DATE/TIME:25-07-2006/3.15pm
//NOTES:
...
public class LAKDL_AF_MAS_display_documents_required extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
      ...
      out.println("   }");
			...
			out.println("    m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_documents_required1&data_val=\"+obj.value;");
			out.println("}");
			out.println("    else");
			...
			out.println("    m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_documents_required&data_val=\"+obj.value+\"&ac_status=Y\";");
			out.println("}");
      out.println("    else");
      out.println("    if(document.Form1.hid_help_status.value=='H9' && document.Form1.SCREEN_NAME.value==\"RACT\")");
      out.println("    m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_documents_required&data_val=\"+obj.value+\"&ac_status=N\";");
      out.println("    else");
      out.println("    if(document.Form1.hid_help_status.value=='H_desc')");
      out.println("    m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations1?chksql=m_prime_chk_LAKDL_AF_MAS_display_documents_required_desc&data_val=\"+obj.value;");
      ...
      out.println("   function assign_data(data_vec) { ");
			...
			out.println("    document.Form1.TXT_TYPE.value=data_vec[2]; ");
			out.println("}");
      ...
      out.println("}");
			...
			out.println("		}");
			//out.println("		if(validate_data()){"); 
			out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_MAS_save_documents_required';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MAS_display_documents_required';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("    m_help_message = \"m_help_msg_LAKDL_AF_MAS_display_documents_required\";"); 
			...
			out.println("help_box.innerHTML=\" System Administration - Documents Required - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" System Administration - Documents Required - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
		...
		//	out.println("document.Form1.TXT_DESCRIPTION.value='';"); 
			...
			out.println("    m_sql = \"m_help_TXT_CODE_sql_1\";"); 
			...
			out.println("    document.Form1.TXT_TYPE.value=oBj.valout[4];"); 
			out.println("}"); 
	  	...
	  	out.println("		}");  
			...
			out.println("<td width='30%' ><DIV id='DIV_TXT_CODE'  class=div_input> Documents Required Code *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_CODE' maxlength='10' size='10' onblur=\"assign_help_status('H9'),makeRequest(document.Form1.TXT_CODE)\">"); 
			out.println("<input class='but_input' type='button' name='BUT_HELP_MAIN' value=\"Help\" onClick=\"help_update()\" disabled></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			
			out.println("<tr >"); 
			out.println("<td width='30%' ><DIV id='DIV_TXT_DESCRIPTION'  class=div_input> Documents Required Description *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_DESCRIPTION' maxlength='100' style={width:250px;} size='100' onblur=\"assign_help_status('H_desc'),makeRequest(document.Form1.TXT_DESCRIPTION)\" ></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			
			out.println("<tr >"); 
			out.println("<td width='30%' ><DIV id='DIV_TXT_DESCRIPTION'  class=div_input> Documents Required Type </DIV></td>"); 
			out.println("<td >");
			out.println("<select name=\"TXT_TYPE\" class=\"txt_input\" >");
			out.println("<OPTION value=\"CLIENT\" SELECTED >Client </option>");
			out.println("<OPTION value=\"ASSET\" >Asset </option>");
			out.println("</SELECT></td>");
			//out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_TYPE' maxlength='100' size='100' onblur=\"assign_help_status('H_desc'),makeRequest(document.Form1.TXT_DESCRIPTION)\" ></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
