...
public class LAKDL_FA_MISF_quotation_report extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"FA_MISF_quotation_report';"); 
			out.println("		}"); 
			out.println("}"); 
		...
		//	out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"FA_MK_Inquiry?chksql=Inquiry_Followup_All&INQ_NO=\"+document.Form1.TXT_INQ_CODE.value+\"&FROM_DATE=\"+m_from_date+\"&TO_DATE=\"+m_to_date+\"&order_by=INQUIRY_CODE&order_by_type=ASC \";");
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Quotation Report </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
