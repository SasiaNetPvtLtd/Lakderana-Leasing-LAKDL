...
public class LAKDL_AF_RE_Seizing_Order extends javax.servlet.http.HttpServlet {
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)
	{
		...
		try {
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_RE_Seizing_Order';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("help_box.innerHTML=\" Collection Process - Seizing Order Generarion - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 
			
			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" Collection Process - Seizing Order Generarion - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
			...
			out.println("	m_url = \""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_PRO_Seizing_order_letter_new?chksql=main_page&repossession_no=\"+m_repossess_no+\"&document_code=CEAS_ORDER&pro_invoice_no=\"+m_pro_invoice_no+\"&seizer_code=\"+m_seizer_code+\"&finance_no=\"+m_finance_no+\"&print=TRUE\";"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Collection Process - Seizing Order Generarion</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
		...
		out.println("<input class='but_input' type='button' name='BUT_TXT_RECEIPT_NO' value=\"Help\" onClick=\"help_receipt_no()\"></td>"); 
			...
			*/
			out.println("<tr >"); 
			out.println("<td width='10%' ><DIV id='DIV_TXT_REPOSSESSION_NO'  class=div_input>Repossession No *</DIV></td>"); 
			out.println("<td width='10%' ><input class='txt_input' type='text' name='TXT_REPOSSESSION_NO' maxlength='15' size='15' disabled onblur=\"chk_repossession_no(this)\">"); 
