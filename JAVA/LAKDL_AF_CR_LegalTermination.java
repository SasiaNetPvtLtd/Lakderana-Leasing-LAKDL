...
public class LAKDL_AF_CR_LegalTermination extends javax.servlet.http.HttpServlet {
  ...
  public synchronized void service(HttpServletRequest req, HttpServletResponse res)
	{
      ...
      out.println("<HTML>"); 
       ...
       out.println("   if(type=='Rec'){"); 
			 ...
			 out.println("     document.Form1.TER_RATE.value        =data[14];"); 	
			 ...
			 out.println("     document.Form1.UNE_INC.value         =data[7];"); 
			 ...
			 out.println("     document.Form1.TER_RATE.value       =data[0];"); 	
			 ...
			 out.println("   }"); 
			 //Added by Dineth on 17-03-2009
				
			 out.println(" if(document.Form1.DUE_AMOUNT.value != '' && document.Form1.ODI.value != '' && document.Form1.CAP_OUT.value != ''){ ");
			 out.println("  document.Form1.LEG_DUE_WITH_ODI.value=format_noobject(parseFloat(unformat_noobject(document.Form1.DUE_AMOUNT.value))+parseFloat(unformat_noobject(document.Form1.CAP_OUT.value))+parseFloat(unformat_noobject(document.Form1.ODI.value))-parseFloat(unformat_noobject(document.Form1.NIBSM.value))-parseFloat(unformat_noobject(document.Form1.AMI.value))); ");
			 out.println("}");
			 out.println(" if(document.Form1.DUE_AMOUNT.value != '' && document.Form1.CAP_OUT.value != ''){ ");
			 out.println("  document.Form1.LEG_DUE_WITHOUT_ODI.value=format_noobject(parseFloat(unformat_noobject(document.Form1.DUE_AMOUNT.value))+parseFloat(unformat_noobject(document.Form1.CAP_OUT.value))-parseFloat(unformat_noobject(document.Form1.NIBSM.value))-parseFloat(unformat_noobject(document.Form1.AMI.value))); ");
			 out.println("}");
				
				
				//End by Dineth on 17-03-2009
       out.println(" }else{");
       out.println("  if(type=='Cli'){"); 
			 ...
			 out.println("}");
			  ...
			  out.println("	popupwin = window.open(\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_LegalTermination?chksql=get_Invoice&client=\"+document.Form1.CLIENT_CODE.value+\"\", \"oBj\",\"left=130,top=200,width=750,height=400\");"); 
			  out.println("}");		
				
				out.println("function cal_amount(opt,am1,am2,num) {");//
				out.println("   document.Form1.hid_win_opt.value=num;");
				out.println("   m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_LegalTermination?chksql=Add_Min_Amount&amount1=\"+am1+\"&amount2=\"+am2+\"&type=\"+opt;");
        ...
        out.println("}");	
				...
				out.println("   m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_LegalTermination?chksql=get_Vehicles&Lease_no=\"+document.Form1.LEASE_NO.value;");
      //out.println("   window.open(m_url);");
			  ...
			  /*out.println("function get_Receipt(m_stat,opt) {");
				out.println("   m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_LegalTermination?chksql=get_Receipt&client=\"+document.Form1.CLIENT_CODE.value+\"\";");
        //out.println("   window.open(m_url);");
        ...
        out.println("}");	
				...
				out.println("   m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_LegalTermination?chksql=get_Receipt_del&rec_no=\"+val+\"\";");
        //out.println("   window.open(m_url);");
        ...
        //out.println("   window.open(m_url);");
			...
			out.println("}");
				...
				out.println("  m_i_no=\"\";");
				out.println("for(i=0;i<parseFloat(document.Form1.hid_vcount.value);i++){");    
				out.println(" if(document.Form1.elements['ch_v_'+i].value=='YES'){");
      ...
      out.println("function befor_reset(){");
		  ...
		  out.println("window.location.href='"+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_LegalTermination?chksql=main_page'");
		  out.println(" }  ");
			out.println("}");
 ...
 /*
      ...
      out.println("	 popupwin = window.open(\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_RE_PRO_drill_downs?chksql=SHOW_CLIENT_INFORMATION&client_code=\"+num+\"\", \"oBj\",\"left=150,top=280,width=800,height=600,scrollBars=1\");"); 
			...
			out.println(" if(num!=\"\" ){");	
      //out.println("	 popupwin = window.open(\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CO_Documents?chksql=get_documents&deal_no=\"+num+\"&foll_no=\", \"oBj\",\"left=150,top=280,width=620,height=390\");"); 
			out.println("	 popupwin = window.open(\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_RE_PRO_drill_downs_3?chksql=SHOW_RENT_DETAIL_INVOICED_DRILL&application_no=\"+num+\"\", \"oBj\",\"left=150,top=280,width=800,height=600\");"); 
			//0000000123
			//out.println(" load_c_date(document.Form1.hid_cal_date.value);");
			out.println(" }else{");
			out.println("   alert('Please enter Finance Number and continue!');");
			...
			out.println(" if(num!=\"\" ){");	
      //out.println("	 popupwin = window.open(\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CO_Documents?chksql=get_documents&deal_no=\"+num+\"&foll_no=\", \"oBj\",\"left=150,top=280,width=620,height=390\");"); 
			out.println("	 popupwin = window.open(\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_LegalTermination?chksql=SHOW_BALANCES_INFO&url=&client_code=\"+num+\"\", \"oBj\",\"left=150,top=280,width=800,height=600\");"); 
			//0000000123
			//out.println(" load_c_date(document.Form1.hid_cal_date.value);");
			out.println(" }else{");
			out.println("   alert('Please enter Client Code and continue!');");
			...
			out.println("<input type='hidden' name='Hid_scr_name' value='AF_CR_LEGAL_TERMINATION_CAL' > ");
			...
			out.println("<input name=\"TER_DAY\"   type=\"hidden\" value=\"\"> ");
			out.println("<input name=\"TER_MONTH\" type=\"hidden\" value=\"\"> ");
			out.println("<input name=\"TER_YEAR\"  type=\"hidden\" value=\"\">");
			out.println("<input name=\"REQ_BY\"  type=\"hidden\" value=\"\">");
			out.println("<input name=\"TER_V_DAY\"   type=\"hidden\" value=\"\"> ");
			out.println("<input name=\"TER_V_MONTH\" type=\"hidden\" value=\"\"> ");
			out.println("<input name=\"TER_V_YEAR\"  type=\"hidden\" value=\"\">");
        ...
        out.println("<td>&nbsp;</td>");
			  ...
			  out.println("</td>");//out.println("<input name=\"CLIENT_TYPE\" type=\"text\" maxlength=\"10\" class=\"txt_input\" ></td>");
				...
				out.println("<td><input name=\"LEASE_NO\" type=\"text\" maxlength=\"15\" class=\"txt_input\" onchange=check_lease()><input name=\"APPLICATION_NO\" type=\"hidden\">");
			  ...
			  out.println("</td>");//out.println("<input name=\"CLIENT_TYPE\" type=\"text\" maxlength=\"10\" class=\"txt_input\" ></td>");
				out.println("<td >Remark</td>");//Termination Count
				out.println("<td><input name=\"REMARK\"   type=\"text\" maxlength=\"200\"  class=\"txt_input\" style=\"width:300px;\"> <input name=\"TER_COUNT\"   type=\"HIDDEN\" maxlength=\"2\"  class=\"txt_input\" disabled > ");
				out.println("</td>");
				//out.println("<td ></td>");
				//out.println("<td></td>");
				...
				out.println("</td>");
				out.println("<td id=TMR></td>");
				out.println("<td><input name=\"TER_RATE\" type=\"HIDDEN\" maxlength=\"6\" class=\"txt_input\" onchange=check_Rate(document.Form1.TER_RATE.value) STYLE=\"{text-align:right;}\">");
				out.println("</td>");//out.println("<input name=\"CLIENT_TYPE\" type=\"text\" maxlength=\"10\" class=\"txt_input\" ></td>");
			  ...
			  out.println("<td ></td>");
				...
				out.println("<td ></td>");
				out.println("<td><input name=\"TERM_AMOUNT\" type=\"HIDDEN\" maxlength=\"25\" class=\"txt_input\" onchange=\"\" STYLE=\"{text-align:right;}\">");
				out.println("</td>");//out.println("<input name=\"CLIENT_TYPE\" type=\"text\" maxlength=\"10\" class=\"txt_input\" ></td>");
				//out.println("<input name=\"LEAD_SOURCE_CATEGORY\" type=\"text\" maxlength=\"10\" id=\"txtAddress1\" class=\"txt_input\" style=\"width:150px;\" >");
				out.println("</tr>");
				*/
				...
				out.println("<td><input name=\"VAT_PER\" type=\"text\" maxlength=\"5\" class=\"txt_input\" STYLE=\"{text-align:right;}\" disabled> <input name=\"TERM_AMOUNT\" type=\"HIDDEN\" maxlength=\"25\" class=\"txt_input\" onchange=\"\" STYLE=\"{text-align:right;}\" >");//
				out.println("</td>");
		    ...
		    out.println("<tr class=tr_input>");
				...
				out.println("<tr class=tr_input>");
				out.println("<td>Unearned Income</td>");//Modified by Dineth on 17-03-2009
				out.println("<td><input name=\"UNE_INC\" type=\"text\" maxlength=\"25\" class=\"txt_input\" onchange=\"\" STYLE=\"{text-align:right;}\" disabled>");
				out.println("</td>");
				...
				//Modified by Dineth on 17-03-2009
				out.println("<tr class=tr_input>");
				out.println("<td>ODI Adjustment</td>");//ODI Adjustment
				out.println("<td><input name=\"ODI_ADJ\" type=\"text\" maxlength=\"25\" class=\"txt_input\" onchange=\"check_ODI_ADJ()\" STYLE=\"{text-align:right;}\" VALUE='0.00' disabled> ");
				out.println("</td>");
				out.println("<td>ODI Net</td>");//ODI Net
		    ...
		    //Modified by Dineth on 17-03-2009
				...
				//Added by Dineth on 17-03-2009
				out.println("<tr class=tr_input>");
				out.println("<td>Legal Due(With ODI)</td>");//Modified by Dineth on 17-03-2009
				out.println("<td><input name=\"LEG_DUE_WITH_ODI\" type=\"text\" maxlength=\"25\" class=\"txt_input\" onchange=\"\" STYLE=\"{text-align:right;}\" disabled>");
				out.println("</td>");
				out.println("<td>Legal Due(Without ODI)</td>");
				out.println("<td><input name=\"LEG_DUE_WITHOUT_ODI\" type=\"text\" maxlength=\"25\" class=\"txt_input\" onchange=\"\" STYLE=\"{text-align:right;}\" disabled> ");
				out.println("</td>");
				out.println("</tr>");
        ...
        out.println("<td>&nbsp;</td>");
          ...
          out.println("<tr class=pdn_txtpos2>");
					...
					out.println("<td colspan=6></td>");//Residual value
					out.println("</tr>");
          int j=0;
			    while(rs.next()){
            ...
            out.println("<tr class=tr_input >");
						...
						out.println("<td width=10%><INPUT TYPE=\"hidden\" NAME=\"ch_v_"+j+"\" onclick=ch_status(\""+j+"\") value=\"YES\" ></td>");
