...
public class LAKDL_AF_CR_TerminationCheck extends javax.servlet.http.HttpServlet {
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)
	{
        ...
        out.println("}");	
				*/
				...
				out.println("   m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_TerminationCheck?chksql=get_Receipt&client=\"+document.Form1.CLIENT_CODE.value+\"&term_type=\";");
				//out.println("   m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_TerminationCheck?chksql=get_Receipt_new&client=\"+document.Form1.CLIENT_CODE.value+\"&term_type=\";");
				...
				out.println(" document.Form1.TXT_CLIENT_NAME.value = ''  "); //Added by Prabash on 10-02-2012
				...
				*/
				...
				out.println("window.location.href='"+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_TerminationCheck?chksql=main_page'");
				out.println(" }  ");
				out.println("}");
				...
				*/
				...
				//out.println(" check_client(document.Form1.CLIENT_CODE.value);");  // comment by Prabash on 10-02-2012
				out.println("}");
				...
				// added by udara 01-03-2017
				/*
				out.println("if(document.Form1.elements['Text_standard'+num1].checked){");
				
				out.println("   if(document.Form1.elements['FREEZ_STATUS_'+num1].value!=\"Y\"){  ");
				out.println("       if((document.Form1.elements['TERM_TYPE_'+num1].value==\"ERL_TER\") &&  (parseFloat(unformat_noobject(document.Form1.elements['DUE_AM_'+num1].value)))!=\"0\" ){");//
				out.println("       	document.Form1.elements['Text_standard'+num1].checked=false;");
				out.println("       	document.Form1.elements['Text_standard'+num1].value =\"NO\";");
				out.println("       } "); 
			...
			out.println("       document.Form1.elements['TERM_TYPE_'+num1].value=='RENT_REVIS' ){ ");
				...
				*/
				...
				out.println("function allocate_rec(m_fn_no){ "); 
				//out.println("for (var i=0; i < document.Form1.elements.length; i++ ) {");
				//out.println("document.Form1.elements[i].disabled=false;");
				//out.println("}");
				//out.println("		if(validate_data()){"); 
				out.println("		if(confirm(\"Are you sure you want to run the invoice auto allocation routeen?\")){ "); 
				out.println("   document.Form1.Hid_scr_name.value=\"AUTO_ALLOCATION\";");  
				out.println("   document.Form1.hid_fin_no.value=m_fn_no;");  
				...
				out.println("m_url='"+m_class_url+"/"+m_schema_name+"_AF_RE_Collection_Report_With_Age?chksql=SHOW_TRANSACTION_HISTORY_BY_CONTRACT&finance_no='+val2+'&client_code='+val;"); 
				out.println("window.open(m_url,'displayWindow3','left=50,top=60,width=850,height=500,toolbar=0,location=0,directories=0,status=0,menuBar=0,scrollBars=1,resizable=1');"); 
				out.println("}");
				// end by udara 22-10-2015
				
				//Added by Kanchana on 2016-07-20
				out.println("function show_termi_remark_history(val){");
				...
				out.println("</script>"); 
				//	out.println("<BODY class='body & txt-body' leftmargin='0' topmargin='0' marginwidth='0' ONLOAD=\"load_roll_out_value();load_lock();get_Receipt();\">");  comment by Prabash on 10-02-2012
				...
				*/
				/*out.println("<tr class=tr_input>");
				out.println("<td id=fod>Receipt No</td>");
				out.println("<td><input name=\"RECEPT_NO\" type=\"text\" maxlength=\"15\" class=\"txt_input\" onchange=check_receipt()> ");
				...
				*/
				...
				out.println("<input class='but_input' type='button' name='BUT_TXT_CLIENT_NAME_SEARCH' value=\"Search\" onClick=\"get_Receipt()\"></td>"); //Added by prabsh on 10-02-2012
				//out.println("</td>");//out.println("<input name=\"CLIENT_TYPE\" type=\"text\" maxlength=\"10\" class=\"txt_input\" ></td>");
				out.println("</tr>");//Added by Prabash on 10-02-2012
				...
				/*	out.println("<table align='center' width='100%' class='table' border='0'>"); 
							out.println("<tr class=tr_input>"); 
							out.println("<INPUT TYPE='Hidden' NAME='hid_help_type' VALUE=\"\">");  //pra
							...
							//out.println("<input class='but_input' type='button' name='BUT_TXT_APPLICANT_CODE' value=\"Help\">"); 
							out.println("<input class='but_input' type='button' text-align='center' name='BUT_HELP_CLIENT' value=\" Help \" onClick=\"help_button_2()\">"); // prabash 0n 08-02-2012 -help_update()
				...
				out.println("<tr>");						    // Added by Prabash on 10-02-2012
				out.println("<td style=\"width: 6px\"></td>"); //Added by Prabash on 10-02-2012
				...
				/*	out.println("<tr class=tr_input>");
					...
					out.println("<td>&nbsp;</td>");
					out.println("<td>&nbsp;</td>");
					out.println("<td>&nbsp;</td>"); */ //----- comment by Prabash on 10-02-2012
			...
			else if(m_chksql.trim().equals("get_Receipt_new")){
				...
				// out.println(" SELECT TERMINATION_NO, FINANCE_NO, "+
				rs = stmt.executeQuery (" SELECT TERMINATION_NO, FINANCE_NO, "+
					"        TO_CHAR(TERMINATION_VALIDITY_DATE,'DD-MM-YYYY'),"+
					"        AMOUNT-NVL(INVOICED_RENTALS,0), "+//"+m_schema_name+".AF_CO_GET_AMOUNT(TERMINATION_NO, FINANCE_NO,APPLY_DATE), "+
					"        "+m_schema_name+".AF_CO_GET_SETTLED_AMOUNT(INVOICE_NO) SETTLED_AMOUNT , "+//SETTELED_AMOUNT, "+
					"        "+m_schema_name+".AF_CO_GET_BALANCE_AMOUNT(INVOICE_NO) BALANCE_AMOUNT , "+//BALANCE_AMOUNT-NVL(INVOICED_RENTALS,0), "+//"+m_schema_name+".AF_CO_GET_AMOUNT(TERMINATION_NO, FINANCE_NO,APPLY_DATE), "+
					"        NVL("+m_schema_name+".AF_CO_GET_NOT_INV_RENTAL(FINANCE_NO,'',TO_CHAR(APPLY_DATE,'DD-MM-YYYY')),0)+ "+
					"        NVL("+m_schema_name+".AF_CO_GET_DUE_AMOUNT(TERMINATION_NO, FINANCE_NO,APPLY_DATE),0) DUE_AMOUNT , "+
					"        APPLICATION_NO,INVOICE_NO,CLIENT_CODE, "+
					"        "+m_schema_name+".AF_CO_GET_CLIENT_NAME(CLIENT_CODE),  "+
					"        NVL("+m_schema_name+".AF_CO_GET_TER_RESIDUAL(TERMINATION_NO, FINANCE_NO,APPLY_DATE),0) F, "+
					"        "+m_schema_name+".AF_CO_GET_BALANCE_AMOUNT(ODI_INVOICE_NO) H, "+//NVL(ODI_NET,0) H, "+//NVL("+m_schema_name+".AF_CO_GET_ODI_DUE(FINANCE_NO),0) H, "+//,APPLY_DATE
					"        "+m_schema_name+".AF_CO_GET_APP_UNIT_COUNT(APPLICATION_NO) , "+
					"        "+m_schema_name+".AF_CO_GET_APP_UNIT_COUNT(TERMINATION_NO),VAT_PER, "+
					"        TERMINATION_TYPE,"+m_schema_name+".AF_CO_GET_TERMINATION_TYPE(TERMINATION_TYPE),NVL("+m_schema_name+".AF_CO_GET_USER_NAME(ENT_USER),'-'),  "+
					"        RATE, "+m_schema_name+".AF_CO_GET_APP_RATE(FINANCE_NO,'') "+
					...
					" WHERE  ACTIVE_STATUS ='APPRO2' AND  CLIENT_CODE LIKE '%"+m_client+"%'  "+
					//" AND        TERMINATION_VALIDITY_DATE >= TO_DATE(TO_CHAR(SYSDATE,'DD-MON-YYYY'),'DD-MON-YYYY') "+
					"");
				
				//Modified by Dineth on 2008-10-25
				out.println("<tr class=pdn_txtpos2>");
				out.println("<td  width='8%' >Client Name</td>");
				out.println("<td  width='8%' >Finance No</td>");
				out.println("<td  width='8%' >Value Date</td>");
				//out.println("<td  width='6%' align=right>Due Amount</td>");
				//out.println("<td  width='8%' align=right>Settled Amount</td>");
				out.println("<td  width='6%' align=right>Balance Amount</td>");
				out.println("<td  width='6%' align=right>Termination Type</td>");
				out.println("<td  width='6%'  align=right></td>");
				out.println("<td  width='10%'>Termination Sheet</td>");
				out.println("<td  width='5%'>Term. Rate</td>");
				out.println("<td  width='5%'>Fin. Rate</td>");
				out.println("<td  width='6%'>User</td>");
				out.println("<td  width='6%' >Termination No</td>");
				out.println("</tr>");
				...
				while(rs.next()){	
					...
					out.println("<td>"+nf.format(rs.getDouble("DUE_AMOUNT"))+"</td>");
					out.println("<td align=center><input type=text name=\"TERM_DESC_"+j+"\" value=\""+rs.getString(18) +"\" disabled class=\"txt_input\"><input type=hidden name=\"TERM_TYPE_"+j+"\" value="+rs.getString(17) +" disabled >");
					out.println("<td align=center><INPUT TYPE=\"checkbox\" NAME=\"Text_standard"+j+"\" onclick=check_status(\""+j+"\") value=\"NO\" >");
					out.println("<td><input type=\"button\" value=\"display\" class=\"but_input\" name=\"btn_dis_"+j+"\" onclick=\"show_termination_appr('"+rs.getString(2)+"','"+rs.getString(17)+"','"+rs.getString(1)+"')\"> <input ");
					out.println(           "type=\"button\" value=\"Allocate\" class=\"but_input\" name=\"btn_al_"+j+"\" onclick=\"allocate_rec('"+rs.getString(2)+"')\"></td>");
					out.println("<td>"+nf.format(rs.getDouble(20))+"</td>");
					out.println("<td>"+nf.format(rs.getDouble(21))+"</td>");
					out.println("<td>"+rs.getString(19)+"</td>");
					out.println("<td class=hs onclick=load_allo_window('"+rs.getString(1)+"','"+rs.getString(10)+"')>"+rs.getString(1) +"<input type=hidden name=\"TER_NO_"+j+"\" value=\""+rs.getString(1)+"\"></td>");
					out.println("</tr>");
					out.println("<tr class=tr_input>");
					out.println("<td align=right colspan=11><input type=hidden name=hid_inv_count value="+j+"><input type=button name=top_b     value=\"Go to Top\" class=mainbut onclick=befor_end(document.Form1.end_b);  onMouseOver='load_roll_value(\"Top\");' onmouseout='load_roll_value(document.Form1.OPTION_DESC.value);'></td>");
				...
				out.println("<td colspan=16 align=right><input type=button name=end_b   value=\"Go to End\" class=mainbut onclick=befor_end(document.Form1.top_b); onMouseOver='load_roll_value(\"End\");' onmouseout='load_roll_value(document.Form1.OPTION_DESC.value);'></td>");
				out.println("</tr>");
				...
				rs = stmt.executeQuery (" SELECT TERMINATION_NO, FINANCE_NO, "+
					"        TO_CHAR(TERMINATION_VALIDITY_DATE,'DD-MM-YYYY'),"+
					"        AMOUNT-NVL(INVOICED_RENTALS,0), "+//"+m_schema_name+".AF_CO_GET_AMOUNT(TERMINATION_NO, FINANCE_NO,APPLY_DATE), "+
					"        "+m_schema_name+".AF_CO_GET_SETTLED_AMOUNT(INVOICE_NO), "+//SETTELED_AMOUNT, "+
					"        "+m_schema_name+".AF_CO_GET_BALANCE_AMOUNT(INVOICE_NO), "+//BALANCE_AMOUNT-NVL(INVOICED_RENTALS,0), "+//"+m_schema_name+".AF_CO_GET_AMOUNT(TERMINATION_NO, FINANCE_NO,APPLY_DATE), "+
					
					// commented by udara 02-03-2017
					/*
					"        NVL("+m_schema_name+".AF_CO_GET_NOT_INV_RENTAL(FINANCE_NO,'',TO_CHAR(APPLY_DATE,'DD-MM-YYYY')),0)+ "+
					"        NVL("+m_schema_name+".AF_CO_GET_DUE_AMOUNT(TERMINATION_NO, FINANCE_NO,APPLY_DATE),0) G, "+
					*/
					
					// added by udara 02-03-2017					
					"   CASE WHEN ("+m_schema_name+".AF_RENTAL_FREEZ_STATUS(FINANCE_NO) = 'Y') THEN  "+					
					"        NVL("+m_schema_name+".AF_CO_GET_NOT_INV_RENTAL(FINANCE_NO,'',TO_DATE("+m_schema_name+".AF_RENTAL_FREEZ_DATE(FINANCE_NO),'DD-MM-YYYY')),0)+ "+
					"        NVL("+m_schema_name+".AF_CO_GET_DUE_AMOUNT(TERMINATION_NO, FINANCE_NO,TO_DATE("+m_schema_name+".AF_RENTAL_FREEZ_DATE(FINANCE_NO),'DD-MM-YYYY')),0)  "+ // no need of modification // mod by udara adding - to the end on 23-08-2017
					//"        NVL("+m_schema_name+".AF_CR_FREEZED_RENTAL_AMOUNT(APPLICATION_NO,FINANCE_NO,NULL),0) "+ // no need this modification // added by udara on 23-08-2017
					
					"   ELSE "+
					
					"        NVL("+m_schema_name+".AF_CO_GET_NOT_INV_RENTAL(FINANCE_NO,'',TO_CHAR(APPLY_DATE,'DD-MM-YYYY')),0)+ "+
					"        NVL("+m_schema_name+".AF_CO_GET_DUE_AMOUNT(TERMINATION_NO, FINANCE_NO,APPLY_DATE),0) "+
					
					"   END  G,"+
					// end by udara 02-03-2017
					...
					"        TERMINATION_TYPE,"+m_schema_name+".AF_CO_GET_TERMINATION_TYPE(TERMINATION_TYPE),NVL("+m_schema_name+".AF_CO_GET_USER_NAME(ENT_USER),'-'),  "+
					"        RATE, "+m_schema_name+".AF_CO_GET_APP_RATE(FINANCE_NO,'') "+
					"        , "+m_schema_name+".AF_RENTAL_FREEZ_STATUS(FINANCE_NO) "+ // 21 added by udara 01-03-2017
					//"        ,DUE_AMOUNT,INVOICE_NO,RATE,  REMARKS, CHARGES,  "+
					//"        TO_CHAR(APPLY_DATE,'DD-MM-YYYY'),TERMINATED_DATE, "+
					//"        APPLICATION_NO, REG_NO "+
					" ,"+m_schema_name+".AF_CR_GET_IS_DATE_VALID(TERMINATION_NO) IS_VALID "+//Added by jithendra 04-01-2018
					" FROM   "+m_schema_name+".AF_CR_PRO_TERMINATION "+
					" WHERE  ACTIVE_STATUS ='APPRO2' AND  CLIENT_CODE LIKE '%"+m_client+"%'  "+
					//" AND        TERMINATION_VALIDITY_DATE >= TO_DATE(TO_CHAR(SYSDATE,'DD-MON-YYYY'),'DD-MON-YYYY') "+
					"");
		...
		out.println("<td  width='10%' >Value Date</td>");
				...
				out.println("<td  width='8%' align=right>Due Amount</td>");
				//out.println("<td  width='8%' align=right>Residual Value</td>");
				out.println("<td  width='8%' align=right>OD Interest</td>");
			...
			*/
				...
				out.println("<td  width='8%' >Finance No</td>");
				out.println("<td  width='8%' >Value Date</td>");
				//out.println("<td  width='8%' align=right>Discounted Amount</td>");
				//out.println("<td  width='8%' align=right>Settled Amount</td>");
				//out.println("<td  width='6%' align=right>Balance Amount</td>");
				out.println("<td  width='6%' align=right>Due Amount</td>");
				//out.println("<td  width='8%' align=right>Residual Value</td>");
				out.println("<td  width='6%' align=right>OD Interest</td>");
				out.println("<td  width='8%' align=right>Settled Amount</td>");
				out.println("<td  width='6%' align=right>Balance Amount</td>");
				out.println("<td  width='6%' align=right>Total Bal Amount</td>");
				out.println("<td  width='6%' align=right>Termination Type</td>");
				out.println("<td  width='6%'  align=right></td>");
				out.println("<td  width='10%'>Termination Sheet</td>");
				out.println("<td  width='5%'>Term. Rate</td>");
				...
				out.println("<td  width='6%'>User</td>");
				out.println("<td  width='6%' >Termination No</td>");
				out.println("<td  width='6%'  align=right>Remark history</td>"); //Added by Kanchana on 2016-07-20				
				//out.println("<td  width='13%' >Amount Allocat</td>");
				//out.println("<td  width='8%' ></td>");
				out.println("</tr>");
				...
				while(rs.next()){
					...
					out.println("<td align=right>"+nf.format(rs.getDouble(5))+"<input type=hidden name=\"SETT_A_"+j+"\" value=\""+rs.getString(5)+"\"><input type=hidden name=\"T_V_COUNT_"+j+"\" value=\""+rs.getString(15)+"\"></td>");
					out.println("<td align=right>"+nf.format(rs.getDouble(6))+"<input type=hidden name=\"BAL_AM_"+j+"\" value=\""+(rs.getString(6))+"\"></td>");
					m_DUE_bal=(rs.getDouble(6)+rs.getDouble(7));
					out.println("<td align=right>"+nf.format((rs.getDouble(6)+rs.getDouble(7)))+"<input type=hidden name=\"DUE_AM_"+j+"\" value=\""+nf.format((rs.getDouble(6)+rs.getDouble(7)))+"\"></td>");// +rs.getDouble(13)
					/*if(rs.getDouble(5)>0 && (rs.getDouble(6)+rs.getDouble(7))>0){//+rs.getDouble(13)
					...
					*/
					...
					//out.println("<td align=center><input type=text name=\"TERM_DESC_"+j+"\" value=\""+rs.getString(18)+"\" disabled class=\"txt_input\"><input type=hidden name=\"TERM_TYPE_"+j+"\" value="+rs.getString(17)+" disabled >");  // commented by udara 01-03-2017
					out.println("<td align=center><input type=text name=\"TERM_DESC_"+j+"\" value=\""+rs.getString(18)+"\" disabled class=\"txt_input\"><input type=hidden name=\"TERM_TYPE_"+j+"\" value="+rs.getString(17)+" disabled > <input type=hidden name=\"FREEZ_STATUS_"+j+"\" value="+rs.getString(22)+"  disabled > "); // added udara 01-03-2017
					//out.println("<td align=center><INPUT TYPE=\"checkbox\" NAME=\"Text_standard"+j+"\" onclick=check_status(\""+j+"\") value=\"NO\" >");//commenetd by jithendra 04-01-2018
					
					//added by jithendra 04-01-2018
					    if(rs.getString("IS_VALID").equals("Y")){
						out.println("<td align=center><INPUT TYPE=\"checkbox\" NAME=\"Text_standard"+j+"\" onclick=check_status(\""+j+"\") value=\"NO\" >");
						}else{
						out.println("<td align=center><INPUT TYPE=\"checkbox\" NAME=\"Text_standard"+j+"\" onClick=\"change_not_allowed(this)\" value=\"NO\" >");
						}
					//end by jithendra 04-01-2018
					...
					out.println("<td>"+nf.format(rs.getDouble(20))+"</td>");//Added by Dineth on 2008-11-10
					out.println("<td>"+nf.format(rs.getDouble(21))+"</td>");//Added by Dineth on 2008-11-10
					out.println("<td>"+rs.getString(19)+"</td>"); 
					out.println("<td class=hs onclick=load_allo_window('"+rs.getString(1)+"','"+rs.getString(10)+"')>"+rs.getString(1) +"<input type=hidden name=\"TER_NO_"+j+"\" value=\""+rs.getString(1)+"\"></td>");
					out.println("<td width='8%'><INPUT TYPE='BUTTON' NAME='BTT_REMARK_HIS_"+j+"' class=\"but_input\" VALUE=\"View\" onClick=show_termi_remark_history('"+rs.getString(2)+"')></td>"); //Added by Kanchana on 2016-07-20
					//}
					//out.println("     </td>");
					out.println("</tr>");
					...
					if(rs.next()){
						...
						//out.println("<td align=right><SELECT name=\"TERM_TYPE_"+j+"\" class=\"txt_input\"  >"+m_ter_type+"</td>");//onclick=check_type(\""+j+"\")
						//out.println("<td align=center><input type=text name=\"TERM_DESC_"+j+"\" value=\""+rs.getString(18) +"\" disabled class=\"txt_input\"><input type=hidden name=\"TERM_TYPE_"+j+"\" value="+rs.getString(17) +" disabled >"); // commented by udara 01-03-2017
						out.println("<td align=center><input type=text name=\"TERM_DESC_"+j+"\" value=\""+rs.getString(18) +"\" disabled class=\"txt_input\"><input type=hidden name=\"TERM_TYPE_"+j+"\" value="+rs.getString(17) +" disabled > <input type=hidden name=\"FREEZ_STATUS_"+j+"\" value="+rs.getString(22)+"  disabled > "); // added by udara 01-03-2017
						//out.println("<td align=center><INPUT TYPE=\"checkbox\" NAME=\"Text_standard"+j+"\" onclick=check_status(\""+j+"\") value=\"NO\" >");//commenetd by jithendra 04-01-2018
				...
				out.println("<tr class=tr_input>");
				out.println("<td align=right colspan=16><input type=hidden name=hid_inv_count value="+j+"><input type=button name=top_b     value=\"Go to Top\" class=mainbut onclick=befor_end(document.Form1.end_b);  onMouseOver='load_roll_value(\"Top\");' onmouseout='load_roll_value(document.Form1.OPTION_DESC.value);'></td>");
				...
				out.println("<input class='but_input' type='button' text-align='center' name='BUT_HELP_MAIN' value=\" Help \" onClick=\"help_finance_no()\"></td>"); 
