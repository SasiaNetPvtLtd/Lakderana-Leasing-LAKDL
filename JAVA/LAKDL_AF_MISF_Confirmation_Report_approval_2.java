...
public class LAKDL_AF_MISF_Confirmation_Report_approval_2 extends javax.servlet.http.HttpServlet { //LAKDL_AF_CR_PRO_Enter_Deletion_letter_details_app
	...
	public void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { // added by udara 18-05-2017
		...
		try { 
			...
			if(m_chksql.equals("main_page")){
					out.println("<HTML>"); 
					out.println("<HEAD>"); 
					out.println("<TITLE>Confirmation Report Approval Level 3</TITLE>"); 
					out.println("</HEAD>"); 
					...
					*/
					...
					out.println("      m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Confirmation_Report_approval_2?chksql=details&status=\"+document.Form1.hid_status.value+\"&APPLICATION_NO=\"+document.Form1.TXT_APP_NO.value;"); 
					...
					out.println("			window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MISF_Confirmation_Report_approval_2?chksql=main_page';"); 
					out.println("		}"); 
					out.println("}"); 
					...
					out.println("   help_box.innerHTML=\" Confirmation Report Approval Level 3 - \"+m_val;"); 
					out.println("}"); 
					out.println(""); 

					out.println("function load_roll_out_value(){");
					out.println("help_box.innerHTML=\" Confirmation Report Approval Level 3 - \"+document.Form1.hid_status.value;"); 
					out.println("}"); 
				  ...
				  out.println("document.Form1.TXT_VALUE_DATE_YY.disabled=true;");
					...
					//out.println("		if(validate_data()){");	
					out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_MISF_Confirmation_Report_approval_save_2';");  
				...
				*/
				...
				out.println("}");	
				    ...
				    out.println("function load_details_report(val){"); 
					out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Confirmation_Report_Detail_View?chksql=main_page&finance_no=\"+val; ");
					out.println("window.open(m_url,'popupwin_conf_rpt_app_3','left=110,top=110,width=750,height=800,toolbar=0,location=0,directories=0,status=0,menuBar=1,scrollBars=1,resizable=1')");
					out.println("} ");
				...
				out.println("m_url='"+m_class_url+"/"+m_fschema_name+"AF_MISF_Confirmation_Report_approval_2?chksql=drill_down&finance_no='+val;"); 
				out.println("window.open(m_url,'displayWindow3','left=50,top=60,width=850,height=500,toolbar=0,location=0,directories=0,status=0,menuBar=0,scrollBars=1,resizable=1');"); 
				out.println("}");
				...
				// end by udara 24-07-2018
					...
					out.println("<INPUT TYPE='Hidden' NAME='hid_scr_url'    VALUE=\"LAKDL_AF_MISF_Confirmation_Report_approval_2\" >"); // added by udara 13-06-2017
					...
					out.println("<INPUT TYPE='Hidden' NAME='hid_stage' VALUE=\"APPROVE_3\" >"); // added by udara 23-06-2017
					...
					out.println("</tr>"); 
					out.println("<tr>"); 
					out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Confirmation Report Approval Level 3</td>"); 
					out.println("</tr>"); 
					out.println("<tr>"); 
										...
										" DECODE(B.APPLICATION_STATUS,'ACTIVATED', "+
											 " (SELECT TO_CHAR(MAX(ENT_DATE),'DD-MM-YYYY HH:MI:SS') "+
								                           ...
								                           " AND STATUS = B.APPLICATION_STATUS "+
															...
															" ) "+ // end nvl
											" ) "+
											//" ,"+m_schema_name+".AF_GET_CONF_ASSIGN_ME_STATUS(A.FINANCE_NO,'"+m_username+"') "+ // commented by udara 19-07-2017 // 9 added by udara 13-06-2017
