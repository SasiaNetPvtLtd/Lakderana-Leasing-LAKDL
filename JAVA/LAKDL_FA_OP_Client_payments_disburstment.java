...
public class LAKDL_FA_OP_Client_payments_disburstment extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Operation Process - Client Payments - Disbursement</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("	}"); 
			out.println("	if(document.Form1.TXT_DISBURSE_TO.value==\"\" ){  "); 
			out.println("		DIV_TXT_DISBUR.style.color='red';");
			out.println("		m_flag=false;"); 
			out.println("	}");
			out.println("	if(document.Form1.TXT_SETTLEMENT_MODE.value==\"CHEQUE\" ){  "); 
			...
			out.println("			}");
			out.println("			document.Form1.action='"+m_class_url+"/"+m_fschema_name+"FA_OP_Save_Client_payments_disburstment';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"FA_OP_Client_payments_disburstment';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("    m_help_message = \"m_help_msg_LAKDL_FA_OP_CHEQUE_DISB\";"); 
			...
			out.println("	help_box.innerHTML=\" Operation Process - Client Payments - Disbursement - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\" Operation Process - Client Payments - Disbursement - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
	  	...
	  	out.println("					}"); 
			...
			out.println(" 	m_sql = \"m_help_DIV_TXT_PAYMENT_DISBURSMENT_sql\";"); 
			out.println(" 	m_criteria = document.Form1.TXT_PAYMENT_NO.value+\"@\";");
			out.println(" 	HelpBox('1','10','14');"); 
			out.println("}"); 
      ...
      out.println(" document.Form1.hid_cal_date.value=num;"); 
		  ...
		  out.println("  else if(document.Form1.hid_cal_date.value=='2'){"); 	
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Operation Process - Client Payments - Disbursement</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<td width='50%' ><input class='txt_input' type='text' name='TXT_PAYMENT_NO' maxlength='25' size='10'>"); 
			out.println("<input class='but_input' type='button' name='BUT_HELP_MAIN_10' value=\"Help\" onClick=\"help_update_payment_no()\"></td>"); 
			...
			out.println("<input class='but_input' type='button' name='BUT_HELP_MAIN_1' value=\"Help\" onClick=\"help_update_client()\"></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>");
			out.println("<tr >"); 
			...
			out.println("<td width='50%' ><input class='txt_input' type='text' name='TXT_FACILITY_NO' maxlength='20' size='10' onblur=\"help_update_facility()\" disabled></td>");
			out.println("<td width='*%'></td>"); 
			out.println("</tr>");
			out.println("<tr >"); 
			...
			out.println("<input class=\"txt_input5\" type=\"text\" name=\"TXT_PAYMENT_YY\" maxlength=\"4\" size=\"4\" onblur=\"checkMonthLength(document.Form1.TXT_PAYMENT_DD,document.Form1.TXT_PAYMENT_MM,document.Form1.TXT_PAYMENT_YY)\" disabled></td>");
			out.println("<td width='*%'></td>"); 
			out.println("</tr>");
			out.println("<tr >"); 
			out.println("<td width='15%' ><DIV id='DIV_TXT_PAYMENT_AMOUNT'  class=div_input>Payment Amount</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_PAYMENT_AMOUNT' maxlength='25' size='50' style='width:150;text-align:right;'   value=\"0\" onchange=\"get_rpt_currency_amt();format_num(document.Form1.TXT_PAYMENT_AMOUNT,4);\"  tabindex=\"3\" disabled></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>");
			out.println("<tr >");
			out.println("<td width='15%' ><DIV id='DIV_TXT_CURRENCY'  class=div_input>Currency</DIV></td>");
			out.println("<td width='40%' ><SELECT onchange=\"get_exchange_rate()\" name=\"TXT_CURRENCY_CODE\" class=\"txt_input\" disabled> ");
			...
			out.println("<td width='40%' ><SELECT onchange=\"get_exchange_rate()\" name=\"TXT_SETTLEMENT_MODE\" class=\"txt_input\" disabled> ");
			...
			out.println("<td width=\"40%\"><input class=\"txt_input5\" type=\"text\" name=\"TXT_CHEQUE_DD\" maxlength=\"2\" size=\"2\" disabled>");
			out.println("<input class=\"txt_input5\" type=\"text\" name=\"TXT_CHEQUE_MM\" maxlength=\"2\" size=\"2\" disabled>");
			out.println("<input class=\"txt_input5\" type=\"text\" name=\"TXT_CHEQUE_YY\" maxlength=\"4\" size=\"4\" onblur=\"checkMonthLength(document.Form1.TXT_CHEQUE_DD,document.Form1.TXT_CHEQUE_MM,document.Form1.TXT_CHEQUE_YY)\" disabled></td>");
			out.println("<td width='*%'></td>"); 
			out.println("</tr>");
			out.println("<tr >"); 
			out.println("<td width='15%' ><DIV id='DIV_TXT_INVOICE_COMMENTS'  class=div_input>Comments </DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_INVOICE_COMMENTS' maxlength='200' size='200' style='width:200' disabled></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>");
			out.println("<tr>"); 
			out.println("<td width='15%' ><DIV id='DIV_TXT_LICEN_ACCOUNT'  class=div_input>Licensee Account</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_LICEN_ACCOUNT' maxlength='10' size='10' disabled></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>");
			out.println("<tr>"); 
			...
			out.println("<td width='40%' ><SELECT onchange=\"get_payment_3rd_party()\" name=\"TXT_3RD_PARTY\" class=\"txt_input\" disabled> ");
			...
			out.println("</tr>");
			out.println("<tr>"); 
			out.println("<td width='15%' ><DIV id='DIV_TXT_DISBUR'  class=div_input>Disburse Person *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_DISBURSE_TO' maxlength='100' size='100'></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>");
			out.println("</table>"); 
