...
public class LAKDL_AF_RE_Collection_group_Receipt_Document extends javax.servlet.http.HttpServlet {
  ...
  public synchronized void service(HttpServletRequest req, HttpServletResponse res)
	{
      ...
      out.println("			}");
	  	...
	  	out.println("		}"); 
			...
			out.println("    HelpBox('1','10','0',Crit,'ReceiptSql_group_1','1');"); 
			out.println("}"); 
			out.println(""); 
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_RE_Collection_group_Receipt_Document';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("help_box.innerHTML=\" Collection Process - Group Receipt Document - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" Collection Process - Group Receipt Document - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
			...
			out.println("}");
			out.println("else{");
			out.println("	m_url = \""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_RE_Receipt_Document_group?chksql=main_page&receipt_no=\"+document.Form1.TXT_RECEIPT_NO.value+\"&client_no=\"+m_client_code+\"&print=TRUE\";"); 
      ...
      out.println("</Script>");
	    ...
	    out.println("<INPUT TYPE='Hidden' NAME='hid_no_rec' VALUE=\"\">"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Collection Process - Group Receipt Document</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
