...
public class LAKDL_AF_MISF_Transaction_Audit_Date extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			LAKDL_AF_MISF_Audit_Date_Transaction_SQL CO_methods = new LAKDL_AF_MISF_Audit_Date_Transaction_SQL();
			LAKDL_AF_MISF_Audit_Date_Transaction_Drill_SQL CO_drill_methods = new LAKDL_AF_MISF_Audit_Date_Transaction_Drill_SQL();//mk
					  ...
					  out.println("<HTML>"); 
						...
						//Added by Dineth on 28-04-2009
						  ...
						  out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Agreement_Register?chksql=load_agreement_regi&from_date="+m_from_date+"&to_date="+m_to_date+"&sort_column=\"+m_sort_col+\"&order_by_type=\"+m_order_by_type+\" \";");
							...
							out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Transaction_Audit_Date?chksql=drill_report&m_data=\"+m_data+\"&rpt_type="+m_rpt_type+"&user="+m_user+"&from_date="+m_from_date+"&to_date="+m_to_date+"&rpt_name="+m_rpt_name+"\";"); 
