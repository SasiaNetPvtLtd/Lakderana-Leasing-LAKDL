//--
//SCREEN NAME	:MIS - RECEIPT REALIZE REPORT
//CREATED BY	:DINETH
//DATE/TIME		:2009-06-29
//NOTES				:
...
public class LAKDL_AF_MISF_display_receipt_realization_report extends javax.servlet.http.HttpServlet { 
...
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!	
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MISF_display_receipt_realization_report?chksql=main_page';"); 
			out.println("		}"); 
			out.println("}"); 
		 ...
		 out.println("popupwin = window.showModalDialog('"+m_class_url+"/"+m_fschema_name+"AF_RE_Help_Servlet?class_in="+m_fschema_name+"AF_RE_help_select&Sql_in='+Sql+'&Start_in='+Start+'&End_in='+End+'&Crit_In='+Crit+'&Hid_No='+Hid_No+'&Max_in='+Hid_No+'&Args=', oBj,\"dialogWidth:25em; dialogHeight:26em; center:yes; status:no\");");
	  	...
	  	out.println("		}"); 
			...
			//End by Dineth on 18-06-2009
			out.println("function load_help_msg() {"); 
			out.println("    m_help_message = \"m_help_msg_LAKDL_LAKDL_AF_MISF_display_receipt_realization_report\";"); 
			...
			out.println("help_box.innerHTML=\"  Return Realization Report - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\"  Return Realization Report \";"); 
			out.println("}"); 
		  ...
		  out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_sql_validations?chksql=m_prime_chk_LAKDL_AF_MK_display_application&data_val=\"+obj.value+\"&ac_status=Y\";");
			...
			//Commented by Dineth on 18-06-2009
      /*
      ...
      */
      //End by Dineth on 18-06-2009
		  ...
		  out.println("function view() {");
			...
			//End by Dineth on 18-06-2009
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_display_receipt_realization_report1?chksql=MAIN&order_by=CLIENT_CODE&sort_by=ASC&from_date=\"+document.Form1.hid_from_date.value+\"&branch=\"+m_branch+\"&to_date=\"+document.Form1.hid_to_date.value+\" \";");
...
//-----------------------------------------------------------------------------------------------------------------------
			...
			out.println("</script>"); 
			out.println("<BODY onload=\"get_sys_date();\" class='body & txt-body' leftmargin='0' topmargin='0' marginwidth='0'>"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Return Realization Report </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<td width='10%' ID=VDATE>Return Date</td>");//Modified by Dineth on 18-06-2009
			...
			out.println("<input class='but_input' type='button' name='BUT_VIEW' value=\"View\" onClick=\"view()\"></td>"); 
			//End by Dineth on 26-06-2009
