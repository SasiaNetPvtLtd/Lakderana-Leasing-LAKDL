...
public class LAKDL_AF_CR_PRO_Document_Printing_Main extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res) { 
      ...
      String m_username = m_sn_methods.username;
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE> Credit - Agreement Printing </TITLE>"); 
			out.println("</HEAD>"); 
      ...
      out.println("      display_data(data_vec);"); 		
			...
			out.println("}");
				...
				out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_CR_PRO_Document_Printing_Main?chksql=main_page';"); 
				out.println("		}"); 
				out.println("}"); 
          ...
          out.println("}");
	    		...
	    		out.println("<td width='10%' align='center'><input type=button name=back value=\"Close\" class=mainbut onclick=close_screen(); onMouseOver='load_roll_value(\"Close\");' onmouseout='load_roll_out_value();'></td>");
					...
					*/
					...
					out.println("<td width='35%' ><input class='txt_input' type='text' name='TXT_APPLICATION_NO' maxlength='15' size='15' onblur=\"help_update('1','10','5','m_help_TXT_APPLICATION_NO_9','99')\">"); 
					out.println("<input class='but_input' type='button' name='BUT_HELP_MAIN' value=\"...\" onClick=\"help_update('1','10','5','m_help_TXT_APPLICATION_NO_9','99')\" ></td>");
