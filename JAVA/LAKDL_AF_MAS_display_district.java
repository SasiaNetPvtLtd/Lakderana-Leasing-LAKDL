...
//--
//SCREEN NAME:SYSTEM ADMINISTRATION - DISTRICT
//ID:1.3 District Creation Process
//CREATED BY:N.V.P.Chandana
//DATE/TIME:19-07-2006/4.45pm
//NOTES:
...
public class LAKDL_AF_MAS_display_district extends javax.servlet.http.HttpServlet { 
public ResultSet rs,rs1,val;
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>System Administration - Districts</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("var district_arry=new Array();");
			...
			out.println("			}");
			out.println("		else	if(data_vec.length>0 && document.Form1.SCREEN_NAME.value==\"VIEW\"){");
			out.println("    count_val(data_vec);");
			out.println("			}");
			out.println("    else if(data_vec.length > 0 && document.Form1.SCREEN_NAME.value!=\"NEW\"&& document.Form1.TXT_DISTRICT_CODE.value !=''&& document.Form1.hid_help_status.value == 'H9' ){");
      ...
      out.println("   }");
			out.println("district_arry=data_vec");
			out.println("   }");
			...
			out.println("    else if(data_vec.length == 0 && document.Form1.hid_help_status.value == 'H1'&& document.Form1.TXT_PROVINCE_CODE.value !='' ){");
      //out.println("    alert('Selected Province code is incorrect,use help...!');");
			out.println("    help_button_1() ;");
			out.println("province_arry=data_vec");
      out.println("   }");
			
			out.println("    else if(data_vec.length > 0 &&  document.Form1.SCREEN_NAME.value==\"NEW\" && document.Form1.TXT_DISTRICT_DESC.value !=''&& document.Form1.hid_help_status.value == 'H2' ){");
     //	out.println("    alert('Entered District already in use,enter district that is not in help...!');");
			out.println("				alert('Record already exist');");

			out.println("    help_update_desc() ;");
			out.println("document.Form1.TXT_DISTRICT_DESC.value='';"); 
			out.println("document.Form1.TXT_DISTRICT_DESC.focus();"); 
			...
			out.println("    m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_district1&data_val=\"+obj.value;");
			out.println("}");
			out.println("    else");
			...
			out.println("    m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_district&data_val=\"+obj.value+\"&ac_status=Y\";");
			out.println("}");
			out.println("    if(document.Form1.hid_help_status.value=='H9' && document.Form1.SCREEN_NAME.value==\"RACT\")");
      out.println("    m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_district&data_val=\"+obj.value+\"&ac_status=N\";");
						
      out.println("    if(document.Form1.hid_help_status.value == 'H1') {");
			out.println("    m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_province&data_val=\"+obj.value;");
			out.println("}");
     //	out.println("window.open(m_url);");		
			...
			out.println("    m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_display_district_desc&data_val=\"+obj.value;");
			out.println("     load_interface(m_url,'XML');");
			out.println("}");
      ...
      out.println("}");
			...
			out.println("    document.Form1.TXT_DISTRICT_CODE.value=data_vec[0]; ");
			out.println("    document.Form1.TXT_DISTRICT_DESC.value=data_vec[1]; ");
			out.println("    document.Form1.TXT_PROVINCE_CODE.value=data_vec[2]; ");
			out.println("    document.Form1.TXT_DEFAULT_VALUE.value=data_vec[3]; ");
			out.println("    document.Form1.TXT_PROVINCE_DESC.value=data_vec[4]; ");
			out.println("   }");


			out.println("function validate_data(){"); 
			out.println("//validations goes here"); 
			out.println("if(document.Form1.TXT_DISTRICT_CODE.value==\"\"){  "); 
			...
			out.println("}"); 
			out.println("else if(document.Form1.TXT_DISTRICT_DESC.value==\"\"){  "); 
			out.println("DIV_TXT_DISTRICT_DESC.style.color='red';");
			//out.println("alert('Enter District Decscription..!')");
			out.println("document.Form1.TXT_DISTRICT_DESC.focus()");

			out.println("return false;"); 
			out.println("}"); 
			out.println("else if(document.Form1.TXT_PROVINCE_CODE.value==\"\"){  "); 
			out.println("DIV_TXT_PROVINCE_CODE.style.color='red';");
			//out.println("alert('Enter Province...!')");
		...
		//	out.println("		if(confirm(\"Are You Sure you want to \"+document.Form1.hid_save.value+\" ?\")){ "); //**
			...
			out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_MAS_save_district';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MAS_display_district';"); 
			out.println("		}"); 
			out.println("}"); 
			
			out.println("function close_window(){	"); 
			out.println("		if(confirm(\"Are you sure you want to close the screen? \")){ "); 
			//out.println("		parent.frames[0].change_window();");
			...
			out.println("    m_help_message = \"m_help_msg_LAKDL_AF_MAS_display_district\";"); 
			...
			out.println("help_box.innerHTML=\" System Administration - Districts - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" System Administration - Districts - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
			...
			out.println("document.Form1.TXT_PROVINCE_CODE.disabled=true;"); 
			...
			out.println("document.Form1.BUT_TXT_PROVINCE_CODE.disabled=true;"); 
      ...
      out.println(" }");
			...
			//out.println("if(district_arry.length==0 && document.Form1.hid_help_status.value=='H9' || document.Form1.hid_help_status.value=='H2') {");//**
			...
			//out.println("if(document.Form1.TXT_DISTRICT_CODE.value!='' && province_arry.length==0 && document.Form1.hid_help_status.value=='H1') {");//**
			out.println("document.Form1.TXT_PROVINCE_CODE.value='';");
			out.println("document.Form1.TXT_PROVINCE_DESC.value='';");
			out.println("document.Form1.TXT_PROVINCE_CODE.focus();");
			out.println("}");
		...
		//	out.println("document.Form1.TXT_DEFAULT_VALUE.value='';"); 
			...
			*/
			...
			out.println("var pro=document.Form1.TXT_PROVINCE_CODE.value.substr(0,1)");
			out.println("if(bttn_pres1!=1){");
			out.println("    m_criteria = document.Form1.TXT_PROVINCE_CODE.value+\"@Y@\";"); 
			out.println("}"); 
			out.println("if(bttn_pres1==1){");
			out.println("    m_criteria = pro+\"@Y@\";"); 
			out.println("}"); 
			...
			out.println("    } ");
			out.println("    else{");
			out.println("    m_criteria = document.Form1.TXT_DISTRICT_CODE.value+\"@\"+\"N@\";"); 
			out.println("}"); 
			out.println("    HelpBox('1','10','2');"); 
			...
			out.println("    document.Form1.TXT_PROVINCE_CODE.value=oBj.valout[4];"); 
			out.println("    document.Form1.TXT_DEFAULT_VALUE.value=oBj.valout[5];"); 
			out.println("    assign_help_status('H9'); makeRequest(document.Form1.TXT_DISTRICT_CODE);");
	//		out.println("}");
	//		out.println("else{");
	//		out.println("    document.Form1.TXT_DISTRICT_CODE.value=\"\";"); 
		...
		//	out.println("}"); 
			...
			out.println("    m_sql = \"m_help_TXT_DISTRICT_DESC_sql\";"); 
			out.println("    m_criteria = document.Form1.TXT_DISTRICT_DESC.value+\"@\";"); 
			out.println("    HelpBox('1','10','2');"); 
			out.println("}"); 
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////
	  	...
	  	out.println("		}"); 
			...
			out.println("function count_val(data_vec){");
			out.println("alert('count');");		
			out.println("document.Form1.num_of_rec.value=data_vec[0];");
		  out.println("half_num=document.Form1.num_of_rec.value/2 ;");
			//out.println("alert(half_num);");
			//out.println("data_vec[0]");
			out.println("   }");
			...
			out.println("function check_province() {");
		 	out.println("var keyChar=window.event.keyCode;");
			out.println("if (keyChar <='48'&& keyChar >='48' && keyChar <= '57' || keyChar == '13' )");
			out.println("{	");	
			out.println("window.event.keyCode=keyChar;	");	
			...
			out.println("<INPUT TYPE='Hidden' NAME='num_of_rec' VALUE=\"\">");	
			out.println("<INPUT TYPE='Hidden' NAME='half_rec' VALUE=\"\">");
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>System Administration - Districts</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_DISTRICT_CODE' maxlength='10' size='10' onblur=\"assign_help_status('H9'), makeRequest(document.Form1.TXT_DISTRICT_CODE)\" onkeypress=\"check_district()\">"); 
			...
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_DISTRICT_DESC' maxlength='50' size='20' onblur=\"assign_help_status('H2'),makeRequest1(document.Form1.TXT_DISTRICT_DESC)\" style='{width:180}' ></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 

			out.println("<td width='30%' ><DIV id='DIV_TXT_PROVINCE_CODE'  class=div_input>Province Code *</DIV></td>"); 
			out.println("<td width='30%' ><input class='txt_input' type='text' name='TXT_PROVINCE_CODE' maxlength='10' size='10' onblur=\"assign_help_status('H1'),makeRequest(document.Form1.TXT_PROVINCE_CODE)\" onkeypress=\"check_province()\">"); 
			out.println("<input class='but_input' type='button' name='BUT_TXT_PROVINCE_CODE' value=\"Help\" onClick=\"help_button_1()\"></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
			
			out.println("<tr >"); 
			out.println("<td width='30%' ><DIV id='DIV_TXT_PROVINCE_DESC'  class=div_input>Province Description</DIV></td>"); 
			out.println("<td width='30%' ><input class='txt_input' type='text' name='TXT_PROVINCE_DESC' maxlength='20' size='20' onblur=\"\" style='{width:180}' disabled >"); 
			out.println("</td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>"); 
