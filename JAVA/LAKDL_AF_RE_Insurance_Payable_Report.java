...
// CREATED BY Prabash ON 2011-07-07
// DISPLAY NAME Insurance Payable Report
import java.io.*;
...
public class LAKDL_AF_RE_Insurance_Payable_Report extends javax.servlet.http.HttpServlet {
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)	throws IOException	{
		...
		try {
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_RE_Insurance_Payable_Report';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("    m_help_message = \"m_help_msg_LAKDL_AF_RE_Insurance_Payable_Report\";"); 
			...
			out.println("	help_box.innerHTML=\" Insurance Payable Report - \"+m_val;"); 
			out.println("}"); 
			
			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\" Insurance Payable Report \";"); 
			out.println("}"); 
			...
			out.println("<table class='table' width='100%'  >"); 
			out.println("<tr>"); ; 
			out.println("<td  width='15%' ><DIV id='DIV_TXT_REAL_DATE1'  class=div_input><b>Insurance Done By</b></DIV></td>"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td width='15%' ><DIV id='DIV_COM_NAME'  class=div_input><b> Company</b></DIV></td>"); 
			out.println("<td width='20%' ><input class='txt_input' type='text' name='COM_NAME' maxlength='10' size='50' style='width:100' onblur=\"company_help()\" >"); 
