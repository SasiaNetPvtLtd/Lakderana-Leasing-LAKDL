...
public class LAKDL_AF_RE_Receipt_Bulk_Print_Main extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Invoicing - Recipts Bulk Print </TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("	  if(data_vec.length>0 && document.Form1.hid_option.value==\"2\"){");
			out.println("    document.Form1.TXT_RECEIPT_NO.value=data_vec[0];"); 
      ...
      out.println("			else {");
			...
			out.println("function enable_recep_no(){ ");
				out.println("if(document.Form1.TXT_RECEIPT_NO.value==\"\")");
				out.println("{ ");			
				out.println("alert('Receipt number cannot be blank'); ");
				//out.println("return false; ");
				out.println("} ");
				out.println("else if(document.Form1.TXT_RECEIPT_NO.value!=\"\"){ ");
				//out.println("return true; ");
				out.println("bulk_print();");
				out.println("} "); //if
			out.println("} "); 
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_RE_Receipt_Bulk_Print_Main?chksql=main_page';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("	help_box.innerHTML=\" Invoicing - Receipts Bulk Print - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\" Invoicing - Receipts Bulk Print \";"); 
			out.println("}"); 
		...
		//  out.println("m_user_clear=\"TXT_USER\"+document.Form1.hid_row_no.value;");
			...
			out.println(" 	m_to_date   = m_to_dd+\"-\"+m_to_mm+\"-\"+m_to_yy; ");
			out.println(" 	m_from_date = m_from_dd+\"-\"+m_from_mm+\"-\"+m_from_yy; ");
			out.println(" 	m_receipt_num = document.Form1.TXT_RECEIPT_NO.value; ");
			out.println("		if(validate_date()) {");		
		//	m_url=servlet_client_url+":"+client_t3_port+"/"+client_name+"cheq_printing?chksql=PRINT&ref_no="+m_sus_refno;
		  out.println("   m_url=\""+m_class_url+"/"+m_fschema_name+"AF_RE_Bulk_Print_Main?chksql=RECEIPT&from_date=\"+m_from_date+\"&to_date=\"+m_to_date+\"&print_type=\"+val+\"&receipt_num=\"+m_receipt_num+\"\";");
		
	//	out.println("document.Form1.action=\""+m_class_url+"/"+m_fschema_name+"AF_RE_Bulk_Print_Main\";");
		...
		out.println("}");
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Invoicing - Receipts Bulk Print </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<td width='10%' ><DIV id='DIV_TXT_TO_DATE'  class=div_input><b>To Date</b></DIV></td>"); 
			out.println(" <TD WIDTH=\"25%\"><input class=\"txt_input5\" type=\"text\" name=TXT_TO_DATE_DD maxlength=\"2\" size=\"2\" >");
			...
			out.println("<tr>"); 
			out.println("<td width='10%' ><DIV id='DIV_TXT_RECEIPT_NO'  class=div_input><b>Receipt No </b></DIV></td>"); 
			out.println("<td width='20%' ><input class='txt_input' type='text' name='TXT_RECEIPT_NO' maxlength='15' size='10' onblur=\"val_receipt_no(document.Form1.TXT_RECEIPT_NO)\">"); 
	    out.println("<input class='but_input' type='button' name='BUT_TXT_RECEIPT_NO' value=\"...\" onClick=\"help_receipt_no()\"></td>"); 
			out.println("<td width='6%'><input class='but_input' type='button' name='BUT_BCODE' value=\"Print\" onClick=\"enable_recep_no();\" style='{cursor:hand;}'></td>"); 
