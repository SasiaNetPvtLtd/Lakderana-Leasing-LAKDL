...
class First_Reminder_bulk_print implements Printable {

public String m_facility_no;
public String m_client_no;
public String m_debtor_no;
public String m_invoice_seq_no;

java.text.NumberFormat nf;

public First_Reminder_bulk_print(String mm_facility_no,String mm_client_code,String mm_debtor_no,String mm_invoice_seq_no){
...
m_invoice_seq_no=mm_invoice_seq_no;
}

public First_Reminder_bulk_print(){
...
public int print (Graphics g, PageFormat pageFormat, int page) {
	...
	try{
		...
		g2d.drawString("1ST REMINDER",350,m_row_num);
		m_row_num=m_row_num+10;
		...
		g2d.drawString("We refer to the factoring agreement we have with your above named supplier under which you have been advised to pay all debts due to the ",42,m_row_num);
		m_row_num=m_row_num+10;
		g2d.drawString("said supplier, which have been assigned to us, to the credit of Lakderana Investments Limited carrying on factoring business under the ",42,m_row_num);
		m_row_num=m_row_num+10;
		g2d.drawString("name and style of 'Orient Factor' at No:46,48, Dr.N.M.Perera Mawatha, Colombo 08.",42,m_row_num);
		...
		" AND A.INVOICE_SEQ_NO='"+m_invoice_seq_no+"' "+
		" ORDER BY A.INVOICE_DATE ");
		
		double m_total_pay=0;
		  
		if(rs2.next()){
		m_total_pay=rs2.getDouble(1);
		}
		m_row_num=m_row_num+10;
		g2d.drawString("According to our records, your Account is overdue by Rs "+nf.format(m_total_pay)+" as given hereunder. ",42,m_row_num);
		m_row_num=m_row_num+20;
		...
		m_row_num=m_row_num+20;
		g2d.drawString("If you have already made appropriate remittances, please advise us accordingly at your earliest convenience. Also if you have any queries ",42,m_row_num);
		m_row_num=m_row_num+10;
		g2d.drawString("concerning this account please do not hesitate to contact the undersigned. ",42,m_row_num);
