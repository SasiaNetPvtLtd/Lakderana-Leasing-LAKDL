...
//
*/
// CREATED BY DINETH MEEMANAGE ON 2008-09-23
// DISPLAY NAME CLIENT DAILY STATEMENT
import java.io.*;
...
public class LAKDL_FA_OP_client_daily_statement_report extends javax.servlet.http.HttpServlet {
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)	throws IOException	{
		...
		try {
     	...
     	res.setDateHeader("Expires", 0);
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Client Daily Statement </TITLE>"); 
			out.println("</HEAD>"); 
			...
			//out.println(" load_c_date(document.Form1.hid_cal_date.value);");
						...
						out.println("		 m_url=\""+m_class_url+"/"+m_fschema_name+"FA_OP_client_daily_statement_display?chksql=LOAD_CLI_DAILY_REPORT&as_at_date=\"+m_as_at_date+\"&client_code=\"+document.Form1.TXT_CLIENT_CODE.value;");
		  			...
		  			out.println("  if(document.Form1.hid_cal_date.value=='1'){"); 
						...
						out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"FA_OP_client_daily_statement_report';"); 
						out.println("		}"); 
						out.println("}"); 
						...
						out.println("	help_box.innerHTML=\" Client Daily Statement - \"+m_val;"); 
						out.println("}"); 

						out.println("function load_roll_out_value(){");
						out.println("	help_box.innerHTML=\" Client Daily Statement \";"); 
						out.println("}"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'> Client Daily Statement </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
