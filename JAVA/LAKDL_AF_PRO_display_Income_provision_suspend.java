// DEVELOP BY : INDITHA FOR MRFL   DATE:03-09-2006
...
public class LAKDL_AF_PRO_display_Income_provision_suspend extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("	if(validate_data()){"); 
			out.println("			m_url=\""+m_class_url+"/"+m_fschema_name+"AF_Income_Provision_sql_validations_normal?chksql=INCOME_SUSPENCE_REPORT_RPT&start_date=\"+document.Form1.TXT_REPORT_ST_PERIOD_VIEW.value+\"&end_date=\"+document.Form1.TXT_REPORT_END_PERIOD_VIEW.value;");
			out.println("			window.open(m_url);");
			out.println("	}");
			out.println("}");
			...
			// added by udara on 15-10-2013
			out.println("function get_vector(data_vec) {");
			
			//out.println("   if(data_vec[0]=='FALSE') ");
			//out.println("     alert('Previous provisioning should be run'); ");
			//out.println("   else");
			
			//out.println("     run_report(); ");
			out.println("}");
			
			out.println("function validate_report_run(){"); 
			out.println("   m_date = document.Form1.TXT_REPORT_END_PERIOD_VIEW.value; ");
			//out.println("   m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_MAS_sql_validations1?chksql=m_validate_report_run&dates=\"+m_date;");
			//out.println("   load_interface(m_url,'XML');");
			out.println("     run_report(); ");
			out.println("}");
			
			// end by udara on 15-10-2013
			...
			out.println("			}");
			out.println("			if(validate_data()){"); 
			out.println("				document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_PRO_Save_Provision';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_PRO_display_Income_provision_suspend';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("	help_box.innerHTML=\" Provision for Bad and Doubtful Debts and Income Suspension - \"+m_val;"); 
			out.println("}"); 
			
			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\" Provision for Bad and Doubtful Debts and Income Suspension - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Provision for Bad and Doubtful Debts and Income Suspension</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<td width='30%'><input class='but_input' type='button' name='BUT_RUN_REPORT' value=\"Run Report\" onClick=\"validate_report_run()\" style='width:100'></td>");   // run_report
			...
			out.println("<td width='30%'><input class='but_input' type='button' name='BUT_RUN_REPORT' value=\"View Report\" onClick=\"view_report()\" style='width:100'></td>"); 
