...
public class LAKDL_FA_MAS_display_Product extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>System Administration - Products</TITLE>"); 
			...
			out.println("		}");
			out.println("		else if(data_vec.length==0 && document.Form1.SCREEN_NAME.value!=\"NEW\" && document.Form1.TXT_PRODUCT_CODE.value!=\"\"  && document.Form1.hid_help_status.value!=\"2\"){");
			out.println("			alert('Selected product incorrect please use help');");
			out.println("			help_update();");
			out.println("		}");
			out.println("		else if(data_vec.length>0 && document.Form1.SCREEN_NAME.value!=\"NEW\" && document.Form1.TXT_PRODUCT_CODE.value!=\"\"  && document.Form1.hid_help_status.value!=\"2\"){");
			out.println("    	document.Form1.TXT_PRODUCT_CODE.value=data_vec[0];"); 
			out.println("    	document.Form1.TXT_PRODUCT_DESC.value=data_vec[1];"); 
			...
			out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"FA_MAS_sql_validations?chksql=m_prime_chk_LAKDL_AF_MAS_PRODUCT&data_val=\"+obj1.value+\"&data_va2=\"+obj2+\"&data_va3=\"+obj3;");
			...
			out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"FA_MAS_sql_validations_normal?chksql=PRODUCT_PACKAGES&product_id=\"+document.Form1.TXT_PRODUCT_CODE.value;");
			//out.println("window.open(m_url);");
			...
			out.println("	}"); 
			out.println("	else if(document.Form1.TXT_PRODUCT_DESC.value==\"\"){  "); 
			out.println("		DIV_TXT_PRODUCT_DESC.style.color='red';");
			out.println("		return false;"); 
			out.println("	}"); 
			out.println("	else{"); 
			...
			out.println("			}");
			out.println("			if(validate_data()){"); 
			out.println("				document.Form1.action='"+m_class_url+"/"+m_fschema_name+"FA_MAS_Save_Product';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"FA_MAS_display_Product';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("    m_help_message = \"m_help_msg_LAKDL_FA_MAS_PRODUCT\";"); 
			...
			out.println("	help_box.innerHTML=\" System Administration - Products - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\" System Administration - Products - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
			...
			out.println("			document.Form1.TXT_PRODUCT_DESC.disabled=true;"); 
			out.println("			document.Form1.TXT_DEFAULT_VALUE.disabled=true;"); 
			out.println("		}"); 
			out.println("		else if(m_val==\"EDIT\"){"); 
			out.println("			document.Form1.BUT_HELP_MAIN.disabled=false;"); 
			out.println("			document.Form1.TXT_PRODUCT_DESC.disabled=false;"); 
	  	...
	  	out.println("					}"); 
			...
			out.println(" m_sql = \"m_help_DIV_TXT_PRODUCT_CODE_sql\";"); 
			out.println(" if(document.Form1.SCREEN_NAME.value==\"EDIT\" || document.Form1.SCREEN_NAME.value==\"DACT\"){ ");
			out.println("  	m_criteria = document.Form1.TXT_PRODUCT_CODE.value+\"@\"+document.Form1.TXT_PRODUCT_DESC.value+\"@\"+\"Y@\";"); 
			out.println(" } ");
			...
			out.println(" 		m_sql = \"m_help_DIV_TXT_PRODUCT_DESC_sql\";"); 
			out.println("  		m_criteria = \"@\"+document.Form1.TXT_PRODUCT_DESC.value+\"@\"+\"@\";"); 
			out.println(" 	} ");
			out.println(" 	else{ ");
			out.println("  		m_criteria = document.Form1.TXT_PRODUCT_CODE.value+\"@\"+document.Form1.TXT_PRODUCT_DESC.value+\"@\"+\"@\";"); 
			out.println(" 	} ");
			out.println(" } ");
			out.println(" else{");
			out.println("   m_criteria = document.Form1.TXT_PRODUCT_CODE.value+\"@\"+document.Form1.TXT_PRODUCT_DESC.value+\"@\"+\"N@\";");
			out.println(" }"); 
	  	...
	  	out.println("					}"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>System Administration - Products </td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_PRODUCT_CODE' maxlength='10' size='10' onblur=\"makeRequest(document.Form1.TXT_PRODUCT_CODE,'1')\">"); 
			out.println("<input class='but_input' type='button' name='BUT_HELP_MAIN' value=\"Help\" onClick=\"help_update()\" disabled></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>");
			
			out.println("<tr >"); 
			out.println("<td width='30%' ><DIV id='DIV_TXT_PRODUCT_DESC'  class=div_input>Product Description *</DIV></td>"); 
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_PRODUCT_DESC' maxlength='50' size='50' style='width:250' onblur=\"makeRequest(document.Form1.TXT_PRODUCT_DESC,'2')\"></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>");
			...
			out.println("<table>"); 
			out.println("<tr >"); 
			out.println("<td width='30%'  class=div_input>Product Features</td>"); 
			out.println("<td width='*%' ></td>");
			out.println("</tr>"); 
			out.println("</table>");
			out.println("<br>"); 
