...
//CREATED BY: NISHANTHA EKANAYAKE
...
public class LAKDL_AF_MAS_display_main_transactions extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>System Administration - Main Transaction Types</TITLE>"); 
			out.println("</HEAD>"); 
			...
			*/
			...
			out.println("    m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations1?chksql=m_prime_chk_LAKDL_AF_MAS_display_main_transaction_code&data_val=\"+obj.value;");
			out.println("}");
			out.println("    else");
			...
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MAS_sql_validations1?chksql=m_prime_chk_LAKDL_AF_MAS_display_main_transaction_desc&data_val=\"+obj.value;");
			...
			out.println("}");
			out.println("		document.Form1.action='"+m_class_url+"/"+m_fschema_name+"AF_MAS_save_main_transaction';");  
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MAS_display_main_transactions';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("help_box.innerHTML=\" System Administration - Main Transaction Types - \"+m_val;"); 
			out.println("}"); 
			out.println(""); 
			
			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\" System Administration - Main Transaction Types - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
			...
			out.println("    m_sql = \"m_view_TXT_MAIN_TRAN_CODE_sql\";");
			out.println("    m_criteria = document.Form1.TXT_TRAN_CODE.value+\"@\"+\"Y@\";"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>System Administration - Main Transaction Types</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
			...
			out.println("<tr >"); 
			out.println("<td width='30%' ><DIV id='DIV_TXT_TRAN_CODE'  class=div_input> Transaction Category Code *</DIV></td>"); 
			...
			out.println("<td width='30%' ><DIV id='DIV_TXT_DESCRIPTION'  class=div_input>Transaction Category Description *</DIV></td>"); 
