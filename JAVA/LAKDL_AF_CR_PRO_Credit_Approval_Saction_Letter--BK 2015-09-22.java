		...
		try { 
			...
			*/
			...
			String Sql_client_data="SELECT DISTINCT A.APPLICATION_NO, "+//1
				...
				*/
				...
				" ,DECODE(INSURANCE_DONE_BY,'LICENSEE','Company','CLIENT','Client',INSURANCE_DONE_BY)  "+ // added by udara 27-02-2015
			...
			*/
			...
			String				Sql_data_approval_prcess=" SELECT * FROM ( "+
				...
				"                   A.STATUS IN ('ENTERED') AND UPPER(APPLICATION_NO)=UPPER('"+m_applicaton_no+"')   "+ 
				...
				*/
				...
				" WHERE B.USER_ID=A.ENT_USER AND "+
				"                         C.DESIGNATION_CODE=B.DESIGNATION_CODE AND "+
				//"                   A.STATUS IN ('ENTERED') AND UPPER(APPLICATION_NO)=UPPER('"+m_applicaton_no+"')   "+ // commented by udara 12-05-2014
				"                   A.STATUS IN ('ENT_CON') AND UPPER(APPLICATION_NO)=UPPER('"+m_applicaton_no+"')   "+ // added by udara 12-05-2014
				//" AND A.ENT_DATE IN  "+
				//" (SELECT MAX(ENT_DATE) FROM "+m_schema_name+".AF_CO_PRO_APPLICATION_APPROVAL WHERE UPPER(APPLICATION_NO)=UPPER('"+m_applicaton_no+"') AND STATUS='ENTERED')  "+
     	...
     	out.println("}");
				...
				while(more){
					...
					*/
					...
					rs_charges =stmt_charges.executeQuery("SELECT "+
						...
						"  GROUP BY A.PRICING_NO,A.SUB_CHAGE_CODE,B.DESCRIPTION ");	
			...
			//	}
				...
				if(_m_tmp_pricing_count > 1 ) {
					...
					rs_charges =stmt_charges.executeQuery("SELECT "+
						...
						"  AND A.SUB_CHAGE_CODE = B.SUB_TYPE_CODE  "+
						"  AND NVL(C.AMOUNT,0) <> 0 "+
						"  GROUP BY A.SUB_CHAGE_CODE,B.DESCRIPTION ");	
			...
			*/
				...
				if(!m_Hid_scr_name.equals("AF_CR_PRO_AGM_COMMENT")){
					...
					// mod by udara 19-03-2014
					if(m_app_stage.equals("VERIFY1")){
						out.println("<td width='8%' align='center'><input type='checkbox' name='chk_rej' value=\"N\" unchecked onClick=\"change_reject()\" style='display:none' >");
					}
					else{
