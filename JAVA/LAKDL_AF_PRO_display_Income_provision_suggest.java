...
public class LAKDL_AF_PRO_display_Income_provision_suggest extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			int check_count = 0; // added by udara on 14-10-2013
			...
			rs1= stmt1.executeQuery(" "+
					...
					" WHERE SCREEN = 'AF_INCOME_SUS_PROV_RPT' "+
				" ");
			...
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE>Provision for Bad and Doubtful Debts and Income Suspension Suggession</TITLE>"); 
			out.println("</HEAD>"); 
			...
			out.println("		if(confirm(\"Are you sure you want to Run Provision for Bad and Doubtful Debts and Income Suspension Suggession ?\")){ ");
			...
			out.println("	if(validate_data()){"); 
			out.println("		if(confirm(\"Are you sure you want to Edit Provision for Bad and Doubtful Debts and Income Suspension Suggession ?\")){ ");
			out.println("   	set_timer_actions();");
			...
			out.println("	if(validate_data()){"); 
			out.println("			m_url=\""+m_class_url+"/"+m_fschema_name+"AF_Income_Provision_sql_validations_normal?chksql=INCOME_SUSPENCE_REPORT_RPT_SUGGEST&start_date=\"+document.Form1.TXT_REPORT_ST_PERIOD_VIEW.value+\"&end_date=\"+document.Form1.TXT_REPORT_END_PERIOD_VIEW.value;");
			out.println("			window.open(m_url);");
			out.println("	}");
			out.println("}");
			...
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_PRO_display_Income_provision_suggest';"); 
			out.println("		}"); 
			out.println("}"); 
			...
			out.println("	help_box.innerHTML=\" Provision for Bad and Doubtful Debts and Income Suspension Suggession - \"+m_val;"); 
			out.println("}"); 

			out.println("function load_roll_out_value(){");
			out.println("	help_box.innerHTML=\" Provision for Bad and Doubtful Debts and Income Suspension Suggession - \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
			...
			out.println("</tr>"); 
			out.println("<tr>"); 
			out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Provision for Bad and Doubtful Debts and Income Suspension Suggession</td>"); 
			out.println("</tr>"); 
			out.println("<tr>"); 
