//--
//SCREEN NAME: Thanking letter for business introducer 
//CREATED BY : CHANDANA
//DATE/TIME  :
//NOTES			 :
...
public class LAKDL_AF_MAS_thank_letter_for_bus_introducer extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
      ...
      m_chksql=req.getParameter("chksql");
		...
		if(m_chksql.equals("main_page")){
			out.println("<HTML>"); 
			out.println("<HEAD>"); 
			out.println("<TITLE> Collection - Thanking Letter-Introducer </TITLE>"); 
			out.println("</HEAD>"); 
      ...
      out.println("}"); 
			...
			out.println("help_box.innerHTML=\"Collection - Thanking Letter-Introducer \"+m_val;"); 
			out.println("}"); 
			out.println(""); 

			out.println("function load_roll_out_value(){");
			out.println("help_box.innerHTML=\"Collection - Thanking Letter-Introducer \"+document.Form1.hid_status.value;"); 
			out.println("}"); 
...
//______________________________________________________________________________________________________________________________
			...
			out.println("<input class='but_input' type='button' name='BUT_TXT_EMPLOYEE' value=\"...\" onClick=\"help_button_3()\"></td>"); 
...
String m_Letter_date="";
	...
	rs = stmt.executeQuery ("SELECT TO_CHAR(SYSDATE,'fmddth') ||'  '||TO_CHAR(SYSDATE,'MONTH')||''||TO_CHAR(SYSDATE,'YYYY') FROM DUAL ");
      ...
      out.println("<script>");
			...
			out.println("	m_url = \""+m_class_url+"/"+m_fschema_name+"AF_MAS_thank_letter_for_bus_introducer?chksql=Letter&client_name="+m_client_name+"&autho_name="+m_autho_name+"&add1="+m_add1+"&add2="+m_add2+"&add3="+m_add3+"&design="+m_design+"&print=FALSE\";");  
    	...
    	out.println("m_writedata+'</table>';");
		  ...
		  out.println("</tr>"); 
			...
			out.println("<table align='center' width='100%' class='table'>"); 
			out.println("<tr><td width=\"*%\" class='rep-body' align='left' >Appreciation letter</td>");
			out.println("</tr>");
		  out.println("</table>");
			out.println("<br>");
			out.println("<table align='center' width='100%' class='table'>"); 
			out.println("<tr><td width=\"*%\" class='rep-body' align='center' ><b>Thanking Letter for business Introducer</b></td>");
			out.println("</tr>");
		  out.println("</table>");
		...
		//	out.println("m_fin_number"+m_fin_number);
			...
			out.println("<table border='0' width='90%' class='table'>"); 		
			out.println("<tr><td width='*%' class='rep-body' ><b>Business Introduction - "+m_client_name+"</b></td></tr>");
			out.println("</table>");
		 ...
		 String data="We sincerely appreciate your valuable thougth to introduce potential client for Lakderana Investments Limited "+
      ...
      out.println("<br>");            
			...
			data = "We wish to state that the above client is under <b>Orient Care</b> and ensure our fullest effor to make "+
			        "him another delighted customer of Orient Family. ";
	...
	out.println("<br>");	
			...
			out.println("<tr><td width='*%' class='rep-body' style='text-align:justify' >LAKDERANA INVESTMENTS LIMITED</td>");
			out.println("</tr></table>");
	...
	out.println("<br>");
			...
			out.println("<table border='0' width='90%' class='table'>");  		
			out.println("<tr>");
			out.println("<td width='*%' class='rep-body' style='text-align:justify' >Name &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp "+m_autho_name+"</td>");
			out.println("</tr>");	
			out.println("<tr>");
			out.println("<td width='*%' class='rep-body' style='text-align:justify' >Designation &nbsp"+m_design+"</td>");
			out.println("</tr></table>");	
