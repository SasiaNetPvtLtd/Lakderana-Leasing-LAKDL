...
public class LAKDL_AF_CR_PRO_Other_Payments_Approval1 extends javax.servlet.http.HttpServlet {
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)
	{
		...
		try {
			...
			*/
				...
				out.println("<td  width='10%' >Account Number</td>");
				...
				rs = stmt.executeQuery ("SELECT "+
					...
					" WHERE  PROCESS_STATUS='APPRO1' AND  ENTRY_TYPE<>'V'  AND UPPER(PAYEE_NAME) LIKE UPPER('%"+m_payee_name+"%')  ");//PROCESS_STATUS changed By Lalanka on 22-06-2009
				while(rs.next()){
					if(j>0 && j%2==1){
					...
					out.println("<td width='10%' ><select class=txt_input type=text name=TXT_APPROVE_TYPE"+j+" maxlength=1 size=1  onChange=\"\"  >");  
			...
			else if(m_chksql.trim().equals("main_page"))
			{
				...
				out.println("<html>");
				out.println("<head>");
				out.println("<title>Other Payments Approval</title>    ");
				...
				rs = stmt.executeQuery (" SELECT "+
					" COUNT(PAYMENT_NO) "+
					" FROM "+m_schema_name+".AF_RE_PRO_SETTLMENT_PAYMENT "+
					" WHERE  PROCESS_STATUS='APPRO1' AND  ENTRY_TYPE<>'V' ");//PROCESS_STATUS changed By Lalanka on 22-06-2009
				...
				out.println("help_box.innerHTML=\"Finance - Other Payment Approval 2 \";"); 
				out.println("}else{");
				out.println("help_box.innerHTML=\"Finance - Other Payment Approval 2 - \"+m_val;"); 
				out.println("}");
				out.println("}");
				...
				out.println("}");
				out.println("		document.Form1.action='"+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_PRO_Save_Other_Payment_Approval1';");  
	      ...
	      out.println("	m_url = \""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_MK_Application_Status_Report?chksql=main_page&sort_column=\"+m_sort_col+\"&order_by_type=\"+m_order_by_type;"); 
			  out.println(" window.location.href=m_url;"); 
				...
				*/				
				...
				out.println("m_url=\""+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_PRO_Other_Payments_Approval1?chksql=payment_details&payee_name=\"+m_payee_name+\"\";");
				...
				out.println("help_box.innerHTML=\" Finance - Other Payment Approval1 - \"+document.Form1.hid_status.value;"); 
				out.println("}"); 
				...
				out.println("		window.location.href='"+m_servlet_client_url+":"+m_client_t3_port+"/"+m_client_name+"AF_CR_PRO_Other_Payments_Approval1?chksql=main_page';"); 
				out.println("		}"); 
				out.println("}"); 
				...
				*/
				...
				out.println("function payee_help(){");
				out.println("Crit=document.Form1.TXT_CLIENT_NAME.value+\"@\";");
				out.println("HelpBox('1','10','0',Crit,'PayeeSql2','1');");
				out.println("}");
				...
				out.println("<INPUT TYPE='Hidden' NAME='Hid_scr_name' VALUE=\"AF_CR_PRO_OTHER_PAYMENTS_APPROVE1\">"); 
				...
				out.println("</tr>"); 
				out.println("<tr>"); 
				out.println("<td align='left' class='pdn_txtpos2' style='height: 18px' id='help_box'>Finance - Other Payment Approval 2 - New</td>"); 
				out.println("</tr>"); 
				out.println("<tr>"); 
				...
				out.println("<input type=button name=cli_help value=... class=\"but_input\" onclick=\"payee_help()\">");//Added by prabash on 10-02-2012
