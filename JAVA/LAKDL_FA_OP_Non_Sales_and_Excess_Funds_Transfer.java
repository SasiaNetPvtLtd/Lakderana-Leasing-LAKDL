...
public class LAKDL_FA_OP_Non_Sales_and_Excess_Funds_Transfer extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
		  ...
		  out.println("		document.Form1.elements[\"TXT_TRAN_AMOUNT_\"+k].value=0;");
			...
			out.println("			}");
			out.println("			if(validate_data()){"); 
			out.println("				document.Form1.action='"+m_class_url+"/"+m_fschema_name+"FA_OP_Save_Non_Sales_and_Excess_Funds_Transfer?chksql=RECEIPT_DETAILS';");  
	    ...
	    out.println("	if(document.Form1.SCREEN_NAME.value==\"DELETE\"){");		
			...
			out.println("				document.Form1.elements[i].disabled=false;");
			out.println("			}");
			out.println("				document.Form1.action='"+m_class_url+"/"+m_fschema_name+"FA_OP_Save_Non_Sales_and_Excess_Funds_Transfer?chksql=RECEIPT_DETAILS_DELE';");  
			out.println("				document.Form1.submit();	"); 
			out.println("} "); 
			out.println("} "); 
			out.println("function clear_window(){	"); 
			out.println("		if(confirm(\"Are you sure you want to clear the screen ?\")){ "); 
			out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"FA_OP_Non_Sales_and_Excess_Funds_Transfer';"); 
			out.println("		}"); 
	  	...
	  	out.println("					}"); 
			...
			out.println("		HelpBox(Start,End,Hid_No);"); 
			out.println("}"); 
			out.println("function makeRequest_get_receipt_detail() {");
			out.println("	  document.Form1.hid_option.value=\"3\";");
			out.println("	if(document.Form1.SCREEN_NAME.value==\"NEW\"){");
			out.println("	if(document.Form1.TXT_RECEIPT_NO.value==''|| document.Form1.TXT_RECEIPT_NO.value=='null' ){");
			out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"FA_OP_Non_Sales_and_Excess_Funds_Transfer_Data?chksql=RECEIPT_DETAILS&chk_status=N&facility_no=\"+document.Form1.TXT_FACILITY_NO.value+\"&client_code=\"+document.Form1.TXT_CLIENT_CODE.value+\"&receipt_no=\"+document.Form1.TXT_RECEIPT_NO.value;");
			out.println("}");
			out.println("else{");
			out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"FA_OP_Non_Sales_and_Excess_Funds_Transfer_Data?chksql=RECEIPT_DETAILS&chk_status=Y&facility_no=\"+document.Form1.TXT_FACILITY_NO.value+\"&client_code=\"+document.Form1.TXT_CLIENT_CODE.value+\"&receipt_no=\"+document.Form1.TXT_RECEIPT_NO.value;");
			out.println("}");
			out.println("}");
			out.println("	if(document.Form1.SCREEN_NAME.value==\"DELETE\"){");
			out.println("	if(document.Form1.TXT_RECEIPT_NO.value==''|| document.Form1.TXT_RECEIPT_NO.value=='null' ){");
			out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"FA_OP_Non_Sales_and_Excess_Funds_Transfer_Data?chksql=DELET_RECEIPT_DETAILS&chk_status=N&facility_no=\"+document.Form1.TXT_FACILITY_NO.value+\"&client_code=\"+document.Form1.TXT_CLIENT_CODE.value+\"&receipt_no=\"+document.Form1.TXT_RECEIPT_NO.value;");
			out.println("}");
			out.println("else{");
			out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"FA_OP_Non_Sales_and_Excess_Funds_Transfer_Data?chksql=DELET_RECEIPT_DETAILS&chk_status=Y&facility_no=\"+document.Form1.TXT_FACILITY_NO.value+\"&client_code=\"+document.Form1.TXT_CLIENT_CODE.value+\"&receipt_no=\"+document.Form1.TXT_RECEIPT_NO.value;");
			out.println("}");
			out.println("}");
			...
			out.println("function makeRequest_get_returnable_receipt_detail() {");
			out.println("	  document.Form1.hid_option.value=\"3\";");
			out.println("	if(document.Form1.SCREEN_NAME.value==\"NEW\"){");
			out.println("	if(document.Form1.TXT_RECEIPT_NO.value==''|| document.Form1.TXT_RECEIPT_NO.value=='null' ){");
			out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"FA_OP_Non_Sales_and_Excess_Funds_Transfer_Data?chksql=REFUNDABLE_RECEIPT_DETAILS&chk_status=N&facility_no=\"+document.Form1.TXT_FACILITY_NO.value+\"&client_code=\"+document.Form1.TXT_CLIENT_CODE.value+\"&receipt_no=\"+document.Form1.TXT_RECEIPT_NO.value;");
			out.println("}");
			out.println("else{");
			out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"FA_OP_Non_Sales_and_Excess_Funds_Transfer_Data?chksql=REFUNDABLE_RECEIPT_DETAILS&chk_status=Y&facility_no=\"+document.Form1.TXT_FACILITY_NO.value+\"&client_code=\"+document.Form1.TXT_CLIENT_CODE.value+\"&receipt_no=\"+document.Form1.TXT_RECEIPT_NO.value;");
			out.println("}");
			out.println("}");
			out.println("		load_interface(m_url,'NO');");
			out.println("}");			
			//---END MODIFICATIONS DONE BY ASHINI ON 22-02-2008-----------------------------------------------
		  ...
		  out.println(" 	m_sql = \"m_help_DIV_TXT_FACILITY_NON_SALE_DELE_sql\";"); 
			...
			out.println("<td width='20%' ><input class='txt_input' type='text' name='TXT_RECEIPT_NO' maxlength='10' size='10' onblur=\"help_receipte()\">"); 
			out.println("<input class='but_input' type='button' name='BUT_HELP_MAIN_2' value=\"Help\" onClick=\"help_receipte()\">");
			out.println("<input class='but_input' type='button' name='BUT_RECE_DETAILS' value=\"Display\" onClick=\"makeRequest_get_receipt_detail()\">"); 
			//out.println("<td width='40%'>"); 
  		out.println("<input class='but_input' type='button' name='BUT_RETU_RECE_DETAILS' style=\"{width:150px;}\" value=\"Display Refundable Receipt\" onClick=\"makeRequest_get_returnable_receipt_detail()\"></td>"); 
			out.println("<td width='*%'></td>"); 
			out.println("</tr>");
			out.println("</table>");
			out.println("<hr>");
