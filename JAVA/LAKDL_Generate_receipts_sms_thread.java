...
public class LAKDL_Generate_receipts_sms_thread extends Thread {
	...
	public LAKDL_Generate_receipts_sms_thread(String m_client_no, String m_finance_no, String m_rec_no, String m_amount, String m_type, String m_user, String m_schema_name){
    ...
    public void run() {
		//synchronized(this){
			...
			try{
					...
					System.out.println("From SMS Thread Start ");
					...
					System.out.println("From SMS Thread Conn Created: " + this.conn);
