		...
		try { 
     	...
     	out.println("		document.Form1.TXT_ADJ_DD.value=v_dd;");
	  	...
	  	out.println("					}"); 
			...
			out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"FA_OP_PRO_sql_client_availability?chksql=LOAD_CLIENT_AVAILABILITY_DRILL&CLIENT_CODE=\"+m_client+\"&FACILITY_NO=\"+m_facility+\"&OPTION_NO=\"+m_option;");	
