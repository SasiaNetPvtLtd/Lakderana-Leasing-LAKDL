...
public class LAKDL_MK_MAS_dashboard_add_sql_property extends javax.servlet.http.HttpServlet { 
	...
	public synchronized void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			String DASH_ID=req.getParameter("DASH_TYPE");
			...
			//*************  USE JQUERY GRIDS  ****************//
			//out.println("m_url="../../validations/PW_MK_sql_validate_duplication.jsp?chksql=dash_get_sql_property&dash_id="+document.Form1.HID_DASH_ID.value+"&sql_type="+document.Form1.SUB_SEC_NUM.value;"); 
			out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"PW_MK_sql_validate_duplication?chksql=dash_get_sql_property&dash_id=\"+document.Form1.HID_DASH_ID.value+\"&sql_type=\"+document.Form1.SUB_SEC_NUM.value;	");
			...
			out.println("		colNames:['Dashboard ID','SQL Type','Property Name','Property Value', 'Edit', 'Delete'],"); 
			out.println("		colModel:[ "); 
			out.println("	{name:'DASH_ID' 			,index:'DASH_ID' 			    , hidden:false	,width:200,align:\"center\" 	,formatter:application_no_fmatter},"); 
			out.println("	{name:'SQL_TYPE_ID' 		,index:'SQL_TYPE_ID' 		    , hidden:false	,width:200,align:\"center\" 	},"); 
			out.println("	{name:'PROP_NAME' 			,index:'PROP_NAME' 				, hidden:false	,width:200,align:\"left\" 	,formatter:application_prop_name},"); 
			out.println("	{name:'PROP_VAL' 			,index:'PROP_VAL' 				, hidden:false	,width:200,align:\"left\" 	,formatter:application_prop_val},"); 
			...
			out.println("	function application_prop_name (cellvalue, options, rowObject)"); 
			out.println("	{"); 
			out.println("		var rowid = options['rowId'];"); 
			out.println("	var link ='<input type=\"hidden\" name=\"HID_PROP_NAME_'+rowid+'\" value='+cellvalue+' > '+cellvalue; "); 
			out.println("	return link;	"); 
			out.println("	}"); 
			
			
			out.println("	function application_prop_val (cellvalue, options, rowObject)"); 
			out.println("	{"); 
			out.println("	var rowid = options['rowId'];"); 
			out.println("	var link ='<input type=\"hidden\" name=\"HID_PROP_VAL_'+rowid+'\" value='+cellvalue+' > '+cellvalue; "); 
			out.println("	return link;	"); 
			out.println("}"); 
			...
			out.println("		document.Form1.TXT_PROPERTY_NAME.value 		= document.Form1.elements[\"HID_PROP_NAME_\"+row_id].value;"); 
			out.println("		document.Form1.TXT_PROPERTY_VAL.value		= document.Form1.elements[\"HID_PROP_VAL_\"+row_id].value;"); 
			...
			//out.println("		cal_total_amount_existing_article();"); 
			out.println("	}"); 
			out.println("}"); 
			...
			function makeRequest() {
				alert("1");
				m_url="../../validations/PW_MK_sql_validate_duplication.jsp?chksql=get_sql_query&SUB_SEC_NUM="+document.Form1.SUB_SEC_NUM.value+"&HID_DASH_ID="+document.Form1.HID_DASH_ID.value;
				//window.open(m_url);	
				load_interface(m_url,'XML');
			}
			
			function get_vector(data_vec) {
				alert("2");
				document.Form1.TXT_SQL_QUERY.value = data_vec[0];	
			}
			*/
			...
			out.println("	var property_name 	= document.Form1.elements[\"TXT_PROPERTY_NAME\"].value;"); 
			out.println("	var property_value 	= document.Form1.elements[\"TXT_PROPERTY_VAL\"].value;"); 
			//temp
			//new_item_value = "25.000524";
			//new_loan_value = "30.255787";
			
			out.println("	var data={DASH_ID:document.Form1.HID_DASH_ID.value,"); 
			out.println("			SQL_TYPE_ID:document.Form1.SUB_SEC_NUM.value,"); 
			out.println("			PROP_NAME:property_name,"); 
			out.println("			PROP_VAL:property_value,"); 
			...
			out.println("	document.Form1.elements[\"TXT_PROPERTY_NAME\"].value 	= \"\";"); 
			out.println("	document.Form1.elements[\"TXT_PROPERTY_VAL\"].value 	= \"\";"); 
			...
			out.println("<INPUT TYPE='Hidden' NAME='HID_DASH_ID' VALUE="+DASH_ID+"> ");
			...
			out.println("<tr>	");
			out.println("<td width='10%' ><b>Add SQL Properties</b></td> ");
			out.println("</tr>	");											
			
			out.println("<tr > ");
			
			out.println("<td width='30%' >SQL Type *</DIV></td> ");
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_HEADER_COM_NAME' value="+SUB_SEC_NUM+" maxlength='100' size='100' onblur=\"\" disabled></td> ");
			...
			out.println("<td width='30%' >SQL Query</DIV></td> ");
			out.println("<td width='40%' >");
			//<%
			rs=stmt.executeQuery(" SELECT NVL(SQL_STR,'-') FROM "+m_schema_name+".DH_GRAPH_SQL WHERE "+
				//	out.println(" SELECT NVL(SQL_STR,'-') FROM SNPW.DH_GRAPH_SQL WHERE "+
				"DASH_ID = '"+DASH_ID+"' AND "+
				"SQL_TYPE = '"+SUB_SEC_NUM+"' ");
			if(rs.next()){
				//%>		
				out.println("<textarea rows=\"10\" cols=\"60\" name='TXT_SQL_QUERY' maxlength='2000' size='50' value=\"\">"+rs.getString(1)+"</textarea></td>");
				//<%
			}else{
				//%>
				out.println("<textarea rows=\"10\" cols=\"60\" name='TXT_SQL_QUERY' maxlength='2000' size='50' value=\"\"></textarea></td>");
			...
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_PROPERTY_NAME' maxlength='2000' size='50'></td> ");
			out.println("<td width='*%'></td> ");
			out.println("</tr> ");
			...
			out.println("<td width='30%' >Property Value</DIV></td> ");
			out.println("<td width='40%' ><input class='txt_input' type='text' name='TXT_PROPERTY_VAL' maxlength='2000' size='50'>");
