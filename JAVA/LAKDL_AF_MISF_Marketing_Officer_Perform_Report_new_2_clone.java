// created by udara - 08-12-2016 - for testing purpose
...
public class LAKDL_AF_MISF_Marketing_Officer_Perform_Report_new_2_clone extends javax.servlet.http.HttpServlet { 
	...
	public  void service(HttpServletRequest req, HttpServletResponse res)  throws IOException { 
		...
		try { 
			...
			if(m_chksql.equals("run_report")){ 
				...
				try{
					//callstmt1 = conn.prepareCall("BEGIN "+m_schema_name+".AF_SAVE_MASTER_ARREARS_RPT(:1,:2,:3,:4,:5,:6,:7);END;"); // added by udara 10-01-2014--7 ADDED MILI FOR COLLECTER
					//callstmt1 = conn.prepareCall("BEGIN "+m_schema_name+".AF_SAVE_MASTER_ARREARS_RPT_2(:1,:2,:3,:4,:5,:6,:7);END;"); // added by udara 06-01-2017
					callstmt1 = conn.prepareCall("BEGIN "+m_schema_name+".AF_SAVE_MASTER_ARREARS_RPT_3(:1,:2,:3,:4,:5,:6,:7);END;");
			...
			if(m_chksql.equals("main_page")){ 
				...
				//out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Perform_Report_new_2_clone?chksql=run_report&finance_no=\"+finance_no+\"&date=\"+m_date+\"&location_id=\"+document.Form1.TXT_LOCATION_CODE.value+\"&user_id=\"+document.Form1.TXT_USER.value+\"&perform_status=\"+m_perform_status;"); 
				out.println("		m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Perform_Report_new_2_clone?chksql=run_report&finance_no=\"+finance_no+\"&date=\"+m_date+\"&location_id=\"+document.Form1.TXT_LOCATION_CODE.value+\"&user_id=\"+document.Form1.TXT_USER.value+\"&perform_status=\"+m_perform_status+\"&collector=\"+collector;"); 
				...
				out.println("	}");
				*/
				//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Perform_Report_new_2_clone?chksql=print_report_new&location=\"+m_location+\"&officer=\"+m_officer+\"&slab=\"+m_slba+\"&rendate=\"+m_rendate+\"&date=\"+m_date;");	
				
				// commented by udara on 06-09-2013
				//out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Perform_Report_new_2_clone?chksql=print_report_new&location=\"+m_location+\"&officer=\"+m_officer+\"&slab=\"+m_slba+\"&rendate=\"+m_rendate+\"&date=\"+m_date+\"&period=\"+m_period+\"&period_2=\"+m_period_2;"); // added by udara on 12-03-2013
				...
				//out.println("               m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Perform_Report_new_2_clone?chksql=print_report_new&location=\"+m_location+\"&officer=\"+m_officer+\"&slab=\"+m_slba+\"&rendate=\"+m_rendate+\"&date=\"+m_date+\"&period=\"+m_period+\"&period_2=\"+m_period_2+\"&cr_officer=\"+cr_officer+\"&active_status=\"+document.Form1.TXT_ACTIVE_STATUS.value+\"&region=\"+m_region+\"&perform_status=\"+m_perform_status;"); // m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Perform_Report_new_2_clone?chksql=print_report_new&location=\"+m_location+\"&officer=\"+m_officer+\"&slab=\"+m_slba+\"&rendate=\"+m_rendate+\"&date=\"+m_date+\"&period=\"+m_period+\"&period_2=\"+m_period_2;");
				out.println("               m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Perform_Report_new_2_clone?chksql=print_report_new_logic&location=\"+m_location+\"&officer=\"+m_officer+\"&slab=\"+m_slba+\"&rendate=\"+m_rendate+\"&date=\"+m_date+\"&period=\"+m_period+\"&period_2=\"+m_period_2+\"&cr_officer=\"+cr_officer+\"&active_status=\"+document.Form1.TXT_ACTIVE_STATUS.value+\"&region=\"+m_region+\"&perform_status=\"+m_perform_status;"); // udara 08-12-2016
				out.println("           else ");
				out.println("           	m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Perform_Report_new_2_clone?chksql=print_report_new_2&location=\"+m_location+\"&officer=\"+m_officer+\"&slab=\"+m_slba+\"&rendate=\"+m_rendate+\"&date=\"+m_date+\"&period=\"+m_period+\"&period_2=\"+m_period_2+\"&due_month=\"+due_month+\"&due_year=\"+due_year+\"&ins_level=\"+ins_level+\"&cr_officer=\"+cr_officer+\"&active_status=\"+document.Form1.TXT_ACTIVE_STATUS.value+\"&region=\"+m_region+\"&perform_status=\"+m_perform_status;"); // m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Perform_Report_new_2_clone?chksql=print_report_new_2&location=\"+m_location+\"&officer=\"+m_officer+\"&slab=\"+m_slba+\"&rendate=\"+m_rendate+\"&date=\"+m_date+\"&period=\"+m_period+\"&period_2=\"+m_period_2+\"&due_month=\"+due_month+\"&due_year=\"+due_year+\"&ins_level=\"+ins_level;");
				*/
				
				out.println("   m_product_name   = document.Form1.TXT_PRODUCT.value; "); // added by udara 12-10-2018
				//out.println("               m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Perform_Report_new_2_clone?chksql=print_report_new_logic&location=\"+m_location+\"&officer=\"+m_officer+\"&slab=\"+m_slba+\"&rendate=\"+m_rendate+\"&date=\"+m_date+\"&period=\"+m_period+\"&period_2=\"+m_period_2+\"&cr_officer=\"+cr_officer+\"&active_status=\"+document.Form1.TXT_ACTIVE_STATUS.value+\"&region=\"+m_region+\"&perform_status=\"+m_perform_status+\"&due_month=\"+due_month+\"&due_year=\"+due_year+\"&ins_level=\"+ins_level;"); // udara 09-12-2016
				out.println("               m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Perform_Report_new_2_clone?chksql=print_report_new_logic&location=\"+m_location+\"&officer=\"+m_officer+\"&slab=\"+m_slba+\"&rendate=\"+m_rendate+\"&date=\"+m_date+\"&period=\"+m_period+\"&period_2=\"+m_period_2+\"&cr_officer=\"+cr_officer+\"&active_status=\"+document.Form1.TXT_ACTIVE_STATUS.value+\"&region=\"+m_region+\"&perform_status=\"+m_perform_status+\"&due_month=\"+due_month+\"&due_year=\"+due_year+\"&ins_level=\"+ins_level+\"&product_name=\"+m_product_name;");
				...
				out.println("		window.location.href='"+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Perform_Report_new_2_clone?chksql=main_page&generate=page';"); 
				out.println("		}"); 
				out.println("}"); 
				...
				//out.println("<input class='but_input' type='button' name='BUT_PRINT' value=\"Run Report\" onClick=\"run_report()\" style=\"{width:110px;}\">"); // commented by udara 25-05-2017
			    out.println(" &nbsp; </td>"); // added by udara 25-05-2017
				out.println("</tr>");
				...
				out.println("    m_order_by_type = 'ASC'; ");
				out.println("  }");
				// out.println("	m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Perform_Report_new_2_clone?chksql=print_report_new&location="+m_location+"&officer="+m_officer+"&date="+m_date+"&sort_column=\"+m_sort_col+\"&order_by_type=\"+m_order_by_type;"); 
				out.println("m_url=\""+m_class_url+"/"+m_fschema_name+"AF_MISF_Marketing_Officer_Perform_Report_new_2_clone?chksql=print_report_new&location="+m_location+"&slba="+m_slba+"&rendate="+m_rendate+"&officer="+m_officer+"&date="+m_date+"&sort_column=\"+m_sort_col+\"&order_by_type=\"+m_order_by_type;");	
				...
				if(m_slba.equals("")){
					...
					if((m_period.equals("")) && (m_period_2.equals(""))){	// added by udara on 21-08-2013
						...
						if(!(m_region.equals("NOT_SELECT"))){                 // Added By: Samith Dilshan on 2015-06-15 for Region Code
							...
							" ,"+m_schema_name+".AF_CO_GET_LAST_PAY_AMT_2(FINANCE_NO) "+ // A S Silva 04-06-2015
							//" ,0 "+ // mod udara 20-07-2015
							" FROM T "+
				...
				out.println("<td class=factoring-letter-body ><b>Last Paid Amount</b></td>"); // 
				out.println("</tr >");
				...
				/*	if(rs.getString(20)!=null){
					...
					//if(rs.getString(3)!=null && rs.getString(4)!=null && rs.getString(5)!=null && rs.getString(6)!=null && rs.getString(7)!=null && rs.getString(8)!=null&& rs.getString(9)!=null&& rs.getString(10)!=null&& rs.getString(11)!=null&& rs.getString(12)!=null&& rs.getString(13)!=null){ // commented by udara 09-12-2015
					
					if(rs.getString(3)!=null && rs.getString(4)!=null && rs.getString(6)!=null && rs.getString(7)!=null && rs.getString(8)!=null&& rs.getString(9)!=null&& rs.getString(10)!=null&& rs.getString(11)!=null&& rs.getString(12)!=null&& rs.getString(13)!=null){ // added by udara 09-12-2015
					
					//if(rs.getString(3)!=null && rs.getString(4)!=null && rs.getString(5)!=null && rs.getString(6)!=null && rs.getString(7)!=null && rs.getString(8)!=null&& rs.getString(9)!=null&& rs.getString(10)!=null&& rs.getString(11)!=null&& rs.getString(12)!=null&& rs.getString(13)!=null && rs.getString(1)!=null){ // added by udara 08-12-2015
					...
					//else if( rs.getString(2)==null && rs.getString(1).equals("SUB TOTAL") && j > 1 ){ // mod by udara 08-12-2015
						out.println("<tr>");
						out.println("<td  class=factoring-letter-body   STYLE='{text-align:right;}'  > </td>"); 
						out.println("<td  class=factoring-letter-body   STYLE='{text-align:right;}'  > </td>"); 
						out.println("<td  class=factoring-letter-body   STYLE='{text-align:right;}'  > </td>"); 
			...
			// =============== end by udara on 06-09-2013 ====================================================================================
				...
				String sql_m_region_product = "";
				if(!(m_product_name.equals("NOT_SELECT"))){                 
					sql_m_region_product = "    AND   "+m_schema_name+".AF_CO_GET_FIN_TRAN_TYPE(FINANCE_NO) = '"+m_product_name+"' ";    
				}
				...
				if((!m_rendate.equals("")) && (!m_rendate.equals(""))){
					sql_m_rendate = 	" AND   NVL(VALUE_DATE,' ') LIKE UPPER('%"+m_rendate+"%') ";
				}
				
				String sql_cr_officer_1 = "  ";
				String sql_cr_officer_2 = "  ";
				if((!cr_officer.equals("")) && (!cr_officer.equals(""))){
					sql_cr_officer_1 = " AND   UPPER(NVL("+m_schema_name+".AF_CO_GET_CR_OFFICER_3(APPLICATION_NO),' ') ) LIKE UPPER('%"+cr_officer+"%') ";
					sql_cr_officer_2 = " AND   UPPER(COLLECTER_ID) LIKE UPPER('%"+cr_officer+"%') ";
				}
				
				String sql_m_location = "   ";
				if((!m_location.equals("")) && (!m_location.equals(""))){
					sql_m_location = " AND   UPPER(LOCATION_CODE) LIKE UPPER('%"+m_location+"%') ";
				}
				
				String sql_m_officer = "   ";
				if((!m_officer.equals("")) && (!m_officer.equals(""))){
					sql_m_officer = " AND   UPPER(COLLECTION_OFFICER) LIKE UPPER('%"+m_officer+"%') ";
				}
				...
				Sql_data = " "+					
						" SELECT "+
						    ...
						    " AGE_NEW, "+ // 4
						    " CLIENT_TEL_NO, "+ // 5
						    " NVL("+m_schema_name+".AF_CO_GET_FOLLOWUP_REMARK(APPLICATION_NO,'AF','RECOVERY'),'Enter Follow up') FOL_REMARK, "+ // 6
						    " NVL("+m_schema_name+".AF_CO_GET_CLI_CITY_NAME(CLIENT_CODE),'-') CITY_NAME, "+ // 7
						    " NVL("+m_schema_name+".AF_CO_GET_CR_OFFICER_2(APPLICATION_NO),'-') COLL_OFICER, "+ // 8
						    " NVL("+m_schema_name+".AF_CO_GET_ALL_REG_NUMBERS(FINANCE_NO),'-') VEHICLE_NO, "+ // 9
						    " TOTAL_PERIOD, "+ // 10
							" NVL(VALUE_DATE,'-') VALUE_DATE, "+ // 11
						    " DUE_RENTAL_AMOUNT, "+ // 12
						    " TOTAL_AMOUNT, "+ // 13
						    " "+m_schema_name+".AF_GET_COLL_OFFICER_2(FINANCE_NO) COLL_OFFICER, "+ // 14
						    " "+m_schema_name+".AF_GET_FIN_STATUS(FINANCE_NO) FIN_STATUS, "+ // 15
						    " NVL("+m_schema_name+".AF_CO_GET_LAST_PAY_DATE_2(FINANCE_NO,'"+m_date+"'),'-') LAST_PAY_DATE, "+ // 16
						    " "+m_schema_name+".AF_CO_GET_ARR_RPT_REMARK(FINANCE_NO,CLIENT_CODE) ARR_RPT_REMARK, "+ // 17
						    " NVL("+m_schema_name+".AF_CO_GET_LAST_PAY_AMT_2(FINANCE_NO),0) LAST_PAY_AMT, "+ // 18
							" NVL("+m_schema_name+".AF_CO_GET_CR_OFFICER_2(application_no),'-') CURR_COLL_OFFICER "+ // 19 
						" FROM "+m_schema_name+".AF_MASTER_ARREARS_RPT "+ 
						//" WHERE ENT_USER = '"+m_username+"' "+ // temporary commented by udara 25-05-2017
						" WHERE ENT_USER = 'LAKDLALL' "+ // added commented by udara 25-05-2017
						
						"  "+sql_m_officer+" "+
						//" AND   UPPER(COLLECTION_OFFICER) LIKE UPPER('%"+m_officer+"%') "+

						" "+sql_cr_officer_2+" "+
						//" AND   UPPER(COLLECTER_ID) LIKE UPPER('%"+cr_officer+"%') "+
						
						" "+sql_m_location+" "+
						//" AND   UPPER(LOCATION_CODE) LIKE UPPER('%"+m_location+"%')  "+
						
						" "+sql_cr_officer_1+" "+
						//" AND   UPPER(NVL("+m_schema_name+".AF_CO_GET_CR_OFFICER_3(APPLICATION_NO),' ') ) LIKE UPPER('%"+cr_officer+"%') "+
						...
						"  "+m_active_status_string+" "+
						"  "+sql_m_region+" "+
						"  "+sql_m_region_product+" "+ 
						"  "+sql_m_ins_level+" "+
						"  "+sql_due_month_year+" "+
						" ORDER BY VALUE_DATE,FINANCE_NO,CLIENT_CODE,FULL_NAME,AGE_NEW,CLIENT_TEL_NO,DUE_RENTAL_AMOUNT,FOL_REMARK,CITY_NAME,COLL_OFICER,VEHICLE_NO,TOTAL_PERIOD	 "+					  
					" ";
